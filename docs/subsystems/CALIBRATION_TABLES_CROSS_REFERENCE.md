...
| 0x69E4C | 1D | 48 | f32 | — | — | 0x6FBD8 | MAF Scaling |
...
|---------|---------------|--------|-------|
| 0x6FBD8 | **MAF Scaling** | 1D f32[48] thru desc@0x69E4C | Voltage→g/rev lookup |
...
|---------|------|------|------|---------|------------|
| 0x6FBD8 | **MAF Scaling** | 1D f32[48] | Voltage (0–5V) | `maf_sensor_value.c` | 0x69E4C |
