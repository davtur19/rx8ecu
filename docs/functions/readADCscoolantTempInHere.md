...
```
**Status:** med — the structure is clear (switch on mode, read hardware, write to RAM) but the exact hardware register layout and meaning of control values require verification.
