...
return address from stack ; Load r14 from stack ; Tail-call to 0x7188 via jmp
**Draft C:**
```c
...
```
**Status:** med — register operations are clear, but purpose of 0x7188 tail-call is unknown. Naming as "pulse" is speculative.
