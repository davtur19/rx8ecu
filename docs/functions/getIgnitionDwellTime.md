...
**Out:** RAM 0xFFFFA0D4: final dwell time as u16, clamped to 0xFFFF ; Sets 0xFFFFA0D6 as intermediate (may be offset value) ; return r0: u16 result (return value in r0, then extu.w to zero-extend)
