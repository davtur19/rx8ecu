...
**Out:** RAM 0xFFFF8130 (base) through related addresses: e-shaft learned offsets (floats) ; RAM 0x8684, 0x8682: primary and secondary offset registers (updated with updateMemoryAtAddress functions) ; Adaptive trim values stored back to EEPROM with E2 functions
