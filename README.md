...
- **229 C lifts**, **270 emulator-verified addresses**, 100k+ random vectors per key function (`c/`, `c/verified_addrs.txt`).
...
`tools/gen_c_lift.py` — batch SH-2→C generator: pure-function lifts + mem mode (RAM-only: param/literal/stack bases), emulator-verified
...
| `c/` | 229 verified C lifts, `eeprom_immo.h`, host test suites (203 py + 26 c), `verified_addrs.txt` |
