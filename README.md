...
- **977 C lifts**, **977 emulator-verified addresses**, 100k+ random vectors per key function (`c/`, `c/verified_addrs.txt`).
...
| `c/` | 977 verified C lifts, `eeprom_immo.h`, host test suites (1094 py + 26 c), `verified_addrs.txt` |
