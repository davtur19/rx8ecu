...
- **521 C lifts**, **546 emulator-verified addresses**, 100k+ random vectors per key function (`c/`, `c/verified_addrs.txt`).
...
| `c/` | 521 verified C lifts, `eeprom_immo.h`, host test suites (656 py + 26 c), `verified_addrs.txt` |
