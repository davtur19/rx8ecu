...
- **195 C lifts**, **270 emulator-verified addresses**, 100k+ random vectors per key function (`c/`, `c/verified_addrs.txt`).
...
`tools/gen_c_lift.py` — batch SH-2→C DRAFT generator for pure functions (pilot: 10 lifts, emulator-verified, commit 2723249)
...
| `c/` | 195 verified C lifts, `eeprom_immo.h`, host test suites (203 py + 26 c), `verified_addrs.txt` |
