...
- 1559 C lifts / 1699 `c/*.c`; **295 emulator**-verified (`c/verified_addrs.txt`).
...
- _Counters are snapshot at commit `3d5f9a7`; source of truth: `make catalog` / [MANIFEST.md](MANIFEST.md)._
