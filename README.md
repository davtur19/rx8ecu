...
- **513 C lifts**, **600 emulator-verified addresses**, 100k+ random vectors per key function (`c/`, `c/verified_addrs.txt`).
...
| `c/` | 513 verified C lifts, `eeprom_immo.h`, host test suites (699 py + 26 c), `verified_addrs.txt` |
