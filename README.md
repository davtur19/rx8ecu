...
- **185 C lifts**, **270 emulator-verified addresses**, 100k+ random vectors per key function (`c/`, `c/verified_addrs.txt`).
...
| `c/` | 185 verified C lifts, `eeprom_immo.h`, host test suites (203 py + 26 c), `verified_addrs.txt` |
