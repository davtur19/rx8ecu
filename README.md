...
[Explorer](https://davtur19.github.io/rx8ecu/) — interactive firmware explorer: browse 56k symbols, callgraph, calibration tables and function docs.
...
- 1622 C lifts / 1739 `c/*.c`; **295 emulator**-verified (`c/verified_addrs.txt`).
...
- _Counters are snapshot at commit `7984738`; source of truth: `make catalog` / [MANIFEST.md](MANIFEST.md)._
...
| `c/` | verified C lifts (1739 `c/*.c`), `eeprom_immo.h`, host test suites, `verified_addrs.txt` |
