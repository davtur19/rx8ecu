...
- **1082 C lifts** (unique_lift_addrs), **1082 emulator-verified addresses** (lifts verificati), 100k+ random vectors per key function (`c/`, `c/verified_addrs.txt`; note `c/*.c` also includes ~101 reference non-lift files).
...
| `c/` | 1082 verified C lifts (unique_lift_addrs; `c/*.c` includes ~101 reference non-lift files), `eeprom_immo.h`, host test suites (1267 py + 26 c), `verified_addrs.txt` |
