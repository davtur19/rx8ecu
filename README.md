...
- **L4 — Differential/emulator.** 1486 py + 26 C suites; each lift vs ROM bytes on
...
- 1186 C lifts / 1318 `c/*.c`; **295 emulator**-verified (`c/verified_addrs.txt`).
- Tables: 1,210 cal + 37,121 RomXR/GROM defs / 13 ROM codes; 6,953 call-graph edges; 18 jump tables.
- Docs: 191 function + 15 subsystem; **tests:** 1486 py + 26 C.
- _Counters are snapshot at commit `fa4d54b`; source of truth: `make catalog` / [MANIFEST.md](MANIFEST.md)._
...
| `c/` | verified C lifts (1318 `c/*.c`), `eeprom_immo.h`, host test suites, `verified_addrs.txt` |
