/*
 * loadStatusRegister_ADDR.c  —  RX-8 PCM raw SR write (0x2064)
 *
 * SH-2 asm:  rts            ; return (delay slot executes BEFORE rts)
 *            ldc r4,sr      ; sr = r4  (set Status Register)
 *
 * This function performs an unconditional write of r4 into the Status
 * Register, exactly like
 ...
 * over 50000 random SR values.  Test: c/tests/test_loadStatusRegister_ADDR.py.
 *
...
static inline void loadStatusRegister_ADDR(uint32_t sr)
{
