/* ROM: 60E0FC00 | Address: 0x54CBA | Size: 22 bytes | STATUS: DRAFT
...
void f_54CBA(ST *s)
{
    ...
    /* 0x054CC0: jsr @r3 */
    /* 0x054CC2: mov.b r4,@r15 */
    local_3f8 = s->r[4];
    /* 0x054CC4: mov.b @r15,r4 */
    ...
    /* 0x054CCC: jmp @r3 (tail) */
    /* 0x054CCE: lds.l @r15+,pr */
    s->pr = local_3fc;
    return; /* fallthrough */
}
