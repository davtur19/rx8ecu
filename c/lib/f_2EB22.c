/* ROM: 60E0FC00 | Address: 0x2EB22 | Size: 30 bytes | STATUS: DRAFT
...
void f_2EB22(ST *s)
{
    ...
    /* 0x02EB38: mov.l @r15+,r4 */
    s->r[4] = local_3f8;
    /* 0x02EB3A: op 0xD340 */
    s->r[3] = 0x00003934u;
    /* 0x02EB3C: jmp @r3 (tail) */
    /* 0x02EB3E: lds.l @r15+,pr */
    s->pr = local_3fc;
    return; /* fallthrough */
}
