/* ROM: 60E0FC00 | Address: 0xA186 | Size: 22 bytes | STATUS: DRAFT
...
void f_A186(ST *s)
{
    ...
    /* 0x00A186: op 0xE50C */
    s->r[5] = (uint32_t)(int32_t)(int8_t)0x0C;
    /* 0x00A188: op 0xD21C */
    s->r[2] = 0x00009630u;
    /* 0x00A18A: sts.l pr,@-r15 */
    local_3fc = s->pr;
    /* 0x00A18C: op 0x7FFC */
    s->r[15] = s->r[15] + (uint32_t)(int32_t)(int8_t)0xFC;
    /* 0x00A18E: op 0x66F3 */
    s->r[6] = s->r[15];
    /* 0x00A190: mov.l r4,@r15 */
    local_3f8 = s->r[4];
    /* 0x00A192: jsr @r2 */
    /* 0x00A194: op 0xE401 */
