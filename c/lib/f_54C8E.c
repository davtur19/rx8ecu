/* ROM: 60E0FC00 | Address: 0x54C8E | Size: 22 bytes | STATUS: DRAFT
...
void f_54C8E(ST *s)
{
    ...
    /* 0x054C94: jsr @r3 */
    /* 0x054C96: mov.b r4,@r15 */
    local_3f8 = s->r[4];
    /* 0x054C98: mov.b @r15,r4 */
    ...
    /* 0x054CA0: jmp @r3 (tail) */
    /* 0x054CA2: lds.l @r15+,pr */
    s->pr = local_3fc;
    return; /* fallthrough */
}
