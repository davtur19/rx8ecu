#!/usr/bin/env python3
"""Differential test for isr_decrement_3941e (0x3941E) — v3 lift (branches + delay slots), 42 bytes.
...
Run from repo root: python3 c/tests/test_isr_decrement_3941e_3941e.py
"""
...
ENTRY = 0x3941E
RAW = bytes.fromhex("95 1C 92 1C 63 20 63 3C 43 15 8F 04 00 09 D3 11 61 30 A0 08 25 10 64 50 63 4C 23 38 8D 03 00 09 90 0E 34 0C 25 40 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    0x3941e: {"kind": 'reg', "py": 'r[5] = 0xFFFFC528', "slot_py": None, "target": None, "cond": None},
    0x39420: {"kind": 'reg', "py": 'r[2] = 0xFFFFA400', "slot_py": None, "target": None, "cond": None},
    0x39422: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFA400, 1))', "slot_py": None, "target": None, "cond": None},
    0x39424: {"kind": 'reg', "py": 'r[3] = r[3] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x39426: {"kind": 'reg', "py": 'T = 1 if s32(r[3]) > 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x39428: {"kind": "branch", "py": None, "slot_py": '', "target": 0x39434, "cond": 'notT'},
    0x3942c: {"kind": 'reg', "py": 'r[3] = 0x0006CF87', "slot_py": None, "target": None, "cond": None},
    0x3942e: {"kind": 'mem', "py": 'r[1] = s8(_rdw(ram, 0x0006CF87, 1))', "slot_py": None, "target": None, "cond": None},
    0x39430: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFC528, 1, r[1])', "target": 0x39444, "cond": 'always'},
    0x39434: {"kind": 'mem', "py": 'r[4] = s8(_rdw(ram, 0xFFFFC528, 1))', "slot_py": None, "target": None, "cond": None},
    0x39436: {"kind": 'reg', "py": 'r[3] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x39438: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x3943a: {"kind": "branch", "py": None, "slot_py": '', "target": 0x39444, "cond": 'T'},
    0x3943e: {"kind": 'reg', "py": 'r[0] = 0x000000FF', "slot_py": None, "target": None, "cond": None},
    0x39440: {"kind": 'reg', "py": 'r[4] = (r[4] + r[0]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x39442: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC528, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x39444: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
