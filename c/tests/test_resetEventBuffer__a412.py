#!/usr/bin/env python3
"""Differential test for resetEventBuffer_ (0xA412) — v3 lift (branches + delay slots), 38 bytes.
...
Run from repo root: python3 c/tests/test_resetEventBuffer__a412.py
"""
...
ENTRY = 0xA412
RAW = bytes.fromhex("6E F6 93 59 E4 00 D5 34 E7 05 D1 31 66 43 21 30 D3 31 23 40 76 01 25 42 62 6E 15 41 32 73 8F F9 75 08 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFF802D
SPAN_END = 0xA438
SENT = 0xA438     # stop-sentinel, placed past the literal pool
...
CODE = {
    ...
    0xa420: {"kind": 'mem', "py": '_wrw(ram, 0xFFFF802C, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0xa422: {"kind": 'reg', "py": 'r[3] = 0xFFFF802D', "slot_py": None, "target": None, "cond": None},
    0xa424: {"kind": 'mem', "py": '_wrw(ram, 0xFFFF802D, 1, r[4])', "slot_py": None, "target": None, "cond": None},
