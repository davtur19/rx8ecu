#!/usr/bin/env python3
"""Differential test for caller_41D7C (entry 0x41D7C) — v8 ST caller (CFG), 48 bytes.
...
Run: python3 test_caller_41D7C.py
"""
...
CODE = {
    0x41d7c: {"kind": 'mem', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, r[14])\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x41d7e: {"kind": 'st', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x41d80: {"kind": 'reg', "py": 'r[14] = 0xFFFFC874', "slot_py": None, "target": None, "cond": None},
    0x41d82: {"kind": 'reg', "py": 'r[3] = 0xFFFFB3B4', "slot_py": None, "target": None, "cond": None},
    0x41d84: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFB3B4, 1))', "slot_py": None, "target": None, "cond": None},
    0x41d86: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x41d88: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x41d8a: {"kind": "branch", "py": None, "slot_py": '', "target": 0x41da2, "cond": 'notT'},
    0x41d8e: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFC874, 4))', "slot_py": None, "target": None, "cond": None},
    0x41d90: {"kind": 'reg', "py": 'r[2] = 0xFFFFB3B0', "slot_py": None, "target": None, "cond": None},
    0x41d92: {"kind": 'fpu', "py": 'fr[5] = bits2f(_rdw(ram, 0xFFFFB3B0, 4))', "slot_py": None, "target": None, "cond": None},
    0x41d94: {"kind": 'reg', "py": 'r[1] = 0x0007C160', "slot_py": None, "target": None, "cond": None},
    0x41d96: {"kind": 'fpu', "py": 'fr[5] = ts(fr[5] + fr[3])', "slot_py": None, "target": None, "cond": None},
    0x41d98: {"kind": 'reg', "py": 'r[3] = 0x000023F4', "slot_py": None, "target": None, "cond": None},
    0x41d9a: {"kind": "call", "py": None, "slot_py": 'fr[4] = bits2f(_rdw(ram, 0x0007C160, 4))', "target": 0x23f4, "ret_pc": 0x41d9e, "set_pr": True, "cond": None},
    0x41d9e: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFC874, 4, f2bits(fr[0]))', "target": 0x41da6, "cond": 'always'},
    0x41da2: {"kind": 'fpu', "py": 'fr[3] = 0.0', "slot_py": None, "target": None, "cond": None},
    0x41da4: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFC874, 4, f2bits(fr[3]))', "slot_py": None, "target": None, "cond": None},
    0x41da6: {"kind": 'st', "py": 'pr = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x41da8: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},
