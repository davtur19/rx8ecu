#!/usr/bin/env python3
"""Differential test for fpu_register_copy_simple_32F38 (0x32F38) — v3 lift + v4 FPU, 10 bytes.
...
Run from repo root: python3 c/tests/test_fpu_register_copy_simple_32F38_32f38.py
"""
...
RAM_MAX = 0xFFFFC008
SPAN_END = 0x32F42
SENT = 0x32F42     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x32f38: {"kind": 'reg', "py": 'r[3] = 0xFFFFBC1C', "slot_py": None, "target": None, "cond": None},
    0x32f3a: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFBC1C, 4))', "slot_py": None, "target": None, "cond": None},
    0x32f3c: {"kind": 'reg', "py": 'r[2] = 0xFFFFC008', "slot_py": None, "target": None, "cond": None},
    0x32f3e: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFC008, 4, f2bits(fr[3]))', "target": None, "cond": None},}
