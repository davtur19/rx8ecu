#!/usr/bin/env python3
"""Differential test for can216ResetTimer (0x299D0) — v3 lift (branches + delay slots), 10 bytes.
...
Run from repo root: python3 c/tests/test_can216ResetTimer_299d0.py
"""
...
ENTRY = 0x299D0
RAW = bytes.fromhex("D2 10 63 20 90 18 00 0B 20 30")
SEED = 0
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBAF8
SPAN_END = 0x299DA
SENT = 0x299DA     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x299d0: {"kind": 'reg', "py": 'r[2] = 0x0006D485', "slot_py": None, "target": None, "cond": None},
    0x299d2: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0x0006D485, 1))', "slot_py": None, "target": None, "cond": None},
    0x299d4: {"kind": 'reg', "py": 'r[0] = 0xFFFFBAF8', "slot_py": None, "target": None, "cond": None},
    0x299d6: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBAF8, 1, r[3])', "target": None, "cond": None},}
