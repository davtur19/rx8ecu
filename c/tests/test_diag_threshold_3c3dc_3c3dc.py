#!/usr/bin/env python3
"""Differential test for diag_threshold_3c3dc (0x3C3DC) — v3 lift (branches + delay slots), 32 bytes.
...
Run from repo root: python3 c/tests/test_diag_threshold_3c3dc_3c3dc.py
"""
...
CODE = {
    0x3c3dc: {"kind": 'reg', "py": 'r[4] = 0x0007A97C', "slot_py": None, "target": None, "cond": None},
    0x3c3de: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0x0007A97C, 1))', "slot_py": None, "target": None, "cond": None},
    0x3c3e0: {"kind": 'reg', "py": 'r[2] = 0xFFFFC5FC', "slot_py": None, "target": None, "cond": None},
    0x3c3e2: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC5FC, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x3c3e4: {"kind": 'mem', "py": 'r[1] = s8(_rdw(ram, 0x0007A97C, 1))', "slot_py": None, "target": None, "cond": None},
    0x3c3e6: {"kind": 'reg', "py": 'r[0] = 0xFFFFC5FD', "slot_py": None, "target": None, "cond": None},
    0x3c3e8: {"kind": 'reg', "py": 'r[2] = 0xFFFFC5FE', "slot_py": None, "target": None, "cond": None},
    0x3c3ea: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC5FD, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x3c3ec: {"kind": 'reg', "py": 'r[1] = 0x0007A97D', "slot_py": None, "target": None, "cond": None},
    0x3c3ee: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0x0007A97D, 1))', "slot_py": None, "target": None, "cond": None},
    0x3c3f0: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC5FE, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x3c3f2: {"kind": 'reg', "py": 'r[3] = 0x0007A97E', "slot_py": None, "target": None, "cond": None},
    0x3c3f4: {"kind": 'reg', "py": 'r[2] = 0xFFFFC5FF', "slot_py": None, "target": None, "cond": None},
    0x3c3f6: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0x0007A97E, 1))', "slot_py": None, "target": None, "cond": None},
    0x3c3f8: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFC5FF, 1, r[0])', "target": None, "cond": None},}
