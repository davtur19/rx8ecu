#!/usr/bin/env python3
"""Differential test for track_max_3d_ca80_with_reset (0x44190) — v3 lift (branches + delay slots), 40 bytes.
...
Run from repo root: python3 c/tests/test_track_max_3d_ca80_with_reset_44190.py
"""
...
ENTRY = 0x44190
RAW = bytes.fromhex("91 6A 60 10 60 0C 88 01 8F 0C 00 09 93 65 60 30 60 0C 88 01 8F 06 00 09 93 5C E1 00 90 5E 92 5A 22 31 20 10 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCFD9
SPAN_END = 0x441B8
SENT = 0x441B8     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x44190: {"kind": 'reg', "py": 'r[1] = 0xFFFFCFD9', "slot_py": None, "target": None, "cond": None},
    0x44192: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCFD9, 1))', "slot_py": None, "target": None, "cond": None},
    0x44194: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x44196: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x44198: {"kind": "branch", "py": None, "slot_py": '', "target": 0x441b4, "cond": 'notT'},
    0x4419c: {"kind": 'reg', "py": 'r[3] = 0xFFFFA41C', "slot_py": None, "target": None, "cond": None},
    0x4419e: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFA41C, 1))', "slot_py": None, "target": None, "cond": None},
    0x441a0: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x441a2: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x441a4: {"kind": "branch", "py": None, "slot_py": '', "target": 0x441b4, "cond": 'notT'},
    0x441a8: {"kind": 'reg', "py": 'r[3] = 0x000003E8', "slot_py": None, "target": None, "cond": None},
    0x441aa: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x441ac: {"kind": 'reg', "py": 'r[0] = 0xFFFFCA83', "slot_py": None, "target": None, "cond": None},
    0x441ae: {"kind": 'reg', "py": 'r[2] = 0xFFFFCA80', "slot_py": None, "target": None, "cond": None},
    0x441b0: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCA80, 2, r[3])', "slot_py": None, "target": None, "cond": None},
    0x441b2: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCA83, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x441b4: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
