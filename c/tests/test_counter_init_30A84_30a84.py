#!/usr/bin/env python3
"""Differential test for counter_init_30A84 (0x30A84) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_counter_init_30A84_30a84.py
"""
...
ENTRY = 0x30A84
RAW = bytes.fromhex("D1 36 D0 37 00 0B 20 11")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    0x30a84: {"kind": 'reg', "py": 'r[1] = 0x0000FFFF', "slot_py": None, "target": None, "cond": None},
    0x30a86: {"kind": 'reg', "py": 'r[0] = 0xFFFFBE48', "slot_py": None, "target": None, "cond": None},
    0x30a88: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBE48, 2, r[1])', "target": None, "cond": None},}
