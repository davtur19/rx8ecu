#!/usr/bin/env python3
"""Differential test for boost_pres_read_store_2DD64 (0x2DD64) — v3 lift + v4 FPU, 10 bytes.
...
Run from repo root: python3 c/tests/test_boost_pres_read_store_2DD64_2dd64.py
"""
...
RAM_MAX = 0xFFFFC008
SPAN_END = 0x2DD6E
SENT = 0x2DD6E     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x2dd64: {"kind": 'reg', "py": 'r[3] = 0xFFFFC008', "slot_py": None, "target": None, "cond": None},
    0x2dd66: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFC008, 4))', "slot_py": None, "target": None, "cond": None},
    0x2dd68: {"kind": 'reg', "py": 'r[2] = 0xFFFFBD40', "slot_py": None, "target": None, "cond": None},
    0x2dd6a: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBD40, 4, f2bits(fr[3]))', "target": None, "cond": None},}
