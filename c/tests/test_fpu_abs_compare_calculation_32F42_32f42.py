#!/usr/bin/env python3
"""Differential test for fpu_abs_compare_calculation_32F42 (0x32F42) — v3 lift (branches + delay slots), 72 bytes.
...
Run from repo root: python3 c/tests/test_fpu_abs_compare_calculation_32F42_32f42.py
"""
...
ENTRY = 0x32F42
RAW = bytes.fromhex("70 FF 60 0B 88 01 8F 02 00 09 A0 17 E4 00 60 43 60 00 C8 20 00 29 70 FF 60 0B 88 01 8F 02 00 09 A0 0C E4 01 60 43 60 00 C8 80 00 29 70 FF 60 0B 88 01 8F 02 00 09 A0 01 E4 02 E4 03 64 4C D3 1D 44 08 44 08 00 0B 23 40")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFC008
SPAN_END = 0x32F8A
SENT = 0x32F8A     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x32f42: {"kind": 'reg', "py": 'r[0] = (r[0] + s8(0xFF)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x32f44: {"kind": 'reg', "py": 'r[0] = (-r[0]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x32f46: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x32f48: {"kind": "branch", "py": None, "slot_py": '', "target": 0x32f50, "cond": 'notT'},
    0x32f4c: {"kind": "branch", "py": None, "slot_py": 'r[4] = s8(0x00)', "target": 0x32f7e, "cond": 'always'},
    0x32f50: {"kind": 'reg', "py": 'r[0] = r[4]', "slot_py": None, "target": None, "cond": None},
    0x32f52: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0x00000000, 1))', "slot_py": None, "target": None, "cond": None},
    0x32f54: {"kind": 'reg', "py": 'T = 1 if (r[0] & 0x20) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x32f56: {"kind": 'reg', "py": 'r[0] = T;', "slot_py": None, "target": None, "cond": None},
    0x32f58: {"kind": 'reg', "py": 'r[0] = (r[0] + s8(0xFF)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x32f5a: {"kind": 'reg', "py": 'r[0] = (-r[0]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x32f5c: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x32f5e: {"kind": "branch", "py": None, "slot_py": '', "target": 0x32f66, "cond": 'notT'},
    0x32f62: {"kind": "branch", "py": None, "slot_py": 'r[4] = s8(0x01)', "target": 0x32f7e, "cond": 'always'},
    0x32f66: {"kind": 'reg', "py": 'r[0] = r[4]', "slot_py": None, "target": None, "cond": None},
    0x32f68: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0x00000001, 1))', "slot_py": None, "target": None, "cond": None},
    0x32f6a: {"kind": 'reg', "py": 'T = 1 if (r[0] & 0x80) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x32f6c: {"kind": 'reg', "py": 'r[0] = T;', "slot_py": None, "target": None, "cond": None},
    0x32f6e: {"kind": 'reg', "py": 'r[0] = (r[0] + s8(0xFF)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x32f70: {"kind": 'reg', "py": 'r[0] = (-r[0]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x32f72: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x32f74: {"kind": "branch", "py": None, "slot_py": '', "target": 0x32f7c, "cond": 'notT'},
    0x32f78: {"kind": "branch", "py": None, "slot_py": 'r[4] = s8(0x02)', "target": 0x32f7e, "cond": 'always'},
    0x32f7c: {"kind": 'reg', "py": 'r[4] = s8(0x03)', "slot_py": None, "target": None, "cond": None},
    0x32f7e: {"kind": 'reg', "py": 'r[4] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x32f80: {"kind": 'reg', "py": 'r[3] = 0xFFFFC008', "slot_py": None, "target": None, "cond": None},
    0x32f82: {"kind": 'reg', "py": 'r[4] = (r[4] << 2) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x32f84: {"kind": 'reg', "py": 'r[4] = (r[4] << 2) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x32f86: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFC008, 1, r[4])', "target": None, "cond": None},}
