#!/usr/bin/env python3
"""Differential test for obd_event_counter_47502 (0x47502) — v3 lift (branches + delay slots), 14 bytes.
...
Run from repo root: python3 c/tests/test_obd_event_counter_47502_47502.py
"""
...
ENTRY = 0x47502
RAW = bytes.fromhex("00 09 92 2C 22 D0 4F 26 6D F6 00 0B 6E F6")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
CODE = {
    0x47502: {"kind": 'reg', "py": None, "slot_py": None, "target": None, "cond": None},
