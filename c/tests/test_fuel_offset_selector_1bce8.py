#!/usr/bin/env python3
"""Differential test for fuel_offset_selector (0x1BCE8) — v3 lift + v4 FPU, 28 bytes.
...
Run from repo root: python3 c/tests/test_fuel_offset_selector_1bce8.py
"""
...
ENTRY = 0x1BCE8
RAW = bytes.fromhex("94 0D 93 0D 60 30 60 0C 88 01 8F 03 00 09 D2 08 A0 02 F3 28 D1 07 F3 18 00 0B F4 3A")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFC647
SPAN_END = 0x1BD04
SENT = 0x1BD20     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x1bce8: {"kind": 'reg', "py": 'r[4] = 0xFFFFAD8C', "slot_py": None, "target": None, "cond": None},
    0x1bcea: {"kind": 'reg', "py": 'r[3] = 0xFFFFC647', "slot_py": None, "target": None, "cond": None},
    0x1bcec: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFC647, 1))', "slot_py": None, "target": None, "cond": None},
    0x1bcee: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x1bcf0: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x1bcf2: {"kind": "branch", "py": None, "slot_py": '', "target": 0x1bcfc, "cond": 'notT'},
    0x1bcf6: {"kind": 'reg', "py": 'r[2] = 0x0007A9B8', "slot_py": None, "target": None, "cond": None},
    0x1bcf8: {"kind": "branch", "py": None, "slot_py": 'fr[3] = bits2f(_rdw(ram, 0x0007A9B8, 4))', "target": 0x1bd00, "cond": 'always'},
    0x1bcfc: {"kind": 'reg', "py": 'r[1] = 0xFFFFA3DC', "slot_py": None, "target": None, "cond": None},
    0x1bcfe: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFA3DC, 4))', "slot_py": None, "target": None, "cond": None},
    0x1bd00: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, r[4], 4, f2bits(fr[3]))', "target": None, "cond": None},}
