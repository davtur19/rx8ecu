#!/usr/bin/env python3
"""Differential test for can_231_buf_clear_bc96 (0x2CDC8) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_can_231_buf_clear_bc96_2cdc8.py
"""
...
ENTRY = 0x2CDC8
RAW = bytes.fromhex("D1 0A E3 00 00 0B 21 30")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBC96
SPAN_END = 0x2CDD0
SENT = 0x2CDD0     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x2cdc8: {"kind": 'reg', "py": 'r[1] = 0xFFFFBC96', "slot_py": None, "target": None, "cond": None},
    0x2cdca: {"kind": 'reg', "py": 'r[3] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x2cdcc: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBC96, 1, r[3])', "target": None, "cond": None},}
