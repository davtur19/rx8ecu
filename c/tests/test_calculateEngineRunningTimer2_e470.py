#!/usr/bin/env python3
"""Differential test for calculateEngineRunningTimer2 (0xE470) — v3 lift + v4 FPU, 34 bytes.
...
Run from repo root: python3 c/tests/test_calculateEngineRunningTimer2_e470.py
"""
...
ENTRY = 0xE470
RAW = bytes.fromhex("C7 19 D3 1A F4 38 F4 15 8D 03 F5 08 C7 18 A0 02 F3 08 C7 18 F3 08 F3 41 F0 6C F5 3E F4 5A 00 0B 00 09")
SEED = 43
N = 2000
MAXSTEPS = 100000
