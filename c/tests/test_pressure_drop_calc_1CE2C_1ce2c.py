#!/usr/bin/env python3
"""Differential test for pressure_drop_calc_1CE2C (0x1CE2C) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_pressure_drop_calc_1CE2C_1ce2c.py
"""
...
RAM_MAX = None
SPAN_END = 0x1CE34
SENT = 0x1CE34     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x1ce2c: {"kind": 'mem', "py": 'r[12] = _rdw(ram, STACK_BASE + 0x400, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x1ce2e: {"kind": 'mem', "py": 'r[13] = _rdw(ram, STACK_BASE + 0x404, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x1ce30: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, STACK_BASE + 0x408, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},}
