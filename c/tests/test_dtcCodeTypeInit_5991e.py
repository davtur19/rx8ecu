#!/usr/bin/env python3
"""Differential test for dtcCodeTypeInit (0x5991E) — v3 lift (branches + delay slots), 12 bytes.
...
Run from repo root: python3 c/tests/test_dtcCodeTypeInit_5991e.py
"""
...
ENTRY = 0x5991E
RAW = bytes.fromhex("E4 00 D3 15 23 40 D2 15 00 0B 22 41")
SEED = 0
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFD0FA
SPAN_END = 0x5992A
SENT = 0x5992A     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x5991e: {"kind": 'reg', "py": 'r[4] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x59920: {"kind": 'reg', "py": 'r[3] = 0xFFFFD0F8', "slot_py": None, "target": None, "cond": None},
    0x59922: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD0F8, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x59924: {"kind": 'reg', "py": 'r[2] = 0xFFFFD0FA', "slot_py": None, "target": None, "cond": None},
    0x59926: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFD0FA, 2, r[4])', "target": None, "cond": None},}
