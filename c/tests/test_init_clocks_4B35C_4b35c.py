#!/usr/bin/env python3
"""Differential test for init_clocks_4B35C (0x4B35C) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_init_clocks_4B35C_4b35c.py
"""
...
CODE = {
    0x4b35c: {"kind": 'reg', "py": 'r[2] = 0xFFFFCE12', "slot_py": None, "target": None, "cond": None},
    0x4b35e: {"kind": 'reg', "py": 'r[3] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x4b360: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFCE12, 1, r[3])', "target": None, "cond": None},}
