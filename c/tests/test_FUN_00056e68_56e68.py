#!/usr/bin/env python3
"""Differential test for FUN_00056e68 (0x56E68) — v3 lift (branches + delay slots), 18 bytes.
...
Run from repo root: python3 c/tests/test_FUN_00056e68_56e68.py
"""
...
ENTRY = 0x56E68
RAW = bytes.fromhex("92 3D 63 20 D1 29 21 30 93 3A 60 30 D2 28 00 0B 22 00")
SEED = 42
N = 500
MAXSTEPS = 100000
