#!/usr/bin/env python3
"""Differential test for diag_fault_cond_eval_9088 (0x56ABC) — v3 lift (branches + delay slots), 16 bytes.
...
Run from repo root: python3 c/tests/test_diag_fault_cond_eval_9088_56abc.py
"""
...
ENTRY = 0x56ABC
RAW = bytes.fromhex("00 0B 6E F6 D2 27 63 20 D1 27 24 30 63 10 74 01")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    0x56abc: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, STACK_BASE + 0x400, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},
    0x56ac0: {"kind": 'reg', "py": 'r[2] = 0xFFFFD211', "slot_py": None, "target": None, "cond": None},
    0x56ac2: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFD211, 1))', "slot_py": None, "target": None, "cond": None},
    0x56ac4: {"kind": 'reg', "py": 'r[1] = 0xFFFFD212', "slot_py": None, "target": None, "cond": None},
    0x56ac6: {"kind": 'mem', "py": '_wrw(ram, r[4], 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x56ac8: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFD212, 1))', "slot_py": None, "target": None, "cond": None},
    0x56aca: {"kind": 'reg', "py": 'r[4] = (r[4] + s8(0x01)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},}
