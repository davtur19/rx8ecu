#!/usr/bin/env python3
"""Differential test for fault_counter_cfb8_countdown (0x52146) — v3 lift (branches + delay slots), 52 bytes.
...
Run from repo root: python3 c/tests/test_fault_counter_cfb8_countdown_52146.py
"""
...
ENTRY = 0x52146
RAW = bytes.fromhex("95 3B 93 3B 60 30 60 0C 88 01 8D 05 00 09 92 36 61 20 21 18 8F 04 00 09 D0 1B 63 00 A0 08 25 30 64 50 63 4C 43 15 8F 03 00 09 93 29 34 3C 25 40 00 0B 00 09")
SEED = 43
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCFBA
SPAN_END = 0x5217A
SENT = 0x5217A     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x52146: {"kind": 'reg', "py": 'r[5] = 0xFFFFCFB8', "slot_py": None, "target": None, "cond": None},
    0x52148: {"kind": 'reg', "py": 'r[3] = 0xFFFFA42C', "slot_py": None, "target": None, "cond": None},
    0x5214a: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFA42C, 1))', "slot_py": None, "target": None, "cond": None},
    0x5214c: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x5214e: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x52150: {"kind": "branch", "py": None, "slot_py": '', "target": 0x5215e, "cond": 'T'},
    0x52154: {"kind": 'reg', "py": 'r[2] = 0xFFFFCFBA', "slot_py": None, "target": None, "cond": None},
    0x52156: {"kind": 'mem', "py": 'r[1] = s8(_rdw(ram, 0xFFFFCFBA, 1))', "slot_py": None, "target": None, "cond": None},
    0x52158: {"kind": 'reg', "py": 'T = 1 if (r[1] & r[1]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x5215a: {"kind": "branch", "py": None, "slot_py": '', "target": 0x52166, "cond": 'notT'},
    0x5215e: {"kind": 'reg', "py": 'r[0] = 0x0007C230', "slot_py": None, "target": None, "cond": None},
    0x52160: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0x0007C230, 1))', "slot_py": None, "target": None, "cond": None},
    0x52162: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFCFB8, 1, r[3])', "target": 0x52176, "cond": 'always'},
    0x52166: {"kind": 'mem', "py": 'r[4] = s8(_rdw(ram, r[5], 1))', "slot_py": None, "target": None, "cond": None},
    0x52168: {"kind": 'reg', "py": 'r[3] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x5216a: {"kind": 'reg', "py": 'T = 1 if s32(r[3]) > 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x5216c: {"kind": "branch", "py": None, "slot_py": '', "target": 0x52176, "cond": 'notT'},
    0x52170: {"kind": 'reg', "py": 'r[3] = 0x000000FF', "slot_py": None, "target": None, "cond": None},
    0x52172: {"kind": 'reg', "py": 'r[4] = (r[4] + r[3]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x52174: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCFB8, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x52176: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
