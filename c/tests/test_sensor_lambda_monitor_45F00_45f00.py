#!/usr/bin/env python3
"""Differential test for sensor_lambda_monitor_45F00 (0x45F00) — v3 lift (branches + delay slots), 18 bytes.
...
Run from repo root: python3 c/tests/test_sensor_lambda_monitor_45F00_45f00.py
"""
...
CODE = {
    0x45f00: {"kind": 'reg', "py": 'r[3] = 0xFFFFF74E', "slot_py": None, "target": None, "cond": None},
    0x45f02: {"kind": 'mem', "py": 'r[2] = s16(_rdw(ram, 0xFFFFF74E, 2))', "slot_py": None, "target": None, "cond": None},
    0x45f04: {"kind": 'reg', "py": 'r[2] = r[2] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x45f06: {"kind": 'reg', "py": 'r[1] = 0x00008000', "slot_py": None, "target": None, "cond": None},
    0x45f08: {"kind": 'reg', "py": 'T = 1 if (r[2] & r[1]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x45f0a: {"kind": 'reg', "py": 'r[3] = T;', "slot_py": None, "target": None, "cond": None},
    0x45f0c: {"kind": 'reg', "py": 'r[1] = 0xFFFFCC11', "slot_py": None, "target": None, "cond": None},
    0x45f0e: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFCC11, 1, r[3])', "target": None, "cond": None},}
