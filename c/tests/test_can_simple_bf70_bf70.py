#!/usr/bin/env python3
"""Differential test for can_simple_bf70 (0xBF70) — v3 lift (branches + delay slots), 28 bytes.
...
Run from repo root: python3 c/tests/test_can_simple_bf70_bf70.py
"""
...
CODE = {
    0xbf70: {"kind": 'reg', "py": 'r[3] = 0x00000080', "slot_py": None, "target": None, "cond": None},
    0xbf72: {"kind": 'reg', "py": 'r[2] = 0xFFFFF020', "slot_py": None, "target": None, "cond": None},
    0xbf74: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFF020, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0xbf76: {"kind": 'reg', "py": 'r[4] = 0xFFFFF022', "slot_py": None, "target": None, "cond": None},
    0xbf78: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFF022, 1))', "slot_py": None, "target": None, "cond": None},
    0xbf7a: {"kind": 'reg', "py": 'r[0] = (r[0] & 0xFC) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xbf7c: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFF022, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0xbf7e: {"kind": 'reg', "py": 'r[3] = (r[3] + s8(0x78)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xbf80: {"kind": 'reg', "py": 'r[1] = 0xFFFFF026', "slot_py": None, "target": None, "cond": None},
    0xbf82: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFF026, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0xbf84: {"kind": 'reg', "py": 'r[3] = 0xFFFFF021', "slot_py": None, "target": None, "cond": None},
    0xbf86: {"kind": 'reg', "py": 'r[0] = s8(0x06)', "slot_py": None, "target": None, "cond": None},
    0xbf88: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFF021, 1, r[0])', "target": None, "cond": None},}
