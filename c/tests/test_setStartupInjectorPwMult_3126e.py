#!/usr/bin/env python3
"""Differential test for setStartupInjectorPwMult (0x3126E) — v3 lift + v4 FPU, 36 bytes.
...
Run from repo root: python3 c/tests/test_setStartupInjectorPwMult_3126e.py
"""
...
RAM_MAX = 0xFFFFC600
SPAN_END = 0x31292
SENT = 0x31292     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x3126e: {"kind": 'reg', "py": 'r[2] = 0xFFFFA428', "slot_py": None, "target": None, "cond": None},
    0x31270: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFA428, 1))', "slot_py": None, "target": None, "cond": None},
    0x31272: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x31274: {"kind": "branch", "py": None, "slot_py": '', "target": 0x3128e, "cond": 'notT'},
    0x31278: {"kind": 'reg', "py": 'r[4] = 0xFFFFBEEC', "slot_py": None, "target": None, "cond": None},
    0x3127a: {"kind": 'reg', "py": 'r[1] = 0xFFFFC600', "slot_py": None, "target": None, "cond": None},
    0x3127c: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFC600, 1))', "slot_py": None, "target": None, "cond": None},
    0x3127e: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x31280: {"kind": "branch", "py": None, "slot_py": '', "target": 0x3128a, "cond": 'notT'},
    0x31284: {"kind": 'reg', "py": 'r[0] = 0x00078268', "slot_py": None, "target": None, "cond": None},
    0x31286: {"kind": "branch", "py": None, "slot_py": 'fr[3] = bits2f(_rdw(ram, 0x00078268, 4))', "target": 0x3128c, "cond": 'always'},
    0x3128a: {"kind": 'fpu', "py": 'fr[3] = 1.0', "slot_py": None, "target": None, "cond": None},
    0x3128c: {"kind": 'fpu', "py": '_wrw(ram, r[4], 4, f2bits(fr[3]))', "slot_py": None, "target": None, "cond": None},
    0x3128e: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
