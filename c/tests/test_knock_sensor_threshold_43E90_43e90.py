#!/usr/bin/env python3
"""Differential test for knock_sensor_threshold_43E90 (0x43E90) — v3 lift + v4 FPU, 40 bytes.
...
Run from repo root: python3 c/tests/test_knock_sensor_threshold_43E90_43e90.py
"""
...
ENTRY = 0x43E90
RAW = bytes.fromhex("92 13 63 20 23 38 8F 0D 00 09 94 14 D3 11 F3 38 91 0A F2 18 F2 35 8D 03 00 09 E0 01 A0 02 24 00 E1 02 24 10 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCAAF
SPAN_END = 0x43EB8
SENT = 0x43EE8     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x43e90: {"kind": 'reg', "py": 'r[2] = 0xFFFFCAAF', "slot_py": None, "target": None, "cond": None},
    0x43e92: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFCAAF, 1))', "slot_py": None, "target": None, "cond": None},
    0x43e94: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x43e96: {"kind": "branch", "py": None, "slot_py": '', "target": 0x43eb4, "cond": 'notT'},
    0x43e9a: {"kind": 'reg', "py": 'r[4] = 0xFFFFCAAE', "slot_py": None, "target": None, "cond": None},
    0x43e9c: {"kind": 'reg', "py": 'r[3] = 0x0007B404', "slot_py": None, "target": None, "cond": None},
    0x43e9e: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x0007B404, 4))', "slot_py": None, "target": None, "cond": None},
    0x43ea0: {"kind": 'reg', "py": 'r[1] = 0xFFFFB5B8', "slot_py": None, "target": None, "cond": None},
    0x43ea2: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0xFFFFB5B8, 4))', "slot_py": None, "target": None, "cond": None},
    0x43ea4: {"kind": 'fpu', "py": 'T = 1 if fr[2] > fr[3] else 0', "slot_py": None, "target": None, "cond": None},
    0x43ea6: {"kind": "branch", "py": None, "slot_py": '', "target": 0x43eb0, "cond": 'T'},
    0x43eaa: {"kind": 'reg', "py": 'r[0] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x43eac: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFCAAE, 1, r[0])', "target": 0x43eb4, "cond": 'always'},
    0x43eb0: {"kind": 'reg', "py": 'r[1] = s8(0x02)', "slot_py": None, "target": None, "cond": None},
    0x43eb2: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCAAE, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x43eb4: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
