#!/usr/bin/env python3
"""Differential test for can_get_tx_acknowledge_flags (0xD112) — v3 lift (branches + delay slots), 50 bytes.
...
Run from repo root: python3 c/tests/test_can_get_tx_acknowledge_flags_d112.py
"""
...
ENTRY = 0xD112
RAW = bytes.fromhex("64 4C 24 48 8F 05 00 09 93 2E 64 31 91 30 A0 04 64 47 93 2A 64 31 64 47 91 2B 62 11 24 29 D2 18 65 4D 63 5C 43 18 22 59 42 19 64 33 24 2B 00 0B 60 43")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    ...
    0xd12c: {"kind": 'mem', "py": 'r[2] = s16(_rdw(ram, 0xFFFFE60A, 2))', "slot_py": None, "target": None, "cond": None},
