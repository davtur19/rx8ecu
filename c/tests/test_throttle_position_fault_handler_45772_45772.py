#!/usr/bin/env python3
"""Differential test for throttle_position_fault_handler_45772 (0x45772) — v3 lift + v4 FPU, 48 bytes.
...
Run from repo root: python3 c/tests/test_throttle_position_fault_handler_45772_45772.py
"""
...
RAM_MAX = 0xFFFFCFCC
SPAN_END = 0x457A2
SENT = 0x457A2     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x45772: {"kind": 'reg', "py": 'r[1] = 0xFFFFBB06', "slot_py": None, "target": None, "cond": None},
    0x45774: {"kind": 'reg', "py": 'r[2] = 0x000007D0', "slot_py": None, "target": None, "cond": None},
    0x45776: {"kind": 'mem', "py": 'r[3] = s16(_rdw(ram, 0xFFFFBB06, 2))', "slot_py": None, "target": None, "cond": None},
    0x45778: {"kind": 'reg', "py": 'r[3] = r[3] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x4577a: {"kind": 'reg', "py": 'T = 1 if r[3] == r[2] else 0', "slot_py": None, "target": None, "cond": None},
    0x4577c: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4579e, "cond": 'notT'},
    0x45780: {"kind": 'reg', "py": 'r[4] = 0xFFFFCBE2', "slot_py": None, "target": None, "cond": None},
    0x45782: {"kind": 'reg', "py": 'r[3] = 0x0007C248', "slot_py": None, "target": None, "cond": None},
    0x45784: {"kind": 'reg', "py": 'r[2] = 0xFFFFCFCC', "slot_py": None, "target": None, "cond": None},
    0x45786: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x0007C248, 4))', "slot_py": None, "target": None, "cond": None},
    0x45788: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0xFFFFCFCC, 4))', "slot_py": None, "target": None, "cond": None},
    0x4578a: {"kind": 'fpu', "py": 'T = 1 if fr[3] > fr[2] else 0', "slot_py": None, "target": None, "cond": None},
    0x4578c: {"kind": "branch", "py": None, "slot_py": '', "target": 0x45798, "cond": 'T'},
    0x45790: {"kind": 'reg', "py": 'r[1] = 0x0007C03C', "slot_py": None, "target": None, "cond": None},
    0x45792: {"kind": 'mem', "py": 'r[0] = s16(_rdw(ram, 0x0007C03C, 2))', "slot_py": None, "target": None, "cond": None},
    0x45794: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFCBE2, 2, r[0])', "target": 0x4579e, "cond": 'always'},
    0x45798: {"kind": 'reg', "py": 'r[1] = 0x0007C03E', "slot_py": None, "target": None, "cond": None},
    0x4579a: {"kind": 'mem', "py": 'r[2] = s16(_rdw(ram, 0x0007C03E, 2))', "slot_py": None, "target": None, "cond": None},
    0x4579c: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCBE2, 2, r[2])', "slot_py": None, "target": None, "cond": None},
    0x4579e: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
