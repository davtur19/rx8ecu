#!/usr/bin/env python3
"""Differential test for flag_or_latch_cdbc (0x4C7D4) — v3 lift (branches + delay slots), 40 bytes.
...
Run from repo root: python3 c/tests/test_flag_or_latch_cdbc_4c7d4.py
"""
...
ENTRY = 0x4C7D4
RAW = bytes.fromhex("94 49 93 43 60 30 60 0C 88 01 8D 06 00 09 92 40 60 20 60 0C 88 01 8F 03 00 09 E3 01 A0 02 24 30 E1 00 24 10 00 0B 00 09")
SEED = 43
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCDBE
SPAN_END = 0x4C7FC
SENT = 0x4C7FC     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x4c7d4: {"kind": 'reg', "py": 'r[4] = 0xFFFFCDBC', "slot_py": None, "target": None, "cond": None},
    0x4c7d6: {"kind": 'reg', "py": 'r[3] = 0xFFFFCDBD', "slot_py": None, "target": None, "cond": None},
    0x4c7d8: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCDBD, 1))', "slot_py": None, "target": None, "cond": None},
    0x4c7da: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x4c7dc: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x4c7de: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4c7ee, "cond": 'T'},
    0x4c7e2: {"kind": 'reg', "py": 'r[2] = 0xFFFFCDBE', "slot_py": None, "target": None, "cond": None},
    0x4c7e4: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCDBE, 1))', "slot_py": None, "target": None, "cond": None},
    0x4c7e6: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x4c7e8: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x4c7ea: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4c7f4, "cond": 'notT'},
    0x4c7ee: {"kind": 'reg', "py": 'r[3] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x4c7f0: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFCDBC, 1, r[3])', "target": 0x4c7f8, "cond": 'always'},
    0x4c7f4: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x4c7f6: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCDBC, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x4c7f8: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
