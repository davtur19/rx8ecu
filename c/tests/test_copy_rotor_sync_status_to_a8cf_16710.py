#!/usr/bin/env python3
"""Differential test for copy_rotor_sync_status_to_a8cf (0x16710) — v3 lift (branches + delay slots), 10 bytes.
...
Run from repo root: python3 c/tests/test_copy_rotor_sync_status_to_a8cf_16710.py
"""
