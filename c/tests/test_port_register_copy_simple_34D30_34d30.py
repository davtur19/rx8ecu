#!/usr/bin/env python3
"""Differential test for port_register_copy_simple_34D30 (0x34D30) — v3 lift (branches + delay slots), 10 bytes.
...
Run from repo root: python3 c/tests/test_port_register_copy_simple_34D30_34d30.py
"""
...
CODE = {
    0x34d30: {"kind": 'reg', "py": 'r[2] = 0x00079FD0', "slot_py": None, "target": None, "cond": None},
    0x34d32: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0x00079FD0, 1))', "slot_py": None, "target": None, "cond": None},
    0x34d34: {"kind": 'reg', "py": 'r[1] = 0xFFFFC13C', "slot_py": None, "target": None, "cond": None},
    0x34d36: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFC13C, 1, r[3])', "target": None, "cond": None},}
