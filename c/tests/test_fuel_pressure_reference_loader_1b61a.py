#!/usr/bin/env python3
"""Differential test for fuel_pressure_reference_loader (0x1B61A) — v3 lift + v4 FPU, 10 bytes.
...
Run from repo root: python3 c/tests/test_fuel_pressure_reference_loader_1b61a.py
"""
...
ENTRY = 0x1B61A
RAW = bytes.fromhex("D3 0D 92 02 F3 38 00 0B F2 3A")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFAAF4
SPAN_END = 0x1B624
SENT = 0x1B654     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x1b61a: {"kind": 'reg', "py": 'r[3] = 0xFFFFA1D0', "slot_py": None, "target": None, "cond": None},
    0x1b61c: {"kind": 'reg', "py": 'r[2] = 0xFFFFAAF4', "slot_py": None, "target": None, "cond": None},
    0x1b61e: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFA1D0, 4))', "slot_py": None, "target": None, "cond": None},
    0x1b620: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFAAF4, 4, f2bits(fr[3]))', "target": None, "cond": None},}
