#!/usr/bin/env python3
"""Differential test for sensor_voltage_check_43BC4 (0x43BC4) — v3 lift (branches + delay slots), 28 bytes.
...
Run from repo root: python3 c/tests/test_sensor_voltage_check_43BC4_43bc4.py
"""
...
RAM_MAX = 0xFFFFCA0C
SPAN_END = 0x43BE0
SENT = 0x43BE4     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x43bc4: {"kind": 'reg', "py": 'r[4] = 0xFFFFCA0C', "slot_py": None, "target": None, "cond": None},
    0x43bc6: {"kind": 'reg', "py": 'r[3] = 0xFFFFB5E8', "slot_py": None, "target": None, "cond": None},
    0x43bc8: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFB5E8, 1))', "slot_py": None, "target": None, "cond": None},
    0x43bca: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x43bcc: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x43bce: {"kind": "branch", "py": None, "slot_py": '', "target": 0x43bd8, "cond": 'notT'},
    0x43bd2: {"kind": 'reg', "py": 'r[1] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x43bd4: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFCA0C, 1, r[1])', "target": 0x43bdc, "cond": 'always'},
    0x43bd8: {"kind": 'reg', "py": 'r[0] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x43bda: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCA0C, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x43bdc: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
