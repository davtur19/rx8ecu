#!/usr/bin/env python3
"""Differential test for e2_shadow_c4b9_c4ba_init (0x386FA) — v3 lift (branches + delay slots), 16 bytes.
...
Run from repo root: python3 c/tests/test_e2_shadow_c4b9_c4ba_init_386fa.py
"""
...
ENTRY = 0x386FA
RAW = bytes.fromhex("E0 00 D2 23 63 20 D1 23 21 30 D3 23 00 0B 23 00")
SEED = 42
N = 500
MAXSTEPS = 100000
