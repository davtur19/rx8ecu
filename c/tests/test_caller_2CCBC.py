...
CODE = {
    ...
    0x2ccc0: {"kind": "call", "py": None, "slot_py": 'r[5] = s8(0x00)', "target": 0x3ee58, "ret_pc": 0x2ccc4, "set_pr": False, "cond": None},
