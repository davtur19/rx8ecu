#!/usr/bin/env python3
"""Differential test for rpm_limiter_calc_43E60 (0x43E60) — v3 lift + v4 FPU, 48 bytes.
...
Run from repo root: python3 c/tests/test_rpm_limiter_calc_43E60_43e60.py
"""
...
RAM_MAX = 0xFFFFC008
SPAN_END = 0x43E90
SENT = 0x43E90     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x43e60: {"kind": 'reg', "py": 'r[3] = 0xFFFFC008', "slot_py": None, "target": None, "cond": None},
    0x43e62: {"kind": 'fpu', "py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFC008, 4))', "slot_py": None, "target": None, "cond": None},
    0x43e64: {"kind": 'reg', "py": 'r[4] = 0xFFFFCAA0', "slot_py": None, "target": None, "cond": None},
    0x43e66: {"kind": 'reg', "py": 'r[0] = 0x00043ED8', "slot_py": None, "target": None, "cond": None},
    0x43e68: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x00043ED8, 4))', "slot_py": None, "target": None, "cond": None},
    0x43e6a: {"kind": 'fpu', "py": 'T = 1 if fr[3] > fr[4] else 0', "slot_py": None, "target": None, "cond": None},
    0x43e6c: {"kind": "branch", "py": None, "slot_py": '', "target": 0x43e78, "cond": 'T'},
    0x43e70: {"kind": 'reg', "py": 'r[0] = 0x00043EDC', "slot_py": None, "target": None, "cond": None},
    0x43e72: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0x00043EDC, 4))', "slot_py": None, "target": None, "cond": None},
    0x43e74: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, r[4], 4, f2bits(fr[2]))', "target": 0x43e8c, "cond": 'always'},
    0x43e78: {"kind": 'fpu', "py": 'fr[2] = 0.0', "slot_py": None, "target": None, "cond": None},
    0x43e7a: {"kind": 'fpu', "py": 'T = 1 if fr[4] > fr[2] else 0', "slot_py": None, "target": None, "cond": None},
    0x43e7c: {"kind": "branch", "py": None, "slot_py": '', "target": 0x43e88, "cond": 'notT'},
    0x43e80: {"kind": 'reg', "py": 'r[2] = 0x0007B3FC', "slot_py": None, "target": None, "cond": None},
    0x43e82: {"kind": 'fpu', "py": 'fr[1] = bits2f(_rdw(ram, 0x0007B3FC, 4))', "slot_py": None, "target": None, "cond": None},
    0x43e84: {"kind": "branch", "py": None, "slot_py": 'fr[1] = ts(fr[1] * fr[4])', "target": 0x43e8a, "cond": 'always'},
    0x43e88: {"kind": 'fpu', "py": 'fr[1] = 1.0', "slot_py": None, "target": None, "cond": None},
    0x43e8a: {"kind": 'fpu', "py": '_wrw(ram, r[4], 4, f2bits(fr[1]))', "slot_py": None, "target": None, "cond": None},
    0x43e8c: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
