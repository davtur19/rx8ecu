#!/usr/bin/env python3
"""Differential test for FUN_0002ba58 (0x2BA58) — v3 lift (branches + delay slots), 16 bytes.
...
Run from repo root: python3 c/tests/test_FUN_0002ba58_2ba58.py
"""
...
ENTRY = 0x2BA58
RAW = bytes.fromhex("D3 25 E4 1F D2 25 23 41 22 41 D1 25 00 0B 21 41")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBC20
SPAN_END = 0x2BA68
SENT = 0x2BA68     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x2ba58: {"kind": 'reg', "py": 'r[3] = 0xFFFFBC1C', "slot_py": None, "target": None, "cond": None},
    0x2ba5a: {"kind": 'reg', "py": 'r[4] = s8(0x1F)', "slot_py": None, "target": None, "cond": None},
    0x2ba5c: {"kind": 'reg', "py": 'r[2] = 0xFFFFBC1E', "slot_py": None, "target": None, "cond": None},
    0x2ba5e: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBC1C, 2, r[4])', "slot_py": None, "target": None, "cond": None},
    0x2ba60: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBC1E, 2, r[4])', "slot_py": None, "target": None, "cond": None},
    0x2ba62: {"kind": 'reg', "py": 'r[1] = 0xFFFFBC20', "slot_py": None, "target": None, "cond": None},
    0x2ba64: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBC20, 2, r[4])', "target": None, "cond": None},}
