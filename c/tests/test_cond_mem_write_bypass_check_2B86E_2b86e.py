#!/usr/bin/env python3
"""Differential test for cond_mem_write_bypass_check_2B86E (0x2B86E) — v3 lift (branches + delay slots), 28 bytes.
...
Run from repo root: python3 c/tests/test_cond_mem_write_bypass_check_2B86E_2b86e.py
"""
...
CODE = {
    0x2b86e: {"kind": 'reg', "py": 'r[4] = 0xFFFFBBCC', "slot_py": None, "target": None, "cond": None},
    0x2b870: {"kind": 'reg', "py": 'r[3] = 0xFFFFBE28', "slot_py": None, "target": None, "cond": None},
    0x2b872: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFBE28, 1))', "slot_py": None, "target": None, "cond": None},
    0x2b874: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x2b876: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x2b878: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2b882, "cond": 'notT'},
    0x2b87c: {"kind": 'reg', "py": 'r[1] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x2b87e: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFBBCC, 1, r[1])', "target": 0x2b886, "cond": 'always'},
    0x2b882: {"kind": 'reg', "py": 'r[0] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x2b884: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBBCC, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x2b886: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
