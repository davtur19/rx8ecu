#!/usr/bin/env python3
"""Differential test for calculateEngineLoadMax (0x341F4) — pure straight-line lift, 12 bytes.
...
Run from repo root: python3 c/tests/test_calculateEngineLoadMax_341f4.py
"""
...
ENTRY = 0x341F4
RAW = bytes.fromhex("00 07 96 94 00 07 96 90 00 07 96 A4")
SEED = 42
N = 2000
