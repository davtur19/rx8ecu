#!/usr/bin/env python3
"""Differential test for can_timeout_check_5C668 (0x5C668) — v3 lift (branches + delay slots), 24 bytes.
...
Run from repo root: python3 c/tests/test_can_timeout_check_5C668_5c668.py
"""
...
RAM_MAX = 0xFFFFD34A
SPAN_END = 0x5C680
SENT = 0x5C688     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x5c668: {"kind": 'reg', "py": 'r[2] = 0xFFFFD34A', "slot_py": None, "target": None, "cond": None},
    0x5c66a: {"kind": 'mem', "py": 'r[3] = s16(_rdw(ram, 0xFFFFD34A, 2))', "slot_py": None, "target": None, "cond": None},
    0x5c66c: {"kind": 'reg', "py": 'r[1] = 0x00000271', "slot_py": None, "target": None, "cond": None},
    0x5c66e: {"kind": 'reg', "py": 'r[3] = r[3] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x5c670: {"kind": 'reg', "py": 'T = 1 if s32(r[3]) >= s32(r[1]) else 0', "slot_py": None, "target": None, "cond": None},
    0x5c672: {"kind": "branch", "py": None, "slot_py": '', "target": 0x5c67a, "cond": 'notT'},
    0x5c676: {"kind": "branch", "py": None, "slot_py": 'r[4] = s8(0x00)', "target": 0x5c67c, "cond": 'always'},
    0x5c67a: {"kind": 'reg', "py": 'r[4] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x5c67c: {"kind": "ret", "py": None, "slot_py": 'r[0] = r[4]', "target": None, "cond": None},}
