#!/usr/bin/env python3
"""Differential test for ram_flags_a9c0_zero_init (0x18F6C) — v3 lift (branches + delay slots), 48 bytes.
...
Run from repo root: python3 c/tests/test_ram_flags_a9c0_zero_init_18f6c.py
"""
...
ENTRY = 0x18F6C
RAW = bytes.fromhex("93 53 E4 00 92 52 23 40 22 40 91 50 93 50 21 40 23 40 D2 29 D1 29 22 40 21 40 D3 29 D2 29 23 40 22 40 D1 29 D3 29 21 40 23 40 D2 29 00 0B 22 40")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFA9CC
SPAN_END = 0x18F9C
SENT = 0x18F9C     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x18f6c: {"kind": 'reg', "py": 'r[3] = 0xFFFFA9C1', "slot_py": None, "target": None, "cond": None},
    0x18f6e: {"kind": 'reg', "py": 'r[4] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x18f70: {"kind": 'reg', "py": 'r[2] = 0xFFFFA9C2', "slot_py": None, "target": None, "cond": None},
    0x18f72: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA9C1, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x18f74: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA9C2, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x18f76: {"kind": 'reg', "py": 'r[1] = 0xFFFFA9C3', "slot_py": None, "target": None, "cond": None},
    0x18f78: {"kind": 'reg', "py": 'r[3] = 0xFFFFA9C4', "slot_py": None, "target": None, "cond": None},
    0x18f7a: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA9C3, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x18f7c: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA9C4, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x18f7e: {"kind": 'reg', "py": 'r[2] = 0xFFFFA9CA', "slot_py": None, "target": None, "cond": None},
    0x18f80: {"kind": 'reg', "py": 'r[1] = 0xFFFFA9CB', "slot_py": None, "target": None, "cond": None},
    0x18f82: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA9CA, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x18f84: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA9CB, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x18f86: {"kind": 'reg', "py": 'r[3] = 0xFFFFA9CC', "slot_py": None, "target": None, "cond": None},
    0x18f88: {"kind": 'reg', "py": 'r[2] = 0xFFFFA9C8', "slot_py": None, "target": None, "cond": None},
    0x18f8a: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA9CC, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x18f8c: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA9C8, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x18f8e: {"kind": 'reg', "py": 'r[1] = 0xFFFFA9C7', "slot_py": None, "target": None, "cond": None},
    0x18f90: {"kind": 'reg', "py": 'r[3] = 0xFFFFA9C6', "slot_py": None, "target": None, "cond": None},
    0x18f92: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA9C7, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x18f94: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA9C6, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x18f96: {"kind": 'reg', "py": 'r[2] = 0xFFFFA9C9', "slot_py": None, "target": None, "cond": None},
    0x18f98: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFA9C9, 1, r[4])', "target": None, "cond": None},}
