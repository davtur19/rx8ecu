#!/usr/bin/env python3
"""Differential test for fault_flag_dispatch_2D994 (0x2D994) — v3 lift (branches + delay slots), 58 bytes.
...
Run from repo root: python3 c/tests/test_fault_flag_dispatch_2D994_2d994.py
"""
...
ENTRY = 0x2D994
RAW = bytes.fromhex("2F E6 66 4C 97 1D E3 04 9E 1A 36 33 8F 03 E5 00 2E 50 A0 10 27 50 E4 01 60 63 20 49 88 01 8F 02 E0 02 A0 01 2E 40 2E 50 20 69 88 02 8F 02 00 09 A0 01 27 40 27 50 00 0B 6E F6")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    0x2d994: {"kind": 'mem', "py": 'local[0x3FC] = r[14]\n_wrw(ram, STACK_BASE + 0x3FC, 4, r[14])\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x2d996: {"kind": 'reg', "py": 'r[6] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x2d998: {"kind": 'reg', "py": 'r[7] = 0xFFFFBCF3', "slot_py": None, "target": None, "cond": None},
    0x2d99a: {"kind": 'reg', "py": 'r[3] = s8(0x04)', "slot_py": None, "target": None, "cond": None},
    0x2d99c: {"kind": 'reg', "py": 'r[14] = 0xFFFFBCF2', "slot_py": None, "target": None, "cond": None},
    0x2d99e: {"kind": 'reg', "py": 'T = 1 if s32(r[6]) >= s32(r[3]) else 0', "slot_py": None, "target": None, "cond": None},
    0x2d9a0: {"kind": "branch", "py": None, "slot_py": 'r[5] = s8(0x00)', "target": 0x2d9aa, "cond": 'notT'},
    0x2d9a4: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBCF2, 1, r[5])', "slot_py": None, "target": None, "cond": None},
    0x2d9a6: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFBCF3, 1, r[5])', "target": 0x2d9ca, "cond": 'always'},
    0x2d9aa: {"kind": 'reg', "py": 'r[4] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x2d9ac: {"kind": 'reg', "py": 'r[0] = r[6]', "slot_py": None, "target": None, "cond": None},
    0x2d9ae: {"kind": 'reg', "py": 'r[0] = (r[0] & r[4]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x2d9b0: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x2d9b2: {"kind": "branch", "py": None, "slot_py": 'r[0] = s8(0x02)', "target": 0x2d9ba, "cond": 'notT'},
    0x2d9b6: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFBCF2, 1, r[4])', "target": 0x2d9bc, "cond": 'always'},
    0x2d9ba: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBCF2, 1, r[5])', "slot_py": None, "target": None, "cond": None},
    0x2d9bc: {"kind": 'reg', "py": 'r[0] = (r[0] & r[6]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x2d9be: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x02) else 0', "slot_py": None, "target": None, "cond": None},
    0x2d9c0: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2d9c8, "cond": 'notT'},
    0x2d9c4: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFBCF3, 1, r[4])', "target": 0x2d9ca, "cond": 'always'},
    0x2d9c8: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBCF3, 1, r[5])', "slot_py": None, "target": None, "cond": None},
    0x2d9ca: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, STACK_BASE + 0x3FC, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},}
