#!/usr/bin/env python3
"""Differential test for can430rx_unpack (0x33BCA) — v3 lift (branches + delay slots), 46 bytes.
...
Run from repo root: python3 c/tests/test_can430rx_unpack_33bca.py
"""
...
CODE = {
    0x33bca: {"kind": 'reg', "py": 'r[4] = 0xFFFFC060', "slot_py": None, "target": None, "cond": None},
    0x33bcc: {"kind": 'reg', "py": 'r[2] = 0xFFFFC06B', "slot_py": None, "target": None, "cond": None},
    0x33bce: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFC060, 1))', "slot_py": None, "target": None, "cond": None},
    0x33bd0: {"kind": 'reg', "py": 'r[1] = 0xFFFFC06C', "slot_py": None, "target": None, "cond": None},
    0x33bd2: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC06B, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x33bd4: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFC061, 1))', "slot_py": None, "target": None, "cond": None},
    0x33bd6: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC06C, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x33bd8: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFC062, 1))', "slot_py": None, "target": None, "cond": None},
    0x33bda: {"kind": 'reg', "py": 'r[3] = 0xFFFFC06D', "slot_py": None, "target": None, "cond": None},
    0x33bdc: {"kind": 'reg', "py": 'r[2] = 0xFFFFC06E', "slot_py": None, "target": None, "cond": None},
    0x33bde: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC06D, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x33be0: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFC063, 1))', "slot_py": None, "target": None, "cond": None},
    0x33be2: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC06E, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x33be4: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFC064, 1))', "slot_py": None, "target": None, "cond": None},
    0x33be6: {"kind": 'reg', "py": 'r[1] = 0xFFFFC06F', "slot_py": None, "target": None, "cond": None},
    0x33be8: {"kind": 'reg', "py": 'r[3] = 0xFFFFC070', "slot_py": None, "target": None, "cond": None},
    0x33bea: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC06F, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x33bec: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFC065, 1))', "slot_py": None, "target": None, "cond": None},
    0x33bee: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC070, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x33bf0: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFC066, 1))', "slot_py": None, "target": None, "cond": None},
    0x33bf2: {"kind": 'reg', "py": 'r[2] = 0xFFFFC071', "slot_py": None, "target": None, "cond": None},
    0x33bf4: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFC071, 1, r[0])', "target": None, "cond": None},}
