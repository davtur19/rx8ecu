#!/usr/bin/env python3
"""Differential test for FUN_00045b4e (0x45B4E) — mem lift (RAM-only, straight-line), 8 bytes.
...
Run from repo root: python3 c/tests/test_FUN_00045b4e_45b4e.py
"""
...
ENTRY = 0x45B4E
RAW = bytes.fromhex("00 09 93 65 60 30 60 0C")
SEED = 42
N = 2000
