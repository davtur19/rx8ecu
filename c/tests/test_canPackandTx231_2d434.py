#!/usr/bin/env python3
"""Differential test for canPackandTx231 (0x2D434) — v3 lift + v4 FPU, 12 bytes.
...
Run from repo root: python3 c/tests/test_canPackandTx231_2d434.py
"""
...
ENTRY = 0x2D434
RAW = bytes.fromhex("91 79 F2 18 92 78 F2 31 00 0B F2 2A")
SEED = 42
N = 500
MAXSTEPS = 100000
