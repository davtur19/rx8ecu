#!/usr/bin/env python3
"""Differential test for setInjectorStuffPrevLoop_ (0x30570) — v3 lift + v4 FPU, 22 bytes.
...
Run from repo root: python3 c/tests/test_setInjectorStuffPrevLoop__30570.py
"""
...
ENTRY = 0x30570
RAW = bytes.fromhex("D3 45 F3 38 92 7A F2 3A 91 79 64 10 93 78 23 40 92 77 00 0B 22 40")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBEC9
SPAN_END = 0x30586
SENT = 0x30586     # stop-sentinel, placed past the literal pool
...
CODE = {
    ...
    0x3057e: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBEC7, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x30580: {"kind": 'reg', "py": 'r[2] = 0xFFFFBEC9', "slot_py": None, "target": None, "cond": None},
    0x30582: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBEC9, 1, r[4])', "target": None, "cond": None},}
