#!/usr/bin/env python3
"""Differential test for FUN_0004d5a8 (0x4D5A8) — v3 lift + v4 FPU, 42 bytes.
...
Run from repo root: python3 c/tests/test_FUN_0004d5a8_4d5a8.py
"""
...
ENTRY = 0x4D5A8
RAW = bytes.fromhex("94 28 93 28 D2 15 F4 38 F5 28 F5 45 8D 03 00 09 E0 01 A0 08 24 00 D1 12 F3 18 F5 31 F5 45 8F 02 00 09 E0 00 24 00 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCE17
SPAN_END = 0x4D5D2
SENT = 0x4D5D2     # stop-sentinel, placed past the literal pool
