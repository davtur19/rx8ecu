#!/usr/bin/env python3
"""Differential test for task_create_4C2EC (0x4C2EC) — v3 lift (branches + delay slots), 30 bytes.
...
Run from repo root: python3 c/tests/test_task_create_4C2EC_4c2ec.py
"""
...
ENTRY = 0x4C2EC
RAW = bytes.fromhex("00 09 D2 14 61 20 A0 08 25 10 64 50 62 4C 42 15 8F 03 00 09 92 19 34 2C 25 40 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
CODE = {
    0x4c2ec: {"kind": 'reg', "py": None, "slot_py": None, "target": None, "cond": None},
    ...
    0x4c2f2: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, r[5], 1, r[1])', "target": 0x4c306, "cond": 'always'},
    0x4c2f6: {"kind": 'mem', "py": 'r[4] = s8(_rdw(ram, r[5], 1))', "slot_py": None, "target": None, "cond": None},
    ...
    0x4c304: {"kind": 'mem', "py": '_wrw(ram, r[5], 1, r[4])', "slot_py": None, "target": None, "cond": None},
