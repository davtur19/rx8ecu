#!/usr/bin/env python3
"""Differential test for FUN_00021a30 (0x21A30) — v3 lift (branches + delay slots), 52 bytes.
...
Run from repo root: python3 c/tests/test_FUN_00021a30_21a30.py
"""
...
ENTRY = 0x21A30
RAW = bytes.fromhex("30 22 8D 13 00 09 92 63 60 20 20 08 8F 0E 00 09 93 5F 60 30 60 0C 88 01 8F 08 00 09 92 5A 60 20 20 08 8F 03 00 09 E1 01 A0 02 24 10 E2 00 24 20 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    0x21a30: {"kind": 'reg', "py": 'T = 1 if r[0] >= r[2] else 0', "slot_py": None, "target": None, "cond": None},
    ...
    0x21a58: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, r[4], 1, r[1])', "target": 0x21a60, "cond": 'always'},
    0x21a5c: {"kind": 'reg', "py": 'r[2] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x21a5e: {"kind": 'mem', "py": '_wrw(ram, r[4], 1, r[2])', "slot_py": None, "target": None, "cond": None},
