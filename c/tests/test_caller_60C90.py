#!/usr/bin/env python3
"""Differential test for caller_60C90 (entry 0x60C90) — v8 ST caller (CFG), 16 bytes.
...
Run: python3 test_caller_60C90.py
"""
...
CODE = {
    0x60c90: {"kind": 'st', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x60c92: {"kind": 'reg', "py": 'r[3] = 0x00002430', "slot_py": None, "target": None, "cond": None},
    0x60c94: {"kind": "call", "py": None, "slot_py": '', "target": 0x2430, "ret_pc": 0x60c98, "set_pr": True, "cond": None},
    0x60c98: {"kind": 'reg', "py": 'r[2] = 0xFFFF87BC', "slot_py": None, "target": None, "cond": None},
    0x60c9a: {"kind": 'st', "py": 'pr = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x60c9c: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFF87BC, 4, r[0])', "target": None, "cond": None},
