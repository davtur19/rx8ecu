#!/usr/bin/env python3
"""Differential test for priority_task_alternate_init_2F51E (0x2F51E) — v3 lift + v4 FPU, 96 bytes.
...
Run from repo root: python3 c/tests/test_priority_task_alternate_init_2F51E_2f51e.py
"""
...
CODE = {
    ...
    0x2f522: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, r[7], 1, r[5])', "target": 0x2f530, "cond": 'always'},
    ...
    0x2f52e: {"kind": 'mem', "py": '_wrw(ram, r[7], 1, r[0])', "slot_py": None, "target": None, "cond": None},
    ...
    0x2f53c: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, r[7], 1))', "slot_py": None, "target": None, "cond": None},
    ...
    0x2f54c: {"kind": 'mem', "py": 'r[1] = s8(_rdw(ram, STACK_BASE + 0x400, 1))', "slot_py": None, "target": None, "cond": None},
