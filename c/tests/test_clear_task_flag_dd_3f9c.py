#!/usr/bin/env python3
"""Differential test for clear_task_flag_dd (0x3F9C) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_clear_task_flag_dd_3f9c.py
"""
...
ENTRY = 0x3F9C
RAW = bytes.fromhex("D2 01 E3 00 00 0B 22 30")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFF72DD
SPAN_END = 0x3FA4
SENT = 0x3FA8     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x3f9c: {"kind": 'reg', "py": 'r[2] = 0xFFFF72DD', "slot_py": None, "target": None, "cond": None},
    0x3f9e: {"kind": 'reg', "py": 'r[3] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x3fa0: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFF72DD, 1, r[3])', "target": None, "cond": None},}
