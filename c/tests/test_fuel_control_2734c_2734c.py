#!/usr/bin/env python3
"""Differential test for fuel_control_2734c (0x2734C) — v3 lift (branches + delay slots), 26 bytes.
...
Run from repo root: python3 c/tests/test_fuel_control_2734c_2734c.py
"""
...
ENTRY = 0x2734C
RAW = bytes.fromhex("93 66 E4 00 92 65 23 41 22 41 91 63 93 63 21 41 23 41 92 61 22 40 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
