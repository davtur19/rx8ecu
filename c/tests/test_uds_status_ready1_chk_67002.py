#!/usr/bin/env python3
"""Differential test for uds_status_ready1_chk (0x67002) — v3 lift (branches + delay slots), 26 bytes.
...
Run from repo root: python3 c/tests/test_uds_status_ready1_chk_67002.py
"""
...
ENTRY = 0x67002
RAW = bytes.fromhex("D3 72 65 30 66 5C 26 68 8D 04 E4 01 E1 04 21 68 8D 01 00 09 E4 00 00 0B 60 43")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFDC05
SPAN_END = 0x6701C
SENT = 0x6701C     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x67002: {"kind": 'reg', "py": 'r[3] = 0xFFFFDC05', "slot_py": None, "target": None, "cond": None},
    0x67004: {"kind": 'mem', "py": 'r[5] = s8(_rdw(ram, 0xFFFFDC05, 1))', "slot_py": None, "target": None, "cond": None},
    0x67006: {"kind": 'reg', "py": 'r[6] = r[5] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x67008: {"kind": 'reg', "py": 'T = 1 if (r[6] & r[6]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x6700a: {"kind": "branch", "py": None, "slot_py": 'r[4] = s8(0x01)', "target": 0x67016, "cond": 'T'},
    0x6700e: {"kind": 'reg', "py": 'r[1] = s8(0x04)', "slot_py": None, "target": None, "cond": None},
    0x67010: {"kind": 'reg', "py": 'T = 1 if (r[1] & r[6]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x67012: {"kind": "branch", "py": None, "slot_py": '', "target": 0x67018, "cond": 'T'},
    0x67016: {"kind": 'reg', "py": 'r[4] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x67018: {"kind": "ret", "py": None, "slot_py": 'r[0] = r[4]', "target": None, "cond": None},}
