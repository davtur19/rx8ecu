#!/usr/bin/env python3
"""Differential test for dtc_p0700_trans_4725E (0x4725E) — v3 lift (branches + delay slots), 48 bytes.
...
Run from repo root: python3 c/tests/test_dtc_p0700_trans_4725E_4725e.py
"""
...
ENTRY = 0x4725E
RAW = bytes.fromhex("97 2A 96 2A 93 27 65 30 65 5C 25 58 8F 03 E4 00 27 40 A0 0B 26 40 60 53 88 01 8F 04 00 09 27 40 E1 01 A0 03 26 10 E0 01 27 00 26 40 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCB73
SPAN_END = 0x4728E
SENT = 0x4728E     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x4725e: {"kind": 'reg', "py": 'r[7] = 0xFFFFCB72', "slot_py": None, "target": None, "cond": None},
    0x47260: {"kind": 'reg', "py": 'r[6] = 0xFFFFCB73', "slot_py": None, "target": None, "cond": None},
    0x47262: {"kind": 'reg', "py": 'r[3] = 0xFFFFCB62', "slot_py": None, "target": None, "cond": None},
    0x47264: {"kind": 'mem', "py": 'r[5] = s8(_rdw(ram, 0xFFFFCB62, 1))', "slot_py": None, "target": None, "cond": None},
    0x47266: {"kind": 'reg', "py": 'r[5] = r[5] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x47268: {"kind": 'reg', "py": 'T = 1 if (r[5] & r[5]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x4726a: {"kind": "branch", "py": None, "slot_py": 'r[4] = s8(0x00)', "target": 0x47274, "cond": 'notT'},
    0x4726e: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCB72, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x47270: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFCB73, 1, r[4])', "target": 0x4728a, "cond": 'always'},
    0x47274: {"kind": 'reg', "py": 'r[0] = r[5]', "slot_py": None, "target": None, "cond": None},
    0x47276: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x47278: {"kind": "branch", "py": None, "slot_py": '', "target": 0x47284, "cond": 'notT'},
    0x4727c: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCB72, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x4727e: {"kind": 'reg', "py": 'r[1] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x47280: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFCB73, 1, r[1])', "target": 0x4728a, "cond": 'always'},
    0x47284: {"kind": 'reg', "py": 'r[0] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x47286: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCB72, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x47288: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCB73, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x4728a: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
