#!/usr/bin/env python3
"""Differential test for obd_service_handler_69524 (0x69524) — pure straight-line lift, 12 bytes.
...
Run from repo root: python3 c/tests/test_obd_service_handler_69524_69524.py
"""
...
ENTRY = 0x69524
RAW = bytes.fromhex("97 3E E5 00 D0 24 E6 01 63 53 43 00")
SEED = 42
N = 2000
