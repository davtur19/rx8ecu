#!/usr/bin/env python3
"""Differential test for FUN_00057b64 (0x57B64) — v3 lift (branches + delay slots), 46 bytes.
...
Run from repo root: python3 c/tests/test_FUN_00057b64_57b64.py
"""
...
ENTRY = 0x57B64
RAW = bytes.fromhex("65 4C 60 53 88 02 8F 03 E6 01 92 7C A0 05 00 09 91 7A 35 10 8F 03 00 09 92 77 A0 06 22 60 60 53 88 0F 8F 02 00 09 93 71 23 60 00 0B 00 09")
SEED = 0
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFD06D
SPAN_END = 0x57B92
SENT = 0x57B92     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x57b64: {"kind": 'reg', "py": 'r[5] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x57b66: {"kind": 'reg', "py": 'r[0] = r[5]', "slot_py": None, "target": None, "cond": None},
    0x57b68: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x02) else 0', "slot_py": None, "target": None, "cond": None},
    0x57b6a: {"kind": "branch", "py": None, "slot_py": 'r[6] = s8(0x01)', "target": 0x57b74, "cond": 'notT'},
    0x57b6e: {"kind": 'reg', "py": 'r[2] = 0xFFFFD06B', "slot_py": None, "target": None, "cond": None},
    0x57b70: {"kind": "branch", "py": None, "slot_py": '', "target": 0x57b7e, "cond": 'always'},
    0x57b74: {"kind": 'reg', "py": 'r[1] = 0x00000082', "slot_py": None, "target": None, "cond": None},
    0x57b76: {"kind": 'reg', "py": 'T = 1 if r[5] == r[1] else 0', "slot_py": None, "target": None, "cond": None},
    0x57b78: {"kind": "branch", "py": None, "slot_py": '', "target": 0x57b82, "cond": 'notT'},
    0x57b7c: {"kind": 'reg', "py": 'r[2] = 0xFFFFD06C', "slot_py": None, "target": None, "cond": None},
    0x57b7e: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFD06C, 1, r[6])', "target": 0x57b8e, "cond": 'always'},
    0x57b82: {"kind": 'reg', "py": 'r[0] = r[5]', "slot_py": None, "target": None, "cond": None},
    0x57b84: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x0F) else 0', "slot_py": None, "target": None, "cond": None},
    0x57b86: {"kind": "branch", "py": None, "slot_py": '', "target": 0x57b8e, "cond": 'notT'},
    0x57b8a: {"kind": 'reg', "py": 'r[3] = 0xFFFFD06D', "slot_py": None, "target": None, "cond": None},
    0x57b8c: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD06D, 1, r[6])', "slot_py": None, "target": None, "cond": None},
    0x57b8e: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
