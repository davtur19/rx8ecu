#!/usr/bin/env python3
"""Differential test for caller_57DC0 (entry 0x57DC0) — v8 ST caller (CFG), 84 bytes.
...
Run: python3 test_caller_57DC0.py
"""
...
CODE = {
    0x57dc0: {"kind": 'mem', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, r[14])\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x57dc2: {"kind": 'reg', "py": 'r[14] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x57dc4: {"kind": 'reg', "py": 'r[3] = 0xFFFFD064', "slot_py": None, "target": None, "cond": None},
    0x57dc6: {"kind": 'st', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x57dc8: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD064, 1, r[14])', "slot_py": None, "target": None, "cond": None},
    0x57dca: {"kind": 'reg', "py": 'r[2] = 0xFFFFD065', "slot_py": None, "target": None, "cond": None},
    0x57dcc: {"kind": 'reg', "py": 'r[1] = 0xFFFFD066', "slot_py": None, "target": None, "cond": None},
    0x57dce: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD065, 1, r[14])', "slot_py": None, "target": None, "cond": None},
    0x57dd0: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD066, 1, r[14])', "slot_py": None, "target": None, "cond": None},
    0x57dd2: {"kind": 'reg', "py": 'r[3] = 0xFFFFD067', "slot_py": None, "target": None, "cond": None},
    0x57dd4: {"kind": 'reg', "py": 'r[2] = 0xFFFFD086', "slot_py": None, "target": None, "cond": None},
    0x57dd6: {"kind": 'mem', "py": '_wrw(ram, r[3], 1, r[14])', "slot_py": None, "target": None, "cond": None},
    0x57dd8: {"kind": 'mem', "py": '_wrw(ram, r[2], 1, r[14])', "slot_py": None, "target": None, "cond": None},
    0x57dda: {"kind": 'reg', "py": 'r[0] = 0x0007C274', "slot_py": None, "target": None, "cond": None},
    0x57ddc: {"kind": 'reg', "py": 'r[3] = 0xFFFFD091', "slot_py": None, "target": None, "cond": None},
    0x57dde: {"kind": 'mem', "py": 'r[1] = s8(_rdw(ram, 0x0007C274, 1))', "slot_py": None, "target": None, "cond": None},
    0x57de0: {"kind": 'reg', "py": 'r[2] = 0x00054146', "slot_py": None, "target": None, "cond": None},
    0x57de2: {"kind": "call", "py": None, "slot_py": '_wrw(ram, r[3], 1, r[1])', "target": 0x54146, "ret_pc": 0x57de6, "set_pr": True, "cond": None},
    0x57de6: {"kind": 'reg', "py": 'r[3] = 0xFFFFD092', "slot_py": None, "target": None, "cond": None},
    0x57de8: {"kind": 'reg', "py": 'r[2] = 0xFFFFD093', "slot_py": None, "target": None, "cond": None},
    0x57dea: {"kind": 'mem', "py": '_wrw(ram, r[3], 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x57dec: {"kind": 'mem', "py": '_wrw(ram, r[2], 1, r[14])', "slot_py": None, "target": None, "cond": None},
    0x57dee: {"kind": 'st', "py": 'pr = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x57df0: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},
