#!/usr/bin/env python3
"""Differential test for FUN_00029c24 (0x29C24) — v3 lift (branches + delay slots), 30 bytes.
...
Run from repo root: python3 c/tests/test_FUN_00029c24_29c24.py
"""
...
ENTRY = 0x29C24
RAW = bytes.fromhex("33 60 8D 03 00 09 E1 3E A0 07 25 11 64 51 61 4D 41 15 8F 02 00 09 34 6C 25 41 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    ...
    0x29c2c: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, r[5], 2, r[1])', "target": 0x29c3e, "cond": 'always'},
    0x29c30: {"kind": 'mem', "py": 'r[4] = s16(_rdw(ram, r[5], 2))', "slot_py": None, "target": None, "cond": None},
    ...
    0x29c3c: {"kind": 'mem', "py": '_wrw(ram, r[5], 2, r[4])', "slot_py": None, "target": None, "cond": None},
