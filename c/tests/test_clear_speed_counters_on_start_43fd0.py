#!/usr/bin/env python3
"""Differential test for clear_speed_counters_on_start (0x43FD0) — v3 lift (branches + delay slots), 46 bytes.
...
Run from repo root: python3 c/tests/test_clear_speed_counters_on_start_43fd0.py
"""
...
ENTRY = 0x43FD0
RAW = bytes.fromhex("93 61 60 30 60 0C 88 01 8F 0F 00 09 92 5C 60 20 60 0C 88 01 8F 09 00 09 93 57 E4 00 92 56 23 41 22 41 91 54 93 54 21 41 23 41 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCFD9
SPAN_END = 0x43FFE
SENT = 0x43FFE     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x43fd0: {"kind": 'reg', "py": 'r[3] = 0xFFFFCFD9', "slot_py": None, "target": None, "cond": None},
    0x43fd2: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCFD9, 1))', "slot_py": None, "target": None, "cond": None},
    0x43fd4: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x43fd6: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x43fd8: {"kind": "branch", "py": None, "slot_py": '', "target": 0x43ffa, "cond": 'notT'},
    0x43fdc: {"kind": 'reg', "py": 'r[2] = 0xFFFFA41C', "slot_py": None, "target": None, "cond": None},
    0x43fde: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFA41C, 1))', "slot_py": None, "target": None, "cond": None},
    0x43fe0: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x43fe2: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x43fe4: {"kind": "branch", "py": None, "slot_py": '', "target": 0x43ffa, "cond": 'notT'},
    0x43fe8: {"kind": 'reg', "py": 'r[3] = 0xFFFFCA74', "slot_py": None, "target": None, "cond": None},
    0x43fea: {"kind": 'reg', "py": 'r[4] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x43fec: {"kind": 'reg', "py": 'r[2] = 0xFFFFCA76', "slot_py": None, "target": None, "cond": None},
    0x43fee: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCA74, 2, r[4])', "slot_py": None, "target": None, "cond": None},
    0x43ff0: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCA76, 2, r[4])', "slot_py": None, "target": None, "cond": None},
    0x43ff2: {"kind": 'reg', "py": 'r[1] = 0xFFFFCA78', "slot_py": None, "target": None, "cond": None},
    0x43ff4: {"kind": 'reg', "py": 'r[3] = 0xFFFFCA7A', "slot_py": None, "target": None, "cond": None},
    0x43ff6: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCA78, 2, r[4])', "slot_py": None, "target": None, "cond": None},
    0x43ff8: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCA7A, 2, r[4])', "slot_py": None, "target": None, "cond": None},
    0x43ffa: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
