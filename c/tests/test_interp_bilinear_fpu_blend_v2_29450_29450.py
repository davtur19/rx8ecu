#!/usr/bin/env python3
"""Differential test for interp_bilinear_fpu_blend_v2_29450 (0x29450) — v3 lift (branches + delay slots), 20 bytes.
...
Run from repo root: python3 c/tests/test_interp_bilinear_fpu_blend_v2_29450_29450.py
"""
...
ENTRY = 0x29450
RAW = bytes.fromhex("00 02 7A 0A 00 02 7A 12 00 02 7A 26 92 6B E3 01 00 0B 22 30")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBAD8
SPAN_END = 0x29464
SENT = 0x29464     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x29450: {"kind": 'reg', "py": 'r[0] = sr', "slot_py": None, "target": None, "cond": None},
    0x29452: {"kind": 'reg', "py": 'r[10] = (r[10] + s8(0x0A)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x29454: {"kind": 'reg', "py": 'r[0] = sr', "slot_py": None, "target": None, "cond": None},
    0x29456: {"kind": 'reg', "py": 'r[10] = (r[10] + s8(0x12)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x29458: {"kind": 'reg', "py": 'r[0] = sr', "slot_py": None, "target": None, "cond": None},
    0x2945a: {"kind": 'reg', "py": 'r[10] = (r[10] + s8(0x26)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x2945c: {"kind": 'reg', "py": 'r[2] = 0xFFFFBAD8', "slot_py": None, "target": None, "cond": None},
    0x2945e: {"kind": 'reg', "py": 'r[3] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x29460: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBAD8, 1, r[3])', "target": None, "cond": None},}
