#!/usr/bin/env python3
"""Differential test for call-composition caller_479DE (entry 0x479DE) — v7 ST caller + callee lib, flattened CODE with nested returns.
...
Run: python3 /home/davide/ailocal/rx8ecu/c/tests/test_caller_479DE.py
"""
...
CODE = {
    0x479de: {"kind": 'reg', "py": 'r[4] = 0xFFFF8780', "slot_py": None, "target": None, "cond": None},
    0x479e0: {"kind": 'reg', "py": 'r[3] = 0x0003EE58', "slot_py": None, "target": None, "cond": None},
    0x479e2: {"kind": "call", "py": None, "slot_py": 'r[5] = s8(0x00)', "target": 0x3ee58, "ret_pc": 0x479e6, "set_pr": False, "cond": None},
