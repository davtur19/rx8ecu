#!/usr/bin/env python3
"""Differential test for FUN_0002a3dc (0x2A3DC) — v3 lift (branches + delay slots), 16 bytes.
...
Run from repo root: python3 c/tests/test_FUN_0002a3dc_2a3dc.py
"""
...
ENTRY = 0x2A3DC
RAW = bytes.fromhex("93 34 00 0B 23 40 91 32 D0 1C 62 10 00 0B 20 20")
SEED = 42
N = 500
MAXSTEPS = 100000
