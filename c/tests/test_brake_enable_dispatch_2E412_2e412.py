#!/usr/bin/env python3
"""Differential test for brake_enable_dispatch_2E412 (0x2E412) — v3 lift (branches + delay slots), 62 bytes.
...
Run from repo root: python3 c/tests/test_brake_enable_dispatch_2E412_2e412.py
"""
...
ENTRY = 0x2E412
RAW = bytes.fromhex("94 23 92 1C 63 20 23 38 8F 03 00 09 E0 00 A0 14 24 00 93 1B 60 30 60 0C 88 01 8D 0C 00 09 91 16 60 10 60 0C 88 01 8D 06 00 09 D2 0B 60 20 60 0C 88 01 8F 02 00 09 E2 01 24 20 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFC01D
SPAN_END = 0x2E450
SENT = 0x2E470     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x2e412: {"kind": 'reg', "py": 'r[4] = 0xFFFFBD59', "slot_py": None, "target": None, "cond": None},
    0x2e414: {"kind": 'reg', "py": 'r[2] = 0xFFFFBD58', "slot_py": None, "target": None, "cond": None},
    0x2e416: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFBD58, 1))', "slot_py": None, "target": None, "cond": None},
    0x2e418: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x2e41a: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2e424, "cond": 'notT'},
    0x2e41e: {"kind": 'reg', "py": 'r[0] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x2e420: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFBD59, 1, r[0])', "target": 0x2e44c, "cond": 'always'},
    0x2e424: {"kind": 'reg', "py": 'r[3] = 0xFFFFC01C', "slot_py": None, "target": None, "cond": None},
    0x2e426: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFC01C, 1))', "slot_py": None, "target": None, "cond": None},
    0x2e428: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x2e42a: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x2e42c: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2e448, "cond": 'T'},
    0x2e430: {"kind": 'reg', "py": 'r[1] = 0xFFFFC01D', "slot_py": None, "target": None, "cond": None},
    0x2e432: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFC01D, 1))', "slot_py": None, "target": None, "cond": None},
    0x2e434: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x2e436: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x2e438: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2e448, "cond": 'T'},
    0x2e43c: {"kind": 'reg', "py": 'r[2] = 0x00076B6E', "slot_py": None, "target": None, "cond": None},
    0x2e43e: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0x00076B6E, 1))', "slot_py": None, "target": None, "cond": None},
    0x2e440: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x2e442: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x2e444: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2e44c, "cond": 'notT'},
    0x2e448: {"kind": 'reg', "py": 'r[2] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x2e44a: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBD59, 1, r[2])', "slot_py": None, "target": None, "cond": None},
    0x2e44c: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
