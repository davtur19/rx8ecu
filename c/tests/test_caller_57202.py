#!/usr/bin/env python3
"""Differential test for caller_57202 (entry 0x57202) — v8 ST caller (CFG), 16 bytes.
...
Run: python3 test_caller_57202.py
"""
...
CODE = {
    0x57202: {"kind": 'st', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x57204: {"kind": 'reg', "py": 'r[3] = 0x00011F54', "slot_py": None, "target": None, "cond": None},
    0x57206: {"kind": "call", "py": None, "slot_py": '', "target": 0x11f54, "ret_pc": 0x5720a, "set_pr": True, "cond": None},
    0x5720a: {"kind": 'reg', "py": 'r[2] = 0xFFFFD052', "slot_py": None, "target": None, "cond": None},
    0x5720c: {"kind": 'st', "py": 'pr = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x5720e: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFD052, 1, r[0])', "target": None, "cond": None},
