#!/usr/bin/env python3
"""Differential test for isr_state_2d4e0 (0x2D4E0) — v3 lift (branches + delay slots), 24 bytes.
...
Run from repo root: python3 c/tests/test_isr_state_2d4e0_2d4e0.py
"""
...
ENTRY = 0x2D4E0
RAW = bytes.fromhex("93 6D E4 00 92 6C 23 40 22 40 91 6A 93 6A 21 40 23 40 92 68 00 0B 22 40")
SEED = 42
N = 500
MAXSTEPS = 100000
