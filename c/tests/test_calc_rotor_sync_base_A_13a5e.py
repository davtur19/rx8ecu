#!/usr/bin/env python3
"""Differential test for calc_rotor_sync_base_A (0x13A5E) — v3 lift (branches + delay slots), 40 bytes.
...
Run from repo root: python3 c/tests/test_calc_rotor_sync_base_A_13a5e.py
"""
...
CODE = {
    0x13a5e: {"kind": 'reg', "py": 'r[4] = 0xFFFFA749', "slot_py": None, "target": None, "cond": None},
    0x13a60: {"kind": 'reg', "py": 'r[3] = 0xFFFFCDA4', "slot_py": None, "target": None, "cond": None},
    0x13a62: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCDA4, 1))', "slot_py": None, "target": None, "cond": None},
    0x13a64: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x13a66: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x13a68: {"kind": "branch", "py": None, "slot_py": '', "target": 0x13a7e, "cond": 'notT'},
    0x13a6c: {"kind": 'reg', "py": 'r[2] = 0xFFFFCDA6', "slot_py": None, "target": None, "cond": None},
    0x13a6e: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCDA6, 1))', "slot_py": None, "target": None, "cond": None},
    0x13a70: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x13a72: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x13a74: {"kind": "branch", "py": None, "slot_py": '', "target": 0x13a7e, "cond": 'notT'},
    0x13a78: {"kind": 'reg', "py": 'r[3] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x13a7a: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFA749, 1, r[3])', "target": 0x13a82, "cond": 'always'},
    0x13a7e: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x13a80: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA749, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x13a82: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
