#!/usr/bin/env python3
"""Differential test for caller_1BDD4 (entry 0x1BDD4) — v8 ST caller (CFG), 28 bytes.
...
Run: python3 test_caller_1BDD4.py
"""
...
CODE = {
    0x1bdd4: {"kind": 'st', "py": 'local[0x3FC] = pr\n_wrw(ram, STACK_BASE + 0x3FC, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x1bdd6: {"kind": 'fpu', "py": 'fr[5] = 0.0', "slot_py": None, "target": None, "cond": None},
    0x1bdd8: {"kind": 'reg', "py": 'r[0] = 0x0001BE98', "slot_py": None, "target": None, "cond": None},
    0x1bdda: {"kind": 'fpu', "py": 'fr[4] = bits2f(_rdw(ram, 0x0001BE98, 4))', "slot_py": None, "target": None, "cond": None},
    0x1bddc: {"kind": 'reg', "py": 'r[3] = 0xFFFFAD94', "slot_py": None, "target": None, "cond": None},
    0x1bdde: {"kind": 'reg', "py": 'r[2] = 0x000024C0', "slot_py": None, "target": None, "cond": None},
    0x1bde0: {"kind": "call", "py": None, "slot_py": 'r[4] = s16(_rdw(ram, 0xFFFFAD94, 2))', "target": 0x24c0, "ret_pc": 0x1bde4, "set_pr": True, "cond": None},
    0x1bde4: {"kind": 'reg', "py": 'r[1] = 0xFFFFADA0', "slot_py": None, "target": None, "cond": None},
    0x1bde6: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFADA0, 4, f2bits(fr[0]))', "slot_py": None, "target": None, "cond": None},
    0x1bde8: {"kind": 'reg', "py": 'r[3] = 0xFFFFAD98', "slot_py": None, "target": None, "cond": None},
    0x1bdea: {"kind": 'st', "py": 'pr = _rdw(ram, STACK_BASE + 0x3FC, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x1bdec: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFAD98, 4, f2bits(fr[0]))', "target": None, "cond": None},
