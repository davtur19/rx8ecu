#!/usr/bin/env python3
"""Differential test for diag_set_flag_byte_d086 (0x57B5C) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_diag_set_flag_byte_d086_57b5c.py
"""
...
ENTRY = 0x57B5C
RAW = bytes.fromhex("D0 47 E1 01 00 0B 20 10")
SEED = 43
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFD086
SPAN_END = 0x57B64
SENT = 0x57B64     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x57b5c: {"kind": 'reg', "py": 'r[0] = 0xFFFFD086', "slot_py": None, "target": None, "cond": None},
    0x57b5e: {"kind": 'reg', "py": 'r[1] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x57b60: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFD086, 1, r[1])', "target": None, "cond": None},}
