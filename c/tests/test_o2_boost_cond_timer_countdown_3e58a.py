#!/usr/bin/env python3
"""Differential test for o2_boost_cond_timer_countdown (0x3E58A) — v3 lift + v4 FPU, 68 bytes.
...
Run from repo root: python3 c/tests/test_o2_boost_cond_timer_countdown_3e58a.py
"""
...
RAM_MAX = 0xFFFFD201
SPAN_END = 0x3E5CE
SENT = 0x3E5CE     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x3e58a: {"kind": 'reg', "py": 'r[5] = 0xFFFFC68C', "slot_py": None, "target": None, "cond": None},
    0x3e58c: {"kind": 'reg', "py": 'r[3] = 0x0007A87C', "slot_py": None, "target": None, "cond": None},
    0x3e58e: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x0007A87C, 4))', "slot_py": None, "target": None, "cond": None},
    0x3e590: {"kind": 'reg', "py": 'r[2] = 0xFFFFBC1C', "slot_py": None, "target": None, "cond": None},
    0x3e592: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0xFFFFBC1C, 4))', "slot_py": None, "target": None, "cond": None},
    0x3e594: {"kind": 'fpu', "py": 'T = 1 if fr[3] > fr[2] else 0', "slot_py": None, "target": None, "cond": None},
    0x3e596: {"kind": "branch", "py": None, "slot_py": '', "target": 0x3e5a6, "cond": 'notT'},
    0x3e59a: {"kind": 'reg', "py": 'r[1] = 0xFFFFD201', "slot_py": None, "target": None, "cond": None},
    0x3e59c: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFD201, 1))', "slot_py": None, "target": None, "cond": None},
    0x3e59e: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x3e5a0: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x3e5a2: {"kind": "branch", "py": None, "slot_py": '', "target": 0x3e5ae, "cond": 'notT'},
    0x3e5a6: {"kind": 'reg', "py": 'r[2] = 0x0007A870', "slot_py": None, "target": None, "cond": None},
    0x3e5a8: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0x0007A870, 1))', "slot_py": None, "target": None, "cond": None},
    0x3e5aa: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFC68C, 1, r[3])', "target": 0x3e5ca, "cond": 'always'},
    0x3e5ae: {"kind": 'reg', "py": 'r[1] = 0xFFFFC68D', "slot_py": None, "target": None, "cond": None},
    0x3e5b0: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFC68D, 1))', "slot_py": None, "target": None, "cond": None},
    0x3e5b2: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x3e5b4: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x3e5b6: {"kind": "branch", "py": None, "slot_py": '', "target": 0x3e5ca, "cond": 'notT'},
    0x3e5ba: {"kind": 'mem', "py": 'r[4] = s8(_rdw(ram, 0xFFFFC68C, 1))', "slot_py": None, "target": None, "cond": None},
    0x3e5bc: {"kind": 'reg', "py": 'r[2] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x3e5be: {"kind": 'reg', "py": 'T = 1 if s32(r[2]) > 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x3e5c0: {"kind": "branch", "py": None, "slot_py": '', "target": 0x3e5ca, "cond": 'notT'},
    0x3e5c4: {"kind": 'reg', "py": 'r[2] = 0x000000FF', "slot_py": None, "target": None, "cond": None},
    0x3e5c6: {"kind": 'reg', "py": 'r[4] = (r[4] + r[2]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x3e5c8: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC68C, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x3e5ca: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
