#!/usr/bin/env python3
"""Differential test for securityNotUnlocked (0x541F0) — v3 lift (branches + delay slots), 24 bytes.
...
Run from repo root: python3 c/tests/test_securityNotUnlocked_541f0.py
"""
...
ENTRY = 0x541F0
RAW = bytes.fromhex("D1 42 64 4C 62 10 62 2C 32 40 8F 02 00 09 A0 01 E4 00 E4 01 00 0B 60 43")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCFE4
SPAN_END = 0x54208
SENT = 0x54208     # stop-sentinel, placed past the literal pool
