#!/usr/bin/env python3
"""Differential test for FUN_000566cc (0x566CC) — v3 lift (branches + delay slots), 30 bytes.
...
Run from repo root: python3 c/tests/test_FUN_000566cc_566cc.py
"""
...
ENTRY = 0x566CC
RAW = bytes.fromhex("88 01 8F 08 00 09 92 74 61 20 21 18 8F 03 00 09 E3 01 A0 02 24 30 E1 00 24 10 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFD2AD
SPAN_END = 0x566EA
SENT = 0x566EA     # stop-sentinel, placed past the literal pool
...
CODE = {
    ...
    0x566de: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, r[4], 1, r[3])', "target": 0x566e6, "cond": 'always'},
    0x566e2: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x566e4: {"kind": 'mem', "py": '_wrw(ram, r[4], 1, r[1])', "slot_py": None, "target": None, "cond": None},
