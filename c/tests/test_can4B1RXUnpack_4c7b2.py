#!/usr/bin/env python3
"""Differential test for can4B1RXUnpack (0x4C7B2) — v3 lift (branches + delay slots), 52 bytes.
...
Run from repo root: python3 c/tests/test_can4B1RXUnpack_4c7b2.py
"""
...
CODE = {
    0x4c7b2: {"kind": 'reg', "py": 'r[4] = 0xFFFFCE90', "slot_py": None, "target": None, "cond": None},
    0x4c7b4: {"kind": 'reg', "py": 'r[2] = 0xFFFFCE99', "slot_py": None, "target": None, "cond": None},
    0x4c7b6: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFCE90, 1))', "slot_py": None, "target": None, "cond": None},
    0x4c7b8: {"kind": 'reg', "py": 'r[1] = 0xFFFFCE9A', "slot_py": None, "target": None, "cond": None},
    0x4c7ba: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCE99, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x4c7bc: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCE91, 1))', "slot_py": None, "target": None, "cond": None},
    0x4c7be: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCE9A, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x4c7c0: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCE92, 1))', "slot_py": None, "target": None, "cond": None},
    0x4c7c2: {"kind": 'reg', "py": 'r[3] = 0xFFFFCE9B', "slot_py": None, "target": None, "cond": None},
    0x4c7c4: {"kind": 'reg', "py": 'r[2] = 0xFFFFCE9C', "slot_py": None, "target": None, "cond": None},
    0x4c7c6: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCE9B, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x4c7c8: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCE93, 1))', "slot_py": None, "target": None, "cond": None},
    0x4c7ca: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCE9C, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x4c7cc: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCE94, 1))', "slot_py": None, "target": None, "cond": None},
    0x4c7ce: {"kind": 'reg', "py": 'r[1] = 0xFFFFCE9D', "slot_py": None, "target": None, "cond": None},
    0x4c7d0: {"kind": 'reg', "py": 'r[3] = 0xFFFFCE9E', "slot_py": None, "target": None, "cond": None},
    0x4c7d2: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCE9D, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x4c7d4: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCE95, 1))', "slot_py": None, "target": None, "cond": None},
    0x4c7d6: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCE9E, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x4c7d8: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCE96, 1))', "slot_py": None, "target": None, "cond": None},
    0x4c7da: {"kind": 'reg', "py": 'r[2] = 0xFFFFCE9F', "slot_py": None, "target": None, "cond": None},
    0x4c7dc: {"kind": 'reg', "py": 'r[1] = 0xFFFFCEA0', "slot_py": None, "target": None, "cond": None},
    0x4c7de: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCE9F, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x4c7e0: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCE97, 1))', "slot_py": None, "target": None, "cond": None},
    0x4c7e2: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFCEA0, 1, r[0])', "target": None, "cond": None},}
