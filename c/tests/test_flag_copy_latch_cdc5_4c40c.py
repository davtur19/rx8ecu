#!/usr/bin/env python3
"""Differential test for flag_copy_latch_cdc5 (0x4C40C) — v3 lift (branches + delay slots), 28 bytes.
...
Run from repo root: python3 c/tests/test_flag_copy_latch_cdc5_4c40c.py
"""
...
ENTRY = 0x4C40C
RAW = bytes.fromhex("94 1E 93 1E 60 30 60 0C 88 01 8F 03 00 09 E1 01 A0 02 24 10 E0 00 24 00 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCDC8
SPAN_END = 0x4C428
SENT = 0x4C428     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x4c40c: {"kind": 'reg', "py": 'r[4] = 0xFFFFCDC5', "slot_py": None, "target": None, "cond": None},
    0x4c40e: {"kind": 'reg', "py": 'r[3] = 0xFFFFCDC8', "slot_py": None, "target": None, "cond": None},
    0x4c410: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCDC8, 1))', "slot_py": None, "target": None, "cond": None},
    0x4c412: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x4c414: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x4c416: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4c420, "cond": 'notT'},
    0x4c41a: {"kind": 'reg', "py": 'r[1] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x4c41c: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFCDC5, 1, r[1])', "target": 0x4c424, "cond": 'always'},
    0x4c420: {"kind": 'reg', "py": 'r[0] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x4c422: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCDC5, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x4c424: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
