#!/usr/bin/env python3
"""Differential test for fuel_control_55ec0 (0x55EC0) — v3 lift (branches + delay slots), 12 bytes.
...
Run from repo root: python3 c/tests/test_fuel_control_55ec0_55ec0.py
"""
...
ENTRY = 0x55EC0
RAW = bytes.fromhex("69 F6 60 43 6C F6 6D F6 00 0B 6E F6")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
CODE = {
    0x55ec0: {"kind": 'mem', "py": 'r[9] = _rdw(ram, STACK_BASE + 0x400, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x55ec2: {"kind": 'reg', "py": 'r[0] = r[4]', "slot_py": None, "target": None, "cond": None},
    0x55ec4: {"kind": 'mem', "py": 'r[12] = _rdw(ram, STACK_BASE + 0x404, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x55ec6: {"kind": 'mem', "py": 'r[13] = _rdw(ram, STACK_BASE + 0x408, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x55ec8: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, STACK_BASE + 0x40C, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},}
