#!/usr/bin/env python3
"""Differential test for obd_service_handler_63BE6 (0x63BE6) — pure straight-line lift, 18 bytes.
...
Run from repo root: python3 c/tests/test_obd_service_handler_63BE6_63be6.py
"""
...
ENTRY = 0x63BE6
RAW = bytes.fromhex("E5 00 D6 2E E0 15 D7 2C 61 73 63 53 43 08 43 08 33 6C")
SEED = 42
N = 2000
