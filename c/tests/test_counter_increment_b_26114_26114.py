#!/usr/bin/env python3
"""Differential test for counter_increment_b_26114 (0x26114) — v3 lift (branches + delay slots), 10 bytes.
...
Run from repo root: python3 c/tests/test_counter_increment_b_26114_26114.py
"""
...
CODE = {
    0x26114: {"kind": 'reg', "py": 'r[4] = 0xFFFFB5F3', "slot_py": None, "target": None, "cond": None},
    0x26116: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFB5F3, 1))', "slot_py": None, "target": None, "cond": None},
    0x26118: {"kind": 'reg', "py": 'r[3] = (r[3] + s8(0x01)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x2611a: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFB5F3, 1, r[3])', "target": None, "cond": None},}
