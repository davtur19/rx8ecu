#!/usr/bin/env python3
"""Differential test for state_init_4BF34 (0x4BF34) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_state_init_4BF34_4bf34.py
"""
...
CODE = {
    0x4bf34: {"kind": 'reg', "py": 'r[3] = 0x00000080', "slot_py": None, "target": None, "cond": None},
    0x4bf36: {"kind": 'reg', "py": 'r[2] = 0xFFFFCE5C', "slot_py": None, "target": None, "cond": None},
    0x4bf38: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFCE5C, 1, r[3])', "target": None, "cond": None},}
