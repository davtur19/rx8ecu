#!/usr/bin/env python3
"""Differential test for caller_4BFD8 (entry 0x4BFD8) — v8 ST caller (CFG), 34 bytes.
...
the sh2emu oracle (which runs the actual ROM bytes) over 300 random
inputs.  Cases leaving the modeled span / exceeding max_steps are skipped.
Run: python3 test_caller_4BFD8.py
"""
...
CODE = {
    0x4bfd8: {"kind": 'reg', "py": 'r[3] = 0x0007CBE4', "slot_py": None, "target": None, "cond": None},
    0x4bfda: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x0007CBE4, 4))', "slot_py": None, "target": None, "cond": None},
    0x4bfdc: {"kind": 'reg', "py": 'r[2] = 0xFFFFAA10', "slot_py": None, "target": None, "cond": None},
    0x4bfde: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0xFFFFAA10, 4))', "slot_py": None, "target": None, "cond": None},
    0x4bfe0: {"kind": 'fpu', "py": 'T = 1 if fr[2] > fr[3] else 0', "slot_py": None, "target": None, "cond": None},
    0x4bfe2: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4bff0, "cond": 'notT'},
    0x4bfe6: {"kind": 'reg', "py": 'r[0] = 0x0007CBC8', "slot_py": None, "target": None, "cond": None},
    0x4bfe8: {"kind": 'reg', "py": 'r[4] = 0xFFFF8798', "slot_py": None, "target": None, "cond": None},
    0x4bfea: {"kind": 'reg', "py": 'r[2] = 0x0003EE58', "slot_py": None, "target": None, "cond": None},
    0x4bfec: {"kind": "call", "py": None, "slot_py": 'r[5] = s8(_rdw(ram, 0x0007CBC8, 1))', "target": 0x3ee58, "ret_pc": 0x4bff0, "set_pr": False, "cond": None},
    0x4bff0: {"kind": 'reg', "py": 'r[2] = 0x0007CBC9', "slot_py": None, "target": None, "cond": None},
    0x4bff2: {"kind": 'reg', "py": 'r[4] = 0xFFFF8798', "slot_py": None, "target": None, "cond": None},
    0x4bff4: {"kind": 'reg', "py": 'r[1] = 0x0003EE58', "slot_py": None, "target": None, "cond": None},
    0x4bff6: {"kind": "call", "py": None, "slot_py": 'r[5] = s8(_rdw(ram, 0x0007CBC9, 1))', "target": 0x3ee58, "ret_pc": 0x4bffa, "set_pr": False, "cond": None},
