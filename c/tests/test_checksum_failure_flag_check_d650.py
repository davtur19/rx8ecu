#!/usr/bin/env python3
"""Differential test for checksum_failure_flag_check (0xD650) — v3 lift (branches + delay slots), 22 bytes.
...
Run from repo root: python3 c/tests/test_checksum_failure_flag_check_d650.py
"""
