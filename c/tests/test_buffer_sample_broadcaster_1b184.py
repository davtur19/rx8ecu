#!/usr/bin/env python3
"""Differential test for buffer_sample_broadcaster (0x1B184) — v3 lift + v4 FPU, 14 bytes.
...
Run from repo root: python3 c/tests/test_buffer_sample_broadcaster_1b184.py
"""
...
ENTRY = 0x1B184
RAW = bytes.fromhex("93 57 F4 38 92 56 F2 4A 91 55 00 0B F1 4A")
SEED = 42
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFAA90
SPAN_END = 0x1B192
SENT = 0x1B192     # stop-sentinel, placed past the literal pool
