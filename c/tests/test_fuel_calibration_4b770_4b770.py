#!/usr/bin/env python3
"""Differential test for fuel_calibration_4b770 (0x4B770) — v3 lift (branches + delay slots), 14 bytes.
...
Run from repo root: python3 c/tests/test_fuel_calibration_4b770_4b770.py
"""
...
ENTRY = 0x4B770
RAW = bytes.fromhex("69 F6 6A F6 6B F6 6C F6 6D F6 00 0B 6E F6")
SEED = 42
N = 500
MAXSTEPS = 100000
STACK_BASE = 0xFFFFD000
STACK_TOP = STACK_BASE + 0x400
STACK_OFFS = (0x400, 0x404, 0x408, 0x40C, 0x410, 0x414)
RAM_MIN = None
RAM_MAX = None
SPAN_END = 0x4B77E
SENT = 0x4B77E     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x4b770: {"kind": 'mem', "py": 'r[9] = _rdw(ram, STACK_BASE + 0x400, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x4b772: {"kind": 'mem', "py": 'r[10] = _rdw(ram, STACK_BASE + 0x404, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x4b774: {"kind": 'mem', "py": 'r[11] = _rdw(ram, STACK_BASE + 0x408, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x4b776: {"kind": 'mem', "py": 'r[12] = _rdw(ram, STACK_BASE + 0x40C, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x4b778: {"kind": 'mem', "py": 'r[13] = _rdw(ram, STACK_BASE + 0x410, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x4b77a: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, STACK_BASE + 0x414, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},}
