#!/usr/bin/env python3
"""Differential test for e2_buf_c2aa_addr_get (0x386F4) — v3 lift (branches + delay slots), 22 bytes.
...
Run from repo root: python3 c/tests/test_e2_buf_c2aa_addr_get_386f4.py
"""
...
ENTRY = 0x386F4
RAW = bytes.fromhex("D0 24 00 0B 00 09 E0 00 D2 23 63 20 D1 23 21 30 D3 23 00 0B 23 00")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFC4BA
SPAN_END = 0x3870A
SENT = 0x3870A     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x386f4: {"kind": 'reg', "py": 'r[0] = 0xFFFFC2AA', "slot_py": None, "target": None, "cond": None},
    0x386f6: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},
    0x386fa: {"kind": 'reg', "py": 'r[0] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x386fc: {"kind": 'reg', "py": 'r[2] = 0x000792C0', "slot_py": None, "target": None, "cond": None},
    0x386fe: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0x000792C0, 1))', "slot_py": None, "target": None, "cond": None},
    0x38700: {"kind": 'reg', "py": 'r[1] = 0xFFFFC4B9', "slot_py": None, "target": None, "cond": None},
    0x38702: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC4B9, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x38704: {"kind": 'reg', "py": 'r[3] = 0xFFFFC4BA', "slot_py": None, "target": None, "cond": None},
    0x38706: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFC4BA, 1, r[0])', "target": None, "cond": None},}
