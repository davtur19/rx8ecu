#!/usr/bin/env python3
"""Differential test for DSC_checkIfMode_x10_a (0x2C5CE) — v3 lift (branches + delay slots), 30 bytes.
...
Run from repo root: python3 c/tests/test_DSC_checkIfMode_x10_a_2c5ce.py
"""
...
CODE = {
    0x2c5ce: {"kind": 'reg', "py": 'r[4] = 0xFFFFBC36', "slot_py": None, "target": None, "cond": None},
    0x2c5d0: {"kind": 'reg', "py": 'r[3] = 0xFFFFBC5E', "slot_py": None, "target": None, "cond": None},
    0x2c5d2: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFBC5E, 1))', "slot_py": None, "target": None, "cond": None},
    0x2c5d4: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x2c5d6: {"kind": 'reg', "py": 'r[0] = (r[0] & 0x10) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x2c5d8: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x10) else 0', "slot_py": None, "target": None, "cond": None},
    0x2c5da: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2c5e4, "cond": 'notT'},
    0x2c5de: {"kind": 'reg', "py": 'r[1] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x2c5e0: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFBC36, 1, r[1])', "target": 0x2c5e8, "cond": 'always'},
    0x2c5e4: {"kind": 'reg', "py": 'r[0] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x2c5e6: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBC36, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x2c5e8: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
