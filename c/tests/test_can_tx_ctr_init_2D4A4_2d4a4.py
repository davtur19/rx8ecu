#!/usr/bin/env python3
"""Differential test for can_tx_ctr_init_2D4A4 (0x2D4A4) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_can_tx_ctr_init_2D4A4_2d4a4.py
"""
...
CODE = {
    0x2d4a4: {"kind": 'reg', "py": 'r[2] = 0x0000FFFF', "slot_py": None, "target": None, "cond": None},
    0x2d4a6: {"kind": 'reg', "py": 'r[0] = 0xFFFFBCCC', "slot_py": None, "target": None, "cond": None},
    0x2d4a8: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBCCC, 2, r[2])', "target": None, "cond": None},}
