#!/usr/bin/env python3
"""Differential test for call-composition caller_542C0 (entry 0x542C0) — v7 ST caller + callee lib, flattened CODE with nested returns.
...
Run: python3 /home/davide/ailocal/rx8ecu/c/tests/test_caller_542C0.py
"""
...
CODE = {
    0x542c0: {"kind": 'reg', "py": 'r[4] = 0xFFFF8FEE', "slot_py": None, "target": None, "cond": None},
    0x542c2: {"kind": 'reg', "py": 'r[3] = 0x0003EE58', "slot_py": None, "target": None, "cond": None},
    0x542c4: {"kind": "call", "py": None, "slot_py": 'r[5] = s8(0x00)', "target": 0x3ee58, "ret_pc": 0x542c8, "set_pr": False, "cond": None},
