#!/usr/bin/env python3
"""Differential test for state_copy_float_init_35114 (0x35114) — v3 lift + v4 FPU, 16 bytes.
...
Run from repo root: python3 c/tests/test_state_copy_float_init_35114_35114.py
"""
...
RAM_MAX = 0xFFFFC1BD
SPAN_END = 0x35124
SENT = 0x35124     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x35114: {"kind": 'reg', "py": 'r[2] = 0xFFFFB13D', "slot_py": None, "target": None, "cond": None},
    0x35116: {"kind": 'fpu', "py": 'fr[3] = 1.0', "slot_py": None, "target": None, "cond": None},
    0x35118: {"kind": 'reg', "py": 'r[0] = 0xFFFFC184', "slot_py": None, "target": None, "cond": None},
    0x3511a: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFB13D, 1))', "slot_py": None, "target": None, "cond": None},
    0x3511c: {"kind": 'reg', "py": 'r[1] = 0xFFFFC1BD', "slot_py": None, "target": None, "cond": None},
    0x3511e: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC1BD, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x35120: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFC184, 4, f2bits(fr[3]))', "target": None, "cond": None},}
