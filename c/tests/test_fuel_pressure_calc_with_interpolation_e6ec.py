#!/usr/bin/env python3
"""Differential test for fuel_pressure_calc_with_interpolation (0xE6EC) — v3 lift + v4 FPU, 58 bytes.
...
Run from repo root: python3 c/tests/test_fuel_pressure_calc_with_interpolation_e6ec.py
"""
...
RAM_MAX = 0xFFFFB5B8
SPAN_END = 0xE726
SENT = 0xE726     # stop-sentinel, placed past the literal pool
...
CODE = {
    0xe6ec: {"kind": 'reg', "py": 'r[0] = 0x0000E764', "slot_py": None, "target": None, "cond": None},
    0xe6ee: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x0000E764, 4))', "slot_py": None, "target": None, "cond": None},
    0xe6f0: {"kind": 'reg', "py": 'r[3] = 0xFFFFB5B8', "slot_py": None, "target": None, "cond": None},
    0xe6f2: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0xFFFFB5B8, 4))', "slot_py": None, "target": None, "cond": None},
    0xe6f4: {"kind": 'fpu', "py": 'T = 1 if fr[3] > fr[2] else 0', "slot_py": None, "target": None, "cond": None},
    0xe6f6: {"kind": "branch", "py": None, "slot_py": '', "target": 0xe722, "cond": 'notT'},
    0xe6fa: {"kind": 'fpu', "py": 'fr[1] = 1.0', "slot_py": None, "target": None, "cond": None},
    0xe6fc: {"kind": 'reg', "py": 'r[4] = 0xFFFFA440', "slot_py": None, "target": None, "cond": None},
    0xe6fe: {"kind": 'fpu', "py": 'fr[1] = ts(fr[1] + fr[1])', "slot_py": None, "target": None, "cond": None},
    0xe700: {"kind": 'reg', "py": 'r[0] = 0x0000E768', "slot_py": None, "target": None, "cond": None},
    0xe702: {"kind": 'fpu', "py": 'fr[6] = bits2f(_rdw(ram, 0x0000E768, 4))', "slot_py": None, "target": None, "cond": None},
    0xe704: {"kind": 'reg', "py": 'r[0] = 0x0000E76C', "slot_py": None, "target": None, "cond": None},
    0xe706: {"kind": 'reg', "py": 'r[3] = 0x0006CFA0', "slot_py": None, "target": None, "cond": None},
    0xe708: {"kind": 'fpu', "py": 'fr[4] = bits2f(_rdw(ram, 0x0006CFA0, 4))', "slot_py": None, "target": None, "cond": None},
    0xe70a: {"kind": 'fpu', "py": 'T = 1 if fr[4] > fr[1] else 0', "slot_py": None, "target": None, "cond": None},
    0xe70c: {"kind": "branch", "py": None, "slot_py": 'fr[5] = bits2f(_rdw(ram, 0x0000E76C, 4))', "target": 0xe716, "cond": 'T'},
    0xe710: {"kind": 'reg', "py": 'r[0] = 0x0000E774', "slot_py": None, "target": None, "cond": None},
    0xe712: {"kind": "branch", "py": None, "slot_py": 'fr[3] = bits2f(_rdw(ram, 0x0000E774, 4))', "target": 0xe71a, "cond": 'always'},
    0xe716: {"kind": 'reg', "py": 'r[0] = 0x0000E778', "slot_py": None, "target": None, "cond": None},
    0xe718: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x0000E778, 4))', "slot_py": None, "target": None, "cond": None},
    0xe71a: {"kind": 'fpu', "py": 'fr[3] = ts(fr[3] - fr[4])', "slot_py": None, "target": None, "cond": None},
    0xe71c: {"kind": 'fpu', "py": 'fr[0] = fr[6]', "slot_py": None, "target": None, "cond": None},
    0xe71e: {"kind": 'fpu', "py": 'fr[5] = ts(fr[0] * fr[3] + fr[5])', "slot_py": None, "target": None, "cond": None},
    0xe720: {"kind": 'fpu', "py": '_wrw(ram, r[4], 4, f2bits(fr[5]))', "slot_py": None, "target": None, "cond": None},
    0xe722: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
