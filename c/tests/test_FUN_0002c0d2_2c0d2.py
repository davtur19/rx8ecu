#!/usr/bin/env python3
"""Differential test for FUN_0002c0d2 (0x2C0D2) — v3 lift (branches + delay slots), 10 bytes.
...
Run from repo root: python3 c/tests/test_FUN_0002c0d2_2c0d2.py
"""
...
ENTRY = 0x2C0D2
RAW = bytes.fromhex("D3 14 91 1C 62 30 00 0B 21 20")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBC31
SPAN_END = 0x2C0DC
SENT = 0x2C0DC     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x2c0d2: {"kind": 'reg', "py": 'r[3] = 0xFFFFBC30', "slot_py": None, "target": None, "cond": None},
    0x2c0d4: {"kind": 'reg', "py": 'r[1] = 0xFFFFBC31', "slot_py": None, "target": None, "cond": None},
    0x2c0d6: {"kind": 'mem', "py": 'r[2] = s8(_rdw(ram, 0xFFFFBC30, 1))', "slot_py": None, "target": None, "cond": None},
    0x2c0d8: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBC31, 1, r[2])', "target": None, "cond": None},}
