#!/usr/bin/env python3
"""Differential test for fault_all_clear_flag_eval_cca5 (0x49DE0) — v3 lift (branches + delay slots), 64 bytes.
...
Run from repo root: python3 c/tests/test_fault_all_clear_flag_eval_cca5_49de0.py
"""
...
ENTRY = 0x49DE0
RAW = bytes.fromhex("94 5F 92 62 63 20 23 38 8F 16 00 09 91 5A 60 10 20 08 8F 11 00 09 90 59 63 00 23 38 8F 0C 00 09 90 55 60 00 C8 80 03 29 73 FF 63 3B 23 38 8F 03 00 09 E1 01 A0 02 24 10 E2 00 24 20 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCCE8
SPAN_END = 0x49E20
SENT = 0x49E20     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x49de0: {"kind": 'reg', "py": 'r[4] = 0xFFFFCCA5', "slot_py": None, "target": None, "cond": None},
    0x49de2: {"kind": 'reg', "py": 'r[2] = 0xFFFFB580', "slot_py": None, "target": None, "cond": None},
    0x49de4: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFB580, 1))', "slot_py": None, "target": None, "cond": None},
    0x49de6: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x49de8: {"kind": "branch", "py": None, "slot_py": '', "target": 0x49e18, "cond": 'notT'},
    0x49dec: {"kind": 'reg', "py": 'r[1] = 0xFFFFCCA7', "slot_py": None, "target": None, "cond": None},
    0x49dee: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCCA7, 1))', "slot_py": None, "target": None, "cond": None},
    0x49df0: {"kind": 'reg', "py": 'T = 1 if (r[0] & r[0]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x49df2: {"kind": "branch", "py": None, "slot_py": '', "target": 0x49e18, "cond": 'notT'},
    0x49df6: {"kind": 'reg', "py": 'r[0] = 0xFFFFB586', "slot_py": None, "target": None, "cond": None},
    0x49df8: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFB586, 1))', "slot_py": None, "target": None, "cond": None},
    0x49dfa: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x49dfc: {"kind": "branch", "py": None, "slot_py": '', "target": 0x49e18, "cond": 'notT'},
    0x49e00: {"kind": 'reg', "py": 'r[0] = 0xFFFFCCE8', "slot_py": None, "target": None, "cond": None},
    0x49e02: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCCE8, 1))', "slot_py": None, "target": None, "cond": None},
    0x49e04: {"kind": 'reg', "py": 'T = 1 if (r[0] & 0x80) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x49e06: {"kind": 'reg', "py": 'r[3] = T;', "slot_py": None, "target": None, "cond": None},
    0x49e08: {"kind": 'reg', "py": 'r[3] = (r[3] + s8(0xFF)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x49e0a: {"kind": 'reg', "py": 'r[3] = (-r[3]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x49e0c: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x49e0e: {"kind": "branch", "py": None, "slot_py": '', "target": 0x49e18, "cond": 'notT'},
    0x49e12: {"kind": 'reg', "py": 'r[1] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x49e14: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFCCA5, 1, r[1])', "target": 0x49e1c, "cond": 'always'},
    0x49e18: {"kind": 'reg', "py": 'r[2] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x49e1a: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCCA5, 1, r[2])', "slot_py": None, "target": None, "cond": None},
    0x49e1c: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
