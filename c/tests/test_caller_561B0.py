#!/usr/bin/env python3
"""Differential test for caller_561B0 (entry 0x561B0) — v8 ST caller (CFG), 22 bytes.
...
Run: python3 test_caller_561B0.py
"""
...
CODE = {
    0x561b0: {"kind": 'st', "py": 'local[0x3FC] = pr\n_wrw(ram, STACK_BASE + 0x3FC, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x561b2: {"kind": 'fpu', "py": 'fr[6] = 0.0', "slot_py": None, "target": None, "cond": None},
    0x561b4: {"kind": 'reg', "py": 'r[0] = 0x00056264', "slot_py": None, "target": None, "cond": None},
    0x561b6: {"kind": 'reg', "py": 'r[3] = 0xFFFFADC0', "slot_py": None, "target": None, "cond": None},
    0x561b8: {"kind": 'reg', "py": 'r[2] = 0x000024D0', "slot_py": None, "target": None, "cond": None},
    0x561ba: {"kind": 'fpu', "py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFADC0, 4))', "slot_py": None, "target": None, "cond": None},
    0x561bc: {"kind": "call", "py": None, "slot_py": 'fr[5] = bits2f(_rdw(ram, 0x00056264, 4))', "target": 0x24d0, "ret_pc": 0x561c0, "set_pr": True, "cond": None},
    0x561c0: {"kind": 'st', "py": 'pr = _rdw(ram, STACK_BASE + 0x3FC, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x561c2: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},
