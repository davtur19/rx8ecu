#!/usr/bin/env python3
"""Differential test for read_flag_a41c (0x5E590) — v3 lift (branches + delay slots), 20 bytes.
...
Run from repo root: python3 c/tests/test_read_flag_a41c_5e590.py
"""
...
ENTRY = 0x5E590
RAW = bytes.fromhex("91 42 62 10 22 28 8F 02 00 09 A0 01 E4 00 E4 01 00 0B 60 43")
SEED = 0
N = 2000
MAXSTEPS = 100000
