#!/usr/bin/env python3
"""Differential test for FUN_0004c7fc (0x4C7FC) — v3 lift (branches + delay slots), 68 bytes.
...
Run from repo root: python3 c/tests/test_FUN_0004c7fc_4c7fc.py
"""
...
ENTRY = 0x4C7FC
RAW = bytes.fromhex("94 36 93 36 60 30 60 0C 88 01 8F 02 E5 00 A0 17 24 50 92 2C 60 20 60 0C 88 01 8F 07 00 09 91 29 92 29 60 11 63 21 30 32 8D 06 00 09 93 24 60 30 60 0C 88 01 8F 03 00 09 E3 01 A0 01 24 30 24 50 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCF60
SPAN_END = 0x4C840
SENT = 0x4C840     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x4c7fc: {"kind": 'reg', "py": 'r[4] = 0xFFFFCDB9', "slot_py": None, "target": None, "cond": None},
    0x4c7fe: {"kind": 'reg', "py": 'r[3] = 0xFFFFCDBF', "slot_py": None, "target": None, "cond": None},
    0x4c800: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCDBF, 1))', "slot_py": None, "target": None, "cond": None},
    0x4c802: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x4c804: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x4c806: {"kind": "branch", "py": None, "slot_py": 'r[5] = s8(0x00)', "target": 0x4c80e, "cond": 'notT'},
    0x4c80a: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFCDB9, 1, r[5])', "target": 0x4c83c, "cond": 'always'},
    0x4c80e: {"kind": 'reg', "py": 'r[2] = 0xFFFFCDBC', "slot_py": None, "target": None, "cond": None},
    0x4c810: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCDBC, 1))', "slot_py": None, "target": None, "cond": None},
    0x4c812: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x4c814: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x4c816: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4c828, "cond": 'notT'},
    0x4c81a: {"kind": 'reg', "py": 'r[1] = 0xFFFFCDA6', "slot_py": None, "target": None, "cond": None},
    0x4c81c: {"kind": 'reg', "py": 'r[2] = 0xFFFFCDA2', "slot_py": None, "target": None, "cond": None},
    0x4c81e: {"kind": 'mem', "py": 'r[0] = s16(_rdw(ram, 0xFFFFCDA6, 2))', "slot_py": None, "target": None, "cond": None},
    0x4c820: {"kind": 'mem', "py": 'r[3] = s16(_rdw(ram, 0xFFFFCDA2, 2))', "slot_py": None, "target": None, "cond": None},
    0x4c822: {"kind": 'reg', "py": 'T = 1 if (r[0] & 0xFFFFFFFF) >= (r[3] & 0xFFFFFFFF) else 0', "slot_py": None, "target": None, "cond": None},
    0x4c824: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4c834, "cond": 'T'},
    0x4c828: {"kind": 'reg', "py": 'r[3] = 0xFFFFCF60', "slot_py": None, "target": None, "cond": None},
    0x4c82a: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCF60, 1))', "slot_py": None, "target": None, "cond": None},
    0x4c82c: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x4c82e: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x4c830: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4c83a, "cond": 'notT'},
    0x4c834: {"kind": 'reg', "py": 'r[3] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x4c836: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFCDB9, 1, r[3])', "target": 0x4c83c, "cond": 'always'},
    0x4c83a: {"kind": 'mem', "py": '_wrw(ram, r[4], 1, r[5])', "slot_py": None, "target": None, "cond": None},
    0x4c83c: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
