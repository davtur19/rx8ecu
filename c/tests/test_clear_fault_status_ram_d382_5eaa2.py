#!/usr/bin/env python3
"""Differential test for clear_fault_status_ram_d382 (0x5EAA2) — v3 lift (branches + delay slots), 26 bytes.
...
Run from repo root: python3 c/tests/test_clear_fault_status_ram_d382_5eaa2.py
"""
...
ENTRY = 0x5EAA2
RAW = bytes.fromhex("E5 00 97 58 66 53 D4 2E 76 01 24 50 63 6D 33 73 8F FA 74 01 D3 2C 00 0B 23 51")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFD382
SPAN_END = 0x5EABC
SENT = 0x5EABC     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x5eaa2: {"kind": 'reg', "py": 'r[5] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x5eaa4: {"kind": 'reg', "py": 'r[7] = 0x0000008C', "slot_py": None, "target": None, "cond": None},
    0x5eaa6: {"kind": 'reg', "py": 'r[6] = r[5]', "slot_py": None, "target": None, "cond": None},
    0x5eaa8: {"kind": 'reg', "py": 'r[4] = 0xFFFFD382', "slot_py": None, "target": None, "cond": None},
    0x5eaaa: {"kind": 'reg', "py": 'r[6] = (r[6] + s8(0x01)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x5eaac: {"kind": 'mem', "py": '_wrw(ram, r[4], 1, r[5])', "slot_py": None, "target": None, "cond": None},
    0x5eaae: {"kind": 'reg', "py": 'r[3] = r[6] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x5eab0: {"kind": 'reg', "py": 'T = 1 if s32(r[3]) >= s32(r[7]) else 0', "slot_py": None, "target": None, "cond": None},
    0x5eab2: {"kind": "branch", "py": None, "slot_py": 'r[4] = (r[4] + s8(0x01)) & 0xFFFFFFFF', "target": 0x5eaaa, "cond": 'notT'},
    0x5eab6: {"kind": 'reg', "py": 'r[3] = 0xFFFFD1D4', "slot_py": None, "target": None, "cond": None},
    0x5eab8: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFD1D4, 2, r[5])', "target": None, "cond": None},}
