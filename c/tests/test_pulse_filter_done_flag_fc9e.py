#!/usr/bin/env python3
"""Differential test for pulse_filter_done_flag (0xFC9E) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_pulse_filter_done_flag_fc9e.py
"""
...
CODE = {
    0xfc9e: {"kind": 'reg', "py": 'r[2] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0xfca0: {"kind": 'reg', "py": 'r[1] = 0xFFFFA56C', "slot_py": None, "target": None, "cond": None},
    0xfca2: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFA56C, 1, r[2])', "target": None, "cond": None},}
