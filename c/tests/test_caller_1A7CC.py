#!/usr/bin/env python3
"""Differential test for caller_1A7CC (entry 0x1A7CC) — v8 ST caller (CFG), 40 bytes.
...
Run: python3 test_caller_1A7CC.py
"""
...
CODE = {
    0x1a7cc: {"kind": 'mem', "py": 'local[0x3FC] = r[14]\n_wrw(ram, STACK_BASE + 0x3FC, 4, r[14])\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x1a7ce: {"kind": 'st', "py": 'local[0x3F8] = pr\n_wrw(ram, STACK_BASE + 0x3F8, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x1a7d0: {"kind": 'reg', "py": 'r[14] = 0xFFFFAA7C', "slot_py": None, "target": None, "cond": None},
    0x1a7d2: {"kind": 'reg', "py": 'r[3] = 0xFFFFAAE0', "slot_py": None, "target": None, "cond": None},
    0x1a7d4: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFAAE0, 1))', "slot_py": None, "target": None, "cond": None},
    0x1a7d6: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x1a7d8: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x1a7da: {"kind": "branch", "py": None, "slot_py": '', "target": 0x1a7ea, "cond": 'notT'},
    0x1a7de: {"kind": 'reg', "py": 'r[5] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x1a7e0: {"kind": 'reg', "py": 'r[1] = 0x00002460', "slot_py": None, "target": None, "cond": None},
    0x1a7e2: {"kind": "call", "py": None, "slot_py": 'r[4] = s16(_rdw(ram, 0xFFFFAA7C, 2))', "target": 0x2460, "ret_pc": 0x1a7e6, "set_pr": True, "cond": None},
    0x1a7e6: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFAA7C, 2, r[0])', "target": 0x1a7ee, "cond": 'always'},
    0x1a7ea: {"kind": 'reg', "py": 'r[2] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x1a7ec: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFAA7C, 2, r[2])', "slot_py": None, "target": None, "cond": None},
    0x1a7ee: {"kind": 'st', "py": 'pr = _rdw(ram, STACK_BASE + 0x3F8, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x1a7f0: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, STACK_BASE + 0x3FC, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},
