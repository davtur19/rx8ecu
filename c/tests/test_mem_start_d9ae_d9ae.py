#!/usr/bin/env python3
"""Differential test for mem_start_d9ae (0xD9AE) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_mem_start_d9ae_d9ae.py
"""
...
ENTRY = 0xD9AE
RAW = bytes.fromhex("E1 01 D0 02 00 0B 20 10")
SEED = 42
N = 500
MAXSTEPS = 100000
