#!/usr/bin/env python3
"""Differential test for caller_7094 (entry 0x7094) — v8 ST caller (CFG), 24 bytes.
...
Run: python3 test_caller_7094.py
"""
...
CODE = {
    0x7094: {"kind": 'st', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x7096: {"kind": 'reg', "py": 'r[6] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x7098: {"kind": 'reg', "py": 'r[4] = 0xFFFFF764', "slot_py": None, "target": None, "cond": None},
    0x709a: {"kind": 'reg', "py": 'r[3] = 0x00004BBC', "slot_py": None, "target": None, "cond": None},
    0x709c: {"kind": "call", "py": None, "slot_py": 'r[5] = r[6]', "target": 0x4bbc, "ret_pc": 0x70a0, "set_pr": True, "cond": None},
    0x70a0: {"kind": 'reg', "py": 'r[5] = 0x00000100', "slot_py": None, "target": None, "cond": None},
    0x70a2: {"kind": 'reg', "py": 'r[6] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x70a4: {"kind": 'reg', "py": 'r[4] = 0xFFFFF74E', "slot_py": None, "target": None, "cond": None},
    0x70a6: {"kind": 'reg', "py": 'r[2] = 0x00004BBC', "slot_py": None, "target": None, "cond": None},
    0x70a8: {"kind": "call", "py": None, "slot_py": 'pr = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": 0x4bbc, "ret_pc": 0x70ac, "set_pr": False, "cond": None},
