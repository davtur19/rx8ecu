#!/usr/bin/env python3
"""Differential test for clear_task_flag_dc (0x3F90) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_clear_task_flag_dc_3f90.py
"""
