#!/usr/bin/env python3
"""Differential test for diag_fault_cond_eval_9050 (0x5685A) — v3 lift (branches + delay slots), 18 bytes.
...
Run from repo root: python3 c/tests/test_diag_fault_cond_eval_9050_5685a.py
"""
...
ENTRY = 0x5685A
RAW = bytes.fromhex("22 68 8F 01 00 09 65 43 00 0B 60 53 D3 26 00 0B 60 30")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFD20B
SPAN_END = 0x5686C
SENT = 0x5686C     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x5685a: {"kind": 'reg', "py": 'T = 1 if (r[2] & r[6]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x5685c: {"kind": "branch", "py": None, "slot_py": '', "target": 0x56862, "cond": 'notT'},
    0x56860: {"kind": 'reg', "py": 'r[5] = r[4]', "slot_py": None, "target": None, "cond": None},
    0x56862: {"kind": "ret", "py": None, "slot_py": 'r[0] = r[5]', "target": None, "cond": None},
