#!/usr/bin/env python3
"""Differential test for spi_eeprom_verify_49778 (0x49778) — v3 lift + v4 FPU, 56 bytes.
...
Run from repo root: python3 c/tests/test_spi_eeprom_verify_49778_49778.py
"""
...
ENTRY = 0x49778
RAW = bytes.fromhex("D5 1E D3 1F 92 32 F3 38 F2 28 F3 25 8F 0A 00 09 91 2D 60 10 60 0C 88 01 8F 04 00 09 D2 19 63 21 A0 08 25 31 64 51 63 4D 43 15 8F 03 00 09 D3 16 34 3C 25 41 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCD0A
SPAN_END = 0x497B0
SENT = 0x497B0     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x49778: {"kind": 'reg', "py": 'r[5] = 0xFFFFCD0A', "slot_py": None, "target": None, "cond": None},
    0x4977a: {"kind": 'reg', "py": 'r[3] = 0x0007C2F0', "slot_py": None, "target": None, "cond": None},
    0x4977c: {"kind": 'reg', "py": 'r[2] = 0xFFFFB528', "slot_py": None, "target": None, "cond": None},
    0x4977e: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x0007C2F0, 4))', "slot_py": None, "target": None, "cond": None},
    0x49780: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0xFFFFB528, 4))', "slot_py": None, "target": None, "cond": None},
    0x49782: {"kind": 'fpu', "py": 'T = 1 if fr[3] > fr[2] else 0', "slot_py": None, "target": None, "cond": None},
    0x49784: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4979c, "cond": 'notT'},
    0x49788: {"kind": 'reg', "py": 'r[1] = 0xFFFFCC10', "slot_py": None, "target": None, "cond": None},
    0x4978a: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCC10, 1))', "slot_py": None, "target": None, "cond": None},
    0x4978c: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x4978e: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x49790: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4979c, "cond": 'notT'},
    0x49794: {"kind": 'reg', "py": 'r[2] = 0x0007C2C0', "slot_py": None, "target": None, "cond": None},
    0x49796: {"kind": 'mem', "py": 'r[3] = s16(_rdw(ram, 0x0007C2C0, 2))', "slot_py": None, "target": None, "cond": None},
    0x49798: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFCD0A, 2, r[3])', "target": 0x497ac, "cond": 'always'},
    0x4979c: {"kind": 'mem', "py": 'r[4] = s16(_rdw(ram, 0xFFFFCD0A, 2))', "slot_py": None, "target": None, "cond": None},
    0x4979e: {"kind": 'reg', "py": 'r[3] = r[4] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x497a0: {"kind": 'reg', "py": 'T = 1 if s32(r[3]) > 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x497a2: {"kind": "branch", "py": None, "slot_py": '', "target": 0x497ac, "cond": 'notT'},
    0x497a6: {"kind": 'reg', "py": 'r[3] = 0x0000FFFF', "slot_py": None, "target": None, "cond": None},
    0x497a8: {"kind": 'reg', "py": 'r[4] = (r[4] + r[3]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x497aa: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCD0A, 2, r[4])', "slot_py": None, "target": None, "cond": None},
    0x497ac: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
