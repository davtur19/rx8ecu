#!/usr/bin/env python3
"""Differential test for FUN_0004499e (0x4499E) — v3 lift (branches + delay slots), 28 bytes.
...
Run from repo root: python3 c/tests/test_FUN_0004499e_4499e.py
"""
...
ENTRY = 0x4499E
RAW = bytes.fromhex("D3 3C 62 30 A0 08 26 20 65 60 63 5C 43 15 8F 03 00 09 93 63 35 3C 26 50 00 0B 27 40")
SEED = 42
N = 500
MAXSTEPS = 100000
