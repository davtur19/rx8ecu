#!/usr/bin/env python3
"""Differential test for fpu_multi_register_swap_344FE (0x344FE) — v3 lift + v4 FPU, 44 bytes.
...
Run from repo root: python3 c/tests/test_fpu_multi_register_swap_344FE_344fe.py
"""
...
ENTRY = 0x344FE
RAW = bytes.fromhex("D4 1A D3 0F F3 48 F3 3A D5 17 D2 0E F3 58 F2 3A D6 17 D1 0D F3 68 F1 3A 93 09 92 07 F3 38 F5 3A F3 28 F4 3A 91 04 F3 18 00 0B F6 3A")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFC12C
SPAN_END = 0x3452A
SENT = 0x34570     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x344fe: {"kind": 'reg', "py": 'r[4] = 0xFFFFC104', "slot_py": None, "target": None, "cond": None},
    0x34500: {"kind": 'reg', "py": 'r[3] = 0xFFFFC0D8', "slot_py": None, "target": None, "cond": None},
    0x34502: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, r[4], 4))', "slot_py": None, "target": None, "cond": None},
    0x34504: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFC0D8, 4, f2bits(fr[3]))', "slot_py": None, "target": None, "cond": None},
    0x34506: {"kind": 'reg', "py": 'r[5] = 0xFFFFC108', "slot_py": None, "target": None, "cond": None},
    0x34508: {"kind": 'reg', "py": 'r[2] = 0xFFFFC0DC', "slot_py": None, "target": None, "cond": None},
    0x3450a: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, r[5], 4))', "slot_py": None, "target": None, "cond": None},
    0x3450c: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFC0DC, 4, f2bits(fr[3]))', "slot_py": None, "target": None, "cond": None},
    0x3450e: {"kind": 'reg', "py": 'r[6] = 0xFFFFC10C', "slot_py": None, "target": None, "cond": None},
    0x34510: {"kind": 'reg', "py": 'r[1] = 0xFFFFC0E0', "slot_py": None, "target": None, "cond": None},
    0x34512: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, r[6], 4))', "slot_py": None, "target": None, "cond": None},
    0x34514: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFC0E0, 4, f2bits(fr[3]))', "slot_py": None, "target": None, "cond": None},
    0x34516: {"kind": 'reg', "py": 'r[3] = 0xFFFFC12C', "slot_py": None, "target": None, "cond": None},
    0x34518: {"kind": 'reg', "py": 'r[2] = 0xFFFFB5B8', "slot_py": None, "target": None, "cond": None},
    0x3451a: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFC12C, 4))', "slot_py": None, "target": None, "cond": None},
    0x3451c: {"kind": 'fpu', "py": '_wrw(ram, r[5], 4, f2bits(fr[3]))', "slot_py": None, "target": None, "cond": None},
    0x3451e: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFB5B8, 4))', "slot_py": None, "target": None, "cond": None},
    0x34520: {"kind": 'fpu', "py": '_wrw(ram, r[4], 4, f2bits(fr[3]))', "slot_py": None, "target": None, "cond": None},
    0x34522: {"kind": 'reg', "py": 'r[1] = 0xFFFFADC0', "slot_py": None, "target": None, "cond": None},
    0x34524: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFADC0, 4))', "slot_py": None, "target": None, "cond": None},
    0x34526: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, r[6], 4, f2bits(fr[3]))', "target": None, "cond": None},}
