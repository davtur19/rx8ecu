#!/usr/bin/env python3
"""Differential test for math_register_344da (0x344DA) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_math_register_344da_344da.py
"""
...
ENTRY = 0x344DA
RAW = bytes.fromhex("E3 00 91 29 00 0B 21 30")
SEED = 42
N = 500
MAXSTEPS = 100000
