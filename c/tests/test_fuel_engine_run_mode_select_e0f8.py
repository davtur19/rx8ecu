#!/usr/bin/env python3
"""Differential test for fuel_engine_run_mode_select (0xE0F8) — v3 lift (branches + delay slots), 18 bytes.
...
Run from repo root: python3 c/tests/test_fuel_engine_run_mode_select_e0f8.py
"""
...
ENTRY = 0xE0F8
RAW = bytes.fromhex("61 4C 21 18 8D 03 00 09 90 38 34 0C 25 40 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
