#!/usr/bin/env python3
"""Differential test for port_counter_decrement_check_33C1C (0x33C1C) — v3 lift (branches + delay slots), 42 bytes.
...
Run from repo root: python3 c/tests/test_port_counter_decrement_check_33C1C_33c1c.py
"""
...
ENTRY = 0x33C1C
RAW = bytes.fromhex("95 16 92 16 63 20 63 3C 43 15 8F 04 00 09 D3 15 61 30 A0 08 25 10 64 50 63 4C 23 38 8D 03 00 09 90 08 34 0C 25 40 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    0x33c1c: {"kind": 'reg', "py": 'r[5] = 0xFFFFC067', "slot_py": None, "target": None, "cond": None},
    0x33c1e: {"kind": 'reg', "py": 'r[2] = 0xFFFFA400', "slot_py": None, "target": None, "cond": None},
    0x33c20: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFA400, 1))', "slot_py": None, "target": None, "cond": None},
    0x33c22: {"kind": 'reg', "py": 'r[3] = r[3] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x33c24: {"kind": 'reg', "py": 'T = 1 if s32(r[3]) > 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x33c26: {"kind": "branch", "py": None, "slot_py": '', "target": 0x33c32, "cond": 'notT'},
    0x33c2a: {"kind": 'reg', "py": 'r[3] = 0x0006CF83', "slot_py": None, "target": None, "cond": None},
    0x33c2c: {"kind": 'mem', "py": 'r[1] = s8(_rdw(ram, 0x0006CF83, 1))', "slot_py": None, "target": None, "cond": None},
    0x33c2e: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFC067, 1, r[1])', "target": 0x33c42, "cond": 'always'},
    0x33c32: {"kind": 'mem', "py": 'r[4] = s8(_rdw(ram, 0xFFFFC067, 1))', "slot_py": None, "target": None, "cond": None},
    0x33c34: {"kind": 'reg', "py": 'r[3] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x33c36: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x33c38: {"kind": "branch", "py": None, "slot_py": '', "target": 0x33c42, "cond": 'T'},
    0x33c3c: {"kind": 'reg', "py": 'r[0] = 0x000000FF', "slot_py": None, "target": None, "cond": None},
    0x33c3e: {"kind": 'reg', "py": 'r[4] = (r[4] + r[0]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x33c40: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC067, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x33c42: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
