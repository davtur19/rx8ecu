#!/usr/bin/env python3
"""Differential test for getOdoBroadcastForCAN (0x295E8) — v3 lift (branches + delay slots), 10 bytes.
...
Run from repo root: python3 c/tests/test_getOdoBroadcastForCAN_295e8.py
"""
...
ENTRY = 0x295E8
RAW = bytes.fromhex("93 24 60 30 D2 17 00 0B 22 00")
SEED = 0
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBC31
SPAN_END = 0x295F2
SENT = 0x295F2     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x295e8: {"kind": 'reg', "py": 'r[3] = 0xFFFFBC31', "slot_py": None, "target": None, "cond": None},
    0x295ea: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFBC31, 1))', "slot_py": None, "target": None, "cond": None},
    0x295ec: {"kind": 'reg', "py": 'r[2] = 0xFFFFBAE5', "slot_py": None, "target": None, "cond": None},
    0x295ee: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBAE5, 1, r[0])', "target": None, "cond": None},}
