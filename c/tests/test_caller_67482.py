#!/usr/bin/env python3
"""Differential test for caller_67482 (entry 0x67482) — v8 ST caller (CFG), 18 bytes.
...
Run: python3 test_caller_67482.py
"""
...
CODE = {
    0x67482: {"kind": 'st', "py": 'local[0x3FC] = pr\n_wrw(ram, STACK_BASE + 0x3FC, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x67484: {"kind": 'reg', "py": 'r[3] = 0x00060DB4', "slot_py": None, "target": None, "cond": None},
    0x67486: {"kind": "call", "py": None, "slot_py": '', "target": 0x60db4, "ret_pc": 0x6748a, "set_pr": True, "cond": None},
    0x6748a: {"kind": 'reg', "py": 'r[4] = r[0] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x6748c: {"kind": 'reg', "py": 'r[2] = 0xFFFFD96C', "slot_py": None, "target": None, "cond": None},
    0x6748e: {"kind": 'st', "py": 'pr = _rdw(ram, STACK_BASE + 0x3FC, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x67490: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFD96C, 4, r[4])', "target": None, "cond": None},
    0x60db4: {"kind": 'reg', "py": 'r[3] = 0xFFFFD1E9', "slot_py": None, "target": None, "cond": None},
    0x60db6: {"kind": 'reg', "py": 'r[5] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x60db8: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFD1E9, 1))', "slot_py": None, "target": None, "cond": None},
    0x60dba: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x60dbc: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x60dbe: {"kind": "branch", "py": None, "slot_py": 'r[4] = r[5]', "target": 0x60dc4, "cond": 'notT'},
    0x60dc2: {"kind": 'reg', "py": 'r[4] = s8(0x03)', "slot_py": None, "target": None, "cond": None},
    0x60dc4: {"kind": 'reg', "py": 'r[2] = 0xFFFF9EC8', "slot_py": None, "target": None, "cond": None},
    0x60dc6: {"kind": 'mem', "py": 'r[3] = s16(_rdw(ram, 0xFFFF9EC8, 2))', "slot_py": None, "target": None, "cond": None},
    0x60dc8: {"kind": 'reg', "py": 'r[3] = r[3] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x60dca: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[5]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x60dcc: {"kind": "branch", "py": None, "slot_py": '', "target": 0x60dd6, "cond": 'T'},
    0x60dd0: {"kind": 'reg', "py": 'T = 1 if (r[5] & r[5]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x60dd2: {"kind": "branch", "py": None, "slot_py": '', "target": 0x60dda, "cond": 'notT'},
    0x60dd6: {"kind": 'reg', "py": 'r[1] = s8(0x04)', "slot_py": None, "target": None, "cond": None},
    0x60dd8: {"kind": 'reg', "py": 'r[4] = (r[4] | r[1]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x60dda: {"kind": 'reg', "py": 'r[3] = 0xFFFFD1D4', "slot_py": None, "target": None, "cond": None},
    0x60ddc: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFD1D4, 1))', "slot_py": None, "target": None, "cond": None},
    0x60dde: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x60de0: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x60de2: {"kind": "branch", "py": None, "slot_py": '', "target": 0x60dea, "cond": 'notT'},
    0x60de6: {"kind": 'reg', "py": 'r[1] = s8(0x08)', "slot_py": None, "target": None, "cond": None},
    0x60de8: {"kind": 'reg', "py": 'r[4] = (r[4] | r[1]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x60dea: {"kind": "ret", "py": None, "slot_py": 'r[0] = r[4]', "target": None, "cond": None},
}
