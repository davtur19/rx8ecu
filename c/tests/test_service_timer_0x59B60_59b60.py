#!/usr/bin/env python3
"""Differential test for service_timer_0x59B60 (0x59B60) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_service_timer_0x59B60_59b60.py
"""
...
ENTRY = 0x59B60
RAW = bytes.fromhex("D2 16 E3 00 00 0B 22 30")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    0x59b60: {"kind": 'reg', "py": 'r[2] = 0xFFFFD27F', "slot_py": None, "target": None, "cond": None},
    0x59b62: {"kind": 'reg', "py": 'r[3] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x59b64: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFD27F, 1, r[3])', "target": None, "cond": None},}
