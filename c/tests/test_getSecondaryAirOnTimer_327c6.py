#!/usr/bin/env python3
"""Differential test for getSecondaryAirOnTimer (0x327C6) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_getSecondaryAirOnTimer_327c6.py
"""
...
ENTRY = 0x327C6
RAW = bytes.fromhex("25 20 D3 3B 00 0B 23 40")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBFE8
SPAN_END = 0x327CE
SENT = 0x327CE     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x327c6: {"kind": 'mem', "py": '_wrw(ram, r[5], 1, r[2])', "slot_py": None, "target": None, "cond": None},
    0x327c8: {"kind": 'reg', "py": 'r[3] = 0xFFFFBFE8', "slot_py": None, "target": None, "cond": None},
    0x327ca: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBFE8, 1, r[4])', "target": None, "cond": None},}
