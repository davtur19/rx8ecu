#!/usr/bin/env python3
"""Differential test for ram_byte_copy_2A30A (0x2A30A) — v3 lift (branches + delay slots), 10 bytes.
...
Run from repo root: python3 c/tests/test_ram_byte_copy_2A30A_2a30a.py
"""
...
CODE = {
    0x2a30a: {"kind": 'reg', "py": 'r[3] = 0xFFFFBB81', "slot_py": None, "target": None, "cond": None},
    0x2a30c: {"kind": 'reg', "py": 'r[2] = 0xFFFFBB93', "slot_py": None, "target": None, "cond": None},
    0x2a30e: {"kind": 'mem', "py": 'r[1] = s8(_rdw(ram, 0xFFFFBB81, 1))', "slot_py": None, "target": None, "cond": None},
    0x2a310: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBB93, 1, r[1])', "target": None, "cond": None},}
