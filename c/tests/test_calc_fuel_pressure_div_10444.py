#!/usr/bin/env python3
"""Differential test for calc_fuel_pressure_div (0x10444) — v3 lift + v4 FPU, 72 bytes.
...
Run from repo root: python3 c/tests/test_calc_fuel_pressure_div_10444.py
"""
...
ENTRY = 0x10444
RAW = bytes.fromhex("60 4C 88 00 8D 11 00 09 88 03 8D 0E 00 09 88 01 8D 0E 00 09 88 02 8D 0B 00 09 88 04 8D 08 00 09 88 05 8D 05 00 09 A0 06 00 09 93 0F A0 04 F4 38 91 0D A0 01 F4 18 F4 8D C7 07 F3 08 F4 33 F4 4C F4 3D 04 5A 00 0B 60 43")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBEB0
SPAN_END = 0x1048C
SENT = 0x1048C     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x10444: {"kind": 'reg', "py": 'r[0] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x10446: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x00) else 0', "slot_py": None, "target": None, "cond": None},
    0x10448: {"kind": "branch", "py": None, "slot_py": '', "target": 0x1046e, "cond": 'T'},
    0x1044c: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x03) else 0', "slot_py": None, "target": None, "cond": None},
    0x1044e: {"kind": "branch", "py": None, "slot_py": '', "target": 0x1046e, "cond": 'T'},
    0x10452: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x10454: {"kind": "branch", "py": None, "slot_py": '', "target": 0x10474, "cond": 'T'},
    0x10458: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x02) else 0', "slot_py": None, "target": None, "cond": None},
    0x1045a: {"kind": "branch", "py": None, "slot_py": '', "target": 0x10474, "cond": 'T'},
    0x1045e: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x04) else 0', "slot_py": None, "target": None, "cond": None},
    0x10460: {"kind": "branch", "py": None, "slot_py": '', "target": 0x10474, "cond": 'T'},
    0x10464: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x05) else 0', "slot_py": None, "target": None, "cond": None},
    0x10466: {"kind": "branch", "py": None, "slot_py": '', "target": 0x10474, "cond": 'T'},
    0x1046a: {"kind": "branch", "py": None, "slot_py": '', "target": 0x1047a, "cond": 'always'},
    0x1046e: {"kind": 'reg', "py": 'r[3] = 0xFFFFBEAC', "slot_py": None, "target": None, "cond": None},
    0x10470: {"kind": "branch", "py": None, "slot_py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFBEAC, 4))', "target": 0x1047c, "cond": 'always'},
    0x10474: {"kind": 'reg', "py": 'r[1] = 0xFFFFBEB0', "slot_py": None, "target": None, "cond": None},
    0x10476: {"kind": "branch", "py": None, "slot_py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFBEB0, 4))', "target": 0x1047c, "cond": 'always'},
    0x1047a: {"kind": 'fpu', "py": 'fr[4] = 0.0', "slot_py": None, "target": None, "cond": None},
    0x1047c: {"kind": 'reg', "py": 'r[0] = 0x0001049C', "slot_py": None, "target": None, "cond": None},
    0x1047e: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x0001049C, 4))', "slot_py": None, "target": None, "cond": None},
    0x10480: {"kind": 'fpu', "py": 'fr[4] = ts(fr[4] / fr[3])', "slot_py": None, "target": None, "cond": None},
    0x10482: {"kind": 'fpu', "py": 'fr[4] = fr[4]', "slot_py": None, "target": None, "cond": None},
    0x10484: {"kind": 'fpu', "py": 'fpul = (0x80000000 if fr[4] != fr[4] else (0x7FFFFFFF if fr[4] >= 2147483648.0 else (0x80000000 if fr[4] < -2147483648.0 else int(fr[4])))) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x10486: {"kind": 'fpu', "py": 'r[4] = fpul', "slot_py": None, "target": None, "cond": None},
    0x10488: {"kind": "ret", "py": None, "slot_py": 'r[0] = r[4]', "target": None, "cond": None},}
