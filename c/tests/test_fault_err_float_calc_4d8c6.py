#!/usr/bin/env python3
"""Differential test for fault_err_float_calc (0x4D8C6) — v3 lift + v4 FPU, 54 bytes.
...
Run from repo root: python3 c/tests/test_fault_err_float_calc_4d8c6.py
"""
...
ENTRY = 0x4D8C6
RAW = bytes.fromhex("93 60 60 30 60 0C 88 01 8F 13 00 09 92 5B D3 34 61 21 60 31 31 06 8F 0C 00 09 91 55 60 10 20 08 8F 07 00 09 93 51 92 51 F3 38 F2 28 F2 31 91 4E F1 2A 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCE1C
SPAN_END = 0x4D8FC
SENT = 0x4D8FC     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x4d8c6: {"kind": 'reg', "py": 'r[3] = 0xFFFFCDC4', "slot_py": None, "target": None, "cond": None},
    0x4d8c8: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCDC4, 1))', "slot_py": None, "target": None, "cond": None},
    0x4d8ca: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x4d8cc: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x4d8ce: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4d8f8, "cond": 'notT'},
    0x4d8d2: {"kind": 'reg', "py": 'r[2] = 0xFFFFCDA6', "slot_py": None, "target": None, "cond": None},
    0x4d8d4: {"kind": 'reg', "py": 'r[3] = 0x0007B98A', "slot_py": None, "target": None, "cond": None},
    0x4d8d6: {"kind": 'mem', "py": 'r[1] = s16(_rdw(ram, 0xFFFFCDA6, 2))', "slot_py": None, "target": None, "cond": None},
    0x4d8d8: {"kind": 'mem', "py": 'r[0] = s16(_rdw(ram, 0x0007B98A, 2))', "slot_py": None, "target": None, "cond": None},
    0x4d8da: {"kind": 'reg', "py": 'T = 1 if (r[1] & 0xFFFFFFFF) > (r[0] & 0xFFFFFFFF) else 0', "slot_py": None, "target": None, "cond": None},
    0x4d8dc: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4d8f8, "cond": 'notT'},
    0x4d8e0: {"kind": 'reg', "py": 'r[1] = 0xFFFFCE00', "slot_py": None, "target": None, "cond": None},
    0x4d8e2: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCE00, 1))', "slot_py": None, "target": None, "cond": None},
    0x4d8e4: {"kind": 'reg', "py": 'T = 1 if (r[0] & r[0]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x4d8e6: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4d8f8, "cond": 'notT'},
    0x4d8ea: {"kind": 'reg', "py": 'r[3] = 0xFFFFCDE8', "slot_py": None, "target": None, "cond": None},
    0x4d8ec: {"kind": 'reg', "py": 'r[2] = 0xFFFFCDE4', "slot_py": None, "target": None, "cond": None},
    0x4d8ee: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFCDE8, 4))', "slot_py": None, "target": None, "cond": None},
    0x4d8f0: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0xFFFFCDE4, 4))', "slot_py": None, "target": None, "cond": None},
    0x4d8f2: {"kind": 'fpu', "py": 'fr[2] = ts(fr[2] - fr[3])', "slot_py": None, "target": None, "cond": None},
    0x4d8f4: {"kind": 'reg', "py": 'r[1] = 0xFFFFCE1C', "slot_py": None, "target": None, "cond": None},
    0x4d8f6: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFCE1C, 4, f2bits(fr[2]))', "slot_py": None, "target": None, "cond": None},
    0x4d8f8: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
