#!/usr/bin/env python3
"""Differential test for FUN_00039258 (0x39258) — v3 lift (branches + delay slots), 18 bytes.
...
Run from repo root: python3 c/tests/test_FUN_00039258_39258.py
"""
...
ENTRY = 0x39258
RAW = bytes.fromhex("00 09 E0 00 D2 23 63 20 D1 23 21 30 D3 23 00 0B 23 00")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    0x39258: {"kind": 'reg', "py": None, "slot_py": None, "target": None, "cond": None},
