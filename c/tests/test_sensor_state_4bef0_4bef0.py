#!/usr/bin/env python3
"""Differential test for sensor_state_4bef0 (0x4BEF0) — v3 lift (branches + delay slots), 28 bytes.
...
Run from repo root: python3 c/tests/test_sensor_state_4bef0_4bef0.py
"""
...
ENTRY = 0x4BEF0
RAW = bytes.fromhex("94 0C 93 0C 60 30 60 0C 88 01 8F 03 00 09 E1 00 A0 02 24 10 E0 01 24 00 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFD1D4
SPAN_END = 0x4BF0C
SENT = 0x4BF10     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x4bef0: {"kind": 'reg', "py": 'r[4] = 0xFFFFCE54', "slot_py": None, "target": None, "cond": None},
    0x4bef2: {"kind": 'reg', "py": 'r[3] = 0xFFFFD1D4', "slot_py": None, "target": None, "cond": None},
    0x4bef4: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFD1D4, 1))', "slot_py": None, "target": None, "cond": None},
    0x4bef6: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x4bef8: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x4befa: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4bf04, "cond": 'notT'},
    0x4befe: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x4bf00: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFCE54, 1, r[1])', "target": 0x4bf08, "cond": 'always'},
    0x4bf04: {"kind": 'reg', "py": 'r[0] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x4bf06: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCE54, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x4bf08: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
