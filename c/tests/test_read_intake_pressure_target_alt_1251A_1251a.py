#!/usr/bin/env python3
"""Differential test for read_intake_pressure_target_alt_1251A (0x1251A) — v3 lift + v4 FPU, 18 bytes.
...
Run from repo root: python3 c/tests/test_read_intake_pressure_target_alt_1251A_1251a.py
"""
...
RAM_MAX = 0xFFFFA65C
SPAN_END = 0x1252C
SENT = 0x1252C     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x1251a: {"kind": 'reg', "py": 'r[3] = 0x0006E3D8', "slot_py": None, "target": None, "cond": None},
    0x1251c: {"kind": 'reg', "py": 'r[2] = 0xFFFFA64C', "slot_py": None, "target": None, "cond": None},
    0x1251e: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x0006E3D8, 4))', "slot_py": None, "target": None, "cond": None},
    0x12520: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFA64C, 4, f2bits(fr[3]))', "slot_py": None, "target": None, "cond": None},
    0x12522: {"kind": 'reg', "py": 'r[1] = 0x0006E40C', "slot_py": None, "target": None, "cond": None},
    0x12524: {"kind": 'reg', "py": 'r[0] = 0xFFFFA65C', "slot_py": None, "target": None, "cond": None},
    0x12526: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x0006E40C, 4))', "slot_py": None, "target": None, "cond": None},
    0x12528: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFA65C, 4, f2bits(fr[3]))', "target": None, "cond": None},}
