#!/usr/bin/env python3
"""Differential test for FUN_000540c8 (0x540C8) — pure straight-line lift, 8 bytes.
...
Run from repo root: python3 c/tests/test_FUN_000540c8_540c8.py
"""
...
ENTRY = 0x540C8
RAW = bytes.fromhex("00 07 D9 54 00 07 D9 50")
SEED = 42
N = 2000
