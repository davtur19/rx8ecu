#!/usr/bin/env python3
"""Differential test for reset_all_status_flags (0xD666) — v3 lift (branches + delay slots), 16 bytes.
...
Run from repo root: python3 c/tests/test_reset_all_status_flags_d666.py
"""
...
ENTRY = 0xD666
RAW = bytes.fromhex("E4 00 D3 03 23 40 D2 05 22 40 D1 09 00 0B 21 40")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFA3FB
SPAN_END = 0xD676
SENT = 0xD69C     # stop-sentinel, placed past the literal pool
...
CODE = {
    0xd666: {"kind": 'reg', "py": 'r[4] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0xd668: {"kind": 'reg', "py": 'r[3] = 0xFFFFA3FB', "slot_py": None, "target": None, "cond": None},
    0xd66a: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA3FB, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0xd66c: {"kind": 'reg', "py": 'r[2] = 0xFFFFA3FA', "slot_py": None, "target": None, "cond": None},
    0xd66e: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA3FA, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0xd670: {"kind": 'reg', "py": 'r[1] = 0xFFFFA3F9', "slot_py": None, "target": None, "cond": None},
    0xd672: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFA3F9, 1, r[4])', "target": None, "cond": None},}
