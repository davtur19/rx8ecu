#!/usr/bin/env python3
"""Differential test for fuel_cut_flag_cc8a_clear (0x49A6C) — v3 lift (branches + delay slots), 34 bytes.
...
Run from repo root: python3 c/tests/test_fuel_cut_flag_cc8a_clear_49a6c.py
"""
...
ENTRY = 0x49A6C
RAW = bytes.fromhex("D3 2A 60 30 60 0C 88 01 8D 06 00 09 92 3F 60 20 60 0C 88 01 8F 03 00 09 92 3A E3 00 22 30 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCFD9
SPAN_END = 0x49A8E
SENT = 0x49A8E     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x49a6c: {"kind": 'reg', "py": 'r[3] = 0xFFFFCC92', "slot_py": None, "target": None, "cond": None},
    0x49a6e: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCC92, 1))', "slot_py": None, "target": None, "cond": None},
    0x49a70: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x49a72: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x49a74: {"kind": "branch", "py": None, "slot_py": '', "target": 0x49a84, "cond": 'T'},
    0x49a78: {"kind": 'reg', "py": 'r[2] = 0xFFFFCFD9', "slot_py": None, "target": None, "cond": None},
    0x49a7a: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCFD9, 1))', "slot_py": None, "target": None, "cond": None},
    0x49a7c: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x49a7e: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x49a80: {"kind": "branch", "py": None, "slot_py": '', "target": 0x49a8a, "cond": 'notT'},
    0x49a84: {"kind": 'reg', "py": 'r[2] = 0xFFFFCC8A', "slot_py": None, "target": None, "cond": None},
    0x49a86: {"kind": 'reg', "py": 'r[3] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x49a88: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCC8A, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x49a8a: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
