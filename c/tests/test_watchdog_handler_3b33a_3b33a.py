#!/usr/bin/env python3
"""Differential test for watchdog_handler_3b33a (0x3B33A) — v3 lift (branches + delay slots), 10 bytes.
...
Run from repo root: python3 c/tests/test_watchdog_handler_3b33a_3b33a.py
"""
...
ENTRY = 0x3B33A
RAW = bytes.fromhex("00 09 74 01 25 40 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
CODE = {
    0x3b33a: {"kind": 'reg', "py": None, "slot_py": None, "target": None, "cond": None},
    0x3b33c: {"kind": 'reg', "py": 'r[4] = (r[4] + s8(0x01)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x3b33e: {"kind": 'mem', "py": '_wrw(ram, r[5], 1, r[4])', "slot_py": None, "target": None, "cond": None},
