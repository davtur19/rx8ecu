#!/usr/bin/env python3
"""Differential test for counter_saturated_decrement_29E5A (0x29E5A) — v3 lift (branches + delay slots), 42 bytes.
...
Run from repo root: python3 c/tests/test_counter_saturated_decrement_29E5A_29e5a.py
"""
...
CODE = {
    0x29e5a: {"kind": 'reg', "py": 'r[5] = 0xFFFFBB28', "slot_py": None, "target": None, "cond": None},
    0x29e5c: {"kind": 'reg', "py": 'r[2] = 0xFFFFA400', "slot_py": None, "target": None, "cond": None},
    0x29e5e: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFA400, 1))', "slot_py": None, "target": None, "cond": None},
    0x29e60: {"kind": 'reg', "py": 'r[3] = r[3] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x29e62: {"kind": 'reg', "py": 'T = 1 if s32(r[3]) > 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x29e64: {"kind": "branch", "py": None, "slot_py": '', "target": 0x29e70, "cond": 'notT'},
    0x29e68: {"kind": 'reg', "py": 'r[3] = 0x0006CF85', "slot_py": None, "target": None, "cond": None},
    0x29e6a: {"kind": 'mem', "py": 'r[1] = s8(_rdw(ram, 0x0006CF85, 1))', "slot_py": None, "target": None, "cond": None},
    0x29e6c: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFBB28, 1, r[1])', "target": 0x29e80, "cond": 'always'},
    0x29e70: {"kind": 'mem', "py": 'r[4] = s8(_rdw(ram, 0xFFFFBB28, 1))', "slot_py": None, "target": None, "cond": None},
    0x29e72: {"kind": 'reg', "py": 'r[3] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x29e74: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x29e76: {"kind": "branch", "py": None, "slot_py": '', "target": 0x29e80, "cond": 'T'},
    0x29e7a: {"kind": 'reg', "py": 'r[0] = 0x000000FF', "slot_py": None, "target": None, "cond": None},
    0x29e7c: {"kind": 'reg', "py": 'r[4] = (r[4] + r[0]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x29e7e: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBB28, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x29e80: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
