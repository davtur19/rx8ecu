#!/usr/bin/env python3
"""Differential test for FUN_00022bba (0x22BBA) — v3 lift (branches + delay slots), 12 bytes.
...
Run from repo root: python3 c/tests/test_FUN_00022bba_22bba.py
"""
...
ENTRY = 0x22BBA
RAW = bytes.fromhex("00 09 A0 01 26 50 26 40 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = None
SPAN_END = 0x22BC6
SENT = 0x22BC6     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x22bba: {"kind": 'reg', "py": None, "slot_py": None, "target": None, "cond": None},
    0x22bbc: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, r[6], 1, r[5])', "target": 0x22bc2, "cond": 'always'},
    0x22bc0: {"kind": 'mem', "py": '_wrw(ram, r[6], 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x22bc2: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
