#!/usr/bin/env python3
"""Differential test for knock_flag_copy_b588_a692 (0x127CC) — v3 lift (branches + delay slots), 10 bytes.
...
Run from repo root: python3 c/tests/test_knock_flag_copy_b588_a692_127cc.py
"""
...
ENTRY = 0x127CC
RAW = bytes.fromhex("92 74 63 20 D1 3E 00 0B 21 30")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFB588
SPAN_END = 0x127D6
SENT = 0x127D6     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x127cc: {"kind": 'reg', "py": 'r[2] = 0xFFFFB588', "slot_py": None, "target": None, "cond": None},
    0x127ce: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFB588, 1))', "slot_py": None, "target": None, "cond": None},
    0x127d0: {"kind": 'reg', "py": 'r[1] = 0xFFFFA692', "slot_py": None, "target": None, "cond": None},
    0x127d2: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFA692, 1, r[3])', "target": None, "cond": None},}
