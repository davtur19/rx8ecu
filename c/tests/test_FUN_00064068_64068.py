#!/usr/bin/env python3
"""Differential test for FUN_00064068 (0x64068) — mem lift (RAM-only, straight-line), 8 bytes.
...
Run from repo root: python3 c/tests/test_FUN_00064068_64068.py
"""
...
ENTRY = 0x64068
RAW = bytes.fromhex("81 42 60 53 80 46 80 47")
SEED = 42
N = 2000
...
def spec_mirror(r4, r5, r6, r7, ram, stack_top):
    ...
    _wrw(ram, (r[4] + 4), 2, r[0])
    # 0x06406A: op 0x6053
    r[0] = r[5]
    # 0x06406C: mov.b r0,@(0x6,r4)
    _wrw(ram, (r[4] + 6), 1, r[0])
    # 0x06406E: mov.b r0,@(0x7,r4)
    _wrw(ram, (r[4] + 7), 1, r[0])
    r[15] = sp
