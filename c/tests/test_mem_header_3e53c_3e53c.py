#!/usr/bin/env python3
"""Differential test for mem_header_3e53c (0x3E53C) — v3 lift + v4 FPU, 36 bytes.
...
Run from repo root: python3 c/tests/test_mem_header_3e53c_3e53c.py
"""
...
ENTRY = 0x3E53C
RAW = bytes.fromhex("94 16 92 16 63 20 23 38 8F 03 00 09 E0 00 A0 07 24 00 D3 0B F3 38 F4 35 8F 02 00 09 E0 01 24 00 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFC684
SPAN_END = 0x3E560
SENT = 0x3E560     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x3e53c: {"kind": 'reg', "py": 'r[4] = 0xFFFFC684', "slot_py": None, "target": None, "cond": None},
    0x3e53e: {"kind": 'reg', "py": 'r[2] = 0xFFFFC680', "slot_py": None, "target": None, "cond": None},
    0x3e540: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFC680, 1))', "slot_py": None, "target": None, "cond": None},
    0x3e542: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x3e544: {"kind": "branch", "py": None, "slot_py": '', "target": 0x3e54e, "cond": 'notT'},
    0x3e548: {"kind": 'reg', "py": 'r[0] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x3e54a: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFC684, 1, r[0])', "target": 0x3e55c, "cond": 'always'},
    0x3e54e: {"kind": 'reg', "py": 'r[3] = 0x0007A884', "slot_py": None, "target": None, "cond": None},
    0x3e550: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x0007A884, 4))', "slot_py": None, "target": None, "cond": None},
    0x3e552: {"kind": 'fpu', "py": 'T = 1 if fr[4] > fr[3] else 0', "slot_py": None, "target": None, "cond": None},
    0x3e554: {"kind": "branch", "py": None, "slot_py": '', "target": 0x3e55c, "cond": 'notT'},
    0x3e558: {"kind": 'reg', "py": 'r[0] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x3e55a: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC684, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x3e55c: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
