#!/usr/bin/env python3
"""Differential test for can_task_counter_reset (0xA686) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_can_task_counter_reset_a686.py
"""
...
RAM_MAX = 0xFFFFA188
SPAN_END = 0xA68E
SENT = 0xA68E     # stop-sentinel, placed past the literal pool
...
CODE = {
    0xa686: {"kind": 'reg', "py": 'r[3] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0xa688: {"kind": 'reg', "py": 'r[2] = 0xFFFFA188', "slot_py": None, "target": None, "cond": None},
    0xa68a: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFA188, 2, r[3])', "target": None, "cond": None},}
