#!/usr/bin/env python3
"""Differential test for calcRelativePressure (0x302B8) — v3 lift + v4 FPU, 30 bytes.
...
Run from repo root: python3 c/tests/test_calcRelativePressure_302b8.py
"""
...
ENTRY = 0x302B8
RAW = bytes.fromhex("95 29 94 2C F3 58 F4 3A 96 2A F2 68 93 29 F2 31 92 28 F3 2A F3 58 F1 68 F1 31 00 0B F2 1A")
SEED = 43
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBE28
SPAN_END = 0x302D6
SENT = 0x302D6     # stop-sentinel, placed past the literal pool
