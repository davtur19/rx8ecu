#!/usr/bin/env python3
"""Differential test for math_convert_53610 (0x53610) — v3 lift + v4 FPU, 44 bytes.
...
Run from repo root: python3 c/tests/test_math_convert_53610_53610.py
"""
...
ENTRY = 0x53610
RAW = bytes.fromhex("94 19 93 19 60 30 60 0C 88 01 8F 04 00 09 D2 10 F3 28 A0 09 F4 3A 91 10 60 10 60 0C 88 01 8F 03 00 09 D2 0C F3 28 F4 3A 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFD12E
SPAN_END = 0x5363C
SENT = 0x5363C     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x53610: {"kind": 'reg', "py": 'r[4] = 0xFFFFD168', "slot_py": None, "target": None, "cond": None},
    0x53612: {"kind": 'reg', "py": 'r[3] = 0xFFFFD002', "slot_py": None, "target": None, "cond": None},
    0x53614: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFD002, 1))', "slot_py": None, "target": None, "cond": None},
    0x53616: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x53618: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x5361a: {"kind": "branch", "py": None, "slot_py": '', "target": 0x53626, "cond": 'notT'},
    0x5361e: {"kind": 'reg', "py": 'r[2] = 0x0007D7E8', "slot_py": None, "target": None, "cond": None},
    0x53620: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x0007D7E8, 4))', "slot_py": None, "target": None, "cond": None},
    0x53622: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, r[4], 4, f2bits(fr[3]))', "target": 0x53638, "cond": 'always'},
    0x53626: {"kind": 'reg', "py": 'r[1] = 0xFFFFD12E', "slot_py": None, "target": None, "cond": None},
    0x53628: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFD12E, 1))', "slot_py": None, "target": None, "cond": None},
    0x5362a: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x5362c: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x5362e: {"kind": "branch", "py": None, "slot_py": '', "target": 0x53638, "cond": 'notT'},
    0x53632: {"kind": 'reg', "py": 'r[2] = 0x0007D7EC', "slot_py": None, "target": None, "cond": None},
    0x53634: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x0007D7EC, 4))', "slot_py": None, "target": None, "cond": None},
    0x53636: {"kind": 'fpu', "py": '_wrw(ram, r[4], 4, f2bits(fr[3]))', "slot_py": None, "target": None, "cond": None},
    0x53638: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
