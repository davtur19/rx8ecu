#!/usr/bin/env python3
"""Differential test for pressure_ref_copy_26470 (0x26470) — v3 lift + v4 FPU, 10 bytes.
...
Run from repo root: python3 c/tests/test_pressure_ref_copy_26470_26470.py
"""
...
RAM_MAX = 0xFFFFB5FC
SPAN_END = 0x2647A
SENT = 0x2647A     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x26470: {"kind": 'reg', "py": 'r[3] = 0xFFFF9F68', "slot_py": None, "target": None, "cond": None},
    0x26472: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFF9F68, 4))', "slot_py": None, "target": None, "cond": None},
    0x26474: {"kind": 'reg', "py": 'r[2] = 0xFFFFB5FC', "slot_py": None, "target": None, "cond": None},
    0x26476: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFB5FC, 4, f2bits(fr[3]))', "target": None, "cond": None},}
