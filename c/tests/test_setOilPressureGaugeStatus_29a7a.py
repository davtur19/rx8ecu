#!/usr/bin/env python3
"""Differential test for setOilPressureGaugeStatus (0x29A7A) — v3 lift (branches + delay slots), 38 bytes.
...
Run from repo root: python3 c/tests/test_setOilPressureGaugeStatus_29a7a.py
"""
...
CODE = {
    0x29a7a: {"kind": 'reg', "py": 'r[4] = 0xFFFFBB18', "slot_py": None, "target": None, "cond": None},
    0x29a7c: {"kind": 'reg', "py": 'r[2] = 0xFFFFBC7C', "slot_py": None, "target": None, "cond": None},
    0x29a7e: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFBC7C, 1))', "slot_py": None, "target": None, "cond": None},
    0x29a80: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x29a82: {"kind": "branch", "py": None, "slot_py": '', "target": 0x29a92, "cond": 'T'},
    0x29a86: {"kind": 'reg', "py": 'r[1] = 0xFFFFB738', "slot_py": None, "target": None, "cond": None},
    0x29a88: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFB738, 1))', "slot_py": None, "target": None, "cond": None},
    0x29a8a: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x29a8c: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x29a8e: {"kind": "branch", "py": None, "slot_py": '', "target": 0x29a98, "cond": 'notT'},
    0x29a92: {"kind": 'reg', "py": 'r[2] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x29a94: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFBB18, 1, r[2])', "target": 0x29a9c, "cond": 'always'},
    0x29a98: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x29a9a: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBB18, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x29a9c: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
