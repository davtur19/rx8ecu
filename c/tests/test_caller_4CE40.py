#!/usr/bin/env python3
"""Differential test for caller_4CE40 (entry 0x4CE40) — v8 ST caller (CFG), 52 bytes.
...
Run: python3 test_caller_4CE40.py
"""
...
CODE = {
    0x4ce40: {"kind": 'mem', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, r[14])\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x4ce42: {"kind": 'st', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x4ce44: {"kind": 'reg', "py": 'r[14] = 0xFFFFCDA6', "slot_py": None, "target": None, "cond": None},
    0x4ce46: {"kind": 'reg', "py": 'r[3] = 0xFFFFCFD9', "slot_py": None, "target": None, "cond": None},
    0x4ce48: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCFD9, 1))', "slot_py": None, "target": None, "cond": None},
    0x4ce4a: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x4ce4c: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x4ce4e: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4ce58, "cond": 'notT'},
    0x4ce52: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x4ce54: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFCDA6, 2, r[1])', "target": 0x4ce6e, "cond": 'always'},
    0x4ce58: {"kind": 'reg', "py": 'r[2] = 0xFFFFCDBC', "slot_py": None, "target": None, "cond": None},
    0x4ce5a: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCDBC, 1))', "slot_py": None, "target": None, "cond": None},
    0x4ce5c: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x4ce5e: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x4ce60: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4ce6e, "cond": 'notT'},
    0x4ce64: {"kind": 'reg', "py": 'r[1] = 0x00002460', "slot_py": None, "target": None, "cond": None},
    0x4ce66: {"kind": 'reg', "py": 'r[5] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x4ce68: {"kind": "call", "py": None, "slot_py": 'r[4] = s16(_rdw(ram, 0xFFFFCDA6, 2))', "target": 0x2460, "ret_pc": 0x4ce6c, "set_pr": True, "cond": None},
    0x4ce6c: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCDA6, 2, r[0])', "slot_py": None, "target": None, "cond": None},
    0x4ce6e: {"kind": 'st', "py": 'pr = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x4ce70: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},
