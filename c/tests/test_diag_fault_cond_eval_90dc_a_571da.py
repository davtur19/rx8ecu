#!/usr/bin/env python3
"""Differential test for diag_fault_cond_eval_90dc_a (0x571DA) — v3 lift (branches + delay slots), 12 bytes.
...
Run from repo root: python3 c/tests/test_diag_fault_cond_eval_90dc_a_571da.py
"""
...
ENTRY = 0x571DA
RAW = bytes.fromhex("E4 00 92 13 E3 00 4F 26 00 0B 22 30")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFD21C
SPAN_END = 0x571E6
SENT = 0x571E6     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x571da: {"kind": 'reg', "py": 'r[4] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x571dc: {"kind": 'reg', "py": 'r[2] = 0xFFFFD21C', "slot_py": None, "target": None, "cond": None},
    0x571de: {"kind": 'reg', "py": 'r[3] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x571e0: {"kind": 'mem', "py": 'pr = _rdw(ram, STACK_BASE + 0x400, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x571e2: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFD21C, 1, r[3])', "target": None, "cond": None},}
