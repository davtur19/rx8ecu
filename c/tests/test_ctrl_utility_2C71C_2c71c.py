#!/usr/bin/env python3
"""Differential test for ctrl_utility_2C71C (0x2C71C) — v3 lift (branches + delay slots), 10 bytes.
...
Run from repo root: python3 c/tests/test_ctrl_utility_2C71C_2c71c.py
"""
...
ENTRY = 0x2C71C
RAW = bytes.fromhex("D1 16 63 10 90 1C 00 0B 20 30")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    0x2c71c: {"kind": 'reg', "py": 'r[1] = 0x0006CF84', "slot_py": None, "target": None, "cond": None},
    0x2c71e: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0x0006CF84, 1))', "slot_py": None, "target": None, "cond": None},
    0x2c720: {"kind": 'reg', "py": 'r[0] = 0xFFFFBC44', "slot_py": None, "target": None, "cond": None},
    0x2c722: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBC44, 1, r[3])', "target": None, "cond": None},}
