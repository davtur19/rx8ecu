#!/usr/bin/env python3
"""Differential test for unknownEnrichmentInit (0x4A27C) — v3 lift + v4 FPU, 8 bytes.
...
Run from repo root: python3 c/tests/test_unknownEnrichmentInit_4a27c.py
"""
...
ENTRY = 0x4A27C
RAW = bytes.fromhex("93 2F F3 8D 00 0B F3 3A")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCCC0
SPAN_END = 0x4A284
SENT = 0x4A284     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x4a27c: {"kind": 'reg', "py": 'r[3] = 0xFFFFCCC0', "slot_py": None, "target": None, "cond": None},
    0x4a27e: {"kind": 'fpu', "py": 'fr[3] = 0.0', "slot_py": None, "target": None, "cond": None},
    0x4a280: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFCCC0, 4, f2bits(fr[3]))', "target": None, "cond": None},}
