#!/usr/bin/env python3
"""Differential test for FUN_00027c82 (0x27C82) — v3 lift (branches + delay slots), 34 bytes.
...
Run from repo root: python3 c/tests/test_FUN_00027c82_27c82.py
"""
...
ENTRY = 0x27C82
RAW = bytes.fromhex("93 45 60 31 60 0D 88 01 8F 09 00 09 D5 23 64 51 61 4D 41 15 8F 03 00 09 D1 21 34 1C 25 41 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBA44
SPAN_END = 0x27CA4
SENT = 0x27CA4     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x27c82: {"kind": 'reg', "py": 'r[3] = 0xFFFFB69C', "slot_py": None, "target": None, "cond": None},
    0x27c84: {"kind": 'mem', "py": 'r[0] = s16(_rdw(ram, 0xFFFFB69C, 2))', "slot_py": None, "target": None, "cond": None},
    0x27c86: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x27c88: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x27c8a: {"kind": "branch", "py": None, "slot_py": '', "target": 0x27ca0, "cond": 'notT'},
    0x27c8e: {"kind": 'reg', "py": 'r[5] = 0xFFFFBA44', "slot_py": None, "target": None, "cond": None},
    0x27c90: {"kind": 'mem', "py": 'r[4] = s16(_rdw(ram, 0xFFFFBA44, 2))', "slot_py": None, "target": None, "cond": None},
    0x27c92: {"kind": 'reg', "py": 'r[1] = r[4] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x27c94: {"kind": 'reg', "py": 'T = 1 if s32(r[1]) > 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x27c96: {"kind": "branch", "py": None, "slot_py": '', "target": 0x27ca0, "cond": 'notT'},
    0x27c9a: {"kind": 'reg', "py": 'r[1] = 0x0000FFFF', "slot_py": None, "target": None, "cond": None},
    0x27c9c: {"kind": 'reg', "py": 'r[4] = (r[4] + r[1]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x27c9e: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBA44, 2, r[4])', "slot_py": None, "target": None, "cond": None},
    0x27ca0: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
