#!/usr/bin/env python3
"""Differential test for task_queue_pending_count (0x3E0) — v3 lift (branches + delay slots), 24 bytes.
...
Run from repo root: python3 c/tests/test_task_queue_pending_count_3e0.py
"""
...
ENTRY = 0x3E0
RAW = bytes.fromhex("92 0E 64 21 91 0E 64 4D 63 11 63 3D 34 38 44 11 89 00 74 64 00 0B 60 43")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    0x3e0: {"kind": 'reg', "py": 'r[2] = 0xFFFFDFB4', "slot_py": None, "target": None, "cond": None},
    0x3e2: {"kind": 'mem', "py": 'r[4] = s16(_rdw(ram, 0xFFFFDFB4, 2))', "slot_py": None, "target": None, "cond": None},
    0x3e4: {"kind": 'reg', "py": 'r[1] = 0xFFFFDFB6', "slot_py": None, "target": None, "cond": None},
    0x3e6: {"kind": 'reg', "py": 'r[4] = r[4] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x3e8: {"kind": 'mem', "py": 'r[3] = s16(_rdw(ram, 0xFFFFDFB6, 2))', "slot_py": None, "target": None, "cond": None},
    0x3ea: {"kind": 'reg', "py": 'r[3] = r[3] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x3ec: {"kind": 'reg', "py": 'r[4] = (r[4] - r[3]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x3ee: {"kind": 'reg', "py": 'T = 1 if s32(r[4]) >= 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x3f0: {"kind": "branch", "py": None, "slot_py": None, "target": 0x3f4, "cond": 'T'},
    0x3f2: {"kind": 'reg', "py": 'r[4] = (r[4] + s8(0x64)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x3f4: {"kind": "ret", "py": None, "slot_py": 'r[0] = r[4]', "target": None, "cond": None},}
