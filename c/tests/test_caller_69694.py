#!/usr/bin/env python3
"""Differential test for caller_69694 (entry 0x69694) — v8 ST caller (CFG), 10 bytes.
...
Run: python3 test_caller_69694.py
"""
...
CODE = {
    0x69694: {"kind": 'reg', "py": 'r[0] = 0xFFFFDE38', "slot_py": None, "target": None, "cond": None},
    0x69696: {"kind": 'reg', "py": 'r[3] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x69698: {"kind": 'reg', "py": 'r[4] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x6969a: {"kind": "ret", "py": None, "slot_py": None, "target": None, "cond": None},
}
