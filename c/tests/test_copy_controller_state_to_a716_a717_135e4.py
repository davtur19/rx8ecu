#!/usr/bin/env python3
"""Differential test for copy_controller_state_to_a716_a717 (0x135E4) — v3 lift (branches + delay slots), 18 bytes.
...
Run from repo root: python3 c/tests/test_copy_controller_state_to_a716_a717_135e4.py
"""
...
CODE = {
    0x135e4: {"kind": 'reg', "py": 'r[2] = 0xFFFFA415', "slot_py": None, "target": None, "cond": None},
    0x135e6: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFA415, 1))', "slot_py": None, "target": None, "cond": None},
    0x135e8: {"kind": 'reg', "py": 'r[1] = 0xFFFFA716', "slot_py": None, "target": None, "cond": None},
    0x135ea: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA716, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x135ec: {"kind": 'reg', "py": 'r[3] = 0xFFFFA414', "slot_py": None, "target": None, "cond": None},
    0x135ee: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFA414, 1))', "slot_py": None, "target": None, "cond": None},
    0x135f0: {"kind": 'reg', "py": 'r[2] = 0xFFFFA717', "slot_py": None, "target": None, "cond": None},
    0x135f2: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFA717, 1, r[0])', "target": None, "cond": None},}
