#!/usr/bin/env python3
"""Differential test for DSC_checkIfMode_x80_a (0x2C4EA) — v3 lift (branches + delay slots), 64 bytes.
...
Run from repo root: python3 c/tests/test_DSC_checkIfMode_x80_a_2c4ea.py
"""
...
ENTRY = 0x2C4EA
RAW = bytes.fromhex("95 23 94 23 D2 20 63 20 63 3C 23 49 33 40 8D 0A 00 09 D3 1D 61 30 21 18 8F 05 00 09 D0 1C 61 00 21 18 8D 09 00 09 93 12 60 30 60 0C 88 01 8F 03 00 09 E3 01 A0 02 25 30 E1 00 25 10 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    0x2c4ea: {"kind": 'reg', "py": 'r[5] = 0xFFFFBC33', "slot_py": None, "target": None, "cond": None},
    0x2c4ec: {"kind": 'reg', "py": 'r[4] = 0x00000080', "slot_py": None, "target": None, "cond": None},
    0x2c4ee: {"kind": 'reg', "py": 'r[2] = 0xFFFFBC5E', "slot_py": None, "target": None, "cond": None},
    0x2c4f0: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFBC5E, 1))', "slot_py": None, "target": None, "cond": None},
    0x2c4f2: {"kind": 'reg', "py": 'r[3] = r[3] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x2c4f4: {"kind": 'reg', "py": 'r[3] = (r[3] & r[4]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x2c4f6: {"kind": 'reg', "py": 'T = 1 if r[3] == r[4] else 0', "slot_py": None, "target": None, "cond": None},
    0x2c4f8: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2c510, "cond": 'T'},
    0x2c4fc: {"kind": 'reg', "py": 'r[3] = 0x00078D5C', "slot_py": None, "target": None, "cond": None},
    0x2c4fe: {"kind": 'mem', "py": 'r[1] = s8(_rdw(ram, 0x00078D5C, 1))', "slot_py": None, "target": None, "cond": None},
    0x2c500: {"kind": 'reg', "py": 'T = 1 if (r[1] & r[1]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x2c502: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2c510, "cond": 'notT'},
    0x2c506: {"kind": 'reg', "py": 'r[0] = 0x00078D5E', "slot_py": None, "target": None, "cond": None},
    0x2c508: {"kind": 'mem', "py": 'r[1] = s8(_rdw(ram, 0x00078D5E, 1))', "slot_py": None, "target": None, "cond": None},
    0x2c50a: {"kind": 'reg', "py": 'T = 1 if (r[1] & r[1]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x2c50c: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2c522, "cond": 'T'},
    0x2c510: {"kind": 'reg', "py": 'r[3] = 0xFFFFA428', "slot_py": None, "target": None, "cond": None},
    0x2c512: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFA428, 1))', "slot_py": None, "target": None, "cond": None},
    0x2c514: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x2c516: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x2c518: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2c522, "cond": 'notT'},
    0x2c51c: {"kind": 'reg', "py": 'r[3] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x2c51e: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFBC33, 1, r[3])', "target": 0x2c526, "cond": 'always'},
    0x2c522: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x2c524: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBC33, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x2c526: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
