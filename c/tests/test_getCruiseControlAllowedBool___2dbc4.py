#!/usr/bin/env python3
"""Differential test for getCruiseControlAllowedBool__ (0x2DBC4) — v3 lift + v4 FPU, 102 bytes.
...
Run from repo root: python3 c/tests/test_getCruiseControlAllowedBool___2dbc4.py
"""
...
ENTRY = 0x2DBC4
RAW = bytes.fromhex("94 50 93 50 60 30 60 0C 88 01 8D 12 00 09 92 4B 60 20 60 0C 88 01 8D 0C 00 09 91 46 60 10 60 0C 88 01 8D 06 00 09 93 41 60 30 60 0C 88 01 8F 09 00 09 D3 21 60 30 60 0C 88 01 8D 03 00 09 E3 00 A0 0F 24 30 D2 1D F3 28 91 31 F2 18 F2 35 8D 06 00 09 D3 19 60 30 60 0C 88 01 8F 02 00 09 E3 01 24 30 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBFBC
SPAN_END = 0x2DC2A
SENT = 0x2DC2A     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x2dbc4: {"kind": 'reg', "py": 'r[4] = 0xFFFFBD1C', "slot_py": None, "target": None, "cond": None},
    0x2dbc6: {"kind": 'reg', "py": 'r[3] = 0xFFFFBD18', "slot_py": None, "target": None, "cond": None},
    0x2dbc8: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFBD18, 1))', "slot_py": None, "target": None, "cond": None},
    0x2dbca: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x2dbcc: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x2dbce: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2dbf6, "cond": 'T'},
    0x2dbd2: {"kind": 'reg', "py": 'r[2] = 0xFFFFBD19', "slot_py": None, "target": None, "cond": None},
    0x2dbd4: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFBD19, 1))', "slot_py": None, "target": None, "cond": None},
    0x2dbd6: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x2dbd8: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x2dbda: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2dbf6, "cond": 'T'},
    0x2dbde: {"kind": 'reg', "py": 'r[1] = 0xFFFFBD1A', "slot_py": None, "target": None, "cond": None},
    0x2dbe0: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFBD1A, 1))', "slot_py": None, "target": None, "cond": None},
    0x2dbe2: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x2dbe4: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x2dbe6: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2dbf6, "cond": 'T'},
    0x2dbea: {"kind": 'reg', "py": 'r[3] = 0xFFFFBD2E', "slot_py": None, "target": None, "cond": None},
    0x2dbec: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFBD2E, 1))', "slot_py": None, "target": None, "cond": None},
    0x2dbee: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x2dbf0: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x2dbf2: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2dc08, "cond": 'notT'},
    0x2dbf6: {"kind": 'reg', "py": 'r[3] = 0x000762A5', "slot_py": None, "target": None, "cond": None},
    0x2dbf8: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0x000762A5, 1))', "slot_py": None, "target": None, "cond": None},
    0x2dbfa: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x2dbfc: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x2dbfe: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2dc08, "cond": 'T'},
    0x2dc02: {"kind": 'reg', "py": 'r[3] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x2dc04: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFBD1C, 1, r[3])', "target": 0x2dc26, "cond": 'always'},
    0x2dc08: {"kind": 'reg', "py": 'r[2] = 0x00076298', "slot_py": None, "target": None, "cond": None},
    0x2dc0a: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x00076298, 4))', "slot_py": None, "target": None, "cond": None},
    0x2dc0c: {"kind": 'reg', "py": 'r[1] = 0xFFFFBFBC', "slot_py": None, "target": None, "cond": None},
    0x2dc0e: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0xFFFFBFBC, 4))', "slot_py": None, "target": None, "cond": None},
    0x2dc10: {"kind": 'fpu', "py": 'T = 1 if fr[2] > fr[3] else 0', "slot_py": None, "target": None, "cond": None},
    0x2dc12: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2dc22, "cond": 'T'},
    0x2dc16: {"kind": 'reg', "py": 'r[3] = 0x000762A5', "slot_py": None, "target": None, "cond": None},
    0x2dc18: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0x000762A5, 1))', "slot_py": None, "target": None, "cond": None},
    0x2dc1a: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x2dc1c: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x2dc1e: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2dc26, "cond": 'notT'},
    0x2dc22: {"kind": 'reg', "py": 'r[3] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x2dc24: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBD1C, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x2dc26: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
