#!/usr/bin/env python3
"""Differential test for caller_5667C (entry 0x5667C) — v8 ST caller (CFG), 80 bytes.
...
Run: python3 test_caller_5667C.py
"""
...
CODE = {
    0x5667c: {"kind": 'st', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x5667e: {"kind": 'reg', "py": 'r[15] = (r[15] + s8(0xFC)) & 0xFFFFFFFF\nsp = (sp + s8(0xFC)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x56680: {"kind": 'reg', "py": 'r[3] = 0xFFFFD1C8', "slot_py": None, "target": None, "cond": None},
    0x56682: {"kind": 'mem', "py": '_wrw(ram, sp, 2, r[4])', "slot_py": None, "target": None, "cond": None},
    0x56684: {"kind": 'mem', "py": 'r[5] = s16(_rdw(ram, 0xFFFFD1C8, 2))', "slot_py": None, "target": None, "cond": None},
    0x56686: {"kind": 'reg', "py": 'r[2] = 0x0005E2CE', "slot_py": None, "target": None, "cond": None},
    0x56688: {"kind": "call", "py": None, "slot_py": 'r[4] = s16(_rdw(ram, sp, 2))', "target": 0x5e2ce, "ret_pc": 0x5668c, "set_pr": True, "cond": None},
    0x5668c: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x5668e: {"kind": 'reg', "py": 'T = 1 if (r[0] & r[0]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x56690: {"kind": "branch", "py": None, "slot_py": '', "target": 0x566a8, "cond": 'notT'},
    0x56694: {"kind": 'reg', "py": 'r[3] = 0x0005E2BC', "slot_py": None, "target": None, "cond": None},
    0x56696: {"kind": 'reg', "py": 'r[5] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x56698: {"kind": "call", "py": None, "slot_py": 'r[4] = s16(_rdw(ram, sp, 2))', "target": 0x5e2bc, "ret_pc": 0x5669c, "set_pr": True, "cond": None},
    0x5669c: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x5669e: {"kind": 'reg', "py": 'T = 1 if (r[0] & r[0]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x566a0: {"kind": "branch", "py": None, "slot_py": '', "target": 0x566a8, "cond": 'notT'},
    0x566a4: {"kind": "branch", "py": None, "slot_py": 'r[4] = s8(0x00)', "target": 0x566aa, "cond": 'always'},
    0x566aa: {"kind": 'reg', "py": 'r[15] = (r[15] + s8(0x04)) & 0xFFFFFFFF\nsp = (sp + s8(0x04)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x566ac: {"kind": 'st', "py": 'pr = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x566ae: {"kind": "ret", "py": None, "slot_py": 'r[0] = r[4]', "target": None, "cond": None, },
    0x566bc: {"kind": "ret", "py": None, "slot_py": 'r[0] = s8(0x00)', "target": None, "cond": None, },
    0x566c0: {"kind": "ret", "py": None, "slot_py": 'r[0] = s8(0x00)', "target": None, "cond": None, },
    0x566c4: {"kind": "ret", "py": None, "slot_py": 'r[0] = s8(0x00)', "target": None, "cond": None, },
    0x566c8: {"kind": "ret", "py": None, "slot_py": 'r[0] = s8(0x01)', "target": None, "cond": None, },
    0x566a8: {"kind": 'reg', "py": 'r[4] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    ...
    0x5e2ce: {"kind": 'reg', "py": 'r[4] = r[4] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x5e2d0: {"kind": 'reg', "py": 'r[0] = 0x0007CBA0', "slot_py": None, "target": None, "cond": None},
    0x5e2d2: {"kind": 'reg', "py": 'r[5] = r[5] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x5e2d4: {"kind": 'reg', "py": 'T = (r[4] >> 31) & 1\nr[4] = (r[4] << 1) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x5e2d6: {"kind": 'mem', "py": 'r[3] = s16(_rdw(ram, (r[4] + r[0]), 2))', "slot_py": None, "target": None, "cond": None},
    0x5e2d8: {"kind": 'reg', "py": 'r[3] = r[3] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x5e2da: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[5]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x5e2dc: {"kind": 'reg', "py": 'r[4] = T;', "slot_py": None, "target": None, "cond": None},
    0x5e2de: {"kind": "ret", "py": None, "slot_py": 'r[0] = r[4]', "target": None, "cond": None, },
}
