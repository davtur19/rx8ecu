#!/usr/bin/env python3
"""Differential test for coil_charge_enabled_query (0xE450) — v3 lift (branches + delay slots), 26 bytes.
...
Run from repo root: python3 c/tests/test_coil_charge_enabled_query_e450.py
"""
...
ENTRY = 0xE450
RAW = bytes.fromhex("94 0B D2 06 63 20 23 38 8F 03 00 09 E0 00 A0 02 24 00 E1 01 24 10 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFA41C
SPAN_END = 0xE46A
SENT = 0xE470     # stop-sentinel, placed past the literal pool
...
CODE = {
    0xe450: {"kind": 'reg', "py": 'r[4] = 0xFFFFA41C', "slot_py": None, "target": None, "cond": None},
    0xe452: {"kind": 'reg', "py": 'r[2] = 0xFFFF9F8C', "slot_py": None, "target": None, "cond": None},
    0xe454: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFF9F8C, 1))', "slot_py": None, "target": None, "cond": None},
    0xe456: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0xe458: {"kind": "branch", "py": None, "slot_py": '', "target": 0xe462, "cond": 'notT'},
    0xe45c: {"kind": 'reg', "py": 'r[0] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0xe45e: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFA41C, 1, r[0])', "target": 0xe466, "cond": 'always'},
    0xe462: {"kind": 'reg', "py": 'r[1] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0xe464: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA41C, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0xe466: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
