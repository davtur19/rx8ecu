#!/usr/bin/env python3
"""Differential test for ram_shadow_word_copy_bb72 (0x2A48C) — v3 lift (branches + delay slots), 10 bytes.
...
Run from repo root: python3 c/tests/test_ram_shadow_word_copy_bb72_2a48c.py
"""
...
ENTRY = 0x2A48C
RAW = bytes.fromhex("93 22 60 31 D2 17 00 0B 22 01")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBB8A
SPAN_END = 0x2A496
SENT = 0x2A496     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x2a48c: {"kind": 'reg', "py": 'r[3] = 0xFFFFBB72', "slot_py": None, "target": None, "cond": None},
    0x2a48e: {"kind": 'mem', "py": 'r[0] = s16(_rdw(ram, 0xFFFFBB72, 2))', "slot_py": None, "target": None, "cond": None},
    0x2a490: {"kind": 'reg', "py": 'r[2] = 0xFFFFBB8A', "slot_py": None, "target": None, "cond": None},
    0x2a492: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBB8A, 2, r[0])', "target": None, "cond": None},}
