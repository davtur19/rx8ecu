#!/usr/bin/env python3
"""Differential test for FUN_00006a28 (0x6A28) — v3 lift (branches + delay slots), 36 bytes.
...
Run from repo root: python3 c/tests/test_FUN_00006a28_6a28.py
"""
...
ENTRY = 0x6A28
RAW = bytes.fromhex("D4 30 84 41 88 01 8D 08 00 09 84 44 88 01 8D 04 00 09 84 47 88 01 8F 02 00 09 00 0B E0 01 E0 00 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFF9F29
SPAN_END = 0x6A4C
SENT = 0x6A4C     # stop-sentinel, placed past the literal pool
