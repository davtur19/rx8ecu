#!/usr/bin/env python3
"""Differential test for FUN_00053ca4 (0x53CA4) — v3 lift (branches + delay slots), 10 bytes.
...
Run from repo root: python3 c/tests/test_FUN_00053ca4_53ca4.py
"""
...
ENTRY = 0x53CA4
RAW = bytes.fromhex("D2 10 63 20 D1 10 00 0B 21 30")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCFDC
SPAN_END = 0x53CAE
SENT = 0x53CAE     # stop-sentinel, placed past the literal pool
