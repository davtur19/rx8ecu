#!/usr/bin/env python3
"""Differential test for ram_byte_copy_2A31E (0x2A31E) — v3 lift (branches + delay slots), 10 bytes.
...
Run from repo root: python3 c/tests/test_ram_byte_copy_2A31E_2a31e.py
"""
...
ENTRY = 0x2A31E
RAW = bytes.fromhex("93 08 D2 0B 61 30 00 0B 22 10")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    0x2a31e: {"kind": 'reg', "py": 'r[3] = 0xFFFFBB84', "slot_py": None, "target": None, "cond": None},
    0x2a320: {"kind": 'reg', "py": 'r[2] = 0xFFFFBB95', "slot_py": None, "target": None, "cond": None},
    0x2a322: {"kind": 'mem', "py": 'r[1] = s8(_rdw(ram, 0xFFFFBB84, 1))', "slot_py": None, "target": None, "cond": None},
    0x2a324: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBB95, 1, r[1])', "target": None, "cond": None},}
