#!/usr/bin/env python3
"""Differential test for obd_readiness_monitor_474FA (0x474FA) — v3 lift (branches + delay slots), 22 bytes.
...
Run from repo root: python3 c/tests/test_obd_readiness_monitor_474FA_474fa.py
"""
...
ENTRY = 0x474FA
RAW = bytes.fromhex("00 09 60 EC 88 01 8F 02 00 09 92 2C 22 D0 4F 26 6D F6 00 0B 6E F6")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCB74
SPAN_END = 0x47510
SENT = 0x47510     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x474fa: {"kind": 'reg', "py": None, "slot_py": None, "target": None, "cond": None},
    0x474fc: {"kind": 'reg', "py": 'r[0] = r[14] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x474fe: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x47500: {"kind": "branch", "py": None, "slot_py": '', "target": 0x47508, "cond": 'notT'},
    0x47504: {"kind": 'reg', "py": 'r[2] = 0xFFFFCB74', "slot_py": None, "target": None, "cond": None},
    0x47506: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCB74, 1, r[13])', "slot_py": None, "target": None, "cond": None},
    0x47508: {"kind": 'mem', "py": 'pr = _rdw(ram, STACK_BASE + 0x400, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x4750a: {"kind": 'mem', "py": 'r[13] = _rdw(ram, STACK_BASE + 0x404, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x4750c: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, STACK_BASE + 0x408, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},}
