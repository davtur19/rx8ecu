#!/usr/bin/env python3
"""Differential test for add_float_to_ram_a898 (0x16244) — v3 lift + v4 FPU, 16 bytes.
...
Run from repo root: python3 c/tests/test_add_float_to_ram_a898_16244.py
"""
...
ENTRY = 0x16244
RAW = bytes.fromhex("93 06 F3 38 92 05 F2 28 91 04 F2 30 00 0B F1 2A")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFA8DC
SPAN_END = 0x16254
SENT = 0x1625A     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x16244: {"kind": 'reg', "py": 'r[3] = 0xFFFFA7B4', "slot_py": None, "target": None, "cond": None},
    0x16246: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFA7B4, 4))', "slot_py": None, "target": None, "cond": None},
    0x16248: {"kind": 'reg', "py": 'r[2] = 0xFFFFA8DC', "slot_py": None, "target": None, "cond": None},
    0x1624a: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0xFFFFA8DC, 4))', "slot_py": None, "target": None, "cond": None},
    0x1624c: {"kind": 'reg', "py": 'r[1] = 0xFFFFA898', "slot_py": None, "target": None, "cond": None},
    0x1624e: {"kind": 'fpu', "py": 'fr[2] = ts(fr[2] + fr[3])', "slot_py": None, "target": None, "cond": None},
    0x16250: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFA898, 4, f2bits(fr[2]))', "target": None, "cond": None},}
