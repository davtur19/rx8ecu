#!/usr/bin/env python3
"""Differential test for init_floats_cb0c_cb10 (0x456A4) — v3 lift + v4 FPU, 14 bytes.
...
Run from repo root: python3 c/tests/test_init_floats_cb0c_cb10_456a4.py
"""
...
ENTRY = 0x456A4
RAW = bytes.fromhex("93 31 F4 38 92 30 F2 4A 91 2F 00 0B F1 4A")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCB10
SPAN_END = 0x456B2
SENT = 0x456B2     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x456a4: {"kind": 'reg', "py": 'r[3] = 0xFFFFC0D8', "slot_py": None, "target": None, "cond": None},
    0x456a6: {"kind": 'fpu', "py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFC0D8, 4))', "slot_py": None, "target": None, "cond": None},
    0x456a8: {"kind": 'reg', "py": 'r[2] = 0xFFFFCB0C', "slot_py": None, "target": None, "cond": None},
    0x456aa: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFCB0C, 4, f2bits(fr[4]))', "slot_py": None, "target": None, "cond": None},
    0x456ac: {"kind": 'reg', "py": 'r[1] = 0xFFFFCB10', "slot_py": None, "target": None, "cond": None},
    0x456ae: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFCB10, 4, f2bits(fr[4]))', "target": None, "cond": None},}
