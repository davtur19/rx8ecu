#!/usr/bin/env python3
"""Differential test for fuel_injection_control_0x4F364 (0x4F364) — v3 lift (branches + delay slots), 40 bytes.
...
Run from repo root: python3 c/tests/test_fuel_injection_control_0x4F364_4f364.py
"""
...
ENTRY = 0x4F364
RAW = bytes.fromhex("94 2F 93 2F 60 30 60 0C 88 01 8D 06 00 09 92 2A 60 20 60 0C 88 01 8F 03 00 09 E3 01 A0 02 24 30 E1 00 24 10 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    0x4f364: {"kind": 'reg', "py": 'r[4] = 0xFFFFD002', "slot_py": None, "target": None, "cond": None},
    0x4f366: {"kind": 'reg', "py": 'r[3] = 0xFFFFD07C', "slot_py": None, "target": None, "cond": None},
    0x4f368: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFD07C, 1))', "slot_py": None, "target": None, "cond": None},
    0x4f36a: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x4f36c: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x4f36e: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4f37e, "cond": 'T'},
    0x4f372: {"kind": 'reg', "py": 'r[2] = 0xFFFFD0E4', "slot_py": None, "target": None, "cond": None},
    0x4f374: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFD0E4, 1))', "slot_py": None, "target": None, "cond": None},
    0x4f376: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x4f378: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x4f37a: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4f384, "cond": 'notT'},
    0x4f37e: {"kind": 'reg', "py": 'r[3] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x4f380: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFD002, 1, r[3])', "target": 0x4f388, "cond": 'always'},
    0x4f384: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x4f386: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD002, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x4f388: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
