#!/usr/bin/env python3
"""Differential test for callsFlash__ (0x527E) — v3 lift (branches + delay slots), 16 bytes.
...
Run from repo root: python3 c/tests/test_callsFlash___527e.py
"""
...
ENTRY = 0x527E
RAW = bytes.fromhex("E4 00 93 4B 23 40 92 4A 22 40 91 49 00 0B 21 41")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFEC26
SPAN_END = 0x528E
SENT = 0x528E     # stop-sentinel, placed past the literal pool
