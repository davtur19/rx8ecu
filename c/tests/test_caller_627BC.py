#!/usr/bin/env python3
"""Differential test for caller_627BC (entry 0x627BC) — v8 ST caller (CFG), 48 bytes.
...
Run: python3 test_caller_627BC.py
"""
...
CODE = {
    0x627bc: {"kind": 'st', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x627be: {"kind": 'reg', "py": 'r[15] = (r[15] + s8(0xFC)) & 0xFFFFFFFF\nsp = (sp + s8(0xFC)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x627c0: {"kind": 'reg', "py": 'r[2] = 0xFFFF8E94', "slot_py": None, "target": None, "cond": None},
    0x627c2: {"kind": 'mem', "py": '_wrw(ram, sp, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x627c4: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, sp, 1))', "slot_py": None, "target": None, "cond": None},
    0x627c6: {"kind": 'mem', "py": 'r[4] = s8(_rdw(ram, 0xFFFF8E94, 1))', "slot_py": None, "target": None, "cond": None},
    0x627c8: {"kind": 'reg', "py": 'r[2] = 0xFFFF8E90', "slot_py": None, "target": None, "cond": None},
    0x627ca: {"kind": 'reg', "py": 'r[4] = (r[4] - r[3]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x627cc: {"kind": 'mem', "py": 'r[1] = s8(_rdw(ram, r[2], 1))', "slot_py": None, "target": None, "cond": None},
    0x627ce: {"kind": 'reg', "py": 'r[4] = (r[4] + r[1]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x627d0: {"kind": 'reg', "py": 'r[1] = 0x00002420', "slot_py": None, "target": None, "cond": None},
    0x627d2: {"kind": "call", "py": None, "slot_py": '', "target": 0x2420, "ret_pc": 0x627d6, "set_pr": True, "cond": None},
    0x627d6: {"kind": 'reg', "py": 'r[3] = 0xFFFF8E90', "slot_py": None, "target": None, "cond": None},
    0x627d8: {"kind": 'reg', "py": 'r[2] = 0x00002420', "slot_py": None, "target": None, "cond": None},
    0x627da: {"kind": 'mem', "py": '_wrw(ram, 0xFFFF8E90, 2, r[0])', "slot_py": None, "target": None, "cond": None},
    0x627dc: {"kind": "call", "py": None, "slot_py": 'r[4] = s8(_rdw(ram, sp, 1))', "target": 0x2420, "ret_pc": 0x627e0, "set_pr": True, "cond": None},
    0x627e0: {"kind": 'reg', "py": 'r[3] = 0xFFFF8E94', "slot_py": None, "target": None, "cond": None},
    0x627e2: {"kind": 'mem', "py": '_wrw(ram, r[3], 2, r[0])', "slot_py": None, "target": None, "cond": None},
    0x627e4: {"kind": 'reg', "py": 'r[15] = (r[15] + s8(0x04)) & 0xFFFFFFFF\nsp = (sp + s8(0x04)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x627e6: {"kind": 'st', "py": 'pr = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x627e8: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},
