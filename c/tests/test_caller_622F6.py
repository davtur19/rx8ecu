#!/usr/bin/env python3
"""Differential test for caller_622F6 (entry 0x622F6) — v8 ST caller (CFG), 32 bytes.
...
Run: python3 test_caller_622F6.py
"""
...
CODE = {
    0x622f6: {"kind": 'st', "py": 'local[0x3FC] = pr\n_wrw(ram, STACK_BASE + 0x3FC, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x622f8: {"kind": 'reg', "py": 'r[3] = 0xFFFF87AC', "slot_py": None, "target": None, "cond": None},
    0x622fa: {"kind": 'mem', "py": 'r[4] = s16(_rdw(ram, 0xFFFF87AC, 2))', "slot_py": None, "target": None, "cond": None},
    0x622fc: {"kind": 'reg', "py": 'r[1] = 0x0000FFFF', "slot_py": None, "target": None, "cond": None},
    0x622fe: {"kind": 'reg', "py": 'r[2] = r[4] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x62300: {"kind": 'reg', "py": 'T = 1 if s32(r[2]) >= s32(r[1]) else 0', "slot_py": None, "target": None, "cond": None},
    0x62302: {"kind": "branch", "py": None, "slot_py": '', "target": 0x62308, "cond": 'T'},
    0x62306: {"kind": 'reg', "py": 'r[4] = (r[4] + s8(0x01)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x62308: {"kind": 'reg', "py": 'r[3] = 0x00002430', "slot_py": None, "target": None, "cond": None},
    0x6230a: {"kind": "call", "py": None, "slot_py": '', "target": 0x2430, "ret_pc": 0x6230e, "set_pr": True, "cond": None},
    0x6230e: {"kind": 'reg', "py": 'r[2] = 0xFFFF87AC', "slot_py": None, "target": None, "cond": None},
    0x62310: {"kind": 'st', "py": 'pr = _rdw(ram, STACK_BASE + 0x3FC, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x62312: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFF87AC, 4, r[0])', "target": None, "cond": None},
