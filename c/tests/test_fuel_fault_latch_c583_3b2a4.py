#!/usr/bin/env python3
"""Differential test for fuel_fault_latch_c583 (0x3B2A4) — v3 lift (branches + delay slots), 62 bytes.
...
Run from repo root: python3 c/tests/test_fuel_fault_latch_c583_3b2a4.py
"""
...
ENTRY = 0x3B2A4
RAW = bytes.fromhex("D4 41 93 74 60 31 60 0D 92 72 20 29 96 71 20 08 D5 3E 00 29 CA 01 88 01 03 29 24 30 63 50 23 38 8F 08 00 09 60 40 60 0C 88 01 8F 03 00 09 E2 01 A0 02 26 20 E1 00 26 10 63 40 00 0B 25 30")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFF726
SPAN_END = 0x3B2E2
SENT = 0x3B2E2     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x3b2a4: {"kind": 'reg', "py": 'r[4] = 0xFFFFCF90', "slot_py": None, "target": None, "cond": None},
    0x3b2a6: {"kind": 'reg', "py": 'r[3] = 0xFFFFF726', "slot_py": None, "target": None, "cond": None},
    0x3b2a8: {"kind": 'mem', "py": 'r[0] = s16(_rdw(ram, 0xFFFFF726, 2))', "slot_py": None, "target": None, "cond": None},
    0x3b2aa: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x3b2ac: {"kind": 'reg', "py": 'r[2] = 0x00000800', "slot_py": None, "target": None, "cond": None},
    0x3b2ae: {"kind": 'reg', "py": 'r[0] = (r[0] & r[2]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x3b2b0: {"kind": 'reg', "py": 'r[6] = 0xFFFFC583', "slot_py": None, "target": None, "cond": None},
    0x3b2b2: {"kind": 'reg', "py": 'T = 1 if (r[0] & r[0]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x3b2b4: {"kind": 'reg', "py": 'r[5] = 0xFFFFCF91', "slot_py": None, "target": None, "cond": None},
    0x3b2b6: {"kind": 'reg', "py": 'r[0] = T;', "slot_py": None, "target": None, "cond": None},
    0x3b2b8: {"kind": 'reg', "py": 'r[0] = (r[0] ^ 0x01) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x3b2ba: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x3b2bc: {"kind": 'reg', "py": 'r[3] = T;', "slot_py": None, "target": None, "cond": None},
    0x3b2be: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCF90, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x3b2c0: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFCF91, 1))', "slot_py": None, "target": None, "cond": None},
    0x3b2c2: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x3b2c4: {"kind": "branch", "py": None, "slot_py": '', "target": 0x3b2d8, "cond": 'notT'},
    0x3b2c8: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCF90, 1))', "slot_py": None, "target": None, "cond": None},
    0x3b2ca: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x3b2cc: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x3b2ce: {"kind": "branch", "py": None, "slot_py": '', "target": 0x3b2d8, "cond": 'notT'},
    0x3b2d2: {"kind": 'reg', "py": 'r[2] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x3b2d4: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFC583, 1, r[2])', "target": 0x3b2dc, "cond": 'always'},
    0x3b2d8: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x3b2da: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC583, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x3b2dc: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, r[4], 1))', "slot_py": None, "target": None, "cond": None},
    0x3b2de: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFCF91, 1, r[3])', "target": None, "cond": None},}
