#!/usr/bin/env python3
"""Differential test for fuel_cut_flag_a56c_set (0xFA0A) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_fuel_cut_flag_a56c_set_fa0a.py
"""
...
ENTRY = 0xFA0A
RAW = bytes.fromhex("E2 01 91 3D 00 0B 21 20")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFA56C
SPAN_END = 0xFA12
SENT = 0xFA12     # stop-sentinel, placed past the literal pool
...
CODE = {
    0xfa0a: {"kind": 'reg', "py": 'r[2] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0xfa0c: {"kind": 'reg', "py": 'r[1] = 0xFFFFA56C', "slot_py": None, "target": None, "cond": None},
    0xfa0e: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFA56C, 1, r[2])', "target": None, "cond": None},}
