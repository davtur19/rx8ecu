#!/usr/bin/env python3
"""Differential test for crank_enable_status_checker (0x1B56C) — v3 lift (branches + delay slots), 40 bytes.
...
Run from repo root: python3 c/tests/test_crank_enable_status_checker_1b56c.py
"""
...
CODE = {
    0x1b56c: {"kind": 'reg', "py": 'r[5] = 0xFFFFAAE1', "slot_py": None, "target": None, "cond": None},
    0x1b56e: {"kind": 'reg', "py": 'r[4] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x1b570: {"kind": 'reg', "py": 'r[3] = 0xFFFF9EC8', "slot_py": None, "target": None, "cond": None},
    0x1b572: {"kind": 'mem', "py": 'r[0] = s16(_rdw(ram, 0xFFFF9EC8, 2))', "slot_py": None, "target": None, "cond": None},
    0x1b574: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x1b576: {"kind": 'reg', "py": 'T = 1 if (r[0] & r[4]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x1b578: {"kind": "branch", "py": None, "slot_py": '', "target": 0x1b580, "cond": 'T'},
    0x1b57c: {"kind": "branch", "py": None, "slot_py": 'r[0] = r[4]', "target": 0x1b582, "cond": 'always'},
    0x1b580: {"kind": 'reg', "py": 'r[0] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x1b582: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x1b584: {"kind": "branch", "py": None, "slot_py": '', "target": 0x1b58c, "cond": 'notT'},
    0x1b588: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFAAE1, 1, r[4])', "target": 0x1b590, "cond": 'always'},
    0x1b58c: {"kind": 'reg', "py": 'r[2] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x1b58e: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFAAE1, 1, r[2])', "slot_py": None, "target": None, "cond": None},
    0x1b590: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
