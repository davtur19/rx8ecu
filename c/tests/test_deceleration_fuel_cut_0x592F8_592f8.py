#!/usr/bin/env python3
"""Differential test for deceleration_fuel_cut_0x592F8 (0x592F8) — v3 lift (branches + delay slots), 18 bytes.
...
Run from repo root: python3 c/tests/test_deceleration_fuel_cut_0x592F8_592f8.py
"""
...
CODE = {
    0x592f8: {"kind": 'reg', "py": 'r[2] = 0xFFFFD081', "slot_py": None, "target": None, "cond": None},
    0x592fa: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFD081, 1))', "slot_py": None, "target": None, "cond": None},
    0x592fc: {"kind": 'reg', "py": 'r[1] = 0xFFFFD271', "slot_py": None, "target": None, "cond": None},
    0x592fe: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD271, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x59300: {"kind": 'reg', "py": 'r[3] = 0xFFFFD082', "slot_py": None, "target": None, "cond": None},
    0x59302: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFD082, 1))', "slot_py": None, "target": None, "cond": None},
    0x59304: {"kind": 'reg', "py": 'r[2] = 0xFFFFD272', "slot_py": None, "target": None, "cond": None},
    0x59306: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFD272, 1, r[0])', "target": None, "cond": None},}
