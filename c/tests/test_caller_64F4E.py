#!/usr/bin/env python3
"""Differential test for caller_64F4E (entry 0x64F4E) — v8 ST caller (CFG), 26 bytes.
...
Run: python3 test_caller_64F4E.py
"""
...
CODE = {
    0x64f4e: {"kind": 'st', "py": 'local[0x3FC] = pr\n_wrw(ram, STACK_BASE + 0x3FC, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x64f50: {"kind": 'reg', "py": 'r[3] = 0x00002420', "slot_py": None, "target": None, "cond": None},
    0x64f52: {"kind": "call", "py": None, "slot_py": 'r[4] = s8(0x00)', "target": 0x2420, "ret_pc": 0x64f56, "set_pr": True, "cond": None},
    0x64f56: {"kind": 'reg', "py": 'r[2] = 0xFFFF8EA0', "slot_py": None, "target": None, "cond": None},
    0x64f58: {"kind": 'reg', "py": 'r[3] = 0x00002420', "slot_py": None, "target": None, "cond": None},
    0x64f5a: {"kind": 'mem', "py": '_wrw(ram, 0xFFFF8EA0, 2, r[0])', "slot_py": None, "target": None, "cond": None},
    0x64f5c: {"kind": "call", "py": None, "slot_py": 'r[4] = s8(0x00)', "target": 0x2420, "ret_pc": 0x64f60, "set_pr": True, "cond": None},
    0x64f60: {"kind": 'reg', "py": 'r[2] = 0xFFFF8EA2', "slot_py": None, "target": None, "cond": None},
    0x64f62: {"kind": 'st', "py": 'pr = _rdw(ram, STACK_BASE + 0x3FC, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x64f64: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFF8EA2, 2, r[0])', "target": None, "cond": None},
