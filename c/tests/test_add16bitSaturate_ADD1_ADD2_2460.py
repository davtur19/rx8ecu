#!/usr/bin/env python3
"""Differential test for add16bitSaturate_ADD1_ADD2 (0x2460) — pure straight-line lift, 10 bytes.
...
Run from repo root: python3 c/tests/test_add16bitSaturate_ADD1_ADD2_2460.py
"""
...
ENTRY = 0x2460
RAW = bytes.fromhex("64 4D 65 5D 34 5C D5 03 34 52")
SEED = 42
N = 2000
