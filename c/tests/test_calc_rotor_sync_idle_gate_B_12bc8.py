#!/usr/bin/env python3
"""Differential test for calc_rotor_sync_idle_gate_B (0x12BC8) — v3 lift (branches + delay slots), 14 bytes.
...
Run from repo root: python3 c/tests/test_calc_rotor_sync_idle_gate_B_12bc8.py
"""
...
ENTRY = 0x12BC8
RAW = bytes.fromhex("36 2C 24 60 D3 1E 23 50 D2 1E 00 0B 22 70")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
CODE = {
    ...
    0x12bca: {"kind": 'mem', "py": '_wrw(ram, r[4], 1, r[6])', "slot_py": None, "target": None, "cond": None},
