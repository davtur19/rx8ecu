#!/usr/bin/env python3
"""Differential test for fuel_control_26374 (0x26374) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_fuel_control_26374_26374.py
"""
...
ENTRY = 0x26374
RAW = bytes.fromhex("90 02 E1 01 00 0B 20 10")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFB5F8
SPAN_END = 0x2637C
SENT = 0x2637E     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x26374: {"kind": 'reg', "py": 'r[0] = 0xFFFFB5F8', "slot_py": None, "target": None, "cond": None},
    0x26376: {"kind": 'reg', "py": 'r[1] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x26378: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFB5F8, 1, r[1])', "target": None, "cond": None},}
