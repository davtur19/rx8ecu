#!/usr/bin/env python3
"""Differential test for FUN_00050eb8 (0x50EB8) — mem lift (RAM-only, straight-line), 8 bytes.
...
Run from repo root: python3 c/tests/test_FUN_00050eb8_50eb8.py
"""
...
ENTRY = 0x50EB8
RAW = bytes.fromhex("00 09 93 25 62 31 62 2D")
SEED = 42
N = 2000
