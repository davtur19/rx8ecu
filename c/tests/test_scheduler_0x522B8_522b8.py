#!/usr/bin/env python3
"""Differential test for scheduler_0x522B8 (0x522B8) — v3 lift + v4 FPU, 24 bytes.
...
Run from repo root: python3 c/tests/test_scheduler_0x522B8_522b8.py
"""
...
ENTRY = 0x522B8
RAW = bytes.fromhex("93 13 60 30 60 0C 88 01 8F 04 00 09 92 07 F3 28 91 0A F1 3A 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFD11C
SPAN_END = 0x522D0
SENT = 0x522D0     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x522b8: {"kind": 'reg', "py": 'r[3] = 0xFFFFCFC2', "slot_py": None, "target": None, "cond": None},
    0x522ba: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCFC2, 1))', "slot_py": None, "target": None, "cond": None},
    0x522bc: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x522be: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x522c0: {"kind": "branch", "py": None, "slot_py": '', "target": 0x522cc, "cond": 'notT'},
    0x522c4: {"kind": 'reg', "py": 'r[2] = 0xFFFFD01C', "slot_py": None, "target": None, "cond": None},
    0x522c6: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFD01C, 4))', "slot_py": None, "target": None, "cond": None},
    0x522c8: {"kind": 'reg', "py": 'r[1] = 0xFFFFD11C', "slot_py": None, "target": None, "cond": None},
    0x522ca: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFD11C, 4, f2bits(fr[3]))', "slot_py": None, "target": None, "cond": None},
    0x522cc: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
