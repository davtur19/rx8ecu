#!/usr/bin/env python3
"""Differential test for caller_26498 (entry 0x26498) — v8 ST caller (CFG), 30 bytes.
...
Run: python3 test_caller_26498.py
"""
...
CODE = {
    0x26498: {"kind": 'st', "py": 'local[0x3FC] = pr\n_wrw(ram, STACK_BASE + 0x3FC, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x2649a: {"kind": 'reg', "py": 'r[0] = 0x000264C0', "slot_py": None, "target": None, "cond": None},
    0x2649c: {"kind": 'reg', "py": 'r[3] = 0x0007519C', "slot_py": None, "target": None, "cond": None},
    0x2649e: {"kind": 'fpu', "py": 'fr[7] = bits2f(_rdw(ram, 0x000264C0, 4))', "slot_py": None, "target": None, "cond": None},
    0x264a0: {"kind": 'fpu', "py": 'fr[6] = bits2f(_rdw(ram, 0x0007519C, 4))', "slot_py": None, "target": None, "cond": None},
    0x264a2: {"kind": 'reg', "py": 'r[2] = 0xFFFFB604', "slot_py": None, "target": None, "cond": None},
    0x264a4: {"kind": 'reg', "py": 'r[1] = 0xFFFFB600', "slot_py": None, "target": None, "cond": None},
    0x264a6: {"kind": 'fpu', "py": 'fr[5] = bits2f(_rdw(ram, 0xFFFFB604, 4))', "slot_py": None, "target": None, "cond": None},
    0x264a8: {"kind": 'reg', "py": 'r[3] = 0x000023B0', "slot_py": None, "target": None, "cond": None},
    0x264aa: {"kind": "call", "py": None, "slot_py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFB600, 4))', "target": 0x23b0, "ret_pc": 0x264ae, "set_pr": True, "cond": None},
    0x264ae: {"kind": 'reg', "py": 'r[2] = 0xFFFFB604', "slot_py": None, "target": None, "cond": None},
    0x264b0: {"kind": 'st', "py": 'pr = _rdw(ram, STACK_BASE + 0x3FC, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x264b2: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFB604, 4, f2bits(fr[0]))', "target": None, "cond": None},
