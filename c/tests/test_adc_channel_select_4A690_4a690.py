#!/usr/bin/env python3
"""Differential test for adc_channel_select_4A690 (0x4A690) — v3 lift + v4 FPU, 10 bytes.
...
Run from repo root: python3 c/tests/test_adc_channel_select_4A690_4a690.py
"""
...
ENTRY = 0x4A690
RAW = bytes.fromhex("93 5F F3 38 D2 33 00 0B F2 3A")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCD94
SPAN_END = 0x4A69A
SENT = 0x4A69A     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x4a690: {"kind": 'reg', "py": 'r[3] = 0xFFFFAD98', "slot_py": None, "target": None, "cond": None},
    0x4a692: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFAD98, 4))', "slot_py": None, "target": None, "cond": None},
    0x4a694: {"kind": 'reg', "py": 'r[2] = 0xFFFFCD94', "slot_py": None, "target": None, "cond": None},
    0x4a696: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFCD94, 4, f2bits(fr[3]))', "target": None, "cond": None},}
