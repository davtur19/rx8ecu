#!/usr/bin/env python3
"""Differential test for fuel_control_5a214 (0x5A214) — v3 lift (branches + delay slots), 52 bytes.
...
Run from repo root: python3 c/tests/test_fuel_control_5a214_5a214.py
"""
...
CODE = {
    0x5a214: {"kind": 'reg', "py": 'r[4] = 0xFFFFD299', "slot_py": None, "target": None, "cond": None},
    0x5a216: {"kind": 'reg', "py": 'r[3] = 0xFFFFD29D', "slot_py": None, "target": None, "cond": None},
    0x5a218: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFD29D, 1))', "slot_py": None, "target": None, "cond": None},
    0x5a21a: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x5a21c: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x5a21e: {"kind": "branch", "py": None, "slot_py": '', "target": 0x5a23a, "cond": 'T'},
    0x5a222: {"kind": 'reg', "py": 'r[2] = 0xFFFFD2A2', "slot_py": None, "target": None, "cond": None},
    0x5a224: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFD2A2, 1))', "slot_py": None, "target": None, "cond": None},
    0x5a226: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x5a228: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x5a22a: {"kind": "branch", "py": None, "slot_py": '', "target": 0x5a23a, "cond": 'T'},
    0x5a22e: {"kind": 'reg', "py": 'r[1] = 0xFFFFD2AB', "slot_py": None, "target": None, "cond": None},
    0x5a230: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFD2AB, 1))', "slot_py": None, "target": None, "cond": None},
    0x5a232: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x5a234: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x5a236: {"kind": "branch", "py": None, "slot_py": '', "target": 0x5a240, "cond": 'notT'},
    0x5a23a: {"kind": 'reg', "py": 'r[2] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x5a23c: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFD299, 1, r[2])', "target": 0x5a244, "cond": 'always'},
    0x5a240: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x5a242: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD299, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x5a244: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
