#!/usr/bin/env python3
"""Differential test for faultEnableStatus2 (0x5E2BC) — v3 lift (branches + delay slots), 18 bytes.
...
Run from repo root: python3 c/tests/test_faultEnableStatus2_5e2bc.py
"""
...
ENTRY = 0x5E2BC
RAW = bytes.fromhex("D0 0D 65 5C 64 4D 03 4C 63 3C 23 58 04 29 00 0B 60 43")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = None
SPAN_END = 0x5E2CE
SENT = 0x5E2CE     # stop-sentinel, placed past the literal pool
