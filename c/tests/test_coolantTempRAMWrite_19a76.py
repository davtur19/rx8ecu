#!/usr/bin/env python3
"""Differential test for coolantTempRAMWrite (0x19A76) — v3 lift + v4 FPU, 10 bytes.
...
Run from repo root: python3 c/tests/test_coolantTempRAMWrite_19a76.py
"""
...
RAM_MAX = 0xFFFFA9F8
SPAN_END = 0x19A80
SENT = 0x19A80     # stop-sentinel, placed past the literal pool
