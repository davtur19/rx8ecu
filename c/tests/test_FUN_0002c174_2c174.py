#!/usr/bin/env python3
"""Differential test for FUN_0002c174 (0x2C174) — v3 lift (branches + delay slots), 48 bytes.
...
Run from repo root: python3 c/tests/test_FUN_0002c174_2c174.py
"""
...
ENTRY = 0x2C174
RAW = bytes.fromhex("63 4D 43 15 8F 02 00 09 34 0C 25 41 D5 12 D2 16 63 20 63 3C 33 70 8D 02 00 09 A0 07 25 61 64 51 63 4D 43 15 8F 02 00 09 34 0C 25 41 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBC5C
SPAN_END = 0x2C1A4
SENT = 0x2C1A4     # stop-sentinel, placed past the literal pool
...
CODE = {
    ...
    0x2c17e: {"kind": 'mem', "py": '_wrw(ram, r[5], 2, r[4])', "slot_py": None, "target": None, "cond": None},
