#!/usr/bin/env python3
"""Differential test for math_conditional_27df4 (0x27DF4) — v3 lift + v4 FPU, 50 bytes.
...
Run from repo root: python3 c/tests/test_math_conditional_27df4_27df4.py
"""
...
ENTRY = 0x27DF4
RAW = bytes.fromhex("94 17 D3 11 92 16 F3 38 F2 28 F3 25 8D 0D 00 09 D1 0E 60 11 20 08 8D 05 00 09 D0 0A 62 01 22 28 8F 03 00 09 E1 01 A0 02 24 10 E2 00 24 20 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFB716
SPAN_END = 0x27E26
SENT = 0x27E44     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x27df4: {"kind": 'reg', "py": 'r[4] = 0xFFFFB70C', "slot_py": None, "target": None, "cond": None},
    0x27df6: {"kind": 'reg', "py": 'r[3] = 0x00075980', "slot_py": None, "target": None, "cond": None},
    0x27df8: {"kind": 'reg', "py": 'r[2] = 0xFFFFB600', "slot_py": None, "target": None, "cond": None},
    0x27dfa: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x00075980, 4))', "slot_py": None, "target": None, "cond": None},
    0x27dfc: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0xFFFFB600, 4))', "slot_py": None, "target": None, "cond": None},
    0x27dfe: {"kind": 'fpu', "py": 'T = 1 if fr[3] > fr[2] else 0', "slot_py": None, "target": None, "cond": None},
    0x27e00: {"kind": "branch", "py": None, "slot_py": '', "target": 0x27e1e, "cond": 'T'},
    0x27e04: {"kind": 'reg', "py": 'r[1] = 0xFFFFB714', "slot_py": None, "target": None, "cond": None},
    0x27e06: {"kind": 'mem', "py": 'r[0] = s16(_rdw(ram, 0xFFFFB714, 2))', "slot_py": None, "target": None, "cond": None},
    0x27e08: {"kind": 'reg', "py": 'T = 1 if (r[0] & r[0]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x27e0a: {"kind": "branch", "py": None, "slot_py": '', "target": 0x27e18, "cond": 'T'},
    0x27e0e: {"kind": 'reg', "py": 'r[0] = 0xFFFFB716', "slot_py": None, "target": None, "cond": None},
    0x27e10: {"kind": 'mem', "py": 'r[2] = s16(_rdw(ram, 0xFFFFB716, 2))', "slot_py": None, "target": None, "cond": None},
    0x27e12: {"kind": 'reg', "py": 'T = 1 if (r[2] & r[2]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x27e14: {"kind": "branch", "py": None, "slot_py": '', "target": 0x27e1e, "cond": 'notT'},
    0x27e18: {"kind": 'reg', "py": 'r[1] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x27e1a: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFB70C, 1, r[1])', "target": 0x27e22, "cond": 'always'},
    0x27e1e: {"kind": 'reg', "py": 'r[2] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x27e20: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFB70C, 1, r[2])', "slot_py": None, "target": None, "cond": None},
    0x27e22: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
