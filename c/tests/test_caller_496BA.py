#!/usr/bin/env python3
"""Differential test for caller_496BA (entry 0x496BA) — v8 ST caller (CFG), 40 bytes.
...
Run: python3 test_caller_496BA.py
"""
...
CODE = {
    0x496ba: {"kind": 'mem', "py": 'local[0x3FC] = r[14]\n_wrw(ram, STACK_BASE + 0x3FC, 4, r[14])\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x496bc: {"kind": 'st', "py": 'local[0x3F8] = pr\n_wrw(ram, STACK_BASE + 0x3F8, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x496be: {"kind": 'reg', "py": 'r[14] = 0xFFFFCCF8', "slot_py": None, "target": None, "cond": None},
    0x496c0: {"kind": 'reg', "py": 'r[3] = 0xFFFFCCFD', "slot_py": None, "target": None, "cond": None},
    0x496c2: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCCFD, 1))', "slot_py": None, "target": None, "cond": None},
    0x496c4: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x496c6: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x496c8: {"kind": "branch", "py": None, "slot_py": '', "target": 0x496d8, "cond": 'notT'},
    0x496cc: {"kind": 'reg', "py": 'r[1] = 0x00002460', "slot_py": None, "target": None, "cond": None},
    0x496ce: {"kind": 'reg', "py": 'r[5] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x496d0: {"kind": "call", "py": None, "slot_py": 'r[4] = s16(_rdw(ram, 0xFFFFCCF8, 2))', "target": 0x2460, "ret_pc": 0x496d4, "set_pr": True, "cond": None},
    0x496d4: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFCCF8, 2, r[0])', "target": 0x496dc, "cond": 'always'},
    0x496d8: {"kind": 'reg', "py": 'r[2] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x496da: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCCF8, 2, r[2])', "slot_py": None, "target": None, "cond": None},
    0x496dc: {"kind": 'st', "py": 'pr = _rdw(ram, STACK_BASE + 0x3F8, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x496de: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, STACK_BASE + 0x3FC, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},
