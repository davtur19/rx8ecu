#!/usr/bin/env python3
"""Differential test for call-composition caller_474FA (entry 0x474FA) — v7 ST caller + callee lib, flattened CODE with nested returns.
...
Run: python3 /home/davide/ailocal/rx8ecu/c/tests/test_caller_474FA.py
"""
...
CODE = {
    0x474fa: {"kind": 'reg', "py": 'r[4] = 0xFFFF876C', "slot_py": None, "target": None, "cond": None},
    0x474fc: {"kind": 'reg', "py": 'r[3] = 0x0003EE58', "slot_py": None, "target": None, "cond": None},
    0x474fe: {"kind": "call", "py": None, "slot_py": 'r[5] = s8(0x00)', "target": 0x3ee58, "ret_pc": 0x47502, "set_pr": False, "cond": None},
