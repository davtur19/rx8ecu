#!/usr/bin/env python3
"""Differential test for calculateFuelAmountPerRotationMinMax (0x317B8) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_calculateFuelAmountPerRotationMinMax_317b8.py
"""
...
ENTRY = 0x317B8
RAW = bytes.fromhex("E1 00 24 10 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    ...
    0x317ba: {"kind": 'mem', "py": '_wrw(ram, r[4], 1, r[1])', "slot_py": None, "target": None, "cond": None},
