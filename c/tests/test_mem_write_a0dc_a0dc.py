#!/usr/bin/env python3
"""Differential test for mem_write_a0dc (0xA0DC) — v3 lift (branches + delay slots), 12 bytes.
...
Run from repo root: python3 c/tests/test_mem_write_a0dc_a0dc.py
"""
...
RAM_MAX = 0xFFFFA16C
SPAN_END = 0xA0E8
SENT = 0xA0E8     # stop-sentinel, placed past the literal pool
...
CODE = {
    0xa0dc: {"kind": 'reg', "py": 'r[2] = 0xFFFFA16C', "slot_py": None, "target": None, "cond": None},
    0xa0de: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFA16C, 1, r[4])', "target": None, "cond": None},
    0xa0e2: {"kind": 'reg', "py": 'r[3] = 0xFFFFA16C', "slot_py": None, "target": None, "cond": None},
    0xa0e4: {"kind": "ret", "py": None, "slot_py": 'r[0] = s8(_rdw(ram, 0xFFFFA16C, 1))', "target": None, "cond": None},}
