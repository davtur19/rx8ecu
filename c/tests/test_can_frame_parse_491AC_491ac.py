#!/usr/bin/env python3
"""Differential test for can_frame_parse_491AC (0x491AC) — v3 lift (branches + delay slots), 10 bytes.
...
Run from repo root: python3 c/tests/test_can_frame_parse_491AC_491ac.py
"""
...
ENTRY = 0x491AC
RAW = bytes.fromhex("92 49 63 20 D1 26 00 0B 21 30")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCC81
SPAN_END = 0x491B6
SENT = 0x491B6     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x491ac: {"kind": 'reg', "py": 'r[2] = 0xFFFFAAC6', "slot_py": None, "target": None, "cond": None},
    0x491ae: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFAAC6, 1))', "slot_py": None, "target": None, "cond": None},
    0x491b0: {"kind": 'reg', "py": 'r[1] = 0xFFFFCC81', "slot_py": None, "target": None, "cond": None},
    0x491b2: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFCC81, 1, r[3])', "target": None, "cond": None},}
