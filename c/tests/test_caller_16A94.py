#!/usr/bin/env python3
"""Differential test for caller_16A94 (entry 0x16A94) — v8 ST caller (CFG), 20 bytes.
...
Run: python3 test_caller_16A94.py
"""
...
CODE = {
    0x16a94: {"kind": 'st', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x16a96: {"kind": 'reg', "py": 'r[3] = 0x00016A28', "slot_py": None, "target": None, "cond": None},
    0x16a98: {"kind": "call", "py": None, "slot_py": '', "target": 0x16a28, "ret_pc": 0x16a9c, "set_pr": True, "cond": None},
    0x16a9c: {"kind": 'reg', "py": 'r[2] = 0x00016710', "slot_py": None, "target": None, "cond": None},
    0x16a9e: {"kind": "call", "py": None, "slot_py": '', "target": 0x16710, "ret_pc": 0x16aa2, "set_pr": True, "cond": None},
    0x16aa2: {"kind": 'reg', "py": 'r[3] = 0x00015D78', "slot_py": None, "target": None, "cond": None},
    0x16aa4: {"kind": "call", "py": None, "slot_py": 'pr = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": 0x15d78, "ret_pc": 0x16aa8, "set_pr": False, "cond": None},
    0x15d78: {"kind": 'reg', "py": 'r[2] = 0x0006EAA1', "slot_py": None, "target": None, "cond": None},
    0x15d7a: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0x0006EAA1, 1))', "slot_py": None, "target": None, "cond": None},
    0x15d7c: {"kind": 'reg', "py": 'r[1] = 0xFFFFA894', "slot_py": None, "target": None, "cond": None},
    0x15d7e: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFA894, 1, r[3])', "target": None, "cond": None},
    0x16710: {"kind": 'reg', "py": 'r[2] = 0xFFFFBDD5', "slot_py": None, "target": None, "cond": None},
    0x16712: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFBDD5, 1))', "slot_py": None, "target": None, "cond": None},
    0x16714: {"kind": 'reg', "py": 'r[1] = 0xFFFFA8CF', "slot_py": None, "target": None, "cond": None},
    0x16716: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFA8CF, 1, r[3])', "target": None, "cond": None},
    0x16a28: {"kind": 'reg', "py": 'r[3] = 0xFFFFA8D8', "slot_py": None, "target": None, "cond": None},
    0x16a2a: {"kind": 'fpu', "py": 'fr[3] = 1.0', "slot_py": None, "target": None, "cond": None},
    0x16a2c: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFA8D8, 4, f2bits(fr[3]))', "target": None, "cond": None},
}
