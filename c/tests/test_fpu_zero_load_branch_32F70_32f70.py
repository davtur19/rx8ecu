#!/usr/bin/env python3
"""Differential test for fpu_zero_load_branch_32F70 (0x32F70) — v3 lift (branches + delay slots), 26 bytes.
...
Run from repo root: python3 c/tests/test_fpu_zero_load_branch_32F70_32f70.py
"""
...
ENTRY = 0x32F70
RAW = bytes.fromhex("60 0B 88 01 8F 02 00 09 A0 01 E4 02 E4 03 64 4C D3 1D 44 08 44 08 00 0B 23 40")
SEED = 0
N = 2000
MAXSTEPS = 100000
