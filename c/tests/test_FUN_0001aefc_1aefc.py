#!/usr/bin/env python3
"""Differential test for FUN_0001aefc (0x1AEFC) — v3 lift + v4 FPU, 10 bytes.
...
Run from repo root: python3 c/tests/test_FUN_0001aefc_1aefc.py
"""
...
ENTRY = 0x1AEFC
RAW = bytes.fromhex("D3 25 F3 38 92 43 00 0B F2 3A")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFAABC
SPAN_END = 0x1AF06
SENT = 0x1AF06     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x1aefc: {"kind": 'reg', "py": 'r[3] = 0x0006F7E0', "slot_py": None, "target": None, "cond": None},
    0x1aefe: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x0006F7E0, 4))', "slot_py": None, "target": None, "cond": None},
    0x1af00: {"kind": 'reg', "py": 'r[2] = 0xFFFFAABC', "slot_py": None, "target": None, "cond": None},
    0x1af02: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFAABC, 4, f2bits(fr[3]))', "target": None, "cond": None},}
