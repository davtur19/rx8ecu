#!/usr/bin/env python3
"""Differential test for flag_bb99_gated_a4a6 (0x2B1B6) — v3 lift (branches + delay slots), 38 bytes.
...
Run from repo root: python3 c/tests/test_flag_bb99_gated_a4a6_2b1b6.py
"""
...
ENTRY = 0x2B1B6
RAW = bytes.fromhex("94 41 93 41 60 30 60 0C 88 01 8F 08 00 09 D2 26 61 20 21 18 8D 03 00 09 E3 01 A0 02 24 30 E1 00 24 10 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBB99
SPAN_END = 0x2B1DC
SENT = 0x2B1DC     # stop-sentinel, placed past the literal pool
