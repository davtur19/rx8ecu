#!/usr/bin/env python3
"""Differential test for watchdog_kick_4AC30 (0x4AC30) — v3 lift (branches + delay slots), 10 bytes.
...
Run from repo root: python3 c/tests/test_watchdog_kick_4AC30_4ac30.py
"""
...
CODE = {
    0x4ac30: {"kind": 'reg', "py": 'r[2] = 0xFFFFAADA', "slot_py": None, "target": None, "cond": None},
    0x4ac32: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFAADA, 1))', "slot_py": None, "target": None, "cond": None},
    0x4ac34: {"kind": 'reg', "py": 'r[1] = 0xFFFFCDF5', "slot_py": None, "target": None, "cond": None},
    0x4ac36: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFCDF5, 1, r[3])', "target": None, "cond": None},}
