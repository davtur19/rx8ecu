#!/usr/bin/env python3
"""Differential test for fault_float_copy_cee0 (0x4F5F0) — v3 lift + v4 FPU, 24 bytes.
...
Run from repo root: python3 c/tests/test_fault_float_copy_cee0_4f5f0.py
"""
...
ENTRY = 0x4F5F0
RAW = bytes.fromhex("93 35 60 30 60 0C 88 01 8F 04 00 09 92 2E F3 28 91 2E F1 3A 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCEE0
SPAN_END = 0x4F608
SENT = 0x4F608     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x4f5f0: {"kind": 'reg', "py": 'r[3] = 0xFFFFCD86', "slot_py": None, "target": None, "cond": None},
    0x4f5f2: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCD86, 1))', "slot_py": None, "target": None, "cond": None},
    0x4f5f4: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x4f5f6: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x4f5f8: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4f604, "cond": 'notT'},
    0x4f5fc: {"kind": 'reg', "py": 'r[2] = 0xFFFFCDE0', "slot_py": None, "target": None, "cond": None},
    0x4f5fe: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFCDE0, 4))', "slot_py": None, "target": None, "cond": None},
    0x4f600: {"kind": 'reg', "py": 'r[1] = 0xFFFFCEE0', "slot_py": None, "target": None, "cond": None},
    0x4f602: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFCEE0, 4, f2bits(fr[3]))', "slot_py": None, "target": None, "cond": None},
    0x4f604: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
