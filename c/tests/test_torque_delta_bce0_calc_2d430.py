#!/usr/bin/env python3
"""Differential test for torque_delta_bce0_calc (0x2D430) — v3 lift + v4 FPU, 16 bytes.
...
Run from repo root: python3 c/tests/test_torque_delta_bce0_calc_2d430.py
"""
...
ENTRY = 0x2D430
RAW = bytes.fromhex("93 7A F3 38 91 79 F2 18 92 78 F2 31 00 0B F2 2A")
SEED = 43
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBCE4
SPAN_END = 0x2D440
SENT = 0x2D440     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x2d430: {"kind": 'reg', "py": 'r[3] = 0xFFFFBCE4', "slot_py": None, "target": None, "cond": None},
    0x2d432: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFBCE4, 4))', "slot_py": None, "target": None, "cond": None},
    0x2d434: {"kind": 'reg', "py": 'r[1] = 0xFFFFBCDC', "slot_py": None, "target": None, "cond": None},
    0x2d436: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0xFFFFBCDC, 4))', "slot_py": None, "target": None, "cond": None},
    0x2d438: {"kind": 'reg', "py": 'r[2] = 0xFFFFBCE0', "slot_py": None, "target": None, "cond": None},
    0x2d43a: {"kind": 'fpu', "py": 'fr[2] = ts(fr[2] - fr[3])', "slot_py": None, "target": None, "cond": None},
    0x2d43c: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBCE0, 4, f2bits(fr[2]))', "target": None, "cond": None},}
