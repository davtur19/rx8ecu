#!/usr/bin/env python3
"""Differential test for float_copy_b594_to_b5a0 (0x25708) — v3 lift + v4 FPU, 26 bytes.
...
Run from repo root: python3 c/tests/test_float_copy_b594_to_b5a0_25708.py
"""
...
ENTRY = 0x25708
RAW = bytes.fromhex("94 7D F4 8D 92 7D F3 48 93 7A F3 3A F2 4A F3 48 91 78 F1 3A D3 3E 00 0B F3 4A")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFB5AC
SPAN_END = 0x25722
SENT = 0x25722     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x25708: {"kind": 'reg', "py": 'r[4] = 0xFFFFB594', "slot_py": None, "target": None, "cond": None},
    0x2570a: {"kind": 'fpu', "py": 'fr[4] = 0.0', "slot_py": None, "target": None, "cond": None},
    0x2570c: {"kind": 'reg', "py": 'r[2] = 0xFFFFB598', "slot_py": None, "target": None, "cond": None},
    0x2570e: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, r[4], 4))', "slot_py": None, "target": None, "cond": None},
    0x25710: {"kind": 'reg', "py": 'r[3] = 0xFFFFB59C', "slot_py": None, "target": None, "cond": None},
    0x25712: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFB59C, 4, f2bits(fr[3]))', "slot_py": None, "target": None, "cond": None},
    0x25714: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFB598, 4, f2bits(fr[4]))', "slot_py": None, "target": None, "cond": None},
    0x25716: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, r[4], 4))', "slot_py": None, "target": None, "cond": None},
    0x25718: {"kind": 'reg', "py": 'r[1] = 0xFFFFB5A0', "slot_py": None, "target": None, "cond": None},
    0x2571a: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFB5A0, 4, f2bits(fr[3]))', "slot_py": None, "target": None, "cond": None},
    0x2571c: {"kind": 'reg', "py": 'r[3] = 0xFFFFB5AC', "slot_py": None, "target": None, "cond": None},
    0x2571e: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFB5AC, 4, f2bits(fr[4]))', "target": None, "cond": None},}
