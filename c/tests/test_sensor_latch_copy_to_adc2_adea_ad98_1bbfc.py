#!/usr/bin/env python3
"""Differential test for sensor_latch_copy_to_adc2_adea_ad98 (0x1BBFC) — v3 lift + v4 FPU, 26 bytes.
...
Run from repo root: python3 c/tests/test_sensor_latch_copy_to_adc2_adea_ad98_1bbfc.py
"""
...
ENTRY = 0x1BBFC
RAW = bytes.fromhex("D3 20 62 31 91 36 21 21 D0 1F 63 01 D2 1F 22 31 D1 1F F3 18 93 2F 00 0B F3 3A")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFADEA
SPAN_END = 0x1BC16
SENT = 0x1BC16     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x1bbfc: {"kind": 'reg', "py": 'r[3] = 0xFFFF9F0A', "slot_py": None, "target": None, "cond": None},
    0x1bbfe: {"kind": 'mem', "py": 'r[2] = s16(_rdw(ram, 0xFFFF9F0A, 2))', "slot_py": None, "target": None, "cond": None},
    0x1bc00: {"kind": 'reg', "py": 'r[1] = 0xFFFFADC2', "slot_py": None, "target": None, "cond": None},
    0x1bc02: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFADC2, 2, r[2])', "slot_py": None, "target": None, "cond": None},
    0x1bc04: {"kind": 'reg', "py": 'r[0] = 0xFFFFA224', "slot_py": None, "target": None, "cond": None},
    0x1bc06: {"kind": 'mem', "py": 'r[3] = s16(_rdw(ram, 0xFFFFA224, 2))', "slot_py": None, "target": None, "cond": None},
    0x1bc08: {"kind": 'reg', "py": 'r[2] = 0xFFFFADEA', "slot_py": None, "target": None, "cond": None},
    0x1bc0a: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFADEA, 2, r[3])', "slot_py": None, "target": None, "cond": None},
    0x1bc0c: {"kind": 'reg', "py": 'r[1] = 0xFFFFA21C', "slot_py": None, "target": None, "cond": None},
    0x1bc0e: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFA21C, 4))', "slot_py": None, "target": None, "cond": None},
    0x1bc10: {"kind": 'reg', "py": 'r[3] = 0xFFFFAD98', "slot_py": None, "target": None, "cond": None},
    0x1bc12: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFAD98, 4, f2bits(fr[3]))', "target": None, "cond": None},}
