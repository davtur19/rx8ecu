#!/usr/bin/env python3
"""Differential test for timing_control_update_0x4F38C (0x4F38C) — v3 lift (branches + delay slots), 28 bytes.
...
Run from repo root: python3 c/tests/test_timing_control_update_0x4F38C_4f38c.py
"""
...
CODE = {
    0x4f38c: {"kind": 'reg', "py": 'r[4] = 0xFFFFD003', "slot_py": None, "target": None, "cond": None},
    0x4f38e: {"kind": 'reg', "py": 'r[3] = 0xFFFFD006', "slot_py": None, "target": None, "cond": None},
    0x4f390: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFD006, 1))', "slot_py": None, "target": None, "cond": None},
    0x4f392: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x4f394: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x4f396: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4f3a0, "cond": 'notT'},
    0x4f39a: {"kind": 'reg', "py": 'r[1] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x4f39c: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFD003, 1, r[1])', "target": 0x4f3a4, "cond": 'always'},
    0x4f3a0: {"kind": 'reg', "py": 'r[0] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x4f3a2: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD003, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x4f3a4: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
