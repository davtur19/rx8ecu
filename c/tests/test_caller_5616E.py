#!/usr/bin/env python3
"""Differential test for caller_5616E (entry 0x5616E) — v8 ST caller (CFG), 22 bytes.
...
Run: python3 test_caller_5616E.py
"""
...
CODE = {
    0x5616e: {"kind": 'fpu', "py": 'fr[6] = 0.0', "slot_py": None, "target": None, "cond": None},
    0x56170: {"kind": 'reg', "py": 'r[0] = 0x0005625C', "slot_py": None, "target": None, "cond": None},
    0x56172: {"kind": 'st', "py": 'local[0x3FC] = pr\n_wrw(ram, STACK_BASE + 0x3FC, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x56174: {"kind": 'reg', "py": 'r[3] = 0xFFFFB600', "slot_py": None, "target": None, "cond": None},
    0x56176: {"kind": 'fpu', "py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFB600, 4))', "slot_py": None, "target": None, "cond": None},
    0x56178: {"kind": 'reg', "py": 'r[2] = 0x00002490', "slot_py": None, "target": None, "cond": None},
    0x5617a: {"kind": "call", "py": None, "slot_py": 'fr[5] = bits2f(_rdw(ram, 0x0005625C, 4))', "target": 0x2490, "ret_pc": 0x5617e, "set_pr": True, "cond": None},
    0x5617e: {"kind": 'st', "py": 'pr = _rdw(ram, STACK_BASE + 0x3FC, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x56180: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},
