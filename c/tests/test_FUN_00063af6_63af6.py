#!/usr/bin/env python3
"""Differential test for FUN_00063af6 (0x63AF6) — pure straight-line lift, 16 bytes.
...
Run from repo root: python3 c/tests/test_FUN_00063af6_63af6.py
"""
...
ENTRY = 0x63AF6
RAW = bytes.fromhex("E5 00 D6 6A E1 15 67 53 63 53 43 08 43 08 33 6C")
SEED = 42
N = 2000
