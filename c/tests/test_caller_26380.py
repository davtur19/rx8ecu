#!/usr/bin/env python3
"""Differential test for caller_26380 (entry 0x26380) — v8 ST caller (CFG), 14 bytes.
...
Run: python3 test_caller_26380.py
"""
...
CODE = {
    0x26380: {"kind": 'st', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x26382: {"kind": 'reg', "py": 'r[3] = 0x0002636C', "slot_py": None, "target": None, "cond": None},
    0x26384: {"kind": "call", "py": None, "slot_py": '', "target": 0x2636c, "ret_pc": 0x26388, "set_pr": True, "cond": None},
    0x26388: {"kind": 'reg', "py": 'r[2] = 0x000263C4', "slot_py": None, "target": None, "cond": None},
    0x2638a: {"kind": "call", "py": None, "slot_py": 'pr = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": 0x263c4, "ret_pc": 0x2638e, "set_pr": False, "cond": None},
    0x2636c: {"kind": 'reg', "py": 'r[2] = 0xFFFFB5F8', "slot_py": None, "target": None, "cond": None},
    0x2636e: {"kind": 'reg', "py": 'r[3] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x26370: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFB5F8, 1, r[3])', "target": None, "cond": None},
    0x263c4: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},
}
