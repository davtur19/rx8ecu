#!/usr/bin/env python3
"""Differential test for sensor_machine_297ba (0x297BA) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_sensor_machine_297ba_297ba.py
"""
...
ENTRY = 0x297BA
RAW = bytes.fromhex("34 6C 25 41 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
