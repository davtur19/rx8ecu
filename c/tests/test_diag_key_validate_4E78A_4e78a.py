#!/usr/bin/env python3
"""Differential test for diag_key_validate_4E78A (0x4E78A) — v3 lift (branches + delay slots), 60 bytes.
...
Run from repo root: python3 c/tests/test_diag_key_validate_4E78A_4e78a.py
"""
...
ENTRY = 0x4E78A
RAW = bytes.fromhex("96 4F 93 4F 65 60 60 30 60 0C 88 01 8F 02 E4 01 91 49 21 40 93 48 60 30 60 0C 88 01 8F 01 65 5C 26 40 25 58 8F 08 00 09 93 3B 60 30 60 0C 88 01 8F 02 00 09 D3 22 23 40 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    0x4e78a: {"kind": 'reg', "py": 'r[6] = 0xFFFFCF82', "slot_py": None, "target": None, "cond": None},
    0x4e78c: {"kind": 'reg', "py": 'r[3] = 0xFFFFC020', "slot_py": None, "target": None, "cond": None},
    0x4e78e: {"kind": 'mem', "py": 'r[5] = s8(_rdw(ram, 0xFFFFCF82, 1))', "slot_py": None, "target": None, "cond": None},
    0x4e790: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFC020, 1))', "slot_py": None, "target": None, "cond": None},
    0x4e792: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x4e794: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x4e796: {"kind": "branch", "py": None, "slot_py": 'r[4] = s8(0x01)', "target": 0x4e79e, "cond": 'notT'},
    0x4e79a: {"kind": 'reg', "py": 'r[1] = 0xFFFFCF81', "slot_py": None, "target": None, "cond": None},
    0x4e79c: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCF81, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x4e79e: {"kind": 'reg', "py": 'r[3] = 0xFFFFC01E', "slot_py": None, "target": None, "cond": None},
    0x4e7a0: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFC01E, 1))', "slot_py": None, "target": None, "cond": None},
    0x4e7a2: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x4e7a4: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x4e7a6: {"kind": "branch", "py": None, "slot_py": 'r[5] = r[5] & 0xFF', "target": 0x4e7ac, "cond": 'notT'},
    0x4e7aa: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCF82, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x4e7ac: {"kind": 'reg', "py": 'T = 1 if (r[5] & r[5]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x4e7ae: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4e7c2, "cond": 'notT'},
    0x4e7b2: {"kind": 'reg', "py": 'r[3] = 0xFFFFCF82', "slot_py": None, "target": None, "cond": None},
    0x4e7b4: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCF82, 1))', "slot_py": None, "target": None, "cond": None},
    0x4e7b6: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x4e7b8: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x4e7ba: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4e7c2, "cond": 'notT'},
    0x4e7be: {"kind": 'reg', "py": 'r[3] = 0xFFFFCFAC', "slot_py": None, "target": None, "cond": None},
    0x4e7c0: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCFAC, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x4e7c2: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
