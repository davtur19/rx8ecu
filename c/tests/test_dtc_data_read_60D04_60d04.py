#!/usr/bin/env python3
"""Differential test for dtc_data_read_60D04 (0x60D04) — v3 lift (branches + delay slots), 12 bytes.
...
Run from repo root: python3 c/tests/test_dtc_data_read_60D04_60d04.py
"""
...
ENTRY = 0x60D04
RAW = bytes.fromhex("7F 08 4F 26 6C F6 6D F6 00 0B 6E F6")
SEED = 43
N = 2000
MAXSTEPS = 100000
STACK_BASE = 0xFFFFD000
STACK_TOP = STACK_BASE + 0x400
STACK_OFFS = (0x408, 0x40C, 0x410, 0x414)
SEED_OFFS = (0x408,)   # lds.l pr/macl/mach slots seeded with the return sentinel
RAM_MIN = None
RAM_MAX = None
SPAN_END = 0x60D10
SENT = 0x60D10     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x60d04: {"kind": 'reg', "py": 'r[15] = (r[15] + s8(0x08)) & 0xFFFFFFFF\nsp = (sp + s8(0x08)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x60d06: {"kind": 'mem', "py": 'pr = _rdw(ram, STACK_BASE + 0x408, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x60d08: {"kind": 'mem', "py": 'r[12] = _rdw(ram, STACK_BASE + 0x40C, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x60d0a: {"kind": 'mem', "py": 'r[13] = _rdw(ram, STACK_BASE + 0x410, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x60d0c: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, STACK_BASE + 0x414, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},}
