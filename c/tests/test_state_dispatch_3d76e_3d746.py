#!/usr/bin/env python3
"""Differential test for state_dispatch_3d76e (0x3D746) — v3 lift + v4 FPU, 42 bytes.
...
Run from repo root: python3 c/tests/test_state_dispatch_3d76e_3d746.py
"""
...
ENTRY = 0x3D746
RAW = bytes.fromhex("E5 01 D3 0D 96 15 F3 38 F3 45 8F 02 E4 00 A0 01 26 50 26 40 96 0E D3 09 F3 38 F4 35 8F 02 00 09 A0 01 26 50 26 40 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFC643
SPAN_END = 0x3D770
SENT = 0x3D770     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x3d746: {"kind": 'reg', "py": 'r[5] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x3d748: {"kind": 'reg', "py": 'r[3] = 0x0007A930', "slot_py": None, "target": None, "cond": None},
    0x3d74a: {"kind": 'reg', "py": 'r[6] = 0xFFFFC642', "slot_py": None, "target": None, "cond": None},
    0x3d74c: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x0007A930, 4))', "slot_py": None, "target": None, "cond": None},
    0x3d74e: {"kind": 'fpu', "py": 'T = 1 if fr[3] > fr[4] else 0', "slot_py": None, "target": None, "cond": None},
    0x3d750: {"kind": "branch", "py": None, "slot_py": 'r[4] = s8(0x00)', "target": 0x3d758, "cond": 'notT'},
    0x3d754: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFC642, 1, r[5])', "target": 0x3d75a, "cond": 'always'},
    0x3d758: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC642, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x3d75a: {"kind": 'reg', "py": 'r[6] = 0xFFFFC643', "slot_py": None, "target": None, "cond": None},
    0x3d75c: {"kind": 'reg', "py": 'r[3] = 0x0007A934', "slot_py": None, "target": None, "cond": None},
    0x3d75e: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x0007A934, 4))', "slot_py": None, "target": None, "cond": None},
    0x3d760: {"kind": 'fpu', "py": 'T = 1 if fr[4] > fr[3] else 0', "slot_py": None, "target": None, "cond": None},
    0x3d762: {"kind": "branch", "py": None, "slot_py": '', "target": 0x3d76a, "cond": 'notT'},
    0x3d766: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFC643, 1, r[5])', "target": 0x3d76c, "cond": 'always'},
    0x3d76a: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC643, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x3d76c: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
