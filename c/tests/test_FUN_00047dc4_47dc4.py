#!/usr/bin/env python3
"""Differential test for FUN_00047dc4 (0x47DC4) — v3 lift + v4 FPU, 56 bytes.
...
Run from repo root: python3 c/tests/test_FUN_00047dc4_47dc4.py
"""
...
RAM_MAX = 0xFFFFCB9A
SPAN_END = 0x47DFC
SENT = 0x47DFC     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x47dc4: {"kind": 'reg', "py": 'r[5] = 0xFFFFCB9A', "slot_py": None, "target": None, "cond": None},
    0x47dc6: {"kind": 'reg', "py": 'r[3] = 0x0007AE70', "slot_py": None, "target": None, "cond": None},
    0x47dc8: {"kind": 'reg', "py": 'r[2] = 0xFFFFB504', "slot_py": None, "target": None, "cond": None},
    0x47dca: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x0007AE70, 4))', "slot_py": None, "target": None, "cond": None},
    0x47dcc: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0xFFFFB504, 4))', "slot_py": None, "target": None, "cond": None},
    0x47dce: {"kind": 'fpu', "py": 'T = 1 if fr[3] > fr[2] else 0', "slot_py": None, "target": None, "cond": None},
    0x47dd0: {"kind": "branch", "py": None, "slot_py": '', "target": 0x47de8, "cond": 'notT'},
    0x47dd4: {"kind": 'reg', "py": 'r[1] = 0xFFFFCAA0', "slot_py": None, "target": None, "cond": None},
    0x47dd6: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCAA0, 1))', "slot_py": None, "target": None, "cond": None},
    0x47dd8: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x47dda: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x47ddc: {"kind": "branch", "py": None, "slot_py": '', "target": 0x47de8, "cond": 'notT'},
    0x47de0: {"kind": 'reg', "py": 'r[2] = 0x0007AE40', "slot_py": None, "target": None, "cond": None},
    0x47de2: {"kind": 'mem', "py": 'r[3] = s16(_rdw(ram, 0x0007AE40, 2))', "slot_py": None, "target": None, "cond": None},
    0x47de4: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFCB9A, 2, r[3])', "target": 0x47df8, "cond": 'always'},
    0x47de8: {"kind": 'mem', "py": 'r[4] = s16(_rdw(ram, 0xFFFFCB9A, 2))', "slot_py": None, "target": None, "cond": None},
    0x47dea: {"kind": 'reg', "py": 'r[3] = r[4] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x47dec: {"kind": 'reg', "py": 'T = 1 if s32(r[3]) > 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x47dee: {"kind": "branch", "py": None, "slot_py": '', "target": 0x47df8, "cond": 'notT'},
    0x47df2: {"kind": 'reg', "py": 'r[3] = 0x0000FFFF', "slot_py": None, "target": None, "cond": None},
    0x47df4: {"kind": 'reg', "py": 'r[4] = (r[4] + r[3]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x47df6: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCB9A, 2, r[4])', "slot_py": None, "target": None, "cond": None},
    0x47df8: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
