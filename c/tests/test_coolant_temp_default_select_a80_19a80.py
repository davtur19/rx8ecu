#!/usr/bin/env python3
"""Differential test for coolant_temp_default_select_a80 (0x19A80) — v3 lift + v4 FPU, 50 bytes.
...
Run from repo root: python3 c/tests/test_coolant_temp_default_select_a80_19a80.py
"""
...
ENTRY = 0x19A80
RAW = bytes.fromhex("97 3D 96 3B 95 38 92 3E 63 20 23 38 8F 07 00 09 94 33 F3 48 F5 3A F2 48 F6 2A A0 08 F3 48 D3 21 D1 21 F3 38 F5 3A F3 18 F6 3A D2 20 F3 28 00 0B F7 3A")
SEED = 43
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFC5EA
SPAN_END = 0x19AB2
SENT = 0x19AB2     # stop-sentinel, placed past the literal pool
