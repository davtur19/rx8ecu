#!/usr/bin/env python3
"""Differential test for ram_word_copy_2AB60 (0x2AB60) — v3 lift (branches + delay slots), 10 bytes.
...
Run from repo root: python3 c/tests/test_ram_word_copy_2AB60_2ab60.py
"""
...
CODE = {
    0x2ab60: {"kind": 'reg', "py": 'r[3] = 0xFFFFBBA6', "slot_py": None, "target": None, "cond": None},
    0x2ab62: {"kind": 'mem', "py": 'r[0] = s16(_rdw(ram, 0xFFFFBBA6, 2))', "slot_py": None, "target": None, "cond": None},
    0x2ab64: {"kind": 'reg', "py": 'r[2] = 0xFFFFBBBE', "slot_py": None, "target": None, "cond": None},
    0x2ab66: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBBBE, 2, r[0])', "target": None, "cond": None},}
