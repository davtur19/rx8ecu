#!/usr/bin/env python3
"""Differential test for knockMultiplierInit (0x3395A) — v3 lift + v4 FPU, 32 bytes.
...
Run from repo root: python3 c/tests/test_knockMultiplierInit_3395a.py
"""
...
ENTRY = 0x3395A
RAW = bytes.fromhex("D3 24 D1 24 F3 38 F1 3A D2 24 D0 24 F3 28 F0 3A E2 00 D3 23 F3 38 D1 23 F1 3A 90 2C 00 0B 20 20")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFC080
SPAN_END = 0x3397A
SENT = 0x3397A     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x3395a: {"kind": 'reg', "py": 'r[3] = 0x00078ECC', "slot_py": None, "target": None, "cond": None},
    0x3395c: {"kind": 'reg', "py": 'r[1] = 0xFFFFC078', "slot_py": None, "target": None, "cond": None},
    0x3395e: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x00078ECC, 4))', "slot_py": None, "target": None, "cond": None},
    0x33960: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFC078, 4, f2bits(fr[3]))', "slot_py": None, "target": None, "cond": None},
    0x33962: {"kind": 'reg', "py": 'r[2] = 0x00078ED0', "slot_py": None, "target": None, "cond": None},
    0x33964: {"kind": 'reg', "py": 'r[0] = 0xFFFFC07C', "slot_py": None, "target": None, "cond": None},
    0x33966: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x00078ED0, 4))', "slot_py": None, "target": None, "cond": None},
    0x33968: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFC07C, 4, f2bits(fr[3]))', "slot_py": None, "target": None, "cond": None},
    0x3396a: {"kind": 'reg', "py": 'r[2] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x3396c: {"kind": 'reg', "py": 'r[3] = 0x00078ED4', "slot_py": None, "target": None, "cond": None},
    0x3396e: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x00078ED4, 4))', "slot_py": None, "target": None, "cond": None},
    0x33970: {"kind": 'reg', "py": 'r[1] = 0xFFFFC080', "slot_py": None, "target": None, "cond": None},
    0x33972: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFC080, 4, f2bits(fr[3]))', "slot_py": None, "target": None, "cond": None},
    0x33974: {"kind": 'reg', "py": 'r[0] = 0xFFFFC071', "slot_py": None, "target": None, "cond": None},
    0x33976: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFC071, 1, r[2])', "target": None, "cond": None},}
