#!/usr/bin/env python3
"""Differential test for flag_bc03_bit3_bc12 (0x2BDF8) — v3 lift (branches + delay slots), 30 bytes.
...
Run from repo root: python3 c/tests/test_flag_bc03_bit3_bc12_2bdf8.py
"""
...
ENTRY = 0x2BDF8
RAW = bytes.fromhex("94 30 93 30 60 31 60 0D C9 08 88 08 8F 03 00 09 E1 01 A0 02 24 10 E0 00 24 00 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBC12
SPAN_END = 0x2BE16
SENT = 0x2BE16     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x2bdf8: {"kind": 'reg', "py": 'r[4] = 0xFFFFBC03', "slot_py": None, "target": None, "cond": None},
    0x2bdfa: {"kind": 'reg', "py": 'r[3] = 0xFFFFBC12', "slot_py": None, "target": None, "cond": None},
    0x2bdfc: {"kind": 'mem', "py": 'r[0] = s16(_rdw(ram, 0xFFFFBC12, 2))', "slot_py": None, "target": None, "cond": None},
    0x2bdfe: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x2be00: {"kind": 'reg', "py": 'r[0] = (r[0] & 0x08) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x2be02: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x08) else 0', "slot_py": None, "target": None, "cond": None},
    0x2be04: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2be0e, "cond": 'notT'},
    0x2be08: {"kind": 'reg', "py": 'r[1] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x2be0a: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFBC03, 1, r[1])', "target": 0x2be12, "cond": 'always'},
    0x2be0e: {"kind": 'reg', "py": 'r[0] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x2be10: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBC03, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x2be12: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
