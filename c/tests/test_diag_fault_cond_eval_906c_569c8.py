#!/usr/bin/env python3
"""Differential test for diag_fault_cond_eval_906c (0x569C8) — mem lift (RAM-only, straight-line), 8 bytes.
...
Run from repo root: python3 c/tests/test_diag_fault_cond_eval_906c_569c8.py
"""
...
ENTRY = 0x569C8
RAW = bytes.fromhex("2F 30 EA 55 79 1C 63 93")
SEED = 42
N = 2000
...
def spec_mirror(r4, r5, r6, r7, ram, stack_top):
    ...
    local[0x400] = r[3]
    _wrw(ram, STACK_BASE + 0x400, 1, r[3])
    # 0x0569CA: op 0xEA55
    r[10] = s8(0x55)
    # 0x0569CC: op 0x791C
    r[9] = (r[9] + s8(0x1C)) & 0xFFFFFFFF
    # 0x0569CE: op 0x6393
    r[3] = r[9]
    r[15] = sp
