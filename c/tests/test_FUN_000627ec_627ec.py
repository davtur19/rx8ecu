#!/usr/bin/env python3
"""Differential test for FUN_000627ec (0x627EC) — pure straight-line lift, 8 bytes.
...
Run from repo root: python3 c/tests/test_FUN_000627ec_627ec.py
"""
...
ENTRY = 0x627EC
RAW = bytes.fromhex("6A DD 4A 00 60 4C 88 00")
SEED = 42
N = 2000
