#!/usr/bin/env python3
"""Differential test for cal_copy_751a2_b6e4 (0x27550) — v3 lift (branches + delay slots), 24 bytes.
...
Run from repo root: python3 c/tests/test_cal_copy_751a2_b6e4_27550.py
"""
...
ENTRY = 0x27550
RAW = bytes.fromhex("D2 41 E0 01 D1 41 63 21 21 31 D3 41 D1 42 23 00 D0 40 62 01 00 0B 21 21")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFB6FE
SPAN_END = 0x27568
SENT = 0x27568     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x27550: {"kind": 'reg', "py": 'r[2] = 0x000751A4', "slot_py": None, "target": None, "cond": None},
    0x27552: {"kind": 'reg', "py": 'r[0] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x27554: {"kind": 'reg', "py": 'r[1] = 0xFFFFB6E4', "slot_py": None, "target": None, "cond": None},
    0x27556: {"kind": 'mem', "py": 'r[3] = s16(_rdw(ram, 0x000751A4, 2))', "slot_py": None, "target": None, "cond": None},
    0x27558: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFB6E4, 2, r[3])', "slot_py": None, "target": None, "cond": None},
    0x2755a: {"kind": 'reg', "py": 'r[3] = 0xFFFFB6FE', "slot_py": None, "target": None, "cond": None},
    0x2755c: {"kind": 'reg', "py": 'r[1] = 0xFFFFB6E6', "slot_py": None, "target": None, "cond": None},
    0x2755e: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFB6FE, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x27560: {"kind": 'reg', "py": 'r[0] = 0x000751A2', "slot_py": None, "target": None, "cond": None},
    0x27562: {"kind": 'mem', "py": 'r[2] = s16(_rdw(ram, 0x000751A2, 2))', "slot_py": None, "target": None, "cond": None},
    0x27564: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFB6E6, 2, r[2])', "target": None, "cond": None},}
