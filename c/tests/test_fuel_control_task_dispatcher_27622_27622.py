#!/usr/bin/env python3
"""Differential test for fuel_control_task_dispatcher_27622 (0x27622) — v3 lift (branches + delay slots), 14 bytes.
...
Run from repo root: python3 c/tests/test_fuel_control_task_dispatcher_27622_27622.py
"""
...
ENTRY = 0x27622
RAW = bytes.fromhex("00 09 D2 20 E1 01 22 10 4F 26 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFB6ED
SPAN_END = 0x27630
SENT = 0x27630     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x27622: {"kind": 'reg', "py": None, "slot_py": None, "target": None, "cond": None},
    ...
    0x27628: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFB6ED, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x2762a: {"kind": 'mem', "py": 'pr = _rdw(ram, STACK_BASE + 0x400, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
