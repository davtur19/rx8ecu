#!/usr/bin/env python3
"""Differential test for cond_flag_b2e0_multi_eval (0x21534) — pure straight-line lift, 12 bytes.
...
Run from repo root: python3 c/tests/test_cond_flag_b2e0_multi_eval_21534.py
"""
...
ENTRY = 0x21534
RAW = bytes.fromhex("7C 04 ED 01 66 43 60 6C 40 08 75 FF")
SEED = 42
N = 2000
