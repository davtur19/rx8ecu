#!/usr/bin/env python3
"""Differential test for flag_mirror_9f8c_a41c (0xE1BC) — v3 lift (branches + delay slots), 32 bytes.
...
Run from repo root: python3 c/tests/test_flag_mirror_9f8c_a41c_e1bc.py
"""
...
ENTRY = 0xE1BC
RAW = bytes.fromhex("94 0B D2 06 63 20 23 38 8F 03 00 09 E0 00 A0 02 24 00 E1 01 24 10 00 0B 00 09 A4 1C FF FF 9F 8C")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFA41C
SPAN_END = 0xE1DC
SENT = 0xE1DC     # stop-sentinel, placed past the literal pool
...
CODE = {
    0xe1bc: {"kind": 'reg', "py": 'r[4] = 0xFFFFA41C', "slot_py": None, "target": None, "cond": None},
    0xe1be: {"kind": 'reg', "py": 'r[2] = 0xFFFF9F8C', "slot_py": None, "target": None, "cond": None},
    0xe1c0: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFF9F8C, 1))', "slot_py": None, "target": None, "cond": None},
    0xe1c2: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0xe1c4: {"kind": "branch", "py": None, "slot_py": '', "target": 0xe1ce, "cond": 'notT'},
    0xe1c8: {"kind": 'reg', "py": 'r[0] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0xe1ca: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFA41C, 1, r[0])', "target": 0xe1d2, "cond": 'always'},
    0xe1ce: {"kind": 'reg', "py": 'r[1] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0xe1d0: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA41C, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0xe1d2: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
