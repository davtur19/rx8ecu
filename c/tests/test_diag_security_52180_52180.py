#!/usr/bin/env python3
"""Differential test for diag_security_52180 (0x52180) — v3 lift (branches + delay slots), 22 bytes.
...
Run from repo root: python3 c/tests/test_diag_security_52180_52180.py
"""
...
ENTRY = 0x52180
RAW = bytes.fromhex("63 3C 43 15 8F 03 00 09 E1 01 A0 02 24 10 E0 00 24 00 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
CODE = {
    ...
    0x5218a: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, r[4], 1, r[1])', "target": 0x52192, "cond": 'always'},
    0x5218e: {"kind": 'reg', "py": 'r[0] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x52190: {"kind": 'mem', "py": '_wrw(ram, r[4], 1, r[0])', "slot_py": None, "target": None, "cond": None},
