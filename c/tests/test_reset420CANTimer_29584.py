#!/usr/bin/env python3
"""Differential test for reset420CANTimer (0x29584) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_reset420CANTimer_29584.py
"""
...
ENTRY = 0x29584
RAW = bytes.fromhex("D2 2E E3 00 00 0B 22 31")
SEED = 0
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBAEC
SPAN_END = 0x2958C
SENT = 0x2958C     # stop-sentinel, placed past the literal pool
