#!/usr/bin/env python3
"""Differential test for dtc_primary_record_threshold_update (0x62A64) — v3 lift (branches + delay slots), 24 bytes.
...
Run from repo root: python3 c/tests/test_dtc_primary_record_threshold_update_62a64.py
"""
...
ENTRY = 0x62A64
RAW = bytes.fromhex("33 40 8F 01 00 09 6E C3 60 E3 80 66 7F 04 4F 26 6C F6 6D F6 00 0B 6E F6")
SEED = 0
N = 2000
MAXSTEPS = 100000
STACK_BASE = 0xFFFFD000
STACK_TOP = STACK_BASE + 0x400
STACK_OFFS = (0x404, 0x408, 0x40C, 0x410)
