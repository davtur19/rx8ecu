#!/usr/bin/env python3
"""Differential test for caller_535EA (entry 0x535EA) — v8 ST caller (CFG), 22 bytes.
...
Run: python3 test_caller_535EA.py
"""
...
CODE = {
    0x535ea: {"kind": 'fpu', "py": 'fr[6] = 0.0', "slot_py": None, "target": None, "cond": None},
    0x535ec: {"kind": 'reg', "py": 'r[0] = 0x00053668', "slot_py": None, "target": None, "cond": None},
    0x535ee: {"kind": 'st', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x535f0: {"kind": 'reg', "py": 'r[3] = 0xFFFFB594', "slot_py": None, "target": None, "cond": None},
    0x535f2: {"kind": 'fpu', "py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFB594, 4))', "slot_py": None, "target": None, "cond": None},
    0x535f4: {"kind": 'reg', "py": 'r[2] = 0x00002490', "slot_py": None, "target": None, "cond": None},
    0x535f6: {"kind": "call", "py": None, "slot_py": 'fr[5] = bits2f(_rdw(ram, 0x00053668, 4))', "target": 0x2490, "ret_pc": 0x535fa, "set_pr": True, "cond": None},
    0x535fa: {"kind": 'st', "py": 'pr = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x535fc: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},
