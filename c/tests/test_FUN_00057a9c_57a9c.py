#!/usr/bin/env python3
"""Differential test for FUN_00057a9c (0x57A9C) — v3 lift (branches + delay slots), 26 bytes.
...
Run from repo root: python3 c/tests/test_FUN_00057a9c_57a9c.py
"""
...
ENTRY = 0x57A9C
RAW = bytes.fromhex("93 53 64 4C 66 30 66 6C 34 60 8F 03 E5 00 26 68 8F 01 00 09 E5 01 00 0B 60 53")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFD064
SPAN_END = 0x57AB6
SENT = 0x57AB6     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x57a9c: {"kind": 'reg', "py": 'r[3] = 0xFFFFD064', "slot_py": None, "target": None, "cond": None},
    0x57a9e: {"kind": 'reg', "py": 'r[4] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x57aa0: {"kind": 'mem', "py": 'r[6] = s8(_rdw(ram, 0xFFFFD064, 1))', "slot_py": None, "target": None, "cond": None},
    0x57aa2: {"kind": 'reg', "py": 'r[6] = r[6] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x57aa4: {"kind": 'reg', "py": 'T = 1 if r[4] == r[6] else 0', "slot_py": None, "target": None, "cond": None},
    0x57aa6: {"kind": "branch", "py": None, "slot_py": 'r[5] = s8(0x00)', "target": 0x57ab0, "cond": 'notT'},
    0x57aaa: {"kind": 'reg', "py": 'T = 1 if (r[6] & r[6]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x57aac: {"kind": "branch", "py": None, "slot_py": '', "target": 0x57ab2, "cond": 'notT'},
    0x57ab0: {"kind": 'reg', "py": 'r[5] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x57ab2: {"kind": "ret", "py": None, "slot_py": 'r[0] = r[5]', "target": None, "cond": None},}
