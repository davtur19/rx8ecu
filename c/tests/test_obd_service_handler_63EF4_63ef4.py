#!/usr/bin/env python3
"""Differential test for obd_service_handler_63EF4 (0x63EF4) — v3 lift (branches + delay slots), 18 bytes.
...
Run from repo root: python3 c/tests/test_obd_service_handler_63EF4_63ef4.py
"""
...
ENTRY = 0x63EF4
RAW = bytes.fromhex("8D 01 00 09 EE 01 60 E3 4F 26 00 0B 6E F6 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = None
SPAN_END = 0x63F06
SENT = 0x63F06     # stop-sentinel, placed past the literal pool
...
CODE = {
    ...
    0x63efc: {"kind": 'mem', "py": 'pr = _rdw(ram, STACK_BASE + 0x400, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x63efe: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, STACK_BASE + 0x404, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},
    0x63f02: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
