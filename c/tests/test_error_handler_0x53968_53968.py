#!/usr/bin/env python3
"""Differential test for error_handler_0x53968 (0x53968) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_error_handler_0x53968_53968.py
"""
...
CODE = {
    0x53968: {"kind": 'reg', "py": 'r[2] = 0xFFFFD180', "slot_py": None, "target": None, "cond": None},
    0x5396a: {"kind": 'reg', "py": 'r[3] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x5396c: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFD180, 1, r[3])', "target": None, "cond": None},}
