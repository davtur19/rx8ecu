#!/usr/bin/env python3
"""Differential test for updateFaultStatus (0x5E72C) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_updateFaultStatus_5e72c.py
"""
...
RAM_MAX = None
SPAN_END = 0x5E734
SENT = 0x5E734     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x5e72c: {"kind": 'mem', "py": 'r[12] = _rdw(ram, STACK_BASE + 0x400, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x5e72e: {"kind": 'mem', "py": 'r[13] = _rdw(ram, STACK_BASE + 0x404, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x5e730: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, STACK_BASE + 0x408, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},}
