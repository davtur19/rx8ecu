#!/usr/bin/env python3
"""Differential test for sensor_extract_6072e (0x6072E) — v3 lift + v4 FPU, 12 bytes.
...
Run from repo root: python3 c/tests/test_sensor_extract_6072e_6072e.py
"""
...
ENTRY = 0x6072E
RAW = bytes.fromhex("93 0E 00 0B F0 38 93 05 00 0B F0 38")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFC12C
SPAN_END = 0x6073A
SENT = 0x6073A     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x6072e: {"kind": 'reg', "py": 'r[3] = 0xFFFFC12C', "slot_py": None, "target": None, "cond": None},
    0x60730: {"kind": "ret", "py": None, "slot_py": 'fr[0] = bits2f(_rdw(ram, 0xFFFFC12C, 4))', "target": None, "cond": None},
