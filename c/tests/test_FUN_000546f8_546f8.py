#!/usr/bin/env python3
"""Differential test for FUN_000546f8 (0x546F8) — pure straight-line lift, 10 bytes.
...
Run from repo root: python3 c/tests/test_FUN_000546f8_546f8.py
"""
...
ENTRY = 0x546F8
RAW = bytes.fromhex("E5 00 E5 01 94 50 7F 04 D3 2A")
SEED = 42
N = 2000
