#!/usr/bin/env python3
"""Differential test for diag_fault_cond_eval_90C8 (0x56F94) — pure straight-line lift, 8 bytes.
...
Run from repo root: python3 c/tests/test_diag_fault_cond_eval_90C8_56f94.py
"""
...
ENTRY = 0x56F94
RAW = bytes.fromhex("00 09 6E ED D2 1C 2E 28")
SEED = 42
N = 2000
