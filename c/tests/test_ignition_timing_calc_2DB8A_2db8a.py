#!/usr/bin/env python3
"""Differential test for ignition_timing_calc_2DB8A (0x2DB8A) — v3 lift + v4 FPU, 22 bytes.
...
Run from repo root: python3 c/tests/test_ignition_timing_calc_2DB8A_2db8a.py
"""
...
RAM_MAX = 0xFFFFBD28
SPAN_END = 0x2DBA0
SENT = 0x2DBA0     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x2db8a: {"kind": 'reg', "py": 'r[3] = 0xFFFFBD24', "slot_py": None, "target": None, "cond": None},
    0x2db8c: {"kind": 'reg', "py": 'r[1] = 0xFFFFBD0C', "slot_py": None, "target": None, "cond": None},
    0x2db8e: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFBD24, 4))', "slot_py": None, "target": None, "cond": None},
    0x2db90: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0xFFFFBD0C, 4))', "slot_py": None, "target": None, "cond": None},
    0x2db92: {"kind": 'fpu', "py": 'fr[2] = ts(fr[2] + fr[3])', "slot_py": None, "target": None, "cond": None},
    0x2db94: {"kind": 'reg', "py": 'r[2] = 0xFFFFBD28', "slot_py": None, "target": None, "cond": None},
    0x2db96: {"kind": 'fpu', "py": 'fr[1] = bits2f(_rdw(ram, 0xFFFFBD28, 4))', "slot_py": None, "target": None, "cond": None},
    0x2db98: {"kind": 'reg', "py": 'r[1] = 0xFFFFBD14', "slot_py": None, "target": None, "cond": None},
    0x2db9a: {"kind": 'fpu', "py": 'fr[2] = ts(fr[2] + fr[1])', "slot_py": None, "target": None, "cond": None},
    0x2db9c: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBD14, 4, f2bits(fr[2]))', "target": None, "cond": None},}
