#!/usr/bin/env python3
"""Differential test for crank_event_update (0x7F46) — v3 lift (branches + delay slots), 32 bytes.
...
Run from repo root: python3 c/tests/test_crank_event_update_7f46.py
"""
