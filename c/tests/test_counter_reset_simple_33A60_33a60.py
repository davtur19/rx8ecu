#!/usr/bin/env python3
"""Differential test for counter_reset_simple_33A60 (0x33A60) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_counter_reset_simple_33A60_33a60.py
"""
...
CODE = {
    0x33a60: {"kind": 'reg', "py": 'r[2] = 0xFFFFC05E', "slot_py": None, "target": None, "cond": None},
    0x33a62: {"kind": 'reg', "py": 'r[3] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x33a64: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFC05E, 2, r[3])', "target": None, "cond": None},}
