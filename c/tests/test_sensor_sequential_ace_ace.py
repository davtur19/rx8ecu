#!/usr/bin/env python3
"""Differential test for sensor_sequential_ace (0xACE) — v3 lift (branches + delay slots), 26 bytes.
...
Run from repo root: python3 c/tests/test_sensor_sequential_ace_ace.py
"""
