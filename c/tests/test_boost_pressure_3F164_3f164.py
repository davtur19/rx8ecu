#!/usr/bin/env python3
"""Differential test for boost_pressure_3F164 (0x3F164) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_boost_pressure_3F164_3f164.py
"""
...
ENTRY = 0x3F164
RAW = bytes.fromhex("92 03 E3 01 00 0B 22 30")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFC6AD
SPAN_END = 0x3F16C
SENT = 0x3F170     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x3f164: {"kind": 'reg', "py": 'r[2] = 0xFFFFC6AD', "slot_py": None, "target": None, "cond": None},
    0x3f166: {"kind": 'reg', "py": 'r[3] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x3f168: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFC6AD, 1, r[3])', "target": None, "cond": None},}
