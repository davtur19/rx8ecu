#!/usr/bin/env python3
"""Differential test for obd_service_handler_66648 (0x66648) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_obd_service_handler_66648_66648.py
"""
...
ENTRY = 0x66648
RAW = bytes.fromhex("81 61 81 62 00 0B 4F 16")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = None
SPAN_END = 0x66650
SENT = 0x66650     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x66648: {"kind": 'mem', "py": '_wrw(ram, (r[6] + 2), 2, r[0])', "slot_py": None, "target": None, "cond": None},
    0x6664a: {"kind": 'mem', "py": '_wrw(ram, (r[6] + 4), 2, r[0])', "slot_py": None, "target": None, "cond": None},
    0x6664c: {"kind": "ret", "py": None, "slot_py": 'macl = _rdw(ram, STACK_BASE + 0x400, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},}
