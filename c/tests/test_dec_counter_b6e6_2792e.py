#!/usr/bin/env python3
"""Differential test for dec_counter_b6e6 (0x2792E) — v3 lift (branches + delay slots), 34 bytes.
...
Run from repo root: python3 c/tests/test_dec_counter_b6e6_2792e.py
"""
...
ENTRY = 0x2792E
RAW = bytes.fromhex("D3 16 60 30 60 0C 88 01 8F 09 00 09 D5 16 64 51 61 4D 41 15 8F 03 00 09 D1 12 34 1C 25 41 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFB6EC
SPAN_END = 0x27950
SENT = 0x27950     # stop-sentinel, placed past the literal pool
