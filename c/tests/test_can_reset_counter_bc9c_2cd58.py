#!/usr/bin/env python3
"""Differential test for can_reset_counter_bc9c (0x2CD58) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_can_reset_counter_bc9c_2cd58.py
"""
...
ENTRY = 0x2CD58
RAW = bytes.fromhex("D2 23 E3 00 00 0B 22 31")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBC9C
SPAN_END = 0x2CD60
SENT = 0x2CD60     # stop-sentinel, placed past the literal pool
