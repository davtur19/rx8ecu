#!/usr/bin/env python3
"""Differential test for getBaroSensorValue (0xD13C) — v3 lift (branches + delay slots), 40 bytes.
...
Run from repo root: python3 c/tests/test_getBaroSensorValue_d13c.py
"""
...
ENTRY = 0xD13C
RAW = bytes.fromhex("64 33 24 2B 00 0B 60 43 64 4C 24 48 8F 03 66 5D 94 19 A0 01 00 09 94 17 D2 0F 63 6C 43 18 22 69 42 19 23 2B 00 0B 24 31")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFE60A
SPAN_END = 0xD164
SENT = 0xD164     # stop-sentinel, placed past the literal pool
