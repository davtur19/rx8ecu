#!/usr/bin/env python3
"""Differential test for diag_status_a11c (0xA11C) — v3 lift (branches + delay slots), 10 bytes.
...
Run from repo root: python3 c/tests/test_diag_status_a11c_a11c.py
"""
...
ENTRY = 0xA11C
RAW = bytes.fromhex("E4 01 7F 04 4F 26 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = None
SPAN_END = 0xA126
SENT = 0xA126     # stop-sentinel, placed past the literal pool
...
CODE = {
    0xa11c: {"kind": 'reg', "py": 'r[4] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0xa11e: {"kind": 'reg', "py": 'r[15] = (r[15] + s8(0x04)) & 0xFFFFFFFF\nsp = (sp + s8(0x04)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xa120: {"kind": 'mem', "py": 'pr = _rdw(ram, STACK_BASE + 0x404, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xa122: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
