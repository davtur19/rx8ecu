#!/usr/bin/env python3
"""Differential test for memory_checksum_validator_runner (0xD704) — v3 lift (branches + delay slots), 14 bytes.
...
Run from repo root: python3 c/tests/test_memory_checksum_validator_runner_d704.py
"""
...
ENTRY = 0xD704
RAW = bytes.fromhex("4F 26 00 0B 00 09 E3 00 D2 05 00 0B 22 30")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFA3FC
SPAN_END = 0xD712
SENT = 0xD712     # stop-sentinel, placed past the literal pool
...
CODE = {
    0xd704: {"kind": 'mem', "py": 'pr = _rdw(ram, STACK_BASE + 0x400, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xd706: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},
    0xd70a: {"kind": 'reg', "py": 'r[3] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0xd70c: {"kind": 'reg', "py": 'r[2] = 0xFFFFA3FC', "slot_py": None, "target": None, "cond": None},
    0xd70e: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFA3FC, 1, r[3])', "target": None, "cond": None},}
