#!/usr/bin/env python3
"""Differential test for getThrottleLessThanLookupTimer (0x448E0) — v3 lift (branches + delay slots), 42 bytes.
...
Run from repo root: python3 c/tests/test_getThrottleLessThanLookupTimer_448e0.py
"""
...
ENTRY = 0x448E0
RAW = bytes.fromhex("95 2D 92 2D 63 20 23 38 8F 03 00 09 E0 00 A0 0A 25 00 64 50 D0 1B 61 4C 63 00 63 3C 31 33 8D 02 00 09 74 01 25 40 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    0x448e0: {"kind": 'reg', "py": 'r[5] = 0xFFFFCAB1', "slot_py": None, "target": None, "cond": None},
    0x448e2: {"kind": 'reg', "py": 'r[2] = 0xFFFFCAB6', "slot_py": None, "target": None, "cond": None},
    0x448e4: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFCAB6, 1))', "slot_py": None, "target": None, "cond": None},
    0x448e6: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x448e8: {"kind": "branch", "py": None, "slot_py": '', "target": 0x448f2, "cond": 'notT'},
    0x448ec: {"kind": 'reg', "py": 'r[0] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x448ee: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFCAB1, 1, r[0])', "target": 0x44906, "cond": 'always'},
    0x448f2: {"kind": 'mem', "py": 'r[4] = s8(_rdw(ram, 0xFFFFCAB1, 1))', "slot_py": None, "target": None, "cond": None},
    0x448f4: {"kind": 'reg', "py": 'r[0] = 0x0007B3DA', "slot_py": None, "target": None, "cond": None},
    0x448f6: {"kind": 'reg', "py": 'r[1] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x448f8: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0x0007B3DA, 1))', "slot_py": None, "target": None, "cond": None},
    0x448fa: {"kind": 'reg', "py": 'r[3] = r[3] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x448fc: {"kind": 'reg', "py": 'T = 1 if s32(r[1]) >= s32(r[3]) else 0', "slot_py": None, "target": None, "cond": None},
    0x448fe: {"kind": "branch", "py": None, "slot_py": '', "target": 0x44906, "cond": 'T'},
    0x44902: {"kind": 'reg', "py": 'r[4] = (r[4] + s8(0x01)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x44904: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCAB1, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x44906: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
