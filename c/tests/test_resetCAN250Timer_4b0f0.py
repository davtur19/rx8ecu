#!/usr/bin/env python3
"""Differential test for resetCAN250Timer (0x4B0F0) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_resetCAN250Timer_4b0f0.py
"""
...
ENTRY = 0x4B0F0
RAW = bytes.fromhex("D1 1F E3 00 00 0B 21 31")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCD54
SPAN_END = 0x4B0F8
SENT = 0x4B0F8     # stop-sentinel, placed past the literal pool
