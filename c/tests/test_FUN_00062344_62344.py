#!/usr/bin/env python3
"""Differential test for FUN_00062344 (0x62344) — pure straight-line lift, 8 bytes.
...
Run from repo root: python3 c/tests/test_FUN_00062344_62344.py
"""
...
ENTRY = 0x62344
RAW = bytes.fromhex("D0 8F 61 F3 72 04 71 08")
SEED = 42
N = 2000
...
def spec_mirror(r4, r5, r6, r7):
    ...
    r[1] = r[15]
    # 0x062348: op 0x7204
    r[2] = (r[2] + s8(0x04)) & 0xFFFFFFFF
    # 0x06234A: op 0x7108
    r[1] = (r[1] + s8(0x08)) & 0xFFFFFFFF
