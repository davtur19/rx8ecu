#!/usr/bin/env python3
"""Differential test for FUN_000486bc (0x486BC) — v3 lift + v4 FPU, 18 bytes.
...
Run from repo root: python3 c/tests/test_FUN_000486bc_486bc.py
"""
...
ENTRY = 0x486BC
RAW = bytes.fromhex("92 6B 63 20 D1 37 21 30 90 68 F3 08 D3 36 00 0B F3 3A")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCC07
SPAN_END = 0x486CE
SENT = 0x486CE     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x486bc: {"kind": 'reg', "py": 'r[2] = 0xFFFFB129', "slot_py": None, "target": None, "cond": None},
    0x486be: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFB129, 1))', "slot_py": None, "target": None, "cond": None},
    0x486c0: {"kind": 'reg', "py": 'r[1] = 0xFFFFCC07', "slot_py": None, "target": None, "cond": None},
    0x486c2: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCC07, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x486c4: {"kind": 'reg', "py": 'r[0] = 0xFFFFAD84', "slot_py": None, "target": None, "cond": None},
    0x486c6: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFAD84, 4))', "slot_py": None, "target": None, "cond": None},
    0x486c8: {"kind": 'reg', "py": 'r[3] = 0xFFFFCC00', "slot_py": None, "target": None, "cond": None},
    0x486ca: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFCC00, 4, f2bits(fr[3]))', "target": None, "cond": None},}
