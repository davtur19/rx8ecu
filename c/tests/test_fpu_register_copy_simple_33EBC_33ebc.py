#!/usr/bin/env python3
"""Differential test for fpu_register_copy_simple_33EBC (0x33EBC) — v3 lift + v4 FPU, 10 bytes.
...
Run from repo root: python3 c/tests/test_fpu_register_copy_simple_33EBC_33ebc.py
"""
...
RAM_MAX = 0xFFFFC090
SPAN_END = 0x33EC6
SENT = 0x33EC6     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x33ebc: {"kind": 'reg', "py": 'r[0] = 0x00033F9C', "slot_py": None, "target": None, "cond": None},
    0x33ebe: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x00033F9C, 4))', "slot_py": None, "target": None, "cond": None},
    0x33ec0: {"kind": 'reg', "py": 'r[3] = 0xFFFFC090', "slot_py": None, "target": None, "cond": None},
    0x33ec2: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFC090, 4, f2bits(fr[3]))', "target": None, "cond": None},}
