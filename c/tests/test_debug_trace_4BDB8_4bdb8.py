#!/usr/bin/env python3
"""Differential test for debug_trace_4BDB8 (0x4BDB8) — v3 lift + v4 FPU, 10 bytes.
...
Run from repo root: python3 c/tests/test_debug_trace_4BDB8_4bdb8.py
"""
...
ENTRY = 0x4BDB8
RAW = bytes.fromhex("92 08 F3 28 91 07 00 0B F1 3A")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCE44
SPAN_END = 0x4BDC2
SENT = 0x4BDC2     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x4bdb8: {"kind": 'reg', "py": 'r[2] = 0xFFFFCE40', "slot_py": None, "target": None, "cond": None},
    0x4bdba: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFCE40, 4))', "slot_py": None, "target": None, "cond": None},
    0x4bdbc: {"kind": 'reg', "py": 'r[1] = 0xFFFFCE44', "slot_py": None, "target": None, "cond": None},
    0x4bdbe: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFCE44, 4, f2bits(fr[3]))', "target": None, "cond": None},}
