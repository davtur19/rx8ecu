#!/usr/bin/env python3
"""Differential test for air_quality_0x5A2E4 (0x5A2E4) — pure straight-line lift, 8 bytes.
...
Run from repo root: python3 c/tests/test_air_quality_0x5A2E4_5a2e4.py
"""
...
ENTRY = 0x5A2E4
RAW = bytes.fromhex("93 75 E7 00 91 74 7F FC")
SEED = 42
N = 2000
