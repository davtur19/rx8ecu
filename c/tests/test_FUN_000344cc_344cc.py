#!/usr/bin/env python3
"""Differential test for FUN_000344cc (0x344CC) — v3 lift + v4 FPU, 14 bytes.
...
Run from repo root: python3 c/tests/test_FUN_000344cc_344cc.py
"""
...
ENTRY = 0x344CC
RAW = bytes.fromhex("D3 23 F3 38 D1 23 F1 3A 90 2C 00 0B 20 20")
SEED = 42
N = 500
MAXSTEPS = 100000
