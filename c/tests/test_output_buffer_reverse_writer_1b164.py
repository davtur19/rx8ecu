#!/usr/bin/env python3
"""Differential test for output_buffer_reverse_writer (0x1B164) — v3 lift + v4 FPU, 32 bytes.
...
Run from repo root: python3 c/tests/test_output_buffer_reverse_writer_1b164.py
"""
...
RAM_MAX = 0xFFFFAAAC
SPAN_END = 0x1B184
SENT = 0x1B184     # stop-sentinel, placed past the literal pool
