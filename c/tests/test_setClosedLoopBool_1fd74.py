#!/usr/bin/env python3
"""Differential test for setClosedLoopBool (0x1FD74) — v3 lift (branches + delay slots), 26 bytes.
...
Run from repo root: python3 c/tests/test_setClosedLoopBool_1fd74.py
"""
...
CODE = {
    0x1fd74: {"kind": 'reg', "py": 'r[4] = 0xFFFFB19C', "slot_py": None, "target": None, "cond": None},
    0x1fd76: {"kind": 'reg', "py": 'r[2] = 0xFFFFB19A', "slot_py": None, "target": None, "cond": None},
    0x1fd78: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFB19A, 1))', "slot_py": None, "target": None, "cond": None},
    0x1fd7a: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x1fd7c: {"kind": "branch", "py": None, "slot_py": '', "target": 0x1fd86, "cond": 'notT'},
    0x1fd80: {"kind": 'reg', "py": 'r[0] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x1fd82: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFB19C, 1, r[0])', "target": 0x1fd8a, "cond": 'always'},
    0x1fd86: {"kind": 'reg', "py": 'r[1] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x1fd88: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFB19C, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x1fd8a: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
