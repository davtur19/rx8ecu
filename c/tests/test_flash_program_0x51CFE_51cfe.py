#!/usr/bin/env python3
"""Differential test for flash_program_0x51CFE (0x51CFE) — v3 lift (branches + delay slots), 42 bytes.
...
Run from repo root: python3 c/tests/test_flash_program_0x51CFE_51cfe.py
"""
...
ENTRY = 0x51CFE
RAW = bytes.fromhex("90 19 D6 0F 60 00 63 60 C8 80 04 29 74 FF 23 38 8F 09 64 4B 60 4C 88 01 8F 05 00 09 E5 00 92 07 22 50 93 07 23 50 00 0B 26 40")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    0x51cfe: {"kind": 'reg', "py": 'r[0] = 0xFFFFCFF1', "slot_py": None, "target": None, "cond": None},
    0x51d00: {"kind": 'reg', "py": 'r[6] = 0xFFFFD111', "slot_py": None, "target": None, "cond": None},
    0x51d02: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCFF1, 1))', "slot_py": None, "target": None, "cond": None},
    0x51d04: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFD111, 1))', "slot_py": None, "target": None, "cond": None},
    0x51d06: {"kind": 'reg', "py": 'T = 1 if (r[0] & 0x80) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x51d08: {"kind": 'reg', "py": 'r[4] = T;', "slot_py": None, "target": None, "cond": None},
    0x51d0a: {"kind": 'reg', "py": 'r[4] = (r[4] + s8(0xFF)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x51d0c: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x51d0e: {"kind": "branch", "py": None, "slot_py": 'r[4] = (-r[4]) & 0xFFFFFFFF', "target": 0x51d24, "cond": 'notT'},
    0x51d12: {"kind": 'reg', "py": 'r[0] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x51d14: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x51d16: {"kind": "branch", "py": None, "slot_py": '', "target": 0x51d24, "cond": 'notT'},
    0x51d1a: {"kind": 'reg', "py": 'r[5] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x51d1c: {"kind": 'reg', "py": 'r[2] = 0xFFFFD0E5', "slot_py": None, "target": None, "cond": None},
    0x51d1e: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD0E5, 1, r[5])', "slot_py": None, "target": None, "cond": None},
    0x51d20: {"kind": 'reg', "py": 'r[3] = 0xFFFFD0E6', "slot_py": None, "target": None, "cond": None},
    0x51d22: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD0E6, 1, r[5])', "slot_py": None, "target": None, "cond": None},
    0x51d24: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFD111, 1, r[4])', "target": None, "cond": None},}
