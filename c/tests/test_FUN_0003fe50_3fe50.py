#!/usr/bin/env python3
"""Differential test for FUN_0003fe50 (0x3FE50) — v3 lift + v4 FPU, 32 bytes.
...
Run from repo root: python3 c/tests/test_FUN_0003fe50_3fe50.py
"""
...
ENTRY = 0x3FE50
RAW = bytes.fromhex("00 09 F4 4A A0 0A F5 4A F3 48 F4 35 8F 01 00 09 F4 4A F3 58 F4 35 8D 01 00 09 F5 4A 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    0x3fe50: {"kind": 'reg', "py": None, "slot_py": None, "target": None, "cond": None},
