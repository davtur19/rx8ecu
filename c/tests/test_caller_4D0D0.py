#!/usr/bin/env python3
"""Differential test for caller_4D0D0 (entry 0x4D0D0) — v8 ST caller (CFG), 138 bytes.
...
Run: python3 test_caller_4D0D0.py
"""
...
CODE = {
    0x4d0d0: {"kind": 'st', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x4d0d2: {"kind": 'reg', "py": 'r[2] = 0xFFFFCDBC', "slot_py": None, "target": None, "cond": None},
    0x4d0d4: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCDBC, 1))', "slot_py": None, "target": None, "cond": None},
    0x4d0d6: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x4d0d8: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x4d0da: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4d154, "cond": 'notT'},
    0x4d0de: {"kind": 'reg', "py": 'r[3] = 0xFFFFCE01', "slot_py": None, "target": None, "cond": None},
    0x4d0e0: {"kind": 'reg', "py": 'r[2] = 0x0007B985', "slot_py": None, "target": None, "cond": None},
    0x4d0e2: {"kind": 'mem', "py": 'r[1] = s8(_rdw(ram, 0xFFFFCE01, 1))', "slot_py": None, "target": None, "cond": None},
    0x4d0e4: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, r[2], 1))', "slot_py": None, "target": None, "cond": None},
    0x4d0e6: {"kind": 'reg', "py": 'T = 1 if r[1] == r[0] else 0', "slot_py": None, "target": None, "cond": None},
    0x4d0e8: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4d154, "cond": 'notT'},
    0x4d0ec: {"kind": 'reg', "py": 'r[2] = 0xFFFFCE00', "slot_py": None, "target": None, "cond": None},
    0x4d0ee: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, r[2], 1))', "slot_py": None, "target": None, "cond": None},
    0x4d0f0: {"kind": 'reg', "py": 'r[3] = r[3] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x4d0f2: {"kind": 'reg', "py": 'T = 1 if s32(r[3]) > 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x4d0f4: {"kind": "branch", "py": None, "slot_py": 'fr[4] = 1.0', "target": 0x4d138, "cond": 'notT'},
    0x4d0f8: {"kind": 'reg', "py": 'r[3] = 0x0007B99C', "slot_py": None, "target": None, "cond": None},
    0x4d0fa: {"kind": "branch", "py": None, "slot_py": 'fr[3] = bits2f(_rdw(ram, 0x0007B99C, 4))', "target": 0x4d13c, "cond": 'always'},
    0x4d13c: {"kind": 'reg', "py": 'r[0] = 0x0004D1EC', "slot_py": None, "target": None, "cond": None},
    0x4d13e: {"kind": 'fpu', "py": 'fr[6] = fr[4]', "slot_py": None, "target": None, "cond": None},
    0x4d140: {"kind": 'reg', "py": 'r[3] = 0xFFFFCDE0', "slot_py": None, "target": None, "cond": None},
    0x4d142: {"kind": 'fpu', "py": 'fr[6] = ts(fr[6] - fr[3])', "slot_py": None, "target": None, "cond": None},
    0x4d144: {"kind": 'fpu', "py": 'fr[7] = bits2f(_rdw(ram, 0x0004D1EC, 4))', "slot_py": None, "target": None, "cond": None},
    0x4d146: {"kind": 'fpu', "py": 'fr[5] = bits2f(_rdw(ram, 0xFFFFCDE0, 4))', "slot_py": None, "target": None, "cond": None},
    0x4d148: {"kind": 'reg', "py": 'r[2] = 0xFFFFCDDC', "slot_py": None, "target": None, "cond": None},
    0x4d14a: {"kind": 'reg', "py": 'r[1] = 0x000023B0', "slot_py": None, "target": None, "cond": None},
    0x4d14c: {"kind": "call", "py": None, "slot_py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFCDDC, 4))', "target": 0x23b0, "ret_pc": 0x4d150, "set_pr": True, "cond": None},
    0x4d150: {"kind": 'reg', "py": 'r[3] = 0xFFFFCDE0', "slot_py": None, "target": None, "cond": None},
    0x4d152: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFCDE0, 4, f2bits(fr[0]))', "slot_py": None, "target": None, "cond": None},
    0x4d154: {"kind": 'st', "py": 'pr = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x4d156: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None, },
    0x4d138: {"kind": 'reg', "py": 'r[1] = 0x0007B9A0', "slot_py": None, "target": None, "cond": None},
    0x4d13a: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x0007B9A0, 4))', "slot_py": None, "target": None, "cond": None},
