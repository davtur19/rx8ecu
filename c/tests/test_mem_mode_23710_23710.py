#!/usr/bin/env python3
"""Differential test for mem_mode_23710 (0x23710) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_mem_mode_23710_23710.py
"""
...
CODE = {
    0x23710: {"kind": 'reg', "py": 'r[2] = 0xFFFFB404', "slot_py": None, "target": None, "cond": None},
    0x23712: {"kind": 'reg', "py": 'r[3] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x23714: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFB404, 1, r[3])', "target": None, "cond": None},}
