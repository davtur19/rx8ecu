#!/usr/bin/env python3
"""Differential test for sensor_return_11206 (0x11206) — v3 lift (branches + delay slots), 18 bytes.
...
Run from repo root: python3 c/tests/test_sensor_return_11206_11206.py
"""
...
RAM_MAX = 0xFFFFA0D4
SPAN_END = 0x11218
SENT = 0x11218     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x11206: {"kind": "ret", "py": None, "slot_py": 'r[0] = s8(0x01)', "target": None, "cond": None},
    0x1120a: {"kind": 'reg', "py": 'r[3] = 0xFFFFA0D4', "slot_py": None, "target": None, "cond": None},
    0x1120c: {"kind": 'mem', "py": 'r[4] = s16(_rdw(ram, 0xFFFFA0D4, 2))', "slot_py": None, "target": None, "cond": None},
    0x1120e: {"kind": 'reg', "py": 'r[4] = r[4] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x11210: {"kind": 'reg', "py": 'r[4] = (r[4] << 2) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x11212: {"kind": 'reg', "py": 'r[4] = (r[4] << 2) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x11214: {"kind": "ret", "py": None, "slot_py": 'r[0] = r[4]', "target": None, "cond": None},}
