#!/usr/bin/env python3
"""Differential test for rtos_noop_stub_5028 (0x5028) — v3 lift (branches + delay slots), 18 bytes.
...
Run from repo root: python3 c/tests/test_rtos_noop_stub_5028_5028.py
"""
...
RAM_MAX = 0xFFFFEC12
SPAN_END = 0x503A
SENT = 0x503A     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x5028: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},
    0x502c: {"kind": 'reg', "py": 'r[1] = 0x00005A1F', "slot_py": None, "target": None, "cond": None},
    0x502e: {"kind": 'reg', "py": 'r[0] = 0xFFFFEC12', "slot_py": None, "target": None, "cond": None},
    0x5030: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFEC12, 2, r[1])', "slot_py": None, "target": None, "cond": None},
    0x5032: {"kind": 'reg', "py": 'r[3] = 0x0000A518', "slot_py": None, "target": None, "cond": None},
    0x5034: {"kind": 'reg', "py": 'r[2] = 0xFFFFEC10', "slot_py": None, "target": None, "cond": None},
    0x5036: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFEC10, 2, r[3])', "target": None, "cond": None},}
