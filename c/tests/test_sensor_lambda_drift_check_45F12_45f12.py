#!/usr/bin/env python3
"""Differential test for sensor_lambda_drift_check_45F12 (0x45F12) — v3 lift (branches + delay slots), 54 bytes.
...
Run from repo root: python3 c/tests/test_sensor_lambda_drift_check_45F12_45f12.py
"""
...
ENTRY = 0x45F12
RAW = bytes.fromhex("92 19 64 21 64 4D D3 0C 24 38 97 15 04 29 D6 0B 60 4C 65 60 88 01 8F 07 65 5C 60 53 88 01 8F 08 00 09 E3 01 A0 05 27 30 25 58 8F 02 00 09 E2 00 27 20 00 0B 26 40")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFF74E
SPAN_END = 0x45F48
SENT = 0x45F54     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x45f12: {"kind": 'reg', "py": 'r[2] = 0xFFFFF74E', "slot_py": None, "target": None, "cond": None},
    0x45f14: {"kind": 'mem', "py": 'r[4] = s16(_rdw(ram, 0xFFFFF74E, 2))', "slot_py": None, "target": None, "cond": None},
    0x45f16: {"kind": 'reg', "py": 'r[4] = r[4] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x45f18: {"kind": 'reg', "py": 'r[3] = 0x00008000', "slot_py": None, "target": None, "cond": None},
    0x45f1a: {"kind": 'reg', "py": 'T = 1 if (r[4] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x45f1c: {"kind": 'reg', "py": 'r[7] = 0xFFFFCC10', "slot_py": None, "target": None, "cond": None},
    0x45f1e: {"kind": 'reg', "py": 'r[4] = T;', "slot_py": None, "target": None, "cond": None},
    0x45f20: {"kind": 'reg', "py": 'r[6] = 0xFFFFCC11', "slot_py": None, "target": None, "cond": None},
    0x45f22: {"kind": 'reg', "py": 'r[0] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x45f24: {"kind": 'mem', "py": 'r[5] = s8(_rdw(ram, 0xFFFFCC11, 1))', "slot_py": None, "target": None, "cond": None},
    0x45f26: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x45f28: {"kind": "branch", "py": None, "slot_py": 'r[5] = r[5] & 0xFF', "target": 0x45f3a, "cond": 'notT'},
    0x45f2c: {"kind": 'reg', "py": 'r[0] = r[5]', "slot_py": None, "target": None, "cond": None},
    0x45f2e: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x45f30: {"kind": "branch", "py": None, "slot_py": '', "target": 0x45f44, "cond": 'notT'},
    0x45f34: {"kind": 'reg', "py": 'r[3] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x45f36: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFCC10, 1, r[3])', "target": 0x45f44, "cond": 'always'},
    0x45f3a: {"kind": 'reg', "py": 'T = 1 if (r[5] & r[5]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x45f3c: {"kind": "branch", "py": None, "slot_py": '', "target": 0x45f44, "cond": 'notT'},
    0x45f40: {"kind": 'reg', "py": 'r[2] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x45f42: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCC10, 1, r[2])', "slot_py": None, "target": None, "cond": None},
    0x45f44: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFCC11, 1, r[4])', "target": None, "cond": None},}
