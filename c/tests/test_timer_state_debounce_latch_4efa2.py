#!/usr/bin/env python3
"""Differential test for timer_state_debounce_latch (0x4EFA2) — pure straight-line lift, 8 bytes.
...
Run from repo root: python3 c/tests/test_timer_state_debounce_latch_4efa2.py
"""
...
ENTRY = 0x4EFA2
RAW = bytes.fromhex("E7 01 94 30 95 30 92 30")
SEED = 42
N = 2000
