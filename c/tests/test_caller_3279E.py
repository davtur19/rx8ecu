#!/usr/bin/env python3
"""Differential test for caller_3279E (entry 0x3279E) — v8 ST caller (CFG), 40 bytes.
...
Run: python3 test_caller_3279E.py
"""
...
CODE = {
    0x3279e: {"kind": 'mem', "py": 'local[0x3FC] = r[14]\n_wrw(ram, STACK_BASE + 0x3FC, 4, r[14])\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x327a0: {"kind": 'st', "py": 'local[0x3F8] = pr\n_wrw(ram, STACK_BASE + 0x3F8, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x327a2: {"kind": 'reg', "py": 'r[14] = 0xFFFFBFD6', "slot_py": None, "target": None, "cond": None},
    0x327a4: {"kind": 'reg', "py": 'r[3] = 0xFFFFA41C', "slot_py": None, "target": None, "cond": None},
    0x327a6: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFA41C, 1))', "slot_py": None, "target": None, "cond": None},
    0x327a8: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x327aa: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x327ac: {"kind": "branch", "py": None, "slot_py": '', "target": 0x327bc, "cond": 'notT'},
    0x327b0: {"kind": 'reg', "py": 'r[1] = 0x00002460', "slot_py": None, "target": None, "cond": None},
    0x327b2: {"kind": 'reg', "py": 'r[5] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x327b4: {"kind": "call", "py": None, "slot_py": 'r[4] = s16(_rdw(ram, 0xFFFFBFD6, 2))', "target": 0x2460, "ret_pc": 0x327b8, "set_pr": True, "cond": None},
    0x327b8: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFBFD6, 2, r[0])', "target": 0x327c0, "cond": 'always'},
    0x327bc: {"kind": 'reg', "py": 'r[2] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x327be: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBFD6, 2, r[2])', "slot_py": None, "target": None, "cond": None},
    0x327c0: {"kind": 'st', "py": 'pr = _rdw(ram, STACK_BASE + 0x3F8, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x327c2: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, STACK_BASE + 0x3FC, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},
