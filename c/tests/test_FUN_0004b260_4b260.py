#!/usr/bin/env python3
"""Differential test for FUN_0004b260 (0x4B260) — v3 lift (branches + delay slots), 46 bytes.
...
Run from repo root: python3 c/tests/test_FUN_0004b260_4b260.py
"""
...
ENTRY = 0x4B260
RAW = bytes.fromhex("A0 01 26 70 26 40 93 29 60 30 60 0C 88 01 8D 06 00 09 92 24 60 20 60 0C 88 01 8F 02 00 09 A0 04 25 70 A0 02 25 40 26 40 25 40 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCDBE
SPAN_END = 0x4B28E
SENT = 0x4B28E     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x4b260: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, r[6], 1, r[7])', "target": 0x4b266, "cond": 'always'},
    0x4b264: {"kind": 'mem', "py": '_wrw(ram, r[6], 1, r[4])', "slot_py": None, "target": None, "cond": None},
    ...
    0x4b27e: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, r[5], 1, r[7])', "target": 0x4b28a, "cond": 'always'},
    0x4b282: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, r[5], 1, r[4])', "target": 0x4b28a, "cond": 'always'},
    0x4b286: {"kind": 'mem', "py": '_wrw(ram, r[6], 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x4b288: {"kind": 'mem', "py": '_wrw(ram, r[5], 1, r[4])', "slot_py": None, "target": None, "cond": None},
