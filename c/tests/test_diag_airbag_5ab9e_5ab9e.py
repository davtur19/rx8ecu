#!/usr/bin/env python3
"""Differential test for diag_airbag_5ab9e (0x5AB9E) — v3 lift (branches + delay slots), 38 bytes.
...
Run from repo root: python3 c/tests/test_diag_airbag_5ab9e_5ab9e.py
"""
...
CODE = {
    0x5ab9e: {"kind": 'reg', "py": 'r[3] = 0xFFFFA41C', "slot_py": None, "target": None, "cond": None},
    0x5aba0: {"kind": 'mem', "py": 'r[4] = s8(_rdw(ram, 0xFFFFA41C, 1))', "slot_py": None, "target": None, "cond": None},
    0x5aba2: {"kind": 'reg', "py": 'r[4] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x5aba4: {"kind": 'reg', "py": 'T = 1 if (r[4] & r[4]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x5aba6: {"kind": "branch", "py": None, "slot_py": '', "target": 0x5abc0, "cond": 'notT'},
    0x5abaa: {"kind": 'reg', "py": 'r[2] = 0xFFFFD2C0', "slot_py": None, "target": None, "cond": None},
    0x5abac: {"kind": 'reg', "py": 'r[0] = 0x0000FFFF', "slot_py": None, "target": None, "cond": None},
    0x5abae: {"kind": 'mem', "py": 'r[1] = s16(_rdw(ram, 0xFFFFD2C0, 2))', "slot_py": None, "target": None, "cond": None},
    0x5abb0: {"kind": 'reg', "py": 'r[1] = r[1] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x5abb2: {"kind": 'reg', "py": 'T = 1 if r[1] == r[0] else 0', "slot_py": None, "target": None, "cond": None},
    0x5abb4: {"kind": "branch", "py": None, "slot_py": '', "target": 0x5abc0, "cond": 'T'},
    0x5abb8: {"kind": 'reg', "py": 'r[4] = 0xFFFFD2C0', "slot_py": None, "target": None, "cond": None},
    0x5abba: {"kind": 'mem', "py": 'r[2] = s16(_rdw(ram, 0xFFFFD2C0, 2))', "slot_py": None, "target": None, "cond": None},
    0x5abbc: {"kind": 'reg', "py": 'r[2] = (r[2] + s8(0x01)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x5abbe: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD2C0, 2, r[2])', "slot_py": None, "target": None, "cond": None},
    0x5abc0: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
