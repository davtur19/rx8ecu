#!/usr/bin/env python3
"""Differential test for diag_reset_session_state (0x1720) — pure straight-line lift, 12 bytes.
...
Run from repo root: python3 c/tests/test_diag_reset_session_state_1720.py
"""
...
ENTRY = 0x1720
RAW = bytes.fromhex("D7 44 E5 00 D3 44 60 43 D2 44 88 01")
SEED = 42
N = 2000
