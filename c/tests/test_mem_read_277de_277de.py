#!/usr/bin/env python3
"""Differential test for mem_read_277de (0x277DE) — v3 lift (branches + delay slots), 12 bytes.
...
Run from repo root: python3 c/tests/test_mem_read_277de_277de.py
"""
...
CODE = {
    0x277de: {"kind": 'reg', "py": 'r[1] = 0xFFFFA3B0', "slot_py": None, "target": None, "cond": None},
    0x277e0: {"kind": 'reg', "py": 'r[2] = 0xFFFFB6D0', "slot_py": None, "target": None, "cond": None},
    0x277e2: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFA3B0, 1))', "slot_py": None, "target": None, "cond": None},
    0x277e4: {"kind": 'reg', "py": 'r[3] = r[3] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x277e6: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFB6D0, 2, r[3])', "target": None, "cond": None},}
