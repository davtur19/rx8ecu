#!/usr/bin/env python3
"""Differential test for state_byte_latch_a8bb (0x1622C) — v3 lift (branches + delay slots), 10 bytes.
...
Run from repo root: python3 c/tests/test_state_byte_latch_a8bb_1622c.py
"""
...
ENTRY = 0x1622C
RAW = bytes.fromhex("92 5E 63 20 D1 33 00 0B 21 30")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBD89
SPAN_END = 0x16236
SENT = 0x16236     # stop-sentinel, placed past the literal pool
