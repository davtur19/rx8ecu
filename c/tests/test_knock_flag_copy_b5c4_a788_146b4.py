#!/usr/bin/env python3
"""Differential test for knock_flag_copy_b5c4_a788 (0x146B4) — v3 lift (branches + delay slots), 32 bytes.
...
Run from repo root: python3 c/tests/test_knock_flag_copy_b5c4_a788_146b4.py
"""
...
ENTRY = 0x146B4
RAW = bytes.fromhex("94 0C 93 0C 60 30 60 0C 88 01 8F 03 00 09 E1 01 A0 02 24 10 E0 00 24 00 00 0B 00 09 A7 88 B5 C4")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFB5C4
SPAN_END = 0x146D4
SENT = 0x146D4     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x146b4: {"kind": 'reg', "py": 'r[4] = 0xFFFFA788', "slot_py": None, "target": None, "cond": None},
    0x146b6: {"kind": 'reg', "py": 'r[3] = 0xFFFFB5C4', "slot_py": None, "target": None, "cond": None},
    0x146b8: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFB5C4, 1))', "slot_py": None, "target": None, "cond": None},
    0x146ba: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x146bc: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x146be: {"kind": "branch", "py": None, "slot_py": '', "target": 0x146c8, "cond": 'notT'},
    0x146c2: {"kind": 'reg', "py": 'r[1] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x146c4: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFA788, 1, r[1])', "target": 0x146cc, "cond": 'always'},
    0x146c8: {"kind": 'reg', "py": 'r[0] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x146ca: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA788, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x146cc: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
