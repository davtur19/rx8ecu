#!/usr/bin/env python3
"""Differential test for FUN_0004c5c2 (0x4C5C2) — v3 lift (branches + delay slots), 30 bytes.
...
Run from repo root: python3 c/tests/test_FUN_0004c5c2_4c5c2.py
"""
...
ENTRY = 0x4C5C2
RAW = bytes.fromhex("93 3C 60 30 60 0C 88 01 8F 07 00 09 E4 00 91 36 21 40 92 35 22 40 93 34 23 40 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCFD9
SPAN_END = 0x4C5E0
SENT = 0x4C5E0     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x4c5c2: {"kind": 'reg', "py": 'r[3] = 0xFFFFCFD9', "slot_py": None, "target": None, "cond": None},
    0x4c5c4: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCFD9, 1))', "slot_py": None, "target": None, "cond": None},
    0x4c5c6: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x4c5c8: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x4c5ca: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4c5dc, "cond": 'notT'},
    0x4c5ce: {"kind": 'reg', "py": 'r[4] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x4c5d0: {"kind": 'reg', "py": 'r[1] = 0xFFFFCDC1', "slot_py": None, "target": None, "cond": None},
    0x4c5d2: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCDC1, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x4c5d4: {"kind": 'reg', "py": 'r[2] = 0xFFFFCDBF', "slot_py": None, "target": None, "cond": None},
    0x4c5d6: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCDBF, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x4c5d8: {"kind": 'reg', "py": 'r[3] = 0xFFFFCDC0', "slot_py": None, "target": None, "cond": None},
    0x4c5da: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCDC0, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x4c5dc: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
