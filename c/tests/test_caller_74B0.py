#!/usr/bin/env python3
"""Differential test for caller_74B0 (entry 0x74B0) — v8 ST caller (CFG), 42 bytes.
...
Run: python3 test_caller_74B0.py
"""
...
CODE = {
    0x74b0: {"kind": 'st', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x74b2: {"kind": 'reg', "py": 'r[15] = (r[15] + s8(0xFC)) & 0xFFFFFFFF\nsp = (sp + s8(0xFC)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x74b4: {"kind": 'reg', "py": 'r[5] = 0x000000E0', "slot_py": None, "target": None, "cond": None},
    0x74b6: {"kind": 'reg', "py": 'r[3] = 0x00002054', "slot_py": None, "target": None, "cond": None},
    0x74b8: {"kind": "call", "py": None, "slot_py": 'r[4] = r[15]', "target": 0x2054, "ret_pc": 0x74bc, "set_pr": True, "cond": None},
    0x74bc: {"kind": 'reg', "py": 'r[3] = 0x00002064', "slot_py": None, "target": None, "cond": None},
    0x74be: {"kind": "call", "py": None, "slot_py": 'r[4] = _rdw(ram, sp, 4)', "target": 0x2064, "ret_pc": 0x74c2, "set_pr": True, "cond": None},
    0x74c2: {"kind": 'reg', "py": 'r[15] = (r[15] + s8(0x04)) & 0xFFFFFFFF\nsp = (sp + s8(0x04)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x74c4: {"kind": 'st', "py": 'pr = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x74c6: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},
    0x74d4: {"kind": 'reg', "py": 'r[3] = 0xFFFF9FA3', "slot_py": None, "target": None, "cond": None},
    0x74d6: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, r[3], 1, r[4])', "target": None, "cond": None},
