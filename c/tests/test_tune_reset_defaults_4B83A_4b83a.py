#!/usr/bin/env python3
"""Differential test for tune_reset_defaults_4B83A (0x4B83A) — v3 lift (branches + delay slots), 42 bytes.
...
Run from repo root: python3 c/tests/test_tune_reset_defaults_4B83A_4b83a.py
"""
...
CODE = {
    0x4b83a: {"kind": 'reg', "py": 'r[5] = 0xFFFFCE1B', "slot_py": None, "target": None, "cond": None},
    0x4b83c: {"kind": 'reg', "py": 'r[3] = 0xFFFFA42C', "slot_py": None, "target": None, "cond": None},
    0x4b83e: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFA42C, 1))', "slot_py": None, "target": None, "cond": None},
    0x4b840: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x4b842: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x4b844: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4b850, "cond": 'notT'},
    0x4b848: {"kind": 'reg', "py": 'r[2] = 0x0007C6B4', "slot_py": None, "target": None, "cond": None},
    0x4b84a: {"kind": 'mem', "py": 'r[1] = s8(_rdw(ram, 0x0007C6B4, 1))', "slot_py": None, "target": None, "cond": None},
    0x4b84c: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFCE1B, 1, r[1])', "target": 0x4b860, "cond": 'always'},
    0x4b850: {"kind": 'mem', "py": 'r[4] = s8(_rdw(ram, 0xFFFFCE1B, 1))', "slot_py": None, "target": None, "cond": None},
    0x4b852: {"kind": 'reg', "py": 'r[2] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x4b854: {"kind": 'reg', "py": 'T = 1 if s32(r[2]) > 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x4b856: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4b860, "cond": 'notT'},
    0x4b85a: {"kind": 'reg', "py": 'r[2] = 0x000000FF', "slot_py": None, "target": None, "cond": None},
    0x4b85c: {"kind": 'reg', "py": 'r[4] = (r[4] + r[2]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x4b85e: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCE1B, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x4b860: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
