#!/usr/bin/env python3
"""Differential test for sys_flags_9ec8_bit0_latch_cdb6 (0x4C292) — v3 lift (branches + delay slots), 40 bytes.
...
Run from repo root: python3 c/tests/test_sys_flags_9ec8_bit0_latch_cdb6_4c292.py
"""
...
ENTRY = 0x4C292
RAW = bytes.fromhex("E4 01 D3 2C 95 4B 60 31 60 0D 20 48 8D 02 00 09 A0 01 60 43 E0 00 88 01 8F 02 00 09 A0 02 25 40 E2 00 25 20 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCDB6
SPAN_END = 0x4C2BA
SENT = 0x4C2BA     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x4c292: {"kind": 'reg', "py": 'r[4] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x4c294: {"kind": 'reg', "py": 'r[3] = 0xFFFF9EC8', "slot_py": None, "target": None, "cond": None},
    0x4c296: {"kind": 'reg', "py": 'r[5] = 0xFFFFCDB6', "slot_py": None, "target": None, "cond": None},
    0x4c298: {"kind": 'mem', "py": 'r[0] = s16(_rdw(ram, 0xFFFF9EC8, 2))', "slot_py": None, "target": None, "cond": None},
    0x4c29a: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x4c29c: {"kind": 'reg', "py": 'T = 1 if (r[0] & r[4]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x4c29e: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4c2a6, "cond": 'T'},
    0x4c2a2: {"kind": "branch", "py": None, "slot_py": 'r[0] = r[4]', "target": 0x4c2a8, "cond": 'always'},
    0x4c2a6: {"kind": 'reg', "py": 'r[0] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x4c2a8: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x4c2aa: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4c2b2, "cond": 'notT'},
    0x4c2ae: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFCDB6, 1, r[4])', "target": 0x4c2b6, "cond": 'always'},
    0x4c2b2: {"kind": 'reg', "py": 'r[2] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x4c2b4: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCDB6, 1, r[2])', "slot_py": None, "target": None, "cond": None},
    0x4c2b6: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
