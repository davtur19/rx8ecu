#!/usr/bin/env python3
"""Differential test for interrupt_state_update_5E878 (0x5E878) — v3 lift (branches + delay slots), 24 bytes.
...
Run from repo root: python3 c/tests/test_interrupt_state_update_5E878_5e878.py
"""
...
ENTRY = 0x5E878
RAW = bytes.fromhex("D2 0A 63 21 91 08 63 3D 33 13 8F 02 00 09 A0 01 E4 00 E4 01 00 0B 60 43")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFD3B6
SPAN_END = 0x5E890
SENT = 0x5E8A8     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x5e878: {"kind": 'reg', "py": 'r[2] = 0xFFFFD3B6', "slot_py": None, "target": None, "cond": None},
    0x5e87a: {"kind": 'mem', "py": 'r[3] = s16(_rdw(ram, 0xFFFFD3B6, 2))', "slot_py": None, "target": None, "cond": None},
    0x5e87c: {"kind": 'reg', "py": 'r[1] = 0x00000271', "slot_py": None, "target": None, "cond": None},
    0x5e87e: {"kind": 'reg', "py": 'r[3] = r[3] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x5e880: {"kind": 'reg', "py": 'T = 1 if s32(r[3]) >= s32(r[1]) else 0', "slot_py": None, "target": None, "cond": None},
    0x5e882: {"kind": "branch", "py": None, "slot_py": '', "target": 0x5e88a, "cond": 'notT'},
    0x5e886: {"kind": "branch", "py": None, "slot_py": 'r[4] = s8(0x00)', "target": 0x5e88c, "cond": 'always'},
    0x5e88a: {"kind": 'reg', "py": 'r[4] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x5e88c: {"kind": "ret", "py": None, "slot_py": 'r[0] = r[4]', "target": None, "cond": None},}
