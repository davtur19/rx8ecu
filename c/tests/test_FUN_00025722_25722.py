#!/usr/bin/env python3
"""Differential test for FUN_00025722 (0x25722) — v3 lift + v4 FPU, 12 bytes.
...
Run from repo root: python3 c/tests/test_FUN_00025722_25722.py
"""
...
RAM_MAX = 0xFFFFB5B0
SPAN_END = 0x2572E
SENT = 0x2572E     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x25722: {"kind": 'fpu', "py": 'fr[4] = 0.0', "slot_py": None, "target": None, "cond": None},
    0x25724: {"kind": 'reg', "py": 'r[3] = 0xFFFFB5A8', "slot_py": None, "target": None, "cond": None},
    0x25726: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFB5A8, 4, f2bits(fr[4]))', "slot_py": None, "target": None, "cond": None},
    0x25728: {"kind": 'reg', "py": 'r[2] = 0xFFFFB5B0', "slot_py": None, "target": None, "cond": None},
    0x2572a: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFB5B0, 4, f2bits(fr[4]))', "target": None, "cond": None},}
