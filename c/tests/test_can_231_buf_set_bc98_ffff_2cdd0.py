#!/usr/bin/env python3
"""Differential test for can_231_buf_set_bc98_ffff (0x2CDD0) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_can_231_buf_set_bc98_ffff_2cdd0.py
"""
...
ENTRY = 0x2CDD0
RAW = bytes.fromhex("D2 0D D0 09 00 0B 20 21")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBC98
SPAN_END = 0x2CDD8
SENT = 0x2CDD8     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x2cdd0: {"kind": 'reg', "py": 'r[2] = 0x0000FFFF', "slot_py": None, "target": None, "cond": None},
    0x2cdd2: {"kind": 'reg', "py": 'r[0] = 0xFFFFBC98', "slot_py": None, "target": None, "cond": None},
    0x2cdd4: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBC98, 2, r[2])', "target": None, "cond": None},}
