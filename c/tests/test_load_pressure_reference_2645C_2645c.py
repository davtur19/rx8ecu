#!/usr/bin/env python3
"""Differential test for load_pressure_reference_2645C (0x2645C) — v3 lift + v4 FPU, 20 bytes.
...
Run from repo root: python3 c/tests/test_load_pressure_reference_2645C_2645c.py
"""
...
RAM_MAX = 0xFFFFB604
SPAN_END = 0x26470
SENT = 0x26470     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x2645c: {"kind": 'reg', "py": 'r[4] = 0xFFFFB5FC', "slot_py": None, "target": None, "cond": None},
    0x2645e: {"kind": 'reg', "py": 'r[3] = 0xFFFF9F68', "slot_py": None, "target": None, "cond": None},
    0x26460: {"kind": 'reg', "py": 'r[2] = 0xFFFFB600', "slot_py": None, "target": None, "cond": None},
    0x26462: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFF9F68, 4))', "slot_py": None, "target": None, "cond": None},
    0x26464: {"kind": 'fpu', "py": '_wrw(ram, r[4], 4, f2bits(fr[3]))', "slot_py": None, "target": None, "cond": None},
    0x26466: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFB600, 4, f2bits(fr[3]))', "slot_py": None, "target": None, "cond": None},
    0x26468: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, r[4], 4))', "slot_py": None, "target": None, "cond": None},
    0x2646a: {"kind": 'reg', "py": 'r[1] = 0xFFFFB604', "slot_py": None, "target": None, "cond": None},
    0x2646c: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFB604, 4, f2bits(fr[3]))', "target": None, "cond": None},}
