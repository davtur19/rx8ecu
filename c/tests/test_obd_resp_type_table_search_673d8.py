#!/usr/bin/env python3
"""Differential test for obd_resp_type_table_search (0x673D8) — v3 lift (branches + delay slots), 40 bytes.
...
Run from repo root: python3 c/tests/test_obd_resp_type_table_search_673d8.py
"""
...
ENTRY = 0x673D8
RAW = bytes.fromhex("97 3E E5 00 D0 24 E6 01 63 53 43 00 02 3C 63 4C 62 2C 32 30 8F 02 00 09 A0 04 67 53 75 01 35 63 8F F2 00 09 00 0B 60 73")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = None
SPAN_END = 0x67400
SENT = 0x67400     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x673d8: {"kind": 'reg', "py": 'r[7] = 0x000000FF', "slot_py": None, "target": None, "cond": None},
    0x673da: {"kind": 'reg', "py": 'r[5] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x673dc: {"kind": 'reg', "py": 'r[0] = 0xFFFFDC03', "slot_py": None, "target": None, "cond": None},
    0x673de: {"kind": 'reg', "py": 'r[6] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x673e0: {"kind": 'reg', "py": 'r[3] = r[5]', "slot_py": None, "target": None, "cond": None},
    0x673e2: {"kind": 'reg', "py": 'T = (r[3] >> 31) & 1\nr[3] = (r[3] << 1) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x673e4: {"kind": 'mem', "py": 'r[2] = s8(_rdw(ram, (r[3] + r[0]), 1))', "slot_py": None, "target": None, "cond": None},
    0x673e6: {"kind": 'reg', "py": 'r[3] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x673e8: {"kind": 'reg', "py": 'r[2] = r[2] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x673ea: {"kind": 'reg', "py": 'T = 1 if r[2] == r[3] else 0', "slot_py": None, "target": None, "cond": None},
    0x673ec: {"kind": "branch", "py": None, "slot_py": '', "target": 0x673f4, "cond": 'notT'},
    0x673f0: {"kind": "branch", "py": None, "slot_py": 'r[7] = r[5]', "target": 0x673fc, "cond": 'always'},
    0x673f4: {"kind": 'reg', "py": 'r[5] = (r[5] + s8(0x01)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x673f6: {"kind": 'reg', "py": 'T = 1 if s32(r[5]) >= s32(r[6]) else 0', "slot_py": None, "target": None, "cond": None},
    0x673f8: {"kind": "branch", "py": None, "slot_py": '', "target": 0x673e0, "cond": 'notT'},
    0x673fc: {"kind": "ret", "py": None, "slot_py": 'r[0] = r[7]', "target": None, "cond": None},}
