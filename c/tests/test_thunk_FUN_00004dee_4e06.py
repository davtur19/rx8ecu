#!/usr/bin/env python3
"""Differential test for thunk_FUN_00004dee (0x4E06) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_thunk_FUN_00004dee_4e06.py
"""
...
ENTRY = 0x4E06
RAW = bytes.fromhex("E3 00 91 25 00 0B 21 31")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFEC0A
SPAN_END = 0x4E0E
SENT = 0x4E0E     # stop-sentinel, placed past the literal pool
