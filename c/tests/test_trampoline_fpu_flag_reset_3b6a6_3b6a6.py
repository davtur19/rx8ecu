#!/usr/bin/env python3
"""Differential test for trampoline_fpu_flag_reset_3b6a6 (0x3B6A6) — v3 lift + v4 FPU, 10 bytes.
...
Run from repo root: python3 c/tests/test_trampoline_fpu_flag_reset_3b6a6_3b6a6.py
"""
...
ENTRY = 0x3B6A6
RAW = bytes.fromhex("93 21 92 19 F3 38 00 0B F2 3A")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFC5A8
SPAN_END = 0x3B6B0
SENT = 0x3B6B0     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x3b6a6: {"kind": 'reg', "py": 'r[3] = 0xFFFFBF18', "slot_py": None, "target": None, "cond": None},
    0x3b6a8: {"kind": 'reg', "py": 'r[2] = 0xFFFFC5A8', "slot_py": None, "target": None, "cond": None},
    0x3b6aa: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFBF18, 4))', "slot_py": None, "target": None, "cond": None},
    0x3b6ac: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFC5A8, 4, f2bits(fr[3]))', "target": None, "cond": None},}
