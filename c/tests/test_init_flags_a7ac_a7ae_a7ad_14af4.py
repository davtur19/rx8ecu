#!/usr/bin/env python3
"""Differential test for init_flags_a7ac_a7ae_a7ad (0x14AF4) — v3 lift (branches + delay slots), 16 bytes.
...
Run from repo root: python3 c/tests/test_init_flags_a7ac_a7ae_a7ad_14af4.py
"""
...
CODE = {
    0x14af4: {"kind": 'reg', "py": 'r[3] = 0xFFFFA7AC', "slot_py": None, "target": None, "cond": None},
    0x14af6: {"kind": 'reg', "py": 'r[4] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x14af8: {"kind": 'reg', "py": 'r[2] = 0xFFFFA7AE', "slot_py": None, "target": None, "cond": None},
    0x14afa: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA7AC, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x14afc: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA7AE, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x14afe: {"kind": 'reg', "py": 'r[1] = 0xFFFFA7AD', "slot_py": None, "target": None, "cond": None},
    0x14b00: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFA7AD, 1, r[4])', "target": None, "cond": None},}
