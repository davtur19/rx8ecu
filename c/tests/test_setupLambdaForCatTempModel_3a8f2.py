#!/usr/bin/env python3
"""Differential test for setupLambdaForCatTempModel (0x3A8F2) — v3 lift + v4 FPU, 10 bytes.
...
Run from repo root: python3 c/tests/test_setupLambdaForCatTempModel_3a8f2.py
"""
...
RAM_MAX = 0xFFFFC538
SPAN_END = 0x3A8FC
SENT = 0x3A8FC     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x3a8f2: {"kind": 'reg', "py": 'r[3] = 0xFFFFBECC', "slot_py": None, "target": None, "cond": None},
    0x3a8f4: {"kind": 'reg', "py": 'r[2] = 0xFFFFC538', "slot_py": None, "target": None, "cond": None},
    0x3a8f6: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFBECC, 4))', "slot_py": None, "target": None, "cond": None},
    0x3a8f8: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFC538, 4, f2bits(fr[3]))', "target": None, "cond": None},}
