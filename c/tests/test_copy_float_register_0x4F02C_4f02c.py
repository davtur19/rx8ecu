#!/usr/bin/env python3
"""Differential test for copy_float_register_0x4F02C (0x4F02C) — v3 lift + v4 FPU, 10 bytes.
...
Run from repo root: python3 c/tests/test_copy_float_register_0x4F02C_4f02c.py
"""
...
ENTRY = 0x4F02C
RAW = bytes.fromhex("93 77 F3 38 92 76 00 0B F2 3A")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCFCC
SPAN_END = 0x4F036
SENT = 0x4F036     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x4f02c: {"kind": 'reg', "py": 'r[3] = 0xFFFFCFC8', "slot_py": None, "target": None, "cond": None},
    0x4f02e: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFCFC8, 4))', "slot_py": None, "target": None, "cond": None},
    0x4f030: {"kind": 'reg', "py": 'r[2] = 0xFFFFCFCC', "slot_py": None, "target": None, "cond": None},
    0x4f032: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFCFCC, 4, f2bits(fr[3]))', "target": None, "cond": None},}
