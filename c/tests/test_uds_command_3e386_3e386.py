#!/usr/bin/env python3
"""Differential test for uds_command_3e386 (0x3E386) — v3 lift + v4 FPU, 20 bytes.
...
Run from repo root: python3 c/tests/test_uds_command_3e386_3e386.py
"""
...
RAM_MAX = 0xFFFFC67C
SPAN_END = 0x3E39A
SENT = 0x3E39A     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x3e386: {"kind": 'reg', "py": 'r[0] = 0xFFFFBC1C', "slot_py": None, "target": None, "cond": None},
    0x3e388: {"kind": 'reg', "py": 'r[4] = 0xFFFFC688', "slot_py": None, "target": None, "cond": None},
    0x3e38a: {"kind": 'fpu', "py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFBC1C, 4))', "slot_py": None, "target": None, "cond": None},
    0x3e38c: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, r[4], 4))', "slot_py": None, "target": None, "cond": None},
    0x3e38e: {"kind": 'fpu', "py": 'fr[2] = fr[4]', "slot_py": None, "target": None, "cond": None},
    0x3e390: {"kind": 'reg', "py": 'r[3] = 0xFFFFC67C', "slot_py": None, "target": None, "cond": None},
    0x3e392: {"kind": 'fpu', "py": 'fr[2] = ts(fr[2] - fr[3])', "slot_py": None, "target": None, "cond": None},
    0x3e394: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFC67C, 4, f2bits(fr[2]))', "slot_py": None, "target": None, "cond": None},
    0x3e396: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, r[4], 4, f2bits(fr[4]))', "target": None, "cond": None},}
