#!/usr/bin/env python3
"""Differential test for revlimit_byte_copy_b129_to_c169 (0x345B4) — v3 lift + v4 FPU, 16 bytes.
...
Run from repo root: python3 c/tests/test_revlimit_byte_copy_b129_to_c169_345b4.py
"""
...
ENTRY = 0x345B4
RAW = bytes.fromhex("92 6E F3 9D D0 3C 63 20 D1 3A 21 30 00 0B F0 3A")
SEED = 43
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFC169
SPAN_END = 0x345C4
SENT = 0x345C4     # stop-sentinel, placed past the literal pool
