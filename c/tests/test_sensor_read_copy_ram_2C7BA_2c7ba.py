#!/usr/bin/env python3
"""Differential test for sensor_read_copy_ram_2C7BA (0x2C7BA) — v3 lift (branches + delay slots), 42 bytes.
...
Run from repo root: python3 c/tests/test_sensor_read_copy_ram_2C7BA_2c7ba.py
"""
...
ENTRY = 0x2C7BA
RAW = bytes.fromhex("95 14 92 14 63 20 63 3C 43 15 8F 04 00 09 D3 0C 61 30 A0 08 25 10 64 50 63 4C 23 38 8D 03 00 09 90 06 34 0C 25 40 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBC66
SPAN_END = 0x2C7E4
SENT = 0x2C800     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x2c7ba: {"kind": 'reg', "py": 'r[5] = 0xFFFFBC66', "slot_py": None, "target": None, "cond": None},
    0x2c7bc: {"kind": 'reg', "py": 'r[2] = 0xFFFFA400', "slot_py": None, "target": None, "cond": None},
    0x2c7be: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFA400, 1))', "slot_py": None, "target": None, "cond": None},
    0x2c7c0: {"kind": 'reg', "py": 'r[3] = r[3] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x2c7c2: {"kind": 'reg', "py": 'T = 1 if s32(r[3]) > 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x2c7c4: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2c7d0, "cond": 'notT'},
    0x2c7c8: {"kind": 'reg', "py": 'r[3] = 0x0006CF82', "slot_py": None, "target": None, "cond": None},
    0x2c7ca: {"kind": 'mem', "py": 'r[1] = s8(_rdw(ram, 0x0006CF82, 1))', "slot_py": None, "target": None, "cond": None},
    0x2c7cc: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFBC66, 1, r[1])', "target": 0x2c7e0, "cond": 'always'},
    0x2c7d0: {"kind": 'mem', "py": 'r[4] = s8(_rdw(ram, 0xFFFFBC66, 1))', "slot_py": None, "target": None, "cond": None},
    0x2c7d2: {"kind": 'reg', "py": 'r[3] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x2c7d4: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x2c7d6: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2c7e0, "cond": 'T'},
    0x2c7da: {"kind": 'reg', "py": 'r[0] = 0x000000FF', "slot_py": None, "target": None, "cond": None},
    0x2c7dc: {"kind": 'reg', "py": 'r[4] = (r[4] + r[0]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x2c7de: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBC66, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x2c7e0: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
