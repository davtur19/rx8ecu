#!/usr/bin/env python3
"""Differential test for caller_1B90C (entry 0x1B90C) — v8 ST caller (CFG), 24 bytes.
...
Run: python3 test_caller_1B90C.py
"""
...
CODE = {
    0x1b90c: {"kind": 'st', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x1b90e: {"kind": 'fpu', "py": 'fr[6] = 0.0', "slot_py": None, "target": None, "cond": None},
    0x1b910: {"kind": 'reg', "py": 'r[0] = 0x0001B9B4', "slot_py": None, "target": None, "cond": None},
    0x1b912: {"kind": 'reg', "py": 'r[2] = 0xFFFFA3E4', "slot_py": None, "target": None, "cond": None},
    0x1b914: {"kind": 'reg', "py": 'r[3] = 0x00002490', "slot_py": None, "target": None, "cond": None},
    0x1b916: {"kind": 'fpu', "py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFA3E4, 4))', "slot_py": None, "target": None, "cond": None},
    0x1b918: {"kind": "call", "py": None, "slot_py": 'fr[5] = bits2f(_rdw(ram, 0x0001B9B4, 4))', "target": 0x2490, "ret_pc": 0x1b91c, "set_pr": True, "cond": None},
    0x1b91c: {"kind": 'reg', "py": 'r[2] = 0xFFFFAD80', "slot_py": None, "target": None, "cond": None},
    0x1b91e: {"kind": 'st', "py": 'pr = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x1b920: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, r[2], 2, r[0])', "target": None, "cond": None},
