#!/usr/bin/env python3
"""Differential test for FUN_0004c5e0 (0x4C5E0) — pure straight-line lift, 10 bytes.
...
Run from repo root: python3 c/tests/test_FUN_0004c5e0_4c5e0.py
"""
...
ENTRY = 0x4C5E0
RAW = bytes.fromhex("00 07 CB F0 00 07 CB F4 D1 2D")
SEED = 42
N = 2000
...
def spec_mirror(r4, r5, r6, r7):
    ...
    # 0x04C5E2: op 0xCBF0
    r[0] = (r[0] | 0xF0) & 0xFFFFFFFF
    # 0x04C5E4: op 0x0007
    macl = (s32(r[0]) * s32(r[0])) & 0xFFFFFFFF
    # 0x04C5E6: op 0xCBF4
    r[0] = (r[0] | 0xF4) & 0xFFFFFFFF
    # 0x04C5E8: op 0xD12D
    r[1] = 0x0007CC04
