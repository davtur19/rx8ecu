#!/usr/bin/env python3
"""Differential test for FUN_00066634 (0x66634) — v3 lift (branches + delay slots), 20 bytes.
...
Run from repo root: python3 c/tests/test_FUN_00066634_66634.py
"""
...
ENTRY = 0x66634
RAW = bytes.fromhex("7E 02 60 A3 4F 26 69 F6 6A F6 6B F6 6C F6 6D F6 00 0B 6E F6")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = None
SPAN_END = 0x66648
SENT = 0x66648     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x66634: {"kind": 'reg', "py": 'r[14] = (r[14] + s8(0x02)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x66636: {"kind": 'reg', "py": 'r[0] = r[10]', "slot_py": None, "target": None, "cond": None},
    0x66638: {"kind": 'mem', "py": 'pr = _rdw(ram, STACK_BASE + 0x400, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x6663a: {"kind": 'mem', "py": 'r[9] = _rdw(ram, STACK_BASE + 0x404, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x6663c: {"kind": 'mem', "py": 'r[10] = _rdw(ram, STACK_BASE + 0x408, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x6663e: {"kind": 'mem', "py": 'r[11] = _rdw(ram, STACK_BASE + 0x40C, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x66640: {"kind": 'mem', "py": 'r[12] = _rdw(ram, STACK_BASE + 0x410, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x66642: {"kind": 'mem', "py": 'r[13] = _rdw(ram, STACK_BASE + 0x414, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x66644: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, STACK_BASE + 0x418, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},}
