#!/usr/bin/env python3
"""Differential test for dtc_data_read_60F58 (0x60F58) — pure straight-line lift, 10 bytes.
...
Run from repo root: python3 c/tests/test_dtc_data_read_60F58_60f58.py
"""
...
ENTRY = 0x60F58
RAW = bytes.fromhex("D7 0E 64 73 D5 0E 66 73 76 08")
SEED = 42
N = 2000
