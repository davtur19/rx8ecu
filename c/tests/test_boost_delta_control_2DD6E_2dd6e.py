#!/usr/bin/env python3
"""Differential test for boost_delta_control_2DD6E (0x2DD6E) — v3 lift + v4 FPU, 26 bytes.
...
Run from repo root: python3 c/tests/test_boost_delta_control_2DD6E_2dd6e.py
"""
...
RAM_MAX = 0xFFFFC008
SPAN_END = 0x2DD88
SENT = 0x2DD88     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x2dd6e: {"kind": 'reg', "py": 'r[1] = 0xFFFFC008', "slot_py": None, "target": None, "cond": None},
    0x2dd70: {"kind": 'reg', "py": 'r[4] = 0xFFFFBD40', "slot_py": None, "target": None, "cond": None},
    0x2dd72: {"kind": 'fpu', "py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFC008, 4))', "slot_py": None, "target": None, "cond": None},
    0x2dd74: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, r[4], 4))', "slot_py": None, "target": None, "cond": None},
    0x2dd76: {"kind": 'fpu', "py": 'fr[2] = fr[4]', "slot_py": None, "target": None, "cond": None},
    0x2dd78: {"kind": 'reg', "py": 'r[0] = 0x0002DDB0', "slot_py": None, "target": None, "cond": None},
    0x2dd7a: {"kind": 'fpu', "py": 'fr[2] = ts(fr[2] - fr[3])', "slot_py": None, "target": None, "cond": None},
    0x2dd7c: {"kind": 'reg', "py": 'r[3] = 0xFFFFBD3C', "slot_py": None, "target": None, "cond": None},
    0x2dd7e: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x0002DDB0, 4))', "slot_py": None, "target": None, "cond": None},
    0x2dd80: {"kind": 'fpu', "py": 'fr[2] = ts(fr[2] * fr[3])', "slot_py": None, "target": None, "cond": None},
    0x2dd82: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFBD3C, 4, f2bits(fr[2]))', "slot_py": None, "target": None, "cond": None},
    0x2dd84: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, r[4], 4, f2bits(fr[4]))', "target": None, "cond": None},}
