#!/usr/bin/env python3
"""Differential test for fpu_float_broadcast_29312 (0x29312) — v3 lift + v4 FPU, 22 bytes.
...
Run from repo root: python3 c/tests/test_fpu_float_broadcast_29312_29312.py
"""
...
RAM_MAX = 0xFFFFBAE8
SPAN_END = 0x29328
SENT = 0x29328     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x29312: {"kind": 'reg', "py": 'r[0] = 0x0002941C', "slot_py": None, "target": None, "cond": None},
    0x29314: {"kind": 'reg', "py": 'r[3] = 0xFFFFBADC', "slot_py": None, "target": None, "cond": None},
    0x29316: {"kind": 'fpu', "py": 'fr[4] = bits2f(_rdw(ram, 0x0002941C, 4))', "slot_py": None, "target": None, "cond": None},
    0x29318: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFBADC, 4, f2bits(fr[4]))', "slot_py": None, "target": None, "cond": None},
    0x2931a: {"kind": 'reg', "py": 'r[2] = 0xFFFFBAE0', "slot_py": None, "target": None, "cond": None},
    0x2931c: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFBAE0, 4, f2bits(fr[4]))', "slot_py": None, "target": None, "cond": None},
    0x2931e: {"kind": 'reg', "py": 'r[1] = 0xFFFFBAE4', "slot_py": None, "target": None, "cond": None},
    0x29320: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFBAE4, 4, f2bits(fr[4]))', "slot_py": None, "target": None, "cond": None},
    0x29322: {"kind": 'reg', "py": 'r[3] = 0xFFFFBAE8', "slot_py": None, "target": None, "cond": None},
    0x29324: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBAE8, 4, f2bits(fr[4]))', "target": None, "cond": None},}
