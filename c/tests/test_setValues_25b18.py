#!/usr/bin/env python3
"""Differential test for setValues (0x25B18) — v3 lift (branches + delay slots), 14 bytes.
...
Run from repo root: python3 c/tests/test_setValues_25b18.py
"""
...
ENTRY = 0x25B18
RAW = bytes.fromhex("D2 3B E1 01 90 6E E3 00 22 30 00 0B 20 10")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFB5C6
SPAN_END = 0x25B26
SENT = 0x25B26     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x25b18: {"kind": 'reg', "py": 'r[2] = 0xFFFFB5C6', "slot_py": None, "target": None, "cond": None},
    0x25b1a: {"kind": 'reg', "py": 'r[1] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x25b1c: {"kind": 'reg', "py": 'r[0] = 0xFFFFB5C5', "slot_py": None, "target": None, "cond": None},
    0x25b1e: {"kind": 'reg', "py": 'r[3] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x25b20: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFB5C6, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x25b22: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFB5C5, 1, r[1])', "target": None, "cond": None},}
