#!/usr/bin/env python3
"""Differential test for sensor_extract_606f8 (0x606F8) — v3 lift + v4 FPU, 40 bytes.
...
Run from repo root: python3 c/tests/test_sensor_extract_606f8_606f8.py
"""
...
RAM_MAX = 0xFFFFD3F8
SPAN_END = 0x60720
SENT = 0x60720     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x606f8: {"kind": 'reg', "py": 'r[4] = 0xFFFFD3F8', "slot_py": None, "target": None, "cond": None},
    0x606fa: {"kind": 'reg', "py": 'r[3] = 0xFFFFAA10', "slot_py": None, "target": None, "cond": None},
    0x606fc: {"kind": 'reg', "py": 'r[0] = 0x0006076C', "slot_py": None, "target": None, "cond": None},
    0x606fe: {"kind": 'fpu', "py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFAA10, 4))', "slot_py": None, "target": None, "cond": None},
    0x60700: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x0006076C, 4))', "slot_py": None, "target": None, "cond": None},
    0x60702: {"kind": 'fpu', "py": 'T = 1 if fr[3] > fr[4] else 0', "slot_py": None, "target": None, "cond": None},
    0x60704: {"kind": "branch", "py": None, "slot_py": '', "target": 0x6070e, "cond": 'T'},
    0x60708: {"kind": 'reg', "py": 'r[1] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x6070a: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFD3F8, 1, r[1])', "target": 0x6071c, "cond": 'always'},
    0x6070e: {"kind": 'reg', "py": 'r[0] = 0x00060770', "slot_py": None, "target": None, "cond": None},
    0x60710: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0x00060770, 4))', "slot_py": None, "target": None, "cond": None},
    0x60712: {"kind": 'fpu', "py": 'T = 1 if fr[2] > fr[4] else 0', "slot_py": None, "target": None, "cond": None},
    0x60714: {"kind": "branch", "py": None, "slot_py": '', "target": 0x6071c, "cond": 'notT'},
    0x60718: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x6071a: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD3F8, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x6071c: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
