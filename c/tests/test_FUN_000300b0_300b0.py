#!/usr/bin/env python3
"""Differential test for FUN_000300b0 (0x300B0) — mem lift (RAM-only, straight-line), 8 bytes.
...
Run from repo root: python3 c/tests/test_FUN_000300b0_300b0.py
"""
...
ENTRY = 0x300B0
RAW = bytes.fromhex("84 F8 60 0C 88 01 06 29")
SEED = 42
N = 2000
...
def spec_mirror(r4, r5, r6, r7, ram, stack_top):
    ...
    r[0] = s8(_rdw(ram, STACK_BASE + 0x408, 1))
    # 0x0300B2: op 0x600C
    r[0] = r[0] & 0xFF
    # 0x0300B4: op 0x8801
