#!/usr/bin/env python3
"""Differential test for initialization_3C7FC (0x3C7FC) — v3 lift + v4 FPU, 72 bytes.
...
Run from repo root: python3 c/tests/test_initialization_3C7FC_3c7fc.py
"""
...
RAM_MAX = 0xFFFFCFC8
SPAN_END = 0x3C844
SENT = 0x3C844     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x3c7fc: {"kind": 'reg', "py": 'r[2] = 0x0007A948', "slot_py": None, "target": None, "cond": None},
    0x3c7fe: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0x0007A948, 1))', "slot_py": None, "target": None, "cond": None},
    0x3c800: {"kind": 'reg', "py": 'r[1] = 0xFFFFC614', "slot_py": None, "target": None, "cond": None},
    0x3c802: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC614, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x3c804: {"kind": 'reg', "py": 'r[3] = 0x0007A947', "slot_py": None, "target": None, "cond": None},
    0x3c806: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0x0007A947, 1))', "slot_py": None, "target": None, "cond": None},
    0x3c808: {"kind": 'reg', "py": 'r[2] = 0xFFFFC615', "slot_py": None, "target": None, "cond": None},
    0x3c80a: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC615, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x3c80c: {"kind": 'reg', "py": 'r[1] = 0xFFFFCFC8', "slot_py": None, "target": None, "cond": None},
    0x3c80e: {"kind": 'fpu', "py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFCFC8, 4))', "slot_py": None, "target": None, "cond": None},
    0x3c810: {"kind": 'reg', "py": 'r[3] = 0xFFFFC60C', "slot_py": None, "target": None, "cond": None},
    0x3c812: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFC60C, 4, f2bits(fr[4]))', "slot_py": None, "target": None, "cond": None},
    0x3c814: {"kind": 'reg', "py": 'r[2] = 0xFFFFC610', "slot_py": None, "target": None, "cond": None},
    0x3c816: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFC610, 4, f2bits(fr[4]))', "slot_py": None, "target": None, "cond": None},
    0x3c818: {"kind": 'reg', "py": 'r[4] = 0x0007A949', "slot_py": None, "target": None, "cond": None},
    0x3c81a: {"kind": 'mem', "py": 'r[1] = s8(_rdw(ram, 0x0007A949, 1))', "slot_py": None, "target": None, "cond": None},
    0x3c81c: {"kind": 'reg', "py": 'r[0] = 0xFFFFC616', "slot_py": None, "target": None, "cond": None},
    0x3c81e: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC616, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x3c820: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0x0007A949, 1))', "slot_py": None, "target": None, "cond": None},
    0x3c822: {"kind": 'reg', "py": 'r[1] = 0xFFFFC617', "slot_py": None, "target": None, "cond": None},
    0x3c824: {"kind": 'reg', "py": 'r[4] = 0x0007A946', "slot_py": None, "target": None, "cond": None},
    0x3c826: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC617, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x3c828: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0x0007A946, 1))', "slot_py": None, "target": None, "cond": None},
    0x3c82a: {"kind": 'reg', "py": 'r[2] = 0xFFFFC618', "slot_py": None, "target": None, "cond": None},
    0x3c82c: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC618, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x3c82e: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0x0007A946, 1))', "slot_py": None, "target": None, "cond": None},
    0x3c830: {"kind": 'reg', "py": 'r[3] = 0xFFFFC619', "slot_py": None, "target": None, "cond": None},
    0x3c832: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC619, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x3c834: {"kind": 'reg', "py": 'r[4] = 0x0007A94C', "slot_py": None, "target": None, "cond": None},
    0x3c836: {"kind": 'mem', "py": 'r[1] = s8(_rdw(ram, 0x0007A94C, 1))', "slot_py": None, "target": None, "cond": None},
    0x3c838: {"kind": 'reg', "py": 'r[0] = 0xFFFFC61A', "slot_py": None, "target": None, "cond": None},
    0x3c83a: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC61A, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x3c83c: {"kind": 'mem', "py": 'r[2] = s8(_rdw(ram, 0x0007A94C, 1))', "slot_py": None, "target": None, "cond": None},
    0x3c83e: {"kind": 'reg', "py": 'r[1] = 0xFFFFC61B', "slot_py": None, "target": None, "cond": None},
    0x3c840: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFC61B, 1, r[2])', "target": None, "cond": None},}
