#!/usr/bin/env python3
"""Differential test for can_reset_counter_bb94 (0x2A40C) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_can_reset_counter_bb94_2a40c.py
"""
...
ENTRY = 0x2A40C
RAW = bytes.fromhex("D2 35 E3 00 00 0B 22 31")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBB94
SPAN_END = 0x2A414
SENT = 0x2A414     # stop-sentinel, placed past the literal pool
