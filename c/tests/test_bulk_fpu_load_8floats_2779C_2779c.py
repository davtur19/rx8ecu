#!/usr/bin/env python3
"""Differential test for bulk_fpu_load_8floats_2779C (0x2779C) — v3 lift + v4 FPU, 66 bytes.
...
Run from repo root: python3 c/tests/test_bulk_fpu_load_8floats_2779C_2779c.py
"""
...
RAM_MAX = 0xFFFFB6F0
SPAN_END = 0x277DE
SENT = 0x277DE     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x2779c: {"kind": 'reg', "py": 'r[4] = 0xFFFFA390', "slot_py": None, "target": None, "cond": None},
    0x2779e: {"kind": 'reg', "py": 'r[0] = s8(0x04)', "slot_py": None, "target": None, "cond": None},
    0x277a0: {"kind": 'reg', "py": 'r[2] = 0xFFFFB6D8', "slot_py": None, "target": None, "cond": None},
    0x277a2: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, r[4], 4))', "slot_py": None, "target": None, "cond": None},
    0x277a4: {"kind": 'reg', "py": 'r[3] = 0xFFFFB6D4', "slot_py": None, "target": None, "cond": None},
    0x277a6: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFB6D4, 4, f2bits(fr[3]))', "slot_py": None, "target": None, "cond": None},
    0x277a8: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, r[0] + r[4], 4))', "slot_py": None, "target": None, "cond": None},
    0x277aa: {"kind": 'reg', "py": 'r[0] = s8(0x08)', "slot_py": None, "target": None, "cond": None},
    0x277ac: {"kind": 'reg', "py": 'r[1] = 0xFFFFB6DC', "slot_py": None, "target": None, "cond": None},
    0x277ae: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFB6D8, 4, f2bits(fr[3]))', "slot_py": None, "target": None, "cond": None},
    0x277b0: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, r[0] + r[4], 4))', "slot_py": None, "target": None, "cond": None},
    0x277b2: {"kind": 'reg', "py": 'r[0] = s8(0x0C)', "slot_py": None, "target": None, "cond": None},
    0x277b4: {"kind": 'reg', "py": 'r[3] = 0xFFFFB6E0', "slot_py": None, "target": None, "cond": None},
    0x277b6: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFB6DC, 4, f2bits(fr[3]))', "slot_py": None, "target": None, "cond": None},
    0x277b8: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, r[0] + r[4], 4))', "slot_py": None, "target": None, "cond": None},
    0x277ba: {"kind": 'reg', "py": 'r[0] = s8(0x10)', "slot_py": None, "target": None, "cond": None},
    0x277bc: {"kind": 'reg', "py": 'r[2] = 0xFFFFB6E4', "slot_py": None, "target": None, "cond": None},
    0x277be: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFB6E0, 4, f2bits(fr[3]))', "slot_py": None, "target": None, "cond": None},
    0x277c0: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, r[0] + r[4], 4))', "slot_py": None, "target": None, "cond": None},
    0x277c2: {"kind": 'reg', "py": 'r[0] = s8(0x14)', "slot_py": None, "target": None, "cond": None},
    0x277c4: {"kind": 'reg', "py": 'r[1] = 0xFFFFB6E8', "slot_py": None, "target": None, "cond": None},
    0x277c6: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFB6E4, 4, f2bits(fr[3]))', "slot_py": None, "target": None, "cond": None},
    0x277c8: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, r[0] + r[4], 4))', "slot_py": None, "target": None, "cond": None},
    0x277ca: {"kind": 'reg', "py": 'r[0] = s8(0x18)', "slot_py": None, "target": None, "cond": None},
    0x277cc: {"kind": 'reg', "py": 'r[3] = 0xFFFFB6EC', "slot_py": None, "target": None, "cond": None},
    0x277ce: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFB6E8, 4, f2bits(fr[3]))', "slot_py": None, "target": None, "cond": None},
    0x277d0: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, r[0] + r[4], 4))', "slot_py": None, "target": None, "cond": None},
    0x277d2: {"kind": 'reg', "py": 'r[0] = s8(0x1C)', "slot_py": None, "target": None, "cond": None},
    0x277d4: {"kind": 'reg', "py": 'r[2] = 0xFFFFB6F0', "slot_py": None, "target": None, "cond": None},
    0x277d6: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFB6EC, 4, f2bits(fr[3]))', "slot_py": None, "target": None, "cond": None},
    0x277d8: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, r[0] + r[4], 4))', "slot_py": None, "target": None, "cond": None},
    0x277da: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFB6F0, 4, f2bits(fr[3]))', "target": None, "cond": None},}
