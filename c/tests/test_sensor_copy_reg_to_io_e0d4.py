#!/usr/bin/env python3
"""Differential test for sensor_copy_reg_to_io (0xE0D4) — v3 lift (branches + delay slots), 10 bytes.
...
Run from repo root: python3 c/tests/test_sensor_copy_reg_to_io_e0d4.py
"""
...
CODE = {
    0xe0d4: {"kind": 'reg', "py": 'r[2] = 0x0006CF88', "slot_py": None, "target": None, "cond": None},
    0xe0d6: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0x0006CF88, 1))', "slot_py": None, "target": None, "cond": None},
    0xe0d8: {"kind": 'reg', "py": 'r[1] = 0xFFFFA400', "slot_py": None, "target": None, "cond": None},
    0xe0da: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFA400, 1, r[3])', "target": None, "cond": None},}
