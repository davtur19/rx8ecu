#!/usr/bin/env python3
"""Differential test for setPerRotorLevel1FuelCut (0x47EF2) — v3 lift (branches + delay slots), 66 bytes.
...
Run from repo root: python3 c/tests/test_setPerRotorLevel1FuelCut_47ef2.py
"""
...
ENTRY = 0x47EF2
RAW = bytes.fromhex("7F FC 97 1E 63 4C 96 1D E2 04 33 23 8F 03 E5 00 26 50 A0 14 27 50 E3 01 23 49 2F 30 60 3C 88 01 8F 03 E2 02 E0 01 A0 01 26 00 26 50 24 29 60 4C 88 02 8F 03 00 09 E1 01 A0 01 27 10 27 50 00 0B 7F 04")
SEED = 0
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCCB3
SPAN_END = 0x47F34
SENT = 0x47F38     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x47ef2: {"kind": 'reg', "py": 'r[15] = (r[15] + s8(0xFC)) & 0xFFFFFFFF\nsp = (sp + s8(0xFC)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x47ef4: {"kind": 'reg', "py": 'r[7] = 0xFFFFCCB3', "slot_py": None, "target": None, "cond": None},
    0x47ef6: {"kind": 'reg', "py": 'r[3] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x47ef8: {"kind": 'reg', "py": 'r[6] = 0xFFFFCCB2', "slot_py": None, "target": None, "cond": None},
    0x47efa: {"kind": 'reg', "py": 'r[2] = s8(0x04)', "slot_py": None, "target": None, "cond": None},
    0x47efc: {"kind": 'reg', "py": 'T = 1 if s32(r[3]) >= s32(r[2]) else 0', "slot_py": None, "target": None, "cond": None},
    0x47efe: {"kind": "branch", "py": None, "slot_py": 'r[5] = s8(0x00)', "target": 0x47f08, "cond": 'notT'},
    0x47f02: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCCB2, 1, r[5])', "slot_py": None, "target": None, "cond": None},
    0x47f04: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFCCB3, 1, r[5])', "target": 0x47f30, "cond": 'always'},
    0x47f08: {"kind": 'reg', "py": 'r[3] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x47f0a: {"kind": 'reg', "py": 'r[3] = (r[3] & r[4]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x47f0c: {"kind": 'mem', "py": 'local[0x3FC] = r[3]\n_wrw(ram, STACK_BASE + 0x3FC, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x47f0e: {"kind": 'reg', "py": 'r[0] = r[3] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x47f10: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x47f12: {"kind": "branch", "py": None, "slot_py": 'r[2] = s8(0x02)', "target": 0x47f1c, "cond": 'notT'},
    0x47f16: {"kind": 'reg', "py": 'r[0] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x47f18: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFCCB2, 1, r[0])', "target": 0x47f1e, "cond": 'always'},
    0x47f1c: {"kind": 'mem', "py": '_wrw(ram, r[6], 1, r[5])', "slot_py": None, "target": None, "cond": None},
    0x47f1e: {"kind": 'reg', "py": 'r[4] = (r[4] & r[2]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x47f20: {"kind": 'reg', "py": 'r[0] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x47f22: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x02) else 0', "slot_py": None, "target": None, "cond": None},
    0x47f24: {"kind": "branch", "py": None, "slot_py": '', "target": 0x47f2e, "cond": 'notT'},
    0x47f28: {"kind": 'reg', "py": 'r[1] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x47f2a: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFCCB3, 1, r[1])', "target": 0x47f30, "cond": 'always'},
    0x47f2e: {"kind": 'mem', "py": '_wrw(ram, r[7], 1, r[5])', "slot_py": None, "target": None, "cond": None},
    0x47f30: {"kind": "ret", "py": None, "slot_py": 'r[15] = (r[15] + s8(0x04)) & 0xFFFFFFFF\nsp = (sp + s8(0x04)) & 0xFFFFFFFF', "target": None, "cond": None},}
