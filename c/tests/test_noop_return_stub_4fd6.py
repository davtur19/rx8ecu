#!/usr/bin/env python3
"""Differential test for noop_return_stub (0x4FD6) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_noop_return_stub_4fd6.py
"""
...
ENTRY = 0x4FD6
RAW = bytes.fromhex("7F 04 4F 26 00 0B 6E F6")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = None
SPAN_END = 0x4FDE
SENT = 0x4FDE     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x4fd6: {"kind": 'reg', "py": 'r[15] = (r[15] + s8(0x04)) & 0xFFFFFFFF\nsp = (sp + s8(0x04)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x4fd8: {"kind": 'mem', "py": 'pr = _rdw(ram, STACK_BASE + 0x404, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x4fda: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, STACK_BASE + 0x408, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},}
