#!/usr/bin/env python3
"""Differential test for rtos_task_register_a140 (0x96DE) — pure straight-line lift, 10 bytes.
...
Run from repo root: python3 c/tests/test_rtos_task_register_a140_96de.py
"""
...
ENTRY = 0x96DE
RAW = bytes.fromhex("64 B3 D8 2C 63 B3 9E 4B 69 33")
SEED = 42
N = 2000
