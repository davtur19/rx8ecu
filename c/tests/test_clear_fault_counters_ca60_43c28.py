#!/usr/bin/env python3
"""Differential test for clear_fault_counters_ca60 (0x43C28) — v3 lift (branches + delay slots), 42 bytes.
...
Run from repo root: python3 c/tests/test_clear_fault_counters_ca60_43c28.py
"""
...
ENTRY = 0x43C28
RAW = bytes.fromhex("93 78 60 30 60 0C 88 01 8F 0D 00 09 92 73 60 20 60 0C 88 01 8F 07 00 09 93 6E E4 00 92 6D 23 41 22 41 D1 3B 21 41 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCFD9
SPAN_END = 0x43C52
SENT = 0x43C52     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x43c28: {"kind": 'reg', "py": 'r[3] = 0xFFFFCFD9', "slot_py": None, "target": None, "cond": None},
    0x43c2a: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCFD9, 1))', "slot_py": None, "target": None, "cond": None},
    0x43c2c: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x43c2e: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x43c30: {"kind": "branch", "py": None, "slot_py": '', "target": 0x43c4e, "cond": 'notT'},
    0x43c34: {"kind": 'reg', "py": 'r[2] = 0xFFFFA41C', "slot_py": None, "target": None, "cond": None},
    0x43c36: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFA41C, 1))', "slot_py": None, "target": None, "cond": None},
    0x43c38: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x43c3a: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x43c3c: {"kind": "branch", "py": None, "slot_py": '', "target": 0x43c4e, "cond": 'notT'},
    0x43c40: {"kind": 'reg', "py": 'r[3] = 0xFFFFCA60', "slot_py": None, "target": None, "cond": None},
    0x43c42: {"kind": 'reg', "py": 'r[4] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x43c44: {"kind": 'reg', "py": 'r[2] = 0xFFFFCA62', "slot_py": None, "target": None, "cond": None},
    0x43c46: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCA60, 2, r[4])', "slot_py": None, "target": None, "cond": None},
    0x43c48: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCA62, 2, r[4])', "slot_py": None, "target": None, "cond": None},
    0x43c4a: {"kind": 'reg', "py": 'r[1] = 0xFFFFCA68', "slot_py": None, "target": None, "cond": None},
    0x43c4c: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCA68, 2, r[4])', "slot_py": None, "target": None, "cond": None},
    0x43c4e: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
