#!/usr/bin/env python3
"""Differential test for fpu_init_coefficients_40AC0 (0x40AC0) — v3 lift + v4 FPU, 20 bytes.
...
Run from repo root: python3 c/tests/test_fpu_init_coefficients_40AC0_40ac0.py
"""
...
ENTRY = 0x40AC0
RAW = bytes.fromhex("D3 04 F4 9D D2 04 F3 4A F2 4A D1 04 F1 4A D3 04 00 0B F3 4A")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFC784
SPAN_END = 0x40AD4
SENT = 0x40AE4     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x40ac0: {"kind": 'reg', "py": 'r[3] = 0xFFFFC778', "slot_py": None, "target": None, "cond": None},
    0x40ac2: {"kind": 'fpu', "py": 'fr[4] = 1.0', "slot_py": None, "target": None, "cond": None},
    0x40ac4: {"kind": 'reg', "py": 'r[2] = 0xFFFFC77C', "slot_py": None, "target": None, "cond": None},
    0x40ac6: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFC778, 4, f2bits(fr[4]))', "slot_py": None, "target": None, "cond": None},
    0x40ac8: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFC77C, 4, f2bits(fr[4]))', "slot_py": None, "target": None, "cond": None},
    0x40aca: {"kind": 'reg', "py": 'r[1] = 0xFFFFC780', "slot_py": None, "target": None, "cond": None},
    0x40acc: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFC780, 4, f2bits(fr[4]))', "slot_py": None, "target": None, "cond": None},
    0x40ace: {"kind": 'reg', "py": 'r[3] = 0xFFFFC784', "slot_py": None, "target": None, "cond": None},
    0x40ad0: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFC784, 4, f2bits(fr[4]))', "target": None, "cond": None},}
