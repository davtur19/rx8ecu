#!/usr/bin/env python3
"""Differential test for obd_service_handler_69168 (0x69168) — v3 lift (branches + delay slots), 56 bytes.
...
Run from repo root: python3 c/tests/test_obd_service_handler_69168_69168.py
"""
...
CODE = {
    0x69168: {"kind": 'reg', "py": 'r[4] = 0xFFFFDE22', "slot_py": None, "target": None, "cond": None},
    0x6916a: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFDE27, 1))', "slot_py": None, "target": None, "cond": None},
    0x6916c: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x6916e: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x04) else 0', "slot_py": None, "target": None, "cond": None},
    0x69170: {"kind": "branch", "py": None, "slot_py": 'r[6] = s8(0x01)', "target": 0x6919c, "cond": 'notT'},
    0x69174: {"kind": 'reg', "py": 'r[0] = 0xFFFFDE04', "slot_py": None, "target": None, "cond": None},
    0x69176: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFDE04, 1))', "slot_py": None, "target": None, "cond": None},
    0x69178: {"kind": 'reg', "py": 'r[0] = (r[0] & 0x0F) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x6917a: {"kind": 'reg', "py": 'r[7] = r[0]', "slot_py": None, "target": None, "cond": None},
    0x6917c: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFDE29, 1))', "slot_py": None, "target": None, "cond": None},
    0x6917e: {"kind": 'reg', "py": 'r[5] = r[7] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x69180: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x69182: {"kind": 'reg', "py": 'T = 1 if r[0] == r[5] else 0', "slot_py": None, "target": None, "cond": None},
    0x69184: {"kind": "branch", "py": None, "slot_py": '', "target": 0x6919c, "cond": 'notT'},
    0x69188: {"kind": 'reg', "py": 'r[2] = s8(0x0F)', "slot_py": None, "target": None, "cond": None},
    0x6918a: {"kind": 'reg', "py": 'T = 1 if s32(r[5]) >= s32(r[2]) else 0', "slot_py": None, "target": None, "cond": None},
    0x6918c: {"kind": "branch", "py": None, "slot_py": 'r[7] = s8(0x00)', "target": 0x69194, "cond": 'notT'},
    0x69190: {"kind": "branch", "py": None, "slot_py": 'r[0] = r[7]', "target": 0x69198, "cond": 'always'},
    0x69194: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFDE29, 1))', "slot_py": None, "target": None, "cond": None},
    0x69196: {"kind": 'reg', "py": 'r[0] = (r[0] + s8(0x01)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x69198: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFDE29, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x6919a: {"kind": 'reg', "py": 'r[6] = r[7]', "slot_py": None, "target": None, "cond": None},
    0x6919c: {"kind": "ret", "py": None, "slot_py": 'r[0] = r[6]', "target": None, "cond": None},}
