#!/usr/bin/env python3
"""Differential test for call-composition caller_546A0 (entry 0x546A0) — v7 ST caller + callee lib, flattened CODE with nested returns.
...
Run: python3 /home/davide/ailocal/rx8ecu/c/tests/test_caller_546A0.py
"""
...
CODE = {
    0x546a0: {"kind": 'reg', "py": 'r[2] = 0xFFFF87A8', "slot_py": None, "target": None, "cond": None},
    0x546a2: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFF87A8, 1))', "slot_py": None, "target": None, "cond": None},
    0x546a4: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x546a6: {"kind": "branch", "py": None, "slot_py": '', "target": 0x546b6, "cond": 'T'},
    0x546aa: {"kind": 'reg', "py": 'r[1] = 0xFFFFD201', "slot_py": None, "target": None, "cond": None},
    0x546ac: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFD201, 1))', "slot_py": None, "target": None, "cond": None},
    0x546ae: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x546b0: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x546b2: {"kind": "branch", "py": None, "slot_py": '', "target": 0x546ba, "cond": 'notT'},
    0x546b6: {"kind": "branch", "py": None, "slot_py": 'r[5] = s8(0x00)', "target": 0x546bc, "cond": 'T'},
    0x546ba: {"kind": 'reg', "py": 'r[5] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x546bc: {"kind": 'reg', "py": 'r[4] = 0xFFFF9000', "slot_py": None, "target": None, "cond": None},
    0x546be: {"kind": 'reg', "py": 'r[2] = 0x0003EE58', "slot_py": None, "target": None, "cond": None},
    0x546c0: {"kind": "call", "py": None, "slot_py": None, "target": 0x3ee58, "ret_pc": 0x546c4, "set_pr": False, "cond": None},
