#!/usr/bin/env python3
"""Differential test for scheduler_init_4BF3C (0x4BF3C) — v3 lift (branches + delay slots), 50 bytes.
...
Run from repo root: python3 c/tests/test_scheduler_init_4BF3C_4bf3c.py
"""
...
ENTRY = 0x4BF3C
RAW = bytes.fromhex("94 18 93 18 60 30 60 0C 88 01 8D 0B 00 09 92 13 60 20 60 0C 88 01 8F 08 00 09 91 0E 60 10 20 08 8F 03 00 09 92 05 A0 02 24 20 E1 00 24 10 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCE5C
SPAN_END = 0x4BF6E
SENT = 0x4BF78     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x4bf3c: {"kind": 'reg', "py": 'r[4] = 0xFFFFCE5C', "slot_py": None, "target": None, "cond": None},
    0x4bf3e: {"kind": 'reg', "py": 'r[3] = 0xFFFFA41C', "slot_py": None, "target": None, "cond": None},
    0x4bf40: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFA41C, 1))', "slot_py": None, "target": None, "cond": None},
    0x4bf42: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x4bf44: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x4bf46: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4bf60, "cond": 'T'},
    0x4bf4a: {"kind": 'reg', "py": 'r[2] = 0xFFFFA42C', "slot_py": None, "target": None, "cond": None},
    0x4bf4c: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFA42C, 1))', "slot_py": None, "target": None, "cond": None},
    0x4bf4e: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x4bf50: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x4bf52: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4bf66, "cond": 'notT'},
    0x4bf56: {"kind": 'reg', "py": 'r[1] = 0xFFFFA428', "slot_py": None, "target": None, "cond": None},
    0x4bf58: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFA428, 1))', "slot_py": None, "target": None, "cond": None},
    0x4bf5a: {"kind": 'reg', "py": 'T = 1 if (r[0] & r[0]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x4bf5c: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4bf66, "cond": 'notT'},
    0x4bf60: {"kind": 'reg', "py": 'r[2] = 0x00000080', "slot_py": None, "target": None, "cond": None},
    0x4bf62: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFCE5C, 1, r[2])', "target": 0x4bf6a, "cond": 'always'},
    0x4bf66: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x4bf68: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCE5C, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x4bf6a: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
