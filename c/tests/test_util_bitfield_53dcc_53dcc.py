#!/usr/bin/env python3
"""Differential test for util_bitfield_53dcc (0x53DCC) — v3 lift + v4 FPU, 10 bytes.
...
Run from repo root: python3 c/tests/test_util_bitfield_53dcc_53dcc.py
"""
...
ENTRY = 0x53DCC
RAW = bytes.fromhex("93 27 F3 38 92 26 00 0B F2 3A")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFD19C
SPAN_END = 0x53DD6
SENT = 0x53DD6     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x53dcc: {"kind": 'reg', "py": 'r[3] = 0xFFFFAE54', "slot_py": None, "target": None, "cond": None},
    0x53dce: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFAE54, 4))', "slot_py": None, "target": None, "cond": None},
    0x53dd0: {"kind": 'reg', "py": 'r[2] = 0xFFFFD19C', "slot_py": None, "target": None, "cond": None},
    0x53dd2: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFD19C, 4, f2bits(fr[3]))', "target": None, "cond": None},}
