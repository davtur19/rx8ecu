#!/usr/bin/env python3
"""Differential test for caller_9C34 (entry 0x9C34) — v8 ST caller (CFG), 60 bytes.
...
Run: python3 test_caller_9C34.py
"""
...
CODE = {
    0x9c34: {"kind": 'st', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x9c36: {"kind": 'reg', "py": 'r[15] = (r[15] + s8(0xFC)) & 0xFFFFFFFF\nsp = (sp + s8(0xFC)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x9c38: {"kind": 'reg', "py": 'r[3] = 0x0000CD40', "slot_py": None, "target": None, "cond": None},
    0x9c3a: {"kind": 'mem', "py": '_wrw(ram, sp, 4, r[4])', "slot_py": None, "target": None, "cond": None},
    0x9c3c: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, (r[4] + 5), 1))', "slot_py": None, "target": None, "cond": None},
    0x9c3e: {"kind": "call", "py": None, "slot_py": 'r[4] = r[0]', "target": 0xcd40, "ret_pc": 0x9c42, "set_pr": True, "cond": None},
    0x9c42: {"kind": 'reg', "py": 'r[15] = (r[15] + s8(0x04)) & 0xFFFFFFFF\nsp = (sp + s8(0x04)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x9c44: {"kind": 'st', "py": 'pr = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x9c46: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None, },
    0x9c4a: {"kind": 'reg', "py": 'r[4] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x9c4e: {"kind": 'reg', "py": 'r[4] = s8(0x06)', "slot_py": None, "target": None, "cond": None},
    0x9c50: {"kind": 'reg', "py": 'r[4] = s8(0x0C)', "slot_py": None, "target": None, "cond": None},
    0x9c52: {"kind": 'reg', "py": 'r[4] = s8(0x08)', "slot_py": None, "target": None, "cond": None},
    0x9c5a: {"kind": 'reg', "py": 'T = 1 if r[9] == r[2] else 0', "slot_py": None, "target": None, "cond": None},
    0x9c66: {"kind": 'reg', "py": 'r[0] = (r[0] ^ 0xCC) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x9c6a: {"kind": 'reg', "py": 't0 = (r[9] >> 31) & 1\nr[9] = ((r[9] << 1) | (T & 1)) & 0xFFFFFFFF\nt1 = (Q ^ M) & 1\nt1 = (t1 - 1) & 0xFFFFFFFF\nt2 = (-r[3]) & 0xFFFFFFFF\nif t1 == 0: t2 = r[3]\nlo = r[9] + t2\nr[9] = lo & 0xFFFFFFFF\ncarry = (lo >> 32) & 1\nt1 = (t1 + carry) & 1\nt1 ^= t0\nT = (t1 ^ 1) & 1\nQ = (M ^ t1) & 1', "slot_py": None, "target": None, "cond": None},
    0xcd40: {"kind": 'st', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xcd42: {"kind": 'reg', "py": 'r[15] = (r[15] + s8(0xFC)) & 0xFFFFFFFF\nsp = (sp + s8(0xFC)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xcd44: {"kind": 'reg', "py": 'r[5] = 0xFFFFE420', "slot_py": None, "target": None, "cond": None},
    0xcd46: {"kind": 'mem', "py": '_wrw(ram, sp, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0xcd48: {"kind": "call", "py": None, "slot_py": 'r[4] = s8(_rdw(ram, sp, 1))', "target": 0xcee8, "ret_pc": 0xcd4c, "set_pr": True, "cond": None},
    ...
    0xcd4c: {"kind": 'reg', "py": 'r[4] = r[0]', "slot_py": None, "target": None, "cond": None},
    0xcd4e: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, sp, 1))', "slot_py": None, "target": None, "cond": None},
    0xcd50: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0xcd52: {"kind": 'reg', "py": 'r[0] = (r[0] & 0x0F) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xcd54: {"kind": 'reg', "py": 'r[0] = (r[0] << 2) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xcd56: {"kind": 'reg', "py": 'T = (r[0] >> 31) & 1\nr[0] = (r[0] << 1) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xcd58: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, (r[4] + r[0]), 1))', "slot_py": None, "target": None, "cond": None},
    0xcd5a: {"kind": 'reg', "py": 'r[15] = (r[15] + s8(0x04)) & 0xFFFFFFFF\nsp = (sp + s8(0x04)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xcd5c: {"kind": 'st', "py": 'pr = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xcd5e: {"kind": "ret", "py": None, "slot_py": 'r[0] = (r[0] & 0x0F) & 0xFFFFFFFF', "target": None, "cond": None, },
}
