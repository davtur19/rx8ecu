#!/usr/bin/env python3
"""Differential test for math_register_39254 (0x39254) — v3 lift (branches + delay slots), 22 bytes.
...
Run from repo root: python3 c/tests/test_math_register_39254_39254.py
"""
...
RAM_MAX = 0xFFFFC50E
SPAN_END = 0x3926A
SENT = 0x3926A     # stop-sentinel, placed past the literal pool
...
CODE = {
    ...
    0x3925a: {"kind": 'reg', "py": 'r[0] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x3925c: {"kind": 'reg', "py": 'r[2] = 0x0007A5B4', "slot_py": None, "target": None, "cond": None},
    0x3925e: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0x0007A5B4, 1))', "slot_py": None, "target": None, "cond": None},
    0x39260: {"kind": 'reg', "py": 'r[1] = 0xFFFFC50D', "slot_py": None, "target": None, "cond": None},
    0x39262: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC50D, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x39264: {"kind": 'reg', "py": 'r[3] = 0xFFFFC50E', "slot_py": None, "target": None, "cond": None},
    0x39266: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFC50E, 1, r[0])', "target": None, "cond": None},}
