#!/usr/bin/env python3
"""Differential test for fault_cell_c4d4_from_6d487 (0x388B4) — v3 lift (branches + delay slots), 10 bytes.
...
Run from repo root: python3 c/tests/test_fault_cell_c4d4_from_6d487_388b4.py
"""
...
ENTRY = 0x388B4
RAW = bytes.fromhex("D3 17 60 30 92 1F 00 0B 22 00")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFC4D4
SPAN_END = 0x388BE
SENT = 0x388BE     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x388b4: {"kind": 'reg', "py": 'r[3] = 0x0006D487', "slot_py": None, "target": None, "cond": None},
    0x388b6: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0x0006D487, 1))', "slot_py": None, "target": None, "cond": None},
    0x388b8: {"kind": 'reg', "py": 'r[2] = 0xFFFFC4D4', "slot_py": None, "target": None, "cond": None},
    0x388ba: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFC4D4, 1, r[0])', "target": None, "cond": None},}
