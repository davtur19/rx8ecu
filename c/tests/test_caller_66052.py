#!/usr/bin/env python3
"""Differential test for caller_66052 (entry 0x66052) — v8 ST caller (CFG), 26 bytes.
...
Run: python3 test_caller_66052.py
"""
...
CODE = {
    0x66052: {"kind": 'st', "py": 'local[0x3FC] = pr\n_wrw(ram, STACK_BASE + 0x3FC, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x66054: {"kind": 'reg', "py": 'r[3] = 0x00002420', "slot_py": None, "target": None, "cond": None},
    0x66056: {"kind": "call", "py": None, "slot_py": 'r[4] = s8(0x00)', "target": 0x2420, "ret_pc": 0x6605a, "set_pr": True, "cond": None},
    0x6605a: {"kind": 'reg', "py": 'r[2] = 0xFFFF8EA4', "slot_py": None, "target": None, "cond": None},
    0x6605c: {"kind": 'reg', "py": 'r[3] = 0x00002420', "slot_py": None, "target": None, "cond": None},
    0x6605e: {"kind": 'mem', "py": '_wrw(ram, 0xFFFF8EA4, 2, r[0])', "slot_py": None, "target": None, "cond": None},
    0x66060: {"kind": "call", "py": None, "slot_py": 'r[4] = s8(0x00)', "target": 0x2420, "ret_pc": 0x66064, "set_pr": True, "cond": None},
    0x66064: {"kind": 'reg', "py": 'r[2] = 0xFFFF8EA6', "slot_py": None, "target": None, "cond": None},
    0x66066: {"kind": 'st', "py": 'pr = _rdw(ram, STACK_BASE + 0x3FC, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x66068: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFF8EA6, 2, r[0])', "target": None, "cond": None},
