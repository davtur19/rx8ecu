#!/usr/bin/env python3
"""Differential test for crank_angle_timeout_calc (0x7BE4) — v3 lift (branches + delay slots), 40 bytes.
...
Run from repo root: python3 c/tests/test_crank_angle_timeout_calc_7be4.py
"""
...
ENTRY = 0x7BE4
RAW = bytes.fromhex("92 38 63 40 63 3C 33 23 8D 03 00 09 61 40 71 01 24 10 D2 20 D0 1D 63 20 00 0B 20 30 91 2A D3 1E 00 0B 23 10 D2 1A 60 20")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    ...
    0x7be6: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, r[4], 1))', "slot_py": None, "target": None, "cond": None},
    ...
    0x7bf0: {"kind": 'mem', "py": 'r[1] = s8(_rdw(ram, r[4], 1))', "slot_py": None, "target": None, "cond": None},
    0x7bf2: {"kind": 'reg', "py": 'r[1] = (r[1] + s8(0x01)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x7bf4: {"kind": 'mem', "py": '_wrw(ram, r[4], 1, r[1])', "slot_py": None, "target": None, "cond": None},
    ...
    0x7c00: {"kind": 'reg', "py": 'r[1] = 0x000000FF', "slot_py": None, "target": None, "cond": None},
    0x7c02: {"kind": 'reg', "py": 'r[3] = 0xFFFF9FC6', "slot_py": None, "target": None, "cond": None},
    0x7c04: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFF9FC6, 1, r[1])', "target": None, "cond": None},
    0x7c08: {"kind": 'reg', "py": 'r[2] = 0xFFFF9F96', "slot_py": None, "target": None, "cond": None},
    0x7c0a: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFF9F96, 1))', "slot_py": None, "target": None, "cond": None},}
