#!/usr/bin/env python3
"""Differential test for uds_mode22_evap_purge_responder (0x54E22) — pure straight-line lift, 8 bytes.
...
Run from repo root: python3 c/tests/test_uds_mode22_evap_purge_responder_54e22.py
"""
...
ENTRY = 0x54E22
RAW = bytes.fromhex("E6 01 94 5B 7F FC D3 31")
SEED = 42
N = 2000
