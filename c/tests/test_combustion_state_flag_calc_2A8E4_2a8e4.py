#!/usr/bin/env python3
"""Differential test for combustion_state_flag_calc_2A8E4 (0x2A8E4) — v3 lift + v4 FPU, 86 bytes.
...
Run from repo root: python3 c/tests/test_combustion_state_flag_calc_2A8E4_2a8e4.py
"""
...
ENTRY = 0x2A8E4
RAW = bytes.fromhex("94 34 93 34 92 34 F3 38 F2 28 F2 35 8D 11 00 09 91 2F 60 10 60 0C 88 01 8F 0B 00 09 92 2A 60 20 60 0C 88 01 8F 05 00 09 93 25 60 30 20 08 8D 0B 00 09 92 21 61 21 21 18 8F 09 00 09 93 1D 60 31 60 0D 40 15 8F 03 00 09 E3 01 A0 02 24 30 E1 00 24 10 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBB8D
SPAN_END = 0x2A93A
SENT = 0x2A93A     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x2a8e4: {"kind": 'reg', "py": 'r[4] = 0xFFFFBB8D', "slot_py": None, "target": None, "cond": None},
    0x2a8e6: {"kind": 'reg', "py": 'r[3] = 0xFFFFA9AC', "slot_py": None, "target": None, "cond": None},
    0x2a8e8: {"kind": 'reg', "py": 'r[2] = 0xFFFFA63C', "slot_py": None, "target": None, "cond": None},
    0x2a8ea: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFA9AC, 4))', "slot_py": None, "target": None, "cond": None},
    0x2a8ec: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0xFFFFA63C, 4))', "slot_py": None, "target": None, "cond": None},
    0x2a8ee: {"kind": 'fpu', "py": 'T = 1 if fr[2] > fr[3] else 0', "slot_py": None, "target": None, "cond": None},
    0x2a8f0: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2a916, "cond": 'T'},
    0x2a8f4: {"kind": 'reg', "py": 'r[1] = 0xFFFFA9C0', "slot_py": None, "target": None, "cond": None},
    0x2a8f6: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFA9C0, 1))', "slot_py": None, "target": None, "cond": None},
    0x2a8f8: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x2a8fa: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x2a8fc: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2a916, "cond": 'notT'},
    0x2a900: {"kind": 'reg', "py": 'r[2] = 0xFFFFA428', "slot_py": None, "target": None, "cond": None},
    0x2a902: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFA428, 1))', "slot_py": None, "target": None, "cond": None},
    0x2a904: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x2a906: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x2a908: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2a916, "cond": 'notT'},
    0x2a90c: {"kind": 'reg', "py": 'r[3] = 0xFFFFAADA', "slot_py": None, "target": None, "cond": None},
    0x2a90e: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFAADA, 1))', "slot_py": None, "target": None, "cond": None},
    0x2a910: {"kind": 'reg', "py": 'T = 1 if (r[0] & r[0]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x2a912: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2a92c, "cond": 'T'},
    0x2a916: {"kind": 'reg', "py": 'r[2] = 0xFFFFA9BC', "slot_py": None, "target": None, "cond": None},
    0x2a918: {"kind": 'mem', "py": 'r[1] = s16(_rdw(ram, 0xFFFFA9BC, 2))', "slot_py": None, "target": None, "cond": None},
    0x2a91a: {"kind": 'reg', "py": 'T = 1 if (r[1] & r[1]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x2a91c: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2a932, "cond": 'notT'},
    0x2a920: {"kind": 'reg', "py": 'r[3] = 0xFFFFA9BE', "slot_py": None, "target": None, "cond": None},
    0x2a922: {"kind": 'mem', "py": 'r[0] = s16(_rdw(ram, 0xFFFFA9BE, 2))', "slot_py": None, "target": None, "cond": None},
    0x2a924: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x2a926: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) > 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x2a928: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2a932, "cond": 'notT'},
    0x2a92c: {"kind": 'reg', "py": 'r[3] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x2a92e: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFBB8D, 1, r[3])', "target": 0x2a936, "cond": 'always'},
    0x2a932: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x2a934: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBB8D, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x2a936: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
