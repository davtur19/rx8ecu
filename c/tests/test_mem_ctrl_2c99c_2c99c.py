#!/usr/bin/env python3
"""Differential test for mem_ctrl_2c99c (0x2C99C) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_mem_ctrl_2c99c_2c99c.py
"""
...
CODE = {
    0x2c99c: {"kind": 'reg', "py": 'r[2] = 0xFFFFBC7C', "slot_py": None, "target": None, "cond": None},
    0x2c99e: {"kind": 'reg', "py": 'r[3] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x2c9a0: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBC7C, 1, r[3])', "target": None, "cond": None},}
