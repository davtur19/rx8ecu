#!/usr/bin/env python3
"""Differential test for calculateIgnitionDwellAdder (0x4B89C) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_calculateIgnitionDwellAdder_4b89c.py
"""
...
ENTRY = 0x4B89C
RAW = bytes.fromhex("E2 00 24 20 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
