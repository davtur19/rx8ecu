#!/usr/bin/env python3
"""Differential test for setMainInitDoneBool__ (0x9F0C) — v3 lift (branches + delay slots), 12 bytes.
...
Run from repo root: python3 c/tests/test_setMainInitDoneBool___9f0c.py
"""
...
ENTRY = 0x9F0C
RAW = bytes.fromhex("D2 0D 00 0B 22 40 D3 0C 00 0B 60 30")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFA16C
SPAN_END = 0x9F18
SENT = 0x9F18     # stop-sentinel, placed past the literal pool
