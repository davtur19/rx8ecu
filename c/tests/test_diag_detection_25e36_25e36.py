#!/usr/bin/env python3
"""Differential test for diag_detection_25e36 (0x25E36) — v3 lift (branches + delay slots), 22 bytes.
...
Run from repo root: python3 c/tests/test_diag_detection_25e36_25e36.py
"""
...
CODE = {
    0x25e36: {"kind": 'reg', "py": 'r[3] = 0xFFFFCE14', "slot_py": None, "target": None, "cond": None},
    0x25e38: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCE14, 1))', "slot_py": None, "target": None, "cond": None},
    0x25e3a: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x25e3c: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x25e3e: {"kind": "branch", "py": None, "slot_py": '', "target": 0x25e48, "cond": 'notT'},
    0x25e42: {"kind": 'reg', "py": 'r[1] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x25e44: {"kind": 'reg', "py": 'r[2] = 0xFFFFB5D9', "slot_py": None, "target": None, "cond": None},
    0x25e46: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFB5D9, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x25e48: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
