#!/usr/bin/env python3
"""Differential test for can_get_mailbox_config (0xD1AC) — v3 lift (branches + delay slots), 14 bytes.
...
Run from repo root: python3 c/tests/test_can_get_mailbox_config_d1ac.py
"""
...
ENTRY = 0xD1AC
RAW = bytes.fromhex("60 4C E4 0F 24 09 44 00 D0 01 00 0B 00 4D")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = None
SPAN_END = 0xD1BA
SENT = 0xD1C0     # stop-sentinel, placed past the literal pool
...
CODE = {
    0xd1ac: {"kind": 'reg', "py": 'r[0] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0xd1ae: {"kind": 'reg', "py": 'r[4] = s8(0x0F)', "slot_py": None, "target": None, "cond": None},
    0xd1b0: {"kind": 'reg', "py": 'r[4] = (r[4] & r[0]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xd1b2: {"kind": 'reg', "py": 'T = (r[4] >> 31) & 1\nr[4] = (r[4] << 1) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xd1b4: {"kind": 'reg', "py": 'r[0] = 0x0000DBAC', "slot_py": None, "target": None, "cond": None},
    0xd1b6: {"kind": "ret", "py": None, "slot_py": 'r[0] = s16(_rdw(ram, (r[4] + r[0]), 2))', "target": None, "cond": None},}
