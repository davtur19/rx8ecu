#!/usr/bin/env python3
"""Differential test for caller_67BFE (entry 0x67BFE) — v8 ST caller (CFG), 22 bytes.
...
Run: python3 test_caller_67BFE.py
"""
...
CODE = {
    0x67bfe: {"kind": 'reg', "py": 'r[6] = r[4] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x67c00: {"kind": 'reg', "py": 'T = 1 if (r[6] & r[6]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x67c02: {"kind": "branch", "py": None, "slot_py": 'r[5] = s8(0x00)', "target": 0x67c0e, "cond": 'T'},
    0x67c06: {"kind": 'reg', "py": 'r[2] = s8(0x06)', "slot_py": None, "target": None, "cond": None},
    0x67c08: {"kind": 'reg', "py": 'T = 1 if s32(r[6]) > s32(r[2]) else 0', "slot_py": None, "target": None, "cond": None},
    0x67c0a: {"kind": "branch", "py": None, "slot_py": '', "target": 0x67c10, "cond": 'notT'},
    0x67c0e: {"kind": 'reg', "py": 'r[5] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x67c10: {"kind": "ret", "py": None, "slot_py": 'r[0] = r[5]', "target": None, "cond": None},
}
