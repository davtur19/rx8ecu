#!/usr/bin/env python3
"""Differential test for returnEngineLoad (0x5E5FE) — v3 lift (branches + delay slots), 24 bytes.
...
Run from repo root: python3 c/tests/test_returnEngineLoad_5e5fe.py
"""
...
ENTRY = 0x5E5FE
RAW = bytes.fromhex("63 40 73 FF 24 30 68 F6 60 63 69 F6 6A F6 6B F6 6C F6 6D F6 00 0B 6E F6")
SEED = 42
N = 500
MAXSTEPS = 100000
