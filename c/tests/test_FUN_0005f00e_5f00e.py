#!/usr/bin/env python3
"""Differential test for FUN_0005f00e (0x5F00E) — pure straight-line lift, 12 bytes.
...
Run from repo root: python3 c/tests/test_FUN_0005f00e_5f00e.py
"""
...
ENTRY = 0x5F00E
RAW = bytes.fromhex("DA C2 00 07 DA C1 00 07 DA C3 91 30")
SEED = 42
N = 2000
