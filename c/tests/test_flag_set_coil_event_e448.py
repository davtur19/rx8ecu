#!/usr/bin/env python3
"""Differential test for flag_set_coil_event (0xE448) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_flag_set_coil_event_e448.py
"""
...
CODE = {
    0xe448: {"kind": 'reg', "py": 'r[2] = 0xFFFFA41C', "slot_py": None, "target": None, "cond": None},
    0xe44a: {"kind": 'reg', "py": 'r[3] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0xe44c: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFA41C, 1, r[3])', "target": None, "cond": None},}
