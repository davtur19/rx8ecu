#!/usr/bin/env python3
"""Differential test for set_ign_flag_a5d5 (0x10766) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_set_ign_flag_a5d5_10766.py
"""
...
ENTRY = 0x10766
RAW = bytes.fromhex("E2 01 D1 82 00 0B 21 20")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFA5D5
SPAN_END = 0x1076E
SENT = 0x1076E     # stop-sentinel, placed past the literal pool
