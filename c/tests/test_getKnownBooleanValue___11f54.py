#!/usr/bin/env python3
"""Differential test for getKnownBooleanValue__ (0x11F54) — v3 lift (branches + delay slots), 36 bytes.
...
Run from repo root: python3 c/tests/test_getKnownBooleanValue___11f54.py
"""
...
ENTRY = 0x11F54
RAW = bytes.fromhex("D3 06 60 30 60 0C 88 01 04 29 00 0B 60 43 D3 04 60 30 60 0C 88 01 04 29 00 0B 60 43 FF FF 8E 9C FF FF 8E 9E")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFF8E9E
SPAN_END = 0x11F78
SENT = 0x11F78     # stop-sentinel, placed past the literal pool
...
CODE = {
    ...
    0x11f62: {"kind": 'reg', "py": 'r[3] = 0xFFFF8E9E', "slot_py": None, "target": None, "cond": None},
    0x11f64: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFF8E9E, 1))', "slot_py": None, "target": None, "cond": None},
    0x11f66: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x11f68: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x11f6a: {"kind": 'reg', "py": 'r[4] = T;', "slot_py": None, "target": None, "cond": None},
    0x11f6c: {"kind": "ret", "py": None, "slot_py": 'r[0] = r[4]', "target": None, "cond": None},}
