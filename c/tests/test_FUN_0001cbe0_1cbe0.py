#!/usr/bin/env python3
"""Differential test for FUN_0001cbe0 (0x1CBE0) — v3 lift (branches + delay slots), 12 bytes.
...
Run from repo root: python3 c/tests/test_FUN_0001cbe0_1cbe0.py
"""
...
ENTRY = 0x1CBE0
RAW = bytes.fromhex("93 2D E4 00 D2 20 23 41 00 0B 22 40")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFB080
SPAN_END = 0x1CBEC
SENT = 0x1CBEC     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x1cbe0: {"kind": 'reg', "py": 'r[3] = 0xFFFFAE7C', "slot_py": None, "target": None, "cond": None},
    0x1cbe2: {"kind": 'reg', "py": 'r[4] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x1cbe4: {"kind": 'reg', "py": 'r[2] = 0xFFFFB080', "slot_py": None, "target": None, "cond": None},
    0x1cbe6: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFAE7C, 2, r[4])', "slot_py": None, "target": None, "cond": None},
    0x1cbe8: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFB080, 1, r[4])', "target": None, "cond": None},}
