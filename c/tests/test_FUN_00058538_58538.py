#!/usr/bin/env python3
"""Differential test for FUN_00058538 (0x58538) — v3 lift (branches + delay slots), 24 bytes.
...
Run from repo root: python3 c/tests/test_FUN_00058538_58538.py
"""
...
RAM_MAX = 0xFFFFD07B
SPAN_END = 0x58550
SENT = 0x58550     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x58538: {"kind": 'reg', "py": 'r[2] = 0xFFFFD066', "slot_py": None, "target": None, "cond": None},
    0x5853a: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFD066, 1))', "slot_py": None, "target": None, "cond": None},
    0x5853c: {"kind": 'reg', "py": 'r[1] = 0x00000080', "slot_py": None, "target": None, "cond": None},
    0x5853e: {"kind": 'reg', "py": 'r[3] = r[3] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x58540: {"kind": 'reg', "py": 'T = 1 if r[3] == r[1] else 0', "slot_py": None, "target": None, "cond": None},
    0x58542: {"kind": "branch", "py": None, "slot_py": '', "target": 0x5854c, "cond": 'notT'},
    0x58546: {"kind": 'reg', "py": 'r[0] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x58548: {"kind": 'reg', "py": 'r[3] = 0xFFFFD07B', "slot_py": None, "target": None, "cond": None},
    0x5854a: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD07B, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x5854c: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
