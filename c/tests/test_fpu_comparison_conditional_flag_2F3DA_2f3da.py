#!/usr/bin/env python3
"""Differential test for fpu_comparison_conditional_flag_2F3DA (0x2F3DA) — v3 lift + v4 FPU, 40 bytes.
...
Run from repo root: python3 c/tests/test_fpu_comparison_conditional_flag_2F3DA_2f3da.py
"""
...
ENTRY = 0x2F3DA
RAW = bytes.fromhex("94 12 92 12 63 20 23 38 8D 07 00 09 91 0E 90 0E F3 18 F2 08 F3 25 8F 03 00 09 E2 00 A0 02 24 20 E1 01 24 10 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBDCD
SPAN_END = 0x2F402
SENT = 0x2F40A     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x2f3da: {"kind": 'reg', "py": 'r[4] = 0xFFFFBDCD', "slot_py": None, "target": None, "cond": None},
    0x2f3dc: {"kind": 'reg', "py": 'r[2] = 0xFFFFBD59', "slot_py": None, "target": None, "cond": None},
    0x2f3de: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFBD59, 1))', "slot_py": None, "target": None, "cond": None},
    0x2f3e0: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x2f3e2: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2f3f4, "cond": 'T'},
    0x2f3e6: {"kind": 'reg', "py": 'r[1] = 0xFFFFAA38', "slot_py": None, "target": None, "cond": None},
    0x2f3e8: {"kind": 'reg', "py": 'r[0] = 0xFFFFBD64', "slot_py": None, "target": None, "cond": None},
    0x2f3ea: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFAA38, 4))', "slot_py": None, "target": None, "cond": None},
    0x2f3ec: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0xFFFFBD64, 4))', "slot_py": None, "target": None, "cond": None},
    0x2f3ee: {"kind": 'fpu', "py": 'T = 1 if fr[3] > fr[2] else 0', "slot_py": None, "target": None, "cond": None},
    0x2f3f0: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2f3fa, "cond": 'notT'},
    0x2f3f4: {"kind": 'reg', "py": 'r[2] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x2f3f6: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFBDCD, 1, r[2])', "target": 0x2f3fe, "cond": 'always'},
    0x2f3fa: {"kind": 'reg', "py": 'r[1] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x2f3fc: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBDCD, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x2f3fe: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
