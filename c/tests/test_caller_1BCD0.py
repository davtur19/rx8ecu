#!/usr/bin/env python3
"""Differential test for caller_1BCD0 (entry 0x1BCD0) — v8 ST caller (CFG), 24 bytes.
...
Run: python3 test_caller_1BCD0.py
"""
...
CODE = {
    0x1bcd0: {"kind": 'st', "py": 'local[0x3FC] = pr\n_wrw(ram, STACK_BASE + 0x3FC, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x1bcd2: {"kind": 'fpu', "py": 'fr[5] = 0.0', "slot_py": None, "target": None, "cond": None},
    0x1bcd4: {"kind": 'reg', "py": 'r[0] = 0x0001BD10', "slot_py": None, "target": None, "cond": None},
    0x1bcd6: {"kind": 'reg', "py": 'r[4] = 0xFFFF9F18', "slot_py": None, "target": None, "cond": None},
    0x1bcd8: {"kind": 'reg', "py": 'r[3] = 0x000024C0', "slot_py": None, "target": None, "cond": None},
    0x1bcda: {"kind": 'mem', "py": 'r[4] = s16(_rdw(ram, 0xFFFF9F18, 2))', "slot_py": None, "target": None, "cond": None},
    0x1bcdc: {"kind": "call", "py": None, "slot_py": 'fr[4] = bits2f(_rdw(ram, 0x0001BD10, 4))', "target": 0x24c0, "ret_pc": 0x1bce0, "set_pr": True, "cond": None},
    0x1bce0: {"kind": 'reg', "py": 'r[2] = 0xFFFFAD88', "slot_py": None, "target": None, "cond": None},
    0x1bce2: {"kind": 'st', "py": 'pr = _rdw(ram, STACK_BASE + 0x3FC, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x1bce4: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFAD88, 4, f2bits(fr[0]))', "target": None, "cond": None},
