#!/usr/bin/env python3
"""Differential test for call-composition caller_45F9C (entry 0x45F9C) — v7 ST caller + callee lib, flattened CODE with nested returns.
...
Run: python3 /home/davide/ailocal/rx8ecu/c/tests/test_caller_45F9C.py
"""
...
CODE = {
    0x45f9c: {"kind": 'reg', "py": 'r[4] = 0xFFFF8750', "slot_py": None, "target": None, "cond": None},
    0x45f9e: {"kind": 'reg', "py": 'r[3] = 0x0003EE58', "slot_py": None, "target": None, "cond": None},
    0x45fa0: {"kind": "call", "py": None, "slot_py": 'r[5] = s8(0x00)', "target": 0x3ee58, "ret_pc": 0x45fa4, "set_pr": False, "cond": None},
