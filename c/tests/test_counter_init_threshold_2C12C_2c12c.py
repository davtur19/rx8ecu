#!/usr/bin/env python3
"""Differential test for counter_init_threshold_2C12C (0x2C12C) — v3 lift (branches + delay slots), 16 bytes.
...
Run from repo root: python3 c/tests/test_counter_init_threshold_2C12C_2c12c.py
"""
...
CODE = {
    0x2c12c: {"kind": 'reg', "py": 'r[3] = 0xFFFFBC50', "slot_py": None, "target": None, "cond": None},
    0x2c12e: {"kind": 'reg', "py": 'r[4] = s8(0x1F)', "slot_py": None, "target": None, "cond": None},
    0x2c130: {"kind": 'reg', "py": 'r[2] = 0xFFFFBC52', "slot_py": None, "target": None, "cond": None},
    0x2c132: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBC50, 2, r[4])', "slot_py": None, "target": None, "cond": None},
    0x2c134: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBC52, 2, r[4])', "slot_py": None, "target": None, "cond": None},
    0x2c136: {"kind": 'reg', "py": 'r[1] = 0xFFFFBC54', "slot_py": None, "target": None, "cond": None},
    0x2c138: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBC54, 2, r[4])', "target": None, "cond": None},}
