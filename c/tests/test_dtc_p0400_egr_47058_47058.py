#!/usr/bin/env python3
"""Differential test for dtc_p0400_egr_47058 (0x47058) — v3 lift + v4 FPU, 14 bytes.
...
Run from repo root: python3 c/tests/test_dtc_p0400_egr_47058_47058.py
"""
...
RAM_MAX = 0xFFFFCC80
SPAN_END = 0x47066
SENT = 0x47066     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x47058: {"kind": 'reg', "py": 'r[3] = 0xFFFFC12C', "slot_py": None, "target": None, "cond": None},
    0x4705a: {"kind": 'fpu', "py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFC12C, 4))', "slot_py": None, "target": None, "cond": None},
    0x4705c: {"kind": 'reg', "py": 'r[2] = 0xFFFFCC7C', "slot_py": None, "target": None, "cond": None},
    0x4705e: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFCC7C, 4, f2bits(fr[4]))', "slot_py": None, "target": None, "cond": None},
    0x47060: {"kind": 'reg', "py": 'r[1] = 0xFFFFCC80', "slot_py": None, "target": None, "cond": None},
    0x47062: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFCC80, 4, f2bits(fr[4]))', "target": None, "cond": None},}
