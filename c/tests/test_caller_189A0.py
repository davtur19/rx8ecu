#!/usr/bin/env python3
"""Differential test for caller_189A0 (entry 0x189A0) — v8 ST caller (CFG), 36 bytes.
...
Run: python3 test_caller_189A0.py
"""
...
CODE = {
    0x189a0: {"kind": 'mem', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, r[14])\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x189a2: {"kind": 'st', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x189a4: {"kind": 'reg', "py": 'r[14] = 0x0003E1F8', "slot_py": None, "target": None, "cond": None},
    0x189a6: {"kind": 'reg', "py": 'r[4] = 0xFFFF8080', "slot_py": None, "target": None, "cond": None},
    0x189a8: {"kind": "call", "py": None, "slot_py": 'r[5] = s8(0x00)', "target": 0x3e1f8, "ret_pc": 0x189ac, "set_pr": True, "cond": None},
    0x189ac: {"kind": 'reg', "py": 'r[4] = 0xFFFF8082', "slot_py": None, "target": None, "cond": None},
    0x189ae: {"kind": "call", "py": None, "slot_py": 'r[5] = s8(0x00)', "target": 0x3e1f8, "ret_pc": 0x189b2, "set_pr": True, "cond": None},
    0x189b2: {"kind": 'reg', "py": 'r[4] = 0xFFFF8084', "slot_py": None, "target": None, "cond": None},
    0x189b4: {"kind": "call", "py": None, "slot_py": 'r[5] = s8(0x00)', "target": 0x3e1f8, "ret_pc": 0x189b8, "set_pr": True, "cond": None},
    0x189b8: {"kind": 'reg', "py": 'r[4] = 0xFFFF8086', "slot_py": None, "target": None, "cond": None},
    0x189ba: {"kind": "call", "py": None, "slot_py": 'r[5] = s8(0x00)', "target": 0x3e1f8, "ret_pc": 0x189be, "set_pr": True, "cond": None},
    0x189be: {"kind": 'st', "py": 'pr = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x189c0: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},
