#!/usr/bin/env python3
"""Differential test for FUN_0000de3c (0xDE3C) — v3 lift (branches + delay slots), 10 bytes.
...
Run from repo root: python3 c/tests/test_FUN_0000de3c_de3c.py
"""
...
ENTRY = 0xDE3C
RAW = bytes.fromhex("D2 2F 63 20 91 4A 00 0B 21 30")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFA400
SPAN_END = 0xDE46
SENT = 0xDE46     # stop-sentinel, placed past the literal pool
...
CODE = {
    0xde3c: {"kind": 'reg', "py": 'r[2] = 0x0006D488', "slot_py": None, "target": None, "cond": None},
    0xde3e: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0x0006D488, 1))', "slot_py": None, "target": None, "cond": None},
    0xde40: {"kind": 'reg', "py": 'r[1] = 0xFFFFA400', "slot_py": None, "target": None, "cond": None},
    0xde42: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFA400, 1, r[3])', "target": None, "cond": None},}
