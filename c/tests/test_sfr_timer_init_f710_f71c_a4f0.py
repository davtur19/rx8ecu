#!/usr/bin/env python3
"""Differential test for sfr_timer_init_f710_f71c (0xA4F0) — v3 lift (branches + delay slots), 30 bytes.
...
Run from repo root: python3 c/tests/test_sfr_timer_init_f710_f71c_a4f0.py
"""
...
ENTRY = 0xA4F0
RAW = bytes.fromhex("95 49 E4 00 25 41 96 47 63 61 92 46 26 21 93 45 91 45 21 31 92 44 22 41 E3 02 00 0B 25 31")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFF71C
SPAN_END = 0xA50E
SENT = 0xA50E     # stop-sentinel, placed past the literal pool
...
CODE = {
    0xa4f0: {"kind": 'reg', "py": 'r[5] = 0xFFFFF710', "slot_py": None, "target": None, "cond": None},
    0xa4f2: {"kind": 'reg', "py": 'r[4] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0xa4f4: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFF710, 2, r[4])', "slot_py": None, "target": None, "cond": None},
    0xa4f6: {"kind": 'reg', "py": 'r[6] = 0xFFFFF718', "slot_py": None, "target": None, "cond": None},
    0xa4f8: {"kind": 'mem', "py": 'r[3] = s16(_rdw(ram, 0xFFFFF718, 2))', "slot_py": None, "target": None, "cond": None},
    0xa4fa: {"kind": 'reg', "py": 'r[2] = 0x000000C0', "slot_py": None, "target": None, "cond": None},
    0xa4fc: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFF718, 2, r[2])', "slot_py": None, "target": None, "cond": None},
    0xa4fe: {"kind": 'reg', "py": 'r[3] = 0x000009C3', "slot_py": None, "target": None, "cond": None},
    0xa500: {"kind": 'reg', "py": 'r[1] = 0xFFFFF71C', "slot_py": None, "target": None, "cond": None},
    0xa502: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFF71C, 2, r[3])', "slot_py": None, "target": None, "cond": None},
    0xa504: {"kind": 'reg', "py": 'r[2] = 0xFFFFF71A', "slot_py": None, "target": None, "cond": None},
    0xa506: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFF71A, 2, r[4])', "slot_py": None, "target": None, "cond": None},
    0xa508: {"kind": 'reg', "py": 'r[3] = s8(0x02)', "slot_py": None, "target": None, "cond": None},
    0xa50a: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFF710, 2, r[3])', "target": None, "cond": None},}
