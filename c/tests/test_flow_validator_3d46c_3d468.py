#!/usr/bin/env python3
"""Differential test for flow_validator_3d46c (0x3D468) — v3 lift (branches + delay slots), 26 bytes.
...
Run from repo root: python3 c/tests/test_flow_validator_3d46c_3d468.py
"""
...
ENTRY = 0x3D468
RAW = bytes.fromhex("94 0B D2 09 63 20 23 38 8D 03 00 09 E0 01 A0 02 24 00 E1 00 24 10 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFC63D
SPAN_END = 0x3D482
SENT = 0x3D494     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x3d468: {"kind": 'reg', "py": 'r[4] = 0xFFFFC63D', "slot_py": None, "target": None, "cond": None},
    0x3d46a: {"kind": 'reg', "py": 'r[2] = 0x0007A93B', "slot_py": None, "target": None, "cond": None},
    0x3d46c: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0x0007A93B, 1))', "slot_py": None, "target": None, "cond": None},
    0x3d46e: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x3d470: {"kind": "branch", "py": None, "slot_py": '', "target": 0x3d47a, "cond": 'T'},
    0x3d474: {"kind": 'reg', "py": 'r[0] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x3d476: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFC63D, 1, r[0])', "target": 0x3d47e, "cond": 'always'},
    0x3d47a: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x3d47c: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC63D, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x3d47e: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
