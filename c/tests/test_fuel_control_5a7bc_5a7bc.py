#!/usr/bin/env python3
"""Differential test for fuel_control_5a7bc (0x5A7BC) — v3 lift (branches + delay slots), 24 bytes.
...
Run from repo root: python3 c/tests/test_fuel_control_5a7bc_5a7bc.py
"""
...
ENTRY = 0x5A7BC
RAW = bytes.fromhex("92 69 63 20 91 68 63 3C 33 10 8F 03 00 09 E0 01 93 63 23 00 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFD2A3
SPAN_END = 0x5A7D4
SENT = 0x5A7D4     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x5a7bc: {"kind": 'reg', "py": 'r[2] = 0xFFFFD28E', "slot_py": None, "target": None, "cond": None},
    0x5a7be: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFD28E, 1))', "slot_py": None, "target": None, "cond": None},
    0x5a7c0: {"kind": 'reg', "py": 'r[1] = 0x00000080', "slot_py": None, "target": None, "cond": None},
    0x5a7c2: {"kind": 'reg', "py": 'r[3] = r[3] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x5a7c4: {"kind": 'reg', "py": 'T = 1 if r[3] == r[1] else 0', "slot_py": None, "target": None, "cond": None},
    0x5a7c6: {"kind": "branch", "py": None, "slot_py": '', "target": 0x5a7d0, "cond": 'notT'},
    0x5a7ca: {"kind": 'reg', "py": 'r[0] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x5a7cc: {"kind": 'reg', "py": 'r[3] = 0xFFFFD2A3', "slot_py": None, "target": None, "cond": None},
    0x5a7ce: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD2A3, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x5a7d0: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
