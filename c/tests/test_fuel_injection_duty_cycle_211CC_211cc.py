#!/usr/bin/env python3
"""Differential test for fuel_injection_duty_cycle_211CC (0x211CC) — v3 lift + v4 FPU, 16 bytes.
...
Run from repo root: python3 c/tests/test_fuel_injection_duty_cycle_211CC_211cc.py
"""
...
RAM_MAX = 0xFFFFB29C
SPAN_END = 0x211DC
SENT = 0x211DC     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x211cc: {"kind": 'reg', "py": 'r[3] = 0xFFFFB29C', "slot_py": None, "target": None, "cond": None},
    0x211ce: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFB29C, 4))', "slot_py": None, "target": None, "cond": None},
    0x211d0: {"kind": 'reg', "py": 'r[2] = 0xFFFFB290', "slot_py": None, "target": None, "cond": None},
    0x211d2: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0xFFFFB290, 4))', "slot_py": None, "target": None, "cond": None},
    0x211d4: {"kind": 'reg', "py": 'r[1] = 0xFFFFB28C', "slot_py": None, "target": None, "cond": None},
    0x211d6: {"kind": 'fpu', "py": 'fr[2] = ts(fr[2] * fr[3])', "slot_py": None, "target": None, "cond": None},
    0x211d8: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFB28C, 4, f2bits(fr[2]))', "target": None, "cond": None},}
