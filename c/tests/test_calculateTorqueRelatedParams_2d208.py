#!/usr/bin/env python3
"""Differential test for calculateTorqueRelatedParams (0x2D208) — v3 lift + v4 FPU, 54 bytes.
...
Run from repo root: python3 c/tests/test_calculateTorqueRelatedParams_2d208.py
"""
...
ENTRY = 0x2D208
RAW = bytes.fromhex("F3 45 8D 02 00 09 A0 0F E0 04 D3 1A F3 38 F3 52 F3 45 8D 02 00 09 A0 07 E0 05 D1 17 F3 18 F3 52 F3 45 8D 03 00 09 E0 06 A0 03 24 00 A0 01 24 50 24 50 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
