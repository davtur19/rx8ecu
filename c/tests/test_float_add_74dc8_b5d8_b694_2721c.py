#!/usr/bin/env python3
"""Differential test for float_add_74dc8_b5d8_b694 (0x2721C) — v3 lift + v4 FPU, 16 bytes.
...
Run from repo root: python3 c/tests/test_float_add_74dc8_b5d8_b694_2721c.py
"""
...
ENTRY = 0x2721C
RAW = bytes.fromhex("D2 0D F3 28 91 0E F2 18 93 0D F2 30 00 0B F3 2A")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFB694
SPAN_END = 0x2722C
SENT = 0x2722C     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x2721c: {"kind": 'reg', "py": 'r[2] = 0x00074DC8', "slot_py": None, "target": None, "cond": None},
    0x2721e: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x00074DC8, 4))', "slot_py": None, "target": None, "cond": None},
    0x27220: {"kind": 'reg', "py": 'r[1] = 0xFFFFB5D8', "slot_py": None, "target": None, "cond": None},
    0x27222: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0xFFFFB5D8, 4))', "slot_py": None, "target": None, "cond": None},
    0x27224: {"kind": 'reg', "py": 'r[3] = 0xFFFFB694', "slot_py": None, "target": None, "cond": None},
    0x27226: {"kind": 'fpu', "py": 'fr[2] = ts(fr[2] + fr[3])', "slot_py": None, "target": None, "cond": None},
    0x27228: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFB694, 4, f2bits(fr[2]))', "target": None, "cond": None},}
