#!/usr/bin/env python3
"""Differential test for obd_service_handler_67538 (0x67538) — v3 lift (branches + delay slots), 16 bytes.
...
Run from repo root: python3 c/tests/test_obd_service_handler_67538_67538.py
"""
...
ENTRY = 0x67538
RAW = bytes.fromhex("68 F6 69 F6 6A F6 6B F6 6C F6 6D F6 00 0B 6E F6")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    0x67538: {"kind": 'mem', "py": 'r[8] = _rdw(ram, STACK_BASE + 0x400, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x6753a: {"kind": 'mem', "py": 'r[9] = _rdw(ram, STACK_BASE + 0x404, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x6753c: {"kind": 'mem', "py": 'r[10] = _rdw(ram, STACK_BASE + 0x408, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x6753e: {"kind": 'mem', "py": 'r[11] = _rdw(ram, STACK_BASE + 0x40C, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x67540: {"kind": 'mem', "py": 'r[12] = _rdw(ram, STACK_BASE + 0x410, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x67542: {"kind": 'mem', "py": 'r[13] = _rdw(ram, STACK_BASE + 0x414, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x67544: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, STACK_BASE + 0x418, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},}
