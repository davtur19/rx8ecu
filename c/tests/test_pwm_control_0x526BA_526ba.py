#!/usr/bin/env python3
"""Differential test for pwm_control_0x526BA (0x526BA) — v3 lift (branches + delay slots), 40 bytes.
...
Run from repo root: python3 c/tests/test_pwm_control_0x526BA_526ba.py
"""
...
ENTRY = 0x526BA
RAW = bytes.fromhex("95 18 92 18 63 20 23 38 8F 04 00 09 D1 0E 60 10 A0 08 25 00 64 50 61 4C 41 15 8F 03 00 09 91 0B 34 1C 25 40 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFD12D
SPAN_END = 0x526E2
SENT = 0x526E2     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x526ba: {"kind": 'reg', "py": 'r[5] = 0xFFFFD12C', "slot_py": None, "target": None, "cond": None},
    0x526bc: {"kind": 'reg', "py": 'r[2] = 0xFFFFD12D', "slot_py": None, "target": None, "cond": None},
    0x526be: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFD12D, 1))', "slot_py": None, "target": None, "cond": None},
    0x526c0: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x526c2: {"kind": "branch", "py": None, "slot_py": '', "target": 0x526ce, "cond": 'notT'},
    0x526c6: {"kind": 'reg', "py": 'r[1] = 0x0007D6C8', "slot_py": None, "target": None, "cond": None},
    0x526c8: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0x0007D6C8, 1))', "slot_py": None, "target": None, "cond": None},
    0x526ca: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFD12C, 1, r[0])', "target": 0x526de, "cond": 'always'},
    0x526ce: {"kind": 'mem', "py": 'r[4] = s8(_rdw(ram, 0xFFFFD12C, 1))', "slot_py": None, "target": None, "cond": None},
    0x526d0: {"kind": 'reg', "py": 'r[1] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x526d2: {"kind": 'reg', "py": 'T = 1 if s32(r[1]) > 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x526d4: {"kind": "branch", "py": None, "slot_py": '', "target": 0x526de, "cond": 'notT'},
    0x526d8: {"kind": 'reg', "py": 'r[1] = 0x000000FF', "slot_py": None, "target": None, "cond": None},
    0x526da: {"kind": 'reg', "py": 'r[4] = (r[4] + r[1]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x526dc: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD12C, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x526de: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
