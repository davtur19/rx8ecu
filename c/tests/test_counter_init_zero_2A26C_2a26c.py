#!/usr/bin/env python3
"""Differential test for counter_init_zero_2A26C (0x2A26C) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_counter_init_zero_2A26C_2a26c.py
"""
...
ENTRY = 0x2A26C
RAW = bytes.fromhex("D2 32 E3 00 00 0B 22 31")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    0x2a26c: {"kind": 'reg', "py": 'r[2] = 0xFFFFBB98', "slot_py": None, "target": None, "cond": None},
    0x2a26e: {"kind": 'reg', "py": 'r[3] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x2a270: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBB98, 2, r[3])', "target": None, "cond": None},}
