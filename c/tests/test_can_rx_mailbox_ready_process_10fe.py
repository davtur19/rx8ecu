#!/usr/bin/env python3
"""Differential test for can_rx_mailbox_ready_process (0x10FE) — pure straight-line lift, 10 bytes.
...
Run from repo root: python3 c/tests/test_can_rx_mailbox_ready_process_10fe.py
"""
...
ENTRY = 0x10FE
RAW = bytes.fromhex("E4 0F 95 51 7F 30 D3 31 64 53")
SEED = 42
N = 2000
