#!/usr/bin/env python3
"""Differential test for obd_service_handler_63A82 (0x63A82) — pure straight-line lift, 18 bytes.
...
Run from repo root: python3 c/tests/test_obd_service_handler_63A82_63a82.py
"""
...
ENTRY = 0x63A82
RAW = bytes.fromhex("E5 00 D0 86 E1 15 D6 86 67 53 63 53 43 08 43 08 33 6C")
SEED = 42
N = 2000
