#!/usr/bin/env python3
"""Differential test for fault_input_latch_ce4a (0x56BE2) — v3 lift (branches + delay slots), 18 bytes.
...
Run from repo root: python3 c/tests/test_fault_input_latch_ce4a_56be2.py
"""
...
ENTRY = 0x56BE2
RAW = bytes.fromhex("92 3C D1 27 63 20 D2 27 21 30 93 38 60 30 00 0B 22 00")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFD048
SPAN_END = 0x56BF4
SENT = 0x56BF4     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x56be2: {"kind": 'reg', "py": 'r[2] = 0xFFFFCE4A', "slot_py": None, "target": None, "cond": None},
    0x56be4: {"kind": 'reg', "py": 'r[1] = 0xFFFFD047', "slot_py": None, "target": None, "cond": None},
    0x56be6: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFCE4A, 1))', "slot_py": None, "target": None, "cond": None},
    0x56be8: {"kind": 'reg', "py": 'r[2] = 0xFFFFD048', "slot_py": None, "target": None, "cond": None},
    0x56bea: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD047, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x56bec: {"kind": 'reg', "py": 'r[3] = 0xFFFFCE4B', "slot_py": None, "target": None, "cond": None},
    0x56bee: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCE4B, 1))', "slot_py": None, "target": None, "cond": None},
    0x56bf0: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFD048, 1, r[0])', "target": None, "cond": None},}
