#!/usr/bin/env python3
"""Differential test for obdFuelingAddRequst_ (0x5AAD4) — v3 lift (branches + delay slots), 10 bytes.
...
Run from repo root: python3 c/tests/test_obdFuelingAddRequst__5aad4.py
"""
...
ENTRY = 0x5AAD4
RAW = bytes.fromhex("25 20 E1 00 25 10 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    0x5aad4: {"kind": 'mem', "py": '_wrw(ram, r[5], 1, r[2])', "slot_py": None, "target": None, "cond": None},
    0x5aad6: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x5aad8: {"kind": 'mem', "py": '_wrw(ram, r[5], 1, r[1])', "slot_py": None, "target": None, "cond": None},
