#!/usr/bin/env python3
"""Differential test for init_string_532cc (0x532CC) — v3 lift + v4 FPU, 62 bytes.
...
Run from repo root: python3 c/tests/test_init_string_532cc_532cc.py
"""
...
ENTRY = 0x532CC
RAW = bytes.fromhex("93 27 F3 38 92 26 F2 28 F2 35 8F 16 00 09 91 22 60 10 20 08 8F 11 00 09 92 1E 60 20 60 0C 88 01 8F 0B 00 09 93 19 60 31 91 18 62 11 30 26 8F 04 00 09 92 14 91 0C 63 20 21 30 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFD149
SPAN_END = 0x5330A
SENT = 0x5330A     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x532cc: {"kind": 'reg', "py": 'r[3] = 0xFFFFD020', "slot_py": None, "target": None, "cond": None},
    0x532ce: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFD020, 4))', "slot_py": None, "target": None, "cond": None},
    0x532d0: {"kind": 'reg', "py": 'r[2] = 0xFFFFD01C', "slot_py": None, "target": None, "cond": None},
    0x532d2: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0xFFFFD01C, 4))', "slot_py": None, "target": None, "cond": None},
    0x532d4: {"kind": 'fpu', "py": 'T = 1 if fr[2] > fr[3] else 0', "slot_py": None, "target": None, "cond": None},
    0x532d6: {"kind": "branch", "py": None, "slot_py": '', "target": 0x53306, "cond": 'notT'},
    0x532da: {"kind": 'reg', "py": 'r[1] = 0xFFFFD034', "slot_py": None, "target": None, "cond": None},
    0x532dc: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFD034, 1))', "slot_py": None, "target": None, "cond": None},
    0x532de: {"kind": 'reg', "py": 'T = 1 if (r[0] & r[0]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x532e0: {"kind": "branch", "py": None, "slot_py": '', "target": 0x53306, "cond": 'notT'},
    0x532e4: {"kind": 'reg', "py": 'r[2] = 0xFFFFCFFB', "slot_py": None, "target": None, "cond": None},
    0x532e6: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCFFB, 1))', "slot_py": None, "target": None, "cond": None},
    0x532e8: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x532ea: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x532ec: {"kind": "branch", "py": None, "slot_py": '', "target": 0x53306, "cond": 'notT'},
    0x532f0: {"kind": 'reg', "py": 'r[3] = 0xFFFFCFE6', "slot_py": None, "target": None, "cond": None},
    0x532f2: {"kind": 'mem', "py": 'r[0] = s16(_rdw(ram, 0xFFFFCFE6, 2))', "slot_py": None, "target": None, "cond": None},
    0x532f4: {"kind": 'reg', "py": 'r[1] = 0xFFFFCFE4', "slot_py": None, "target": None, "cond": None},
    0x532f6: {"kind": 'mem', "py": 'r[2] = s16(_rdw(ram, 0xFFFFCFE4, 2))', "slot_py": None, "target": None, "cond": None},
    0x532f8: {"kind": 'reg', "py": 'T = 1 if r[0] > r[2] else 0', "slot_py": None, "target": None, "cond": None},
    0x532fa: {"kind": "branch", "py": None, "slot_py": '', "target": 0x53306, "cond": 'notT'},
    0x532fe: {"kind": 'reg', "py": 'r[2] = 0xFFFFD149', "slot_py": None, "target": None, "cond": None},
    0x53300: {"kind": 'reg', "py": 'r[1] = 0xFFFFD148', "slot_py": None, "target": None, "cond": None},
    0x53302: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFD149, 1))', "slot_py": None, "target": None, "cond": None},
    0x53304: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD148, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x53306: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
