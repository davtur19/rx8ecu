#!/usr/bin/env python3
"""Differential test for ram_byte_copy_2A300 (0x2A300) — v3 lift (branches + delay slots), 10 bytes.
...
Run from repo root: python3 c/tests/test_ram_byte_copy_2A300_2a300.py
"""
...
ENTRY = 0x2A300
RAW = bytes.fromhex("93 14 60 30 D2 0F 00 0B 22 00")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    0x2a300: {"kind": 'reg', "py": 'r[3] = 0xFFFFBB82', "slot_py": None, "target": None, "cond": None},
    0x2a302: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFBB82, 1))', "slot_py": None, "target": None, "cond": None},
    0x2a304: {"kind": 'reg', "py": 'r[2] = 0xFFFFBB92', "slot_py": None, "target": None, "cond": None},
    0x2a306: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBB92, 1, r[0])', "target": None, "cond": None},}
