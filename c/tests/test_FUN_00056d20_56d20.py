#!/usr/bin/env python3
"""Differential test for FUN_00056d20 (0x56D20) — v3 lift (branches + delay slots), 18 bytes.
...
Run from repo root: python3 c/tests/test_FUN_00056d20_56d20.py
"""
...
RAM_MAX = 0xFFFFD04A
SPAN_END = 0x56D32
SENT = 0x56D32     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x56d20: {"kind": 'reg', "py": 'r[2] = 0xFFFFCE4D', "slot_py": None, "target": None, "cond": None},
    0x56d22: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFCE4D, 1))', "slot_py": None, "target": None, "cond": None},
    0x56d24: {"kind": 'reg', "py": 'r[1] = 0xFFFFD049', "slot_py": None, "target": None, "cond": None},
    0x56d26: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD049, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x56d28: {"kind": 'reg', "py": 'r[3] = 0xFFFFCE4E', "slot_py": None, "target": None, "cond": None},
    0x56d2a: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCE4E, 1))', "slot_py": None, "target": None, "cond": None},
    0x56d2c: {"kind": 'reg', "py": 'r[2] = 0xFFFFD04A', "slot_py": None, "target": None, "cond": None},
    0x56d2e: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFD04A, 1, r[0])', "target": None, "cond": None},}
