#!/usr/bin/env python3
"""Differential test for fpu_multi_register_copy_35590 (0x35590) — v3 lift + v4 FPU, 26 bytes.
...
Run from repo root: python3 c/tests/test_fpu_multi_register_copy_35590_35590.py
"""
...
RAM_MAX = 0xFFFFC1FC
SPAN_END = 0x355AA
SENT = 0x355AA     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x35590: {"kind": 'reg', "py": 'r[3] = 0xFFFFC128', "slot_py": None, "target": None, "cond": None},
    0x35592: {"kind": 'fpu', "py": 'fr[5] = bits2f(_rdw(ram, 0xFFFFC128, 4))', "slot_py": None, "target": None, "cond": None},
    0x35594: {"kind": 'reg', "py": 'r[2] = 0xFFFFC12C', "slot_py": None, "target": None, "cond": None},
    0x35596: {"kind": 'fpu', "py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFC12C, 4))', "slot_py": None, "target": None, "cond": None},
    0x35598: {"kind": 'reg', "py": 'r[1] = 0xFFFFC1F8', "slot_py": None, "target": None, "cond": None},
    0x3559a: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFC1F8, 4, f2bits(fr[4]))', "slot_py": None, "target": None, "cond": None},
    0x3559c: {"kind": 'reg', "py": 'r[3] = 0xFFFFC1FC', "slot_py": None, "target": None, "cond": None},
    0x3559e: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFC1FC, 4, f2bits(fr[4]))', "slot_py": None, "target": None, "cond": None},
    0x355a0: {"kind": 'reg', "py": 'r[2] = 0xFFFFC1E4', "slot_py": None, "target": None, "cond": None},
    0x355a2: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFC1E4, 4, f2bits(fr[5]))', "slot_py": None, "target": None, "cond": None},
    0x355a4: {"kind": 'reg', "py": 'r[1] = 0xFFFFC1F0', "slot_py": None, "target": None, "cond": None},
    0x355a6: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFC1F0, 4, f2bits(fr[5]))', "target": None, "cond": None},}
