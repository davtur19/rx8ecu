#!/usr/bin/env python3
"""Differential test for debounceThrottleRate (0x13E04) — v3 lift + v4 FPU, 44 bytes.
...
Run from repo root: python3 c/tests/test_debounceThrottleRate_13e04.py
"""
...
ENTRY = 0x13E04
RAW = bytes.fromhex("D5 45 D3 46 92 81 F3 38 F2 28 F3 25 8D 04 00 09 D1 43 60 11 A0 08 25 01 64 51 61 4D 41 15 8F 03 00 09 D1 40 34 1C 25 41 00 0B 00 09")
SEED = 43
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFADB4
SPAN_END = 0x13E30
SENT = 0x13E30     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x13e04: {"kind": 'reg', "py": 'r[5] = 0xFFFFA762', "slot_py": None, "target": None, "cond": None},
    0x13e06: {"kind": 'reg', "py": 'r[3] = 0x000727E0', "slot_py": None, "target": None, "cond": None},
    0x13e08: {"kind": 'reg', "py": 'r[2] = 0xFFFFADB4', "slot_py": None, "target": None, "cond": None},
    0x13e0a: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x000727E0, 4))', "slot_py": None, "target": None, "cond": None},
    0x13e0c: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0xFFFFADB4, 4))', "slot_py": None, "target": None, "cond": None},
    0x13e0e: {"kind": 'fpu', "py": 'T = 1 if fr[3] > fr[2] else 0', "slot_py": None, "target": None, "cond": None},
    0x13e10: {"kind": "branch", "py": None, "slot_py": '', "target": 0x13e1c, "cond": 'T'},
    0x13e14: {"kind": 'reg', "py": 'r[1] = 0x000727BE', "slot_py": None, "target": None, "cond": None},
    0x13e16: {"kind": 'mem', "py": 'r[0] = s16(_rdw(ram, 0x000727BE, 2))', "slot_py": None, "target": None, "cond": None},
    0x13e18: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFA762, 2, r[0])', "target": 0x13e2c, "cond": 'always'},
    0x13e1c: {"kind": 'mem', "py": 'r[4] = s16(_rdw(ram, r[5], 2))', "slot_py": None, "target": None, "cond": None},
    0x13e1e: {"kind": 'reg', "py": 'r[1] = r[4] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x13e20: {"kind": 'reg', "py": 'T = 1 if s32(r[1]) > 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x13e22: {"kind": "branch", "py": None, "slot_py": '', "target": 0x13e2c, "cond": 'notT'},
    0x13e26: {"kind": 'reg', "py": 'r[1] = 0x0000FFFF', "slot_py": None, "target": None, "cond": None},
    0x13e28: {"kind": 'reg', "py": 'r[4] = (r[4] + r[1]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x13e2a: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA762, 2, r[4])', "slot_py": None, "target": None, "cond": None},
    0x13e2c: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
