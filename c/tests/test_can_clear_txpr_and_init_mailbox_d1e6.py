#!/usr/bin/env python3
"""Differential test for can_clear_txpr_and_init_mailbox (0xD1E6) — v3 lift (branches + delay slots), 30 bytes.
...
Run from repo root: python3 c/tests/test_can_clear_txpr_and_init_mailbox_d1e6.py
"""
...
ENTRY = 0xD1E6
RAW = bytes.fromhex("E3 09 D2 30 E5 00 D7 31 22 30 64 73 66 73 76 06 24 50 74 01 34 62 8F FB 00 09 00 0B 00 09")
SEED = 0
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFA3D7
SPAN_END = 0xD204
SENT = 0xD204     # stop-sentinel, placed past the literal pool
...
CODE = {
    0xd1e6: {"kind": 'reg', "py": 'r[3] = s8(0x09)', "slot_py": None, "target": None, "cond": None},
    0xd1e8: {"kind": 'reg', "py": 'r[2] = 0xFFFFA3D7', "slot_py": None, "target": None, "cond": None},
    0xd1ea: {"kind": 'reg', "py": 'r[5] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0xd1ec: {"kind": 'reg', "py": 'r[7] = 0xFFFFA3D0', "slot_py": None, "target": None, "cond": None},
    0xd1ee: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA3D7, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0xd1f0: {"kind": 'reg', "py": 'r[4] = r[7]', "slot_py": None, "target": None, "cond": None},
    0xd1f2: {"kind": 'reg', "py": 'r[6] = r[7]', "slot_py": None, "target": None, "cond": None},
    0xd1f4: {"kind": 'reg', "py": 'r[6] = (r[6] + s8(0x06)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xd1f6: {"kind": 'mem', "py": '_wrw(ram, r[4], 1, r[5])', "slot_py": None, "target": None, "cond": None},
    0xd1f8: {"kind": 'reg', "py": 'r[4] = (r[4] + s8(0x01)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xd1fa: {"kind": 'reg', "py": 'T = 1 if (r[4] & 0xFFFFFFFF) >= (r[6] & 0xFFFFFFFF) else 0', "slot_py": None, "target": None, "cond": None},
    0xd1fc: {"kind": "branch", "py": None, "slot_py": '', "target": 0xd1f6, "cond": 'notT'},
    0xd200: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
