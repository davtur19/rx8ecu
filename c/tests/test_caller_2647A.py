#!/usr/bin/env python3
"""Differential test for caller_2647A (entry 0x2647A) — v8 ST caller (CFG), 30 bytes.
...
Run: python3 test_caller_2647A.py
"""
...
CODE = {
    0x2647a: {"kind": 'st', "py": 'local[0x3FC] = pr\n_wrw(ram, STACK_BASE + 0x3FC, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x2647c: {"kind": 'reg', "py": 'r[0] = 0x000264C0', "slot_py": None, "target": None, "cond": None},
    0x2647e: {"kind": 'fpu', "py": 'fr[7] = bits2f(_rdw(ram, 0x000264C0, 4))', "slot_py": None, "target": None, "cond": None},
    0x26480: {"kind": 'reg', "py": 'r[3] = 0x00075198', "slot_py": None, "target": None, "cond": None},
    0x26482: {"kind": 'fpu', "py": 'fr[6] = bits2f(_rdw(ram, 0x00075198, 4))', "slot_py": None, "target": None, "cond": None},
    0x26484: {"kind": 'reg', "py": 'r[2] = 0xFFFFB600', "slot_py": None, "target": None, "cond": None},
    0x26486: {"kind": 'fpu', "py": 'fr[5] = bits2f(_rdw(ram, 0xFFFFB600, 4))', "slot_py": None, "target": None, "cond": None},
    0x26488: {"kind": 'reg', "py": 'r[1] = 0xFFFFB5FC', "slot_py": None, "target": None, "cond": None},
    0x2648a: {"kind": 'reg', "py": 'r[3] = 0x000023B0', "slot_py": None, "target": None, "cond": None},
    0x2648c: {"kind": "call", "py": None, "slot_py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFB5FC, 4))', "target": 0x23b0, "ret_pc": 0x26490, "set_pr": True, "cond": None},
    0x26490: {"kind": 'reg', "py": 'r[2] = 0xFFFFB600', "slot_py": None, "target": None, "cond": None},
    0x26492: {"kind": 'st', "py": 'pr = _rdw(ram, STACK_BASE + 0x3FC, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x26494: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFB600, 4, f2bits(fr[0]))', "target": None, "cond": None},
