#!/usr/bin/env python3
"""Differential test for mem_clear_5286 (0x5286) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_mem_clear_5286_5286.py
"""
...
ENTRY = 0x5286
RAW = bytes.fromhex("E3 00 92 53 00 0B 22 31")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    0x5286: {"kind": 'reg', "py": 'r[3] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x5288: {"kind": 'reg', "py": 'r[2] = 0xFFFFEC26', "slot_py": None, "target": None, "cond": None},
    0x528a: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFEC26, 2, r[3])', "target": None, "cond": None},}
