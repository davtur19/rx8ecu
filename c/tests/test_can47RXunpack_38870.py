#!/usr/bin/env python3
"""Differential test for can47RXunpack (0x38870) — v3 lift (branches + delay slots), 58 bytes.
...
Run from repo root: python3 c/tests/test_can47RXunpack_38870.py
"""
...
ENTRY = 0x38870
RAW = bytes.fromhex("D4 26 63 40 92 3A 22 30 84 41 91 38 93 38 21 00 84 42 23 00 84 43 92 34 91 34 22 00 84 44 21 00 84 45 93 30 23 00 84 46 60 0C 40 18 62 03 84 47 60 0C 32 0C D0 1A 00 0B 20 21")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFC4E0
SPAN_END = 0x388AA
SENT = 0x388AA     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x38870: {"kind": 'reg', "py": 'r[4] = 0xFFFFC4CC', "slot_py": None, "target": None, "cond": None},
    0x38872: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFC4CC, 1))', "slot_py": None, "target": None, "cond": None},
    0x38874: {"kind": 'reg', "py": 'r[2] = 0xFFFFC4D5', "slot_py": None, "target": None, "cond": None},
    0x38876: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC4D5, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x38878: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFC4CD, 1))', "slot_py": None, "target": None, "cond": None},
    0x3887a: {"kind": 'reg', "py": 'r[1] = 0xFFFFC4D6', "slot_py": None, "target": None, "cond": None},
    0x3887c: {"kind": 'reg', "py": 'r[3] = 0xFFFFC4D7', "slot_py": None, "target": None, "cond": None},
    0x3887e: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC4D6, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x38880: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFC4CE, 1))', "slot_py": None, "target": None, "cond": None},
    0x38882: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC4D7, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x38884: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFC4CF, 1))', "slot_py": None, "target": None, "cond": None},
    0x38886: {"kind": 'reg', "py": 'r[2] = 0xFFFFC4D8', "slot_py": None, "target": None, "cond": None},
    0x38888: {"kind": 'reg', "py": 'r[1] = 0xFFFFC4D9', "slot_py": None, "target": None, "cond": None},
    0x3888a: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC4D8, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x3888c: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFC4D0, 1))', "slot_py": None, "target": None, "cond": None},
    0x3888e: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC4D9, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x38890: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFC4D1, 1))', "slot_py": None, "target": None, "cond": None},
    0x38892: {"kind": 'reg', "py": 'r[3] = 0xFFFFC4DA', "slot_py": None, "target": None, "cond": None},
    0x38894: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC4DA, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x38896: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFC4D2, 1))', "slot_py": None, "target": None, "cond": None},
    0x38898: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x3889a: {"kind": 'reg', "py": 'r[0] = (r[0] << 8) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x3889c: {"kind": 'reg', "py": 'r[2] = r[0]', "slot_py": None, "target": None, "cond": None},
    0x3889e: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFC4D3, 1))', "slot_py": None, "target": None, "cond": None},
    0x388a0: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x388a2: {"kind": 'reg', "py": 'r[2] = (r[2] + r[0]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x388a4: {"kind": 'reg', "py": 'r[0] = 0xFFFFC4E0', "slot_py": None, "target": None, "cond": None},
    0x388a6: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFC4E0, 2, r[2])', "target": None, "cond": None},}
