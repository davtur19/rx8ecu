#!/usr/bin/env python3
"""Differential test for irq_atomic_bit_setclear_byte (0x4B64) — v3 lift (branches + delay slots), 88 bytes.
...
Run from repo root: python3 c/tests/test_irq_atomic_bit_setclear_byte_4b64.py
"""
...
ENTRY = 0x4B64
RAW = bytes.fromhex("93 46 02 02 43 0E 66 6D 63 40 26 68 8B 04 65 57 23 59 24 30 00 0B 42 0E 23 5B 24 30 00 0B 42 0E 93 36 02 02 43 0E 66 6D 63 41 26 68 8B 04 65 57 23 59 24 31 00 0B 42 0E 23 5B 24 31 00 0B 42 0E 63 40 66 6D 26 68 8B 03 65 57 23 59 00 0B 24 30 23 5B 24 30 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = None
SPAN_END = 0x4BBC
SENT = 0x4BBC     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x4b64: {"kind": 'reg', "py": 'r[3] = 0x000000E0', "slot_py": None, "target": None, "cond": None},
    0x4b66: {"kind": 'reg', "py": 'r[2] = sr', "slot_py": None, "target": None, "cond": None},
    0x4b68: {"kind": 'reg', "py": 'sr = r[3]', "slot_py": None, "target": None, "cond": None},
    0x4b6a: {"kind": 'reg', "py": 'r[6] = r[6] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x4b6c: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, r[4], 1))', "slot_py": None, "target": None, "cond": None},
    0x4b6e: {"kind": 'reg', "py": 'T = 1 if (r[6] & r[6]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x4b70: {"kind": "branch", "py": None, "slot_py": None, "target": 0x4b7c, "cond": 'notT'},
    0x4b72: {"kind": 'reg', "py": 'r[5] = (~r[5]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x4b74: {"kind": 'reg', "py": 'r[3] = (r[3] & r[5]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x4b76: {"kind": 'mem', "py": '_wrw(ram, r[4], 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x4b78: {"kind": "ret", "py": None, "slot_py": 'sr = r[2]', "target": None, "cond": None},
    0x4b7c: {"kind": 'reg', "py": 'r[3] = (r[3] | r[5]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x4b7e: {"kind": 'mem', "py": '_wrw(ram, r[4], 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x4b80: {"kind": "ret", "py": None, "slot_py": 'sr = r[2]', "target": None, "cond": None},
    0x4b84: {"kind": 'reg', "py": 'r[3] = 0x000000E0', "slot_py": None, "target": None, "cond": None},
    0x4b86: {"kind": 'reg', "py": 'r[2] = sr', "slot_py": None, "target": None, "cond": None},
    0x4b88: {"kind": 'reg', "py": 'sr = r[3]', "slot_py": None, "target": None, "cond": None},
    0x4b8a: {"kind": 'reg', "py": 'r[6] = r[6] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x4b8c: {"kind": 'mem', "py": 'r[3] = s16(_rdw(ram, r[4], 2))', "slot_py": None, "target": None, "cond": None},
    0x4b8e: {"kind": 'reg', "py": 'T = 1 if (r[6] & r[6]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x4b90: {"kind": "branch", "py": None, "slot_py": None, "target": 0x4b9c, "cond": 'notT'},
    0x4b92: {"kind": 'reg', "py": 'r[5] = (~r[5]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x4b94: {"kind": 'reg', "py": 'r[3] = (r[3] & r[5]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x4b96: {"kind": 'mem', "py": '_wrw(ram, r[4], 2, r[3])', "slot_py": None, "target": None, "cond": None},
    0x4b98: {"kind": "ret", "py": None, "slot_py": 'sr = r[2]', "target": None, "cond": None},
    ...
    0x4bb0: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, r[4], 1, r[3])', "target": None, "cond": None},
    0x4bb4: {"kind": 'reg', "py": 'r[3] = (r[3] | r[5]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x4bb6: {"kind": 'mem', "py": '_wrw(ram, r[4], 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x4bb8: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
