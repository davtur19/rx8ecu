...
CODE = {
    ...
    0x4b68: {"kind": 'reg', "py": 'sr = r[3]\nT = sr & 1\nQ = (sr >> 8) & 1\nM = (sr >> 9) & 1', "slot_py": None, "target": None, "cond": None},
    ...
    0x4b78: {"kind": "ret", "py": None, "slot_py": 'sr = r[2]\nT = sr & 1\nQ = (sr >> 8) & 1\nM = (sr >> 9) & 1', "target": None, "cond": None},
    ...
    0x4b80: {"kind": "ret", "py": None, "slot_py": 'sr = r[2]\nT = sr & 1\nQ = (sr >> 8) & 1\nM = (sr >> 9) & 1', "target": None, "cond": None},
    ...
    0x4b8e: {"kind": 'reg', "py": 'T = 1 if (r[6] & r[6]) == 0 else 0\nsr = (sr & ~1) | (T & 1)', "slot_py": None, "target": None, "cond": None},
    ...
    0x4b98: {"kind": "ret", "py": None, "slot_py": 'sr = r[2]\nT = sr & 1\nQ = (sr >> 8) & 1\nM = (sr >> 9) & 1', "target": None, "cond": None},
