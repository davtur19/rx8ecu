#!/usr/bin/env python3
"""Differential test for fanout_float_9f68_to_b5d8_b5dc_b5e0 (0x25E88) — v3 lift + v4 FPU, 20 bytes.
...
Run from repo root: python3 c/tests/test_fanout_float_9f68_to_b5d8_b5dc_b5e0_25e88.py
"""
...
ENTRY = 0x25E88
RAW = bytes.fromhex("94 2B D3 17 92 2A F3 38 F4 3A F2 3A F3 48 91 26 00 0B F1 3A")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFB5E0
SPAN_END = 0x25E9C
SENT = 0x25E9C     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x25e88: {"kind": 'reg', "py": 'r[4] = 0xFFFFB5D8', "slot_py": None, "target": None, "cond": None},
    0x25e8a: {"kind": 'reg', "py": 'r[3] = 0xFFFF9F68', "slot_py": None, "target": None, "cond": None},
    0x25e8c: {"kind": 'reg', "py": 'r[2] = 0xFFFFB5DC', "slot_py": None, "target": None, "cond": None},
    0x25e8e: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFF9F68, 4))', "slot_py": None, "target": None, "cond": None},
    0x25e90: {"kind": 'fpu', "py": '_wrw(ram, r[4], 4, f2bits(fr[3]))', "slot_py": None, "target": None, "cond": None},
    0x25e92: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFB5DC, 4, f2bits(fr[3]))', "slot_py": None, "target": None, "cond": None},
    0x25e94: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, r[4], 4))', "slot_py": None, "target": None, "cond": None},
    0x25e96: {"kind": 'reg', "py": 'r[1] = 0xFFFFB5E0', "slot_py": None, "target": None, "cond": None},
    0x25e98: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFB5E0, 4, f2bits(fr[3]))', "target": None, "cond": None},}
