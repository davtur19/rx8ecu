#!/usr/bin/env python3
"""Differential test for tune_table_write_4B8E4 (0x4B8E4) — v3 lift (branches + delay slots), 34 bytes.
...
Run from repo root: python3 c/tests/test_tune_table_write_4B8E4_4b8e4.py
"""
...
CODE = {
    0x4b8e4: {"kind": 'reg', "py": 'r[2] = 0xFFFFCE1C', "slot_py": None, "target": None, "cond": None},
    0x4b8e6: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFCE1C, 1))', "slot_py": None, "target": None, "cond": None},
    0x4b8e8: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x4b8ea: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4b902, "cond": 'notT'},
    0x4b8ee: {"kind": 'reg', "py": 'r[4] = 0xFFFFCE1A', "slot_py": None, "target": None, "cond": None},
    0x4b8f0: {"kind": 'reg', "py": 'r[1] = 0xFFFFCE19', "slot_py": None, "target": None, "cond": None},
    0x4b8f2: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFCE19, 1))', "slot_py": None, "target": None, "cond": None},
    0x4b8f4: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x4b8f6: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4b8fe, "cond": 'notT'},
    0x4b8fa: {"kind": "branch", "py": None, "slot_py": 'r[3] = s8(0x00)', "target": 0x4b900, "cond": 'always'},
    0x4b8fe: {"kind": 'reg', "py": 'r[3] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x4b900: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCE1A, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x4b902: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
