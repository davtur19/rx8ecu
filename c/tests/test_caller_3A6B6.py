#!/usr/bin/env python3
"""Differential test for caller_3A6B6 (entry 0x3A6B6) — v8 ST caller (CFG), 148 bytes.
...
Run: python3 test_caller_3A6B6.py
"""
...
CODE = {
    0x3a6b6: {"kind": 'mem', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, r[14])\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x3a6b8: {"kind": 'mem', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, r[13])\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x3a6ba: {"kind": 'mem', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, r[12])\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x3a6bc: {"kind": 'st', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x3a6be: {"kind": 'reg', "py": 'r[12] = 0xFFFFC541', "slot_py": None, "target": None, "cond": None},
    0x3a6c0: {"kind": 'reg', "py": 'r[13] = 0xFFFFC53E', "slot_py": None, "target": None, "cond": None},
    0x3a6c2: {"kind": 'reg', "py": 'r[3] = 0xFFFFCFD9', "slot_py": None, "target": None, "cond": None},
    0x3a6c4: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCFD9, 1))', "slot_py": None, "target": None, "cond": None},
    0x3a6c6: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x3a6c8: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x3a6ca: {"kind": "branch", "py": None, "slot_py": 'r[14] = s8(0x00)', "target": 0x3a6d8, "cond": 'T'},
    0x3a6ce: {"kind": 'reg', "py": 'r[1] = 0xFFFFBF88', "slot_py": None, "target": None, "cond": None},
    0x3a6d0: {"kind": 'mem', "py": 'r[2] = s8(_rdw(ram, 0xFFFFBF88, 1))', "slot_py": None, "target": None, "cond": None},
    0x3a6d2: {"kind": 'reg', "py": 'T = 1 if (r[2] & r[2]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x3a6d4: {"kind": "branch", "py": None, "slot_py": '', "target": 0x3a6de, "cond": 'notT'},
    0x3a6d8: {"kind": 'mem', "py": '_wrw(ram, r[12], 1, r[14])', "slot_py": None, "target": None, "cond": None},
    0x3a6da: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFC53E, 1, r[14])', "target": 0x3a740, "cond": 'always'},
    0x3a740: {"kind": 'st', "py": 'pr = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x3a742: {"kind": 'mem', "py": 'r[12] = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x3a744: {"kind": 'mem', "py": 'r[13] = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x3a746: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None, },
    0x3a6de: {"kind": 'reg', "py": 'r[5] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x3a6e0: {"kind": 'reg', "py": 'r[2] = 0x00002478', "slot_py": None, "target": None, "cond": None},
    0x3a6e2: {"kind": "call", "py": None, "slot_py": 'r[4] = s8(_rdw(ram, 0xFFFFC53E, 1))', "target": 0x2478, "ret_pc": 0x3a6e6, "set_pr": True, "cond": None},
    0x3a6e6: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC53E, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x3a6e8: {"kind": 'reg', "py": 'r[2] = 0xFFFFC548', "slot_py": None, "target": None, "cond": None},
    0x3a6ea: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, r[2], 1))', "slot_py": None, "target": None, "cond": None},
    0x3a6ec: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x3a6ee: {"kind": "branch", "py": None, "slot_py": '', "target": 0x3a730, "cond": 'notT'},
    0x3a6f2: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFC541, 1, r[14])', "target": 0x3a740, "cond": 'always'},
    0x3a730: {"kind": 'mem', "py": 'r[1] = s8(_rdw(ram, r[13], 1))', "slot_py": None, "target": None, "cond": None},
    0x3a732: {"kind": 'reg', "py": 'r[0] = 0x00079572', "slot_py": None, "target": None, "cond": None},
    0x3a734: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0x00079572, 1))', "slot_py": None, "target": None, "cond": None},
    0x3a736: {"kind": 'reg', "py": 'T = 1 if (r[1] & 0xFFFFFFFF) > (r[3] & 0xFFFFFFFF) else 0', "slot_py": None, "target": None, "cond": None},
    0x3a738: {"kind": "branch", "py": None, "slot_py": '', "target": 0x3a740, "cond": 'notT'},
    0x3a73c: {"kind": 'reg', "py": 'r[1] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x3a73e: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC541, 1, r[1])', "slot_py": None, "target": None, "cond": None},
