#!/usr/bin/env python3
"""Differential test for calculateEngineRunning (0xE278) — v3 lift + v4 FPU, 52 bytes.
...
Run from repo root: python3 c/tests/test_calculateEngineRunning_e278.py
"""
...
ENTRY = 0xE278
RAW = bytes.fromhex("93 12 F4 38 94 11 D2 09 F3 28 F3 45 8F 03 00 09 E0 00 A0 07 24 00 D1 06 F2 18 F2 45 8D 02 00 09 E0 01 24 00 00 0B 00 09 B5 94 A4 28 00 06 D4 90 00 06 D4 94")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFB594
SPAN_END = 0xE2AC
SENT = 0xE2AC     # stop-sentinel, placed past the literal pool
...
CODE = {
    0xe278: {"kind": 'reg', "py": 'r[3] = 0xFFFFB594', "slot_py": None, "target": None, "cond": None},
    0xe27a: {"kind": 'fpu', "py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFB594, 4))', "slot_py": None, "target": None, "cond": None},
    0xe27c: {"kind": 'reg', "py": 'r[4] = 0xFFFFA428', "slot_py": None, "target": None, "cond": None},
    0xe27e: {"kind": 'reg', "py": 'r[2] = 0x0006D490', "slot_py": None, "target": None, "cond": None},
    0xe280: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x0006D490, 4))', "slot_py": None, "target": None, "cond": None},
    0xe282: {"kind": 'fpu', "py": 'T = 1 if fr[3] > fr[4] else 0', "slot_py": None, "target": None, "cond": None},
    0xe284: {"kind": "branch", "py": None, "slot_py": '', "target": 0xe28e, "cond": 'notT'},
    0xe288: {"kind": 'reg', "py": 'r[0] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0xe28a: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFA428, 1, r[0])', "target": 0xe29c, "cond": 'always'},
    0xe28e: {"kind": 'reg', "py": 'r[1] = 0x0006D494', "slot_py": None, "target": None, "cond": None},
    0xe290: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0x0006D494, 4))', "slot_py": None, "target": None, "cond": None},
    0xe292: {"kind": 'fpu', "py": 'T = 1 if fr[2] > fr[4] else 0', "slot_py": None, "target": None, "cond": None},
    0xe294: {"kind": "branch", "py": None, "slot_py": '', "target": 0xe29c, "cond": 'T'},
    0xe298: {"kind": 'reg', "py": 'r[0] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0xe29a: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA428, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0xe29c: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
