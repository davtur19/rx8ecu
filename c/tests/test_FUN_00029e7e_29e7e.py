#!/usr/bin/env python3
"""Differential test for FUN_00029e7e (0x29E7E) — v3 lift (branches + delay slots), 10 bytes.
...
Run from repo root: python3 c/tests/test_FUN_00029e7e_29e7e.py
"""
...
ENTRY = 0x29E7E
RAW = bytes.fromhex("93 10 D2 0E 61 30 00 0B 22 10")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBB61
SPAN_END = 0x29E88
SENT = 0x29E88     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x29e7e: {"kind": 'reg', "py": 'r[3] = 0xFFFFBB51', "slot_py": None, "target": None, "cond": None},
    0x29e80: {"kind": 'reg', "py": 'r[2] = 0xFFFFBB61', "slot_py": None, "target": None, "cond": None},
    0x29e82: {"kind": 'mem', "py": 'r[1] = s8(_rdw(ram, 0xFFFFBB51, 1))', "slot_py": None, "target": None, "cond": None},
    0x29e84: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBB61, 1, r[1])', "target": None, "cond": None},}
