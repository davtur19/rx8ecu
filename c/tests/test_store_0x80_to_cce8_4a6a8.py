#!/usr/bin/env python3
"""Differential test for store_0x80_to_cce8 (0x4A6A8) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_store_0x80_to_cce8_4a6a8.py
"""
...
ENTRY = 0x4A6A8
RAW = bytes.fromhex("93 1B 92 1B 00 0B 22 30")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCCE8
SPAN_END = 0x4A6B0
SENT = 0x4A6B0     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x4a6a8: {"kind": 'reg', "py": 'r[3] = 0x00000080', "slot_py": None, "target": None, "cond": None},
    0x4a6aa: {"kind": 'reg', "py": 'r[2] = 0xFFFFCCE8', "slot_py": None, "target": None, "cond": None},
    0x4a6ac: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFCCE8, 1, r[3])', "target": None, "cond": None},}
