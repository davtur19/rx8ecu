#!/usr/bin/env python3
"""Differential test for fpu_multiply_calc_simple_34D44 (0x34D44) — v3 lift + v4 FPU, 16 bytes.
...
Run from repo root: python3 c/tests/test_fpu_multiply_calc_simple_34D44_34d44.py
"""
...
ENTRY = 0x34D44
RAW = bytes.fromhex("D2 40 F3 28 91 6F F2 18 93 6E F2 32 00 0B F3 2A")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFC128
SPAN_END = 0x34D54
SENT = 0x34D54     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x34d44: {"kind": 'reg', "py": 'r[2] = 0x00079FE0', "slot_py": None, "target": None, "cond": None},
    0x34d46: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x00079FE0, 4))', "slot_py": None, "target": None, "cond": None},
    0x34d48: {"kind": 'reg', "py": 'r[1] = 0xFFFFAAD4', "slot_py": None, "target": None, "cond": None},
    0x34d4a: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0xFFFFAAD4, 4))', "slot_py": None, "target": None, "cond": None},
    0x34d4c: {"kind": 'reg', "py": 'r[3] = 0xFFFFC128', "slot_py": None, "target": None, "cond": None},
    0x34d4e: {"kind": 'fpu', "py": 'fr[2] = ts(fr[2] * fr[3])', "slot_py": None, "target": None, "cond": None},
    0x34d50: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFC128, 4, f2bits(fr[2]))', "target": None, "cond": None},}
