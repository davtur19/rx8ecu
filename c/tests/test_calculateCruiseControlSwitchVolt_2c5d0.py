#!/usr/bin/env python3
"""Differential test for calculateCruiseControlSwitchVolt (0x2C5D0) — v3 lift (branches + delay slots), 28 bytes.
...
Run from repo root: python3 c/tests/test_calculateCruiseControlSwitchVolt_2c5d0.py
"""
...
ENTRY = 0x2C5D0
RAW = bytes.fromhex("D3 26 60 30 60 0C C9 10 88 10 8F 03 00 09 E1 01 A0 02 24 10 E0 00 24 00 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBC5E
SPAN_END = 0x2C5EC
SENT = 0x2C5EC     # stop-sentinel, placed past the literal pool
...
CODE = {
    ...
    0x2c5e0: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, r[4], 1, r[1])', "target": 0x2c5e8, "cond": 'always'},
    0x2c5e4: {"kind": 'reg', "py": 'r[0] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x2c5e6: {"kind": 'mem', "py": '_wrw(ram, r[4], 1, r[0])', "slot_py": None, "target": None, "cond": None},
