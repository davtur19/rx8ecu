#!/usr/bin/env python3
"""Differential test for call-composition caller_490F0 (entry 0x490F0) — v7 ST caller + callee lib, flattened CODE with nested returns.
...
Run: python3 /home/davide/ailocal/rx8ecu/c/tests/test_caller_490F0.py
"""
...
CODE = {
    0x490f0: {"kind": 'reg', "py": 'r[4] = 0xFFFF8788', "slot_py": None, "target": None, "cond": None},
    0x490f2: {"kind": 'reg', "py": 'r[3] = 0x0003EE58', "slot_py": None, "target": None, "cond": None},
    0x490f4: {"kind": "call", "py": None, "slot_py": 'r[5] = s8(0x01)', "target": 0x3ee58, "ret_pc": 0x490f8, "set_pr": False, "cond": None},
