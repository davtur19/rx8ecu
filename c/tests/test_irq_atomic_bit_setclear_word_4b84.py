#!/usr/bin/env python3
"""Differential test for irq_atomic_bit_setclear_word (0x4B84) — v3 lift (branches + delay slots), 56 bytes.
...
Run from repo root: python3 c/tests/test_irq_atomic_bit_setclear_word_4b84.py
"""
...
ENTRY = 0x4B84
RAW = bytes.fromhex("93 36 02 02 43 0E 66 6D 63 41 26 68 8B 04 65 57 23 59 24 31 00 0B 42 0E 23 5B 24 31 00 0B 42 0E 63 40 66 6D 26 68 8B 03 65 57 23 59 00 0B 24 30 23 5B 24 30 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
