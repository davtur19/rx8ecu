#!/usr/bin/env python3
"""Differential test for diag_circuit_54a08 (0x54A08) — v3 lift (branches + delay slots), 64 bytes.
...
Run from repo root: python3 c/tests/test_diag_circuit_54a08_54a08.py
"""
...
ENTRY = 0x54A08
RAW = bytes.fromhex("94 24 93 24 60 30 60 0C 88 01 8F 15 00 09 92 1F 60 20 60 0C 88 01 8F 0F 00 09 91 1A 60 10 60 0C 88 01 8F 09 00 09 93 15 60 30 60 0C 88 01 8F 03 00 09 E3 01 A0 02 24 30 E1 00 24 10 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    0x54a08: {"kind": 'reg', "py": 'r[4] = 0xFFFFD1E5', "slot_py": None, "target": None, "cond": None},
    0x54a0a: {"kind": 'reg', "py": 'r[3] = 0xFFFFC981', "slot_py": None, "target": None, "cond": None},
    0x54a0c: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFC981, 1))', "slot_py": None, "target": None, "cond": None},
    0x54a0e: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x54a10: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x54a12: {"kind": "branch", "py": None, "slot_py": '', "target": 0x54a40, "cond": 'notT'},
    0x54a16: {"kind": 'reg', "py": 'r[2] = 0xFFFFC983', "slot_py": None, "target": None, "cond": None},
    0x54a18: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFC983, 1))', "slot_py": None, "target": None, "cond": None},
    0x54a1a: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x54a1c: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x54a1e: {"kind": "branch", "py": None, "slot_py": '', "target": 0x54a40, "cond": 'notT'},
    0x54a22: {"kind": 'reg', "py": 'r[1] = 0xFFFFCA04', "slot_py": None, "target": None, "cond": None},
    0x54a24: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCA04, 1))', "slot_py": None, "target": None, "cond": None},
    0x54a26: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x54a28: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x54a2a: {"kind": "branch", "py": None, "slot_py": '', "target": 0x54a40, "cond": 'notT'},
    0x54a2e: {"kind": 'reg', "py": 'r[3] = 0xFFFFCA06', "slot_py": None, "target": None, "cond": None},
    0x54a30: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCA06, 1))', "slot_py": None, "target": None, "cond": None},
    0x54a32: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x54a34: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x54a36: {"kind": "branch", "py": None, "slot_py": '', "target": 0x54a40, "cond": 'notT'},
    0x54a3a: {"kind": 'reg', "py": 'r[3] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x54a3c: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFD1E5, 1, r[3])', "target": 0x54a44, "cond": 'always'},
    0x54a40: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x54a42: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD1E5, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x54a44: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
