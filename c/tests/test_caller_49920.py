...
CODE = {
    ...
    0x4996e: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCC9C, 1, r[13])', "slot_py": None, "target": None, "cond": None},
    ...
    0x4994c: {"kind": "branch", "py": None, "slot_py": 'r[4] = s8(_rdw(ram, r[2], 1))', "target": 0x4995c, "cond": 'notT'},
