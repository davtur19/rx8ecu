#!/usr/bin/env python3
"""Differential test for array_init_zeros_small_1D068 (0x1D068) — v3 lift + v4 FPU, 24 bytes.
...
Run from repo root: python3 c/tests/test_array_init_zeros_small_1D068_1d068.py
"""
...
RAM_MAX = None
SPAN_END = 0x1D080
SENT = 0x1D080     # stop-sentinel, placed past the literal pool
