#!/usr/bin/env python3
"""Differential test for atomic_calc_engine_temps (0x21DCA) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_atomic_calc_engine_temps_21dca.py
"""
...
ENTRY = 0x21DCA
RAW = bytes.fromhex("4F 26 6D F6 00 0B 6E F6")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = None
SPAN_END = 0x21DD2
SENT = 0x21DD2     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x21dca: {"kind": 'mem', "py": 'pr = _rdw(ram, STACK_BASE + 0x400, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x21dcc: {"kind": 'mem', "py": 'r[13] = _rdw(ram, STACK_BASE + 0x404, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x21dce: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, STACK_BASE + 0x408, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},}
