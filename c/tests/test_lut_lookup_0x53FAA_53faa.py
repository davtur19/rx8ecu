#!/usr/bin/env python3
"""Differential test for lut_lookup_0x53FAA (0x53FAA) — v3 lift (branches + delay slots), 32 bytes.
...
Run from repo root: python3 c/tests/test_lut_lookup_0x53FAA_53faa.py
"""
...
ENTRY = 0x53FAA
RAW = bytes.fromhex("60 0C 88 01 8F 08 00 09 92 74 61 20 21 18 8F 03 00 09 E3 01 A0 02 24 30 E1 00 24 10 00 0B 00 09")
SEED = 43
N = 2000
MAXSTEPS = 100000
...
CODE = {
    ...
    0x53fbe: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, r[4], 1, r[3])', "target": 0x53fc6, "cond": 'always'},
    0x53fc2: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x53fc4: {"kind": 'mem', "py": '_wrw(ram, r[4], 1, r[1])', "slot_py": None, "target": None, "cond": None},
