#!/usr/bin/env python3
"""Differential test for atu_read_capture_value (0x1DFA) — v3 lift (branches + delay slots), 28 bytes.
...
Run from repo root: python3 c/tests/test_atu_read_capture_value_1dfa.py
"""
...
ENTRY = 0x1DFA
RAW = bytes.fromhex("84 41 63 40 60 0C 40 18 63 3C 43 28 30 3C 63 03 84 42 60 0C 64 33 34 0C 00 0B 60 43")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = None
SPAN_END = 0x1E16
SENT = 0x1E16     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x1dfa: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, (r[4] + 1), 1))', "slot_py": None, "target": None, "cond": None},
    0x1dfc: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, r[4], 1))', "slot_py": None, "target": None, "cond": None},
    0x1dfe: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x1e00: {"kind": 'reg', "py": 'r[0] = (r[0] << 8) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x1e02: {"kind": 'reg', "py": 'r[3] = r[3] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x1e04: {"kind": 'reg', "py": 'r[3] = (r[3] << 16) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x1e06: {"kind": 'reg', "py": 'r[0] = (r[0] + r[3]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x1e08: {"kind": 'reg', "py": 'r[3] = r[0]', "slot_py": None, "target": None, "cond": None},
    0x1e0a: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, (r[4] + 2), 1))', "slot_py": None, "target": None, "cond": None},
    0x1e0c: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x1e0e: {"kind": 'reg', "py": 'r[4] = r[3]', "slot_py": None, "target": None, "cond": None},
    0x1e10: {"kind": 'reg', "py": 'r[4] = (r[4] + r[0]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x1e12: {"kind": "ret", "py": None, "slot_py": 'r[0] = r[4]', "target": None, "cond": None},}
