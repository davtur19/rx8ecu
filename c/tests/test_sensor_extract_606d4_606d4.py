#!/usr/bin/env python3
"""Differential test for sensor_extract_606d4 (0x606D4) — v3 lift (branches + delay slots), 22 bytes.
...
Run from repo root: python3 c/tests/test_sensor_extract_606d4_606d4.py
"""
...
CODE = {
    0x606d4: {"kind": 'reg', "py": 'r[3] = 0xFFFFBB09', "slot_py": None, "target": None, "cond": None},
    0x606d6: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFBB09, 1))', "slot_py": None, "target": None, "cond": None},
    0x606d8: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x606da: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x606dc: {"kind": "branch", "py": None, "slot_py": '', "target": 0x606e4, "cond": 'notT'},
    0x606e0: {"kind": "branch", "py": None, "slot_py": 'r[4] = s8(0x00)', "target": 0x606e6, "cond": 'always'},
    0x606e4: {"kind": 'reg', "py": 'r[4] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x606e6: {"kind": "ret", "py": None, "slot_py": 'r[0] = r[4]', "target": None, "cond": None},}
