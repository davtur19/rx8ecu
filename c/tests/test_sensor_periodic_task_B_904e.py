#!/usr/bin/env python3
"""Differential test for sensor_periodic_task_B (0x904E) — v3 lift (branches + delay slots), 34 bytes.
...
Run from repo root: python3 c/tests/test_sensor_periodic_task_B_904e.py
"""
...
ENTRY = 0x904E
RAW = bytes.fromhex("24 48 8F 0C 00 09 D4 34 E5 00 66 53 E7 04 60 53 76 01 80 44 63 6C 80 45 33 73 8F F8 74 08 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    0x904e: {"kind": 'reg', "py": 'T = 1 if (r[4] & r[4]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x9050: {"kind": "branch", "py": None, "slot_py": '', "target": 0x906c, "cond": 'notT'},
    0x9054: {"kind": 'reg', "py": 'r[4] = 0xFFFFA0D8', "slot_py": None, "target": None, "cond": None},
    0x9056: {"kind": 'reg', "py": 'r[5] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x9058: {"kind": 'reg', "py": 'r[6] = r[5]', "slot_py": None, "target": None, "cond": None},
    0x905a: {"kind": 'reg', "py": 'r[7] = s8(0x04)', "slot_py": None, "target": None, "cond": None},
    0x905c: {"kind": 'reg', "py": 'r[0] = r[5]', "slot_py": None, "target": None, "cond": None},
    0x905e: {"kind": 'reg', "py": 'r[6] = (r[6] + s8(0x01)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x9060: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA0DC, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x9062: {"kind": 'reg', "py": 'r[3] = r[6] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x9064: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA0DD, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x9066: {"kind": 'reg', "py": 'T = 1 if s32(r[3]) >= s32(r[7]) else 0', "slot_py": None, "target": None, "cond": None},
    0x9068: {"kind": "branch", "py": None, "slot_py": 'r[4] = (r[4] + s8(0x08)) & 0xFFFFFFFF', "target": 0x905c, "cond": 'notT'},
    0x906c: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
