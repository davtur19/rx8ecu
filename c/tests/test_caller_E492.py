#!/usr/bin/env python3
"""Differential test for caller_E492 (entry 0xE492) — v8 ST caller (CFG), 34 bytes.
...
Run: python3 test_caller_E492.py
"""
...
CODE = {
    0xe492: {"kind": 'st', "py": 'local[0x3FC] = pr\n_wrw(ram, STACK_BASE + 0x3FC, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xe494: {"kind": 'reg', "py": 'r[2] = 0xFFFFA428', "slot_py": None, "target": None, "cond": None},
    0xe496: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFA428, 1))', "slot_py": None, "target": None, "cond": None},
    0xe498: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0xe49a: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0xe49c: {"kind": "branch", "py": None, "slot_py": '', "target": 0xe4ae, "cond": 'notT'},
    0xe4a0: {"kind": 'reg', "py": 'r[1] = 0xFFFFA422', "slot_py": None, "target": None, "cond": None},
    0xe4a2: {"kind": 'reg', "py": 'r[5] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0xe4a4: {"kind": 'reg', "py": 'r[3] = 0x00002460', "slot_py": None, "target": None, "cond": None},
    0xe4a6: {"kind": "call", "py": None, "slot_py": 'r[4] = s16(_rdw(ram, 0xFFFFA422, 2))', "target": 0x2460, "ret_pc": 0xe4aa, "set_pr": True, "cond": None},
    0xe4aa: {"kind": 'reg', "py": 'r[2] = 0xFFFFA422', "slot_py": None, "target": None, "cond": None},
    0xe4ac: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA422, 2, r[0])', "slot_py": None, "target": None, "cond": None},
    0xe4ae: {"kind": 'st', "py": 'pr = _rdw(ram, STACK_BASE + 0x3FC, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xe4b0: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},
