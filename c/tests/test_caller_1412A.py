#!/usr/bin/env python3
"""Differential test for caller_1412A (entry 0x1412A) — v8 ST caller (CFG), 32 bytes.
...
Run: python3 test_caller_1412A.py
"""
...
CODE = {
    ...
    0x14134: {"kind": 'reg', "py": 'T = 1 if s32(r[3]) >= s32(r[1]) else 0', "slot_py": None, "target": None, "cond": None},
    0x14136: {"kind": "branch", "py": None, "slot_py": '', "target": 0x14144, "cond": 'T'},
