#!/usr/bin/env python3
"""Differential test for clear_status_bytes_a9c (0x18F3C) — v3 lift (branches + delay slots), 48 bytes.
...
Run from repo root: python3 c/tests/test_clear_status_bytes_a9c_18f3c.py
"""
...
ENTRY = 0x18F3C
RAW = bytes.fromhex("93 6B E4 00 92 6A 23 40 22 40 91 68 93 68 21 40 23 40 D2 35 D1 35 22 40 21 40 D3 35 D2 35 23 40 22 40 D1 35 D3 35 21 40 23 40 D2 35 00 0B 22 40")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFA9CC
SPAN_END = 0x18F6C
SENT = 0x18F6C     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x18f3c: {"kind": 'reg', "py": 'r[3] = 0xFFFFA9C1', "slot_py": None, "target": None, "cond": None},
    0x18f3e: {"kind": 'reg', "py": 'r[4] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x18f40: {"kind": 'reg', "py": 'r[2] = 0xFFFFA9C2', "slot_py": None, "target": None, "cond": None},
    0x18f42: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA9C1, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x18f44: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA9C2, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x18f46: {"kind": 'reg', "py": 'r[1] = 0xFFFFA9C3', "slot_py": None, "target": None, "cond": None},
    0x18f48: {"kind": 'reg', "py": 'r[3] = 0xFFFFA9C4', "slot_py": None, "target": None, "cond": None},
    0x18f4a: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA9C3, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x18f4c: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA9C4, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x18f4e: {"kind": 'reg', "py": 'r[2] = 0xFFFFA9CA', "slot_py": None, "target": None, "cond": None},
    0x18f50: {"kind": 'reg', "py": 'r[1] = 0xFFFFA9CB', "slot_py": None, "target": None, "cond": None},
    0x18f52: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA9CA, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x18f54: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA9CB, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x18f56: {"kind": 'reg', "py": 'r[3] = 0xFFFFA9CC', "slot_py": None, "target": None, "cond": None},
    0x18f58: {"kind": 'reg', "py": 'r[2] = 0xFFFFA9C8', "slot_py": None, "target": None, "cond": None},
    0x18f5a: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA9CC, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x18f5c: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA9C8, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x18f5e: {"kind": 'reg', "py": 'r[1] = 0xFFFFA9C7', "slot_py": None, "target": None, "cond": None},
    0x18f60: {"kind": 'reg', "py": 'r[3] = 0xFFFFA9C6', "slot_py": None, "target": None, "cond": None},
    0x18f62: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA9C7, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x18f64: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA9C6, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x18f66: {"kind": 'reg', "py": 'r[2] = 0xFFFFA9C9', "slot_py": None, "target": None, "cond": None},
    0x18f68: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFA9C9, 1, r[4])', "target": None, "cond": None},}
