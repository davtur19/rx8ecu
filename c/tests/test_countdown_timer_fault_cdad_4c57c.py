#!/usr/bin/env python3
"""Differential test for countdown_timer_fault_cdad (0x4C57C) — v3 lift + v4 FPU, 70 bytes.
...
Run from repo root: python3 c/tests/test_countdown_timer_fault_cdad_4c57c.py
"""
...
ENTRY = 0x4C57C
RAW = bytes.fromhex("93 58 60 30 60 0C 88 01 8F 1B 00 09 92 53 61 21 93 52 60 31 31 06 8F 14 00 09 95 4E 93 4E F3 38 92 4D F2 28 F2 35 8D 04 00 09 D1 29 60 10 A0 08 25 00 64 50 61 4C 41 15 8F 03 00 09 91 40 34 1C 25 40 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCDE4
SPAN_END = 0x4C5C2
SENT = 0x4C5C2     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x4c57c: {"kind": 'reg', "py": 'r[3] = 0xFFFFCDC4', "slot_py": None, "target": None, "cond": None},
    0x4c57e: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCDC4, 1))', "slot_py": None, "target": None, "cond": None},
    0x4c580: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x4c582: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x4c584: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4c5be, "cond": 'notT'},
    0x4c588: {"kind": 'reg', "py": 'r[2] = 0xFFFFCDA6', "slot_py": None, "target": None, "cond": None},
    0x4c58a: {"kind": 'mem', "py": 'r[1] = s16(_rdw(ram, 0xFFFFCDA6, 2))', "slot_py": None, "target": None, "cond": None},
    0x4c58c: {"kind": 'reg', "py": 'r[3] = 0xFFFFCDA4', "slot_py": None, "target": None, "cond": None},
    0x4c58e: {"kind": 'mem', "py": 'r[0] = s16(_rdw(ram, 0xFFFFCDA4, 2))', "slot_py": None, "target": None, "cond": None},
    0x4c590: {"kind": 'reg', "py": 'T = 1 if (r[1] & 0xFFFFFFFF) > (r[0] & 0xFFFFFFFF) else 0', "slot_py": None, "target": None, "cond": None},
    0x4c592: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4c5be, "cond": 'notT'},
    0x4c596: {"kind": 'reg', "py": 'r[5] = 0xFFFFCDAD', "slot_py": None, "target": None, "cond": None},
    0x4c598: {"kind": 'reg', "py": 'r[3] = 0xFFFFCDE4', "slot_py": None, "target": None, "cond": None},
    0x4c59a: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFCDE4, 4))', "slot_py": None, "target": None, "cond": None},
    0x4c59c: {"kind": 'reg', "py": 'r[2] = 0xFFFFCDE0', "slot_py": None, "target": None, "cond": None},
    0x4c59e: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0xFFFFCDE0, 4))', "slot_py": None, "target": None, "cond": None},
    0x4c5a0: {"kind": 'fpu', "py": 'T = 1 if fr[2] > fr[3] else 0', "slot_py": None, "target": None, "cond": None},
    0x4c5a2: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4c5ae, "cond": 'T'},
    0x4c5a6: {"kind": 'reg', "py": 'r[1] = 0x0007B813', "slot_py": None, "target": None, "cond": None},
    0x4c5a8: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0x0007B813, 1))', "slot_py": None, "target": None, "cond": None},
    0x4c5aa: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFCDAD, 1, r[0])', "target": 0x4c5be, "cond": 'always'},
    0x4c5ae: {"kind": 'mem', "py": 'r[4] = s8(_rdw(ram, r[5], 1))', "slot_py": None, "target": None, "cond": None},
    0x4c5b0: {"kind": 'reg', "py": 'r[1] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x4c5b2: {"kind": 'reg', "py": 'T = 1 if s32(r[1]) > 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x4c5b4: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4c5be, "cond": 'notT'},
    0x4c5b8: {"kind": 'reg', "py": 'r[1] = 0x000000FF', "slot_py": None, "target": None, "cond": None},
    0x4c5ba: {"kind": 'reg', "py": 'r[4] = (r[4] + r[1]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x4c5bc: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCDAD, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x4c5be: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
