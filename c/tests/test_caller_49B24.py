#!/usr/bin/env python3
"""Differential test for caller_49B24 (entry 0x49B24) — v8 ST caller (CFG), 54 bytes.
...
Run: python3 test_caller_49B24.py
"""
...
CODE = {
    0x49b24: {"kind": 'mem', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, r[14])\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x49b26: {"kind": 'st', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x49b28: {"kind": 'reg', "py": 'r[14] = 0xFFFFCC8E', "slot_py": None, "target": None, "cond": None},
    0x49b2a: {"kind": 'mem', "py": 'r[4] = s16(_rdw(ram, 0xFFFFCC8E, 2))', "slot_py": None, "target": None, "cond": None},
    0x49b2c: {"kind": 'reg', "py": 'r[1] = 0x0007C2BE', "slot_py": None, "target": None, "cond": None},
    0x49b2e: {"kind": 'reg', "py": 'r[3] = r[4] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x49b30: {"kind": 'mem', "py": 'r[2] = s16(_rdw(ram, 0x0007C2BE, 2))', "slot_py": None, "target": None, "cond": None},
    0x49b32: {"kind": 'reg', "py": 'r[2] = r[2] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x49b34: {"kind": 'reg', "py": 'T = 1 if r[3] == r[2] else 0', "slot_py": None, "target": None, "cond": None},
    0x49b36: {"kind": "branch", "py": None, "slot_py": '', "target": 0x49b46, "cond": 'T'},
    0x49b3a: {"kind": 'reg', "py": 'r[3] = 0xFFFFCFD9', "slot_py": None, "target": None, "cond": None},
    0x49b3c: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCFD9, 1))', "slot_py": None, "target": None, "cond": None},
    0x49b3e: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x49b40: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x49b42: {"kind": "branch", "py": None, "slot_py": '', "target": 0x49b4c, "cond": 'notT'},
    0x49b46: {"kind": 'reg', "py": 'r[3] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x49b48: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFCC8E, 2, r[3])', "target": 0x49b54, "cond": 'always'},
    0x49b4c: {"kind": 'reg', "py": 'r[3] = 0x00002460', "slot_py": None, "target": None, "cond": None},
    0x49b4e: {"kind": "call", "py": None, "slot_py": 'r[5] = s8(0x01)', "target": 0x2460, "ret_pc": 0x49b52, "set_pr": True, "cond": None},
    0x49b52: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCC8E, 2, r[0])', "slot_py": None, "target": None, "cond": None},
    0x49b54: {"kind": 'st', "py": 'pr = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x49b56: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},
