#!/usr/bin/env python3
"""Differential test for can216ResetTimer (0x29E50) — v3 lift (branches + delay slots), 10 bytes.
...
Run from repo root: python3 c/tests/test_can216ResetTimer_29e50.py
"""
...
CODE = {
    0x29e50: {"kind": 'reg', "py": 'r[2] = 0x0006CF85', "slot_py": None, "target": None, "cond": None},
    0x29e52: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0x0006CF85, 1))', "slot_py": None, "target": None, "cond": None},
    0x29e54: {"kind": 'reg', "py": 'r[0] = 0xFFFFBB28', "slot_py": None, "target": None, "cond": None},
    0x29e56: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBB28, 1, r[3])', "target": None, "cond": None},}
