#!/usr/bin/env python3
"""Differential test for counterFunction (0x25B36) — v3 lift (branches + delay slots), 10 bytes.
...
Run from repo root: python3 c/tests/test_counterFunction_25b36.py
"""
...
ENTRY = 0x25B36
RAW = bytes.fromhex("D4 37 63 40 73 01 00 0B 24 30")
SEED = 0
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFB5CE
SPAN_END = 0x25B40
SENT = 0x25B40     # stop-sentinel, placed past the literal pool
