#!/usr/bin/env python3
"""Differential test for fuel_fluid_59ba0 (0x59BA0) — v3 lift (branches + delay slots), 22 bytes.
...
Run from repo root: python3 c/tests/test_fuel_fluid_59ba0_59ba0.py
"""
...
ENTRY = 0x59BA0
RAW = bytes.fromhex("95 0B 64 51 63 4D 43 15 8F 03 00 09 D3 06 34 3C 25 41 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    0x59ba0: {"kind": 'reg', "py": 'r[5] = 0xFFFFD27C', "slot_py": None, "target": None, "cond": None},
    0x59ba2: {"kind": 'mem', "py": 'r[4] = s16(_rdw(ram, 0xFFFFD27C, 2))', "slot_py": None, "target": None, "cond": None},
    0x59ba4: {"kind": 'reg', "py": 'r[3] = r[4] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x59ba6: {"kind": 'reg', "py": 'T = 1 if s32(r[3]) > 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x59ba8: {"kind": "branch", "py": None, "slot_py": '', "target": 0x59bb2, "cond": 'notT'},
    0x59bac: {"kind": 'reg', "py": 'r[3] = 0x0000FFFF', "slot_py": None, "target": None, "cond": None},
    0x59bae: {"kind": 'reg', "py": 'r[4] = (r[4] + r[3]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x59bb0: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD27C, 2, r[4])', "slot_py": None, "target": None, "cond": None},
    0x59bb2: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
