#!/usr/bin/env python3
"""Differential test for resetFuelCutCondition7 (0x4B512) — v3 lift (branches + delay slots), 48 bytes.
...
Run from repo root: python3 c/tests/test_resetFuelCutCondition7_4b512.py
"""
...
CODE = {
    0x4b512: {"kind": 'reg', "py": 'r[4] = 0xFFFFCDFE', "slot_py": None, "target": None, "cond": None},
    0x4b514: {"kind": 'reg', "py": 'r[2] = 0xFFFFD201', "slot_py": None, "target": None, "cond": None},
    0x4b516: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFD201, 1))', "slot_py": None, "target": None, "cond": None},
    0x4b518: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x4b51a: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4b53a, "cond": 'notT'},
    0x4b51e: {"kind": 'reg', "py": 'r[1] = 0xFFFF9FA2', "slot_py": None, "target": None, "cond": None},
    0x4b520: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFF9FA2, 1))', "slot_py": None, "target": None, "cond": None},
    0x4b522: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x4b524: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x02) else 0', "slot_py": None, "target": None, "cond": None},
    0x4b526: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4b53e, "cond": 'notT'},
    0x4b52a: {"kind": 'reg', "py": 'r[3] = 0x0007DAD4', "slot_py": None, "target": None, "cond": None},
    0x4b52c: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0x0007DAD4, 1))', "slot_py": None, "target": None, "cond": None},
    0x4b52e: {"kind": 'reg', "py": 'T = 1 if (r[0] & r[0]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x4b530: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4b53e, "cond": 'notT'},
    0x4b534: {"kind": 'reg', "py": 'r[1] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x4b536: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFCDFE, 1, r[1])', "target": 0x4b53e, "cond": 'always'},
    0x4b53a: {"kind": 'reg', "py": 'r[0] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x4b53c: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCDFE, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x4b53e: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
