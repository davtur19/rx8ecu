#!/usr/bin/env python3
"""Differential test for eshaft_angle_byte_add_wrap (0x107C8) — v3 lift (branches + delay slots), 44 bytes.
...
Run from repo root: python3 c/tests/test_eshaft_angle_byte_add_wrap_107c8.py
"""
...
ENTRY = 0x107C8
RAW = bytes.fromhex("D1 6E 62 10 D3 6E 62 2C D5 6F 02 37 02 1A 32 48 D4 6C 34 2C 34 53 8F 03 00 09 D0 6C A0 04 34 0C 44 11 8D 01 00 09 34 5C 00 0B 60 43")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFA5D4
SPAN_END = 0x107F4
SENT = 0x107F4     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x107c8: {"kind": 'reg', "py": 'r[1] = 0xFFFFA5D4', "slot_py": None, "target": None, "cond": None},
    0x107ca: {"kind": 'mem', "py": 'r[2] = s8(_rdw(ram, 0xFFFFA5D4, 1))', "slot_py": None, "target": None, "cond": None},
    0x107cc: {"kind": 'reg', "py": 'r[3] = 0x001E0000', "slot_py": None, "target": None, "cond": None},
    0x107ce: {"kind": 'reg', "py": 'r[2] = r[2] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x107d0: {"kind": 'reg', "py": 'r[5] = 0x02D00000', "slot_py": None, "target": None, "cond": None},
    0x107d2: {"kind": 'reg', "py": 'macl = (s32(r[2]) * s32(r[3])) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x107d4: {"kind": 'reg', "py": 'r[2] = macl', "slot_py": None, "target": None, "cond": None},
    0x107d6: {"kind": 'reg', "py": 'r[2] = (r[2] - r[4]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x107d8: {"kind": 'reg', "py": 'r[4] = 0xFFFB0000', "slot_py": None, "target": None, "cond": None},
    0x107da: {"kind": 'reg', "py": 'r[4] = (r[4] + r[2]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x107dc: {"kind": 'reg', "py": 'T = 1 if s32(r[4]) >= s32(r[5]) else 0', "slot_py": None, "target": None, "cond": None},
    0x107de: {"kind": "branch", "py": None, "slot_py": '', "target": 0x107e8, "cond": 'notT'},
    0x107e2: {"kind": 'reg', "py": 'r[0] = 0xFD300000', "slot_py": None, "target": None, "cond": None},
    0x107e4: {"kind": "branch", "py": None, "slot_py": 'r[4] = (r[4] + r[0]) & 0xFFFFFFFF', "target": 0x107f0, "cond": 'always'},
    0x107e8: {"kind": 'reg', "py": 'T = 1 if s32(r[4]) >= 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x107ea: {"kind": "branch", "py": None, "slot_py": '', "target": 0x107f0, "cond": 'T'},
    0x107ee: {"kind": 'reg', "py": 'r[4] = (r[4] + r[5]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x107f0: {"kind": "ret", "py": None, "slot_py": 'r[0] = r[4]', "target": None, "cond": None},}
