#!/usr/bin/env python3
"""Differential test for can240TX_pack (0x4C888) — v3 lift (branches + delay slots), 72 bytes.
...
Run from repo root: python3 c/tests/test_can240TX_pack_4c888.py
"""
...
ENTRY = 0x4C888
RAW = bytes.fromhex("88 01 8F 18 6E ED 92 64 91 64 60 21 63 11 30 32 8F 11 00 09 90 5F 60 00 C8 80 00 29 70 FF 60 0B 88 01 8F 05 00 09 4E 15 8D 03 26 70 A0 09 24 50 26 50 A0 06 24 70 4E 15 8F 02 26 50 A0 01 24 70 24 50 7F 04 00 0B 6E F6")
SEED = 42
N = 500
MAXSTEPS = 100000
