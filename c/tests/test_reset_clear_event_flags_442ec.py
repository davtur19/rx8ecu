#!/usr/bin/env python3
"""Differential test for reset_clear_event_flags (0x442EC) — v3 lift (branches + delay slots), 50 bytes.
...
Run from repo root: python3 c/tests/test_reset_clear_event_flags_442ec.py
"""
...
ENTRY = 0x442EC
RAW = bytes.fromhex("93 88 60 30 60 0C 88 01 8F 11 00 09 92 83 60 20 60 0C 88 01 8F 0B 00 09 93 7E E4 00 92 7D 23 40 22 40 91 7B 93 7B 21 40 23 40 92 79 22 40 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCFD9
SPAN_END = 0x4431E
SENT = 0x4431E     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x442ec: {"kind": 'reg', "py": 'r[3] = 0xFFFFCFD9', "slot_py": None, "target": None, "cond": None},
    0x442ee: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCFD9, 1))', "slot_py": None, "target": None, "cond": None},
    0x442f0: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x442f2: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x442f4: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4431a, "cond": 'notT'},
    0x442f8: {"kind": 'reg', "py": 'r[2] = 0xFFFFA41C', "slot_py": None, "target": None, "cond": None},
    0x442fa: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFA41C, 1))', "slot_py": None, "target": None, "cond": None},
    0x442fc: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x442fe: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x44300: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4431a, "cond": 'notT'},
    0x44304: {"kind": 'reg', "py": 'r[3] = 0xFFFFCA99', "slot_py": None, "target": None, "cond": None},
    0x44306: {"kind": 'reg', "py": 'r[4] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x44308: {"kind": 'reg', "py": 'r[2] = 0xFFFFCA9A', "slot_py": None, "target": None, "cond": None},
    0x4430a: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCA99, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x4430c: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCA9A, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x4430e: {"kind": 'reg', "py": 'r[1] = 0xFFFFCA98', "slot_py": None, "target": None, "cond": None},
    0x44310: {"kind": 'reg', "py": 'r[3] = 0xFFFFCA9B', "slot_py": None, "target": None, "cond": None},
    0x44312: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCA98, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x44314: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCA9B, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x44316: {"kind": 'reg', "py": 'r[2] = 0xFFFFCA9C', "slot_py": None, "target": None, "cond": None},
    0x44318: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCA9C, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x4431a: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
