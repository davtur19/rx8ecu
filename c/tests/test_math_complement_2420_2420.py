#!/usr/bin/env python3
"""Differential test for math_complement_2420 (0x2420) — pure straight-line lift, 12 bytes.
...
Run from repo root: python3 c/tests/test_math_complement_2420_2420.py
"""
...
ENTRY = 0x2420
RAW = bytes.fromhex("63 4C 43 18 62 47 62 2C 64 33 34 2C")
SEED = 42
N = 2000
