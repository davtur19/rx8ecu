#!/usr/bin/env python3
"""Differential test for crank_gated_fuel_pressure_proc (0xE6DC) — v3 lift + v4 FPU, 20 bytes.
...
Run from repo root: python3 c/tests/test_crank_gated_fuel_pressure_proc_e6dc.py
"""
...
ENTRY = 0xE6DC
RAW = bytes.fromhex("D3 20 60 30 60 0C 88 01 8D 02 00 09 00 0B 00 09 C7 1D F3 08")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFF9F8C
SPAN_END = 0xE6F0
SENT = 0xE6F0     # stop-sentinel, placed past the literal pool
...
CODE = {
    0xe6dc: {"kind": 'reg', "py": 'r[3] = 0xFFFF9F8C', "slot_py": None, "target": None, "cond": None},
    0xe6de: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFF9F8C, 1))', "slot_py": None, "target": None, "cond": None},
    0xe6e0: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0xe6e2: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0xe6e4: {"kind": "branch", "py": None, "slot_py": '', "target": 0xe6ec, "cond": 'T'},
    0xe6e8: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},
