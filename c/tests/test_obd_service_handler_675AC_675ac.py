#!/usr/bin/env python3
"""Differential test for obd_service_handler_675AC (0x675AC) — v3 lift (branches + delay slots), 30 bytes.
...
Run from repo root: python3 c/tests/test_obd_service_handler_675AC_675ac.py
"""
...
RAM_MAX = None
SPAN_END = 0x675CA
SENT = 0x675CA     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x675ac: {"kind": 'reg', "py": 'r[0] = 0x0007DAEA', "slot_py": None, "target": None, "cond": None},
    0x675ae: {"kind": 'reg', "py": 'r[4] = r[4] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x675b0: {"kind": 'reg', "py": 'T = (r[4] >> 31) & 1\nr[4] = (r[4] << 1) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x675b2: {"kind": 'mem', "py": 'r[4] = s16(_rdw(ram, (r[4] + r[0]), 2))', "slot_py": None, "target": None, "cond": None},
    0x675b4: {"kind": 'reg', "py": 'r[0] = 0xFFFF8D7C', "slot_py": None, "target": None, "cond": None},
    0x675b6: {"kind": 'reg', "py": 'r[4] = r[4] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x675b8: {"kind": 'reg', "py": 'T = (r[4] >> 31) & 1\nr[4] = (r[4] << 1) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x675ba: {"kind": 'mem', "py": 'r[4] = s8(_rdw(ram, (r[4] + r[0]), 1))', "slot_py": None, "target": None, "cond": None},
    0x675bc: {"kind": 'reg', "py": 'r[4] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x675be: {"kind": 'reg', "py": 'T = 1 if (r[4] & r[4]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x675c0: {"kind": "branch", "py": None, "slot_py": 'r[5] = s8(0x00)', "target": 0x675c6, "cond": 'T'},
    0x675c4: {"kind": 'reg', "py": 'r[5] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x675c6: {"kind": "ret", "py": None, "slot_py": 'r[0] = r[5]', "target": None, "cond": None},}
