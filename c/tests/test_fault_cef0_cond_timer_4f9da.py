#!/usr/bin/env python3
"""Differential test for fault_cef0_cond_timer (0x4F9DA) — v3 lift (branches + delay slots), 40 bytes.
...
Run from repo root: python3 c/tests/test_fault_cef0_cond_timer_4f9da.py
"""
...
ENTRY = 0x4F9DA
RAW = bytes.fromhex("95 33 92 33 63 20 23 38 8F 04 00 09 D1 1D 60 10 A0 08 25 00 64 50 61 4C 41 15 8F 03 00 09 91 26 34 1C 25 40 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCEF1
SPAN_END = 0x4FA02
SENT = 0x4FA02     # stop-sentinel, placed past the literal pool
