#!/usr/bin/env python3
"""Differential test for fuel_phase_diff_wrap_scaled (0xFA12) — v3 lift (branches + delay slots), 44 bytes.
...
Run from repo root: python3 c/tests/test_fuel_phase_diff_wrap_scaled_fa12.py
"""
...
ENTRY = 0xFA12
RAW = bytes.fromhex("D0 26 D2 26 63 00 D5 27 63 3C 03 27 03 1A 33 48 D4 24 34 3C 34 53 8F 03 00 09 D1 23 A0 04 34 1C 44 11 8D 01 00 09 34 5C 00 0B 60 43")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFA570
SPAN_END = 0xFA3E
SENT = 0xFA3E     # stop-sentinel, placed past the literal pool
...
CODE = {
    0xfa12: {"kind": 'reg', "py": 'r[0] = 0xFFFFA570', "slot_py": None, "target": None, "cond": None},
    0xfa14: {"kind": 'reg', "py": 'r[2] = 0x001E0000', "slot_py": None, "target": None, "cond": None},
    0xfa16: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFA570, 1))', "slot_py": None, "target": None, "cond": None},
    0xfa18: {"kind": 'reg', "py": 'r[5] = 0x02D00000', "slot_py": None, "target": None, "cond": None},
    0xfa1a: {"kind": 'reg', "py": 'r[3] = r[3] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0xfa1c: {"kind": 'reg', "py": 'macl = (s32(r[3]) * s32(r[2])) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xfa1e: {"kind": 'reg', "py": 'r[3] = macl', "slot_py": None, "target": None, "cond": None},
    0xfa20: {"kind": 'reg', "py": 'r[3] = (r[3] - r[4]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xfa22: {"kind": 'reg', "py": 'r[4] = 0xFFFB0000', "slot_py": None, "target": None, "cond": None},
    0xfa24: {"kind": 'reg', "py": 'r[4] = (r[4] + r[3]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xfa26: {"kind": 'reg', "py": 'T = 1 if s32(r[4]) >= s32(r[5]) else 0', "slot_py": None, "target": None, "cond": None},
    0xfa28: {"kind": "branch", "py": None, "slot_py": '', "target": 0xfa32, "cond": 'notT'},
    0xfa2c: {"kind": 'reg', "py": 'r[1] = 0xFD300000', "slot_py": None, "target": None, "cond": None},
    0xfa2e: {"kind": "branch", "py": None, "slot_py": 'r[4] = (r[4] + r[1]) & 0xFFFFFFFF', "target": 0xfa3a, "cond": 'always'},
    0xfa32: {"kind": 'reg', "py": 'T = 1 if s32(r[4]) >= 0 else 0', "slot_py": None, "target": None, "cond": None},
    0xfa34: {"kind": "branch", "py": None, "slot_py": '', "target": 0xfa3a, "cond": 'T'},
    0xfa38: {"kind": 'reg', "py": 'r[4] = (r[4] + r[5]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xfa3a: {"kind": "ret", "py": None, "slot_py": 'r[0] = r[4]', "target": None, "cond": None},}
