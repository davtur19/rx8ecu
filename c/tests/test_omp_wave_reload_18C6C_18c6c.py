#!/usr/bin/env python3
"""Differential test for omp_wave_reload_18C6C (0x18C6C) — v3 lift + v4 FPU, 64 bytes.
...
Run from repo root: python3 c/tests/test_omp_wave_reload_18C6C_18c6c.py
"""
...
ENTRY = 0x18C6C
RAW = bytes.fromhex("8D 10 00 09 92 47 63 21 23 38 8F 0F 00 09 D1 27 60 11 60 0D 40 15 8F 09 00 09 93 3B 60 31 20 08 8F 04 00 09 D2 22 61 21 A0 08 25 11 64 51 62 4D 42 15 8F 03 00 09 D2 1F 34 2C 25 41 00 0B F6 4A")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
CODE = {
    ...
    0x18c94: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, r[5], 2, r[1])', "target": 0x18ca8, "cond": 'always'},
    ...
    0x18ca6: {"kind": 'mem', "py": '_wrw(ram, r[5], 2, r[4])', "slot_py": None, "target": None, "cond": None},
