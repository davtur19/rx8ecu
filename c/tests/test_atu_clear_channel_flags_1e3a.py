#!/usr/bin/env python3
"""Differential test for atu_clear_channel_flags (0x1E3A) — v3 lift (branches + delay slots), 30 bytes.
...
Run from repo root: python3 c/tests/test_atu_clear_channel_flags_1e3a.py
"""
...
ENTRY = 0x1E3A
RAW = bytes.fromhex("E6 08 60 40 C9 FE 24 00 94 8C 63 50 63 3C 23 68 89 03 74 FF E3 00 34 36 89 F7 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    0x1e3a: {"kind": 'reg', "py": 'r[6] = s8(0x08)', "slot_py": None, "target": None, "cond": None},
    0x1e3c: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, r[4], 1))', "slot_py": None, "target": None, "cond": None},
    0x1e3e: {"kind": 'reg', "py": 'r[0] = (r[0] & 0xFE) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x1e40: {"kind": 'mem', "py": '_wrw(ram, r[4], 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x1e42: {"kind": 'reg', "py": 'r[4] = 0x00000FA0', "slot_py": None, "target": None, "cond": None},
    0x1e44: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, r[5], 1))', "slot_py": None, "target": None, "cond": None},
    0x1e46: {"kind": 'reg', "py": 'r[3] = r[3] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x1e48: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[6]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x1e4a: {"kind": "branch", "py": None, "slot_py": None, "target": 0x1e54, "cond": 'T'},
    0x1e4c: {"kind": 'reg', "py": 'r[4] = (r[4] + s8(0xFF)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x1e4e: {"kind": 'reg', "py": 'r[3] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x1e50: {"kind": 'reg', "py": 'T = 1 if r[4] > r[3] else 0', "slot_py": None, "target": None, "cond": None},
    0x1e52: {"kind": "branch", "py": None, "slot_py": None, "target": 0x1e44, "cond": 'T'},
    0x1e54: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
