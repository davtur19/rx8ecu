#!/usr/bin/env python3
"""Differential test for getCoolantTempConditional (0x5E5C8) — v3 lift + v4 FPU, 40 bytes.
...
Run from repo root: python3 c/tests/test_getCoolantTempConditional_5e5c8.py
"""
...
ENTRY = 0x5E5C8
RAW = bytes.fromhex("D4 1B 93 23 C7 1B F4 38 F3 08 F3 45 8D 03 00 09 E1 01 A0 07 24 10 C7 18 F2 08 F2 45 8F 02 00 09 E1 00 24 10 00 0B 00 09")
SEED = 43
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFD1D0
SPAN_END = 0x5E5F0
SENT = 0x5E5F0     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x5e5c8: {"kind": 'reg', "py": 'r[4] = 0xFFFFD1D0', "slot_py": None, "target": None, "cond": None},
    0x5e5ca: {"kind": 'reg', "py": 'r[3] = 0xFFFFA9FC', "slot_py": None, "target": None, "cond": None},
    0x5e5cc: {"kind": 'reg', "py": 'r[0] = 0x0005E63C', "slot_py": None, "target": None, "cond": None},
    0x5e5ce: {"kind": 'fpu', "py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFA9FC, 4))', "slot_py": None, "target": None, "cond": None},
    0x5e5d0: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x0005E63C, 4))', "slot_py": None, "target": None, "cond": None},
    0x5e5d2: {"kind": 'fpu', "py": 'T = 1 if fr[3] > fr[4] else 0', "slot_py": None, "target": None, "cond": None},
    0x5e5d4: {"kind": "branch", "py": None, "slot_py": '', "target": 0x5e5de, "cond": 'T'},
    0x5e5d8: {"kind": 'reg', "py": 'r[1] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x5e5da: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFD1D0, 1, r[1])', "target": 0x5e5ec, "cond": 'always'},
    0x5e5de: {"kind": 'reg', "py": 'r[0] = 0x0005E640', "slot_py": None, "target": None, "cond": None},
    0x5e5e0: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0x0005E640, 4))', "slot_py": None, "target": None, "cond": None},
    0x5e5e2: {"kind": 'fpu', "py": 'T = 1 if fr[2] > fr[4] else 0', "slot_py": None, "target": None, "cond": None},
    0x5e5e4: {"kind": "branch", "py": None, "slot_py": '', "target": 0x5e5ec, "cond": 'notT'},
    0x5e5e8: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x5e5ea: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD1D0, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x5e5ec: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
