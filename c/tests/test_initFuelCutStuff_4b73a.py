#!/usr/bin/env python3
"""Differential test for initFuelCutStuff (0x4B73A) — v3 lift (branches + delay slots), 54 bytes.
...
Run from repo root: python3 c/tests/test_initFuelCutStuff_4b73a.py
"""
...
CODE = {
    0x4b73a: {"kind": 'reg', "py": 'r[4] = 0xFFFFCDFC', "slot_py": None, "target": None, "cond": None},
    0x4b73c: {"kind": 'reg', "py": 'r[3] = 0xFFFFD201', "slot_py": None, "target": None, "cond": None},
    0x4b73e: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFD201, 1))', "slot_py": None, "target": None, "cond": None},
    0x4b740: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x4b742: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x4b744: {"kind": "branch", "py": None, "slot_py": 'r[5] = s8(0x00)', "target": 0x4b74c, "cond": 'notT'},
    0x4b748: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFCDFC, 1, r[5])', "target": 0x4b76c, "cond": 'always'},
    0x4b74c: {"kind": 'reg', "py": 'r[2] = 0xFFFFCE00', "slot_py": None, "target": None, "cond": None},
    0x4b74e: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCE00, 1))', "slot_py": None, "target": None, "cond": None},
    0x4b750: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x4b752: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x4b754: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4b764, "cond": 'T'},
    0x4b758: {"kind": 'reg', "py": 'r[1] = 0xFFFFCE01', "slot_py": None, "target": None, "cond": None},
    0x4b75a: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCE01, 1))', "slot_py": None, "target": None, "cond": None},
    0x4b75c: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x4b75e: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x4b760: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4b76a, "cond": 'notT'},
    0x4b764: {"kind": 'reg', "py": 'r[2] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x4b766: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFCDFC, 1, r[2])', "target": 0x4b76c, "cond": 'always'},
    0x4b76a: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCDFC, 1, r[5])', "slot_py": None, "target": None, "cond": None},
    0x4b76c: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
