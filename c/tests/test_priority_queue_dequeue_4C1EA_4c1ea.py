#!/usr/bin/env python3
"""Differential test for priority_queue_dequeue_4C1EA (0x4C1EA) — v3 lift (branches + delay slots), 10 bytes.
...
Run from repo root: python3 c/tests/test_priority_queue_dequeue_4C1EA_4c1ea.py
"""
...
ENTRY = 0x4C1EA
RAW = bytes.fromhex("D2 16 D1 16 63 21 00 0B 21 31")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    0x4c1ea: {"kind": 'reg', "py": 'r[2] = 0x0007CBCE', "slot_py": None, "target": None, "cond": None},
    0x4c1ec: {"kind": 'reg', "py": 'r[1] = 0xFFFFCE80', "slot_py": None, "target": None, "cond": None},
    0x4c1ee: {"kind": 'mem', "py": 'r[3] = s16(_rdw(ram, 0x0007CBCE, 2))', "slot_py": None, "target": None, "cond": None},
    0x4c1f0: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFCE80, 2, r[3])', "target": None, "cond": None},}
