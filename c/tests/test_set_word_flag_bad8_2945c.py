#!/usr/bin/env python3
"""Differential test for set_word_flag_bad8 (0x2945C) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_set_word_flag_bad8_2945c.py
"""
...
ENTRY = 0x2945C
RAW = bytes.fromhex("92 6B E3 01 00 0B 22 30")
SEED = 43
N = 2000
MAXSTEPS = 100000
