#!/usr/bin/env python3
"""Differential test for rotor_sync_idle_gate_cells_reset (0x127D6) — v3 lift + v4 FPU, 18 bytes.
...
Run from repo root: python3 c/tests/test_rotor_sync_idle_gate_cells_reset_127d6.py
"""
...
ENTRY = 0x127D6
RAW = bytes.fromhex("F3 8D D0 3D E4 00 D3 3D F0 3A 23 40 D2 3D 00 0B 22 40")
SEED = 43
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFA694
SPAN_END = 0x127E8
SENT = 0x127E8     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x127d6: {"kind": 'fpu', "py": 'fr[3] = 0.0', "slot_py": None, "target": None, "cond": None},
    0x127d8: {"kind": 'reg', "py": 'r[0] = 0xFFFFA684', "slot_py": None, "target": None, "cond": None},
    0x127da: {"kind": 'reg', "py": 'r[4] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x127dc: {"kind": 'reg', "py": 'r[3] = 0xFFFFA693', "slot_py": None, "target": None, "cond": None},
    0x127de: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFA684, 4, f2bits(fr[3]))', "slot_py": None, "target": None, "cond": None},
    0x127e0: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA693, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x127e2: {"kind": 'reg', "py": 'r[2] = 0xFFFFA694', "slot_py": None, "target": None, "cond": None},
    0x127e4: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFA694, 1, r[4])', "target": None, "cond": None},}
