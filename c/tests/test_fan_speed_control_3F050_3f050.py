#!/usr/bin/env python3
"""Differential test for fan_speed_control_3F050 (0x3F050) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_fan_speed_control_3F050_3f050.py
"""
...
ENTRY = 0x3F050
RAW = bytes.fromhex("92 8C E3 01 00 0B 22 30")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    0x3f050: {"kind": 'reg', "py": 'r[2] = 0xFFFFC6AC', "slot_py": None, "target": None, "cond": None},
    0x3f052: {"kind": 'reg', "py": 'r[3] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x3f054: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFC6AC, 1, r[3])', "target": None, "cond": None},}
