#!/usr/bin/env python3
"""Differential test for fuel_injector_timing_45CD2 (0x45CD2) — v3 lift + v4 FPU, 48 bytes.
...
Run from repo root: python3 c/tests/test_fuel_injector_timing_45CD2_45cd2.py
"""
...
ENTRY = 0x45CD2
RAW = bytes.fromhex("91 76 92 76 63 11 63 3D 33 20 8F 0F 00 09 D4 3B D3 3C 92 6F F3 38 F2 28 F3 25 8D 04 00 09 91 6A 60 11 A0 03 24 01 D1 37 62 11 24 21 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCFCC
SPAN_END = 0x45D02
SENT = 0x45D02     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x45cd2: {"kind": 'reg', "py": 'r[1] = 0xFFFFBB04', "slot_py": None, "target": None, "cond": None},
    0x45cd4: {"kind": 'reg', "py": 'r[2] = 0x00000190', "slot_py": None, "target": None, "cond": None},
    0x45cd6: {"kind": 'mem', "py": 'r[3] = s16(_rdw(ram, 0xFFFFBB04, 2))', "slot_py": None, "target": None, "cond": None},
    0x45cd8: {"kind": 'reg', "py": 'r[3] = r[3] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x45cda: {"kind": 'reg', "py": 'T = 1 if r[3] == r[2] else 0', "slot_py": None, "target": None, "cond": None},
    0x45cdc: {"kind": "branch", "py": None, "slot_py": '', "target": 0x45cfe, "cond": 'notT'},
    0x45ce0: {"kind": 'reg', "py": 'r[4] = 0xFFFFCC0E', "slot_py": None, "target": None, "cond": None},
    0x45ce2: {"kind": 'reg', "py": 'r[3] = 0x0007C248', "slot_py": None, "target": None, "cond": None},
    0x45ce4: {"kind": 'reg', "py": 'r[2] = 0xFFFFCFCC', "slot_py": None, "target": None, "cond": None},
    0x45ce6: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x0007C248, 4))', "slot_py": None, "target": None, "cond": None},
    0x45ce8: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0xFFFFCFCC, 4))', "slot_py": None, "target": None, "cond": None},
    0x45cea: {"kind": 'fpu', "py": 'T = 1 if fr[3] > fr[2] else 0', "slot_py": None, "target": None, "cond": None},
    0x45cec: {"kind": "branch", "py": None, "slot_py": '', "target": 0x45cf8, "cond": 'T'},
    0x45cf0: {"kind": 'reg', "py": 'r[1] = 0xFFFFCBF0', "slot_py": None, "target": None, "cond": None},
    0x45cf2: {"kind": 'mem', "py": 'r[0] = s16(_rdw(ram, 0xFFFFCBF0, 2))', "slot_py": None, "target": None, "cond": None},
    0x45cf4: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFCC0E, 2, r[0])', "target": 0x45cfe, "cond": 'always'},
    0x45cf8: {"kind": 'reg', "py": 'r[1] = 0x0007C244', "slot_py": None, "target": None, "cond": None},
    0x45cfa: {"kind": 'mem', "py": 'r[2] = s16(_rdw(ram, 0x0007C244, 2))', "slot_py": None, "target": None, "cond": None},
    0x45cfc: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCC0E, 2, r[2])', "slot_py": None, "target": None, "cond": None},
    0x45cfe: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
