#!/usr/bin/env python3
"""Differential test for FUN_000552c4 (0x552C4) — v3 lift + v4 FPU, 58 bytes.
...
Run from repo root: python3 c/tests/test_FUN_000552c4_552c4.py
"""
...
ENTRY = 0x552C4
RAW = bytes.fromhex("F6 31 F2 8D F2 65 8F 03 00 09 C7 4E A0 02 F4 08 C7 4D F4 08 F6 53 F6 6C F3 6C F3 40 95 8F F3 3D 04 5A 34 57 8F 02 00 09 A0 05 64 53 95 88 34 53 8D 01 00 09 64 53 00 0B 60 43")
SEED = 42
N = 500
MAXSTEPS = 100000
