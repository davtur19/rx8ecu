#!/usr/bin/env python3
"""Differential test for caller_56156 (entry 0x56156) — v8 ST caller (CFG), 24 bytes.
...
Run: python3 test_caller_56156.py
"""
...
CODE = {
    0x56156: {"kind": 'st', "py": 'local[0x3FC] = pr\n_wrw(ram, STACK_BASE + 0x3FC, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x56158: {"kind": 'reg', "py": 'r[3] = 0xFFFFC6B4', "slot_py": None, "target": None, "cond": None},
    0x5615a: {"kind": 'fpu', "py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFC6B4, 4))', "slot_py": None, "target": None, "cond": None},
    0x5615c: {"kind": 'reg', "py": 'r[0] = 0x00056254', "slot_py": None, "target": None, "cond": None},
    0x5615e: {"kind": 'fpu', "py": 'fr[6] = bits2f(_rdw(ram, 0x00056254, 4))', "slot_py": None, "target": None, "cond": None},
    0x56160: {"kind": 'reg', "py": 'r[0] = 0x00056258', "slot_py": None, "target": None, "cond": None},
    0x56162: {"kind": 'reg', "py": 'r[2] = 0x00002490', "slot_py": None, "target": None, "cond": None},
    0x56164: {"kind": "call", "py": None, "slot_py": 'fr[5] = bits2f(_rdw(ram, 0x00056258, 4))', "target": 0x2490, "ret_pc": 0x56168, "set_pr": True, "cond": None},
    0x56168: {"kind": 'st', "py": 'pr = _rdw(ram, STACK_BASE + 0x3FC, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x5616a: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},
