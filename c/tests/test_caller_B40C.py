#!/usr/bin/env python3
"""Differential test for caller_B40C (entry 0xB40C) — v8 ST caller (CFG), 84 bytes.
...
Run: python3 test_caller_B40C.py
"""
...
CODE = {
    0xb40c: {"kind": 'mem', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, r[14])\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xb40e: {"kind": 'reg', "py": 'r[14] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0xb410: {"kind": 'reg', "py": 'r[3] = 0x00002054', "slot_py": None, "target": None, "cond": None},
    0xb412: {"kind": 'mem', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, r[13])\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xb414: {"kind": 'st', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xb416: {"kind": 'reg', "py": 'r[13] = r[14]', "slot_py": None, "target": None, "cond": None},
    0xb418: {"kind": 'reg', "py": 'r[5] = 0xFFFFA210', "slot_py": None, "target": None, "cond": None},
    0xb41a: {"kind": 'reg', "py": 'r[15] = (r[15] + s8(0xFC)) & 0xFFFFFFFF\nsp = (sp + s8(0xFC)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xb41c: {"kind": 'reg', "py": 'r[4] = 0xFFFFA214', "slot_py": None, "target": None, "cond": None},
    0xb41e: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA214, 1, r[14])', "slot_py": None, "target": None, "cond": None},
    0xb420: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA210, 4, r[14])', "slot_py": None, "target": None, "cond": None},
    0xb422: {"kind": 'reg', "py": 'r[5] = 0x000000E0', "slot_py": None, "target": None, "cond": None},
    0xb424: {"kind": "call", "py": None, "slot_py": 'r[4] = r[15]', "target": 0x2054, "ret_pc": 0xb428, "set_pr": True, "cond": None},
    0xb428: {"kind": 'reg', "py": 'T = 1 if (r[14] & r[14]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0xb42a: {"kind": "branch", "py": None, "slot_py": 'r[4] = s8(0x01)', "target": 0xb430, "cond": 'T'},
    0xb42e: {"kind": 'reg', "py": 'r[13] = r[4]', "slot_py": None, "target": None, "cond": None},
    0xb430: {"kind": 'reg', "py": 'r[5] = 0xFFFFF400', "slot_py": None, "target": None, "cond": None},
    0xb432: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, r[5], 1))', "slot_py": None, "target": None, "cond": None},
    0xb434: {"kind": 'reg', "py": 'r[0] = (r[0] & 0x7F) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xb436: {"kind": 'mem', "py": '_wrw(ram, r[5], 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0xb438: {"kind": 'reg', "py": 'r[3] = 0xFFFFF58E', "slot_py": None, "target": None, "cond": None},
    0xb43a: {"kind": 'mem', "py": '_wrw(ram, r[3], 2, r[4])', "slot_py": None, "target": None, "cond": None},
    0xb43c: {"kind": 'reg', "py": 'r[2] = 0xFFFFF586', "slot_py": None, "target": None, "cond": None},
    0xb43e: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFF586, 2, r[4])', "slot_py": None, "target": None, "cond": None},
    0xb440: {"kind": 'reg', "py": 'r[6] = 0xFFFFF596', "slot_py": None, "target": None, "cond": None},
    0xb442: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFF596, 2, r[4])', "slot_py": None, "target": None, "cond": None},
    0xb444: {"kind": 'reg', "py": 'r[1] = 0xFFFFF59E', "slot_py": None, "target": None, "cond": None},
    0xb446: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFF59E, 2, r[4])', "slot_py": None, "target": None, "cond": None},
    0xb448: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFF596, 2, r[13])', "slot_py": None, "target": None, "cond": None},
    0xb44a: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, r[5], 1))', "slot_py": None, "target": None, "cond": None},
    0xb44c: {"kind": 'reg', "py": 'r[0] = (r[0] | 0x80) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xb44e: {"kind": 'mem', "py": '_wrw(ram, r[5], 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0xb450: {"kind": 'reg', "py": 'r[3] = 0x00002064', "slot_py": None, "target": None, "cond": None},
    0xb452: {"kind": "call", "py": None, "slot_py": 'r[4] = _rdw(ram, sp, 4)', "target": 0x2064, "ret_pc": 0xb456, "set_pr": True, "cond": None},
    0xb456: {"kind": 'reg', "py": 'r[15] = (r[15] + s8(0x04)) & 0xFFFFFFFF\nsp = (sp + s8(0x04)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xb458: {"kind": 'st', "py": 'pr = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xb45a: {"kind": 'mem', "py": 'r[13] = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xb45c: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},
