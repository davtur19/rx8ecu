#!/usr/bin/env python3
"""Differential test for fuel_pressure_storage_25CDC (0x25CDC) — v3 lift + v4 FPU, 26 bytes.
...
Run from repo root: python3 c/tests/test_fuel_pressure_storage_25CDC_25cdc.py
"""
...
RAM_MAX = 0xFFFFB5D0
SPAN_END = 0x25CF6
SENT = 0x25CF6     # stop-sentinel, placed past the literal pool
