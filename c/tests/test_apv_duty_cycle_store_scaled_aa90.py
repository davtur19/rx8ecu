#!/usr/bin/env python3
"""Differential test for apv_duty_cycle_store_scaled (0xAA90) — v3 lift + v4 FPU, 52 bytes.
...
Run from repo root: python3 c/tests/test_apv_duty_cycle_store_scaled_aa90.py
"""
...
ENTRY = 0xAA90
RAW = bytes.fromhex("D2 22 F2 4C D6 22 63 21 D5 22 63 3D 43 5A F3 2D F4 3C F3 8D F4 22 F3 45 8F 06 E4 00 25 41 F4 4D F4 3D 01 5A A0 04 26 11 F4 3D 00 5A 25 01 26 41 00 0B 00 09")
SEED = 43
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFA1C6
SPAN_END = 0xAAC4
SENT = 0xAAC4     # stop-sentinel, placed past the literal pool
...
CODE = {
    0xaa90: {"kind": 'reg', "py": 'r[2] = 0x000779B6', "slot_py": None, "target": None, "cond": None},
    0xaa92: {"kind": 'fpu', "py": 'fr[2] = fr[4]', "slot_py": None, "target": None, "cond": None},
    0xaa94: {"kind": 'reg', "py": 'r[6] = 0xFFFFA1C6', "slot_py": None, "target": None, "cond": None},
    0xaa96: {"kind": 'mem', "py": 'r[3] = s16(_rdw(ram, 0x000779B6, 2))', "slot_py": None, "target": None, "cond": None},
    0xaa98: {"kind": 'reg', "py": 'r[5] = 0xFFFFA1C4', "slot_py": None, "target": None, "cond": None},
    0xaa9a: {"kind": 'reg', "py": 'r[3] = r[3] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0xaa9c: {"kind": 'fpu', "py": 'fpul = r[3]', "slot_py": None, "target": None, "cond": None},
    0xaa9e: {"kind": 'fpu', "py": 'fr[3] = ts(float(s32(fpul)))', "slot_py": None, "target": None, "cond": None},
    0xaaa0: {"kind": 'fpu', "py": 'fr[4] = fr[3]', "slot_py": None, "target": None, "cond": None},
    0xaaa2: {"kind": 'fpu', "py": 'fr[3] = 0.0', "slot_py": None, "target": None, "cond": None},
    0xaaa4: {"kind": 'fpu', "py": 'fr[4] = ts(fr[4] * fr[2])', "slot_py": None, "target": None, "cond": None},
    0xaaa6: {"kind": 'fpu', "py": 'T = 1 if fr[3] > fr[4] else 0', "slot_py": None, "target": None, "cond": None},
    0xaaa8: {"kind": "branch", "py": None, "slot_py": 'r[4] = s8(0x00)', "target": 0xaab8, "cond": 'notT'},
    0xaaac: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA1C4, 2, r[4])', "slot_py": None, "target": None, "cond": None},
    0xaaae: {"kind": 'fpu', "py": 'fr[4] = -fr[4]', "slot_py": None, "target": None, "cond": None},
    0xaab0: {"kind": 'fpu', "py": 'fpul = (0x80000000 if fr[4] != fr[4] else (0x7FFFFFFF if fr[4] >= 2147483648.0 else (0x80000000 if fr[4] < -2147483648.0 else int(fr[4])))) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xaab2: {"kind": 'fpu', "py": 'r[1] = fpul', "slot_py": None, "target": None, "cond": None},
    0xaab4: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFA1C6, 2, r[1])', "target": 0xaac0, "cond": 'always'},
    0xaab8: {"kind": 'fpu', "py": 'fpul = (0x80000000 if fr[4] != fr[4] else (0x7FFFFFFF if fr[4] >= 2147483648.0 else (0x80000000 if fr[4] < -2147483648.0 else int(fr[4])))) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xaaba: {"kind": 'fpu', "py": 'r[0] = fpul', "slot_py": None, "target": None, "cond": None},
    0xaabc: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA1C4, 2, r[0])', "slot_py": None, "target": None, "cond": None},
    0xaabe: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA1C6, 2, r[4])', "slot_py": None, "target": None, "cond": None},
    0xaac0: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
