#!/usr/bin/env python3
"""Differential test for write_pressure_sensor_bias (0x13F58) — v3 lift + v4 FPU, 16 bytes.
...
Run from repo root: python3 c/tests/test_write_pressure_sensor_bias_13f58.py
"""
...
RAM_MAX = 0xFFFFC12C
SPAN_END = 0x13F68
SENT = 0x13F68     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x13f58: {"kind": 'reg', "py": 'r[2] = 0xFFFFA768', "slot_py": None, "target": None, "cond": None},
    0x13f5a: {"kind": 'reg', "py": 'r[3] = s8(0x15)', "slot_py": None, "target": None, "cond": None},
    0x13f5c: {"kind": 'reg', "py": 'r[1] = 0xFFFFC12C', "slot_py": None, "target": None, "cond": None},
    0x13f5e: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA768, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x13f60: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFC12C, 4))', "slot_py": None, "target": None, "cond": None},
    0x13f62: {"kind": 'reg', "py": 'r[0] = 0xFFFFA778', "slot_py": None, "target": None, "cond": None},
    0x13f64: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFA778, 4, f2bits(fr[3]))', "target": None, "cond": None},}
