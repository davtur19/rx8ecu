#!/usr/bin/env python3
"""Differential test for write_o2_sensor_trim (0x12B54) — v3 lift (branches + delay slots), 10 bytes.
...
Run from repo root: python3 c/tests/test_write_o2_sensor_trim_12b54.py
"""
...
CODE = {
    0x12b54: {"kind": 'reg', "py": 'r[2] = 0xFFFFB5AC', "slot_py": None, "target": None, "cond": None},
    0x12b56: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFB5AC, 1))', "slot_py": None, "target": None, "cond": None},
    0x12b58: {"kind": 'reg', "py": 'r[1] = 0xFFFFA6A2', "slot_py": None, "target": None, "cond": None},
    0x12b5a: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFA6A2, 1, r[3])', "target": None, "cond": None},}
