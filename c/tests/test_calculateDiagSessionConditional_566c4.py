#!/usr/bin/env python3
"""Differential test for calculateDiagSessionConditional (0x566C4) — v3 lift (branches + delay slots), 38 bytes.
...
Run from repo root: python3 c/tests/test_calculateDiagSessionConditional_566c4.py
"""
...
CODE = {
    0x566c4: {"kind": 'reg', "py": 'r[4] = 0xFFFFD208', "slot_py": None, "target": None, "cond": None},
    0x566c6: {"kind": 'reg', "py": 'r[3] = 0xFFFFA41C', "slot_py": None, "target": None, "cond": None},
    0x566c8: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFA41C, 1))', "slot_py": None, "target": None, "cond": None},
    0x566ca: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x566cc: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x566ce: {"kind": "branch", "py": None, "slot_py": '', "target": 0x566e2, "cond": 'notT'},
    0x566d2: {"kind": 'reg', "py": 'r[2] = 0xFFFFD2AD', "slot_py": None, "target": None, "cond": None},
    0x566d4: {"kind": 'mem', "py": 'r[1] = s8(_rdw(ram, 0xFFFFD2AD, 1))', "slot_py": None, "target": None, "cond": None},
    0x566d6: {"kind": 'reg', "py": 'T = 1 if (r[1] & r[1]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x566d8: {"kind": "branch", "py": None, "slot_py": '', "target": 0x566e2, "cond": 'notT'},
    0x566dc: {"kind": 'reg', "py": 'r[3] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x566de: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFD208, 1, r[3])', "target": 0x566e6, "cond": 'always'},
    0x566e2: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x566e4: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD208, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x566e6: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
