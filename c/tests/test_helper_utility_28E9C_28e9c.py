#!/usr/bin/env python3
"""Differential test for helper_utility_28E9C (0x28E9C) — v3 lift + v4 FPU, 14 bytes.
...
Run from repo root: python3 c/tests/test_helper_utility_28E9C_28e9c.py
"""
...
ENTRY = 0x28E9C
RAW = bytes.fromhex("93 56 F3 8D D2 2F E0 00 23 01 00 0B F2 3A")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBAD4
SPAN_END = 0x28EAA
SENT = 0x28EAA     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x28e9c: {"kind": 'reg', "py": 'r[3] = 0xFFFFBAC4', "slot_py": None, "target": None, "cond": None},
    0x28e9e: {"kind": 'fpu', "py": 'fr[3] = 0.0', "slot_py": None, "target": None, "cond": None},
    0x28ea0: {"kind": 'reg', "py": 'r[2] = 0xFFFFBAD4', "slot_py": None, "target": None, "cond": None},
    0x28ea2: {"kind": 'reg', "py": 'r[0] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x28ea4: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBAC4, 2, r[0])', "slot_py": None, "target": None, "cond": None},
    0x28ea6: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBAD4, 4, f2bits(fr[3]))', "target": None, "cond": None},}
