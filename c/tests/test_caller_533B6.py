#!/usr/bin/env python3
"""Differential test for caller_533B6 (entry 0x533B6) — v8 ST caller (CFG), 38 bytes.
...
Run: python3 test_caller_533B6.py
"""
...
CODE = {
    0x533b6: {"kind": 'mem', "py": 'local[0x3FC] = r[14]\n_wrw(ram, STACK_BASE + 0x3FC, 4, r[14])\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x533b8: {"kind": 'st', "py": 'local[0x3F8] = pr\n_wrw(ram, STACK_BASE + 0x3F8, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x533ba: {"kind": 'reg', "py": 'r[14] = 0x0003EE58', "slot_py": None, "target": None, "cond": None},
    0x533bc: {"kind": 'reg', "py": 'r[4] = 0xFFFF8706', "slot_py": None, "target": None, "cond": None},
    0x533be: {"kind": "call", "py": None, "slot_py": 'r[5] = s8(0x00)', "target": 0x3ee58, "ret_pc": 0x533c2, "set_pr": True, "cond": None},
    0x533c2: {"kind": 'reg', "py": 'r[4] = 0xFFFF8708', "slot_py": None, "target": None, "cond": None},
    0x533c4: {"kind": "call", "py": None, "slot_py": 'r[5] = s8(0x00)', "target": 0x3ee58, "ret_pc": 0x533c8, "set_pr": True, "cond": None},
    0x533c8: {"kind": 'reg', "py": 'r[4] = 0xFFFF870A', "slot_py": None, "target": None, "cond": None},
    0x533ca: {"kind": "call", "py": None, "slot_py": 'r[5] = s8(0x00)', "target": 0x3ee58, "ret_pc": 0x533ce, "set_pr": True, "cond": None},
    0x533ce: {"kind": 'reg', "py": 'r[3] = 0x0007D7DE', "slot_py": None, "target": None, "cond": None},
    0x533d0: {"kind": 'reg', "py": 'r[4] = 0xFFFF8704', "slot_py": None, "target": None, "cond": None},
    0x533d2: {"kind": "call", "py": None, "slot_py": 'r[5] = s8(_rdw(ram, 0x0007D7DE, 1))', "target": 0x3ee58, "ret_pc": 0x533d6, "set_pr": True, "cond": None},
    0x533d6: {"kind": 'st', "py": 'pr = _rdw(ram, STACK_BASE + 0x3F8, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x533d8: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, STACK_BASE + 0x3FC, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},
