#!/usr/bin/env python3
"""Differential test for FUN_000607a0 (0x607A0) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_FUN_000607a0_607a0.py
"""
...
ENTRY = 0x607A0
RAW = bytes.fromhex("E1 00 25 10 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = None
SPAN_END = 0x607A8
SENT = 0x607A8     # stop-sentinel, placed past the literal pool
...
CODE = {
    ...
    0x607a2: {"kind": 'mem', "py": '_wrw(ram, r[5], 1, r[1])', "slot_py": None, "target": None, "cond": None},
