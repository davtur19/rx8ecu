#!/usr/bin/env python3
"""Differential test for copy_byte_c618 (0x3D920) — v3 lift (branches + delay slots), 10 bytes.
...
Run from repo root: python3 c/tests/test_copy_byte_c618_3d920.py
"""
...
ENTRY = 0x3D920
RAW = bytes.fromhex("D2 43 63 20 91 77 00 0B 21 30")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFC618
SPAN_END = 0x3D92A
SENT = 0x3D92A     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x3d920: {"kind": 'reg', "py": 'r[2] = 0x00079628', "slot_py": None, "target": None, "cond": None},
    0x3d922: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0x00079628, 1))', "slot_py": None, "target": None, "cond": None},
    0x3d924: {"kind": 'reg', "py": 'r[1] = 0xFFFFC618', "slot_py": None, "target": None, "cond": None},
    0x3d926: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFC618, 1, r[3])', "target": None, "cond": None},}
