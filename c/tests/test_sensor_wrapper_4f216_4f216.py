#!/usr/bin/env python3
"""Differential test for sensor_wrapper_4f216 (0x4F216) — v3 lift (branches + delay slots), 40 bytes.
...
Run from repo root: python3 c/tests/test_sensor_wrapper_4f216_4f216.py
"""
...
ENTRY = 0x4F216
RAW = bytes.fromhex("E4 01 D3 2B 95 4A 60 31 60 0D 20 48 8D 02 00 09 A0 01 60 43 E0 00 88 01 8F 02 00 09 A0 02 25 40 E2 00 25 20 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    0x4f216: {"kind": 'reg', "py": 'r[4] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x4f218: {"kind": 'reg', "py": 'r[3] = 0xFFFF9EC8', "slot_py": None, "target": None, "cond": None},
    0x4f21a: {"kind": 'reg', "py": 'r[5] = 0xFFFFCFF5', "slot_py": None, "target": None, "cond": None},
    0x4f21c: {"kind": 'mem', "py": 'r[0] = s16(_rdw(ram, 0xFFFF9EC8, 2))', "slot_py": None, "target": None, "cond": None},
    0x4f21e: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x4f220: {"kind": 'reg', "py": 'T = 1 if (r[0] & r[4]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x4f222: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4f22a, "cond": 'T'},
    0x4f226: {"kind": "branch", "py": None, "slot_py": 'r[0] = r[4]', "target": 0x4f22c, "cond": 'always'},
    0x4f22a: {"kind": 'reg', "py": 'r[0] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x4f22c: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x4f22e: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4f236, "cond": 'notT'},
    0x4f232: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFCFF5, 1, r[4])', "target": 0x4f23a, "cond": 'always'},
    0x4f236: {"kind": 'reg', "py": 'r[2] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x4f238: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCFF5, 1, r[2])', "slot_py": None, "target": None, "cond": None},
    0x4f23a: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
