#!/usr/bin/env python3
"""Differential test for setCANRXBool (0xE044) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_setCANRXBool_e044.py
"""
...
ENTRY = 0xE044
RAW = bytes.fromhex("90 0B E3 01 00 0B 20 30")
SEED = 0
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFA406
SPAN_END = 0xE04C
SENT = 0xE04C     # stop-sentinel, placed past the literal pool
...
CODE = {
    0xe044: {"kind": 'reg', "py": 'r[0] = 0xFFFFA406', "slot_py": None, "target": None, "cond": None},
    0xe046: {"kind": 'reg', "py": 'r[3] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0xe048: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFA406, 1, r[3])', "target": None, "cond": None},}
