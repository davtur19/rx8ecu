#!/usr/bin/env python3
"""Differential test for diag_fault_cond_eval_909c_a (0x56CF8) — mem lift (RAM-only, straight-line), 8 bytes.
...
Run from repo root: python3 c/tests/test_diag_fault_cond_eval_909c_a_56cf8.py
"""
...
ENTRY = 0x56CF8
RAW = bytes.fromhex("00 09 D3 0B 60 31 60 0D")
SEED = 42
N = 2000
