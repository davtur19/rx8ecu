#!/usr/bin/env python3
"""Differential test for caller_A9F4 (entry 0xA9F4) — v8 ST caller (CFG), 44 bytes.
...
Run: python3 test_caller_A9F4.py
"""
...
CODE = {
    0xa9f4: {"kind": 'st', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xa9f6: {"kind": 'reg', "py": 'r[15] = (r[15] + s8(0xFC)) & 0xFFFFFFFF\nsp = (sp + s8(0xFC)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xa9f8: {"kind": 'reg', "py": 'r[5] = 0x000000E0', "slot_py": None, "target": None, "cond": None},
    0xa9fa: {"kind": 'reg', "py": 'r[3] = 0x00002054', "slot_py": None, "target": None, "cond": None},
    0xa9fc: {"kind": "call", "py": None, "slot_py": 'r[4] = r[15]', "target": 0x2054, "ret_pc": 0xaa00, "set_pr": True, "cond": None},
    0xaa00: {"kind": 'reg', "py": 'r[5] = 0x00007FFF', "slot_py": None, "target": None, "cond": None},
    0xaa02: {"kind": 'reg', "py": 'r[4] = 0xFFFFF738', "slot_py": None, "target": None, "cond": None},
    0xaa04: {"kind": 'mem', "py": 'r[2] = s16(_rdw(ram, 0xFFFFF738, 2))', "slot_py": None, "target": None, "cond": None},
    0xaa06: {"kind": 'reg', "py": 'r[2] = (r[2] | r[5]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xaa08: {"kind": 'reg', "py": 'r[2] = (~r[2]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xaa0a: {"kind": 'mem', "py": 'r[3] = s16(_rdw(ram, 0xFFFFF738, 2))', "slot_py": None, "target": None, "cond": None},
    0xaa0c: {"kind": 'reg', "py": 'r[3] = (r[3] & r[5]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xaa0e: {"kind": 'reg', "py": 'r[2] = (r[2] + r[3]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xaa10: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFF738, 2, r[2])', "slot_py": None, "target": None, "cond": None},
    0xaa12: {"kind": 'reg', "py": 'r[3] = 0x00002064', "slot_py": None, "target": None, "cond": None},
    0xaa14: {"kind": "call", "py": None, "slot_py": 'r[4] = _rdw(ram, sp, 4)', "target": 0x2064, "ret_pc": 0xaa18, "set_pr": True, "cond": None},
    0xaa18: {"kind": 'reg', "py": 'r[15] = (r[15] + s8(0x04)) & 0xFFFFFFFF\nsp = (sp + s8(0x04)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xaa1a: {"kind": 'st', "py": 'pr = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xaa1c: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},
