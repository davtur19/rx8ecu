#!/usr/bin/env python3
"""Differential test for noOpFun3 (0x5020) — v3 lift (branches + delay slots), 18 bytes.
...
Run from repo root: python3 c/tests/test_noOpFun3_5020.py
"""
...
ENTRY = 0x5020
RAW = bytes.fromhex("00 0B 00 09 91 93 90 93 20 11 D3 60 92 91 00 0B 22 31")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFEC12
SPAN_END = 0x5032
SENT = 0x5032     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x5020: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},
