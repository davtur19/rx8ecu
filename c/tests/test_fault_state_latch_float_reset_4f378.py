#!/usr/bin/env python3
"""Differential test for fault_state_latch_float_reset (0x4F378) — v3 lift (branches + delay slots), 20 bytes.
...
Run from repo root: python3 c/tests/test_fault_state_latch_float_reset_4f378.py
"""
...
ENTRY = 0x4F378
RAW = bytes.fromhex("88 01 8F 03 00 09 E3 01 A0 02 24 30 E1 00 24 10 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = None
SPAN_END = 0x4F38C
SENT = 0x4F38C     # stop-sentinel, placed past the literal pool
...
CODE = {
    ...
    0x4f380: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, r[4], 1, r[3])', "target": 0x4f388, "cond": 'always'},
    0x4f384: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x4f386: {"kind": 'mem', "py": '_wrw(ram, r[4], 1, r[1])', "slot_py": None, "target": None, "cond": None},
