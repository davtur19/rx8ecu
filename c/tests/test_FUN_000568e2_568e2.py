#!/usr/bin/env python3
"""Differential test for FUN_000568e2 (0x568E2) — v3 lift (branches + delay slots), 10 bytes.
...
Run from repo root: python3 c/tests/test_FUN_000568e2_568e2.py
"""
...
ENTRY = 0x568E2
RAW = bytes.fromhex("00 0B 60 53 D3 09 00 0B 60 30")
SEED = 42
N = 500
MAXSTEPS = 100000
