#!/usr/bin/env python3
"""Differential test for FUN_00061a9a (0x61A9A) — v3 lift (branches + delay slots), 16 bytes.
...
Run from repo root: python3 c/tests/test_FUN_00061a9a_61a9a.py
"""
...
ENTRY = 0x61A9A
RAW = bytes.fromhex("20 08 8D 01 00 09 EE 01 60 E3 4F 26 00 0B 6E F6")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = None
SPAN_END = 0x61AAA
SENT = 0x61AAA     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x61a9a: {"kind": 'reg', "py": 'T = 1 if (r[0] & r[0]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x61a9c: {"kind": "branch", "py": None, "slot_py": '', "target": 0x61aa2, "cond": 'T'},
    0x61aa0: {"kind": 'reg', "py": 'r[14] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x61aa2: {"kind": 'reg', "py": 'r[0] = r[14]', "slot_py": None, "target": None, "cond": None},
    0x61aa4: {"kind": 'mem', "py": 'pr = _rdw(ram, STACK_BASE + 0x400, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x61aa6: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, STACK_BASE + 0x404, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},}
