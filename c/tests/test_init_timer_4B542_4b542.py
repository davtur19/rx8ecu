#!/usr/bin/env python3
"""Differential test for init_timer_4B542 (0x4B542) — v3 lift (branches + delay slots), 60 bytes.
...
Run from repo root: python3 c/tests/test_init_timer_4B542_4b542.py
"""
...
ENTRY = 0x4B542
RAW = bytes.fromhex("94 1E D3 15 60 30 60 0C 88 01 8D 06 00 09 92 15 60 20 60 0C 88 01 8F 03 00 09 E3 00 A0 0C 24 30 D2 10 61 20 21 18 8F 07 00 09 D3 08 60 30 20 08 8F 02 00 09 E1 01 24 10 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFD201
SPAN_END = 0x4B57E
SENT = 0x4B5A8     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x4b542: {"kind": 'reg', "py": 'r[4] = 0xFFFFCDFF', "slot_py": None, "target": None, "cond": None},
    0x4b544: {"kind": 'reg', "py": 'r[3] = 0xFFFFCE06', "slot_py": None, "target": None, "cond": None},
    0x4b546: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCE06, 1))', "slot_py": None, "target": None, "cond": None},
    0x4b548: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x4b54a: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x4b54c: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4b55c, "cond": 'T'},
    0x4b550: {"kind": 'reg', "py": 'r[2] = 0xFFFFD201', "slot_py": None, "target": None, "cond": None},
    0x4b552: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFD201, 1))', "slot_py": None, "target": None, "cond": None},
    0x4b554: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x4b556: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x4b558: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4b562, "cond": 'notT'},
    0x4b55c: {"kind": 'reg', "py": 'r[3] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x4b55e: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFCDFF, 1, r[3])', "target": 0x4b57a, "cond": 'always'},
    0x4b562: {"kind": 'reg', "py": 'r[2] = 0x0007DAD5', "slot_py": None, "target": None, "cond": None},
    0x4b564: {"kind": 'mem', "py": 'r[1] = s8(_rdw(ram, 0x0007DAD5, 1))', "slot_py": None, "target": None, "cond": None},
    0x4b566: {"kind": 'reg', "py": 'T = 1 if (r[1] & r[1]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x4b568: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4b57a, "cond": 'notT'},
    0x4b56c: {"kind": 'reg', "py": 'r[3] = 0xFFFFCE11', "slot_py": None, "target": None, "cond": None},
    0x4b56e: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCE11, 1))', "slot_py": None, "target": None, "cond": None},
    0x4b570: {"kind": 'reg', "py": 'T = 1 if (r[0] & r[0]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x4b572: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4b57a, "cond": 'notT'},
    0x4b576: {"kind": 'reg', "py": 'r[1] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x4b578: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCDFF, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x4b57a: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
