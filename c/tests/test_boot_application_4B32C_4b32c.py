#!/usr/bin/env python3
"""Differential test for boot_application_4B32C (0x4B32C) — v3 lift (branches + delay slots), 40 bytes.
...
Run from repo root: python3 c/tests/test_boot_application_4B32C_4b32c.py
"""
...
ENTRY = 0x4B32C
RAW = bytes.fromhex("94 12 93 12 60 30 60 0C 88 01 8D 06 00 09 92 0D 60 20 60 0C 88 01 8F 03 00 09 E3 01 A0 02 24 30 E1 00 24 10 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCDF8
SPAN_END = 0x4B354
SENT = 0x4B35A     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x4b32c: {"kind": 'reg', "py": 'r[4] = 0xFFFFCDF8', "slot_py": None, "target": None, "cond": None},
    0x4b32e: {"kind": 'reg', "py": 'r[3] = 0xFFFFCA05', "slot_py": None, "target": None, "cond": None},
    0x4b330: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCA05, 1))', "slot_py": None, "target": None, "cond": None},
    0x4b332: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x4b334: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x4b336: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4b346, "cond": 'T'},
    0x4b33a: {"kind": 'reg', "py": 'r[2] = 0xFFFFCA07', "slot_py": None, "target": None, "cond": None},
    0x4b33c: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCA07, 1))', "slot_py": None, "target": None, "cond": None},
    0x4b33e: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x4b340: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x4b342: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4b34c, "cond": 'notT'},
    0x4b346: {"kind": 'reg', "py": 'r[3] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x4b348: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFCDF8, 1, r[3])', "target": 0x4b350, "cond": 'always'},
    0x4b34c: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x4b34e: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCDF8, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x4b350: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
