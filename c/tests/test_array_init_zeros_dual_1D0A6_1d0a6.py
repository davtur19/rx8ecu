#!/usr/bin/env python3
"""Differential test for array_init_zeros_dual_1D0A6 (0x1D0A6) — pure straight-line lift, 8 bytes.
...
Run from repo root: python3 c/tests/test_array_init_zeros_dual_1D0A6_1d0a6.py
"""
...
ENTRY = 0x1D0A6
RAW = bytes.fromhex("E5 01 D1 26 E6 14 D7 26")
SEED = 42
N = 2000
