#!/usr/bin/env python3
"""Differential test for FUN_000289f8 (0x289F8) — pure straight-line lift, 8 bytes.
...
Run from repo root: python3 c/tests/test_FUN_000289f8_289f8.py
"""
...
ENTRY = 0x289F8
RAW = bytes.fromhex("C7 1C 6A B3 74 14 63 43")
SEED = 42
N = 2000
