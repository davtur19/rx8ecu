#!/usr/bin/env python3
"""Differential test for ram_byte_copy_2A2F6 (0x2A2F6) — v3 lift (branches + delay slots), 10 bytes.
...
Run from repo root: python3 c/tests/test_ram_byte_copy_2A2F6_2a2f6.py
"""
...
CODE = {
    0x2a2f6: {"kind": 'reg', "py": 'r[2] = 0xFFFFBB80', "slot_py": None, "target": None, "cond": None},
    0x2a2f8: {"kind": 'reg', "py": 'r[1] = 0xFFFFBB91', "slot_py": None, "target": None, "cond": None},
    0x2a2fa: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFBB80, 1))', "slot_py": None, "target": None, "cond": None},
    0x2a2fc: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBB91, 1, r[3])', "target": None, "cond": None},}
