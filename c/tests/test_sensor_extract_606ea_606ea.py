#!/usr/bin/env python3
"""Differential test for sensor_extract_606ea (0x606EA) — v3 lift (branches + delay slots), 14 bytes.
...
Run from repo root: python3 c/tests/test_sensor_extract_606ea_606ea.py
"""
...
CODE = {
    0x606ea: {"kind": 'reg', "py": 'r[3] = 0xFFFFCBF2', "slot_py": None, "target": None, "cond": None},
    0x606ec: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCBF2, 1))', "slot_py": None, "target": None, "cond": None},
    0x606ee: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x606f0: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x606f2: {"kind": 'reg', "py": 'r[4] = T;', "slot_py": None, "target": None, "cond": None},
    0x606f4: {"kind": "ret", "py": None, "slot_py": 'r[0] = r[4]', "target": None, "cond": None},}
