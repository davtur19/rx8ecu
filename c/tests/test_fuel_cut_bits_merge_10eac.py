#!/usr/bin/env python3
"""Differential test for fuel_cut_bits_merge (0x10EAC) — v3 lift (branches + delay slots), 38 bytes.
...
Run from repo root: python3 c/tests/test_fuel_cut_bits_merge_10eac.py
"""
...
ENTRY = 0x10EAC
RAW = bytes.fromhex("93 79 D5 41 62 50 22 28 8F 03 64 31 91 74 60 11 24 0B E0 2C 03 5C 23 38 8F 03 00 09 92 6D 61 21 24 1B 00 0B 60 43")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFA5DC
SPAN_END = 0x10ED2
SENT = 0x10ED2     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x10eac: {"kind": 'reg', "py": 'r[3] = 0xFFFFA5D8', "slot_py": None, "target": None, "cond": None},
    0x10eae: {"kind": 'reg', "py": 'r[5] = 0xFFFFA578', "slot_py": None, "target": None, "cond": None},
    0x10eb0: {"kind": 'mem', "py": 'r[2] = s8(_rdw(ram, 0xFFFFA578, 1))', "slot_py": None, "target": None, "cond": None},
    0x10eb2: {"kind": 'reg', "py": 'T = 1 if (r[2] & r[2]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x10eb4: {"kind": "branch", "py": None, "slot_py": 'r[4] = s16(_rdw(ram, 0xFFFFA5D8, 2))', "target": 0x10ebe, "cond": 'notT'},
    0x10eb8: {"kind": 'reg', "py": 'r[1] = 0xFFFFA5DA', "slot_py": None, "target": None, "cond": None},
    0x10eba: {"kind": 'mem', "py": 'r[0] = s16(_rdw(ram, 0xFFFFA5DA, 2))', "slot_py": None, "target": None, "cond": None},
    0x10ebc: {"kind": 'reg', "py": 'r[4] = (r[4] | r[0]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x10ebe: {"kind": 'reg', "py": 'r[0] = s8(0x2C)', "slot_py": None, "target": None, "cond": None},
    0x10ec0: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, (0xFFFFA578 + r[0]), 1))', "slot_py": None, "target": None, "cond": None},
    0x10ec2: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x10ec4: {"kind": "branch", "py": None, "slot_py": '', "target": 0x10ece, "cond": 'notT'},
    0x10ec8: {"kind": 'reg', "py": 'r[2] = 0xFFFFA5DC', "slot_py": None, "target": None, "cond": None},
    0x10eca: {"kind": 'mem', "py": 'r[1] = s16(_rdw(ram, 0xFFFFA5DC, 2))', "slot_py": None, "target": None, "cond": None},
    0x10ecc: {"kind": 'reg', "py": 'r[4] = (r[4] | r[1]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x10ece: {"kind": "ret", "py": None, "slot_py": 'r[0] = r[4]', "target": None, "cond": None},}
