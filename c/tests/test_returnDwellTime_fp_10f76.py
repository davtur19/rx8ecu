#!/usr/bin/env python3
"""Differential test for returnDwellTime_fp (0x10F76) — v3 lift (branches + delay slots), 14 bytes.
...
Run from repo root: python3 c/tests/test_returnDwellTime_fp_10f76.py
"""
...
ENTRY = 0x10F76
RAW = bytes.fromhex("D3 14 64 31 64 4D 44 08 44 08 00 0B 60 43")
SEED = 0
N = 2000
MAXSTEPS = 100000
