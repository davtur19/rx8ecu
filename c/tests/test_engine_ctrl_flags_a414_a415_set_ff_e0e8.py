#!/usr/bin/env python3
"""Differential test for engine_ctrl_flags_a414_a415_set_ff (0xE0E8) — v3 lift + v4 FPU, 34 bytes.
...
Run from repo root: python3 c/tests/test_engine_ctrl_flags_a414_a415_set_ff_e0e8.py
"""
...
ENTRY = 0xE0E8
RAW = bytes.fromhex("F3 25 8F 04 00 09 D1 29 60 10 A0 08 25 00 64 50 61 4C 21 18 8D 03 00 09 90 38 34 0C 25 40 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    ...
    0xe0f2: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, r[5], 1, r[0])', "target": 0xe106, "cond": 'always'},
    0xe0f6: {"kind": 'mem', "py": 'r[4] = s8(_rdw(ram, r[5], 1))', "slot_py": None, "target": None, "cond": None},
    ...
    0xe104: {"kind": 'mem', "py": '_wrw(ram, r[5], 1, r[4])', "slot_py": None, "target": None, "cond": None},
