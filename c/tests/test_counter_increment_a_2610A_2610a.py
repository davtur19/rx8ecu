#!/usr/bin/env python3
"""Differential test for counter_increment_a_2610A (0x2610A) — v3 lift (branches + delay slots), 10 bytes.
...
Run from repo root: python3 c/tests/test_counter_increment_a_2610A_2610a.py
"""
...
CODE = {
    0x2610a: {"kind": 'reg', "py": 'r[4] = 0xFFFFB5F2', "slot_py": None, "target": None, "cond": None},
    0x2610c: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFB5F2, 1))', "slot_py": None, "target": None, "cond": None},
    0x2610e: {"kind": 'reg', "py": 'r[3] = (r[3] + s8(0x01)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x26110: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFB5F2, 1, r[3])', "target": None, "cond": None},}
