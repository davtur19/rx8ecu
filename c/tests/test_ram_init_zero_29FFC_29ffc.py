#!/usr/bin/env python3
"""Differential test for ram_init_zero_29FFC (0x29FFC) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_ram_init_zero_29FFC_29ffc.py
"""
...
CODE = {
    0x29ffc: {"kind": 'reg', "py": 'r[2] = 0xFFFFBB74', "slot_py": None, "target": None, "cond": None},
    0x29ffe: {"kind": 'reg', "py": 'r[3] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x2a000: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBB74, 2, r[3])', "target": None, "cond": None},}
