#!/usr/bin/env python3
"""Differential test for obd_pid_emit_53804 (0x54E4E) — v3 lift (branches + delay slots), 20 bytes.
...
Run from repo root: python3 c/tests/test_obd_pid_emit_53804_54e4e.py
"""
...
ENTRY = 0x54E4E
RAW = bytes.fromhex("61 1C 31 20 8D 02 00 09 E0 01 24 00 7F 04 4F 26 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
