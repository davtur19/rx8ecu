#!/usr/bin/env python3
"""Differential test for caller_9C8E (entry 0x9C8E) — v8 ST caller (CFG), 14 bytes.
...
Run: python3 test_caller_9C8E.py
"""
...
CODE = {
    0x9c8e: {"kind": 'st', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x9c90: {"kind": 'reg', "py": 'r[3] = 0x0000CE24', "slot_py": None, "target": None, "cond": None},
    0x9c92: {"kind": "call", "py": None, "slot_py": '', "target": 0xce24, "ret_pc": 0x9c96, "set_pr": True, "cond": None},
    0x9c96: {"kind": 'st', "py": 'pr = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x9c98: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},
