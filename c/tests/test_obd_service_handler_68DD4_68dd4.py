#!/usr/bin/env python3
"""Differential test for obd_service_handler_68DD4 (0x68DD4) — v3 lift (branches + delay slots), 28 bytes.
...
Run from repo root: python3 c/tests/test_obd_service_handler_68DD4_68dd4.py
"""
...
CODE = {
    0x68dd4: {"kind": 'reg', "py": 'r[4] = 0xFFFFDE18', "slot_py": None, "target": None, "cond": None},
    0x68dd6: {"kind": 'reg', "py": 'r[5] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x68dd8: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFDE18, 2, r[5])', "slot_py": None, "target": None, "cond": None},
    0x68dda: {"kind": 'reg', "py": 'r[0] = r[5]', "slot_py": None, "target": None, "cond": None},
    0x68ddc: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFDE1A, 2, r[0])', "slot_py": None, "target": None, "cond": None},
    0x68dde: {"kind": 'reg', "py": 'r[0] = 0x000000FF', "slot_py": None, "target": None, "cond": None},
    0x68de0: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFDE1C, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x68de2: {"kind": 'reg', "py": 'r[0] = r[5]', "slot_py": None, "target": None, "cond": None},
    0x68de4: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFDE1D, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x68de6: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFDE1E, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x68de8: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFDE1F, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x68dea: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFDE20, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x68dec: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFDE21, 1, r[0])', "target": None, "cond": None},}
