#!/usr/bin/env python3
"""Differential test for uds_service_0f_check_d083 (0x57AB6) — v3 lift (branches + delay slots), 26 bytes.
...
Run from repo root: python3 c/tests/test_uds_service_0f_check_d083_57ab6.py
"""
...
ENTRY = 0x57AB6
RAW = bytes.fromhex("60 4C 88 0F 8F 07 E5 00 93 46 60 30 60 0C 88 01 8F 01 00 09 E5 01 00 0B 60 53")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFD083
SPAN_END = 0x57AD0
SENT = 0x57AD0     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x57ab6: {"kind": 'reg', "py": 'r[0] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x57ab8: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x0F) else 0', "slot_py": None, "target": None, "cond": None},
    0x57aba: {"kind": "branch", "py": None, "slot_py": 'r[5] = s8(0x00)', "target": 0x57acc, "cond": 'notT'},
    0x57abe: {"kind": 'reg', "py": 'r[3] = 0xFFFFD083', "slot_py": None, "target": None, "cond": None},
    0x57ac0: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFD083, 1))', "slot_py": None, "target": None, "cond": None},
    0x57ac2: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x57ac4: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x57ac6: {"kind": "branch", "py": None, "slot_py": '', "target": 0x57acc, "cond": 'notT'},
    0x57aca: {"kind": 'reg', "py": 'r[5] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x57acc: {"kind": "ret", "py": None, "slot_py": 'r[0] = r[5]', "target": None, "cond": None},}
