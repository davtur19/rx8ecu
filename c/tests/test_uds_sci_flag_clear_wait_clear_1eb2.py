#!/usr/bin/env python3
"""Differential test for uds_sci_flag_clear_wait_clear (0x1EB2) — v3 lift (branches + delay slots), 30 bytes.
...
Run from repo root: python3 c/tests/test_uds_sci_flag_clear_wait_clear_1eb2.py
"""
...
ENTRY = 0x1EB2
RAW = bytes.fromhex("E6 08 60 40 C9 FE 24 00 94 81 63 50 63 3C 23 68 89 03 74 FF E3 00 34 36 89 F7 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = None
SPAN_END = 0x1ED0
SENT = 0x1ED0     # stop-sentinel, placed past the literal pool
