#!/usr/bin/env python3
"""Differential test for read_inverted_flag_bad9 (0x5E5A4) — v3 lift (branches + delay slots), 22 bytes.
...
Run from repo root: python3 c/tests/test_read_inverted_flag_bad9_5e5a4.py
"""
...
ENTRY = 0x5E5A4
RAW = bytes.fromhex("93 39 60 30 60 0C 88 01 8F 02 00 09 A0 01 E4 00 E4 01 00 0B 60 43")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBAD9
SPAN_END = 0x5E5BA
SENT = 0x5E5BA     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x5e5a4: {"kind": 'reg', "py": 'r[3] = 0xFFFFBAD9', "slot_py": None, "target": None, "cond": None},
    0x5e5a6: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFBAD9, 1))', "slot_py": None, "target": None, "cond": None},
    0x5e5a8: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x5e5aa: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x5e5ac: {"kind": "branch", "py": None, "slot_py": '', "target": 0x5e5b4, "cond": 'notT'},
    0x5e5b0: {"kind": "branch", "py": None, "slot_py": 'r[4] = s8(0x00)', "target": 0x5e5b6, "cond": 'always'},
    0x5e5b4: {"kind": 'reg', "py": 'r[4] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x5e5b6: {"kind": "ret", "py": None, "slot_py": 'r[0] = r[4]', "target": None, "cond": None},}
