#!/usr/bin/env python3
"""Differential test for fpu_gate_compare_conditional_2FF52 (0x2FF52) — v3 lift + v4 FPU, 42 bytes.
...
Run from repo root: python3 c/tests/test_fpu_gate_compare_conditional_2FF52_2ff52.py
"""
...
ENTRY = 0x2FF52
RAW = bytes.fromhex("93 14 D2 12 F4 38 F5 28 D1 12 94 10 F4 55 F3 18 F6 5C 8D 03 F6 30 E0 01 A0 05 24 00 F4 65 8F 02 00 09 E3 00 24 30 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFC71C
SPAN_END = 0x2FF7C
SENT = 0x2FFA8     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x2ff52: {"kind": 'reg', "py": 'r[3] = 0xFFFFC71C', "slot_py": None, "target": None, "cond": None},
    0x2ff54: {"kind": 'reg', "py": 'r[2] = 0x000778E4', "slot_py": None, "target": None, "cond": None},
    0x2ff56: {"kind": 'fpu', "py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFC71C, 4))', "slot_py": None, "target": None, "cond": None},
    0x2ff58: {"kind": 'fpu', "py": 'fr[5] = bits2f(_rdw(ram, 0x000778E4, 4))', "slot_py": None, "target": None, "cond": None},
    0x2ff5a: {"kind": 'reg', "py": 'r[1] = 0x000778E8', "slot_py": None, "target": None, "cond": None},
    0x2ff5c: {"kind": 'reg', "py": 'r[4] = 0xFFFFBDD6', "slot_py": None, "target": None, "cond": None},
    0x2ff5e: {"kind": 'fpu', "py": 'T = 1 if fr[4] > fr[5] else 0', "slot_py": None, "target": None, "cond": None},
    0x2ff60: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x000778E8, 4))', "slot_py": None, "target": None, "cond": None},
    0x2ff62: {"kind": 'fpu', "py": 'fr[6] = fr[5]', "slot_py": None, "target": None, "cond": None},
    0x2ff64: {"kind": "branch", "py": None, "slot_py": 'fr[6] = ts(fr[6] + fr[3])', "target": 0x2ff6e, "cond": 'T'},
    0x2ff68: {"kind": 'reg', "py": 'r[0] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x2ff6a: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFBDD6, 1, r[0])', "target": 0x2ff78, "cond": 'always'},
    0x2ff6e: {"kind": 'fpu', "py": 'T = 1 if fr[4] > fr[6] else 0', "slot_py": None, "target": None, "cond": None},
    0x2ff70: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2ff78, "cond": 'notT'},
    0x2ff74: {"kind": 'reg', "py": 'r[3] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x2ff76: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBDD6, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x2ff78: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
