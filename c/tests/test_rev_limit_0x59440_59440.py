#!/usr/bin/env python3
"""Differential test for rev_limit_0x59440 (0x59440) — v3 lift (branches + delay slots), 18 bytes.
...
Run from repo root: python3 c/tests/test_rev_limit_0x59440_59440.py
"""
...
CODE = {
    0x59440: {"kind": 'reg', "py": 'r[2] = 0xFFFFD0E5', "slot_py": None, "target": None, "cond": None},
    0x59442: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFD0E5, 1))', "slot_py": None, "target": None, "cond": None},
    0x59444: {"kind": 'reg', "py": 'r[1] = 0xFFFFD273', "slot_py": None, "target": None, "cond": None},
    0x59446: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD273, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x59448: {"kind": 'reg', "py": 'r[3] = 0xFFFFD0E6', "slot_py": None, "target": None, "cond": None},
    0x5944a: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFD0E6, 1))', "slot_py": None, "target": None, "cond": None},
    0x5944c: {"kind": 'reg', "py": 'r[2] = 0xFFFFD274', "slot_py": None, "target": None, "cond": None},
    0x5944e: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFD274, 1, r[0])', "target": None, "cond": None},}
