#!/usr/bin/env python3
"""Differential test for caller_4F046 (entry 0x4F046) — v8 ST caller (CFG), 24 bytes.
...
Run: python3 test_caller_4F046.py
"""
...
CODE = {
    0x4f046: {"kind": 'fpu', "py": 'fr[5] = 0.0', "slot_py": None, "target": None, "cond": None},
    0x4f048: {"kind": 'reg', "py": 'r[0] = 0x0004F138', "slot_py": None, "target": None, "cond": None},
    0x4f04a: {"kind": 'st', "py": 'local[0x3FC] = pr\n_wrw(ram, STACK_BASE + 0x3FC, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x4f04c: {"kind": 'fpu', "py": 'fr[4] = bits2f(_rdw(ram, 0x0004F138, 4))', "slot_py": None, "target": None, "cond": None},
    0x4f04e: {"kind": 'reg', "py": 'r[3] = 0xFFFFC068', "slot_py": None, "target": None, "cond": None},
    0x4f050: {"kind": 'reg', "py": 'r[2] = 0x00002500', "slot_py": None, "target": None, "cond": None},
    0x4f052: {"kind": "call", "py": None, "slot_py": 'r[4] = s8(_rdw(ram, 0xFFFFC068, 1))', "target": 0x2500, "ret_pc": 0x4f056, "set_pr": True, "cond": None},
    0x4f056: {"kind": 'reg', "py": 'r[1] = 0xFFFFCFC8', "slot_py": None, "target": None, "cond": None},
    0x4f058: {"kind": 'st', "py": 'pr = _rdw(ram, STACK_BASE + 0x3FC, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x4f05a: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFCFC8, 4, f2bits(fr[0]))', "target": None, "cond": None},
