#!/usr/bin/env python3
"""Differential test for FUN_00025b26 (0x25B26) — mem lift (RAM-only, straight-line), 8 bytes.
...
Run from repo root: python3 c/tests/test_FUN_00025b26_25b26.py
"""
...
ENTRY = 0x25B26
RAW = bytes.fromhex("24 E0 63 40 63 3C 43 15")
SEED = 42
N = 2000
...
def spec_mirror(r4, r5, r6, r7, ram, stack_top):
    ...
    r[3] = s8(_rdw(ram, r[4], 1))
    # 0x025B2A: op 0x633C
    r[3] = r[3] & 0xFF
    # 0x025B2C: op 0x4315
    T = 1 if s32(r[3]) > 0 else 0
    r[15] = sp
