#!/usr/bin/env python3
"""Differential test for fault_cd0c_load_gated (0x4A9C0) — v3 lift (branches + delay slots), 66 bytes.
...
Run from repo root: python3 c/tests/test_fault_cd0c_load_gated_4a9c0.py
"""
...
ENTRY = 0x4A9C0
RAW = bytes.fromhex("90 71 D5 3D 63 50 23 38 8F 19 64 00 60 4C 88 01 8F 15 00 09 D3 39 62 30 22 28 8F 10 00 09 D6 38 90 62 60 00 C8 80 8F 04 00 09 92 5E 61 21 A0 03 26 11 D3 34 60 31 26 01 D1 30 E2 01 21 20 00 0B 25 40")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCD1A
SPAN_END = 0x4AA02
SENT = 0x4AA02     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x4a9c0: {"kind": 'reg', "py": 'r[0] = 0xFFFFC4DC', "slot_py": None, "target": None, "cond": None},
    0x4a9c2: {"kind": 'reg', "py": 'r[5] = 0xFFFFCD1A', "slot_py": None, "target": None, "cond": None},
    0x4a9c4: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFCD1A, 1))', "slot_py": None, "target": None, "cond": None},
    0x4a9c6: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x4a9c8: {"kind": "branch", "py": None, "slot_py": 'r[4] = s8(_rdw(ram, 0xFFFFC4DC, 1))', "target": 0x4a9fe, "cond": 'notT'},
    0x4a9cc: {"kind": 'reg', "py": 'r[0] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x4a9ce: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x4a9d0: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4a9fe, "cond": 'notT'},
    0x4a9d4: {"kind": 'reg', "py": 'r[3] = 0xFFFFCD19', "slot_py": None, "target": None, "cond": None},
    0x4a9d6: {"kind": 'mem', "py": 'r[2] = s8(_rdw(ram, 0xFFFFCD19, 1))', "slot_py": None, "target": None, "cond": None},
    0x4a9d8: {"kind": 'reg', "py": 'T = 1 if (r[2] & r[2]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x4a9da: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4a9fe, "cond": 'notT'},
    0x4a9de: {"kind": 'reg', "py": 'r[6] = 0xFFFFCD0C', "slot_py": None, "target": None, "cond": None},
    0x4a9e0: {"kind": 'reg', "py": 'r[0] = 0xFFFFCBD4', "slot_py": None, "target": None, "cond": None},
    0x4a9e2: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCBD4, 1))', "slot_py": None, "target": None, "cond": None},
    0x4a9e4: {"kind": 'reg', "py": 'T = 1 if (r[0] & 0x80) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x4a9e6: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4a9f2, "cond": 'notT'},
    0x4a9ea: {"kind": 'reg', "py": 'r[2] = 0xFFFFC4DE', "slot_py": None, "target": None, "cond": None},
    0x4a9ec: {"kind": 'mem', "py": 'r[1] = s16(_rdw(ram, 0xFFFFC4DE, 2))', "slot_py": None, "target": None, "cond": None},
    0x4a9ee: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFCD0C, 2, r[1])', "target": 0x4a9f8, "cond": 'always'},
    0x4a9f2: {"kind": 'reg', "py": 'r[3] = 0x0007B7AA', "slot_py": None, "target": None, "cond": None},
    0x4a9f4: {"kind": 'mem', "py": 'r[0] = s16(_rdw(ram, 0x0007B7AA, 2))', "slot_py": None, "target": None, "cond": None},
    0x4a9f6: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCD0C, 2, r[0])', "slot_py": None, "target": None, "cond": None},
    0x4a9f8: {"kind": 'reg', "py": 'r[1] = 0xFFFFCD19', "slot_py": None, "target": None, "cond": None},
    0x4a9fa: {"kind": 'reg', "py": 'r[2] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x4a9fc: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCD19, 1, r[2])', "slot_py": None, "target": None, "cond": None},
    0x4a9fe: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFCD1A, 1, r[4])', "target": None, "cond": None},}
