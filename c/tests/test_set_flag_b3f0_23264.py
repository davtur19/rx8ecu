#!/usr/bin/env python3
"""Differential test for set_flag_b3f0 (0x23264) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_set_flag_b3f0_23264.py
"""
...
ENTRY = 0x23264
RAW = bytes.fromhex("92 78 E3 01 00 0B 22 30")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFB3F0
SPAN_END = 0x2326C
SENT = 0x2326C     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x23264: {"kind": 'reg', "py": 'r[2] = 0xFFFFB3F0', "slot_py": None, "target": None, "cond": None},
    0x23266: {"kind": 'reg', "py": 'r[3] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x23268: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFB3F0, 1, r[3])', "target": None, "cond": None},}
