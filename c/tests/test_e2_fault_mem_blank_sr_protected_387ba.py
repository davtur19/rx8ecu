#!/usr/bin/env python3
"""Differential test for e2_fault_mem_blank_sr_protected (0x387BA) — v3 lift (branches + delay slots), 12 bytes.
...
Run from repo root: python3 c/tests/test_e2_fault_mem_blank_sr_protected_387ba.py
"""
...
ENTRY = 0x387BA
RAW = bytes.fromhex("4F 26 6B F6 6C F6 6D F6 00 0B 6E F6")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = None
SPAN_END = 0x387C6
SENT = 0x387C6     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x387ba: {"kind": 'mem', "py": 'pr = _rdw(ram, STACK_BASE + 0x400, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x387bc: {"kind": 'mem', "py": 'r[11] = _rdw(ram, STACK_BASE + 0x404, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x387be: {"kind": 'mem', "py": 'r[12] = _rdw(ram, STACK_BASE + 0x408, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x387c0: {"kind": 'mem', "py": 'r[13] = _rdw(ram, STACK_BASE + 0x40C, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x387c2: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, STACK_BASE + 0x410, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},}
