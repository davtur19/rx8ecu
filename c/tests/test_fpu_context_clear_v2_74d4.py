#!/usr/bin/env python3
"""Differential test for fpu_context_clear_v2 (0x74D4) — v3 lift (branches + delay slots), 12 bytes.
...
Run from repo root: python3 c/tests/test_fpu_context_clear_v2_74d4.py
"""
...
ENTRY = 0x74D4
RAW = bytes.fromhex("D3 3A 00 0B 23 40 D2 3A 00 0B 22 40")
SEED = 43
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFF9FA4
SPAN_END = 0x74E0
SENT = 0x74E0     # stop-sentinel, placed past the literal pool
...
CODE = {
    ...
    0x74da: {"kind": 'reg', "py": 'r[2] = 0xFFFF9FA4', "slot_py": None, "target": None, "cond": None},
    0x74dc: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFF9FA4, 1, r[4])', "target": None, "cond": None},}
