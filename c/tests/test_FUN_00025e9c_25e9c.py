#!/usr/bin/env python3
"""Differential test for FUN_00025e9c (0x25E9C) — v3 lift + v4 FPU, 10 bytes.
...
Run from repo root: python3 c/tests/test_FUN_00025e9c_25e9c.py
"""
...
ENTRY = 0x25E9C
RAW = bytes.fromhex("D3 12 F3 38 92 1F 00 0B F2 3A")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFB5D8
SPAN_END = 0x25EA6
SENT = 0x25EA6     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x25e9c: {"kind": 'reg', "py": 'r[3] = 0xFFFF9F68', "slot_py": None, "target": None, "cond": None},
    0x25e9e: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFF9F68, 4))', "slot_py": None, "target": None, "cond": None},
    0x25ea0: {"kind": 'reg', "py": 'r[2] = 0xFFFFB5D8', "slot_py": None, "target": None, "cond": None},
    0x25ea2: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFB5D8, 4, f2bits(fr[3]))', "target": None, "cond": None},}
