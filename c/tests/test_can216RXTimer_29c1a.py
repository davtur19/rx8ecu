#!/usr/bin/env python3
"""Differential test for can216RXTimer (0x29C1A) — v3 lift (branches + delay slots), 40 bytes.
...
Run from repo root: python3 c/tests/test_can216RXTimer_29c1a.py
"""
...
CODE = {
    0x29c1a: {"kind": 'reg', "py": 'r[6] = 0x0000FFFF', "slot_py": None, "target": None, "cond": None},
    0x29c1c: {"kind": 'reg', "py": 'r[5] = 0xFFFFBB3A', "slot_py": None, "target": None, "cond": None},
    0x29c1e: {"kind": 'reg', "py": 'r[2] = 0xFFFFBB3C', "slot_py": None, "target": None, "cond": None},
    0x29c20: {"kind": 'mem', "py": 'r[3] = s16(_rdw(ram, 0xFFFFBB3C, 2))', "slot_py": None, "target": None, "cond": None},
    0x29c22: {"kind": 'reg', "py": 'r[3] = r[3] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x29c24: {"kind": 'reg', "py": 'T = 1 if r[3] == r[6] else 0', "slot_py": None, "target": None, "cond": None},
    0x29c26: {"kind": "branch", "py": None, "slot_py": '', "target": 0x29c30, "cond": 'T'},
    0x29c2a: {"kind": 'reg', "py": 'r[1] = s8(0x3E)', "slot_py": None, "target": None, "cond": None},
    0x29c2c: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFBB3A, 2, r[1])', "target": 0x29c3e, "cond": 'always'},
    0x29c30: {"kind": 'mem', "py": 'r[4] = s16(_rdw(ram, 0xFFFFBB3A, 2))', "slot_py": None, "target": None, "cond": None},
    0x29c32: {"kind": 'reg', "py": 'r[1] = r[4] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x29c34: {"kind": 'reg', "py": 'T = 1 if s32(r[1]) > 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x29c36: {"kind": "branch", "py": None, "slot_py": '', "target": 0x29c3e, "cond": 'notT'},
    0x29c3a: {"kind": 'reg', "py": 'r[4] = (r[4] + r[6]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x29c3c: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBB3A, 2, r[4])', "slot_py": None, "target": None, "cond": None},
    0x29c3e: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
