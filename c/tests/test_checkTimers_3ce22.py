#!/usr/bin/env python3
"""Differential test for checkTimers (0x3CE22) — v3 lift (branches + delay slots), 38 bytes.
...
Run from repo root: python3 c/tests/test_checkTimers_3ce22.py
"""
...
ENTRY = 0x3CE22
RAW = bytes.fromhex("96 36 95 36 64 50 63 4C 43 15 8F 02 00 09 34 6C 25 40 D5 20 64 50 63 4C 43 15 8F 02 00 09 34 6C 25 40 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFC5E3
SPAN_END = 0x3CE48
SENT = 0x3CE48     # stop-sentinel, placed past the literal pool
...
CODE = {
    ...
    0x3ce36: {"kind": 'mem', "py": 'r[4] = s8(_rdw(ram, 0xFFFFC5E3, 1))', "slot_py": None, "target": None, "cond": None},
    ...
    0x3ce42: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC5E3, 1, r[4])', "slot_py": None, "target": None, "cond": None},
