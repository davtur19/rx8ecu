#!/usr/bin/env python3
"""Differential test for float_copy_ad84_to_cc20 (0x48B54) — v3 lift + v4 FPU, 10 bytes.
...
Run from repo root: python3 c/tests/test_float_copy_ad84_to_cc20_48b54.py
"""
...
ENTRY = 0x48B54
RAW = bytes.fromhex("93 64 F3 38 D2 35 00 0B F2 3A")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCC20
SPAN_END = 0x48B5E
SENT = 0x48B5E     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x48b54: {"kind": 'reg', "py": 'r[3] = 0xFFFFAD84', "slot_py": None, "target": None, "cond": None},
    0x48b56: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFAD84, 4))', "slot_py": None, "target": None, "cond": None},
    0x48b58: {"kind": 'reg', "py": 'r[2] = 0xFFFFCC20', "slot_py": None, "target": None, "cond": None},
    0x48b5a: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFCC20, 4, f2bits(fr[3]))', "target": None, "cond": None},}
