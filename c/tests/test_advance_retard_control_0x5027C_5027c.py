#!/usr/bin/env python3
"""Differential test for advance_retard_control_0x5027C (0x5027C) — v3 lift (branches + delay slots), 16 bytes.
...
Run from repo root: python3 c/tests/test_advance_retard_control_0x5027C_5027c.py
"""
...
ENTRY = 0x5027C
RAW = bytes.fromhex("20 08 8F 03 00 09 E2 01 93 27 23 20 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
