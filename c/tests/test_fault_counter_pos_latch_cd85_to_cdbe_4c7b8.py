#!/usr/bin/env python3
"""Differential test for fault_counter_pos_latch_cd85_to_cdbe (0x4C7B8) — v3 lift (branches + delay slots), 28 bytes.
...
Run from repo root: python3 c/tests/test_fault_counter_pos_latch_cd85_to_cdbe_4c7b8.py
"""
...
ENTRY = 0x4C7B8
RAW = bytes.fromhex("94 55 92 55 63 20 63 3C 43 15 8F 03 00 09 E1 01 A0 02 24 10 E0 00 24 00 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCDBE
SPAN_END = 0x4C7D4
SENT = 0x4C7D4     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x4c7b8: {"kind": 'reg', "py": 'r[4] = 0xFFFFCDBE', "slot_py": None, "target": None, "cond": None},
    0x4c7ba: {"kind": 'reg', "py": 'r[2] = 0xFFFFCD85', "slot_py": None, "target": None, "cond": None},
    0x4c7bc: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFCD85, 1))', "slot_py": None, "target": None, "cond": None},
    0x4c7be: {"kind": 'reg', "py": 'r[3] = r[3] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x4c7c0: {"kind": 'reg', "py": 'T = 1 if s32(r[3]) > 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x4c7c2: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4c7cc, "cond": 'notT'},
    0x4c7c6: {"kind": 'reg', "py": 'r[1] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x4c7c8: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFCDBE, 1, r[1])', "target": 0x4c7d0, "cond": 'always'},
    0x4c7cc: {"kind": 'reg', "py": 'r[0] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x4c7ce: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCDBE, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x4c7d0: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
