#!/usr/bin/env python3
"""Differential test for is_eeprom_valid (0x624) — v3 lift (branches + delay slots), 18 bytes.
...
Run from repo root: python3 c/tests/test_is_eeprom_valid_624.py
"""
...
ENTRY = 0x624
RAW = bytes.fromhex("90 4D 60 00 60 0C 88 55 8F 01 E4 00 E4 01 00 0B 60 43")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    0x624: {"kind": 'reg', "py": 'r[0] = 0xFFFFDFEC', "slot_py": None, "target": None, "cond": None},
    0x626: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFDFEC, 1))', "slot_py": None, "target": None, "cond": None},
    0x628: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x62a: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x55) else 0', "slot_py": None, "target": None, "cond": None},
    0x62c: {"kind": "branch", "py": None, "slot_py": 'r[4] = s8(0x00)', "target": 0x632, "cond": 'notT'},
    0x630: {"kind": 'reg', "py": 'r[4] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x632: {"kind": "ret", "py": None, "slot_py": 'r[0] = r[4]', "target": None, "cond": None},}
