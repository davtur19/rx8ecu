#!/usr/bin/env python3
"""Differential test for caller_1A066 (entry 0x1A066) — v8 ST caller (CFG), 30 bytes.
...
Run: python3 test_caller_1A066.py
"""
...
CODE = {
    0x1a066: {"kind": 'st', "py": 'local[0x3FC] = pr\n_wrw(ram, STACK_BASE + 0x3FC, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x1a068: {"kind": 'reg', "py": 'r[0] = 0x0001A150', "slot_py": None, "target": None, "cond": None},
    0x1a06a: {"kind": 'fpu', "py": 'fr[7] = bits2f(_rdw(ram, 0x0001A150, 4))', "slot_py": None, "target": None, "cond": None},
    0x1a06c: {"kind": 'reg', "py": 'r[3] = 0x0006FA24', "slot_py": None, "target": None, "cond": None},
    0x1a06e: {"kind": 'fpu', "py": 'fr[6] = bits2f(_rdw(ram, 0x0006FA24, 4))', "slot_py": None, "target": None, "cond": None},
    0x1a070: {"kind": 'reg', "py": 'r[2] = 0xFFFFAA24', "slot_py": None, "target": None, "cond": None},
    0x1a072: {"kind": 'fpu', "py": 'fr[5] = bits2f(_rdw(ram, 0xFFFFAA24, 4))', "slot_py": None, "target": None, "cond": None},
    0x1a074: {"kind": 'reg', "py": 'r[1] = 0xFFFFAA20', "slot_py": None, "target": None, "cond": None},
    0x1a076: {"kind": 'reg', "py": 'r[3] = 0x000023B0', "slot_py": None, "target": None, "cond": None},
    0x1a078: {"kind": "call", "py": None, "slot_py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFAA20, 4))', "target": 0x23b0, "ret_pc": 0x1a07c, "set_pr": True, "cond": None},
    0x1a07c: {"kind": 'reg', "py": 'r[2] = 0xFFFFAA24', "slot_py": None, "target": None, "cond": None},
    0x1a07e: {"kind": 'st', "py": 'pr = _rdw(ram, STACK_BASE + 0x3FC, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x1a080: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFAA24, 4, f2bits(fr[0]))', "target": None, "cond": None},
