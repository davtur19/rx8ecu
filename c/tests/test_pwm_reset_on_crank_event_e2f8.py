#!/usr/bin/env python3
"""Differential test for pwm_reset_on_crank_event (0xE2F8) — v3 lift (branches + delay slots), 26 bytes.
...
Run from repo root: python3 c/tests/test_pwm_reset_on_crank_event_e2f8.py
"""
...
CODE = {
    0xe2f8: {"kind": 'reg', "py": 'r[3] = 0xFFFF9F8C', "slot_py": None, "target": None, "cond": None},
    0xe2fa: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFF9F8C, 1))', "slot_py": None, "target": None, "cond": None},
    0xe2fc: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0xe2fe: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0xe300: {"kind": "branch", "py": None, "slot_py": '', "target": 0xe30e, "cond": 'notT'},
    0xe304: {"kind": 'reg', "py": 'r[4] = 0x000000FF', "slot_py": None, "target": None, "cond": None},
    0xe306: {"kind": 'reg', "py": 'r[1] = 0xFFFFA414', "slot_py": None, "target": None, "cond": None},
    0xe308: {"kind": 'reg', "py": 'r[2] = 0xFFFFA415', "slot_py": None, "target": None, "cond": None},
    0xe30a: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA414, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0xe30c: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA415, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0xe30e: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
