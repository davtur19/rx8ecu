#!/usr/bin/env python3
"""Differential test for sensor_state_reset_ch0 (0x72A4) — v3 lift (branches + delay slots), 12 bytes.
...
Run from repo root: python3 c/tests/test_sensor_state_reset_ch0_72a4.py
"""
...
ENTRY = 0x72A4
RAW = bytes.fromhex("D4 02 E3 00 24 31 E0 01 00 0B 80 4A")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFF9F52
SPAN_END = 0x72B0
SENT = 0x72B4     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x72a4: {"kind": 'reg', "py": 'r[4] = 0xFFFF9F52', "slot_py": None, "target": None, "cond": None},
    0x72a6: {"kind": 'reg', "py": 'r[3] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x72a8: {"kind": 'mem', "py": '_wrw(ram, 0xFFFF9F52, 2, r[3])', "slot_py": None, "target": None, "cond": None},
    0x72aa: {"kind": 'reg', "py": 'r[0] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x72ac: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFF9F5C, 1, r[0])', "target": None, "cond": None},}
