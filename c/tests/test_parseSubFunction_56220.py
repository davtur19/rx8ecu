#!/usr/bin/env python3
"""Differential test for parseSubFunction (0x56220) — v3 lift (branches + delay slots), 58 bytes.
...
Run from repo root: python3 c/tests/test_parseSubFunction_56220.py
"""
...
ENTRY = 0x56220
RAW = bytes.fromhex("E5 01 60 4C 88 01 8D 05 E6 00 88 04 8D 0A 00 09 A0 10 00 09 93 11 60 30 60 0C 88 01 8F 0B 00 09 A0 09 65 63 93 0A 60 30 60 0C 88 01 8F 03 00 09 A0 01 65 63 65 63 00 0B 60 53")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCFE1
SPAN_END = 0x5625A
SENT = 0x5625E     # stop-sentinel, placed past the literal pool
...
CODE = {
    ...
    0x56236: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCFE0, 1))', "slot_py": None, "target": None, "cond": None},
