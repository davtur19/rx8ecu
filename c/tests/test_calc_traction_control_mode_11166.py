#!/usr/bin/env python3
"""Differential test for calc_traction_control_mode (0x11166) — v3 lift (branches + delay slots), 20 bytes.
...
Run from repo root: python3 c/tests/test_calc_traction_control_mode_11166.py
"""
...
CODE = {
    0x11166: {"kind": 'reg', "py": 'r[2] = 0xFFFFA7AC', "slot_py": None, "target": None, "cond": None},
    0x11168: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFA7AC, 1))', "slot_py": None, "target": None, "cond": None},
    0x1116a: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x1116c: {"kind": "branch", "py": None, "slot_py": '', "target": 0x11174, "cond": 'notT'},
    0x11170: {"kind": "branch", "py": None, "slot_py": 'r[4] = s8(0x01)', "target": 0x11176, "cond": 'always'},
    0x11174: {"kind": 'reg', "py": 'r[4] = s8(0x02)', "slot_py": None, "target": None, "cond": None},
    0x11176: {"kind": "ret", "py": None, "slot_py": 'r[0] = r[4]', "target": None, "cond": None},}
