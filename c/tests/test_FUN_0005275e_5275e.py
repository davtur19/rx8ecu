#!/usr/bin/env python3
"""Differential test for FUN_0005275e (0x5275E) — v3 lift (branches + delay slots), 44 bytes.
...
Run from repo root: python3 c/tests/test_FUN_0005275e_5275e.py
"""
...
ENTRY = 0x5275E
RAW = bytes.fromhex("E4 01 93 2C 23 40 95 27 92 2A 60 20 60 0C 88 01 8D 06 00 09 91 25 60 10 60 0C 88 01 8F 02 00 09 A0 02 25 40 E3 00 25 30 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCFCF
SPAN_END = 0x5278A
SENT = 0x5278A     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x5275e: {"kind": 'reg', "py": 'r[4] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x52760: {"kind": 'reg', "py": 'r[3] = 0xFFFFCFCF', "slot_py": None, "target": None, "cond": None},
    0x52762: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCFCF, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x52764: {"kind": 'reg', "py": 'r[5] = 0xFFFFCFCC', "slot_py": None, "target": None, "cond": None},
    0x52766: {"kind": 'reg', "py": 'r[2] = 0xFFFFC82D', "slot_py": None, "target": None, "cond": None},
    0x52768: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFC82D, 1))', "slot_py": None, "target": None, "cond": None},
    0x5276a: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x5276c: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x5276e: {"kind": "branch", "py": None, "slot_py": '', "target": 0x5277e, "cond": 'T'},
    0x52772: {"kind": 'reg', "py": 'r[1] = 0xFFFFC830', "slot_py": None, "target": None, "cond": None},
    0x52774: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFC830, 1))', "slot_py": None, "target": None, "cond": None},
    0x52776: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x52778: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x5277a: {"kind": "branch", "py": None, "slot_py": '', "target": 0x52782, "cond": 'notT'},
    0x5277e: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFCFCC, 1, r[4])', "target": 0x52786, "cond": 'always'},
    0x52782: {"kind": 'reg', "py": 'r[3] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x52784: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCFCC, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x52786: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
