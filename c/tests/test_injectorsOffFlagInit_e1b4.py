#!/usr/bin/env python3
"""Differential test for injectorsOffFlagInit (0xE1B4) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_injectorsOffFlagInit_e1b4.py
"""
...
ENTRY = 0xE1B4
RAW = bytes.fromhex("92 0F E3 01 00 0B 22 30")
SEED = 0
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFA41C
SPAN_END = 0xE1BC
SENT = 0xE1BC     # stop-sentinel, placed past the literal pool
...
CODE = {
    0xe1b4: {"kind": 'reg', "py": 'r[2] = 0xFFFFA41C', "slot_py": None, "target": None, "cond": None},
    0xe1b6: {"kind": 'reg', "py": 'r[3] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0xe1b8: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFA41C, 1, r[3])', "target": None, "cond": None},}
