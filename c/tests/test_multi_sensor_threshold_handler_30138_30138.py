#!/usr/bin/env python3
"""Differential test for multi_sensor_threshold_handler_30138 (0x30138) — v3 lift (branches + delay slots), 44 bytes.
...
Run from repo root: python3 c/tests/test_multi_sensor_threshold_handler_30138_30138.py
"""
...
ENTRY = 0x30138
RAW = bytes.fromhex("D1 1B 62 11 33 26 8D 07 00 09 60 C3 88 01 8F 03 00 09 E3 01 A0 01 24 30 24 E0 7F 04 4F 26 69 F6 6A F6 6B F6 6C F6 6D F6 00 0B 6E F6")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = None
SPAN_END = 0x30164
SENT = 0x30164     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x30138: {"kind": 'reg', "py": 'r[1] = 0x0007A7C8', "slot_py": None, "target": None, "cond": None},
    0x3013a: {"kind": 'mem', "py": 'r[2] = s16(_rdw(ram, 0x0007A7C8, 2))', "slot_py": None, "target": None, "cond": None},
    0x3013c: {"kind": 'reg', "py": 'T = 1 if (r[3] & 0xFFFFFFFF) > (r[2] & 0xFFFFFFFF) else 0', "slot_py": None, "target": None, "cond": None},
    0x3013e: {"kind": "branch", "py": None, "slot_py": '', "target": 0x30150, "cond": 'T'},
    0x30142: {"kind": 'reg', "py": 'r[0] = r[12]', "slot_py": None, "target": None, "cond": None},
    0x30144: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x30146: {"kind": "branch", "py": None, "slot_py": '', "target": 0x30150, "cond": 'notT'},
    0x3014a: {"kind": 'reg', "py": 'r[3] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x3014c: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, r[4], 1, r[3])', "target": 0x30152, "cond": 'always'},
    0x30150: {"kind": 'mem', "py": '_wrw(ram, r[4], 1, r[14])', "slot_py": None, "target": None, "cond": None},
    0x30152: {"kind": 'reg', "py": 'r[15] = (r[15] + s8(0x04)) & 0xFFFFFFFF\nsp = (sp + s8(0x04)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x30154: {"kind": 'mem', "py": 'pr = _rdw(ram, STACK_BASE + 0x404, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x30156: {"kind": 'mem', "py": 'r[9] = _rdw(ram, STACK_BASE + 0x408, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x30158: {"kind": 'mem', "py": 'r[10] = _rdw(ram, STACK_BASE + 0x40C, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x3015a: {"kind": 'mem', "py": 'r[11] = _rdw(ram, STACK_BASE + 0x410, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x3015c: {"kind": 'mem', "py": 'r[12] = _rdw(ram, STACK_BASE + 0x414, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x3015e: {"kind": 'mem', "py": 'r[13] = _rdw(ram, STACK_BASE + 0x418, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x30160: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, STACK_BASE + 0x41C, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},}
