#!/usr/bin/env python3
"""Differential test for state_init_27A0C (0x27A0C) — v3 lift (branches + delay slots), 42 bytes.
...
Run from repo root: python3 c/tests/test_state_init_27A0C_27a0c.py
"""
...
CODE = {
    0x27a0c: {"kind": 'reg', "py": 'r[3] = 0xFFFFB71C', "slot_py": None, "target": None, "cond": None},
    0x27a0e: {"kind": 'reg', "py": 'r[4] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x27a10: {"kind": 'reg', "py": 'r[1] = 0xFFFFD201', "slot_py": None, "target": None, "cond": None},
    0x27a12: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFB71C, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x27a14: {"kind": 'mem', "py": 'r[2] = s8(_rdw(ram, 0xFFFFD201, 1))', "slot_py": None, "target": None, "cond": None},
    0x27a16: {"kind": 'reg', "py": 'r[0] = 0xFFFFB730', "slot_py": None, "target": None, "cond": None},
    0x27a18: {"kind": 'reg', "py": 'r[1] = 0xFFFFB714', "slot_py": None, "target": None, "cond": None},
    0x27a1a: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFB730, 1, r[2])', "slot_py": None, "target": None, "cond": None},
    0x27a1c: {"kind": 'reg', "py": 'r[2] = 0x00075950', "slot_py": None, "target": None, "cond": None},
    0x27a1e: {"kind": 'reg', "py": 'r[0] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x27a20: {"kind": 'mem', "py": 'r[3] = s16(_rdw(ram, 0x00075950, 2))', "slot_py": None, "target": None, "cond": None},
    0x27a22: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFB714, 2, r[3])', "slot_py": None, "target": None, "cond": None},
    0x27a24: {"kind": 'reg', "py": 'r[3] = 0xFFFFB72E', "slot_py": None, "target": None, "cond": None},
    0x27a26: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFB72E, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x27a28: {"kind": 'reg', "py": 'r[0] = 0x0007594E', "slot_py": None, "target": None, "cond": None},
    0x27a2a: {"kind": 'mem', "py": 'r[2] = s16(_rdw(ram, 0x0007594E, 2))', "slot_py": None, "target": None, "cond": None},
    0x27a2c: {"kind": 'reg', "py": 'r[1] = 0xFFFFB716', "slot_py": None, "target": None, "cond": None},
    0x27a2e: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFB716, 2, r[2])', "slot_py": None, "target": None, "cond": None},
    0x27a30: {"kind": 'reg', "py": 'r[3] = 0xFFFFB72F', "slot_py": None, "target": None, "cond": None},
    0x27a32: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFB72F, 1, r[4])', "target": None, "cond": None},}
