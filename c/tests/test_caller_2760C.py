#!/usr/bin/env python3
"""Differential test for caller_2760C (entry 0x2760C) — v8 ST caller (CFG), 36 bytes.
...
Run: python3 test_caller_2760C.py
"""
...
CODE = {
    0x2760c: {"kind": 'st', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x2760e: {"kind": 'fpu', "py": 'fr[5] = 0.0', "slot_py": None, "target": None, "cond": None},
    0x27610: {"kind": 'reg', "py": 'r[3] = 0xFFFFADB4', "slot_py": None, "target": None, "cond": None},
    0x27612: {"kind": 'reg', "py": 'r[2] = 0x000023DC', "slot_py": None, "target": None, "cond": None},
    0x27614: {"kind": "call", "py": None, "slot_py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFADB4, 4))', "target": 0x23dc, "ret_pc": 0x27618, "set_pr": True, "cond": None},
    0x27618: {"kind": 'reg', "py": 'r[3] = 0x000751AC', "slot_py": None, "target": None, "cond": None},
    0x2761a: {"kind": 'fpu', "py": 'fr[4] = fr[0]', "slot_py": None, "target": None, "cond": None},
    0x2761c: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x000751AC, 4))', "slot_py": None, "target": None, "cond": None},
    0x2761e: {"kind": 'fpu', "py": 'T = 1 if fr[3] > fr[4] else 0', "slot_py": None, "target": None, "cond": None},
    0x27620: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2762a, "cond": 'T'},
    0x27624: {"kind": 'reg', "py": 'r[2] = 0xFFFFB6ED', "slot_py": None, "target": None, "cond": None},
    0x27626: {"kind": 'reg', "py": 'r[1] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x27628: {"kind": 'mem', "py": '_wrw(ram, r[2], 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x2762a: {"kind": 'st', "py": 'pr = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x2762c: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},
