#!/usr/bin/env python3
"""Differential test for serial_recv_0x5274C (0x5274C) — v3 lift (branches + delay slots), 18 bytes.
...
Run from repo root: python3 c/tests/test_serial_recv_0x5274C_5274c.py
"""
...
ENTRY = 0x5274C
RAW = bytes.fromhex("92 35 A0 03 22 30 E0 00 91 31 21 00 4F 26 00 0B 00 09")
SEED = 43
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCFCE
SPAN_END = 0x5275E
SENT = 0x5275E     # stop-sentinel, placed past the literal pool
