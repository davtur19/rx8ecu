#!/usr/bin/env python3
"""Differential test for fault_condition_check_5F018 (0x5F018) — v3 lift (branches + delay slots), 24 bytes.
...
Run from repo root: python3 c/tests/test_fault_condition_check_5F018_5f018.py
"""
...
CODE = {
    0x5f018: {"kind": 'reg', "py": 'r[1] = 0xFFFFD3C4', "slot_py": None, "target": None, "cond": None},
    0x5f01a: {"kind": 'mem', "py": 'r[2] = s8(_rdw(ram, 0xFFFFD3C4, 1))', "slot_py": None, "target": None, "cond": None},
    0x5f01c: {"kind": 'reg', "py": 'r[0] = 0xFFFFD3CC', "slot_py": None, "target": None, "cond": None},
    0x5f01e: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD3CC, 1, r[2])', "slot_py": None, "target": None, "cond": None},
    0x5f020: {"kind": 'reg', "py": 'r[2] = 0xFFFFD3C5', "slot_py": None, "target": None, "cond": None},
    0x5f022: {"kind": 'reg', "py": 'r[0] = s8(0x10)', "slot_py": None, "target": None, "cond": None},
    0x5f024: {"kind": 'reg', "py": 'r[1] = 0xFFFFD3CD', "slot_py": None, "target": None, "cond": None},
    0x5f026: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFD3C5, 1))', "slot_py": None, "target": None, "cond": None},
    0x5f028: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD3CD, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x5f02a: {"kind": 'reg', "py": 'r[3] = 0xFFFFD3CE', "slot_py": None, "target": None, "cond": None},
    0x5f02c: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFD3CE, 1, r[0])', "target": None, "cond": None},}
