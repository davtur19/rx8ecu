#!/usr/bin/env python3
"""Differential test for uds_mode22_data_getter_aa38 (0x550A4) — v3 lift (branches + delay slots), 26 bytes.
...
Run from repo root: python3 c/tests/test_uds_mode22_data_getter_aa38_550a4.py
"""
...
ENTRY = 0x550A4
RAW = bytes.fromhex("88 01 8F 04 00 09 E3 01 92 33 A0 03 22 30 E0 00 91 2F 21 00 4F 26 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFD1FA
SPAN_END = 0x550BE
SENT = 0x550BE     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x550a4: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x550a6: {"kind": "branch", "py": None, "slot_py": '', "target": 0x550b2, "cond": 'notT'},
    0x550aa: {"kind": 'reg', "py": 'r[3] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x550ac: {"kind": 'reg', "py": 'r[2] = 0xFFFFD1FA', "slot_py": None, "target": None, "cond": None},
    0x550ae: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFD1FA, 1, r[3])', "target": 0x550b8, "cond": 'always'},
    0x550b2: {"kind": 'reg', "py": 'r[0] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x550b4: {"kind": 'reg', "py": 'r[1] = 0xFFFFD1FA', "slot_py": None, "target": None, "cond": None},
    0x550b6: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD1FA, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x550b8: {"kind": 'mem', "py": 'pr = _rdw(ram, STACK_BASE + 0x400, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x550ba: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
