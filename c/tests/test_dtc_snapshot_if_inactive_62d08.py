#!/usr/bin/env python3
"""Differential test for dtc_snapshot_if_inactive (0x62D08) — v3 lift (branches + delay slots), 20 bytes.
...
Run from repo root: python3 c/tests/test_dtc_snapshot_if_inactive_62d08.py
"""
...
ENTRY = 0x62D08
RAW = bytes.fromhex("00 09 60 0C 20 08 8D 01 00 09 EE 01 4F 26 60 E3 00 0B 6E F6")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = None
SPAN_END = 0x62D1C
SENT = 0x62D1C     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x62d08: {"kind": 'reg', "py": None, "slot_py": None, "target": None, "cond": None},
    0x62d0a: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x62d0c: {"kind": 'reg', "py": 'T = 1 if (r[0] & r[0]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x62d0e: {"kind": "branch", "py": None, "slot_py": '', "target": 0x62d14, "cond": 'T'},
    0x62d12: {"kind": 'reg', "py": 'r[14] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x62d14: {"kind": 'mem', "py": 'pr = _rdw(ram, STACK_BASE + 0x400, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x62d16: {"kind": 'reg', "py": 'r[0] = r[14]', "slot_py": None, "target": None, "cond": None},
    0x62d18: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, STACK_BASE + 0x404, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},}
