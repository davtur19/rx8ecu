#!/usr/bin/env python3
"""Differential test for fpu_control_calc_31088 (0x31088) — v3 lift + v4 FPU, 76 bytes.
...
Run from repo root: python3 c/tests/test_fpu_control_calc_31088_31088.py
"""
...
RAM_MAX = 0xFFFFBEF8
SPAN_END = 0x310D4
SENT = 0x310D4     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x31088: {"kind": 'reg', "py": 'r[1] = 0xFFFFA428', "slot_py": None, "target": None, "cond": None},
    0x3108a: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFA428, 1))', "slot_py": None, "target": None, "cond": None},
    0x3108c: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x3108e: {"kind": "branch", "py": None, "slot_py": '', "target": 0x3109e, "cond": 'T'},
    0x31092: {"kind": 'reg', "py": 'r[2] = 0xFFFFBEA8', "slot_py": None, "target": None, "cond": None},
    0x31094: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFBEA8, 1))', "slot_py": None, "target": None, "cond": None},
    0x31096: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x31098: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) > 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x3109a: {"kind": "branch", "py": None, "slot_py": '', "target": 0x310d0, "cond": 'notT'},
    0x3109e: {"kind": 'reg', "py": 'r[3] = 0xFFFFBED4', "slot_py": None, "target": None, "cond": None},
    0x310a0: {"kind": 'reg', "py": 'r[2] = 0x00078248', "slot_py": None, "target": None, "cond": None},
    0x310a2: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFBED4, 4))', "slot_py": None, "target": None, "cond": None},
    0x310a4: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0x00078248, 4))', "slot_py": None, "target": None, "cond": None},
    0x310a6: {"kind": 'fpu', "py": 'fr[2] = ts(fr[2] * fr[3])', "slot_py": None, "target": None, "cond": None},
    0x310a8: {"kind": 'reg', "py": 'r[1] = 0xFFFFBEE8', "slot_py": None, "target": None, "cond": None},
    0x310aa: {"kind": 'fpu', "py": 'fr[1] = bits2f(_rdw(ram, 0xFFFFBEE8, 4))', "slot_py": None, "target": None, "cond": None},
    0x310ac: {"kind": 'reg', "py": 'r[2] = 0xFFFFBEEC', "slot_py": None, "target": None, "cond": None},
    0x310ae: {"kind": 'fpu', "py": 'fr[2] = ts(fr[2] * fr[1])', "slot_py": None, "target": None, "cond": None},
    0x310b0: {"kind": 'reg', "py": 'r[3] = 0xFFFFBEF0', "slot_py": None, "target": None, "cond": None},
    0x310b2: {"kind": 'fpu', "py": 'fr[0] = bits2f(_rdw(ram, 0xFFFFBEEC, 4))', "slot_py": None, "target": None, "cond": None},
    0x310b4: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFBEF0, 4))', "slot_py": None, "target": None, "cond": None},
    0x310b6: {"kind": 'fpu', "py": 'fr[2] = ts(fr[2] * fr[0])', "slot_py": None, "target": None, "cond": None},
    0x310b8: {"kind": 'reg', "py": 'r[2] = 0xFFFFBEF4', "slot_py": None, "target": None, "cond": None},
    0x310ba: {"kind": 'fpu', "py": 'fr[4] = fr[2]', "slot_py": None, "target": None, "cond": None},
    0x310bc: {"kind": 'reg', "py": 'r[3] = 0xFFFFBEC4', "slot_py": None, "target": None, "cond": None},
    0x310be: {"kind": 'fpu', "py": 'fr[4] = ts(fr[4] * fr[3])', "slot_py": None, "target": None, "cond": None},
    0x310c0: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0xFFFFBEF4, 4))', "slot_py": None, "target": None, "cond": None},
    0x310c2: {"kind": 'fpu', "py": 'fr[2] = ts(fr[2] * fr[4])', "slot_py": None, "target": None, "cond": None},
    0x310c4: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFBEC4, 4, f2bits(fr[2]))', "slot_py": None, "target": None, "cond": None},
    0x310c6: {"kind": 'reg', "py": 'r[1] = 0xFFFFBEF8', "slot_py": None, "target": None, "cond": None},
    0x310c8: {"kind": 'reg', "py": 'r[3] = 0xFFFFBEC8', "slot_py": None, "target": None, "cond": None},
    0x310ca: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFBEF8, 4))', "slot_py": None, "target": None, "cond": None},
    0x310cc: {"kind": 'fpu', "py": 'fr[3] = ts(fr[3] * fr[4])', "slot_py": None, "target": None, "cond": None},
    0x310ce: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFBEC8, 4, f2bits(fr[3]))', "slot_py": None, "target": None, "cond": None},
    0x310d0: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
