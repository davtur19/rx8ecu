#!/usr/bin/env python3
"""Differential test for dtc_code_set_46780 (0x46780) — v3 lift (branches + delay slots), 16 bytes.
...
Run from repo root: python3 c/tests/test_dtc_code_set_46780_46780.py
"""
...
ENTRY = 0x46780
RAW = bytes.fromhex("88 01 8F 02 00 09 A0 01 26 40 26 50 00 0B 6E F6")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = None
SPAN_END = 0x46790
SENT = 0x46790     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x46780: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x46782: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4678a, "cond": 'notT'},
    0x46786: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, r[6], 1, r[4])', "target": 0x4678c, "cond": 'always'},
    0x4678a: {"kind": 'mem', "py": '_wrw(ram, r[6], 1, r[5])', "slot_py": None, "target": None, "cond": None},
    0x4678c: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, STACK_BASE + 0x400, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},}
