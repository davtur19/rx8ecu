#!/usr/bin/env python3
"""Differential test for FUN_0002c15c (0x2C15C) — mem lift (RAM-only, straight-line), 8 bytes.
...
Run from repo root: python3 c/tests/test_FUN_0002c15c_2c15c.py
"""
...
ENTRY = 0x2C15C
RAW = bytes.fromhex("34 0C 25 41 D5 19 D2 1D")
SEED = 42
N = 2000
