#!/usr/bin/env python3
"""Differential test for fpu_compare_and_mac_394da (0x394DA) — pure straight-line lift, 8 bytes.
...
Run from repo root: python3 c/tests/test_fpu_compare_and_mac_394da_394da.py
"""
...
ENTRY = 0x394DA
RAW = bytes.fromhex("95 56 94 4D 92 55 D0 30")
SEED = 42
N = 2000
