#!/usr/bin/env python3
"""Differential test for knock_control_state_check_2AA1A (0x2AA1A) — v3 lift + v4 FPU, 52 bytes.
...
Run from repo root: python3 c/tests/test_knock_control_state_check_2AA1A_2aa1a.py
"""
...
ENTRY = 0x2AA1A
RAW = bytes.fromhex("94 38 93 38 F3 38 92 37 F2 28 F2 35 8D 0E 00 09 91 2C 60 10 60 0C 88 01 8F 08 00 09 92 27 60 20 20 08 8F 03 00 09 E1 01 A0 02 24 10 E2 00 24 20 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBB8F
SPAN_END = 0x2AA4E
SENT = 0x2AA4E     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x2aa1a: {"kind": 'reg', "py": 'r[4] = 0xFFFFBB8F', "slot_py": None, "target": None, "cond": None},
    0x2aa1c: {"kind": 'reg', "py": 'r[3] = 0xFFFFB488', "slot_py": None, "target": None, "cond": None},
    0x2aa1e: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFB488, 4))', "slot_py": None, "target": None, "cond": None},
    0x2aa20: {"kind": 'reg', "py": 'r[2] = 0xFFFFADBC', "slot_py": None, "target": None, "cond": None},
    0x2aa22: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0xFFFFADBC, 4))', "slot_py": None, "target": None, "cond": None},
    0x2aa24: {"kind": 'fpu', "py": 'T = 1 if fr[2] > fr[3] else 0', "slot_py": None, "target": None, "cond": None},
    0x2aa26: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2aa46, "cond": 'T'},
    0x2aa2a: {"kind": 'reg', "py": 'r[1] = 0xFFFFA428', "slot_py": None, "target": None, "cond": None},
    0x2aa2c: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFA428, 1))', "slot_py": None, "target": None, "cond": None},
    0x2aa2e: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x2aa30: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x2aa32: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2aa46, "cond": 'notT'},
    0x2aa36: {"kind": 'reg', "py": 'r[2] = 0xFFFFAADA', "slot_py": None, "target": None, "cond": None},
    0x2aa38: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFAADA, 1))', "slot_py": None, "target": None, "cond": None},
    0x2aa3a: {"kind": 'reg', "py": 'T = 1 if (r[0] & r[0]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x2aa3c: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2aa46, "cond": 'notT'},
    0x2aa40: {"kind": 'reg', "py": 'r[1] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x2aa42: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFBB8F, 1, r[1])', "target": 0x2aa4a, "cond": 'always'},
    0x2aa46: {"kind": 'reg', "py": 'r[2] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x2aa48: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBB8F, 1, r[2])', "slot_py": None, "target": None, "cond": None},
    0x2aa4a: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
