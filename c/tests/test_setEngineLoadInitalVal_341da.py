#!/usr/bin/env python3
"""Differential test for setEngineLoadInitalVal (0x341DA) — v3 lift + v4 FPU, 10 bytes.
...
Run from repo root: python3 c/tests/test_setEngineLoadInitalVal_341da.py
"""
...
RAM_MAX = 0xFFFFC0D8
SPAN_END = 0x341E4
SENT = 0x341E4     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x341da: {"kind": 'reg', "py": 'r[0] = 0x00078CE4', "slot_py": None, "target": None, "cond": None},
    0x341dc: {"kind": 'reg', "py": 'r[3] = 0xFFFFC0D8', "slot_py": None, "target": None, "cond": None},
    0x341de: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x00078CE4, 4))', "slot_py": None, "target": None, "cond": None},
    0x341e0: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFC0D8, 4, f2bits(fr[3]))', "target": None, "cond": None},}
