#!/usr/bin/env python3
"""Differential test for scheduler_execute_4BF78 (0x4BF78) — v3 lift (branches + delay slots), 66 bytes.
...
Run from repo root: python3 c/tests/test_scheduler_execute_4BF78_4bf78.py
"""
...
ENTRY = 0x4BF78
RAW = bytes.fromhex("00 09 92 1A 60 20 60 0C 88 01 8D 0C 00 09 93 15 60 30 60 0C 88 01 8D 06 00 09 92 10 60 20 60 0C 88 01 8F 02 00 09 92 0B 22 60 00 0B 00 09 CD 7C CE 4D CE 4A CF 0E CF 0F CF 11 CF 13 CF 15 CF 17 CD 7D")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCF17
SPAN_END = 0x4BFBA
SENT = 0x4BFBA     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x4bf78: {"kind": 'reg', "py": None, "slot_py": None, "target": None, "cond": None},
    0x4bf7a: {"kind": 'reg', "py": 'r[2] = 0xFFFFCF13', "slot_py": None, "target": None, "cond": None},
    0x4bf7c: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCF13, 1))', "slot_py": None, "target": None, "cond": None},
    0x4bf7e: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x4bf80: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x4bf82: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4bf9e, "cond": 'T'},
    0x4bf86: {"kind": 'reg', "py": 'r[3] = 0xFFFFCF15', "slot_py": None, "target": None, "cond": None},
    0x4bf88: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCF15, 1))', "slot_py": None, "target": None, "cond": None},
    0x4bf8a: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x4bf8c: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x4bf8e: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4bf9e, "cond": 'T'},
    0x4bf92: {"kind": 'reg', "py": 'r[2] = 0xFFFFCF17', "slot_py": None, "target": None, "cond": None},
    0x4bf94: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCF17, 1))', "slot_py": None, "target": None, "cond": None},
    0x4bf96: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x4bf98: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x4bf9a: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4bfa2, "cond": 'notT'},
    0x4bf9e: {"kind": 'reg', "py": 'r[2] = 0xFFFFCD7D', "slot_py": None, "target": None, "cond": None},
    0x4bfa0: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCD7D, 1, r[6])', "slot_py": None, "target": None, "cond": None},
    0x4bfa2: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},
    0x4bfa6: {"kind": 'mem', "py": '_wrw(ram, (gbr + r[0]), 1, _rdw(ram, (gbr + r[0]), 1) & 0x7C)', "slot_py": None, "target": None, "cond": None},
    0x4bfa8: {"kind": 'mem', "py": '_wrw(ram, (gbr + r[0]), 1, _rdw(ram, (gbr + r[0]), 1) ^ 0x4D)', "slot_py": None, "target": None, "cond": None},
    0x4bfaa: {"kind": 'mem', "py": '_wrw(ram, (gbr + r[0]), 1, _rdw(ram, (gbr + r[0]), 1) ^ 0x4A)', "slot_py": None, "target": None, "cond": None},
    0x4bfac: {"kind": 'mem', "py": '_wrw(ram, (gbr + r[0]), 1, _rdw(ram, (gbr + r[0]), 1) | 0x0E)', "slot_py": None, "target": None, "cond": None},
    0x4bfae: {"kind": 'mem', "py": '_wrw(ram, (gbr + r[0]), 1, _rdw(ram, (gbr + r[0]), 1) | 0x0F)', "slot_py": None, "target": None, "cond": None},
    0x4bfb0: {"kind": 'mem', "py": '_wrw(ram, (gbr + r[0]), 1, _rdw(ram, (gbr + r[0]), 1) | 0x11)', "slot_py": None, "target": None, "cond": None},}
