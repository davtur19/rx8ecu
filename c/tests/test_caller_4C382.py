#!/usr/bin/env python3
"""Differential test for caller_4C382 (entry 0x4C382) — v8 ST caller (CFG), 98 bytes.
...
Run: python3 test_caller_4C382.py
"""
...
CODE = {
    0x4c382: {"kind": 'st', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x4c384: {"kind": 'reg', "py": 'r[1] = 0xFFFFCDC7', "slot_py": None, "target": None, "cond": None},
    0x4c386: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFCDC7, 1))', "slot_py": None, "target": None, "cond": None},
    0x4c388: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x4c38a: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4c392, "cond": 'notT'},
    0x4c38e: {"kind": "branch", "py": None, "slot_py": 'r[4] = s8(0x00)', "target": 0x4c3b8, "cond": 'always'},
    0x4c3b8: {"kind": 'reg', "py": 'r[0] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x4c3ba: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x00) else 0', "slot_py": None, "target": None, "cond": None},
    0x4c3bc: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4c3d0, "cond": 'T'},
    0x4c3c0: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x4c3c2: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4c3d6, "cond": 'T'},
    0x4c3c6: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x02) else 0', "slot_py": None, "target": None, "cond": None},
    0x4c3c8: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4c3da, "cond": 'T'},
    0x4c3cc: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4c3dc, "cond": 'always'},
    0x4c3dc: {"kind": 'reg', "py": 'r[2] = 0xFFFFCDB2', "slot_py": None, "target": None, "cond": None},
    0x4c3de: {"kind": 'st', "py": 'pr = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x4c3e0: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFCDB2, 1, r[4])', "target": None, "cond": None, },
    0x4c3da: {"kind": 'reg', "py": 'r[4] = s8(0x20)', "slot_py": None, "target": None, "cond": None},
    0x4c3d6: {"kind": "branch", "py": None, "slot_py": 'r[4] = s8(0x40)', "target": 0x4c3dc, "cond": 'always'},
    0x4c3d0: {"kind": 'reg', "py": 'r[4] = 0x00000080', "slot_py": None, "target": None, "cond": None},
    0x4c3d2: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4c3dc, "cond": 'always'},
    0x4c392: {"kind": 'reg', "py": 'r[2] = 0x00011F54', "slot_py": None, "target": None, "cond": None},
    0x4c394: {"kind": "call", "py": None, "slot_py": '', "target": 0x11f54, "ret_pc": 0x4c398, "set_pr": True, "cond": None},
    0x4c398: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x4c39a: {"kind": 'reg', "py": 'T = 1 if (r[0] & r[0]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x4c39c: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4c3b2, "cond": 'T'},
    0x4c3a0: {"kind": 'reg', "py": 'r[0] = 0xFFFFCCE8', "slot_py": None, "target": None, "cond": None},
    0x4c3a2: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCCE8, 1))', "slot_py": None, "target": None, "cond": None},
    0x4c3a4: {"kind": 'reg', "py": 'T = 1 if (r[0] & 0x80) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x4c3a6: {"kind": 'reg', "py": 'r[0] = T;', "slot_py": None, "target": None, "cond": None},
    0x4c3a8: {"kind": 'reg', "py": 'r[0] = (r[0] + s8(0xFF)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x4c3aa: {"kind": 'reg', "py": 'r[0] = (-r[0]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x4c3ac: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x4c3ae: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4c3b6, "cond": 'notT'},
    0x4c3b2: {"kind": "branch", "py": None, "slot_py": 'r[4] = s8(0x01)', "target": 0x4c3b8, "cond": 'always'},
    0x4c3b6: {"kind": 'reg', "py": 'r[4] = s8(0x02)', "slot_py": None, "target": None, "cond": None},
