#!/usr/bin/env python3
"""Differential test for ram_byte_copy_2A314 (0x2A314) — v3 lift (branches + delay slots), 10 bytes.
...
Run from repo root: python3 c/tests/test_ram_byte_copy_2A314_2a314.py
"""
...
CODE = {
    0x2a314: {"kind": 'reg', "py": 'r[3] = 0xFFFFBB83', "slot_py": None, "target": None, "cond": None},
    0x2a316: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFBB83, 1))', "slot_py": None, "target": None, "cond": None},
    0x2a318: {"kind": 'reg', "py": 'r[2] = 0xFFFFBB94', "slot_py": None, "target": None, "cond": None},
    0x2a31a: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBB94, 1, r[0])', "target": None, "cond": None},}
