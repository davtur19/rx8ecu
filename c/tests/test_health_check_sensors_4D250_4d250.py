#!/usr/bin/env python3
"""Differential test for health_check_sensors_4D250 (0x4D250) — v3 lift + v4 FPU, 28 bytes.
...
Run from repo root: python3 c/tests/test_health_check_sensors_4D250_4d250.py
"""
...
ENTRY = 0x4D250
RAW = bytes.fromhex("92 73 E3 0C D4 44 22 30 F3 48 93 6F F3 3A F3 48 91 6D F1 3A F3 48 92 6B 00 0B F2 3A")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCFA1
SPAN_END = 0x4D26C
SENT = 0x4D26C     # stop-sentinel, placed past the literal pool
