#!/usr/bin/env python3
"""Differential test for float_add_27764 (0x27764) — v3 lift + v4 FPU, 16 bytes.
...
Run from repo root: python3 c/tests/test_float_add_27764_27764.py
"""
...
ENTRY = 0x27764
RAW = bytes.fromhex("D2 09 F3 28 91 06 F2 18 93 06 F2 30 00 0B F3 2A")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFB6CC
SPAN_END = 0x27774
SENT = 0x27774     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x27764: {"kind": 'reg', "py": 'r[2] = 0x00075574', "slot_py": None, "target": None, "cond": None},
    0x27766: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x00075574, 4))', "slot_py": None, "target": None, "cond": None},
    0x27768: {"kind": 'reg', "py": 'r[1] = 0xFFFFB5FC', "slot_py": None, "target": None, "cond": None},
    0x2776a: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0xFFFFB5FC, 4))', "slot_py": None, "target": None, "cond": None},
    0x2776c: {"kind": 'reg', "py": 'r[3] = 0xFFFFB6CC', "slot_py": None, "target": None, "cond": None},
    0x2776e: {"kind": 'fpu', "py": 'fr[2] = ts(fr[2] + fr[3])', "slot_py": None, "target": None, "cond": None},
    0x27770: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFB6CC, 4, f2bits(fr[2]))', "target": None, "cond": None},}
