#!/usr/bin/env python3
"""Differential test for caller_611C6 (entry 0x611C6) — v8 ST caller (CFG), 30 bytes.
...
Run: python3 test_caller_611C6.py
"""
...
CODE = {
    0x611c6: {"kind": 'st', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x611c8: {"kind": 'reg', "py": 'r[2] = 0xFFFF87C8', "slot_py": None, "target": None, "cond": None},
    0x611ca: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFF87C8, 1))', "slot_py": None, "target": None, "cond": None},
    0x611cc: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x611ce: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x611d0: {"kind": "branch", "py": None, "slot_py": '', "target": 0x611de, "cond": 'notT'},
    0x611d4: {"kind": 'reg', "py": 'r[1] = 0x00002420', "slot_py": None, "target": None, "cond": None},
    0x611d6: {"kind": "call", "py": None, "slot_py": 'r[4] = s8(0x00)', "target": 0x2420, "ret_pc": 0x611da, "set_pr": True, "cond": None},
    0x611da: {"kind": 'reg', "py": 'r[3] = 0xFFFF87C8', "slot_py": None, "target": None, "cond": None},
    0x611dc: {"kind": 'mem', "py": '_wrw(ram, 0xFFFF87C8, 2, r[0])', "slot_py": None, "target": None, "cond": None},
    0x611de: {"kind": 'st', "py": 'pr = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x611e0: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},
