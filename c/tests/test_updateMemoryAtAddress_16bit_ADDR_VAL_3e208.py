#!/usr/bin/env python3
"""Differential test for updateMemoryAtAddress_16bit_ADDR_VAL (0x3E208) — v3 lift (branches + delay slots), 16 bytes.
...
Run from repo root: python3 c/tests/test_updateMemoryAtAddress_16bit_ADDR_VAL_3e208.py
"""
...
ENTRY = 0x3E208
RAW = bytes.fromhex("63 5D 43 28 62 57 62 2D 33 2C 24 32 00 0B E0 00")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = None
SPAN_END = 0x3E218
SENT = 0x3E218     # stop-sentinel, placed past the literal pool
