#!/usr/bin/env python3
"""Differential test for init_adc_4B4F0 (0x4B4F0) — v3 lift (branches + delay slots), 34 bytes.
...
Run from repo root: python3 c/tests/test_init_adc_4B4F0_4b4f0.py
"""
...
CODE = {
    0x4b4f0: {"kind": 'reg', "py": 'r[3] = 0xFFFFCE06', "slot_py": None, "target": None, "cond": None},
    0x4b4f2: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCE06, 1))', "slot_py": None, "target": None, "cond": None},
    0x4b4f4: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x4b4f6: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x4b4f8: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4b508, "cond": 'T'},
    0x4b4fc: {"kind": 'reg', "py": 'r[2] = 0xFFFFD201', "slot_py": None, "target": None, "cond": None},
    0x4b4fe: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFD201, 1))', "slot_py": None, "target": None, "cond": None},
    0x4b500: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x4b502: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x4b504: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4b50e, "cond": 'notT'},
    0x4b508: {"kind": 'reg', "py": 'r[2] = 0xFFFFCDFE', "slot_py": None, "target": None, "cond": None},
    0x4b50a: {"kind": 'reg', "py": 'r[3] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x4b50c: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCDFE, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x4b50e: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
