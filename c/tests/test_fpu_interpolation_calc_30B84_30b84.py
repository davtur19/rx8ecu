#!/usr/bin/env python3
"""Differential test for fpu_interpolation_calc_30B84 (0x30B84) — v3 lift + v4 FPU, 70 bytes.
...
Run from repo root: python3 c/tests/test_fpu_interpolation_calc_30B84_30b84.py
"""
...
RAM_MAX = 0xFFFFBE64
SPAN_END = 0x30BCA
SENT = 0x30BCA     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x30b84: {"kind": 'reg', "py": 'r[3] = 0xFFFFAE54', "slot_py": None, "target": None, "cond": None},
    0x30b86: {"kind": 'fpu', "py": 'fr[6] = 1.0', "slot_py": None, "target": None, "cond": None},
    0x30b88: {"kind": 'reg', "py": 'r[1] = 0xFFFFBE5C', "slot_py": None, "target": None, "cond": None},
    0x30b8a: {"kind": 'fpu', "py": 'fr[3] = fr[6]', "slot_py": None, "target": None, "cond": None},
    0x30b8c: {"kind": 'fpu', "py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFAE54, 4))', "slot_py": None, "target": None, "cond": None},
    0x30b8e: {"kind": 'reg', "py": 'r[2] = 0xFFFFAA10', "slot_py": None, "target": None, "cond": None},
    0x30b90: {"kind": 'reg', "py": 'r[4] = 0x00077A38', "slot_py": None, "target": None, "cond": None},
    0x30b92: {"kind": 'fpu', "py": 'fr[5] = bits2f(_rdw(ram, 0xFFFFAA10, 4))', "slot_py": None, "target": None, "cond": None},
    0x30b94: {"kind": 'fpu', "py": 'fr[0] = bits2f(_rdw(ram, r[4], 4))', "slot_py": None, "target": None, "cond": None},
    0x30b96: {"kind": 'fpu', "py": 'fr[3] = ts(fr[3] - fr[0])', "slot_py": None, "target": None, "cond": None},
    0x30b98: {"kind": 'reg', "py": 'r[4] = 0x00077A3C', "slot_py": None, "target": None, "cond": None},
    0x30b9a: {"kind": 'fpu', "py": 'fr[2] = fr[0]', "slot_py": None, "target": None, "cond": None},
    0x30b9c: {"kind": 'reg', "py": 'r[3] = 0xFFFFBE60', "slot_py": None, "target": None, "cond": None},
    0x30b9e: {"kind": 'fpu', "py": 'fr[2] = ts(fr[2] * fr[5])', "slot_py": None, "target": None, "cond": None},
    0x30ba0: {"kind": 'fpu', "py": 'fr[0] = fr[4]', "slot_py": None, "target": None, "cond": None},
    0x30ba2: {"kind": 'fpu', "py": 'fr[2] = ts(fr[0] * fr[3] + fr[2])', "slot_py": None, "target": None, "cond": None},
    0x30ba4: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFBE5C, 4, f2bits(fr[2]))', "slot_py": None, "target": None, "cond": None},
    0x30ba6: {"kind": 'fpu', "py": 'fr[3] = fr[6]', "slot_py": None, "target": None, "cond": None},
    0x30ba8: {"kind": 'fpu', "py": 'fr[0] = bits2f(_rdw(ram, r[4], 4))', "slot_py": None, "target": None, "cond": None},
    0x30baa: {"kind": 'fpu', "py": 'fr[3] = ts(fr[3] - fr[0])', "slot_py": None, "target": None, "cond": None},
    0x30bac: {"kind": 'reg', "py": 'r[4] = 0x00077A40', "slot_py": None, "target": None, "cond": None},
    0x30bae: {"kind": 'fpu', "py": 'fr[1] = fr[0]', "slot_py": None, "target": None, "cond": None},
    0x30bb0: {"kind": 'fpu', "py": 'fr[1] = ts(fr[1] * fr[5])', "slot_py": None, "target": None, "cond": None},
    0x30bb2: {"kind": 'fpu', "py": 'fr[0] = fr[4]', "slot_py": None, "target": None, "cond": None},
    0x30bb4: {"kind": 'fpu', "py": 'fr[1] = ts(fr[0] * fr[3] + fr[1])', "slot_py": None, "target": None, "cond": None},
    0x30bb6: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFBE60, 4, f2bits(fr[1]))', "slot_py": None, "target": None, "cond": None},
    0x30bb8: {"kind": 'fpu', "py": 'fr[0] = bits2f(_rdw(ram, r[4], 4))', "slot_py": None, "target": None, "cond": None},
    0x30bba: {"kind": 'fpu', "py": 'fr[6] = ts(fr[6] - fr[0])', "slot_py": None, "target": None, "cond": None},
    0x30bbc: {"kind": 'fpu', "py": 'fr[3] = fr[0]', "slot_py": None, "target": None, "cond": None},
    0x30bbe: {"kind": 'fpu', "py": 'fr[3] = ts(fr[3] * fr[5])', "slot_py": None, "target": None, "cond": None},
    0x30bc0: {"kind": 'reg', "py": 'r[2] = 0xFFFFBE64', "slot_py": None, "target": None, "cond": None},
    0x30bc2: {"kind": 'fpu', "py": 'fr[0] = fr[4]', "slot_py": None, "target": None, "cond": None},
    0x30bc4: {"kind": 'fpu', "py": 'fr[3] = ts(fr[0] * fr[6] + fr[3])', "slot_py": None, "target": None, "cond": None},
    0x30bc6: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBE64, 4, f2bits(fr[3]))', "target": None, "cond": None},}
