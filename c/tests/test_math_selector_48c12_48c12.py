#!/usr/bin/env python3
"""Differential test for math_selector_48c12 (0x48C12) — v3 lift (branches + delay slots), 48 bytes.
...
Run from repo root: python3 c/tests/test_math_selector_48c12_48c12.py
"""
...
CODE = {
    0x48c12: {"kind": 'reg', "py": 'r[7] = 0xFFFFCCE2', "slot_py": None, "target": None, "cond": None},
    0x48c14: {"kind": 'reg', "py": 'r[6] = 0xFFFFCCE3', "slot_py": None, "target": None, "cond": None},
    0x48c16: {"kind": 'reg', "py": 'r[3] = 0xFFFFCCD2', "slot_py": None, "target": None, "cond": None},
    0x48c18: {"kind": 'mem', "py": 'r[5] = s8(_rdw(ram, 0xFFFFCCD2, 1))', "slot_py": None, "target": None, "cond": None},
    0x48c1a: {"kind": 'reg', "py": 'r[5] = r[5] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x48c1c: {"kind": 'reg', "py": 'T = 1 if (r[5] & r[5]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x48c1e: {"kind": "branch", "py": None, "slot_py": 'r[4] = s8(0x00)', "target": 0x48c28, "cond": 'notT'},
    0x48c22: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCCE2, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x48c24: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFCCE3, 1, r[4])', "target": 0x48c3e, "cond": 'always'},
    0x48c28: {"kind": 'reg', "py": 'r[0] = r[5]', "slot_py": None, "target": None, "cond": None},
    0x48c2a: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x48c2c: {"kind": "branch", "py": None, "slot_py": '', "target": 0x48c38, "cond": 'notT'},
    0x48c30: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCCE2, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x48c32: {"kind": 'reg', "py": 'r[1] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x48c34: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFCCE3, 1, r[1])', "target": 0x48c3e, "cond": 'always'},
    0x48c38: {"kind": 'reg', "py": 'r[0] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x48c3a: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCCE2, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x48c3c: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCCE3, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x48c3e: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
