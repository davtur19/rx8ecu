#!/usr/bin/env python3
"""Differential test for reset_control_state_1D0C4 (0x1D0C4) — v3 lift (branches + delay slots), 12 bytes.
...
Run from repo root: python3 c/tests/test_reset_control_state_1D0C4_1d0c4.py
"""
