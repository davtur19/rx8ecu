#!/usr/bin/env python3
"""Differential test for idle_corr_sum_add_a884 (0x15D60) — v3 lift + v4 FPU, 22 bytes.
...
Run from repo root: python3 c/tests/test_idle_corr_sum_add_a884_15d60.py
"""
...
ENTRY = 0x15D60
RAW = bytes.fromhex("93 06 F3 38 92 05 F2 28 91 04 F2 30 00 0B F1 2A A7 A4 A8 C8 A8 84")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFA8C8
SPAN_END = 0x15D76
SENT = 0x15D76     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x15d60: {"kind": 'reg', "py": 'r[3] = 0xFFFFA7A4', "slot_py": None, "target": None, "cond": None},
    0x15d62: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFA7A4, 4))', "slot_py": None, "target": None, "cond": None},
    0x15d64: {"kind": 'reg', "py": 'r[2] = 0xFFFFA8C8', "slot_py": None, "target": None, "cond": None},
    0x15d66: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0xFFFFA8C8, 4))', "slot_py": None, "target": None, "cond": None},
    0x15d68: {"kind": 'reg', "py": 'r[1] = 0xFFFFA884', "slot_py": None, "target": None, "cond": None},
    0x15d6a: {"kind": 'fpu', "py": 'fr[2] = ts(fr[2] + fr[3])', "slot_py": None, "target": None, "cond": None},
    0x15d6c: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFA884, 4, f2bits(fr[2]))', "target": None, "cond": None},}
