#!/usr/bin/env python3
"""Differential test for byte_ramp_c942 (0x42FD4) — v3 lift (branches + delay slots), 50 bytes.
...
Run from repo root: python3 c/tests/test_byte_ramp_c942_42fd4.py
"""
...
RAM_MAX = 0xFFFFC99A
SPAN_END = 0x43006
SENT = 0x43006     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x42fd4: {"kind": 'reg', "py": 'r[2] = 0xFFFFAAC6', "slot_py": None, "target": None, "cond": None},
    0x42fd6: {"kind": 'reg', "py": 'r[7] = 0xFFFFC99A', "slot_py": None, "target": None, "cond": None},
    0x42fd8: {"kind": 'reg', "py": 'r[6] = 0xFFFFC942', "slot_py": None, "target": None, "cond": None},
    0x42fda: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFC99A, 1))', "slot_py": None, "target": None, "cond": None},
    0x42fdc: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x42fde: {"kind": "branch", "py": None, "slot_py": 'r[4] = s8(_rdw(ram, 0xFFFFAAC6, 1))', "target": 0x42ff2, "cond": 'notT'},
    0x42fe2: {"kind": 'reg', "py": 'r[0] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x42fe4: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x42fe6: {"kind": "branch", "py": None, "slot_py": '', "target": 0x42ff2, "cond": 'notT'},
    0x42fea: {"kind": 'reg', "py": 'r[3] = 0x0007A184', "slot_py": None, "target": None, "cond": None},
    0x42fec: {"kind": 'mem', "py": 'r[2] = s8(_rdw(ram, 0x0007A184, 1))', "slot_py": None, "target": None, "cond": None},
    0x42fee: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFC942, 1, r[2])', "target": 0x43002, "cond": 'always'},
    0x42ff2: {"kind": 'mem', "py": 'r[5] = s8(_rdw(ram, r[6], 1))', "slot_py": None, "target": None, "cond": None},
    0x42ff4: {"kind": 'reg', "py": 'r[3] = r[5] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x42ff6: {"kind": 'reg', "py": 'T = 1 if s32(r[3]) > 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x42ff8: {"kind": "branch", "py": None, "slot_py": '', "target": 0x43002, "cond": 'notT'},
    0x42ffc: {"kind": 'reg', "py": 'r[3] = 0x000000FF', "slot_py": None, "target": None, "cond": None},
    0x42ffe: {"kind": 'reg', "py": 'r[5] = (r[5] + r[3]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x43000: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC942, 1, r[5])', "slot_py": None, "target": None, "cond": None},
    0x43002: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFC99A, 1, r[4])', "target": None, "cond": None},}
