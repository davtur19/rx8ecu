#!/usr/bin/env python3
"""Differential test for counterReset (0x4CA9A) — pure straight-line lift, 8 bytes.
...
Run from repo root: python3 c/tests/test_counterReset_4ca9a.py
"""
...
ENTRY = 0x4CA9A
RAW = bytes.fromhex("97 44 96 44 95 44 92 3E")
SEED = 42
N = 2000
