#!/usr/bin/env python3
"""Differential test for FUN_0003d92a (0x3D92A) — v3 lift + v4 FPU, 68 bytes.
...
Run from repo root: python3 c/tests/test_FUN_0003d92a_3d92a.py
"""
...
ENTRY = 0x3D92A
RAW = bytes.fromhex("95 74 D3 41 F3 38 92 72 F2 28 F3 25 8F 06 00 09 91 6E 60 10 60 0C 88 01 8F 04 00 09 D2 3A 63 20 A0 0E 25 30 91 65 60 10 60 0C 88 01 8F 08 00 09 64 50 62 4C 42 15 8F 03 00 09 92 5B 34 2C 25 40 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCFD9
SPAN_END = 0x3D96E
SENT = 0x3D96E     # stop-sentinel, placed past the literal pool
...
CODE = {
    ...
    0x3d948: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0x00079628, 1))', "slot_py": None, "target": None, "cond": None},
    ...
    0x3d950: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFC619, 1))', "slot_py": None, "target": None, "cond": None},
