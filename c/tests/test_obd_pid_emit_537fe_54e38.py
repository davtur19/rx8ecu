#!/usr/bin/env python3
"""Differential test for obd_pid_emit_537fe (0x54E38) — v3 lift (branches + delay slots), 42 bytes.
...
Run from repo root: python3 c/tests/test_obd_pid_emit_537fe_54e38.py
"""
...
ENTRY = 0x54E38
RAW = bytes.fromhex("60 F0 60 0C 88 2A 8F 03 00 09 E2 00 A0 09 24 20 D3 2A 61 30 92 49 61 1C 31 20 8D 02 00 09 E0 01 24 00 7F 04 4F 26 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = None
SPAN_END = 0x54E62
SENT = 0x54E62     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x54e38: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, STACK_BASE + 0x400, 1))', "slot_py": None, "target": None, "cond": None},
    0x54e3a: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x54e3c: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x2A) else 0', "slot_py": None, "target": None, "cond": None},
    0x54e3e: {"kind": "branch", "py": None, "slot_py": '', "target": 0x54e48, "cond": 'notT'},
    0x54e42: {"kind": 'reg', "py": 'r[2] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x54e44: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, r[4], 1, r[2])', "target": 0x54e5a, "cond": 'always'},
    0x54e48: {"kind": 'reg', "py": 'r[3] = 0x0007DA5C', "slot_py": None, "target": None, "cond": None},
    0x54e4a: {"kind": 'mem', "py": 'r[1] = s8(_rdw(ram, 0x0007DA5C, 1))', "slot_py": None, "target": None, "cond": None},
    0x54e4c: {"kind": 'reg', "py": 'r[2] = 0x000000FF', "slot_py": None, "target": None, "cond": None},
    0x54e4e: {"kind": 'reg', "py": 'r[1] = r[1] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x54e50: {"kind": 'reg', "py": 'T = 1 if r[1] == r[2] else 0', "slot_py": None, "target": None, "cond": None},
    0x54e52: {"kind": "branch", "py": None, "slot_py": '', "target": 0x54e5a, "cond": 'T'},
    0x54e56: {"kind": 'reg', "py": 'r[0] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x54e58: {"kind": 'mem', "py": '_wrw(ram, r[4], 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x54e5a: {"kind": 'reg', "py": 'r[15] = (r[15] + s8(0x04)) & 0xFFFFFFFF\nsp = (sp + s8(0x04)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x54e5c: {"kind": 'mem', "py": 'pr = _rdw(ram, STACK_BASE + 0x404, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x54e5e: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
