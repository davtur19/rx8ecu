#!/usr/bin/env python3
"""Differential test for sensor_fpu_compare_bounds_2BF7E (0x2BF7E) — v3 lift + v4 FPU, 40 bytes.
...
Run from repo root: python3 c/tests/test_sensor_fpu_compare_bounds_2BF7E_2bf7e.py
"""
...
ENTRY = 0x2BF7E
RAW = bytes.fromhex("94 6A 93 68 F4 38 D2 3A F3 28 F4 35 8D 03 00 09 E0 01 A0 07 24 00 D1 37 F2 18 F2 45 8D 02 00 09 E0 00 24 00 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBC20
SPAN_END = 0x2BFA6
SENT = 0x2BFA6     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x2bf7e: {"kind": 'reg', "py": 'r[4] = 0xFFFFBC20', "slot_py": None, "target": None, "cond": None},
    0x2bf80: {"kind": 'reg', "py": 'r[3] = 0xFFFFBC1C', "slot_py": None, "target": None, "cond": None},
    0x2bf82: {"kind": 'fpu', "py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFBC1C, 4))', "slot_py": None, "target": None, "cond": None},
    0x2bf84: {"kind": 'reg', "py": 'r[2] = 0x00078D78', "slot_py": None, "target": None, "cond": None},
    0x2bf86: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x00078D78, 4))', "slot_py": None, "target": None, "cond": None},
    0x2bf88: {"kind": 'fpu', "py": 'T = 1 if fr[4] > fr[3] else 0', "slot_py": None, "target": None, "cond": None},
    0x2bf8a: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2bf94, "cond": 'T'},
    0x2bf8e: {"kind": 'reg', "py": 'r[0] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x2bf90: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFBC20, 1, r[0])', "target": 0x2bfa2, "cond": 'always'},
    0x2bf94: {"kind": 'reg', "py": 'r[1] = 0x00078D7C', "slot_py": None, "target": None, "cond": None},
    0x2bf96: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0x00078D7C, 4))', "slot_py": None, "target": None, "cond": None},
    0x2bf98: {"kind": 'fpu', "py": 'T = 1 if fr[2] > fr[4] else 0', "slot_py": None, "target": None, "cond": None},
    0x2bf9a: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2bfa2, "cond": 'T'},
    0x2bf9e: {"kind": 'reg', "py": 'r[0] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x2bfa0: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBC20, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x2bfa2: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
