#!/usr/bin/env python3
"""Differential test for diag_bitfield_2c4cc (0x2C4CC) — v3 lift (branches + delay slots), 30 bytes.
...
Run from repo root: python3 c/tests/test_diag_bitfield_2c4cc_2c4cc.py
"""
...
CODE = {
    0x2c4cc: {"kind": 'reg', "py": 'r[4] = 0xFFFFBC37', "slot_py": None, "target": None, "cond": None},
    0x2c4ce: {"kind": 'reg', "py": 'r[3] = 0xFFFFBC46', "slot_py": None, "target": None, "cond": None},
    0x2c4d0: {"kind": 'mem', "py": 'r[0] = s16(_rdw(ram, 0xFFFFBC46, 2))', "slot_py": None, "target": None, "cond": None},
    0x2c4d2: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x2c4d4: {"kind": 'reg', "py": 'r[0] = (r[0] & 0x08) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x2c4d6: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x08) else 0', "slot_py": None, "target": None, "cond": None},
    0x2c4d8: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2c4e2, "cond": 'notT'},
    0x2c4dc: {"kind": 'reg', "py": 'r[1] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x2c4de: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFBC37, 1, r[1])', "target": 0x2c4e6, "cond": 'always'},
    0x2c4e2: {"kind": 'reg', "py": 'r[0] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x2c4e4: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBC37, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x2c4e6: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
