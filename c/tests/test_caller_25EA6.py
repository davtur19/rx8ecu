#!/usr/bin/env python3
"""Differential test for caller_25EA6 (entry 0x25EA6) — v8 ST caller (CFG), 30 bytes.
...
Run: python3 test_caller_25EA6.py
"""
...
CODE = {
    0x25ea6: {"kind": 'st', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x25ea8: {"kind": 'reg', "py": 'r[0] = 0x00025EEC', "slot_py": None, "target": None, "cond": None},
    0x25eaa: {"kind": 'fpu', "py": 'fr[7] = bits2f(_rdw(ram, 0x00025EEC, 4))', "slot_py": None, "target": None, "cond": None},
    0x25eac: {"kind": 'reg', "py": 'r[3] = 0x000749E4', "slot_py": None, "target": None, "cond": None},
    0x25eae: {"kind": 'fpu', "py": 'fr[6] = bits2f(_rdw(ram, 0x000749E4, 4))', "slot_py": None, "target": None, "cond": None},
    0x25eb0: {"kind": 'reg', "py": 'r[2] = 0xFFFFB5DC', "slot_py": None, "target": None, "cond": None},
    0x25eb2: {"kind": 'fpu', "py": 'fr[5] = bits2f(_rdw(ram, 0xFFFFB5DC, 4))', "slot_py": None, "target": None, "cond": None},
    0x25eb4: {"kind": 'reg', "py": 'r[1] = 0xFFFFB5D8', "slot_py": None, "target": None, "cond": None},
    0x25eb6: {"kind": 'reg', "py": 'r[3] = 0x000023B0', "slot_py": None, "target": None, "cond": None},
    0x25eb8: {"kind": "call", "py": None, "slot_py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFB5D8, 4))', "target": 0x23b0, "ret_pc": 0x25ebc, "set_pr": True, "cond": None},
    0x25ebc: {"kind": 'reg', "py": 'r[2] = 0xFFFFB5DC', "slot_py": None, "target": None, "cond": None},
    0x25ebe: {"kind": 'st', "py": 'pr = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x25ec0: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFB5DC, 4, f2bits(fr[0]))', "target": None, "cond": None},
