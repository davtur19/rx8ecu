#!/usr/bin/env python3
"""Differential test for sensor_extract_60734 (0x60734) — v3 lift + v4 FPU, 12 bytes.
...
Run from repo root: python3 c/tests/test_sensor_extract_60734_60734.py
"""
...
ENTRY = 0x60734
RAW = bytes.fromhex("93 05 00 0B F0 38 92 03 00 0B F0 28")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFB5B8
SPAN_END = 0x60740
SENT = 0x60746     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x60734: {"kind": 'reg', "py": 'r[3] = 0xFFFFB5B8', "slot_py": None, "target": None, "cond": None},
    0x60736: {"kind": "ret", "py": None, "slot_py": 'fr[0] = bits2f(_rdw(ram, 0xFFFFB5B8, 4))', "target": None, "cond": None},
    0x6073a: {"kind": 'reg', "py": 'r[2] = 0xFFFFAA10', "slot_py": None, "target": None, "cond": None},
    0x6073c: {"kind": "ret", "py": None, "slot_py": 'fr[0] = bits2f(_rdw(ram, 0xFFFFAA10, 4))', "target": None, "cond": None},}
