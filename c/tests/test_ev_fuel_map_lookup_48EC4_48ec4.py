#!/usr/bin/env python3
"""Differential test for ev_fuel_map_lookup_48EC4 (0x48EC4) — v3 lift (branches + delay slots), 40 bytes.
...
Run from repo root: python3 c/tests/test_ev_fuel_map_lookup_48EC4_48ec4.py
"""
...
ENTRY = 0x48EC4
RAW = bytes.fromhex("00 09 92 46 60 20 60 0C 88 01 8D 06 00 09 93 41 60 30 60 0C 88 01 8F 03 00 09 E3 01 A0 02 24 30 E1 00 24 10 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
CODE = {
    0x48ec4: {"kind": 'reg', "py": None, "slot_py": None, "target": None, "cond": None},
    ...
    0x48ee0: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, r[4], 1, r[3])', "target": 0x48ee8, "cond": 'always'},
    0x48ee4: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x48ee6: {"kind": 'mem', "py": '_wrw(ram, r[4], 1, r[1])', "slot_py": None, "target": None, "cond": None},
