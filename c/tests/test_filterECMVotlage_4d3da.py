#!/usr/bin/env python3
"""Differential test for filterECMVotlage (0x4D3DA) — v3 lift (branches + delay slots), 28 bytes.
...
Run from repo root: python3 c/tests/test_filterECMVotlage_4d3da.py
"""
...
ENTRY = 0x4D3DA
RAW = bytes.fromhex("00 09 93 1B 23 70 D2 11 22 40 91 18 63 10 D0 10 20 30 D2 0C 22 50 D3 0C 00 0B 23 60")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCFAD
SPAN_END = 0x4D3F6
SENT = 0x4D3F6     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x4d3da: {"kind": 'reg', "py": None, "slot_py": None, "target": None, "cond": None},
    0x4d3dc: {"kind": 'reg', "py": 'r[3] = 0xFFFFCF7D', "slot_py": None, "target": None, "cond": None},
    0x4d3de: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCF7D, 1, r[7])', "slot_py": None, "target": None, "cond": None},
    0x4d3e0: {"kind": 'reg', "py": 'r[2] = 0xFFFFCFAC', "slot_py": None, "target": None, "cond": None},
    0x4d3e2: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCFAC, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x4d3e4: {"kind": 'reg', "py": 'r[1] = 0xFFFFCF81', "slot_py": None, "target": None, "cond": None},
    0x4d3e6: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFCF81, 1))', "slot_py": None, "target": None, "cond": None},
    0x4d3e8: {"kind": 'reg', "py": 'r[0] = 0xFFFFCFAD', "slot_py": None, "target": None, "cond": None},
    0x4d3ea: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCFAD, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x4d3ec: {"kind": 'reg', "py": 'r[2] = 0xFFFFCFA3', "slot_py": None, "target": None, "cond": None},
    0x4d3ee: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCFA3, 1, r[5])', "slot_py": None, "target": None, "cond": None},
    0x4d3f0: {"kind": 'reg', "py": 'r[3] = 0xFFFFCFA5', "slot_py": None, "target": None, "cond": None},
    0x4d3f2: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFCFA5, 1, r[6])', "target": None, "cond": None},}
