#!/usr/bin/env python3
"""Differential test for compare_update_float_0x4F172 (0x4F172) — v3 lift + v4 FPU, 20 bytes.
...
Run from repo root: python3 c/tests/test_compare_update_float_0x4F172_4f172.py
"""
...
ENTRY = 0x4F172
RAW = bytes.fromhex("91 08 94 08 F4 18 F3 48 F3 45 8F 01 00 09 F4 4A 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFAE54
SPAN_END = 0x4F186
SENT = 0x4F18A     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x4f172: {"kind": 'reg', "py": 'r[1] = 0xFFFFAE54', "slot_py": None, "target": None, "cond": None},
    0x4f174: {"kind": 'reg', "py": 'r[4] = 0xFFFFCFD4', "slot_py": None, "target": None, "cond": None},
    0x4f176: {"kind": 'fpu', "py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFAE54, 4))', "slot_py": None, "target": None, "cond": None},
    0x4f178: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, r[4], 4))', "slot_py": None, "target": None, "cond": None},
    0x4f17a: {"kind": 'fpu', "py": 'T = 1 if fr[3] > fr[4] else 0', "slot_py": None, "target": None, "cond": None},
    0x4f17c: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4f182, "cond": 'notT'},
    0x4f180: {"kind": 'fpu', "py": '_wrw(ram, r[4], 4, f2bits(fr[4]))', "slot_py": None, "target": None, "cond": None},
