#!/usr/bin/env python3
"""Differential test for FUN_0000e04c (0xE04C) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_FUN_0000e04c_e04c.py
"""
...
CODE = {
    0xe04c: {"kind": 'mem', "py": 'r[12] = _rdw(ram, STACK_BASE + 0x400, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xe04e: {"kind": 'mem', "py": 'r[13] = _rdw(ram, STACK_BASE + 0x404, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xe050: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, STACK_BASE + 0x408, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},}
