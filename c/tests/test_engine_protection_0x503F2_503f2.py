#!/usr/bin/env python3
"""Differential test for engine_protection_0x503F2 (0x503F2) — v3 lift (branches + delay slots), 42 bytes.
...
Run from repo root: python3 c/tests/test_engine_protection_0x503F2_503f2.py
"""
...
ENTRY = 0x503F2
RAW = bytes.fromhex("94 15 93 15 60 30 60 0C 88 01 8F 04 00 09 D2 0A 61 20 A0 08 24 10 62 40 62 2C 42 15 8F 03 00 09 62 40 72 FF 24 20 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    0x503f2: {"kind": 'reg', "py": 'r[4] = 0xFFFFD04C', "slot_py": None, "target": None, "cond": None},
    0x503f4: {"kind": 'reg', "py": 'r[3] = 0xFFFFBE0C', "slot_py": None, "target": None, "cond": None},
    0x503f6: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFBE0C, 1))', "slot_py": None, "target": None, "cond": None},
    0x503f8: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x503fa: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x503fc: {"kind": "branch", "py": None, "slot_py": '', "target": 0x50408, "cond": 'notT'},
    0x50400: {"kind": 'reg', "py": 'r[2] = 0x0007D285', "slot_py": None, "target": None, "cond": None},
    0x50402: {"kind": 'mem', "py": 'r[1] = s8(_rdw(ram, 0x0007D285, 1))', "slot_py": None, "target": None, "cond": None},
    0x50404: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFD04C, 1, r[1])', "target": 0x50418, "cond": 'always'},
    0x50408: {"kind": 'mem', "py": 'r[2] = s8(_rdw(ram, 0xFFFFD04C, 1))', "slot_py": None, "target": None, "cond": None},
    0x5040a: {"kind": 'reg', "py": 'r[2] = r[2] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x5040c: {"kind": 'reg', "py": 'T = 1 if s32(r[2]) > 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x5040e: {"kind": "branch", "py": None, "slot_py": '', "target": 0x50418, "cond": 'notT'},
    0x50412: {"kind": 'mem', "py": 'r[2] = s8(_rdw(ram, 0xFFFFD04C, 1))', "slot_py": None, "target": None, "cond": None},
    0x50414: {"kind": 'reg', "py": 'r[2] = (r[2] + s8(0xFF)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x50416: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD04C, 1, r[2])', "slot_py": None, "target": None, "cond": None},
    0x50418: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
