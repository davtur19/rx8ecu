#!/usr/bin/env python3
"""Differential test for ssv_mode_gated_copy_bf59_to_bf58 (0x317C0) — v3 lift (branches + delay slots), 24 bytes.
...
Run from repo root: python3 c/tests/test_ssv_mode_gated_copy_bf59_to_bf58_317c0.py
"""
...
ENTRY = 0x317C0
RAW = bytes.fromhex("93 0A 60 30 60 0C 88 01 8F 04 00 09 D2 03 61 20 90 03 20 10 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBF59
SPAN_END = 0x317D8
SENT = 0x317E0     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x317c0: {"kind": 'reg', "py": 'r[3] = 0xFFFFAACC', "slot_py": None, "target": None, "cond": None},
    0x317c2: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFAACC, 1))', "slot_py": None, "target": None, "cond": None},
    0x317c4: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x317c6: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x317c8: {"kind": "branch", "py": None, "slot_py": '', "target": 0x317d4, "cond": 'notT'},
    0x317cc: {"kind": 'reg', "py": 'r[2] = 0xFFFFBF59', "slot_py": None, "target": None, "cond": None},
    0x317ce: {"kind": 'mem', "py": 'r[1] = s8(_rdw(ram, 0xFFFFBF59, 1))', "slot_py": None, "target": None, "cond": None},
    0x317d0: {"kind": 'reg', "py": 'r[0] = 0xFFFFBF58', "slot_py": None, "target": None, "cond": None},
    0x317d2: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBF58, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x317d4: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
