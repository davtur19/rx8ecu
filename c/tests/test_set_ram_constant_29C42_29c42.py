#!/usr/bin/env python3
"""Differential test for set_ram_constant_29C42 (0x29C42) — v3 lift + v4 FPU, 90 bytes.
...
Run from repo root: python3 c/tests/test_set_ram_constant_29C42_29c42.py
"""
...
ENTRY = 0x29C42
RAW = bytes.fromhex("D2 25 63 20 23 38 8F 22 00 09 D1 20 60 11 20 08 8D 1D 00 09 93 24 60 30 60 0C 88 01 8D 17 00 09 92 1F 60 20 60 0C 88 01 8D 11 00 09 93 1A 60 30 20 08 8D 0C 00 09 92 16 60 20 60 0C 88 01 8D 06 00 09 93 11 60 30 60 0C 88 01 8F 04 00 09 D3 12 F3 38 92 02 F2 3A 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBB90
SPAN_END = 0x29C9C
SENT = 0x29CE0     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x29c42: {"kind": 'reg', "py": 'r[2] = 0x00078E0C', "slot_py": None, "target": None, "cond": None},
    0x29c44: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0x00078E0C, 1))', "slot_py": None, "target": None, "cond": None},
    0x29c46: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x29c48: {"kind": "branch", "py": None, "slot_py": '', "target": 0x29c90, "cond": 'notT'},
    0x29c4c: {"kind": 'reg', "py": 'r[1] = 0xFFFFBB3A', "slot_py": None, "target": None, "cond": None},
    0x29c4e: {"kind": 'mem', "py": 'r[0] = s16(_rdw(ram, 0xFFFFBB3A, 2))', "slot_py": None, "target": None, "cond": None},
    0x29c50: {"kind": 'reg', "py": 'T = 1 if (r[0] & r[0]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x29c52: {"kind": "branch", "py": None, "slot_py": '', "target": 0x29c90, "cond": 'T'},
    0x29c56: {"kind": 'reg', "py": 'r[3] = 0xFFFFBB8C', "slot_py": None, "target": None, "cond": None},
    0x29c58: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFBB8C, 1))', "slot_py": None, "target": None, "cond": None},
    0x29c5a: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x29c5c: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x29c5e: {"kind": "branch", "py": None, "slot_py": '', "target": 0x29c90, "cond": 'T'},
    0x29c62: {"kind": 'reg', "py": 'r[2] = 0xFFFFBB90', "slot_py": None, "target": None, "cond": None},
    0x29c64: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFBB90, 1))', "slot_py": None, "target": None, "cond": None},
    0x29c66: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x29c68: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x29c6a: {"kind": "branch", "py": None, "slot_py": '', "target": 0x29c90, "cond": 'T'},
    0x29c6e: {"kind": 'reg', "py": 'r[3] = 0xFFFFA428', "slot_py": None, "target": None, "cond": None},
    0x29c70: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFA428, 1))', "slot_py": None, "target": None, "cond": None},
    0x29c72: {"kind": 'reg', "py": 'T = 1 if (r[0] & r[0]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x29c74: {"kind": "branch", "py": None, "slot_py": '', "target": 0x29c90, "cond": 'T'},
    0x29c78: {"kind": 'reg', "py": 'r[2] = 0xFFFFA402', "slot_py": None, "target": None, "cond": None},
    0x29c7a: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFA402, 1))', "slot_py": None, "target": None, "cond": None},
    0x29c7c: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x29c7e: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x29c80: {"kind": "branch", "py": None, "slot_py": '', "target": 0x29c90, "cond": 'T'},
    0x29c84: {"kind": 'reg', "py": 'r[3] = 0xFFFFA40A', "slot_py": None, "target": None, "cond": None},
    0x29c86: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFA40A, 1))', "slot_py": None, "target": None, "cond": None},
    0x29c88: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x29c8a: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x29c8c: {"kind": "branch", "py": None, "slot_py": '', "target": 0x29c98, "cond": 'notT'},
    0x29c90: {"kind": 'reg', "py": 'r[3] = 0x00078E1C', "slot_py": None, "target": None, "cond": None},
    0x29c92: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x00078E1C, 4))', "slot_py": None, "target": None, "cond": None},
    0x29c94: {"kind": 'reg', "py": 'r[2] = 0xFFFFBB2C', "slot_py": None, "target": None, "cond": None},
    0x29c96: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFBB2C, 4, f2bits(fr[3]))', "slot_py": None, "target": None, "cond": None},
    0x29c98: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
