#!/usr/bin/env python3
"""Differential test for sensor_status_byte_pack (0x2A360) — v3 lift (branches + delay slots), 18 bytes.
...
Run from repo root: python3 c/tests/test_sensor_status_byte_pack_2a360.py
"""
...
ENTRY = 0x2A360
RAW = bytes.fromhex("8F 03 00 09 E3 01 A0 02 24 30 E1 00 24 10 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    ...
    0x2a366: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, r[4], 1, r[3])', "target": 0x2a36e, "cond": 'always'},
    0x2a36a: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x2a36c: {"kind": 'mem', "py": '_wrw(ram, r[4], 1, r[1])', "slot_py": None, "target": None, "cond": None},
