#!/usr/bin/env python3
"""Differential test for inj_timing_offset_0x506E6 (0x506E6) — v3 lift + v4 FPU, 54 bytes.
...
Run from repo root: python3 c/tests/test_inj_timing_offset_0x506E6_506e6.py
"""
...
RAM_MAX = 0xFFFFD050
SPAN_END = 0x5071C
SENT = 0x5071C     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x506e6: {"kind": 'reg', "py": 'r[3] = 0xFFFFD002', "slot_py": None, "target": None, "cond": None},
    0x506e8: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFD002, 1))', "slot_py": None, "target": None, "cond": None},
    0x506ea: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x506ec: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x506ee: {"kind": "branch", "py": None, "slot_py": '', "target": 0x50718, "cond": 'notT'},
    0x506f2: {"kind": 'reg', "py": 'r[2] = 0xFFFFCFE6', "slot_py": None, "target": None, "cond": None},
    0x506f4: {"kind": 'reg', "py": 'r[3] = 0x0007D23E', "slot_py": None, "target": None, "cond": None},
    0x506f6: {"kind": 'mem', "py": 'r[1] = s16(_rdw(ram, 0xFFFFCFE6, 2))', "slot_py": None, "target": None, "cond": None},
    0x506f8: {"kind": 'mem', "py": 'r[0] = s16(_rdw(ram, 0x0007D23E, 2))', "slot_py": None, "target": None, "cond": None},
    0x506fa: {"kind": 'reg', "py": 'T = 1 if (r[1] & 0xFFFFFFFF) > (r[0] & 0xFFFFFFFF) else 0', "slot_py": None, "target": None, "cond": None},
    0x506fc: {"kind": "branch", "py": None, "slot_py": '', "target": 0x50718, "cond": 'notT'},
    0x50700: {"kind": 'reg', "py": 'r[1] = 0xFFFFD034', "slot_py": None, "target": None, "cond": None},
    0x50702: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFD034, 1))', "slot_py": None, "target": None, "cond": None},
    0x50704: {"kind": 'reg', "py": 'T = 1 if (r[0] & r[0]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x50706: {"kind": "branch", "py": None, "slot_py": '', "target": 0x50718, "cond": 'notT'},
    0x5070a: {"kind": 'reg', "py": 'r[3] = 0xFFFFD024', "slot_py": None, "target": None, "cond": None},
    0x5070c: {"kind": 'reg', "py": 'r[2] = 0xFFFFD020', "slot_py": None, "target": None, "cond": None},
    0x5070e: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFD024, 4))', "slot_py": None, "target": None, "cond": None},
    0x50710: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0xFFFFD020, 4))', "slot_py": None, "target": None, "cond": None},
    0x50712: {"kind": 'fpu', "py": 'fr[2] = ts(fr[2] - fr[3])', "slot_py": None, "target": None, "cond": None},
    0x50714: {"kind": 'reg', "py": 'r[1] = 0xFFFFD050', "slot_py": None, "target": None, "cond": None},
    0x50716: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFD050, 4, f2bits(fr[2]))', "slot_py": None, "target": None, "cond": None},
    0x50718: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
