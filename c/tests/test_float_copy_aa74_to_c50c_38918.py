#!/usr/bin/env python3
"""Differential test for float_copy_aa74_to_c50c (0x38918) — v3 lift + v4 FPU, 10 bytes.
...
Run from repo root: python3 c/tests/test_float_copy_aa74_to_c50c_38918.py
"""
...
ENTRY = 0x38918
RAW = bytes.fromhex("93 81 F3 38 92 80 00 0B F2 3A")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFC50C
SPAN_END = 0x38922
SENT = 0x38922     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x38918: {"kind": 'reg', "py": 'r[3] = 0xFFFFAA74', "slot_py": None, "target": None, "cond": None},
    0x3891a: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFAA74, 4))', "slot_py": None, "target": None, "cond": None},
    0x3891c: {"kind": 'reg', "py": 'r[2] = 0xFFFFC50C', "slot_py": None, "target": None, "cond": None},
    0x3891e: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFC50C, 4, f2bits(fr[3]))', "target": None, "cond": None},}
