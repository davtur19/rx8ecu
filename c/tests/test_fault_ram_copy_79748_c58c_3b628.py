#!/usr/bin/env python3
"""Differential test for fault_ram_copy_79748_c58c (0x3B628) — v3 lift (branches + delay slots), 32 bytes.
...
Run from repo root: python3 c/tests/test_fault_ram_copy_79748_c58c_3b628.py
"""
...
ENTRY = 0x3B628
RAW = bytes.fromhex("D4 47 63 40 92 7C 22 30 61 40 90 7A 92 7A 20 10 D1 44 63 10 22 30 D3 44 92 75 60 30 00 0B 22 00")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFC58F
SPAN_END = 0x3B648
SENT = 0x3B648     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x3b628: {"kind": 'reg', "py": 'r[4] = 0x00079748', "slot_py": None, "target": None, "cond": None},
    0x3b62a: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0x00079748, 1))', "slot_py": None, "target": None, "cond": None},
    0x3b62c: {"kind": 'reg', "py": 'r[2] = 0xFFFFC58C', "slot_py": None, "target": None, "cond": None},
    0x3b62e: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC58C, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x3b630: {"kind": 'mem', "py": 'r[1] = s8(_rdw(ram, 0x00079748, 1))', "slot_py": None, "target": None, "cond": None},
    0x3b632: {"kind": 'reg', "py": 'r[0] = 0xFFFFC58D', "slot_py": None, "target": None, "cond": None},
    0x3b634: {"kind": 'reg', "py": 'r[2] = 0xFFFFC58E', "slot_py": None, "target": None, "cond": None},
    0x3b636: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC58D, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x3b638: {"kind": 'reg', "py": 'r[1] = 0x00079749', "slot_py": None, "target": None, "cond": None},
    0x3b63a: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0x00079749, 1))', "slot_py": None, "target": None, "cond": None},
    0x3b63c: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC58E, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x3b63e: {"kind": 'reg', "py": 'r[3] = 0x0007974A', "slot_py": None, "target": None, "cond": None},
    0x3b640: {"kind": 'reg', "py": 'r[2] = 0xFFFFC58F', "slot_py": None, "target": None, "cond": None},
    0x3b642: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0x0007974A, 1))', "slot_py": None, "target": None, "cond": None},
    0x3b644: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFC58F, 1, r[0])', "target": None, "cond": None},}
