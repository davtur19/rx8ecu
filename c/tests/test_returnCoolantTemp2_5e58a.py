#!/usr/bin/env python3
"""Differential test for returnCoolantTemp2 (0x5E58A) — v3 lift + v4 FPU, 26 bytes.
...
Run from repo root: python3 c/tests/test_returnCoolantTemp2_5e58a.py
"""
...
ENTRY = 0x5E58A
RAW = bytes.fromhex("93 44 00 0B F0 38 91 42 62 10 22 28 8F 02 00 09 A0 01 E4 00 E4 01 00 0B 60 43")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFAA08
SPAN_END = 0x5E5A4
SENT = 0x5E5A4     # stop-sentinel, placed past the literal pool
...
CODE = {
    ...
    0x5e590: {"kind": 'reg', "py": 'r[1] = 0xFFFFA41C', "slot_py": None, "target": None, "cond": None},
    0x5e592: {"kind": 'mem', "py": 'r[2] = s8(_rdw(ram, 0xFFFFA41C, 1))', "slot_py": None, "target": None, "cond": None},
    0x5e594: {"kind": 'reg', "py": 'T = 1 if (r[2] & r[2]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x5e596: {"kind": "branch", "py": None, "slot_py": '', "target": 0x5e59e, "cond": 'notT'},
    0x5e59a: {"kind": "branch", "py": None, "slot_py": 'r[4] = s8(0x00)', "target": 0x5e5a0, "cond": 'always'},
    0x5e59e: {"kind": 'reg', "py": 'r[4] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x5e5a0: {"kind": "ret", "py": None, "slot_py": 'r[0] = r[4]', "target": None, "cond": None},}
