#!/usr/bin/env python3
"""Differential test for dtc_data_read_60F74 (0x60F74) — pure straight-line lift, 8 bytes.
...
Run from repo root: python3 c/tests/test_dtc_data_read_60F74_60f74.py
"""
...
ENTRY = 0x60F74
RAW = bytes.fromhex("D7 08 60 5C D6 06 88 20")
SEED = 42
N = 2000
