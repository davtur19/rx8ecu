#!/usr/bin/env python3
"""Differential test for fuel_purgeAndFuelArrayAtomic (0x21A54) — v3 lift (branches + delay slots), 16 bytes.
...
Run from repo root: python3 c/tests/test_fuel_purgeAndFuelArrayAtomic_21a54.py
"""
...
ENTRY = 0x21A54
RAW = bytes.fromhex("00 09 E1 01 A0 02 24 10 E2 00 24 20 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    0x21a54: {"kind": 'reg', "py": None, "slot_py": None, "target": None, "cond": None},
