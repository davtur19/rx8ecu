#!/usr/bin/env python3
"""Differential test for diag_seed_generate_4E72C (0x4E72C) — pure straight-line lift, 12 bytes.
...
Run from repo root: python3 c/tests/test_diag_seed_generate_4E72C_4e72c.py
"""
...
ENTRY = 0x4E72C
RAW = bytes.fromhex("93 7B E5 0B D7 43 E4 28 7F FC 34 7C")
SEED = 42
N = 2000
