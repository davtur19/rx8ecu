#!/usr/bin/env python3
"""Differential test for ignition_load_copy_44D8E (0x44D8E) — v3 lift + v4 FPU, 10 bytes.
...
Run from repo root: python3 c/tests/test_ignition_load_copy_44D8E_44d8e.py
"""
...
RAM_MAX = 0xFFFFCB40
SPAN_END = 0x44D98
SENT = 0x44D98     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x44d8e: {"kind": 'reg', "py": 'r[3] = 0xFFFFC6B8', "slot_py": None, "target": None, "cond": None},
    0x44d90: {"kind": 'reg', "py": 'r[1] = 0xFFFFCB40', "slot_py": None, "target": None, "cond": None},
    0x44d92: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFC6B8, 4))', "slot_py": None, "target": None, "cond": None},
    0x44d94: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFCB40, 4, f2bits(fr[3]))', "target": None, "cond": None},}
