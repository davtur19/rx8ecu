#!/usr/bin/env python3
"""Differential test for immo_update_state_machine (0x365C0) — v3 lift (branches + delay slots), 22 bytes.
...
Run from repo root: python3 c/tests/test_immo_update_state_machine_365c0.py
"""
...
ENTRY = 0x365C0
RAW = bytes.fromhex("93 51 E2 00 91 50 23 20 D0 29 E2 04 20 11 D1 29 4F 26 00 0B 21 20")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFC28D
SPAN_END = 0x365D6
SENT = 0x365D6     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x365c0: {"kind": 'reg', "py": 'r[3] = 0xFFFFC240', "slot_py": None, "target": None, "cond": None},
    0x365c2: {"kind": 'reg', "py": 'r[2] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x365c4: {"kind": 'reg', "py": 'r[1] = 0x000001F4', "slot_py": None, "target": None, "cond": None},
    0x365c6: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC240, 1, r[2])', "slot_py": None, "target": None, "cond": None},
    0x365c8: {"kind": 'reg', "py": 'r[0] = 0xFFFFC284', "slot_py": None, "target": None, "cond": None},
    0x365ca: {"kind": 'reg', "py": 'r[2] = s8(0x04)', "slot_py": None, "target": None, "cond": None},
    0x365cc: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC284, 2, r[1])', "slot_py": None, "target": None, "cond": None},
    0x365ce: {"kind": 'reg', "py": 'r[1] = 0xFFFFC28D', "slot_py": None, "target": None, "cond": None},
    0x365d0: {"kind": 'mem', "py": 'pr = _rdw(ram, STACK_BASE + 0x400, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x365d2: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFC28D, 1, r[2])', "target": None, "cond": None},}
