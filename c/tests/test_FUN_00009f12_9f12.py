#!/usr/bin/env python3
"""Differential test for FUN_00009f12 (0x9F12) — pure straight-line lift, 18 bytes.
...
Run from repo root: python3 c/tests/test_FUN_00009f12_9f12.py
"""
...
ENTRY = 0x9F12
RAW = bytes.fromhex("E4 07 60 AC 40 08 40 00 24 D9 44 08 44 08 44 00 30 4C")
SEED = 42
N = 2000
