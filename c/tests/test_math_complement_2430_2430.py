#!/usr/bin/env python3
"""Differential test for math_complement_2430 (0x2430) — pure straight-line lift, 12 bytes.
...
Run from repo root: python3 c/tests/test_math_complement_2430_2430.py
"""
...
ENTRY = 0x2430
RAW = bytes.fromhex("63 4D 43 28 62 47 62 2D 64 33 34 2C")
SEED = 42
N = 2000
