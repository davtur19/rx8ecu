#!/usr/bin/env python3
"""Differential test for FUN_0003d244 (0x3D244) — pure straight-line lift, 10 bytes.
...
Run from repo root: python3 c/tests/test_FUN_0003d244_3d244.py
"""
...
ENTRY = 0x3D244
RAW = bytes.fromhex("E4 02 60 0C C8 80 00 29 88 01")
SEED = 42
N = 2000
