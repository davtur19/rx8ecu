#!/usr/bin/env python3
"""Differential test for knockConditonalInit (0x33992) — v3 lift (branches + delay slots), 12 bytes.
...
Run from repo root: python3 c/tests/test_knockConditonalInit_33992.py
"""
...
ENTRY = 0x33992
RAW = bytes.fromhex("E4 00 93 1F 23 40 92 1E 00 0B 22 40")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFC074
SPAN_END = 0x3399E
SENT = 0x3399E     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x33992: {"kind": 'reg', "py": 'r[4] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x33994: {"kind": 'reg', "py": 'r[3] = 0xFFFFC074', "slot_py": None, "target": None, "cond": None},
    0x33996: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC074, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x33998: {"kind": 'reg', "py": 'r[2] = 0xFFFFC073', "slot_py": None, "target": None, "cond": None},
    0x3399a: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFC073, 1, r[4])', "target": None, "cond": None},}
