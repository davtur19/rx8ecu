#!/usr/bin/env python3
"""Differential test for fpu_tri_register_copy_344BA (0x344BA) — v3 lift + v4 FPU, 32 bytes.
...
Run from repo root: python3 c/tests/test_fpu_tri_register_copy_344BA_344ba.py
"""
...
RAM_MAX = 0xFFFFC0D4
SPAN_END = 0x344DA
SENT = 0x344DA     # stop-sentinel, placed past the literal pool
