#!/usr/bin/env python3
"""Differential test for diag_routine_control_4E4BE (0x4E4BE) — v3 lift (branches + delay slots), 10 bytes.
...
Run from repo root: python3 c/tests/test_diag_routine_control_4E4BE_4e4be.py
"""
...
RAM_MAX = None
SPAN_END = 0x4E4C8
SENT = 0x4E4C8     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x4e4be: {"kind": 'mem', "py": 'r[11] = _rdw(ram, STACK_BASE + 0x400, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x4e4c0: {"kind": 'mem', "py": 'r[12] = _rdw(ram, STACK_BASE + 0x404, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x4e4c2: {"kind": 'mem', "py": 'r[13] = _rdw(ram, STACK_BASE + 0x408, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x4e4c4: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, STACK_BASE + 0x40C, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},}
