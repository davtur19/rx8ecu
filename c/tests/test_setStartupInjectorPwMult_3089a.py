#!/usr/bin/env python3
"""Differential test for setStartupInjectorPwMult (0x3089A) — v3 lift + v4 FPU, 36 bytes.
...
Run from repo root: python3 c/tests/test_setStartupInjectorPwMult_3089a.py
"""
...
ENTRY = 0x3089A
RAW = bytes.fromhex("92 14 63 20 23 38 8F 0B 00 09 94 16 91 16 63 10 23 38 8F 03 00 09 D0 13 A0 01 F3 08 F3 9D F4 3A 00 0B 00 09")
SEED = 43
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFC590
SPAN_END = 0x308BE
SENT = 0x308BE     # stop-sentinel, placed past the literal pool
