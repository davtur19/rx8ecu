#!/usr/bin/env python3
"""Differential test for can_set_mailbox_ptr_control (0xCDFA) — v3 lift (branches + delay slots), 42 bytes.
...
Run from repo root: python3 c/tests/test_can_set_mailbox_ptr_control_cdfa.py
"""
...
ENTRY = 0xCDFA
RAW = bytes.fromhex("60 53 64 4C 24 48 8F 03 00 09 92 52 A0 02 64 21 91 50 64 11 64 47 D2 2C 65 4D 63 5C 43 18 22 59 42 19 64 33 24 2B 00 0B 60 43")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    0xcdfa: {"kind": 'reg', "py": 'r[0] = r[5]', "slot_py": None, "target": None, "cond": None},
