#!/usr/bin/env python3
"""Differential test for caller_E1FE (entry 0xE1FE) — v8 ST caller (CFG), 34 bytes.
...
Run: python3 test_caller_E1FE.py
"""
...
CODE = {
    0xe1fe: {"kind": 'st', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xe200: {"kind": 'reg', "py": 'r[2] = 0xFFFFA428', "slot_py": None, "target": None, "cond": None},
    0xe202: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFA428, 1))', "slot_py": None, "target": None, "cond": None},
    0xe204: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0xe206: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0xe208: {"kind": "branch", "py": None, "slot_py": '', "target": 0xe21a, "cond": 'notT'},
    0xe20c: {"kind": 'reg', "py": 'r[1] = 0xFFFFA422', "slot_py": None, "target": None, "cond": None},
    0xe20e: {"kind": 'reg', "py": 'r[5] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0xe210: {"kind": 'reg', "py": 'r[3] = 0x00002460', "slot_py": None, "target": None, "cond": None},
    0xe212: {"kind": "call", "py": None, "slot_py": 'r[4] = s16(_rdw(ram, 0xFFFFA422, 2))', "target": 0x2460, "ret_pc": 0xe216, "set_pr": True, "cond": None},
    0xe216: {"kind": 'reg', "py": 'r[2] = 0xFFFFA422', "slot_py": None, "target": None, "cond": None},
    0xe218: {"kind": 'mem', "py": '_wrw(ram, r[2], 2, r[0])', "slot_py": None, "target": None, "cond": None},
    0xe21a: {"kind": 'st', "py": 'pr = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xe21c: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},
