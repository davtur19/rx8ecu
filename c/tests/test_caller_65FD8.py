#!/usr/bin/env python3
"""Differential test for caller_65FD8 (entry 0x65FD8) — v8 ST caller (CFG), 44 bytes.
...
Run: python3 test_caller_65FD8.py
"""
...
CODE = {
    0x65fd8: {"kind": 'reg', "py": 'r[0] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x65fda: {"kind": 'reg', "py": 'r[3] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x65fdc: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) >= s32(r[3]) else 0', "slot_py": None, "target": None, "cond": None},
    0x65fde: {"kind": "branch", "py": None, "slot_py": 'r[5] = r[4]', "target": 0x65fee, "cond": 'notT'},
    0x65fe2: {"kind": 'reg', "py": 'r[1] = s8(0x3F)', "slot_py": None, "target": None, "cond": None},
    0x65fe4: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) > s32(r[1]) else 0', "slot_py": None, "target": None, "cond": None},
    0x65fe6: {"kind": "branch", "py": None, "slot_py": '', "target": 0x65fee, "cond": 'T'},
    0x65fea: {"kind": "branch", "py": None, "slot_py": 'r[5] = s8(0x60)', "target": 0x66000, "cond": 'always'},
    0x65fee: {"kind": 'reg', "py": 'r[2] = 0x00000081', "slot_py": None, "target": None, "cond": None},
    0x65ff0: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) >= s32(r[2]) else 0', "slot_py": None, "target": None, "cond": None},
    0x65ff2: {"kind": "branch", "py": None, "slot_py": '', "target": 0x66000, "cond": 'notT'},
    0x65ff6: {"kind": 'reg', "py": 'r[1] = 0x000000BF', "slot_py": None, "target": None, "cond": None},
    0x65ff8: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) > s32(r[1]) else 0', "slot_py": None, "target": None, "cond": None},
    0x65ffa: {"kind": "branch", "py": None, "slot_py": '', "target": 0x66000, "cond": 'T'},
    0x65ffe: {"kind": 'reg', "py": 'r[5] = s8(0x70)', "slot_py": None, "target": None, "cond": None},
    0x66000: {"kind": "ret", "py": None, "slot_py": 'r[0] = r[5]', "target": None, "cond": None},
}
