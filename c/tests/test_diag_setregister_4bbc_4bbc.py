#!/usr/bin/env python3
"""Differential test for diag_setregister_4bbc (0x4BBC) — v3 lift (branches + delay slots), 24 bytes.
...
Run from repo root: python3 c/tests/test_diag_setregister_4bbc_4bbc.py
"""
...
ENTRY = 0x4BBC
RAW = bytes.fromhex("63 41 66 6D 26 68 8B 03 65 57 23 59 00 0B 24 31 23 5B 24 31 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = None
SPAN_END = 0x4BD4
SENT = 0x4BD4     # stop-sentinel, placed past the literal pool
