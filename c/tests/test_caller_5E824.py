#!/usr/bin/env python3
"""Differential test for caller_5E824 (entry 0x5E824) — v8 ST caller (CFG), 48 bytes.
...
Run: python3 test_caller_5E824.py
"""
...
CODE = {
    0x5e824: {"kind": 'st', "py": 'local[0x3FC] = pr\n_wrw(ram, STACK_BASE + 0x3FC, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x5e826: {"kind": 'reg', "py": 'r[0] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x5e828: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x5e82a: {"kind": "branch", "py": None, "slot_py": '', "target": 0x5e838, "cond": 'T'},
    0x5e82e: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x02) else 0', "slot_py": None, "target": None, "cond": None},
    0x5e830: {"kind": "branch", "py": None, "slot_py": '', "target": 0x5e842, "cond": 'T'},
    0x5e834: {"kind": "branch", "py": None, "slot_py": '', "target": 0x5e84e, "cond": 'always'},
    0x5e838: {"kind": 'reg', "py": 'r[3] = 0x00060786', "slot_py": None, "target": None, "cond": None},
    0x5e83a: {"kind": "call", "py": None, "slot_py": 'r[4] = s8(0x01)', "target": 0x60786, "ret_pc": 0x5e83e, "set_pr": True, "cond": None},
    0x5e83e: {"kind": "branch", "py": None, "slot_py": 'r[2] = s8(0x00)', "target": 0x5e84a, "cond": 'always'},
    0x5e842: {"kind": 'reg', "py": 'r[3] = 0x00060786', "slot_py": None, "target": None, "cond": None},
    0x5e844: {"kind": "call", "py": None, "slot_py": 'r[4] = s8(0x00)', "target": 0x60786, "ret_pc": 0x5e848, "set_pr": True, "cond": None},
    0x5e848: {"kind": 'reg', "py": 'r[2] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x5e84a: {"kind": 'reg', "py": 'r[3] = 0xFFFFD3B4', "slot_py": None, "target": None, "cond": None},
    0x5e84c: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD3B4, 1, r[2])', "slot_py": None, "target": None, "cond": None},
    0x5e84e: {"kind": 'st', "py": 'pr = _rdw(ram, STACK_BASE + 0x3FC, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x5e850: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},
    0x60786: {"kind": 'reg', "py": 'r[0] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x60788: {"kind": 'reg', "py": 'r[5] = 0xFFFFD6C4', "slot_py": None, "target": None, "cond": None},
    0x6078a: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x6078c: {"kind": "branch", "py": None, "slot_py": '', "target": 0x6079a, "cond": 'T'},
    0x60790: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x00) else 0', "slot_py": None, "target": None, "cond": None},
    0x60792: {"kind": "branch", "py": None, "slot_py": '', "target": 0x607a0, "cond": 'T'},
    0x60796: {"kind": "branch", "py": None, "slot_py": '', "target": 0x607a4, "cond": 'always'},
    0x6079a: {"kind": 'reg', "py": 'r[3] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x6079c: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFD6C4, 1, r[3])', "target": 0x607a4, "cond": 'always'},
    0x607a0: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x607a2: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD6C4, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x607a4: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},
}
