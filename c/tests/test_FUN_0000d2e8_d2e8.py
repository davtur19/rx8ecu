#!/usr/bin/env python3
"""Differential test for FUN_0000d2e8 (0xD2E8) — mem lift (RAM-only, straight-line), 14 bytes.
...
Run from repo root: python3 c/tests/test_FUN_0000d2e8_d2e8.py
"""
...
ENTRY = 0xD2E8
RAW = bytes.fromhex("70 1C 7D 18 1F 03 63 E3 C7 33 7B 10 73 14")
SEED = 42
N = 2000
...
def spec_mirror(r4, r5, r6, r7, ram, stack_top):
    ...
    # 0x00D2E8: op 0x701C
    r[0] = (r[0] + s8(0x1C)) & 0xFFFFFFFF
    # 0x00D2EA: op 0x7D18
    r[13] = (r[13] + s8(0x18)) & 0xFFFFFFFF
    # 0x00D2EC: mov.l r0,@(0xC,r15)
    local[0x40C] = r[0]
    _wrw(ram, STACK_BASE + 0x40C, 4, r[0])
    # 0x00D2EE: op 0x63E3
    r[3] = r[14]
    # 0x00D2F0: op 0xC733
    r[0] = 0x0000D3C0
    # 0x00D2F2: op 0x7B10
    r[11] = (r[11] + s8(0x10)) & 0xFFFFFFFF
    # 0x00D2F4: op 0x7314
    r[3] = (r[3] + s8(0x14)) & 0xFFFFFFFF
    r[15] = sp
