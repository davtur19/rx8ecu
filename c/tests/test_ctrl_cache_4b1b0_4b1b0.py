#!/usr/bin/env python3
"""Differential test for ctrl_cache_4b1b0 (0x4B1B0) — v3 lift (branches + delay slots), 38 bytes.
...
Run from repo root: python3 c/tests/test_ctrl_cache_4b1b0_4b1b0.py
"""
...
ENTRY = 0x4B1B0
RAW = bytes.fromhex("D2 40 E3 03 D4 40 22 30 63 40 D1 40 21 30 60 40 D3 3F 23 00 D0 3F 62 00 D1 3F 21 20 D2 3F 63 20 D1 3F 00 0B 21 30")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCD74
SPAN_END = 0x4B1D6
SENT = 0x4B1D6     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x4b1b0: {"kind": 'reg', "py": 'r[2] = 0xFFFFCD74', "slot_py": None, "target": None, "cond": None},
    0x4b1b2: {"kind": 'reg', "py": 'r[3] = s8(0x03)', "slot_py": None, "target": None, "cond": None},
    0x4b1b4: {"kind": 'reg', "py": 'r[4] = 0x0007B45C', "slot_py": None, "target": None, "cond": None},
    0x4b1b6: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCD74, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x4b1b8: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0x0007B45C, 1))', "slot_py": None, "target": None, "cond": None},
    0x4b1ba: {"kind": 'reg', "py": 'r[1] = 0xFFFFCD68', "slot_py": None, "target": None, "cond": None},
    0x4b1bc: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCD68, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x4b1be: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0x0007B45C, 1))', "slot_py": None, "target": None, "cond": None},
    0x4b1c0: {"kind": 'reg', "py": 'r[3] = 0xFFFFCD69', "slot_py": None, "target": None, "cond": None},
    0x4b1c2: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCD69, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x4b1c4: {"kind": 'reg', "py": 'r[0] = 0x0007B45D', "slot_py": None, "target": None, "cond": None},
    0x4b1c6: {"kind": 'mem', "py": 'r[2] = s8(_rdw(ram, 0x0007B45D, 1))', "slot_py": None, "target": None, "cond": None},
    0x4b1c8: {"kind": 'reg', "py": 'r[1] = 0xFFFFCD6A', "slot_py": None, "target": None, "cond": None},
    0x4b1ca: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCD6A, 1, r[2])', "slot_py": None, "target": None, "cond": None},
    0x4b1cc: {"kind": 'reg', "py": 'r[2] = 0x0007B45E', "slot_py": None, "target": None, "cond": None},
    0x4b1ce: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0x0007B45E, 1))', "slot_py": None, "target": None, "cond": None},
    0x4b1d0: {"kind": 'reg', "py": 'r[1] = 0xFFFFCD6B', "slot_py": None, "target": None, "cond": None},
    0x4b1d2: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFCD6B, 1, r[3])', "target": None, "cond": None},}
