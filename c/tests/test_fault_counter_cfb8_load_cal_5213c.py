#!/usr/bin/env python3
"""Differential test for fault_counter_cfb8_load_cal (0x5213C) — v3 lift (branches + delay slots), 10 bytes.
...
Run from repo root: python3 c/tests/test_fault_counter_cfb8_load_cal_5213c.py
"""
...
ENTRY = 0x5213C
RAW = bytes.fromhex("D2 23 63 20 91 3E 00 0B 21 30")
SEED = 43
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCFB8
SPAN_END = 0x52146
SENT = 0x52146     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x5213c: {"kind": 'reg', "py": 'r[2] = 0x0007C230', "slot_py": None, "target": None, "cond": None},
    0x5213e: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0x0007C230, 1))', "slot_py": None, "target": None, "cond": None},
    0x52140: {"kind": 'reg', "py": 'r[1] = 0xFFFFCFB8', "slot_py": None, "target": None, "cond": None},
    0x52142: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFCFB8, 1, r[3])', "target": None, "cond": None},}
