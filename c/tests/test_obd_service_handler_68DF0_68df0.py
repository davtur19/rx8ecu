#!/usr/bin/env python3
"""Differential test for obd_service_handler_68DF0 (0x68DF0) — pure straight-line lift, 8 bytes.
...
Run from repo root: python3 c/tests/test_obd_service_handler_68DF0_68df0.py
"""
...
ENTRY = 0x68DF0
RAW = bytes.fromhex("D3 16 E4 00 D5 16 60 43")
SEED = 42
N = 2000
