#!/usr/bin/env python3
"""Differential test for alternatorControlMain (0x2718C) — v3 lift (branches + delay slots), 14 bytes.
...
Run from repo root: python3 c/tests/test_alternatorControlMain_2718c.py
"""
...
RAM_MAX = None
SPAN_END = 0x2719A
SENT = 0x2719A     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x2718c: {"kind": 'mem', "py": 'r[9] = _rdw(ram, STACK_BASE + 0x400, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x2718e: {"kind": 'mem', "py": 'r[10] = _rdw(ram, STACK_BASE + 0x404, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x27190: {"kind": 'mem', "py": 'r[11] = _rdw(ram, STACK_BASE + 0x408, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x27192: {"kind": 'mem', "py": 'r[12] = _rdw(ram, STACK_BASE + 0x40C, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x27194: {"kind": 'mem', "py": 'r[13] = _rdw(ram, STACK_BASE + 0x410, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x27196: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, STACK_BASE + 0x414, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},}
