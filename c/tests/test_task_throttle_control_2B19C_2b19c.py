#!/usr/bin/env python3
"""Differential test for task_throttle_control_2B19C (0x2B19C) — v3 lift (branches + delay slots), 26 bytes.
...
Run from repo root: python3 c/tests/test_task_throttle_control_2B19C_2b19c.py
"""
...
ENTRY = 0x2B19C
RAW = bytes.fromhex("93 4D 60 30 60 0C 88 01 8F 03 00 09 E1 01 A0 02 24 10 E0 00 24 00 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
CODE = {
    ...
    0x2b1aa: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, r[4], 1, r[1])', "target": 0x2b1b2, "cond": 'always'},
    0x2b1ae: {"kind": 'reg', "py": 'r[0] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x2b1b0: {"kind": 'mem', "py": '_wrw(ram, r[4], 1, r[0])', "slot_py": None, "target": None, "cond": None},
