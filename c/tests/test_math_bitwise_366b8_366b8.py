#!/usr/bin/env python3
"""Differential test for math_bitwise_366b8 (0x366B8) — pure straight-line lift, 8 bytes.
...
Run from repo root: python3 c/tests/test_math_bitwise_366b8_366b8.py
"""
...
ENTRY = 0x366B8
RAW = bytes.fromhex("91 B1 7F F4 D2 59 60 53")
SEED = 42
N = 2000
