#!/usr/bin/env python3
"""Differential test for dtc_data_read_60BEE (0x60BEE) — pure straight-line lift, 10 bytes.
...
Run from repo root: python3 c/tests/test_dtc_data_read_60BEE_60bee.py
"""
...
ENTRY = 0x60BEE
RAW = bytes.fromhex("E5 00 97 58 66 53 D4 2E 76 01")
SEED = 42
N = 2000
