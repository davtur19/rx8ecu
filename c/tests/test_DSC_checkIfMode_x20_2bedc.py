#!/usr/bin/env python3
"""Differential test for DSC_checkIfMode_x20 (0x2BEDC) — v3 lift (branches + delay slots), 30 bytes.
...
Run from repo root: python3 c/tests/test_DSC_checkIfMode_x20_2bedc.py
"""
...
ENTRY = 0x2BEDC
RAW = bytes.fromhex("94 56 D3 2E 60 30 60 0C C9 20 88 20 8F 03 00 09 E1 01 A0 02 24 10 E0 00 24 00 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBC2A
SPAN_END = 0x2BEFA
SENT = 0x2BEFA     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x2bedc: {"kind": 'reg', "py": 'r[4] = 0xFFFFBC01', "slot_py": None, "target": None, "cond": None},
    0x2bede: {"kind": 'reg', "py": 'r[3] = 0xFFFFBC2A', "slot_py": None, "target": None, "cond": None},
    0x2bee0: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFBC2A, 1))', "slot_py": None, "target": None, "cond": None},
    0x2bee2: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x2bee4: {"kind": 'reg', "py": 'r[0] = (r[0] & 0x20) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x2bee6: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x20) else 0', "slot_py": None, "target": None, "cond": None},
    0x2bee8: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2bef2, "cond": 'notT'},
    0x2beec: {"kind": 'reg', "py": 'r[1] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x2beee: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFBC01, 1, r[1])', "target": 0x2bef6, "cond": 'always'},
    0x2bef2: {"kind": 'reg', "py": 'r[0] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x2bef4: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBC01, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x2bef6: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
