#!/usr/bin/env python3
"""Differential test for diag_fault_cond_eval_9060 (0x56962) — mem lift (RAM-only, straight-line), 8 bytes.
...
Run from repo root: python3 c/tests/test_diag_fault_cond_eval_9060_56962.py
"""
...
ENTRY = 0x56962
RAW = bytes.fromhex("63 6C 84 72 60 0C 30 30")
SEED = 42
N = 2000
...
def spec_mirror(r4, r5, r6, r7, ram, stack_top):
    ...
    r[0] = s8(_rdw(ram, (r[7] + 2), 1))
    # 0x056966: op 0x600C
    r[0] = r[0] & 0xFF
    # 0x056968: op 0x3030
    T = 1 if r[0] == r[3] else 0
    r[15] = sp
