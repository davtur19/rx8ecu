#!/usr/bin/env python3
"""Differential test for fault_flags_init_d0ef (0x58B70) — v3 lift (branches + delay slots), 14 bytes.
...
Run from repo root: python3 c/tests/test_fault_flags_init_d0ef_58b70.py
"""
...
ENTRY = 0x58B70
RAW = bytes.fromhex("D2 37 E1 01 D0 37 E3 00 22 30 00 0B 20 10")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFD0F0
SPAN_END = 0x58B7E
SENT = 0x58B7E     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x58b70: {"kind": 'reg', "py": 'r[2] = 0xFFFFD0F0', "slot_py": None, "target": None, "cond": None},
    0x58b72: {"kind": 'reg', "py": 'r[1] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x58b74: {"kind": 'reg', "py": 'r[0] = 0xFFFFD0EF', "slot_py": None, "target": None, "cond": None},
    0x58b76: {"kind": 'reg', "py": 'r[3] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x58b78: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD0F0, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x58b7a: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFD0EF, 1, r[1])', "target": None, "cond": None},}
