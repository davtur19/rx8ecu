#!/usr/bin/env python3
"""Differential test for can_task_init_flags (0xA478) — v3 lift (branches + delay slots), 14 bytes.
...
Run from repo root: python3 c/tests/test_can_task_init_flags_a478.py
"""
...
CODE = {
    0xa478: {"kind": 'reg', "py": 'r[2] = 0xFFFFA188', "slot_py": None, "target": None, "cond": None},
    0xa47a: {"kind": 'reg', "py": 'r[1] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0xa47c: {"kind": 'reg', "py": 'r[0] = 0xFFFFA18A', "slot_py": None, "target": None, "cond": None},
    0xa47e: {"kind": 'reg', "py": 'r[3] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0xa480: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA188, 2, r[3])', "slot_py": None, "target": None, "cond": None},
    0xa482: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFA18A, 1, r[1])', "target": None, "cond": None},}
