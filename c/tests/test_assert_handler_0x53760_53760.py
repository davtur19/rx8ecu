#!/usr/bin/env python3
"""Differential test for assert_handler_0x53760 (0x53760) — v3 lift (branches + delay slots), 16 bytes.
...
Run from repo root: python3 c/tests/test_assert_handler_0x53760_53760.py
"""
...
ENTRY = 0x53760
RAW = bytes.fromhex("8F 02 00 09 A0 01 65 63 65 43 4F 26 00 0B 60 53")
SEED = 43
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = None
SPAN_END = 0x53770
SENT = 0x53770     # stop-sentinel, placed past the literal pool
