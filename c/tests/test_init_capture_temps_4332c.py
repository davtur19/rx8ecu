#!/usr/bin/env python3
"""Differential test for init_capture_temps (0x4332C) — v3 lift + v4 FPU, 24 bytes.
...
Run from repo root: python3 c/tests/test_init_capture_temps_4332c.py
"""
...
ENTRY = 0x4332C
RAW = bytes.fromhex("D2 3A E3 01 91 6B 22 30 F3 18 D0 39 F0 3A 93 67 D2 38 F3 38 00 0B F2 3A")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCA40
SPAN_END = 0x43344
SENT = 0x43344     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x4332c: {"kind": 'reg', "py": 'r[2] = 0xFFFFCA3A', "slot_py": None, "target": None, "cond": None},
    0x4332e: {"kind": 'reg', "py": 'r[3] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x43330: {"kind": 'reg', "py": 'r[1] = 0xFFFFB594', "slot_py": None, "target": None, "cond": None},
    0x43332: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCA3A, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x43334: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFB594, 4))', "slot_py": None, "target": None, "cond": None},
    0x43336: {"kind": 'reg', "py": 'r[0] = 0xFFFFCA3C', "slot_py": None, "target": None, "cond": None},
    0x43338: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFCA3C, 4, f2bits(fr[3]))', "slot_py": None, "target": None, "cond": None},
    0x4333a: {"kind": 'reg', "py": 'r[3] = 0xFFFFC0D8', "slot_py": None, "target": None, "cond": None},
    0x4333c: {"kind": 'reg', "py": 'r[2] = 0xFFFFCA40', "slot_py": None, "target": None, "cond": None},
    0x4333e: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFC0D8, 4))', "slot_py": None, "target": None, "cond": None},
    0x43340: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFCA40, 4, f2bits(fr[3]))', "target": None, "cond": None},}
