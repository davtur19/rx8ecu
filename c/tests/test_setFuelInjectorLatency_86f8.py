#!/usr/bin/env python3
"""Differential test for setFuelInjectorLatency (0x86F8) — v3 lift (branches + delay slots), 36 bytes.
...
Run from repo root: python3 c/tests/test_setFuelInjectorLatency_86f8.py
"""
...
ENTRY = 0x86F8
RAW = bytes.fromhex("D6 3C 24 48 8F 02 60 43 26 52 16 53 88 01 8F 02 60 43 16 51 16 54 88 02 8F 02 00 09 16 52 16 55 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFA094
SPAN_END = 0x871C
SENT = 0x871C     # stop-sentinel, placed past the literal pool
