#!/usr/bin/env python3
"""Differential test for read_engine_speed_status (0x13070) — v3 lift + v4 FPU, 28 bytes.
...
Run from repo root: python3 c/tests/test_read_engine_speed_status_13070.py
"""
...
ENTRY = 0x13070
RAW = bytes.fromhex("D4 0E D3 0F F2 48 F3 38 92 09 F2 32 D1 0D F2 2A F1 18 F0 48 93 04 F0 12 00 0B F3 0A")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFA688
SPAN_END = 0x1308C
SENT = 0x130B8     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x13070: {"kind": 'reg', "py": 'r[4] = 0x00072BF8', "slot_py": None, "target": None, "cond": None},
    0x13072: {"kind": 'reg', "py": 'r[3] = 0xFFFFA684', "slot_py": None, "target": None, "cond": None},
    0x13074: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, r[4], 4))', "slot_py": None, "target": None, "cond": None},
    0x13076: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFA684, 4))', "slot_py": None, "target": None, "cond": None},
    0x13078: {"kind": 'reg', "py": 'r[2] = 0xFFFFA670', "slot_py": None, "target": None, "cond": None},
    0x1307a: {"kind": 'fpu', "py": 'fr[2] = ts(fr[2] * fr[3])', "slot_py": None, "target": None, "cond": None},
    0x1307c: {"kind": 'reg', "py": 'r[1] = 0xFFFFA688', "slot_py": None, "target": None, "cond": None},
    0x1307e: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFA670, 4, f2bits(fr[2]))', "slot_py": None, "target": None, "cond": None},
    0x13080: {"kind": 'fpu', "py": 'fr[1] = bits2f(_rdw(ram, 0xFFFFA688, 4))', "slot_py": None, "target": None, "cond": None},
    0x13082: {"kind": 'fpu', "py": 'fr[0] = bits2f(_rdw(ram, r[4], 4))', "slot_py": None, "target": None, "cond": None},
    0x13084: {"kind": 'reg', "py": 'r[3] = 0xFFFFA674', "slot_py": None, "target": None, "cond": None},
    0x13086: {"kind": 'fpu', "py": 'fr[0] = ts(fr[0] * fr[1])', "slot_py": None, "target": None, "cond": None},
    0x13088: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFA674, 4, f2bits(fr[0]))', "target": None, "cond": None},}
