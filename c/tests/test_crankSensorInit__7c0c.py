#!/usr/bin/env python3
"""Differential test for crankSensorInit_ (0x7C0C) — v3 lift (branches + delay slots), 36 bytes.
...
Run from repo root: python3 c/tests/test_crankSensorInit__7c0c.py
"""
...
ENTRY = 0x7C0C
RAW = bytes.fromhex("60 0C 88 01 8F 0A 00 09 D1 12 E2 0C D0 19 63 00 63 3C 33 23 8F 03 64 10 A0 01 74 24 94 16 D3 14 00 0B 23 40")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFF9FC6
SPAN_END = 0x7C30
SENT = 0x7C30     # stop-sentinel, placed past the literal pool
