#!/usr/bin/env python3
"""Differential test for task_diag_monitor_flags_2B136 (0x2B136) — v3 lift (branches + delay slots), 22 bytes.
...
Run from repo root: python3 c/tests/test_task_diag_monitor_flags_2B136_2b136.py
"""
...
ENTRY = 0x2B136
RAW = bytes.fromhex("7A 10 60 73 7F 10 68 F6 69 F6 6A F6 6B F6 6C F6 6D F6 00 0B 6E F6")
SEED = 0
N = 2000
MAXSTEPS = 100000
STACK_BASE = 0xFFFFD000
STACK_TOP = STACK_BASE + 0x400
STACK_OFFS = (0x410, 0x414, 0x418, 0x41C, 0x420, 0x424, 0x428)
SEED_OFFS = (())   # lds.l pr/macl/mach slots seeded with the return sentinel
RAM_MIN = None
RAM_MAX = None
SPAN_END = 0x2B14C
SENT = 0x2B14C     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x2b136: {"kind": 'reg', "py": 'r[10] = (r[10] + s8(0x10)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    ...
    0x2b13c: {"kind": 'mem', "py": 'r[8] = _rdw(ram, STACK_BASE + 0x410, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x2b13e: {"kind": 'mem', "py": 'r[9] = _rdw(ram, STACK_BASE + 0x414, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x2b140: {"kind": 'mem', "py": 'r[10] = _rdw(ram, STACK_BASE + 0x418, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x2b142: {"kind": 'mem', "py": 'r[11] = _rdw(ram, STACK_BASE + 0x41C, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x2b144: {"kind": 'mem', "py": 'r[12] = _rdw(ram, STACK_BASE + 0x420, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x2b146: {"kind": 'mem', "py": 'r[13] = _rdw(ram, STACK_BASE + 0x424, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x2b148: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, STACK_BASE + 0x428, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},}
