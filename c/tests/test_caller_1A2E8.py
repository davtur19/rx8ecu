#!/usr/bin/env python3
"""Differential test for caller_1A2E8 (entry 0x1A2E8) — v8 ST caller (CFG), 40 bytes.
...
Run: python3 test_caller_1A2E8.py
"""
...
CODE = {
    0x1a2e8: {"kind": 'mem', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, r[14])\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x1a2ea: {"kind": 'st', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x1a2ec: {"kind": 'reg', "py": 'r[14] = 0xFFFFAA68', "slot_py": None, "target": None, "cond": None},
    0x1a2ee: {"kind": 'reg', "py": 'r[3] = 0xFFFFAACC', "slot_py": None, "target": None, "cond": None},
    0x1a2f0: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFAACC, 1))', "slot_py": None, "target": None, "cond": None},
    0x1a2f2: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x1a2f4: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x1a2f6: {"kind": "branch", "py": None, "slot_py": '', "target": 0x1a306, "cond": 'notT'},
    0x1a2fa: {"kind": 'reg', "py": 'r[5] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x1a2fc: {"kind": 'reg', "py": 'r[1] = 0x00002460', "slot_py": None, "target": None, "cond": None},
    0x1a2fe: {"kind": "call", "py": None, "slot_py": 'r[4] = s16(_rdw(ram, 0xFFFFAA68, 2))', "target": 0x2460, "ret_pc": 0x1a302, "set_pr": True, "cond": None},
    0x1a302: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFAA68, 2, r[0])', "target": 0x1a30a, "cond": 'always'},
    0x1a306: {"kind": 'reg', "py": 'r[2] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x1a308: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFAA68, 2, r[2])', "slot_py": None, "target": None, "cond": None},
    0x1a30a: {"kind": 'st', "py": 'pr = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x1a30c: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},
