#!/usr/bin/env python3
"""Differential test for fp_sensor_init_44B04 (0x44B04) — v3 lift + v4 FPU, 12 bytes.
...
Run from repo root: python3 c/tests/test_fp_sensor_init_44B04_44b04.py
"""
...
RAM_MAX = 0xFFFFCB14
SPAN_END = 0x44B10
SENT = 0x44B10     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x44b04: {"kind": 'reg', "py": 'r[3] = 0xFFFFCB14', "slot_py": None, "target": None, "cond": None},
    0x44b06: {"kind": 'fpu', "py": 'fr[4] = 0.0', "slot_py": None, "target": None, "cond": None},
    0x44b08: {"kind": 'reg', "py": 'r[2] = 0xFFFFCB0C', "slot_py": None, "target": None, "cond": None},
    0x44b0a: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFCB14, 4, f2bits(fr[4]))', "slot_py": None, "target": None, "cond": None},
    0x44b0c: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFCB0C, 4, f2bits(fr[4]))', "target": None, "cond": None},}
