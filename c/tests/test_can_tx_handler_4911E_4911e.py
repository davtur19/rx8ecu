#!/usr/bin/env python3
"""Differential test for can_tx_handler_4911E (0x4911E) — v3 lift (branches + delay slots), 32 bytes.
...
Run from repo root: python3 c/tests/test_can_tx_handler_4911E_4911e.py
"""
...
ENTRY = 0x4911E
RAW = bytes.fromhex("8F 03 00 09 E3 01 A0 02 24 30 E1 00 24 10 00 0B 00 09 CC 3C C8 1D C8 12 C8 14 C8 6D C8 6F C8 71")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
CODE = {
    ...
    0x49138: {"kind": 'reg', "py": 'T = 1 if (r[0] & 0x6D) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x4913a: {"kind": 'reg', "py": 'T = 1 if (r[0] & 0x6F) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x4913c: {"kind": 'reg', "py": 'T = 1 if (r[0] & 0x71) == 0 else 0', "slot_py": None, "target": None, "cond": None},}
