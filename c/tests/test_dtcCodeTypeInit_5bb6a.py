#!/usr/bin/env python3
"""Differential test for dtcCodeTypeInit (0x5BB6A) — v3 lift (branches + delay slots), 12 bytes.
...
Run from repo root: python3 c/tests/test_dtcCodeTypeInit_5bb6a.py
"""
...
CODE = {
    0x5bb6a: {"kind": 'reg', "py": 'r[4] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x5bb6c: {"kind": 'reg', "py": 'r[3] = 0xFFFFD320', "slot_py": None, "target": None, "cond": None},
    0x5bb6e: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD320, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x5bb70: {"kind": 'reg', "py": 'r[2] = 0xFFFFD322', "slot_py": None, "target": None, "cond": None},
    0x5bb72: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFD322, 2, r[4])', "target": None, "cond": None},}
