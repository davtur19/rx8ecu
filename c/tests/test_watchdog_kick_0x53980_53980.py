#!/usr/bin/env python3
"""Differential test for watchdog_kick_0x53980 (0x53980) — v3 lift (branches + delay slots), 64 bytes.
...
Run from repo root: python3 c/tests/test_watchdog_kick_0x53980_53980.py
"""
...
ENTRY = 0x53980
RAW = bytes.fromhex("8F 01 00 09 74 08 93 17 60 30 60 0C 88 01 8F 01 00 09 74 20 93 11 60 30 60 0C 88 01 8F 01 00 09 74 40 00 0B 60 43 CF D5 CF CF CF 9D 90 0C 90 08 8F E8 CF 99 CF A4 CF 95 CF A1 CF B3 00 03 E0 DC")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
CODE = {
    ...
    0x539b6: {"kind": 'mem', "py": '_wrw(ram, (gbr + r[0]), 1, _rdw(ram, (gbr + r[0]), 1) | 0x95)', "slot_py": None, "target": None, "cond": None},
