#!/usr/bin/env python3
"""Differential test for caller_17D3E (entry 0x17D3E) — v8 ST caller (CFG), 30 bytes.
...
Run: python3 test_caller_17D3E.py
"""
...
CODE = {
    0x17d3e: {"kind": 'mem', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, r[14])\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x17d40: {"kind": 'st', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x17d42: {"kind": 'reg', "py": 'r[14] = 0x0003E1F8', "slot_py": None, "target": None, "cond": None},
    0x17d44: {"kind": 'reg', "py": 'r[4] = 0xFFFF807C', "slot_py": None, "target": None, "cond": None},
    0x17d46: {"kind": "call", "py": None, "slot_py": 'r[5] = s8(0x00)', "target": 0x3e1f8, "ret_pc": 0x17d4a, "set_pr": True, "cond": None},
    0x17d4a: {"kind": 'reg', "py": 'r[4] = 0xFFFF8078', "slot_py": None, "target": None, "cond": None},
    0x17d4c: {"kind": "call", "py": None, "slot_py": 'r[5] = s8(0x00)', "target": 0x3e1f8, "ret_pc": 0x17d50, "set_pr": True, "cond": None},
    0x17d50: {"kind": 'reg', "py": 'r[4] = 0xFFFF807A', "slot_py": None, "target": None, "cond": None},
    0x17d52: {"kind": "call", "py": None, "slot_py": 'r[5] = s8(0x37)', "target": 0x3e1f8, "ret_pc": 0x17d56, "set_pr": True, "cond": None},
    0x17d56: {"kind": 'st', "py": 'pr = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x17d58: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},
