#!/usr/bin/env python3
"""Differential test for caller_E4B4 (entry 0xE4B4) — v8 ST caller (CFG), 36 bytes.
...
Run: python3 test_caller_E4B4.py
"""
...
CODE = {
    0xe4b4: {"kind": 'mem', "py": 'local[0x3FC] = r[14]\n_wrw(ram, STACK_BASE + 0x3FC, 4, r[14])\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xe4b6: {"kind": 'st', "py": 'local[0x3F8] = pr\n_wrw(ram, STACK_BASE + 0x3F8, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xe4b8: {"kind": 'reg', "py": 'r[14] = 0xFFFFA424', "slot_py": None, "target": None, "cond": None},
    0xe4ba: {"kind": 'reg', "py": 'r[2] = 0xFFFFA428', "slot_py": None, "target": None, "cond": None},
    0xe4bc: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFA428, 1))', "slot_py": None, "target": None, "cond": None},
    0xe4be: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0xe4c0: {"kind": "branch", "py": None, "slot_py": '', "target": 0xe4c8, "cond": 'notT'},
    0xe4c4: {"kind": "branch", "py": None, "slot_py": 'r[0] = s8(0x00)', "target": 0xe4d0, "cond": 'always'},
    0xe4c8: {"kind": 'reg', "py": 'r[1] = 0x00002460', "slot_py": None, "target": None, "cond": None},
    0xe4ca: {"kind": 'reg', "py": 'r[5] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0xe4cc: {"kind": "call", "py": None, "slot_py": 'r[4] = s16(_rdw(ram, 0xFFFFA424, 2))', "target": 0x2460, "ret_pc": 0xe4d0, "set_pr": True, "cond": None},
    0xe4d0: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA424, 2, r[0])', "slot_py": None, "target": None, "cond": None},
    0xe4d2: {"kind": 'st', "py": 'pr = _rdw(ram, STACK_BASE + 0x3F8, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xe4d4: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, STACK_BASE + 0x3FC, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},
