#!/usr/bin/env python3
"""Differential test for setRX4B1Timer (0x4AF5A) — v3 lift (branches + delay slots), 10 bytes.
...
Run from repo root: python3 c/tests/test_setRX4B1Timer_4af5a.py
"""
...
ENTRY = 0x4AF5A
RAW = bytes.fromhex("D2 1A 91 17 63 20 00 0B 21 30")
SEED = 0
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCD24
SPAN_END = 0x4AF64
SENT = 0x4AF64     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x4af5a: {"kind": 'reg', "py": 'r[2] = 0x0006D481', "slot_py": None, "target": None, "cond": None},
    0x4af5c: {"kind": 'reg', "py": 'r[1] = 0xFFFFCD24', "slot_py": None, "target": None, "cond": None},
    0x4af5e: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0x0006D481, 1))', "slot_py": None, "target": None, "cond": None},
    0x4af60: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFCD24, 1, r[3])', "target": None, "cond": None},}
