#!/usr/bin/env python3
"""Differential test for diag_fault_cond_eval_90cc (0x56FB6) — pure straight-line lift, 8 bytes.
...
Run from repo root: python3 c/tests/test_diag_fault_cond_eval_90cc_56fb6.py
"""
...
ENTRY = 0x56FB6
RAW = bytes.fromhex("E4 3E 65 03 63 5D 23 38")
SEED = 42
N = 2000
