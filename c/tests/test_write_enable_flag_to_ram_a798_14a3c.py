#!/usr/bin/env python3
"""Differential test for write_enable_flag_to_ram_a798 (0x14A3C) — v3 lift (branches + delay slots), 28 bytes.
...
Run from repo root: python3 c/tests/test_write_enable_flag_to_ram_a798_14a3c.py
"""
...
ENTRY = 0x14A3C
RAW = bytes.fromhex("94 0C 93 0C 60 30 60 0C 88 01 8F 03 00 09 E1 01 A0 02 24 10 E0 00 24 00 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFB5E8
SPAN_END = 0x14A58
SENT = 0x14A5C     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x14a3c: {"kind": 'reg', "py": 'r[4] = 0xFFFFA798', "slot_py": None, "target": None, "cond": None},
    0x14a3e: {"kind": 'reg', "py": 'r[3] = 0xFFFFB5E8', "slot_py": None, "target": None, "cond": None},
    0x14a40: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFB5E8, 1))', "slot_py": None, "target": None, "cond": None},
    0x14a42: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x14a44: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x14a46: {"kind": "branch", "py": None, "slot_py": '', "target": 0x14a50, "cond": 'notT'},
    0x14a4a: {"kind": 'reg', "py": 'r[1] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x14a4c: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFA798, 1, r[1])', "target": 0x14a54, "cond": 'always'},
    0x14a50: {"kind": 'reg', "py": 'r[0] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x14a52: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA798, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x14a54: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
