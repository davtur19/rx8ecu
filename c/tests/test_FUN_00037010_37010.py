#!/usr/bin/env python3
"""Differential test for FUN_00037010 (0x37010) — pure straight-line lift, 8 bytes.
...
Run from repo root: python3 c/tests/test_FUN_00037010_37010.py
"""
...
ENTRY = 0x37010
RAW = bytes.fromhex("00 09 60 4C DE 31 88 01")
SEED = 42
N = 2000
