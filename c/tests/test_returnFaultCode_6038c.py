#!/usr/bin/env python3
"""Differential test for returnFaultCode (0x6038C) — v3 lift (branches + delay slots), 74 bytes.
...
Run from repo root: python3 c/tests/test_returnFaultCode_6038c.py
"""
...
ENTRY = 0x6038C
RAW = bytes.fromhex("00 09 60 73 00 0B 6C F6 2F C6 67 4D D0 34 E5 00 D1 32 07 7C D3 30 E0 15 6C 31 62 CD 35 20 8D 0D 00 09 66 53 46 08 46 08 36 1C 62 4D 63 61 63 3D 33 20 8F 03 00 09 84 69 A0 04 67 03 75 01 35 03 8F EB 00 09 60 73 00 0B 6C F6")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFF8920
SPAN_END = 0x603D6
SENT = 0x603D6     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x6038c: {"kind": 'reg', "py": None, "slot_py": None, "target": None, "cond": None},
    0x6038e: {"kind": 'reg', "py": 'r[0] = r[7]', "slot_py": None, "target": None, "cond": None},
    0x60390: {"kind": "ret", "py": None, "slot_py": 'r[12] = _rdw(ram, STACK_BASE + 0x400, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},
    0x60394: {"kind": 'mem', "py": 'local[0x400] = r[12]\n_wrw(ram, STACK_BASE + 0x400, 4, r[12])\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x60396: {"kind": 'reg', "py": 'r[7] = r[4] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x60398: {"kind": 'reg', "py": 'r[0] = 0x0007C852', "slot_py": None, "target": None, "cond": None},
    0x6039a: {"kind": 'reg', "py": 'r[5] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x6039c: {"kind": 'reg', "py": 'r[1] = 0xFFFF87D0', "slot_py": None, "target": None, "cond": None},
    0x6039e: {"kind": 'mem', "py": 'r[7] = s8(_rdw(ram, (r[7] + r[0]), 1))', "slot_py": None, "target": None, "cond": None},
    0x603a0: {"kind": 'reg', "py": 'r[3] = 0xFFFF8920', "slot_py": None, "target": None, "cond": None},
    0x603a2: {"kind": 'reg', "py": 'r[0] = s8(0x15)', "slot_py": None, "target": None, "cond": None},
    0x603a4: {"kind": 'mem', "py": 'r[12] = s16(_rdw(ram, 0xFFFF8920, 2))', "slot_py": None, "target": None, "cond": None},
    0x603a6: {"kind": 'reg', "py": 'r[2] = r[12] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x603a8: {"kind": 'reg', "py": 'T = 1 if r[5] == r[2] else 0', "slot_py": None, "target": None, "cond": None},
    0x603aa: {"kind": "branch", "py": None, "slot_py": '', "target": 0x603c8, "cond": 'T'},
    0x603ae: {"kind": 'reg', "py": 'r[6] = r[5]', "slot_py": None, "target": None, "cond": None},
    0x603b0: {"kind": 'reg', "py": 'r[6] = (r[6] << 2) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x603b2: {"kind": 'reg', "py": 'r[6] = (r[6] << 2) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x603b4: {"kind": 'reg', "py": 'r[6] = (r[6] + r[1]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x603b6: {"kind": 'reg', "py": 'r[2] = r[4] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x603b8: {"kind": 'mem', "py": 'r[3] = s16(_rdw(ram, r[6], 2))', "slot_py": None, "target": None, "cond": None},
    0x603ba: {"kind": 'reg', "py": 'r[3] = r[3] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x603bc: {"kind": 'reg', "py": 'T = 1 if r[3] == r[2] else 0', "slot_py": None, "target": None, "cond": None},
    0x603be: {"kind": "branch", "py": None, "slot_py": '', "target": 0x603c8, "cond": 'notT'},
    0x603c2: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, (r[6] + 9), 1))', "slot_py": None, "target": None, "cond": None},
    0x603c4: {"kind": "branch", "py": None, "slot_py": 'r[7] = r[0]', "target": 0x603d0, "cond": 'always'},
    0x603c8: {"kind": 'reg', "py": 'r[5] = (r[5] + s8(0x01)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x603ca: {"kind": 'reg', "py": 'T = 1 if s32(r[5]) >= s32(r[0]) else 0', "slot_py": None, "target": None, "cond": None},
    0x603cc: {"kind": "branch", "py": None, "slot_py": '', "target": 0x603a6, "cond": 'notT'},
    0x603d0: {"kind": 'reg', "py": 'r[0] = r[7]', "slot_py": None, "target": None, "cond": None},
    0x603d2: {"kind": "ret", "py": None, "slot_py": 'r[12] = _rdw(ram, STACK_BASE + 0x400, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},}
