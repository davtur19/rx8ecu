#!/usr/bin/env python3
"""Differential test for FUN_000430fe (0x430FE) — v3 lift (branches + delay slots), 82 bytes.
...
Run from repo root: python3 c/tests/test_FUN_000430fe_430fe.py
"""
...
ENTRY = 0x430FE
RAW = bytes.fromhex("93 1F 95 1F 92 1F 60 20 60 0C 88 01 8F 0A 64 30 91 1A D2 0D 60 10 63 20 30 30 8F 03 00 09 E2 00 A0 0C 25 20 61 4C 21 18 8F 08 00 09 D3 08 60 30 60 0C 88 01 8F 02 00 09 E3 01 25 30 D2 04 00 0B 22 40 C9 46 C9 4F AA C6 C9 3F 00 07 A1 7D FF FF C9 9B")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFC99B
SPAN_END = 0x43150
SENT = 0x43150     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x430fe: {"kind": 'reg', "py": 'r[3] = 0xFFFFC946', "slot_py": None, "target": None, "cond": None},
    0x43100: {"kind": 'reg', "py": 'r[5] = 0xFFFFC94F', "slot_py": None, "target": None, "cond": None},
    0x43102: {"kind": 'reg', "py": 'r[2] = 0xFFFFAAC6', "slot_py": None, "target": None, "cond": None},
    0x43104: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFAAC6, 1))', "slot_py": None, "target": None, "cond": None},
    0x43106: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x43108: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x4310a: {"kind": "branch", "py": None, "slot_py": 'r[4] = s8(_rdw(ram, 0xFFFFC946, 1))', "target": 0x43122, "cond": 'notT'},
    0x4310e: {"kind": 'reg', "py": 'r[1] = 0xFFFFC93F', "slot_py": None, "target": None, "cond": None},
    0x43110: {"kind": 'reg', "py": 'r[2] = 0x0007A17D', "slot_py": None, "target": None, "cond": None},
    0x43112: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFC93F, 1))', "slot_py": None, "target": None, "cond": None},
    0x43114: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0x0007A17D, 1))', "slot_py": None, "target": None, "cond": None},
    0x43116: {"kind": 'reg', "py": 'T = 1 if r[0] == r[3] else 0', "slot_py": None, "target": None, "cond": None},
    0x43118: {"kind": "branch", "py": None, "slot_py": '', "target": 0x43122, "cond": 'notT'},
    0x4311c: {"kind": 'reg', "py": 'r[2] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x4311e: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFC94F, 1, r[2])', "target": 0x4313a, "cond": 'always'},
    0x43122: {"kind": 'reg', "py": 'r[1] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x43124: {"kind": 'reg', "py": 'T = 1 if (r[1] & r[1]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x43126: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4313a, "cond": 'notT'},
    0x4312a: {"kind": 'reg', "py": 'r[3] = 0xFFFFC99B', "slot_py": None, "target": None, "cond": None},
    0x4312c: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFC99B, 1))', "slot_py": None, "target": None, "cond": None},
    0x4312e: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x43130: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x43132: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4313a, "cond": 'notT'},
    0x43136: {"kind": 'reg', "py": 'r[3] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x43138: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC94F, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x4313a: {"kind": 'reg', "py": 'r[2] = 0xFFFFC99B', "slot_py": None, "target": None, "cond": None},
    0x4313c: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFC99B, 1, r[4])', "target": None, "cond": None},}
