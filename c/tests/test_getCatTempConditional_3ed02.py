#!/usr/bin/env python3
"""Differential test for getCatTempConditional (0x3ED02) — v3 lift + v4 FPU, 40 bytes.
...
Run from repo root: python3 c/tests/test_getCatTempConditional_3ed02.py
"""
...
ENTRY = 0x3ED02
RAW = bytes.fromhex("93 39 94 3B F4 38 D2 27 F3 28 F3 45 8F 03 00 09 E0 00 A0 07 24 00 D1 24 F2 18 F4 25 8F 02 00 09 E0 01 24 00 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFC64B
SPAN_END = 0x3ED2A
SENT = 0x3ED2A     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x3ed02: {"kind": 'reg', "py": 'r[3] = 0xFFFFC640', "slot_py": None, "target": None, "cond": None},
    0x3ed04: {"kind": 'reg', "py": 'r[4] = 0xFFFFC64B', "slot_py": None, "target": None, "cond": None},
    0x3ed06: {"kind": 'fpu', "py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFC640, 4))', "slot_py": None, "target": None, "cond": None},
    0x3ed08: {"kind": 'reg', "py": 'r[2] = 0x00079CAC', "slot_py": None, "target": None, "cond": None},
    0x3ed0a: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x00079CAC, 4))', "slot_py": None, "target": None, "cond": None},
    0x3ed0c: {"kind": 'fpu', "py": 'T = 1 if fr[3] > fr[4] else 0', "slot_py": None, "target": None, "cond": None},
    0x3ed0e: {"kind": "branch", "py": None, "slot_py": '', "target": 0x3ed18, "cond": 'notT'},
    0x3ed12: {"kind": 'reg', "py": 'r[0] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x3ed14: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFC64B, 1, r[0])', "target": 0x3ed26, "cond": 'always'},
    0x3ed18: {"kind": 'reg', "py": 'r[1] = 0x00079CA8', "slot_py": None, "target": None, "cond": None},
    0x3ed1a: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0x00079CA8, 4))', "slot_py": None, "target": None, "cond": None},
    0x3ed1c: {"kind": 'fpu', "py": 'T = 1 if fr[4] > fr[2] else 0', "slot_py": None, "target": None, "cond": None},
    0x3ed1e: {"kind": "branch", "py": None, "slot_py": '', "target": 0x3ed26, "cond": 'notT'},
    0x3ed22: {"kind": 'reg', "py": 'r[0] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x3ed24: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC64B, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x3ed26: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
