#!/usr/bin/env python3
"""Differential test for read_float_d1cc (0x5E578) — v3 lift + v4 FPU, 12 bytes.
...
Run from repo root: python3 c/tests/test_read_float_d1cc_5e578.py
"""
...
ENTRY = 0x5E578
RAW = bytes.fromhex("D2 2E 00 0B F0 28 93 48 00 0B F0 38")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFD1CC
SPAN_END = 0x5E584
SENT = 0x5E584     # stop-sentinel, placed past the literal pool
