#!/usr/bin/env python3
"""Differential test for ram_pattern_test_write_verify (0xD648) — v3 lift (branches + delay slots), 30 bytes.
...
Run from repo root: python3 c/tests/test_ram_pattern_test_write_verify_d648.py
"""
...
ENTRY = 0xD648
RAW = bytes.fromhex("E4 00 64 63 00 0B 60 43 D4 0C 60 40 60 0C 88 02 8D 03 00 09 D3 0E E2 00 23 20 00 0B 60 40")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFA3FA
SPAN_END = 0xD666
SENT = 0xD666     # stop-sentinel, placed past the literal pool
...
CODE = {
    0xd648: {"kind": 'reg', "py": 'r[4] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0xd64a: {"kind": 'reg', "py": 'r[4] = r[6]', "slot_py": None, "target": None, "cond": None},
    0xd64c: {"kind": "ret", "py": None, "slot_py": 'r[0] = r[4]', "target": None, "cond": None},
    0xd650: {"kind": 'reg', "py": 'r[4] = 0xFFFFA3FA', "slot_py": None, "target": None, "cond": None},
    0xd652: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFA3FA, 1))', "slot_py": None, "target": None, "cond": None},
    0xd654: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0xd656: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x02) else 0', "slot_py": None, "target": None, "cond": None},
    0xd658: {"kind": "branch", "py": None, "slot_py": '', "target": 0xd662, "cond": 'T'},
    0xd65c: {"kind": 'reg', "py": 'r[3] = 0xFFFFA3F9', "slot_py": None, "target": None, "cond": None},
    0xd65e: {"kind": 'reg', "py": 'r[2] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0xd660: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA3F9, 1, r[2])', "slot_py": None, "target": None, "cond": None},
    0xd662: {"kind": "ret", "py": None, "slot_py": 'r[0] = s8(_rdw(ram, 0xFFFFA3FA, 1))', "target": None, "cond": None},}
