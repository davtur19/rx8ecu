#!/usr/bin/env python3
"""Differential test for mem_setter_49ed0 (0x49ED0) — v3 lift (branches + delay slots), 34 bytes.
...
Run from repo root: python3 c/tests/test_mem_setter_49ed0_49ed0.py
"""
...
ENTRY = 0x49ED0
RAW = bytes.fromhex("96 0F 95 0F 93 0F 60 31 60 0D 92 0D 20 29 20 08 00 29 CA 01 88 01 00 29 88 01 04 29 25 40 00 0B 26 40")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFF76C
SPAN_END = 0x49EF2
SENT = 0x49EFA     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x49ed0: {"kind": 'reg', "py": 'r[6] = 0xFFFFCD49', "slot_py": None, "target": None, "cond": None},
    0x49ed2: {"kind": 'reg', "py": 'r[5] = 0xFFFFCD48', "slot_py": None, "target": None, "cond": None},
    0x49ed4: {"kind": 'reg', "py": 'r[3] = 0xFFFFF76C', "slot_py": None, "target": None, "cond": None},
    0x49ed6: {"kind": 'mem', "py": 'r[0] = s16(_rdw(ram, 0xFFFFF76C, 2))', "slot_py": None, "target": None, "cond": None},
    0x49ed8: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x49eda: {"kind": 'reg', "py": 'r[2] = 0x00000100', "slot_py": None, "target": None, "cond": None},
    0x49edc: {"kind": 'reg', "py": 'r[0] = (r[0] & r[2]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x49ede: {"kind": 'reg', "py": 'T = 1 if (r[0] & r[0]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x49ee0: {"kind": 'reg', "py": 'r[0] = T;', "slot_py": None, "target": None, "cond": None},
    0x49ee2: {"kind": 'reg', "py": 'r[0] = (r[0] ^ 0x01) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x49ee4: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x49ee6: {"kind": 'reg', "py": 'r[0] = T;', "slot_py": None, "target": None, "cond": None},
    0x49ee8: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x49eea: {"kind": 'reg', "py": 'r[4] = T;', "slot_py": None, "target": None, "cond": None},
    0x49eec: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCD48, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x49eee: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFCD49, 1, r[4])', "target": None, "cond": None},}
