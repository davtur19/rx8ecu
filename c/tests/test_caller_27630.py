#!/usr/bin/env python3
"""Differential test for caller_27630 (entry 0x27630) — v8 ST caller (CFG), 188 bytes.
...
Run: python3 test_caller_27630.py
"""
...
CODE = {
    0x27630: {"kind": 'mem', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, r[14])\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x27632: {"kind": 'mem', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, r[13])\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x27634: {"kind": 'mem', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, r[12])\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x27636: {"kind": 'st', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x27638: {"kind": 'reg', "py": 'r[4] = 0xFFFFB6ED', "slot_py": None, "target": None, "cond": None},
    0x2763a: {"kind": 'reg', "py": 'r[12] = 0xFFFFB6EB', "slot_py": None, "target": None, "cond": None},
    0x2763c: {"kind": 'reg', "py": 'r[14] = 0xFFFFB6E8', "slot_py": None, "target": None, "cond": None},
    0x2763e: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFB6ED, 1))', "slot_py": None, "target": None, "cond": None},
    0x27640: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x27642: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x27644: {"kind": "branch", "py": None, "slot_py": 'r[13] = s8(0x00)', "target": 0x276b4, "cond": 'notT'},
    0x27648: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFB6EB, 1, r[13])', "slot_py": None, "target": None, "cond": None},
    0x2764a: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFB6E8, 2, r[13])', "slot_py": None, "target": None, "cond": None},
    0x2764c: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFB6ED, 1, r[13])', "target": 0x276e2, "cond": 'always'},
    0x276e2: {"kind": 'st', "py": 'pr = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x276e4: {"kind": 'mem', "py": 'r[12] = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x276e6: {"kind": 'mem', "py": 'r[13] = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x276e8: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None, },
    0x276b4: {"kind": 'reg', "py": 'r[4] = 0x000000FF', "slot_py": None, "target": None, "cond": None},
    0x276b6: {"kind": 'mem', "py": 'r[3] = s16(_rdw(ram, 0xFFFFB6E8, 2))', "slot_py": None, "target": None, "cond": None},
    0x276b8: {"kind": 'reg', "py": 'r[3] = r[3] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x276ba: {"kind": 'reg', "py": 'T = 1 if s32(r[3]) >= s32(r[4]) else 0', "slot_py": None, "target": None, "cond": None},
    0x276bc: {"kind": "branch", "py": None, "slot_py": '', "target": 0x276cc, "cond": 'T'},
    0x276c0: {"kind": 'reg', "py": 'r[3] = 0x00002460', "slot_py": None, "target": None, "cond": None},
    0x276c2: {"kind": 'reg', "py": 'r[5] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x276c4: {"kind": "call", "py": None, "slot_py": 'r[4] = s16(_rdw(ram, 0xFFFFB6E8, 2))', "target": 0x2460, "ret_pc": 0x276c8, "set_pr": True, "cond": None},
    0x276c8: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFB6E8, 2, r[0])', "target": 0x276ce, "cond": 'always'},
    0x276ce: {"kind": 'mem', "py": 'r[3] = s16(_rdw(ram, r[14], 2))', "slot_py": None, "target": None, "cond": None},
    0x276d0: {"kind": 'reg', "py": 'r[1] = 0x0007519C', "slot_py": None, "target": None, "cond": None},
    0x276d2: {"kind": 'mem', "py": 'r[2] = s16(_rdw(ram, 0x0007519C, 2))', "slot_py": None, "target": None, "cond": None},
    0x276d4: {"kind": 'reg', "py": 'T = 1 if (r[3] & 0xFFFFFFFF) >= (r[2] & 0xFFFFFFFF) else 0', "slot_py": None, "target": None, "cond": None},
    0x276d6: {"kind": "branch", "py": None, "slot_py": '', "target": 0x276de, "cond": 'T'},
    0x276da: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFB6EB, 1, r[13])', "target": 0x276e2, "cond": 'always'},
    0x276de: {"kind": 'reg', "py": 'r[3] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x276e0: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFB6EB, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x276cc: {"kind": 'mem', "py": '_wrw(ram, r[14], 2, r[4])', "slot_py": None, "target": None, "cond": None},
