#!/usr/bin/env python3
"""Differential test for FUN_0004f6f2 (0x4F6F2) — pure straight-line lift, 8 bytes.
...
Run from repo root: python3 c/tests/test_FUN_0004f6f2_4f6f2.py
"""
...
ENTRY = 0x4F6F2
RAW = bytes.fromhex("D1 2E D0 34 D1 4A D1 83")
SEED = 42
N = 2000
