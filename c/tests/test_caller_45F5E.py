#!/usr/bin/env python3
"""Differential test for caller_45F5E (entry 0x45F5E) — v8 ST caller (CFG), 20 bytes.
...
Run: python3 test_caller_45F5E.py
"""
...
CODE = {
    0x45f5e: {"kind": 'st', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x45f60: {"kind": 'reg', "py": 'r[4] = 0xFFFF8770', "slot_py": None, "target": None, "cond": None},
    0x45f62: {"kind": 'reg', "py": 'r[3] = 0x0003E1F8', "slot_py": None, "target": None, "cond": None},
    0x45f64: {"kind": "call", "py": None, "slot_py": 'r[5] = s8(0x00)', "target": 0x3e1f8, "ret_pc": 0x45f68, "set_pr": True, "cond": None},
    0x45f68: {"kind": 'reg', "py": 'r[4] = 0xFFFF8772', "slot_py": None, "target": None, "cond": None},
    0x45f6a: {"kind": 'reg', "py": 'r[5] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x45f6c: {"kind": 'reg', "py": 'r[2] = 0x0003E1F8', "slot_py": None, "target": None, "cond": None},
    0x45f6e: {"kind": "call", "py": None, "slot_py": 'pr = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": 0x3e1f8, "ret_pc": 0x45f72, "set_pr": False, "cond": None},
