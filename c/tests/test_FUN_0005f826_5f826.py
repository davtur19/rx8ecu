#!/usr/bin/env python3
"""Differential test for FUN_0005f826 (0x5F826) — pure straight-line lift, 10 bytes.
...
Run from repo root: python3 c/tests/test_FUN_0005f826_5f826.py
"""
...
ENTRY = 0x5F826
RAW = bytes.fromhex("45 01 47 01 49 01 4A 01 4C 01")
SEED = 42
N = 2000
...
def spec_mirror(r4, r5, r6, r7):
    ...
    # 0x05F828: op 0x4701
    r[7] = (r[7] >> 1) & 0xFFFFFFFF
    # 0x05F82A: op 0x4901
    r[9] = (r[9] >> 1) & 0xFFFFFFFF
    # 0x05F82C: op 0x4A01
    r[10] = (r[10] >> 1) & 0xFFFFFFFF
    # 0x05F82E: op 0x4C01
    r[12] = (r[12] >> 1) & 0xFFFFFFFF
