#!/usr/bin/env python3
"""Differential test for FUN_00021730 (0x21730) — pure straight-line lift, 10 bytes.
...
Run from repo root: python3 c/tests/test_FUN_00021730_21730.py
"""
...
ENTRY = 0x21730
RAW = bytes.fromhex("D6 3B 95 68 DC 3C DD 3D D1 3D")
SEED = 42
N = 2000
