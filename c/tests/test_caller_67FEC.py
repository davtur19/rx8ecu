#!/usr/bin/env python3
"""Differential test for caller_67FEC (entry 0x67FEC) — v8 ST caller (CFG), 18 bytes.
...
Run: python3 test_caller_67FEC.py
"""
...
CODE = {
    0x67fec: {"kind": 'st', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x67fee: {"kind": 'reg', "py": 'r[3] = 0xFFFF8FC4', "slot_py": None, "target": None, "cond": None},
    0x67ff0: {"kind": 'reg', "py": 'r[2] = 0x00002430', "slot_py": None, "target": None, "cond": None},
    0x67ff2: {"kind": "call", "py": None, "slot_py": 'r[4] = s16(_rdw(ram, 0xFFFF8FC4, 2))', "target": 0x2430, "ret_pc": 0x67ff6, "set_pr": True, "cond": None},
    0x67ff6: {"kind": 'reg', "py": 'r[1] = 0xFFFF8FC0', "slot_py": None, "target": None, "cond": None},
    0x67ff8: {"kind": 'st', "py": 'pr = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x67ffa: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFF8FC0, 4, r[0])', "target": None, "cond": None},
