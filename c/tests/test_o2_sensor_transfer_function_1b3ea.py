#!/usr/bin/env python3
"""Differential test for o2_sensor_transfer_function (0x1B3EA) — v3 lift + v4 FPU, 10 bytes.
...
Run from repo root: python3 c/tests/test_o2_sensor_transfer_function_1b3ea.py
"""
...
RAM_MAX = 0xFFFFAAD0
SPAN_END = 0x1B3F4
SENT = 0x1B3F4     # stop-sentinel, placed past the literal pool
