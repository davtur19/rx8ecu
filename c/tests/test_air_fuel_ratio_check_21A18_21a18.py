#!/usr/bin/env python3
"""Differential test for air_fuel_ratio_check_21A18 (0x21A18) — v3 lift + v4 FPU, 76 bytes.
...
Run from repo root: python3 c/tests/test_air_fuel_ratio_check_21A18_21a18.py
"""
...
ENTRY = 0x21A18
RAW = bytes.fromhex("94 6F D3 3F 92 6E F3 38 F2 28 F3 25 8D 1A 00 09 91 69 60 10 D3 3B 62 30 30 22 8D 13 00 09 92 63 60 20 20 08 8F 0E 00 09 93 5F 60 30 60 0C 88 01 8F 08 00 09 92 5A 60 20 20 08 8F 03 00 09 E1 01 A0 02 24 10 E2 00 24 20 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFC656
SPAN_END = 0x21A64
SENT = 0x21A64     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x21a18: {"kind": 'reg', "py": 'r[4] = 0xFFFFB2F4', "slot_py": None, "target": None, "cond": None},
    0x21a1a: {"kind": 'reg', "py": 'r[3] = 0x00070054', "slot_py": None, "target": None, "cond": None},
    0x21a1c: {"kind": 'reg', "py": 'r[2] = 0xFFFFADC8', "slot_py": None, "target": None, "cond": None},
    0x21a1e: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x00070054, 4))', "slot_py": None, "target": None, "cond": None},
    0x21a20: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0xFFFFADC8, 4))', "slot_py": None, "target": None, "cond": None},
    0x21a22: {"kind": 'fpu', "py": 'T = 1 if fr[3] > fr[2] else 0', "slot_py": None, "target": None, "cond": None},
    0x21a24: {"kind": "branch", "py": None, "slot_py": '', "target": 0x21a5c, "cond": 'T'},
    0x21a28: {"kind": 'reg', "py": 'r[1] = 0xFFFFB2E0', "slot_py": None, "target": None, "cond": None},
    0x21a2a: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFB2E0, 1))', "slot_py": None, "target": None, "cond": None},
    0x21a2c: {"kind": 'reg', "py": 'r[3] = 0x00070050', "slot_py": None, "target": None, "cond": None},
    0x21a2e: {"kind": 'mem', "py": 'r[2] = s8(_rdw(ram, 0x00070050, 1))', "slot_py": None, "target": None, "cond": None},
    0x21a30: {"kind": 'reg', "py": 'T = 1 if (r[0] & 0xFFFFFFFF) >= (r[2] & 0xFFFFFFFF) else 0', "slot_py": None, "target": None, "cond": None},
    0x21a32: {"kind": "branch", "py": None, "slot_py": '', "target": 0x21a5c, "cond": 'T'},
    0x21a36: {"kind": 'reg', "py": 'r[2] = 0xFFFFAADA', "slot_py": None, "target": None, "cond": None},
    0x21a38: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFAADA, 1))', "slot_py": None, "target": None, "cond": None},
    0x21a3a: {"kind": 'reg', "py": 'T = 1 if (r[0] & r[0]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x21a3c: {"kind": "branch", "py": None, "slot_py": '', "target": 0x21a5c, "cond": 'notT'},
    0x21a40: {"kind": 'reg', "py": 'r[3] = 0xFFFFA428', "slot_py": None, "target": None, "cond": None},
    0x21a42: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFA428, 1))', "slot_py": None, "target": None, "cond": None},
    0x21a44: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x21a46: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x21a48: {"kind": "branch", "py": None, "slot_py": '', "target": 0x21a5c, "cond": 'notT'},
    0x21a4c: {"kind": 'reg', "py": 'r[2] = 0xFFFFC656', "slot_py": None, "target": None, "cond": None},
    0x21a4e: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFC656, 1))', "slot_py": None, "target": None, "cond": None},
    0x21a50: {"kind": 'reg', "py": 'T = 1 if (r[0] & r[0]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x21a52: {"kind": "branch", "py": None, "slot_py": '', "target": 0x21a5c, "cond": 'notT'},
    0x21a56: {"kind": 'reg', "py": 'r[1] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x21a58: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFB2F4, 1, r[1])', "target": 0x21a60, "cond": 'always'},
    0x21a5c: {"kind": 'reg', "py": 'r[2] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x21a5e: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFB2F4, 1, r[2])', "slot_py": None, "target": None, "cond": None},
    0x21a60: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
