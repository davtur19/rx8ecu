#!/usr/bin/env python3
"""Differential test for sci4_rx_word_16bit_synchronous (0xC1FC) — v3 lift + v4 FPU, 122 bytes.
...
Run from repo root: python3 c/tests/test_sci4_rx_word_16bit_synchronous_c1fc.py
"""
...
CODE = {
    0xc1fc: {"kind": 'mem', "py": 'local[0x3FC] = r[11]\n_wrw(ram, STACK_BASE + 0x3FC, 4, r[11])\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xc1fe: {"kind": 'mem', "py": 'local[0x3F8] = r[10]\n_wrw(ram, STACK_BASE + 0x3F8, 4, r[10])\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    ...
    0xc26c: {"kind": 'mem', "py": 'r[10] = _rdw(ram, STACK_BASE + 0x3F8, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xc26e: {"kind": 'mem', "py": 'r[11] = _rdw(ram, STACK_BASE + 0x3FC, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xc270: {"kind": 'mem', "py": 'r[12] = _rdw(ram, STACK_BASE + 0x400, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xc272: {"kind": "ret", "py": None, "slot_py": 'r[13] = _rdw(ram, STACK_BASE + 0x404, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},}
