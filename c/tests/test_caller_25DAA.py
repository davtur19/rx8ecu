#!/usr/bin/env python3
"""Differential test for caller_25DAA (entry 0x25DAA) — v8 ST caller (CFG), 48 bytes.
...
Run: python3 test_caller_25DAA.py
"""
...
CODE = {
    0x25daa: {"kind": 'mem', "py": 'local[0x3FC] = r[14]\n_wrw(ram, STACK_BASE + 0x3FC, 4, r[14])\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x25dac: {"kind": 'st', "py": 'local[0x3F8] = pr\n_wrw(ram, STACK_BASE + 0x3F8, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x25dae: {"kind": 'reg', "py": 'r[14] = 0xFFFFB5B8', "slot_py": None, "target": None, "cond": None},
    0x25db0: {"kind": 'reg', "py": 'r[3] = 0xFFFFB5D4', "slot_py": None, "target": None, "cond": None},
    0x25db2: {"kind": 'fpu', "py": 'fr[0] = bits2f(_rdw(ram, 0xFFFFB5D4, 4))', "slot_py": None, "target": None, "cond": None},
    0x25db4: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFB5B8, 4))', "slot_py": None, "target": None, "cond": None},
    0x25db6: {"kind": 'fpu', "py": 'fr[3] = ts(fr[3] - fr[0])', "slot_py": None, "target": None, "cond": None},
    0x25db8: {"kind": 'fpu', "py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFB5B8, 4))', "slot_py": None, "target": None, "cond": None},
    0x25dba: {"kind": 'reg', "py": 'r[2] = 0x00075174', "slot_py": None, "target": None, "cond": None},
    0x25dbc: {"kind": 'reg', "py": 'r[0] = 0x00025E20', "slot_py": None, "target": None, "cond": None},
    0x25dbe: {"kind": 'fpu', "py": 'fr[0] = bits2f(_rdw(ram, 0x00075174, 4))', "slot_py": None, "target": None, "cond": None},
    0x25dc0: {"kind": 'fpu', "py": 'fr[6] = bits2f(_rdw(ram, 0x00025E20, 4))', "slot_py": None, "target": None, "cond": None},
    0x25dc2: {"kind": 'fpu', "py": 'fr[4] = ts(fr[0] * fr[3] + fr[4])', "slot_py": None, "target": None, "cond": None},
    0x25dc4: {"kind": 'reg', "py": 'r[1] = 0x00002404', "slot_py": None, "target": None, "cond": None},
    0x25dc6: {"kind": "call", "py": None, "slot_py": 'fr[5] = 0.0', "target": 0x2404, "ret_pc": 0x25dca, "set_pr": True, "cond": None},
    0x25dca: {"kind": 'reg', "py": 'r[3] = 0xFFFFB5CC', "slot_py": None, "target": None, "cond": None},
    0x25dcc: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFB5CC, 4, f2bits(fr[0]))', "slot_py": None, "target": None, "cond": None},
    0x25dce: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFB5B8, 4))', "slot_py": None, "target": None, "cond": None},
    0x25dd0: {"kind": 'reg', "py": 'r[2] = 0xFFFFB5D4', "slot_py": None, "target": None, "cond": None},
    0x25dd2: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFB5D4, 4, f2bits(fr[3]))', "slot_py": None, "target": None, "cond": None},
    0x25dd4: {"kind": 'st', "py": 'pr = _rdw(ram, STACK_BASE + 0x3F8, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x25dd6: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, STACK_BASE + 0x3FC, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},
