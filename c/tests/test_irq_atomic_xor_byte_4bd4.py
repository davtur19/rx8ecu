#!/usr/bin/env python3
"""Differential test for irq_atomic_xor_byte (0x4BD4) — v3 lift (branches + delay slots), 16 bytes.
...
Run from repo root: python3 c/tests/test_irq_atomic_xor_byte_4bd4.py
"""
...
ENTRY = 0x4BD4
RAW = bytes.fromhex("93 0E 02 02 43 0E 63 40 23 5A 24 30 00 0B 42 0E")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = None
SPAN_END = 0x4BE4
SENT = 0x4BE4     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x4bd4: {"kind": 'reg', "py": 'r[3] = 0x000000E0', "slot_py": None, "target": None, "cond": None},
    0x4bd6: {"kind": 'reg', "py": 'r[2] = sr', "slot_py": None, "target": None, "cond": None},
    0x4bd8: {"kind": 'reg', "py": 'sr = r[3]', "slot_py": None, "target": None, "cond": None},
    0x4bda: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, r[4], 1))', "slot_py": None, "target": None, "cond": None},
    0x4bdc: {"kind": 'reg', "py": 'r[3] = (r[3] ^ r[5]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x4bde: {"kind": 'mem', "py": '_wrw(ram, r[4], 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x4be0: {"kind": "ret", "py": None, "slot_py": 'sr = r[2]', "target": None, "cond": None},}
