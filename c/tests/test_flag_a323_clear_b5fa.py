#!/usr/bin/env python3
"""Differential test for flag_a323_clear (0xB5FA) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_flag_a323_clear_b5fa.py
"""
...
RAM_MAX = 0xFFFFA323
SPAN_END = 0xB602
SENT = 0xB602     # stop-sentinel, placed past the literal pool
...
CODE = {
    0xb5fa: {"kind": 'reg', "py": 'r[3] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0xb5fc: {"kind": 'reg', "py": 'r[2] = 0xFFFFA323', "slot_py": None, "target": None, "cond": None},
    0xb5fe: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFA323, 1, r[3])', "target": None, "cond": None},}
