#!/usr/bin/env python3
"""Differential test for knock_counter_reset_check (0x13D1C) — v3 lift + v4 FPU, 134 bytes.
...
Run from repo root: python3 c/tests/test_knock_counter_reset_check_13d1c.py
"""
...
CODE = {
    0x13d1c: {"kind": 'reg', "py": 'r[3] = 0xFFFFB594', "slot_py": None, "target": None, "cond": None},
    0x13d1e: {"kind": 'fpu', "py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFB594, 4))', "slot_py": None, "target": None, "cond": None},
    0x13d20: {"kind": 'reg', "py": 'r[2] = 0xFFFFC0D8', "slot_py": None, "target": None, "cond": None},
    0x13d22: {"kind": 'fpu', "py": 'fr[5] = bits2f(_rdw(ram, 0xFFFFC0D8, 4))', "slot_py": None, "target": None, "cond": None},
    0x13d24: {"kind": 'reg', "py": 'r[1] = 0x000727D0', "slot_py": None, "target": None, "cond": None},
    0x13d26: {"kind": 'fpu', "py": 'fr[6] = bits2f(_rdw(ram, 0x000727D0, 4))', "slot_py": None, "target": None, "cond": None},
    0x13d28: {"kind": 'reg', "py": 'r[3] = 0x000727D4', "slot_py": None, "target": None, "cond": None},
    0x13d2a: {"kind": 'fpu', "py": 'fr[7] = fr[6]', "slot_py": None, "target": None, "cond": None},
    0x13d2c: {"kind": 'reg', "py": 'r[5] = 0xFFFFA777', "slot_py": None, "target": None, "cond": None},
    0x13d2e: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x000727D4, 4))', "slot_py": None, "target": None, "cond": None},
    0x13d30: {"kind": 'fpu', "py": 'fr[7] = ts(fr[7] - fr[3])', "slot_py": None, "target": None, "cond": None},
    0x13d32: {"kind": 'fpu', "py": 'T = 1 if fr[6] > fr[4] else 0', "slot_py": None, "target": None, "cond": None},
    0x13d34: {"kind": "branch", "py": None, "slot_py": 'r[4] = s8(0x00)', "target": 0x13d3c, "cond": 'T'},
    0x13d38: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFA777, 1, r[4])', "target": 0x13d46, "cond": 'always'},
    ...
    0x13d44: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA777, 1, r[0])', "slot_py": None, "target": None, "cond": None},
