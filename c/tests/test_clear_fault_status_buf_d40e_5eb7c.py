#!/usr/bin/env python3
"""Differential test for clear_fault_status_buf_d40e (0x5EB7C) — v3 lift (branches + delay slots), 24 bytes.
...
Run from repo root: python3 c/tests/test_clear_fault_status_buf_d40e_5eb7c.py
"""
...
ENTRY = 0x5EB7C
RAW = bytes.fromhex("97 20 E6 00 D4 10 65 63 24 60 75 01 63 5D 33 73 8F FA 74 01 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFD40E
SPAN_END = 0x5EB94
SENT = 0x5EB94     # stop-sentinel, placed past the literal pool
