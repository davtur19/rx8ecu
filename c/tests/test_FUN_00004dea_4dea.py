#!/usr/bin/env python3
"""Differential test for FUN_00004dea (0x4DEA) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_FUN_00004dea_4dea.py
"""
...
ENTRY = 0x4DEA
RAW = bytes.fromhex("92 2E 93 2E 00 0B 23 21")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFED18
SPAN_END = 0x4DF2
SENT = 0x4DF2     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x4dea: {"kind": 'reg', "py": 'r[2] = 0x000000FF', "slot_py": None, "target": None, "cond": None},
    0x4dec: {"kind": 'reg', "py": 'r[3] = 0xFFFFED18', "slot_py": None, "target": None, "cond": None},
    0x4dee: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFED18, 2, r[2])', "target": None, "cond": None},}
