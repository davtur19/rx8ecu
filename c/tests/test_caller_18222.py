#!/usr/bin/env python3
"""Differential test for caller_18222 (entry 0x18222) — v8 ST caller (CFG), 30 bytes.
...
Run: python3 test_caller_18222.py
"""
...
CODE = {
    ...
    0x1822e: {"kind": 'reg', "py": 'r[4] = 0xFFFF8078', "slot_py": None, "target": None, "cond": None},
