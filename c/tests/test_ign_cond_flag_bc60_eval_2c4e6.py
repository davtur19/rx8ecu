#!/usr/bin/env python3
"""Differential test for ign_cond_flag_bc60_eval (0x2C4E6) — v3 lift + v4 FPU, 98 bytes.
...
Run from repo root: python3 c/tests/test_ign_cond_flag_bc60_eval_2c4e6.py
"""
...
ENTRY = 0x2C4E6
RAW = bytes.fromhex("93 4D D4 32 92 4C 60 20 60 0C 88 01 8F 25 F4 38 D1 30 93 46 F3 18 F2 38 F3 25 8D 1E 00 09 D2 2D F1 28 F1 45 8D 19 00 09 D3 2C F3 38 F3 45 8F 14 00 09 92 37 60 20 20 08 8F 0F 00 09 93 33 60 30 60 0C 88 01 8F 09 00 09 92 2E 60 21 60 0D 40 15 8F 03 00 09 E2 01 A0 02 24 20 E1 00 24 10 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCCFA
SPAN_END = 0x2C548
SENT = 0x2C548     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x2c4e6: {"kind": 'reg', "py": 'r[3] = 0xFFFFA9FC', "slot_py": None, "target": None, "cond": None},
    0x2c4e8: {"kind": 'reg', "py": 'r[4] = 0xFFFFBC60', "slot_py": None, "target": None, "cond": None},
    0x2c4ea: {"kind": 'reg', "py": 'r[2] = 0xFFFFCCFA', "slot_py": None, "target": None, "cond": None},
    0x2c4ec: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCCFA, 1))', "slot_py": None, "target": None, "cond": None},
    0x2c4ee: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x2c4f0: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x2c4f2: {"kind": "branch", "py": None, "slot_py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFA9FC, 4))', "target": 0x2c540, "cond": 'notT'},
    0x2c4f6: {"kind": 'reg', "py": 'r[1] = 0x000753EC', "slot_py": None, "target": None, "cond": None},
    0x2c4f8: {"kind": 'reg', "py": 'r[3] = 0xFFFFADA8', "slot_py": None, "target": None, "cond": None},
    0x2c4fa: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x000753EC, 4))', "slot_py": None, "target": None, "cond": None},
    0x2c4fc: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0xFFFFADA8, 4))', "slot_py": None, "target": None, "cond": None},
    0x2c4fe: {"kind": 'fpu', "py": 'T = 1 if fr[3] > fr[2] else 0', "slot_py": None, "target": None, "cond": None},
    0x2c500: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2c540, "cond": 'T'},
    0x2c504: {"kind": 'reg', "py": 'r[2] = 0x000753F0', "slot_py": None, "target": None, "cond": None},
    0x2c506: {"kind": 'fpu', "py": 'fr[1] = bits2f(_rdw(ram, 0x000753F0, 4))', "slot_py": None, "target": None, "cond": None},
    0x2c508: {"kind": 'fpu', "py": 'T = 1 if fr[1] > fr[4] else 0', "slot_py": None, "target": None, "cond": None},
    0x2c50a: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2c540, "cond": 'T'},
    0x2c50e: {"kind": 'reg', "py": 'r[3] = 0x000753F4', "slot_py": None, "target": None, "cond": None},
    0x2c510: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x000753F4, 4))', "slot_py": None, "target": None, "cond": None},
    0x2c512: {"kind": 'fpu', "py": 'T = 1 if fr[3] > fr[4] else 0', "slot_py": None, "target": None, "cond": None},
    0x2c514: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2c540, "cond": 'notT'},
    0x2c518: {"kind": 'reg', "py": 'r[2] = 0xFFFFA428', "slot_py": None, "target": None, "cond": None},
    0x2c51a: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFA428, 1))', "slot_py": None, "target": None, "cond": None},
    0x2c51c: {"kind": 'reg', "py": 'T = 1 if (r[0] & r[0]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x2c51e: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2c540, "cond": 'notT'},
    0x2c522: {"kind": 'reg', "py": 'r[3] = 0xFFFFA42C', "slot_py": None, "target": None, "cond": None},
    0x2c524: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFA42C, 1))', "slot_py": None, "target": None, "cond": None},
    0x2c526: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x2c528: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x2c52a: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2c540, "cond": 'notT'},
    0x2c52e: {"kind": 'reg', "py": 'r[2] = 0xFFFFB46C', "slot_py": None, "target": None, "cond": None},
    0x2c530: {"kind": 'mem', "py": 'r[0] = s16(_rdw(ram, 0xFFFFB46C, 2))', "slot_py": None, "target": None, "cond": None},
    0x2c532: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x2c534: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) > 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x2c536: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2c540, "cond": 'notT'},
    0x2c53a: {"kind": 'reg', "py": 'r[2] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x2c53c: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFBC60, 1, r[2])', "target": 0x2c544, "cond": 'always'},
    0x2c540: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x2c542: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBC60, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x2c544: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
