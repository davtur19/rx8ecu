#!/usr/bin/env python3
"""Differential test for or_fault_flags_to_cc84 (0x498A8) — v3 lift (branches + delay slots), 46 bytes.
...
Run from repo root: python3 c/tests/test_or_fault_flags_to_cc84_498a8.py
"""
...
ENTRY = 0x498A8
RAW = bytes.fromhex("94 12 93 12 60 30 60 0C 88 01 8D 06 00 09 92 0D 60 20 60 0C 88 01 8F 03 00 09 E3 01 A0 02 24 30 E1 00 24 10 00 0B 00 09 CC 84 C8 95 C8 97")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCC84
SPAN_END = 0x498D6
SENT = 0x498D6     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x498a8: {"kind": 'reg', "py": 'r[4] = 0xFFFFCC84', "slot_py": None, "target": None, "cond": None},
    0x498aa: {"kind": 'reg', "py": 'r[3] = 0xFFFFC895', "slot_py": None, "target": None, "cond": None},
    0x498ac: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFC895, 1))', "slot_py": None, "target": None, "cond": None},
    0x498ae: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x498b0: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x498b2: {"kind": "branch", "py": None, "slot_py": '', "target": 0x498c2, "cond": 'T'},
    0x498b6: {"kind": 'reg', "py": 'r[2] = 0xFFFFC897', "slot_py": None, "target": None, "cond": None},
    0x498b8: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFC897, 1))', "slot_py": None, "target": None, "cond": None},
    0x498ba: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x498bc: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x498be: {"kind": "branch", "py": None, "slot_py": '', "target": 0x498c8, "cond": 'notT'},
    0x498c2: {"kind": 'reg', "py": 'r[3] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x498c4: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFCC84, 1, r[3])', "target": 0x498cc, "cond": 'always'},
    0x498c8: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x498ca: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCC84, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x498cc: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
