#!/usr/bin/env python3
"""Differential test for init_const_float_ce10 (0x4D532) — v3 lift + v4 FPU, 10 bytes.
...
Run from repo root: python3 c/tests/test_init_const_float_ce10_4d532.py
"""
...
ENTRY = 0x4D532
RAW = bytes.fromhex("C7 1A 93 19 F3 08 00 0B F3 3A")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCE10
SPAN_END = 0x4D53C
SENT = 0x4D53C     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x4d532: {"kind": 'reg', "py": 'r[0] = 0x0004D59C', "slot_py": None, "target": None, "cond": None},
    0x4d534: {"kind": 'reg', "py": 'r[3] = 0xFFFFCE10', "slot_py": None, "target": None, "cond": None},
    0x4d536: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x0004D59C, 4))', "slot_py": None, "target": None, "cond": None},
    0x4d538: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFCE10, 4, f2bits(fr[3]))', "target": None, "cond": None},}
