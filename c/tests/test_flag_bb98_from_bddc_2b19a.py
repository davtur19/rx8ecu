#!/usr/bin/env python3
"""Differential test for flag_bb98_from_bddc (0x2B19A) — v3 lift (branches + delay slots), 28 bytes.
...
Run from repo root: python3 c/tests/test_flag_bb98_from_bddc_2b19a.py
"""
...
ENTRY = 0x2B19A
RAW = bytes.fromhex("94 4D 93 4D 60 30 60 0C 88 01 8F 03 00 09 E1 01 A0 02 24 10 E0 00 24 00 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBDDC
SPAN_END = 0x2B1B6
SENT = 0x2B1B6     # stop-sentinel, placed past the literal pool
