#!/usr/bin/env python3
"""Differential test for calculateTorqueRelated (0x2D300) — v3 lift + v4 FPU, 32 bytes.
...
Run from repo root: python3 c/tests/test_calculateTorqueRelated_2d300.py
"""
...
RAM_MAX = 0xFFFFBCCC
SPAN_END = 0x2D320
SENT = 0x2D320     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x2d300: {"kind": 'reg', "py": 'r[2] = 0xFFFFA62C', "slot_py": None, "target": None, "cond": None},
    0x2d302: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFA62C, 4))', "slot_py": None, "target": None, "cond": None},
    0x2d304: {"kind": 'reg', "py": 'r[1] = 0xFFFFBCC4', "slot_py": None, "target": None, "cond": None},
    0x2d306: {"kind": 'fpu', "py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFBCC4, 4))', "slot_py": None, "target": None, "cond": None},
    0x2d308: {"kind": 'reg', "py": 'r[3] = 0xFFFFBCC0', "slot_py": None, "target": None, "cond": None},
    0x2d30a: {"kind": 'fpu', "py": 'fr[4] = ts(fr[4] - fr[3])', "slot_py": None, "target": None, "cond": None},
    0x2d30c: {"kind": 'reg', "py": 'r[1] = 0xFFFFBCC8', "slot_py": None, "target": None, "cond": None},
    0x2d30e: {"kind": 'fpu', "py": 'fr[2] = fr[4]', "slot_py": None, "target": None, "cond": None},
    0x2d310: {"kind": 'fpu', "py": 'fr[1] = bits2f(_rdw(ram, 0xFFFFBCC0, 4))', "slot_py": None, "target": None, "cond": None},
    0x2d312: {"kind": 'fpu', "py": 'fr[2] = ts(fr[2] * fr[4])', "slot_py": None, "target": None, "cond": None},
    0x2d314: {"kind": 'fpu', "py": 'fr[0] = bits2f(_rdw(ram, 0xFFFFBCC8, 4))', "slot_py": None, "target": None, "cond": None},
    0x2d316: {"kind": 'fpu', "py": 'fr[2] = ts(fr[2] * fr[1])', "slot_py": None, "target": None, "cond": None},
    0x2d318: {"kind": 'reg', "py": 'r[3] = 0xFFFFBCCC', "slot_py": None, "target": None, "cond": None},
    0x2d31a: {"kind": 'fpu', "py": 'fr[0] = ts(fr[0] - fr[2])', "slot_py": None, "target": None, "cond": None},
    0x2d31c: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBCCC, 4, f2bits(fr[0]))', "target": None, "cond": None},}
