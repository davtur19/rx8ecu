#!/usr/bin/env python3
"""Differential test for calculateLeadingTimingDerateCompensated (0x12342) — v3 lift + v4 FPU, 16 bytes.
...
Run from repo root: python3 c/tests/test_calculateLeadingTimingDerateCompensated_12342.py
"""
...
ENTRY = 0x12342
RAW = bytes.fromhex("D2 1E D1 1E F3 28 F2 18 F2 30 93 24 00 0B F3 2A")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFA644
SPAN_END = 0x12352
SENT = 0x12352     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x12342: {"kind": 'reg', "py": 'r[2] = 0xFFFFA644', "slot_py": None, "target": None, "cond": None},
    0x12344: {"kind": 'reg', "py": 'r[1] = 0xFFFFA63C', "slot_py": None, "target": None, "cond": None},
    0x12346: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFA644, 4))', "slot_py": None, "target": None, "cond": None},
    0x12348: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0xFFFFA63C, 4))', "slot_py": None, "target": None, "cond": None},
    0x1234a: {"kind": 'fpu', "py": 'fr[2] = ts(fr[2] + fr[3])', "slot_py": None, "target": None, "cond": None},
    0x1234c: {"kind": 'reg', "py": 'r[3] = 0xFFFFA630', "slot_py": None, "target": None, "cond": None},
    0x1234e: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFA630, 4, f2bits(fr[2]))', "target": None, "cond": None},}
