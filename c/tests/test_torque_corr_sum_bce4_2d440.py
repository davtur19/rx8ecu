#!/usr/bin/env python3
"""Differential test for torque_corr_sum_bce4 (0x2D440) — v3 lift + v4 FPU, 22 bytes.
...
Run from repo root: python3 c/tests/test_torque_corr_sum_bce4_2d440.py
"""
...
ENTRY = 0x2D440
RAW = bytes.fromhex("D3 3F F3 38 91 73 F2 18 D2 3E F2 30 91 6C F1 28 F2 10 00 0B F1 2A")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBCF8
SPAN_END = 0x2D456
SENT = 0x2D456     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x2d440: {"kind": 'reg', "py": 'r[3] = 0xFFFFBCF0', "slot_py": None, "target": None, "cond": None},
    0x2d442: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFBCF0, 4))', "slot_py": None, "target": None, "cond": None},
    0x2d444: {"kind": 'reg', "py": 'r[1] = 0xFFFFBCEC', "slot_py": None, "target": None, "cond": None},
    0x2d446: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0xFFFFBCEC, 4))', "slot_py": None, "target": None, "cond": None},
    0x2d448: {"kind": 'reg', "py": 'r[2] = 0xFFFFBCF8', "slot_py": None, "target": None, "cond": None},
    0x2d44a: {"kind": 'fpu', "py": 'fr[2] = ts(fr[2] + fr[3])', "slot_py": None, "target": None, "cond": None},
    0x2d44c: {"kind": 'reg', "py": 'r[1] = 0xFFFFBCE4', "slot_py": None, "target": None, "cond": None},
    0x2d44e: {"kind": 'fpu', "py": 'fr[1] = bits2f(_rdw(ram, 0xFFFFBCF8, 4))', "slot_py": None, "target": None, "cond": None},
    0x2d450: {"kind": 'fpu', "py": 'fr[2] = ts(fr[2] + fr[1])', "slot_py": None, "target": None, "cond": None},
    0x2d452: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBCE4, 4, f2bits(fr[2]))', "target": None, "cond": None},}
