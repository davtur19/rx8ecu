#!/usr/bin/env python3
"""Differential test for ram_set_flag_byte_bc48 (0x2C2C8) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_ram_set_flag_byte_bc48_2c2c8.py
"""
...
ENTRY = 0x2C2C8
RAW = bytes.fromhex("92 46 E3 01 00 0B 22 30")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBC48
SPAN_END = 0x2C2D0
SENT = 0x2C2D0     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x2c2c8: {"kind": 'reg', "py": 'r[2] = 0xFFFFBC48', "slot_py": None, "target": None, "cond": None},
    0x2c2ca: {"kind": 'reg', "py": 'r[3] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x2c2cc: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBC48, 1, r[3])', "target": None, "cond": None},}
