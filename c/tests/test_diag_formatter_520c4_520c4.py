#!/usr/bin/env python3
"""Differential test for diag_formatter_520c4 (0x520C4) — v3 lift + v4 FPU, 50 bytes.
...
Run from repo root: python3 c/tests/test_diag_formatter_520c4_520c4.py
"""
...
ENTRY = 0x520C4
RAW = bytes.fromhex("92 69 60 20 60 0C 88 01 8F 11 00 09 93 64 61 31 D2 35 60 21 31 00 8F 0A 00 09 F3 9D 93 5D F3 4D C7 32 F2 38 F1 08 F2 30 93 58 F2 12 F3 2A 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFD12E
SPAN_END = 0x520F6
SENT = 0x520F6     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x520c4: {"kind": 'reg', "py": 'r[2] = 0xFFFFD12E', "slot_py": None, "target": None, "cond": None},
    0x520c6: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFD12E, 1))', "slot_py": None, "target": None, "cond": None},
    0x520c8: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x520ca: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x520cc: {"kind": "branch", "py": None, "slot_py": '', "target": 0x520f2, "cond": 'notT'},
    0x520d0: {"kind": 'reg', "py": 'r[3] = 0xFFFFCFE6', "slot_py": None, "target": None, "cond": None},
    0x520d2: {"kind": 'mem', "py": 'r[1] = s16(_rdw(ram, 0xFFFFCFE6, 2))', "slot_py": None, "target": None, "cond": None},
    0x520d4: {"kind": 'reg', "py": 'r[2] = 0x0007D6CA', "slot_py": None, "target": None, "cond": None},
    0x520d6: {"kind": 'mem', "py": 'r[0] = s16(_rdw(ram, 0x0007D6CA, 2))', "slot_py": None, "target": None, "cond": None},
    0x520d8: {"kind": 'reg', "py": 'T = 1 if r[1] == r[0] else 0', "slot_py": None, "target": None, "cond": None},
    0x520da: {"kind": "branch", "py": None, "slot_py": '', "target": 0x520f2, "cond": 'notT'},
    0x520de: {"kind": 'fpu', "py": 'fr[3] = 1.0', "slot_py": None, "target": None, "cond": None},
    0x520e0: {"kind": 'reg', "py": 'r[3] = 0xFFFFAE64', "slot_py": None, "target": None, "cond": None},
    0x520e2: {"kind": 'fpu', "py": 'fr[3] = -fr[3]', "slot_py": None, "target": None, "cond": None},
    0x520e4: {"kind": 'reg', "py": 'r[0] = 0x000521B0', "slot_py": None, "target": None, "cond": None},
    0x520e6: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0xFFFFAE64, 4))', "slot_py": None, "target": None, "cond": None},
    0x520e8: {"kind": 'fpu', "py": 'fr[1] = bits2f(_rdw(ram, 0x000521B0, 4))', "slot_py": None, "target": None, "cond": None},
    0x520ea: {"kind": 'fpu', "py": 'fr[2] = ts(fr[2] + fr[3])', "slot_py": None, "target": None, "cond": None},
    0x520ec: {"kind": 'reg', "py": 'r[3] = 0xFFFFD114', "slot_py": None, "target": None, "cond": None},
    0x520ee: {"kind": 'fpu', "py": 'fr[2] = ts(fr[2] * fr[1])', "slot_py": None, "target": None, "cond": None},
    0x520f0: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFD114, 4, f2bits(fr[2]))', "slot_py": None, "target": None, "cond": None},
    0x520f2: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
