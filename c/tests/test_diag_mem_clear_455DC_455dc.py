#!/usr/bin/env python3
"""Differential test for diag_mem_clear_455DC (0x455DC) — v3 lift (branches + delay slots), 42 bytes.
...
Run from repo root: python3 c/tests/test_diag_mem_clear_455DC_455dc.py
"""
...
CODE = {
    0x455dc: {"kind": 'reg', "py": 'r[3] = 0xFFFFD201', "slot_py": None, "target": None, "cond": None},
    0x455de: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFD201, 1))', "slot_py": None, "target": None, "cond": None},
    0x455e0: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x455e2: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x455e4: {"kind": "branch", "py": None, "slot_py": '', "target": 0x45602, "cond": 'notT'},
    0x455e8: {"kind": 'reg', "py": 'r[2] = 0xFFFFA41C', "slot_py": None, "target": None, "cond": None},
    0x455ea: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFA41C, 1))', "slot_py": None, "target": None, "cond": None},
    0x455ec: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x455ee: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x455f0: {"kind": "branch", "py": None, "slot_py": '', "target": 0x45602, "cond": 'notT'},
    0x455f4: {"kind": 'reg', "py": 'r[3] = 0xFFFFCBD0', "slot_py": None, "target": None, "cond": None},
    0x455f6: {"kind": 'reg', "py": 'r[4] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x455f8: {"kind": 'reg', "py": 'r[2] = 0xFFFFCBD2', "slot_py": None, "target": None, "cond": None},
    0x455fa: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCBD0, 2, r[4])', "slot_py": None, "target": None, "cond": None},
    0x455fc: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCBD2, 2, r[4])', "slot_py": None, "target": None, "cond": None},
    0x455fe: {"kind": 'reg', "py": 'r[1] = 0xFFFFCBD8', "slot_py": None, "target": None, "cond": None},
    0x45600: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCBD8, 2, r[4])', "slot_py": None, "target": None, "cond": None},
    0x45602: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
