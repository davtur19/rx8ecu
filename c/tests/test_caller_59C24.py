#!/usr/bin/env python3
"""Differential test for caller_59C24 (entry 0x59C24) — v8 ST caller (CFG), 18 bytes.
...
Run: python3 test_caller_59C24.py
"""
...
CODE = {
    0x59c24: {"kind": 'reg', "py": 'r[5] = r[5] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x59c26: {"kind": 'reg', "py": 'T = 1 if (r[5] & r[5]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x59c28: {"kind": "branch", "py": None, "slot_py": '', "target": 0x59c30, "cond": 'notT'},
    0x59c2c: {"kind": "branch", "py": None, "slot_py": 'r[4] = s8(0x00)', "target": 0x59c32, "cond": 'always'},
    0x59c30: {"kind": 'reg', "py": 'r[4] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x59c32: {"kind": "ret", "py": None, "slot_py": 'r[0] = r[4]', "target": None, "cond": None},
}
