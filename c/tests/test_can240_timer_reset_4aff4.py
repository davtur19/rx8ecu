#!/usr/bin/env python3
"""Differential test for can240_timer_reset (0x4AFF4) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_can240_timer_reset_4aff4.py
"""
...
ENTRY = 0x4AFF4
RAW = bytes.fromhex("D1 21 E3 00 00 0B 21 31")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCD40
SPAN_END = 0x4AFFC
SENT = 0x4AFFC     # stop-sentinel, placed past the literal pool
