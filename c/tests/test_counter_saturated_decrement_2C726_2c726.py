#!/usr/bin/env python3
"""Differential test for counter_saturated_decrement_2C726 (0x2C726) — v3 lift (branches + delay slots), 42 bytes.
...
Run from repo root: python3 c/tests/test_counter_saturated_decrement_2C726_2c726.py
"""
...
ENTRY = 0x2C726
RAW = bytes.fromhex("95 19 92 19 63 20 63 3C 43 15 8F 04 00 09 D3 10 61 30 A0 08 25 10 64 50 63 4C 23 38 8D 03 00 09 90 0B 34 0C 25 40 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    0x2c726: {"kind": 'reg', "py": 'r[5] = 0xFFFFBC44', "slot_py": None, "target": None, "cond": None},
    0x2c728: {"kind": 'reg', "py": 'r[2] = 0xFFFFA400', "slot_py": None, "target": None, "cond": None},
    0x2c72a: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFA400, 1))', "slot_py": None, "target": None, "cond": None},
    0x2c72c: {"kind": 'reg', "py": 'r[3] = r[3] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x2c72e: {"kind": 'reg', "py": 'T = 1 if s32(r[3]) > 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x2c730: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2c73c, "cond": 'notT'},
    0x2c734: {"kind": 'reg', "py": 'r[3] = 0x0006CF84', "slot_py": None, "target": None, "cond": None},
    0x2c736: {"kind": 'mem', "py": 'r[1] = s8(_rdw(ram, 0x0006CF84, 1))', "slot_py": None, "target": None, "cond": None},
    0x2c738: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFBC44, 1, r[1])', "target": 0x2c74c, "cond": 'always'},
    0x2c73c: {"kind": 'mem', "py": 'r[4] = s8(_rdw(ram, 0xFFFFBC44, 1))', "slot_py": None, "target": None, "cond": None},
    0x2c73e: {"kind": 'reg', "py": 'r[3] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x2c740: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x2c742: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2c74c, "cond": 'T'},
    0x2c746: {"kind": 'reg', "py": 'r[0] = 0x000000FF', "slot_py": None, "target": None, "cond": None},
    0x2c748: {"kind": 'reg', "py": 'r[4] = (r[4] + r[0]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x2c74a: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBC44, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x2c74c: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
