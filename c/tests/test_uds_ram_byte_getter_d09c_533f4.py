#!/usr/bin/env python3
"""Differential test for uds_ram_byte_getter_d09c (0x533F4) — v3 lift (branches + delay slots), 12 bytes.
...
Run from repo root: python3 c/tests/test_uds_ram_byte_getter_d09c_533f4.py
"""
...
ENTRY = 0x533F4
RAW = bytes.fromhex("93 77 00 0B 60 30 92 75 00 0B 60 20")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFD09D
SPAN_END = 0x53400
SENT = 0x53400     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x533f4: {"kind": 'reg', "py": 'r[3] = 0xFFFFD09C', "slot_py": None, "target": None, "cond": None},
    0x533f6: {"kind": "ret", "py": None, "slot_py": 'r[0] = s8(_rdw(ram, 0xFFFFD09C, 1))', "target": None, "cond": None},
    0x533fa: {"kind": 'reg', "py": 'r[2] = 0xFFFFD09D', "slot_py": None, "target": None, "cond": None},
    0x533fc: {"kind": "ret", "py": None, "slot_py": 'r[0] = s8(_rdw(ram, 0xFFFFD09D, 1))', "target": None, "cond": None},}
