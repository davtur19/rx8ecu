#!/usr/bin/env python3
"""Differential test for cruiseControlMain (0x2EB40) — pure straight-line lift, 10 bytes.
...
Run from repo root: python3 c/tests/test_cruiseControlMain_2eb40.py
"""
...
ENTRY = 0x2EB40
RAW = bytes.fromhex("00 07 6B 9C 00 07 6B AC 00 07")
SEED = 42
N = 2000
