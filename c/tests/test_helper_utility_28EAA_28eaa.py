#!/usr/bin/env python3
"""Differential test for helper_utility_28EAA (0x28EAA) — v3 lift + v4 FPU, 90 bytes.
...
Run from repo root: python3 c/tests/test_helper_utility_28EAA_28eaa.py
"""
...
RAM_MAX = 0xFFFFBAD8
SPAN_END = 0x28F04
SENT = 0x28F04     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x28eaa: {"kind": 'reg', "py": 'r[6] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x28eac: {"kind": 'reg', "py": 'r[4] = 0xFFFFBAD8', "slot_py": None, "target": None, "cond": None},
    0x28eae: {"kind": 'reg', "py": 'r[3] = 0xFFFFB5B8', "slot_py": None, "target": None, "cond": None},
    0x28eb0: {"kind": 'reg', "py": 'r[2] = 0x00075B30', "slot_py": None, "target": None, "cond": None},
    0x28eb2: {"kind": 'fpu', "py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFB5B8, 4))', "slot_py": None, "target": None, "cond": None},
    0x28eb4: {"kind": 'fpu', "py": 'fr[5] = bits2f(_rdw(ram, 0x00075B30, 4))', "slot_py": None, "target": None, "cond": None},
    0x28eb6: {"kind": 'reg', "py": 'r[1] = 0x00075B38', "slot_py": None, "target": None, "cond": None},
    0x28eb8: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x00075B38, 4))', "slot_py": None, "target": None, "cond": None},
    0x28eba: {"kind": 'fpu', "py": 'fr[6] = fr[5]', "slot_py": None, "target": None, "cond": None},
    0x28ebc: {"kind": 'fpu', "py": 'fr[6] = ts(fr[6] + fr[3])', "slot_py": None, "target": None, "cond": None},
    0x28ebe: {"kind": 'fpu', "py": 'T = 1 if fr[5] > fr[4] else 0', "slot_py": None, "target": None, "cond": None},
    0x28ec0: {"kind": "branch", "py": None, "slot_py": 'r[5] = s8(0x00)', "target": 0x28ec8, "cond": 'notT'},
    0x28ec4: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFBAD8, 1, r[5])', "target": 0x28ed0, "cond": 'always'},
    0x28ec8: {"kind": 'fpu', "py": 'T = 1 if fr[6] > fr[4] else 0', "slot_py": None, "target": None, "cond": None},
    0x28eca: {"kind": "branch", "py": None, "slot_py": '', "target": 0x28ed0, "cond": 'T'},
    0x28ece: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBAD8, 1, r[6])', "slot_py": None, "target": None, "cond": None},
    0x28ed0: {"kind": 'reg', "py": 'r[7] = 0xFFFFBAC8', "slot_py": None, "target": None, "cond": None},
    0x28ed2: {"kind": 'mem', "py": 'r[2] = s8(_rdw(ram, 0xFFFFBAD8, 1))', "slot_py": None, "target": None, "cond": None},
    0x28ed4: {"kind": 'reg', "py": 'T = 1 if (r[2] & r[2]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x28ed6: {"kind": "branch", "py": None, "slot_py": '', "target": 0x28eee, "cond": 'notT'},
    0x28eda: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBAC8, 1, r[5])', "slot_py": None, "target": None, "cond": None},
    0x28edc: {"kind": 'reg', "py": 'r[3] = 0x00075B28', "slot_py": None, "target": None, "cond": None},
    0x28ede: {"kind": 'mem', "py": 'r[2] = s8(_rdw(ram, 0x00075B28, 1))', "slot_py": None, "target": None, "cond": None},
    0x28ee0: {"kind": 'reg', "py": 'r[1] = 0xFFFFBAC6', "slot_py": None, "target": None, "cond": None},
    0x28ee2: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBAC6, 1, r[2])', "slot_py": None, "target": None, "cond": None},
    0x28ee4: {"kind": 'reg', "py": 'r[2] = 0x00075B2A', "slot_py": None, "target": None, "cond": None},
    0x28ee6: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0x00075B2A, 1))', "slot_py": None, "target": None, "cond": None},
    0x28ee8: {"kind": 'reg', "py": 'r[3] = 0xFFFFBAC7', "slot_py": None, "target": None, "cond": None},
    0x28eea: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFBAC7, 1, r[0])', "target": 0x28f00, "cond": 'always'},
    0x28eee: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBAC8, 1, r[6])', "slot_py": None, "target": None, "cond": None},
    0x28ef0: {"kind": 'reg', "py": 'r[2] = 0x00075B29', "slot_py": None, "target": None, "cond": None},
    0x28ef2: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0x00075B29, 1))', "slot_py": None, "target": None, "cond": None},
    0x28ef4: {"kind": 'reg', "py": 'r[1] = 0xFFFFBAC6', "slot_py": None, "target": None, "cond": None},
    0x28ef6: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBAC6, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x28ef8: {"kind": 'reg', "py": 'r[3] = 0x00075B2B', "slot_py": None, "target": None, "cond": None},
    0x28efa: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0x00075B2B, 1))', "slot_py": None, "target": None, "cond": None},
    0x28efc: {"kind": 'reg', "py": 'r[2] = 0xFFFFBAC7', "slot_py": None, "target": None, "cond": None},
    0x28efe: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBAC7, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x28f00: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
