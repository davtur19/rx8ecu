#!/usr/bin/env python3
"""Differential test for can231SetupTx (0x29A46) — v3 lift (branches + delay slots), 40 bytes.
...
Run from repo root: python3 c/tests/test_can231SetupTx_29a46.py
"""
...
ENTRY = 0x29A46
RAW = bytes.fromhex("D4 3A 92 62 63 40 D1 39 22 30 84 41 21 00 84 42 60 0C 92 5B 40 18 63 03 84 43 60 0C 33 0C D0 34 20 31 84 44 00 0B 22 00")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBB2A
SPAN_END = 0x29A6E
SENT = 0x29A6E     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x29a46: {"kind": 'reg', "py": 'r[4] = 0xFFFFBB18', "slot_py": None, "target": None, "cond": None},
    0x29a48: {"kind": 'reg', "py": 'r[2] = 0xFFFFBB1D', "slot_py": None, "target": None, "cond": None},
    0x29a4a: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFBB18, 1))', "slot_py": None, "target": None, "cond": None},
    0x29a4c: {"kind": 'reg', "py": 'r[1] = 0xFFFFBB29', "slot_py": None, "target": None, "cond": None},
    0x29a4e: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBB1D, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x29a50: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFBB19, 1))', "slot_py": None, "target": None, "cond": None},
    0x29a52: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBB29, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x29a54: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFBB1A, 1))', "slot_py": None, "target": None, "cond": None},
    0x29a56: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x29a58: {"kind": 'reg', "py": 'r[2] = 0xFFFFBB1E', "slot_py": None, "target": None, "cond": None},
    0x29a5a: {"kind": 'reg', "py": 'r[0] = (r[0] << 8) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x29a5c: {"kind": 'reg', "py": 'r[3] = r[0]', "slot_py": None, "target": None, "cond": None},
    0x29a5e: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFBB1B, 1))', "slot_py": None, "target": None, "cond": None},
    0x29a60: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x29a62: {"kind": 'reg', "py": 'r[3] = (r[3] + r[0]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x29a64: {"kind": 'reg', "py": 'r[0] = 0xFFFFBB2A', "slot_py": None, "target": None, "cond": None},
    0x29a66: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBB2A, 2, r[3])', "slot_py": None, "target": None, "cond": None},
    0x29a68: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFBB1C, 1))', "slot_py": None, "target": None, "cond": None},
    0x29a6a: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBB1E, 1, r[0])', "target": None, "cond": None},}
