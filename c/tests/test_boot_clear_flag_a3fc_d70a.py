#!/usr/bin/env python3
"""Differential test for boot_clear_flag_a3fc (0xD70A) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_boot_clear_flag_a3fc_d70a.py
"""
...
ENTRY = 0xD70A
RAW = bytes.fromhex("E3 00 D2 05 00 0B 22 30")
SEED = 42
N = 500
MAXSTEPS = 100000
