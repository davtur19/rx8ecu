#!/usr/bin/env python3
"""Differential test for copy_ram_bytes_c61c_c623 (0x3DA78) — v3 lift (branches + delay slots), 34 bytes.
...
Run from repo root: python3 c/tests/test_copy_ram_bytes_c61c_c623_3da78.py
"""
...
ENTRY = 0x3DA78
RAW = bytes.fromhex("92 86 63 20 91 85 21 30 D3 48 60 30 92 82 22 00 90 81 61 00 93 80 23 10 D1 45 62 10 93 7D 00 0B 23 20")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFC623
SPAN_END = 0x3DA9A
SENT = 0x3DA9A     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x3da78: {"kind": 'reg', "py": 'r[2] = 0xFFFFB587', "slot_py": None, "target": None, "cond": None},
    0x3da7a: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFB587, 1))', "slot_py": None, "target": None, "cond": None},
    0x3da7c: {"kind": 'reg', "py": 'r[1] = 0xFFFFC61F', "slot_py": None, "target": None, "cond": None},
    0x3da7e: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC61F, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x3da80: {"kind": 'reg', "py": 'r[3] = 0x00079785', "slot_py": None, "target": None, "cond": None},
    0x3da82: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0x00079785, 1))', "slot_py": None, "target": None, "cond": None},
    0x3da84: {"kind": 'reg', "py": 'r[2] = 0xFFFFC61C', "slot_py": None, "target": None, "cond": None},
    0x3da86: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC61C, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x3da88: {"kind": 'reg', "py": 'r[0] = 0xFFFFBFB8', "slot_py": None, "target": None, "cond": None},
    0x3da8a: {"kind": 'mem', "py": 'r[1] = s8(_rdw(ram, 0xFFFFBFB8, 1))', "slot_py": None, "target": None, "cond": None},
    0x3da8c: {"kind": 'reg', "py": 'r[3] = 0xFFFFC623', "slot_py": None, "target": None, "cond": None},
    0x3da8e: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC623, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x3da90: {"kind": 'reg', "py": 'r[1] = 0x00079784', "slot_py": None, "target": None, "cond": None},
    0x3da92: {"kind": 'mem', "py": 'r[2] = s8(_rdw(ram, 0x00079784, 1))', "slot_py": None, "target": None, "cond": None},
    0x3da94: {"kind": 'reg', "py": 'r[3] = 0xFFFFC61D', "slot_py": None, "target": None, "cond": None},
    0x3da96: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFC61D, 1, r[2])', "target": None, "cond": None},}
