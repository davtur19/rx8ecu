#!/usr/bin/env python3
"""Differential test for FUN_00025700 (0x25700) — v3 lift + v4 FPU, 8 bytes.
...
Run from repo root: python3 c/tests/test_FUN_00025700_25700.py
"""
...
RAM_MAX = 0xFFFFB594
SPAN_END = 0x25708
SENT = 0x25708     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x25700: {"kind": 'reg', "py": 'r[3] = 0xFFFFB594', "slot_py": None, "target": None, "cond": None},
    0x25702: {"kind": 'fpu', "py": 'fr[3] = 0.0', "slot_py": None, "target": None, "cond": None},
    0x25704: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFB594, 4, f2bits(fr[3]))', "target": None, "cond": None},}
