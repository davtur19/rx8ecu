#!/usr/bin/env python3
"""Differential test for FUN_000364a0 (0x364A0) — v3 lift (branches + delay slots), 60 bytes.
...
Run from repo root: python3 c/tests/test_FUN_000364a0_364a0.py
"""
...
ENTRY = 0x364A0
RAW = bytes.fromhex("43 15 8F 04 00 09 D3 39 62 41 32 3C 24 21 63 41 23 38 8F 0F 00 09 E1 01 26 10 63 41 23 38 8F 09 00 09 D2 33 60 20 60 0C 88 01 8F 03 00 09 D2 31 A0 02 22 50 00 0B 00 09 2F E6 2F D6")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFC28D
SPAN_END = 0x364DC
SENT = 0x364DC     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x364a0: {"kind": 'reg', "py": 'T = 1 if s32(r[3]) > 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x364a2: {"kind": "branch", "py": None, "slot_py": '', "target": 0x364ae, "cond": 'notT'},
    0x364a6: {"kind": 'reg', "py": 'r[3] = 0x0000FFFF', "slot_py": None, "target": None, "cond": None},
    0x364a8: {"kind": 'mem', "py": 'r[2] = s16(_rdw(ram, r[4], 2))', "slot_py": None, "target": None, "cond": None},
    0x364aa: {"kind": 'reg', "py": 'r[2] = (r[2] + r[3]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x364ac: {"kind": 'mem', "py": '_wrw(ram, r[4], 2, r[2])', "slot_py": None, "target": None, "cond": None},
    0x364ae: {"kind": 'mem', "py": 'r[3] = s16(_rdw(ram, r[4], 2))', "slot_py": None, "target": None, "cond": None},
    0x364b0: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x364b2: {"kind": "branch", "py": None, "slot_py": '', "target": 0x364d4, "cond": 'notT'},
    0x364b6: {"kind": 'reg', "py": 'r[1] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x364b8: {"kind": 'mem', "py": '_wrw(ram, r[6], 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x364ba: {"kind": 'mem', "py": 'r[3] = s16(_rdw(ram, r[4], 2))', "slot_py": None, "target": None, "cond": None},
    0x364bc: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x364be: {"kind": "branch", "py": None, "slot_py": '', "target": 0x364d4, "cond": 'notT'},
    0x364c2: {"kind": 'reg', "py": 'r[2] = 0xFFFFC28C', "slot_py": None, "target": None, "cond": None},
    0x364c4: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFC28C, 1))', "slot_py": None, "target": None, "cond": None},
    0x364c6: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x364c8: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x364ca: {"kind": "branch", "py": None, "slot_py": '', "target": 0x364d4, "cond": 'notT'},
    0x364ce: {"kind": 'reg', "py": 'r[2] = 0xFFFFC28D', "slot_py": None, "target": None, "cond": None},
    0x364d0: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFC28D, 1, r[5])', "target": 0x364d8, "cond": 'always'},
    0x364d4: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},
    0x364d8: {"kind": 'mem', "py": 'local[0x3FC] = r[14]\n_wrw(ram, STACK_BASE + 0x3FC, 4, r[14])\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x364da: {"kind": 'mem', "py": 'local[0x3F8] = r[13]\n_wrw(ram, STACK_BASE + 0x3F8, 4, r[13])\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},}
