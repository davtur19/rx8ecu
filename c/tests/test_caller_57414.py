#!/usr/bin/env python3
"""Differential test for caller_57414 (entry 0x57414) — v8 ST caller (CFG), 16 bytes.
...
Run: python3 test_caller_57414.py
"""
...
CODE = {
    0x57414: {"kind": 'st', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x57416: {"kind": 'reg', "py": 'r[3] = 0x00011F54', "slot_py": None, "target": None, "cond": None},
    0x57418: {"kind": "call", "py": None, "slot_py": '', "target": 0x11f54, "ret_pc": 0x5741c, "set_pr": True, "cond": None},
    0x5741c: {"kind": 'reg', "py": 'r[2] = 0xFFFFD053', "slot_py": None, "target": None, "cond": None},
    0x5741e: {"kind": 'st', "py": 'pr = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x57420: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFD053, 1, r[0])', "target": None, "cond": None},
