#!/usr/bin/env python3
"""Differential test for fault_cca8_change_debounce (0x49E20) — v3 lift (branches + delay slots), 64 bytes.
...
Run from repo root: python3 c/tests/test_fault_cca8_change_debounce_49e20.py
"""
...
ENTRY = 0x49E20
RAW = bytes.fromhex("93 3F 65 30 D7 24 66 5C 94 42 62 70 62 2C 36 20 8D 0C 00 09 60 63 88 01 8F 04 00 09 D2 20 61 20 A0 0C 24 10 D0 1F 62 00 A0 08 24 20 66 40 62 6C 42 15 8F 03 00 09 92 27 36 2C 24 60 00 0B 27 50")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCCA9
SPAN_END = 0x49E60
SENT = 0x49E60     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x49e20: {"kind": 'reg', "py": 'r[3] = 0xFFFFCCA5', "slot_py": None, "target": None, "cond": None},
    0x49e22: {"kind": 'mem', "py": 'r[5] = s8(_rdw(ram, 0xFFFFCCA5, 1))', "slot_py": None, "target": None, "cond": None},
    0x49e24: {"kind": 'reg', "py": 'r[7] = 0xFFFFCCA9', "slot_py": None, "target": None, "cond": None},
    0x49e26: {"kind": 'reg', "py": 'r[6] = r[5] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x49e28: {"kind": 'reg', "py": 'r[4] = 0xFFFFCCA8', "slot_py": None, "target": None, "cond": None},
    0x49e2a: {"kind": 'mem', "py": 'r[2] = s8(_rdw(ram, 0xFFFFCCA9, 1))', "slot_py": None, "target": None, "cond": None},
    0x49e2c: {"kind": 'reg', "py": 'r[2] = r[2] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x49e2e: {"kind": 'reg', "py": 'T = 1 if r[6] == r[2] else 0', "slot_py": None, "target": None, "cond": None},
    0x49e30: {"kind": "branch", "py": None, "slot_py": '', "target": 0x49e4c, "cond": 'T'},
    0x49e34: {"kind": 'reg', "py": 'r[0] = r[6]', "slot_py": None, "target": None, "cond": None},
    0x49e36: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x49e38: {"kind": "branch", "py": None, "slot_py": '', "target": 0x49e44, "cond": 'notT'},
    0x49e3c: {"kind": 'reg', "py": 'r[2] = 0x0007B235', "slot_py": None, "target": None, "cond": None},
    0x49e3e: {"kind": 'mem', "py": 'r[1] = s8(_rdw(ram, 0x0007B235, 1))', "slot_py": None, "target": None, "cond": None},
    0x49e40: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFCCA8, 1, r[1])', "target": 0x49e5c, "cond": 'always'},
    0x49e44: {"kind": 'reg', "py": 'r[0] = 0x0007B236', "slot_py": None, "target": None, "cond": None},
    0x49e46: {"kind": 'mem', "py": 'r[2] = s8(_rdw(ram, 0x0007B236, 1))', "slot_py": None, "target": None, "cond": None},
    0x49e48: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFCCA8, 1, r[2])', "target": 0x49e5c, "cond": 'always'},
    0x49e4c: {"kind": 'mem', "py": 'r[6] = s8(_rdw(ram, 0xFFFFCCA8, 1))', "slot_py": None, "target": None, "cond": None},
    0x49e4e: {"kind": 'reg', "py": 'r[2] = r[6] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x49e50: {"kind": 'reg', "py": 'T = 1 if s32(r[2]) > 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x49e52: {"kind": "branch", "py": None, "slot_py": '', "target": 0x49e5c, "cond": 'notT'},
    0x49e56: {"kind": 'reg', "py": 'r[2] = 0x000000FF', "slot_py": None, "target": None, "cond": None},
    0x49e58: {"kind": 'reg', "py": 'r[6] = (r[6] + r[2]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x49e5a: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCCA8, 1, r[6])', "slot_py": None, "target": None, "cond": None},
    0x49e5c: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFCCA9, 1, r[5])', "target": None, "cond": None},}
