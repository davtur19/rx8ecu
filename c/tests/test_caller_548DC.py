#!/usr/bin/env python3
"""Differential test for call-composition caller_548DC (entry 0x548DC) — v7 ST caller + callee lib, flattened CODE with nested returns.
...
Run: python3 /home/davide/ailocal/rx8ecu/c/tests/test_caller_548DC.py
"""
...
CODE = {
    0x548dc: {"kind": 'reg', "py": 'r[4] = 0xFFFF9006', "slot_py": None, "target": None, "cond": None},
    0x548de: {"kind": 'reg', "py": 'r[3] = 0x0003EE58', "slot_py": None, "target": None, "cond": None},
    0x548e0: {"kind": "call", "py": None, "slot_py": 'r[5] = s8(0x00)', "target": 0x3ee58, "ret_pc": 0x548e4, "set_pr": False, "cond": None},
