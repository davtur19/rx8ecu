#!/usr/bin/env python3
"""Differential test for immo_status_mirror_b5c4_to_c89c (0x42210) — v3 lift (branches + delay slots), 32 bytes.
...
Run from repo root: python3 c/tests/test_immo_status_mirror_b5c4_to_c89c_42210.py
"""
...
ENTRY = 0x42210
RAW = bytes.fromhex("94 0C 93 0C 60 30 60 0C 88 01 8F 03 00 09 E1 01 A0 02 24 10 E0 00 24 00 00 0B 00 09 C8 9C B5 C4")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFC89C
SPAN_END = 0x42230
SENT = 0x42230     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x42210: {"kind": 'reg', "py": 'r[4] = 0xFFFFC89C', "slot_py": None, "target": None, "cond": None},
    0x42212: {"kind": 'reg', "py": 'r[3] = 0xFFFFB5C4', "slot_py": None, "target": None, "cond": None},
    0x42214: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFB5C4, 1))', "slot_py": None, "target": None, "cond": None},
    0x42216: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x42218: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x4221a: {"kind": "branch", "py": None, "slot_py": '', "target": 0x42224, "cond": 'notT'},
    0x4221e: {"kind": 'reg', "py": 'r[1] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x42220: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFC89C, 1, r[1])', "target": 0x42228, "cond": 'always'},
    0x42224: {"kind": 'reg', "py": 'r[0] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x42226: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC89C, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x42228: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
