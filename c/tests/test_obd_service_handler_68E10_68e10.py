#!/usr/bin/env python3
"""Differential test for obd_service_handler_68E10 (0x68E10) — v3 lift (branches + delay slots), 24 bytes.
...
Run from repo root: python3 c/tests/test_obd_service_handler_68E10_68e10.py
"""
...
ENTRY = 0x68E10
RAW = bytes.fromhex("D0 14 E5 40 60 00 C9 F0 64 03 63 4C 33 53 8F 01 00 09 64 53 00 0B 60 43")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    0x68e10: {"kind": 'reg', "py": 'r[0] = 0xFFFFDE04', "slot_py": None, "target": None, "cond": None},
    0x68e12: {"kind": 'reg', "py": 'r[5] = s8(0x40)', "slot_py": None, "target": None, "cond": None},
    0x68e14: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFDE04, 1))', "slot_py": None, "target": None, "cond": None},
    0x68e16: {"kind": 'reg', "py": 'r[0] = (r[0] & 0xF0) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x68e18: {"kind": 'reg', "py": 'r[4] = r[0]', "slot_py": None, "target": None, "cond": None},
    0x68e1a: {"kind": 'reg', "py": 'r[3] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x68e1c: {"kind": 'reg', "py": 'T = 1 if s32(r[3]) >= s32(r[5]) else 0', "slot_py": None, "target": None, "cond": None},
    0x68e1e: {"kind": "branch", "py": None, "slot_py": '', "target": 0x68e24, "cond": 'notT'},
    0x68e22: {"kind": 'reg', "py": 'r[4] = r[5]', "slot_py": None, "target": None, "cond": None},
    0x68e24: {"kind": "ret", "py": None, "slot_py": 'r[0] = r[4]', "target": None, "cond": None},}
