#!/usr/bin/env python3
"""Differential test for fpu_delta_calc_30C8C (0x30C8C) — v3 lift + v4 FPU, 30 bytes.
...
Run from repo root: python3 c/tests/test_fpu_delta_calc_30C8C_30c8c.py
"""
...
RAM_MAX = 0xFFFFBE74
SPAN_END = 0x30CAA
SENT = 0x30CAA     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x30c8c: {"kind": 'reg', "py": 'r[5] = 0xFFFFBE6C', "slot_py": None, "target": None, "cond": None},
    0x30c8e: {"kind": 'reg', "py": 'r[4] = 0xFFFFBE8C', "slot_py": None, "target": None, "cond": None},
    0x30c90: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, r[5], 4))', "slot_py": None, "target": None, "cond": None},
    0x30c92: {"kind": 'fpu', "py": '_wrw(ram, r[4], 4, f2bits(fr[3]))', "slot_py": None, "target": None, "cond": None},
    0x30c94: {"kind": 'reg', "py": 'r[6] = 0xFFFFAD8C', "slot_py": None, "target": None, "cond": None},
    0x30c96: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, r[6], 4))', "slot_py": None, "target": None, "cond": None},
    0x30c98: {"kind": 'reg', "py": 'r[3] = 0xFFFFBE70', "slot_py": None, "target": None, "cond": None},
    0x30c9a: {"kind": 'fpu', "py": 'fr[2] = ts(fr[2] - fr[3])', "slot_py": None, "target": None, "cond": None},
    0x30c9c: {"kind": 'reg', "py": 'r[2] = 0xFFFFBE74', "slot_py": None, "target": None, "cond": None},
    0x30c9e: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFBE70, 4, f2bits(fr[2]))', "slot_py": None, "target": None, "cond": None},
    0x30ca0: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, r[5], 4))', "slot_py": None, "target": None, "cond": None},
    0x30ca2: {"kind": 'fpu', "py": 'fr[1] = bits2f(_rdw(ram, r[6], 4))', "slot_py": None, "target": None, "cond": None},
    0x30ca4: {"kind": 'fpu', "py": 'fr[1] = ts(fr[1] - fr[3])', "slot_py": None, "target": None, "cond": None},
    0x30ca6: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBE74, 4, f2bits(fr[1]))', "target": None, "cond": None},}
