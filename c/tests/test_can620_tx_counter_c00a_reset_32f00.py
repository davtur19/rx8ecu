#!/usr/bin/env python3
"""Differential test for can620_tx_counter_c00a_reset (0x32F00) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_can620_tx_counter_c00a_reset_32f00.py
"""
...
ENTRY = 0x32F00
RAW = bytes.fromhex("D2 3B E3 00 00 0B 22 31")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFC00A
SPAN_END = 0x32F08
SENT = 0x32F08     # stop-sentinel, placed past the literal pool
