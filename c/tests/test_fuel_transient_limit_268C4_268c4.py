#!/usr/bin/env python3
"""Differential test for fuel_transient_limit_268C4 (0x268C4) — v3 lift + v4 FPU, 56 bytes.
...
Run from repo root: python3 c/tests/test_fuel_transient_limit_268C4_268c4.py
"""
...
ENTRY = 0x268C4
RAW = bytes.fromhex("D4 1E D3 1F F5 48 F3 38 95 2B F5 31 D2 1D F2 28 91 28 F1 18 96 27 F1 22 F5 1A F4 1C F3 48 F3 45 8D 03 00 09 E1 01 A0 05 26 10 F5 45 8F 02 00 09 E3 00 26 30 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFB683
SPAN_END = 0x268FC
SENT = 0x268FC     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x268c4: {"kind": 'reg', "py": 'r[4] = 0x000751D4', "slot_py": None, "target": None, "cond": None},
    0x268c6: {"kind": 'reg', "py": 'r[3] = 0x000751D8', "slot_py": None, "target": None, "cond": None},
    0x268c8: {"kind": 'fpu', "py": 'fr[5] = bits2f(_rdw(ram, r[4], 4))', "slot_py": None, "target": None, "cond": None},
    0x268ca: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x000751D8, 4))', "slot_py": None, "target": None, "cond": None},
    0x268cc: {"kind": 'reg', "py": 'r[5] = 0xFFFFB608', "slot_py": None, "target": None, "cond": None},
    0x268ce: {"kind": 'fpu', "py": 'fr[5] = ts(fr[5] - fr[3])', "slot_py": None, "target": None, "cond": None},
    0x268d0: {"kind": 'reg', "py": 'r[2] = 0x000751D0', "slot_py": None, "target": None, "cond": None},
    0x268d2: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0x000751D0, 4))', "slot_py": None, "target": None, "cond": None},
    0x268d4: {"kind": 'reg', "py": 'r[1] = 0xFFFFB5B8', "slot_py": None, "target": None, "cond": None},
    0x268d6: {"kind": 'fpu', "py": 'fr[1] = bits2f(_rdw(ram, 0xFFFFB5B8, 4))', "slot_py": None, "target": None, "cond": None},
    0x268d8: {"kind": 'reg', "py": 'r[6] = 0xFFFFB683', "slot_py": None, "target": None, "cond": None},
    0x268da: {"kind": 'fpu', "py": 'fr[1] = ts(fr[1] * fr[2])', "slot_py": None, "target": None, "cond": None},
    0x268dc: {"kind": 'fpu', "py": '_wrw(ram, r[5], 4, f2bits(fr[1]))', "slot_py": None, "target": None, "cond": None},
    0x268de: {"kind": 'fpu', "py": 'fr[4] = fr[1]', "slot_py": None, "target": None, "cond": None},
    0x268e0: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, r[4], 4))', "slot_py": None, "target": None, "cond": None},
    0x268e2: {"kind": 'fpu', "py": 'T = 1 if fr[3] > fr[4] else 0', "slot_py": None, "target": None, "cond": None},
    0x268e4: {"kind": "branch", "py": None, "slot_py": '', "target": 0x268ee, "cond": 'T'},
    0x268e8: {"kind": 'reg', "py": 'r[1] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x268ea: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFB683, 1, r[1])', "target": 0x268f8, "cond": 'always'},
    0x268ee: {"kind": 'fpu', "py": 'T = 1 if fr[5] > fr[4] else 0', "slot_py": None, "target": None, "cond": None},
    0x268f0: {"kind": "branch", "py": None, "slot_py": '', "target": 0x268f8, "cond": 'notT'},
    0x268f4: {"kind": 'reg', "py": 'r[3] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x268f6: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFB683, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x268f8: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
