/* test_obd_service_handler_63312.c
 *
 * Host C companion for obd_service_handler_63312 (0x63312).
 *
 * Pending-flag clear leaf, identical to 0x632D6 but for the flag at
 * 0xFFFF87D0: if byte@0xFFFF87D0 == 1 the 16-bit cell is rewritten as
 * enc8(0) = 0x00FF; otherwise untouched.  Cell in page 0xFFFF8000.
 *
 * The cell is accessed as a uint16_t VALUE: byte@0xFFFF87D0 is the high byte
...
extern void obd_service_handler_63312(void);
...
int main(void)
{
    ...
    map_page(0xFFFF8000);
    printf("=== obd_service_handler_63312 ===\n");
