#!/usr/bin/env python3
"""Differential test for float_array_zero_fill_aed0_cb84 (0x1CB84) — v3 lift + v4 FPU, 24 bytes.
...
Run from repo root: python3 c/tests/test_float_array_zero_fill_aed0_cb84_1cb84.py
"""
...
ENTRY = 0x1CB84
RAW = bytes.fromhex("D4 34 E5 01 E6 15 F4 8D F4 4A 75 01 63 5C 33 67 8F FA 74 04 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = None
SPAN_END = 0x1CB9C
SENT = 0x1CB9C     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x1cb84: {"kind": 'reg', "py": 'r[4] = 0xFFFFAED0', "slot_py": None, "target": None, "cond": None},
    0x1cb86: {"kind": 'reg', "py": 'r[5] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x1cb88: {"kind": 'reg', "py": 'r[6] = s8(0x15)', "slot_py": None, "target": None, "cond": None},
    0x1cb8a: {"kind": 'fpu', "py": 'fr[4] = 0.0', "slot_py": None, "target": None, "cond": None},
    0x1cb8c: {"kind": 'fpu', "py": '_wrw(ram, r[4], 4, f2bits(fr[4]))', "slot_py": None, "target": None, "cond": None},
    0x1cb8e: {"kind": 'reg', "py": 'r[5] = (r[5] + s8(0x01)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x1cb90: {"kind": 'reg', "py": 'r[3] = r[5] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x1cb92: {"kind": 'reg', "py": 'T = 1 if s32(r[3]) > s32(r[6]) else 0', "slot_py": None, "target": None, "cond": None},
    0x1cb94: {"kind": "branch", "py": None, "slot_py": 'r[4] = (r[4] + s8(0x04)) & 0xFFFFFFFF', "target": 0x1cb8c, "cond": 'notT'},
    0x1cb98: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
