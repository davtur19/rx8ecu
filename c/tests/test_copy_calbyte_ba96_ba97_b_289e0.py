#!/usr/bin/env python3
"""Differential test for copy_calbyte_ba96_ba97_b (0x289E0) — v3 lift (branches + delay slots), 24 bytes.
...
Run from repo root: python3 c/tests/test_copy_calbyte_ba96_ba97_b_289e0.py
"""
...
ENTRY = 0x289E0
RAW = bytes.fromhex("93 5F E0 00 D1 33 23 00 62 10 90 5B 91 5B 20 20 D2 31 63 20 00 0B 21 30")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBA98
SPAN_END = 0x289F8
SENT = 0x289F8     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x289e0: {"kind": 'reg', "py": 'r[3] = 0xFFFFBA98', "slot_py": None, "target": None, "cond": None},
    0x289e2: {"kind": 'reg', "py": 'r[0] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x289e4: {"kind": 'reg', "py": 'r[1] = 0x0007537C', "slot_py": None, "target": None, "cond": None},
    0x289e6: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBA98, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x289e8: {"kind": 'mem', "py": 'r[2] = s8(_rdw(ram, 0x0007537C, 1))', "slot_py": None, "target": None, "cond": None},
    0x289ea: {"kind": 'reg', "py": 'r[0] = 0xFFFFBA96', "slot_py": None, "target": None, "cond": None},
    0x289ec: {"kind": 'reg', "py": 'r[1] = 0xFFFFBA97', "slot_py": None, "target": None, "cond": None},
    0x289ee: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBA96, 1, r[2])', "slot_py": None, "target": None, "cond": None},
    0x289f0: {"kind": 'reg', "py": 'r[2] = 0x0007537E', "slot_py": None, "target": None, "cond": None},
    0x289f2: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0x0007537E, 1))', "slot_py": None, "target": None, "cond": None},
    0x289f4: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBA97, 1, r[3])', "target": None, "cond": None},}
