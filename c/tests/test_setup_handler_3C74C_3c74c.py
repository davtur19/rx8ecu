#!/usr/bin/env python3
"""Differential test for setup_handler_3C74C (0x3C74C) — v3 lift (branches + delay slots), 22 bytes.
...
Run from repo root: python3 c/tests/test_setup_handler_3C74C_3c74c.py
"""
...
CODE = {
    0x3c74c: {"kind": 'reg', "py": 'r[5] = 0xFFFFC5FF', "slot_py": None, "target": None, "cond": None},
    0x3c74e: {"kind": 'mem', "py": 'r[4] = s8(_rdw(ram, 0xFFFFC5FF, 1))', "slot_py": None, "target": None, "cond": None},
    0x3c750: {"kind": 'reg', "py": 'r[3] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x3c752: {"kind": 'reg', "py": 'T = 1 if s32(r[3]) > 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x3c754: {"kind": "branch", "py": None, "slot_py": '', "target": 0x3c75e, "cond": 'notT'},
    0x3c758: {"kind": 'reg', "py": 'r[3] = 0x000000FF', "slot_py": None, "target": None, "cond": None},
    0x3c75a: {"kind": 'reg', "py": 'r[4] = (r[4] + r[3]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x3c75c: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC5FF, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x3c75e: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
