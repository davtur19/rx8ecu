#!/usr/bin/env python3
"""Differential test for isr_decrement_28126 (0x28126) — v3 lift (branches + delay slots), 34 bytes.
...
Run from repo root: python3 c/tests/test_isr_decrement_28126_28126.py
"""
...
CODE = {
    0x28126: {"kind": 'reg', "py": 'r[3] = 0xFFFFB6D0', "slot_py": None, "target": None, "cond": None},
    0x28128: {"kind": 'mem', "py": 'r[0] = s16(_rdw(ram, 0xFFFFB6D0, 2))', "slot_py": None, "target": None, "cond": None},
    0x2812a: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x2812c: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x2812e: {"kind": "branch", "py": None, "slot_py": '', "target": 0x28144, "cond": 'notT'},
    0x28132: {"kind": 'reg', "py": 'r[5] = 0xFFFFBA74', "slot_py": None, "target": None, "cond": None},
    0x28134: {"kind": 'mem', "py": 'r[4] = s16(_rdw(ram, 0xFFFFBA74, 2))', "slot_py": None, "target": None, "cond": None},
    0x28136: {"kind": 'reg', "py": 'r[1] = r[4] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x28138: {"kind": 'reg', "py": 'T = 1 if s32(r[1]) > 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x2813a: {"kind": "branch", "py": None, "slot_py": '', "target": 0x28144, "cond": 'notT'},
    0x2813e: {"kind": 'reg', "py": 'r[1] = 0x0000FFFF', "slot_py": None, "target": None, "cond": None},
    0x28140: {"kind": 'reg', "py": 'r[4] = (r[4] + r[1]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x28142: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBA74, 2, r[4])', "slot_py": None, "target": None, "cond": None},
    0x28144: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
