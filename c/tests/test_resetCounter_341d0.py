#!/usr/bin/env python3
"""Differential test for resetCounter (0x341D0) — v3 lift (branches + delay slots), 10 bytes.
...
Run from repo root: python3 c/tests/test_resetCounter_341d0.py
"""
...
ENTRY = 0x341D0
RAW = bytes.fromhex("D2 42 63 20 D1 42 00 0B 21 30")
SEED = 0
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFC0E8
SPAN_END = 0x341DA
SENT = 0x341DA     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x341d0: {"kind": 'reg', "py": 'r[2] = 0x00078CDC', "slot_py": None, "target": None, "cond": None},
    0x341d2: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0x00078CDC, 1))', "slot_py": None, "target": None, "cond": None},
    0x341d4: {"kind": 'reg', "py": 'r[1] = 0xFFFFC0E8', "slot_py": None, "target": None, "cond": None},
    0x341d6: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFC0E8, 1, r[3])', "target": None, "cond": None},}
