#!/usr/bin/env python3
"""Differential test for can_get_rx_pending_flags (0xD0C0) — v3 lift (branches + delay slots), 50 bytes.
...
Run from repo root: python3 c/tests/test_can_get_rx_pending_flags_d0c0.py
"""
...
ENTRY = 0xD0C0
RAW = bytes.fromhex("64 4C 24 48 8F 05 00 09 93 57 64 31 91 57 A0 04 64 47 93 53 64 31 64 47 91 52 62 11 24 29 65 4D D2 2C 63 5C 43 18 22 59 42 19 64 33 24 2B 00 0B 60 43")
SEED = 42
N = 2000
MAXSTEPS = 100000
...
CODE = {
    ...
    0xd0da: {"kind": 'mem', "py": 'r[2] = s16(_rdw(ram, 0xFFFFE60E, 2))', "slot_py": None, "target": None, "cond": None},
