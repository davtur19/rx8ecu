#!/usr/bin/env python3
"""Differential test for fault_code_dispatcher_3ECDC (0x3ECDC) — v3 lift (branches + delay slots), 40 bytes.
...
Run from repo root: python3 c/tests/test_fault_code_dispatcher_3ECDC_3ecdc.py
"""
...
ENTRY = 0x3ECDC
RAW = bytes.fromhex("93 12 64 30 D6 09 65 4C 62 60 62 2C 32 50 8F 09 00 09 25 58 97 09 8F 03 00 09 E1 01 A0 02 27 10 E0 00 27 00 00 0B 26 40")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFC6A9
SPAN_END = 0x3ED04
SENT = 0x3ED0C     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x3ecdc: {"kind": 'reg', "py": 'r[3] = 0xFFFFC6A7', "slot_py": None, "target": None, "cond": None},
    0x3ecde: {"kind": 'mem', "py": 'r[4] = s8(_rdw(ram, 0xFFFFC6A7, 1))', "slot_py": None, "target": None, "cond": None},
    0x3ece0: {"kind": 'reg', "py": 'r[6] = 0xFFFFC6A9', "slot_py": None, "target": None, "cond": None},
    0x3ece2: {"kind": 'reg', "py": 'r[5] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x3ece4: {"kind": 'mem', "py": 'r[2] = s8(_rdw(ram, 0xFFFFC6A9, 1))', "slot_py": None, "target": None, "cond": None},
    0x3ece6: {"kind": 'reg', "py": 'r[2] = r[2] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x3ece8: {"kind": 'reg', "py": 'T = 1 if r[2] == r[5] else 0', "slot_py": None, "target": None, "cond": None},
    0x3ecea: {"kind": "branch", "py": None, "slot_py": '', "target": 0x3ed00, "cond": 'notT'},
    0x3ecee: {"kind": 'reg', "py": 'T = 1 if (r[5] & r[5]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x3ecf0: {"kind": 'reg', "py": 'r[7] = 0xFFFFC6A8', "slot_py": None, "target": None, "cond": None},
    0x3ecf2: {"kind": "branch", "py": None, "slot_py": '', "target": 0x3ecfc, "cond": 'notT'},
    0x3ecf6: {"kind": 'reg', "py": 'r[1] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x3ecf8: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFC6A8, 1, r[1])', "target": 0x3ed00, "cond": 'always'},
    0x3ecfc: {"kind": 'reg', "py": 'r[0] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x3ecfe: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC6A8, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x3ed00: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFC6A9, 1, r[4])', "target": None, "cond": None},}
