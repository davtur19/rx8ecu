#!/usr/bin/env python3
"""Differential test for helper_utility_28E84 (0x28E84) — v3 lift (branches + delay slots), 24 bytes.
...
Run from repo root: python3 c/tests/test_helper_utility_28E84_28e84.py
"""
...
CODE = {
    0x28e84: {"kind": 'reg', "py": 'r[3] = 0xFFFFBAC8', "slot_py": None, "target": None, "cond": None},
    0x28e86: {"kind": 'reg', "py": 'r[0] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x28e88: {"kind": 'reg', "py": 'r[1] = 0x00075B28', "slot_py": None, "target": None, "cond": None},
    0x28e8a: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBAC8, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x28e8c: {"kind": 'mem', "py": 'r[2] = s8(_rdw(ram, 0x00075B28, 1))', "slot_py": None, "target": None, "cond": None},
    0x28e8e: {"kind": 'reg', "py": 'r[0] = 0xFFFFBAC6', "slot_py": None, "target": None, "cond": None},
    0x28e90: {"kind": 'reg', "py": 'r[1] = 0xFFFFBAC7', "slot_py": None, "target": None, "cond": None},
    0x28e92: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBAC6, 1, r[2])', "slot_py": None, "target": None, "cond": None},
    0x28e94: {"kind": 'reg', "py": 'r[2] = 0x00075B2A', "slot_py": None, "target": None, "cond": None},
    0x28e96: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0x00075B2A, 1))', "slot_py": None, "target": None, "cond": None},
    0x28e98: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBAC7, 1, r[3])', "target": None, "cond": None},}
