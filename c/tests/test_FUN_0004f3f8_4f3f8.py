#!/usr/bin/env python3
"""Differential test for FUN_0004f3f8 (0x4F3F8) — v3 lift (branches + delay slots), 20 bytes.
...
Run from repo root: python3 c/tests/test_FUN_0004f3f8_4f3f8.py
"""
...
ENTRY = 0x4F3F8
RAW = bytes.fromhex("66 40 62 6C 42 15 8F 03 00 09 92 5D 36 2C 24 60 00 0B 27 50")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = None
SPAN_END = 0x4F40C
SENT = 0x4F40C     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x4f3f8: {"kind": 'mem', "py": 'r[6] = s8(_rdw(ram, r[4], 1))', "slot_py": None, "target": None, "cond": None},
    0x4f3fa: {"kind": 'reg', "py": 'r[2] = r[6] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x4f3fc: {"kind": 'reg', "py": 'T = 1 if s32(r[2]) > 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x4f3fe: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4f408, "cond": 'notT'},
    0x4f402: {"kind": 'reg', "py": 'r[2] = 0x000000FF', "slot_py": None, "target": None, "cond": None},
    0x4f404: {"kind": 'reg', "py": 'r[6] = (r[6] + r[2]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x4f406: {"kind": 'mem', "py": '_wrw(ram, r[4], 1, r[6])', "slot_py": None, "target": None, "cond": None},
    0x4f408: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, r[7], 1, r[5])', "target": None, "cond": None},}
