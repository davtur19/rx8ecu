#!/usr/bin/env python3
"""Differential test for atu_clear_status_flags (0x119A) — v3 lift (branches + delay slots), 12 bytes.
...
Run from repo root: python3 c/tests/test_atu_clear_status_flags_119a.py
"""
...
ENTRY = 0x119A
RAW = bytes.fromhex("E4 40 93 0D 23 41 92 0C 00 0B 22 41")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    0x119a: {"kind": 'reg', "py": 'r[4] = s8(0x40)', "slot_py": None, "target": None, "cond": None},
    0x119c: {"kind": 'reg', "py": 'r[3] = 0xFFFFE40E', "slot_py": None, "target": None, "cond": None},
    0x119e: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFE40E, 2, r[4])', "slot_py": None, "target": None, "cond": None},
    0x11a0: {"kind": 'reg', "py": 'r[2] = 0xFFFFE41A', "slot_py": None, "target": None, "cond": None},
    0x11a2: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFE41A, 2, r[4])', "target": None, "cond": None},}
