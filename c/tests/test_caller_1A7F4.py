#!/usr/bin/env python3
"""Differential test for caller_1A7F4 (entry 0x1A7F4) — v8 ST caller (CFG), 38 bytes.
...
Run: python3 test_caller_1A7F4.py
"""
...
CODE = {
    0x1a7f4: {"kind": 'mem', "py": 'local[0x3FC] = r[14]\n_wrw(ram, STACK_BASE + 0x3FC, 4, r[14])\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x1a7f6: {"kind": 'st', "py": 'local[0x3F8] = pr\n_wrw(ram, STACK_BASE + 0x3F8, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x1a7f8: {"kind": 'reg', "py": 'r[14] = 0xFFFFAA7E', "slot_py": None, "target": None, "cond": None},
    0x1a7fa: {"kind": 'reg', "py": 'r[2] = 0xFFFFAAE0', "slot_py": None, "target": None, "cond": None},
    0x1a7fc: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFAAE0, 1))', "slot_py": None, "target": None, "cond": None},
    0x1a7fe: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x1a800: {"kind": "branch", "py": None, "slot_py": '', "target": 0x1a810, "cond": 'notT'},
    0x1a804: {"kind": 'reg', "py": 'r[3] = 0x00002460', "slot_py": None, "target": None, "cond": None},
    0x1a806: {"kind": 'reg', "py": 'r[5] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x1a808: {"kind": "call", "py": None, "slot_py": 'r[4] = s16(_rdw(ram, 0xFFFFAA7E, 2))', "target": 0x2460, "ret_pc": 0x1a80c, "set_pr": True, "cond": None},
    0x1a80c: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFAA7E, 2, r[0])', "target": 0x1a814, "cond": 'always'},
    0x1a810: {"kind": 'reg', "py": 'r[3] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x1a812: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFAA7E, 2, r[3])', "slot_py": None, "target": None, "cond": None},
    0x1a814: {"kind": 'st', "py": 'pr = _rdw(ram, STACK_BASE + 0x3F8, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x1a816: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, STACK_BASE + 0x3FC, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},
