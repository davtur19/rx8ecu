#!/usr/bin/env python3
"""Differential test for float_c534_init_one (0x3A600) — v3 lift + v4 FPU, 8 bytes.
...
Run from repo root: python3 c/tests/test_float_c534_init_one_3a600.py
"""
...
ENTRY = 0x3A600
RAW = bytes.fromhex("93 79 F3 9D 00 0B F3 3A")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFC534
SPAN_END = 0x3A608
SENT = 0x3A608     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x3a600: {"kind": 'reg', "py": 'r[3] = 0xFFFFC534', "slot_py": None, "target": None, "cond": None},
    0x3a602: {"kind": 'fpu', "py": 'fr[3] = 1.0', "slot_py": None, "target": None, "cond": None},
    0x3a604: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFC534, 4, f2bits(fr[3]))', "target": None, "cond": None},}
