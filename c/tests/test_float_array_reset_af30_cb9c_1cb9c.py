#!/usr/bin/env python3
"""Differential test for float_array_reset_af30_cb9c (0x1CB9C) — v3 lift + v4 FPU, 38 bytes.
...
Run from repo root: python3 c/tests/test_float_array_reset_af30_cb9c_1cb9c.py
"""
...
ENTRY = 0x1CB9C
RAW = bytes.fromhex("93 4A E5 01 D4 2E F4 9D 92 47 E6 14 91 46 F3 4A F2 4A F1 4A F4 8D 75 01 F4 4A 63 5C 33 67 8F FA 74 04 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFAE58
SPAN_END = 0x1CBC2
SENT = 0x1CBC2     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x1cb9c: {"kind": 'reg', "py": 'r[3] = 0xFFFFAE50', "slot_py": None, "target": None, "cond": None},
    0x1cb9e: {"kind": 'reg', "py": 'r[5] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x1cba0: {"kind": 'reg', "py": 'r[4] = 0xFFFFAF30', "slot_py": None, "target": None, "cond": None},
    0x1cba2: {"kind": 'fpu', "py": 'fr[4] = 1.0', "slot_py": None, "target": None, "cond": None},
    0x1cba4: {"kind": 'reg', "py": 'r[2] = 0xFFFFAE54', "slot_py": None, "target": None, "cond": None},
    0x1cba6: {"kind": 'reg', "py": 'r[6] = s8(0x14)', "slot_py": None, "target": None, "cond": None},
    0x1cba8: {"kind": 'reg', "py": 'r[1] = 0xFFFFAE58', "slot_py": None, "target": None, "cond": None},
    0x1cbaa: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFAE50, 4, f2bits(fr[4]))', "slot_py": None, "target": None, "cond": None},
    0x1cbac: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFAE54, 4, f2bits(fr[4]))', "slot_py": None, "target": None, "cond": None},
    0x1cbae: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFAE58, 4, f2bits(fr[4]))', "slot_py": None, "target": None, "cond": None},
    0x1cbb0: {"kind": 'fpu', "py": 'fr[4] = 0.0', "slot_py": None, "target": None, "cond": None},
    0x1cbb2: {"kind": 'reg', "py": 'r[5] = (r[5] + s8(0x01)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x1cbb4: {"kind": 'fpu', "py": '_wrw(ram, r[4], 4, f2bits(fr[4]))', "slot_py": None, "target": None, "cond": None},
    0x1cbb6: {"kind": 'reg', "py": 'r[3] = r[5] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x1cbb8: {"kind": 'reg', "py": 'T = 1 if s32(r[3]) > s32(r[6]) else 0', "slot_py": None, "target": None, "cond": None},
    0x1cbba: {"kind": "branch", "py": None, "slot_py": 'r[4] = (r[4] + s8(0x04)) & 0xFFFFFFFF', "target": 0x1cbb2, "cond": 'notT'},
    0x1cbbe: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
