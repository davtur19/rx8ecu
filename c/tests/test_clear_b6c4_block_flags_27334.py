#!/usr/bin/env python3
"""Differential test for clear_b6c4_block_flags (0x27334) — v3 lift (branches + delay slots), 50 bytes.
...
Run from repo root: python3 c/tests/test_clear_b6c4_block_flags_27334.py
"""
...
ENTRY = 0x27334
RAW = bytes.fromhex("93 70 60 30 60 0C 88 01 8F 11 00 09 92 6B 60 20 60 0C 88 01 8F 0B 00 09 93 66 E4 00 92 65 23 41 22 41 91 63 93 63 21 41 23 41 92 61 22 40 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCFD9
SPAN_END = 0x27366
SENT = 0x27366     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x27334: {"kind": 'reg', "py": 'r[3] = 0xFFFFCFD9', "slot_py": None, "target": None, "cond": None},
    0x27336: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCFD9, 1))', "slot_py": None, "target": None, "cond": None},
    0x27338: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x2733a: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x2733c: {"kind": "branch", "py": None, "slot_py": '', "target": 0x27362, "cond": 'notT'},
    0x27340: {"kind": 'reg', "py": 'r[2] = 0xFFFFA41C', "slot_py": None, "target": None, "cond": None},
    0x27342: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFA41C, 1))', "slot_py": None, "target": None, "cond": None},
    0x27344: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x27346: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x27348: {"kind": "branch", "py": None, "slot_py": '', "target": 0x27362, "cond": 'notT'},
    0x2734c: {"kind": 'reg', "py": 'r[3] = 0xFFFFB6C4', "slot_py": None, "target": None, "cond": None},
    0x2734e: {"kind": 'reg', "py": 'r[4] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x27350: {"kind": 'reg', "py": 'r[2] = 0xFFFFB6C6', "slot_py": None, "target": None, "cond": None},
    0x27352: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFB6C4, 2, r[4])', "slot_py": None, "target": None, "cond": None},
    0x27354: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFB6C6, 2, r[4])', "slot_py": None, "target": None, "cond": None},
    0x27356: {"kind": 'reg', "py": 'r[1] = 0xFFFFB6C8', "slot_py": None, "target": None, "cond": None},
    0x27358: {"kind": 'reg', "py": 'r[3] = 0xFFFFB6CA', "slot_py": None, "target": None, "cond": None},
    0x2735a: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFB6C8, 2, r[4])', "slot_py": None, "target": None, "cond": None},
    0x2735c: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFB6CA, 2, r[4])', "slot_py": None, "target": None, "cond": None},
    0x2735e: {"kind": 'reg', "py": 'r[2] = 0xFFFFB6D4', "slot_py": None, "target": None, "cond": None},
    0x27360: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFB6D4, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x27362: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
