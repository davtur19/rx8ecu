#!/usr/bin/env python3
"""Differential test for setAlternatorFault (0x52698) — v3 lift (branches + delay slots), 34 bytes.
...
Run from repo root: python3 c/tests/test_setAlternatorFault_52698.py
"""
...
ENTRY = 0x52698
RAW = bytes.fromhex("8F 09 00 09 90 25 63 00 23 38 8F 04 00 09 E1 01 92 20 A0 03 22 10 E0 00 93 1C 23 00 4F 26 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
