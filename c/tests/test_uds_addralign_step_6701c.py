#!/usr/bin/env python3
"""Differential test for uds_addralign_step (0x6701C) — v3 lift (branches + delay slots), 56 bytes.
...
Run from repo root: python3 c/tests/test_uds_addralign_step_6701c.py
"""
...
ENTRY = 0x6701C
RAW = bytes.fromhex("D4 6C 84 45 60 0C 88 04 8F 14 E6 01 D0 63 60 00 C9 0F 67 03 84 47 65 7C 60 0C 30 50 8F 0A 00 09 E2 0F 35 23 8F 02 E7 00 A0 02 60 73 84 47 70 01 80 47 66 73 00 0B 60 63")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFDBF6
SPAN_END = 0x67054
SENT = 0x67054     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x6701c: {"kind": 'reg', "py": 'r[4] = 0xFFFFDBF6', "slot_py": None, "target": None, "cond": None},
    0x6701e: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFDBFB, 1))', "slot_py": None, "target": None, "cond": None},
    0x67020: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x67022: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x04) else 0', "slot_py": None, "target": None, "cond": None},
    0x67024: {"kind": "branch", "py": None, "slot_py": 'r[6] = s8(0x01)', "target": 0x67050, "cond": 'notT'},
    0x67028: {"kind": 'reg', "py": 'r[0] = 0xFFFFDBD8', "slot_py": None, "target": None, "cond": None},
    0x6702a: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFDBD8, 1))', "slot_py": None, "target": None, "cond": None},
    0x6702c: {"kind": 'reg', "py": 'r[0] = (r[0] & 0x0F) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x6702e: {"kind": 'reg', "py": 'r[7] = r[0]', "slot_py": None, "target": None, "cond": None},
    0x67030: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFDBFD, 1))', "slot_py": None, "target": None, "cond": None},
    0x67032: {"kind": 'reg', "py": 'r[5] = r[7] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x67034: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x67036: {"kind": 'reg', "py": 'T = 1 if r[0] == r[5] else 0', "slot_py": None, "target": None, "cond": None},
    0x67038: {"kind": "branch", "py": None, "slot_py": '', "target": 0x67050, "cond": 'notT'},
    0x6703c: {"kind": 'reg', "py": 'r[2] = s8(0x0F)', "slot_py": None, "target": None, "cond": None},
    0x6703e: {"kind": 'reg', "py": 'T = 1 if s32(r[5]) >= s32(r[2]) else 0', "slot_py": None, "target": None, "cond": None},
    0x67040: {"kind": "branch", "py": None, "slot_py": 'r[7] = s8(0x00)', "target": 0x67048, "cond": 'notT'},
    0x67044: {"kind": "branch", "py": None, "slot_py": 'r[0] = r[7]', "target": 0x6704c, "cond": 'always'},
    0x67048: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, (r[4] + 7), 1))', "slot_py": None, "target": None, "cond": None},
    0x6704a: {"kind": 'reg', "py": 'r[0] = (r[0] + s8(0x01)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x6704c: {"kind": 'mem', "py": '_wrw(ram, (r[4] + 7), 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x6704e: {"kind": 'reg', "py": 'r[6] = r[7]', "slot_py": None, "target": None, "cond": None},
    0x67050: {"kind": "ret", "py": None, "slot_py": 'r[0] = r[6]', "target": None, "cond": None},}
