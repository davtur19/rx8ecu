#!/usr/bin/env python3
"""Differential test for diag_fault_0x6e_cond_eval (0x449A6) — v3 lift (branches + delay slots), 20 bytes.
...
Run from repo root: python3 c/tests/test_diag_fault_0x6e_cond_eval_449a6.py
"""
...
ENTRY = 0x449A6
RAW = bytes.fromhex("65 60 63 5C 43 15 8F 03 00 09 93 63 35 3C 26 50 00 0B 27 40")
SEED = 42
N = 500
MAXSTEPS = 100000
