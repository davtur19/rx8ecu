#!/usr/bin/env python3
"""Differential test for fuel_pressure_storage_45B0A (0x45B0A) — v3 lift (branches + delay slots), 18 bytes.
...
Run from repo root: python3 c/tests/test_fuel_pressure_storage_45B0A_45b0a.py
"""
...
ENTRY = 0x45B0A
RAW = bytes.fromhex("92 10 91 10 63 21 92 0F 21 31 93 07 60 31 00 0B 22 01")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    0x45b0a: {"kind": 'reg', "py": 'r[2] = 0xFFFFCBE4', "slot_py": None, "target": None, "cond": None},
    0x45b0c: {"kind": 'reg', "py": 'r[1] = 0xFFFFCBEC', "slot_py": None, "target": None, "cond": None},
    0x45b0e: {"kind": 'mem', "py": 'r[3] = s16(_rdw(ram, 0xFFFFCBE4, 2))', "slot_py": None, "target": None, "cond": None},
    0x45b10: {"kind": 'reg', "py": 'r[2] = 0xFFFFCBEE', "slot_py": None, "target": None, "cond": None},
    0x45b12: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCBEC, 2, r[3])', "slot_py": None, "target": None, "cond": None},
    0x45b14: {"kind": 'reg', "py": 'r[3] = 0xFFFFCBE8', "slot_py": None, "target": None, "cond": None},
    0x45b16: {"kind": 'mem', "py": 'r[0] = s16(_rdw(ram, 0xFFFFCBE8, 2))', "slot_py": None, "target": None, "cond": None},
    0x45b18: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFCBEE, 2, r[0])', "target": None, "cond": None},}
