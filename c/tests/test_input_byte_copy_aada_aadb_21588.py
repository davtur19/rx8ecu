#!/usr/bin/env python3
"""Differential test for input_byte_copy_aada_aadb (0x21588) — v3 lift (branches + delay slots), 18 bytes.
...
Run from repo root: python3 c/tests/test_input_byte_copy_aada_aadb_21588.py
"""
...
CODE = {
    0x21588: {"kind": 'reg', "py": 'r[2] = 0xFFFFAADA', "slot_py": None, "target": None, "cond": None},
    0x2158a: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFAADA, 1))', "slot_py": None, "target": None, "cond": None},
    0x2158c: {"kind": 'reg', "py": 'r[1] = 0xFFFFB2D5', "slot_py": None, "target": None, "cond": None},
    0x2158e: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFB2D5, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x21590: {"kind": 'reg', "py": 'r[3] = 0xFFFFAADB', "slot_py": None, "target": None, "cond": None},
    0x21592: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFAADB, 1))', "slot_py": None, "target": None, "cond": None},
    0x21594: {"kind": 'reg', "py": 'r[2] = 0xFFFFB2D6', "slot_py": None, "target": None, "cond": None},
    0x21596: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFB2D6, 1, r[0])', "target": None, "cond": None},}
