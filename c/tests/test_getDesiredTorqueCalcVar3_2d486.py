#!/usr/bin/env python3
"""Differential test for getDesiredTorqueCalcVar3 (0x2D486) — v3 lift (branches + delay slots), 22 bytes.
...
Run from repo root: python3 c/tests/test_getDesiredTorqueCalcVar3_2d486.py
"""
...
ENTRY = 0x2D486
RAW = bytes.fromhex("00 09 A0 01 E4 0F 64 53 64 4C D2 0C 44 08 44 08 74 0F 00 0B 22 40")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBCC9
SPAN_END = 0x2D49C
SENT = 0x2D49C     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x2d486: {"kind": 'reg', "py": None, "slot_py": None, "target": None, "cond": None},
