#!/usr/bin/env python3
"""Differential test for can_fault_active_flag_bb5c (0x2A2CE) — v3 lift (branches + delay slots), 78 bytes.
...
Run from repo root: python3 c/tests/test_can_fault_active_flag_bb5c_2a2ce.py
"""
...
ENTRY = 0x2A2CE
RAW = bytes.fromhex("94 6C 93 6C 60 30 60 0C 88 01 8D 19 00 09 92 67 60 20 60 0C 88 01 8D 13 00 09 91 62 60 10 60 0C 88 01 8D 0D 00 09 93 5D 60 30 60 0C 88 01 8D 07 00 09 92 58 E3 03 60 20 60 0C 30 33 8F 03 00 09 E1 01 A0 02 24 10 E2 00 24 20 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCB61
SPAN_END = 0x2A31C
SENT = 0x2A31C     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x2a2ce: {"kind": 'reg', "py": 'r[4] = 0xFFFFBB5C', "slot_py": None, "target": None, "cond": None},
    0x2a2d0: {"kind": 'reg', "py": 'r[3] = 0xFFFFC590', "slot_py": None, "target": None, "cond": None},
    0x2a2d2: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFC590, 1))', "slot_py": None, "target": None, "cond": None},
    0x2a2d4: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x2a2d6: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x2a2d8: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2a30e, "cond": 'T'},
    0x2a2dc: {"kind": 'reg', "py": 'r[2] = 0xFFFFC5EA', "slot_py": None, "target": None, "cond": None},
    0x2a2de: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFC5EA, 1))', "slot_py": None, "target": None, "cond": None},
    0x2a2e0: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x2a2e2: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x2a2e4: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2a30e, "cond": 'T'},
    0x2a2e8: {"kind": 'reg', "py": 'r[1] = 0xFFFFC5DB', "slot_py": None, "target": None, "cond": None},
    0x2a2ea: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFC5DB, 1))', "slot_py": None, "target": None, "cond": None},
    0x2a2ec: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x2a2ee: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x2a2f0: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2a30e, "cond": 'T'},
    0x2a2f4: {"kind": 'reg', "py": 'r[3] = 0xFFFFC5D7', "slot_py": None, "target": None, "cond": None},
    0x2a2f6: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFC5D7, 1))', "slot_py": None, "target": None, "cond": None},
    0x2a2f8: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x2a2fa: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x2a2fc: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2a30e, "cond": 'T'},
    0x2a300: {"kind": 'reg', "py": 'r[2] = 0xFFFFCB61', "slot_py": None, "target": None, "cond": None},
    0x2a302: {"kind": 'reg', "py": 'r[3] = s8(0x03)', "slot_py": None, "target": None, "cond": None},
    0x2a304: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCB61, 1))', "slot_py": None, "target": None, "cond": None},
    0x2a306: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x2a308: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) >= s32(r[3]) else 0', "slot_py": None, "target": None, "cond": None},
    0x2a30a: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2a314, "cond": 'notT'},
    0x2a30e: {"kind": 'reg', "py": 'r[1] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x2a310: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFBB5C, 1, r[1])', "target": 0x2a318, "cond": 'always'},
    0x2a314: {"kind": 'reg', "py": 'r[2] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x2a316: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBB5C, 1, r[2])', "slot_py": None, "target": None, "cond": None},
    0x2a318: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
