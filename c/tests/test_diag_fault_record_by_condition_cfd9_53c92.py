#!/usr/bin/env python3
"""Differential test for diag_fault_record_by_condition_cfd9 (0x53C92) — v3 lift (branches + delay slots), 32 bytes.
...
Run from repo root: python3 c/tests/test_diag_fault_record_by_condition_cfd9_53c92.py
"""
...
ENTRY = 0x53C92
RAW = bytes.fromhex("64 42 60 43 88 04 8F 02 00 09 A0 07 E4 04 00 0B 00 09 D2 10 63 20 D1 10 00 0B 21 30 E0 01 93 07")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCFDC
SPAN_END = 0x53CB2
SENT = 0x53CB2     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x53c92: {"kind": 'mem', "py": 'r[4] = _rdw(ram, r[4], 4)', "slot_py": None, "target": None, "cond": None},
    0x53c94: {"kind": 'reg', "py": 'r[0] = r[4]', "slot_py": None, "target": None, "cond": None},
    0x53c96: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x04) else 0', "slot_py": None, "target": None, "cond": None},
    0x53c98: {"kind": "branch", "py": None, "slot_py": '', "target": 0x53ca0, "cond": 'notT'},
    0x53c9c: {"kind": "branch", "py": None, "slot_py": 'r[4] = s8(0x04)', "target": 0x53cae, "cond": 'always'},
    0x53ca0: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},
    0x53ca4: {"kind": 'reg', "py": 'r[2] = 0x0007C26C', "slot_py": None, "target": None, "cond": None},
    0x53ca6: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0x0007C26C, 1))', "slot_py": None, "target": None, "cond": None},
    0x53ca8: {"kind": 'reg', "py": 'r[1] = 0xFFFFCFDC', "slot_py": None, "target": None, "cond": None},
    0x53caa: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFCFDC, 1, r[3])', "target": None, "cond": None},
    0x53cae: {"kind": 'reg', "py": 'r[0] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x53cb0: {"kind": 'reg', "py": 'r[3] = 0xFFFFCFD9', "slot_py": None, "target": None, "cond": None},}
