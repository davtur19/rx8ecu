#!/usr/bin/env python3
"""Differential test for obd_service_handler_696D4 (0x696D4) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_obd_service_handler_696D4_696d4.py
"""
...
CODE = {
    0x696d4: {"kind": 'reg', "py": 'r[2] = 0xFFFFDE5C', "slot_py": None, "target": None, "cond": None},
    0x696d6: {"kind": 'reg', "py": 'r[3] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x696d8: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFDE5C, 1, r[3])', "target": None, "cond": None},}
