#!/usr/bin/env python3
"""Differential test for init_copy_cal_byte_cf0a (0x4FA6C) — v3 lift (branches + delay slots), 22 bytes.
...
Run from repo root: python3 c/tests/test_init_copy_cal_byte_cf0a_4fa6c.py
"""
...
ENTRY = 0x4FA6C
RAW = bytes.fromhex("D4 2C 63 40 92 49 22 30 61 40 90 47 20 10 63 40 91 45 00 0B 21 30")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCF0C
SPAN_END = 0x4FA82
SENT = 0x4FA82     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x4fa6c: {"kind": 'reg', "py": 'r[4] = 0x0007BF0C', "slot_py": None, "target": None, "cond": None},
    0x4fa6e: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0x0007BF0C, 1))', "slot_py": None, "target": None, "cond": None},
    0x4fa70: {"kind": 'reg', "py": 'r[2] = 0xFFFFCF0A', "slot_py": None, "target": None, "cond": None},
    0x4fa72: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCF0A, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x4fa74: {"kind": 'mem', "py": 'r[1] = s8(_rdw(ram, 0x0007BF0C, 1))', "slot_py": None, "target": None, "cond": None},
    0x4fa76: {"kind": 'reg', "py": 'r[0] = 0xFFFFCF0B', "slot_py": None, "target": None, "cond": None},
    0x4fa78: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCF0B, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x4fa7a: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0x0007BF0C, 1))', "slot_py": None, "target": None, "cond": None},
    0x4fa7c: {"kind": 'reg', "py": 'r[1] = 0xFFFFCF0C', "slot_py": None, "target": None, "cond": None},
    0x4fa7e: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFCF0C, 1, r[3])', "target": None, "cond": None},}
