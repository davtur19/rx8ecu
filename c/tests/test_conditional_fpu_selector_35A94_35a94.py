#!/usr/bin/env python3
"""Differential test for conditional_fpu_selector_35A94 (0x35A94) — v3 lift + v4 FPU, 26 bytes.
...
Run from repo root: python3 c/tests/test_conditional_fpu_selector_35A94_35a94.py
"""
...
ENTRY = 0x35A94
RAW = bytes.fromhex("94 0C 93 0C 60 30 60 0C 88 01 8F 03 00 09 D2 04 A0 01 F3 28 F3 8D 00 0B F4 3A")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFC21C
SPAN_END = 0x35AAE
SENT = 0x35AB8     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x35a94: {"kind": 'reg', "py": 'r[4] = 0xFFFFC20C', "slot_py": None, "target": None, "cond": None},
    0x35a96: {"kind": 'reg', "py": 'r[3] = 0xFFFFB5A4', "slot_py": None, "target": None, "cond": None},
    0x35a98: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFB5A4, 1))', "slot_py": None, "target": None, "cond": None},
    0x35a9a: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x35a9c: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x35a9e: {"kind": "branch", "py": None, "slot_py": '', "target": 0x35aa8, "cond": 'notT'},
    0x35aa2: {"kind": 'reg', "py": 'r[2] = 0xFFFFC21C', "slot_py": None, "target": None, "cond": None},
    0x35aa4: {"kind": "branch", "py": None, "slot_py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFC21C, 4))', "target": 0x35aaa, "cond": 'always'},
    0x35aa8: {"kind": 'fpu', "py": 'fr[3] = 0.0', "slot_py": None, "target": None, "cond": None},
    0x35aaa: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, r[4], 4, f2bits(fr[3]))', "target": None, "cond": None},}
