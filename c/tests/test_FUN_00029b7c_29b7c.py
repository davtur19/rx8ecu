#!/usr/bin/env python3
"""Differential test for FUN_00029b7c (0x29B7C) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_FUN_00029b7c_29b7c.py
"""
...
ENTRY = 0x29B7C
RAW = bytes.fromhex("D2 31 E3 00 00 0B 22 31")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBB44
SPAN_END = 0x29B84
SENT = 0x29B84     # stop-sentinel, placed past the literal pool
