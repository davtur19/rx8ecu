#!/usr/bin/env python3
"""Differential test for wankel_sequential_inj_4870E (0x4870E) — v3 lift (branches + delay slots), 10 bytes.
...
Run from repo root: python3 c/tests/test_wankel_sequential_inj_4870E_4870e.py
"""
...
CODE = {
    0x4870e: {"kind": 'reg', "py": 'r[1] = 0xFFFFCCD0', "slot_py": None, "target": None, "cond": None},
    0x48710: {"kind": 'reg', "py": 'r[0] = 0xFFFFCCD1', "slot_py": None, "target": None, "cond": None},
    0x48712: {"kind": 'mem', "py": 'r[2] = s8(_rdw(ram, 0xFFFFCCD0, 1))', "slot_py": None, "target": None, "cond": None},
    0x48714: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFCCD1, 1, r[2])', "target": None, "cond": None},}
