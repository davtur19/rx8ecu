#!/usr/bin/env python3
"""Differential test for floatDivideDiv0errCheck_SIG_DIVISOR (0x3E0AC) — v3 lift + v4 FPU, 48 bytes.
...
Run from repo root: python3 c/tests/test_floatDivideDiv0errCheck_SIG_DIVISOR_3e0ac.py
"""
...
ENTRY = 0x3E0AC
RAW = bytes.fromhex("F3 8D F5 34 8F 0F 00 09 F4 34 8F 02 00 09 A0 0D F6 8D F3 8D F4 35 8F 03 00 09 C7 94 A0 06 F6 08 C7 93 A0 03 F6 08 F6 4C F6 53 F6 6C 00 0B F0 6C")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = None
SPAN_END = 0x3E0DC
SENT = 0x3E0DC     # stop-sentinel, placed past the literal pool
