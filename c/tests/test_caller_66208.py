#!/usr/bin/env python3
"""Differential test for caller_66208 (entry 0x66208) — v8 ST caller (CFG), 14 bytes.
...
Run: python3 test_caller_66208.py
"""
...
CODE = {
    0x66208: {"kind": 'st', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x6620a: {"kind": 'reg', "py": 'r[3] = 0x00060F58', "slot_py": None, "target": None, "cond": None},
    0x6620c: {"kind": "call", "py": None, "slot_py": '', "target": 0x60f58, "ret_pc": 0x66210, "set_pr": True, "cond": None},
    0x66210: {"kind": 'reg', "py": 'r[2] = 0x00060FCA', "slot_py": None, "target": None, "cond": None},
    0x66212: {"kind": "call", "py": None, "slot_py": 'pr = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": 0x60fca, "ret_pc": 0x66216, "set_pr": False, "cond": None},
    0x60f58: {"kind": 'reg', "py": 'r[7] = 0xFFFFD6C8', "slot_py": None, "target": None, "cond": None},
    0x60f5a: {"kind": 'reg', "py": 'r[4] = r[7]', "slot_py": None, "target": None, "cond": None},
    0x60f5c: {"kind": 'reg', "py": 'r[5] = 0x0000FFFF', "slot_py": None, "target": None, "cond": None},
    0x60f5e: {"kind": 'reg', "py": 'r[6] = r[7]', "slot_py": None, "target": None, "cond": None},
    0x60f60: {"kind": 'reg', "py": 'r[6] = (r[6] + s8(0x08)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x60f62: {"kind": 'mem', "py": '_wrw(ram, r[4], 2, r[5])', "slot_py": None, "target": None, "cond": None},
    0x60f64: {"kind": 'reg', "py": 'r[4] = (r[4] + s8(0x04)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x60f66: {"kind": 'reg', "py": 'T = 1 if (r[4] & 0xFFFFFFFF) >= (r[6] & 0xFFFFFFFF) else 0', "slot_py": None, "target": None, "cond": None},
    0x60f68: {"kind": "branch", "py": None, "slot_py": '', "target": 0x60f62, "cond": 'notT'},
    0x60f6c: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},
    0x60fca: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},
}
