#!/usr/bin/env python3
"""Differential test for writeImmoBitZero_ (0x11C4) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_writeImmoBitZero__11c4.py
"""
...
ENTRY = 0x11C4
RAW = bytes.fromhex("D2 2F E3 00 00 0B 22 31")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFDFA0
SPAN_END = 0x11CC
SENT = 0x11CC     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x11c4: {"kind": 'reg', "py": 'r[2] = 0xFFFFDFA0', "slot_py": None, "target": None, "cond": None},
    0x11c6: {"kind": 'reg', "py": 'r[3] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x11c8: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFDFA0, 2, r[3])', "target": None, "cond": None},}
