#!/usr/bin/env python3
"""Differential test for caller_AA20 (entry 0xAA20) — v8 ST caller (CFG), 58 bytes.
...
Run: python3 test_caller_AA20.py
"""
...
CODE = {
    0xaa20: {"kind": 'mem', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, r[14])\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xaa22: {"kind": 'st', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xaa24: {"kind": 'reg', "py": 'r[5] = 0x000000E0', "slot_py": None, "target": None, "cond": None},
    0xaa26: {"kind": 'reg', "py": 'r[15] = (r[15] + s8(0xFC)) & 0xFFFFFFFF\nsp = (sp + s8(0xFC)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xaa28: {"kind": 'reg', "py": 'r[3] = 0x00002054', "slot_py": None, "target": None, "cond": None},
    0xaa2a: {"kind": "call", "py": None, "slot_py": 'r[4] = r[15]', "target": 0x2054, "ret_pc": 0xaa2e, "set_pr": True, "cond": None},
    0xaa2e: {"kind": 'reg', "py": 'r[14] = 0xFFFFF738', "slot_py": None, "target": None, "cond": None},
    0xaa30: {"kind": 'reg', "py": 'r[3] = 0x00008000', "slot_py": None, "target": None, "cond": None},
    0xaa32: {"kind": 'mem', "py": 'r[2] = s16(_rdw(ram, 0xFFFFF738, 2))', "slot_py": None, "target": None, "cond": None},
    0xaa34: {"kind": 'reg', "py": 'r[2] = (r[2] | r[3]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xaa36: {"kind": 'reg', "py": 'r[4] = 0x00000096', "slot_py": None, "target": None, "cond": None},
    0xaa38: {"kind": 'reg', "py": 'r[1] = 0x0000239C', "slot_py": None, "target": None, "cond": None},
    0xaa3a: {"kind": "call", "py": None, "slot_py": '_wrw(ram, 0xFFFFF738, 2, r[2])', "target": 0x239c, "ret_pc": 0xaa3e, "set_pr": True, "cond": None},
    0xaa3e: {"kind": 'reg', "py": 'r[3] = 0x00007FFF', "slot_py": None, "target": None, "cond": None},
    0xaa40: {"kind": 'mem', "py": 'r[2] = s16(_rdw(ram, 0xFFFFF738, 2))', "slot_py": None, "target": None, "cond": None},
    0xaa42: {"kind": 'reg', "py": 'r[2] = (r[2] & r[3]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xaa44: {"kind": 'reg', "py": 'r[4] = 0x00000096', "slot_py": None, "target": None, "cond": None},
    0xaa46: {"kind": 'reg', "py": 'r[1] = 0x0000239C', "slot_py": None, "target": None, "cond": None},
    0xaa48: {"kind": "call", "py": None, "slot_py": '_wrw(ram, 0xFFFFF738, 2, r[2])', "target": 0x239c, "ret_pc": 0xaa4c, "set_pr": True, "cond": None},
    0xaa4c: {"kind": 'reg', "py": 'r[3] = 0x00002064', "slot_py": None, "target": None, "cond": None},
    0xaa4e: {"kind": "call", "py": None, "slot_py": 'r[4] = _rdw(ram, sp, 4)', "target": 0x2064, "ret_pc": 0xaa52, "set_pr": True, "cond": None},
    0xaa52: {"kind": 'reg', "py": 'r[15] = (r[15] + s8(0x04)) & 0xFFFFFFFF\nsp = (sp + s8(0x04)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xaa54: {"kind": 'st', "py": 'pr = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xaa56: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},
