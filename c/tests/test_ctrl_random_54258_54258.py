#!/usr/bin/env python3
"""Differential test for ctrl_random_54258 (0x54258) — v3 lift (branches + delay slots), 18 bytes.
...
Run from repo root: python3 c/tests/test_ctrl_random_54258_54258.py
"""
...
ENTRY = 0x54258
RAW = bytes.fromhex("3E 13 04 29 60 43 7F 04 4F 26 6C F6 6D F6 00 0B 6E F6")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = None
SPAN_END = 0x5426A
SENT = 0x5426A     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x54258: {"kind": 'reg', "py": 'T = 1 if s32(r[14]) >= s32(r[1]) else 0', "slot_py": None, "target": None, "cond": None},
    0x5425a: {"kind": 'reg', "py": 'r[4] = T;', "slot_py": None, "target": None, "cond": None},
    0x5425c: {"kind": 'reg', "py": 'r[0] = r[4]', "slot_py": None, "target": None, "cond": None},
    0x5425e: {"kind": 'reg', "py": 'r[15] = (r[15] + s8(0x04)) & 0xFFFFFFFF\nsp = (sp + s8(0x04)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x54260: {"kind": 'mem', "py": 'pr = _rdw(ram, STACK_BASE + 0x404, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x54262: {"kind": 'mem', "py": 'r[12] = _rdw(ram, STACK_BASE + 0x408, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x54264: {"kind": 'mem', "py": 'r[13] = _rdw(ram, STACK_BASE + 0x40C, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x54266: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, STACK_BASE + 0x410, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},}
