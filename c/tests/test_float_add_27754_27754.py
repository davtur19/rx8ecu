#!/usr/bin/env python3
"""Differential test for float_add_27754 (0x27754) — v3 lift + v4 FPU, 16 bytes.
...
Run from repo root: python3 c/tests/test_float_add_27754_27754.py
"""
...
RAM_MAX = 0xFFFFB6C8
SPAN_END = 0x27764
SENT = 0x27764     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x27754: {"kind": 'reg', "py": 'r[2] = 0x00075574', "slot_py": None, "target": None, "cond": None},
    0x27756: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x00075574, 4))', "slot_py": None, "target": None, "cond": None},
    0x27758: {"kind": 'reg', "py": 'r[1] = 0xFFFFB5FC', "slot_py": None, "target": None, "cond": None},
    0x2775a: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0xFFFFB5FC, 4))', "slot_py": None, "target": None, "cond": None},
    0x2775c: {"kind": 'reg', "py": 'r[3] = 0xFFFFB6C8', "slot_py": None, "target": None, "cond": None},
    0x2775e: {"kind": 'fpu', "py": 'fr[2] = ts(fr[2] + fr[3])', "slot_py": None, "target": None, "cond": None},
    0x27760: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFB6C8, 4, f2bits(fr[2]))', "target": None, "cond": None},}
