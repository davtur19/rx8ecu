#!/usr/bin/env python3
"""Differential test for ctrl_sigmoid_56d66 (0x56D66) — v3 lift (branches + delay slots), 24 bytes.
...
Run from repo root: python3 c/tests/test_ctrl_sigmoid_56d66_56d66.py
"""
...
ENTRY = 0x56D66
RAW = bytes.fromhex("D2 08 91 0A 63 21 63 3D 33 13 8F 02 00 09 A0 01 E4 00 E4 01 00 0B 60 43")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFD20E
SPAN_END = 0x56D7E
SENT = 0x56D8C     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x56d66: {"kind": 'reg', "py": 'r[2] = 0xFFFFD20E', "slot_py": None, "target": None, "cond": None},
    0x56d68: {"kind": 'reg', "py": 'r[1] = 0x00000271', "slot_py": None, "target": None, "cond": None},
    0x56d6a: {"kind": 'mem', "py": 'r[3] = s16(_rdw(ram, 0xFFFFD20E, 2))', "slot_py": None, "target": None, "cond": None},
    0x56d6c: {"kind": 'reg', "py": 'r[3] = r[3] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x56d6e: {"kind": 'reg', "py": 'T = 1 if s32(r[3]) >= s32(r[1]) else 0', "slot_py": None, "target": None, "cond": None},
    0x56d70: {"kind": "branch", "py": None, "slot_py": '', "target": 0x56d78, "cond": 'notT'},
    0x56d74: {"kind": "branch", "py": None, "slot_py": 'r[4] = s8(0x00)', "target": 0x56d7a, "cond": 'always'},
    0x56d78: {"kind": 'reg', "py": 'r[4] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x56d7a: {"kind": "ret", "py": None, "slot_py": 'r[0] = r[4]', "target": None, "cond": None},}
