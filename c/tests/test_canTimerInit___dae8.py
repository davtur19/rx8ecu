#!/usr/bin/env python3
"""Differential test for canTimerInit__ (0xDAE8) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_canTimerInit___dae8.py
"""
...
ENTRY = 0xDAE8
RAW = bytes.fromhex("D2 10 E3 01 00 0B 22 30")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFA411
SPAN_END = 0xDAF0
SENT = 0xDAF0     # stop-sentinel, placed past the literal pool
...
CODE = {
    0xdae8: {"kind": 'reg', "py": 'r[2] = 0xFFFFA411', "slot_py": None, "target": None, "cond": None},
    0xdaea: {"kind": 'reg', "py": 'r[3] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0xdaec: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFA411, 1, r[3])', "target": None, "cond": None},}
