#!/usr/bin/env python3
"""Differential test for resetWatchdog_ (0x1364) — v3 lift (branches + delay slots), 20 bytes.
...
Run from repo root: python3 c/tests/test_resetWatchdog__1364.py
"""
...
ENTRY = 0x1364
RAW = bytes.fromhex("93 65 92 65 22 31 73 E1 94 63 24 31 61 40 D0 34 00 0B 24 01")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFEC12
SPAN_END = 0x1378
SENT = 0x1378     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x1364: {"kind": 'reg', "py": 'r[3] = 0x00005A1F', "slot_py": None, "target": None, "cond": None},
    0x1366: {"kind": 'reg', "py": 'r[2] = 0xFFFFEC12', "slot_py": None, "target": None, "cond": None},
    0x1368: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFEC12, 2, r[3])', "slot_py": None, "target": None, "cond": None},
    0x136a: {"kind": 'reg', "py": 'r[3] = (r[3] + s8(0xE1)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x136c: {"kind": 'reg', "py": 'r[4] = 0xFFFFEC10', "slot_py": None, "target": None, "cond": None},
    0x136e: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFEC10, 2, r[3])', "slot_py": None, "target": None, "cond": None},
    0x1370: {"kind": 'mem', "py": 'r[1] = s8(_rdw(ram, 0xFFFFEC10, 1))', "slot_py": None, "target": None, "cond": None},
    0x1372: {"kind": 'reg', "py": 'r[0] = 0x0000A53C', "slot_py": None, "target": None, "cond": None},
    0x1374: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFEC10, 2, r[0])', "target": None, "cond": None},}
