#!/usr/bin/env python3
"""Differential test for math_finalize_3e994 (0x3E994) — v3 lift (branches + delay slots), 18 bytes.
...
Run from repo root: python3 c/tests/test_math_finalize_3e994_3e994.py
"""
...
CODE = {
    0x3e994: {"kind": 'reg', "py": 'r[2] = 0x0007A9B1', "slot_py": None, "target": None, "cond": None},
    0x3e996: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0x0007A9B1, 1))', "slot_py": None, "target": None, "cond": None},
    0x3e998: {"kind": 'reg', "py": 'r[1] = 0xFFFFC69E', "slot_py": None, "target": None, "cond": None},
    0x3e99a: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC69E, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x3e99c: {"kind": 'reg', "py": 'r[3] = 0x0007A9B2', "slot_py": None, "target": None, "cond": None},
    0x3e99e: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0x0007A9B2, 1))', "slot_py": None, "target": None, "cond": None},
    0x3e9a0: {"kind": 'reg', "py": 'r[2] = 0xFFFFC69F', "slot_py": None, "target": None, "cond": None},
    0x3e9a2: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFC69F, 1, r[0])', "target": None, "cond": None},}
