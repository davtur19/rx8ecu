#!/usr/bin/env python3
"""Differential test for getBatteryVoltage (0x4D44C) — v3 lift + v4 FPU, 14 bytes.
...
Run from repo root: python3 c/tests/test_getBatteryVoltage_4d44c.py
"""
...
ENTRY = 0x4D44C
RAW = bytes.fromhex("92 03 F3 28 91 02 00 0B F1 3A CD F8 CD FC")
SEED = 43
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCDFC
SPAN_END = 0x4D45A
SENT = 0x4D45A     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x4d44c: {"kind": 'reg', "py": 'r[2] = 0xFFFFCDF8', "slot_py": None, "target": None, "cond": None},
    0x4d44e: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFCDF8, 4))', "slot_py": None, "target": None, "cond": None},
    0x4d450: {"kind": 'reg', "py": 'r[1] = 0xFFFFCDFC', "slot_py": None, "target": None, "cond": None},
    0x4d452: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFCDFC, 4, f2bits(fr[3]))', "target": None, "cond": None},}
