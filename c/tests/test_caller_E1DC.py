#!/usr/bin/env python3
"""Differential test for caller_E1DC (entry 0xE1DC) — v8 ST caller (CFG), 34 bytes.
...
Run: python3 test_caller_E1DC.py
"""
...
CODE = {
    0xe1dc: {"kind": 'st', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xe1de: {"kind": 'reg', "py": 'r[3] = 0xFFFFA428', "slot_py": None, "target": None, "cond": None},
    0xe1e0: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFA428, 1))', "slot_py": None, "target": None, "cond": None},
    0xe1e2: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0xe1e4: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0xe1e6: {"kind": "branch", "py": None, "slot_py": '', "target": 0xe1f8, "cond": 'notT'},
    0xe1ea: {"kind": 'reg', "py": 'r[5] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0xe1ec: {"kind": 'reg', "py": 'r[1] = 0xFFFFA420', "slot_py": None, "target": None, "cond": None},
    0xe1ee: {"kind": 'reg', "py": 'r[2] = 0x00002460', "slot_py": None, "target": None, "cond": None},
    0xe1f0: {"kind": "call", "py": None, "slot_py": 'r[4] = s16(_rdw(ram, 0xFFFFA420, 2))', "target": 0x2460, "ret_pc": 0xe1f4, "set_pr": True, "cond": None},
    0xe1f4: {"kind": 'reg', "py": 'r[3] = 0xFFFFA420', "slot_py": None, "target": None, "cond": None},
    0xe1f6: {"kind": 'mem', "py": '_wrw(ram, r[3], 2, r[0])', "slot_py": None, "target": None, "cond": None},
    0xe1f8: {"kind": 'st', "py": 'pr = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xe1fa: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},
