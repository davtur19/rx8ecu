#!/usr/bin/env python3
"""Differential test for FUN_0005698e (0x5698E) — pure straight-line lift, 8 bytes.
...
Run from repo root: python3 c/tests/test_FUN_0005698e_5698e.py
"""
...
ENTRY = 0x5698E
RAW = bytes.fromhex("63 03 40 00 43 08 30 3C")
SEED = 42
N = 2000
