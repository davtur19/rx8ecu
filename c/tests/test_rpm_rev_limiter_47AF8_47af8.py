#!/usr/bin/env python3
"""Differential test for rpm_rev_limiter_47AF8 (0x47AF8) — v3 lift (branches + delay slots), 24 bytes.
...
Run from repo root: python3 c/tests/test_rpm_rev_limiter_47AF8_47af8.py
"""
