#!/usr/bin/env python3
"""Differential test for throttleLiftCountersandConditions (0x4244C) — v3 lift + v4 FPU, 96 bytes.
...
Run from repo root: python3 c/tests/test_throttleLiftCountersandConditions_4244c.py
"""
...
ENTRY = 0x4244C
RAW = bytes.fromhex("91 5A F4 18 96 59 95 59 92 59 63 20 23 38 8F 03 E4 00 26 40 A0 22 25 40 67 60 D0 2B 62 00 63 7C 61 2C 33 13 8D 18 00 09 D3 28 77 01 26 70 F3 38 F4 35 8F 0F 00 09 D2 26 F2 28 F2 45 8F 0A 00 09 D1 24 F1 18 93 3C F0 38 F0 15 8F 03 00 09 E0 01 A0 04 25 00 A0 02 25 40 26 20 25 40 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFC946
SPAN_END = 0x424AC
SENT = 0x424AC     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x4244c: {"kind": 'reg', "py": 'r[1] = 0xFFFFB594', "slot_py": None, "target": None, "cond": None},
    0x4244e: {"kind": 'fpu', "py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFB594, 4))', "slot_py": None, "target": None, "cond": None},
    0x42450: {"kind": 'reg', "py": 'r[6] = 0xFFFFC93F', "slot_py": None, "target": None, "cond": None},
    0x42452: {"kind": 'reg', "py": 'r[5] = 0xFFFFC944', "slot_py": None, "target": None, "cond": None},
    0x42454: {"kind": 'reg', "py": 'r[2] = 0xFFFFC946', "slot_py": None, "target": None, "cond": None},
    0x42456: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFC946, 1))', "slot_py": None, "target": None, "cond": None},
    0x42458: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x4245a: {"kind": "branch", "py": None, "slot_py": 'r[4] = s8(0x00)', "target": 0x42464, "cond": 'notT'},
    0x4245e: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC93F, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x42460: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFC944, 1, r[4])', "target": 0x424a8, "cond": 'always'},
    0x42464: {"kind": 'mem', "py": 'r[7] = s8(_rdw(ram, 0xFFFFC93F, 1))', "slot_py": None, "target": None, "cond": None},
    0x42466: {"kind": 'reg', "py": 'r[0] = 0x0007A17D', "slot_py": None, "target": None, "cond": None},
    0x42468: {"kind": 'mem', "py": 'r[2] = s8(_rdw(ram, 0x0007A17D, 1))', "slot_py": None, "target": None, "cond": None},
    0x4246a: {"kind": 'reg', "py": 'r[3] = r[7] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x4246c: {"kind": 'reg', "py": 'r[1] = r[2] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x4246e: {"kind": 'reg', "py": 'T = 1 if s32(r[3]) >= s32(r[1]) else 0', "slot_py": None, "target": None, "cond": None},
    0x42470: {"kind": "branch", "py": None, "slot_py": '', "target": 0x424a4, "cond": 'T'},
    0x42474: {"kind": 'reg', "py": 'r[3] = 0x0007A194', "slot_py": None, "target": None, "cond": None},
    0x42476: {"kind": 'reg', "py": 'r[7] = (r[7] + s8(0x01)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x42478: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC93F, 1, r[7])', "slot_py": None, "target": None, "cond": None},
    0x4247a: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x0007A194, 4))', "slot_py": None, "target": None, "cond": None},
    0x4247c: {"kind": 'fpu', "py": 'T = 1 if fr[4] > fr[3] else 0', "slot_py": None, "target": None, "cond": None},
    0x4247e: {"kind": "branch", "py": None, "slot_py": '', "target": 0x424a0, "cond": 'notT'},
    0x42482: {"kind": 'reg', "py": 'r[2] = 0x0007A198', "slot_py": None, "target": None, "cond": None},
    0x42484: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0x0007A198, 4))', "slot_py": None, "target": None, "cond": None},
    0x42486: {"kind": 'fpu', "py": 'T = 1 if fr[2] > fr[4] else 0', "slot_py": None, "target": None, "cond": None},
    0x42488: {"kind": "branch", "py": None, "slot_py": '', "target": 0x424a0, "cond": 'notT'},
    0x4248c: {"kind": 'reg', "py": 'r[1] = 0x0007A19C', "slot_py": None, "target": None, "cond": None},
    0x4248e: {"kind": 'fpu', "py": 'fr[1] = bits2f(_rdw(ram, 0x0007A19C, 4))', "slot_py": None, "target": None, "cond": None},
    0x42490: {"kind": 'reg', "py": 'r[3] = 0xFFFFA9FC', "slot_py": None, "target": None, "cond": None},
    0x42492: {"kind": 'fpu', "py": 'fr[0] = bits2f(_rdw(ram, 0xFFFFA9FC, 4))', "slot_py": None, "target": None, "cond": None},
    0x42494: {"kind": 'fpu', "py": 'T = 1 if fr[0] > fr[1] else 0', "slot_py": None, "target": None, "cond": None},
    0x42496: {"kind": "branch", "py": None, "slot_py": '', "target": 0x424a0, "cond": 'notT'},
    0x4249a: {"kind": 'reg', "py": 'r[0] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x4249c: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFC944, 1, r[0])', "target": 0x424a8, "cond": 'always'},
    0x424a0: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFC944, 1, r[4])', "target": 0x424a8, "cond": 'always'},
    0x424a4: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC93F, 1, r[2])', "slot_py": None, "target": None, "cond": None},
    0x424a6: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC944, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x424a8: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
