#!/usr/bin/env python3
"""Differential test for crank_irq_callback (0x7F66) — v3 lift (branches + delay slots), 42 bytes.
...
Run from repo root: python3 c/tests/test_crank_irq_callback_7f66.py
"""
...
ENTRY = 0x7F66
RAW = bytes.fromhex("E4 00 D3 0F 23 41 D1 0F 62 11 62 2D 42 15 8F 0A 00 09 D0 08 20 40 D3 0C 60 30 60 0C 88 02 8F 02 00 09 D0 05 20 40 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFF9FCC
SPAN_END = 0x7F90
SENT = 0x7F90     # stop-sentinel, placed past the literal pool
