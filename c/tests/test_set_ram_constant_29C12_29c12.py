#!/usr/bin/env python3
"""Differential test for set_ram_constant_29C12 (0x29C12) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_set_ram_constant_29C12_29c12.py
"""
...
CODE = {
    0x29c12: {"kind": 'reg', "py": 'r[3] = s8(0x3E)', "slot_py": None, "target": None, "cond": None},
    0x29c14: {"kind": 'reg', "py": 'r[2] = 0xFFFFBB3A', "slot_py": None, "target": None, "cond": None},
    0x29c16: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBB3A, 2, r[3])', "target": None, "cond": None},}
