#!/usr/bin/env python3
"""Differential test for sensor_extract_6096c (0x6096C) — pure straight-line lift, 8 bytes.
...
Run from repo root: python3 c/tests/test_sensor_extract_6096c_6096c.py
"""
...
ENTRY = 0x6096C
RAW = bytes.fromhex("97 71 E4 00 D5 39 66 43")
SEED = 42
N = 2000
