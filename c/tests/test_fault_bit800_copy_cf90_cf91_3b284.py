#!/usr/bin/env python3
"""Differential test for fault_bit800_copy_cf90_cf91 (0x3B284) — v3 lift (branches + delay slots), 32 bytes.
...
Run from repo root: python3 c/tests/test_fault_bit800_copy_cf90_cf91_3b284.py
"""
...
ENTRY = 0x3B284
RAW = bytes.fromhex("D4 49 93 84 60 31 60 0D 92 82 20 29 D2 47 20 08 00 29 CA 01 88 01 03 29 24 30 61 40 00 0B 22 10")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFF726
SPAN_END = 0x3B2A4
SENT = 0x3B2A4     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x3b284: {"kind": 'reg', "py": 'r[4] = 0xFFFFCF90', "slot_py": None, "target": None, "cond": None},
    0x3b286: {"kind": 'reg', "py": 'r[3] = 0xFFFFF726', "slot_py": None, "target": None, "cond": None},
    0x3b288: {"kind": 'mem', "py": 'r[0] = s16(_rdw(ram, 0xFFFFF726, 2))', "slot_py": None, "target": None, "cond": None},
    0x3b28a: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x3b28c: {"kind": 'reg', "py": 'r[2] = 0x00000800', "slot_py": None, "target": None, "cond": None},
    0x3b28e: {"kind": 'reg', "py": 'r[0] = (r[0] & r[2]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x3b290: {"kind": 'reg', "py": 'r[2] = 0xFFFFCF91', "slot_py": None, "target": None, "cond": None},
    0x3b292: {"kind": 'reg', "py": 'T = 1 if (r[0] & r[0]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x3b294: {"kind": 'reg', "py": 'r[0] = T;', "slot_py": None, "target": None, "cond": None},
    0x3b296: {"kind": 'reg', "py": 'r[0] = (r[0] ^ 0x01) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x3b298: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x3b29a: {"kind": 'reg', "py": 'r[3] = T;', "slot_py": None, "target": None, "cond": None},
    0x3b29c: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCF90, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x3b29e: {"kind": 'mem', "py": 'r[1] = s8(_rdw(ram, 0xFFFFCF90, 1))', "slot_py": None, "target": None, "cond": None},
    0x3b2a0: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFCF91, 1, r[1])', "target": None, "cond": None},}
