#!/usr/bin/env python3
"""Differential test for knockRelatedInit (0xC1F8) — v3 lift + v4 FPU, 126 bytes.
...
Run from repo root: python3 c/tests/test_knockRelatedInit_c1f8.py
"""
...
ENTRY = 0xC1F8
RAW = bytes.fromhex("2F D6 2F C6 2F B6 2F A6 D2 31 63 21 D1 31 21 31 D3 31 60 31 D2 31 22 01 D1 31 F3 18 D3 31 F3 3A C7 31 F5 08 D2 31 F2 5A D7 31 F3 78 D3 31 F3 3A 91 4C D0 31 D2 31 20 10 D3 31 E0 00 22 00 F4 8D D2 31 66 03 DD 32 23 00 D1 2E 21 00 F2 4A E1 02 D3 2E E0 00 D5 2F F3 4A DA 2F DB 30 DC 30 76 01 FC 57 36 13 F3 78 FB 37 63 D4 25 30 FA 47 75 01 8F F5 70 04 6A F6 6B F6 6C F6 00 0B 6D F6")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFA389
SPAN_END = 0xC276
SENT = 0xC276     # stop-sentinel, placed past the literal pool
...
CODE = {
    0xc1f8: {"kind": 'mem', "py": 'local[0x3FC] = r[13]\n_wrw(ram, STACK_BASE + 0x3FC, 4, r[13])\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xc1fa: {"kind": 'mem', "py": 'local[0x3F8] = r[12]\n_wrw(ram, STACK_BASE + 0x3F8, 4, r[12])\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xc1fc: {"kind": 'mem', "py": 'local[0x3F4] = r[11]\n_wrw(ram, STACK_BASE + 0x3F4, 4, r[11])\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xc1fe: {"kind": 'mem', "py": 'local[0x3F0] = r[10]\n_wrw(ram, STACK_BASE + 0x3F0, 4, r[10])\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xc200: {"kind": 'reg', "py": 'r[2] = 0x00078E84', "slot_py": None, "target": None, "cond": None},
    0xc202: {"kind": 'mem', "py": 'r[3] = s16(_rdw(ram, 0x00078E84, 2))', "slot_py": None, "target": None, "cond": None},
    0xc204: {"kind": 'reg', "py": 'r[1] = 0xFFFFA37E', "slot_py": None, "target": None, "cond": None},
    0xc206: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA37E, 2, r[3])', "slot_py": None, "target": None, "cond": None},
    0xc208: {"kind": 'reg', "py": 'r[3] = 0x00078E86', "slot_py": None, "target": None, "cond": None},
    0xc20a: {"kind": 'mem', "py": 'r[0] = s16(_rdw(ram, 0x00078E86, 2))', "slot_py": None, "target": None, "cond": None},
    0xc20c: {"kind": 'reg', "py": 'r[2] = 0xFFFFA37C', "slot_py": None, "target": None, "cond": None},
    0xc20e: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA37C, 2, r[0])', "slot_py": None, "target": None, "cond": None},
    0xc210: {"kind": 'reg', "py": 'r[1] = 0x00078EB0', "slot_py": None, "target": None, "cond": None},
    0xc212: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x00078EB0, 4))', "slot_py": None, "target": None, "cond": None},
    0xc214: {"kind": 'reg', "py": 'r[3] = 0xFFFFA328', "slot_py": None, "target": None, "cond": None},
    0xc216: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFA328, 4, f2bits(fr[3]))', "slot_py": None, "target": None, "cond": None},
    0xc218: {"kind": 'reg', "py": 'r[0] = 0x0000C2E0', "slot_py": None, "target": None, "cond": None},
    0xc21a: {"kind": 'fpu', "py": 'fr[5] = bits2f(_rdw(ram, 0x0000C2E0, 4))', "slot_py": None, "target": None, "cond": None},
    0xc21c: {"kind": 'reg', "py": 'r[2] = 0xFFFFA360', "slot_py": None, "target": None, "cond": None},
    0xc21e: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFA360, 4, f2bits(fr[5]))', "slot_py": None, "target": None, "cond": None},
    0xc220: {"kind": 'reg', "py": 'r[7] = 0x00078EDC', "slot_py": None, "target": None, "cond": None},
    0xc222: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, r[7], 4))', "slot_py": None, "target": None, "cond": None},
    0xc224: {"kind": 'reg', "py": 'r[3] = 0xFFFFA364', "slot_py": None, "target": None, "cond": None},
    0xc226: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFA364, 4, f2bits(fr[3]))', "slot_py": None, "target": None, "cond": None},
    0xc228: {"kind": 'reg', "py": 'r[1] = 0x000000FF', "slot_py": None, "target": None, "cond": None},
    0xc22a: {"kind": 'reg', "py": 'r[0] = 0xFFFFA384', "slot_py": None, "target": None, "cond": None},
    0xc22c: {"kind": 'reg', "py": 'r[2] = 0xFFFFA385', "slot_py": None, "target": None, "cond": None},
    0xc22e: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA384, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0xc230: {"kind": 'reg', "py": 'r[3] = 0xFFFFA386', "slot_py": None, "target": None, "cond": None},
    0xc232: {"kind": 'reg', "py": 'r[0] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0xc234: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA385, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0xc236: {"kind": 'fpu', "py": 'fr[4] = 0.0', "slot_py": None, "target": None, "cond": None},
    0xc238: {"kind": 'reg', "py": 'r[2] = 0xFFFFA32C', "slot_py": None, "target": None, "cond": None},
    0xc23a: {"kind": 'reg', "py": 'r[6] = r[0]', "slot_py": None, "target": None, "cond": None},
    0xc23c: {"kind": 'reg', "py": 'r[13] = 0x00078E70', "slot_py": None, "target": None, "cond": None},
    0xc23e: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA386, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0xc240: {"kind": 'reg', "py": 'r[1] = 0xFFFFA324', "slot_py": None, "target": None, "cond": None},
    0xc242: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA324, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0xc244: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFA32C, 4, f2bits(fr[4]))', "slot_py": None, "target": None, "cond": None},
    0xc246: {"kind": 'reg', "py": 'r[1] = s8(0x02)', "slot_py": None, "target": None, "cond": None},
    0xc248: {"kind": 'reg', "py": 'r[3] = 0xFFFFA348', "slot_py": None, "target": None, "cond": None},
    0xc24a: {"kind": 'reg', "py": 'r[0] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0xc24c: {"kind": 'reg', "py": 'r[5] = 0xFFFFA389', "slot_py": None, "target": None, "cond": None},
    0xc24e: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFA348, 4, f2bits(fr[4]))', "slot_py": None, "target": None, "cond": None},
    0xc250: {"kind": 'reg', "py": 'r[10] = 0xFFFFA334', "slot_py": None, "target": None, "cond": None},
    0xc252: {"kind": 'reg', "py": 'r[11] = 0xFFFFA368', "slot_py": None, "target": None, "cond": None},
    0xc254: {"kind": 'reg', "py": 'r[12] = 0xFFFFA350', "slot_py": None, "target": None, "cond": None},
    0xc256: {"kind": 'reg', "py": 'r[6] = (r[6] + s8(0x01)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xc258: {"kind": 'fpu', "py": '_wrw(ram, r[0] + r[12], 4, f2bits(fr[5]))', "slot_py": None, "target": None, "cond": None},
    0xc25a: {"kind": 'reg', "py": 'T = 1 if s32(r[6]) >= s32(r[1]) else 0', "slot_py": None, "target": None, "cond": None},
    0xc25c: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, r[7], 4))', "slot_py": None, "target": None, "cond": None},
    0xc25e: {"kind": 'fpu', "py": '_wrw(ram, r[0] + r[11], 4, f2bits(fr[3]))', "slot_py": None, "target": None, "cond": None},
    0xc260: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0x00078E70, 1))\nr[13] = (r[13] + 1) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xc262: {"kind": 'mem', "py": '_wrw(ram, r[5], 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0xc264: {"kind": 'fpu', "py": '_wrw(ram, r[0] + r[10], 4, f2bits(fr[4]))', "slot_py": None, "target": None, "cond": None},
    0xc266: {"kind": 'reg', "py": 'r[5] = (r[5] + s8(0x01)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xc268: {"kind": "branch", "py": None, "slot_py": 'r[0] = (r[0] + s8(0x04)) & 0xFFFFFFFF', "target": 0xc256, "cond": 'notT'},
    0xc26c: {"kind": 'mem', "py": 'r[10] = _rdw(ram, STACK_BASE + 0x3F0, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xc26e: {"kind": 'mem', "py": 'r[11] = _rdw(ram, STACK_BASE + 0x3F4, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xc270: {"kind": 'mem', "py": 'r[12] = _rdw(ram, STACK_BASE + 0x3F8, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xc272: {"kind": "ret", "py": None, "slot_py": 'r[13] = _rdw(ram, STACK_BASE + 0x3FC, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},}
