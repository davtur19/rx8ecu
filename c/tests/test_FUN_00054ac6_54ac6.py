#!/usr/bin/env python3
"""Differential test for FUN_00054ac6 (0x54AC6) — v3 lift + v4 FPU, 30 bytes.
...
Run from repo root: python3 c/tests/test_FUN_00054ac6_54ac6.py
"""
...
ENTRY = 0x54AC6
RAW = bytes.fromhex("8D 03 00 09 E0 01 A0 08 24 00 D1 09 F3 18 F5 31 F5 45 8F 02 00 09 E0 00 24 00 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    ...
    0x54acc: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, r[4], 1, r[0])', "target": 0x54ae0, "cond": 'always'},
    ...
    0x54ade: {"kind": 'mem', "py": '_wrw(ram, r[4], 1, r[0])', "slot_py": None, "target": None, "cond": None},
