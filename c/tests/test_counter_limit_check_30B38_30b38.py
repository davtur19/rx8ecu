#!/usr/bin/env python3
"""Differential test for counter_limit_check_30B38 (0x30B38) — v3 lift (branches + delay slots), 34 bytes.
...
Run from repo root: python3 c/tests/test_counter_limit_check_30B38_30b38.py
"""
...
ENTRY = 0x30B38
RAW = bytes.fromhex("D3 0A E4 00 D5 0D 23 41 D1 0B 62 11 D3 0E 60 31 32 06 8F 03 00 09 E0 01 A0 01 25 00 25 40 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBE4C
SPAN_END = 0x30B5A
SENT = 0x30B5A     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x30b38: {"kind": 'reg', "py": 'r[3] = 0xFFFFBE48', "slot_py": None, "target": None, "cond": None},
    0x30b3a: {"kind": 'reg', "py": 'r[4] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x30b3c: {"kind": 'reg', "py": 'r[5] = 0xFFFFBE4C', "slot_py": None, "target": None, "cond": None},
    0x30b3e: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBE48, 2, r[4])', "slot_py": None, "target": None, "cond": None},
    0x30b40: {"kind": 'reg', "py": 'r[1] = 0xFFFFBE4A', "slot_py": None, "target": None, "cond": None},
    0x30b42: {"kind": 'mem', "py": 'r[2] = s16(_rdw(ram, 0xFFFFBE4A, 2))', "slot_py": None, "target": None, "cond": None},
    0x30b44: {"kind": 'reg', "py": 'r[3] = 0x0007BA22', "slot_py": None, "target": None, "cond": None},
    0x30b46: {"kind": 'mem', "py": 'r[0] = s16(_rdw(ram, 0x0007BA22, 2))', "slot_py": None, "target": None, "cond": None},
    0x30b48: {"kind": 'reg', "py": 'T = 1 if (r[2] & 0xFFFFFFFF) > (r[0] & 0xFFFFFFFF) else 0', "slot_py": None, "target": None, "cond": None},
    0x30b4a: {"kind": "branch", "py": None, "slot_py": '', "target": 0x30b54, "cond": 'notT'},
    0x30b4e: {"kind": 'reg', "py": 'r[0] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x30b50: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFBE4C, 1, r[0])', "target": 0x30b56, "cond": 'always'},
    0x30b54: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBE4C, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x30b56: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
