#!/usr/bin/env python3
"""Differential test for tune_table_lookup_4B8A4 (0x4B8A4) — v3 lift (branches + delay slots), 64 bytes.
...
Run from repo root: python3 c/tests/test_tune_table_lookup_4B8A4_4b8a4.py
"""
...
CODE = {
    0x4b8a4: {"kind": 'reg', "py": 'r[3] = 0xFFFFCE19', "slot_py": None, "target": None, "cond": None},
    0x4b8a6: {"kind": 'mem', "py": 'r[5] = s8(_rdw(ram, 0xFFFFCE19, 1))', "slot_py": None, "target": None, "cond": None},
    0x4b8a8: {"kind": 'reg', "py": 'r[7] = 0xFFFFCE1D', "slot_py": None, "target": None, "cond": None},
    0x4b8aa: {"kind": 'reg', "py": 'r[6] = r[5] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x4b8ac: {"kind": 'reg', "py": 'r[4] = 0xFFFFCE1C', "slot_py": None, "target": None, "cond": None},
    0x4b8ae: {"kind": 'mem', "py": 'r[2] = s8(_rdw(ram, 0xFFFFCE1D, 1))', "slot_py": None, "target": None, "cond": None},
    0x4b8b0: {"kind": 'reg', "py": 'r[2] = r[2] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x4b8b2: {"kind": 'reg', "py": 'T = 1 if r[6] == r[2] else 0', "slot_py": None, "target": None, "cond": None},
    0x4b8b4: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4b8d0, "cond": 'T'},
    0x4b8b8: {"kind": 'reg', "py": 'r[0] = r[6]', "slot_py": None, "target": None, "cond": None},
    0x4b8ba: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x4b8bc: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4b8c8, "cond": 'notT'},
    0x4b8c0: {"kind": 'reg', "py": 'r[2] = 0x0007C6B5', "slot_py": None, "target": None, "cond": None},
    0x4b8c2: {"kind": 'mem', "py": 'r[1] = s8(_rdw(ram, 0x0007C6B5, 1))', "slot_py": None, "target": None, "cond": None},
    0x4b8c4: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFCE1C, 1, r[1])', "target": 0x4b8e0, "cond": 'always'},
    0x4b8c8: {"kind": 'reg', "py": 'r[0] = 0x0007C6B6', "slot_py": None, "target": None, "cond": None},
    0x4b8ca: {"kind": 'mem', "py": 'r[2] = s8(_rdw(ram, 0x0007C6B6, 1))', "slot_py": None, "target": None, "cond": None},
    0x4b8cc: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFCE1C, 1, r[2])', "target": 0x4b8e0, "cond": 'always'},
    0x4b8d0: {"kind": 'mem', "py": 'r[6] = s8(_rdw(ram, 0xFFFFCE1C, 1))', "slot_py": None, "target": None, "cond": None},
    0x4b8d2: {"kind": 'reg', "py": 'r[2] = r[6] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x4b8d4: {"kind": 'reg', "py": 'T = 1 if s32(r[2]) > 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x4b8d6: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4b8e0, "cond": 'notT'},
    0x4b8da: {"kind": 'reg', "py": 'r[2] = 0x000000FF', "slot_py": None, "target": None, "cond": None},
    0x4b8dc: {"kind": 'reg', "py": 'r[6] = (r[6] + r[2]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x4b8de: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCE1C, 1, r[6])', "slot_py": None, "target": None, "cond": None},
    0x4b8e0: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFCE1D, 1, r[5])', "target": None, "cond": None},}
