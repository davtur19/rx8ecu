#!/usr/bin/env python3
"""Differential test for call_float_clamp_0x4F03E (0x4F03E) — v3 lift + v4 FPU, 70 bytes.
...
Run from repo root: python3 c/tests/test_call_float_clamp_0x4F03E_4f03e.py
"""
...
ENTRY = 0x4F03E
RAW = bytes.fromhex("E5 01 D2 28 93 32 96 32 F4 38 F5 28 F5 45 8D 02 E4 00 A0 07 26 50 D1 24 F3 18 F5 31 F5 45 8F 01 00 09 26 40 96 24 D2 21 F5 28 F5 45 8D 02 00 09 A0 07 26 50 D3 1F F3 38 F5 31 F5 45 8F 01 00 09 26 40 00 0B 00 09")
SEED = 43
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCEF8
SPAN_END = 0x4F084
SENT = 0x4F084     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x4f03e: {"kind": 'reg', "py": 'r[5] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x4f040: {"kind": 'reg', "py": 'r[2] = 0x0007BEA4', "slot_py": None, "target": None, "cond": None},
    0x4f042: {"kind": 'reg', "py": 'r[3] = 0xFFFFB594', "slot_py": None, "target": None, "cond": None},
    0x4f044: {"kind": 'reg', "py": 'r[6] = 0xFFFFCEF7', "slot_py": None, "target": None, "cond": None},
    0x4f046: {"kind": 'fpu', "py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFB594, 4))', "slot_py": None, "target": None, "cond": None},
    0x4f048: {"kind": 'fpu', "py": 'fr[5] = bits2f(_rdw(ram, 0x0007BEA4, 4))', "slot_py": None, "target": None, "cond": None},
    0x4f04a: {"kind": 'fpu', "py": 'T = 1 if fr[5] > fr[4] else 0', "slot_py": None, "target": None, "cond": None},
    0x4f04c: {"kind": "branch", "py": None, "slot_py": 'r[4] = s8(0x00)', "target": 0x4f054, "cond": 'T'},
    0x4f050: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFCEF7, 1, r[5])', "target": 0x4f062, "cond": 'always'},
    0x4f054: {"kind": 'reg', "py": 'r[1] = 0x0007BEB4', "slot_py": None, "target": None, "cond": None},
    0x4f056: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x0007BEB4, 4))', "slot_py": None, "target": None, "cond": None},
    0x4f058: {"kind": 'fpu', "py": 'fr[5] = ts(fr[5] - fr[3])', "slot_py": None, "target": None, "cond": None},
    0x4f05a: {"kind": 'fpu', "py": 'T = 1 if fr[5] > fr[4] else 0', "slot_py": None, "target": None, "cond": None},
    0x4f05c: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4f062, "cond": 'notT'},
    0x4f060: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCEF7, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x4f062: {"kind": 'reg', "py": 'r[6] = 0xFFFFCEF8', "slot_py": None, "target": None, "cond": None},
    0x4f064: {"kind": 'reg', "py": 'r[2] = 0x0007BEA8', "slot_py": None, "target": None, "cond": None},
    0x4f066: {"kind": 'fpu', "py": 'fr[5] = bits2f(_rdw(ram, 0x0007BEA8, 4))', "slot_py": None, "target": None, "cond": None},
    0x4f068: {"kind": 'fpu', "py": 'T = 1 if fr[5] > fr[4] else 0', "slot_py": None, "target": None, "cond": None},
    0x4f06a: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4f072, "cond": 'T'},
    0x4f06e: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFCEF8, 1, r[5])', "target": 0x4f080, "cond": 'always'},
    0x4f072: {"kind": 'reg', "py": 'r[3] = 0x0007BEB8', "slot_py": None, "target": None, "cond": None},
    0x4f074: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x0007BEB8, 4))', "slot_py": None, "target": None, "cond": None},
    0x4f076: {"kind": 'fpu', "py": 'fr[5] = ts(fr[5] - fr[3])', "slot_py": None, "target": None, "cond": None},
    0x4f078: {"kind": 'fpu', "py": 'T = 1 if fr[5] > fr[4] else 0', "slot_py": None, "target": None, "cond": None},
    0x4f07a: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4f080, "cond": 'notT'},
    0x4f07e: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCEF8, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x4f080: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
