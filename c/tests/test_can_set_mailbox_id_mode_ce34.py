#!/usr/bin/env python3
"""Differential test for can_set_mailbox_id_mode (0xCE34) — v3 lift (branches + delay slots), 66 bytes.
...
Run from repo root: python3 c/tests/test_can_set_mailbox_id_mode_ce34.py
"""
...
ENTRY = 0xCE34
RAW = bytes.fromhex("64 47 93 3A 64 31 64 47 91 39 62 11 24 29 65 4D D2 1F 63 5C 43 18 22 59 42 19 64 33 24 2B 00 0B 60 43 64 4C 24 48 8F 03 66 5D 94 27 A0 01 00 09 94 25 63 6C D2 16 43 18 22 69 42 19 23 2B 00 0B 24 31")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
CODE = {
    0xce34: {"kind": 'reg', "py": 'r[4] = (~r[4]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    ...
    0xce3e: {"kind": 'mem', "py": 'r[2] = s16(_rdw(ram, 0xFFFFE60E, 2))', "slot_py": None, "target": None, "cond": None},
