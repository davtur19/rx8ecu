#!/usr/bin/env python3
"""Differential test for VDIControl (0x35AC4) — v3 lift (branches + delay slots), 42 bytes.
...
Run from repo root: python3 c/tests/test_VDIControl_35ac4.py
"""
...
ENTRY = 0x35AC4
RAW = bytes.fromhex("D3 1D D1 17 D0 1D 62 12 22 3B 20 22 D3 1C D2 16 D0 1C 61 22 21 3B 20 12 D3 1B D1 14 D0 1B 62 12 22 3B 20 22 4F 26 00 0B 6E F6")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFC218
SPAN_END = 0x35AEE
SENT = 0x35AEE     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x35ac4: {"kind": 'reg', "py": 'r[3] = 0x02000000', "slot_py": None, "target": None, "cond": None},
    0x35ac6: {"kind": 'reg', "py": 'r[1] = 0xFFFFC1FC', "slot_py": None, "target": None, "cond": None},
    0x35ac8: {"kind": 'reg', "py": 'r[0] = 0xFFFFC210', "slot_py": None, "target": None, "cond": None},
    0x35aca: {"kind": 'mem', "py": 'r[2] = _rdw(ram, 0xFFFFC1FC, 4)', "slot_py": None, "target": None, "cond": None},
    0x35acc: {"kind": 'reg', "py": 'r[2] = (r[2] | r[3]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x35ace: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC210, 4, r[2])', "slot_py": None, "target": None, "cond": None},
    0x35ad0: {"kind": 'reg', "py": 'r[3] = 0x03000000', "slot_py": None, "target": None, "cond": None},
    0x35ad2: {"kind": 'reg', "py": 'r[2] = 0xFFFFC200', "slot_py": None, "target": None, "cond": None},
    0x35ad4: {"kind": 'reg', "py": 'r[0] = 0xFFFFC214', "slot_py": None, "target": None, "cond": None},
    0x35ad6: {"kind": 'mem', "py": 'r[1] = _rdw(ram, 0xFFFFC200, 4)', "slot_py": None, "target": None, "cond": None},
    0x35ad8: {"kind": 'reg', "py": 'r[1] = (r[1] | r[3]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x35ada: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC214, 4, r[1])', "slot_py": None, "target": None, "cond": None},
    0x35adc: {"kind": 'reg', "py": 'r[3] = 0x04000000', "slot_py": None, "target": None, "cond": None},
    0x35ade: {"kind": 'reg', "py": 'r[1] = 0xFFFFC204', "slot_py": None, "target": None, "cond": None},
    0x35ae0: {"kind": 'reg', "py": 'r[0] = 0xFFFFC218', "slot_py": None, "target": None, "cond": None},
    0x35ae2: {"kind": 'mem', "py": 'r[2] = _rdw(ram, 0xFFFFC204, 4)', "slot_py": None, "target": None, "cond": None},
    0x35ae4: {"kind": 'reg', "py": 'r[2] = (r[2] | r[3]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x35ae6: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC218, 4, r[2])', "slot_py": None, "target": None, "cond": None},
    0x35ae8: {"kind": 'mem', "py": 'pr = _rdw(ram, STACK_BASE + 0x400, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x35aea: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, STACK_BASE + 0x404, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},}
