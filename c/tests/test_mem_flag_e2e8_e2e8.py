#!/usr/bin/env python3
"""Differential test for mem_flag_e2e8 (0xE2E8) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_mem_flag_e2e8_e2e8.py
"""
...
ENTRY = 0xE2E8
RAW = bytes.fromhex("90 05 E3 01 00 0B 20 30")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    0xe2e8: {"kind": 'reg', "py": 'r[0] = 0xFFFFA408', "slot_py": None, "target": None, "cond": None},
    0xe2ea: {"kind": 'reg', "py": 'r[3] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0xe2ec: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFA408, 1, r[3])', "target": None, "cond": None},}
