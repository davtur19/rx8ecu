#!/usr/bin/env python3
"""Differential test for diag_safety_53a2e (0x53A2E) — v3 lift (branches + delay slots), 42 bytes.
...
Run from repo root: python3 c/tests/test_diag_safety_53a2e_53a2e.py
"""
...
ENTRY = 0x53A2E
RAW = bytes.fromhex("91 1B D0 16 63 10 62 00 33 26 8F 0C 00 09 90 15 60 00 C8 80 00 29 70 FF 60 0B 88 01 8F 03 00 09 E2 01 93 0C 23 20 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFD183
SPAN_END = 0x53A58
SENT = 0x53A58     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x53a2e: {"kind": 'reg', "py": 'r[1] = 0xFFFFD181', "slot_py": None, "target": None, "cond": None},
    0x53a30: {"kind": 'reg', "py": 'r[0] = 0x0007D7F2', "slot_py": None, "target": None, "cond": None},
    0x53a32: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFD181, 1))', "slot_py": None, "target": None, "cond": None},
    0x53a34: {"kind": 'mem', "py": 'r[2] = s8(_rdw(ram, 0x0007D7F2, 1))', "slot_py": None, "target": None, "cond": None},
    0x53a36: {"kind": 'reg', "py": 'T = 1 if (r[3] & 0xFFFFFFFF) > (r[2] & 0xFFFFFFFF) else 0', "slot_py": None, "target": None, "cond": None},
    0x53a38: {"kind": "branch", "py": None, "slot_py": '', "target": 0x53a54, "cond": 'notT'},
    0x53a3c: {"kind": 'reg', "py": 'r[0] = 0xFFFFCFF1', "slot_py": None, "target": None, "cond": None},
    0x53a3e: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCFF1, 1))', "slot_py": None, "target": None, "cond": None},
    0x53a40: {"kind": 'reg', "py": 'T = 1 if (r[0] & 0x80) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x53a42: {"kind": 'reg', "py": 'r[0] = T;', "slot_py": None, "target": None, "cond": None},
    0x53a44: {"kind": 'reg', "py": 'r[0] = (r[0] + s8(0xFF)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x53a46: {"kind": 'reg', "py": 'r[0] = (-r[0]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x53a48: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x53a4a: {"kind": "branch", "py": None, "slot_py": '', "target": 0x53a54, "cond": 'notT'},
    0x53a4e: {"kind": 'reg', "py": 'r[2] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x53a50: {"kind": 'reg', "py": 'r[3] = 0xFFFFD183', "slot_py": None, "target": None, "cond": None},
    0x53a52: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD183, 1, r[2])', "slot_py": None, "target": None, "cond": None},
    0x53a54: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
