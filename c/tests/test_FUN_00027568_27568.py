#!/usr/bin/env python3
"""Differential test for FUN_00027568 (0x27568) — v3 lift (branches + delay slots), 42 bytes.
...
Run from repo root: python3 c/tests/test_FUN_00027568_27568.py
"""
...
ENTRY = 0x27568
RAW = bytes.fromhex("D3 40 E4 00 91 70 23 40 62 10 D0 3F D1 39 20 20 D2 37 E0 01 63 21 21 31 D3 37 23 00 D0 37 62 01 D1 37 21 21 D3 39 00 0B 23 40")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCFD9
SPAN_END = 0x27592
SENT = 0x27592     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x27568: {"kind": 'reg', "py": 'r[3] = 0xFFFFB6EC', "slot_py": None, "target": None, "cond": None},
    0x2756a: {"kind": 'reg', "py": 'r[4] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x2756c: {"kind": 'reg', "py": 'r[1] = 0xFFFFCFD9', "slot_py": None, "target": None, "cond": None},
    0x2756e: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFB6EC, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x27570: {"kind": 'mem', "py": 'r[2] = s8(_rdw(ram, 0xFFFFCFD9, 1))', "slot_py": None, "target": None, "cond": None},
    0x27572: {"kind": 'reg', "py": 'r[0] = 0xFFFFB700', "slot_py": None, "target": None, "cond": None},
    0x27574: {"kind": 'reg', "py": 'r[1] = 0xFFFFB6E4', "slot_py": None, "target": None, "cond": None},
    0x27576: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFB700, 1, r[2])', "slot_py": None, "target": None, "cond": None},
    0x27578: {"kind": 'reg', "py": 'r[2] = 0x000751A4', "slot_py": None, "target": None, "cond": None},
    0x2757a: {"kind": 'reg', "py": 'r[0] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x2757c: {"kind": 'mem', "py": 'r[3] = s16(_rdw(ram, 0x000751A4, 2))', "slot_py": None, "target": None, "cond": None},
    0x2757e: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFB6E4, 2, r[3])', "slot_py": None, "target": None, "cond": None},
    0x27580: {"kind": 'reg', "py": 'r[3] = 0xFFFFB6FE', "slot_py": None, "target": None, "cond": None},
    0x27582: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFB6FE, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x27584: {"kind": 'reg', "py": 'r[0] = 0x000751A2', "slot_py": None, "target": None, "cond": None},
    0x27586: {"kind": 'mem', "py": 'r[2] = s16(_rdw(ram, 0x000751A2, 2))', "slot_py": None, "target": None, "cond": None},
    0x27588: {"kind": 'reg', "py": 'r[1] = 0xFFFFB6E6', "slot_py": None, "target": None, "cond": None},
    0x2758a: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFB6E6, 2, r[2])', "slot_py": None, "target": None, "cond": None},
    0x2758c: {"kind": 'reg', "py": 'r[3] = 0xFFFFB6FF', "slot_py": None, "target": None, "cond": None},
    0x2758e: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFB6FF, 1, r[4])', "target": None, "cond": None},}
