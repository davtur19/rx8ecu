#!/usr/bin/env python3
"""Differential test for getApvVoltageRange (0x44C86) — v3 lift + v4 FPU, 60 bytes.
...
Run from repo root: python3 c/tests/test_getApvVoltageRange_44c86.py
"""
...
ENTRY = 0x44C86
RAW = bytes.fromhex("E6 01 D4 14 D3 12 D2 12 F5 38 F3 28 F6 5C 91 15 F6 31 F4 18 F5 45 8D 02 E5 00 A0 04 24 60 F6 45 8F 01 00 09 24 50 97 0A 60 40 60 0C 88 01 8F 02 00 09 A0 01 27 60 27 50 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCB25
SPAN_END = 0x44CC2
SENT = 0x44CE0     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x44c86: {"kind": 'reg', "py": 'r[6] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x44c88: {"kind": 'reg', "py": 'r[4] = 0xFFFFCB25', "slot_py": None, "target": None, "cond": None},
    0x44c8a: {"kind": 'reg', "py": 'r[3] = 0x0007BA28', "slot_py": None, "target": None, "cond": None},
    0x44c8c: {"kind": 'reg', "py": 'r[2] = 0x0007BA2C', "slot_py": None, "target": None, "cond": None},
    0x44c8e: {"kind": 'fpu', "py": 'fr[5] = bits2f(_rdw(ram, 0x0007BA28, 4))', "slot_py": None, "target": None, "cond": None},
    0x44c90: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x0007BA2C, 4))', "slot_py": None, "target": None, "cond": None},
    0x44c92: {"kind": 'fpu', "py": 'fr[6] = fr[5]', "slot_py": None, "target": None, "cond": None},
    0x44c94: {"kind": 'reg', "py": 'r[1] = 0xFFFFCB20', "slot_py": None, "target": None, "cond": None},
    0x44c96: {"kind": 'fpu', "py": 'fr[6] = ts(fr[6] - fr[3])', "slot_py": None, "target": None, "cond": None},
    0x44c98: {"kind": 'fpu', "py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFCB20, 4))', "slot_py": None, "target": None, "cond": None},
    0x44c9a: {"kind": 'fpu', "py": 'T = 1 if fr[5] > fr[4] else 0', "slot_py": None, "target": None, "cond": None},
    0x44c9c: {"kind": "branch", "py": None, "slot_py": 'r[5] = s8(0x00)', "target": 0x44ca4, "cond": 'T'},
    0x44ca0: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFCB25, 1, r[6])', "target": 0x44cac, "cond": 'always'},
    0x44ca4: {"kind": 'fpu', "py": 'T = 1 if fr[6] > fr[4] else 0', "slot_py": None, "target": None, "cond": None},
    0x44ca6: {"kind": "branch", "py": None, "slot_py": '', "target": 0x44cac, "cond": 'notT'},
    0x44caa: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCB25, 1, r[5])', "slot_py": None, "target": None, "cond": None},
    0x44cac: {"kind": 'reg', "py": 'r[7] = 0xFFFFCB24', "slot_py": None, "target": None, "cond": None},
    0x44cae: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCB25, 1))', "slot_py": None, "target": None, "cond": None},
    0x44cb0: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x44cb2: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x44cb4: {"kind": "branch", "py": None, "slot_py": '', "target": 0x44cbc, "cond": 'notT'},
    0x44cb8: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFCB24, 1, r[6])', "target": 0x44cbe, "cond": 'always'},
    0x44cbc: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCB24, 1, r[5])', "slot_py": None, "target": None, "cond": None},
    0x44cbe: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
