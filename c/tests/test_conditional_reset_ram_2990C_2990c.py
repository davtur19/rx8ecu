#!/usr/bin/env python3
"""Differential test for conditional_reset_ram_2990C (0x2990C) — v3 lift (branches + delay slots), 44 bytes.
...
Run from repo root: python3 c/tests/test_conditional_reset_ram_2990C_2990c.py
"""
...
ENTRY = 0x2990C
RAW = bytes.fromhex("91 5A 60 10 60 0C 88 01 8F 0E 00 09 93 55 60 30 60 0C 88 01 8F 08 00 09 93 4C E1 01 90 49 E4 00 92 49 23 41 22 41 20 10 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    0x2990c: {"kind": 'reg', "py": 'r[1] = 0xFFFFD201', "slot_py": None, "target": None, "cond": None},
    0x2990e: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFD201, 1))', "slot_py": None, "target": None, "cond": None},
    0x29910: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x29912: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x29914: {"kind": "branch", "py": None, "slot_py": '', "target": 0x29934, "cond": 'notT'},
    0x29918: {"kind": 'reg', "py": 'r[3] = 0xFFFFA41C', "slot_py": None, "target": None, "cond": None},
    0x2991a: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFA41C, 1))', "slot_py": None, "target": None, "cond": None},
    0x2991c: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x2991e: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x29920: {"kind": "branch", "py": None, "slot_py": '', "target": 0x29934, "cond": 'notT'},
    0x29924: {"kind": 'reg', "py": 'r[3] = 0xFFFFBB04', "slot_py": None, "target": None, "cond": None},
    0x29926: {"kind": 'reg', "py": 'r[1] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x29928: {"kind": 'reg', "py": 'r[0] = 0xFFFFBB08', "slot_py": None, "target": None, "cond": None},
    0x2992a: {"kind": 'reg', "py": 'r[4] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x2992c: {"kind": 'reg', "py": 'r[2] = 0xFFFFBB06', "slot_py": None, "target": None, "cond": None},
    0x2992e: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBB04, 2, r[4])', "slot_py": None, "target": None, "cond": None},
    0x29930: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBB06, 2, r[4])', "slot_py": None, "target": None, "cond": None},
    0x29932: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBB08, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x29934: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
