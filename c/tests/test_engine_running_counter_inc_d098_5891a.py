#!/usr/bin/env python3
"""Differential test for engine_running_counter_inc_d098 (0x5891A) — v3 lift (branches + delay slots), 38 bytes.
...
Run from repo root: python3 c/tests/test_engine_running_counter_inc_d098_5891a.py
"""
...
ENTRY = 0x5891A
RAW = bytes.fromhex("93 4F 64 30 64 4C 24 48 8F 0B 00 09 92 4A D0 28 61 21 61 1D 31 00 8D 04 00 09 94 43 62 41 72 01 24 21 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFD098
SPAN_END = 0x58940
SENT = 0x58940     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x5891a: {"kind": 'reg', "py": 'r[3] = 0xFFFFA41C', "slot_py": None, "target": None, "cond": None},
    0x5891c: {"kind": 'mem', "py": 'r[4] = s8(_rdw(ram, 0xFFFFA41C, 1))', "slot_py": None, "target": None, "cond": None},
    0x5891e: {"kind": 'reg', "py": 'r[4] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x58920: {"kind": 'reg', "py": 'T = 1 if (r[4] & r[4]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x58922: {"kind": "branch", "py": None, "slot_py": '', "target": 0x5893c, "cond": 'notT'},
    0x58926: {"kind": 'reg', "py": 'r[2] = 0xFFFFD098', "slot_py": None, "target": None, "cond": None},
    0x58928: {"kind": 'reg', "py": 'r[0] = 0x0000FFFF', "slot_py": None, "target": None, "cond": None},
    0x5892a: {"kind": 'mem', "py": 'r[1] = s16(_rdw(ram, 0xFFFFD098, 2))', "slot_py": None, "target": None, "cond": None},
    0x5892c: {"kind": 'reg', "py": 'r[1] = r[1] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x5892e: {"kind": 'reg', "py": 'T = 1 if r[1] == r[0] else 0', "slot_py": None, "target": None, "cond": None},
    0x58930: {"kind": "branch", "py": None, "slot_py": '', "target": 0x5893c, "cond": 'T'},
    0x58934: {"kind": 'reg', "py": 'r[4] = 0xFFFFD098', "slot_py": None, "target": None, "cond": None},
    0x58936: {"kind": 'mem', "py": 'r[2] = s16(_rdw(ram, 0xFFFFD098, 2))', "slot_py": None, "target": None, "cond": None},
    0x58938: {"kind": 'reg', "py": 'r[2] = (r[2] + s8(0x01)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x5893a: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD098, 2, r[2])', "slot_py": None, "target": None, "cond": None},
    0x5893c: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
