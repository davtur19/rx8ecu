#!/usr/bin/env python3
"""Differential test for caller_32D4A (entry 0x32D4A) — v8 ST caller (CFG), 60 bytes.
...
Run: python3 test_caller_32D4A.py
"""
...
CODE = {
    0x32d4a: {"kind": 'mem', "py": 'local[0x3FC] = r[14]\n_wrw(ram, STACK_BASE + 0x3FC, 4, r[14])\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x32d4c: {"kind": 'st', "py": 'local[0x3F8] = pr\n_wrw(ram, STACK_BASE + 0x3F8, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x32d4e: {"kind": 'reg', "py": 'r[14] = 0xFFFFBFF0', "slot_py": None, "target": None, "cond": None},
    0x32d50: {"kind": 'reg', "py": 'r[2] = 0xFFFFBFF3', "slot_py": None, "target": None, "cond": None},
    0x32d52: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFBFF3, 1))', "slot_py": None, "target": None, "cond": None},
    0x32d54: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x32d56: {"kind": "branch", "py": None, "slot_py": 'r[5] = s8(0x00)', "target": 0x32d74, "cond": 'T'},
    0x32d5a: {"kind": 'mem', "py": 'r[4] = s16(_rdw(ram, 0xFFFFBFF0, 2))', "slot_py": None, "target": None, "cond": None},
    0x32d5c: {"kind": 'reg', "py": 'r[0] = 0x00078CB0', "slot_py": None, "target": None, "cond": None},
    0x32d5e: {"kind": 'reg', "py": 'r[1] = r[4] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x32d60: {"kind": 'mem', "py": 'r[3] = s16(_rdw(ram, 0x00078CB0, 2))', "slot_py": None, "target": None, "cond": None},
    0x32d62: {"kind": 'reg', "py": 'r[3] = r[3] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x32d64: {"kind": 'reg', "py": 'T = 1 if s32(r[1]) >= s32(r[3]) else 0', "slot_py": None, "target": None, "cond": None},
    0x32d66: {"kind": "branch", "py": None, "slot_py": '', "target": 0x32d78, "cond": 'notT'},
    0x32d6a: {"kind": 'reg', "py": 'r[3] = 0xFFFFCB24', "slot_py": None, "target": None, "cond": None},
    0x32d6c: {"kind": 'mem', "py": 'r[1] = s8(_rdw(ram, 0xFFFFCB24, 1))', "slot_py": None, "target": None, "cond": None},
    0x32d6e: {"kind": 'reg', "py": 'T = 1 if (r[1] & r[1]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x32d70: {"kind": "branch", "py": None, "slot_py": '', "target": 0x32d78, "cond": 'notT'},
    0x32d74: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFBFF0, 2, r[5])', "target": 0x32d80, "cond": 'always'},
    0x32d78: {"kind": 'reg', "py": 'r[2] = 0x00002460', "slot_py": None, "target": None, "cond": None},
    0x32d7a: {"kind": "call", "py": None, "slot_py": 'r[5] = s8(0x01)', "target": 0x2460, "ret_pc": 0x32d7e, "set_pr": True, "cond": None},
    0x32d7e: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBFF0, 2, r[0])', "slot_py": None, "target": None, "cond": None},
    0x32d80: {"kind": 'st', "py": 'pr = _rdw(ram, STACK_BASE + 0x3F8, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x32d82: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, STACK_BASE + 0x3FC, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},
