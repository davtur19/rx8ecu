#!/usr/bin/env python3
"""Differential test for calc_ignition_advance_modifier (0x13A0E) — v3 lift + v4 FPU, 80 bytes.
...
Run from repo root: python3 c/tests/test_calc_ignition_advance_modifier_13a0e.py
"""
...
RAM_MAX = 0xFFFFC12C
SPAN_END = 0x13A5E
SENT = 0x13A5E     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x13a0e: {"kind": 'reg', "py": 'r[3] = 0xFFFFB5B8', "slot_py": None, "target": None, "cond": None},
    0x13a10: {"kind": 'reg', "py": 'r[4] = 0xFFFFA748', "slot_py": None, "target": None, "cond": None},
    0x13a12: {"kind": 'reg', "py": 'r[1] = 0x0007A172', "slot_py": None, "target": None, "cond": None},
    0x13a14: {"kind": 'mem', "py": 'r[2] = s8(_rdw(ram, 0x0007A172, 1))', "slot_py": None, "target": None, "cond": None},
    0x13a16: {"kind": 'reg', "py": 'T = 1 if (r[2] & r[2]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x13a18: {"kind": "branch", "py": None, "slot_py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFB5B8, 4))', "target": 0x13a56, "cond": 'notT'},
    0x13a1c: {"kind": 'reg', "py": 'r[0] = 0xFFFFA424', "slot_py": None, "target": None, "cond": None},
    0x13a1e: {"kind": 'mem', "py": 'r[2] = s16(_rdw(ram, 0xFFFFA424, 2))', "slot_py": None, "target": None, "cond": None},
    0x13a20: {"kind": 'reg', "py": 'r[1] = 0x0007983C', "slot_py": None, "target": None, "cond": None},
    0x13a22: {"kind": 'mem', "py": 'r[3] = s16(_rdw(ram, 0x0007983C, 2))', "slot_py": None, "target": None, "cond": None},
    0x13a24: {"kind": 'reg', "py": 'T = 1 if (r[2] & 0xFFFFFFFF) >= (r[3] & 0xFFFFFFFF) else 0', "slot_py": None, "target": None, "cond": None},
    0x13a26: {"kind": "branch", "py": None, "slot_py": '', "target": 0x13a56, "cond": 'notT'},
    0x13a2a: {"kind": 'reg', "py": 'r[3] = 0x00079840', "slot_py": None, "target": None, "cond": None},
    0x13a2c: {"kind": 'reg', "py": 'r[2] = 0xFFFFAA10', "slot_py": None, "target": None, "cond": None},
    0x13a2e: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x00079840, 4))', "slot_py": None, "target": None, "cond": None},
    0x13a30: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0xFFFFAA10, 4))', "slot_py": None, "target": None, "cond": None},
    0x13a32: {"kind": 'fpu', "py": 'T = 1 if fr[3] > fr[2] else 0', "slot_py": None, "target": None, "cond": None},
    0x13a34: {"kind": "branch", "py": None, "slot_py": '', "target": 0x13a56, "cond": 'T'},
    0x13a38: {"kind": 'reg', "py": 'r[1] = 0x00079844', "slot_py": None, "target": None, "cond": None},
    0x13a3a: {"kind": 'fpu', "py": 'fr[1] = bits2f(_rdw(ram, 0x00079844, 4))', "slot_py": None, "target": None, "cond": None},
    0x13a3c: {"kind": 'reg', "py": 'r[3] = 0xFFFFC12C', "slot_py": None, "target": None, "cond": None},
    0x13a3e: {"kind": 'fpu', "py": 'fr[0] = bits2f(_rdw(ram, 0xFFFFC12C, 4))', "slot_py": None, "target": None, "cond": None},
    0x13a40: {"kind": 'fpu', "py": 'T = 1 if fr[1] > fr[0] else 0', "slot_py": None, "target": None, "cond": None},
    0x13a42: {"kind": "branch", "py": None, "slot_py": '', "target": 0x13a56, "cond": 'T'},
    0x13a46: {"kind": 'reg', "py": 'r[2] = 0x00079848', "slot_py": None, "target": None, "cond": None},
    0x13a48: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x00079848, 4))', "slot_py": None, "target": None, "cond": None},
    0x13a4a: {"kind": 'fpu', "py": 'T = 1 if fr[3] > fr[4] else 0', "slot_py": None, "target": None, "cond": None},
    0x13a4c: {"kind": "branch", "py": None, "slot_py": '', "target": 0x13a56, "cond": 'notT'},
    0x13a50: {"kind": 'reg', "py": 'r[1] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x13a52: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFA748, 1, r[1])', "target": 0x13a5a, "cond": 'always'},
    0x13a56: {"kind": 'reg', "py": 'r[2] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x13a58: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA748, 1, r[2])', "slot_py": None, "target": None, "cond": None},
    0x13a5a: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
