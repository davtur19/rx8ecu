#!/usr/bin/env python3
"""Differential test for sensor_extract_606b4 (0x606B4) — v3 lift + v4 FPU, 12 bytes.
...
Run from repo root: python3 c/tests/test_sensor_extract_606b4_606b4.py
"""
...
ENTRY = 0x606B4
RAW = bytes.fromhex("92 46 00 0B F0 28 93 44 00 0B F0 38")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFAA1C
SPAN_END = 0x606C0
SENT = 0x606C0     # stop-sentinel, placed past the literal pool
