#!/usr/bin/env python3
"""Differential test for caller_1A084 (entry 0x1A084) — v8 ST caller (CFG), 38 bytes.
...
Run: python3 test_caller_1A084.py
"""
...
CODE = {
    0x1a084: {"kind": 'st', "py": 'local[0x3FC] = pr\n_wrw(ram, STACK_BASE + 0x3FC, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x1a086: {"kind": 'reg', "py": 'r[3] = 0xFFFF9EEE', "slot_py": None, "target": None, "cond": None},
    0x1a088: {"kind": 'reg', "py": 'r[1] = 0xFFFFAA4E', "slot_py": None, "target": None, "cond": None},
    0x1a08a: {"kind": 'mem', "py": 'r[2] = s16(_rdw(ram, 0xFFFF9EEE, 2))', "slot_py": None, "target": None, "cond": None},
    0x1a08c: {"kind": 'reg', "py": 'r[0] = 0xFFFFA114', "slot_py": None, "target": None, "cond": None},
    0x1a08e: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFAA4E, 2, r[2])', "slot_py": None, "target": None, "cond": None},
    0x1a090: {"kind": 'mem', "py": 'r[3] = s16(_rdw(ram, 0xFFFFA114, 2))', "slot_py": None, "target": None, "cond": None},
    0x1a092: {"kind": 'reg', "py": 'r[2] = 0xFFFFAA5A', "slot_py": None, "target": None, "cond": None},
    0x1a094: {"kind": 'reg', "py": 'r[1] = 0xFFFFA10C', "slot_py": None, "target": None, "cond": None},
    0x1a096: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFAA5A, 2, r[3])', "slot_py": None, "target": None, "cond": None},
    0x1a098: {"kind": 'fpu', "py": 'fr[5] = bits2f(_rdw(ram, 0xFFFFA10C, 4))', "slot_py": None, "target": None, "cond": None},
    0x1a09a: {"kind": 'reg', "py": 'r[3] = 0x0006FA28', "slot_py": None, "target": None, "cond": None},
    0x1a09c: {"kind": 'reg', "py": 'r[2] = 0x000023F4', "slot_py": None, "target": None, "cond": None},
    0x1a09e: {"kind": "call", "py": None, "slot_py": 'fr[4] = bits2f(_rdw(ram, 0x0006FA28, 4))', "target": 0x23f4, "ret_pc": 0x1a0a2, "set_pr": True, "cond": None},
    0x1a0a2: {"kind": 'reg', "py": 'r[1] = 0xFFFFAA28', "slot_py": None, "target": None, "cond": None},
    0x1a0a4: {"kind": 'st', "py": 'pr = _rdw(ram, STACK_BASE + 0x3FC, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x1a0a6: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFAA28, 4, f2bits(fr[0]))', "target": None, "cond": None},
