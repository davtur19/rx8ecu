#!/usr/bin/env python3
"""Differential test for task_queue_get_next (0x3B0) — v3 lift (branches + delay slots), 36 bytes.
...
Run from repo root: python3 c/tests/test_task_queue_get_next_3b0.py
"""
...
ENTRY = 0x3B0
RAW = bytes.fromhex("94 28 E1 64 D3 17 65 41 62 41 65 5D 45 08 45 00 72 01 24 21 62 2D 32 13 8F 02 35 3C E0 00 24 01 00 0B 60 53")
SEED = 0
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFDFB6
SPAN_END = 0x3D4
SENT = 0x3D4     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x3b0: {"kind": 'reg', "py": 'r[4] = 0xFFFFDFB6', "slot_py": None, "target": None, "cond": None},
    0x3b2: {"kind": 'reg', "py": 'r[1] = s8(0x64)', "slot_py": None, "target": None, "cond": None},
    0x3b4: {"kind": 'reg', "py": 'r[3] = 0xFFFFD4E0', "slot_py": None, "target": None, "cond": None},
    0x3b6: {"kind": 'mem', "py": 'r[5] = s16(_rdw(ram, 0xFFFFDFB6, 2))', "slot_py": None, "target": None, "cond": None},
    0x3b8: {"kind": 'mem', "py": 'r[2] = s16(_rdw(ram, 0xFFFFDFB6, 2))', "slot_py": None, "target": None, "cond": None},
    0x3ba: {"kind": 'reg', "py": 'r[5] = r[5] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x3bc: {"kind": 'reg', "py": 'r[5] = (r[5] << 2) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x3be: {"kind": 'reg', "py": 'T = (r[5] >> 31) & 1\nr[5] = (r[5] << 1) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x3c0: {"kind": 'reg', "py": 'r[2] = (r[2] + s8(0x01)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x3c2: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFDFB6, 2, r[2])', "slot_py": None, "target": None, "cond": None},
    0x3c4: {"kind": 'reg', "py": 'r[2] = r[2] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x3c6: {"kind": 'reg', "py": 'T = 1 if s32(r[2]) >= s32(r[1]) else 0', "slot_py": None, "target": None, "cond": None},
    0x3c8: {"kind": "branch", "py": None, "slot_py": 'r[5] = (r[5] + r[3]) & 0xFFFFFFFF', "target": 0x3d0, "cond": 'notT'},
    0x3cc: {"kind": 'reg', "py": 'r[0] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x3ce: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFDFB6, 2, r[0])', "slot_py": None, "target": None, "cond": None},
    0x3d0: {"kind": "ret", "py": None, "slot_py": 'r[0] = r[5]', "target": None, "cond": None},}
