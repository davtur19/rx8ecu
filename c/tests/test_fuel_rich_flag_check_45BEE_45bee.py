#!/usr/bin/env python3
"""Differential test for fuel_rich_flag_check_45BEE (0x45BEE) — v3 lift + v4 FPU, 42 bytes.
...
Run from repo root: python3 c/tests/test_fuel_rich_flag_check_45BEE_45bee.py
"""
...
ENTRY = 0x45BEE
RAW = bytes.fromhex("94 17 93 14 60 30 60 0C 88 01 8F 03 00 09 E1 00 A0 09 24 10 D2 10 90 0E F3 28 F2 08 F3 25 8D 02 00 09 E1 01 24 10 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFD201
SPAN_END = 0x45C18
SENT = 0x45C18     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x45bee: {"kind": 'reg', "py": 'r[4] = 0xFFFFCBF3', "slot_py": None, "target": None, "cond": None},
    0x45bf0: {"kind": 'reg', "py": 'r[3] = 0xFFFFD201', "slot_py": None, "target": None, "cond": None},
    0x45bf2: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFD201, 1))', "slot_py": None, "target": None, "cond": None},
    0x45bf4: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x45bf6: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x45bf8: {"kind": "branch", "py": None, "slot_py": '', "target": 0x45c02, "cond": 'notT'},
    0x45bfc: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x45bfe: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFCBF3, 1, r[1])', "target": 0x45c14, "cond": 'always'},
    0x45c02: {"kind": 'reg', "py": 'r[2] = 0x0007C04C', "slot_py": None, "target": None, "cond": None},
    0x45c04: {"kind": 'reg', "py": 'r[0] = 0xFFFFB5B8', "slot_py": None, "target": None, "cond": None},
    0x45c06: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x0007C04C, 4))', "slot_py": None, "target": None, "cond": None},
    0x45c08: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0xFFFFB5B8, 4))', "slot_py": None, "target": None, "cond": None},
    0x45c0a: {"kind": 'fpu', "py": 'T = 1 if fr[3] > fr[2] else 0', "slot_py": None, "target": None, "cond": None},
    0x45c0c: {"kind": "branch", "py": None, "slot_py": '', "target": 0x45c14, "cond": 'T'},
    0x45c10: {"kind": 'reg', "py": 'r[1] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x45c12: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCBF3, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x45c14: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
