#!/usr/bin/env python3
"""Differential test for udsResponseRelated2 (0x6772E) — pure straight-line lift, 10 bytes.
...
Run from repo root: python3 c/tests/test_udsResponseRelated2_6772e.py
"""
...
ENTRY = 0x6772E
RAW = bytes.fromhex("6E F3 7E 18 65 5D 63 53 43 15")
SEED = 42
N = 2000
