#!/usr/bin/env python3
"""Differential test for udsServiceResponse (0x66A74) — pure straight-line lift, 8 bytes.
...
Run from repo root: python3 c/tests/test_udsServiceResponse_66a74.py
"""
...
ENTRY = 0x66A74
RAW = bytes.fromhex("E4 03 E2 43 DB 21 E6 01")
SEED = 42
N = 2000
