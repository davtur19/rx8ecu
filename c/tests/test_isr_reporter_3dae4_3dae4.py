#!/usr/bin/env python3
"""Differential test for isr_reporter_3dae4 (0x3DAE4) — v3 lift (branches + delay slots), 22 bytes.
...
Run from repo root: python3 c/tests/test_isr_reporter_3dae4_3dae4.py
"""
...
ENTRY = 0x3DAE4
RAW = bytes.fromhex("95 62 64 50 63 4C 43 15 8F 03 00 09 93 5D 34 3C 25 40 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    0x3dae4: {"kind": 'reg', "py": 'r[5] = 0xFFFFC64A', "slot_py": None, "target": None, "cond": None},
    0x3dae6: {"kind": 'mem', "py": 'r[4] = s8(_rdw(ram, 0xFFFFC64A, 1))', "slot_py": None, "target": None, "cond": None},
    0x3dae8: {"kind": 'reg', "py": 'r[3] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x3daea: {"kind": 'reg', "py": 'T = 1 if s32(r[3]) > 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x3daec: {"kind": "branch", "py": None, "slot_py": '', "target": 0x3daf6, "cond": 'notT'},
    0x3daf0: {"kind": 'reg', "py": 'r[3] = 0x000000FF', "slot_py": None, "target": None, "cond": None},
    0x3daf2: {"kind": 'reg', "py": 'r[4] = (r[4] + r[3]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x3daf4: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC64A, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x3daf6: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
