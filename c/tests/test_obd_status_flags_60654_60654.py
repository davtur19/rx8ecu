#!/usr/bin/env python3
"""Differential test for obd_status_flags_60654 (0x60654) — v3 lift (branches + delay slots), 28 bytes.
...
Run from repo root: python3 c/tests/test_obd_status_flags_60654_60654.py
"""
...
ENTRY = 0x60654
RAW = bytes.fromhex("D2 07 E4 00 91 0A 63 21 60 10 24 3B 60 0C 88 01 8F 01 00 09 D4 03 92 02 00 0B 22 41")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFD3F0
SPAN_END = 0x60670
SENT = 0x6067C     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x60654: {"kind": 'reg', "py": 'r[2] = 0x0007DAE8', "slot_py": None, "target": None, "cond": None},
    0x60656: {"kind": 'reg', "py": 'r[4] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x60658: {"kind": 'reg', "py": 'r[1] = 0xFFFFD20A', "slot_py": None, "target": None, "cond": None},
    0x6065a: {"kind": 'mem', "py": 'r[3] = s16(_rdw(ram, 0x0007DAE8, 2))', "slot_py": None, "target": None, "cond": None},
    0x6065c: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFD20A, 1))', "slot_py": None, "target": None, "cond": None},
    0x6065e: {"kind": 'reg', "py": 'r[4] = (r[4] | r[3]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x60660: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x60662: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x60664: {"kind": "branch", "py": None, "slot_py": '', "target": 0x6066a, "cond": 'notT'},
    0x60668: {"kind": 'reg', "py": 'r[4] = 0x0000FFFD', "slot_py": None, "target": None, "cond": None},
    0x6066a: {"kind": 'reg', "py": 'r[2] = 0xFFFFD3F0', "slot_py": None, "target": None, "cond": None},
    0x6066c: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFD3F0, 2, r[4])', "target": None, "cond": None},}
