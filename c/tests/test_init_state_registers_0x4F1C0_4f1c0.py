#!/usr/bin/env python3
"""Differential test for init_state_registers_0x4F1C0 (0x4F1C0) — v3 lift (branches + delay slots), 38 bytes.
...
Run from repo root: python3 c/tests/test_init_state_registers_0x4F1C0_4f1c0.py
"""
...
ENTRY = 0x4F1C0
RAW = bytes.fromhex("D2 3E E0 40 91 6E 63 20 21 30 E2 01 93 6B 23 00 90 6A 20 20 D2 3A 61 20 93 67 23 10 D1 39 60 10 93 64 00 0B 23 00")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    0x4f1c0: {"kind": 'reg', "py": 'r[2] = 0x0007D0CB', "slot_py": None, "target": None, "cond": None},
    0x4f1c2: {"kind": 'reg', "py": 'r[0] = s8(0x40)', "slot_py": None, "target": None, "cond": None},
    0x4f1c4: {"kind": 'reg', "py": 'r[1] = 0xFFFFCFED', "slot_py": None, "target": None, "cond": None},
    0x4f1c6: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0x0007D0CB, 1))', "slot_py": None, "target": None, "cond": None},
    0x4f1c8: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCFED, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x4f1ca: {"kind": 'reg', "py": 'r[2] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x4f1cc: {"kind": 'reg', "py": 'r[3] = 0xFFFFCFF1', "slot_py": None, "target": None, "cond": None},
    0x4f1ce: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCFF1, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x4f1d0: {"kind": 'reg', "py": 'r[0] = 0xFFFFD005', "slot_py": None, "target": None, "cond": None},
    0x4f1d2: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD005, 1, r[2])', "slot_py": None, "target": None, "cond": None},
    0x4f1d4: {"kind": 'reg', "py": 'r[2] = 0x0007D0CD', "slot_py": None, "target": None, "cond": None},
    0x4f1d6: {"kind": 'mem', "py": 'r[1] = s8(_rdw(ram, 0x0007D0CD, 1))', "slot_py": None, "target": None, "cond": None},
    0x4f1d8: {"kind": 'reg', "py": 'r[3] = 0xFFFFCFEF', "slot_py": None, "target": None, "cond": None},
    0x4f1da: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCFEF, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x4f1dc: {"kind": 'reg', "py": 'r[1] = 0x0007D0CE', "slot_py": None, "target": None, "cond": None},
    0x4f1de: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0x0007D0CE, 1))', "slot_py": None, "target": None, "cond": None},
    0x4f1e0: {"kind": 'reg', "py": 'r[3] = 0xFFFFCFF0', "slot_py": None, "target": None, "cond": None},
    0x4f1e2: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFCFF0, 1, r[0])', "target": None, "cond": None},}
