#!/usr/bin/env python3
"""Differential test for can430rx_unpack (0x3306A) — v3 lift (branches + delay slots), 46 bytes.
...
Run from repo root: python3 c/tests/test_can430rx_unpack_3306a.py
"""
...
ENTRY = 0x3306A
RAW = bytes.fromhex("D4 25 D2 25 63 40 D1 25 22 30 84 41 21 00 84 42 D3 24 D2 24 23 00 84 43 22 00 84 44 D1 23 D3 23 21 00 84 45 23 00 84 46 D2 22 00 0B 22 00")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFC01D
SPAN_END = 0x33098
SENT = 0x33098     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x3306a: {"kind": 'reg', "py": 'r[4] = 0xFFFFC00C', "slot_py": None, "target": None, "cond": None},
    0x3306c: {"kind": 'reg', "py": 'r[2] = 0xFFFFC017', "slot_py": None, "target": None, "cond": None},
    0x3306e: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFC00C, 1))', "slot_py": None, "target": None, "cond": None},
    0x33070: {"kind": 'reg', "py": 'r[1] = 0xFFFFC018', "slot_py": None, "target": None, "cond": None},
    0x33072: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC017, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x33074: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFC00D, 1))', "slot_py": None, "target": None, "cond": None},
    0x33076: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC018, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x33078: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFC00E, 1))', "slot_py": None, "target": None, "cond": None},
    0x3307a: {"kind": 'reg', "py": 'r[3] = 0xFFFFC019', "slot_py": None, "target": None, "cond": None},
    0x3307c: {"kind": 'reg', "py": 'r[2] = 0xFFFFC01A', "slot_py": None, "target": None, "cond": None},
    0x3307e: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC019, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x33080: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFC00F, 1))', "slot_py": None, "target": None, "cond": None},
    0x33082: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC01A, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x33084: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFC010, 1))', "slot_py": None, "target": None, "cond": None},
    0x33086: {"kind": 'reg', "py": 'r[1] = 0xFFFFC01B', "slot_py": None, "target": None, "cond": None},
    0x33088: {"kind": 'reg', "py": 'r[3] = 0xFFFFC01C', "slot_py": None, "target": None, "cond": None},
    0x3308a: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC01B, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x3308c: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFC011, 1))', "slot_py": None, "target": None, "cond": None},
    0x3308e: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC01C, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x33090: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFC012, 1))', "slot_py": None, "target": None, "cond": None},
    0x33092: {"kind": 'reg', "py": 'r[2] = 0xFFFFC01D', "slot_py": None, "target": None, "cond": None},
    0x33094: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFC01D, 1, r[0])', "target": None, "cond": None},}
