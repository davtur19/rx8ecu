#!/usr/bin/env python3
"""Differential test for diag_getacswitchstatus_2fd20 (0x2FD20) — v3 lift (branches + delay slots), 32 bytes.
...
Run from repo root: python3 c/tests/test_diag_getacswitchstatus_2fd20_2fd20.py
"""
...
ENTRY = 0x2FD20
RAW = bytes.fromhex("94 0E D3 08 60 30 60 0C C8 04 00 29 88 01 8F 03 00 09 E3 01 A0 02 24 30 E1 00 24 10 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBDD8
SPAN_END = 0x2FD40
SENT = 0x2FD48     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x2fd20: {"kind": 'reg', "py": 'r[4] = 0xFFFFBDD8', "slot_py": None, "target": None, "cond": None},
    0x2fd22: {"kind": 'reg', "py": 'r[3] = 0xFFFF9ECD', "slot_py": None, "target": None, "cond": None},
    0x2fd24: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFF9ECD, 1))', "slot_py": None, "target": None, "cond": None},
    0x2fd26: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x2fd28: {"kind": 'reg', "py": 'T = 1 if (r[0] & 0x04) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x2fd2a: {"kind": 'reg', "py": 'r[0] = T;', "slot_py": None, "target": None, "cond": None},
    0x2fd2c: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x2fd2e: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2fd38, "cond": 'notT'},
    0x2fd32: {"kind": 'reg', "py": 'r[3] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x2fd34: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFBDD8, 1, r[3])', "target": 0x2fd3c, "cond": 'always'},
    0x2fd38: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x2fd3a: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBDD8, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x2fd3c: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
