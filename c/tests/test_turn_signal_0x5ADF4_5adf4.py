#!/usr/bin/env python3
"""Differential test for turn_signal_0x5ADF4 (0x5ADF4) — v3 lift (branches + delay slots), 14 bytes.
...
Run from repo root: python3 c/tests/test_turn_signal_0x5ADF4_5adf4.py
"""
...
CODE = {
    0x5adf4: {"kind": 'reg', "py": 'r[2] = 0xFFFFD318', "slot_py": None, "target": None, "cond": None},
    0x5adf6: {"kind": 'reg', "py": 'r[1] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x5adf8: {"kind": 'reg', "py": 'r[0] = 0xFFFFD317', "slot_py": None, "target": None, "cond": None},
    0x5adfa: {"kind": 'reg', "py": 'r[3] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x5adfc: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD318, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x5adfe: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFD317, 1, r[1])', "target": None, "cond": None},}
