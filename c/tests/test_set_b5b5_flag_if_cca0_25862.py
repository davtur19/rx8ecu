#!/usr/bin/env python3
"""Differential test for set_b5b5_flag_if_cca0 (0x25862) — v3 lift (branches + delay slots), 22 bytes.
...
Run from repo root: python3 c/tests/test_set_b5b5_flag_if_cca0_25862.py
"""
...
ENTRY = 0x25862
RAW = bytes.fromhex("93 4D 60 30 60 0C 88 01 8F 03 00 09 E1 01 92 47 22 10 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCCA0
SPAN_END = 0x25878
SENT = 0x25878     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x25862: {"kind": 'reg', "py": 'r[3] = 0xFFFFCCA0', "slot_py": None, "target": None, "cond": None},
    0x25864: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCCA0, 1))', "slot_py": None, "target": None, "cond": None},
    0x25866: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x25868: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x2586a: {"kind": "branch", "py": None, "slot_py": '', "target": 0x25874, "cond": 'notT'},
    0x2586e: {"kind": 'reg', "py": 'r[1] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x25870: {"kind": 'reg', "py": 'r[2] = 0xFFFFB5B5', "slot_py": None, "target": None, "cond": None},
    0x25872: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFB5B5, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x25874: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
