#!/usr/bin/env python3
"""Differential test for updateRAM__ (0x529AE) — v3 lift (branches + delay slots), 14 bytes.
...
Run from repo root: python3 c/tests/test_updateRAM___529ae.py
"""
...
ENTRY = 0x529AE
RAW = bytes.fromhex("63 50 73 01 25 30 24 60 74 01 00 0B 60 43")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = None
SPAN_END = 0x529BC
SENT = 0x529BC     # stop-sentinel, placed past the literal pool
