#!/usr/bin/env python3
"""Differential test for FUN_0003cf3c (0x3CF3C) — v3 lift (branches + delay slots), 12 bytes.
...
Run from repo root: python3 c/tests/test_FUN_0003cf3c_3cf3c.py
"""
...
ENTRY = 0x3CF3C
RAW = bytes.fromhex("23 38 8F 01 00 09 26 70 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    ...
    0x3cf42: {"kind": 'mem', "py": '_wrw(ram, r[6], 1, r[7])', "slot_py": None, "target": None, "cond": None},
