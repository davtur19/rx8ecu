#!/usr/bin/env python3
"""Differential test for returnDwellTime_fp (0x1120A) — v3 lift (branches + delay slots), 14 bytes.
...
Run from repo root: python3 c/tests/test_returnDwellTime_fp_1120a.py
"""
