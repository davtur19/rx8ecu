#!/usr/bin/env python3
"""Differential test for caller_2FE00 (entry 0x2FE00) — v8 ST caller (CFG), 20 bytes.
...
Run: python3 test_caller_2FE00.py
"""
...
CODE = {
    0x2fe00: {"kind": 'st', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x2fe02: {"kind": 'reg', "py": 'r[3] = 0x000300A8', "slot_py": None, "target": None, "cond": None},
    0x2fe04: {"kind": "call", "py": None, "slot_py": '', "target": 0x300a8, "ret_pc": 0x2fe08, "set_pr": True, "cond": None},
    0x2fe08: {"kind": 'reg', "py": 'r[2] = 0x000300B0', "slot_py": None, "target": None, "cond": None},
    0x2fe0a: {"kind": "call", "py": None, "slot_py": '', "target": 0x300b0, "ret_pc": 0x2fe0e, "set_pr": True, "cond": None},
    0x2fe0e: {"kind": 'reg', "py": 'r[3] = 0x0002FD48', "slot_py": None, "target": None, "cond": None},
    0x2fe10: {"kind": "call", "py": None, "slot_py": 'pr = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": 0x2fd48, "ret_pc": 0x2fe14, "set_pr": False, "cond": None},
    0x2fd48: {"kind": 'st', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x2fd4a: {"kind": 'reg', "py": 'r[15] = (r[15] + s8(0xFC)) & 0xFFFFFFFF\nsp = (sp + s8(0xFC)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x2fd4c: {"kind": 'reg', "py": 'r[5] = 0x000000E0', "slot_py": None, "target": None, "cond": None},
    0x2fd4e: {"kind": 'reg', "py": 'r[3] = 0x00002054', "slot_py": None, "target": None, "cond": None},
    0x2fd50: {"kind": "call", "py": None, "slot_py": 'r[4] = sp', "target": 0x2054, "ret_pc": 0x2fd54, "set_pr": True, "cond": None},
    ...
    0x2fd54: {"kind": 'reg', "py": 'r[3] = 0xFFFFBDF8', "slot_py": None, "target": None, "cond": None},
    0x2fd56: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, r[3], 1))', "slot_py": None, "target": None, "cond": None},
    0x2fd58: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x2fd5a: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x2fd5c: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2fd6e, "cond": 'notT'},
    0x2fd60: {"kind": 'reg', "py": 'r[4] = 0xFFFFF754', "slot_py": None, "target": None, "cond": None},
    0x2fd62: {"kind": 'reg', "py": 'r[6] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x2fd64: {"kind": 'reg', "py": 'r[1] = 0x00004BBC', "slot_py": None, "target": None, "cond": None},
    0x2fd66: {"kind": "call", "py": None, "slot_py": 'r[5] = s8(0x04)', "target": 0x4bbc, "ret_pc": 0x2fd6a, "set_pr": True, "cond": None},
    ...
    0x2fd6a: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2fd78, "cond": 'always'},
    0x2fd78: {"kind": 'reg', "py": 'r[3] = 0x00002064', "slot_py": None, "target": None, "cond": None},
    0x2fd7a: {"kind": "call", "py": None, "slot_py": 'r[4] = _rdw(ram, sp, 4)', "target": 0x2064, "ret_pc": 0x2fd7e, "set_pr": True, "cond": None},
    0x2064: {"kind": "ret", "py": None, "slot_py": 'sr = r[4]', "target": None, "cond": None, },
    0x2fd7e: {"kind": 'reg', "py": 'r[15] = (r[15] + s8(0x04)) & 0xFFFFFFFF\nsp = (sp + s8(0x04)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x2fd80: {"kind": 'st', "py": 'pr = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x2fd82: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None, },
    0x2fd6e: {"kind": 'reg', "py": 'r[6] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x2fd70: {"kind": 'reg', "py": 'r[4] = 0xFFFFF754', "slot_py": None, "target": None, "cond": None},
    0x2fd72: {"kind": 'reg', "py": 'r[2] = 0x00004BBC', "slot_py": None, "target": None, "cond": None},
    0x2fd74: {"kind": "call", "py": None, "slot_py": 'r[5] = s8(0x04)', "target": 0x4bbc, "ret_pc": 0x2fd78, "set_pr": True, "cond": None},
    0x4bbc: {"kind": 'mem', "py": 'r[3] = s16(_rdw(ram, r[4], 2))', "slot_py": None, "target": None, "cond": None},
    0x4bbe: {"kind": 'reg', "py": 'r[6] = r[6] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x4bc0: {"kind": 'reg', "py": 'T = 1 if (r[6] & r[6]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x4bc2: {"kind": "branch", "py": None, "slot_py": None, "target": 0x4bcc, "cond": 'notT'},
    ...
    0x4bce: {"kind": 'mem', "py": '_wrw(ram, r[4], 2, r[3])', "slot_py": None, "target": None, "cond": None},
    0x4bd0: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None, },
    0x300a8: {"kind": 'reg', "py": 'r[2] = 0xFFFFBDF8', "slot_py": None, "target": None, "cond": None},
    0x300aa: {"kind": 'reg', "py": 'r[3] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x300ac: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBDF8, 1, r[3])', "target": None, "cond": None, },
    0x300b0: {"kind": 'reg', "py": 'r[1] = 0x0000FFFF', "slot_py": None, "target": None, "cond": None},
    0x300b2: {"kind": 'reg', "py": 'r[0] = 0xFFFFBDFC', "slot_py": None, "target": None, "cond": None},
    0x300b4: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBDFC, 2, r[1])', "target": None, "cond": None, },
}
