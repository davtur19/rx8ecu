#!/usr/bin/env python3
"""Differential test for sensor_branch_dispatcher_32F78 (0x32F78) — v3 lift (branches + delay slots), 18 bytes.
...
Run from repo root: python3 c/tests/test_sensor_branch_dispatcher_32F78_32f78.py
"""
...
ENTRY = 0x32F78
RAW = bytes.fromhex("A0 01 E4 02 E4 03 64 4C D3 1D 44 08 44 08 00 0B 23 40")
SEED = 42
N = 500
MAXSTEPS = 100000
