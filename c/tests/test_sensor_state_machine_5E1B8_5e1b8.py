#!/usr/bin/env python3
"""Differential test for sensor_state_machine_5E1B8 (0x5E1B8) — v3 lift (branches + delay slots), 52 bytes.
...
Run from repo root: python3 c/tests/test_sensor_state_machine_5E1B8_5e1b8.py
"""
...
ENTRY = 0x5E1B8
RAW = bytes.fromhex("93 18 64 30 92 17 60 4C 91 16 88 01 66 20 8F 03 65 10 94 12 A0 0B 00 09 60 6C 88 01 8F 06 00 09 60 5C 88 01 8F 02 00 09 A0 01 E4 40 E4 20 93 05 00 0B 23 40")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFD3A8
SPAN_END = 0x5E1EC
SENT = 0x5E1F6     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x5e1b8: {"kind": 'reg', "py": 'r[3] = 0xFFFFA41C', "slot_py": None, "target": None, "cond": None},
    0x5e1ba: {"kind": 'mem', "py": 'r[4] = s8(_rdw(ram, 0xFFFFA41C, 1))', "slot_py": None, "target": None, "cond": None},
    0x5e1bc: {"kind": 'reg', "py": 'r[2] = 0xFFFFAADB', "slot_py": None, "target": None, "cond": None},
    0x5e1be: {"kind": 'reg', "py": 'r[0] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x5e1c0: {"kind": 'reg', "py": 'r[1] = 0xFFFFB5AA', "slot_py": None, "target": None, "cond": None},
    0x5e1c2: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x5e1c4: {"kind": 'mem', "py": 'r[6] = s8(_rdw(ram, 0xFFFFAADB, 1))', "slot_py": None, "target": None, "cond": None},
    0x5e1c6: {"kind": "branch", "py": None, "slot_py": 'r[5] = s8(_rdw(ram, 0xFFFFB5AA, 1))', "target": 0x5e1d0, "cond": 'notT'},
    0x5e1ca: {"kind": 'reg', "py": 'r[4] = 0x00000080', "slot_py": None, "target": None, "cond": None},
    0x5e1cc: {"kind": "branch", "py": None, "slot_py": '', "target": 0x5e1e6, "cond": 'always'},
    0x5e1d0: {"kind": 'reg', "py": 'r[0] = r[6] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x5e1d2: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x5e1d4: {"kind": "branch", "py": None, "slot_py": '', "target": 0x5e1e4, "cond": 'notT'},
    0x5e1d8: {"kind": 'reg', "py": 'r[0] = r[5] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x5e1da: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x5e1dc: {"kind": "branch", "py": None, "slot_py": '', "target": 0x5e1e4, "cond": 'notT'},
    0x5e1e0: {"kind": "branch", "py": None, "slot_py": 'r[4] = s8(0x40)', "target": 0x5e1e6, "cond": 'always'},
    0x5e1e4: {"kind": 'reg', "py": 'r[4] = s8(0x20)', "slot_py": None, "target": None, "cond": None},
    0x5e1e6: {"kind": 'reg', "py": 'r[3] = 0xFFFFD3A8', "slot_py": None, "target": None, "cond": None},
    0x5e1e8: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFD3A8, 1, r[4])', "target": None, "cond": None},}
