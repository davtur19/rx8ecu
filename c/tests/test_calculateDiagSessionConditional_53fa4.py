#!/usr/bin/env python3
"""Differential test for calculateDiagSessionConditional (0x53FA4) — v3 lift (branches + delay slots), 38 bytes.
...
Run from repo root: python3 c/tests/test_calculateDiagSessionConditional_53fa4.py
"""
...
ENTRY = 0x53FA4
RAW = bytes.fromhex("94 79 93 79 60 30 60 0C 88 01 8F 08 00 09 92 74 61 20 21 18 8F 03 00 09 E3 01 A0 02 24 30 E1 00 24 10 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFD085
SPAN_END = 0x53FCA
SENT = 0x53FCA     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x53fa4: {"kind": 'reg', "py": 'r[4] = 0xFFFFCFE0', "slot_py": None, "target": None, "cond": None},
    0x53fa6: {"kind": 'reg', "py": 'r[3] = 0xFFFFA41C', "slot_py": None, "target": None, "cond": None},
    0x53fa8: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFA41C, 1))', "slot_py": None, "target": None, "cond": None},
    0x53faa: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x53fac: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x53fae: {"kind": "branch", "py": None, "slot_py": '', "target": 0x53fc2, "cond": 'notT'},
    0x53fb2: {"kind": 'reg', "py": 'r[2] = 0xFFFFD085', "slot_py": None, "target": None, "cond": None},
    0x53fb4: {"kind": 'mem', "py": 'r[1] = s8(_rdw(ram, 0xFFFFD085, 1))', "slot_py": None, "target": None, "cond": None},
    0x53fb6: {"kind": 'reg', "py": 'T = 1 if (r[1] & r[1]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x53fb8: {"kind": "branch", "py": None, "slot_py": '', "target": 0x53fc2, "cond": 'notT'},
    0x53fbc: {"kind": 'reg', "py": 'r[3] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x53fbe: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFCFE0, 1, r[3])', "target": 0x53fc6, "cond": 'always'},
    0x53fc2: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x53fc4: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCFE0, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x53fc6: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
