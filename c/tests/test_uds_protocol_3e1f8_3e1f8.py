#!/usr/bin/env python3
"""Differential test for uds_protocol_3e1f8 (0x3E1F8) — v3 lift (branches + delay slots), 16 bytes.
...
Run from repo root: python3 c/tests/test_uds_protocol_3e1f8_3e1f8.py
"""
...
ENTRY = 0x3E1F8
RAW = bytes.fromhex("63 5C 43 18 62 57 62 2C 33 2C 24 31 00 0B E0 00")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = None
SPAN_END = 0x3E208
SENT = 0x3E208     # stop-sentinel, placed past the literal pool
