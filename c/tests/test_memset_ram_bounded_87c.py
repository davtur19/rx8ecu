#!/usr/bin/env python3
"""Differential test for memset_ram_bounded (0x87C) — v3 lift (branches + delay slots), 48 bytes.
...
Run from repo root: python3 c/tests/test_memset_ram_bounded_87c.py
"""
...
ENTRY = 0x87C
RAW = bytes.fromhex("D3 0C 36 32 8B 11 61 53 92 12 31 6C 71 FF 31 26 89 0B E3 00 35 36 8B 06 63 44 75 FF 26 30 E2 00 35 26 8D F9 76 01 A0 01 E4 00 E4 FF 00 0B 60 43")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    0x87c: {"kind": 'reg', "py": 'r[3] = 0xFFFF6000', "slot_py": None, "target": None, "cond": None},
    0x87e: {"kind": 'reg', "py": 'T = 1 if r[6] >= r[3] else 0', "slot_py": None, "target": None, "cond": None},
    0x880: {"kind": "branch", "py": None, "slot_py": None, "target": 0x8a6, "cond": 'notT'},
    0x882: {"kind": 'reg', "py": 'r[1] = r[5]', "slot_py": None, "target": None, "cond": None},
    0x884: {"kind": 'reg', "py": 'r[2] = 0xFFFFDFFF', "slot_py": None, "target": None, "cond": None},
    0x886: {"kind": 'reg', "py": 'r[1] = (r[1] + r[6]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x888: {"kind": 'reg', "py": 'r[1] = (r[1] + s8(0xFF)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x88a: {"kind": 'reg', "py": 'T = 1 if r[1] > r[2] else 0', "slot_py": None, "target": None, "cond": None},
    0x88c: {"kind": "branch", "py": None, "slot_py": None, "target": 0x8a6, "cond": 'T'},
    0x88e: {"kind": 'reg', "py": 'r[3] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x890: {"kind": 'reg', "py": 'T = 1 if r[5] > r[3] else 0', "slot_py": None, "target": None, "cond": None},
    0x892: {"kind": "branch", "py": None, "slot_py": None, "target": 0x8a2, "cond": 'notT'},
    0x894: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, r[4], 1))\nr[4] = (r[4] + 1) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x896: {"kind": 'reg', "py": 'r[5] = (r[5] + s8(0xFF)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x898: {"kind": 'mem', "py": '_wrw(ram, r[6], 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x89a: {"kind": 'reg', "py": 'r[2] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x89c: {"kind": 'reg', "py": 'T = 1 if r[5] > r[2] else 0', "slot_py": None, "target": None, "cond": None},
    0x89e: {"kind": "branch", "py": None, "slot_py": 'r[6] = (r[6] + s8(0x01)) & 0xFFFFFFFF', "target": 0x894, "cond": 'T'},
    0x8a2: {"kind": "branch", "py": None, "slot_py": 'r[4] = s8(0x00)', "target": 0x8a8, "cond": 'always'},
    0x8a6: {"kind": 'reg', "py": 'r[4] = s8(0xFF)', "slot_py": None, "target": None, "cond": None},
    0x8a8: {"kind": "ret", "py": None, "slot_py": 'r[0] = r[4]', "target": None, "cond": None},}
