#!/usr/bin/env python3
"""Differential test for FUN_00045052 (0x45052) — mem lift (RAM-only, straight-line), 8 bytes.
...
Run from repo root: python3 c/tests/test_FUN_00045052_45052.py
"""
...
ENTRY = 0x45052
RAW = bytes.fromhex("2F B6 2F A6 2F 96 2F 86")
SEED = 42
N = 2000
...
def spec_mirror(r4, r5, r6, r7, ram, stack_top):
    ...
    local[0x3F4] = r[9]
    _wrw(ram, STACK_BASE + 0x3F4, 4, r[9])
    sp = (sp - 4) & 0xFFFFFFFF
    # 0x045058: mov.l r8,@-r15
    local[0x3F0] = r[8]
    _wrw(ram, STACK_BASE + 0x3F0, 4, r[8])
    sp = (sp - 4) & 0xFFFFFFFF
    r[15] = sp
