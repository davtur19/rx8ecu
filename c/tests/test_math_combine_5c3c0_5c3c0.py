#!/usr/bin/env python3
"""Differential test for math_combine_5c3c0 (0x5C3C0) — v3 lift (branches + delay slots), 10 bytes.
...
Run from repo root: python3 c/tests/test_math_combine_5c3c0_5c3c0.py
"""
...
CODE = {
    0x5c3c0: {"kind": 'mem', "py": 'r[11] = _rdw(ram, STACK_BASE + 0x400, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x5c3c2: {"kind": 'mem', "py": 'r[12] = _rdw(ram, STACK_BASE + 0x404, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x5c3c4: {"kind": 'mem', "py": 'r[13] = _rdw(ram, STACK_BASE + 0x408, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x5c3c6: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, STACK_BASE + 0x40C, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},}
