#!/usr/bin/env python3
"""Differential test for diag_flag_combine_or (0x550BE) — v3 lift (branches + delay slots), 40 bytes.
...
Run from repo root: python3 c/tests/test_diag_flag_combine_or_550be.py
"""
...
ENTRY = 0x550BE
RAW = bytes.fromhex("94 28 93 2A 60 30 60 0C 88 01 8D 06 00 09 92 25 60 20 60 0C 88 01 8F 03 00 09 E3 01 A0 02 24 30 E1 00 24 10 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    0x550be: {"kind": 'reg', "py": 'r[4] = 0xFFFFD1F8', "slot_py": None, "target": None, "cond": None},
    0x550c0: {"kind": 'reg', "py": 'r[3] = 0xFFFFC99D', "slot_py": None, "target": None, "cond": None},
    0x550c2: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFC99D, 1))', "slot_py": None, "target": None, "cond": None},
    0x550c4: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x550c6: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x550c8: {"kind": "branch", "py": None, "slot_py": '', "target": 0x550d8, "cond": 'T'},
    0x550cc: {"kind": 'reg', "py": 'r[2] = 0xFFFFC9A0', "slot_py": None, "target": None, "cond": None},
    0x550ce: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFC9A0, 1))', "slot_py": None, "target": None, "cond": None},
    0x550d0: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x550d2: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x550d4: {"kind": "branch", "py": None, "slot_py": '', "target": 0x550de, "cond": 'notT'},
    0x550d8: {"kind": 'reg', "py": 'r[3] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x550da: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFD1F8, 1, r[3])', "target": 0x550e2, "cond": 'always'},
    0x550de: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x550e0: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD1F8, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x550e2: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
