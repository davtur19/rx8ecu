#!/usr/bin/env python3
"""Differential test for fuel_control_35bbc (0x35BBC) — v3 lift (branches + delay slots), 64 bytes.
...
Run from repo root: python3 c/tests/test_fuel_control_35bbc_35bbc.py
"""
...
ENTRY = 0x35BBC
RAW = bytes.fromhex("43 28 43 08 43 08 43 00 62 43 42 09 42 01 64 33 24 2B 63 43 43 29 60 43 2F 30 40 19 80 F4 60 43 80 F8 2F 30 84 F8 60 0C 63 F0 40 28 64 03 63 3C 84 F4 60 0C 40 18 24 0B 24 3B 60 43 00 0B 7F 0C")
SEED = 0
N = 2000
MAXSTEPS = 100000
