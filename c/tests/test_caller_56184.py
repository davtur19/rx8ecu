#!/usr/bin/env python3
"""Differential test for caller_56184 (entry 0x56184) — v8 ST caller (CFG), 22 bytes.
...
Run: python3 test_caller_56184.py
"""
...
CODE = {
    0x56184: {"kind": 'st', "py": 'local[0x3FC] = pr\n_wrw(ram, STACK_BASE + 0x3FC, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x56186: {"kind": 'fpu', "py": 'fr[6] = 0.0', "slot_py": None, "target": None, "cond": None},
    0x56188: {"kind": 'reg', "py": 'r[0] = 0x00056260', "slot_py": None, "target": None, "cond": None},
    0x5618a: {"kind": 'reg', "py": 'r[3] = 0xFFFFC12C', "slot_py": None, "target": None, "cond": None},
    0x5618c: {"kind": 'reg', "py": 'r[2] = 0x00002490', "slot_py": None, "target": None, "cond": None},
    0x5618e: {"kind": 'fpu', "py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFC12C, 4))', "slot_py": None, "target": None, "cond": None},
    0x56190: {"kind": "call", "py": None, "slot_py": 'fr[5] = bits2f(_rdw(ram, 0x00056260, 4))', "target": 0x2490, "ret_pc": 0x56194, "set_pr": True, "cond": None},
    0x56194: {"kind": 'st', "py": 'pr = _rdw(ram, STACK_BASE + 0x3FC, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x56196: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},
