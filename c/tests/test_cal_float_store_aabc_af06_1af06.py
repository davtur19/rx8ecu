#!/usr/bin/env python3
"""Differential test for cal_float_store_aabc_af06 (0x1AF06) — v3 lift + v4 FPU, 10 bytes.
...
Run from repo root: python3 c/tests/test_cal_float_store_aabc_af06_1af06.py
"""
...
ENTRY = 0x1AF06
RAW = bytes.fromhex("D1 23 90 3F F3 18 00 0B F0 3A")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFAABC
SPAN_END = 0x1AF10
SENT = 0x1AF10     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x1af06: {"kind": 'reg', "py": 'r[1] = 0x0006F7E0', "slot_py": None, "target": None, "cond": None},
    0x1af08: {"kind": 'reg', "py": 'r[0] = 0xFFFFAABC', "slot_py": None, "target": None, "cond": None},
    0x1af0a: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x0006F7E0, 4))', "slot_py": None, "target": None, "cond": None},
    0x1af0c: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFAABC, 4, f2bits(fr[3]))', "target": None, "cond": None},}
