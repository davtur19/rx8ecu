#!/usr/bin/env python3
"""Differential test for bilinear_interp_3d_0x51688 (0x51688) — v3 lift (branches + delay slots), 64 bytes.
...
Run from repo root: python3 c/tests/test_bilinear_interp_3d_0x51688_51688.py
"""
...
ENTRY = 0x51688
RAW = bytes.fromhex("94 82 92 82 90 82 63 21 61 01 33 16 8F 14 00 09 93 7D 61 30 21 18 8F 0F 00 09 92 79 60 20 60 0C 88 01 8D 06 00 09 91 74 60 10 60 0C 88 01 8F 03 00 09 E2 01 A0 02 24 20 E1 00 24 10 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFD0E7
SPAN_END = 0x516C8
SENT = 0x516C8     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x51688: {"kind": 'reg', "py": 'r[4] = 0xFFFFD0E7', "slot_py": None, "target": None, "cond": None},
    0x5168a: {"kind": 'reg', "py": 'r[2] = 0xFFFFCFE6', "slot_py": None, "target": None, "cond": None},
    0x5168c: {"kind": 'reg', "py": 'r[0] = 0xFFFFCFE4', "slot_py": None, "target": None, "cond": None},
    0x5168e: {"kind": 'mem', "py": 'r[3] = s16(_rdw(ram, 0xFFFFCFE6, 2))', "slot_py": None, "target": None, "cond": None},
    0x51690: {"kind": 'mem', "py": 'r[1] = s16(_rdw(ram, 0xFFFFCFE4, 2))', "slot_py": None, "target": None, "cond": None},
    0x51692: {"kind": 'reg', "py": 'T = 1 if (r[3] & 0xFFFFFFFF) > (r[1] & 0xFFFFFFFF) else 0', "slot_py": None, "target": None, "cond": None},
    0x51694: {"kind": "branch", "py": None, "slot_py": '', "target": 0x516c0, "cond": 'notT'},
    0x51698: {"kind": 'reg', "py": 'r[3] = 0xFFFFD034', "slot_py": None, "target": None, "cond": None},
    0x5169a: {"kind": 'mem', "py": 'r[1] = s8(_rdw(ram, 0xFFFFD034, 1))', "slot_py": None, "target": None, "cond": None},
    0x5169c: {"kind": 'reg', "py": 'T = 1 if (r[1] & r[1]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x5169e: {"kind": "branch", "py": None, "slot_py": '', "target": 0x516c0, "cond": 'notT'},
    0x516a2: {"kind": 'reg', "py": 'r[2] = 0xFFFFD0E4', "slot_py": None, "target": None, "cond": None},
    0x516a4: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFD0E4, 1))', "slot_py": None, "target": None, "cond": None},
    0x516a6: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x516a8: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x516aa: {"kind": "branch", "py": None, "slot_py": '', "target": 0x516ba, "cond": 'T'},
    0x516ae: {"kind": 'reg', "py": 'r[1] = 0xFFFFCFB4', "slot_py": None, "target": None, "cond": None},
    0x516b0: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCFB4, 1))', "slot_py": None, "target": None, "cond": None},
    0x516b2: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x516b4: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x516b6: {"kind": "branch", "py": None, "slot_py": '', "target": 0x516c0, "cond": 'notT'},
    0x516ba: {"kind": 'reg', "py": 'r[2] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x516bc: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFD0E7, 1, r[2])', "target": 0x516c4, "cond": 'always'},
    0x516c0: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x516c2: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD0E7, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x516c4: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
