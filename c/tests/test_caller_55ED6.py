#!/usr/bin/env python3
"""Differential test for caller_55ED6 (entry 0x55ED6) — v8 ST caller (CFG), 20 bytes.
...
Run: python3 test_caller_55ED6.py
"""
...
CODE = {
    0x55ed6: {"kind": 'fpu', "py": 'fr[6] = 0.0', "slot_py": None, "target": None, "cond": None},
    0x55ed8: {"kind": 'reg', "py": 'r[2] = 0x000024D0', "slot_py": None, "target": None, "cond": None},
    0x55eda: {"kind": 'st', "py": 'local[0x3FC] = pr\n_wrw(ram, STACK_BASE + 0x3FC, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x55edc: {"kind": 'reg', "py": 'r[3] = 0xFFFFBC1C', "slot_py": None, "target": None, "cond": None},
    0x55ede: {"kind": 'fpu', "py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFBC1C, 4))', "slot_py": None, "target": None, "cond": None},
    0x55ee0: {"kind": "call", "py": None, "slot_py": 'fr[5] = 1.0', "target": 0x24d0, "ret_pc": 0x55ee4, "set_pr": True, "cond": None},
    0x55ee4: {"kind": 'st', "py": 'pr = _rdw(ram, STACK_BASE + 0x3FC, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x55ee6: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},
