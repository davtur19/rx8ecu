#!/usr/bin/env python3
"""Differential test for caller_9DC2 (entry 0x9DC2) — v8 ST caller (CFG), 14 bytes.
...
Run: python3 test_caller_9DC2.py
"""
...
CODE = {
    0x9dc2: {"kind": 'st', "py": 'local[0x3FC] = pr\n_wrw(ram, STACK_BASE + 0x3FC, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x9dc4: {"kind": 'reg', "py": 'r[3] = 0x0000D0C0', "slot_py": None, "target": None, "cond": None},
    0x9dc6: {"kind": "call", "py": None, "slot_py": '', "target": 0xd0c0, "ret_pc": 0x9dca, "set_pr": True, "cond": None},
    0x9dca: {"kind": 'st', "py": 'pr = _rdw(ram, STACK_BASE + 0x3FC, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x9dcc: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},
    0xd0c0: {"kind": 'reg', "py": 'r[4] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0xd0c2: {"kind": 'reg', "py": 'T = 1 if (r[4] & r[4]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0xd0c4: {"kind": "branch", "py": None, "slot_py": '', "target": 0xd0d2, "cond": 'notT'},
    0xd0c8: {"kind": 'reg', "py": 'r[3] = 0xFFFFE414', "slot_py": None, "target": None, "cond": None},
    0xd0ca: {"kind": 'mem', "py": 'r[4] = s16(_rdw(ram, 0xFFFFE414, 2))', "slot_py": None, "target": None, "cond": None},
    0xd0cc: {"kind": 'reg', "py": 'r[1] = 0xFFFFE40E', "slot_py": None, "target": None, "cond": None},
    0xd0ce: {"kind": "branch", "py": None, "slot_py": 'r[4] = (~r[4]) & 0xFFFFFFFF', "target": 0xd0da, "cond": 'always'},
    0xd0d2: {"kind": 'reg', "py": 'r[3] = 0xFFFFE614', "slot_py": None, "target": None, "cond": None},
    0xd0d4: {"kind": 'mem', "py": 'r[4] = s16(_rdw(ram, 0xFFFFE614, 2))', "slot_py": None, "target": None, "cond": None},
    0xd0d6: {"kind": 'reg', "py": 'r[4] = (~r[4]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xd0d8: {"kind": 'reg', "py": 'r[1] = 0xFFFFE60E', "slot_py": None, "target": None, "cond": None},
    0xd0da: {"kind": 'mem', "py": 'r[2] = s16(_rdw(ram, r[1], 2))', "slot_py": None, "target": None, "cond": None},
    0xd0dc: {"kind": 'reg', "py": 'r[4] = (r[4] & r[2]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xd0de: {"kind": 'reg', "py": 'r[5] = r[4] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0xd0e0: {"kind": 'reg', "py": 'r[2] = 0x0000FF00', "slot_py": None, "target": None, "cond": None},
    0xd0e2: {"kind": 'reg', "py": 'r[3] = r[5] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0xd0e4: {"kind": 'reg', "py": 'r[3] = (r[3] << 8) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xd0e6: {"kind": 'reg', "py": 'r[2] = (r[2] & r[5]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xd0e8: {"kind": 'reg', "py": 'r[2] = (r[2] >> 8) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xd0ea: {"kind": 'reg', "py": 'r[4] = r[3]', "slot_py": None, "target": None, "cond": None},
    0xd0ec: {"kind": 'reg', "py": 'r[4] = (r[4] | r[2]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xd0ee: {"kind": "ret", "py": None, "slot_py": 'r[0] = r[4]', "target": None, "cond": None},
}
