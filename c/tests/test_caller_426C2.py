#!/usr/bin/env python3
"""Differential test for caller_426C2 (entry 0x426C2) — v8 ST caller (CFG), 40 bytes.
...
Run: python3 test_caller_426C2.py
"""
...
CODE = {
    0x426c2: {"kind": 'fpu', "py": 'fr[6] = 1.0', "slot_py": None, "target": None, "cond": None},
    0x426c4: {"kind": 'reg', "py": 'r[0] = 0x00042790', "slot_py": None, "target": None, "cond": None},
    0x426c6: {"kind": 'fpu', "py": 'fr[6] = ts(fr[6] + fr[6])', "slot_py": None, "target": None, "cond": None},
    0x426c8: {"kind": 'reg', "py": 'r[3] = 0xFFFFC0D8', "slot_py": None, "target": None, "cond": None},
    0x426ca: {"kind": 'st', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x426cc: {"kind": 'fpu', "py": 'fr[5] = bits2f(_rdw(ram, 0x00042790, 4))', "slot_py": None, "target": None, "cond": None},
    0x426ce: {"kind": 'reg', "py": 'r[2] = 0x00002404', "slot_py": None, "target": None, "cond": None},
    0x426d0: {"kind": "call", "py": None, "slot_py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFC0D8, 4))', "target": 0x2404, "ret_pc": 0x426d4, "set_pr": True, "cond": None},
    0x426d4: {"kind": 'reg', "py": 'r[1] = 0xFFFFC8EC', "slot_py": None, "target": None, "cond": None},
    0x426d6: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFC8EC, 4, f2bits(fr[0]))', "slot_py": None, "target": None, "cond": None},
    0x426d8: {"kind": 'reg', "py": 'r[3] = 0x0007A1A4', "slot_py": None, "target": None, "cond": None},
    0x426da: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x0007A1A4, 4))', "slot_py": None, "target": None, "cond": None},
    0x426dc: {"kind": 'reg', "py": 'r[2] = 0xFFFFB594', "slot_py": None, "target": None, "cond": None},
    0x426de: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0xFFFFB594, 4))', "slot_py": None, "target": None, "cond": None},
    0x426e0: {"kind": 'reg', "py": 'r[1] = 0xFFFFC8E8', "slot_py": None, "target": None, "cond": None},
    0x426e2: {"kind": 'fpu', "py": 'fr[2] = ts(fr[2] * fr[3])', "slot_py": None, "target": None, "cond": None},
    0x426e4: {"kind": 'st', "py": 'pr = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x426e6: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFC8E8, 4, f2bits(fr[2]))', "target": None, "cond": None},
