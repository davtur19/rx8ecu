#!/usr/bin/env python3
"""Differential test for caller_323B2 (entry 0x323B2) — v8 ST caller (CFG), 40 bytes.
...
Run: python3 test_caller_323B2.py
"""
...
CODE = {
    0x323b2: {"kind": 'mem', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, r[14])\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x323b4: {"kind": 'st', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x323b6: {"kind": 'reg', "py": 'r[14] = 0xFFFFBFA6', "slot_py": None, "target": None, "cond": None},
    0x323b8: {"kind": 'reg', "py": 'r[3] = 0xFFFFBFA7', "slot_py": None, "target": None, "cond": None},
    0x323ba: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFBFA7, 1))', "slot_py": None, "target": None, "cond": None},
    0x323bc: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x323be: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x323c0: {"kind": "branch", "py": None, "slot_py": '', "target": 0x323ca, "cond": 'notT'},
    0x323c4: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x323c6: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFBFA6, 1, r[1])', "target": 0x323d4, "cond": 'always'},
    0x323ca: {"kind": 'reg', "py": 'r[5] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x323cc: {"kind": 'reg', "py": 'r[1] = 0x00002478', "slot_py": None, "target": None, "cond": None},
    0x323ce: {"kind": "call", "py": None, "slot_py": 'r[4] = s8(_rdw(ram, 0xFFFFBFA6, 1))', "target": 0x2478, "ret_pc": 0x323d2, "set_pr": True, "cond": None},
    0x323d2: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBFA6, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x323d4: {"kind": 'st', "py": 'pr = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x323d6: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},
