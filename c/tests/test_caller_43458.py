#!/usr/bin/env python3
"""Differential test for caller_43458 (entry 0x43458) — v8 ST caller (CFG), 30 bytes.
...
Run: python3 test_caller_43458.py
"""
...
CODE = {
    0x43458: {"kind": 'st', "py": 'local[0x3FC] = pr\n_wrw(ram, STACK_BASE + 0x3FC, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x4345a: {"kind": 'reg', "py": 'r[0] = 0x00043524', "slot_py": None, "target": None, "cond": None},
    0x4345c: {"kind": 'reg', "py": 'r[3] = 0x0007AE30', "slot_py": None, "target": None, "cond": None},
    0x4345e: {"kind": 'fpu', "py": 'fr[7] = bits2f(_rdw(ram, 0x00043524, 4))', "slot_py": None, "target": None, "cond": None},
    0x43460: {"kind": 'fpu', "py": 'fr[6] = bits2f(_rdw(ram, 0x0007AE30, 4))', "slot_py": None, "target": None, "cond": None},
    0x43462: {"kind": 'reg', "py": 'r[2] = 0xFFFFC9B0', "slot_py": None, "target": None, "cond": None},
    0x43464: {"kind": 'reg', "py": 'r[1] = 0xFFFFAA88', "slot_py": None, "target": None, "cond": None},
    0x43466: {"kind": 'fpu', "py": 'fr[5] = bits2f(_rdw(ram, 0xFFFFC9B0, 4))', "slot_py": None, "target": None, "cond": None},
    0x43468: {"kind": 'reg', "py": 'r[3] = 0x000023B0', "slot_py": None, "target": None, "cond": None},
    0x4346a: {"kind": "call", "py": None, "slot_py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFAA88, 4))', "target": 0x23b0, "ret_pc": 0x4346e, "set_pr": True, "cond": None},
    0x4346e: {"kind": 'reg', "py": 'r[2] = 0xFFFFC9B0', "slot_py": None, "target": None, "cond": None},
    0x43470: {"kind": 'st', "py": 'pr = _rdw(ram, STACK_BASE + 0x3FC, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x43472: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFC9B0, 4, f2bits(fr[0]))', "target": None, "cond": None},
