#!/usr/bin/env python3
"""Differential test for semaphore_post_4C880 (0x4C880) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_semaphore_post_4C880_4c880.py
"""
...
CODE = {
    0x4c880: {"kind": 'reg', "py": 'r[1] = 0xFFFFCEB4', "slot_py": None, "target": None, "cond": None},
    0x4c882: {"kind": 'reg', "py": 'r[3] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x4c884: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFCEB4, 2, r[3])', "target": None, "cond": None},}
