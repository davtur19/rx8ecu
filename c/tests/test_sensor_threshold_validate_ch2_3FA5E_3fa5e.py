#!/usr/bin/env python3
"""Differential test for sensor_threshold_validate_ch2_3FA5E (0x3FA5E) — v3 lift + v4 FPU, 40 bytes.
...
Run from repo root: python3 c/tests/test_sensor_threshold_validate_ch2_3FA5E_3fa5e.py
"""
...
ENTRY = 0x3FA5E
RAW = bytes.fromhex("93 52 94 52 F4 38 D2 36 F3 28 F3 45 8F 03 00 09 E0 00 A0 07 24 00 D1 33 F2 18 F4 25 8F 02 00 09 E0 01 24 00 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFC6C1
SPAN_END = 0x3FA86
SENT = 0x3FA86     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x3fa5e: {"kind": 'reg', "py": 'r[3] = 0xFFFFC6B8', "slot_py": None, "target": None, "cond": None},
    0x3fa60: {"kind": 'reg', "py": 'r[4] = 0xFFFFC6C1', "slot_py": None, "target": None, "cond": None},
    0x3fa62: {"kind": 'fpu', "py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFC6B8, 4))', "slot_py": None, "target": None, "cond": None},
    0x3fa64: {"kind": 'reg', "py": 'r[2] = 0x0007AF20', "slot_py": None, "target": None, "cond": None},
    0x3fa66: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x0007AF20, 4))', "slot_py": None, "target": None, "cond": None},
    0x3fa68: {"kind": 'fpu', "py": 'T = 1 if fr[3] > fr[4] else 0', "slot_py": None, "target": None, "cond": None},
    0x3fa6a: {"kind": "branch", "py": None, "slot_py": '', "target": 0x3fa74, "cond": 'notT'},
    0x3fa6e: {"kind": 'reg', "py": 'r[0] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x3fa70: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFC6C1, 1, r[0])', "target": 0x3fa82, "cond": 'always'},
    0x3fa74: {"kind": 'reg', "py": 'r[1] = 0x0007AF1C', "slot_py": None, "target": None, "cond": None},
    0x3fa76: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0x0007AF1C, 4))', "slot_py": None, "target": None, "cond": None},
    0x3fa78: {"kind": 'fpu', "py": 'T = 1 if fr[4] > fr[2] else 0', "slot_py": None, "target": None, "cond": None},
    0x3fa7a: {"kind": "branch", "py": None, "slot_py": '', "target": 0x3fa82, "cond": 'notT'},
    0x3fa7e: {"kind": 'reg', "py": 'r[0] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x3fa80: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC6C1, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x3fa82: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
