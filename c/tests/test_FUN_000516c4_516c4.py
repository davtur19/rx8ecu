#!/usr/bin/env python3
"""Differential test for FUN_000516c4 (0x516C4) — v3 lift + v4 FPU, 32 bytes.
...
Run from repo root: python3 c/tests/test_FUN_000516c4_516c4.py
"""
...
ENTRY = 0x516C4
RAW = bytes.fromhex("00 0B 00 09 2F E6 2F D6 2F C6 2F B6 2F A6 93 63 92 63 F5 38 F4 28 91 5A 93 58 64 11 67 30 9A 5D")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFD0E7
SPAN_END = 0x516E4
SENT = 0x516E4     # stop-sentinel, placed past the literal pool
...
CODE = {
    ...
    0x516c8: {"kind": 'mem', "py": 'local[0x3FC] = r[14]\n_wrw(ram, STACK_BASE + 0x3FC, 4, r[14])\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x516ca: {"kind": 'mem', "py": 'local[0x3F8] = r[13]\n_wrw(ram, STACK_BASE + 0x3F8, 4, r[13])\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x516cc: {"kind": 'mem', "py": 'local[0x3F4] = r[12]\n_wrw(ram, STACK_BASE + 0x3F4, 4, r[12])\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x516ce: {"kind": 'mem', "py": 'local[0x3F0] = r[11]\n_wrw(ram, STACK_BASE + 0x3F0, 4, r[11])\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x516d0: {"kind": 'mem', "py": 'local[0x3EC] = r[10]\n_wrw(ram, STACK_BASE + 0x3EC, 4, r[10])\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x516d2: {"kind": 'reg', "py": 'r[3] = 0xFFFFD01C', "slot_py": None, "target": None, "cond": None},
    0x516d4: {"kind": 'reg', "py": 'r[2] = 0xFFFFD020', "slot_py": None, "target": None, "cond": None},
    0x516d6: {"kind": 'fpu', "py": 'fr[5] = bits2f(_rdw(ram, 0xFFFFD01C, 4))', "slot_py": None, "target": None, "cond": None},
    0x516d8: {"kind": 'fpu', "py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFD020, 4))', "slot_py": None, "target": None, "cond": None},
    0x516da: {"kind": 'reg', "py": 'r[1] = 0xFFFFCFE6', "slot_py": None, "target": None, "cond": None},
    0x516dc: {"kind": 'reg', "py": 'r[3] = 0xFFFFD0E7', "slot_py": None, "target": None, "cond": None},
    0x516de: {"kind": 'mem', "py": 'r[4] = s16(_rdw(ram, 0xFFFFCFE6, 2))', "slot_py": None, "target": None, "cond": None},
    0x516e0: {"kind": 'mem', "py": 'r[7] = s8(_rdw(ram, 0xFFFFD0E7, 1))', "slot_py": None, "target": None, "cond": None},
    0x516e2: {"kind": 'reg', "py": 'r[10] = 0xFFFFD0E2', "slot_py": None, "target": None, "cond": None},}
