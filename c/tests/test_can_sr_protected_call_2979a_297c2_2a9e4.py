#!/usr/bin/env python3
"""Differential test for can_sr_protected_call_2979a_297c2 (0x2A9E4) — v3 lift (branches + delay slots), 54 bytes.
...
Run from repo root: python3 c/tests/test_can_sr_protected_call_2979a_297c2_2a9e4.py
"""
...
ENTRY = 0x2A9E4
RAW = bytes.fromhex("88 01 8F 05 00 09 93 4D 60 30 20 08 8D 0B 00 09 92 49 61 21 21 18 8F 09 00 09 93 45 60 31 60 0D 40 15 8F 03 00 09 E3 01 A0 02 26 30 E1 00 26 10 4F 26 00 0B 6E F6")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFAADA
SPAN_END = 0x2AA1A
SENT = 0x2AA1A     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x2a9e4: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x2a9e6: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2a9f4, "cond": 'notT'},
    0x2a9ea: {"kind": 'reg', "py": 'r[3] = 0xFFFFAADA', "slot_py": None, "target": None, "cond": None},
    0x2a9ec: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFAADA, 1))', "slot_py": None, "target": None, "cond": None},
    0x2a9ee: {"kind": 'reg', "py": 'T = 1 if (r[0] & r[0]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x2a9f0: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2aa0a, "cond": 'T'},
    0x2a9f4: {"kind": 'reg', "py": 'r[2] = 0xFFFFA9BC', "slot_py": None, "target": None, "cond": None},
    0x2a9f6: {"kind": 'mem', "py": 'r[1] = s16(_rdw(ram, 0xFFFFA9BC, 2))', "slot_py": None, "target": None, "cond": None},
    0x2a9f8: {"kind": 'reg', "py": 'T = 1 if (r[1] & r[1]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x2a9fa: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2aa10, "cond": 'notT'},
    0x2a9fe: {"kind": 'reg', "py": 'r[3] = 0xFFFFA9BE', "slot_py": None, "target": None, "cond": None},
    0x2aa00: {"kind": 'mem', "py": 'r[0] = s16(_rdw(ram, 0xFFFFA9BE, 2))', "slot_py": None, "target": None, "cond": None},
    0x2aa02: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x2aa04: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) > 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x2aa06: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2aa10, "cond": 'notT'},
    0x2aa0a: {"kind": 'reg', "py": 'r[3] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x2aa0c: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, r[6], 1, r[3])', "target": 0x2aa14, "cond": 'always'},
    0x2aa10: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x2aa12: {"kind": 'mem', "py": '_wrw(ram, r[6], 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x2aa14: {"kind": 'mem', "py": 'pr = _rdw(ram, STACK_BASE + 0x400, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x2aa16: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, STACK_BASE + 0x404, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},}
