#!/usr/bin/env python3
"""Differential test for FUN_00066ca4 (0x66CA4) — v3 lift (branches + delay slots), 32 bytes.
...
Run from repo root: python3 c/tests/test_FUN_00066ca4_66ca4.py
"""
...
ENTRY = 0x66CA4
RAW = bytes.fromhex("D3 16 E4 00 D5 16 60 43 23 40 25 41 81 51 90 14 80 54 60 43 80 55 80 56 80 57 80 58 00 0B 80 59")
SEED = 43
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFDC08
SPAN_END = 0x66CC4
SENT = 0x66CC4     # stop-sentinel, placed past the literal pool
