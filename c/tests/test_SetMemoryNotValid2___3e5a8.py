#!/usr/bin/env python3
"""Differential test for SetMemoryNotValid2__ (0x3E5A8) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_SetMemoryNotValid2___3e5a8.py
"""
...
ENTRY = 0x3E5A8
RAW = bytes.fromhex("92 86 E3 01 00 0B 22 30")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFC639
SPAN_END = 0x3E5B0
SENT = 0x3E5B0     # stop-sentinel, placed past the literal pool
