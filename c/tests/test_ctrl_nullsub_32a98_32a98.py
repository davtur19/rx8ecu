#!/usr/bin/env python3
"""Differential test for ctrl_nullsub_32a98 (0x32A98) — v3 lift (branches + delay slots), 36 bytes.
...
Run from repo root: python3 c/tests/test_ctrl_nullsub_32a98_32a98.py
"""
...
ENTRY = 0x32A98
RAW = bytes.fromhex("D3 1F 23 E0 D2 1F 22 60 D1 1F 21 70 90 2B 63 00 D2 19 22 30 93 28 61 30 D2 18 22 10 6C F6 6D F6 00 0B 6E F6")
SEED = 0
N = 2000
MAXSTEPS = 100000
