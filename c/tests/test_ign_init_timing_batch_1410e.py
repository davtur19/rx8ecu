#!/usr/bin/env python3
"""Differential test for ign_init_timing_batch (0x1410E) — v3 lift + v4 FPU, 28 bytes.
...
Run from repo root: python3 c/tests/test_ign_init_timing_batch_1410e.py
"""
...
ENTRY = 0x1410E
RAW = bytes.fromhex("60 0C 88 15 8F 07 00 09 D2 13 60 21 20 08 8F 02 00 09 91 16 21 40 D3 16 00 0B F3 5A")
SEED = 42
N = 500
MAXSTEPS = 100000
