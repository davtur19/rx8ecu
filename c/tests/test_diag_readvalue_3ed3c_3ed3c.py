#!/usr/bin/env python3
"""Differential test for diag_readvalue_3ed3c (0x3ED3C) — v3 lift + v4 FPU, 22 bytes.
...
Run from repo root: python3 c/tests/test_diag_readvalue_3ed3c_3ed3c.py
"""
...
ENTRY = 0x3ED3C
RAW = bytes.fromhex("A0 07 24 00 D1 1C F2 18 F4 25 8F 02 00 09 E0 01 24 00 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
CODE = {
    0x3ed3c: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, r[4], 1, r[0])', "target": 0x3ed4e, "cond": 'always'},
    ...
    0x3ed4c: {"kind": 'mem', "py": '_wrw(ram, r[4], 1, r[0])', "slot_py": None, "target": None, "cond": None},
