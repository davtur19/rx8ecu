#!/usr/bin/env python3
"""Differential test for obd_service_handler_657E2 (0x657E2) — v3 lift (branches + delay slots), 20 bytes.
...
Run from repo root: python3 c/tests/test_obd_service_handler_657E2_657e2.py
"""
...
ENTRY = 0x657E2
RAW = bytes.fromhex("7F 18 4F 26 68 F6 69 F6 6A F6 6B F6 6C F6 6D F6 00 0B 6E F6")
SEED = 0
N = 2000
MAXSTEPS = 100000
STACK_BASE = 0xFFFFD000
STACK_TOP = STACK_BASE + 0x400
STACK_OFFS = (0x418, 0x41C, 0x420, 0x424, 0x428, 0x42C, 0x430, 0x434)
SEED_OFFS = (0x418,)   # lds.l pr/macl/mach slots seeded with the return sentinel
RAM_MIN = None
RAM_MAX = None
SPAN_END = 0x657F6
SENT = 0x657F6     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x657e2: {"kind": 'reg', "py": 'r[15] = (r[15] + s8(0x18)) & 0xFFFFFFFF\nsp = (sp + s8(0x18)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x657e4: {"kind": 'mem', "py": 'pr = _rdw(ram, STACK_BASE + 0x418, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x657e6: {"kind": 'mem', "py": 'r[8] = _rdw(ram, STACK_BASE + 0x41C, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x657e8: {"kind": 'mem', "py": 'r[9] = _rdw(ram, STACK_BASE + 0x420, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x657ea: {"kind": 'mem', "py": 'r[10] = _rdw(ram, STACK_BASE + 0x424, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x657ec: {"kind": 'mem', "py": 'r[11] = _rdw(ram, STACK_BASE + 0x428, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x657ee: {"kind": 'mem', "py": 'r[12] = _rdw(ram, STACK_BASE + 0x42C, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x657f0: {"kind": 'mem', "py": 'r[13] = _rdw(ram, STACK_BASE + 0x430, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x657f2: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, STACK_BASE + 0x434, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},}
