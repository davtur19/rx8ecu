#!/usr/bin/env python3
"""Differential test for knock_threshold_initializer (0x1B49C) — v3 lift (branches + delay slots), 20 bytes.
...
Run from repo root: python3 c/tests/test_knock_threshold_initializer_1b49c.py
"""
...
CODE = {
    0x1b49c: {"kind": 'reg', "py": 'r[2] = 0x0006FCA0', "slot_py": None, "target": None, "cond": None},
    0x1b49e: {"kind": 'reg', "py": 'r[4] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x1b4a0: {"kind": 'reg', "py": 'r[1] = 0xFFFFAAD8', "slot_py": None, "target": None, "cond": None},
    0x1b4a2: {"kind": 'mem', "py": 'r[3] = s16(_rdw(ram, 0x0006FCA0, 2))', "slot_py": None, "target": None, "cond": None},
    0x1b4a4: {"kind": 'reg', "py": 'r[2] = 0xFFFFAADA', "slot_py": None, "target": None, "cond": None},
    0x1b4a6: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFAAD8, 2, r[3])', "slot_py": None, "target": None, "cond": None},
    0x1b4a8: {"kind": 'reg', "py": 'r[3] = 0xFFFFAADB', "slot_py": None, "target": None, "cond": None},
    0x1b4aa: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFAADB, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x1b4ac: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFAADA, 1, r[4])', "target": None, "cond": None},}
