#!/usr/bin/env python3
"""Differential test for dtc_fuel_system_reset_45740 (0x45740) — v3 lift (branches + delay slots), 50 bytes.
...
Run from repo root: python3 c/tests/test_dtc_fuel_system_reset_45740_45740.py
"""
...
CODE = {
    0x45740: {"kind": 'reg', "py": 'r[3] = 0xFFFFD201', "slot_py": None, "target": None, "cond": None},
    0x45742: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFD201, 1))', "slot_py": None, "target": None, "cond": None},
    0x45744: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x45746: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x45748: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4576e, "cond": 'notT'},
    0x4574c: {"kind": 'reg', "py": 'r[2] = 0xFFFFA41C', "slot_py": None, "target": None, "cond": None},
    0x4574e: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFA41C, 1))', "slot_py": None, "target": None, "cond": None},
    0x45750: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x45752: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x45754: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4576e, "cond": 'notT'},
    0x45758: {"kind": 'reg', "py": 'r[3] = 0xFFFFCBDD', "slot_py": None, "target": None, "cond": None},
    0x4575a: {"kind": 'reg', "py": 'r[4] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x4575c: {"kind": 'reg', "py": 'r[2] = 0xFFFFCBDE', "slot_py": None, "target": None, "cond": None},
    0x4575e: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCBDD, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x45760: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCBDE, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x45762: {"kind": 'reg', "py": 'r[1] = 0xFFFFCBDC', "slot_py": None, "target": None, "cond": None},
    0x45764: {"kind": 'reg', "py": 'r[3] = 0xFFFFCBDF', "slot_py": None, "target": None, "cond": None},
    0x45766: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCBDC, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x45768: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCBDF, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x4576a: {"kind": 'reg', "py": 'r[2] = 0xFFFFCBE0', "slot_py": None, "target": None, "cond": None},
    0x4576c: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCBE0, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x4576e: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
