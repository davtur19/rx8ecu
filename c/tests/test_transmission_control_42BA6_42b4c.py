#!/usr/bin/env python3
"""Differential test for transmission_control_42BA6 (0x42B4C) — v3 lift + v4 FPU, 14 bytes.
...
Run from repo root: python3 c/tests/test_transmission_control_42BA6_42b4c.py
"""
...
ENTRY = 0x42B4C
RAW = bytes.fromhex("6D F6 00 0B 6E F6 F3 8D 93 01 00 0B F3 3A")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFC914
SPAN_END = 0x42B5A
SENT = 0x42B5C     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x42b4c: {"kind": 'mem', "py": 'r[13] = _rdw(ram, STACK_BASE + 0x400, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x42b4e: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, STACK_BASE + 0x404, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},
    0x42b52: {"kind": 'fpu', "py": 'fr[3] = 0.0', "slot_py": None, "target": None, "cond": None},
    0x42b54: {"kind": 'reg', "py": 'r[3] = 0xFFFFC914', "slot_py": None, "target": None, "cond": None},
    0x42b56: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFC914, 4, f2bits(fr[3]))', "target": None, "cond": None},}
