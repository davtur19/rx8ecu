#!/usr/bin/env python3
"""Differential test for obd_cat_monitor_eff_calc (0x4A308) — v3 lift (branches + delay slots), 18 bytes.
...
Run from repo root: python3 c/tests/test_obd_cat_monitor_eff_calc_4a308.py
"""
...
ENTRY = 0x4A308
RAW = bytes.fromhex("D3 3C 62 31 30 22 8F 02 00 09 E3 01 25 30 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = None
SPAN_END = 0x4A31A
SENT = 0x4A31A     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x4a308: {"kind": 'reg', "py": 'r[3] = 0x0007C5C4', "slot_py": None, "target": None, "cond": None},
    0x4a30a: {"kind": 'mem', "py": 'r[2] = s16(_rdw(ram, 0x0007C5C4, 2))', "slot_py": None, "target": None, "cond": None},
    0x4a30c: {"kind": 'reg', "py": 'T = 1 if r[0] >= r[2] else 0', "slot_py": None, "target": None, "cond": None},
    0x4a30e: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4a316, "cond": 'notT'},
    0x4a312: {"kind": 'reg', "py": 'r[3] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x4a314: {"kind": 'mem', "py": '_wrw(ram, r[5], 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x4a316: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
