#!/usr/bin/env python3
"""Differential test for canister_purge_0x4F734 (0x4F734) — v3 lift (branches + delay slots), 28 bytes.
...
Run from repo root: python3 c/tests/test_canister_purge_0x4F734_4f734.py
"""
...
ENTRY = 0x4F734
RAW = bytes.fromhex("94 67 92 67 63 20 63 3C 43 15 8F 03 00 09 E1 01 A0 02 24 10 E0 00 24 00 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    0x4f734: {"kind": 'reg', "py": 'r[4] = 0xFFFFCFFC', "slot_py": None, "target": None, "cond": None},
    0x4f736: {"kind": 'reg', "py": 'r[2] = 0xFFFFCFC1', "slot_py": None, "target": None, "cond": None},
    0x4f738: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFCFC1, 1))', "slot_py": None, "target": None, "cond": None},
    0x4f73a: {"kind": 'reg', "py": 'r[3] = r[3] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x4f73c: {"kind": 'reg', "py": 'T = 1 if s32(r[3]) > 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x4f73e: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4f748, "cond": 'notT'},
    0x4f742: {"kind": 'reg', "py": 'r[1] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x4f744: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFCFFC, 1, r[1])', "target": 0x4f74c, "cond": 'always'},
    0x4f748: {"kind": 'reg', "py": 'r[0] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x4f74a: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCFFC, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x4f74c: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
