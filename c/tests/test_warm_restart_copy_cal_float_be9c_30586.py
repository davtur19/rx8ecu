#!/usr/bin/env python3
"""Differential test for warm_restart_copy_cal_float_be9c (0x30586) — v3 lift + v4 FPU, 24 bytes.
...
Run from repo root: python3 c/tests/test_warm_restart_copy_cal_float_be9c_30586.py
"""
...
ENTRY = 0x30586
RAW = bytes.fromhex("D3 41 60 30 60 0C 88 01 8F 04 00 09 D2 3D 91 6A F3 28 F1 3A 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBE9C
SPAN_END = 0x3059E
SENT = 0x3059E     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x30586: {"kind": 'reg', "py": 'r[3] = 0xFFFF9F8C', "slot_py": None, "target": None, "cond": None},
    0x30588: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFF9F8C, 1))', "slot_py": None, "target": None, "cond": None},
    0x3058a: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x3058c: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x3058e: {"kind": "branch", "py": None, "slot_py": '', "target": 0x3059a, "cond": 'notT'},
    0x30592: {"kind": 'reg', "py": 'r[2] = 0x00077018', "slot_py": None, "target": None, "cond": None},
    0x30594: {"kind": 'reg', "py": 'r[1] = 0xFFFFBE9C', "slot_py": None, "target": None, "cond": None},
    0x30596: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x00077018, 4))', "slot_py": None, "target": None, "cond": None},
    0x30598: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFBE9C, 4, f2bits(fr[3]))', "slot_py": None, "target": None, "cond": None},
    0x3059a: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
