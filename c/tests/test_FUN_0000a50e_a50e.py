#!/usr/bin/env python3
"""Differential test for FUN_0000a50e (0xA50E) — v3 lift (branches + delay slots), 20 bytes.
...
Run from repo root: python3 c/tests/test_FUN_0000a50e_a50e.py
"""
...
ENTRY = 0xA50E
RAW = bytes.fromhex("E2 02 91 39 21 21 93 39 90 37 20 31 92 37 93 37 00 0B 23 21")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFF71C
SPAN_END = 0xA522
SENT = 0xA522     # stop-sentinel, placed past the literal pool
...
CODE = {
    0xa50e: {"kind": 'reg', "py": 'r[2] = s8(0x02)', "slot_py": None, "target": None, "cond": None},
    0xa510: {"kind": 'reg', "py": 'r[1] = 0xFFFFF710', "slot_py": None, "target": None, "cond": None},
    0xa512: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFF710, 2, r[2])', "slot_py": None, "target": None, "cond": None},
    0xa514: {"kind": 'reg', "py": 'r[3] = 0x000000C0', "slot_py": None, "target": None, "cond": None},
    0xa516: {"kind": 'reg', "py": 'r[0] = 0xFFFFF718', "slot_py": None, "target": None, "cond": None},
    0xa518: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFF718, 2, r[3])', "slot_py": None, "target": None, "cond": None},
    0xa51a: {"kind": 'reg', "py": 'r[2] = 0x000009C3', "slot_py": None, "target": None, "cond": None},
    0xa51c: {"kind": 'reg', "py": 'r[3] = 0xFFFFF71C', "slot_py": None, "target": None, "cond": None},
    0xa51e: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFF71C, 2, r[2])', "target": None, "cond": None},}
