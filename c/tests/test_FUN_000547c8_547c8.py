#!/usr/bin/env python3
"""Differential test for FUN_000547c8 (0x547C8) — v3 lift (branches + delay slots), 50 bytes.
...
Run from repo root: python3 c/tests/test_FUN_000547c8_547c8.py
"""
...
ENTRY = 0x547C8
RAW = bytes.fromhex("25 58 8D 0B 00 09 93 57 60 30 60 0C 88 01 8D 05 00 09 92 52 61 20 21 18 8F 03 00 09 93 4E A0 06 23 60 60 53 88 01 8F 02 00 09 92 47 22 70 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFD201
SPAN_END = 0x547FA
SENT = 0x547FA     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x547c8: {"kind": 'reg', "py": 'T = 1 if (r[5] & r[5]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x547ca: {"kind": "branch", "py": None, "slot_py": '', "target": 0x547e4, "cond": 'T'},
    0x547ce: {"kind": 'reg', "py": 'r[3] = 0xFFFFD201', "slot_py": None, "target": None, "cond": None},
    0x547d0: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFD201, 1))', "slot_py": None, "target": None, "cond": None},
    0x547d2: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x547d4: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x547d6: {"kind": "branch", "py": None, "slot_py": '', "target": 0x547e4, "cond": 'T'},
    0x547da: {"kind": 'reg', "py": 'r[2] = 0xFFFFA428', "slot_py": None, "target": None, "cond": None},
    0x547dc: {"kind": 'mem', "py": 'r[1] = s8(_rdw(ram, 0xFFFFA428, 1))', "slot_py": None, "target": None, "cond": None},
    0x547de: {"kind": 'reg', "py": 'T = 1 if (r[1] & r[1]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x547e0: {"kind": "branch", "py": None, "slot_py": '', "target": 0x547ea, "cond": 'notT'},
    0x547e4: {"kind": 'reg', "py": 'r[3] = 0xFFFFD1DF', "slot_py": None, "target": None, "cond": None},
    0x547e6: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFD1DF, 1, r[6])', "target": 0x547f6, "cond": 'always'},
    0x547ea: {"kind": 'reg', "py": 'r[0] = r[5]', "slot_py": None, "target": None, "cond": None},
    0x547ec: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x547ee: {"kind": "branch", "py": None, "slot_py": '', "target": 0x547f6, "cond": 'notT'},
    0x547f2: {"kind": 'reg', "py": 'r[2] = 0xFFFFD1DF', "slot_py": None, "target": None, "cond": None},
    0x547f4: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD1DF, 1, r[7])', "slot_py": None, "target": None, "cond": None},
    0x547f6: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
