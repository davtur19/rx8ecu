#!/usr/bin/env python3
"""Differential test for getAlternatorSpeedConditonal (0x26308) — v3 lift + v4 FPU, 56 bytes.
...
Run from repo root: python3 c/tests/test_getAlternatorSpeedConditonal_26308.py
"""
...
ENTRY = 0x26308
RAW = bytes.fromhex("D4 33 D3 34 F5 48 F3 38 95 55 F5 31 D2 32 F2 28 91 52 F1 18 96 51 F1 22 F5 1A F4 1C F3 48 F3 45 8D 03 00 09 E1 01 A0 05 26 10 F5 45 8F 02 00 09 E3 00 26 30 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFB663
SPAN_END = 0x26340
SENT = 0x26340     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x26308: {"kind": 'reg', "py": 'r[4] = 0x00074A20', "slot_py": None, "target": None, "cond": None},
    0x2630a: {"kind": 'reg', "py": 'r[3] = 0x00074A24', "slot_py": None, "target": None, "cond": None},
    0x2630c: {"kind": 'fpu', "py": 'fr[5] = bits2f(_rdw(ram, r[4], 4))', "slot_py": None, "target": None, "cond": None},
    0x2630e: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x00074A24, 4))', "slot_py": None, "target": None, "cond": None},
    0x26310: {"kind": 'reg', "py": 'r[5] = 0xFFFFB5E4', "slot_py": None, "target": None, "cond": None},
    0x26312: {"kind": 'fpu', "py": 'fr[5] = ts(fr[5] - fr[3])', "slot_py": None, "target": None, "cond": None},
    0x26314: {"kind": 'reg', "py": 'r[2] = 0x00074A1C', "slot_py": None, "target": None, "cond": None},
    0x26316: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0x00074A1C, 4))', "slot_py": None, "target": None, "cond": None},
    0x26318: {"kind": 'reg', "py": 'r[1] = 0xFFFFB594', "slot_py": None, "target": None, "cond": None},
    0x2631a: {"kind": 'fpu', "py": 'fr[1] = bits2f(_rdw(ram, 0xFFFFB594, 4))', "slot_py": None, "target": None, "cond": None},
    0x2631c: {"kind": 'reg', "py": 'r[6] = 0xFFFFB663', "slot_py": None, "target": None, "cond": None},
    0x2631e: {"kind": 'fpu', "py": 'fr[1] = ts(fr[1] * fr[2])', "slot_py": None, "target": None, "cond": None},
    0x26320: {"kind": 'fpu', "py": '_wrw(ram, r[5], 4, f2bits(fr[1]))', "slot_py": None, "target": None, "cond": None},
    0x26322: {"kind": 'fpu', "py": 'fr[4] = fr[1]', "slot_py": None, "target": None, "cond": None},
    0x26324: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, r[4], 4))', "slot_py": None, "target": None, "cond": None},
    0x26326: {"kind": 'fpu', "py": 'T = 1 if fr[3] > fr[4] else 0', "slot_py": None, "target": None, "cond": None},
    0x26328: {"kind": "branch", "py": None, "slot_py": '', "target": 0x26332, "cond": 'T'},
    0x2632c: {"kind": 'reg', "py": 'r[1] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x2632e: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFB663, 1, r[1])', "target": 0x2633c, "cond": 'always'},
    0x26332: {"kind": 'fpu', "py": 'T = 1 if fr[5] > fr[4] else 0', "slot_py": None, "target": None, "cond": None},
    0x26334: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2633c, "cond": 'notT'},
    0x26338: {"kind": 'reg', "py": 'r[3] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x2633a: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFB663, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x2633c: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
