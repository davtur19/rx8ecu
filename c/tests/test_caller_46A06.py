#!/usr/bin/env python3
"""Differential test for call-composition caller_46A06 (entry 0x46A06) — v7 ST caller + callee lib, flattened CODE with nested returns.
...
Run: python3 /home/davide/ailocal/rx8ecu/c/tests/test_caller_46A06.py
"""
...
CODE = {
    0x46a06: {"kind": 'reg', "py": 'r[4] = 0xFFFF8760', "slot_py": None, "target": None, "cond": None},
    0x46a08: {"kind": 'reg', "py": 'r[3] = 0x0003EE58', "slot_py": None, "target": None, "cond": None},
    0x46a0a: {"kind": "call", "py": None, "slot_py": 'r[5] = s8(0x00)', "target": 0x3ee58, "ret_pc": 0x46a0e, "set_pr": False, "cond": None},
