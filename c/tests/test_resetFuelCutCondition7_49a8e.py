#!/usr/bin/env python3
"""Differential test for resetFuelCutCondition7 (0x49A8E) — v3 lift (branches + delay slots), 48 bytes.
...
Run from repo root: python3 c/tests/test_resetFuelCutCondition7_49a8e.py
"""
...
ENTRY = 0x49A8E
RAW = bytes.fromhex("94 35 92 33 63 20 23 38 8F 0E 00 09 D1 1B 60 10 60 0C 88 02 8F 0A 00 09 D3 1D 60 30 20 08 8F 05 00 09 E1 01 A0 02 24 10 E0 00 24 00 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCFD9
SPAN_END = 0x49ABE
SENT = 0x49ABE     # stop-sentinel, placed past the literal pool
