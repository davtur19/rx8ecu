#!/usr/bin/env python3
"""Differential test for fault_flag_cce8_eval (0x4A6B0) — v3 lift (branches + delay slots), 60 bytes.
...
Run from repo root: python3 c/tests/test_fault_flag_cce8_eval_4a6b0.py
"""
...
ENTRY = 0x4A6B0
RAW = bytes.fromhex("94 18 93 18 60 30 60 0C 88 01 8D 0B 00 09 92 13 60 20 60 0C 88 01 8F 08 00 09 91 0E 60 10 20 08 8F 03 00 09 92 05 A0 02 24 20 E1 00 24 10 00 0B 00 09 00 80 CC E8 A4 1C A4 2C A4 28")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCCE8
SPAN_END = 0x4A6EC
SENT = 0x4A6EC     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x4a6b0: {"kind": 'reg', "py": 'r[4] = 0xFFFFCCE8', "slot_py": None, "target": None, "cond": None},
    0x4a6b2: {"kind": 'reg', "py": 'r[3] = 0xFFFFA41C', "slot_py": None, "target": None, "cond": None},
    0x4a6b4: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFA41C, 1))', "slot_py": None, "target": None, "cond": None},
    0x4a6b6: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x4a6b8: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x4a6ba: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4a6d4, "cond": 'T'},
    0x4a6be: {"kind": 'reg', "py": 'r[2] = 0xFFFFA42C', "slot_py": None, "target": None, "cond": None},
    0x4a6c0: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFA42C, 1))', "slot_py": None, "target": None, "cond": None},
    0x4a6c2: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x4a6c4: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x4a6c6: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4a6da, "cond": 'notT'},
    0x4a6ca: {"kind": 'reg', "py": 'r[1] = 0xFFFFA428', "slot_py": None, "target": None, "cond": None},
    0x4a6cc: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFA428, 1))', "slot_py": None, "target": None, "cond": None},
    0x4a6ce: {"kind": 'reg', "py": 'T = 1 if (r[0] & r[0]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x4a6d0: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4a6da, "cond": 'notT'},
    0x4a6d4: {"kind": 'reg', "py": 'r[2] = 0x00000080', "slot_py": None, "target": None, "cond": None},
    0x4a6d6: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFCCE8, 1, r[2])', "target": 0x4a6de, "cond": 'always'},
    0x4a6da: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x4a6dc: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCCE8, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x4a6de: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
