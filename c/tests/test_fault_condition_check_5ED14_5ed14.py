#!/usr/bin/env python3
"""Differential test for fault_condition_check_5ED14 (0x5ED14) — v3 lift (branches + delay slots), 24 bytes.
...
Run from repo root: python3 c/tests/test_fault_condition_check_5ED14_5ed14.py
"""
...
ENTRY = 0x5ED14
RAW = bytes.fromhex("D2 06 63 21 91 08 63 3D 33 13 8F 02 00 09 A0 01 E4 00 E4 01 00 0B 60 43")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFD3C0
SPAN_END = 0x5ED2C
SENT = 0x5ED34     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x5ed14: {"kind": 'reg', "py": 'r[2] = 0xFFFFD3C0', "slot_py": None, "target": None, "cond": None},
    0x5ed16: {"kind": 'mem', "py": 'r[3] = s16(_rdw(ram, 0xFFFFD3C0, 2))', "slot_py": None, "target": None, "cond": None},
    0x5ed18: {"kind": 'reg', "py": 'r[1] = 0x00000271', "slot_py": None, "target": None, "cond": None},
    0x5ed1a: {"kind": 'reg', "py": 'r[3] = r[3] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x5ed1c: {"kind": 'reg', "py": 'T = 1 if s32(r[3]) >= s32(r[1]) else 0', "slot_py": None, "target": None, "cond": None},
    0x5ed1e: {"kind": "branch", "py": None, "slot_py": '', "target": 0x5ed26, "cond": 'notT'},
    0x5ed22: {"kind": "branch", "py": None, "slot_py": 'r[4] = s8(0x00)', "target": 0x5ed28, "cond": 'always'},
    0x5ed26: {"kind": 'reg', "py": 'r[4] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x5ed28: {"kind": "ret", "py": None, "slot_py": 'r[0] = r[4]', "target": None, "cond": None},}
