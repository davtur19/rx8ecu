#!/usr/bin/env python3
"""Differential test for crank_flags_enable (0x7ED8) — v3 lift (branches + delay slots), 22 bytes.
...
Run from repo root: python3 c/tests/test_crank_flags_enable_7ed8.py
"""
