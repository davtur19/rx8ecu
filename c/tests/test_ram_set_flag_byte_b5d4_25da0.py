#!/usr/bin/env python3
"""Differential test for ram_set_flag_byte_b5d4 (0x25DA0) — v3 lift (branches + delay slots), 10 bytes.
...
Run from repo root: python3 c/tests/test_ram_set_flag_byte_b5d4_25da0.py
"""
...
ENTRY = 0x25DA0
RAW = bytes.fromhex("90 02 E1 01 00 0B 20 10 B5 D4")
SEED = 43
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFB5D4
SPAN_END = 0x25DAA
SENT = 0x25DAA     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x25da0: {"kind": 'reg', "py": 'r[0] = 0xFFFFB5D4', "slot_py": None, "target": None, "cond": None},
    0x25da2: {"kind": 'reg', "py": 'r[1] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x25da4: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFB5D4, 1, r[1])', "target": None, "cond": None},}
