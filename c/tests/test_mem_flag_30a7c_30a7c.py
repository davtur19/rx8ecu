#!/usr/bin/env python3
"""Differential test for mem_flag_30a7c (0x30A7C) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_mem_flag_30a7c_30a7c.py
"""
...
CODE = {
    0x30a7c: {"kind": 'reg', "py": 'r[2] = 0xFFFFBE44', "slot_py": None, "target": None, "cond": None},
    0x30a7e: {"kind": 'reg', "py": 'r[3] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x30a80: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBE44, 1, r[3])', "target": None, "cond": None},}
