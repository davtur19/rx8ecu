#!/usr/bin/env python3
"""Differential test for atu_get_rx_byte_count (0x1FA2) — v3 lift (branches + delay slots), 26 bytes.
...
Run from repo root: python3 c/tests/test_atu_get_rx_byte_count_1fa2.py
"""
...
ENTRY = 0x1FA2
RAW = bytes.fromhex("60 4C 63 5C 33 03 89 06 75 01 63 74 62 5C 26 30 32 03 8F F9 76 01 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = None
SPAN_END = 0x1FBC
SENT = 0x1FBC     # stop-sentinel, placed past the literal pool
