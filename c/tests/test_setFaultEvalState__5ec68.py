#!/usr/bin/env python3
"""Differential test for setFaultEvalState_ (0x5EC68) — v3 lift (branches + delay slots), 58 bytes.
...
Run from repo root: python3 c/tests/test_setFaultEvalState__5ec68.py
"""
...
ENTRY = 0x5EC68
RAW = bytes.fromhex("93 71 E5 01 60 30 60 0C 88 01 8F 01 64 53 E4 03 D2 37 63 21 63 3D 23 58 8D 03 00 09 25 58 8F 02 00 09 E1 04 24 1B 93 5F 60 30 60 0C 88 01 8F 02 00 09 E1 08 24 1B 00 0B 60 43")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCFB9
SPAN_END = 0x5ECA2
SENT = 0x5ECA2     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x5ec68: {"kind": 'reg', "py": 'r[3] = 0xFFFFCFB9', "slot_py": None, "target": None, "cond": None},
    0x5ec6a: {"kind": 'reg', "py": 'r[5] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x5ec6c: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCFB9, 1))', "slot_py": None, "target": None, "cond": None},
    0x5ec6e: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x5ec70: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x5ec72: {"kind": "branch", "py": None, "slot_py": 'r[4] = r[5]', "target": 0x5ec78, "cond": 'notT'},
    0x5ec76: {"kind": 'reg', "py": 'r[4] = s8(0x03)', "slot_py": None, "target": None, "cond": None},
    0x5ec78: {"kind": 'reg', "py": 'r[2] = 0xFFFF9EC8', "slot_py": None, "target": None, "cond": None},
    0x5ec7a: {"kind": 'mem', "py": 'r[3] = s16(_rdw(ram, 0xFFFF9EC8, 2))', "slot_py": None, "target": None, "cond": None},
    0x5ec7c: {"kind": 'reg', "py": 'r[3] = r[3] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x5ec7e: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[5]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x5ec80: {"kind": "branch", "py": None, "slot_py": '', "target": 0x5ec8a, "cond": 'T'},
    0x5ec84: {"kind": 'reg', "py": 'T = 1 if (r[5] & r[5]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x5ec86: {"kind": "branch", "py": None, "slot_py": '', "target": 0x5ec8e, "cond": 'notT'},
    0x5ec8a: {"kind": 'reg', "py": 'r[1] = s8(0x04)', "slot_py": None, "target": None, "cond": None},
    0x5ec8c: {"kind": 'reg', "py": 'r[4] = (r[4] | r[1]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x5ec8e: {"kind": 'reg', "py": 'r[3] = 0xFFFFCF9C', "slot_py": None, "target": None, "cond": None},
    0x5ec90: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCF9C, 1))', "slot_py": None, "target": None, "cond": None},
    0x5ec92: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x5ec94: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x5ec96: {"kind": "branch", "py": None, "slot_py": '', "target": 0x5ec9e, "cond": 'notT'},
    0x5ec9a: {"kind": 'reg', "py": 'r[1] = s8(0x08)', "slot_py": None, "target": None, "cond": None},
    0x5ec9c: {"kind": 'reg', "py": 'r[4] = (r[4] | r[1]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x5ec9e: {"kind": "ret", "py": None, "slot_py": 'r[0] = r[4]', "target": None, "cond": None},}
