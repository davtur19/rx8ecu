#!/usr/bin/env python3
"""Differential test for task_delete_4C3C6 (0x4C3C6) — v3 lift (branches + delay slots), 38 bytes.
...
Run from repo root: python3 c/tests/test_task_delete_4C3C6_4c3c6.py
"""
...
RAM_MAX = 0xFFFFCE7C
SPAN_END = 0x4C3EC
SENT = 0x4C3EC     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x4c3c6: {"kind": 'reg', "py": 'r[5] = 0xFFFFCE7C', "slot_py": None, "target": None, "cond": None},
    0x4c3c8: {"kind": 'reg', "py": 'r[3] = 0xFFFFA41C', "slot_py": None, "target": None, "cond": None},
    0x4c3ca: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFA41C, 1))', "slot_py": None, "target": None, "cond": None},
    0x4c3cc: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x4c3ce: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x4c3d0: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4c3e4, "cond": 'notT'},
    0x4c3d4: {"kind": 'mem', "py": 'r[4] = _rdw(ram, 0xFFFFCE7C, 4)', "slot_py": None, "target": None, "cond": None},
    0x4c3d6: {"kind": 'reg', "py": 'r[1] = s8(0xFF)', "slot_py": None, "target": None, "cond": None},
    0x4c3d8: {"kind": 'reg', "py": 'T = 1 if (r[4] & 0xFFFFFFFF) >= (r[1] & 0xFFFFFFFF) else 0', "slot_py": None, "target": None, "cond": None},
    0x4c3da: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4c3e8, "cond": 'T'},
    0x4c3de: {"kind": 'reg', "py": 'r[4] = (r[4] + s8(0x01)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x4c3e0: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFCE7C, 4, r[4])', "target": 0x4c3e8, "cond": 'always'},
    0x4c3e4: {"kind": 'reg', "py": 'r[2] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x4c3e6: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCE7C, 4, r[2])', "slot_py": None, "target": None, "cond": None},
    0x4c3e8: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
