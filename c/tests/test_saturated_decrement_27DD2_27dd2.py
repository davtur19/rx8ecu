#!/usr/bin/env python3
"""Differential test for saturated_decrement_27DD2 (0x27DD2) — v3 lift (branches + delay slots), 34 bytes.
...
Run from repo root: python3 c/tests/test_saturated_decrement_27DD2_27dd2.py
"""
...
CODE = {
    0x27dd2: {"kind": 'reg', "py": 'r[3] = 0xFFFFB71C', "slot_py": None, "target": None, "cond": None},
    0x27dd4: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFB71C, 1))', "slot_py": None, "target": None, "cond": None},
    0x27dd6: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x27dd8: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x27dda: {"kind": "branch", "py": None, "slot_py": '', "target": 0x27df0, "cond": 'notT'},
    0x27dde: {"kind": 'reg', "py": 'r[5] = 0xFFFFB716', "slot_py": None, "target": None, "cond": None},
    0x27de0: {"kind": 'mem', "py": 'r[4] = s16(_rdw(ram, 0xFFFFB716, 2))', "slot_py": None, "target": None, "cond": None},
    0x27de2: {"kind": 'reg', "py": 'r[1] = r[4] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x27de4: {"kind": 'reg', "py": 'T = 1 if s32(r[1]) > 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x27de6: {"kind": "branch", "py": None, "slot_py": '', "target": 0x27df0, "cond": 'notT'},
    0x27dea: {"kind": 'reg', "py": 'r[1] = 0x0000FFFF', "slot_py": None, "target": None, "cond": None},
    0x27dec: {"kind": 'reg', "py": 'r[4] = (r[4] + r[1]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x27dee: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFB716, 2, r[4])', "slot_py": None, "target": None, "cond": None},
    0x27df0: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
