#!/usr/bin/env python3
"""Differential test for ctrl_predict_550e6 (0x550E6) — v3 lift (branches + delay slots), 40 bytes.
...
Run from repo root: python3 c/tests/test_ctrl_predict_550e6_550e6.py
"""
...
ENTRY = 0x550E6
RAW = bytes.fromhex("94 15 93 18 60 30 60 0C 88 01 8F 09 00 09 92 13 60 20 60 0C 88 01 8F 03 00 09 E3 01 A0 02 24 30 E1 00 24 10 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    0x550e6: {"kind": 'reg', "py": 'r[4] = 0xFFFFD1F9', "slot_py": None, "target": None, "cond": None},
    0x550e8: {"kind": 'reg', "py": 'r[3] = 0xFFFFC99C', "slot_py": None, "target": None, "cond": None},
    0x550ea: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFC99C, 1))', "slot_py": None, "target": None, "cond": None},
    0x550ec: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x550ee: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x550f0: {"kind": "branch", "py": None, "slot_py": '', "target": 0x55106, "cond": 'notT'},
    0x550f4: {"kind": 'reg', "py": 'r[2] = 0xFFFFC99E', "slot_py": None, "target": None, "cond": None},
    0x550f6: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFC99E, 1))', "slot_py": None, "target": None, "cond": None},
    0x550f8: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x550fa: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x550fc: {"kind": "branch", "py": None, "slot_py": '', "target": 0x55106, "cond": 'notT'},
    0x55100: {"kind": 'reg', "py": 'r[3] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x55102: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFD1F9, 1, r[3])', "target": 0x5510a, "cond": 'always'},
    0x55106: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x55108: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD1F9, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x5510a: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
