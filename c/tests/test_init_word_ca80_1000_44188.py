#!/usr/bin/env python3
"""Differential test for init_word_ca80_1000 (0x44188) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_init_word_ca80_1000_44188.py
"""
...
ENTRY = 0x44188
RAW = bytes.fromhex("93 6C 92 6C 00 0B 22 31")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCA80
SPAN_END = 0x44190
SENT = 0x44190     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x44188: {"kind": 'reg', "py": 'r[3] = 0x000003E8', "slot_py": None, "target": None, "cond": None},
    0x4418a: {"kind": 'reg', "py": 'r[2] = 0xFFFFCA80', "slot_py": None, "target": None, "cond": None},
    0x4418c: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFCA80, 2, r[3])', "target": None, "cond": None},}
