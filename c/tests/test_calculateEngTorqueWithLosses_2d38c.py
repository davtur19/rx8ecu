#!/usr/bin/env python3
"""Differential test for calculateEngTorqueWithLosses (0x2D38C) — v3 lift + v4 FPU, 22 bytes.
...
Run from repo root: python3 c/tests/test_calculateEngTorqueWithLosses_2d38c.py
"""
...
ENTRY = 0x2D38C
RAW = bytes.fromhex("93 35 F3 38 92 2D F2 28 91 32 F2 30 92 31 F1 18 F2 10 00 0B F2 2A")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBCEC
SPAN_END = 0x2D3A2
SENT = 0x2D3A2     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x2d38c: {"kind": 'reg', "py": 'r[3] = 0xFFFFBCE8', "slot_py": None, "target": None, "cond": None},
    0x2d38e: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFBCE8, 4))', "slot_py": None, "target": None, "cond": None},
    0x2d390: {"kind": 'reg', "py": 'r[2] = 0xFFFFBCCC', "slot_py": None, "target": None, "cond": None},
    0x2d392: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0xFFFFBCCC, 4))', "slot_py": None, "target": None, "cond": None},
    0x2d394: {"kind": 'reg', "py": 'r[1] = 0xFFFFBCEC', "slot_py": None, "target": None, "cond": None},
    0x2d396: {"kind": 'fpu', "py": 'fr[2] = ts(fr[2] + fr[3])', "slot_py": None, "target": None, "cond": None},
    0x2d398: {"kind": 'reg', "py": 'r[2] = 0xFFFFBCD4', "slot_py": None, "target": None, "cond": None},
    0x2d39a: {"kind": 'fpu', "py": 'fr[1] = bits2f(_rdw(ram, 0xFFFFBCEC, 4))', "slot_py": None, "target": None, "cond": None},
    0x2d39c: {"kind": 'fpu', "py": 'fr[2] = ts(fr[2] + fr[1])', "slot_py": None, "target": None, "cond": None},
    0x2d39e: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBCD4, 4, f2bits(fr[2]))', "target": None, "cond": None},}
