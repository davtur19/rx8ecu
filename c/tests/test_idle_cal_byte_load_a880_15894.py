#!/usr/bin/env python3
"""Differential test for idle_cal_byte_load_a880 (0x15894) — v3 lift (branches + delay slots), 10 bytes.
...
Run from repo root: python3 c/tests/test_idle_cal_byte_load_a880_15894.py
"""
...
ENTRY = 0x15894
RAW = bytes.fromhex("D2 49 63 20 D1 49 00 0B 21 30")
SEED = 43
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFA880
SPAN_END = 0x1589E
SENT = 0x1589E     # stop-sentinel, placed past the literal pool
