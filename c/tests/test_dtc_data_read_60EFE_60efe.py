#!/usr/bin/env python3
"""Differential test for dtc_data_read_60EFE (0x60EFE) — v3 lift (branches + delay slots), 36 bytes.
...
Run from repo root: python3 c/tests/test_dtc_data_read_60EFE_60efe.py
"""
...
ENTRY = 0x60EFE
RAW = bytes.fromhex("60 4C 93 10 88 00 8D 05 65 31 88 01 8D 05 00 09 A0 05 00 09 64 5D A0 03 44 19 A0 01 64 53 E4 00 00 0B 60 43")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFD3F0
SPAN_END = 0x60F22
SENT = 0x60F26     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x60efe: {"kind": 'reg', "py": 'r[0] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x60f00: {"kind": 'reg', "py": 'r[3] = 0xFFFFD3F0', "slot_py": None, "target": None, "cond": None},
    0x60f02: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x00) else 0', "slot_py": None, "target": None, "cond": None},
    0x60f04: {"kind": "branch", "py": None, "slot_py": 'r[5] = s16(_rdw(ram, 0xFFFFD3F0, 2))', "target": 0x60f12, "cond": 'T'},
    0x60f08: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x60f0a: {"kind": "branch", "py": None, "slot_py": '', "target": 0x60f18, "cond": 'T'},
    0x60f0e: {"kind": "branch", "py": None, "slot_py": '', "target": 0x60f1c, "cond": 'always'},
    0x60f12: {"kind": 'reg', "py": 'r[4] = r[5] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x60f14: {"kind": "branch", "py": None, "slot_py": 'r[4] = (r[4] >> 8) & 0xFFFFFFFF', "target": 0x60f1e, "cond": 'always'},
    0x60f18: {"kind": "branch", "py": None, "slot_py": 'r[4] = r[5]', "target": 0x60f1e, "cond": 'always'},
    0x60f1c: {"kind": 'reg', "py": 'r[4] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x60f1e: {"kind": "ret", "py": None, "slot_py": 'r[0] = r[4]', "target": None, "cond": None},}
