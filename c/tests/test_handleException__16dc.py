#!/usr/bin/env python3
"""Differential test for handleException_ (0x16DC) — v3 lift (branches + delay slots), 18 bytes.
...
Run from repo root: python3 c/tests/test_handleException__16dc.py
"""
...
ENTRY = 0x16DC
RAW = bytes.fromhex("A0 03 E4 00 A0 01 E4 FE 64 73 60 43 6D F6 00 0B 6E F6")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = None
SPAN_END = 0x16EE
SENT = 0x16EE     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x16dc: {"kind": "branch", "py": None, "slot_py": 'r[4] = s8(0x00)', "target": 0x16e6, "cond": 'always'},
    0x16e0: {"kind": "branch", "py": None, "slot_py": 'r[4] = s8(0xFE)', "target": 0x16e6, "cond": 'always'},
    0x16e4: {"kind": 'reg', "py": 'r[4] = r[7]', "slot_py": None, "target": None, "cond": None},
    0x16e6: {"kind": 'reg', "py": 'r[0] = r[4]', "slot_py": None, "target": None, "cond": None},
    0x16e8: {"kind": 'mem', "py": 'r[13] = _rdw(ram, STACK_BASE + 0x400, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x16ea: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, STACK_BASE + 0x404, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},}
