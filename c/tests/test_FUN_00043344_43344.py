#!/usr/bin/env python3
"""Differential test for FUN_00043344 (0x43344) — pure straight-line lift, 8 bytes.
...
Run from repo root: python3 c/tests/test_FUN_00043344_43344.py
"""
...
ENTRY = 0x43344
RAW = bytes.fromhex("E5 01 6B E3 6D E3 E0 01")
SEED = 42
N = 2000
