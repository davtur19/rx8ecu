#!/usr/bin/env python3
"""Differential test for utility_bitfield_check_2C5EC (0x2C5EC) — v3 lift (branches + delay slots), 30 bytes.
...
Run from repo root: python3 c/tests/test_utility_bitfield_check_2C5EC_2c5ec.py
"""
...
RAM_MAX = 0xFFFFBC58
SPAN_END = 0x2C60A
SENT = 0x2C60A     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x2c5ec: {"kind": 'reg', "py": 'r[4] = 0xFFFFBC38', "slot_py": None, "target": None, "cond": None},
    0x2c5ee: {"kind": 'reg', "py": 'r[2] = 0xFFFFBC58', "slot_py": None, "target": None, "cond": None},
    0x2c5f0: {"kind": 'reg', "py": 'r[0] = 0x0007BA1E', "slot_py": None, "target": None, "cond": None},
    0x2c5f2: {"kind": 'mem', "py": 'r[3] = s16(_rdw(ram, 0xFFFFBC58, 2))', "slot_py": None, "target": None, "cond": None},
    0x2c5f4: {"kind": 'mem', "py": 'r[1] = s16(_rdw(ram, 0x0007BA1E, 2))', "slot_py": None, "target": None, "cond": None},
    0x2c5f6: {"kind": 'reg', "py": 'T = 1 if (r[3] & 0xFFFFFFFF) >= (r[1] & 0xFFFFFFFF) else 0', "slot_py": None, "target": None, "cond": None},
    0x2c5f8: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2c602, "cond": 'notT'},
    0x2c5fc: {"kind": 'reg', "py": 'r[1] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x2c5fe: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFBC38, 1, r[1])', "target": 0x2c606, "cond": 'always'},
    0x2c602: {"kind": 'reg', "py": 'r[3] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x2c604: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBC38, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x2c606: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
