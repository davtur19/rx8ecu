#!/usr/bin/env python3
"""Differential test for FUN_0003397a (0x3397A) — mem lift (RAM-only, straight-line), 8 bytes.
...
Run from repo root: python3 c/tests/test_FUN_0003397a_3397a.py
"""
...
ENTRY = 0x3397A
RAW = bytes.fromhex("60 53 D2 28 63 20 D2 2A")
SEED = 42
N = 2000
