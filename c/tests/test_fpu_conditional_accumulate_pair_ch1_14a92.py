#!/usr/bin/env python3
"""Differential test for fpu_conditional_accumulate_pair_ch1 (0x14A92) — v3 lift + v4 FPU, 54 bytes.
...
Run from repo root: python3 c/tests/test_fpu_conditional_accumulate_pair_ch1_14a92.py
"""
...
ENTRY = 0x14A92
RAW = bytes.fromhex("96 1E 94 1E D2 14 63 20 23 38 8F 0C 00 09 95 19 D3 12 F2 58 F3 38 D1 11 F2 30 F4 2A F3 18 F2 58 F2 30 A0 06 F6 2A 93 0E F3 38 F4 3A 91 0C F3 18 F6 3A 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFA6F0
SPAN_END = 0x14AC8
SENT = 0x14AC8     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x14a92: {"kind": 'reg', "py": 'r[6] = 0xFFFFA7A8', "slot_py": None, "target": None, "cond": None},
    0x14a94: {"kind": 'reg', "py": 'r[4] = 0xFFFFA7A4', "slot_py": None, "target": None, "cond": None},
    0x14a96: {"kind": 'reg', "py": 'r[2] = 0x0006E431', "slot_py": None, "target": None, "cond": None},
    0x14a98: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0x0006E431, 1))', "slot_py": None, "target": None, "cond": None},
    0x14a9a: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x14a9c: {"kind": "branch", "py": None, "slot_py": '', "target": 0x14ab8, "cond": 'notT'},
    0x14aa0: {"kind": 'reg', "py": 'r[5] = 0xFFFFA644', "slot_py": None, "target": None, "cond": None},
    0x14aa2: {"kind": 'reg', "py": 'r[3] = 0x00075B90', "slot_py": None, "target": None, "cond": None},
    0x14aa4: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, r[5], 4))', "slot_py": None, "target": None, "cond": None},
    0x14aa6: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x00075B90, 4))', "slot_py": None, "target": None, "cond": None},
    0x14aa8: {"kind": 'reg', "py": 'r[1] = 0x00075B94', "slot_py": None, "target": None, "cond": None},
    0x14aaa: {"kind": 'fpu', "py": 'fr[2] = ts(fr[2] + fr[3])', "slot_py": None, "target": None, "cond": None},
    0x14aac: {"kind": 'fpu', "py": '_wrw(ram, r[4], 4, f2bits(fr[2]))', "slot_py": None, "target": None, "cond": None},
    0x14aae: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x00075B94, 4))', "slot_py": None, "target": None, "cond": None},
    0x14ab0: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, r[5], 4))', "slot_py": None, "target": None, "cond": None},
    0x14ab2: {"kind": 'fpu', "py": 'fr[2] = ts(fr[2] + fr[3])', "slot_py": None, "target": None, "cond": None},
    0x14ab4: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, r[6], 4, f2bits(fr[2]))', "target": 0x14ac4, "cond": 'always'},
    0x14ab8: {"kind": 'reg', "py": 'r[3] = 0xFFFFA6EC', "slot_py": None, "target": None, "cond": None},
    0x14aba: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFA6EC, 4))', "slot_py": None, "target": None, "cond": None},
    0x14abc: {"kind": 'fpu', "py": '_wrw(ram, r[4], 4, f2bits(fr[3]))', "slot_py": None, "target": None, "cond": None},
    0x14abe: {"kind": 'reg', "py": 'r[1] = 0xFFFFA6F0', "slot_py": None, "target": None, "cond": None},
    0x14ac0: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFA6F0, 4))', "slot_py": None, "target": None, "cond": None},
    0x14ac2: {"kind": 'fpu', "py": '_wrw(ram, r[6], 4, f2bits(fr[3]))', "slot_py": None, "target": None, "cond": None},
    0x14ac4: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
