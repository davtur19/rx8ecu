#!/usr/bin/env python3
"""Differential test for caller_327CE (entry 0x327CE) — v8 ST caller (CFG), 82 bytes.
...
Run: python3 test_caller_327CE.py
"""
...
CODE = {
    0x327ce: {"kind": 'mem', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, r[14])\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x327d0: {"kind": 'st', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x327d2: {"kind": 'reg', "py": 'r[2] = 0xFFFFBC6D', "slot_py": None, "target": None, "cond": None},
    0x327d4: {"kind": 'reg', "py": 'r[6] = 0xFFFFBFD6', "slot_py": None, "target": None, "cond": None},
    0x327d6: {"kind": 'mem', "py": 'r[4] = s8(_rdw(ram, 0xFFFFBC6D, 1))', "slot_py": None, "target": None, "cond": None},
    0x327d8: {"kind": 'reg', "py": 'r[3] = 0xFFFFBD1D', "slot_py": None, "target": None, "cond": None},
    0x327da: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFBD1D, 1))', "slot_py": None, "target": None, "cond": None},
    0x327dc: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x327de: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x327e0: {"kind": "branch", "py": None, "slot_py": 'r[5] = s8(0x00)', "target": 0x32800, "cond": 'notT'},
    0x327e4: {"kind": 'reg', "py": 'r[0] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x327e6: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x327e8: {"kind": "branch", "py": None, "slot_py": '', "target": 0x32800, "cond": 'notT'},
    0x327ec: {"kind": 'reg', "py": 'r[1] = 0xFFFFBFDA', "slot_py": None, "target": None, "cond": None},
    0x327ee: {"kind": 'mem', "py": 'r[0] = s16(_rdw(ram, 0xFFFFBFDA, 2))', "slot_py": None, "target": None, "cond": None},
    0x327f0: {"kind": 'reg', "py": 'r[3] = 0x00077A10', "slot_py": None, "target": None, "cond": None},
    0x327f2: {"kind": 'mem', "py": 'r[2] = s16(_rdw(ram, r[3], 2))', "slot_py": None, "target": None, "cond": None},
    0x327f4: {"kind": 'reg', "py": 'T = 1 if (r[0] & 0xFFFFFFFF) >= (r[2] & 0xFFFFFFFF) else 0', "slot_py": None, "target": None, "cond": None},
    0x327f6: {"kind": "branch", "py": None, "slot_py": '', "target": 0x32800, "cond": 'notT'},
    0x327fa: {"kind": 'reg', "py": 'r[3] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x327fc: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFBFD6, 1, r[3])', "target": 0x32802, "cond": 'always'},
    0x32802: {"kind": 'reg', "py": 'r[0] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x32804: {"kind": 'reg', "py": 'r[14] = 0xFFFFBFDA', "slot_py": None, "target": None, "cond": None},
    0x32806: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x32808: {"kind": "branch", "py": None, "slot_py": '', "target": 0x32818, "cond": 'notT'},
    0x3280c: {"kind": 'reg', "py": 'r[2] = 0x00002460', "slot_py": None, "target": None, "cond": None},
    0x3280e: {"kind": 'reg', "py": 'r[5] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x32810: {"kind": "call", "py": None, "slot_py": 'r[4] = s16(_rdw(ram, 0xFFFFBFDA, 2))', "target": 0x2460, "ret_pc": 0x32814, "set_pr": True, "cond": None},
    0x32814: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFBFDA, 2, r[0])', "target": 0x3281a, "cond": 'always'},
    0x3281a: {"kind": 'st', "py": 'pr = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x3281c: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None, },
    0x32818: {"kind": 'mem', "py": '_wrw(ram, r[14], 2, r[5])', "slot_py": None, "target": None, "cond": None},
    0x32800: {"kind": 'mem', "py": '_wrw(ram, r[6], 1, r[5])', "slot_py": None, "target": None, "cond": None},
