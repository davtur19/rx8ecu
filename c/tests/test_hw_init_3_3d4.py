#!/usr/bin/env python3
"""Differential test for hw_init_3 (0x3D4) — v3 lift (branches + delay slots), 12 bytes.
...
Run from repo root: python3 c/tests/test_hw_init_3_3d4.py
"""
...
ENTRY = 0x3D4
RAW = bytes.fromhex("92 16 E3 00 91 12 22 31 00 0B 21 31")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    0x3d4: {"kind": 'reg', "py": 'r[2] = 0xFFFFDFB6', "slot_py": None, "target": None, "cond": None},
    0x3d6: {"kind": 'reg', "py": 'r[3] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x3d8: {"kind": 'reg', "py": 'r[1] = 0xFFFFDFB4', "slot_py": None, "target": None, "cond": None},
    0x3da: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFDFB6, 2, r[3])', "slot_py": None, "target": None, "cond": None},
    0x3dc: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFDFB4, 2, r[3])', "target": None, "cond": None},}
