#!/usr/bin/env python3
"""Differential test for immo_init_check_dispatch (0x35104) — pure straight-line lift, 8 bytes.
...
Run from repo root: python3 c/tests/test_immo_init_check_dispatch_35104.py
"""
...
ENTRY = 0x35104
RAW = bytes.fromhex("00 07 99 6C 00 07 99 70")
SEED = 42
N = 2000
