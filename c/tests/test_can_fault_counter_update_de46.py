#!/usr/bin/env python3
"""Differential test for can_fault_counter_update (0xDE46) — v3 lift + v4 FPU, 44 bytes.
...
Run from repo root: python3 c/tests/test_can_fault_counter_update_de46.py
"""
...
ENTRY = 0xDE46
RAW = bytes.fromhex("95 47 D3 2D F3 38 92 45 F2 28 F3 25 8F 04 00 09 D1 29 60 10 A0 08 25 00 64 50 61 4C 21 18 8D 03 00 09 90 38 34 0C 25 40 00 0B 00 09")
SEED = 43
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFB5DC
SPAN_END = 0xDE72
SENT = 0xDE72     # stop-sentinel, placed past the literal pool
...
CODE = {
    0xde46: {"kind": 'reg', "py": 'r[5] = 0xFFFFA400', "slot_py": None, "target": None, "cond": None},
    0xde48: {"kind": 'reg', "py": 'r[3] = 0x0006D48C', "slot_py": None, "target": None, "cond": None},
    0xde4a: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x0006D48C, 4))', "slot_py": None, "target": None, "cond": None},
    0xde4c: {"kind": 'reg', "py": 'r[2] = 0xFFFFB5DC', "slot_py": None, "target": None, "cond": None},
    0xde4e: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0xFFFFB5DC, 4))', "slot_py": None, "target": None, "cond": None},
    0xde50: {"kind": 'fpu', "py": 'T = 1 if fr[3] > fr[2] else 0', "slot_py": None, "target": None, "cond": None},
    0xde52: {"kind": "branch", "py": None, "slot_py": '', "target": 0xde5e, "cond": 'notT'},
    0xde56: {"kind": 'reg', "py": 'r[1] = 0x0006D488', "slot_py": None, "target": None, "cond": None},
    0xde58: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0x0006D488, 1))', "slot_py": None, "target": None, "cond": None},
    0xde5a: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFA400, 1, r[0])', "target": 0xde6e, "cond": 'always'},
    0xde5e: {"kind": 'mem', "py": 'r[4] = s8(_rdw(ram, r[5], 1))', "slot_py": None, "target": None, "cond": None},
    0xde60: {"kind": 'reg', "py": 'r[1] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0xde62: {"kind": 'reg', "py": 'T = 1 if (r[1] & r[1]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0xde64: {"kind": "branch", "py": None, "slot_py": '', "target": 0xde6e, "cond": 'T'},
    0xde68: {"kind": 'reg', "py": 'r[0] = 0x000000FF', "slot_py": None, "target": None, "cond": None},
    0xde6a: {"kind": 'reg', "py": 'r[4] = (r[4] + r[0]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xde6c: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA400, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0xde6e: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
