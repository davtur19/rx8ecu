#!/usr/bin/env python3
"""Differential test for diag_threshold_35124 (0x35124) — v3 lift + v4 FPU, 44 bytes.
...
Run from repo root: python3 c/tests/test_diag_threshold_35124_35124.py
"""
...
RAM_MAX = 0xFFFFC17C
SPAN_END = 0x35150
SENT = 0x35150     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x35124: {"kind": 'reg', "py": 'r[3] = 0xFFFFADC0', "slot_py": None, "target": None, "cond": None},
    0x35126: {"kind": 'fpu', "py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFADC0, 4))', "slot_py": None, "target": None, "cond": None},
    0x35128: {"kind": 'reg', "py": 'r[2] = 0x00079BC0', "slot_py": None, "target": None, "cond": None},
    0x3512a: {"kind": 'fpu', "py": 'fr[6] = bits2f(_rdw(ram, 0x00079BC0, 4))', "slot_py": None, "target": None, "cond": None},
    0x3512c: {"kind": 'reg', "py": 'r[1] = 0x00079BC4', "slot_py": None, "target": None, "cond": None},
    0x3512e: {"kind": 'fpu', "py": 'fr[5] = fr[6]', "slot_py": None, "target": None, "cond": None},
    0x35130: {"kind": 'reg', "py": 'r[4] = 0xFFFFC17C', "slot_py": None, "target": None, "cond": None},
    0x35132: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x00079BC4, 4))', "slot_py": None, "target": None, "cond": None},
    0x35134: {"kind": 'fpu', "py": 'fr[5] = ts(fr[5] - fr[3])', "slot_py": None, "target": None, "cond": None},
    0x35136: {"kind": 'fpu', "py": 'T = 1 if fr[5] > fr[4] else 0', "slot_py": None, "target": None, "cond": None},
    0x35138: {"kind": "branch", "py": None, "slot_py": '', "target": 0x35142, "cond": 'notT'},
    0x3513c: {"kind": 'reg', "py": 'r[0] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x3513e: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFC17C, 1, r[0])', "target": 0x3514c, "cond": 'always'},
    0x35142: {"kind": 'fpu', "py": 'T = 1 if fr[6] > fr[4] else 0', "slot_py": None, "target": None, "cond": None},
    0x35144: {"kind": "branch", "py": None, "slot_py": '', "target": 0x3514c, "cond": 'T'},
    0x35148: {"kind": 'reg', "py": 'r[3] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x3514a: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC17C, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x3514c: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
