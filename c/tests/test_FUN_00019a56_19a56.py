#!/usr/bin/env python3
"""Differential test for FUN_00019a56 (0x19A56) — mem lift (RAM-only, straight-line), 8 bytes.
...
Run from repo root: python3 c/tests/test_FUN_00019a56_19a56.py
"""
...
ENTRY = 0x19A56
RAW = bytes.fromhex("DE 35 92 5F 63 20 23 38")
SEED = 42
N = 2000
...
def spec_mirror(r4, r5, r6, r7, ram, stack_top):
    ...
    r[3] = s8(_rdw(ram, 0xFFFFB5AA, 1))
    # 0x019A5C: op 0x2338
    T = 1 if (r[3] & r[3]) == 0 else 0
    r[15] = sp
