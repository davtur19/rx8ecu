#!/usr/bin/env python3
"""Differential test for caller_56052 (entry 0x56052) — v8 ST caller (CFG), 22 bytes.
...
Run: python3 test_caller_56052.py
"""
...
CODE = {
    0x56052: {"kind": 'fpu', "py": 'fr[6] = 0.0', "slot_py": None, "target": None, "cond": None},
    0x56054: {"kind": 'reg', "py": 'r[0] = 0x000560B4', "slot_py": None, "target": None, "cond": None},
    0x56056: {"kind": 'st', "py": 'local[0x3FC] = pr\n_wrw(ram, STACK_BASE + 0x3FC, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x56058: {"kind": 'reg', "py": 'r[3] = 0xFFFFB360', "slot_py": None, "target": None, "cond": None},
    0x5605a: {"kind": 'fpu', "py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFB360, 4))', "slot_py": None, "target": None, "cond": None},
    0x5605c: {"kind": 'reg', "py": 'r[2] = 0x000024D0', "slot_py": None, "target": None, "cond": None},
    0x5605e: {"kind": "call", "py": None, "slot_py": 'fr[5] = bits2f(_rdw(ram, 0x000560B4, 4))', "target": 0x24d0, "ret_pc": 0x56062, "set_pr": True, "cond": None},
    0x56062: {"kind": 'st', "py": 'pr = _rdw(ram, STACK_BASE + 0x3FC, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x56064: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},
