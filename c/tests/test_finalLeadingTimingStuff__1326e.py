#!/usr/bin/env python3
"""Differential test for finalLeadingTimingStuff_ (0x1326E) — v3 lift + v4 FPU, 92 bytes.
...
Run from repo root: python3 c/tests/test_finalLeadingTimingStuff__1326e.py
"""
...
RAM_MAX = 0xFFFFA700
SPAN_END = 0x132CA
SENT = 0x132CA     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x1326e: {"kind": 'reg', "py": 'r[6] = 0x0006E0F0', "slot_py": None, "target": None, "cond": None},
    0x13270: {"kind": 'reg', "py": 'r[5] = 0xFFFFA6E4', "slot_py": None, "target": None, "cond": None},
    0x13272: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0x0006E0F0, 1))', "slot_py": None, "target": None, "cond": None},
    0x13274: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x13276: {"kind": "branch", "py": None, "slot_py": '', "target": 0x13280, "cond": 'notT'},
    0x1327a: {"kind": 'reg', "py": 'r[2] = 0xFFFFA62C', "slot_py": None, "target": None, "cond": None},
    0x1327c: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFA62C, 4))', "slot_py": None, "target": None, "cond": None},
    0x1327e: {"kind": 'fpu', "py": '_wrw(ram, r[5], 4, f2bits(fr[3]))', "slot_py": None, "target": None, "cond": None},
    0x13280: {"kind": 'reg', "py": 'r[7] = 0xFFFFA6D4', "slot_py": None, "target": None, "cond": None},
    0x13282: {"kind": 'mem', "py": 'r[4] = s8(_rdw(ram, 0x0006E0F0, 1))', "slot_py": None, "target": None, "cond": None},
    0x13284: {"kind": 'reg', "py": 'r[0] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x13286: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x13288: {"kind": "branch", "py": None, "slot_py": 'r[4] = r[0]', "target": 0x132b0, "cond": 'notT'},
    0x1328c: {"kind": 'reg', "py": 'r[3] = 0xFFFFA6EC', "slot_py": None, "target": None, "cond": None},
    0x1328e: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFA6EC, 4))', "slot_py": None, "target": None, "cond": None},
    0x13290: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, r[5], 4))', "slot_py": None, "target": None, "cond": None},
    0x13292: {"kind": 'fpu', "py": 'fr[2] = ts(fr[2] + fr[3])', "slot_py": None, "target": None, "cond": None},
    0x13294: {"kind": 'reg', "py": 'r[2] = 0xFFFFA6FC', "slot_py": None, "target": None, "cond": None},
    0x13296: {"kind": 'fpu', "py": 'fr[1] = bits2f(_rdw(ram, 0xFFFFA6FC, 4))', "slot_py": None, "target": None, "cond": None},
    0x13298: {"kind": 'reg', "py": 'r[1] = 0xFFFFA6F0', "slot_py": None, "target": None, "cond": None},
    0x1329a: {"kind": 'fpu', "py": 'fr[2] = ts(fr[2] + fr[1])', "slot_py": None, "target": None, "cond": None},
    0x1329c: {"kind": 'reg', "py": 'r[3] = 0xFFFFA700', "slot_py": None, "target": None, "cond": None},
    0x1329e: {"kind": 'fpu', "py": '_wrw(ram, r[7], 4, f2bits(fr[2]))', "slot_py": None, "target": None, "cond": None},
    0x132a0: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFA6F0, 4))', "slot_py": None, "target": None, "cond": None},
    0x132a2: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, r[5], 4))', "slot_py": None, "target": None, "cond": None},
    0x132a4: {"kind": 'fpu', "py": 'fr[1] = bits2f(_rdw(ram, 0xFFFFA700, 4))', "slot_py": None, "target": None, "cond": None},
    0x132a6: {"kind": 'fpu', "py": 'fr[2] = ts(fr[2] + fr[3])', "slot_py": None, "target": None, "cond": None},
    0x132a8: {"kind": 'reg', "py": 'r[2] = 0xFFFFA6D8', "slot_py": None, "target": None, "cond": None},
    0x132aa: {"kind": 'fpu', "py": 'fr[2] = ts(fr[2] + fr[1])', "slot_py": None, "target": None, "cond": None},
    0x132ac: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFA6D8, 4, f2bits(fr[2]))', "target": 0x132c6, "cond": 'always'},
    0x132b0: {"kind": 'reg', "py": 'r[0] = r[4]', "slot_py": None, "target": None, "cond": None},
    0x132b2: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x02) else 0', "slot_py": None, "target": None, "cond": None},
    0x132b4: {"kind": "branch", "py": None, "slot_py": '', "target": 0x132c6, "cond": 'notT'},
    0x132b8: {"kind": 'reg', "py": 'r[3] = 0x0006E0F8', "slot_py": None, "target": None, "cond": None},
    0x132ba: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x0006E0F8, 4))', "slot_py": None, "target": None, "cond": None},
    0x132bc: {"kind": 'fpu', "py": '_wrw(ram, r[7], 4, f2bits(fr[3]))', "slot_py": None, "target": None, "cond": None},
    0x132be: {"kind": 'reg', "py": 'r[2] = 0x0006E0FC', "slot_py": None, "target": None, "cond": None},
    0x132c0: {"kind": 'reg', "py": 'r[1] = 0xFFFFA6D8', "slot_py": None, "target": None, "cond": None},
    0x132c2: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x0006E0FC, 4))', "slot_py": None, "target": None, "cond": None},
    0x132c4: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFA6D8, 4, f2bits(fr[3]))', "slot_py": None, "target": None, "cond": None},
    0x132c6: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
