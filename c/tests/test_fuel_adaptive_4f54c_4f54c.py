#!/usr/bin/env python3
"""Differential test for fuel_adaptive_4f54c (0x4F54C) — v3 lift (branches + delay slots), 30 bytes.
...
Run from repo root: python3 c/tests/test_fuel_adaptive_4f54c_4f54c.py
"""
...
ENTRY = 0x4F54C
RAW = bytes.fromhex("93 3A 60 30 60 0C 88 01 8F 07 00 09 91 35 E4 00 92 34 21 40 22 40 93 32 23 40 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    0x4f54c: {"kind": 'reg', "py": 'r[3] = 0xFFFFD201', "slot_py": None, "target": None, "cond": None},
    0x4f54e: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFD201, 1))', "slot_py": None, "target": None, "cond": None},
    0x4f550: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x4f552: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x4f554: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4f566, "cond": 'notT'},
    0x4f558: {"kind": 'reg', "py": 'r[1] = 0xFFFFCFFF', "slot_py": None, "target": None, "cond": None},
    0x4f55a: {"kind": 'reg', "py": 'r[4] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x4f55c: {"kind": 'reg', "py": 'r[2] = 0xFFFFCFFD', "slot_py": None, "target": None, "cond": None},
    0x4f55e: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCFFF, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x4f560: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCFFD, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x4f562: {"kind": 'reg', "py": 'r[3] = 0xFFFFCFFE', "slot_py": None, "target": None, "cond": None},
    0x4f564: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCFFE, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x4f566: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
