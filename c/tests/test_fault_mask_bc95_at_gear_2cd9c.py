#!/usr/bin/env python3
"""Differential test for fault_mask_bc95_at_gear (0x2CD9C) — v3 lift (branches + delay slots), 44 bytes.
...
Run from repo root: python3 c/tests/test_fault_mask_bc95_at_gear_2cd9c.py
"""
...
ENTRY = 0x2CD9C
RAW = bytes.fromhex("93 20 60 30 60 0C 88 01 8F 08 E5 00 92 1B 60 20 60 0C 88 01 8D 02 00 09 A0 01 E4 0F 64 53 64 4C D2 0C 44 08 44 08 74 0F 00 0B 22 40")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBC95
SPAN_END = 0x2CDC8
SENT = 0x2CDC8     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x2cd9c: {"kind": 'reg', "py": 'r[3] = 0xFFFFB580', "slot_py": None, "target": None, "cond": None},
    0x2cd9e: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFB580, 1))', "slot_py": None, "target": None, "cond": None},
    0x2cda0: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x2cda2: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x2cda4: {"kind": "branch", "py": None, "slot_py": 'r[5] = s8(0x00)', "target": 0x2cdb8, "cond": 'notT'},
    0x2cda8: {"kind": 'reg', "py": 'r[2] = 0xFFFFB586', "slot_py": None, "target": None, "cond": None},
    0x2cdaa: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFB586, 1))', "slot_py": None, "target": None, "cond": None},
    0x2cdac: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x2cdae: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x2cdb0: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2cdb8, "cond": 'T'},
    0x2cdb4: {"kind": "branch", "py": None, "slot_py": 'r[4] = s8(0x0F)', "target": 0x2cdba, "cond": 'always'},
    0x2cdb8: {"kind": 'reg', "py": 'r[4] = r[5]', "slot_py": None, "target": None, "cond": None},
    0x2cdba: {"kind": 'reg', "py": 'r[4] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x2cdbc: {"kind": 'reg', "py": 'r[2] = 0xFFFFBC95', "slot_py": None, "target": None, "cond": None},
    0x2cdbe: {"kind": 'reg', "py": 'r[4] = (r[4] << 2) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x2cdc0: {"kind": 'reg', "py": 'r[4] = (r[4] << 2) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x2cdc2: {"kind": 'reg', "py": 'r[4] = (r[4] + s8(0x0F)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x2cdc4: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBC95, 1, r[4])', "target": None, "cond": None},}
