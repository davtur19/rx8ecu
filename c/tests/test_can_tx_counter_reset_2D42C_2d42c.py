#!/usr/bin/env python3
"""Differential test for can_tx_counter_reset_2D42C (0x2D42C) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_can_tx_counter_reset_2D42C_2d42c.py
"""
...
CODE = {
    0x2d42c: {"kind": 'reg', "py": 'r[2] = 0xFFFFBCD0', "slot_py": None, "target": None, "cond": None},
    0x2d42e: {"kind": 'reg', "py": 'r[3] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x2d430: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBCD0, 2, r[3])', "target": None, "cond": None},}
