#!/usr/bin/env python3
"""Differential test for FUN_00004f00 (0x4F00) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_FUN_00004f00_4f00.py
"""
...
ENTRY = 0x4F00
RAW = bytes.fromhex("27 50 91 70 00 0B 21 40")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    0x4f00: {"kind": 'mem', "py": '_wrw(ram, r[7], 1, r[5])', "slot_py": None, "target": None, "cond": None},
