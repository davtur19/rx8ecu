#!/usr/bin/env python3
"""Differential test for fp_sensor_clear_44B10 (0x44B10) — v3 lift + v4 FPU, 12 bytes.
...
Run from repo root: python3 c/tests/test_fp_sensor_clear_44B10_44b10.py
"""
...
ENTRY = 0x44B10
RAW = bytes.fromhex("D3 40 F4 8D 92 77 F3 4A 00 0B F2 4A")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCB18
SPAN_END = 0x44B1C
SENT = 0x44B1C     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x44b10: {"kind": 'reg', "py": 'r[3] = 0xFFFFCB18', "slot_py": None, "target": None, "cond": None},
    0x44b12: {"kind": 'fpu', "py": 'fr[4] = 0.0', "slot_py": None, "target": None, "cond": None},
    0x44b14: {"kind": 'reg', "py": 'r[2] = 0xFFFFCB10', "slot_py": None, "target": None, "cond": None},
    0x44b16: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFCB18, 4, f2bits(fr[4]))', "slot_py": None, "target": None, "cond": None},
    0x44b18: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFCB10, 4, f2bits(fr[4]))', "target": None, "cond": None},}
