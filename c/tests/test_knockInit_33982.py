#!/usr/bin/env python3
"""Differential test for knockInit (0x33982) — v3 lift (branches + delay slots), 16 bytes.
...
Run from repo root: python3 c/tests/test_knockInit_33982.py
"""
...
ENTRY = 0x33982
RAW = bytes.fromhex("E4 00 D3 22 23 40 D2 22 22 41 91 22 00 0B 21 40")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFC0AF
SPAN_END = 0x33992
SENT = 0x33992     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x33982: {"kind": 'reg', "py": 'r[4] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x33984: {"kind": 'reg', "py": 'r[3] = 0xFFFFC0AF', "slot_py": None, "target": None, "cond": None},
    0x33986: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC0AF, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x33988: {"kind": 'reg', "py": 'r[2] = 0xFFFFC0AC', "slot_py": None, "target": None, "cond": None},
    0x3398a: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC0AC, 2, r[4])', "slot_py": None, "target": None, "cond": None},
    0x3398c: {"kind": 'reg', "py": 'r[1] = 0xFFFFC072', "slot_py": None, "target": None, "cond": None},
    0x3398e: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFC072, 1, r[4])', "target": None, "cond": None},}
