#!/usr/bin/env python3
"""Differential test for can_tx_dlc_set_2D470 (0x2D470) — v3 lift (branches + delay slots), 44 bytes.
...
Run from repo root: python3 c/tests/test_can_tx_dlc_set_2D470_2d470.py
"""
...
CODE = {
    0x2d470: {"kind": 'reg', "py": 'r[3] = 0xFFFFB5A4', "slot_py": None, "target": None, "cond": None},
    0x2d472: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFB5A4, 1))', "slot_py": None, "target": None, "cond": None},
    0x2d474: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x2d476: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x2d478: {"kind": "branch", "py": None, "slot_py": 'r[5] = s8(0x00)', "target": 0x2d48c, "cond": 'notT'},
    0x2d47c: {"kind": 'reg', "py": 'r[2] = 0xFFFFB5AA', "slot_py": None, "target": None, "cond": None},
    0x2d47e: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFB5AA, 1))', "slot_py": None, "target": None, "cond": None},
    0x2d480: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x2d482: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x2d484: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2d48c, "cond": 'T'},
    0x2d488: {"kind": "branch", "py": None, "slot_py": 'r[4] = s8(0x0F)', "target": 0x2d48e, "cond": 'always'},
    0x2d48c: {"kind": 'reg', "py": 'r[4] = r[5]', "slot_py": None, "target": None, "cond": None},
    0x2d48e: {"kind": 'reg', "py": 'r[4] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x2d490: {"kind": 'reg', "py": 'r[2] = 0xFFFFBCC9', "slot_py": None, "target": None, "cond": None},
    0x2d492: {"kind": 'reg', "py": 'r[4] = (r[4] << 2) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x2d494: {"kind": 'reg', "py": 'r[4] = (r[4] << 2) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x2d496: {"kind": 'reg', "py": 'r[4] = (r[4] + s8(0x0F)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x2d498: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBCC9, 1, r[4])', "target": None, "cond": None},}
