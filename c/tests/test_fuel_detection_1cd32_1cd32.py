#!/usr/bin/env python3
"""Differential test for fuel_detection_1cd32 (0x1CD32) — pure straight-line lift, 8 bytes.
...
Run from repo root: python3 c/tests/test_fuel_detection_1cd32_1cd32.py
"""
...
ENTRY = 0x1CD32
RAW = bytes.fromhex("E3 01 92 18 65 33 94 17")
SEED = 42
N = 2000
