#!/usr/bin/env python3
"""Differential test for FUN_00067488 (0x67488) — v3 lift (branches + delay slots), 12 bytes.
...
Run from repo root: python3 c/tests/test_FUN_00067488_67488.py
"""
...
ENTRY = 0x67488
RAW = bytes.fromhex("00 09 64 0D D2 69 4F 26 00 0B 22 42")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFD96C
SPAN_END = 0x67494
SENT = 0x67494     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x67488: {"kind": 'reg', "py": None, "slot_py": None, "target": None, "cond": None},
