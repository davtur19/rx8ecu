#!/usr/bin/env python3
"""Differential test for FUN_00032e98 (0x32E98) — v3 lift (branches + delay slots), 10 bytes.
...
Run from repo root: python3 c/tests/test_FUN_00032e98_32e98.py
"""
...
ENTRY = 0x32E98
RAW = bytes.fromhex("92 0A 63 20 D0 09 00 0B 20 30")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFD196
SPAN_END = 0x32EA2
SENT = 0x32EA2     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x32e98: {"kind": 'reg', "py": 'r[2] = 0xFFFFD196', "slot_py": None, "target": None, "cond": None},
    0x32e9a: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFD196, 1))', "slot_py": None, "target": None, "cond": None},
    0x32e9c: {"kind": 'reg', "py": 'r[0] = 0xFFFFBFFA', "slot_py": None, "target": None, "cond": None},
    0x32e9e: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBFFA, 1, r[3])', "target": None, "cond": None},}
