#!/usr/bin/env python3
"""Differential test for diag_security_access_4E6E2 (0x4E6E2) — v3 lift (branches + delay slots), 32 bytes.
...
Run from repo root: python3 c/tests/test_diag_security_access_4E6E2_4e6e2.py
"""
...
ENTRY = 0x4E6E2
RAW = bytes.fromhex("92 16 63 20 23 38 8F 02 E4 00 90 12 20 40 92 11 63 20 23 38 8F 02 00 09 90 0D 20 40 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    0x4e6e2: {"kind": 'reg', "py": 'r[2] = 0xFFFFC020', "slot_py": None, "target": None, "cond": None},
    0x4e6e4: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFC020, 1))', "slot_py": None, "target": None, "cond": None},
    0x4e6e6: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x4e6e8: {"kind": "branch", "py": None, "slot_py": 'r[4] = s8(0x00)', "target": 0x4e6f0, "cond": 'notT'},
    0x4e6ec: {"kind": 'reg', "py": 'r[0] = 0xFFFFCF81', "slot_py": None, "target": None, "cond": None},
    0x4e6ee: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCF81, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x4e6f0: {"kind": 'reg', "py": 'r[2] = 0xFFFFC01E', "slot_py": None, "target": None, "cond": None},
    0x4e6f2: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFC01E, 1))', "slot_py": None, "target": None, "cond": None},
    0x4e6f4: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x4e6f6: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4e6fe, "cond": 'notT'},
    0x4e6fa: {"kind": 'reg', "py": 'r[0] = 0xFFFFCF82', "slot_py": None, "target": None, "cond": None},
    0x4e6fc: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCF82, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x4e6fe: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
