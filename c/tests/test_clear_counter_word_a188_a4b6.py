#!/usr/bin/env python3
"""Differential test for clear_counter_word_a188 (0xA4B6) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_clear_counter_word_a188_a4b6.py
"""
...
ENTRY = 0xA4B6
RAW = bytes.fromhex("E3 00 D2 05 00 0B 22 31")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFA188
SPAN_END = 0xA4BE
SENT = 0xA4BE     # stop-sentinel, placed past the literal pool
