#!/usr/bin/env python3
"""Differential test for lambda_sensor_active_check_2AE82 (0x2AE82) — v3 lift (branches + delay slots), 40 bytes.
...
Run from repo root: python3 c/tests/test_lambda_sensor_active_check_2AE82_2ae82.py
"""
...
CODE = {
    0x2ae82: {"kind": 'reg', "py": 'r[4] = 0xFFFFBBB0', "slot_py": None, "target": None, "cond": None},
    0x2ae84: {"kind": 'reg', "py": 'r[3] = 0xFFFFA428', "slot_py": None, "target": None, "cond": None},
    0x2ae86: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFA428, 1))', "slot_py": None, "target": None, "cond": None},
    0x2ae88: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x2ae8a: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x2ae8c: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2ae9c, "cond": 'T'},
    0x2ae90: {"kind": 'reg', "py": 'r[2] = 0xFFFFA42C', "slot_py": None, "target": None, "cond": None},
    0x2ae92: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFA42C, 1))', "slot_py": None, "target": None, "cond": None},
    0x2ae94: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x2ae96: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x2ae98: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2aea2, "cond": 'notT'},
    0x2ae9c: {"kind": 'reg', "py": 'r[3] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x2ae9e: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFBBB0, 1, r[3])', "target": 0x2aea6, "cond": 'always'},
    0x2aea2: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x2aea4: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBBB0, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x2aea6: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
