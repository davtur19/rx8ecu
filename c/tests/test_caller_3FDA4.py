#!/usr/bin/env python3
"""Differential test for caller_3FDA4 (entry 0x3FDA4) — v8 ST caller (CFG), 24 bytes.
...
Run: python3 test_caller_3FDA4.py
"""
...
CODE = {
    0x3fda4: {"kind": 'st', "py": 'local[0x3FC] = pr\n_wrw(ram, STACK_BASE + 0x3FC, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x3fda6: {"kind": 'fpu', "py": 'fr[5] = 0.0', "slot_py": None, "target": None, "cond": None},
    0x3fda8: {"kind": 'reg', "py": 'r[0] = 0x0003FDC0', "slot_py": None, "target": None, "cond": None},
    0x3fdaa: {"kind": 'fpu', "py": 'fr[4] = bits2f(_rdw(ram, 0x0003FDC0, 4))', "slot_py": None, "target": None, "cond": None},
    0x3fdac: {"kind": 'reg', "py": 'r[4] = 0xFFFF9F16', "slot_py": None, "target": None, "cond": None},
    0x3fdae: {"kind": 'reg', "py": 'r[3] = 0x000024C0', "slot_py": None, "target": None, "cond": None},
    0x3fdb0: {"kind": "call", "py": None, "slot_py": 'r[4] = s16(_rdw(ram, 0xFFFF9F16, 2))', "target": 0x24c0, "ret_pc": 0x3fdb4, "set_pr": True, "cond": None},
    0x3fdb4: {"kind": 'reg', "py": 'r[2] = 0xFFFFC71C', "slot_py": None, "target": None, "cond": None},
    0x3fdb6: {"kind": 'st', "py": 'pr = _rdw(ram, STACK_BASE + 0x3FC, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x3fdb8: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFC71C, 4, f2bits(fr[0]))', "target": None, "cond": None},
