#!/usr/bin/env python3
"""Differential test for crank_state_bytes_clear (0x7BA8) — v3 lift (branches + delay slots), 12 bytes.
...
Run from repo root: python3 c/tests/test_crank_state_bytes_clear_7ba8.py
"""
...
CODE = {
    0x7ba8: {"kind": 'reg', "py": 'r[3] = 0xFFFF9FC7', "slot_py": None, "target": None, "cond": None},
    0x7baa: {"kind": 'reg', "py": 'r[4] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x7bac: {"kind": 'reg', "py": 'r[2] = 0xFFFF9FC8', "slot_py": None, "target": None, "cond": None},
    0x7bae: {"kind": 'mem', "py": '_wrw(ram, 0xFFFF9FC7, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x7bb0: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFF9FC8, 1, r[4])', "target": None, "cond": None},}
