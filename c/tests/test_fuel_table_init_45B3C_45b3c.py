#!/usr/bin/env python3
"""Differential test for fuel_table_init_45B3C (0x45B3C) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_fuel_table_init_45B3C_45b3c.py
"""
...
CODE = {
    0x45b3c: {"kind": 'reg', "py": 'r[3] = 0x000003E8', "slot_py": None, "target": None, "cond": None},
    0x45b3e: {"kind": 'reg', "py": 'r[2] = 0xFFFFCBF0', "slot_py": None, "target": None, "cond": None},
    0x45b40: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFCBF0, 2, r[3])', "target": None, "cond": None},}
