#!/usr/bin/env python3
"""Differential test for call-composition caller_49A92 (entry 0x49A92) — v7 ST caller + callee lib, flattened CODE with nested returns.
...
Run: python3 /home/davide/ailocal/rx8ecu/c/tests/test_caller_49A92.py
"""
...
CODE = {
    0x49a92: {"kind": 'reg', "py": 'r[2] = 0xFFFFAAE0', "slot_py": None, "target": None, "cond": None},
    0x49a94: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFAAE0, 1))', "slot_py": None, "target": None, "cond": None},
    0x49a96: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x49a98: {"kind": "branch", "py": None, "slot_py": '', "target": 0x49abc, "cond": 'notT'},
    0x49a9c: {"kind": 'reg', "py": 'r[1] = 0xFFFFCD06', "slot_py": None, "target": None, "cond": None},
    0x49a9e: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCD06, 1))', "slot_py": None, "target": None, "cond": None},
    0x49aa0: {"kind": 'reg', "py": 'T = 1 if (r[0] & r[0]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x49aa2: {"kind": "branch", "py": None, "slot_py": '', "target": 0x49abc, "cond": 'notT'},
    0x49aa6: {"kind": 'reg', "py": 'r[0] = 0xFFFFCCF6', "slot_py": None, "target": None, "cond": None},
    0x49aa8: {"kind": 'reg', "py": 'r[1] = 0x0007C2CA', "slot_py": None, "target": None, "cond": None},
    0x49aaa: {"kind": 'mem', "py": 'r[3] = s16(_rdw(ram, 0xFFFFCCF6, 2))', "slot_py": None, "target": None, "cond": None},
    0x49aac: {"kind": 'mem', "py": 'r[2] = s16(_rdw(ram, 0x0007C2CA, 2))', "slot_py": None, "target": None, "cond": None},
    0x49aae: {"kind": 'reg', "py": 'T = 1 if r[3] >= r[2] else 0', "slot_py": None, "target": None, "cond": None},
    0x49ab0: {"kind": "branch", "py": None, "slot_py": '', "target": 0x49abc, "cond": 'notT'},
    0x49ab4: {"kind": 'reg', "py": 'r[4] = 0xFFFF8788', "slot_py": None, "target": None, "cond": None},
    0x49ab6: {"kind": 'reg', "py": 'r[2] = 0x0003EE58', "slot_py": None, "target": None, "cond": None},
    0x49ab8: {"kind": "call", "py": None, "slot_py": 'r[5] = s8(0x01)', "target": 0x3ee58, "ret_pc": 0x49abc, "set_pr": False, "cond": None},
