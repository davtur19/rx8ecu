#!/usr/bin/env python3
"""Differential test for mutex_lock_4C7F0 (0x4C7F0) — v3 lift (branches + delay slots), 42 bytes.
...
Run from repo root: python3 c/tests/test_mutex_lock_4C7F0_4c7f0.py
"""
...
ENTRY = 0x4C7F0
RAW = bytes.fromhex("95 13 92 13 63 20 63 3C 43 15 8F 04 00 09 D3 14 61 30 A0 08 25 10 64 50 63 4C 23 38 8D 03 00 09 90 05 34 0C 25 40 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCE98
SPAN_END = 0x4C81A
SENT = 0x4C854     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x4c7f0: {"kind": 'reg', "py": 'r[5] = 0xFFFFCE98', "slot_py": None, "target": None, "cond": None},
    0x4c7f2: {"kind": 'reg', "py": 'r[2] = 0xFFFFA400', "slot_py": None, "target": None, "cond": None},
    0x4c7f4: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFA400, 1))', "slot_py": None, "target": None, "cond": None},
    0x4c7f6: {"kind": 'reg', "py": 'r[3] = r[3] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x4c7f8: {"kind": 'reg', "py": 'T = 1 if s32(r[3]) > 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x4c7fa: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4c806, "cond": 'notT'},
    0x4c7fe: {"kind": 'reg', "py": 'r[3] = 0x0006CF81', "slot_py": None, "target": None, "cond": None},
    0x4c800: {"kind": 'mem', "py": 'r[1] = s8(_rdw(ram, 0x0006CF81, 1))', "slot_py": None, "target": None, "cond": None},
    0x4c802: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFCE98, 1, r[1])', "target": 0x4c816, "cond": 'always'},
    0x4c806: {"kind": 'mem', "py": 'r[4] = s8(_rdw(ram, 0xFFFFCE98, 1))', "slot_py": None, "target": None, "cond": None},
    0x4c808: {"kind": 'reg', "py": 'r[3] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x4c80a: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x4c80c: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4c816, "cond": 'T'},
    0x4c810: {"kind": 'reg', "py": 'r[0] = 0x000000FF', "slot_py": None, "target": None, "cond": None},
    0x4c812: {"kind": 'reg', "py": 'r[4] = (r[4] + r[0]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x4c814: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCE98, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x4c816: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
