#!/usr/bin/env python3
"""Differential test for FUN_000288fc (0x288FC) — pure straight-line lift, 8 bytes.
...
Run from repo root: python3 c/tests/test_FUN_000288fc_288fc.py
"""
...
ENTRY = 0x288FC
RAW = bytes.fromhex("E5 00 EA 00 6A AC 2A A8")
SEED = 42
N = 2000
