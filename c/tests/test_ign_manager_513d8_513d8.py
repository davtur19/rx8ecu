#!/usr/bin/env python3
"""Differential test for ign_manager_513d8 (0x513D8) — v3 lift (branches + delay slots), 18 bytes.
...
Run from repo root: python3 c/tests/test_ign_manager_513d8_513d8.py
"""
...
ENTRY = 0x513D8
RAW = bytes.fromhex("30 40 8F 03 00 09 D3 36 62 30 25 20 4F 26 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = None
SPAN_END = 0x513EA
SENT = 0x513EA     # stop-sentinel, placed past the literal pool
...
CODE = {
    ...
    0x513e0: {"kind": 'mem', "py": 'r[2] = s8(_rdw(ram, 0x0007C054, 1))', "slot_py": None, "target": None, "cond": None},
    0x513e2: {"kind": 'mem', "py": '_wrw(ram, r[5], 1, r[2])', "slot_py": None, "target": None, "cond": None},
    0x513e4: {"kind": 'mem', "py": 'pr = _rdw(ram, STACK_BASE + 0x400, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
