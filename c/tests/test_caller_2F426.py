#!/usr/bin/env python3
"""Differential test for caller_2F426 (entry 0x2F426) — v8 ST caller (CFG), 14 bytes.
...
Run: python3 test_caller_2F426.py
"""
...
CODE = {
    0x2f426: {"kind": 'st', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x2f428: {"kind": 'reg', "py": 'r[3] = 0x0004D250', "slot_py": None, "target": None, "cond": None},
    0x2f42a: {"kind": "call", "py": None, "slot_py": '', "target": 0x4d250, "ret_pc": 0x2f42e, "set_pr": True, "cond": None},
    0x2f42e: {"kind": 'reg', "py": 'r[2] = 0x0004E904', "slot_py": None, "target": None, "cond": None},
    0x2f430: {"kind": "call", "py": None, "slot_py": 'pr = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": 0x4e904, "ret_pc": 0x2f434, "set_pr": False, "cond": None},
    0x4d250: {"kind": 'reg', "py": 'r[2] = 0xFFFFCFA1', "slot_py": None, "target": None, "cond": None},
    0x4d252: {"kind": 'reg', "py": 'r[3] = s8(0x0C)', "slot_py": None, "target": None, "cond": None},
    0x4d254: {"kind": 'reg', "py": 'r[4] = 0x0007CC9C', "slot_py": None, "target": None, "cond": None},
    0x4d256: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCFA1, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x4d258: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, r[4], 4))', "slot_py": None, "target": None, "cond": None},
    0x4d25a: {"kind": 'reg', "py": 'r[3] = 0xFFFFCF24', "slot_py": None, "target": None, "cond": None},
    0x4d25c: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFCF24, 4, f2bits(fr[3]))', "slot_py": None, "target": None, "cond": None},
    0x4d25e: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, r[4], 4))', "slot_py": None, "target": None, "cond": None},
    0x4d260: {"kind": 'reg', "py": 'r[1] = 0xFFFFCF28', "slot_py": None, "target": None, "cond": None},
    0x4d262: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFCF28, 4, f2bits(fr[3]))', "slot_py": None, "target": None, "cond": None},
    0x4d264: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, r[4], 4))', "slot_py": None, "target": None, "cond": None},
    0x4d266: {"kind": 'reg', "py": 'r[2] = 0xFFFFCF2C', "slot_py": None, "target": None, "cond": None},
    0x4d268: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFCF2C, 4, f2bits(fr[3]))', "target": None, "cond": None},
    0x4e904: {"kind": 'reg', "py": 'r[2] = 0xFFFFCF89', "slot_py": None, "target": None, "cond": None},
    0x4e906: {"kind": 'reg', "py": 'r[1] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x4e908: {"kind": 'reg', "py": 'r[0] = 0xFFFFCF8A', "slot_py": None, "target": None, "cond": None},
    0x4e90a: {"kind": 'reg', "py": 'r[3] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x4e90c: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCF89, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x4e90e: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFCF8A, 1, r[1])', "target": None, "cond": None},
}
