#!/usr/bin/env python3
"""Differential test for set_b5d4_flag (0x25D98) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_set_b5d4_flag_25d98.py
"""
...
ENTRY = 0x25D98
RAW = bytes.fromhex("92 06 E3 01 00 0B 22 30")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFB5D4
SPAN_END = 0x25DA0
SENT = 0x25DA0     # stop-sentinel, placed past the literal pool
