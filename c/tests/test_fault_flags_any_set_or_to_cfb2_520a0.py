#!/usr/bin/env python3
"""Differential test for fault_flags_any_set_or_to_cfb2 (0x520A0) — v3 lift (branches + delay slots), 64 bytes.
...
Run from repo root: python3 c/tests/test_fault_flags_any_set_or_to_cfb2_520a0.py
"""
...
ENTRY = 0x520A0
RAW = bytes.fromhex("94 40 93 40 60 30 60 0C 88 01 8D 12 00 09 92 3B 60 20 60 0C 88 01 8D 0C 00 09 91 36 60 10 60 0C 88 01 8D 06 00 09 93 31 60 30 60 0C 88 01 8F 03 00 09 E3 01 A0 02 24 30 E1 00 24 10 00 0B 00 09")
SEED = 43
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCFB2
SPAN_END = 0x520E0
SENT = 0x520E0     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x520a0: {"kind": 'reg', "py": 'r[4] = 0xFFFFCFB2', "slot_py": None, "target": None, "cond": None},
    0x520a2: {"kind": 'reg', "py": 'r[3] = 0xFFFFC812', "slot_py": None, "target": None, "cond": None},
    0x520a4: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFC812, 1))', "slot_py": None, "target": None, "cond": None},
    0x520a6: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x520a8: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x520aa: {"kind": "branch", "py": None, "slot_py": '', "target": 0x520d2, "cond": 'T'},
    0x520ae: {"kind": 'reg', "py": 'r[2] = 0xFFFFC814', "slot_py": None, "target": None, "cond": None},
    0x520b0: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFC814, 1))', "slot_py": None, "target": None, "cond": None},
    0x520b2: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x520b4: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x520b6: {"kind": "branch", "py": None, "slot_py": '', "target": 0x520d2, "cond": 'T'},
    0x520ba: {"kind": 'reg', "py": 'r[1] = 0xFFFFC895', "slot_py": None, "target": None, "cond": None},
    0x520bc: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFC895, 1))', "slot_py": None, "target": None, "cond": None},
    0x520be: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x520c0: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x520c2: {"kind": "branch", "py": None, "slot_py": '', "target": 0x520d2, "cond": 'T'},
    0x520c6: {"kind": 'reg', "py": 'r[3] = 0xFFFFC897', "slot_py": None, "target": None, "cond": None},
    0x520c8: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFC897, 1))', "slot_py": None, "target": None, "cond": None},
    0x520ca: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x520cc: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x520ce: {"kind": "branch", "py": None, "slot_py": '', "target": 0x520d8, "cond": 'notT'},
    0x520d2: {"kind": 'reg', "py": 'r[3] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x520d4: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFCFB2, 1, r[3])', "target": 0x520dc, "cond": 'always'},
    0x520d8: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x520da: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCFB2, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x520dc: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
