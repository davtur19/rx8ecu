#!/usr/bin/env python3
"""Differential test for speedometer_0x5A9DC (0x5A9DC) — v3 lift + v4 FPU, 64 bytes.
...
Run from repo root: python3 c/tests/test_speedometer_0x5A9DC_5a9dc.py
"""
...
ENTRY = 0x5A9DC
RAW = bytes.fromhex("93 31 60 30 60 0C 88 20 8F 03 00 09 92 2C E1 01 22 10 00 0B 00 09 94 28 93 28 F4 38 D2 15 F5 28 F5 45 8D 03 00 09 E0 01 A0 08 24 00 D1 12 F3 18 F5 31 F5 45 8F 02 00 09 E0 00 24 00 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFD2AD
SPAN_END = 0x5AA1C
SENT = 0x5AA1C     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x5a9dc: {"kind": 'reg', "py": 'r[3] = 0xFFFFD28F', "slot_py": None, "target": None, "cond": None},
    0x5a9de: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFD28F, 1))', "slot_py": None, "target": None, "cond": None},
    0x5a9e0: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x5a9e2: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x20) else 0', "slot_py": None, "target": None, "cond": None},
    0x5a9e4: {"kind": "branch", "py": None, "slot_py": '', "target": 0x5a9ee, "cond": 'notT'},
    0x5a9e8: {"kind": 'reg', "py": 'r[2] = 0xFFFFD2AC', "slot_py": None, "target": None, "cond": None},
    0x5a9ea: {"kind": 'reg', "py": 'r[1] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x5a9ec: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD2AC, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x5a9ee: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},
    0x5a9f2: {"kind": 'reg', "py": 'r[4] = 0xFFFFD2AD', "slot_py": None, "target": None, "cond": None},
    0x5a9f4: {"kind": 'reg', "py": 'r[3] = 0xFFFFBC1C', "slot_py": None, "target": None, "cond": None},
    0x5a9f6: {"kind": 'fpu', "py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFBC1C, 4))', "slot_py": None, "target": None, "cond": None},
    0x5a9f8: {"kind": 'reg', "py": 'r[2] = 0x0007DAB4', "slot_py": None, "target": None, "cond": None},
    0x5a9fa: {"kind": 'fpu', "py": 'fr[5] = bits2f(_rdw(ram, 0x0007DAB4, 4))', "slot_py": None, "target": None, "cond": None},
    0x5a9fc: {"kind": 'fpu', "py": 'T = 1 if fr[5] > fr[4] else 0', "slot_py": None, "target": None, "cond": None},
    0x5a9fe: {"kind": "branch", "py": None, "slot_py": '', "target": 0x5aa08, "cond": 'T'},
    0x5aa02: {"kind": 'reg', "py": 'r[0] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x5aa04: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFD2AD, 1, r[0])', "target": 0x5aa18, "cond": 'always'},
    0x5aa08: {"kind": 'reg', "py": 'r[1] = 0x0007DAB8', "slot_py": None, "target": None, "cond": None},
    0x5aa0a: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x0007DAB8, 4))', "slot_py": None, "target": None, "cond": None},
    0x5aa0c: {"kind": 'fpu', "py": 'fr[5] = ts(fr[5] - fr[3])', "slot_py": None, "target": None, "cond": None},
    0x5aa0e: {"kind": 'fpu', "py": 'T = 1 if fr[5] > fr[4] else 0', "slot_py": None, "target": None, "cond": None},
    0x5aa10: {"kind": "branch", "py": None, "slot_py": '', "target": 0x5aa18, "cond": 'notT'},
    0x5aa14: {"kind": 'reg', "py": 'r[0] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x5aa16: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD2AD, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x5aa18: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
