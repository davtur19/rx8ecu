#!/usr/bin/env python3
"""Differential test for getSecondaryAirPumpRequestForMode22 (0x55FA6) — v3 lift (branches + delay slots), 22 bytes.
...
Run from repo root: python3 c/tests/test_getSecondaryAirPumpRequestForMode22_55fa6.py
"""
...
ENTRY = 0x55FA6
RAW = bytes.fromhex("93 71 60 30 60 0C 88 01 8F 02 00 09 A0 01 E4 01 E4 04 00 0B 60 43")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    0x55fa6: {"kind": 'reg', "py": 'r[3] = 0xFFFFA9E4', "slot_py": None, "target": None, "cond": None},
    0x55fa8: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFA9E4, 1))', "slot_py": None, "target": None, "cond": None},
    0x55faa: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x55fac: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x55fae: {"kind": "branch", "py": None, "slot_py": '', "target": 0x55fb6, "cond": 'notT'},
    0x55fb2: {"kind": "branch", "py": None, "slot_py": 'r[4] = s8(0x01)', "target": 0x55fb8, "cond": 'always'},
    0x55fb6: {"kind": 'reg', "py": 'r[4] = s8(0x04)', "slot_py": None, "target": None, "cond": None},
    0x55fb8: {"kind": "ret", "py": None, "slot_py": 'r[0] = r[4]', "target": None, "cond": None},}
