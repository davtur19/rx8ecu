#!/usr/bin/env python3
"""Differential test for fpu_register_copy_39478 (0x39478) — v3 lift + v4 FPU, 22 bytes.
...
Run from repo root: python3 c/tests/test_fpu_register_copy_39478_39478.py
"""
...
ENTRY = 0x39478
RAW = bytes.fromhex("94 7F 93 7F 92 7F F3 38 F4 3A F2 3A 91 7C F3 18 93 7B 00 0B F3 3A")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFC550
SPAN_END = 0x3948E
SENT = 0x3948E     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x39478: {"kind": 'reg', "py": 'r[4] = 0xFFFFC53C', "slot_py": None, "target": None, "cond": None},
    0x3947a: {"kind": 'reg', "py": 'r[3] = 0xFFFFAA10', "slot_py": None, "target": None, "cond": None},
    0x3947c: {"kind": 'reg', "py": 'r[2] = 0xFFFFC538', "slot_py": None, "target": None, "cond": None},
    0x3947e: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFAA10, 4))', "slot_py": None, "target": None, "cond": None},
    0x39480: {"kind": 'fpu', "py": '_wrw(ram, r[4], 4, f2bits(fr[3]))', "slot_py": None, "target": None, "cond": None},
    0x39482: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFC538, 4, f2bits(fr[3]))', "slot_py": None, "target": None, "cond": None},
    0x39484: {"kind": 'reg', "py": 'r[1] = 0xFFFFAA88', "slot_py": None, "target": None, "cond": None},
    0x39486: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFAA88, 4))', "slot_py": None, "target": None, "cond": None},
    0x39488: {"kind": 'reg', "py": 'r[3] = 0xFFFFC550', "slot_py": None, "target": None, "cond": None},
    0x3948a: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFC550, 4, f2bits(fr[3]))', "target": None, "cond": None},}
