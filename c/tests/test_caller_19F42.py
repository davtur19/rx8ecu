#!/usr/bin/env python3
"""Differential test for caller_19F42 (entry 0x19F42) — v8 ST caller (CFG), 24 bytes.
...
Run: python3 test_caller_19F42.py
"""
...
CODE = {
    0x19f42: {"kind": 'fpu', "py": 'fr[5] = 0.0', "slot_py": None, "target": None, "cond": None},
    0x19f44: {"kind": 'reg', "py": 'r[0] = 0x0001A000', "slot_py": None, "target": None, "cond": None},
    0x19f46: {"kind": 'st', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x19f48: {"kind": 'reg', "py": 'r[4] = 0xFFFF9F1C', "slot_py": None, "target": None, "cond": None},
    0x19f4a: {"kind": 'mem', "py": 'r[4] = s16(_rdw(ram, 0xFFFF9F1C, 2))', "slot_py": None, "target": None, "cond": None},
    0x19f4c: {"kind": 'reg', "py": 'r[3] = 0x000024C0', "slot_py": None, "target": None, "cond": None},
    0x19f4e: {"kind": "call", "py": None, "slot_py": 'fr[4] = bits2f(_rdw(ram, 0x0001A000, 4))', "target": 0x24c0, "ret_pc": 0x19f52, "set_pr": True, "cond": None},
    0x19f52: {"kind": 'reg', "py": 'r[2] = 0xFFFFAA08', "slot_py": None, "target": None, "cond": None},
    0x19f54: {"kind": 'st', "py": 'pr = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x19f56: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFAA08, 4, f2bits(fr[0]))', "target": None, "cond": None},
