#!/usr/bin/env python3
"""Differential test for ign_coil_output_set (0x8730) — v3 lift (branches + delay slots), 36 bytes.
...
Run from repo root: python3 c/tests/test_ign_coil_output_set_8730.py
"""
...
RAM_MAX = 0xFFFFA094
SPAN_END = 0x8754
SENT = 0x8754     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x8730: {"kind": 'reg', "py": 'r[6] = 0xFFFFA094', "slot_py": None, "target": None, "cond": None},
    0x8732: {"kind": 'reg', "py": 'T = 1 if (r[4] & r[4]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x8734: {"kind": "branch", "py": None, "slot_py": 'r[0] = r[4]', "target": 0x873c, "cond": 'notT'},
    0x8738: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA094, 4, r[5])', "slot_py": None, "target": None, "cond": None},
    0x873a: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA0A0, 4, r[5])', "slot_py": None, "target": None, "cond": None},
    0x873c: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x873e: {"kind": "branch", "py": None, "slot_py": 'r[0] = r[4]', "target": 0x8746, "cond": 'notT'},
    0x8742: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA098, 4, r[5])', "slot_py": None, "target": None, "cond": None},
    0x8744: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA0A4, 4, r[5])', "slot_py": None, "target": None, "cond": None},
    0x8746: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x02) else 0', "slot_py": None, "target": None, "cond": None},
    0x8748: {"kind": "branch", "py": None, "slot_py": '', "target": 0x8750, "cond": 'notT'},
    0x874c: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA09C, 4, r[5])', "slot_py": None, "target": None, "cond": None},
    0x874e: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA0A8, 4, r[5])', "slot_py": None, "target": None, "cond": None},
    0x8750: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
