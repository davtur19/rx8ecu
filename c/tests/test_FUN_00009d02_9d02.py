#!/usr/bin/env python3
"""Differential test for FUN_00009d02 (0x9D02) — v3 lift (branches + delay slots), 34 bytes.
...
Run from repo root: python3 c/tests/test_FUN_00009d02_9d02.py
"""
...
ENTRY = 0x9D02
RAW = bytes.fromhex("E6 08 60 40 C9 FE 24 00 94 92 63 50 63 3C 23 68 8D 05 00 09 74 FF E3 00 34 36 8D F6 00 09 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = None
SPAN_END = 0x9D24
SENT = 0x9D24     # stop-sentinel, placed past the literal pool
