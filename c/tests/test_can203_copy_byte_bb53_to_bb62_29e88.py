#!/usr/bin/env python3
"""Differential test for can203_copy_byte_bb53_to_bb62 (0x29E88) — v3 lift (branches + delay slots), 10 bytes.
...
Run from repo root: python3 c/tests/test_can203_copy_byte_bb53_to_bb62_29e88.py
"""
...
ENTRY = 0x29E88
RAW = bytes.fromhex("93 0C 60 30 D2 0C 00 0B 22 00")
SEED = 43
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBB62
SPAN_END = 0x29E92
SENT = 0x29E92     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x29e88: {"kind": 'reg', "py": 'r[3] = 0xFFFFBB53', "slot_py": None, "target": None, "cond": None},
    0x29e8a: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFBB53, 1))', "slot_py": None, "target": None, "cond": None},
    0x29e8c: {"kind": 'reg', "py": 'r[2] = 0xFFFFBB62', "slot_py": None, "target": None, "cond": None},
    0x29e8e: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBB62, 1, r[0])', "target": None, "cond": None},}
