#!/usr/bin/env python3
"""Differential test for flag_setter_f76c_bit8_cbd0 (0x48394) — v3 lift (branches + delay slots), 42 bytes.
...
Run from repo root: python3 c/tests/test_flag_setter_f76c_bit8_cbd0_48394.py
"""
...
ENTRY = 0x48394
RAW = bytes.fromhex("96 0F 95 0F 93 0F 60 31 60 0D 92 0D 20 29 20 08 00 29 CA 01 88 01 00 29 88 01 04 29 25 40 00 0B 26 40 CB D1 CB D0 F7 6C 01 00")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFF76C
SPAN_END = 0x483BE
SENT = 0x483BE     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x48394: {"kind": 'reg', "py": 'r[6] = 0xFFFFCBD1', "slot_py": None, "target": None, "cond": None},
    0x48396: {"kind": 'reg', "py": 'r[5] = 0xFFFFCBD0', "slot_py": None, "target": None, "cond": None},
    0x48398: {"kind": 'reg', "py": 'r[3] = 0xFFFFF76C', "slot_py": None, "target": None, "cond": None},
    0x4839a: {"kind": 'mem', "py": 'r[0] = s16(_rdw(ram, 0xFFFFF76C, 2))', "slot_py": None, "target": None, "cond": None},
    0x4839c: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x4839e: {"kind": 'reg', "py": 'r[2] = 0x00000100', "slot_py": None, "target": None, "cond": None},
    0x483a0: {"kind": 'reg', "py": 'r[0] = (r[0] & r[2]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x483a2: {"kind": 'reg', "py": 'T = 1 if (r[0] & r[0]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x483a4: {"kind": 'reg', "py": 'r[0] = T;', "slot_py": None, "target": None, "cond": None},
    0x483a6: {"kind": 'reg', "py": 'r[0] = (r[0] ^ 0x01) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x483a8: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x483aa: {"kind": 'reg', "py": 'r[0] = T;', "slot_py": None, "target": None, "cond": None},
    0x483ac: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x483ae: {"kind": 'reg', "py": 'r[4] = T;', "slot_py": None, "target": None, "cond": None},
    0x483b0: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCBD0, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x483b2: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFCBD1, 1, r[4])', "target": None, "cond": None},}
