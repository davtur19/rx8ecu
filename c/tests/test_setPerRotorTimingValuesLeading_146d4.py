#!/usr/bin/env python3
"""Differential test for setPerRotorTimingValuesLeading (0x146D4) — v3 lift + v4 FPU, 54 bytes.
...
Run from repo root: python3 c/tests/test_setPerRotorTimingValuesLeading_146d4.py
"""
...
RAM_MAX = 0xFFFFA6D8
SPAN_END = 0x1470A
SENT = 0x1470A     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x146d4: {"kind": 'reg', "py": 'r[6] = 0xFFFFA790', "slot_py": None, "target": None, "cond": None},
    0x146d6: {"kind": 'reg', "py": 'r[4] = 0xFFFFA78C', "slot_py": None, "target": None, "cond": None},
    0x146d8: {"kind": 'reg', "py": 'r[2] = 0x0006E0F0', "slot_py": None, "target": None, "cond": None},
    0x146da: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0x0006E0F0, 1))', "slot_py": None, "target": None, "cond": None},
    0x146dc: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x146de: {"kind": "branch", "py": None, "slot_py": '', "target": 0x146fa, "cond": 'notT'},
    0x146e2: {"kind": 'reg', "py": 'r[5] = 0xFFFFA62C', "slot_py": None, "target": None, "cond": None},
    0x146e4: {"kind": 'reg', "py": 'r[3] = 0x000753DC', "slot_py": None, "target": None, "cond": None},
    0x146e6: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x000753DC, 4))', "slot_py": None, "target": None, "cond": None},
    0x146e8: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, r[5], 4))', "slot_py": None, "target": None, "cond": None},
    0x146ea: {"kind": 'fpu', "py": 'fr[2] = ts(fr[2] + fr[3])', "slot_py": None, "target": None, "cond": None},
    0x146ec: {"kind": 'fpu', "py": '_wrw(ram, r[4], 4, f2bits(fr[2]))', "slot_py": None, "target": None, "cond": None},
    0x146ee: {"kind": 'reg', "py": 'r[1] = 0x000753E0', "slot_py": None, "target": None, "cond": None},
    0x146f0: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, r[5], 4))', "slot_py": None, "target": None, "cond": None},
    0x146f2: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x000753E0, 4))', "slot_py": None, "target": None, "cond": None},
    0x146f4: {"kind": 'fpu', "py": 'fr[2] = ts(fr[2] + fr[3])', "slot_py": None, "target": None, "cond": None},
    0x146f6: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, r[6], 4, f2bits(fr[2]))', "target": 0x14706, "cond": 'always'},
    0x146fa: {"kind": 'reg', "py": 'r[3] = 0xFFFFA6D4', "slot_py": None, "target": None, "cond": None},
    0x146fc: {"kind": 'reg', "py": 'r[1] = 0xFFFFA6D8', "slot_py": None, "target": None, "cond": None},
    0x146fe: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFA6D4, 4))', "slot_py": None, "target": None, "cond": None},
    0x14700: {"kind": 'fpu', "py": '_wrw(ram, r[4], 4, f2bits(fr[3]))', "slot_py": None, "target": None, "cond": None},
    0x14702: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFA6D8, 4))', "slot_py": None, "target": None, "cond": None},
    0x14704: {"kind": 'fpu', "py": '_wrw(ram, r[6], 4, f2bits(fr[3]))', "slot_py": None, "target": None, "cond": None},
    0x14706: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
