#!/usr/bin/env python3
"""Differential test for diagControlModeSomething (0x5A78C) — pure straight-line lift, 12 bytes.
...
Run from repo root: python3 c/tests/test_diagControlModeSomething_5a78c.py
"""
...
ENTRY = 0x5A78C
RAW = bytes.fromhex("D2 94 D2 86 00 07 DA A8 00 07 DA 9E")
SEED = 42
N = 2000
