#!/usr/bin/env python3
"""Differential test for fpu_clear_result_44506 (0x44506) — v3 lift + v4 FPU, 8 bytes.
...
Run from repo root: python3 c/tests/test_fpu_clear_result_44506_44506.py
"""
...
ENTRY = 0x44506
RAW = bytes.fromhex("F3 8D 93 01 00 0B F3 3A")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCA84
SPAN_END = 0x4450E
SENT = 0x44510     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x44506: {"kind": 'fpu', "py": 'fr[3] = 0.0', "slot_py": None, "target": None, "cond": None},
    0x44508: {"kind": 'reg', "py": 'r[3] = 0xFFFFCA84', "slot_py": None, "target": None, "cond": None},
    0x4450a: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFCA84, 4, f2bits(fr[3]))', "target": None, "cond": None},}
