#!/usr/bin/env python3
"""Differential test for diag_health_4d2da (0x4D2DA) — v3 lift + v4 FPU, 46 bytes.
...
Run from repo root: python3 c/tests/test_diag_health_4d2da_4d2da.py
"""
...
ENTRY = 0x4D2DA
RAW = bytes.fromhex("94 39 93 39 F3 38 F4 3A 95 37 91 37 62 10 22 28 8D 06 00 09 F3 48 90 32 F2 08 F2 35 8F 03 00 09 E2 00 A0 02 25 20 E1 01 25 10 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCF70
SPAN_END = 0x4D308
SENT = 0x4D308     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x4d2da: {"kind": 'reg', "py": 'r[4] = 0xFFFFCF54', "slot_py": None, "target": None, "cond": None},
    0x4d2dc: {"kind": 'reg', "py": 'r[3] = 0xFFFFBD64', "slot_py": None, "target": None, "cond": None},
    0x4d2de: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFBD64, 4))', "slot_py": None, "target": None, "cond": None},
    0x4d2e0: {"kind": 'fpu', "py": '_wrw(ram, r[4], 4, f2bits(fr[3]))', "slot_py": None, "target": None, "cond": None},
    0x4d2e2: {"kind": 'reg', "py": 'r[5] = 0xFFFFCF70', "slot_py": None, "target": None, "cond": None},
    0x4d2e4: {"kind": 'reg', "py": 'r[1] = 0xFFFFBD59', "slot_py": None, "target": None, "cond": None},
    0x4d2e6: {"kind": 'mem', "py": 'r[2] = s8(_rdw(ram, 0xFFFFBD59, 1))', "slot_py": None, "target": None, "cond": None},
    0x4d2e8: {"kind": 'reg', "py": 'T = 1 if (r[2] & r[2]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x4d2ea: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4d2fa, "cond": 'T'},
    0x4d2ee: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, r[4], 4))', "slot_py": None, "target": None, "cond": None},
    0x4d2f0: {"kind": 'reg', "py": 'r[0] = 0xFFFFAA38', "slot_py": None, "target": None, "cond": None},
    0x4d2f2: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0xFFFFAA38, 4))', "slot_py": None, "target": None, "cond": None},
    0x4d2f4: {"kind": 'fpu', "py": 'T = 1 if fr[2] > fr[3] else 0', "slot_py": None, "target": None, "cond": None},
    0x4d2f6: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4d300, "cond": 'notT'},
    0x4d2fa: {"kind": 'reg', "py": 'r[2] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x4d2fc: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFCF70, 1, r[2])', "target": 0x4d304, "cond": 'always'},
    0x4d300: {"kind": 'reg', "py": 'r[1] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x4d302: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCF70, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x4d304: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
