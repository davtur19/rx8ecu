#!/usr/bin/env python3
"""Differential test for sensor_latch_ch2 (0x73BC) — mem lift (RAM-only, straight-line), 8 bytes.
...
Run from repo root: python3 c/tests/test_sensor_latch_ch2_73bc.py
"""
...
ENTRY = 0x73BC
RAW = bytes.fromhex("D3 1B 62 31 D1 1B 21 21")
SEED = 42
N = 2000
...
def spec_mirror(r4, r5, r6, r7, ram, stack_top):
    ...
    r[2] = s16(_rdw(ram, 0xFFFF9F1C, 2))
    # 0x0073C0: op 0xD11B
    r[1] = 0xFFFF9F76
    # 0x0073C2: mov.w r2,@r1
    _wrw(ram, 0xFFFF9F76, 2, r[2])
    r[15] = sp
