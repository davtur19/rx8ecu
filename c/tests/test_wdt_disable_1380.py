#!/usr/bin/env python3
"""Differential test for wdt_disable (0x1380) — v3 lift (branches + delay slots), 20 bytes.
...
Run from repo root: python3 c/tests/test_wdt_disable_1380.py
"""
...
CODE = {
    0x1380: {"kind": 'reg', "py": 'r[3] = 0x00005A1F', "slot_py": None, "target": None, "cond": None},
    0x1382: {"kind": 'reg', "py": 'r[2] = 0xFFFFEC12', "slot_py": None, "target": None, "cond": None},
    0x1384: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFEC12, 2, r[3])', "slot_py": None, "target": None, "cond": None},
    0x1386: {"kind": 'reg', "py": 'r[3] = (r[3] + s8(0xE1)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x1388: {"kind": 'reg', "py": 'r[4] = 0xFFFFEC10', "slot_py": None, "target": None, "cond": None},
    0x138a: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFEC10, 2, r[3])', "slot_py": None, "target": None, "cond": None},
    0x138c: {"kind": 'mem', "py": 'r[1] = s8(_rdw(ram, 0xFFFFEC10, 1))', "slot_py": None, "target": None, "cond": None},
    0x138e: {"kind": 'reg', "py": 'r[0] = 0x0000A53C', "slot_py": None, "target": None, "cond": None},
    0x1390: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFEC10, 2, r[0])', "target": None, "cond": None},}
