#!/usr/bin/env python3
"""Differential test for float_source_select_store_c904 (0x1C904) — v3 lift + v4 FPU, 26 bytes.
...
Run from repo root: python3 c/tests/test_float_source_select_store_c904_1c904.py
"""
...
ENTRY = 0x1C904
RAW = bytes.fromhex("94 44 92 49 63 20 23 38 8F 03 00 09 91 3F A0 02 F3 18 D3 29 F3 38 00 0B F4 3A")
SEED = 43
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFC5DB
SPAN_END = 0x1C91E
SENT = 0x1C91E     # stop-sentinel, placed past the literal pool
