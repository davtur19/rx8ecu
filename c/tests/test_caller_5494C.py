#!/usr/bin/env python3
"""Differential test for call-composition caller_5494C (entry 0x5494C) — v7 ST caller + callee lib, flattened CODE with nested returns.
...
Run: python3 /home/davide/ailocal/rx8ecu/c/tests/test_caller_5494C.py
"""
...
CODE = {
    0x5494c: {"kind": 'reg', "py": 'r[4] = 0xFFFF9004', "slot_py": None, "target": None, "cond": None},
    0x5494e: {"kind": 'reg', "py": 'r[3] = 0x0003EE58', "slot_py": None, "target": None, "cond": None},
    0x54950: {"kind": "call", "py": None, "slot_py": 'r[5] = s8(0x00)', "target": 0x3ee58, "ret_pc": 0x54954, "set_pr": False, "cond": None},
