#!/usr/bin/env python3
"""Differential test for caller_64908 (entry 0x64908) — v8 ST caller (CFG), 48 bytes.
...
Run: python3 test_caller_64908.py
"""
...
CODE = {
    0x64908: {"kind": 'st', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x6490a: {"kind": 'reg', "py": 'r[15] = (r[15] + s8(0xFC)) & 0xFFFFFFFF\nsp = (sp + s8(0xFC)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x6490c: {"kind": 'reg', "py": 'r[2] = 0xFFFF8E9C', "slot_py": None, "target": None, "cond": None},
    0x6490e: {"kind": 'mem', "py": '_wrw(ram, sp, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x64910: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, sp, 1))', "slot_py": None, "target": None, "cond": None},
    0x64912: {"kind": 'mem', "py": 'r[4] = s8(_rdw(ram, 0xFFFF8E9C, 1))', "slot_py": None, "target": None, "cond": None},
    0x64914: {"kind": 'reg', "py": 'r[2] = 0xFFFF8E98', "slot_py": None, "target": None, "cond": None},
    0x64916: {"kind": 'reg', "py": 'r[4] = (r[4] - r[3]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x64918: {"kind": 'mem', "py": 'r[1] = s8(_rdw(ram, r[2], 1))', "slot_py": None, "target": None, "cond": None},
    0x6491a: {"kind": 'reg', "py": 'r[4] = (r[4] + r[1]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x6491c: {"kind": 'reg', "py": 'r[1] = 0x00002420', "slot_py": None, "target": None, "cond": None},
    0x6491e: {"kind": "call", "py": None, "slot_py": '', "target": 0x2420, "ret_pc": 0x64922, "set_pr": True, "cond": None},
    0x64922: {"kind": 'reg', "py": 'r[3] = 0xFFFF8E98', "slot_py": None, "target": None, "cond": None},
    0x64924: {"kind": 'reg', "py": 'r[2] = 0x00002420', "slot_py": None, "target": None, "cond": None},
    0x64926: {"kind": 'mem', "py": '_wrw(ram, 0xFFFF8E98, 2, r[0])', "slot_py": None, "target": None, "cond": None},
    0x64928: {"kind": "call", "py": None, "slot_py": 'r[4] = s8(_rdw(ram, sp, 1))', "target": 0x2420, "ret_pc": 0x6492c, "set_pr": True, "cond": None},
    0x6492c: {"kind": 'reg', "py": 'r[3] = 0xFFFF8E9C', "slot_py": None, "target": None, "cond": None},
    0x6492e: {"kind": 'mem', "py": '_wrw(ram, r[3], 2, r[0])', "slot_py": None, "target": None, "cond": None},
    0x64930: {"kind": 'reg', "py": 'r[15] = (r[15] + s8(0x04)) & 0xFFFFFFFF\nsp = (sp + s8(0x04)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x64932: {"kind": 'st', "py": 'pr = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x64934: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},
