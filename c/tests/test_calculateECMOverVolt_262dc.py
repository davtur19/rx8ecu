#!/usr/bin/env python3
"""Differential test for calculateECMOverVolt (0x262DC) — v3 lift + v4 FPU, 44 bytes.
...
Run from repo root: python3 c/tests/test_calculateECMOverVolt_262dc.py
"""
...
ENTRY = 0x262DC
RAW = bytes.fromhex("94 6C D3 3C 92 6B F3 38 F2 28 F3 25 8F 07 00 09 D1 39 F1 18 90 64 F0 08 F1 05 8D 03 00 09 E2 01 A0 02 24 20 E1 00 24 10 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFB694
SPAN_END = 0x26308
SENT = 0x26308     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x262dc: {"kind": 'reg', "py": 'r[4] = 0xFFFFB662', "slot_py": None, "target": None, "cond": None},
    0x262de: {"kind": 'reg', "py": 'r[3] = 0x00074A14', "slot_py": None, "target": None, "cond": None},
    0x262e0: {"kind": 'reg', "py": 'r[2] = 0xFFFFB690', "slot_py": None, "target": None, "cond": None},
    0x262e2: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x00074A14, 4))', "slot_py": None, "target": None, "cond": None},
    0x262e4: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0xFFFFB690, 4))', "slot_py": None, "target": None, "cond": None},
    0x262e6: {"kind": 'fpu', "py": 'T = 1 if fr[3] > fr[2] else 0', "slot_py": None, "target": None, "cond": None},
    0x262e8: {"kind": "branch", "py": None, "slot_py": '', "target": 0x262fa, "cond": 'notT'},
    0x262ec: {"kind": 'reg', "py": 'r[1] = 0x00074A18', "slot_py": None, "target": None, "cond": None},
    0x262ee: {"kind": 'fpu', "py": 'fr[1] = bits2f(_rdw(ram, 0x00074A18, 4))', "slot_py": None, "target": None, "cond": None},
    0x262f0: {"kind": 'reg', "py": 'r[0] = 0xFFFFB694', "slot_py": None, "target": None, "cond": None},
    0x262f2: {"kind": 'fpu', "py": 'fr[0] = bits2f(_rdw(ram, 0xFFFFB694, 4))', "slot_py": None, "target": None, "cond": None},
    0x262f4: {"kind": 'fpu', "py": 'T = 1 if fr[1] > fr[0] else 0', "slot_py": None, "target": None, "cond": None},
    0x262f6: {"kind": "branch", "py": None, "slot_py": '', "target": 0x26300, "cond": 'T'},
    0x262fa: {"kind": 'reg', "py": 'r[2] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x262fc: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFB662, 1, r[2])', "target": 0x26304, "cond": 'always'},
    0x26300: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x26302: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFB662, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x26304: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
