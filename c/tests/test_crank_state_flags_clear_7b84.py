#!/usr/bin/env python3
"""Differential test for crank_state_flags_clear (0x7B84) — v3 lift (branches + delay slots), 12 bytes.
...
Run from repo root: python3 c/tests/test_crank_state_flags_clear_7b84.py
"""
...
ENTRY = 0x7B84
RAW = bytes.fromhex("D3 30 E4 00 D2 30 23 40 00 0B 22 40")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFF9FC8
SPAN_END = 0x7B90
SENT = 0x7B90     # stop-sentinel, placed past the literal pool
