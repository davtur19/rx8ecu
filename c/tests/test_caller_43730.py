#!/usr/bin/env python3
"""Differential test for caller_43730 (entry 0x43730) — v8 ST caller (CFG), 48 bytes.
...
Run: python3 test_caller_43730.py
"""
...
CODE = {
    0x43730: {"kind": 'mem', "py": 'local[0x3FC] = r[14]\n_wrw(ram, STACK_BASE + 0x3FC, 4, r[14])\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x43732: {"kind": 'st', "py": 'local[0x3F8] = pr\n_wrw(ram, STACK_BASE + 0x3F8, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x43734: {"kind": 'reg', "py": 'r[14] = 0xFFFFC9E4', "slot_py": None, "target": None, "cond": None},
    0x43736: {"kind": 'reg', "py": 'r[3] = 0xFFFFB3C8', "slot_py": None, "target": None, "cond": None},
    0x43738: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFB3C8, 1))', "slot_py": None, "target": None, "cond": None},
    0x4373a: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x4373c: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x4373e: {"kind": "branch", "py": None, "slot_py": '', "target": 0x43756, "cond": 'notT'},
    0x43742: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFC9E4, 4))', "slot_py": None, "target": None, "cond": None},
    0x43744: {"kind": 'reg', "py": 'r[2] = 0xFFFFB3C4', "slot_py": None, "target": None, "cond": None},
    0x43746: {"kind": 'fpu', "py": 'fr[5] = bits2f(_rdw(ram, 0xFFFFB3C4, 4))', "slot_py": None, "target": None, "cond": None},
    0x43748: {"kind": 'reg', "py": 'r[1] = 0x0007D980', "slot_py": None, "target": None, "cond": None},
    0x4374a: {"kind": 'fpu', "py": 'fr[5] = ts(fr[5] + fr[3])', "slot_py": None, "target": None, "cond": None},
    0x4374c: {"kind": 'reg', "py": 'r[3] = 0x000023F4', "slot_py": None, "target": None, "cond": None},
    0x4374e: {"kind": "call", "py": None, "slot_py": 'fr[4] = bits2f(_rdw(ram, 0x0007D980, 4))', "target": 0x23f4, "ret_pc": 0x43752, "set_pr": True, "cond": None},
    0x43752: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFC9E4, 4, f2bits(fr[0]))', "target": 0x4375a, "cond": 'always'},
    0x43756: {"kind": 'fpu', "py": 'fr[3] = 0.0', "slot_py": None, "target": None, "cond": None},
    0x43758: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFC9E4, 4, f2bits(fr[3]))', "slot_py": None, "target": None, "cond": None},
    0x4375a: {"kind": 'st', "py": 'pr = _rdw(ram, STACK_BASE + 0x3F8, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x4375c: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, STACK_BASE + 0x3FC, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},
