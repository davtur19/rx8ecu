#!/usr/bin/env python3
"""Differential test for atu2_edge_capture_config_en_dis (0x6F16) — v3 lift (branches + delay slots), 36 bytes.
...
Run from repo root: python3 c/tests/test_atu2_edge_capture_config_en_dis_6f16.py
"""
...
ENTRY = 0x6F16
RAW = bytes.fromhex("C9 DF 24 00 62 50 E3 1B A0 06 25 30 60 40 C9 DF 24 00 63 50 E2 18 25 20 60 40 C9 2F CB 20 24 00 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    ...
    0x6f18: {"kind": 'mem', "py": '_wrw(ram, r[4], 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x6f1a: {"kind": 'mem', "py": 'r[2] = s8(_rdw(ram, r[5], 1))', "slot_py": None, "target": None, "cond": None},
    0x6f1c: {"kind": 'reg', "py": 'r[3] = s8(0x1B)', "slot_py": None, "target": None, "cond": None},
    0x6f1e: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, r[5], 1, r[3])', "target": 0x6f2e, "cond": 'always'},
    ...
    0x6f26: {"kind": 'mem', "py": '_wrw(ram, r[4], 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x6f28: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, r[5], 1))', "slot_py": None, "target": None, "cond": None},
    ...
    0x6f34: {"kind": 'mem', "py": '_wrw(ram, r[4], 1, r[0])', "slot_py": None, "target": None, "cond": None},
