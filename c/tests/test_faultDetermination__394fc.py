#!/usr/bin/env python3
"""Differential test for faultDetermination_ (0x394FC) — v3 lift + v4 FPU, 14 bytes.
...
Run from repo root: python3 c/tests/test_faultDetermination__394fc.py
"""
...
ENTRY = 0x394FC
RAW = bytes.fromhex("F4 3A F3 8D 93 3D F5 3A F2 48 00 0B F3 2A")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFC538
SPAN_END = 0x3950A
SENT = 0x3950A     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x394fc: {"kind": 'fpu', "py": '_wrw(ram, r[4], 4, f2bits(fr[3]))', "slot_py": None, "target": None, "cond": None},
    0x394fe: {"kind": 'fpu', "py": 'fr[3] = 0.0', "slot_py": None, "target": None, "cond": None},
    0x39500: {"kind": 'reg', "py": 'r[3] = 0xFFFFC538', "slot_py": None, "target": None, "cond": None},
    0x39502: {"kind": 'fpu', "py": '_wrw(ram, r[5], 4, f2bits(fr[3]))', "slot_py": None, "target": None, "cond": None},
    0x39504: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, r[4], 4))', "slot_py": None, "target": None, "cond": None},
    0x39506: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFC538, 4, f2bits(fr[2]))', "target": None, "cond": None},}
