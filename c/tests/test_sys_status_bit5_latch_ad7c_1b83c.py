#!/usr/bin/env python3
"""Differential test for sys_status_bit5_latch_ad7c (0x1B83C) — v3 lift (branches + delay slots), 44 bytes.
...
Run from repo root: python3 c/tests/test_sys_status_bit5_latch_ad7c_1b83c.py
"""
...
ENTRY = 0x1B83C
RAW = bytes.fromhex("93 4D 60 30 60 0C 88 01 8F 0E 00 09 94 48 D2 25 60 21 60 0D C8 20 8D 02 00 09 A0 01 E1 01 E1 00 24 10 62 40 D3 20 23 20 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBD68
SPAN_END = 0x1B868
SENT = 0x1B868     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x1b83c: {"kind": 'reg', "py": 'r[3] = 0xFFFFBD68', "slot_py": None, "target": None, "cond": None},
    0x1b83e: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFBD68, 1))', "slot_py": None, "target": None, "cond": None},
    0x1b840: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x1b842: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x1b844: {"kind": "branch", "py": None, "slot_py": '', "target": 0x1b864, "cond": 'notT'},
    0x1b848: {"kind": 'reg', "py": 'r[4] = 0xFFFFAD7C', "slot_py": None, "target": None, "cond": None},
    0x1b84a: {"kind": 'reg', "py": 'r[2] = 0xFFFF9EC8', "slot_py": None, "target": None, "cond": None},
    0x1b84c: {"kind": 'mem', "py": 'r[0] = s16(_rdw(ram, 0xFFFF9EC8, 2))', "slot_py": None, "target": None, "cond": None},
    0x1b84e: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x1b850: {"kind": 'reg', "py": 'T = 1 if (r[0] & 0x20) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x1b852: {"kind": "branch", "py": None, "slot_py": '', "target": 0x1b85a, "cond": 'T'},
    0x1b856: {"kind": "branch", "py": None, "slot_py": 'r[1] = s8(0x01)', "target": 0x1b85c, "cond": 'always'},
    0x1b85a: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x1b85c: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFAD7C, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x1b85e: {"kind": 'mem', "py": 'r[2] = s8(_rdw(ram, 0xFFFFAD7C, 1))', "slot_py": None, "target": None, "cond": None},
    0x1b860: {"kind": 'reg', "py": 'r[3] = 0xFFFFAD7E', "slot_py": None, "target": None, "cond": None},
    0x1b862: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFAD7E, 1, r[2])', "slot_py": None, "target": None, "cond": None},
    0x1b864: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
