#!/usr/bin/env python3
"""Differential test for sensor_limit_check_3FE30 (0x3FE30) — v3 lift + v4 FPU, 64 bytes.
...
Run from repo root: python3 c/tests/test_sensor_limit_check_3FE30_3fe30.py
"""
...
RAM_MAX = 0xFFFFD201
SPAN_END = 0x3FE70
SENT = 0x3FE70     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x3fe30: {"kind": 'reg', "py": 'r[3] = 0xFFFFAD98', "slot_py": None, "target": None, "cond": None},
    0x3fe32: {"kind": 'fpu', "py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFAD98, 4))', "slot_py": None, "target": None, "cond": None},
    0x3fe34: {"kind": 'reg', "py": 'r[5] = 0xFFFFC730', "slot_py": None, "target": None, "cond": None},
    0x3fe36: {"kind": 'reg', "py": 'r[4] = 0xFFFFC734', "slot_py": None, "target": None, "cond": None},
    0x3fe38: {"kind": 'reg', "py": 'r[2] = 0x0007DA10', "slot_py": None, "target": None, "cond": None},
    0x3fe3a: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x0007DA10, 4))', "slot_py": None, "target": None, "cond": None},
    0x3fe3c: {"kind": 'reg', "py": 'r[1] = 0xFFFFB3A4', "slot_py": None, "target": None, "cond": None},
    0x3fe3e: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0xFFFFB3A4, 4))', "slot_py": None, "target": None, "cond": None},
    0x3fe40: {"kind": 'fpu', "py": 'T = 1 if fr[3] > fr[2] else 0', "slot_py": None, "target": None, "cond": None},
    0x3fe42: {"kind": "branch", "py": None, "slot_py": '', "target": 0x3fe52, "cond": 'T'},
    0x3fe46: {"kind": 'reg', "py": 'r[3] = 0xFFFFD201', "slot_py": None, "target": None, "cond": None},
    0x3fe48: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFD201, 1))', "slot_py": None, "target": None, "cond": None},
    0x3fe4a: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x3fe4c: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x3fe4e: {"kind": "branch", "py": None, "slot_py": '', "target": 0x3fe58, "cond": 'notT'},
    0x3fe52: {"kind": 'fpu', "py": '_wrw(ram, r[4], 4, f2bits(fr[4]))', "slot_py": None, "target": None, "cond": None},
    0x3fe54: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, r[5], 4, f2bits(fr[4]))', "target": 0x3fe6c, "cond": 'always'},
    0x3fe58: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, r[4], 4))', "slot_py": None, "target": None, "cond": None},
    0x3fe5a: {"kind": 'fpu', "py": 'T = 1 if fr[4] > fr[3] else 0', "slot_py": None, "target": None, "cond": None},
    0x3fe5c: {"kind": "branch", "py": None, "slot_py": '', "target": 0x3fe62, "cond": 'notT'},
    0x3fe60: {"kind": 'fpu', "py": '_wrw(ram, r[4], 4, f2bits(fr[4]))', "slot_py": None, "target": None, "cond": None},
    0x3fe62: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, r[5], 4))', "slot_py": None, "target": None, "cond": None},
    0x3fe64: {"kind": 'fpu', "py": 'T = 1 if fr[4] > fr[3] else 0', "slot_py": None, "target": None, "cond": None},
    0x3fe66: {"kind": "branch", "py": None, "slot_py": '', "target": 0x3fe6c, "cond": 'T'},
    0x3fe6a: {"kind": 'fpu', "py": '_wrw(ram, r[5], 4, f2bits(fr[4]))', "slot_py": None, "target": None, "cond": None},
    0x3fe6c: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
