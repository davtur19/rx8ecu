#!/usr/bin/env python3
"""Differential test for oil_pressure_check_3C038 (0x3C038) — v3 lift (branches + delay slots), 32 bytes.
...
Run from repo root: python3 c/tests/test_oil_pressure_check_3C038_3c038.py
"""
...
CODE = {
    0x3c038: {"kind": 'reg', "py": 'r[4] = 0xFFFFD1C8', "slot_py": None, "target": None, "cond": None},
    0x3c03a: {"kind": 'reg', "py": 'r[3] = 0xFFFFF726', "slot_py": None, "target": None, "cond": None},
    0x3c03c: {"kind": 'mem', "py": 'r[0] = s16(_rdw(ram, 0xFFFFF726, 2))', "slot_py": None, "target": None, "cond": None},
    0x3c03e: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x3c040: {"kind": 'reg', "py": 'r[2] = 0x00000800', "slot_py": None, "target": None, "cond": None},
    0x3c042: {"kind": 'reg', "py": 'r[0] = (r[0] & r[2]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x3c044: {"kind": 'reg', "py": 'r[2] = 0xFFFFD1C9', "slot_py": None, "target": None, "cond": None},
    0x3c046: {"kind": 'reg', "py": 'T = 1 if (r[0] & r[0]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x3c048: {"kind": 'reg', "py": 'r[0] = T;', "slot_py": None, "target": None, "cond": None},
    0x3c04a: {"kind": 'reg', "py": 'r[0] = (r[0] ^ 0x01) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x3c04c: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x3c04e: {"kind": 'reg', "py": 'r[3] = T;', "slot_py": None, "target": None, "cond": None},
    0x3c050: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD1C8, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x3c052: {"kind": 'mem', "py": 'r[1] = s8(_rdw(ram, 0xFFFFD1C8, 1))', "slot_py": None, "target": None, "cond": None},
    0x3c054: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFD1C9, 1, r[1])', "target": None, "cond": None},}
