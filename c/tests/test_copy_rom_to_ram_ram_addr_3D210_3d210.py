#!/usr/bin/env python3
"""Differential test for copy_rom_to_ram_ram_addr_3D210 (0x3D210) — v3 lift (branches + delay slots), 10 bytes.
...
Run from repo root: python3 c/tests/test_copy_rom_to_ram_ram_addr_3D210_3d210.py
"""
...
RAM_MAX = 0xFFFFC634
SPAN_END = 0x3D21A
SENT = 0x3D21A     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x3d210: {"kind": 'reg', "py": 'r[2] = 0x0007A940', "slot_py": None, "target": None, "cond": None},
    0x3d212: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0x0007A940, 1))', "slot_py": None, "target": None, "cond": None},
    0x3d214: {"kind": 'reg', "py": 'r[1] = 0xFFFFC634', "slot_py": None, "target": None, "cond": None},
    0x3d216: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFC634, 1, r[3])', "target": None, "cond": None},}
