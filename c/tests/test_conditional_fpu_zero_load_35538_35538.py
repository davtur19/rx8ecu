#!/usr/bin/env python3
"""Differential test for conditional_fpu_zero_load_35538 (0x35538) — v3 lift + v4 FPU, 22 bytes.
...
Run from repo root: python3 c/tests/test_conditional_fpu_zero_load_35538_35538.py
"""
...
ENTRY = 0x35538
RAW = bytes.fromhex("D2 14 60 20 60 0C 88 01 8F 03 00 09 93 06 F3 8D F3 3A 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFC178
SPAN_END = 0x3554E
SENT = 0x3554E     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x35538: {"kind": 'reg', "py": 'r[2] = 0xFFFF9F8C', "slot_py": None, "target": None, "cond": None},
    0x3553a: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFF9F8C, 1))', "slot_py": None, "target": None, "cond": None},
    0x3553c: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x3553e: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x35540: {"kind": "branch", "py": None, "slot_py": '', "target": 0x3554a, "cond": 'notT'},
    0x35544: {"kind": 'reg', "py": 'r[3] = 0xFFFFC178', "slot_py": None, "target": None, "cond": None},
    0x35546: {"kind": 'fpu', "py": 'fr[3] = 0.0', "slot_py": None, "target": None, "cond": None},
    0x35548: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFC178, 4, f2bits(fr[3]))', "slot_py": None, "target": None, "cond": None},
    0x3554a: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
