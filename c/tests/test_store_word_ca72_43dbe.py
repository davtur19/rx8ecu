#!/usr/bin/env python3
"""Differential test for store_word_ca72 (0x43DBE) — v3 lift + v4 FPU, 48 bytes.
...
Run from repo root: python3 c/tests/test_store_word_ca72_43dbe.py
"""
...
ENTRY = 0x43DBE
RAW = bytes.fromhex("91 6B 92 6B 63 11 63 3D 33 20 8F 0F 00 09 D4 35 D3 36 92 64 F3 38 F2 28 F3 25 8D 04 00 09 D1 33 60 11 A0 03 24 01 D1 32 62 11 24 21 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCD90
SPAN_END = 0x43DEE
SENT = 0x43DEE     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x43dbe: {"kind": 'reg', "py": 'r[1] = 0xFFFFBAD6', "slot_py": None, "target": None, "cond": None},
    0x43dc0: {"kind": 'reg', "py": 'r[2] = 0x000007D0', "slot_py": None, "target": None, "cond": None},
    0x43dc2: {"kind": 'mem', "py": 'r[3] = s16(_rdw(ram, 0xFFFFBAD6, 2))', "slot_py": None, "target": None, "cond": None},
    0x43dc4: {"kind": 'reg', "py": 'r[3] = r[3] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x43dc6: {"kind": 'reg', "py": 'T = 1 if r[3] == r[2] else 0', "slot_py": None, "target": None, "cond": None},
    0x43dc8: {"kind": "branch", "py": None, "slot_py": '', "target": 0x43dea, "cond": 'notT'},
    0x43dcc: {"kind": 'reg', "py": 'r[4] = 0xFFFFCA72', "slot_py": None, "target": None, "cond": None},
    0x43dce: {"kind": 'reg', "py": 'r[3] = 0x0007ADC8', "slot_py": None, "target": None, "cond": None},
    0x43dd0: {"kind": 'reg', "py": 'r[2] = 0xFFFFCD90', "slot_py": None, "target": None, "cond": None},
    0x43dd2: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x0007ADC8, 4))', "slot_py": None, "target": None, "cond": None},
    0x43dd4: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0xFFFFCD90, 4))', "slot_py": None, "target": None, "cond": None},
    0x43dd6: {"kind": 'fpu', "py": 'T = 1 if fr[3] > fr[2] else 0', "slot_py": None, "target": None, "cond": None},
    0x43dd8: {"kind": "branch", "py": None, "slot_py": '', "target": 0x43de4, "cond": 'T'},
    0x43ddc: {"kind": 'reg', "py": 'r[1] = 0x0007ABBC', "slot_py": None, "target": None, "cond": None},
    0x43dde: {"kind": 'mem', "py": 'r[0] = s16(_rdw(ram, 0x0007ABBC, 2))', "slot_py": None, "target": None, "cond": None},
    0x43de0: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFCA72, 2, r[0])', "target": 0x43dea, "cond": 'always'},
    0x43de4: {"kind": 'reg', "py": 'r[1] = 0x0007ABBE', "slot_py": None, "target": None, "cond": None},
    0x43de6: {"kind": 'mem', "py": 'r[2] = s16(_rdw(ram, 0x0007ABBE, 2))', "slot_py": None, "target": None, "cond": None},
    0x43de8: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCA72, 2, r[2])', "slot_py": None, "target": None, "cond": None},
    0x43dea: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
