#!/usr/bin/env python3
"""Differential test for Immo_Keygen_related_ADC (0x36AFC) — v3 lift (branches + delay slots), 66 bytes.
...
Run from repo root: python3 c/tests/test_Immo_Keygen_related_ADC_36afc.py
"""
...
ENTRY = 0x36AFC
RAW = bytes.fromhex("D4 40 62 40 93 74 62 2C 32 33 8D 03 00 09 61 40 71 01 24 10 63 40 E2 19 63 3C 33 23 8F 0F 00 09 D5 39 61 50 61 1C 41 15 8F 07 E6 00 61 50 E3 01 D0 36 71 FF 25 10 A0 01 20 30 27 60 24 60 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
