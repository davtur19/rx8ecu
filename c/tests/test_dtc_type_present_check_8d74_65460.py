#!/usr/bin/env python3
"""Differential test for dtc_type_present_check_8d74 (0x65460) — v3 lift (branches + delay slots), 30 bytes.
...
Run from repo root: python3 c/tests/test_dtc_type_present_check_8d74_65460.py
"""
...
ENTRY = 0x65460
RAW = bytes.fromhex("D0 31 64 4D 44 00 04 4D D0 30 64 4D 44 00 04 4C 64 4C 24 48 8D 01 E5 00 E5 01 00 0B 60 53")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = None
SPAN_END = 0x6547E
SENT = 0x6547E     # stop-sentinel, placed past the literal pool
