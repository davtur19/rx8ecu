#!/usr/bin/env python3
"""Differential test for ctrl_archive_5c5ce (0x5C5CE) — v3 lift (branches + delay slots), 10 bytes.
...
Run from repo root: python3 c/tests/test_ctrl_archive_5c5ce_5c5ce.py
"""
...
ENTRY = 0x5C5CE
RAW = bytes.fromhex("64 F2 7F 04 4F 26 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = None
SPAN_END = 0x5C5D8
SENT = 0x5C5D8     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x5c5ce: {"kind": 'mem', "py": 'r[4] = _rdw(ram, STACK_BASE + 0x400, 4)', "slot_py": None, "target": None, "cond": None},
    0x5c5d0: {"kind": 'reg', "py": 'r[15] = (r[15] + s8(0x04)) & 0xFFFFFFFF\nsp = (sp + s8(0x04)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x5c5d2: {"kind": 'mem', "py": 'pr = _rdw(ram, STACK_BASE + 0x404, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x5c5d4: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
