#!/usr/bin/env python3
"""Differential test for can_msg_schedule_handler (0xA500) — v3 lift (branches + delay slots), 14 bytes.
...
Run from repo root: python3 c/tests/test_can_msg_schedule_handler_a500.py
"""
...
ENTRY = 0xA500
RAW = bytes.fromhex("91 45 21 31 92 44 22 41 E3 02 00 0B 25 31")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
CODE = {
    ...
    0xa50a: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, r[5], 2, r[3])', "target": None, "cond": None},}
