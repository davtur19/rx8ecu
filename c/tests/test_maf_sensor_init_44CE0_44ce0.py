#!/usr/bin/env python3
"""Differential test for maf_sensor_init_44CE0 (0x44CE0) — v3 lift + v4 FPU, 24 bytes.
...
Run from repo root: python3 c/tests/test_maf_sensor_init_44CE0_44ce0.py
"""
...
RAM_MAX = 0xFFFFCBB0
SPAN_END = 0x44CF8
SENT = 0x44CF8     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x44ce0: {"kind": 'reg', "py": 'r[2] = 0xFFFFCBAA', "slot_py": None, "target": None, "cond": None},
    0x44ce2: {"kind": 'reg', "py": 'r[3] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x44ce4: {"kind": 'reg', "py": 'r[1] = 0xFFFFB5B8', "slot_py": None, "target": None, "cond": None},
    0x44ce6: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCBAA, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x44ce8: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFB5B8, 4))', "slot_py": None, "target": None, "cond": None},
    0x44cea: {"kind": 'reg', "py": 'r[0] = 0xFFFFCBAC', "slot_py": None, "target": None, "cond": None},
    0x44cec: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFCBAC, 4, f2bits(fr[3]))', "slot_py": None, "target": None, "cond": None},
    0x44cee: {"kind": 'reg', "py": 'r[3] = 0xFFFFC12C', "slot_py": None, "target": None, "cond": None},
    0x44cf0: {"kind": 'reg', "py": 'r[2] = 0xFFFFCBB0', "slot_py": None, "target": None, "cond": None},
    0x44cf2: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFC12C, 4))', "slot_py": None, "target": None, "cond": None},
    0x44cf4: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFCBB0, 4, f2bits(fr[3]))', "target": None, "cond": None},}
