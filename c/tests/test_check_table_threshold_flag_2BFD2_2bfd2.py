#!/usr/bin/env python3
"""Differential test for check_table_threshold_flag_2BFD2 (0x2BFD2) — v3 lift (branches + delay slots), 44 bytes.
...
Run from repo root: python3 c/tests/test_check_table_threshold_flag_2BFD2_2bfd2.py
"""
...
RAM_MAX = 0xFFFFBC26
SPAN_END = 0x2BFFE
SENT = 0x2BFFE     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x2bfd2: {"kind": 'reg', "py": 'r[4] = 0xFFFFBC22', "slot_py": None, "target": None, "cond": None},
    0x2bfd4: {"kind": 'reg', "py": 'r[2] = 0xFFFFBC16', "slot_py": None, "target": None, "cond": None},
    0x2bfd6: {"kind": 'mem', "py": 'r[3] = s16(_rdw(ram, 0xFFFFBC16, 2))', "slot_py": None, "target": None, "cond": None},
    0x2bfd8: {"kind": 'reg', "py": 'r[1] = 0x0000FFFF', "slot_py": None, "target": None, "cond": None},
    0x2bfda: {"kind": 'reg', "py": 'r[3] = r[3] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x2bfdc: {"kind": 'reg', "py": 'T = 1 if r[3] == r[1] else 0', "slot_py": None, "target": None, "cond": None},
    0x2bfde: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2bff0, "cond": 'T'},
    0x2bfe2: {"kind": 'reg', "py": 'r[3] = 0xFFFFBC26', "slot_py": None, "target": None, "cond": None},
    0x2bfe4: {"kind": 'reg', "py": 'r[1] = 0x0007BA1C', "slot_py": None, "target": None, "cond": None},
    0x2bfe6: {"kind": 'mem', "py": 'r[0] = s16(_rdw(ram, 0xFFFFBC26, 2))', "slot_py": None, "target": None, "cond": None},
    0x2bfe8: {"kind": 'mem', "py": 'r[2] = s16(_rdw(ram, 0x0007BA1C, 2))', "slot_py": None, "target": None, "cond": None},
    0x2bfea: {"kind": 'reg', "py": 'T = 1 if (r[0] & 0xFFFFFFFF) >= (r[2] & 0xFFFFFFFF) else 0', "slot_py": None, "target": None, "cond": None},
    0x2bfec: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2bff6, "cond": 'notT'},
    0x2bff0: {"kind": 'reg', "py": 'r[3] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x2bff2: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFBC22, 1, r[3])', "target": 0x2bffa, "cond": 'always'},
    0x2bff6: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x2bff8: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBC22, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x2bffa: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
