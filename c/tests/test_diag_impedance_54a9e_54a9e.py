#!/usr/bin/env python3
"""Differential test for diag_impedance_54a9e (0x54A9E) — v3 lift (branches + delay slots), 28 bytes.
...
Run from repo root: python3 c/tests/test_diag_impedance_54a9e_54a9e.py
"""
...
CODE = {
    0x54a9e: {"kind": 'reg', "py": 'r[4] = 0xFFFFD1E9', "slot_py": None, "target": None, "cond": None},
    0x54aa0: {"kind": 'reg', "py": 'r[2] = 0xFFFFD1E8', "slot_py": None, "target": None, "cond": None},
    0x54aa2: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFD1E8, 1))', "slot_py": None, "target": None, "cond": None},
    0x54aa4: {"kind": 'reg', "py": 'r[3] = r[3] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x54aa6: {"kind": 'reg', "py": 'T = 1 if s32(r[3]) > 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x54aa8: {"kind": "branch", "py": None, "slot_py": '', "target": 0x54ab2, "cond": 'notT'},
    0x54aac: {"kind": 'reg', "py": 'r[1] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x54aae: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFD1E9, 1, r[1])', "target": 0x54ab6, "cond": 'always'},
    0x54ab2: {"kind": 'reg', "py": 'r[0] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x54ab4: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD1E9, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x54ab6: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
