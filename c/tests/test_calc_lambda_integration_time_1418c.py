#!/usr/bin/env python3
"""Differential test for calc_lambda_integration_time (0x1418C) — v3 lift + v4 FPU, 44 bytes.
...
RAM_MAX = 0xFFFFADC8
SPAN_END = 0x141B8
SENT = 0x141B8     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x1418c: {"kind": 'reg', "py": 'r[5] = 0xFFFFA772', "slot_py": None, "target": None, "cond": None},
    0x1418e: {"kind": 'reg', "py": 'r[3] = 0x00072D6C', "slot_py": None, "target": None, "cond": None},
    0x14190: {"kind": 'reg', "py": 'r[2] = 0xFFFFADC8', "slot_py": None, "target": None, "cond": None},
    0x14192: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x00072D6C, 4))', "slot_py": None, "target": None, "cond": None},
    0x14194: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0xFFFFADC8, 4))', "slot_py": None, "target": None, "cond": None},
    0x14196: {"kind": 'fpu', "py": 'T = 1 if fr[3] > fr[2] else 0', "slot_py": None, "target": None, "cond": None},
    0x14198: {"kind": "branch", "py": None, "slot_py": '', "target": 0x141a4, "cond": 'T'},
    0x1419c: {"kind": 'reg', "py": 'r[1] = 0x00072D4A', "slot_py": None, "target": None, "cond": None},
    0x1419e: {"kind": 'mem', "py": 'r[0] = s16(_rdw(ram, 0x00072D4A, 2))', "slot_py": None, "target": None, "cond": None},
    0x141a0: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFA772, 2, r[0])', "target": 0x141b4, "cond": 'always'},
    0x141a4: {"kind": 'mem', "py": 'r[4] = s16(_rdw(ram, 0xFFFFA772, 2))', "slot_py": None, "target": None, "cond": None},
    0x141a6: {"kind": 'reg', "py": 'r[1] = r[4] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x141a8: {"kind": 'reg', "py": 'T = 1 if s32(r[1]) > 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x141aa: {"kind": "branch", "py": None, "slot_py": '', "target": 0x141b4, "cond": 'notT'},
    0x141ae: {"kind": 'reg', "py": 'r[1] = 0x0000FFFF', "slot_py": None, "target": None, "cond": None},
    0x141b0: {"kind": 'reg', "py": 'r[4] = (r[4] + r[1]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x141b2: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA772, 2, r[4])', "slot_py": None, "target": None, "cond": None},
    0x141b4: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
