#!/usr/bin/env python3
"""Differential test for caller_53A24 (entry 0x53A24) — v8 ST caller (CFG), 22 bytes.
...
Run: python3 test_caller_53A24.py
"""
...
CODE = {
    0x53a24: {"kind": 'st', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x53a26: {"kind": 'fpu', "py": 'fr[6] = 0.0', "slot_py": None, "target": None, "cond": None},
    0x53a28: {"kind": 'reg', "py": 'r[0] = 0x00053AFC', "slot_py": None, "target": None, "cond": None},
    0x53a2a: {"kind": 'reg', "py": 'r[3] = 0xFFFFB5DC', "slot_py": None, "target": None, "cond": None},
    0x53a2c: {"kind": 'reg', "py": 'r[2] = 0x00002490', "slot_py": None, "target": None, "cond": None},
    0x53a2e: {"kind": 'fpu', "py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFB5DC, 4))', "slot_py": None, "target": None, "cond": None},
    0x53a30: {"kind": "call", "py": None, "slot_py": 'fr[5] = bits2f(_rdw(ram, 0x00053AFC, 4))', "target": 0x2490, "ret_pc": 0x53a34, "set_pr": True, "cond": None},
    0x53a34: {"kind": 'st', "py": 'pr = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x53a36: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},
