#!/usr/bin/env python3
"""Differential test for FUN_0004c0c4 (0x4C0C4) — v3 lift + v4 FPU, 10 bytes.
...
Run from repo root: python3 c/tests/test_FUN_0004c0c4_4c0c4.py
"""
...
RAM_MAX = 0xFFFFCD90
SPAN_END = 0x4C0CE
SENT = 0x4C0CE     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x4c0c4: {"kind": 'reg', "py": 'r[3] = 0xFFFFCD8C', "slot_py": None, "target": None, "cond": None},
    0x4c0c6: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFCD8C, 4))', "slot_py": None, "target": None, "cond": None},
    0x4c0c8: {"kind": 'reg', "py": 'r[2] = 0xFFFFCD90', "slot_py": None, "target": None, "cond": None},
    0x4c0ca: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFCD90, 4, f2bits(fr[3]))', "target": None, "cond": None},}
