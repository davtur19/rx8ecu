#!/usr/bin/env python3
"""Differential test for caller_E4D8 (entry 0xE4D8) — v8 ST caller (CFG), 36 bytes.
...
Run: python3 test_caller_E4D8.py
"""
...
CODE = {
    0xe4d8: {"kind": 'mem', "py": 'local[0x3FC] = r[14]\n_wrw(ram, STACK_BASE + 0x3FC, 4, r[14])\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xe4da: {"kind": 'st', "py": 'local[0x3F8] = pr\n_wrw(ram, STACK_BASE + 0x3F8, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xe4dc: {"kind": 'reg', "py": 'r[14] = 0xFFFFA426', "slot_py": None, "target": None, "cond": None},
    0xe4de: {"kind": 'reg', "py": 'r[2] = 0xFFFFA428', "slot_py": None, "target": None, "cond": None},
    0xe4e0: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFA428, 1))', "slot_py": None, "target": None, "cond": None},
    0xe4e2: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0xe4e4: {"kind": "branch", "py": None, "slot_py": '', "target": 0xe4ec, "cond": 'notT'},
    0xe4e8: {"kind": "branch", "py": None, "slot_py": 'r[0] = s8(0x00)', "target": 0xe4f4, "cond": 'always'},
    0xe4ec: {"kind": 'reg', "py": 'r[1] = 0x00002460', "slot_py": None, "target": None, "cond": None},
    0xe4ee: {"kind": 'reg', "py": 'r[5] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0xe4f0: {"kind": "call", "py": None, "slot_py": 'r[4] = s16(_rdw(ram, 0xFFFFA426, 2))', "target": 0x2460, "ret_pc": 0xe4f4, "set_pr": True, "cond": None},
    0xe4f4: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA426, 2, r[0])', "slot_py": None, "target": None, "cond": None},
    0xe4f6: {"kind": 'st', "py": 'pr = _rdw(ram, STACK_BASE + 0x3F8, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xe4f8: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, STACK_BASE + 0x3FC, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},
