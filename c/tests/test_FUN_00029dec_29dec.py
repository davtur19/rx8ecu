#!/usr/bin/env python3
"""Differential test for FUN_00029dec (0x29DEC) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_FUN_00029dec_29dec.py
"""
...
RAM_MAX = 0xFFFFBB66
SPAN_END = 0x29DF4
SENT = 0x29DF4     # stop-sentinel, placed past the literal pool
