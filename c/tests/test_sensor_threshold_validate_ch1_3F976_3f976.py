#!/usr/bin/env python3
"""Differential test for sensor_threshold_validate_ch1_3F976 (0x3F976) — v3 lift + v4 FPU, 40 bytes.
...
Run from repo root: python3 c/tests/test_sensor_threshold_validate_ch1_3F976_3f976.py
"""
...
RAM_MAX = 0xFFFFC6C0
SPAN_END = 0x3F99E
SENT = 0x3F99E     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x3f976: {"kind": 'reg', "py": 'r[3] = 0xFFFFC6B4', "slot_py": None, "target": None, "cond": None},
    0x3f978: {"kind": 'reg', "py": 'r[4] = 0xFFFFC6C0', "slot_py": None, "target": None, "cond": None},
    0x3f97a: {"kind": 'fpu', "py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFC6B4, 4))', "slot_py": None, "target": None, "cond": None},
    0x3f97c: {"kind": 'reg', "py": 'r[2] = 0x0007AF10', "slot_py": None, "target": None, "cond": None},
    0x3f97e: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x0007AF10, 4))', "slot_py": None, "target": None, "cond": None},
    0x3f980: {"kind": 'fpu', "py": 'T = 1 if fr[3] > fr[4] else 0', "slot_py": None, "target": None, "cond": None},
    0x3f982: {"kind": "branch", "py": None, "slot_py": '', "target": 0x3f98c, "cond": 'notT'},
    0x3f986: {"kind": 'reg', "py": 'r[0] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x3f988: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFC6C0, 1, r[0])', "target": 0x3f99a, "cond": 'always'},
    0x3f98c: {"kind": 'reg', "py": 'r[1] = 0x0007AF0C', "slot_py": None, "target": None, "cond": None},
    0x3f98e: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0x0007AF0C, 4))', "slot_py": None, "target": None, "cond": None},
    0x3f990: {"kind": 'fpu', "py": 'T = 1 if fr[4] > fr[2] else 0', "slot_py": None, "target": None, "cond": None},
    0x3f992: {"kind": "branch", "py": None, "slot_py": '', "target": 0x3f99a, "cond": 'notT'},
    0x3f996: {"kind": 'reg', "py": 'r[0] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x3f998: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC6C0, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x3f99a: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
