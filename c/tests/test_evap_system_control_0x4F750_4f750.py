#!/usr/bin/env python3
"""Differential test for evap_system_control_0x4F750 (0x4F750) — v3 lift (branches + delay slots), 40 bytes.
...
Run from repo root: python3 c/tests/test_evap_system_control_0x4F750_4f750.py
"""
...
ENTRY = 0x4F750
RAW = bytes.fromhex("94 5B 93 55 60 30 60 0C 88 01 8D 06 00 09 92 52 60 20 60 0C 88 01 8F 03 00 09 E3 01 A0 02 24 30 E1 00 24 10 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    0x4f750: {"kind": 'reg', "py": 'r[4] = 0xFFFFCFFA', "slot_py": None, "target": None, "cond": None},
    0x4f752: {"kind": 'reg', "py": 'r[3] = 0xFFFFCFFB', "slot_py": None, "target": None, "cond": None},
    0x4f754: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCFFB, 1))', "slot_py": None, "target": None, "cond": None},
    0x4f756: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x4f758: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x4f75a: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4f76a, "cond": 'T'},
    0x4f75e: {"kind": 'reg', "py": 'r[2] = 0xFFFFCFFC', "slot_py": None, "target": None, "cond": None},
    0x4f760: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCFFC, 1))', "slot_py": None, "target": None, "cond": None},
    0x4f762: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x4f764: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x4f766: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4f770, "cond": 'notT'},
    0x4f76a: {"kind": 'reg', "py": 'r[3] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x4f76c: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFCFFA, 1, r[3])', "target": 0x4f774, "cond": 'always'},
    0x4f770: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x4f772: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCFFA, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x4f774: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
