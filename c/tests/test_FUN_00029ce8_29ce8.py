#!/usr/bin/env python3
"""Differential test for FUN_00029ce8 (0x29CE8) — pure straight-line lift, 8 bytes.
...
Run from repo root: python3 c/tests/test_FUN_00029ce8_29ce8.py
"""
...
ENTRY = 0x29CE8
RAW = bytes.fromhex("D2 42 60 0C 43 18 33 0C")
SEED = 42
N = 2000
