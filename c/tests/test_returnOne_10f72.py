#!/usr/bin/env python3
"""Differential test for returnOne (0x10F72) — v3 lift (branches + delay slots), 18 bytes.
...
Run from repo root: python3 c/tests/test_returnOne_10f72.py
"""
...
ENTRY = 0x10F72
RAW = bytes.fromhex("00 0B E0 01 D3 14 64 31 64 4D 44 08 44 08 00 0B 60 43")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFA0D4
SPAN_END = 0x10F84
SENT = 0x10F84     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x10f72: {"kind": "ret", "py": None, "slot_py": 'r[0] = s8(0x01)', "target": None, "cond": None},
    0x10f76: {"kind": 'reg', "py": 'r[3] = 0xFFFFA0D4', "slot_py": None, "target": None, "cond": None},
    0x10f78: {"kind": 'mem', "py": 'r[4] = s16(_rdw(ram, 0xFFFFA0D4, 2))', "slot_py": None, "target": None, "cond": None},
    0x10f7a: {"kind": 'reg', "py": 'r[4] = r[4] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x10f7c: {"kind": 'reg', "py": 'r[4] = (r[4] << 2) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x10f7e: {"kind": 'reg', "py": 'r[4] = (r[4] << 2) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x10f80: {"kind": "ret", "py": None, "slot_py": 'r[0] = r[4]', "target": None, "cond": None},}
