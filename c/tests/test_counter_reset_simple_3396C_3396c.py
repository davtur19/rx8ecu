#!/usr/bin/env python3
"""Differential test for counter_reset_simple_3396C (0x3396C) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_counter_reset_simple_3396C_3396c.py
"""
...
ENTRY = 0x3396C
RAW = bytes.fromhex("D2 2A E3 00 00 0B 22 31")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    0x3396c: {"kind": 'reg', "py": 'r[2] = 0xFFFFC050', "slot_py": None, "target": None, "cond": None},
    0x3396e: {"kind": 'reg', "py": 'r[3] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x33970: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFC050, 2, r[3])', "target": None, "cond": None},}
