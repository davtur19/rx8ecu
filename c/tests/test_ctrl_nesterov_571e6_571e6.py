#!/usr/bin/env python3
"""Differential test for ctrl_nesterov_571e6 (0x571E6) — v3 lift (branches + delay slots), 24 bytes.
...
Run from repo root: python3 c/tests/test_ctrl_nesterov_571e6_571e6.py
"""
...
ENTRY = 0x571E6
RAW = bytes.fromhex("64 4D D0 09 61 01 61 1D 31 43 8F 02 00 09 A0 01 E4 00 E4 01 00 0B 60 43")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    0x571e6: {"kind": 'reg', "py": 'r[4] = r[4] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x571e8: {"kind": 'reg', "py": 'r[0] = 0xFFFFD21E', "slot_py": None, "target": None, "cond": None},
    0x571ea: {"kind": 'mem', "py": 'r[1] = s16(_rdw(ram, 0xFFFFD21E, 2))', "slot_py": None, "target": None, "cond": None},
    0x571ec: {"kind": 'reg', "py": 'r[1] = r[1] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x571ee: {"kind": 'reg', "py": 'T = 1 if s32(r[1]) >= s32(r[4]) else 0', "slot_py": None, "target": None, "cond": None},
    0x571f0: {"kind": "branch", "py": None, "slot_py": '', "target": 0x571f8, "cond": 'notT'},
    0x571f4: {"kind": "branch", "py": None, "slot_py": 'r[4] = s8(0x00)', "target": 0x571fa, "cond": 'always'},
    0x571f8: {"kind": 'reg', "py": 'r[4] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x571fa: {"kind": "ret", "py": None, "slot_py": 'r[0] = r[4]', "target": None, "cond": None},}
