#!/usr/bin/env python3
"""Differential test for UnknownFueling1 (0xE444) — v3 lift + v4 FPU, 24 bytes.
...
Run from repo root: python3 c/tests/test_UnknownFueling1_e444.py
"""
...
ENTRY = 0xE444
RAW = bytes.fromhex("A0 08 00 09 D3 20 60 30 60 0C 88 01 8D 02 00 09 00 0B 00 09 C7 1D F3 08")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFF9F8C
SPAN_END = 0xE45C
SENT = 0xE45C     # stop-sentinel, placed past the literal pool
...
CODE = {
    0xe444: {"kind": "branch", "py": None, "slot_py": '', "target": 0xe458, "cond": 'always'},
    0xe448: {"kind": 'reg', "py": 'r[3] = 0xFFFF9F8C', "slot_py": None, "target": None, "cond": None},
    0xe44a: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFF9F8C, 1))', "slot_py": None, "target": None, "cond": None},
    0xe44c: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0xe44e: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0xe450: {"kind": "branch", "py": None, "slot_py": '', "target": 0xe458, "cond": 'T'},
    0xe454: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},
