#!/usr/bin/env python3
"""Differential test for caller_E220 (entry 0xE220) — v8 ST caller (CFG), 36 bytes.
...
Run: python3 test_caller_E220.py
"""
...
CODE = {
    0xe220: {"kind": 'mem', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, r[14])\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xe222: {"kind": 'st', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xe224: {"kind": 'reg', "py": 'r[14] = 0xFFFFA424', "slot_py": None, "target": None, "cond": None},
    0xe226: {"kind": 'reg', "py": 'r[2] = 0xFFFFA428', "slot_py": None, "target": None, "cond": None},
    0xe228: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFA428, 1))', "slot_py": None, "target": None, "cond": None},
    0xe22a: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0xe22c: {"kind": "branch", "py": None, "slot_py": '', "target": 0xe234, "cond": 'notT'},
    0xe230: {"kind": "branch", "py": None, "slot_py": 'r[0] = s8(0x00)', "target": 0xe23c, "cond": 'always'},
    0xe234: {"kind": 'reg', "py": 'r[1] = 0x00002460', "slot_py": None, "target": None, "cond": None},
    0xe236: {"kind": 'reg', "py": 'r[5] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0xe238: {"kind": "call", "py": None, "slot_py": 'r[4] = s16(_rdw(ram, 0xFFFFA424, 2))', "target": 0x2460, "ret_pc": 0xe23c, "set_pr": True, "cond": None},
    0xe23c: {"kind": 'mem', "py": '_wrw(ram, r[14], 2, r[0])', "slot_py": None, "target": None, "cond": None},
    0xe23e: {"kind": 'st', "py": 'pr = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xe240: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},
