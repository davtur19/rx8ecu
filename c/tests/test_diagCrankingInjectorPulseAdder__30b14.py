#!/usr/bin/env python3
"""Differential test for diagCrankingInjectorPulseAdder_ (0x30B14) — v3 lift (branches + delay slots), 36 bytes.
...
Run from repo root: python3 c/tests/test_diagCrankingInjectorPulseAdder__30b14.py
"""
...
ENTRY = 0x30B14
RAW = bytes.fromhex("00 09 60 C3 88 01 8F 03 00 09 E3 01 A0 01 24 30 24 E0 7F 04 4F 26 69 F6 6A F6 6B F6 6C F6 6D F6 00 0B 6E F6")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = None
SPAN_END = 0x30B38
SENT = 0x30B38     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x30b14: {"kind": 'reg', "py": None, "slot_py": None, "target": None, "cond": None},
    0x30b16: {"kind": 'reg', "py": 'r[0] = r[12]', "slot_py": None, "target": None, "cond": None},
    0x30b18: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x30b1a: {"kind": "branch", "py": None, "slot_py": '', "target": 0x30b24, "cond": 'notT'},
    0x30b1e: {"kind": 'reg', "py": 'r[3] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x30b20: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, r[4], 1, r[3])', "target": 0x30b26, "cond": 'always'},
    0x30b24: {"kind": 'mem', "py": '_wrw(ram, r[4], 1, r[14])', "slot_py": None, "target": None, "cond": None},
    0x30b26: {"kind": 'reg', "py": 'r[15] = (r[15] + s8(0x04)) & 0xFFFFFFFF\nsp = (sp + s8(0x04)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x30b28: {"kind": 'mem', "py": 'pr = _rdw(ram, STACK_BASE + 0x404, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x30b2a: {"kind": 'mem', "py": 'r[9] = _rdw(ram, STACK_BASE + 0x408, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x30b2c: {"kind": 'mem', "py": 'r[10] = _rdw(ram, STACK_BASE + 0x40C, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x30b2e: {"kind": 'mem', "py": 'r[11] = _rdw(ram, STACK_BASE + 0x410, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x30b30: {"kind": 'mem', "py": 'r[12] = _rdw(ram, STACK_BASE + 0x414, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x30b32: {"kind": 'mem', "py": 'r[13] = _rdw(ram, STACK_BASE + 0x418, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x30b34: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, STACK_BASE + 0x41C, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},}
