#!/usr/bin/env python3
"""Differential test for caller_70AC (entry 0x70AC) — v8 ST caller (CFG), 36 bytes.
...
Run: python3 test_caller_70AC.py
"""
...
CODE = {
    0x70ac: {"kind": 'st', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x70ae: {"kind": 'reg', "py": 'r[15] = (r[15] + s8(0xFC)) & 0xFFFFFFFF\nsp = (sp + s8(0xFC)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x70b0: {"kind": 'reg', "py": 'r[5] = 0x000000E0', "slot_py": None, "target": None, "cond": None},
    0x70b2: {"kind": 'reg', "py": 'r[3] = 0x00002054', "slot_py": None, "target": None, "cond": None},
    0x70b4: {"kind": "call", "py": None, "slot_py": 'r[4] = r[15]', "target": 0x2054, "ret_pc": 0x70b8, "set_pr": True, "cond": None},
    0x70b8: {"kind": 'reg', "py": 'r[5] = 0x00000100', "slot_py": None, "target": None, "cond": None},
    0x70ba: {"kind": 'reg', "py": 'r[4] = 0xFFFFF74E', "slot_py": None, "target": None, "cond": None},
    0x70bc: {"kind": 'reg', "py": 'r[2] = 0x00004BBC', "slot_py": None, "target": None, "cond": None},
    0x70be: {"kind": "call", "py": None, "slot_py": 'r[6] = s8(0x01)', "target": 0x4bbc, "ret_pc": 0x70c2, "set_pr": True, "cond": None},
    0x70c2: {"kind": 'reg', "py": 'r[3] = 0x00002064', "slot_py": None, "target": None, "cond": None},
    0x70c4: {"kind": "call", "py": None, "slot_py": 'r[4] = _rdw(ram, sp, 4)', "target": 0x2064, "ret_pc": 0x70c8, "set_pr": True, "cond": None},
    0x70c8: {"kind": 'reg', "py": 'r[15] = (r[15] + s8(0x04)) & 0xFFFFFFFF\nsp = (sp + s8(0x04)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x70ca: {"kind": 'st', "py": 'pr = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x70cc: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},
