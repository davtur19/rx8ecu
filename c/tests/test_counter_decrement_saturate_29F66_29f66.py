#!/usr/bin/env python3
"""Differential test for counter_decrement_saturate_29F66 (0x29F66) — v3 lift (branches + delay slots), 42 bytes.
...
Run from repo root: python3 c/tests/test_counter_decrement_saturate_29F66_29f66.py
"""
...
ENTRY = 0x29F66
RAW = bytes.fromhex("95 1A 92 1A 63 20 63 3C 43 15 8F 04 00 09 D3 14 61 30 A0 08 25 10 64 50 63 4C 23 38 8D 03 00 09 90 0C 34 0C 25 40 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    0x29f66: {"kind": 'reg', "py": 'r[5] = 0xFFFFBB58', "slot_py": None, "target": None, "cond": None},
    0x29f68: {"kind": 'reg', "py": 'r[2] = 0xFFFFA400', "slot_py": None, "target": None, "cond": None},
    0x29f6a: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFA400, 1))', "slot_py": None, "target": None, "cond": None},
    0x29f6c: {"kind": 'reg', "py": 'r[3] = r[3] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x29f6e: {"kind": 'reg', "py": 'T = 1 if s32(r[3]) > 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x29f70: {"kind": "branch", "py": None, "slot_py": '', "target": 0x29f7c, "cond": 'notT'},
    0x29f74: {"kind": 'reg', "py": 'r[3] = 0x0006CF86', "slot_py": None, "target": None, "cond": None},
    0x29f76: {"kind": 'mem', "py": 'r[1] = s8(_rdw(ram, 0x0006CF86, 1))', "slot_py": None, "target": None, "cond": None},
    0x29f78: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFBB58, 1, r[1])', "target": 0x29f8c, "cond": 'always'},
    0x29f7c: {"kind": 'mem', "py": 'r[4] = s8(_rdw(ram, 0xFFFFBB58, 1))', "slot_py": None, "target": None, "cond": None},
    0x29f7e: {"kind": 'reg', "py": 'r[3] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x29f80: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x29f82: {"kind": "branch", "py": None, "slot_py": '', "target": 0x29f8c, "cond": 'T'},
    0x29f86: {"kind": 'reg', "py": 'r[0] = 0x000000FF', "slot_py": None, "target": None, "cond": None},
    0x29f88: {"kind": 'reg', "py": 'r[4] = (r[4] + r[0]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x29f8a: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBB58, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x29f8c: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
