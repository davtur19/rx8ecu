#!/usr/bin/env python3
"""Differential test for diagControlVDI (0x5ABB0) — v3 lift (branches + delay slots), 20 bytes.
...
Run from repo root: python3 c/tests/test_diagControlVDI_5abb0.py
"""
...
ENTRY = 0x5ABB0
RAW = bytes.fromhex("61 1D 31 00 8D 04 00 09 94 43 62 41 72 01 24 21 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFD2C0
SPAN_END = 0x5ABC4
SENT = 0x5ABC4     # stop-sentinel, placed past the literal pool
