#!/usr/bin/env python3
"""Differential test for can212RXUnpack (0x2BF36) — v3 lift (branches + delay slots), 52 bytes.
...
Run from repo root: python3 c/tests/test_can212RXUnpack_2bf36.py
"""
...
ENTRY = 0x2BF36
RAW = bytes.fromhex("D4 1C D2 1C 63 40 D1 1C 22 30 84 41 21 00 84 42 D3 1B D2 1B 23 00 84 43 22 00 84 44 60 0C D3 10 40 18 61 03 84 45 60 0C 31 0C 90 17 20 11 84 46 00 0B 23 00")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBC2A
SPAN_END = 0x2BF6A
SENT = 0x2BF6A     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x2bf36: {"kind": 'reg', "py": 'r[4] = 0xFFFFBBF4', "slot_py": None, "target": None, "cond": None},
    0x2bf38: {"kind": 'reg', "py": 'r[2] = 0xFFFFBC26', "slot_py": None, "target": None, "cond": None},
    0x2bf3a: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFBBF4, 1))', "slot_py": None, "target": None, "cond": None},
    0x2bf3c: {"kind": 'reg', "py": 'r[1] = 0xFFFFBC27', "slot_py": None, "target": None, "cond": None},
    0x2bf3e: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBC26, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x2bf40: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFBBF5, 1))', "slot_py": None, "target": None, "cond": None},
    0x2bf42: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBC27, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x2bf44: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFBBF6, 1))', "slot_py": None, "target": None, "cond": None},
    0x2bf46: {"kind": 'reg', "py": 'r[3] = 0xFFFFBC28', "slot_py": None, "target": None, "cond": None},
    0x2bf48: {"kind": 'reg', "py": 'r[2] = 0xFFFFBC29', "slot_py": None, "target": None, "cond": None},
    0x2bf4a: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBC28, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x2bf4c: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFBBF7, 1))', "slot_py": None, "target": None, "cond": None},
    0x2bf4e: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBC29, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x2bf50: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFBBF8, 1))', "slot_py": None, "target": None, "cond": None},
    0x2bf52: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x2bf54: {"kind": 'reg', "py": 'r[3] = 0xFFFFBC2A', "slot_py": None, "target": None, "cond": None},
    0x2bf56: {"kind": 'reg', "py": 'r[0] = (r[0] << 8) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x2bf58: {"kind": 'reg', "py": 'r[1] = r[0]', "slot_py": None, "target": None, "cond": None},
    0x2bf5a: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFBBF9, 1))', "slot_py": None, "target": None, "cond": None},
    0x2bf5c: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x2bf5e: {"kind": 'reg', "py": 'r[1] = (r[1] + r[0]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x2bf60: {"kind": 'reg', "py": 'r[0] = 0xFFFFBC12', "slot_py": None, "target": None, "cond": None},
    0x2bf62: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBC12, 2, r[1])', "slot_py": None, "target": None, "cond": None},
    0x2bf64: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFBBFA, 1))', "slot_py": None, "target": None, "cond": None},
    0x2bf66: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBC2A, 1, r[0])', "target": None, "cond": None},}
