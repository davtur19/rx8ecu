#!/usr/bin/env python3
"""Differential test for heater_setup_handler_2638E (0x2638E) — v3 lift (branches + delay slots), 12 bytes.
...
Run from repo root: python3 c/tests/test_heater_setup_handler_2638E_2638e.py
"""
...
ENTRY = 0x2638E
RAW = bytes.fromhex("00 09 D3 17 34 3C 25 41 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    0x2638e: {"kind": 'reg', "py": None, "slot_py": None, "target": None, "cond": None},
    ...
    0x26394: {"kind": 'mem', "py": '_wrw(ram, r[5], 2, r[4])', "slot_py": None, "target": None, "cond": None},
