#!/usr/bin/env python3
"""Differential test for initFuelCutStuff (0x49CB6) — v3 lift (branches + delay slots), 54 bytes.
...
Run from repo root: python3 c/tests/test_initFuelCutStuff_49cb6.py
"""
...
ENTRY = 0x49CB6
RAW = bytes.fromhex("94 24 93 21 60 30 60 0C 88 01 8F 02 E5 00 A0 10 24 50 92 1C 60 20 60 0C 88 01 8D 06 00 09 91 14 60 10 60 0C 88 01 8F 03 00 09 E2 01 A0 01 24 20 24 50 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCFD9
SPAN_END = 0x49CEC
SENT = 0x49CEC     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x49cb6: {"kind": 'reg', "py": 'r[4] = 0xFFFFCC88', "slot_py": None, "target": None, "cond": None},
    0x49cb8: {"kind": 'reg', "py": 'r[3] = 0xFFFFCFD9', "slot_py": None, "target": None, "cond": None},
    0x49cba: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCFD9, 1))', "slot_py": None, "target": None, "cond": None},
    0x49cbc: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x49cbe: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x49cc0: {"kind": "branch", "py": None, "slot_py": 'r[5] = s8(0x00)', "target": 0x49cc8, "cond": 'notT'},
    0x49cc4: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFCC88, 1, r[5])', "target": 0x49ce8, "cond": 'always'},
    0x49cc8: {"kind": 'reg', "py": 'r[2] = 0xFFFFCC8C', "slot_py": None, "target": None, "cond": None},
    0x49cca: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCC8C, 1))', "slot_py": None, "target": None, "cond": None},
    0x49ccc: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x49cce: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x49cd0: {"kind": "branch", "py": None, "slot_py": '', "target": 0x49ce0, "cond": 'T'},
    0x49cd4: {"kind": 'reg', "py": 'r[1] = 0xFFFFCC8D', "slot_py": None, "target": None, "cond": None},
    0x49cd6: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCC8D, 1))', "slot_py": None, "target": None, "cond": None},
    0x49cd8: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x49cda: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x49cdc: {"kind": "branch", "py": None, "slot_py": '', "target": 0x49ce6, "cond": 'notT'},
    0x49ce0: {"kind": 'reg', "py": 'r[2] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x49ce2: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFCC88, 1, r[2])', "target": 0x49ce8, "cond": 'always'},
    0x49ce6: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCC88, 1, r[5])', "slot_py": None, "target": None, "cond": None},
    0x49ce8: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
