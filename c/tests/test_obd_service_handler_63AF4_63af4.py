#!/usr/bin/env python3
"""Differential test for obd_service_handler_63AF4 (0x63AF4) — pure straight-line lift, 18 bytes.
...
Run from repo root: python3 c/tests/test_obd_service_handler_63AF4_63af4.py
"""
...
ENTRY = 0x63AF4
RAW = bytes.fromhex("D0 6A E5 00 D6 6A E1 15 67 53 63 53 43 08 43 08 33 6C")
SEED = 42
N = 2000
