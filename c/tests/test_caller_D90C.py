#!/usr/bin/env python3
"""Differential test for caller_D90C (entry 0xD90C) — v8 ST caller (CFG), 38 bytes.
...
Run: python3 test_caller_D90C.py
"""
...
CODE = {
    0xd90c: {"kind": 'reg', "py": 'r[7] = s8(0x03)', "slot_py": None, "target": None, "cond": None},
    0xd90e: {"kind": 'reg', "py": 'r[3] = r[4]', "slot_py": None, "target": None, "cond": None},
    0xd910: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[7]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0xd912: {"kind": "branch", "py": None, "slot_py": 'r[6] = s8(0x00)', "target": 0xd92c, "cond": 'notT'},
    0xd916: {"kind": 'reg', "py": 'T = 1 if (r[4] & 0xFFFFFFFF) > (r[5] & 0xFFFFFFFF) else 0', "slot_py": None, "target": None, "cond": None},
    0xd918: {"kind": "branch", "py": None, "slot_py": '', "target": 0xd92c, "cond": 'T'},
    0xd91c: {"kind": 'reg', "py": 'r[0] = r[5]', "slot_py": None, "target": None, "cond": None},
    0xd91e: {"kind": 'reg', "py": 'r[0] = (r[0] & r[7]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xd920: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x03) else 0', "slot_py": None, "target": None, "cond": None},
    0xd922: {"kind": "branch", "py": None, "slot_py": '', "target": 0xd92e, "cond": 'T'},
    0xd926: {"kind": 'reg', "py": 'T = 1 if r[4] == r[5] else 0', "slot_py": None, "target": None, "cond": None},
    0xd928: {"kind": "branch", "py": None, "slot_py": '', "target": 0xd92e, "cond": 'T'},
    0xd92c: {"kind": 'reg', "py": 'r[6] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0xd92e: {"kind": "ret", "py": None, "slot_py": 'r[0] = r[6]', "target": None, "cond": None},
}
