#!/usr/bin/env python3
"""Differential test for init_power_552c0 (0x552C0) — v3 lift + v4 FPU, 62 bytes.
...
Run from repo root: python3 c/tests/test_init_power_552c0_552c0.py
"""
...
RAM_MAX = None
SPAN_END = 0x552FE
SENT = 0x552FE     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x552c0: {"kind": 'fpu', "py": 'fr[3] = fr[6]', "slot_py": None, "target": None, "cond": None},
    0x552c2: {"kind": 'fpu', "py": 'fr[6] = fr[4]', "slot_py": None, "target": None, "cond": None},
    0x552c4: {"kind": 'fpu', "py": 'fr[6] = ts(fr[6] - fr[3])', "slot_py": None, "target": None, "cond": None},
    0x552c6: {"kind": 'fpu', "py": 'fr[2] = 0.0', "slot_py": None, "target": None, "cond": None},
    0x552c8: {"kind": 'fpu', "py": 'T = 1 if fr[2] > fr[6] else 0', "slot_py": None, "target": None, "cond": None},
    0x552ca: {"kind": "branch", "py": None, "slot_py": '', "target": 0x552d4, "cond": 'notT'},
    0x552ce: {"kind": 'reg', "py": 'r[0] = 0x00055408', "slot_py": None, "target": None, "cond": None},
    0x552d0: {"kind": "branch", "py": None, "slot_py": 'fr[4] = bits2f(_rdw(ram, 0x00055408, 4))', "target": 0x552d8, "cond": 'always'},
    0x552d4: {"kind": 'reg', "py": 'r[0] = 0x0005540C', "slot_py": None, "target": None, "cond": None},
    0x552d6: {"kind": 'fpu', "py": 'fr[4] = bits2f(_rdw(ram, 0x0005540C, 4))', "slot_py": None, "target": None, "cond": None},
    0x552d8: {"kind": 'fpu', "py": 'fr[6] = ts(fr[6] / fr[5])', "slot_py": None, "target": None, "cond": None},
    0x552da: {"kind": 'fpu', "py": 'fr[6] = fr[6]', "slot_py": None, "target": None, "cond": None},
    0x552dc: {"kind": 'fpu', "py": 'fr[3] = fr[6]', "slot_py": None, "target": None, "cond": None},
    0x552de: {"kind": 'fpu', "py": 'fr[3] = ts(fr[3] + fr[4])', "slot_py": None, "target": None, "cond": None},
    0x552e0: {"kind": 'reg', "py": 'r[5] = 0x00007FFF', "slot_py": None, "target": None, "cond": None},
    0x552e2: {"kind": 'fpu', "py": 'fpul = (0x80000000 if fr[3] != fr[3] else (0x7FFFFFFF if fr[3] >= 2147483648.0 else (0x80000000 if fr[3] < -2147483648.0 else int(fr[3])))) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x552e4: {"kind": 'fpu', "py": 'r[4] = fpul', "slot_py": None, "target": None, "cond": None},
    0x552e6: {"kind": 'reg', "py": 'T = 1 if s32(r[4]) > s32(r[5]) else 0', "slot_py": None, "target": None, "cond": None},
    0x552e8: {"kind": "branch", "py": None, "slot_py": '', "target": 0x552f0, "cond": 'notT'},
    0x552ec: {"kind": "branch", "py": None, "slot_py": 'r[4] = r[5]', "target": 0x552fa, "cond": 'always'},
    0x552f0: {"kind": 'reg', "py": 'r[5] = 0xFFFF8000', "slot_py": None, "target": None, "cond": None},
    0x552f2: {"kind": 'reg', "py": 'T = 1 if s32(r[4]) >= s32(r[5]) else 0', "slot_py": None, "target": None, "cond": None},
    0x552f4: {"kind": "branch", "py": None, "slot_py": '', "target": 0x552fa, "cond": 'T'},
    0x552f8: {"kind": 'reg', "py": 'r[4] = r[5]', "slot_py": None, "target": None, "cond": None},
    0x552fa: {"kind": "ret", "py": None, "slot_py": 'r[0] = r[4]', "target": None, "cond": None},}
