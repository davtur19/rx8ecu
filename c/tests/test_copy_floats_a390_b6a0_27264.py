#!/usr/bin/env python3
"""Differential test for copy_floats_a390_b6a0 (0x27264) — v3 lift + v4 FPU, 66 bytes.
...
Run from repo root: python3 c/tests/test_copy_floats_a390_b6a0_27264.py
"""
...
ENTRY = 0x27264
RAW = bytes.fromhex("D4 2F E0 04 92 51 F3 48 93 4E F3 3A F3 46 E0 08 91 4C F2 3A F3 46 E0 0C 93 49 F1 3A F3 46 E0 10 92 46 F3 3A F3 46 E0 14 91 43 F2 3A F3 46 E0 18 93 40 F1 3A F3 46 E0 1C 92 3D F3 3A F3 46 00 0B F2 3A")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFB6BC
SPAN_END = 0x272A6
SENT = 0x272A6     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x27264: {"kind": 'reg', "py": 'r[4] = 0xFFFFA390', "slot_py": None, "target": None, "cond": None},
    0x27266: {"kind": 'reg', "py": 'r[0] = s8(0x04)', "slot_py": None, "target": None, "cond": None},
    0x27268: {"kind": 'reg', "py": 'r[2] = 0xFFFFB6A4', "slot_py": None, "target": None, "cond": None},
    0x2726a: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, r[4], 4))', "slot_py": None, "target": None, "cond": None},
    0x2726c: {"kind": 'reg', "py": 'r[3] = 0xFFFFB6A0', "slot_py": None, "target": None, "cond": None},
    0x2726e: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFB6A0, 4, f2bits(fr[3]))', "slot_py": None, "target": None, "cond": None},
    0x27270: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, r[0] + r[4], 4))', "slot_py": None, "target": None, "cond": None},
    0x27272: {"kind": 'reg', "py": 'r[0] = s8(0x08)', "slot_py": None, "target": None, "cond": None},
    0x27274: {"kind": 'reg', "py": 'r[1] = 0xFFFFB6A8', "slot_py": None, "target": None, "cond": None},
    0x27276: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFB6A4, 4, f2bits(fr[3]))', "slot_py": None, "target": None, "cond": None},
    0x27278: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, r[0] + r[4], 4))', "slot_py": None, "target": None, "cond": None},
    0x2727a: {"kind": 'reg', "py": 'r[0] = s8(0x0C)', "slot_py": None, "target": None, "cond": None},
    0x2727c: {"kind": 'reg', "py": 'r[3] = 0xFFFFB6AC', "slot_py": None, "target": None, "cond": None},
    0x2727e: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFB6A8, 4, f2bits(fr[3]))', "slot_py": None, "target": None, "cond": None},
    0x27280: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, r[0] + r[4], 4))', "slot_py": None, "target": None, "cond": None},
    0x27282: {"kind": 'reg', "py": 'r[0] = s8(0x10)', "slot_py": None, "target": None, "cond": None},
    0x27284: {"kind": 'reg', "py": 'r[2] = 0xFFFFB6B0', "slot_py": None, "target": None, "cond": None},
    0x27286: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFB6AC, 4, f2bits(fr[3]))', "slot_py": None, "target": None, "cond": None},
    0x27288: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, r[0] + r[4], 4))', "slot_py": None, "target": None, "cond": None},
    0x2728a: {"kind": 'reg', "py": 'r[0] = s8(0x14)', "slot_py": None, "target": None, "cond": None},
    0x2728c: {"kind": 'reg', "py": 'r[1] = 0xFFFFB6B4', "slot_py": None, "target": None, "cond": None},
    0x2728e: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFB6B0, 4, f2bits(fr[3]))', "slot_py": None, "target": None, "cond": None},
    0x27290: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, r[0] + r[4], 4))', "slot_py": None, "target": None, "cond": None},
    0x27292: {"kind": 'reg', "py": 'r[0] = s8(0x18)', "slot_py": None, "target": None, "cond": None},
    0x27294: {"kind": 'reg', "py": 'r[3] = 0xFFFFB6B8', "slot_py": None, "target": None, "cond": None},
    0x27296: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFB6B4, 4, f2bits(fr[3]))', "slot_py": None, "target": None, "cond": None},
    0x27298: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, r[0] + r[4], 4))', "slot_py": None, "target": None, "cond": None},
    0x2729a: {"kind": 'reg', "py": 'r[0] = s8(0x1C)', "slot_py": None, "target": None, "cond": None},
    0x2729c: {"kind": 'reg', "py": 'r[2] = 0xFFFFB6BC', "slot_py": None, "target": None, "cond": None},
    0x2729e: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFB6B8, 4, f2bits(fr[3]))', "slot_py": None, "target": None, "cond": None},
    0x272a0: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, r[0] + r[4], 4))', "slot_py": None, "target": None, "cond": None},
    0x272a2: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFB6BC, 4, f2bits(fr[3]))', "target": None, "cond": None},}
