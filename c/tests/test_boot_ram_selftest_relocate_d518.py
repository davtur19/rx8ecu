#!/usr/bin/env python3
"""Differential test for boot_ram_selftest_relocate (0xD518) — v3 lift (branches + delay slots), 16 bytes.
...
Run from repo root: python3 c/tests/test_boot_ram_selftest_relocate_d518.py
"""
...
ENTRY = 0xD518
RAW = bytes.fromhex("8D 01 00 09 EE 00 60 E3 4F 26 00 0B 6E F6 2F E6")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = None
SPAN_END = 0xD528
SENT = 0xD528     # stop-sentinel, placed past the literal pool
...
CODE = {
    0xd518: {"kind": "branch", "py": None, "slot_py": '', "target": 0xd51e, "cond": 'T'},
    0xd51c: {"kind": 'reg', "py": 'r[14] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0xd51e: {"kind": 'reg', "py": 'r[0] = r[14]', "slot_py": None, "target": None, "cond": None},
    0xd520: {"kind": 'mem', "py": 'pr = _rdw(ram, STACK_BASE + 0x400, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xd522: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, STACK_BASE + 0x404, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},
    0xd526: {"kind": 'mem', "py": 'local[0x404] = r[14]\n_wrw(ram, STACK_BASE + 0x404, 4, r[14])\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},}
