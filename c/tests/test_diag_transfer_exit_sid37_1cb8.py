#!/usr/bin/env python3
"""Differential test for diag_transfer_exit_sid37 (0x1CB8) — pure straight-line lift, 8 bytes.
...
Run from repo root: python3 c/tests/test_diag_transfer_exit_sid37_1cb8.py
"""
...
ENTRY = 0x1CB8
RAW = bytes.fromhex("D5 3A E3 7F D2 3A E0 37")
SEED = 42
N = 2000
