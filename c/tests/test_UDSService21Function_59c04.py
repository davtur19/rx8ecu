#!/usr/bin/env python3
"""Differential test for UDSService21Function (0x59C04) — v3 lift (branches + delay slots), 32 bytes.
...
Run from repo root: python3 c/tests/test_UDSService21Function_59c04.py
"""
...
ENTRY = 0x59C04
RAW = bytes.fromhex("00 09 85 F3 63 F1 60 0D 63 3D 20 38 8F 02 00 09 A0 01 E4 01 E4 00 60 43 7F 08 4F 26 00 0B 6E F6")
SEED = 0
N = 2000
MAXSTEPS = 100000
STACK_BASE = 0xFFFFD000
STACK_TOP = STACK_BASE + 0x400
STACK_OFFS = (0x400, 0x406, 0x408, 0x40C)
SEED_OFFS = (0x408,)   # lds.l pr/macl/mach slots seeded with the return sentinel
RAM_MIN = None
RAM_MAX = None
SPAN_END = 0x59C24
SENT = 0x59C24     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x59c04: {"kind": 'reg', "py": None, "slot_py": None, "target": None, "cond": None},
    0x59c06: {"kind": 'mem', "py": 'r[0] = s16(_rdw(ram, STACK_BASE + 0x406, 2))', "slot_py": None, "target": None, "cond": None},
    0x59c08: {"kind": 'mem', "py": 'r[3] = s16(_rdw(ram, STACK_BASE + 0x400, 2))', "slot_py": None, "target": None, "cond": None},
    0x59c0a: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x59c0c: {"kind": 'reg', "py": 'r[3] = r[3] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x59c0e: {"kind": 'reg', "py": 'T = 1 if (r[0] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x59c10: {"kind": "branch", "py": None, "slot_py": '', "target": 0x59c18, "cond": 'notT'},
    0x59c14: {"kind": "branch", "py": None, "slot_py": 'r[4] = s8(0x01)', "target": 0x59c1a, "cond": 'always'},
    0x59c18: {"kind": 'reg', "py": 'r[4] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x59c1a: {"kind": 'reg', "py": 'r[0] = r[4]', "slot_py": None, "target": None, "cond": None},
    0x59c1c: {"kind": 'reg', "py": 'r[15] = (r[15] + s8(0x08)) & 0xFFFFFFFF\nsp = (sp + s8(0x08)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x59c1e: {"kind": 'mem', "py": 'pr = _rdw(ram, STACK_BASE + 0x408, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x59c20: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, STACK_BASE + 0x40C, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},}
