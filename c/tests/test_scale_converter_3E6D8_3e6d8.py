#!/usr/bin/env python3
"""Differential test for scale_converter_3E6D8 (0x3E6D8) — v3 lift (branches + delay slots), 34 bytes.
...
Run from repo root: python3 c/tests/test_scale_converter_3E6D8_3e6d8.py
"""
...
CODE = {
    0x3e6d8: {"kind": 'reg', "py": 'r[2] = 0xFFFFB5AB', "slot_py": None, "target": None, "cond": None},
    0x3e6da: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFB5AB, 1))', "slot_py": None, "target": None, "cond": None},
    0x3e6dc: {"kind": 'reg', "py": 'r[1] = 0xFFFFC693', "slot_py": None, "target": None, "cond": None},
    0x3e6de: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC693, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x3e6e0: {"kind": 'reg', "py": 'r[3] = 0x0007A9B5', "slot_py": None, "target": None, "cond": None},
    0x3e6e2: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0x0007A9B5, 1))', "slot_py": None, "target": None, "cond": None},
    0x3e6e4: {"kind": 'reg', "py": 'r[2] = 0xFFFFC690', "slot_py": None, "target": None, "cond": None},
    0x3e6e6: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC690, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x3e6e8: {"kind": 'reg', "py": 'r[0] = 0xFFFFC004', "slot_py": None, "target": None, "cond": None},
    0x3e6ea: {"kind": 'mem', "py": 'r[1] = s8(_rdw(ram, 0xFFFFC004, 1))', "slot_py": None, "target": None, "cond": None},
    0x3e6ec: {"kind": 'reg', "py": 'r[3] = 0xFFFFC697', "slot_py": None, "target": None, "cond": None},
    0x3e6ee: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC697, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x3e6f0: {"kind": 'reg', "py": 'r[1] = 0x0007A9B4', "slot_py": None, "target": None, "cond": None},
    0x3e6f2: {"kind": 'mem', "py": 'r[2] = s8(_rdw(ram, 0x0007A9B4, 1))', "slot_py": None, "target": None, "cond": None},
    0x3e6f4: {"kind": 'reg', "py": 'r[3] = 0xFFFFC691', "slot_py": None, "target": None, "cond": None},
    0x3e6f6: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFC691, 1, r[2])', "target": None, "cond": None},}
