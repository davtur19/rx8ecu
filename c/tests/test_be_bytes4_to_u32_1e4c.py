#!/usr/bin/env python3
"""Differential test for be_bytes4_to_u32 (0x1E4C) — v3 lift (branches + delay slots), 38 bytes.
...
Run from repo root: python3 c/tests/test_be_bytes4_to_u32_1e4c.py
"""
...
ENTRY = 0x1E4C
RAW = bytes.fromhex("84 41 60 0C 62 40 40 28 63 03 62 2C 84 42 42 28 60 0C 40 18 33 0C 42 18 84 43 33 2C 60 0C 64 33 34 0C 00 0B 60 43")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = None
SPAN_END = 0x1E72
SENT = 0x1E72     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x1e4c: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, (r[4] + 1), 1))', "slot_py": None, "target": None, "cond": None},
    0x1e4e: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x1e50: {"kind": 'mem', "py": 'r[2] = s8(_rdw(ram, r[4], 1))', "slot_py": None, "target": None, "cond": None},
    0x1e52: {"kind": 'reg', "py": 'r[0] = (r[0] << 16) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x1e54: {"kind": 'reg', "py": 'r[3] = r[0]', "slot_py": None, "target": None, "cond": None},
    0x1e56: {"kind": 'reg', "py": 'r[2] = r[2] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x1e58: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, (r[4] + 2), 1))', "slot_py": None, "target": None, "cond": None},
    0x1e5a: {"kind": 'reg', "py": 'r[2] = (r[2] << 16) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x1e5c: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x1e5e: {"kind": 'reg', "py": 'r[0] = (r[0] << 8) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x1e60: {"kind": 'reg', "py": 'r[3] = (r[3] + r[0]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x1e62: {"kind": 'reg', "py": 'r[2] = (r[2] << 8) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x1e64: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, (r[4] + 3), 1))', "slot_py": None, "target": None, "cond": None},
    0x1e66: {"kind": 'reg', "py": 'r[3] = (r[3] + r[2]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x1e68: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x1e6a: {"kind": 'reg', "py": 'r[4] = r[3]', "slot_py": None, "target": None, "cond": None},
    0x1e6c: {"kind": 'reg', "py": 'r[4] = (r[4] + r[0]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x1e6e: {"kind": "ret", "py": None, "slot_py": 'r[0] = r[4]', "target": None, "cond": None},}
