#!/usr/bin/env python3
"""Differential test for FUN_00046144 (0x46144) — v3 lift (branches + delay slots), 24 bytes.
...
Run from repo root: python3 c/tests/test_FUN_00046144_46144.py
"""
...
ENTRY = 0x46144
RAW = bytes.fromhex("D3 36 E4 00 D2 36 23 40 22 40 91 5A 93 5A 21 40 23 40 92 58 00 0B 22 40")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCB45
SPAN_END = 0x4615C
SENT = 0x4615C     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x46144: {"kind": 'reg', "py": 'r[3] = 0xFFFFCB44', "slot_py": None, "target": None, "cond": None},
    0x46146: {"kind": 'reg', "py": 'r[4] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x46148: {"kind": 'reg', "py": 'r[2] = 0xFFFFCB45', "slot_py": None, "target": None, "cond": None},
    0x4614a: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCB44, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x4614c: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCB45, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x4614e: {"kind": 'reg', "py": 'r[1] = 0xFFFFCB40', "slot_py": None, "target": None, "cond": None},
    0x46150: {"kind": 'reg', "py": 'r[3] = 0xFFFFCB42', "slot_py": None, "target": None, "cond": None},
    0x46152: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCB40, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x46154: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCB42, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x46156: {"kind": 'reg', "py": 'r[2] = 0xFFFFCB43', "slot_py": None, "target": None, "cond": None},
    0x46158: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFCB43, 1, r[4])', "target": None, "cond": None},}
