#!/usr/bin/env python3
"""Differential test for caller_66022 (entry 0x66022) — v8 ST caller (CFG), 48 bytes.
...
Run: python3 test_caller_66022.py
"""
...
CODE = {
    0x66022: {"kind": 'st', "py": 'local[0x3FC] = pr\n_wrw(ram, STACK_BASE + 0x3FC, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x66024: {"kind": 'reg', "py": 'r[4] = 0xFFFF8EA4', "slot_py": None, "target": None, "cond": None},
    0x66026: {"kind": 'reg', "py": 'r[3] = 0x00002044', "slot_py": None, "target": None, "cond": None},
    0x66028: {"kind": "call", "py": None, "slot_py": 'r[14] = s8(0x00)', "target": 0x2044, "ret_pc": 0x6602c, "set_pr": True, "cond": None},
    0x6602c: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x6602e: {"kind": 'reg', "py": 'T = 1 if (r[0] & r[0]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x66030: {"kind": "branch", "py": None, "slot_py": '', "target": 0x66044, "cond": 'notT'},
    0x66034: {"kind": 'reg', "py": 'r[4] = 0xFFFF8EA6', "slot_py": None, "target": None, "cond": None},
    0x66036: {"kind": 'reg', "py": 'r[3] = 0x00002044', "slot_py": None, "target": None, "cond": None},
    0x66038: {"kind": "call", "py": None, "slot_py": '', "target": 0x2044, "ret_pc": 0x6603c, "set_pr": True, "cond": None},
    0x6603c: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x6603e: {"kind": 'reg', "py": 'T = 1 if (r[0] & r[0]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x66040: {"kind": "branch", "py": None, "slot_py": '', "target": 0x66046, "cond": 'T'},
    0x66044: {"kind": 'reg', "py": 'r[14] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x66046: {"kind": 'reg', "py": 'r[0] = r[14]', "slot_py": None, "target": None, "cond": None},
    0x66048: {"kind": 'st', "py": 'pr = _rdw(ram, STACK_BASE + 0x3FC, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x6604a: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, STACK_BASE + 0x400, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},
    0x6604e: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},
