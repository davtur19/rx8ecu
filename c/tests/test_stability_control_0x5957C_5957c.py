#!/usr/bin/env python3
"""Differential test for stability_control_0x5957C (0x5957C) — v3 lift (branches + delay slots), 18 bytes.
...
Run from repo root: python3 c/tests/test_stability_control_0x5957C_5957c.py
"""
...
CODE = {
    0x5957c: {"kind": 'reg', "py": 'r[2] = 0xFFFFD130', "slot_py": None, "target": None, "cond": None},
    0x5957e: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFD130, 1))', "slot_py": None, "target": None, "cond": None},
    0x59580: {"kind": 'reg', "py": 'r[1] = 0xFFFFD275', "slot_py": None, "target": None, "cond": None},
    0x59582: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD275, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x59584: {"kind": 'reg', "py": 'r[3] = 0xFFFFD131', "slot_py": None, "target": None, "cond": None},
    0x59586: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFD131, 1))', "slot_py": None, "target": None, "cond": None},
    0x59588: {"kind": 'reg', "py": 'r[2] = 0xFFFFD276', "slot_py": None, "target": None, "cond": None},
    0x5958a: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFD276, 1, r[0])', "target": None, "cond": None},}
