#!/usr/bin/env python3
"""Differential test for ram_copy_byte_29A68 (0x29A68) — v3 lift (branches + delay slots), 10 bytes.
...
Run from repo root: python3 c/tests/test_ram_copy_byte_29A68_29a68.py
"""
...
CODE = {
    0x29a68: {"kind": 'reg', "py": 'r[3] = 0xFFFFBC65', "slot_py": None, "target": None, "cond": None},
    0x29a6a: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFBC65, 1))', "slot_py": None, "target": None, "cond": None},
    0x29a6c: {"kind": 'reg', "py": 'r[2] = 0xFFFFBB15', "slot_py": None, "target": None, "cond": None},
    0x29a6e: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBB15, 1, r[0])', "target": None, "cond": None},}
