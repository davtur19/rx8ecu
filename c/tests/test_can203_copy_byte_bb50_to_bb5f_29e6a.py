#!/usr/bin/env python3
"""Differential test for can203_copy_byte_bb50_to_bb5f (0x29E6A) — v3 lift (branches + delay slots), 10 bytes.
...
Run from repo root: python3 c/tests/test_can203_copy_byte_bb50_to_bb5f_29e6a.py
"""
...
ENTRY = 0x29E6A
RAW = bytes.fromhex("92 18 D1 11 63 20 00 0B 21 30")
SEED = 43
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBB5F
SPAN_END = 0x29E74
SENT = 0x29E74     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x29e6a: {"kind": 'reg', "py": 'r[2] = 0xFFFFBB50', "slot_py": None, "target": None, "cond": None},
    0x29e6c: {"kind": 'reg', "py": 'r[1] = 0xFFFFBB5F', "slot_py": None, "target": None, "cond": None},
    0x29e6e: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFBB50, 1))', "slot_py": None, "target": None, "cond": None},
    0x29e70: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBB5F, 1, r[3])', "target": None, "cond": None},}
