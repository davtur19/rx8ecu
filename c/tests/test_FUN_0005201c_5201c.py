#!/usr/bin/env python3
"""Differential test for FUN_0005201c (0x5201C) — mem lift (RAM-only, straight-line), 8 bytes.
...
Run from repo root: python3 c/tests/test_FUN_0005201c_5201c.py
"""
...
ENTRY = 0x5201C
RAW = bytes.fromhex("00 09 D3 26 62 30 22 28")
SEED = 42
N = 2000
