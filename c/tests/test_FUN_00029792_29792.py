#!/usr/bin/env python3
"""Differential test for FUN_00029792 (0x29792) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_FUN_00029792_29792.py
"""
...
ENTRY = 0x29792
RAW = bytes.fromhex("E3 3E D2 2E 00 0B 22 31")
SEED = 42
N = 500
MAXSTEPS = 100000
