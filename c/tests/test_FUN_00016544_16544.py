#!/usr/bin/env python3
"""Differential test for FUN_00016544 (0x16544) — v3 lift + v4 FPU, 8 bytes.
...
Run from repo root: python3 c/tests/test_FUN_00016544_16544.py
"""
...
RAM_MAX = 0xFFFFA8C4
SPAN_END = 0x1654C
SENT = 0x1654C     # stop-sentinel, placed past the literal pool
