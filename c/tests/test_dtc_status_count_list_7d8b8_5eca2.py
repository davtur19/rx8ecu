#!/usr/bin/env python3
"""Differential test for dtc_status_count_list_7d8b8 (0x5ECA2) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_dtc_status_count_list_7d8b8_5eca2.py
"""
...
ENTRY = 0x5ECA2
RAW = bytes.fromhex("7F 04 4F 26 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = None
SPAN_END = 0x5ECAA
SENT = 0x5ECAA     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x5eca2: {"kind": 'reg', "py": 'r[15] = (r[15] + s8(0x04)) & 0xFFFFFFFF\nsp = (sp + s8(0x04)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x5eca4: {"kind": 'mem', "py": 'pr = _rdw(ram, STACK_BASE + 0x404, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x5eca6: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
