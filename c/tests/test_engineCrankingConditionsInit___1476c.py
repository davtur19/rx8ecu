#!/usr/bin/env python3
"""Differential test for engineCrankingConditionsInit__ (0x1476C) — v3 lift (branches + delay slots), 16 bytes.
...
Run from repo root: python3 c/tests/test_engineCrankingConditionsInit___1476c.py
"""
...
ENTRY = 0x1476C
RAW = bytes.fromhex("93 39 E4 00 D2 1E 23 40 22 40 D1 1E 00 0B 21 40")
SEED = 43
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFA79E
SPAN_END = 0x1477C
SENT = 0x1477C     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x1476c: {"kind": 'reg', "py": 'r[3] = 0xFFFFA79C', "slot_py": None, "target": None, "cond": None},
    0x1476e: {"kind": 'reg', "py": 'r[4] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x14770: {"kind": 'reg', "py": 'r[2] = 0xFFFFA79E', "slot_py": None, "target": None, "cond": None},
    0x14772: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA79C, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x14774: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA79E, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x14776: {"kind": 'reg', "py": 'r[1] = 0xFFFFA79D', "slot_py": None, "target": None, "cond": None},
    0x14778: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFA79D, 1, r[4])', "target": None, "cond": None},}
