#!/usr/bin/env python3
"""Differential test for lookup_timing_event_table (0x10408) — v3 lift (branches + delay slots), 60 bytes.
...
Run from repo root: python3 c/tests/test_lookup_timing_event_table_10408.py
"""
...
CODE = {
    0x10408: {"kind": 'reg', "py": 'r[0] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x1040a: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x00) else 0', "slot_py": None, "target": None, "cond": None},
    0x1040c: {"kind": "branch", "py": None, "slot_py": '', "target": 0x10432, "cond": 'T'},
    0x10410: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x03) else 0', "slot_py": None, "target": None, "cond": None},
    0x10412: {"kind": "branch", "py": None, "slot_py": '', "target": 0x10432, "cond": 'T'},
    0x10416: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x10418: {"kind": "branch", "py": None, "slot_py": '', "target": 0x10438, "cond": 'T'},
    0x1041c: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x02) else 0', "slot_py": None, "target": None, "cond": None},
    0x1041e: {"kind": "branch", "py": None, "slot_py": '', "target": 0x10438, "cond": 'T'},
    0x10422: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x04) else 0', "slot_py": None, "target": None, "cond": None},
    0x10424: {"kind": "branch", "py": None, "slot_py": '', "target": 0x10438, "cond": 'T'},
    0x10428: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x05) else 0', "slot_py": None, "target": None, "cond": None},
    0x1042a: {"kind": "branch", "py": None, "slot_py": '', "target": 0x10438, "cond": 'T'},
    0x1042e: {"kind": "branch", "py": None, "slot_py": '', "target": 0x1043e, "cond": 'always'},
    0x10432: {"kind": 'reg', "py": 'r[3] = 0x0006CF98', "slot_py": None, "target": None, "cond": None},
    0x10434: {"kind": "branch", "py": None, "slot_py": 'r[4] = _rdw(ram, 0x0006CF98, 4)', "target": 0x10440, "cond": 'always'},
    0x10438: {"kind": 'reg', "py": 'r[1] = 0x0006CF9C', "slot_py": None, "target": None, "cond": None},
    0x1043a: {"kind": "branch", "py": None, "slot_py": 'r[4] = _rdw(ram, 0x0006CF9C, 4)', "target": 0x10440, "cond": 'always'},
    0x1043e: {"kind": 'reg', "py": 'r[4] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x10440: {"kind": "ret", "py": None, "slot_py": 'r[0] = r[4]', "target": None, "cond": None},}
