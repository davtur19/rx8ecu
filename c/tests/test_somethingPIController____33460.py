#!/usr/bin/env python3
"""Differential test for somethingPIController___ (0x33460) — v3 lift (branches + delay slots), 48 bytes.
...
Run from repo root: python3 c/tests/test_somethingPIController____33460.py
"""
...
ENTRY = 0x33460
RAW = bytes.fromhex("00 09 92 39 A0 02 22 50 91 36 21 40 D3 1F 23 E0 D2 1F 22 60 D1 1F 21 70 90 2B 63 00 D2 19 22 30 93 28 61 30 D2 18 22 10 6C F6 6D F6 00 0B 6E F6")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFC032
SPAN_END = 0x33490
SENT = 0x33490     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x33460: {"kind": 'reg', "py": None, "slot_py": None, "target": None, "cond": None},
    0x33462: {"kind": 'reg', "py": 'r[2] = 0xFFFFC01C', "slot_py": None, "target": None, "cond": None},
    0x33464: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFC01C, 1, r[5])', "target": 0x3346c, "cond": 'always'},
    0x33468: {"kind": 'reg', "py": 'r[1] = 0xFFFFC01C', "slot_py": None, "target": None, "cond": None},
    0x3346a: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC01C, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x3346c: {"kind": 'reg', "py": 'r[3] = 0xFFFFC02F', "slot_py": None, "target": None, "cond": None},
    0x3346e: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC02F, 1, r[14])', "slot_py": None, "target": None, "cond": None},
    0x33470: {"kind": 'reg', "py": 'r[2] = 0xFFFFC030', "slot_py": None, "target": None, "cond": None},
    0x33472: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC030, 1, r[6])', "slot_py": None, "target": None, "cond": None},
    0x33474: {"kind": 'reg', "py": 'r[1] = 0xFFFFC02E', "slot_py": None, "target": None, "cond": None},
    0x33476: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC02E, 1, r[7])', "slot_py": None, "target": None, "cond": None},
    0x33478: {"kind": 'reg', "py": 'r[0] = 0xFFFFC022', "slot_py": None, "target": None, "cond": None},
    0x3347a: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFC022, 1))', "slot_py": None, "target": None, "cond": None},
    0x3347c: {"kind": 'reg', "py": 'r[2] = 0xFFFFC031', "slot_py": None, "target": None, "cond": None},
    0x3347e: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC031, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x33480: {"kind": 'reg', "py": 'r[3] = 0xFFFFC021', "slot_py": None, "target": None, "cond": None},
    0x33482: {"kind": 'mem', "py": 'r[1] = s8(_rdw(ram, 0xFFFFC021, 1))', "slot_py": None, "target": None, "cond": None},
    0x33484: {"kind": 'reg', "py": 'r[2] = 0xFFFFC032', "slot_py": None, "target": None, "cond": None},
    0x33486: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC032, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x33488: {"kind": 'mem', "py": 'r[12] = _rdw(ram, STACK_BASE + 0x400, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x3348a: {"kind": 'mem', "py": 'r[13] = _rdw(ram, STACK_BASE + 0x404, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x3348c: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, STACK_BASE + 0x408, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},}
