#!/usr/bin/env python3
"""Differential test for FUN_0000522a (0x522A) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_FUN_0000522a_522a.py
"""
...
ENTRY = 0x522A
RAW = bytes.fromhex("91 6C 92 6C 00 0B 22 11")
SEED = 42
N = 500
MAXSTEPS = 100000
