#!/usr/bin/env python3
"""Differential test for FUN_0004431e (0x4431E) — v3 lift + v4 FPU, 48 bytes.
...
Run from repo root: python3 c/tests/test_FUN_0004431e_4431e.py
"""
...
RAM_MAX = 0xFFFFCD90
SPAN_END = 0x4434E
SENT = 0x4434E     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x4431e: {"kind": 'reg', "py": 'r[1] = 0xFFFFBAD4', "slot_py": None, "target": None, "cond": None},
    0x44320: {"kind": 'reg', "py": 'r[2] = 0x00000190', "slot_py": None, "target": None, "cond": None},
    0x44322: {"kind": 'mem', "py": 'r[3] = s16(_rdw(ram, 0xFFFFBAD4, 2))', "slot_py": None, "target": None, "cond": None},
    0x44324: {"kind": 'reg', "py": 'r[3] = r[3] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x44326: {"kind": 'reg', "py": 'T = 1 if r[3] == r[2] else 0', "slot_py": None, "target": None, "cond": None},
    0x44328: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4434a, "cond": 'notT'},
    0x4432c: {"kind": 'reg', "py": 'r[4] = 0xFFFFCA9E', "slot_py": None, "target": None, "cond": None},
    0x4432e: {"kind": 'reg', "py": 'r[3] = 0x0007ADC8', "slot_py": None, "target": None, "cond": None},
    0x44330: {"kind": 'reg', "py": 'r[2] = 0xFFFFCD90', "slot_py": None, "target": None, "cond": None},
    0x44332: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x0007ADC8, 4))', "slot_py": None, "target": None, "cond": None},
    0x44334: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0xFFFFCD90, 4))', "slot_py": None, "target": None, "cond": None},
    0x44336: {"kind": 'fpu', "py": 'T = 1 if fr[3] > fr[2] else 0', "slot_py": None, "target": None, "cond": None},
    0x44338: {"kind": "branch", "py": None, "slot_py": '', "target": 0x44344, "cond": 'T'},
    0x4433c: {"kind": 'reg', "py": 'r[1] = 0xFFFFCA80', "slot_py": None, "target": None, "cond": None},
    0x4433e: {"kind": 'mem', "py": 'r[0] = s16(_rdw(ram, 0xFFFFCA80, 2))', "slot_py": None, "target": None, "cond": None},
    0x44340: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFCA9E, 2, r[0])', "target": 0x4434a, "cond": 'always'},
    0x44344: {"kind": 'reg', "py": 'r[1] = 0x0007ADC4', "slot_py": None, "target": None, "cond": None},
    0x44346: {"kind": 'mem', "py": 'r[2] = s16(_rdw(ram, 0x0007ADC4, 2))', "slot_py": None, "target": None, "cond": None},
    0x44348: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCA9E, 2, r[2])', "slot_py": None, "target": None, "cond": None},
    0x4434a: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
