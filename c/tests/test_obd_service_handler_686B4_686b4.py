#!/usr/bin/env python3
"""Differential test for obd_service_handler_686B4 (0x686B4) — pure straight-line lift, 20 bytes.
...
Run from repo root: python3 c/tests/test_obd_service_handler_686B4_686b4.py
"""
...
ENTRY = 0x686B4
RAW = bytes.fromhex("D6 1B E5 00 67 53 E0 02 63 53 62 53 43 08 33 2C 43 00 33 6C")
SEED = 42
N = 2000
