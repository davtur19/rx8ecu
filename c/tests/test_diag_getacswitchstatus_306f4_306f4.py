#!/usr/bin/env python3
"""Differential test for diag_getacswitchstatus_306f4 (0x306F4) — v3 lift (branches + delay slots), 32 bytes.
...
Run from repo root: python3 c/tests/test_diag_getacswitchstatus_306f4_306f4.py
"""
...
RAM_MAX = 0xFFFFBE24
SPAN_END = 0x30714
SENT = 0x3071C     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x306f4: {"kind": 'reg', "py": 'r[4] = 0xFFFFBE24', "slot_py": None, "target": None, "cond": None},
    0x306f6: {"kind": 'reg', "py": 'r[3] = 0xFFFF9ECD', "slot_py": None, "target": None, "cond": None},
    0x306f8: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFF9ECD, 1))', "slot_py": None, "target": None, "cond": None},
    0x306fa: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x306fc: {"kind": 'reg', "py": 'T = 1 if (r[0] & 0x04) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x306fe: {"kind": 'reg', "py": 'r[0] = T;', "slot_py": None, "target": None, "cond": None},
    0x30700: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x30702: {"kind": "branch", "py": None, "slot_py": '', "target": 0x3070c, "cond": 'notT'},
    0x30706: {"kind": 'reg', "py": 'r[3] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x30708: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFBE24, 1, r[3])', "target": 0x30710, "cond": 'always'},
    0x3070c: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x3070e: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBE24, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x30710: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
