#!/usr/bin/env python3
"""Differential test for set_flag_a571 (0xF8CC) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_set_flag_a571_f8cc.py
"""
...
ENTRY = 0xF8CC
RAW = bytes.fromhex("D1 22 E2 01 00 0B 21 20")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFA571
SPAN_END = 0xF8D4
SENT = 0xF8D4     # stop-sentinel, placed past the literal pool
