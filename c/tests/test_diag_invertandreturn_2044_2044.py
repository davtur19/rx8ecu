#!/usr/bin/env python3
"""Differential test for diag_invertandreturn_2044 (0x2044) — v3 lift (branches + delay slots), 14 bytes.
...
Run from repo root: python3 c/tests/test_diag_invertandreturn_2044_2044.py
"""
...
ENTRY = 0x2044
RAW = bytes.fromhex("63 41 60 33 43 19 60 07 30 38 00 0B 60 0C")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = None
SPAN_END = 0x2052
SENT = 0x2052     # stop-sentinel, placed past the literal pool
