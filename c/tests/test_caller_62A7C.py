#!/usr/bin/env python3
"""Differential test for caller_62A7C (entry 0x62A7C) — v8 ST caller (CFG), 40 bytes.
...
Run: python3 test_caller_62A7C.py
"""
...
CODE = {
    0x62a7c: {"kind": 'st', "py": 'local[0x3FC] = pr\n_wrw(ram, STACK_BASE + 0x3FC, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x62a7e: {"kind": 'reg', "py": 'r[0] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x62a80: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x62a82: {"kind": "branch", "py": None, "slot_py": '', "target": 0x62a9e, "cond": 'notT'},
    0x62a86: {"kind": 'reg', "py": 'r[2] = 0xFFFF87B0', "slot_py": None, "target": None, "cond": None},
    0x62a88: {"kind": 'reg', "py": 'r[1] = 0x0000FFFF', "slot_py": None, "target": None, "cond": None},
    0x62a8a: {"kind": 'mem', "py": 'r[4] = s16(_rdw(ram, 0xFFFF87B0, 2))', "slot_py": None, "target": None, "cond": None},
    0x62a8c: {"kind": 'reg', "py": 'r[3] = r[4] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x62a8e: {"kind": 'reg', "py": 'T = 1 if s32(r[3]) >= s32(r[1]) else 0', "slot_py": None, "target": None, "cond": None},
    0x62a90: {"kind": "branch", "py": None, "slot_py": '', "target": 0x62a9e, "cond": 'T'},
    0x62a94: {"kind": 'reg', "py": 'r[3] = 0x00002430', "slot_py": None, "target": None, "cond": None},
    0x62a96: {"kind": "call", "py": None, "slot_py": 'r[4] = (r[4] + s8(0x01)) & 0xFFFFFFFF', "target": 0x2430, "ret_pc": 0x62a9a, "set_pr": True, "cond": None},
    0x62a9a: {"kind": 'reg', "py": 'r[2] = 0xFFFF87B0', "slot_py": None, "target": None, "cond": None},
    0x62a9c: {"kind": 'mem', "py": '_wrw(ram, 0xFFFF87B0, 4, r[0])', "slot_py": None, "target": None, "cond": None},
    0x62a9e: {"kind": 'st', "py": 'pr = _rdw(ram, STACK_BASE + 0x3FC, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x62aa0: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},
