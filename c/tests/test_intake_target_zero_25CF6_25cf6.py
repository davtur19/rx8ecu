#!/usr/bin/env python3
"""Differential test for intake_target_zero_25CF6 (0x25CF6) — v3 lift + v4 FPU, 12 bytes.
...
Run from repo root: python3 c/tests/test_intake_target_zero_25CF6_25cf6.py
"""
...
ENTRY = 0x25CF6
RAW = bytes.fromhex("F4 8D 93 73 F3 4A D2 3C 00 0B F2 4A")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFB5D4
SPAN_END = 0x25D02
SENT = 0x25D02     # stop-sentinel, placed past the literal pool
