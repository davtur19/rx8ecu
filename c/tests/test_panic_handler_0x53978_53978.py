#!/usr/bin/env python3
"""Differential test for panic_handler_0x53978 (0x53978) — v3 lift (branches + delay slots), 72 bytes.
...
Run from repo root: python3 c/tests/test_panic_handler_0x53978_53978.py
"""
...
ENTRY = 0x53978
RAW = bytes.fromhex("93 1D 60 30 60 0C 88 01 8F 01 00 09 74 08 93 17 60 30 60 0C 88 01 8F 01 00 09 74 20 93 11 60 30 60 0C 88 01 8F 01 00 09 74 40 00 0B 60 43 CF D5 CF CF CF 9D 90 0C 90 08 8F E8 CF 99 CF A4 CF 95 CF A1 CF B3 00 03 E0 DC")
SEED = 43
N = 2000
MAXSTEPS = 100000
