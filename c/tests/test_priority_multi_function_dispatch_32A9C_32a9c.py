#!/usr/bin/env python3
"""Differential test for priority_multi_function_dispatch_32A9C (0x32A9C) — v3 lift (branches + delay slots), 32 bytes.
...
Run from repo root: python3 c/tests/test_priority_multi_function_dispatch_32A9C_32a9c.py
"""
...
ENTRY = 0x32A9C
RAW = bytes.fromhex("D2 1F 22 60 D1 1F 21 70 90 2B 63 00 D2 19 22 30 93 28 61 30 D2 18 22 10 6C F6 6D F6 00 0B 6E F6")
SEED = 42
N = 500
MAXSTEPS = 100000
