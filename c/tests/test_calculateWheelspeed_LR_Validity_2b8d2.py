#!/usr/bin/env python3
"""Differential test for calculateWheelspeed_LR_Validity (0x2B8D2) — v3 lift (branches + delay slots), 44 bytes.
...
Run from repo root: python3 c/tests/test_calculateWheelspeed_LR_Validity_2b8d2.py
"""
...
ENTRY = 0x2B8D2
RAW = bytes.fromhex("94 57 92 57 63 21 D1 32 63 3D 33 10 8D 07 00 09 D3 31 D1 31 60 31 62 11 30 22 8F 03 00 09 E3 01 A0 02 24 30 E1 00 24 10 00 0B 00 09")
SEED = 43
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBBF2
SPAN_END = 0x2B8FE
SENT = 0x2B8FE     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x2b8d2: {"kind": 'reg', "py": 'r[4] = 0xFFFFBBED', "slot_py": None, "target": None, "cond": None},
    0x2b8d4: {"kind": 'reg', "py": 'r[2] = 0xFFFFBBE0', "slot_py": None, "target": None, "cond": None},
    0x2b8d6: {"kind": 'mem', "py": 'r[3] = s16(_rdw(ram, 0xFFFFBBE0, 2))', "slot_py": None, "target": None, "cond": None},
    0x2b8d8: {"kind": 'reg', "py": 'r[1] = 0x0000FFFF', "slot_py": None, "target": None, "cond": None},
    0x2b8da: {"kind": 'reg', "py": 'r[3] = r[3] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x2b8dc: {"kind": 'reg', "py": 'T = 1 if r[3] == r[1] else 0', "slot_py": None, "target": None, "cond": None},
    0x2b8de: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2b8f0, "cond": 'T'},
    0x2b8e2: {"kind": 'reg', "py": 'r[3] = 0xFFFFBBF2', "slot_py": None, "target": None, "cond": None},
    0x2b8e4: {"kind": 'reg', "py": 'r[1] = 0x0007A7C0', "slot_py": None, "target": None, "cond": None},
    0x2b8e6: {"kind": 'mem', "py": 'r[0] = s16(_rdw(ram, 0xFFFFBBF2, 2))', "slot_py": None, "target": None, "cond": None},
    0x2b8e8: {"kind": 'mem', "py": 'r[2] = s16(_rdw(ram, 0x0007A7C0, 2))', "slot_py": None, "target": None, "cond": None},
    0x2b8ea: {"kind": 'reg', "py": 'T = 1 if (r[0] & 0xFFFFFFFF) >= (r[2] & 0xFFFFFFFF) else 0', "slot_py": None, "target": None, "cond": None},
    0x2b8ec: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2b8f6, "cond": 'notT'},
    0x2b8f0: {"kind": 'reg', "py": 'r[3] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x2b8f2: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFBBED, 1, r[3])', "target": 0x2b8fa, "cond": 'always'},
    0x2b8f6: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x2b8f8: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBBED, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x2b8fa: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
