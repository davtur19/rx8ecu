#!/usr/bin/env python3
"""Differential test for FUN_000578be (0x578BE) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_FUN_000578be_578be.py
"""
...
ENTRY = 0x578BE
RAW = bytes.fromhex("E3 00 D2 16 00 0B 22 30")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFD057
SPAN_END = 0x578C6
SENT = 0x578C6     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x578be: {"kind": 'reg', "py": 'r[3] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x578c0: {"kind": 'reg', "py": 'r[2] = 0xFFFFD057', "slot_py": None, "target": None, "cond": None},
    0x578c2: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFD057, 1, r[3])', "target": None, "cond": None},}
