#!/usr/bin/env python3
"""Differential test for caller_D6E4 (entry 0xD6E4) — v8 ST caller (CFG), 38 bytes.
...
Run: python3 test_caller_D6E4.py
"""
...
CODE = {
    0xd6e4: {"kind": 'st', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xd6e6: {"kind": 'reg', "py": 'r[15] = (r[15] + s8(0xF8)) & 0xFFFFFFFF\nsp = (sp + s8(0xF8)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xd6e8: {"kind": 'reg', "py": 'r[5] = 0x000000E0', "slot_py": None, "target": None, "cond": None},
    0xd6ea: {"kind": 'reg', "py": 'r[3] = 0x00002054', "slot_py": None, "target": None, "cond": None},
    0xd6ec: {"kind": "call", "py": None, "slot_py": 'r[4] = r[15]', "target": 0x2054, "ret_pc": 0xd6f0, "set_pr": True, "cond": None},
    0xd6f0: {"kind": 'reg', "py": 'r[4] = 0xFFFFA3FC', "slot_py": None, "target": None, "cond": None},
    0xd6f2: {"kind": 'reg', "py": 'r[3] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0xd6f4: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFA3FC, 1))', "slot_py": None, "target": None, "cond": None},
    0xd6f6: {"kind": 'mem', "py": '_wrw(ram, sp + 4, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0xd6f8: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA3FC, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0xd6fa: {"kind": 'reg', "py": 'r[3] = 0x00002064', "slot_py": None, "target": None, "cond": None},
    0xd6fc: {"kind": "call", "py": None, "slot_py": 'r[4] = _rdw(ram, sp, 4)', "target": 0x2064, "ret_pc": 0xd700, "set_pr": True, "cond": None},
    0xd700: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, sp + 4, 1))', "slot_py": None, "target": None, "cond": None},
    0xd702: {"kind": 'reg', "py": 'r[15] = (r[15] + s8(0x08)) & 0xFFFFFFFF\nsp = (sp + s8(0x08)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xd704: {"kind": 'st', "py": 'pr = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xd706: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},
