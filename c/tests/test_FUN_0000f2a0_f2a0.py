#!/usr/bin/env python3
"""Differential test for FUN_0000f2a0 (0xF2A0) — v3 lift (branches + delay slots), 16 bytes.
...
Run from repo root: python3 c/tests/test_FUN_0000f2a0_f2a0.py
"""
...
ENTRY = 0xF2A0
RAW = bytes.fromhex("93 55 E4 00 D2 2B 23 40 22 40 D1 2B 00 0B 21 40")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFA4B2
SPAN_END = 0xF2B0
SENT = 0xF2B0     # stop-sentinel, placed past the literal pool
