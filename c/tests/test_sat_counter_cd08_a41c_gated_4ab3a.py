#!/usr/bin/env python3
"""Differential test for sat_counter_cd08_a41c_gated (0x4AB3A) — v3 lift (branches + delay slots), 38 bytes.
...
Run from repo root: python3 c/tests/test_sat_counter_cd08_a41c_gated_4ab3a.py
"""
...
ENTRY = 0x4AB3A
RAW = bytes.fromhex("D5 30 93 4C 60 30 60 0C 88 01 8F 08 00 09 64 52 E1 FF 34 12 8D 05 00 09 74 01 A0 02 25 42 E2 00 25 22 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCD08
SPAN_END = 0x4AB60
SENT = 0x4AB60     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x4ab3a: {"kind": 'reg', "py": 'r[5] = 0xFFFFCD08', "slot_py": None, "target": None, "cond": None},
    0x4ab3c: {"kind": 'reg', "py": 'r[3] = 0xFFFFA41C', "slot_py": None, "target": None, "cond": None},
    0x4ab3e: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFA41C, 1))', "slot_py": None, "target": None, "cond": None},
    0x4ab40: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x4ab42: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x4ab44: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4ab58, "cond": 'notT'},
    0x4ab48: {"kind": 'mem', "py": 'r[4] = _rdw(ram, 0xFFFFCD08, 4)', "slot_py": None, "target": None, "cond": None},
    0x4ab4a: {"kind": 'reg', "py": 'r[1] = s8(0xFF)', "slot_py": None, "target": None, "cond": None},
    0x4ab4c: {"kind": 'reg', "py": 'T = 1 if (r[4] & 0xFFFFFFFF) >= (r[1] & 0xFFFFFFFF) else 0', "slot_py": None, "target": None, "cond": None},
    0x4ab4e: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4ab5c, "cond": 'T'},
    0x4ab52: {"kind": 'reg', "py": 'r[4] = (r[4] + s8(0x01)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x4ab54: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFCD08, 4, r[4])', "target": 0x4ab5c, "cond": 'always'},
    0x4ab58: {"kind": 'reg', "py": 'r[2] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x4ab5a: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCD08, 4, r[2])', "slot_py": None, "target": None, "cond": None},
    0x4ab5c: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
