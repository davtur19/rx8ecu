#!/usr/bin/env python3
"""Differential test for cond_float_copy_a9fc_to_ccfc (0x4AC1C) — v3 lift + v4 FPU, 34 bytes.
...
Run from repo root: python3 c/tests/test_cond_float_copy_a9fc_to_ccfc_4ac1c.py
"""
...
ENTRY = 0x4AC1C
RAW = bytes.fromhex("D2 3D D5 3E 60 50 60 0C 88 01 8F 08 64 20 61 4C 21 18 8F 04 00 09 93 6B D2 39 F3 38 F2 3A 00 0B 25 40")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCD17
SPAN_END = 0x4AC3E
SENT = 0x4AC3E     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x4ac1c: {"kind": 'reg', "py": 'r[2] = 0xFFFFCD11', "slot_py": None, "target": None, "cond": None},
    0x4ac1e: {"kind": 'reg', "py": 'r[5] = 0xFFFFCD17', "slot_py": None, "target": None, "cond": None},
    0x4ac20: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCD17, 1))', "slot_py": None, "target": None, "cond": None},
    0x4ac22: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x4ac24: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x4ac26: {"kind": "branch", "py": None, "slot_py": 'r[4] = s8(_rdw(ram, 0xFFFFCD11, 1))', "target": 0x4ac3a, "cond": 'notT'},
    0x4ac2a: {"kind": 'reg', "py": 'r[1] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x4ac2c: {"kind": 'reg', "py": 'T = 1 if (r[1] & r[1]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x4ac2e: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4ac3a, "cond": 'notT'},
    0x4ac32: {"kind": 'reg', "py": 'r[3] = 0xFFFFA9FC', "slot_py": None, "target": None, "cond": None},
    0x4ac34: {"kind": 'reg', "py": 'r[2] = 0xFFFFCCFC', "slot_py": None, "target": None, "cond": None},
    0x4ac36: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFA9FC, 4))', "slot_py": None, "target": None, "cond": None},
    0x4ac38: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFCCFC, 4, f2bits(fr[3]))', "slot_py": None, "target": None, "cond": None},
    0x4ac3a: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFCD17, 1, r[4])', "target": None, "cond": None},}
