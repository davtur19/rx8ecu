#!/usr/bin/env python3
"""Differential test for fpu_register_copy_simple_34D3A (0x34D3A) — v3 lift + v4 FPU, 10 bytes.
...
Run from repo root: python3 c/tests/test_fpu_register_copy_simple_34D3A_34d3a.py
"""
...
ENTRY = 0x34D3A
RAW = bytes.fromhex("D0 42 93 74 F3 08 00 0B F3 3A")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFC12C
SPAN_END = 0x34D44
SENT = 0x34D44     # stop-sentinel, placed past the literal pool
