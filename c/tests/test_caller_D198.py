#!/usr/bin/env python3
"""Differential test for caller_D198 (entry 0xD198) — v8 ST caller (CFG), 20 bytes.
...
Run: python3 test_caller_D198.py
"""
...
CODE = {
    0xd198: {"kind": 'reg', "py": 'r[4] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0xd19a: {"kind": 'reg', "py": 'T = 1 if (r[4] & r[4]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0xd19c: {"kind": "branch", "py": None, "slot_py": '', "target": 0xd1a4, "cond": 'notT'},
    0xd1a0: {"kind": "branch", "py": None, "slot_py": 'r[4] = r[5]', "target": 0xd1a8, "cond": 'always'},
    0xd1a4: {"kind": 'reg', "py": 'r[4] = 0x00000200', "slot_py": None, "target": None, "cond": None},
    0xd1a6: {"kind": 'reg', "py": 'r[4] = (r[4] + r[5]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xd1a8: {"kind": "ret", "py": None, "slot_py": 'r[0] = r[4]', "target": None, "cond": None},
}
