#!/usr/bin/env python3
"""Differential test for interrupt_state_update_5E7F0 (0x5E7F0) — v3 lift (branches + delay slots), 10 bytes.
...
Run from repo root: python3 c/tests/test_interrupt_state_update_5E7F0_5e7f0.py
"""
...
ENTRY = 0x5E7F0
RAW = bytes.fromhex("6B F6 6C F6 6D F6 00 0B 6E F6")
SEED = 43
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = None
SPAN_END = 0x5E7FA
SENT = 0x5E7FA     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x5e7f0: {"kind": 'mem', "py": 'r[11] = _rdw(ram, STACK_BASE + 0x400, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x5e7f2: {"kind": 'mem', "py": 'r[12] = _rdw(ram, STACK_BASE + 0x404, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x5e7f4: {"kind": 'mem', "py": 'r[13] = _rdw(ram, STACK_BASE + 0x408, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x5e7f6: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, STACK_BASE + 0x40C, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},}
