#!/usr/bin/env python3
"""Differential test for getThrottlePositionFault__ (0x345C4) — v3 lift + v4 FPU, 44 bytes.
...
Run from repo root: python3 c/tests/test_getThrottlePositionFault___345c4.py
"""
...
ENTRY = 0x345C4
RAW = bytes.fromhex("93 67 F4 38 D2 39 F6 28 D1 39 F5 6C 94 62 F3 18 F5 31 F5 45 8F 03 00 09 E0 00 A0 05 24 00 F6 45 8D 02 00 09 E3 01 24 30 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFC128
SPAN_END = 0x345F0
SENT = 0x345F0     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x345c4: {"kind": 'reg', "py": 'r[3] = 0xFFFFADAC', "slot_py": None, "target": None, "cond": None},
    0x345c6: {"kind": 'fpu', "py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFADAC, 4))', "slot_py": None, "target": None, "cond": None},
    0x345c8: {"kind": 'reg', "py": 'r[2] = 0x000788CC', "slot_py": None, "target": None, "cond": None},
    0x345ca: {"kind": 'fpu', "py": 'fr[6] = bits2f(_rdw(ram, 0x000788CC, 4))', "slot_py": None, "target": None, "cond": None},
    0x345cc: {"kind": 'reg', "py": 'r[1] = 0x000788D0', "slot_py": None, "target": None, "cond": None},
    0x345ce: {"kind": 'fpu', "py": 'fr[5] = fr[6]', "slot_py": None, "target": None, "cond": None},
    0x345d0: {"kind": 'reg', "py": 'r[4] = 0xFFFFC128', "slot_py": None, "target": None, "cond": None},
    0x345d2: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x000788D0, 4))', "slot_py": None, "target": None, "cond": None},
    0x345d4: {"kind": 'fpu', "py": 'fr[5] = ts(fr[5] - fr[3])', "slot_py": None, "target": None, "cond": None},
    0x345d6: {"kind": 'fpu', "py": 'T = 1 if fr[5] > fr[4] else 0', "slot_py": None, "target": None, "cond": None},
    0x345d8: {"kind": "branch", "py": None, "slot_py": '', "target": 0x345e2, "cond": 'notT'},
    0x345dc: {"kind": 'reg', "py": 'r[0] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x345de: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFC128, 1, r[0])', "target": 0x345ec, "cond": 'always'},
    0x345e2: {"kind": 'fpu', "py": 'T = 1 if fr[6] > fr[4] else 0', "slot_py": None, "target": None, "cond": None},
    0x345e4: {"kind": "branch", "py": None, "slot_py": '', "target": 0x345ec, "cond": 'T'},
    0x345e8: {"kind": 'reg', "py": 'r[3] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x345ea: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC128, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x345ec: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
