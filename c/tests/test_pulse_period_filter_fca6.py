#!/usr/bin/env python3
"""Differential test for pulse_period_filter (0xFCA6) — v3 lift (branches + delay slots), 44 bytes.
...
Run from repo root: python3 c/tests/test_pulse_period_filter_fca6.py
"""
...
CODE = {
    0xfca6: {"kind": 'reg', "py": 'r[0] = 0xFFFFA570', "slot_py": None, "target": None, "cond": None},
    0xfca8: {"kind": 'reg', "py": 'r[2] = 0x001E0000', "slot_py": None, "target": None, "cond": None},
    0xfcaa: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFA570, 1))', "slot_py": None, "target": None, "cond": None},
    0xfcac: {"kind": 'reg', "py": 'r[5] = 0x02D00000', "slot_py": None, "target": None, "cond": None},
    0xfcae: {"kind": 'reg', "py": 'r[3] = r[3] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0xfcb0: {"kind": 'reg', "py": 'macl = (s32(r[3]) * s32(r[2])) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xfcb2: {"kind": 'reg', "py": 'r[3] = macl', "slot_py": None, "target": None, "cond": None},
    0xfcb4: {"kind": 'reg', "py": 'r[3] = (r[3] - r[4]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xfcb6: {"kind": 'reg', "py": 'r[4] = 0xFFFB0000', "slot_py": None, "target": None, "cond": None},
    0xfcb8: {"kind": 'reg', "py": 'r[4] = (r[4] + r[3]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xfcba: {"kind": 'reg', "py": 'T = 1 if s32(r[4]) >= s32(r[5]) else 0', "slot_py": None, "target": None, "cond": None},
    0xfcbc: {"kind": "branch", "py": None, "slot_py": '', "target": 0xfcc6, "cond": 'notT'},
    0xfcc0: {"kind": 'reg', "py": 'r[1] = 0xFD300000', "slot_py": None, "target": None, "cond": None},
    0xfcc2: {"kind": "branch", "py": None, "slot_py": 'r[4] = (r[4] + r[1]) & 0xFFFFFFFF', "target": 0xfcce, "cond": 'always'},
    0xfcc6: {"kind": 'reg', "py": 'T = 1 if s32(r[4]) >= 0 else 0', "slot_py": None, "target": None, "cond": None},
    0xfcc8: {"kind": "branch", "py": None, "slot_py": '', "target": 0xfcce, "cond": 'T'},
    0xfccc: {"kind": 'reg', "py": 'r[4] = (r[4] + r[5]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xfcce: {"kind": "ret", "py": None, "slot_py": 'r[0] = r[4]', "target": None, "cond": None},}
