#!/usr/bin/env python3
"""Differential test for updateMemoryAtAddress_8bit_ADDR_VAL (0x3EE58) — v3 lift (branches + delay slots), 16 bytes.
...
Run from repo root: python3 c/tests/test_updateMemoryAtAddress_8bit_ADDR_VAL_3ee58.py
"""
