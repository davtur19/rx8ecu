#!/usr/bin/env python3
"""Differential test for sensor_counter_compare_saturate (0x4D2F0) — v3 lift + v4 FPU, 24 bytes.
...
Run from repo root: python3 c/tests/test_sensor_counter_compare_saturate_4d2f0.py
"""
...
ENTRY = 0x4D2F0
RAW = bytes.fromhex("90 32 F2 08 F2 35 8F 03 00 09 E2 00 A0 02 25 20 E1 01 25 10 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    ...
    0x4d2fc: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, r[5], 1, r[2])', "target": 0x4d304, "cond": 'always'},
    0x4d300: {"kind": 'reg', "py": 'r[1] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x4d302: {"kind": 'mem', "py": '_wrw(ram, r[5], 1, r[1])', "slot_py": None, "target": None, "cond": None},
