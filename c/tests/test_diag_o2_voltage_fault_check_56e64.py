#!/usr/bin/env python3
"""Differential test for diag_o2_voltage_fault_check (0x56E64) — v3 lift (branches + delay slots), 22 bytes.
...
Run from repo root: python3 c/tests/test_diag_o2_voltage_fault_check_56e64.py
"""
...
ENTRY = 0x56E64
RAW = bytes.fromhex("00 0B 00 09 92 3D 63 20 D1 29 21 30 93 3A 60 30 D2 28 00 0B 22 00")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFD04C
SPAN_END = 0x56E7A
SENT = 0x56E7A     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x56e64: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},
    0x56e68: {"kind": 'reg', "py": 'r[2] = 0xFFFFCEBD', "slot_py": None, "target": None, "cond": None},
    0x56e6a: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFCEBD, 1))', "slot_py": None, "target": None, "cond": None},
    0x56e6c: {"kind": 'reg', "py": 'r[1] = 0xFFFFD04B', "slot_py": None, "target": None, "cond": None},
    0x56e6e: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD04B, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x56e70: {"kind": 'reg', "py": 'r[3] = 0xFFFFCEBE', "slot_py": None, "target": None, "cond": None},
    0x56e72: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCEBE, 1))', "slot_py": None, "target": None, "cond": None},
    0x56e74: {"kind": 'reg', "py": 'r[2] = 0xFFFFD04C', "slot_py": None, "target": None, "cond": None},
    0x56e76: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFD04C, 1, r[0])', "target": None, "cond": None},}
