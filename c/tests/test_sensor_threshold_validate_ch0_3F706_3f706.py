#!/usr/bin/env python3
"""Differential test for sensor_threshold_validate_ch0_3F706 (0x3F706) — v3 lift + v4 FPU, 66 bytes.
...
Run from repo root: python3 c/tests/test_sensor_threshold_validate_ch0_3F706_3f706.py
"""
...
RAM_MAX = 0xFFFFC6BD
SPAN_END = 0x3F748
SENT = 0x3F748     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x3f706: {"kind": 'reg', "py": 'r[5] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x3f708: {"kind": 'reg', "py": 'r[2] = 0x0007AED4', "slot_py": None, "target": None, "cond": None},
    0x3f70a: {"kind": 'reg', "py": 'r[3] = 0xFFFFC6B0', "slot_py": None, "target": None, "cond": None},
    0x3f70c: {"kind": 'reg', "py": 'r[6] = 0xFFFFC6BC', "slot_py": None, "target": None, "cond": None},
    0x3f70e: {"kind": 'fpu', "py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFC6B0, 4))', "slot_py": None, "target": None, "cond": None},
    0x3f710: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x0007AED4, 4))', "slot_py": None, "target": None, "cond": None},
    0x3f712: {"kind": 'fpu', "py": 'T = 1 if fr[3] > fr[4] else 0', "slot_py": None, "target": None, "cond": None},
    0x3f714: {"kind": "branch", "py": None, "slot_py": 'r[4] = s8(0x00)', "target": 0x3f71c, "cond": 'notT'},
    0x3f718: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFC6BC, 1, r[4])', "target": 0x3f728, "cond": 'always'},
    0x3f71c: {"kind": 'reg', "py": 'r[1] = 0x0007AED0', "slot_py": None, "target": None, "cond": None},
    0x3f71e: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0x0007AED0, 4))', "slot_py": None, "target": None, "cond": None},
    0x3f720: {"kind": 'fpu', "py": 'T = 1 if fr[4] > fr[2] else 0', "slot_py": None, "target": None, "cond": None},
    0x3f722: {"kind": "branch", "py": None, "slot_py": '', "target": 0x3f728, "cond": 'notT'},
    0x3f726: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC6BC, 1, r[5])', "slot_py": None, "target": None, "cond": None},
    0x3f728: {"kind": 'reg', "py": 'r[6] = 0xFFFFC6BD', "slot_py": None, "target": None, "cond": None},
    0x3f72a: {"kind": 'reg', "py": 'r[3] = 0x0007AEDC', "slot_py": None, "target": None, "cond": None},
    0x3f72c: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x0007AEDC, 4))', "slot_py": None, "target": None, "cond": None},
    0x3f72e: {"kind": 'fpu', "py": 'T = 1 if fr[3] > fr[4] else 0', "slot_py": None, "target": None, "cond": None},
    0x3f730: {"kind": "branch", "py": None, "slot_py": '', "target": 0x3f738, "cond": 'notT'},
    0x3f734: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFC6BD, 1, r[4])', "target": 0x3f744, "cond": 'always'},
    0x3f738: {"kind": 'reg', "py": 'r[2] = 0x0007AED8', "slot_py": None, "target": None, "cond": None},
    0x3f73a: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0x0007AED8, 4))', "slot_py": None, "target": None, "cond": None},
    0x3f73c: {"kind": 'fpu', "py": 'T = 1 if fr[4] > fr[2] else 0', "slot_py": None, "target": None, "cond": None},
    0x3f73e: {"kind": "branch", "py": None, "slot_py": '', "target": 0x3f744, "cond": 'notT'},
    0x3f742: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC6BD, 1, r[5])', "slot_py": None, "target": None, "cond": None},
    0x3f744: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
