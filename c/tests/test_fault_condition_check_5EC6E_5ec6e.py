#!/usr/bin/env python3
"""Differential test for fault_condition_check_5EC6E (0x5EC6E) — v3 lift (branches + delay slots), 52 bytes.
...
Run from repo root: python3 c/tests/test_fault_condition_check_5EC6E_5ec6e.py
"""
...
ENTRY = 0x5EC6E
RAW = bytes.fromhex("60 0C 88 01 8F 01 64 53 E4 03 D2 37 63 21 63 3D 23 58 8D 03 00 09 25 58 8F 02 00 09 E1 04 24 1B 93 5F 60 30 60 0C 88 01 8F 02 00 09 E1 08 24 1B 00 0B 60 43")
SEED = 43
N = 2000
MAXSTEPS = 100000
