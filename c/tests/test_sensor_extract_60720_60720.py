#!/usr/bin/env python3
"""Differential test for sensor_extract_60720 (0x60720) — v3 lift (branches + delay slots), 14 bytes.
...
Run from repo root: python3 c/tests/test_sensor_extract_60720_60720.py
"""
...
ENTRY = 0x60720
RAW = bytes.fromhex("D3 11 60 30 60 0C 88 01 04 29 00 0B 60 43")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    0x60720: {"kind": 'reg', "py": 'r[3] = 0xFFFFD3F8', "slot_py": None, "target": None, "cond": None},
    0x60722: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFD3F8, 1))', "slot_py": None, "target": None, "cond": None},
    0x60724: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x60726: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x60728: {"kind": 'reg', "py": 'r[4] = T;', "slot_py": None, "target": None, "cond": None},
    0x6072a: {"kind": "ret", "py": None, "slot_py": 'r[0] = r[4]', "target": None, "cond": None},}
