#!/usr/bin/env python3
"""Differential test for caller_27AB0 (entry 0x27AB0) — v8 ST caller (CFG), 36 bytes.
...
Run: python3 test_caller_27AB0.py
"""
...
CODE = {
    0x27ab0: {"kind": 'st', "py": 'local[0x3FC] = pr\n_wrw(ram, STACK_BASE + 0x3FC, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x27ab2: {"kind": 'fpu', "py": 'fr[5] = 0.0', "slot_py": None, "target": None, "cond": None},
    0x27ab4: {"kind": 'reg', "py": 'r[3] = 0xFFFFADC8', "slot_py": None, "target": None, "cond": None},
    0x27ab6: {"kind": 'reg', "py": 'r[2] = 0x000023DC', "slot_py": None, "target": None, "cond": None},
    0x27ab8: {"kind": "call", "py": None, "slot_py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFADC8, 4))', "target": 0x23dc, "ret_pc": 0x27abc, "set_pr": True, "cond": None},
    0x27abc: {"kind": 'reg', "py": 'r[3] = 0x00075958', "slot_py": None, "target": None, "cond": None},
    0x27abe: {"kind": 'fpu', "py": 'fr[4] = fr[0]', "slot_py": None, "target": None, "cond": None},
    0x27ac0: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x00075958, 4))', "slot_py": None, "target": None, "cond": None},
    0x27ac2: {"kind": 'fpu', "py": 'T = 1 if fr[3] > fr[4] else 0', "slot_py": None, "target": None, "cond": None},
    0x27ac4: {"kind": "branch", "py": None, "slot_py": '', "target": 0x27ace, "cond": 'T'},
    0x27ac8: {"kind": 'reg', "py": 'r[2] = 0xFFFFB71D', "slot_py": None, "target": None, "cond": None},
    0x27aca: {"kind": 'reg', "py": 'r[1] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x27acc: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFB71D, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x27ace: {"kind": 'st', "py": 'pr = _rdw(ram, STACK_BASE + 0x3FC, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x27ad0: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},
