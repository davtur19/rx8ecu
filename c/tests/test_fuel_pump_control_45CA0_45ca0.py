#!/usr/bin/env python3
"""Differential test for fuel_pump_control_45CA0 (0x45CA0) — v3 lift (branches + delay slots), 50 bytes.
...
Run from repo root: python3 c/tests/test_fuel_pump_control_45CA0_45ca0.py
"""
...
CODE = {
    0x45ca0: {"kind": 'reg', "py": 'r[3] = 0xFFFFD201', "slot_py": None, "target": None, "cond": None},
    0x45ca2: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFD201, 1))', "slot_py": None, "target": None, "cond": None},
    0x45ca4: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x45ca6: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x45ca8: {"kind": "branch", "py": None, "slot_py": '', "target": 0x45cce, "cond": 'notT'},
    0x45cac: {"kind": 'reg', "py": 'r[2] = 0xFFFFA41C', "slot_py": None, "target": None, "cond": None},
    0x45cae: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFA41C, 1))', "slot_py": None, "target": None, "cond": None},
    0x45cb0: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x45cb2: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x45cb4: {"kind": "branch", "py": None, "slot_py": '', "target": 0x45cce, "cond": 'notT'},
    0x45cb8: {"kind": 'reg', "py": 'r[3] = 0xFFFFCC09', "slot_py": None, "target": None, "cond": None},
    0x45cba: {"kind": 'reg', "py": 'r[4] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x45cbc: {"kind": 'reg', "py": 'r[2] = 0xFFFFCC0A', "slot_py": None, "target": None, "cond": None},
    0x45cbe: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCC09, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x45cc0: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCC0A, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x45cc2: {"kind": 'reg', "py": 'r[1] = 0xFFFFCC08', "slot_py": None, "target": None, "cond": None},
    0x45cc4: {"kind": 'reg', "py": 'r[3] = 0xFFFFCC0B', "slot_py": None, "target": None, "cond": None},
    0x45cc6: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCC08, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x45cc8: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCC0B, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x45cca: {"kind": 'reg', "py": 'r[2] = 0xFFFFCC0C', "slot_py": None, "target": None, "cond": None},
    0x45ccc: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCC0C, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x45cce: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
