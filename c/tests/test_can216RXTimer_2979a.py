#!/usr/bin/env python3
"""Differential test for can216RXTimer (0x2979A) — v3 lift (branches + delay slots), 40 bytes.
...
Run from repo root: python3 c/tests/test_can216RXTimer_2979a.py
"""
...
ENTRY = 0x2979A
RAW = bytes.fromhex("D6 2E D5 2C D2 24 63 21 63 3D 33 60 8D 03 00 09 E1 3E A0 07 25 11 64 51 61 4D 41 15 8F 02 00 09 34 6C 25 41 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBB0C
SPAN_END = 0x297C2
SENT = 0x297C2     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x2979a: {"kind": 'reg', "py": 'r[6] = 0x0000FFFF', "slot_py": None, "target": None, "cond": None},
    0x2979c: {"kind": 'reg', "py": 'r[5] = 0xFFFFBB0A', "slot_py": None, "target": None, "cond": None},
    0x2979e: {"kind": 'reg', "py": 'r[2] = 0xFFFFBB0C', "slot_py": None, "target": None, "cond": None},
    0x297a0: {"kind": 'mem', "py": 'r[3] = s16(_rdw(ram, 0xFFFFBB0C, 2))', "slot_py": None, "target": None, "cond": None},
    0x297a2: {"kind": 'reg', "py": 'r[3] = r[3] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x297a4: {"kind": 'reg', "py": 'T = 1 if r[3] == r[6] else 0', "slot_py": None, "target": None, "cond": None},
    0x297a6: {"kind": "branch", "py": None, "slot_py": '', "target": 0x297b0, "cond": 'T'},
    0x297aa: {"kind": 'reg', "py": 'r[1] = s8(0x3E)', "slot_py": None, "target": None, "cond": None},
    0x297ac: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFBB0A, 2, r[1])', "target": 0x297be, "cond": 'always'},
    0x297b0: {"kind": 'mem', "py": 'r[4] = s16(_rdw(ram, r[5], 2))', "slot_py": None, "target": None, "cond": None},
    0x297b2: {"kind": 'reg', "py": 'r[1] = r[4] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x297b4: {"kind": 'reg', "py": 'T = 1 if s32(r[1]) > 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x297b6: {"kind": "branch", "py": None, "slot_py": '', "target": 0x297be, "cond": 'notT'},
    0x297ba: {"kind": 'reg', "py": 'r[4] = (r[4] + r[6]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x297bc: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBB0A, 2, r[4])', "slot_py": None, "target": None, "cond": None},
    0x297be: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
