#!/usr/bin/env python3
"""Differential test for caller_F9F6 (entry 0xF9F6) — v8 ST caller (CFG), 20 bytes.
...
Run: python3 test_caller_F9F6.py
"""
...
CODE = {
    0xf9f6: {"kind": 'reg', "py": 'r[5] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0xf9f8: {"kind": 'reg', "py": 'r[3] = 0xFFFFA568', "slot_py": None, "target": None, "cond": None},
    0xf9fa: {"kind": 'st', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xf9fc: {"kind": 'reg', "py": 'r[2] = 0x00002304', "slot_py": None, "target": None, "cond": None},
    0xf9fe: {"kind": "call", "py": None, "slot_py": 'r[4] = _rdw(ram, 0xFFFFA568, 4)', "target": 0x2304, "ret_pc": 0xfa02, "set_pr": True, "cond": None},
    0xfa02: {"kind": 'reg', "py": 'r[3] = 0xFFFFA568', "slot_py": None, "target": None, "cond": None},
    0xfa04: {"kind": 'st', "py": 'pr = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xfa06: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, r[3], 4, r[0])', "target": None, "cond": None},
