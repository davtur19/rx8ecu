#!/usr/bin/env python3
"""Differential test for FUN_0002b9b8 (0x2B9B8) — v3 lift (branches + delay slots), 52 bytes.
...
Run from repo root: python3 c/tests/test_FUN_0002b9b8_2b9b8.py
"""
...
ENTRY = 0x2B9B8
RAW = bytes.fromhex("95 13 92 13 63 20 63 3C 43 15 8F 04 00 09 D3 08 61 30 A0 08 25 10 64 50 63 4C 23 38 8D 03 00 09 90 05 34 0C 25 40 00 0B 00 09 BB E4 A4 00 00 FF 00 06 D4 80")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBBE4
SPAN_END = 0x2B9EC
SENT = 0x2B9EC     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x2b9b8: {"kind": 'reg', "py": 'r[5] = 0xFFFFBBE4', "slot_py": None, "target": None, "cond": None},
    0x2b9ba: {"kind": 'reg', "py": 'r[2] = 0xFFFFA400', "slot_py": None, "target": None, "cond": None},
    0x2b9bc: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFA400, 1))', "slot_py": None, "target": None, "cond": None},
    0x2b9be: {"kind": 'reg', "py": 'r[3] = r[3] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x2b9c0: {"kind": 'reg', "py": 'T = 1 if s32(r[3]) > 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x2b9c2: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2b9ce, "cond": 'notT'},
    0x2b9c6: {"kind": 'reg', "py": 'r[3] = 0x0006D480', "slot_py": None, "target": None, "cond": None},
    0x2b9c8: {"kind": 'mem', "py": 'r[1] = s8(_rdw(ram, 0x0006D480, 1))', "slot_py": None, "target": None, "cond": None},
    0x2b9ca: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFBBE4, 1, r[1])', "target": 0x2b9de, "cond": 'always'},
    0x2b9ce: {"kind": 'mem', "py": 'r[4] = s8(_rdw(ram, r[5], 1))', "slot_py": None, "target": None, "cond": None},
    0x2b9d0: {"kind": 'reg', "py": 'r[3] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x2b9d2: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x2b9d4: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2b9de, "cond": 'T'},
    0x2b9d8: {"kind": 'reg', "py": 'r[0] = 0x000000FF', "slot_py": None, "target": None, "cond": None},
    0x2b9da: {"kind": 'reg', "py": 'r[4] = (r[4] + r[0]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x2b9dc: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBBE4, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x2b9de: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
