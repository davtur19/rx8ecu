#!/usr/bin/env python3
"""Differential test for can216DataPlausibilityCheck (0x4305E) — v3 lift + v4 FPU, 70 bytes.
...
Run from repo root: python3 c/tests/test_can216DataPlausibilityCheck_4305e.py
"""
...
ENTRY = 0x4305E
RAW = bytes.fromhex("F7 9D D1 1F F3 7C 94 33 93 33 92 33 F4 38 F5 28 F6 18 F3 61 F8 3C F8 42 F3 4C F6 70 F4 6C F5 85 8F 0C F4 32 F4 55 8F 09 00 09 65 40 63 5C 43 15 8F 07 00 09 93 18 35 3C A0 03 24 50 D2 12 63 20 24 30 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFC943
SPAN_END = 0x430A4
SENT = 0x430A4     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x4305e: {"kind": 'fpu', "py": 'fr[7] = 1.0', "slot_py": None, "target": None, "cond": None},
    0x43060: {"kind": 'reg', "py": 'r[1] = 0x0007A190', "slot_py": None, "target": None, "cond": None},
    0x43062: {"kind": 'fpu', "py": 'fr[3] = fr[7]', "slot_py": None, "target": None, "cond": None},
    0x43064: {"kind": 'reg', "py": 'r[4] = 0xFFFFC943', "slot_py": None, "target": None, "cond": None},
    0x43066: {"kind": 'reg', "py": 'r[3] = 0xFFFFB594', "slot_py": None, "target": None, "cond": None},
    0x43068: {"kind": 'reg', "py": 'r[2] = 0xFFFFBB04', "slot_py": None, "target": None, "cond": None},
    0x4306a: {"kind": 'fpu', "py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFB594, 4))', "slot_py": None, "target": None, "cond": None},
    0x4306c: {"kind": 'fpu', "py": 'fr[5] = bits2f(_rdw(ram, 0xFFFFBB04, 4))', "slot_py": None, "target": None, "cond": None},
    0x4306e: {"kind": 'fpu', "py": 'fr[6] = bits2f(_rdw(ram, 0x0007A190, 4))', "slot_py": None, "target": None, "cond": None},
    0x43070: {"kind": 'fpu', "py": 'fr[3] = ts(fr[3] - fr[6])', "slot_py": None, "target": None, "cond": None},
    0x43072: {"kind": 'fpu', "py": 'fr[8] = fr[3]', "slot_py": None, "target": None, "cond": None},
    0x43074: {"kind": 'fpu', "py": 'fr[8] = ts(fr[8] * fr[4])', "slot_py": None, "target": None, "cond": None},
    0x43076: {"kind": 'fpu', "py": 'fr[3] = fr[4]', "slot_py": None, "target": None, "cond": None},
    0x43078: {"kind": 'fpu', "py": 'fr[6] = ts(fr[6] + fr[7])', "slot_py": None, "target": None, "cond": None},
    0x4307a: {"kind": 'fpu', "py": 'fr[4] = fr[6]', "slot_py": None, "target": None, "cond": None},
    0x4307c: {"kind": 'fpu', "py": 'T = 1 if fr[5] > fr[8] else 0', "slot_py": None, "target": None, "cond": None},
    0x4307e: {"kind": "branch", "py": None, "slot_py": 'fr[4] = ts(fr[4] * fr[3])', "target": 0x4309a, "cond": 'notT'},
    0x43082: {"kind": 'fpu', "py": 'T = 1 if fr[4] > fr[5] else 0', "slot_py": None, "target": None, "cond": None},
    0x43084: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4309a, "cond": 'notT'},
    0x43088: {"kind": 'mem', "py": 'r[5] = s8(_rdw(ram, 0xFFFFC943, 1))', "slot_py": None, "target": None, "cond": None},
    0x4308a: {"kind": 'reg', "py": 'r[3] = r[5] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x4308c: {"kind": 'reg', "py": 'T = 1 if s32(r[3]) > 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x4308e: {"kind": "branch", "py": None, "slot_py": '', "target": 0x430a0, "cond": 'notT'},
    0x43092: {"kind": 'reg', "py": 'r[3] = 0x000000FF', "slot_py": None, "target": None, "cond": None},
    0x43094: {"kind": 'reg', "py": 'r[5] = (r[5] + r[3]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x43096: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFC943, 1, r[5])', "target": 0x430a0, "cond": 'always'},
    0x4309a: {"kind": 'reg', "py": 'r[2] = 0x0007A182', "slot_py": None, "target": None, "cond": None},
    0x4309c: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0x0007A182, 1))', "slot_py": None, "target": None, "cond": None},
    0x4309e: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC943, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x430a0: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
