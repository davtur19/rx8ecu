#!/usr/bin/env python3
"""Differential test for read_fuel_pressure_feedback_status (0x1408C) — v3 lift + v4 FPU, 24 bytes.
...
Run from repo root: python3 c/tests/test_read_fuel_pressure_feedback_status_1408c.py
"""
...
ENTRY = 0x1408C
RAW = bytes.fromhex("93 5D F3 8D F2 38 F2 35 8F 04 00 09 D2 31 61 21 D0 31 20 11 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFA770
SPAN_END = 0x140A4
SENT = 0x140A4     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x1408c: {"kind": 'reg', "py": 'r[3] = 0xFFFFA760', "slot_py": None, "target": None, "cond": None},
    0x1408e: {"kind": 'fpu', "py": 'fr[3] = 0.0', "slot_py": None, "target": None, "cond": None},
    0x14090: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0xFFFFA760, 4))', "slot_py": None, "target": None, "cond": None},
    0x14092: {"kind": 'fpu', "py": 'T = 1 if fr[2] > fr[3] else 0', "slot_py": None, "target": None, "cond": None},
    0x14094: {"kind": "branch", "py": None, "slot_py": '', "target": 0x140a0, "cond": 'notT'},
    0x14098: {"kind": 'reg', "py": 'r[2] = 0x00072D48', "slot_py": None, "target": None, "cond": None},
    0x1409a: {"kind": 'mem', "py": 'r[1] = s16(_rdw(ram, 0x00072D48, 2))', "slot_py": None, "target": None, "cond": None},
    0x1409c: {"kind": 'reg', "py": 'r[0] = 0xFFFFA770', "slot_py": None, "target": None, "cond": None},
    0x1409e: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA770, 2, r[1])', "slot_py": None, "target": None, "cond": None},
    0x140a0: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
