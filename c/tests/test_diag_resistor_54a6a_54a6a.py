#!/usr/bin/env python3
"""Differential test for diag_resistor_54a6a (0x54A6A) — v3 lift (branches + delay slots), 52 bytes.
...
Run from repo root: python3 c/tests/test_diag_resistor_54a6a_54a6a.py
"""
...
CODE = {
    0x54a6a: {"kind": 'reg', "py": 'r[5] = 0xFFFFD1E8', "slot_py": None, "target": None, "cond": None},
    0x54a6c: {"kind": 'reg', "py": 'r[3] = 0xFFFFA42C', "slot_py": None, "target": None, "cond": None},
    0x54a6e: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFA42C, 1))', "slot_py": None, "target": None, "cond": None},
    0x54a70: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x54a72: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x54a74: {"kind": "branch", "py": None, "slot_py": '', "target": 0x54a82, "cond": 'T'},
    0x54a78: {"kind": 'reg', "py": 'r[2] = 0xFFFFD1EA', "slot_py": None, "target": None, "cond": None},
    0x54a7a: {"kind": 'mem', "py": 'r[1] = s8(_rdw(ram, 0xFFFFD1EA, 1))', "slot_py": None, "target": None, "cond": None},
    0x54a7c: {"kind": 'reg', "py": 'T = 1 if (r[1] & r[1]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x54a7e: {"kind": "branch", "py": None, "slot_py": '', "target": 0x54a8a, "cond": 'notT'},
    0x54a82: {"kind": 'reg', "py": 'r[0] = 0x0007DA50', "slot_py": None, "target": None, "cond": None},
    0x54a84: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0x0007DA50, 1))', "slot_py": None, "target": None, "cond": None},
    0x54a86: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFD1E8, 1, r[3])', "target": 0x54a9a, "cond": 'always'},
    0x54a8a: {"kind": 'mem', "py": 'r[4] = s8(_rdw(ram, 0xFFFFD1E8, 1))', "slot_py": None, "target": None, "cond": None},
    0x54a8c: {"kind": 'reg', "py": 'r[3] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x54a8e: {"kind": 'reg', "py": 'T = 1 if s32(r[3]) > 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x54a90: {"kind": "branch", "py": None, "slot_py": '', "target": 0x54a9a, "cond": 'notT'},
    0x54a94: {"kind": 'reg', "py": 'r[3] = 0x000000FF', "slot_py": None, "target": None, "cond": None},
    0x54a96: {"kind": 'reg', "py": 'r[4] = (r[4] + r[3]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x54a98: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD1E8, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x54a9a: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
