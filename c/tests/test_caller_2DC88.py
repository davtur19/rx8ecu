#!/usr/bin/env python3
"""Differential test for caller_2DC88 (entry 0x2DC88) — v8 ST caller (CFG), 84 bytes.
...
Run: python3 test_caller_2DC88.py
"""
...
CODE = {
    0x2dc88: {"kind": 'mem', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, r[14])\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x2dc8a: {"kind": 'mem', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, r[13])\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x2dc8c: {"kind": 'st', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x2dc8e: {"kind": 'reg', "py": 'r[3] = 0xFFFFBD1D', "slot_py": None, "target": None, "cond": None},
    0x2dc90: {"kind": 'reg', "py": 'r[5] = 0xFFFFBD5E', "slot_py": None, "target": None, "cond": None},
    0x2dc92: {"kind": 'mem', "py": 'r[13] = s8(_rdw(ram, 0xFFFFBD1D, 1))', "slot_py": None, "target": None, "cond": None},
    0x2dc94: {"kind": 'reg', "py": 'r[14] = 0xFFFFBD58', "slot_py": None, "target": None, "cond": None},
    0x2dc96: {"kind": 'reg', "py": 'r[0] = r[13] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x2dc98: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x2dc9a: {"kind": "branch", "py": None, "slot_py": 'r[4] = s8(0x00)', "target": 0x2dccc, "cond": 'notT'},
    0x2dc9e: {"kind": 'reg', "py": 'r[2] = 0xFFFFBD5F', "slot_py": None, "target": None, "cond": None},
    0x2dca0: {"kind": 'mem', "py": 'r[1] = s8(_rdw(ram, 0xFFFFBD5F, 1))', "slot_py": None, "target": None, "cond": None},
    0x2dca2: {"kind": 'reg', "py": 'T = 1 if (r[1] & r[1]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x2dca4: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2dcb6, "cond": 'T'},
    0x2dca8: {"kind": 'reg', "py": 'r[0] = 0xFFFFBD58', "slot_py": None, "target": None, "cond": None},
    0x2dcaa: {"kind": 'mem', "py": 'r[1] = s16(_rdw(ram, 0xFFFFBD58, 2))', "slot_py": None, "target": None, "cond": None},
    0x2dcac: {"kind": 'reg', "py": 'r[2] = 0x000762AC', "slot_py": None, "target": None, "cond": None},
    0x2dcae: {"kind": 'mem', "py": 'r[3] = s16(_rdw(ram, r[2], 2))', "slot_py": None, "target": None, "cond": None},
    0x2dcb0: {"kind": 'reg', "py": 'T = 1 if (r[1] & 0xFFFFFFFF) >= (r[3] & 0xFFFFFFFF) else 0', "slot_py": None, "target": None, "cond": None},
    0x2dcb2: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2dcbe, "cond": 'notT'},
    0x2dcb6: {"kind": 'reg', "py": 'r[2] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x2dcb8: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBD5E, 1, r[2])', "slot_py": None, "target": None, "cond": None},
    0x2dcba: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFBD58, 2, r[4])', "target": 0x2dcc0, "cond": 'always'},
    0x2dcc0: {"kind": 'reg', "py": 'r[2] = 0x00002460', "slot_py": None, "target": None, "cond": None},
    0x2dcc2: {"kind": 'reg', "py": 'r[5] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x2dcc4: {"kind": "call", "py": None, "slot_py": 'r[4] = s16(_rdw(ram, 0xFFFFBD58, 2))', "target": 0x2460, "ret_pc": 0x2dcc8, "set_pr": True, "cond": None},
    0x2dcc8: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFBD58, 2, r[0])', "target": 0x2dcd0, "cond": 'always'},
    0x2dcd0: {"kind": 'reg', "py": 'r[2] = 0xFFFFBD5F', "slot_py": None, "target": None, "cond": None},
    0x2dcd2: {"kind": 'mem', "py": '_wrw(ram, r[2], 1, r[13])', "slot_py": None, "target": None, "cond": None},
    0x2dcd4: {"kind": 'st', "py": 'pr = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x2dcd6: {"kind": 'mem', "py": 'r[13] = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x2dcd8: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None, },
    0x2dcbe: {"kind": 'mem', "py": '_wrw(ram, r[5], 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x2dccc: {"kind": 'mem', "py": '_wrw(ram, r[5], 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x2dcce: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBD58, 2, r[4])', "slot_py": None, "target": None, "cond": None},
