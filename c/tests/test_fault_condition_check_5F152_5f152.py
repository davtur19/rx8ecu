#!/usr/bin/env python3
"""Differential test for fault_condition_check_5F152 (0x5F152) — v3 lift (branches + delay slots), 16 bytes.
...
Run from repo root: python3 c/tests/test_fault_condition_check_5F152_5f152.py
"""
...
ENTRY = 0x5F152
RAW = bytes.fromhex("60 E3 7F 04 4F 26 6A F6 6B F6 6D F6 00 0B 6E F6")
SEED = 0
N = 2000
MAXSTEPS = 100000
STACK_BASE = 0xFFFFD000
STACK_TOP = STACK_BASE + 0x400
STACK_OFFS = (0x404, 0x408, 0x40C, 0x410, 0x414)
SEED_OFFS = (0x404,)   # lds.l pr/macl/mach slots seeded with the return sentinel
RAM_MIN = None
RAM_MAX = None
SPAN_END = 0x5F162
SENT = 0x5F162     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x5f152: {"kind": 'reg', "py": 'r[0] = r[14]', "slot_py": None, "target": None, "cond": None},
    0x5f154: {"kind": 'reg', "py": 'r[15] = (r[15] + s8(0x04)) & 0xFFFFFFFF\nsp = (sp + s8(0x04)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x5f156: {"kind": 'mem', "py": 'pr = _rdw(ram, STACK_BASE + 0x404, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x5f158: {"kind": 'mem', "py": 'r[10] = _rdw(ram, STACK_BASE + 0x408, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x5f15a: {"kind": 'mem', "py": 'r[11] = _rdw(ram, STACK_BASE + 0x40C, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x5f15c: {"kind": 'mem', "py": 'r[13] = _rdw(ram, STACK_BASE + 0x410, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x5f15e: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, STACK_BASE + 0x414, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},}
