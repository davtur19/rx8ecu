#!/usr/bin/env python3
"""Differential test for caller_53A9E (entry 0x53A9E) — v8 ST caller (CFG), 22 bytes.
...
Run: python3 test_caller_53A9E.py
"""
...
CODE = {
    0x53a9e: {"kind": 'st', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x53aa0: {"kind": 'reg', "py": 'r[3] = 0xFFFFCF64', "slot_py": None, "target": None, "cond": None},
    0x53aa2: {"kind": 'fpu', "py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFCF64, 4))', "slot_py": None, "target": None, "cond": None},
    0x53aa4: {"kind": 'reg', "py": 'r[0] = 0x00053B1C', "slot_py": None, "target": None, "cond": None},
    0x53aa6: {"kind": 'fpu', "py": 'fr[6] = bits2f(_rdw(ram, 0x00053B1C, 4))', "slot_py": None, "target": None, "cond": None},
    0x53aa8: {"kind": 'reg', "py": 'r[2] = 0x000024D0', "slot_py": None, "target": None, "cond": None},
    0x53aaa: {"kind": "call", "py": None, "slot_py": 'fr[5] = 1.0', "target": 0x24d0, "ret_pc": 0x53aae, "set_pr": True, "cond": None},
    0x53aae: {"kind": 'st', "py": 'pr = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x53ab0: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},
