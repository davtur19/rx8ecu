#!/usr/bin/env python3
"""Differential test for mem_flag_e2e0 (0xE2E0) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_mem_flag_e2e0_e2e0.py
"""
...
ENTRY = 0xE2E0
RAW = bytes.fromhex("91 08 E2 01 00 0B 21 20")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    0xe2e0: {"kind": 'reg', "py": 'r[1] = 0xFFFFA407', "slot_py": None, "target": None, "cond": None},
    0xe2e2: {"kind": 'reg', "py": 'r[2] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0xe2e4: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFA407, 1, r[2])', "target": None, "cond": None},}
