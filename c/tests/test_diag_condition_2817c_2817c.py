#!/usr/bin/env python3
"""Differential test for diag_condition_2817c (0x2817C) — v3 lift + v4 FPU, 54 bytes.
...
Run from repo root: python3 c/tests/test_diag_condition_2817c_2817c.py
"""
...
ENTRY = 0x2817C
RAW = bytes.fromhex("D4 15 D3 13 92 19 F3 38 F2 28 F3 25 8D 0F 00 09 91 14 60 10 20 08 8F 0A 00 09 D0 0C D1 0F 62 00 63 10 32 32 8F 03 00 09 E2 01 A0 02 24 20 E1 00 24 10 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBA84
SPAN_END = 0x281B2
SENT = 0x281B2     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x2817c: {"kind": 'reg', "py": 'r[4] = 0xFFFFBA78', "slot_py": None, "target": None, "cond": None},
    0x2817e: {"kind": 'reg', "py": 'r[3] = 0x00075A04', "slot_py": None, "target": None, "cond": None},
    0x28180: {"kind": 'reg', "py": 'r[2] = 0xFFFFAAE8', "slot_py": None, "target": None, "cond": None},
    0x28182: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x00075A04, 4))', "slot_py": None, "target": None, "cond": None},
    0x28184: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0xFFFFAAE8, 4))', "slot_py": None, "target": None, "cond": None},
    0x28186: {"kind": 'fpu', "py": 'T = 1 if fr[3] > fr[2] else 0', "slot_py": None, "target": None, "cond": None},
    0x28188: {"kind": "branch", "py": None, "slot_py": '', "target": 0x281aa, "cond": 'T'},
    0x2818c: {"kind": 'reg', "py": 'r[1] = 0xFFFFB13A', "slot_py": None, "target": None, "cond": None},
    0x2818e: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFB13A, 1))', "slot_py": None, "target": None, "cond": None},
    0x28190: {"kind": 'reg', "py": 'T = 1 if (r[0] & r[0]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x28192: {"kind": "branch", "py": None, "slot_py": '', "target": 0x281aa, "cond": 'notT'},
    0x28196: {"kind": 'reg', "py": 'r[0] = 0xFFFFBA84', "slot_py": None, "target": None, "cond": None},
    0x28198: {"kind": 'reg', "py": 'r[1] = 0x000759E0', "slot_py": None, "target": None, "cond": None},
    0x2819a: {"kind": 'mem', "py": 'r[2] = s8(_rdw(ram, 0xFFFFBA84, 1))', "slot_py": None, "target": None, "cond": None},
    0x2819c: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0x000759E0, 1))', "slot_py": None, "target": None, "cond": None},
    0x2819e: {"kind": 'reg', "py": 'T = 1 if r[2] >= r[3] else 0', "slot_py": None, "target": None, "cond": None},
    0x281a0: {"kind": "branch", "py": None, "slot_py": '', "target": 0x281aa, "cond": 'notT'},
    0x281a4: {"kind": 'reg', "py": 'r[2] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x281a6: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFBA78, 1, r[2])', "target": 0x281ae, "cond": 'always'},
    0x281aa: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x281ac: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBA78, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x281ae: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
