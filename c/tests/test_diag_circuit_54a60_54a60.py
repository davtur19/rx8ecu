#!/usr/bin/env python3
"""Differential test for diag_circuit_54a60 (0x54A60) — v3 lift (branches + delay slots), 10 bytes.
...
Run from repo root: python3 c/tests/test_diag_circuit_54a60_54a60.py
"""
...
CODE = {
    0x54a60: {"kind": 'reg', "py": 'r[2] = 0x0007DA50', "slot_py": None, "target": None, "cond": None},
    0x54a62: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0x0007DA50, 1))', "slot_py": None, "target": None, "cond": None},
    0x54a64: {"kind": 'reg', "py": 'r[1] = 0xFFFFD1E8', "slot_py": None, "target": None, "cond": None},
    0x54a66: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFD1E8, 1, r[3])', "target": None, "cond": None},}
