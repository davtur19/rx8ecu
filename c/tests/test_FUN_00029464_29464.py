#!/usr/bin/env python3
"""Differential test for FUN_00029464 (0x29464) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_FUN_00029464_29464.py
"""
...
ENTRY = 0x29464
RAW = bytes.fromhex("90 68 E1 00 00 0B 20 11")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBAD4
SPAN_END = 0x2946C
SENT = 0x2946C     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x29464: {"kind": 'reg', "py": 'r[0] = 0xFFFFBAD4', "slot_py": None, "target": None, "cond": None},
    0x29466: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x29468: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBAD4, 2, r[1])', "target": None, "cond": None},}
