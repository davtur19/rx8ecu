#!/usr/bin/env python3
"""Differential test for call-composition caller_4790A (entry 0x4790A) — v7 ST caller + callee lib, flattened CODE with nested returns.
...
Run: python3 /home/davide/ailocal/rx8ecu/c/tests/test_caller_4790A.py
"""
...
CODE = {
    0x4790a: {"kind": 'reg', "py": 'r[4] = 0xFFFF877C', "slot_py": None, "target": None, "cond": None},
    0x4790c: {"kind": 'reg', "py": 'r[3] = 0x0003EE68', "slot_py": None, "target": None, "cond": None},
    0x4790e: {"kind": "call", "py": None, "slot_py": 'r[5] = s8(0x00)', "target": 0x3ee68, "ret_pc": 0x47912, "set_pr": False, "cond": None},
