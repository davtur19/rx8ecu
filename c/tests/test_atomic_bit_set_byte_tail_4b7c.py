#!/usr/bin/env python3
"""Differential test for atomic_bit_set_byte_tail (0x4B7C) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_atomic_bit_set_byte_tail_4b7c.py
"""
...
ENTRY = 0x4B7C
RAW = bytes.fromhex("23 5B 24 30 00 0B 42 0E")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = None
SPAN_END = 0x4B84
SENT = 0x4B84     # stop-sentinel, placed past the literal pool
