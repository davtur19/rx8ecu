#!/usr/bin/env python3
"""Differential test for caller_2CCA4 (entry 0x2CCA4) — v8 ST caller (CFG), 24 bytes.
...
Run: python3 test_caller_2CCA4.py
"""
...
CODE = {
    0x2cca4: {"kind": 'st', "py": 'local[0x3FC] = pr\n_wrw(ram, STACK_BASE + 0x3FC, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x2cca6: {"kind": 'fpu', "py": 'fr[5] = 0.0', "slot_py": None, "target": None, "cond": None},
    0x2cca8: {"kind": 'reg', "py": 'r[0] = 0x0002CD7C', "slot_py": None, "target": None, "cond": None},
    0x2ccaa: {"kind": 'reg', "py": 'r[4] = 0xFFFF9F1A', "slot_py": None, "target": None, "cond": None},
    0x2ccac: {"kind": 'reg', "py": 'r[3] = 0x000024C0', "slot_py": None, "target": None, "cond": None},
    0x2ccae: {"kind": 'mem', "py": 'r[4] = s16(_rdw(ram, 0xFFFF9F1A, 2))', "slot_py": None, "target": None, "cond": None},
    0x2ccb0: {"kind": "call", "py": None, "slot_py": 'fr[4] = bits2f(_rdw(ram, 0x0002CD7C, 4))', "target": 0x24c0, "ret_pc": 0x2ccb4, "set_pr": True, "cond": None},
    0x2ccb4: {"kind": 'reg', "py": 'r[2] = 0xFFFFBC9C', "slot_py": None, "target": None, "cond": None},
    0x2ccb6: {"kind": 'st', "py": 'pr = _rdw(ram, STACK_BASE + 0x3FC, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x2ccb8: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBC9C, 4, f2bits(fr[0]))', "target": None, "cond": None},
