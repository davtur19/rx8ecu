#!/usr/bin/env python3
"""Differential test for fuel_correction_reset_45B44 (0x45B44) — v3 lift (branches + delay slots), 40 bytes.
...
Run from repo root: python3 c/tests/test_fuel_correction_reset_45B44_45b44.py
"""
...
CODE = {
    0x45b44: {"kind": 'reg', "py": 'r[1] = 0xFFFFD201', "slot_py": None, "target": None, "cond": None},
    0x45b46: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFD201, 1))', "slot_py": None, "target": None, "cond": None},
    0x45b48: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x45b4a: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x45b4c: {"kind": "branch", "py": None, "slot_py": '', "target": 0x45b68, "cond": 'notT'},
    0x45b50: {"kind": 'reg', "py": 'r[3] = 0xFFFFA41C', "slot_py": None, "target": None, "cond": None},
    0x45b52: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFA41C, 1))', "slot_py": None, "target": None, "cond": None},
    0x45b54: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x45b56: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x45b58: {"kind": "branch", "py": None, "slot_py": '', "target": 0x45b68, "cond": 'notT'},
    0x45b5c: {"kind": 'reg', "py": 'r[3] = 0x000003E8', "slot_py": None, "target": None, "cond": None},
    0x45b5e: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x45b60: {"kind": 'reg', "py": 'r[0] = 0xFFFFCBF3', "slot_py": None, "target": None, "cond": None},
    0x45b62: {"kind": 'reg', "py": 'r[2] = 0xFFFFCBF0', "slot_py": None, "target": None, "cond": None},
    0x45b64: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCBF0, 2, r[3])', "slot_py": None, "target": None, "cond": None},
    0x45b66: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCBF3, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x45b68: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
