#!/usr/bin/env python3
"""Differential test for can430_copy_bytes_c017_to_c014 (0x33098) — v3 lift (branches + delay slots), 26 bytes.
...
Run from repo root: python3 c/tests/test_can430_copy_bytes_c017_to_c014_33098.py
"""
...
ENTRY = 0x33098
RAW = bytes.fromhex("D1 1A 63 10 92 23 22 30 D3 19 60 30 92 20 22 00 D0 18 61 00 93 1D 00 0B 23 10")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFC019
SPAN_END = 0x330B2
SENT = 0x330B2     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x33098: {"kind": 'reg', "py": 'r[1] = 0xFFFFC017', "slot_py": None, "target": None, "cond": None},
    0x3309a: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFC017, 1))', "slot_py": None, "target": None, "cond": None},
    0x3309c: {"kind": 'reg', "py": 'r[2] = 0xFFFFC014', "slot_py": None, "target": None, "cond": None},
    0x3309e: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC014, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x330a0: {"kind": 'reg', "py": 'r[3] = 0xFFFFC018', "slot_py": None, "target": None, "cond": None},
    0x330a2: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFC018, 1))', "slot_py": None, "target": None, "cond": None},
    0x330a4: {"kind": 'reg', "py": 'r[2] = 0xFFFFC015', "slot_py": None, "target": None, "cond": None},
    0x330a6: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC015, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x330a8: {"kind": 'reg', "py": 'r[0] = 0xFFFFC019', "slot_py": None, "target": None, "cond": None},
    0x330aa: {"kind": 'mem', "py": 'r[1] = s8(_rdw(ram, 0xFFFFC019, 1))', "slot_py": None, "target": None, "cond": None},
    0x330ac: {"kind": 'reg', "py": 'r[3] = 0xFFFFC016', "slot_py": None, "target": None, "cond": None},
    0x330ae: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFC016, 1, r[1])', "target": None, "cond": None},}
