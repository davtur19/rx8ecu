#!/usr/bin/env python3
"""Differential test for calc_barometric_pressure_trim (0x13F68) — v3 lift + v4 FPU, 100 bytes.
...
Run from repo root: python3 c/tests/test_calc_barometric_pressure_trim_13f68.py
"""
...
ENTRY = 0x13F68
RAW = bytes.fromhex("D4 32 93 5B 92 5B 65 30 60 20 60 0C 88 01 8D 06 65 5C 91 55 60 10 60 0C 88 01 8F 0B 00 09 60 53 88 01 8F 03 00 09 D3 2A A0 02 F3 38 D2 29 F3 28 A0 0A F4 3A 60 53 88 01 8F 03 00 09 D3 26 A0 02 F3 38 D2 26 F3 28 F4 3A D5 25 F3 48 93 39 F2 38 F3 25 8D 03 00 09 E1 01 A0 02 25 10 E0 00 25 00 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBDD4
SPAN_END = 0x13FCC
SENT = 0x13FCC     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x13f68: {"kind": 'reg', "py": 'r[4] = 0xFFFFA76C', "slot_py": None, "target": None, "cond": None},
    0x13f6a: {"kind": 'reg', "py": 'r[3] = 0xFFFFB5AA', "slot_py": None, "target": None, "cond": None},
    0x13f6c: {"kind": 'reg', "py": 'r[2] = 0xFFFFBDD4', "slot_py": None, "target": None, "cond": None},
    0x13f6e: {"kind": 'mem', "py": 'r[5] = s8(_rdw(ram, 0xFFFFB5AA, 1))', "slot_py": None, "target": None, "cond": None},
    0x13f70: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFBDD4, 1))', "slot_py": None, "target": None, "cond": None},
    0x13f72: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x13f74: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x13f76: {"kind": "branch", "py": None, "slot_py": 'r[5] = r[5] & 0xFF', "target": 0x13f86, "cond": 'T'},
    0x13f7a: {"kind": 'reg', "py": 'r[1] = 0xFFFFB623', "slot_py": None, "target": None, "cond": None},
    0x13f7c: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFB623, 1))', "slot_py": None, "target": None, "cond": None},
    0x13f7e: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x13f80: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x13f82: {"kind": "branch", "py": None, "slot_py": '', "target": 0x13f9c, "cond": 'notT'},
    0x13f86: {"kind": 'reg', "py": 'r[0] = r[5]', "slot_py": None, "target": None, "cond": None},
    0x13f88: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x13f8a: {"kind": "branch", "py": None, "slot_py": '', "target": 0x13f94, "cond": 'notT'},
    0x13f8e: {"kind": 'reg', "py": 'r[3] = 0x00072D4C', "slot_py": None, "target": None, "cond": None},
    0x13f90: {"kind": "branch", "py": None, "slot_py": 'fr[3] = bits2f(_rdw(ram, 0x00072D4C, 4))', "target": 0x13f98, "cond": 'always'},
    0x13f94: {"kind": 'reg', "py": 'r[2] = 0x00072D50', "slot_py": None, "target": None, "cond": None},
    0x13f96: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x00072D50, 4))', "slot_py": None, "target": None, "cond": None},
    0x13f98: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, r[4], 4, f2bits(fr[3]))', "target": 0x13fb0, "cond": 'always'},
    0x13f9c: {"kind": 'reg', "py": 'r[0] = r[5]', "slot_py": None, "target": None, "cond": None},
    0x13f9e: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x13fa0: {"kind": "branch", "py": None, "slot_py": '', "target": 0x13faa, "cond": 'notT'},
    0x13fa4: {"kind": 'reg', "py": 'r[3] = 0x00072D54', "slot_py": None, "target": None, "cond": None},
    0x13fa6: {"kind": "branch", "py": None, "slot_py": 'fr[3] = bits2f(_rdw(ram, 0x00072D54, 4))', "target": 0x13fae, "cond": 'always'},
    0x13faa: {"kind": 'reg', "py": 'r[2] = 0x00072D58', "slot_py": None, "target": None, "cond": None},
    0x13fac: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x00072D58, 4))', "slot_py": None, "target": None, "cond": None},
    0x13fae: {"kind": 'fpu', "py": '_wrw(ram, r[4], 4, f2bits(fr[3]))', "slot_py": None, "target": None, "cond": None},
    0x13fb0: {"kind": 'reg', "py": 'r[5] = 0xFFFFA774', "slot_py": None, "target": None, "cond": None},
    0x13fb2: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, r[4], 4))', "slot_py": None, "target": None, "cond": None},
    0x13fb4: {"kind": 'reg', "py": 'r[3] = 0xFFFFA678', "slot_py": None, "target": None, "cond": None},
    0x13fb6: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0xFFFFA678, 4))', "slot_py": None, "target": None, "cond": None},
    0x13fb8: {"kind": 'fpu', "py": 'T = 1 if fr[3] > fr[2] else 0', "slot_py": None, "target": None, "cond": None},
    0x13fba: {"kind": "branch", "py": None, "slot_py": '', "target": 0x13fc4, "cond": 'T'},
    0x13fbe: {"kind": 'reg', "py": 'r[1] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x13fc0: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFA774, 1, r[1])', "target": 0x13fc8, "cond": 'always'},
    0x13fc4: {"kind": 'reg', "py": 'r[0] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x13fc6: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA774, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x13fc8: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
