#!/usr/bin/env python3
"""Differential test for trans_gear_init_byte_copy_bc32 (0x2C0DC) — v3 lift (branches + delay slots), 10 bytes.
...
Run from repo root: python3 c/tests/test_trans_gear_init_byte_copy_bc32_2c0dc.py
"""
...
ENTRY = 0x2C0DC
RAW = bytes.fromhex("D0 12 63 00 92 17 00 0B 22 30")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBC32
SPAN_END = 0x2C0E6
SENT = 0x2C0E6     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x2c0dc: {"kind": 'reg', "py": 'r[0] = 0x0006D482', "slot_py": None, "target": None, "cond": None},
    0x2c0de: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0x0006D482, 1))', "slot_py": None, "target": None, "cond": None},
    0x2c0e0: {"kind": 'reg', "py": 'r[2] = 0xFFFFBC32', "slot_py": None, "target": None, "cond": None},
    0x2c0e2: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBC32, 1, r[3])', "target": None, "cond": None},}
