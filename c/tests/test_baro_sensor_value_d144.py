#!/usr/bin/env python3
"""Differential test for baro_sensor_value (0xD144) — v3 lift (branches + delay slots), 32 bytes.
...
Run from repo root: python3 c/tests/test_baro_sensor_value_d144.py
"""
...
ENTRY = 0xD144
RAW = bytes.fromhex("64 4C 24 48 8F 03 66 5D 94 19 A0 01 00 09 94 17 D2 0F 63 6C 43 18 22 69 42 19 23 2B 00 0B 24 31")
SEED = 0
N = 500
MAXSTEPS = 100000
