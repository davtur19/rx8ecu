#!/usr/bin/env python3
"""Differential test for serial_frame_sync_490F8 (0x490F8) — v3 lift (branches + delay slots), 70 bytes.
...
Run from repo root: python3 c/tests/test_serial_frame_sync_490F8_490f8.py
"""
...
ENTRY = 0x490F8
RAW = bytes.fromhex("88 01 8D 12 00 09 93 1B 60 30 60 0C 88 01 8D 0C 00 09 92 16 60 20 60 0C 88 01 8D 06 00 09 93 11 60 30 60 0C 88 01 8F 03 00 09 E3 01 A0 02 24 30 E1 00 24 10 00 0B 00 09 CC 3C C8 1D C8 12 C8 14 C8 6D C8 6F C8 71")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
CODE = {
    ...
    0x49136: {"kind": 'reg', "py": 'T = 1 if (r[0] & 0x14) == 0 else 0', "slot_py": None, "target": None, "cond": None},}
