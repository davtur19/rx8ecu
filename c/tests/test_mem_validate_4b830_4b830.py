#!/usr/bin/env python3
"""Differential test for mem_validate_4b830 (0x4B830) — v3 lift (branches + delay slots), 10 bytes.
...
Run from repo root: python3 c/tests/test_mem_validate_4b830_4b830.py
"""
...
CODE = {
    0x4b830: {"kind": 'reg', "py": 'r[2] = 0xFFFFCE19', "slot_py": None, "target": None, "cond": None},
    0x4b832: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFCE19, 1))', "slot_py": None, "target": None, "cond": None},
    0x4b834: {"kind": 'reg', "py": 'r[1] = 0xFFFFCE1D', "slot_py": None, "target": None, "cond": None},
    0x4b836: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFCE1D, 1, r[3])', "target": None, "cond": None},}
