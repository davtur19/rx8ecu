#!/usr/bin/env python3
"""Differential test for copy_calbyte_ba96_ba97 (0x289C8) — v3 lift (branches + delay slots), 24 bytes.
...
Run from repo root: python3 c/tests/test_copy_calbyte_ba96_ba97_289c8.py
"""
...
ENTRY = 0x289C8
RAW = bytes.fromhex("92 6B E3 00 D0 39 22 30 61 00 93 67 23 10 D1 38 93 65 62 10 00 0B 23 20")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBA98
SPAN_END = 0x289E0
SENT = 0x289E0     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x289c8: {"kind": 'reg', "py": 'r[2] = 0xFFFFBA98', "slot_py": None, "target": None, "cond": None},
    0x289ca: {"kind": 'reg', "py": 'r[3] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x289cc: {"kind": 'reg', "py": 'r[0] = 0x0007537C', "slot_py": None, "target": None, "cond": None},
    0x289ce: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBA98, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x289d0: {"kind": 'mem', "py": 'r[1] = s8(_rdw(ram, 0x0007537C, 1))', "slot_py": None, "target": None, "cond": None},
    0x289d2: {"kind": 'reg', "py": 'r[3] = 0xFFFFBA96', "slot_py": None, "target": None, "cond": None},
    0x289d4: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBA96, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x289d6: {"kind": 'reg', "py": 'r[1] = 0x0007537E', "slot_py": None, "target": None, "cond": None},
    0x289d8: {"kind": 'reg', "py": 'r[3] = 0xFFFFBA97', "slot_py": None, "target": None, "cond": None},
    0x289da: {"kind": 'mem', "py": 'r[2] = s8(_rdw(ram, 0x0007537E, 1))', "slot_py": None, "target": None, "cond": None},
    0x289dc: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBA97, 1, r[2])', "target": None, "cond": None},}
