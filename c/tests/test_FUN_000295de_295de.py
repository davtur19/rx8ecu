#!/usr/bin/env python3
"""Differential test for FUN_000295de (0x295DE) — v3 lift (branches + delay slots), 10 bytes.
...
Run from repo root: python3 c/tests/test_FUN_000295de_295de.py
"""
...
ENTRY = 0x295DE
RAW = bytes.fromhex("92 28 D1 19 63 20 00 0B 21 30")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBAE4
SPAN_END = 0x295E8
SENT = 0x295E8     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x295de: {"kind": 'reg', "py": 'r[2] = 0xFFFFBAE3', "slot_py": None, "target": None, "cond": None},
    0x295e0: {"kind": 'reg', "py": 'r[1] = 0xFFFFBAE4', "slot_py": None, "target": None, "cond": None},
    0x295e2: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFBAE3, 1))', "slot_py": None, "target": None, "cond": None},
    0x295e4: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBAE4, 1, r[3])', "target": None, "cond": None},}
