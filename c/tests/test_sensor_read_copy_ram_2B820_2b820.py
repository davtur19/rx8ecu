#!/usr/bin/env python3
"""Differential test for sensor_read_copy_ram_2B820 (0x2B820) — v3 lift (branches + delay slots), 10 bytes.
...
Run from repo root: python3 c/tests/test_sensor_read_copy_ram_2B820_2b820.py
"""
...
RAM_MAX = 0xFFFFBC05
SPAN_END = 0x2B82A
SENT = 0x2B82A     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x2b820: {"kind": 'reg', "py": 'r[2] = 0xFFFFA41C', "slot_py": None, "target": None, "cond": None},
    0x2b822: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFA41C, 1))', "slot_py": None, "target": None, "cond": None},
    0x2b824: {"kind": 'reg', "py": 'r[1] = 0xFFFFBC05', "slot_py": None, "target": None, "cond": None},
    0x2b826: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBC05, 1, r[3])', "target": None, "cond": None},}
