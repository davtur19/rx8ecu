#!/usr/bin/env python3
"""Differential test for FUN_00057fc4 (0x57FC4) — v3 lift (branches + delay slots), 70 bytes.
...
Run from repo root: python3 c/tests/test_FUN_00057fc4_57fc4.py
"""
...
ENTRY = 0x57FC4
RAW = bytes.fromhex("95 3A 92 32 63 20 23 38 8F 02 E4 00 A0 19 25 40 96 33 60 60 60 0C 88 01 8D 0C 00 09 93 2E 60 30 60 0C 88 01 8D 06 00 09 91 29 60 10 60 0C 88 01 8F 07 00 09 92 22 E3 01 25 30 26 40 22 40 93 1E 23 40 00 0B 00 09")
SEED = 43
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFD084
SPAN_END = 0x5800A
SENT = 0x5800A     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x57fc4: {"kind": 'reg', "py": 'r[5] = 0xFFFFD06F', "slot_py": None, "target": None, "cond": None},
    0x57fc6: {"kind": 'reg', "py": 'r[2] = 0xFFFFD070', "slot_py": None, "target": None, "cond": None},
    0x57fc8: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFD070, 1))', "slot_py": None, "target": None, "cond": None},
    0x57fca: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x57fcc: {"kind": "branch", "py": None, "slot_py": 'r[4] = s8(0x00)', "target": 0x57fd4, "cond": 'notT'},
    0x57fd0: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFD06F, 1, r[4])', "target": 0x58006, "cond": 'always'},
    0x57fd4: {"kind": 'reg', "py": 'r[6] = 0xFFFFD076', "slot_py": None, "target": None, "cond": None},
    0x57fd6: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFD076, 1))', "slot_py": None, "target": None, "cond": None},
    0x57fd8: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x57fda: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x57fdc: {"kind": "branch", "py": None, "slot_py": '', "target": 0x57ff8, "cond": 'T'},
    0x57fe0: {"kind": 'reg', "py": 'r[3] = 0xFFFFD07B', "slot_py": None, "target": None, "cond": None},
    0x57fe2: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFD07B, 1))', "slot_py": None, "target": None, "cond": None},
    0x57fe4: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x57fe6: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x57fe8: {"kind": "branch", "py": None, "slot_py": '', "target": 0x57ff8, "cond": 'T'},
    0x57fec: {"kind": 'reg', "py": 'r[1] = 0xFFFFD084', "slot_py": None, "target": None, "cond": None},
    0x57fee: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFD084, 1))', "slot_py": None, "target": None, "cond": None},
    0x57ff0: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x57ff2: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x57ff4: {"kind": "branch", "py": None, "slot_py": '', "target": 0x58006, "cond": 'notT'},
    0x57ff8: {"kind": 'reg', "py": 'r[2] = 0xFFFFD07B', "slot_py": None, "target": None, "cond": None},
    0x57ffa: {"kind": 'reg', "py": 'r[3] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x57ffc: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD06F, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x57ffe: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD076, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x58000: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD07B, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x58002: {"kind": 'reg', "py": 'r[3] = 0xFFFFD084', "slot_py": None, "target": None, "cond": None},
    0x58004: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD084, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x58006: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
