#!/usr/bin/env python3
"""Differential test for immo_fault_mem_commit_code_1 (0x36862) — v3 lift (branches + delay slots), 14 bytes.
...
Run from repo root: python3 c/tests/test_immo_fault_mem_commit_code_1_36862.py
"""
...
ENTRY = 0x36862
RAW = bytes.fromhex("34 EC 63 3C 34 3C 60 43 7F 08 00 0B 6E F6")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = None
SPAN_END = 0x36870
SENT = 0x36870     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x36862: {"kind": 'reg', "py": 'r[4] = (r[4] + r[14]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x36864: {"kind": 'reg', "py": 'r[3] = r[3] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x36866: {"kind": 'reg', "py": 'r[4] = (r[4] + r[3]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x36868: {"kind": 'reg', "py": 'r[0] = r[4]', "slot_py": None, "target": None, "cond": None},
    0x3686a: {"kind": 'reg', "py": 'r[15] = (r[15] + s8(0x08)) & 0xFFFFFFFF\nsp = (sp + s8(0x08)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x3686c: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, STACK_BASE + 0x408, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},}
