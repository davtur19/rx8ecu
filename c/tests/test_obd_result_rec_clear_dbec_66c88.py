#!/usr/bin/env python3
"""Differential test for obd_result_rec_clear_dbec (0x66C88) — v3 lift (branches + delay slots), 28 bytes.
...
Run from repo root: python3 c/tests/test_obd_result_rec_clear_dbec_66c88.py
"""
...
ENTRY = 0x66C88
RAW = bytes.fromhex("D4 22 E5 00 24 51 60 53 81 41 90 24 80 44 60 53 80 45 80 46 80 47 80 48 00 0B 80 49")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFDBEC
SPAN_END = 0x66CA4
SENT = 0x66CA4     # stop-sentinel, placed past the literal pool
