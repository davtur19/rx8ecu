#!/usr/bin/env python3
"""Differential test for mem_flag_e2d8 (0xE2D8) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_mem_flag_e2d8_e2d8.py
"""
...
CODE = {
    0xe2d8: {"kind": 'reg', "py": 'r[0] = 0xFFFFA406', "slot_py": None, "target": None, "cond": None},
    0xe2da: {"kind": 'reg', "py": 'r[3] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0xe2dc: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFA406, 1, r[3])', "target": None, "cond": None},}
