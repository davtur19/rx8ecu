#!/usr/bin/env python3
"""Differential test for fpu_conditional_zero_reset_35096 (0x35096) — v3 lift + v4 FPU, 22 bytes.
...
Run from repo root: python3 c/tests/test_fpu_conditional_zero_reset_35096_35096.py
"""
...
ENTRY = 0x35096
RAW = bytes.fromhex("D3 1E 60 30 60 0C 88 01 8F 03 00 09 F3 8D 92 08 F2 3A 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFC140
SPAN_END = 0x350AC
SENT = 0x350AC     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x35096: {"kind": 'reg', "py": 'r[3] = 0xFFFF9F8C', "slot_py": None, "target": None, "cond": None},
    0x35098: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFF9F8C, 1))', "slot_py": None, "target": None, "cond": None},
    0x3509a: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x3509c: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x3509e: {"kind": "branch", "py": None, "slot_py": '', "target": 0x350a8, "cond": 'notT'},
    0x350a2: {"kind": 'fpu', "py": 'fr[3] = 0.0', "slot_py": None, "target": None, "cond": None},
    0x350a4: {"kind": 'reg', "py": 'r[2] = 0xFFFFC140', "slot_py": None, "target": None, "cond": None},
    0x350a6: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFC140, 4, f2bits(fr[3]))', "slot_py": None, "target": None, "cond": None},
    0x350a8: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
