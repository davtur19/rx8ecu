#!/usr/bin/env python3
"""Differential test for cruiseControlOvershootPlausibilityMon (0x2DB00) — v3 lift + v4 FPU, 8 bytes.
...
Run from repo root: python3 c/tests/test_cruiseControlOvershootPlausibilityMon_2db00.py
"""
...
ENTRY = 0x2DB00
RAW = bytes.fromhex("93 69 F0 21 00 0B F3 0A")
SEED = 42
N = 500
MAXSTEPS = 100000
