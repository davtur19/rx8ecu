#!/usr/bin/env python3
"""Differential test for can630_status_byte_bff9_from_cbd6 (0x32E4C) — v3 lift (branches + delay slots), 76 bytes.
...
Run from repo root: python3 c/tests/test_can630_status_byte_bff9_from_cbd6_32e4c.py
"""
...
ENTRY = 0x32E4C
RAW = bytes.fromhex("95 2F D4 1C 60 53 60 00 C8 40 00 29 70 FF 60 0B 88 01 8D 09 E6 08 60 53 60 00 C8 20 00 29 70 FF 60 0B 88 01 8F 02 00 09 A0 0E 24 60 60 53 60 00 C8 80 00 29 70 FF 60 0B 88 01 8F 03 00 09 E2 02 A0 02 24 20 E1 00 24 10 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCBD6
SPAN_END = 0x32E98
SENT = 0x32E98     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x32e4c: {"kind": 'reg', "py": 'r[5] = 0xFFFFCBD6', "slot_py": None, "target": None, "cond": None},
    0x32e4e: {"kind": 'reg', "py": 'r[4] = 0xFFFFBFF9', "slot_py": None, "target": None, "cond": None},
    0x32e50: {"kind": 'reg', "py": 'r[0] = r[5]', "slot_py": None, "target": None, "cond": None},
    0x32e52: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCBD6, 1))', "slot_py": None, "target": None, "cond": None},
    0x32e54: {"kind": 'reg', "py": 'T = 1 if (r[0] & 0x40) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x32e56: {"kind": 'reg', "py": 'r[0] = T;', "slot_py": None, "target": None, "cond": None},
    0x32e58: {"kind": 'reg', "py": 'r[0] = (r[0] + s8(0xFF)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x32e5a: {"kind": 'reg', "py": 'r[0] = (-r[0]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x32e5c: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x32e5e: {"kind": "branch", "py": None, "slot_py": 'r[6] = s8(0x08)', "target": 0x32e74, "cond": 'T'},
    0x32e62: {"kind": 'reg', "py": 'r[0] = r[5]', "slot_py": None, "target": None, "cond": None},
    0x32e64: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCBD6, 1))', "slot_py": None, "target": None, "cond": None},
    0x32e66: {"kind": 'reg', "py": 'T = 1 if (r[0] & 0x20) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x32e68: {"kind": 'reg', "py": 'r[0] = T;', "slot_py": None, "target": None, "cond": None},
    0x32e6a: {"kind": 'reg', "py": 'r[0] = (r[0] + s8(0xFF)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x32e6c: {"kind": 'reg', "py": 'r[0] = (-r[0]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x32e6e: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x32e70: {"kind": "branch", "py": None, "slot_py": '', "target": 0x32e78, "cond": 'notT'},
    0x32e74: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFBFF9, 1, r[6])', "target": 0x32e94, "cond": 'always'},
    0x32e78: {"kind": 'reg', "py": 'r[0] = r[5]', "slot_py": None, "target": None, "cond": None},
    0x32e7a: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCBD6, 1))', "slot_py": None, "target": None, "cond": None},
    0x32e7c: {"kind": 'reg', "py": 'T = 1 if (r[0] & 0x80) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x32e7e: {"kind": 'reg', "py": 'r[0] = T;', "slot_py": None, "target": None, "cond": None},
    0x32e80: {"kind": 'reg', "py": 'r[0] = (r[0] + s8(0xFF)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x32e82: {"kind": 'reg', "py": 'r[0] = (-r[0]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x32e84: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x32e86: {"kind": "branch", "py": None, "slot_py": '', "target": 0x32e90, "cond": 'notT'},
    0x32e8a: {"kind": 'reg', "py": 'r[2] = s8(0x02)', "slot_py": None, "target": None, "cond": None},
    0x32e8c: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFBFF9, 1, r[2])', "target": 0x32e94, "cond": 'always'},
    0x32e90: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x32e92: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBFF9, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x32e94: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
