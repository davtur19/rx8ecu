#!/usr/bin/env python3
"""Differential test for ign_channel_pair_write (0x86E4) — v3 lift (branches + delay slots), 36 bytes.
...
Run from repo root: python3 c/tests/test_ign_channel_pair_write_86e4.py
"""
...
ENTRY = 0x86E4
RAW = bytes.fromhex("D6 11 24 48 8F 02 60 43 26 52 16 53 88 01 8F 02 60 43 16 51 16 54 88 02 8F 02 00 09 16 52 16 55 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFA0AC
SPAN_END = 0x8708
SENT = 0x8708     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x86e4: {"kind": 'reg', "py": 'r[6] = 0xFFFFA0AC', "slot_py": None, "target": None, "cond": None},
    0x86e6: {"kind": 'reg', "py": 'T = 1 if (r[4] & r[4]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x86e8: {"kind": "branch", "py": None, "slot_py": 'r[0] = r[4]', "target": 0x86f0, "cond": 'notT'},
    0x86ec: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA0AC, 4, r[5])', "slot_py": None, "target": None, "cond": None},
    0x86ee: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA0B8, 4, r[5])', "slot_py": None, "target": None, "cond": None},
    0x86f0: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x86f2: {"kind": "branch", "py": None, "slot_py": 'r[0] = r[4]', "target": 0x86fa, "cond": 'notT'},
    0x86f6: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA0B0, 4, r[5])', "slot_py": None, "target": None, "cond": None},
    0x86f8: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA0BC, 4, r[5])', "slot_py": None, "target": None, "cond": None},
    0x86fa: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x02) else 0', "slot_py": None, "target": None, "cond": None},
    0x86fc: {"kind": "branch", "py": None, "slot_py": '', "target": 0x8704, "cond": 'notT'},
    0x8700: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA0B4, 4, r[5])', "slot_py": None, "target": None, "cond": None},
    0x8702: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA0C0, 4, r[5])', "slot_py": None, "target": None, "cond": None},
    0x8704: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
