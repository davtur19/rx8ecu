#!/usr/bin/env python3
"""Differential test for exhaust_port_condition_2AF80 (0x2AF80) — v3 lift + v4 FPU, 58 bytes.
...
Run from repo root: python3 c/tests/test_exhaust_port_condition_2AF80_2af80.py
"""
...
ENTRY = 0x2AF80
RAW = bytes.fromhex("92 1B 64 20 97 1A 65 4C 96 19 63 53 23 69 33 60 8D 0C 00 09 E0 40 20 59 88 40 8D 07 00 09 D3 09 91 0E F3 38 F2 18 F2 35 8D 03 00 09 E0 00 A0 02 27 00 E2 01 27 20 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBBB2
SPAN_END = 0x2AFBA
SENT = 0x2AFC8     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x2af80: {"kind": 'reg', "py": 'r[2] = 0xFFFFBB7F', "slot_py": None, "target": None, "cond": None},
    0x2af82: {"kind": 'mem', "py": 'r[4] = s8(_rdw(ram, 0xFFFFBB7F, 1))', "slot_py": None, "target": None, "cond": None},
    0x2af84: {"kind": 'reg', "py": 'r[7] = 0xFFFFBBB2', "slot_py": None, "target": None, "cond": None},
    0x2af86: {"kind": 'reg', "py": 'r[5] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x2af88: {"kind": 'reg', "py": 'r[6] = 0x00000080', "slot_py": None, "target": None, "cond": None},
    0x2af8a: {"kind": 'reg', "py": 'r[3] = r[5]', "slot_py": None, "target": None, "cond": None},
    0x2af8c: {"kind": 'reg', "py": 'r[3] = (r[3] & r[6]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x2af8e: {"kind": 'reg', "py": 'T = 1 if r[3] == r[6] else 0', "slot_py": None, "target": None, "cond": None},
    0x2af90: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2afac, "cond": 'T'},
    0x2af94: {"kind": 'reg', "py": 'r[0] = s8(0x40)', "slot_py": None, "target": None, "cond": None},
    0x2af96: {"kind": 'reg', "py": 'r[0] = (r[0] & r[5]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x2af98: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x40) else 0', "slot_py": None, "target": None, "cond": None},
    0x2af9a: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2afac, "cond": 'T'},
    0x2af9e: {"kind": 'reg', "py": 'r[3] = 0x00078D8C', "slot_py": None, "target": None, "cond": None},
    0x2afa0: {"kind": 'reg', "py": 'r[1] = 0xFFFFAA10', "slot_py": None, "target": None, "cond": None},
    0x2afa2: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x00078D8C, 4))', "slot_py": None, "target": None, "cond": None},
    0x2afa4: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0xFFFFAA10, 4))', "slot_py": None, "target": None, "cond": None},
    0x2afa6: {"kind": 'fpu', "py": 'T = 1 if fr[2] > fr[3] else 0', "slot_py": None, "target": None, "cond": None},
    0x2afa8: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2afb2, "cond": 'T'},
    0x2afac: {"kind": 'reg', "py": 'r[0] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x2afae: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFBBB2, 1, r[0])', "target": 0x2afb6, "cond": 'always'},
    0x2afb2: {"kind": 'reg', "py": 'r[2] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x2afb4: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBBB2, 1, r[2])', "slot_py": None, "target": None, "cond": None},
    0x2afb6: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
