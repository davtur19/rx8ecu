#!/usr/bin/env python3
"""Differential test for FUN_0003697e (0x3697E) — pure straight-line lift, 14 bytes.
...
Run from repo root: python3 c/tests/test_FUN_0003697e_3697e.py
"""
...
ENTRY = 0x3697E
RAW = bytes.fromhex("61 1C 41 28 41 18 62 2C 42 28 31 2C 92 51")
SEED = 42
N = 2000
