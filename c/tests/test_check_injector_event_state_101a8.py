#!/usr/bin/env python3
"""Differential test for check_injector_event_state (0x101A8) — v3 lift (branches + delay slots), 34 bytes.
...
Run from repo root: python3 c/tests/test_check_injector_event_state_101a8.py
"""
...
CODE = {
    0x101a8: {"kind": 'reg', "py": 'r[3] = 0xFFFFA428', "slot_py": None, "target": None, "cond": None},
    0x101aa: {"kind": 'mem', "py": 'r[4] = s8(_rdw(ram, 0xFFFFA428, 1))', "slot_py": None, "target": None, "cond": None},
    0x101ac: {"kind": 'reg', "py": 'r[4] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x101ae: {"kind": 'reg', "py": 'T = 1 if (r[4] & r[4]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x101b0: {"kind": "branch", "py": None, "slot_py": '', "target": 0x101c2, "cond": 'T'},
    0x101b4: {"kind": 'reg', "py": 'r[2] = 0xFFFFBEA8', "slot_py": None, "target": None, "cond": None},
    0x101b6: {"kind": 'mem', "py": 'r[1] = s8(_rdw(ram, 0xFFFFBEA8, 1))', "slot_py": None, "target": None, "cond": None},
    0x101b8: {"kind": 'reg', "py": 'T = 1 if (r[1] & r[1]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x101ba: {"kind": "branch", "py": None, "slot_py": '', "target": 0x101c2, "cond": 'notT'},
    0x101be: {"kind": "branch", "py": None, "slot_py": 'r[4] = s8(0x02)', "target": 0x101c4, "cond": 'always'},
    0x101c2: {"kind": 'reg', "py": 'r[4] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x101c4: {"kind": 'reg', "py": 'r[2] = 0xFFFFA574', "slot_py": None, "target": None, "cond": None},
    0x101c6: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFA574, 1, r[4])', "target": None, "cond": None},}
