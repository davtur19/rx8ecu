#!/usr/bin/env python3
"""Differential test for intake_port_timing_monitor (0x1BD20) — v3 lift (branches + delay slots), 44 bytes.
...
Run from repo root: python3 c/tests/test_intake_port_timing_monitor_1bd20.py
"""
...
CODE = {
    0x1bd20: {"kind": 'reg', "py": 'r[3] = 0xFFFFBDB4', "slot_py": None, "target": None, "cond": None},
    0x1bd22: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFBDB4, 1))', "slot_py": None, "target": None, "cond": None},
    0x1bd24: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x1bd26: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x1bd28: {"kind": "branch", "py": None, "slot_py": '', "target": 0x1bd48, "cond": 'notT'},
    0x1bd2c: {"kind": 'reg', "py": 'r[4] = 0xFFFFAD90', "slot_py": None, "target": None, "cond": None},
    0x1bd2e: {"kind": 'reg', "py": 'r[2] = 0xFFFF9EC8', "slot_py": None, "target": None, "cond": None},
    0x1bd30: {"kind": 'mem', "py": 'r[0] = s16(_rdw(ram, 0xFFFF9EC8, 2))', "slot_py": None, "target": None, "cond": None},
    0x1bd32: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x1bd34: {"kind": 'reg', "py": 'T = 1 if (r[0] & 0x20) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x1bd36: {"kind": "branch", "py": None, "slot_py": '', "target": 0x1bd3e, "cond": 'T'},
    0x1bd3a: {"kind": "branch", "py": None, "slot_py": 'r[1] = s8(0x01)', "target": 0x1bd40, "cond": 'always'},
    0x1bd3e: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x1bd40: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFAD90, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x1bd42: {"kind": 'mem', "py": 'r[2] = s8(_rdw(ram, 0xFFFFAD90, 1))', "slot_py": None, "target": None, "cond": None},
    0x1bd44: {"kind": 'reg', "py": 'r[3] = 0xFFFFAD92', "slot_py": None, "target": None, "cond": None},
    0x1bd46: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFAD92, 1, r[2])', "slot_py": None, "target": None, "cond": None},
    0x1bd48: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
