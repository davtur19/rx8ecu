#!/usr/bin/env python3
"""Differential test for dual_rotor_sync_controller (0x16466) — v3 lift (branches + delay slots), 16 bytes.
...
Run from repo root: python3 c/tests/test_dual_rotor_sync_controller_16466.py
"""
...
ENTRY = 0x16466
RAW = bytes.fromhex("00 09 E0 01 A0 01 25 00 25 60 D2 25 00 0B 22 40")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFA8BB
SPAN_END = 0x16476
SENT = 0x16476     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x16466: {"kind": 'reg', "py": None, "slot_py": None, "target": None, "cond": None},
    0x16468: {"kind": 'reg', "py": 'r[0] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x1646a: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, r[5], 1, r[0])', "target": 0x16470, "cond": 'always'},
    0x1646e: {"kind": 'mem', "py": '_wrw(ram, r[5], 1, r[6])', "slot_py": None, "target": None, "cond": None},
    0x16470: {"kind": 'reg', "py": 'r[2] = 0xFFFFA8BB', "slot_py": None, "target": None, "cond": None},
    0x16472: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFA8BB, 1, r[4])', "target": None, "cond": None},}
