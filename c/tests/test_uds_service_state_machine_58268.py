#!/usr/bin/env python3
"""Differential test for uds_service_state_machine (0x58268) — v3 lift (branches + delay slots), 68 bytes.
...
Run from repo root: python3 c/tests/test_uds_service_state_machine_58268.py
"""
...
ENTRY = 0x58268
RAW = bytes.fromhex("93 69 65 31 96 68 D2 3A 64 20 60 4C 88 01 8D 12 64 03 60 43 88 02 8D 0E 00 09 91 5E 34 10 8F 0D 00 09 60 5D 93 5A 30 30 8D 05 00 09 92 57 60 5D 30 20 8F 03 00 09 E1 01 A0 02 26 10 E2 00 26 20 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFD1AC
SPAN_END = 0x582AC
SENT = 0x582AC     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x58268: {"kind": 'reg', "py": 'r[3] = 0xFFFFD1AC', "slot_py": None, "target": None, "cond": None},
    0x5826a: {"kind": 'mem', "py": 'r[5] = s16(_rdw(ram, 0xFFFFD1AC, 2))', "slot_py": None, "target": None, "cond": None},
    0x5826c: {"kind": 'reg', "py": 'r[6] = 0xFFFFD079', "slot_py": None, "target": None, "cond": None},
    0x5826e: {"kind": 'reg', "py": 'r[2] = 0x0007B114', "slot_py": None, "target": None, "cond": None},
    0x58270: {"kind": 'mem', "py": 'r[4] = s8(_rdw(ram, 0x0007B114, 1))', "slot_py": None, "target": None, "cond": None},
    0x58272: {"kind": 'reg', "py": 'r[0] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x58274: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x58276: {"kind": "branch", "py": None, "slot_py": 'r[4] = r[0]', "target": 0x5829e, "cond": 'T'},
    0x5827a: {"kind": 'reg', "py": 'r[0] = r[4]', "slot_py": None, "target": None, "cond": None},
    0x5827c: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x02) else 0', "slot_py": None, "target": None, "cond": None},
    0x5827e: {"kind": "branch", "py": None, "slot_py": '', "target": 0x5829e, "cond": 'T'},
    0x58282: {"kind": 'reg', "py": 'r[1] = 0x000000FF', "slot_py": None, "target": None, "cond": None},
    0x58284: {"kind": 'reg', "py": 'T = 1 if r[4] == r[1] else 0', "slot_py": None, "target": None, "cond": None},
    0x58286: {"kind": "branch", "py": None, "slot_py": '', "target": 0x582a4, "cond": 'notT'},
    0x5828a: {"kind": 'reg', "py": 'r[0] = r[5] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x5828c: {"kind": 'reg', "py": 'r[3] = 0x00003031', "slot_py": None, "target": None, "cond": None},
    0x5828e: {"kind": 'reg', "py": 'T = 1 if r[0] == r[3] else 0', "slot_py": None, "target": None, "cond": None},
    0x58290: {"kind": "branch", "py": None, "slot_py": '', "target": 0x5829e, "cond": 'T'},
    0x58294: {"kind": 'reg', "py": 'r[2] = 0x00003032', "slot_py": None, "target": None, "cond": None},
    0x58296: {"kind": 'reg', "py": 'r[0] = r[5] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x58298: {"kind": 'reg', "py": 'T = 1 if r[0] == r[2] else 0', "slot_py": None, "target": None, "cond": None},
    0x5829a: {"kind": "branch", "py": None, "slot_py": '', "target": 0x582a4, "cond": 'notT'},
    0x5829e: {"kind": 'reg', "py": 'r[1] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x582a0: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFD079, 1, r[1])', "target": 0x582a8, "cond": 'always'},
    0x582a4: {"kind": 'reg', "py": 'r[2] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x582a6: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD079, 1, r[2])', "slot_py": None, "target": None, "cond": None},
    0x582a8: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
