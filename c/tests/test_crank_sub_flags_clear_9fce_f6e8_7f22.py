#!/usr/bin/env python3
"""Differential test for crank_sub_flags_clear_9fce_f6e8 (0x7F22) — v3 lift (branches + delay slots), 32 bytes.
...
Run from repo root: python3 c/tests/test_crank_sub_flags_clear_9fce_f6e8_7f22.py
"""
...
ENTRY = 0x7F22
RAW = bytes.fromhex("E4 00 D3 13 23 40 D2 18 60 20 60 0C 88 02 8D 02 00 09 D0 11 20 40 94 19 63 41 E2 0E 00 0B 24 21")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFF6E8
SPAN_END = 0x7F42
SENT = 0x7F42     # stop-sentinel, placed past the literal pool
...
CODE = {
    ...
    0x7f3a: {"kind": 'mem', "py": 'r[3] = s16(_rdw(ram, 0xFFFFF6E8, 2))', "slot_py": None, "target": None, "cond": None},
    0x7f3c: {"kind": 'reg', "py": 'r[2] = s8(0x0E)', "slot_py": None, "target": None, "cond": None},
    0x7f3e: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFF6E8, 2, r[2])', "target": None, "cond": None},}
