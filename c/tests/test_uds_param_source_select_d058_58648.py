#!/usr/bin/env python3
"""Differential test for uds_param_source_select_d058 (0x58648) — v3 lift + v4 FPU, 30 bytes.
...
Run from repo root: python3 c/tests/test_uds_param_source_select_d058_58648.py
"""
...
ENTRY = 0x58648
RAW = bytes.fromhex("94 71 E1 30 92 70 63 20 63 3C 33 13 8F 03 00 09 93 6B A0 02 F3 38 D0 39 F3 08 00 0B F4 3A")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFD066
SPAN_END = 0x58666
SENT = 0x58666     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x58648: {"kind": 'reg', "py": 'r[4] = 0xFFFFD058', "slot_py": None, "target": None, "cond": None},
    0x5864a: {"kind": 'reg', "py": 'r[1] = s8(0x30)', "slot_py": None, "target": None, "cond": None},
    0x5864c: {"kind": 'reg', "py": 'r[2] = 0xFFFFD066', "slot_py": None, "target": None, "cond": None},
    0x5864e: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFD066, 1))', "slot_py": None, "target": None, "cond": None},
    0x58650: {"kind": 'reg', "py": 'r[3] = r[3] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x58652: {"kind": 'reg', "py": 'T = 1 if s32(r[3]) >= s32(r[1]) else 0', "slot_py": None, "target": None, "cond": None},
    0x58654: {"kind": "branch", "py": None, "slot_py": '', "target": 0x5865e, "cond": 'notT'},
    0x58658: {"kind": 'reg', "py": 'r[3] = 0xFFFFA7B0', "slot_py": None, "target": None, "cond": None},
    0x5865a: {"kind": "branch", "py": None, "slot_py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFA7B0, 4))', "target": 0x58662, "cond": 'always'},
    0x5865e: {"kind": 'reg', "py": 'r[0] = 0x0007C290', "slot_py": None, "target": None, "cond": None},
    0x58660: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x0007C290, 4))', "slot_py": None, "target": None, "cond": None},
    0x58662: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, r[4], 4, f2bits(fr[3]))', "target": None, "cond": None},}
