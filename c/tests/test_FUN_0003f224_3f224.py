#!/usr/bin/env python3
"""Differential test for FUN_0003f224 (0x3F224) — pure straight-line lift, 8 bytes.
...
Run from repo root: python3 c/tests/test_FUN_0003f224_3f224.py
"""
...
ENTRY = 0x3F224
RAW = bytes.fromhex("65 D3 60 0D D3 3B 30 30")
SEED = 42
N = 2000
