#!/usr/bin/env python3
"""Differential test for idle_speed_control_0x4FD3C (0x4FD3C) — v3 lift + v4 FPU, 16 bytes.
...
Run from repo root: python3 c/tests/test_idle_speed_control_0x4FD3C_4fd3c.py
"""
...
ENTRY = 0x4FD3C
RAW = bytes.fromhex("C7 48 E2 01 91 83 F3 08 93 80 F3 3A 00 0B 21 20")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFD035
SPAN_END = 0x4FD4C
SENT = 0x4FD4C     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x4fd3c: {"kind": 'reg', "py": 'r[0] = 0x0004FE60', "slot_py": None, "target": None, "cond": None},
    0x4fd3e: {"kind": 'reg', "py": 'r[2] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x4fd40: {"kind": 'reg', "py": 'r[1] = 0xFFFFD035', "slot_py": None, "target": None, "cond": None},
    0x4fd42: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x0004FE60, 4))', "slot_py": None, "target": None, "cond": None},
    0x4fd44: {"kind": 'reg', "py": 'r[3] = 0xFFFFD024', "slot_py": None, "target": None, "cond": None},
    0x4fd46: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFD024, 4, f2bits(fr[3]))', "slot_py": None, "target": None, "cond": None},
    0x4fd48: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFD035, 1, r[2])', "target": None, "cond": None},}
