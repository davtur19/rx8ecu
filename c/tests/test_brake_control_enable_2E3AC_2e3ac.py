#!/usr/bin/env python3
"""Differential test for brake_control_enable_2E3AC (0x2E3AC) — v3 lift + v4 FPU, 102 bytes.
...
Run from repo root: python3 c/tests/test_brake_control_enable_2E3AC_2e3ac.py
"""
...
RAM_MAX = 0xFFFFC008
SPAN_END = 0x2E412
SENT = 0x2E412     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x2e3ac: {"kind": 'reg', "py": 'r[4] = 0xFFFFBD58', "slot_py": None, "target": None, "cond": None},
    0x2e3ae: {"kind": 'reg', "py": 'r[3] = 0xFFFFBD54', "slot_py": None, "target": None, "cond": None},
    0x2e3b0: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFBD54, 1))', "slot_py": None, "target": None, "cond": None},
    0x2e3b2: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x2e3b4: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x2e3b6: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2e3de, "cond": 'T'},
    0x2e3ba: {"kind": 'reg', "py": 'r[2] = 0xFFFFBD55', "slot_py": None, "target": None, "cond": None},
    0x2e3bc: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFBD55, 1))', "slot_py": None, "target": None, "cond": None},
    0x2e3be: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x2e3c0: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x2e3c2: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2e3de, "cond": 'T'},
    0x2e3c6: {"kind": 'reg', "py": 'r[1] = 0xFFFFBD56', "slot_py": None, "target": None, "cond": None},
    0x2e3c8: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFBD56, 1))', "slot_py": None, "target": None, "cond": None},
    0x2e3ca: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x2e3cc: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x2e3ce: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2e3de, "cond": 'T'},
    0x2e3d2: {"kind": 'reg', "py": 'r[3] = 0xFFFFBD6A', "slot_py": None, "target": None, "cond": None},
    0x2e3d4: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFBD6A, 1))', "slot_py": None, "target": None, "cond": None},
    0x2e3d6: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x2e3d8: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x2e3da: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2e3f0, "cond": 'notT'},
    0x2e3de: {"kind": 'reg', "py": 'r[3] = 0x00076B6D', "slot_py": None, "target": None, "cond": None},
    0x2e3e0: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0x00076B6D, 1))', "slot_py": None, "target": None, "cond": None},
    0x2e3e2: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x2e3e4: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x2e3e6: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2e3f0, "cond": 'T'},
    0x2e3ea: {"kind": 'reg', "py": 'r[3] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x2e3ec: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFBD58, 1, r[3])', "target": 0x2e40e, "cond": 'always'},
    0x2e3f0: {"kind": 'reg', "py": 'r[2] = 0x00076B60', "slot_py": None, "target": None, "cond": None},
    0x2e3f2: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x00076B60, 4))', "slot_py": None, "target": None, "cond": None},
    0x2e3f4: {"kind": 'reg', "py": 'r[1] = 0xFFFFC008', "slot_py": None, "target": None, "cond": None},
    0x2e3f6: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0xFFFFC008, 4))', "slot_py": None, "target": None, "cond": None},
    0x2e3f8: {"kind": 'fpu', "py": 'T = 1 if fr[2] > fr[3] else 0', "slot_py": None, "target": None, "cond": None},
    0x2e3fa: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2e40a, "cond": 'T'},
    0x2e3fe: {"kind": 'reg', "py": 'r[3] = 0x00076B6D', "slot_py": None, "target": None, "cond": None},
    0x2e400: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0x00076B6D, 1))', "slot_py": None, "target": None, "cond": None},
    0x2e402: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x2e404: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x2e406: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2e40e, "cond": 'notT'},
    0x2e40a: {"kind": 'reg', "py": 'r[3] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x2e40c: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBD58, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x2e40e: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
