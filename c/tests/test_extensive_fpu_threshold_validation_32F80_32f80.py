#!/usr/bin/env python3
"""Differential test for extensive_fpu_threshold_validation_32F80 (0x32F80) — v3 lift (branches + delay slots), 10 bytes.
...
Run from repo root: python3 c/tests/test_extensive_fpu_threshold_validation_32F80_32f80.py
"""
...
ENTRY = 0x32F80
RAW = bytes.fromhex("D3 1D 44 08 44 08 00 0B 23 40")
SEED = 42
N = 500
MAXSTEPS = 100000
