#!/usr/bin/env python3
"""Differential test for ctrl_correlation_563c4 (0x563C4) — v3 lift (branches + delay slots), 10 bytes.
...
Run from repo root: python3 c/tests/test_ctrl_correlation_563c4_563c4.py
"""
...
CODE = {
    0x563c4: {"kind": 'reg', "py": 'r[2] = 0x0007DA8C', "slot_py": None, "target": None, "cond": None},
    0x563c6: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0x0007DA8C, 1))', "slot_py": None, "target": None, "cond": None},
    0x563c8: {"kind": 'reg', "py": 'r[1] = 0xFFFFD204', "slot_py": None, "target": None, "cond": None},
    0x563ca: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFD204, 1, r[3])', "target": None, "cond": None},}
