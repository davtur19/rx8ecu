#!/usr/bin/env python3
"""Differential test for diag_frame_complete_4E912 (0x4E912) — v3 lift + v4 FPU, 14 bytes.
...
Run from repo root: python3 c/tests/test_diag_frame_complete_4E912_4e912.py
"""
...
ENTRY = 0x4E912
RAW = bytes.fromhex("F3 8D 93 0E E2 00 91 0D F3 3A 00 0B 21 20")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCF8B
SPAN_END = 0x4E920
SENT = 0x4E920     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x4e912: {"kind": 'fpu', "py": 'fr[3] = 0.0', "slot_py": None, "target": None, "cond": None},
    0x4e914: {"kind": 'reg', "py": 'r[3] = 0xFFFFCF68', "slot_py": None, "target": None, "cond": None},
    0x4e916: {"kind": 'reg', "py": 'r[2] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x4e918: {"kind": 'reg', "py": 'r[1] = 0xFFFFCF8B', "slot_py": None, "target": None, "cond": None},
    0x4e91a: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFCF68, 4, f2bits(fr[3]))', "slot_py": None, "target": None, "cond": None},
    0x4e91c: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFCF8B, 1, r[2])', "target": None, "cond": None},}
