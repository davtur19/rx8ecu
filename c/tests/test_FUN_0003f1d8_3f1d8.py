#!/usr/bin/env python3
"""Differential test for FUN_0003f1d8 (0x3F1D8) — v3 lift (branches + delay slots), 10 bytes.
...
Run from repo root: python3 c/tests/test_FUN_0003f1d8_3f1d8.py
"""
...
ENTRY = 0x3F1D8
RAW = bytes.fromhex("92 02 E3 01 00 0B 22 30 C6 B0")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFC6B0
SPAN_END = 0x3F1E2
SENT = 0x3F1E2     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x3f1d8: {"kind": 'reg', "py": 'r[2] = 0xFFFFC6B0', "slot_py": None, "target": None, "cond": None},
    0x3f1da: {"kind": 'reg', "py": 'r[3] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x3f1dc: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFC6B0, 1, r[3])', "target": None, "cond": None},}
