#!/usr/bin/env python3
"""Differential test for fault_clear_flag_gated_copy_cca5_to_cca6 (0x49E60) — v3 lift (branches + delay slots), 34 bytes.
...
Run from repo root: python3 c/tests/test_fault_clear_flag_gated_copy_cca5_to_cca6_49e60.py
"""
...
ENTRY = 0x49E60
RAW = bytes.fromhex("92 26 63 20 23 38 8F 0A 00 09 94 22 91 19 63 10 23 38 8F 02 00 09 A0 01 E3 00 E3 01 24 30 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCCA8
SPAN_END = 0x49E82
SENT = 0x49E82     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x49e60: {"kind": 'reg', "py": 'r[2] = 0xFFFFCCA8', "slot_py": None, "target": None, "cond": None},
    0x49e62: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFCCA8, 1))', "slot_py": None, "target": None, "cond": None},
    0x49e64: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x49e66: {"kind": "branch", "py": None, "slot_py": '', "target": 0x49e7e, "cond": 'notT'},
    0x49e6a: {"kind": 'reg', "py": 'r[4] = 0xFFFFCCA6', "slot_py": None, "target": None, "cond": None},
    0x49e6c: {"kind": 'reg', "py": 'r[1] = 0xFFFFCCA5', "slot_py": None, "target": None, "cond": None},
    0x49e6e: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFCCA5, 1))', "slot_py": None, "target": None, "cond": None},
    0x49e70: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x49e72: {"kind": "branch", "py": None, "slot_py": '', "target": 0x49e7a, "cond": 'notT'},
    0x49e76: {"kind": "branch", "py": None, "slot_py": 'r[3] = s8(0x00)', "target": 0x49e7c, "cond": 'always'},
    0x49e7a: {"kind": 'reg', "py": 'r[3] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x49e7c: {"kind": 'mem', "py": '_wrw(ram, r[4], 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x49e7e: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
