#!/usr/bin/env python3
"""Differential test for thunk_FUN_00035184 (0x35148) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_thunk_FUN_00035184_35148.py
"""
...
ENTRY = 0x35148
RAW = bytes.fromhex("E3 01 24 30 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    ...
    0x3514a: {"kind": 'mem', "py": '_wrw(ram, r[4], 1, r[3])', "slot_py": None, "target": None, "cond": None},
