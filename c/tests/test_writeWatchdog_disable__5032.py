#!/usr/bin/env python3
"""Differential test for writeWatchdog_disable_ (0x5032) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_writeWatchdog_disable__5032.py
"""
...
ENTRY = 0x5032
RAW = bytes.fromhex("D3 60 92 91 00 0B 22 31")
SEED = 42
N = 500
MAXSTEPS = 100000
