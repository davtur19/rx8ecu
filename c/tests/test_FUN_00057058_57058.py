#!/usr/bin/env python3
"""Differential test for FUN_00057058 (0x57058) — pure straight-line lift, 8 bytes.
...
Run from repo root: python3 c/tests/test_FUN_00057058_57058.py
"""
...
ENTRY = 0x57058
RAW = bytes.fromhex("64 D3 E5 00 D7 2E 64 F3")
SEED = 42
N = 2000
