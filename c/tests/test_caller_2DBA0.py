#!/usr/bin/env python3
"""Differential test for caller_2DBA0 (entry 0x2DBA0) — v8 ST caller (CFG), 42 bytes.
...
Run: python3 test_caller_2DBA0.py
"""
...
CODE = {
    0x2dba0: {"kind": 'st', "py": 'local[0x3FC] = pr\n_wrw(ram, STACK_BASE + 0x3FC, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x2dba2: {"kind": 'fpu', "py": 'fr[5] = 0.0', "slot_py": None, "target": None, "cond": None},
    0x2dba4: {"kind": 'reg', "py": 'r[3] = 0xFFFFBCEF', "slot_py": None, "target": None, "cond": None},
    0x2dba6: {"kind": 'fpu', "py": 'fr[4] = 1.0', "slot_py": None, "target": None, "cond": None},
    0x2dba8: {"kind": 'reg', "py": 'r[2] = 0x00002500', "slot_py": None, "target": None, "cond": None},
    0x2dbaa: {"kind": "call", "py": None, "slot_py": 'r[4] = s8(_rdw(ram, 0xFFFFBCEF, 1))', "target": 0x2500, "ret_pc": 0x2dbae, "set_pr": True, "cond": None},
    0x2dbae: {"kind": 'fpu', "py": 'fr[4] = fr[0]', "slot_py": None, "target": None, "cond": None},
    0x2dbb0: {"kind": 'reg', "py": 'r[0] = 0x0002DC10', "slot_py": None, "target": None, "cond": None},
    0x2dbb2: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x0002DC10, 4))', "slot_py": None, "target": None, "cond": None},
    0x2dbb4: {"kind": 'reg', "py": 'r[3] = 0xFFFFBD10', "slot_py": None, "target": None, "cond": None},
    0x2dbb6: {"kind": 'fpu', "py": 'fr[3] = ts(fr[3] - fr[4])', "slot_py": None, "target": None, "cond": None},
    0x2dbb8: {"kind": 'reg', "py": 'r[0] = 0x0002DC14', "slot_py": None, "target": None, "cond": None},
    0x2dbba: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0xFFFFBD10, 4))', "slot_py": None, "target": None, "cond": None},
    0x2dbbc: {"kind": 'fpu', "py": 'fr[1] = bits2f(_rdw(ram, 0x0002DC14, 4))', "slot_py": None, "target": None, "cond": None},
    0x2dbbe: {"kind": 'fpu', "py": 'fr[3] = ts(fr[3] * fr[2])', "slot_py": None, "target": None, "cond": None},
    0x2dbc0: {"kind": 'reg', "py": 'r[2] = 0xFFFFBD18', "slot_py": None, "target": None, "cond": None},
    0x2dbc2: {"kind": 'fpu', "py": 'fr[3] = ts(fr[3] * fr[1])', "slot_py": None, "target": None, "cond": None},
    0x2dbc4: {"kind": 'st', "py": 'pr = _rdw(ram, STACK_BASE + 0x3FC, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x2dbc6: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBD18, 4, f2bits(fr[3]))', "target": None, "cond": None},
