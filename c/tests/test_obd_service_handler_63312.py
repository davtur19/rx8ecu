#!/usr/bin/env python3
"""
Verify obd_service_handler_63312 (0x63312) against the ACTUAL ROM bytes,
run in the SH-2E emulator.

Pending-flag clear leaf, identical logic to 0x632D6 but for the flag at
0xFFFF87D0:

  if (byte@0xFFFF87D0 == 0x01)
      word@0xFFFF87D0 = enc8(0x00)     ; (0 << 8) | ~0 == 0x00FF
...
Run from repo root:  python3 c/tests/test_obd_service_handler_63312.py [N]
"""
...
def main():
    ...
    print("OK  obd_service_handler_63312 @0x%04X  (exhaustive + %d random)"
          % (ENTRY, N))
    sys.exit(0)
