#!/usr/bin/env python3
"""Differential test for atu2_capture_process_all (0x6A70) — v3 lift (branches + delay slots), 36 bytes.
...
Run from repo root: python3 c/tests/test_atu2_capture_process_all_6a70.py
"""
...
ENTRY = 0x6A70
RAW = bytes.fromhex("8D 08 00 09 88 00 8D 08 00 09 A0 09 00 09 84 52 70 01 80 52 84 51 70 01 80 51 63 50 73 01 25 30 D7 19 ED 00")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = None
SPAN_END = 0x6A94
SENT = 0x6A94     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x6a70: {"kind": "branch", "py": None, "slot_py": '', "target": 0x6a84, "cond": 'T'},
    0x6a74: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x00) else 0', "slot_py": None, "target": None, "cond": None},
    0x6a76: {"kind": "branch", "py": None, "slot_py": '', "target": 0x6a8a, "cond": 'T'},
    0x6a7a: {"kind": "branch", "py": None, "slot_py": '', "target": 0x6a90, "cond": 'always'},
    0x6a7e: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, (r[5] + 2), 1))', "slot_py": None, "target": None, "cond": None},
    0x6a80: {"kind": 'reg', "py": 'r[0] = (r[0] + s8(0x01)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x6a82: {"kind": 'mem', "py": '_wrw(ram, (r[5] + 2), 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x6a84: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, (r[5] + 1), 1))', "slot_py": None, "target": None, "cond": None},
    0x6a86: {"kind": 'reg', "py": 'r[0] = (r[0] + s8(0x01)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x6a88: {"kind": 'mem', "py": '_wrw(ram, (r[5] + 1), 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x6a8a: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, r[5], 1))', "slot_py": None, "target": None, "cond": None},
    0x6a8c: {"kind": 'reg', "py": 'r[3] = (r[3] + s8(0x01)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x6a8e: {"kind": 'mem', "py": '_wrw(ram, r[5], 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x6a90: {"kind": 'reg', "py": 'r[7] = 0xFFFF9F24', "slot_py": None, "target": None, "cond": None},
    0x6a92: {"kind": 'reg', "py": 'r[13] = s8(0x00)', "slot_py": None, "target": None, "cond": None},}
