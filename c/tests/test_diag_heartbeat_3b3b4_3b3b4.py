#!/usr/bin/env python3
"""Differential test for diag_heartbeat_3b3b4 (0x3B3B4) — v3 lift + v4 FPU, 8 bytes.
...
Run from repo root: python3 c/tests/test_diag_heartbeat_3b3b4_3b3b4.py
"""
...
RAM_MAX = 0xFFFFC5A4
SPAN_END = 0x3B3BC
SENT = 0x3B3BC     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x3b3b4: {"kind": 'reg', "py": 'r[3] = 0xFFFFC5A4', "slot_py": None, "target": None, "cond": None},
    0x3b3b6: {"kind": 'fpu', "py": 'fr[3] = 1.0', "slot_py": None, "target": None, "cond": None},
    0x3b3b8: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFC5A4, 4, f2bits(fr[3]))', "target": None, "cond": None},}
