#!/usr/bin/env python3
"""Differential test for cruise_control_check_0x4FD4C (0x4FD4C) — v3 lift + v4 FPU, 10 bytes.
...
Run from repo root: python3 c/tests/test_cruise_control_check_0x4FD4C_4fd4c.py
"""
...
ENTRY = 0x4FD4C
RAW = bytes.fromhex("C7 44 F3 08 93 7C 00 0B F3 3A")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFD02C
SPAN_END = 0x4FD56
SENT = 0x4FD56     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x4fd4c: {"kind": 'reg', "py": 'r[0] = 0x0004FE60', "slot_py": None, "target": None, "cond": None},
    0x4fd4e: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x0004FE60, 4))', "slot_py": None, "target": None, "cond": None},
    0x4fd50: {"kind": 'reg', "py": 'r[3] = 0xFFFFD02C', "slot_py": None, "target": None, "cond": None},
    0x4fd52: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFD02C, 4, f2bits(fr[3]))', "target": None, "cond": None},}
