#!/usr/bin/env python3
"""Differential test for diag_fault_cond_eval_9054 (0x56862) — v3 lift (branches + delay slots), 10 bytes.
...
Run from repo root: python3 c/tests/test_diag_fault_cond_eval_9054_56862.py
"""
...
ENTRY = 0x56862
RAW = bytes.fromhex("00 0B 60 53 D3 26 00 0B 60 30")
SEED = 42
N = 500
MAXSTEPS = 100000
