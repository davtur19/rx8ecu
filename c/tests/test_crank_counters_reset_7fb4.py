#!/usr/bin/env python3
"""Differential test for crank_counters_reset (0x7FB4) — v3 lift + v4 FPU, 32 bytes.
...
Run from repo root: python3 c/tests/test_crank_counters_reset_7fb4.py
"""
...
RAM_MAX = 0xFFFF9FE8
SPAN_END = 0x7FD4
SENT = 0x7FD4     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x7fb4: {"kind": 'reg', "py": 'r[4] = 0x7FFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x7fb6: {"kind": 'fpu', "py": 'fr[4] = 0.0', "slot_py": None, "target": None, "cond": None},
    0x7fb8: {"kind": 'reg', "py": 'r[1] = 0xFFFF9F80', "slot_py": None, "target": None, "cond": None},
    0x7fba: {"kind": 'reg', "py": 'r[3] = 0xFFFF9F84', "slot_py": None, "target": None, "cond": None},
    0x7fbc: {"kind": 'reg', "py": 'r[2] = 0xFFFF9F88', "slot_py": None, "target": None, "cond": None},
    0x7fbe: {"kind": 'mem', "py": '_wrw(ram, 0xFFFF9F84, 4, r[4])', "slot_py": None, "target": None, "cond": None},
    0x7fc0: {"kind": 'mem', "py": '_wrw(ram, 0xFFFF9F88, 4, r[4])', "slot_py": None, "target": None, "cond": None},
    0x7fc2: {"kind": 'reg', "py": 'r[4] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x7fc4: {"kind": 'reg', "py": 'r[3] = 0xFFFF9FE8', "slot_py": None, "target": None, "cond": None},
    0x7fc6: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFF9F80, 4, f2bits(fr[4]))', "slot_py": None, "target": None, "cond": None},
    0x7fc8: {"kind": 'mem', "py": '_wrw(ram, 0xFFFF9FE8, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x7fca: {"kind": 'reg', "py": 'r[2] = 0xFFFF9F90', "slot_py": None, "target": None, "cond": None},
    0x7fcc: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFF9F90, 4, f2bits(fr[4]))', "slot_py": None, "target": None, "cond": None},
    0x7fce: {"kind": 'reg', "py": 'r[1] = 0xFFFF9F94', "slot_py": None, "target": None, "cond": None},
    0x7fd0: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFF9F94, 1, r[4])', "target": None, "cond": None},}
