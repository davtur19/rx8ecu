#!/usr/bin/env python3
"""Differential test for fuel_dispatch_2978e (0x2978E) — v3 lift (branches + delay slots), 12 bytes.
...
Run from repo root: python3 c/tests/test_fuel_dispatch_2978e_2978e.py
"""
...
ENTRY = 0x2978E
RAW = bytes.fromhex("00 0B 00 09 E3 3E D2 2E 00 0B 22 31")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBB0A
SPAN_END = 0x2979A
SENT = 0x2979A     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x2978e: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},
    0x29792: {"kind": 'reg', "py": 'r[3] = s8(0x3E)', "slot_py": None, "target": None, "cond": None},
    0x29794: {"kind": 'reg', "py": 'r[2] = 0xFFFFBB0A', "slot_py": None, "target": None, "cond": None},
    0x29796: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBB0A, 2, r[3])', "target": None, "cond": None},}
