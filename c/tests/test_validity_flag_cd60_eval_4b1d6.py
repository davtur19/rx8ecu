#!/usr/bin/env python3
"""Differential test for validity_flag_cd60_eval (0x4B1D6) — v3 lift + v4 FPU, 56 bytes.
...
Run from repo root: python3 c/tests/test_validity_flag_cd60_eval_4b1d6.py
"""
...
ENTRY = 0x4B1D6
RAW = bytes.fromhex("90 5C 94 5C 92 5C 63 20 23 38 8F 11 F4 08 91 58 63 10 23 38 8F 0C 00 09 C7 39 F3 08 F4 34 8D 07 00 09 F2 8D F4 24 8D 03 00 09 E2 01 A0 02 24 20 E1 00 24 10 00 0B 00 09")
SEED = 43
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCFD9
SPAN_END = 0x4B20E
SENT = 0x4B20E     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x4b1d6: {"kind": 'reg', "py": 'r[0] = 0xFFFFBFA0', "slot_py": None, "target": None, "cond": None},
    0x4b1d8: {"kind": 'reg', "py": 'r[4] = 0xFFFFCD60', "slot_py": None, "target": None, "cond": None},
    0x4b1da: {"kind": 'reg', "py": 'r[2] = 0xFFFFCFB9', "slot_py": None, "target": None, "cond": None},
    0x4b1dc: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFCFB9, 1))', "slot_py": None, "target": None, "cond": None},
    0x4b1de: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x4b1e0: {"kind": "branch", "py": None, "slot_py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFBFA0, 4))', "target": 0x4b206, "cond": 'notT'},
    0x4b1e4: {"kind": 'reg', "py": 'r[1] = 0xFFFFCFD9', "slot_py": None, "target": None, "cond": None},
    0x4b1e6: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFCFD9, 1))', "slot_py": None, "target": None, "cond": None},
    0x4b1e8: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x4b1ea: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4b206, "cond": 'notT'},
    0x4b1ee: {"kind": 'reg', "py": 'r[0] = 0x0004B2D4', "slot_py": None, "target": None, "cond": None},
    0x4b1f0: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x0004B2D4, 4))', "slot_py": None, "target": None, "cond": None},
    0x4b1f2: {"kind": 'fpu', "py": 'T = 1 if fr[4] == fr[3] else 0', "slot_py": None, "target": None, "cond": None},
    0x4b1f4: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4b206, "cond": 'T'},
    0x4b1f8: {"kind": 'fpu', "py": 'fr[2] = 0.0', "slot_py": None, "target": None, "cond": None},
    0x4b1fa: {"kind": 'fpu', "py": 'T = 1 if fr[4] == fr[2] else 0', "slot_py": None, "target": None, "cond": None},
    0x4b1fc: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4b206, "cond": 'T'},
    0x4b200: {"kind": 'reg', "py": 'r[2] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x4b202: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFCD60, 1, r[2])', "target": 0x4b20a, "cond": 'always'},
    0x4b206: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x4b208: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCD60, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x4b20a: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
