#!/usr/bin/env python3
"""Differential test for timer1_init_and_start (0xA6C0) — v3 lift (branches + delay slots), 30 bytes.
...
Run from repo root: python3 c/tests/test_timer1_init_and_start_a6c0.py
"""
...
CODE = {
    0xa6c0: {"kind": 'reg', "py": 'r[5] = 0xFFFFF710', "slot_py": None, "target": None, "cond": None},
    0xa6c2: {"kind": 'reg', "py": 'r[4] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0xa6c4: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFF710, 2, r[4])', "slot_py": None, "target": None, "cond": None},
    0xa6c6: {"kind": 'reg', "py": 'r[6] = 0xFFFFF718', "slot_py": None, "target": None, "cond": None},
    0xa6c8: {"kind": 'mem', "py": 'r[3] = s16(_rdw(ram, 0xFFFFF718, 2))', "slot_py": None, "target": None, "cond": None},
    0xa6ca: {"kind": 'reg', "py": 'r[2] = 0x000000C0', "slot_py": None, "target": None, "cond": None},
    0xa6cc: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFF718, 2, r[2])', "slot_py": None, "target": None, "cond": None},
    0xa6ce: {"kind": 'reg', "py": 'r[3] = 0x000009C3', "slot_py": None, "target": None, "cond": None},
    0xa6d0: {"kind": 'reg', "py": 'r[1] = 0xFFFFF71C', "slot_py": None, "target": None, "cond": None},
    0xa6d2: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFF71C, 2, r[3])', "slot_py": None, "target": None, "cond": None},
    0xa6d4: {"kind": 'reg', "py": 'r[2] = 0xFFFFF71A', "slot_py": None, "target": None, "cond": None},
    0xa6d6: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFF71A, 2, r[4])', "slot_py": None, "target": None, "cond": None},
    0xa6d8: {"kind": 'reg', "py": 'r[3] = s8(0x02)', "slot_py": None, "target": None, "cond": None},
    0xa6da: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFF710, 2, r[3])', "target": None, "cond": None},}
