#!/usr/bin/env python3
"""Differential test for boot_phase_output_config (0x6DE2) — v3 lift (branches + delay slots), 36 bytes.
...
Run from repo root: python3 c/tests/test_boot_phase_output_config_6de2.py
"""
...
ENTRY = 0x6DE2
RAW = bytes.fromhex("C9 DF 24 00 63 50 E2 13 A0 06 25 20 60 40 C9 DF 24 00 62 50 E3 10 25 30 60 40 C9 2F CB 20 24 00 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = None
SPAN_END = 0x6E06
SENT = 0x6E06     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x6de2: {"kind": 'reg', "py": 'r[0] = (r[0] & 0xDF) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x6de4: {"kind": 'mem', "py": '_wrw(ram, r[4], 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x6de6: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, r[5], 1))', "slot_py": None, "target": None, "cond": None},
    0x6de8: {"kind": 'reg', "py": 'r[2] = s8(0x13)', "slot_py": None, "target": None, "cond": None},
    0x6dea: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, r[5], 1, r[2])', "target": 0x6dfa, "cond": 'always'},
    0x6dee: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, r[4], 1))', "slot_py": None, "target": None, "cond": None},
    0x6df0: {"kind": 'reg', "py": 'r[0] = (r[0] & 0xDF) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x6df2: {"kind": 'mem', "py": '_wrw(ram, r[4], 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x6df4: {"kind": 'mem', "py": 'r[2] = s8(_rdw(ram, r[5], 1))', "slot_py": None, "target": None, "cond": None},
    0x6df6: {"kind": 'reg', "py": 'r[3] = s8(0x10)', "slot_py": None, "target": None, "cond": None},
    0x6df8: {"kind": 'mem', "py": '_wrw(ram, r[5], 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x6dfa: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, r[4], 1))', "slot_py": None, "target": None, "cond": None},
    0x6dfc: {"kind": 'reg', "py": 'r[0] = (r[0] & 0x2F) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x6dfe: {"kind": 'reg', "py": 'r[0] = (r[0] | 0x20) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x6e00: {"kind": 'mem', "py": '_wrw(ram, r[4], 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x6e02: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
