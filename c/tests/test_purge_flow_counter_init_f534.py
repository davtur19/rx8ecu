#!/usr/bin/env python3
"""Differential test for purge_flow_counter_init (0xF534) — v3 lift (branches + delay slots), 16 bytes.
...
Run from repo root: python3 c/tests/test_purge_flow_counter_init_f534.py
"""
...
CODE = {
    0xf534: {"kind": 'reg', "py": 'r[3] = 0xFFFFA4B0', "slot_py": None, "target": None, "cond": None},
    0xf536: {"kind": 'reg', "py": 'r[4] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0xf538: {"kind": 'reg', "py": 'r[2] = 0xFFFFA4B1', "slot_py": None, "target": None, "cond": None},
    0xf53a: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA4B0, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0xf53c: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA4B1, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0xf53e: {"kind": 'reg', "py": 'r[1] = 0xFFFFA4B2', "slot_py": None, "target": None, "cond": None},
    0xf540: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFA4B2, 1, r[4])', "target": None, "cond": None},}
