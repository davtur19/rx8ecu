#!/usr/bin/env python3
"""Differential test for status_mask_d180_from_flags (0x5BF6C) — v3 lift (branches + delay slots), 62 bytes.
...
Run from repo root: python3 c/tests/test_status_mask_d180_from_flags_5bf6c.py
"""
...
ENTRY = 0x5BF6C
RAW = bytes.fromhex("93 18 64 30 92 17 60 4C 91 16 88 01 66 20 8F 03 65 10 94 12 A0 0B 00 09 60 6C 88 01 8F 06 00 09 60 5C 88 01 8F 02 00 09 A0 01 E4 40 E4 20 93 05 00 0B 23 40 A4 1C AA C7 B5 86 00 80 D1 80")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFD180
SPAN_END = 0x5BFAA
SENT = 0x5BFAA     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x5bf6c: {"kind": 'reg', "py": 'r[3] = 0xFFFFA41C', "slot_py": None, "target": None, "cond": None},
    0x5bf6e: {"kind": 'mem', "py": 'r[4] = s8(_rdw(ram, 0xFFFFA41C, 1))', "slot_py": None, "target": None, "cond": None},
    0x5bf70: {"kind": 'reg', "py": 'r[2] = 0xFFFFAAC7', "slot_py": None, "target": None, "cond": None},
    0x5bf72: {"kind": 'reg', "py": 'r[0] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x5bf74: {"kind": 'reg', "py": 'r[1] = 0xFFFFB586', "slot_py": None, "target": None, "cond": None},
    0x5bf76: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x5bf78: {"kind": 'mem', "py": 'r[6] = s8(_rdw(ram, 0xFFFFAAC7, 1))', "slot_py": None, "target": None, "cond": None},
    0x5bf7a: {"kind": "branch", "py": None, "slot_py": 'r[5] = s8(_rdw(ram, 0xFFFFB586, 1))', "target": 0x5bf84, "cond": 'notT'},
    0x5bf7e: {"kind": 'reg', "py": 'r[4] = 0x00000080', "slot_py": None, "target": None, "cond": None},
    0x5bf80: {"kind": "branch", "py": None, "slot_py": '', "target": 0x5bf9a, "cond": 'always'},
    0x5bf84: {"kind": 'reg', "py": 'r[0] = r[6] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x5bf86: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x5bf88: {"kind": "branch", "py": None, "slot_py": '', "target": 0x5bf98, "cond": 'notT'},
    0x5bf8c: {"kind": 'reg', "py": 'r[0] = r[5] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x5bf8e: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x5bf90: {"kind": "branch", "py": None, "slot_py": '', "target": 0x5bf98, "cond": 'notT'},
    0x5bf94: {"kind": "branch", "py": None, "slot_py": 'r[4] = s8(0x40)', "target": 0x5bf9a, "cond": 'always'},
    0x5bf98: {"kind": 'reg', "py": 'r[4] = s8(0x20)', "slot_py": None, "target": None, "cond": None},
    0x5bf9a: {"kind": 'reg', "py": 'r[3] = 0xFFFFD180', "slot_py": None, "target": None, "cond": None},
    0x5bf9c: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFD180, 1, r[4])', "target": None, "cond": None},}
