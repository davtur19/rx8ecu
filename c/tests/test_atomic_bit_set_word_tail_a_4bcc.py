#!/usr/bin/env python3
"""Differential test for atomic_bit_set_word_tail_a (0x4BCC) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_atomic_bit_set_word_tail_a_4bcc.py
"""
...
ENTRY = 0x4BCC
RAW = bytes.fromhex("23 5B 24 31 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
