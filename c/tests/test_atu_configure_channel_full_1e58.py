#!/usr/bin/env python3
"""Differential test for atu_configure_channel_full (0x1E58) — v3 lift (branches + delay slots), 26 bytes.
...
Run from repo root: python3 c/tests/test_atu_configure_channel_full_1e58.py
"""
...
ENTRY = 0x1E58
RAW = bytes.fromhex("84 42 42 28 60 0C 40 18 33 0C 42 18 84 43 33 2C 60 0C 64 33 34 0C 00 0B 60 43")
SEED = 0
N = 2000
MAXSTEPS = 100000
