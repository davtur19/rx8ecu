#!/usr/bin/env python3
"""Differential test for alternator_current_delta_c608 (0x3D726) — v3 lift + v4 FPU, 20 bytes.
...
Run from repo root: python3 c/tests/test_alternator_current_delta_c608_3d726.py
"""
...
ENTRY = 0x3D726
RAW = bytes.fromhex("90 50 D4 2E F4 08 F3 48 F2 4C 93 4F F2 31 F3 2A 00 0B F4 4A")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFC608
SPAN_END = 0x3D73A
SENT = 0x3D73A     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x3d726: {"kind": 'reg', "py": 'r[0] = 0xFFFFBBE8', "slot_py": None, "target": None, "cond": None},
    0x3d728: {"kind": 'reg', "py": 'r[4] = 0xFFFFC614', "slot_py": None, "target": None, "cond": None},
    0x3d72a: {"kind": 'fpu', "py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFBBE8, 4))', "slot_py": None, "target": None, "cond": None},
    0x3d72c: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, r[4], 4))', "slot_py": None, "target": None, "cond": None},
    0x3d72e: {"kind": 'fpu', "py": 'fr[2] = fr[4]', "slot_py": None, "target": None, "cond": None},
    0x3d730: {"kind": 'reg', "py": 'r[3] = 0xFFFFC608', "slot_py": None, "target": None, "cond": None},
    0x3d732: {"kind": 'fpu', "py": 'fr[2] = ts(fr[2] - fr[3])', "slot_py": None, "target": None, "cond": None},
    0x3d734: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFC608, 4, f2bits(fr[2]))', "slot_py": None, "target": None, "cond": None},
    0x3d736: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, r[4], 4, f2bits(fr[4]))', "target": None, "cond": None},}
