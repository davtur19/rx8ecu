#!/usr/bin/env python3
"""Differential test for idle_air_control_calc_2DB74 (0x2DB74) — v3 lift + v4 FPU, 22 bytes.
...
Run from repo root: python3 c/tests/test_idle_air_control_calc_2DB74_2db74.py
"""
...
RAM_MAX = 0xFFFFBD28
SPAN_END = 0x2DB8A
SENT = 0x2DB8A     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x2db74: {"kind": 'reg', "py": 'r[3] = 0xFFFFBD24', "slot_py": None, "target": None, "cond": None},
    0x2db76: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFBD24, 4))', "slot_py": None, "target": None, "cond": None},
    0x2db78: {"kind": 'reg', "py": 'r[2] = 0xFFFFBD08', "slot_py": None, "target": None, "cond": None},
    0x2db7a: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0xFFFFBD08, 4))', "slot_py": None, "target": None, "cond": None},
    0x2db7c: {"kind": 'reg', "py": 'r[1] = 0xFFFFBD28', "slot_py": None, "target": None, "cond": None},
    0x2db7e: {"kind": 'fpu', "py": 'fr[2] = ts(fr[2] + fr[3])', "slot_py": None, "target": None, "cond": None},
    0x2db80: {"kind": 'reg', "py": 'r[2] = 0xFFFFBD10', "slot_py": None, "target": None, "cond": None},
    0x2db82: {"kind": 'fpu', "py": 'fr[1] = bits2f(_rdw(ram, 0xFFFFBD28, 4))', "slot_py": None, "target": None, "cond": None},
    0x2db84: {"kind": 'fpu', "py": 'fr[2] = ts(fr[2] + fr[1])', "slot_py": None, "target": None, "cond": None},
    0x2db86: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBD10, 4, f2bits(fr[2]))', "target": None, "cond": None},}
