#!/usr/bin/env python3
"""Differential test for fuel_trim_channel_inputs_map (0xE07E) — pure straight-line lift, 10 bytes.
...
Run from repo root: python3 c/tests/test_fuel_trim_channel_inputs_map_e07e.py
"""
...
ENTRY = 0xE07E
RAW = bytes.fromhex("EB 00 D4 41 EA 10 DC 41 6D 43")
SEED = 42
N = 2000
