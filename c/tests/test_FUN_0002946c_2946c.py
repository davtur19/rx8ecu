#!/usr/bin/env python3
"""Differential test for FUN_0002946c (0x2946C) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_FUN_0002946c_2946c.py
"""
...
ENTRY = 0x2946C
RAW = bytes.fromhex("92 65 E3 00 00 0B 22 31")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBAD6
SPAN_END = 0x29474
SENT = 0x29474     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x2946c: {"kind": 'reg', "py": 'r[2] = 0xFFFFBAD6', "slot_py": None, "target": None, "cond": None},
    0x2946e: {"kind": 'reg', "py": 'r[3] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x29470: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBAD6, 2, r[3])', "target": None, "cond": None},}
