#!/usr/bin/env python3
"""Differential test for FUN_00029308 (0x29308) — v3 lift + v4 FPU, 10 bytes.
...
Run from repo root: python3 c/tests/test_FUN_00029308_29308.py
"""
...
ENTRY = 0x29308
RAW = bytes.fromhex("91 7E F1 4A 93 7D 00 0B F3 4A")
SEED = 42
N = 500
MAXSTEPS = 100000
