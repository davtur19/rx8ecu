#!/usr/bin/env python3
"""Differential test for sensor_channels_5046 (0x5046) — v3 lift (branches + delay slots), 24 bytes.
...
Run from repo root: python3 c/tests/test_sensor_channels_5046_5046.py
"""
...
RAM_MAX = 0xFFFFF020
SPAN_END = 0x505E
SENT = 0x505E     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x5046: {"kind": 'reg', "py": 'r[4] = 0x00000080', "slot_py": None, "target": None, "cond": None},
    0x5048: {"kind": 'reg', "py": 'r[3] = 0xFFFFF000', "slot_py": None, "target": None, "cond": None},
    0x504a: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFF000, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x504c: {"kind": 'reg', "py": 'r[2] = 0xFFFFF008', "slot_py": None, "target": None, "cond": None},
    0x504e: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFF008, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x5050: {"kind": 'reg', "py": 'r[1] = 0xFFFFF010', "slot_py": None, "target": None, "cond": None},
    0x5052: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFF010, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x5054: {"kind": 'reg', "py": 'r[3] = (r[3] + s8(0x18)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x5056: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFF018, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x5058: {"kind": 'reg', "py": 'r[2] = (r[2] + s8(0x18)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x505a: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFF020, 1, r[4])', "target": None, "cond": None},}
