#!/usr/bin/env python3
"""Differential test for caller_D97C (entry 0xD97C) — v8 ST caller (CFG), 38 bytes.
...
Run: python3 test_caller_D97C.py
"""
...
CODE = {
    0xd97c: {"kind": 'st', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xd97e: {"kind": 'reg', "py": 'r[15] = (r[15] + s8(0xF8)) & 0xFFFFFFFF\nsp = (sp + s8(0xF8)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xd980: {"kind": 'reg', "py": 'r[5] = 0x000000E0', "slot_py": None, "target": None, "cond": None},
    0xd982: {"kind": 'reg', "py": 'r[3] = 0x00002054', "slot_py": None, "target": None, "cond": None},
    0xd984: {"kind": "call", "py": None, "slot_py": 'r[4] = r[15]', "target": 0x2054, "ret_pc": 0xd988, "set_pr": True, "cond": None},
    0xd988: {"kind": 'reg', "py": 'r[4] = 0xFFFFA3FC', "slot_py": None, "target": None, "cond": None},
    0xd98a: {"kind": 'reg', "py": 'r[3] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0xd98c: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFA3FC, 1))', "slot_py": None, "target": None, "cond": None},
    0xd98e: {"kind": 'mem', "py": '_wrw(ram, sp + 4, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0xd990: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA3FC, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0xd992: {"kind": 'reg', "py": 'r[3] = 0x00002064', "slot_py": None, "target": None, "cond": None},
    0xd994: {"kind": "call", "py": None, "slot_py": 'r[4] = _rdw(ram, sp, 4)', "target": 0x2064, "ret_pc": 0xd998, "set_pr": True, "cond": None},
    0xd998: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, sp + 4, 1))', "slot_py": None, "target": None, "cond": None},
    0xd99a: {"kind": 'reg', "py": 'r[15] = (r[15] + s8(0x08)) & 0xFFFFFFFF\nsp = (sp + s8(0x08)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xd99c: {"kind": 'st', "py": 'pr = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xd99e: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},
