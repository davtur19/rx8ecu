#!/usr/bin/env python3
"""Differential test for can231SetupTx (0x29EC6) — v3 lift (branches + delay slots), 40 bytes.
...
Run from repo root: python3 c/tests/test_can231SetupTx_29ec6.py
"""
...
CODE = {
    0x29ec6: {"kind": 'reg', "py": 'r[4] = 0xFFFFBB48', "slot_py": None, "target": None, "cond": None},
    0x29ec8: {"kind": 'reg', "py": 'r[2] = 0xFFFFBB4D', "slot_py": None, "target": None, "cond": None},
    0x29eca: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFBB48, 1))', "slot_py": None, "target": None, "cond": None},
    0x29ecc: {"kind": 'reg', "py": 'r[1] = 0xFFFFBB59', "slot_py": None, "target": None, "cond": None},
    0x29ece: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBB4D, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x29ed0: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFBB49, 1))', "slot_py": None, "target": None, "cond": None},
    0x29ed2: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBB59, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x29ed4: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFBB4A, 1))', "slot_py": None, "target": None, "cond": None},
    0x29ed6: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x29ed8: {"kind": 'reg', "py": 'r[2] = 0xFFFFBB4E', "slot_py": None, "target": None, "cond": None},
    0x29eda: {"kind": 'reg', "py": 'r[0] = (r[0] << 8) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x29edc: {"kind": 'reg', "py": 'r[3] = r[0]', "slot_py": None, "target": None, "cond": None},
    0x29ede: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFBB4B, 1))', "slot_py": None, "target": None, "cond": None},
    0x29ee0: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x29ee2: {"kind": 'reg', "py": 'r[3] = (r[3] + r[0]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x29ee4: {"kind": 'reg', "py": 'r[0] = 0xFFFFBB5A', "slot_py": None, "target": None, "cond": None},
    0x29ee6: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBB5A, 2, r[3])', "slot_py": None, "target": None, "cond": None},
    0x29ee8: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFBB4C, 1))', "slot_py": None, "target": None, "cond": None},
    0x29eea: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBB4E, 1, r[0])', "target": None, "cond": None},}
