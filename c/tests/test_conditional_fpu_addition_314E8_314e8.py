#!/usr/bin/env python3
"""Differential test for conditional_fpu_addition_314E8 (0x314E8) — v3 lift + v4 FPU, 50 bytes.
...
Run from repo root: python3 c/tests/test_conditional_fpu_addition_314E8_314e8.py
"""
...
ENTRY = 0x314E8
RAW = bytes.fromhex("91 1B 62 10 22 28 8F 12 00 09 93 17 60 30 60 0C 88 01 8F 0C 00 09 92 12 60 20 60 0C 88 01 8F 06 00 09 94 07 93 0C F3 48 F2 38 F2 30 F4 2A 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCE6E
SPAN_END = 0x3151A
SENT = 0x3152A     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x314e8: {"kind": 'reg', "py": 'r[1] = 0xFFFFA428', "slot_py": None, "target": None, "cond": None},
    0x314ea: {"kind": 'mem', "py": 'r[2] = s8(_rdw(ram, 0xFFFFA428, 1))', "slot_py": None, "target": None, "cond": None},
    0x314ec: {"kind": 'reg', "py": 'T = 1 if (r[2] & r[2]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x314ee: {"kind": "branch", "py": None, "slot_py": '', "target": 0x31516, "cond": 'notT'},
    0x314f2: {"kind": 'reg', "py": 'r[3] = 0xFFFFA42C', "slot_py": None, "target": None, "cond": None},
    0x314f4: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFA42C, 1))', "slot_py": None, "target": None, "cond": None},
    0x314f6: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x314f8: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x314fa: {"kind": "branch", "py": None, "slot_py": '', "target": 0x31516, "cond": 'notT'},
    0x314fe: {"kind": 'reg', "py": 'r[2] = 0xFFFFCE6E', "slot_py": None, "target": None, "cond": None},
    0x31500: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCE6E, 1))', "slot_py": None, "target": None, "cond": None},
    0x31502: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x31504: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x31506: {"kind": "branch", "py": None, "slot_py": '', "target": 0x31516, "cond": 'notT'},
    0x3150a: {"kind": 'reg', "py": 'r[4] = 0xFFFFBF00', "slot_py": None, "target": None, "cond": None},
    0x3150c: {"kind": 'reg', "py": 'r[3] = 0xFFFFBEC4', "slot_py": None, "target": None, "cond": None},
    0x3150e: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, r[4], 4))', "slot_py": None, "target": None, "cond": None},
    0x31510: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0xFFFFBEC4, 4))', "slot_py": None, "target": None, "cond": None},
    0x31512: {"kind": 'fpu', "py": 'fr[2] = ts(fr[2] + fr[3])', "slot_py": None, "target": None, "cond": None},
    0x31514: {"kind": 'fpu', "py": '_wrw(ram, r[4], 4, f2bits(fr[2]))', "slot_py": None, "target": None, "cond": None},
    0x31516: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
