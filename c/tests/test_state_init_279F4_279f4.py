#!/usr/bin/env python3
"""Differential test for state_init_279F4 (0x279F4) — v3 lift (branches + delay slots), 24 bytes.
...
Run from repo root: python3 c/tests/test_state_init_279F4_279f4.py
"""
...
CODE = {
    0x279f4: {"kind": 'reg', "py": 'r[2] = 0x00075950', "slot_py": None, "target": None, "cond": None},
    0x279f6: {"kind": 'reg', "py": 'r[0] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x279f8: {"kind": 'reg', "py": 'r[1] = 0xFFFFB714', "slot_py": None, "target": None, "cond": None},
    0x279fa: {"kind": 'mem', "py": 'r[3] = s16(_rdw(ram, 0x00075950, 2))', "slot_py": None, "target": None, "cond": None},
    0x279fc: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFB714, 2, r[3])', "slot_py": None, "target": None, "cond": None},
    0x279fe: {"kind": 'reg', "py": 'r[3] = 0xFFFFB72E', "slot_py": None, "target": None, "cond": None},
    0x27a00: {"kind": 'reg', "py": 'r[1] = 0xFFFFB716', "slot_py": None, "target": None, "cond": None},
    0x27a02: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFB72E, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x27a04: {"kind": 'reg', "py": 'r[0] = 0x0007594E', "slot_py": None, "target": None, "cond": None},
    0x27a06: {"kind": 'mem', "py": 'r[2] = s16(_rdw(ram, 0x0007594E, 2))', "slot_py": None, "target": None, "cond": None},
    0x27a08: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFB716, 2, r[2])', "target": None, "cond": None},}
