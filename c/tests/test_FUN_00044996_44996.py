#!/usr/bin/env python3
"""Differential test for FUN_00044996 (0x44996) — v3 lift (branches + delay slots), 36 bytes.
...
Run from repo root: python3 c/tests/test_FUN_00044996_44996.py
"""
...
ENTRY = 0x44996
RAW = bytes.fromhex("60 4C 88 01 8F 04 00 09 D3 3C 62 30 A0 08 26 20 65 60 63 5C 43 15 8F 03 00 09 93 63 35 3C 26 50 00 0B 27 40")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    ...
    0x449a2: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, r[6], 1, r[2])', "target": 0x449b6, "cond": 'always'},
    0x449a6: {"kind": 'mem', "py": 'r[5] = s8(_rdw(ram, r[6], 1))', "slot_py": None, "target": None, "cond": None},
    ...
    0x449b4: {"kind": 'mem', "py": '_wrw(ram, r[6], 1, r[5])', "slot_py": None, "target": None, "cond": None},
    0x449b6: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, r[7], 1, r[4])', "target": None, "cond": None},}
