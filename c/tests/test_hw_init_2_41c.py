#!/usr/bin/env python3
"""Differential test for hw_init_2 (0x41C) — pure straight-line lift, 8 bytes.
...
Run from repo root: python3 c/tests/test_hw_init_2_41c.py
"""
...
ENTRY = 0x41C
RAW = bytes.fromhex("95 59 E4 00 96 58 E7 08")
SEED = 42
N = 2000
