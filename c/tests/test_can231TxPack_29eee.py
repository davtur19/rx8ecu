#!/usr/bin/env python3
"""Differential test for can231TxPack (0x29EEE) — v3 lift (branches + delay slots), 72 bytes.
...
Run from repo root: python3 c/tests/test_can231TxPack_29eee.py
"""
...
ENTRY = 0x29EEE
RAW = bytes.fromhex("E1 40 24 1B 93 71 60 30 60 0C 88 01 8F 02 00 09 E1 08 24 1B E1 7D 92 69 63 20 63 3C 33 13 8F 02 00 09 E0 04 24 0B 92 62 63 20 23 38 8F 02 00 09 E0 02 24 0B 92 5C 63 20 23 38 8F 02 00 09 E0 01 24 0B 93 56 00 0B 23 40")
SEED = 43
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCC2C
SPAN_END = 0x29F36
SENT = 0x29F36     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x29eee: {"kind": 'reg', "py": 'r[1] = s8(0x40)', "slot_py": None, "target": None, "cond": None},
    0x29ef0: {"kind": 'reg', "py": 'r[4] = (r[4] | r[1]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x29ef2: {"kind": 'reg', "py": 'r[3] = 0xFFFFBB5E', "slot_py": None, "target": None, "cond": None},
    0x29ef4: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFBB5E, 1))', "slot_py": None, "target": None, "cond": None},
    0x29ef6: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x29ef8: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x29efa: {"kind": "branch", "py": None, "slot_py": '', "target": 0x29f02, "cond": 'notT'},
    0x29efe: {"kind": 'reg', "py": 'r[1] = s8(0x08)', "slot_py": None, "target": None, "cond": None},
    0x29f00: {"kind": 'reg', "py": 'r[4] = (r[4] | r[1]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x29f02: {"kind": 'reg', "py": 'r[1] = s8(0x7D)', "slot_py": None, "target": None, "cond": None},
    0x29f04: {"kind": 'reg', "py": 'r[2] = 0xFFFFBBFB', "slot_py": None, "target": None, "cond": None},
    0x29f06: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFBBFB, 1))', "slot_py": None, "target": None, "cond": None},
    0x29f08: {"kind": 'reg', "py": 'r[3] = r[3] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x29f0a: {"kind": 'reg', "py": 'T = 1 if s32(r[3]) >= s32(r[1]) else 0', "slot_py": None, "target": None, "cond": None},
    0x29f0c: {"kind": "branch", "py": None, "slot_py": '', "target": 0x29f14, "cond": 'notT'},
    0x29f10: {"kind": 'reg', "py": 'r[0] = s8(0x04)', "slot_py": None, "target": None, "cond": None},
    0x29f12: {"kind": 'reg', "py": 'r[4] = (r[4] | r[0]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x29f14: {"kind": 'reg', "py": 'r[2] = 0xFFFFCC2C', "slot_py": None, "target": None, "cond": None},
    0x29f16: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFCC2C, 1))', "slot_py": None, "target": None, "cond": None},
    0x29f18: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x29f1a: {"kind": "branch", "py": None, "slot_py": '', "target": 0x29f22, "cond": 'notT'},
    0x29f1e: {"kind": 'reg', "py": 'r[0] = s8(0x02)', "slot_py": None, "target": None, "cond": None},
    0x29f20: {"kind": 'reg', "py": 'r[4] = (r[4] | r[0]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x29f22: {"kind": 'reg', "py": 'r[2] = 0xFFFFAD7C', "slot_py": None, "target": None, "cond": None},
    0x29f24: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFAD7C, 1))', "slot_py": None, "target": None, "cond": None},
    0x29f26: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x29f28: {"kind": "branch", "py": None, "slot_py": '', "target": 0x29f30, "cond": 'notT'},
    0x29f2c: {"kind": 'reg', "py": 'r[0] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x29f2e: {"kind": 'reg', "py": 'r[4] = (r[4] | r[0]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x29f30: {"kind": 'reg', "py": 'r[3] = 0xFFFFBB4F', "slot_py": None, "target": None, "cond": None},
    0x29f32: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBB4F, 1, r[4])', "target": None, "cond": None},}
