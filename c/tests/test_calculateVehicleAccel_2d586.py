#!/usr/bin/env python3
"""Differential test for calculateVehicleAccel (0x2D586) — v3 lift + v4 FPU, 26 bytes.
...
Run from repo root: python3 c/tests/test_calculateVehicleAccel_2d586.py
"""
...
ENTRY = 0x2D586
RAW = bytes.fromhex("91 1A D4 0E F4 18 F3 48 F2 4C C7 0D F2 31 D3 0D F3 08 F2 32 F3 2A 00 0B F4 4A")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBFBC
SPAN_END = 0x2D5A0
SENT = 0x2D5A0     # stop-sentinel, placed past the literal pool
