#!/usr/bin/env python3
"""Differential test for FUN_00056acc (0x56ACC) — v3 lift (branches + delay slots), 18 bytes.
...
Run from repo root: python3 c/tests/test_FUN_00056acc_56acc.py
"""
...
ENTRY = 0x56ACC
RAW = bytes.fromhex("D2 23 24 30 D3 25 60 30 80 41 00 0B 60 20 2F E6 2F D6")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    0x56acc: {"kind": 'reg', "py": 'r[2] = 0xFFFFD214', "slot_py": None, "target": None, "cond": None},
    0x56ace: {"kind": 'mem', "py": '_wrw(ram, r[4], 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x56ad0: {"kind": 'reg', "py": 'r[3] = 0xFFFFD213', "slot_py": None, "target": None, "cond": None},
    0x56ad2: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFD213, 1))', "slot_py": None, "target": None, "cond": None},
    0x56ad4: {"kind": 'mem', "py": '_wrw(ram, (r[4] + 1), 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x56ad6: {"kind": "ret", "py": None, "slot_py": 'r[0] = s8(_rdw(ram, 0xFFFFD214, 1))', "target": None, "cond": None},
    0x56ada: {"kind": 'mem', "py": 'local[0x3FC] = r[14]\n_wrw(ram, STACK_BASE + 0x3FC, 4, r[14])\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x56adc: {"kind": 'mem', "py": 'local[0x3F8] = r[13]\n_wrw(ram, STACK_BASE + 0x3F8, 4, r[13])\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},}
