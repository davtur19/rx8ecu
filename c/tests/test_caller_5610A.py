#!/usr/bin/env python3
"""Differential test for caller_5610A (entry 0x5610A) — v8 ST caller (CFG), 30 bytes.
...
Run: python3 test_caller_5610A.py
"""
...
CODE = {
    0x5610a: {"kind": 'fpu', "py": 'fr[6] = 0.0', "slot_py": None, "target": None, "cond": None},
    0x5610c: {"kind": 'st', "py": 'local[0x3FC] = pr\n_wrw(ram, STACK_BASE + 0x3FC, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x5610e: {"kind": 'reg', "py": 'r[3] = 0x0007A9BC', "slot_py": None, "target": None, "cond": None},
    0x56110: {"kind": 'reg', "py": 'r[2] = 0x0007A9C0', "slot_py": None, "target": None, "cond": None},
    0x56112: {"kind": 'fpu', "py": 'fr[4] = bits2f(_rdw(ram, 0x0007A9BC, 4))', "slot_py": None, "target": None, "cond": None},
    0x56114: {"kind": 'fpu', "py": 'fr[0] = bits2f(_rdw(ram, 0x0007A9C0, 4))', "slot_py": None, "target": None, "cond": None},
    0x56116: {"kind": 'reg', "py": 'r[1] = 0xFFFFAD88', "slot_py": None, "target": None, "cond": None},
    0x56118: {"kind": 'reg', "py": 'r[3] = 0x000024D0', "slot_py": None, "target": None, "cond": None},
    0x5611a: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFAD88, 4))', "slot_py": None, "target": None, "cond": None},
    0x5611c: {"kind": 'fpu', "py": 'fr[4] = ts(fr[0] * fr[3] + fr[4])', "slot_py": None, "target": None, "cond": None},
    0x5611e: {"kind": "call", "py": None, "slot_py": 'fr[5] = 1.0', "target": 0x24d0, "ret_pc": 0x56122, "set_pr": True, "cond": None},
    0x56122: {"kind": 'st', "py": 'pr = _rdw(ram, STACK_BASE + 0x3FC, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x56124: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},
