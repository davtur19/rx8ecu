#!/usr/bin/env python3
"""Differential test for counterFunction2 (0x25B40) — v3 lift (branches + delay slots), 10 bytes.
...
Run from repo root: python3 c/tests/test_counterFunction2_25b40.py
"""
...
ENTRY = 0x25B40
RAW = bytes.fromhex("D4 35 63 40 73 01 00 0B 24 30")
SEED = 0
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFB5CF
SPAN_END = 0x25B4A
SENT = 0x25B4A     # stop-sentinel, placed past the literal pool
