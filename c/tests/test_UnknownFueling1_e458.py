#!/usr/bin/env python3
"""Differential test for UnknownFueling1 (0xE458) — v3 lift + v4 FPU, 58 bytes.
...
Run from repo root: python3 c/tests/test_UnknownFueling1_e458.py
"""
...
ENTRY = 0xE458
RAW = bytes.fromhex("C7 1D F3 08 93 31 F2 38 F3 25 8F 14 00 09 F1 9D 94 2C F1 10 C7 19 F6 08 C7 19 D3 1A F4 38 F4 15 8D 03 F5 08 C7 18 A0 02 F3 08 C7 18 F3 08 F3 41 F0 6C F5 3E F4 5A 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFB594
SPAN_END = 0xE492
SENT = 0xE492     # stop-sentinel, placed past the literal pool
