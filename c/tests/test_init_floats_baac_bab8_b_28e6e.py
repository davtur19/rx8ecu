#!/usr/bin/env python3
"""Differential test for init_floats_baac_bab8_b (0x28E6E) — v3 lift + v4 FPU, 22 bytes.
...
Run from repo root: python3 c/tests/test_init_floats_baac_bab8_b_28e6e.py
"""
...
ENTRY = 0x28E6E
RAW = bytes.fromhex("C7 42 93 76 F4 08 F3 4A 92 74 F2 4A 91 73 F1 4A 93 72 00 0B F3 4A")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBAB8
SPAN_END = 0x28E84
SENT = 0x28E84     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x28e6e: {"kind": 'reg', "py": 'r[0] = 0x00028F78', "slot_py": None, "target": None, "cond": None},
    0x28e70: {"kind": 'reg', "py": 'r[3] = 0xFFFFBAAC', "slot_py": None, "target": None, "cond": None},
    0x28e72: {"kind": 'fpu', "py": 'fr[4] = bits2f(_rdw(ram, 0x00028F78, 4))', "slot_py": None, "target": None, "cond": None},
    0x28e74: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFBAAC, 4, f2bits(fr[4]))', "slot_py": None, "target": None, "cond": None},
    0x28e76: {"kind": 'reg', "py": 'r[2] = 0xFFFFBAB0', "slot_py": None, "target": None, "cond": None},
    0x28e78: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFBAB0, 4, f2bits(fr[4]))', "slot_py": None, "target": None, "cond": None},
    0x28e7a: {"kind": 'reg', "py": 'r[1] = 0xFFFFBAB4', "slot_py": None, "target": None, "cond": None},
    0x28e7c: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFBAB4, 4, f2bits(fr[4]))', "slot_py": None, "target": None, "cond": None},
    0x28e7e: {"kind": 'reg', "py": 'r[3] = 0xFFFFBAB8', "slot_py": None, "target": None, "cond": None},
    0x28e80: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBAB8, 4, f2bits(fr[4]))', "target": None, "cond": None},}
