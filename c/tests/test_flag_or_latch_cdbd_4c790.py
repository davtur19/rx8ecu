#!/usr/bin/env python3
"""Differential test for flag_or_latch_cdbd (0x4C790) — v3 lift (branches + delay slots), 40 bytes.
...
Run from repo root: python3 c/tests/test_flag_or_latch_cdbd_4c790.py
"""
...
ENTRY = 0x4C790
RAW = bytes.fromhex("94 66 93 66 60 30 60 0C 88 01 8D 06 00 09 92 61 60 20 60 0C 88 01 8F 03 00 09 E3 01 A0 02 24 30 E1 00 24 10 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCEF3
SPAN_END = 0x4C7B8
SENT = 0x4C7B8     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x4c790: {"kind": 'reg', "py": 'r[4] = 0xFFFFCDBD', "slot_py": None, "target": None, "cond": None},
    0x4c792: {"kind": 'reg', "py": 'r[3] = 0xFFFFCDC4', "slot_py": None, "target": None, "cond": None},
    0x4c794: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCDC4, 1))', "slot_py": None, "target": None, "cond": None},
    0x4c796: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x4c798: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x4c79a: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4c7aa, "cond": 'T'},
    0x4c79e: {"kind": 'reg', "py": 'r[2] = 0xFFFFCEF3', "slot_py": None, "target": None, "cond": None},
    0x4c7a0: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCEF3, 1))', "slot_py": None, "target": None, "cond": None},
    0x4c7a2: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x4c7a4: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x4c7a6: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4c7b0, "cond": 'notT'},
    0x4c7aa: {"kind": 'reg', "py": 'r[3] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x4c7ac: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFCDBD, 1, r[3])', "target": 0x4c7b4, "cond": 'always'},
    0x4c7b0: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x4c7b2: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCDBD, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x4c7b4: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
