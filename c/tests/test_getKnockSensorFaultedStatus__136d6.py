#!/usr/bin/env python3
"""Differential test for getKnockSensorFaultedStatus_ (0x136D6) — v3 lift (branches + delay slots), 40 bytes.
...
Run from repo root: python3 c/tests/test_getKnockSensorFaultedStatus__136d6.py
"""
...
ENTRY = 0x136D6
RAW = bytes.fromhex("D4 21 93 2A 60 30 60 0C 88 01 8F 09 00 09 92 25 60 20 60 0C 88 01 8F 03 00 09 E3 01 A0 02 24 30 E1 00 24 10 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCC32
SPAN_END = 0x136FE
SENT = 0x136FE     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x136d6: {"kind": 'reg', "py": 'r[4] = 0xFFFFA739', "slot_py": None, "target": None, "cond": None},
    0x136d8: {"kind": 'reg', "py": 'r[3] = 0xFFFFCC30', "slot_py": None, "target": None, "cond": None},
    0x136da: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCC30, 1))', "slot_py": None, "target": None, "cond": None},
    0x136dc: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x136de: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x136e0: {"kind": "branch", "py": None, "slot_py": '', "target": 0x136f6, "cond": 'notT'},
    0x136e4: {"kind": 'reg', "py": 'r[2] = 0xFFFFCC32', "slot_py": None, "target": None, "cond": None},
    0x136e6: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCC32, 1))', "slot_py": None, "target": None, "cond": None},
    0x136e8: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x136ea: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x136ec: {"kind": "branch", "py": None, "slot_py": '', "target": 0x136f6, "cond": 'notT'},
    0x136f0: {"kind": 'reg', "py": 'r[3] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x136f2: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFA739, 1, r[3])', "target": 0x136fa, "cond": 'always'},
    0x136f6: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x136f8: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA739, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x136fa: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
