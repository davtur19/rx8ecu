#!/usr/bin/env python3
"""Differential test for counter_decrement_2AAE0 (0x2AAE0) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_counter_decrement_2AAE0_2aae0.py
"""
...
CODE = {
    0x2aae0: {"kind": 'reg', "py": 'r[2] = 0xFFFFBBC8', "slot_py": None, "target": None, "cond": None},
    0x2aae2: {"kind": 'reg', "py": 'r[3] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x2aae4: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBBC8, 2, r[3])', "target": None, "cond": None},}
