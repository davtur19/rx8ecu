#!/usr/bin/env python3
"""Differential test for returnEngineRPM (0x5E57E) — v3 lift + v4 FPU, 12 bytes.
...
Run from repo root: python3 c/tests/test_returnEngineRPM_5e57e.py
"""
...
ENTRY = 0x5E57E
RAW = bytes.fromhex("93 48 00 0B F0 38 92 46 00 0B F0 28")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFB594
SPAN_END = 0x5E58A
SENT = 0x5E58A     # stop-sentinel, placed past the literal pool
