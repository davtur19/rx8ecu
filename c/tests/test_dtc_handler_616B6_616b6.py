#!/usr/bin/env python3
"""Differential test for dtc_handler_616B6 (0x616B6) — v3 lift (branches + delay slots), 18 bytes.
...
Run from repo root: python3 c/tests/test_dtc_handler_616B6_616b6.py
"""
...
ENTRY = 0x616B6
RAW = bytes.fromhex("36 1C 67 4D 47 19 37 4C 36 78 30 6C 80 5E 00 0B 25 41")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = None
SPAN_END = 0x616C8
SENT = 0x616C8     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x616b6: {"kind": 'reg', "py": 'r[6] = (r[6] + r[1]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x616b8: {"kind": 'reg', "py": 'r[7] = r[4] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x616ba: {"kind": 'reg', "py": 'r[7] = (r[7] >> 8) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x616bc: {"kind": 'reg', "py": 'r[7] = (r[7] + r[4]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x616be: {"kind": 'reg', "py": 'r[6] = (r[6] - r[7]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x616c0: {"kind": 'reg', "py": 'r[0] = (r[0] + r[6]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x616c2: {"kind": 'mem', "py": '_wrw(ram, (r[5] + 14), 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x616c4: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, r[5], 2, r[4])', "target": None, "cond": None},}
