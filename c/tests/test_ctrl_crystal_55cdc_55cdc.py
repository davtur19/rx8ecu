#!/usr/bin/env python3
"""Differential test for ctrl_crystal_55cdc (0x55CDC) — v3 lift (branches + delay slots), 12 bytes.
...
Run from repo root: python3 c/tests/test_ctrl_crystal_55cdc_55cdc.py
"""
...
RAM_MAX = 0xFFFFD2C5
SPAN_END = 0x55CE8
SENT = 0x55CE8     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x55cdc: {"kind": 'reg', "py": 'r[3] = 0xFFFFD2C4', "slot_py": None, "target": None, "cond": None},
    0x55cde: {"kind": "ret", "py": None, "slot_py": 'r[0] = s8(_rdw(ram, 0xFFFFD2C4, 1))', "target": None, "cond": None},
    0x55ce2: {"kind": 'reg', "py": 'r[2] = 0xFFFFD2C5', "slot_py": None, "target": None, "cond": None},
    0x55ce4: {"kind": "ret", "py": None, "slot_py": 'r[0] = s8(_rdw(ram, 0xFFFFD2C5, 1))', "target": None, "cond": None},}
