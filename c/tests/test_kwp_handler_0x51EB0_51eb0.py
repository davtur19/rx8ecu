#!/usr/bin/env python3
"""Differential test for kwp_handler_0x51EB0 (0x51EB0) — v3 lift (branches + delay slots), 34 bytes.
...
Run from repo root: python3 c/tests/test_kwp_handler_0x51EB0_51eb0.py
"""
...
ENTRY = 0x51EB0
RAW = bytes.fromhex("00 09 92 52 61 20 21 18 8F 03 00 09 93 4E A0 06 23 60 60 53 88 01 8F 02 00 09 92 47 22 70 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCFAB
SPAN_END = 0x51ED2
SENT = 0x51ED2     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x51eb0: {"kind": 'reg', "py": None, "slot_py": None, "target": None, "cond": None},
    0x51eb2: {"kind": 'reg', "py": 'r[2] = 0xFFFFA428', "slot_py": None, "target": None, "cond": None},
    0x51eb4: {"kind": 'mem', "py": 'r[1] = s8(_rdw(ram, 0xFFFFA428, 1))', "slot_py": None, "target": None, "cond": None},
    0x51eb6: {"kind": 'reg', "py": 'T = 1 if (r[1] & r[1]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x51eb8: {"kind": "branch", "py": None, "slot_py": '', "target": 0x51ec2, "cond": 'notT'},
    0x51ebc: {"kind": 'reg', "py": 'r[3] = 0xFFFFCFAB', "slot_py": None, "target": None, "cond": None},
    0x51ebe: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFCFAB, 1, r[6])', "target": 0x51ece, "cond": 'always'},
    0x51ec2: {"kind": 'reg', "py": 'r[0] = r[5]', "slot_py": None, "target": None, "cond": None},
    0x51ec4: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x51ec6: {"kind": "branch", "py": None, "slot_py": '', "target": 0x51ece, "cond": 'notT'},
    0x51eca: {"kind": 'reg', "py": 'r[2] = 0xFFFFCFAB', "slot_py": None, "target": None, "cond": None},
    0x51ecc: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCFAB, 1, r[7])', "slot_py": None, "target": None, "cond": None},
    0x51ece: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
