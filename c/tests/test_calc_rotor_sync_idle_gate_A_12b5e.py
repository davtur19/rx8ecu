#!/usr/bin/env python3
"""Differential test for calc_rotor_sync_idle_gate_A (0x12B5E) — v3 lift + v4 FPU, 18 bytes.
...
Run from repo root: python3 c/tests/test_calc_rotor_sync_idle_gate_A_12b5e.py
"""
...
RAM_MAX = 0xFFFFA6A4
SPAN_END = 0x12B70
SENT = 0x12B70     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x12b5e: {"kind": 'fpu', "py": 'fr[3] = 0.0', "slot_py": None, "target": None, "cond": None},
    0x12b60: {"kind": 'reg', "py": 'r[0] = 0xFFFFA694', "slot_py": None, "target": None, "cond": None},
    0x12b62: {"kind": 'reg', "py": 'r[4] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x12b64: {"kind": 'reg', "py": 'r[3] = 0xFFFFA6A3', "slot_py": None, "target": None, "cond": None},
    0x12b66: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFA694, 4, f2bits(fr[3]))', "slot_py": None, "target": None, "cond": None},
    0x12b68: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA6A3, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x12b6a: {"kind": 'reg', "py": 'r[2] = 0xFFFFA6A4', "slot_py": None, "target": None, "cond": None},
    0x12b6c: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFA6A4, 1, r[4])', "target": None, "cond": None},}
