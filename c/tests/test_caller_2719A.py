#!/usr/bin/env python3
"""Differential test for caller_2719A (entry 0x2719A) — v8 ST caller (CFG), 30 bytes.
...
Run: python3 test_caller_2719A.py
"""
...
CODE = {
    0x2719a: {"kind": 'st', "py": 'local[0x3FC] = pr\n_wrw(ram, STACK_BASE + 0x3FC, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x2719c: {"kind": 'reg', "py": 'r[0] = 0x00027238', "slot_py": None, "target": None, "cond": None},
    0x2719e: {"kind": 'fpu', "py": 'fr[7] = bits2f(_rdw(ram, 0x00027238, 4))', "slot_py": None, "target": None, "cond": None},
    0x271a0: {"kind": 'reg', "py": 'r[3] = 0x0007524C', "slot_py": None, "target": None, "cond": None},
    0x271a2: {"kind": 'fpu', "py": 'fr[6] = bits2f(_rdw(ram, 0x0007524C, 4))', "slot_py": None, "target": None, "cond": None},
    0x271a4: {"kind": 'reg', "py": 'r[2] = 0xFFFFB614', "slot_py": None, "target": None, "cond": None},
    0x271a6: {"kind": 'fpu', "py": 'fr[5] = bits2f(_rdw(ram, 0xFFFFB614, 4))', "slot_py": None, "target": None, "cond": None},
    0x271a8: {"kind": 'reg', "py": 'r[1] = 0xFFFFB650', "slot_py": None, "target": None, "cond": None},
    0x271aa: {"kind": 'reg', "py": 'r[3] = 0x000023B0', "slot_py": None, "target": None, "cond": None},
    0x271ac: {"kind": "call", "py": None, "slot_py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFB650, 4))', "target": 0x23b0, "ret_pc": 0x271b0, "set_pr": True, "cond": None},
    0x271b0: {"kind": 'reg', "py": 'r[2] = 0xFFFFB614', "slot_py": None, "target": None, "cond": None},
    0x271b2: {"kind": 'st', "py": 'pr = _rdw(ram, STACK_BASE + 0x3FC, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x271b4: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFB614, 4, f2bits(fr[0]))', "target": None, "cond": None},
