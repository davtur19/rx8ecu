#!/usr/bin/env python3
"""Differential test for caller_25DAC (entry 0x25DAC) — v8 ST caller (CFG), 14 bytes.
...
Run: python3 test_caller_25DAC.py
"""
...
CODE = {
    0x25dac: {"kind": 'st', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x25dae: {"kind": 'reg', "py": 'r[3] = 0x00025D98', "slot_py": None, "target": None, "cond": None},
    0x25db0: {"kind": "call", "py": None, "slot_py": '', "target": 0x25d98, "ret_pc": 0x25db4, "set_pr": True, "cond": None},
    0x25db4: {"kind": 'reg', "py": 'r[2] = 0x00025DF0', "slot_py": None, "target": None, "cond": None},
    0x25db6: {"kind": "call", "py": None, "slot_py": 'pr = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": 0x25df0, "ret_pc": 0x25dba, "set_pr": False, "cond": None},
    0x25d98: {"kind": 'reg', "py": 'r[2] = 0xFFFFB5D4', "slot_py": None, "target": None, "cond": None},
    0x25d9a: {"kind": 'reg', "py": 'r[3] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x25d9c: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFB5D4, 1, r[3])', "target": None, "cond": None},
    0x25df0: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},
}
