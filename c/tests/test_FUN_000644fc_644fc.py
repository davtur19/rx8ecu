#!/usr/bin/env python3
"""Differential test for FUN_000644fc (0x644FC) — pure straight-line lift, 8 bytes.
...
Run from repo root: python3 c/tests/test_FUN_000644fc_644fc.py
"""
...
ENTRY = 0x644FC
RAW = bytes.fromhex("05 67 75 01 03 1A 33 7C")
SEED = 42
N = 2000
...
def spec_mirror(r4, r5, r6, r7):
    ...
    # 0x0644FC: op 0x0567
    macl = (s32(r[5]) * s32(r[6])) & 0xFFFFFFFF
    # 0x0644FE: op 0x7501
    r[5] = (r[5] + s8(0x01)) & 0xFFFFFFFF
    # 0x064500: op 0x031A
    r[3] = macl
    # 0x064502: op 0x337C
    r[3] = (r[3] + r[7]) & 0xFFFFFFFF
