#!/usr/bin/env python3
"""Differential test for nothingFunc2 (0x5EE7E) — pure straight-line lift, 16 bytes.
...
Run from repo root: python3 c/tests/test_nothingFunc2_5ee7e.py
"""
...
ENTRY = 0x5EE7E
RAW = bytes.fromhex("91 98 91 9A 91 9C 91 9E 91 A0 91 A2 91 A4 91 A6")
SEED = 42
N = 2000
