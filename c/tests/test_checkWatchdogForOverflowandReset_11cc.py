#!/usr/bin/env python3
"""Differential test for checkWatchdogForOverflowandReset (0x11CC) — v3 lift (branches + delay slots), 46 bytes.
...
Run from repo root: python3 c/tests/test_checkWatchdogForOverflowandReset_11cc.py
"""
...
ENTRY = 0x11CC
RAW = bytes.fromhex("95 54 D4 2D 60 50 60 0C C8 80 89 0E D2 2B 25 21 93 4D D2 2B 61 31 21 2A 23 11 63 41 D1 29 63 3D 33 13 89 02 60 41 70 01 24 01 00 0B 60 41")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFF738
SPAN_END = 0x11FA
SENT = 0x11FA     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x11cc: {"kind": 'reg', "py": 'r[5] = 0xFFFFEC10', "slot_py": None, "target": None, "cond": None},
    0x11ce: {"kind": 'reg', "py": 'r[4] = 0xFFFFDFA0', "slot_py": None, "target": None, "cond": None},
    0x11d0: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFEC10, 1))', "slot_py": None, "target": None, "cond": None},
    0x11d2: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x11d4: {"kind": 'reg', "py": 'T = 1 if (r[0] & 0x80) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x11d6: {"kind": "branch", "py": None, "slot_py": None, "target": 0x11f6, "cond": 'T'},
    0x11d8: {"kind": 'reg', "py": 'r[2] = 0x0000A53C', "slot_py": None, "target": None, "cond": None},
    0x11da: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFEC10, 2, r[2])', "slot_py": None, "target": None, "cond": None},
    0x11dc: {"kind": 'reg', "py": 'r[3] = 0xFFFFF738', "slot_py": None, "target": None, "cond": None},
    0x11de: {"kind": 'reg', "py": 'r[2] = 0x00008000', "slot_py": None, "target": None, "cond": None},
    0x11e0: {"kind": 'mem', "py": 'r[1] = s16(_rdw(ram, 0xFFFFF738, 2))', "slot_py": None, "target": None, "cond": None},
    0x11e2: {"kind": 'reg', "py": 'r[1] = (r[1] ^ r[2]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x11e4: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFF738, 2, r[1])', "slot_py": None, "target": None, "cond": None},
    0x11e6: {"kind": 'mem', "py": 'r[3] = s16(_rdw(ram, 0xFFFFDFA0, 2))', "slot_py": None, "target": None, "cond": None},
    0x11e8: {"kind": 'reg', "py": 'r[1] = 0x0000FFFF', "slot_py": None, "target": None, "cond": None},
    0x11ea: {"kind": 'reg', "py": 'r[3] = r[3] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x11ec: {"kind": 'reg', "py": 'T = 1 if s32(r[3]) >= s32(r[1]) else 0', "slot_py": None, "target": None, "cond": None},
    0x11ee: {"kind": "branch", "py": None, "slot_py": None, "target": 0x11f6, "cond": 'T'},
    0x11f0: {"kind": 'mem', "py": 'r[0] = s16(_rdw(ram, 0xFFFFDFA0, 2))', "slot_py": None, "target": None, "cond": None},
    0x11f2: {"kind": 'reg', "py": 'r[0] = (r[0] + s8(0x01)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x11f4: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFDFA0, 2, r[0])', "slot_py": None, "target": None, "cond": None},
    0x11f6: {"kind": "ret", "py": None, "slot_py": 'r[0] = s16(_rdw(ram, 0xFFFFDFA0, 2))', "target": None, "cond": None},}
