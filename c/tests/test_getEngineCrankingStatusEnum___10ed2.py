#!/usr/bin/env python3
"""Differential test for getEngineCrankingStatusEnum__ (0x10ED2) — v3 lift (branches + delay slots), 20 bytes.
...
Run from repo root: python3 c/tests/test_getEngineCrankingStatusEnum___10ed2.py
"""
...
ENTRY = 0x10ED2
RAW = bytes.fromhex("92 69 63 20 23 38 8F 02 00 09 A0 01 E4 01 E4 02 00 0B 60 43")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFA79C
SPAN_END = 0x10EE6
SENT = 0x10EE6     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x10ed2: {"kind": 'reg', "py": 'r[2] = 0xFFFFA79C', "slot_py": None, "target": None, "cond": None},
    0x10ed4: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFA79C, 1))', "slot_py": None, "target": None, "cond": None},
    0x10ed6: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x10ed8: {"kind": "branch", "py": None, "slot_py": '', "target": 0x10ee0, "cond": 'notT'},
    0x10edc: {"kind": "branch", "py": None, "slot_py": 'r[4] = s8(0x01)', "target": 0x10ee2, "cond": 'always'},
    0x10ee0: {"kind": 'reg', "py": 'r[4] = s8(0x02)', "slot_py": None, "target": None, "cond": None},
    0x10ee2: {"kind": "ret", "py": None, "slot_py": 'r[0] = r[4]', "target": None, "cond": None},}
