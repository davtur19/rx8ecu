#!/usr/bin/env python3
"""Differential test for calc_manifold_pressure_error_clamp_10A5C (0x10A5C) — v3 lift (branches + delay slots), 44 bytes.
...
Run from repo root: python3 c/tests/test_calc_manifold_pressure_error_clamp_10A5C_10a5c.py
"""
...
CODE = {
    0x10a5c: {"kind": 'reg', "py": 'r[1] = 0xFFFFA5D4', "slot_py": None, "target": None, "cond": None},
    0x10a5e: {"kind": 'mem', "py": 'r[2] = s8(_rdw(ram, 0xFFFFA5D4, 1))', "slot_py": None, "target": None, "cond": None},
    0x10a60: {"kind": 'reg', "py": 'r[3] = 0x001E0000', "slot_py": None, "target": None, "cond": None},
    0x10a62: {"kind": 'reg', "py": 'r[2] = r[2] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x10a64: {"kind": 'reg', "py": 'r[5] = 0x02D00000', "slot_py": None, "target": None, "cond": None},
    0x10a66: {"kind": 'reg', "py": 'macl = (s32(r[2]) * s32(r[3])) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x10a68: {"kind": 'reg', "py": 'r[2] = macl', "slot_py": None, "target": None, "cond": None},
    0x10a6a: {"kind": 'reg', "py": 'r[2] = (r[2] - r[4]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x10a6c: {"kind": 'reg', "py": 'r[4] = 0xFFFB0000', "slot_py": None, "target": None, "cond": None},
    0x10a6e: {"kind": 'reg', "py": 'r[4] = (r[4] + r[2]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x10a70: {"kind": 'reg', "py": 'T = 1 if s32(r[4]) >= s32(r[5]) else 0', "slot_py": None, "target": None, "cond": None},
    0x10a72: {"kind": "branch", "py": None, "slot_py": '', "target": 0x10a7c, "cond": 'notT'},
    0x10a76: {"kind": 'reg', "py": 'r[0] = 0xFD300000', "slot_py": None, "target": None, "cond": None},
    0x10a78: {"kind": "branch", "py": None, "slot_py": 'r[4] = (r[4] + r[0]) & 0xFFFFFFFF', "target": 0x10a84, "cond": 'always'},
    0x10a7c: {"kind": 'reg', "py": 'T = 1 if s32(r[4]) >= 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x10a7e: {"kind": "branch", "py": None, "slot_py": '', "target": 0x10a84, "cond": 'T'},
    0x10a82: {"kind": 'reg', "py": 'r[4] = (r[4] + r[5]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x10a84: {"kind": "ret", "py": None, "slot_py": 'r[0] = r[4]', "target": None, "cond": None},}
