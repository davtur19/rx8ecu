#!/usr/bin/env python3
"""Differential test for mem_flag_e2d0 (0xE2D0) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_mem_flag_e2d0_e2d0.py
"""
...
CODE = {
    0xe2d0: {"kind": 'reg', "py": 'r[1] = 0xFFFFA405', "slot_py": None, "target": None, "cond": None},
    0xe2d2: {"kind": 'reg', "py": 'r[2] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0xe2d4: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFA405, 1, r[2])', "target": None, "cond": None},}
