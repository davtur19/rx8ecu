#!/usr/bin/env python3
"""Differential test for counter_modulo_saturation_2CB58 (0x2CB58) — v3 lift (branches + delay slots), 18 bytes.
...
Run from repo root: python3 c/tests/test_counter_modulo_saturation_2CB58_2cb58.py
"""
...
ENTRY = 0x2CB58
RAW = bytes.fromhex("00 09 E0 06 A0 03 24 00 A0 01 24 50 24 50 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
CODE = {
    0x2cb58: {"kind": 'reg', "py": None, "slot_py": None, "target": None, "cond": None},
    0x2cb5a: {"kind": 'reg', "py": 'r[0] = s8(0x06)', "slot_py": None, "target": None, "cond": None},
    0x2cb5c: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, r[4], 1, r[0])', "target": 0x2cb66, "cond": 'always'},
    0x2cb60: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, r[4], 1, r[5])', "target": 0x2cb66, "cond": 'always'},
