#!/usr/bin/env python3
"""Differential test for FUN_00064e16 (0x64E16) — pure straight-line lift, 8 bytes.
...
Run from repo root: python3 c/tests/test_FUN_00064e16_64e16.py
"""
...
ENTRY = 0x64E16
RAW = bytes.fromhex("00 09 61 4C E2 01 31 23")
SEED = 42
N = 2000
