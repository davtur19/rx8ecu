#!/usr/bin/env python3
"""Differential test for oxygen_sensor_monitor_0x4F9C2 (0x4F9C2) — v3 lift (branches + delay slots), 24 bytes.
...
Run from repo root: python3 c/tests/test_oxygen_sensor_monitor_0x4F9C2_4f9c2.py
"""
...
ENTRY = 0x4F9C2
RAW = bytes.fromhex("8F 04 00 09 E1 01 92 3B A0 03 22 10 E0 00 93 37 23 00 4F 26 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCEF4
SPAN_END = 0x4F9DA
SENT = 0x4F9DA     # stop-sentinel, placed past the literal pool
...
CODE = {
    ...
    0x4f9ca: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFCEF4, 1, r[1])', "target": 0x4f9d4, "cond": 'always'},
    ...
    0x4f9d2: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCEF4, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x4f9d4: {"kind": 'mem', "py": 'pr = _rdw(ram, STACK_BASE + 0x400, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
