#!/usr/bin/env python3
"""Differential test for caller_55FE8 (entry 0x55FE8) — v8 ST caller (CFG), 30 bytes.
...
Run: python3 test_caller_55FE8.py
"""
...
CODE = {
    0x55fe8: {"kind": 'st', "py": 'local[0x3FC] = pr\n_wrw(ram, STACK_BASE + 0x3FC, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x55fea: {"kind": 'reg', "py": 'r[0] = 0x000560C4', "slot_py": None, "target": None, "cond": None},
    0x55fec: {"kind": 'reg', "py": 'r[3] = 0xFFFFB0E4', "slot_py": None, "target": None, "cond": None},
    0x55fee: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x000560C4, 4))', "slot_py": None, "target": None, "cond": None},
    0x55ff0: {"kind": 'fpu', "py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFB0E4, 4))', "slot_py": None, "target": None, "cond": None},
    0x55ff2: {"kind": 'fpu', "py": 'fr[4] = ts(fr[4] * fr[3])', "slot_py": None, "target": None, "cond": None},
    0x55ff4: {"kind": 'reg', "py": 'r[0] = 0x000560C8', "slot_py": None, "target": None, "cond": None},
    0x55ff6: {"kind": 'fpu', "py": 'fr[6] = bits2f(_rdw(ram, 0x000560C8, 4))', "slot_py": None, "target": None, "cond": None},
    0x55ff8: {"kind": 'reg', "py": 'r[0] = 0x000560CC', "slot_py": None, "target": None, "cond": None},
    0x55ffa: {"kind": 'reg', "py": 'r[3] = 0x000024D0', "slot_py": None, "target": None, "cond": None},
    0x55ffc: {"kind": "call", "py": None, "slot_py": 'fr[5] = bits2f(_rdw(ram, 0x000560CC, 4))', "target": 0x24d0, "ret_pc": 0x56000, "set_pr": True, "cond": None},
    0x56000: {"kind": 'st', "py": 'pr = _rdw(ram, STACK_BASE + 0x3FC, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x56002: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},
