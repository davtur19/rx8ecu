#!/usr/bin/env python3
"""Differential test for sensor_extract_606a8 (0x606A8) — v3 lift + v4 FPU, 12 bytes.
...
Run from repo root: python3 c/tests/test_sensor_extract_606a8_606a8.py
"""
...
RAM_MAX = 0xFFFFD3F4
SPAN_END = 0x606B4
SENT = 0x606B4     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x606a8: {"kind": 'reg', "py": 'r[2] = 0xFFFFD3F4', "slot_py": None, "target": None, "cond": None},
    0x606aa: {"kind": "ret", "py": None, "slot_py": 'fr[0] = bits2f(_rdw(ram, 0xFFFFD3F4, 4))', "target": None, "cond": None},
    0x606ae: {"kind": 'reg', "py": 'r[3] = 0xFFFFB5B8', "slot_py": None, "target": None, "cond": None},
    0x606b0: {"kind": "ret", "py": None, "slot_py": 'fr[0] = bits2f(_rdw(ram, 0xFFFFB5B8, 4))', "target": None, "cond": None},}
