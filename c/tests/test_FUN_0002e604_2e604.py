#!/usr/bin/env python3
"""Differential test for FUN_0002e604 (0x2E604) — v3 lift (branches + delay slots), 54 bytes.
...
Run from repo root: python3 c/tests/test_FUN_0002e604_2e604.py
"""
...
ENTRY = 0x2E604
RAW = bytes.fromhex("94 2A 93 2A 60 30 60 0C 88 01 8F 07 00 09 D2 15 90 24 61 20 61 1C 31 00 8D 06 00 09 D3 11 60 30 60 0C 88 01 8F 03 00 09 E3 01 A0 02 24 30 E1 00 24 10 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFD1B0
SPAN_END = 0x2E63A
SENT = 0x2E63A     # stop-sentinel, placed past the literal pool
