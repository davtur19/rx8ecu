#!/usr/bin/env python3
"""Differential test for cal_countdown_b6f8_b6ea (0x27592) — v3 lift + v4 FPU, 58 bytes.
...
Run from repo root: python3 c/tests/test_cal_countdown_b6f8_b6ea_27592.py
"""
...
ENTRY = 0x27592
RAW = bytes.fromhex("D5 39 D4 39 D3 3A 92 5B F3 38 F2 28 F3 25 8D 05 E6 00 D1 37 60 11 24 01 A0 0D 25 60 61 41 61 1D 41 15 8F 06 00 09 25 60 D2 33 61 41 31 2C A0 02 24 11 E2 01 25 20 00 0B 00 09")
SEED = 43
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFC16C
SPAN_END = 0x275CC
SENT = 0x275CC     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x27592: {"kind": 'reg', "py": 'r[5] = 0xFFFFB6EA', "slot_py": None, "target": None, "cond": None},
    0x27594: {"kind": 'reg', "py": 'r[4] = 0xFFFFB6F8', "slot_py": None, "target": None, "cond": None},
    0x27596: {"kind": 'reg', "py": 'r[3] = 0x000751A8', "slot_py": None, "target": None, "cond": None},
    0x27598: {"kind": 'reg', "py": 'r[2] = 0xFFFFC16C', "slot_py": None, "target": None, "cond": None},
    0x2759a: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x000751A8, 4))', "slot_py": None, "target": None, "cond": None},
    0x2759c: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0xFFFFC16C, 4))', "slot_py": None, "target": None, "cond": None},
    0x2759e: {"kind": 'fpu', "py": 'T = 1 if fr[3] > fr[2] else 0', "slot_py": None, "target": None, "cond": None},
    0x275a0: {"kind": "branch", "py": None, "slot_py": 'r[6] = s8(0x00)', "target": 0x275ae, "cond": 'T'},
    0x275a4: {"kind": 'reg', "py": 'r[1] = 0x00075198', "slot_py": None, "target": None, "cond": None},
    0x275a6: {"kind": 'mem', "py": 'r[0] = s16(_rdw(ram, 0x00075198, 2))', "slot_py": None, "target": None, "cond": None},
    0x275a8: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFB6F8, 2, r[0])', "slot_py": None, "target": None, "cond": None},
    0x275aa: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFB6EA, 1, r[6])', "target": 0x275c8, "cond": 'always'},
    0x275ae: {"kind": 'mem', "py": 'r[1] = s16(_rdw(ram, r[4], 2))', "slot_py": None, "target": None, "cond": None},
    0x275b0: {"kind": 'reg', "py": 'r[1] = r[1] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x275b2: {"kind": 'reg', "py": 'T = 1 if s32(r[1]) > 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x275b4: {"kind": "branch", "py": None, "slot_py": '', "target": 0x275c4, "cond": 'notT'},
    0x275b8: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFB6EA, 1, r[6])', "slot_py": None, "target": None, "cond": None},
    0x275ba: {"kind": 'reg', "py": 'r[2] = 0x0000FFFF', "slot_py": None, "target": None, "cond": None},
    0x275bc: {"kind": 'mem', "py": 'r[1] = s16(_rdw(ram, 0xFFFFB6F8, 2))', "slot_py": None, "target": None, "cond": None},
    0x275be: {"kind": 'reg', "py": 'r[1] = (r[1] + r[2]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x275c0: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFB6F8, 2, r[1])', "target": 0x275c8, "cond": 'always'},
    0x275c4: {"kind": 'reg', "py": 'r[2] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x275c6: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFB6EA, 1, r[2])', "slot_py": None, "target": None, "cond": None},
    0x275c8: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
