#!/usr/bin/env python3
"""Differential test for FUN_0001aca0 (0x1ACA0) — v3 lift + v4 FPU, 14 bytes.
...
Run from repo root: python3 c/tests/test_FUN_0001aca0_1aca0.py
"""
...
RAM_MAX = 0xFFFFAA7C
SPAN_END = 0x1ACAE
SENT = 0x1ACAE     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x1aca0: {"kind": 'reg', "py": 'r[3] = 0xFFFFAA70', "slot_py": None, "target": None, "cond": None},
    0x1aca2: {"kind": 'fpu', "py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFAA70, 4))', "slot_py": None, "target": None, "cond": None},
    0x1aca4: {"kind": 'reg', "py": 'r[2] = 0xFFFFAA74', "slot_py": None, "target": None, "cond": None},
    0x1aca6: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFAA74, 4, f2bits(fr[4]))', "slot_py": None, "target": None, "cond": None},
    0x1aca8: {"kind": 'reg', "py": 'r[1] = 0xFFFFAA7C', "slot_py": None, "target": None, "cond": None},
    0x1acaa: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFAA7C, 4, f2bits(fr[4]))', "target": None, "cond": None},}
