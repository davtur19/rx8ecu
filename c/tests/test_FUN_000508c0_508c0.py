#!/usr/bin/env python3
"""Differential test for FUN_000508c0 (0x508C0) — pure straight-line lift, 10 bytes.
...
Run from repo root: python3 c/tests/test_FUN_000508c0_508c0.py
"""
...
ENTRY = 0x508C0
RAW = bytes.fromhex("D1 82 D0 77 D0 78 D0 79 D0 7A")
SEED = 42
N = 2000
