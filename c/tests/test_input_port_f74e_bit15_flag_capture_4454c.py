#!/usr/bin/env python3
"""Differential test for input_port_f74e_bit15_flag_capture (0x4454C) — v3 lift (branches + delay slots), 18 bytes.
...
Run from repo root: python3 c/tests/test_input_port_f74e_bit15_flag_capture_4454c.py
"""
...
ENTRY = 0x4454C
RAW = bytes.fromhex("93 22 62 31 62 2D D1 11 22 18 03 29 D1 10 00 0B 21 30")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFF74E
SPAN_END = 0x4455E
SENT = 0x4455E     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x4454c: {"kind": 'reg', "py": 'r[3] = 0xFFFFF74E', "slot_py": None, "target": None, "cond": None},
    0x4454e: {"kind": 'mem', "py": 'r[2] = s16(_rdw(ram, 0xFFFFF74E, 2))', "slot_py": None, "target": None, "cond": None},
    0x44550: {"kind": 'reg', "py": 'r[2] = r[2] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x44552: {"kind": 'reg', "py": 'r[1] = 0x00008000', "slot_py": None, "target": None, "cond": None},
    0x44554: {"kind": 'reg', "py": 'T = 1 if (r[2] & r[1]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x44556: {"kind": 'reg', "py": 'r[3] = T;', "slot_py": None, "target": None, "cond": None},
    0x44558: {"kind": 'reg', "py": 'r[1] = 0xFFFFCAA1', "slot_py": None, "target": None, "cond": None},
    0x4455a: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFCAA1, 1, r[3])', "target": None, "cond": None},}
