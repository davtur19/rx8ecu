#!/usr/bin/env python3
"""Differential test for port_input_handler_0x4F1E6 (0x4F1E6) — v3 lift (branches + delay slots), 48 bytes.
...
Run from repo root: python3 c/tests/test_port_input_handler_0x4F1E6_4f1e6.py
"""
...
ENTRY = 0x4F1E6
RAW = bytes.fromhex("E4 01 93 62 95 60 60 31 60 0D 20 49 20 08 00 29 CA 01 88 01 8F 02 00 09 A0 01 60 43 E0 00 88 01 8F 02 00 09 A0 02 25 40 E2 00 25 20 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    0x4f1e6: {"kind": 'reg', "py": 'r[4] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x4f1e8: {"kind": 'reg', "py": 'r[3] = 0xFFFFF74E', "slot_py": None, "target": None, "cond": None},
    0x4f1ea: {"kind": 'reg', "py": 'r[5] = 0xFFFFCFF4', "slot_py": None, "target": None, "cond": None},
    0x4f1ec: {"kind": 'mem', "py": 'r[0] = s16(_rdw(ram, 0xFFFFF74E, 2))', "slot_py": None, "target": None, "cond": None},
    0x4f1ee: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x4f1f0: {"kind": 'reg', "py": 'r[0] = (r[0] & r[4]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x4f1f2: {"kind": 'reg', "py": 'T = 1 if (r[0] & r[0]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x4f1f4: {"kind": 'reg', "py": 'r[0] = T;', "slot_py": None, "target": None, "cond": None},
    0x4f1f6: {"kind": 'reg', "py": 'r[0] = (r[0] ^ 0x01) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x4f1f8: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x4f1fa: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4f202, "cond": 'notT'},
    0x4f1fe: {"kind": "branch", "py": None, "slot_py": 'r[0] = r[4]', "target": 0x4f204, "cond": 'always'},
    0x4f202: {"kind": 'reg', "py": 'r[0] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x4f204: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x4f206: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4f20e, "cond": 'notT'},
    0x4f20a: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFCFF4, 1, r[4])', "target": 0x4f212, "cond": 'always'},
    0x4f20e: {"kind": 'reg', "py": 'r[2] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x4f210: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCFF4, 1, r[2])', "slot_py": None, "target": None, "cond": None},
    0x4f212: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
