#!/usr/bin/env python3
"""Differential test for diag_check_121cc (0x121CC) — v3 lift (branches + delay slots), 14 bytes.
...
Run from repo root: python3 c/tests/test_diag_check_121cc_121cc.py
"""
...
ENTRY = 0x121CC
RAW = bytes.fromhex("D3 06 60 30 60 0C 88 01 04 29 00 0B 60 43")
SEED = 42
N = 500
MAXSTEPS = 100000
