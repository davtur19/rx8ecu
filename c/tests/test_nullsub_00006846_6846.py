#!/usr/bin/env python3
"""Differential test for nullsub_00006846 (0x6846) — v3 lift (branches + delay slots), 32 bytes.
...
Run from repo root: python3 c/tests/test_nullsub_00006846_6846.py
"""
...
ENTRY = 0x6846
RAW = bytes.fromhex("25 40 D5 15 64 52 D6 15 63 43 62 62 61 43 23 4B 23 29 21 49 23 1B 26 32 25 42 4F 26 00 0B 6E F6")
SEED = 0
N = 2000
MAXSTEPS = 100000
