#!/usr/bin/env python3
"""Differential test for call-composition caller_49AC0 (entry 0x49AC0) — v7 ST caller + callee lib, flattened CODE with nested returns.
...
Run: python3 /home/davide/ailocal/rx8ecu/c/tests/test_caller_49AC0.py
"""
...
CODE = {
    0x49ac0: {"kind": 'reg', "py": 'r[3] = 0xFFFFB33F', "slot_py": None, "target": None, "cond": None},
    0x49ac2: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFB33F, 1))', "slot_py": None, "target": None, "cond": None},
    0x49ac4: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x49ac6: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x49ac8: {"kind": "branch", "py": None, "slot_py": '', "target": 0x49af0, "cond": 'T'},
    0x49acc: {"kind": 'reg', "py": 'r[2] = 0xFFFFC098', "slot_py": None, "target": None, "cond": None},
    0x49ace: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFC098, 1))', "slot_py": None, "target": None, "cond": None},
    0x49ad0: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x49ad2: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x49ad4: {"kind": "branch", "py": None, "slot_py": '', "target": 0x49af0, "cond": 'T'},
    0x49ad8: {"kind": 'reg', "py": 'r[1] = 0xFFFFCCFC', "slot_py": None, "target": None, "cond": None},
    0x49ada: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCCFC, 1))', "slot_py": None, "target": None, "cond": None},
    0x49adc: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x49ade: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x49ae0: {"kind": "branch", "py": None, "slot_py": '', "target": 0x49af0, "cond": 'T'},
    0x49ae4: {"kind": 'reg', "py": 'r[3] = 0xFFFFCCFB', "slot_py": None, "target": None, "cond": None},
    0x49ae6: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCCFB, 1))', "slot_py": None, "target": None, "cond": None},
    0x49ae8: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x49aea: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x49aec: {"kind": "branch", "py": None, "slot_py": '', "target": 0x49af4, "cond": 'notT'},
    0x49af0: {"kind": "branch", "py": None, "slot_py": 'r[5] = s8(0x01)', "target": 0x49af6, "cond": 'T'},
