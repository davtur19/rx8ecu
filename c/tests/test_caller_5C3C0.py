#!/usr/bin/env python3
"""Differential test for caller_5C3C0 (entry 0x5C3C0) — v8 ST caller (CFG), 62 bytes.
...
Run: python3 test_caller_5C3C0.py
"""
...
CODE = {
    0x5c3c0: {"kind": 'mem', "py": 'local[0x3FC] = r[14]\n_wrw(ram, STACK_BASE + 0x3FC, 4, r[14])\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x5c3c2: {"kind": 'st', "py": 'local[0x3F8] = pr\n_wrw(ram, STACK_BASE + 0x3F8, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x5c3c4: {"kind": 'reg', "py": 'r[14] = 0xFFFFD330', "slot_py": None, "target": None, "cond": None},
    0x5c3c6: {"kind": 'mem', "py": 'r[4] = _rdw(ram, 0xFFFFD330, 4)', "slot_py": None, "target": None, "cond": None},
    0x5c3c8: {"kind": 'reg', "py": 'r[3] = 0x80000080', "slot_py": None, "target": None, "cond": None},
    0x5c3ca: {"kind": 'reg', "py": 'T = 1 if (r[4] & 0xFFFFFFFF) >= (r[3] & 0xFFFFFFFF) else 0', "slot_py": None, "target": None, "cond": None},
    0x5c3cc: {"kind": "branch", "py": None, "slot_py": '', "target": 0x5c3f8, "cond": 'notT'},
    0x5c3d0: {"kind": 'reg', "py": 'r[1] = 0x80000100', "slot_py": None, "target": None, "cond": None},
    0x5c3d2: {"kind": 'reg', "py": 'T = 1 if (r[4] & 0xFFFFFFFF) >= (r[1] & 0xFFFFFFFF) else 0', "slot_py": None, "target": None, "cond": None},
    0x5c3d4: {"kind": "branch", "py": None, "slot_py": '', "target": 0x5c3f8, "cond": 'T'},
    0x5c3d8: {"kind": 'reg', "py": 'r[3] = 0x00039254', "slot_py": None, "target": None, "cond": None},
    0x5c3da: {"kind": "call", "py": None, "slot_py": '', "target": 0x39254, "ret_pc": 0x5c3de, "set_pr": True, "cond": None},
    0x5c3de: {"kind": 'reg', "py": 'r[5] = r[0]', "slot_py": None, "target": None, "cond": None},
    0x5c3e0: {"kind": 'reg', "py": 'r[4] = 0x80000000', "slot_py": None, "target": None, "cond": None},
    0x5c3e2: {"kind": 'mem', "py": 'r[2] = _rdw(ram, 0xFFFFD330, 4)', "slot_py": None, "target": None, "cond": None},
    0x5c3e4: {"kind": 'reg', "py": 'r[0] = 0xFFFFD334', "slot_py": None, "target": None, "cond": None},
    0x5c3e6: {"kind": 'reg', "py": 'r[5] = (r[5] + r[2]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x5c3e8: {"kind": 'reg', "py": 'r[2] = 0xFFFFD338', "slot_py": None, "target": None, "cond": None},
    0x5c3ea: {"kind": 'reg', "py": 'r[5] = (r[5] - r[4]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x5c3ec: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD330, 4, r[5])', "slot_py": None, "target": None, "cond": None},
    0x5c3ee: {"kind": 'reg', "py": 'r[1] = r[5]', "slot_py": None, "target": None, "cond": None},
    0x5c3f0: {"kind": 'mem', "py": 'r[3] = s16(_rdw(ram, 0xFFFFD338, 2))', "slot_py": None, "target": None, "cond": None},
    0x5c3f2: {"kind": 'reg', "py": 'r[3] = r[3] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x5c3f4: {"kind": 'reg', "py": 'r[3] = (r[3] + r[1]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x5c3f6: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD334, 4, r[3])', "slot_py": None, "target": None, "cond": None},
    0x5c3f8: {"kind": 'st', "py": 'pr = _rdw(ram, STACK_BASE + 0x3F8, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x5c3fa: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, STACK_BASE + 0x3FC, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},
    0x39254: {"kind": 'reg', "py": 'r[0] = 0xFFFFC2FE', "slot_py": None, "target": None, "cond": None},
    0x39256: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},
}
