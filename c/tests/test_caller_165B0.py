#!/usr/bin/env python3
"""Differential test for caller_165B0 (entry 0x165B0) — v8 ST caller (CFG), 20 bytes.
...
Run: python3 test_caller_165B0.py
"""
...
CODE = {
    0x165b0: {"kind": 'st', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x165b2: {"kind": 'reg', "py": 'r[3] = 0x00016544', "slot_py": None, "target": None, "cond": None},
    0x165b4: {"kind": "call", "py": None, "slot_py": '', "target": 0x16544, "ret_pc": 0x165b8, "set_pr": True, "cond": None},
    0x165b8: {"kind": 'reg', "py": 'r[2] = 0x0001622C', "slot_py": None, "target": None, "cond": None},
    0x165ba: {"kind": "call", "py": None, "slot_py": '', "target": 0x1622c, "ret_pc": 0x165be, "set_pr": True, "cond": None},
    0x165be: {"kind": 'reg', "py": 'r[3] = 0x00015894', "slot_py": None, "target": None, "cond": None},
    0x165c0: {"kind": "call", "py": None, "slot_py": 'pr = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": 0x15894, "ret_pc": 0x165c4, "set_pr": False, "cond": None},
    0x15894: {"kind": 'reg', "py": 'r[2] = 0x0006E6B1', "slot_py": None, "target": None, "cond": None},
    0x15896: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0x0006E6B1, 1))', "slot_py": None, "target": None, "cond": None},
    0x15898: {"kind": 'reg', "py": 'r[1] = 0xFFFFA880', "slot_py": None, "target": None, "cond": None},
    0x1589a: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFA880, 1, r[3])', "target": None, "cond": None},
    0x1622c: {"kind": 'reg', "py": 'r[2] = 0xFFFFBD89', "slot_py": None, "target": None, "cond": None},
    0x1622e: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFBD89, 1))', "slot_py": None, "target": None, "cond": None},
    0x16230: {"kind": 'reg', "py": 'r[1] = 0xFFFFA8BB', "slot_py": None, "target": None, "cond": None},
    0x16232: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFA8BB, 1, r[3])', "target": None, "cond": None},
    0x16544: {"kind": 'reg', "py": 'r[3] = 0xFFFFA8C4', "slot_py": None, "target": None, "cond": None},
    0x16546: {"kind": 'fpu', "py": 'fr[3] = 1.0', "slot_py": None, "target": None, "cond": None},
    0x16548: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFA8C4, 4, f2bits(fr[3]))', "target": None, "cond": None},
}
