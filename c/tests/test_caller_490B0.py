#!/usr/bin/env python3
"""Differential test for caller_490B0 (entry 0x490B0) — v8 ST caller (CFG), 48 bytes.
...
Run: python3 test_caller_490B0.py
"""
...
CODE = {
    0x490b0: {"kind": 'reg', "py": 'r[2] = 0xFFFFCD06', "slot_py": None, "target": None, "cond": None},
    0x490b2: {"kind": 'reg', "py": 'r[3] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x490b4: {"kind": 'reg', "py": 'r[1] = 0xFFFFB520', "slot_py": None, "target": None, "cond": None},
    0x490b6: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCD06, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x490b8: {"kind": 'fpu', "py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFB520, 4))', "slot_py": None, "target": None, "cond": None},
    0x490ba: {"kind": 'reg', "py": 'r[5] = 0xFFFFCD10', "slot_py": None, "target": None, "cond": None},
    0x490bc: {"kind": 'fpu', "py": '_wrw(ram, r[5], 4, f2bits(fr[4]))', "slot_py": None, "target": None, "cond": None},
    0x490be: {"kind": 'reg', "py": 'r[3] = 0x0006FF14', "slot_py": None, "target": None, "cond": None},
    0x490c0: {"kind": 'mem', "py": 'r[4] = s8(_rdw(ram, 0x0006FF14, 1))', "slot_py": None, "target": None, "cond": None},
    0x490c2: {"kind": 'reg', "py": 'r[2] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x490c4: {"kind": 'reg', "py": 'r[2] = (r[2] << 2) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x490c6: {"kind": 'reg', "py": 'r[2] = (r[2] + r[5]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x490c8: {"kind": 'reg', "py": 'r[5] = r[2]', "slot_py": None, "target": None, "cond": None},
    0x490ca: {"kind": 'reg', "py": 'r[0] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x490cc: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) > 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x490ce: {"kind": "branch", "py": None, "slot_py": 'r[5] = (r[5] + s8(0x04)) & 0xFFFFFFFF', "target": 0x490dc, "cond": 'notT'},
    0x490d2: {"kind": 'reg', "py": 'r[4] = (r[4] + s8(0xFF)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x490d4: {"kind": 'reg', "py": 'r[3] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x490d6: {"kind": 'reg', "py": 'T = 1 if s32(r[3]) > 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x490d8: {"kind": "branch", "py": None, "slot_py": 'r[5] = (r[5] - 4) & 0xFFFFFFFF\n_wrw(ram, r[5], 4, f2bits(fr[4]))', "target": 0x490d2, "cond": 'T'},
    0x490dc: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},
}
