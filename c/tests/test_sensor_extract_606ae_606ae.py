#!/usr/bin/env python3
"""Differential test for sensor_extract_606ae (0x606AE) — v3 lift + v4 FPU, 12 bytes.
...
Run from repo root: python3 c/tests/test_sensor_extract_606ae_606ae.py
"""
...
RAM_MAX = 0xFFFFB5B8
SPAN_END = 0x606BA
SENT = 0x606BA     # stop-sentinel, placed past the literal pool
...
CODE = {
    ...
    0x606b4: {"kind": 'reg', "py": 'r[2] = 0xFFFFAA10', "slot_py": None, "target": None, "cond": None},
    0x606b6: {"kind": "ret", "py": None, "slot_py": 'fr[0] = bits2f(_rdw(ram, 0xFFFFAA10, 4))', "target": None, "cond": None},}
