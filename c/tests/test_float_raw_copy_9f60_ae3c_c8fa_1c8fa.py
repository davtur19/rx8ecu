#!/usr/bin/env python3
"""Differential test for float_raw_copy_9f60_ae3c_c8fa (0x1C8FA) — v3 lift + v4 FPU, 10 bytes.
...
Run from repo root: python3 c/tests/test_float_raw_copy_9f60_ae3c_c8fa_1c8fa.py
"""
...
ENTRY = 0x1C8FA
RAW = bytes.fromhex("D3 2A 91 49 F3 38 00 0B F1 3A")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFAE3C
SPAN_END = 0x1C904
SENT = 0x1C904     # stop-sentinel, placed past the literal pool
