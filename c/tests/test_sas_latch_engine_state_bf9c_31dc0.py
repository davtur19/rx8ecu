#!/usr/bin/env python3
"""Differential test for sas_latch_engine_state_bf9c (0x31DC0) — v3 lift (branches + delay slots), 10 bytes.
...
Run from repo root: python3 c/tests/test_sas_latch_engine_state_bf9c_31dc0.py
"""
...
ENTRY = 0x31DC0
RAW = bytes.fromhex("92 53 63 20 D0 2E 00 0B 20 30")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBF9C
SPAN_END = 0x31DCA
SENT = 0x31DCA     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x31dc0: {"kind": 'reg', "py": 'r[2] = 0xFFFFA41C', "slot_py": None, "target": None, "cond": None},
    0x31dc2: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFA41C, 1))', "slot_py": None, "target": None, "cond": None},
    0x31dc4: {"kind": 'reg', "py": 'r[0] = 0xFFFFBF9C', "slot_py": None, "target": None, "cond": None},
    0x31dc6: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBF9C, 1, r[3])', "target": None, "cond": None},}
