#!/usr/bin/env python3
"""Differential test for obd_service_handler_661B4 (0x661B4) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_obd_service_handler_661B4_661b4.py
"""
...
ENTRY = 0x661B4
RAW = bytes.fromhex("D2 1A E3 00 00 0B 22 30")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    0x661b4: {"kind": 'reg', "py": 'r[2] = 0xFFFFD994', "slot_py": None, "target": None, "cond": None},
    0x661b6: {"kind": 'reg', "py": 'r[3] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x661b8: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFD994, 1, r[3])', "target": None, "cond": None},}
