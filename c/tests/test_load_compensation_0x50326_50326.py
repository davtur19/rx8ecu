#!/usr/bin/env python3
"""Differential test for load_compensation_0x50326 (0x50326) — v3 lift (branches + delay slots), 44 bytes.
...
Run from repo root: python3 c/tests/test_load_compensation_0x50326_50326.py
"""
...
CODE = {
    0x50326: {"kind": 'reg', "py": 'r[0] = 0xFFFFCFF1', "slot_py": None, "target": None, "cond": None},
    0x50328: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCFF1, 1))', "slot_py": None, "target": None, "cond": None},
    0x5032a: {"kind": 'reg', "py": 'T = 1 if (r[0] & 0x80) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x5032c: {"kind": 'reg', "py": 'r[4] = T;', "slot_py": None, "target": None, "cond": None},
    0x5032e: {"kind": 'reg', "py": 'r[4] = (r[4] + s8(0xFF)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x50330: {"kind": 'reg', "py": 'r[4] = (-r[4]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x50332: {"kind": 'reg', "py": 'r[0] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x50334: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x50336: {"kind": "branch", "py": None, "slot_py": '', "target": 0x5034c, "cond": 'notT'},
    0x5033a: {"kind": 'reg', "py": 'r[3] = 0xFFFFD04D', "slot_py": None, "target": None, "cond": None},
    0x5033c: {"kind": 'mem', "py": 'r[2] = s8(_rdw(ram, 0xFFFFD04D, 1))', "slot_py": None, "target": None, "cond": None},
    0x5033e: {"kind": 'reg', "py": 'T = 1 if (r[2] & r[2]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x50340: {"kind": "branch", "py": None, "slot_py": '', "target": 0x5034c, "cond": 'notT'},
    0x50344: {"kind": 'reg', "py": 'r[1] = 0xFFFFA426', "slot_py": None, "target": None, "cond": None},
    0x50346: {"kind": 'mem', "py": 'r[0] = s16(_rdw(ram, 0xFFFFA426, 2))', "slot_py": None, "target": None, "cond": None},
    0x50348: {"kind": 'reg', "py": 'r[3] = 0xFFFFD048', "slot_py": None, "target": None, "cond": None},
    0x5034a: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD048, 2, r[0])', "slot_py": None, "target": None, "cond": None},
    0x5034c: {"kind": 'reg', "py": 'r[2] = 0xFFFFD04D', "slot_py": None, "target": None, "cond": None},
    0x5034e: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFD04D, 1, r[4])', "target": None, "cond": None},}
