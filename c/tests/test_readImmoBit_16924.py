#!/usr/bin/env python3
"""Differential test for readImmoBit (0x16924) — v3 lift (branches + delay slots), 54 bytes.
...
Run from repo root: python3 c/tests/test_readImmoBit_16924.py
"""
...
ENTRY = 0x16924
RAW = bytes.fromhex("90 59 62 00 22 28 8F 12 00 09 92 55 63 20 23 38 8F 0D 00 09 91 51 63 10 23 38 8F 08 00 09 92 4D 63 20 23 38 8F 03 00 09 E0 01 A0 01 25 00 25 60 D2 25 00 0B 22 40")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFC68E
SPAN_END = 0x1695A
SENT = 0x1695A     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x16924: {"kind": 'reg', "py": 'r[0] = 0xFFFFC656', "slot_py": None, "target": None, "cond": None},
    0x16926: {"kind": 'mem', "py": 'r[2] = s8(_rdw(ram, 0xFFFFC656, 1))', "slot_py": None, "target": None, "cond": None},
    0x16928: {"kind": 'reg', "py": 'T = 1 if (r[2] & r[2]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x1692a: {"kind": "branch", "py": None, "slot_py": '', "target": 0x16952, "cond": 'notT'},
    0x1692e: {"kind": 'reg', "py": 'r[2] = 0xFFFFC64B', "slot_py": None, "target": None, "cond": None},
    0x16930: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFC64B, 1))', "slot_py": None, "target": None, "cond": None},
    0x16932: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x16934: {"kind": "branch", "py": None, "slot_py": '', "target": 0x16952, "cond": 'notT'},
    0x16938: {"kind": 'reg', "py": 'r[1] = 0xFFFFC647', "slot_py": None, "target": None, "cond": None},
    0x1693a: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFC647, 1))', "slot_py": None, "target": None, "cond": None},
    0x1693c: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x1693e: {"kind": "branch", "py": None, "slot_py": '', "target": 0x16952, "cond": 'notT'},
    0x16942: {"kind": 'reg', "py": 'r[2] = 0xFFFFC68E', "slot_py": None, "target": None, "cond": None},
    0x16944: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFC68E, 1))', "slot_py": None, "target": None, "cond": None},
    0x16946: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x16948: {"kind": "branch", "py": None, "slot_py": '', "target": 0x16952, "cond": 'notT'},
    0x1694c: {"kind": 'reg', "py": 'r[0] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x1694e: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, r[5], 1, r[0])', "target": 0x16954, "cond": 'always'},
    0x16952: {"kind": 'mem', "py": '_wrw(ram, r[5], 1, r[6])', "slot_py": None, "target": None, "cond": None},
    0x16954: {"kind": 'reg', "py": 'r[2] = 0xFFFFA8CF', "slot_py": None, "target": None, "cond": None},
    0x16956: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFA8CF, 1, r[4])', "target": None, "cond": None},}
