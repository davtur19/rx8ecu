#!/usr/bin/env python3
"""Differential test for calc_rotor_sync_solenoid_A (0x12B70) — v3 lift + v4 FPU, 88 bytes.
...
Run from repo root: python3 c/tests/test_calc_rotor_sync_solenoid_A_12b70.py
"""
...
RAM_MAX = 0xFFFFBC1C
SPAN_END = 0x12BC8
SENT = 0x12BC8     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x12b70: {"kind": 'reg', "py": 'r[4] = 0xFFFFA68C', "slot_py": None, "target": None, "cond": None},
    0x12b72: {"kind": 'fpu', "py": 'fr[3] = 0.0', "slot_py": None, "target": None, "cond": None},
    0x12b74: {"kind": 'reg', "py": 'r[3] = 0xFFFFBC1C', "slot_py": None, "target": None, "cond": None},
    0x12b76: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0xFFFFBC1C, 4))', "slot_py": None, "target": None, "cond": None},
    0x12b78: {"kind": 'fpu', "py": 'T = 1 if fr[2] > fr[3] else 0', "slot_py": None, "target": None, "cond": None},
    0x12b7a: {"kind": "branch", "py": None, "slot_py": '', "target": 0x12b86, "cond": 'notT'},
    0x12b7e: {"kind": 'reg', "py": 'r[2] = 0x00072BBC', "slot_py": None, "target": None, "cond": None},
    0x12b80: {"kind": 'mem', "py": 'r[1] = s16(_rdw(ram, 0x00072BBC, 2))', "slot_py": None, "target": None, "cond": None},
    0x12b82: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFA68C, 2, r[1])', "target": 0x12b98, "cond": 'always'},
    0x12b86: {"kind": 'mem', "py": 'r[0] = s16(_rdw(ram, 0xFFFFA68C, 2))', "slot_py": None, "target": None, "cond": None},
    0x12b88: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x12b8a: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) > 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x12b8c: {"kind": "branch", "py": None, "slot_py": '', "target": 0x12b98, "cond": 'notT'},
    0x12b90: {"kind": 'reg', "py": 'r[3] = 0x0000FFFF', "slot_py": None, "target": None, "cond": None},
    0x12b92: {"kind": 'mem', "py": 'r[2] = s16(_rdw(ram, 0xFFFFA68C, 2))', "slot_py": None, "target": None, "cond": None},
    0x12b94: {"kind": 'reg', "py": 'r[2] = (r[2] + r[3]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x12b96: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA68C, 2, r[2])', "slot_py": None, "target": None, "cond": None},
    0x12b98: {"kind": 'reg', "py": 'r[4] = 0xFFFFA67C', "slot_py": None, "target": None, "cond": None},
    0x12b9a: {"kind": 'reg', "py": 'r[2] = 0xFFFFAD90', "slot_py": None, "target": None, "cond": None},
    0x12b9c: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFAD90, 1))', "slot_py": None, "target": None, "cond": None},
    0x12b9e: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x12ba0: {"kind": "branch", "py": None, "slot_py": '', "target": 0x12bae, "cond": 'T'},
    0x12ba4: {"kind": 'reg', "py": 'r[1] = 0xFFFFA68C', "slot_py": None, "target": None, "cond": None},
    0x12ba6: {"kind": 'mem', "py": 'r[0] = s16(_rdw(ram, 0xFFFFA68C, 2))', "slot_py": None, "target": None, "cond": None},
    0x12ba8: {"kind": 'reg', "py": 'T = 1 if (r[0] & r[0]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x12baa: {"kind": "branch", "py": None, "slot_py": '', "target": 0x12bb4, "cond": 'notT'},
    0x12bae: {"kind": 'reg', "py": 'r[2] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x12bb0: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFA67C, 1, r[2])', "target": 0x12bc4, "cond": 'always'},
    0x12bb4: {"kind": 'reg', "py": 'r[3] = 0xFFFFA690', "slot_py": None, "target": None, "cond": None},
    0x12bb6: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFA690, 1))', "slot_py": None, "target": None, "cond": None},
    0x12bb8: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x12bba: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x12bbc: {"kind": "branch", "py": None, "slot_py": '', "target": 0x12bc4, "cond": 'notT'},
    0x12bc0: {"kind": 'reg', "py": 'r[1] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x12bc2: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA67C, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x12bc4: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
