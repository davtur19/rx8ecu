#!/usr/bin/env python3
"""Differential test for updateEngineRunningLessThan60Timer (0x26340) — v3 lift + v4 FPU, 90 bytes.
...
Run from repo root: python3 c/tests/test_updateEngineRunningLessThan60Timer_26340.py
"""
...
ENTRY = 0x26340
RAW = bytes.fromhex("92 40 F4 28 D3 27 F5 38 D1 27 F6 5C 94 3B F5 45 F3 18 8D 03 F6 31 E0 01 A0 05 24 00 F6 45 8F 02 00 09 E2 00 24 20 95 2F 92 2F 63 20 23 38 8F 0A 00 09 91 28 60 10 60 0C 88 01 8F 04 00 09 D3 1B 62 31 A0 08 25 21 64 51 63 4D 43 15 8F 03 00 09 D3 17 34 3C 25 41 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFB684
SPAN_END = 0x2639A
SENT = 0x2639A     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x26340: {"kind": 'reg', "py": 'r[2] = 0xFFFFA9FC', "slot_py": None, "target": None, "cond": None},
    0x26342: {"kind": 'fpu', "py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFA9FC, 4))', "slot_py": None, "target": None, "cond": None},
    0x26344: {"kind": 'reg', "py": 'r[3] = 0x00074A28', "slot_py": None, "target": None, "cond": None},
    0x26346: {"kind": 'fpu', "py": 'fr[5] = bits2f(_rdw(ram, 0x00074A28, 4))', "slot_py": None, "target": None, "cond": None},
    0x26348: {"kind": 'reg', "py": 'r[1] = 0x00074A2C', "slot_py": None, "target": None, "cond": None},
    0x2634a: {"kind": 'fpu', "py": 'fr[6] = fr[5]', "slot_py": None, "target": None, "cond": None},
    0x2634c: {"kind": 'reg', "py": 'r[4] = 0xFFFFB684', "slot_py": None, "target": None, "cond": None},
    0x2634e: {"kind": 'fpu', "py": 'T = 1 if fr[5] > fr[4] else 0', "slot_py": None, "target": None, "cond": None},
    0x26350: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x00074A2C, 4))', "slot_py": None, "target": None, "cond": None},
    0x26352: {"kind": "branch", "py": None, "slot_py": 'fr[6] = ts(fr[6] - fr[3])', "target": 0x2635c, "cond": 'T'},
    0x26356: {"kind": 'reg', "py": 'r[0] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x26358: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFB684, 1, r[0])', "target": 0x26366, "cond": 'always'},
    0x2635c: {"kind": 'fpu', "py": 'T = 1 if fr[6] > fr[4] else 0', "slot_py": None, "target": None, "cond": None},
    0x2635e: {"kind": "branch", "py": None, "slot_py": '', "target": 0x26366, "cond": 'notT'},
    0x26362: {"kind": 'reg', "py": 'r[2] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x26364: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFB684, 1, r[2])', "slot_py": None, "target": None, "cond": None},
    0x26366: {"kind": 'reg', "py": 'r[5] = 0xFFFFB65C', "slot_py": None, "target": None, "cond": None},
    0x26368: {"kind": 'reg', "py": 'r[2] = 0xFFFFA428', "slot_py": None, "target": None, "cond": None},
    0x2636a: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFA428, 1))', "slot_py": None, "target": None, "cond": None},
    0x2636c: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x2636e: {"kind": "branch", "py": None, "slot_py": '', "target": 0x26386, "cond": 'notT'},
    0x26372: {"kind": 'reg', "py": 'r[1] = 0xFFFFB684', "slot_py": None, "target": None, "cond": None},
    0x26374: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFB684, 1))', "slot_py": None, "target": None, "cond": None},
    0x26376: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x26378: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x2637a: {"kind": "branch", "py": None, "slot_py": '', "target": 0x26386, "cond": 'notT'},
    0x2637e: {"kind": 'reg', "py": 'r[3] = 0x000749F6', "slot_py": None, "target": None, "cond": None},
    0x26380: {"kind": 'mem', "py": 'r[2] = s16(_rdw(ram, 0x000749F6, 2))', "slot_py": None, "target": None, "cond": None},
    0x26382: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFB65C, 2, r[2])', "target": 0x26396, "cond": 'always'},
    0x26386: {"kind": 'mem', "py": 'r[4] = s16(_rdw(ram, 0xFFFFB65C, 2))', "slot_py": None, "target": None, "cond": None},
    0x26388: {"kind": 'reg', "py": 'r[3] = r[4] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x2638a: {"kind": 'reg', "py": 'T = 1 if s32(r[3]) > 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x2638c: {"kind": "branch", "py": None, "slot_py": '', "target": 0x26396, "cond": 'notT'},
    0x26390: {"kind": 'reg', "py": 'r[3] = 0x0000FFFF', "slot_py": None, "target": None, "cond": None},
    0x26392: {"kind": 'reg', "py": 'r[4] = (r[4] + r[3]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x26394: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFB65C, 2, r[4])', "slot_py": None, "target": None, "cond": None},
    0x26396: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
