#!/usr/bin/env python3
"""Differential test for caller_51F44 (entry 0x51F44) — v8 ST caller (CFG), 48 bytes.
...
Run: python3 test_caller_51F44.py
"""
...
CODE = {
    0x51f44: {"kind": 'st', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x51f46: {"kind": 'reg', "py": 'r[4] = 0xFFFF8FFC', "slot_py": None, "target": None, "cond": None},
    0x51f48: {"kind": 'reg', "py": 'r[3] = 0x0003E1F8', "slot_py": None, "target": None, "cond": None},
    0x51f4a: {"kind": "call", "py": None, "slot_py": 'r[5] = s8(0x00)', "target": 0x3e1f8, "ret_pc": 0x51f4e, "set_pr": True, "cond": None},
    0x51f4e: {"kind": 'reg', "py": 'r[5] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x51f50: {"kind": 'reg', "py": 'r[4] = 0xFFFF8FFE', "slot_py": None, "target": None, "cond": None},
    0x51f52: {"kind": 'reg', "py": 'r[2] = 0x0003E1F8', "slot_py": None, "target": None, "cond": None},
    0x51f54: {"kind": "call", "py": None, "slot_py": 'pr = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": 0x3e1f8, "ret_pc": 0x51f58, "set_pr": False, "cond": None},
