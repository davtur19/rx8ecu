#!/usr/bin/env python3
"""Differential test for call-composition caller_54250 (entry 0x54250) — v7 ST caller + callee lib, flattened CODE with nested returns.
...
Run: python3 /home/davide/ailocal/rx8ecu/c/tests/test_caller_54250.py
"""
...
CODE = {
    0x54250: {"kind": 'reg', "py": 'r[4] = 0xFFFF8FEC', "slot_py": None, "target": None, "cond": None},
    0x54252: {"kind": 'reg', "py": 'r[3] = 0x0003EE58', "slot_py": None, "target": None, "cond": None},
    0x54254: {"kind": "call", "py": None, "slot_py": 'r[5] = s8(0x00)', "target": 0x3ee58, "ret_pc": 0x54258, "set_pr": False, "cond": None},
