#!/usr/bin/env python3
"""Differential test for init_float_c03c_set_const (0x3335C) — v3 lift + v4 FPU, 10 bytes.
...
Run from repo root: python3 c/tests/test_init_float_c03c_set_const_3335c.py
"""
...
ENTRY = 0x3335C
RAW = bytes.fromhex("C7 37 F3 08 93 64 00 0B F3 3A")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFC03C
SPAN_END = 0x33366
SENT = 0x33366     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x3335c: {"kind": 'reg', "py": 'r[0] = 0x0003343C', "slot_py": None, "target": None, "cond": None},
    0x3335e: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x0003343C, 4))', "slot_py": None, "target": None, "cond": None},
    0x33360: {"kind": 'reg', "py": 'r[3] = 0xFFFFC03C', "slot_py": None, "target": None, "cond": None},
    0x33362: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFC03C, 4, f2bits(fr[3]))', "target": None, "cond": None},}
