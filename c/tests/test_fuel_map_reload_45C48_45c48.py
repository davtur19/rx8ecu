#!/usr/bin/env python3
"""Differential test for fuel_map_reload_45C48 (0x45C48) — v3 lift + v4 FPU, 18 bytes.
...
Run from repo root: python3 c/tests/test_fuel_map_reload_45C48_45c48.py
"""
...
ENTRY = 0x45C48
RAW = bytes.fromhex("D3 10 F3 38 92 18 F2 3A D1 0F F3 18 90 15 00 0B F0 3A")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCBFC
SPAN_END = 0x45C5A
SENT = 0x45C5A     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x45c48: {"kind": 'reg', "py": 'r[3] = 0x0007C17C', "slot_py": None, "target": None, "cond": None},
    0x45c4a: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x0007C17C, 4))', "slot_py": None, "target": None, "cond": None},
    0x45c4c: {"kind": 'reg', "py": 'r[2] = 0xFFFFCBF8', "slot_py": None, "target": None, "cond": None},
    0x45c4e: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFCBF8, 4, f2bits(fr[3]))', "slot_py": None, "target": None, "cond": None},
    0x45c50: {"kind": 'reg', "py": 'r[1] = 0x0007C180', "slot_py": None, "target": None, "cond": None},
    0x45c52: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x0007C180, 4))', "slot_py": None, "target": None, "cond": None},
    0x45c54: {"kind": 'reg', "py": 'r[0] = 0xFFFFCBFC', "slot_py": None, "target": None, "cond": None},
    0x45c56: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFCBFC, 4, f2bits(fr[3]))', "target": None, "cond": None},}
