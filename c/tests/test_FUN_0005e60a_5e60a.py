#!/usr/bin/env python3
"""Differential test for FUN_0005e60a (0x5E60A) — v3 lift (branches + delay slots), 12 bytes.
...
Run from repo root: python3 c/tests/test_FUN_0005e60a_5e60a.py
"""
...
ENTRY = 0x5E60A
RAW = bytes.fromhex("6A F6 6B F6 6C F6 6D F6 00 0B 6E F6")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    0x5e60a: {"kind": 'mem', "py": 'r[10] = _rdw(ram, STACK_BASE + 0x400, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x5e60c: {"kind": 'mem', "py": 'r[11] = _rdw(ram, STACK_BASE + 0x404, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x5e60e: {"kind": 'mem', "py": 'r[12] = _rdw(ram, STACK_BASE + 0x408, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x5e610: {"kind": 'mem', "py": 'r[13] = _rdw(ram, STACK_BASE + 0x40C, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x5e612: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, STACK_BASE + 0x410, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},}
