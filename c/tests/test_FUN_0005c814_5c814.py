#!/usr/bin/env python3
"""Differential test for FUN_0005c814 (0x5C814) — pure straight-line lift, 8 bytes.
...
Run from repo root: python3 c/tests/test_FUN_0005c814_5c814.py
"""
...
ENTRY = 0x5C814
RAW = bytes.fromhex("D0 1C 61 EC 41 08 41 08")
SEED = 42
N = 2000
