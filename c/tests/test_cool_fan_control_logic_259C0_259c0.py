#!/usr/bin/env python3
"""Differential test for cool_fan_control_logic_259C0 (0x259C0) — v3 lift (branches + delay slots), 40 bytes.
...
Run from repo root: python3 c/tests/test_cool_fan_control_logic_259C0_259c0.py
"""
...
CODE = {
    0x259c0: {"kind": 'reg', "py": 'r[5] = 0xFFFFB5AB', "slot_py": None, "target": None, "cond": None},
    0x259c2: {"kind": 'reg', "py": 'r[4] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x259c4: {"kind": 'reg', "py": 'r[3] = 0xFFFF9ECD', "slot_py": None, "target": None, "cond": None},
    0x259c6: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFF9ECD, 1))', "slot_py": None, "target": None, "cond": None},
    0x259c8: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x259ca: {"kind": 'reg', "py": 'T = 1 if (r[0] & r[4]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x259cc: {"kind": "branch", "py": None, "slot_py": '', "target": 0x259d4, "cond": 'notT'},
    0x259d0: {"kind": "branch", "py": None, "slot_py": 'r[0] = r[4]', "target": 0x259d6, "cond": 'always'},
    0x259d4: {"kind": 'reg', "py": 'r[0] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x259d6: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x259d8: {"kind": "branch", "py": None, "slot_py": '', "target": 0x259e0, "cond": 'notT'},
    0x259dc: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFB5AB, 1, r[4])', "target": 0x259e4, "cond": 'always'},
    0x259e0: {"kind": 'reg', "py": 'r[2] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x259e2: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFB5AB, 1, r[2])', "slot_py": None, "target": None, "cond": None},
    0x259e4: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
