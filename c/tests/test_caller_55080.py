#!/usr/bin/env python3
"""Differential test for call-composition caller_55080 (entry 0x55080) — v7 ST caller + callee lib, flattened CODE with nested returns.
...
Run: python3 /home/davide/ailocal/rx8ecu/c/tests/test_caller_55080.py
"""
...
CODE = {
    0x55080: {"kind": 'reg', "py": 'r[4] = 0xFFFF9008', "slot_py": None, "target": None, "cond": None},
    0x55082: {"kind": 'reg', "py": 'r[3] = 0x0003EE58', "slot_py": None, "target": None, "cond": None},
    0x55084: {"kind": "call", "py": None, "slot_py": 'r[5] = s8(0x00)', "target": 0x3ee58, "ret_pc": 0x55088, "set_pr": False, "cond": None},
