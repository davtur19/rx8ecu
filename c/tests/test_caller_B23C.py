#!/usr/bin/env python3
"""Differential test for caller_B23C (entry 0xB23C) — v8 ST caller (CFG), 84 bytes.
...
Run: python3 test_caller_B23C.py
"""
...
CODE = {
    0xb23c: {"kind": 'mem', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, r[14])\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xb23e: {"kind": 'reg', "py": 'r[14] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0xb240: {"kind": 'reg', "py": 'r[3] = 0x00002054', "slot_py": None, "target": None, "cond": None},
    0xb242: {"kind": 'mem', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, r[13])\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xb244: {"kind": 'st', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xb246: {"kind": 'reg', "py": 'r[13] = r[14]', "slot_py": None, "target": None, "cond": None},
    0xb248: {"kind": 'reg', "py": 'r[5] = 0xFFFFA210', "slot_py": None, "target": None, "cond": None},
    0xb24a: {"kind": 'reg', "py": 'r[15] = (r[15] + s8(0xFC)) & 0xFFFFFFFF\nsp = (sp + s8(0xFC)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xb24c: {"kind": 'reg', "py": 'r[4] = 0xFFFFA214', "slot_py": None, "target": None, "cond": None},
    0xb24e: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA214, 1, r[14])', "slot_py": None, "target": None, "cond": None},
    0xb250: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA210, 4, r[14])', "slot_py": None, "target": None, "cond": None},
    0xb252: {"kind": 'reg', "py": 'r[5] = 0x000000E0', "slot_py": None, "target": None, "cond": None},
    0xb254: {"kind": "call", "py": None, "slot_py": 'r[4] = r[15]', "target": 0x2054, "ret_pc": 0xb258, "set_pr": True, "cond": None},
    0xb258: {"kind": 'reg', "py": 'T = 1 if (r[14] & r[14]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0xb25a: {"kind": "branch", "py": None, "slot_py": 'r[4] = s8(0x01)', "target": 0xb260, "cond": 'T'},
    0xb25e: {"kind": 'reg', "py": 'r[13] = r[4]', "slot_py": None, "target": None, "cond": None},
    0xb260: {"kind": 'reg', "py": 'r[5] = 0xFFFFF400', "slot_py": None, "target": None, "cond": None},
    0xb262: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, r[5], 1))', "slot_py": None, "target": None, "cond": None},
    0xb264: {"kind": 'reg', "py": 'r[0] = (r[0] & 0x7F) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xb266: {"kind": 'mem', "py": '_wrw(ram, r[5], 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0xb268: {"kind": 'reg', "py": 'r[3] = 0xFFFFF58E', "slot_py": None, "target": None, "cond": None},
    0xb26a: {"kind": 'mem', "py": '_wrw(ram, r[3], 2, r[4])', "slot_py": None, "target": None, "cond": None},
    0xb26c: {"kind": 'reg', "py": 'r[2] = 0xFFFFF586', "slot_py": None, "target": None, "cond": None},
    0xb26e: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFF586, 2, r[4])', "slot_py": None, "target": None, "cond": None},
    0xb270: {"kind": 'reg', "py": 'r[6] = 0xFFFFF596', "slot_py": None, "target": None, "cond": None},
    0xb272: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFF596, 2, r[4])', "slot_py": None, "target": None, "cond": None},
    0xb274: {"kind": 'reg', "py": 'r[1] = 0xFFFFF59E', "slot_py": None, "target": None, "cond": None},
    0xb276: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFF59E, 2, r[4])', "slot_py": None, "target": None, "cond": None},
    0xb278: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFF596, 2, r[13])', "slot_py": None, "target": None, "cond": None},
    0xb27a: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, r[5], 1))', "slot_py": None, "target": None, "cond": None},
    0xb27c: {"kind": 'reg', "py": 'r[0] = (r[0] | 0x80) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xb27e: {"kind": 'mem', "py": '_wrw(ram, r[5], 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0xb280: {"kind": 'reg', "py": 'r[3] = 0x00002064', "slot_py": None, "target": None, "cond": None},
    0xb282: {"kind": "call", "py": None, "slot_py": 'r[4] = _rdw(ram, sp, 4)', "target": 0x2064, "ret_pc": 0xb286, "set_pr": True, "cond": None},
    0xb286: {"kind": 'reg', "py": 'r[15] = (r[15] + s8(0x04)) & 0xFFFFFFFF\nsp = (sp + s8(0x04)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xb288: {"kind": 'st', "py": 'pr = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xb28a: {"kind": 'mem', "py": 'r[13] = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xb28c: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},
