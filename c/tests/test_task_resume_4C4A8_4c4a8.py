#!/usr/bin/env python3
"""Differential test for task_resume_4C4A8 (0x4C4A8) — v3 lift + v4 FPU, 34 bytes.
...
Run from repo root: python3 c/tests/test_task_resume_4C4A8_4c4a8.py
"""
...
RAM_MAX = 0xFFFFCE8B
SPAN_END = 0x4C4CA
SENT = 0x4C4CA     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x4c4a8: {"kind": 'reg', "py": 'r[2] = 0xFFFFCE85', "slot_py": None, "target": None, "cond": None},
    0x4c4aa: {"kind": 'reg', "py": 'r[5] = 0xFFFFCE8B', "slot_py": None, "target": None, "cond": None},
    0x4c4ac: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCE8B, 1))', "slot_py": None, "target": None, "cond": None},
    0x4c4ae: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x4c4b0: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x4c4b2: {"kind": "branch", "py": None, "slot_py": 'r[4] = s8(_rdw(ram, 0xFFFFCE85, 1))', "target": 0x4c4c6, "cond": 'notT'},
    0x4c4b6: {"kind": 'reg', "py": 'r[1] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x4c4b8: {"kind": 'reg', "py": 'T = 1 if (r[1] & r[1]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x4c4ba: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4c4c6, "cond": 'notT'},
    0x4c4be: {"kind": 'reg', "py": 'r[3] = 0xFFFFAA10', "slot_py": None, "target": None, "cond": None},
    0x4c4c0: {"kind": 'reg', "py": 'r[2] = 0xFFFFCE70', "slot_py": None, "target": None, "cond": None},
    0x4c4c2: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFAA10, 4))', "slot_py": None, "target": None, "cond": None},
    0x4c4c4: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFCE70, 4, f2bits(fr[3]))', "slot_py": None, "target": None, "cond": None},
    0x4c4c6: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFCE8B, 1, r[4])', "target": None, "cond": None},}
