#!/usr/bin/env python3
"""Differential test for caller_39876 (entry 0x39876) — v8 ST caller (CFG), 50 bytes.
...
Run: python3 test_caller_39876.py
"""
...
CODE = {
    0x39876: {"kind": 'st', "py": 'local[0x3FC] = pr\n_wrw(ram, STACK_BASE + 0x3FC, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x39878: {"kind": 'reg', "py": 'r[2] = 0x0007A5F0', "slot_py": None, "target": None, "cond": None},
    0x3987a: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x0007A5F0, 4))', "slot_py": None, "target": None, "cond": None},
    0x3987c: {"kind": 'reg', "py": 'r[0] = 0xFFFFBC1C', "slot_py": None, "target": None, "cond": None},
    0x3987e: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0xFFFFBC1C, 4))', "slot_py": None, "target": None, "cond": None},
    0x39880: {"kind": 'fpu', "py": 'T = 1 if fr[3] > fr[2] else 0', "slot_py": None, "target": None, "cond": None},
    0x39882: {"kind": "branch", "py": None, "slot_py": '', "target": 0x398a2, "cond": 'T'},
    0x39886: {"kind": 'reg', "py": 'r[3] = 0x0007A5F4', "slot_py": None, "target": None, "cond": None},
    0x39888: {"kind": 'reg', "py": 'r[1] = 0xFFFFC12C', "slot_py": None, "target": None, "cond": None},
    0x3988a: {"kind": 'fpu', "py": 'fr[1] = bits2f(_rdw(ram, 0x0007A5F4, 4))', "slot_py": None, "target": None, "cond": None},
    0x3988c: {"kind": 'fpu', "py": 'fr[0] = bits2f(_rdw(ram, 0xFFFFC12C, 4))', "slot_py": None, "target": None, "cond": None},
    0x3988e: {"kind": 'fpu', "py": 'T = 1 if fr[1] > fr[0] else 0', "slot_py": None, "target": None, "cond": None},
    0x39890: {"kind": "branch", "py": None, "slot_py": '', "target": 0x398a2, "cond": 'T'},
    0x39894: {"kind": 'reg', "py": 'r[3] = 0xFFFFC56C', "slot_py": None, "target": None, "cond": None},
    0x39896: {"kind": 'reg', "py": 'r[5] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x39898: {"kind": 'reg', "py": 'r[2] = 0x00002460', "slot_py": None, "target": None, "cond": None},
    0x3989a: {"kind": "call", "py": None, "slot_py": 'r[4] = s16(_rdw(ram, 0xFFFFC56C, 2))', "target": 0x2460, "ret_pc": 0x3989e, "set_pr": True, "cond": None},
    0x3989e: {"kind": 'reg', "py": 'r[1] = 0xFFFFC56C', "slot_py": None, "target": None, "cond": None},
    0x398a0: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC56C, 2, r[0])', "slot_py": None, "target": None, "cond": None},
    0x398a2: {"kind": 'st', "py": 'pr = _rdw(ram, STACK_BASE + 0x3FC, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x398a4: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},
