#!/usr/bin/env python3
"""Differential test for dtc_fault_record_clear_conditional (0x566DE) — v3 lift (branches + delay slots), 12 bytes.
...
Run from repo root: python3 c/tests/test_dtc_fault_record_clear_conditional_566de.py
"""
...
ENTRY = 0x566DE
RAW = bytes.fromhex("A0 02 24 30 E1 00 24 10 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
