#!/usr/bin/env python3
"""Differential test for byte_reg_copy_d483_to_c013 (0x330B2) — v3 lift (branches + delay slots), 10 bytes.
...
Run from repo root: python3 c/tests/test_byte_reg_copy_d483_to_c013_330b2.py
"""
...
ENTRY = 0x330B2
RAW = bytes.fromhex("D3 1B 91 1A 62 30 00 0B 21 20")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFC013
SPAN_END = 0x330BC
SENT = 0x330BC     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x330b2: {"kind": 'reg', "py": 'r[3] = 0x0006D483', "slot_py": None, "target": None, "cond": None},
    0x330b4: {"kind": 'reg', "py": 'r[1] = 0xFFFFC013', "slot_py": None, "target": None, "cond": None},
    0x330b6: {"kind": 'mem', "py": 'r[2] = s8(_rdw(ram, 0x0006D483, 1))', "slot_py": None, "target": None, "cond": None},
    0x330b8: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFC013, 1, r[2])', "target": None, "cond": None},}
