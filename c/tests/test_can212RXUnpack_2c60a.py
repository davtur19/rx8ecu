#!/usr/bin/env python3
"""Differential test for can212RXUnpack (0x2C60A) — v3 lift (branches + delay slots), 52 bytes.
...
Run from repo root: python3 c/tests/test_can212RXUnpack_2c60a.py
"""
...
CODE = {
    0x2c60a: {"kind": 'reg', "py": 'r[4] = 0xFFFFBC28', "slot_py": None, "target": None, "cond": None},
    0x2c60c: {"kind": 'reg', "py": 'r[2] = 0xFFFFBC5A', "slot_py": None, "target": None, "cond": None},
    0x2c60e: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFBC28, 1))', "slot_py": None, "target": None, "cond": None},
    0x2c610: {"kind": 'reg', "py": 'r[1] = 0xFFFFBC5B', "slot_py": None, "target": None, "cond": None},
    0x2c612: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBC5A, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x2c614: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFBC29, 1))', "slot_py": None, "target": None, "cond": None},
    0x2c616: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBC5B, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x2c618: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFBC2A, 1))', "slot_py": None, "target": None, "cond": None},
    0x2c61a: {"kind": 'reg', "py": 'r[3] = 0xFFFFBC5C', "slot_py": None, "target": None, "cond": None},
    0x2c61c: {"kind": 'reg', "py": 'r[2] = 0xFFFFBC5D', "slot_py": None, "target": None, "cond": None},
    0x2c61e: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBC5C, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x2c620: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFBC2B, 1))', "slot_py": None, "target": None, "cond": None},
    0x2c622: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBC5D, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x2c624: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFBC2C, 1))', "slot_py": None, "target": None, "cond": None},
    0x2c626: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x2c628: {"kind": 'reg', "py": 'r[3] = 0xFFFFBC5E', "slot_py": None, "target": None, "cond": None},
    0x2c62a: {"kind": 'reg', "py": 'r[0] = (r[0] << 8) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x2c62c: {"kind": 'reg', "py": 'r[1] = r[0]', "slot_py": None, "target": None, "cond": None},
    0x2c62e: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFBC2D, 1))', "slot_py": None, "target": None, "cond": None},
    0x2c630: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x2c632: {"kind": 'reg', "py": 'r[1] = (r[1] + r[0]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x2c634: {"kind": 'reg', "py": 'r[0] = 0xFFFFBC46', "slot_py": None, "target": None, "cond": None},
    0x2c636: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBC46, 2, r[1])', "slot_py": None, "target": None, "cond": None},
    0x2c638: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFBC2E, 1))', "slot_py": None, "target": None, "cond": None},
    0x2c63a: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBC5E, 1, r[0])', "target": None, "cond": None},}
