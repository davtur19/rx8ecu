#!/usr/bin/env python3
"""Differential test for intake_pressure_zero_25CD4 (0x25CD4) — v3 lift + v4 FPU, 8 bytes.
...
Run from repo root: python3 c/tests/test_intake_pressure_zero_25CD4_25cd4.py
"""
...
ENTRY = 0x25CD4
RAW = bytes.fromhex("93 81 F3 8D 00 0B F3 3A")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFB5B8
SPAN_END = 0x25CDC
SENT = 0x25CDC     # stop-sentinel, placed past the literal pool
