#!/usr/bin/env python3
"""Differential test for aux_condition_duration_counters (0x27DA8) — v3 lift (branches + delay slots), 42 bytes.
...
Run from repo root: python3 c/tests/test_aux_condition_duration_counters_27da8.py
"""
...
ENTRY = 0x27DA8
RAW = bytes.fromhex("D3 20 62 30 22 28 8F 06 00 09 D1 1F 60 11 24 01 62 61 A0 08 25 21 65 41 62 5D 42 15 8F 03 00 09 D2 1A 35 2C 24 51 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFB71C
SPAN_END = 0x27DD2
SENT = 0x27DD2     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x27da8: {"kind": 'reg', "py": 'r[3] = 0xFFFFB71C', "slot_py": None, "target": None, "cond": None},
    0x27daa: {"kind": 'mem', "py": 'r[2] = s8(_rdw(ram, 0xFFFFB71C, 1))', "slot_py": None, "target": None, "cond": None},
    0x27dac: {"kind": 'reg', "py": 'T = 1 if (r[2] & r[2]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x27dae: {"kind": "branch", "py": None, "slot_py": '', "target": 0x27dbe, "cond": 'notT'},
    0x27db2: {"kind": 'reg', "py": 'r[1] = 0x00075952', "slot_py": None, "target": None, "cond": None},
    0x27db4: {"kind": 'mem', "py": 'r[0] = s16(_rdw(ram, 0x00075952, 2))', "slot_py": None, "target": None, "cond": None},
    0x27db6: {"kind": 'mem', "py": '_wrw(ram, r[4], 2, r[0])', "slot_py": None, "target": None, "cond": None},
    0x27db8: {"kind": 'mem', "py": 'r[2] = s16(_rdw(ram, r[6], 2))', "slot_py": None, "target": None, "cond": None},
    0x27dba: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, r[5], 2, r[2])', "target": 0x27dce, "cond": 'always'},
    0x27dbe: {"kind": 'mem', "py": 'r[5] = s16(_rdw(ram, r[4], 2))', "slot_py": None, "target": None, "cond": None},
    0x27dc0: {"kind": 'reg', "py": 'r[2] = r[5] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x27dc2: {"kind": 'reg', "py": 'T = 1 if s32(r[2]) > 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x27dc4: {"kind": "branch", "py": None, "slot_py": '', "target": 0x27dce, "cond": 'notT'},
    0x27dc8: {"kind": 'reg', "py": 'r[2] = 0x0000FFFF', "slot_py": None, "target": None, "cond": None},
    0x27dca: {"kind": 'reg', "py": 'r[5] = (r[5] + r[2]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x27dcc: {"kind": 'mem', "py": '_wrw(ram, r[4], 2, r[5])', "slot_py": None, "target": None, "cond": None},
    0x27dce: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
