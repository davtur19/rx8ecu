#!/usr/bin/env python3
"""Differential test for getActualEngineTorque_related1 (0x29F3E) — v3 lift (branches + delay slots), 40 bytes.
...
Run from repo root: python3 c/tests/test_getActualEngineTorque_related1_29f3e.py
"""
...
ENTRY = 0x29F3E
RAW = bytes.fromhex("90 2C 20 50 94 2B 60 70 60 0C C9 08 88 08 8F 02 00 09 A0 01 24 60 24 50 4F 26 00 0B 00 09 D2 1A 63 20 91 1D 00 0B 21 30")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBB58
SPAN_END = 0x29F66
SENT = 0x29F66     # stop-sentinel, placed past the literal pool
...
CODE = {
    ...
    0x29f44: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, r[7], 1))', "slot_py": None, "target": None, "cond": None},
    ...
    0x29f54: {"kind": 'mem', "py": '_wrw(ram, r[4], 1, r[5])', "slot_py": None, "target": None, "cond": None},
    0x29f56: {"kind": 'mem', "py": 'pr = _rdw(ram, STACK_BASE + 0x400, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x29f58: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},
    0x29f5c: {"kind": 'reg', "py": 'r[2] = 0x0006CF86', "slot_py": None, "target": None, "cond": None},
    0x29f5e: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0x0006CF86, 1))', "slot_py": None, "target": None, "cond": None},
    0x29f60: {"kind": 'reg', "py": 'r[1] = 0xFFFFBB58', "slot_py": None, "target": None, "cond": None},
    0x29f62: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBB58, 1, r[3])', "target": None, "cond": None},}
