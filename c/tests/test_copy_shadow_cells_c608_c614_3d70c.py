#!/usr/bin/env python3
"""Differential test for copy_shadow_cells_c608_c614 (0x3D70C) — v3 lift + v4 FPU, 26 bytes.
...
Run from repo root: python3 c/tests/test_copy_shadow_cells_c608_c614_3d70c.py
"""
...
ENTRY = 0x3D70C
RAW = bytes.fromhex("93 5D F3 38 D2 34 F2 3A 90 5A 61 00 93 59 23 10 D1 32 62 10 93 56 00 0B 23 20")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFC614
SPAN_END = 0x3D726
SENT = 0x3D726     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x3d70c: {"kind": 'reg', "py": 'r[3] = 0xFFFFBBE8', "slot_py": None, "target": None, "cond": None},
    0x3d70e: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFBBE8, 4))', "slot_py": None, "target": None, "cond": None},
    0x3d710: {"kind": 'reg', "py": 'r[2] = 0xFFFFC614', "slot_py": None, "target": None, "cond": None},
    0x3d712: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFC614, 4, f2bits(fr[3]))', "slot_py": None, "target": None, "cond": None},
    0x3d714: {"kind": 'reg', "py": 'r[0] = 0xFFFFAD7C', "slot_py": None, "target": None, "cond": None},
    0x3d716: {"kind": 'mem', "py": 'r[1] = s8(_rdw(ram, 0xFFFFAD7C, 1))', "slot_py": None, "target": None, "cond": None},
    0x3d718: {"kind": 'reg', "py": 'r[3] = 0xFFFFC60F', "slot_py": None, "target": None, "cond": None},
    0x3d71a: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC60F, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x3d71c: {"kind": 'reg', "py": 'r[1] = 0x00079639', "slot_py": None, "target": None, "cond": None},
    0x3d71e: {"kind": 'mem', "py": 'r[2] = s8(_rdw(ram, 0x00079639, 1))', "slot_py": None, "target": None, "cond": None},
    0x3d720: {"kind": 'reg', "py": 'r[3] = 0xFFFFC60D', "slot_py": None, "target": None, "cond": None},
    0x3d722: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFC60D, 1, r[2])', "target": None, "cond": None},}
