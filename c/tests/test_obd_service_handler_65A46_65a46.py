#!/usr/bin/env python3
"""Differential test for obd_service_handler_65A46 (0x65A46) — v3 lift (branches + delay slots), 10 bytes.
...
Run from repo root: python3 c/tests/test_obd_service_handler_65A46_65a46.py
"""
...
ENTRY = 0x65A46
RAW = bytes.fromhex("24 21 7F 08 4F 26 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = None
SPAN_END = 0x65A50
SENT = 0x65A50     # stop-sentinel, placed past the literal pool
