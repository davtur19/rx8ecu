#!/usr/bin/env python3
"""Differential test for knockSensorADCFault (0xC460) — v3 lift (branches + delay slots), 52 bytes.
...
Run from repo root: python3 c/tests/test_knockSensorADCFault_c460.py
"""
...
ENTRY = 0xC460
RAW = bytes.fromhex("D6 25 66 61 D4 25 65 6D D2 25 63 21 63 3D 35 33 8F 03 00 09 E1 01 A0 0B 24 10 D3 22 60 31 60 0D 35 03 8D 03 00 09 E0 02 A0 02 24 00 E1 00 24 10 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    0xc460: {"kind": 'reg', "py": 'r[6] = 0xFFFF9F0E', "slot_py": None, "target": None, "cond": None},
    0xc462: {"kind": 'mem', "py": 'r[6] = s16(_rdw(ram, 0xFFFF9F0E, 2))', "slot_py": None, "target": None, "cond": None},
    0xc464: {"kind": 'reg', "py": 'r[4] = 0xFFFFA325', "slot_py": None, "target": None, "cond": None},
    0xc466: {"kind": 'reg', "py": 'r[5] = r[6] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0xc468: {"kind": 'reg', "py": 'r[2] = 0x0006CF7E', "slot_py": None, "target": None, "cond": None},
    0xc46a: {"kind": 'mem', "py": 'r[3] = s16(_rdw(ram, 0x0006CF7E, 2))', "slot_py": None, "target": None, "cond": None},
    0xc46c: {"kind": 'reg', "py": 'r[3] = r[3] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0xc46e: {"kind": 'reg', "py": 'T = 1 if s32(r[5]) >= s32(r[3]) else 0', "slot_py": None, "target": None, "cond": None},
    0xc470: {"kind": "branch", "py": None, "slot_py": '', "target": 0xc47a, "cond": 'notT'},
    0xc474: {"kind": 'reg', "py": 'r[1] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0xc476: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFA325, 1, r[1])', "target": 0xc490, "cond": 'always'},
    0xc47a: {"kind": 'reg', "py": 'r[3] = 0x0006CF7C', "slot_py": None, "target": None, "cond": None},
    0xc47c: {"kind": 'mem', "py": 'r[0] = s16(_rdw(ram, 0x0006CF7C, 2))', "slot_py": None, "target": None, "cond": None},
    0xc47e: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0xc480: {"kind": 'reg', "py": 'T = 1 if s32(r[5]) >= s32(r[0]) else 0', "slot_py": None, "target": None, "cond": None},
    0xc482: {"kind": "branch", "py": None, "slot_py": '', "target": 0xc48c, "cond": 'T'},
    0xc486: {"kind": 'reg', "py": 'r[0] = s8(0x02)', "slot_py": None, "target": None, "cond": None},
    0xc488: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFA325, 1, r[0])', "target": 0xc490, "cond": 'always'},
    0xc48c: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0xc48e: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA325, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0xc490: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
