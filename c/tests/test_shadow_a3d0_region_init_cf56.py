#!/usr/bin/env python3
"""Differential test for shadow_a3d0_region_init (0xCF56) — v3 lift (branches + delay slots), 30 bytes.
...
Run from repo root: python3 c/tests/test_shadow_a3d0_region_init_cf56.py
"""
...
ENTRY = 0xCF56
RAW = bytes.fromhex("E3 09 D2 2E E5 00 D7 2F 22 30 64 73 66 73 76 06 24 50 74 01 34 62 8F FB 00 09 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFA3D7
SPAN_END = 0xCF74
SENT = 0xCF74     # stop-sentinel, placed past the literal pool
...
CODE = {
    0xcf56: {"kind": 'reg', "py": 'r[3] = s8(0x09)', "slot_py": None, "target": None, "cond": None},
    0xcf58: {"kind": 'reg', "py": 'r[2] = 0xFFFFA3D7', "slot_py": None, "target": None, "cond": None},
    0xcf5a: {"kind": 'reg', "py": 'r[5] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0xcf5c: {"kind": 'reg', "py": 'r[7] = 0xFFFFA3D0', "slot_py": None, "target": None, "cond": None},
    0xcf5e: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA3D7, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0xcf60: {"kind": 'reg', "py": 'r[4] = r[7]', "slot_py": None, "target": None, "cond": None},
    0xcf62: {"kind": 'reg', "py": 'r[6] = r[7]', "slot_py": None, "target": None, "cond": None},
    0xcf64: {"kind": 'reg', "py": 'r[6] = (r[6] + s8(0x06)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xcf66: {"kind": 'mem', "py": '_wrw(ram, r[4], 1, r[5])', "slot_py": None, "target": None, "cond": None},
    0xcf68: {"kind": 'reg', "py": 'r[4] = (r[4] + s8(0x01)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xcf6a: {"kind": 'reg', "py": 'T = 1 if (r[4] & 0xFFFFFFFF) >= (r[6] & 0xFFFFFFFF) else 0', "slot_py": None, "target": None, "cond": None},
    0xcf6c: {"kind": "branch", "py": None, "slot_py": '', "target": 0xcf66, "cond": 'notT'},
    0xcf70: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
