#!/usr/bin/env python3
"""Differential test for conditional_port_output_copy_32194 (0x32194) — v3 lift (branches + delay slots), 24 bytes.
...
Run from repo root: python3 c/tests/test_conditional_port_output_copy_32194_32194.py
"""
...
RAM_MAX = 0xFFFFBFA5
SPAN_END = 0x321AC
SENT = 0x321B4     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x32194: {"kind": 'reg', "py": 'r[3] = 0xFFFFAAE0', "slot_py": None, "target": None, "cond": None},
    0x32196: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFAAE0, 1))', "slot_py": None, "target": None, "cond": None},
    0x32198: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x3219a: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x3219c: {"kind": "branch", "py": None, "slot_py": '', "target": 0x321a8, "cond": 'notT'},
    0x321a0: {"kind": 'reg', "py": 'r[2] = 0xFFFFBFA5', "slot_py": None, "target": None, "cond": None},
    0x321a2: {"kind": 'mem', "py": 'r[1] = s8(_rdw(ram, 0xFFFFBFA5, 1))', "slot_py": None, "target": None, "cond": None},
    0x321a4: {"kind": 'reg', "py": 'r[0] = 0xFFFFBFA4', "slot_py": None, "target": None, "cond": None},
    0x321a6: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBFA4, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x321a8: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
