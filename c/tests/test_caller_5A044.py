#!/usr/bin/env python3
"""Differential test for caller_5A044 (entry 0x5A044) — v8 ST caller (CFG), 52 bytes.
...
Run: python3 test_caller_5A044.py
"""
...
CODE = {
    0x5a044: {"kind": 'mem', "py": 'local[0x3FC] = r[14]\n_wrw(ram, STACK_BASE + 0x3FC, 4, r[14])\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x5a046: {"kind": 'reg', "py": 'r[14] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x5a048: {"kind": 'reg', "py": 'r[3] = 0xFFFFD28C', "slot_py": None, "target": None, "cond": None},
    0x5a04a: {"kind": 'st', "py": 'local[0x3F8] = pr\n_wrw(ram, STACK_BASE + 0x3F8, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x5a04c: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD28C, 1, r[14])', "slot_py": None, "target": None, "cond": None},
    0x5a04e: {"kind": 'reg', "py": 'r[2] = 0xFFFFD28D', "slot_py": None, "target": None, "cond": None},
    0x5a050: {"kind": 'reg', "py": 'r[1] = 0xFFFFD28E', "slot_py": None, "target": None, "cond": None},
    0x5a052: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD28D, 1, r[14])', "slot_py": None, "target": None, "cond": None},
    0x5a054: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD28E, 1, r[14])', "slot_py": None, "target": None, "cond": None},
    0x5a056: {"kind": 'reg', "py": 'r[3] = 0xFFFFD28F', "slot_py": None, "target": None, "cond": None},
    0x5a058: {"kind": 'reg', "py": 'r[2] = 0xFFFFD2AE', "slot_py": None, "target": None, "cond": None},
    0x5a05a: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD28F, 1, r[14])', "slot_py": None, "target": None, "cond": None},
    0x5a05c: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD2AE, 1, r[14])', "slot_py": None, "target": None, "cond": None},
    0x5a05e: {"kind": 'reg', "py": 'r[0] = 0x0007DA94', "slot_py": None, "target": None, "cond": None},
    0x5a060: {"kind": 'reg', "py": 'r[3] = 0xFFFFD2B9', "slot_py": None, "target": None, "cond": None},
    0x5a062: {"kind": 'mem', "py": 'r[1] = s8(_rdw(ram, 0x0007DA94, 1))', "slot_py": None, "target": None, "cond": None},
    0x5a064: {"kind": 'reg', "py": 'r[2] = 0x00056866', "slot_py": None, "target": None, "cond": None},
    0x5a066: {"kind": "call", "py": None, "slot_py": '_wrw(ram, 0xFFFFD2B9, 1, r[1])', "target": 0x56866, "ret_pc": 0x5a06a, "set_pr": True, "cond": None},
    0x5a06a: {"kind": 'reg', "py": 'r[3] = 0xFFFFD2BA', "slot_py": None, "target": None, "cond": None},
    0x5a06c: {"kind": 'reg', "py": 'r[2] = 0xFFFFD2BB', "slot_py": None, "target": None, "cond": None},
    0x5a06e: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD2BA, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x5a070: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD2BB, 1, r[14])', "slot_py": None, "target": None, "cond": None},
    0x5a072: {"kind": 'st', "py": 'pr = _rdw(ram, STACK_BASE + 0x3F8, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x5a074: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, STACK_BASE + 0x3FC, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},
    0x56866: {"kind": 'reg', "py": 'r[3] = 0xFFFFD20B', "slot_py": None, "target": None, "cond": None},
    0x56868: {"kind": "ret", "py": None, "slot_py": 'r[0] = s8(_rdw(ram, 0xFFFFD20B, 1))', "target": None, "cond": None},
}
