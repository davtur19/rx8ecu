#!/usr/bin/env python3
"""Differential test for FUN_00007fb0 (0x7FB0) — v3 lift + v4 FPU, 28 bytes.
...
Run from repo root: python3 c/tests/test_FUN_00007fb0_7fb0.py
"""
...
ENTRY = 0x7FB0
RAW = bytes.fromhex("D2 3A E3 00 D1 3C 22 30 F3 18 D0 39 F0 3A 93 63 D1 3A 62 10 D0 37 32 3C 00 0B 20 20")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFF9FE8
SPAN_END = 0x7FCC
SENT = 0x7FCC     # stop-sentinel, placed past the literal pool
...
CODE = {
    ...
    0x7fc2: {"kind": 'mem', "py": 'r[2] = s8(_rdw(ram, 0xFFFF9FC5, 1))', "slot_py": None, "target": None, "cond": None},
    ...
    0x7fc8: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFF9F94, 1, r[2])', "target": None, "cond": None},}
