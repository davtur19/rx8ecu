#!/usr/bin/env python3
"""Differential test for check_max_injection_threshold_3985E (0x3985E) — v3 lift + v4 FPU, 24 bytes.
...
Run from repo root: python3 c/tests/test_check_max_injection_threshold_3985E_3985e.py
"""
...
ENTRY = 0x3985E
RAW = bytes.fromhex("D2 27 90 39 F3 28 F2 08 F2 35 8F 03 00 09 93 38 E1 01 23 10 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFC572
SPAN_END = 0x39876
SENT = 0x39876     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x3985e: {"kind": 'reg', "py": 'r[2] = 0x0007A5C4', "slot_py": None, "target": None, "cond": None},
    0x39860: {"kind": 'reg', "py": 'r[0] = 0xFFFFC538', "slot_py": None, "target": None, "cond": None},
    0x39862: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x0007A5C4, 4))', "slot_py": None, "target": None, "cond": None},
    0x39864: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0xFFFFC538, 4))', "slot_py": None, "target": None, "cond": None},
    0x39866: {"kind": 'fpu', "py": 'T = 1 if fr[2] > fr[3] else 0', "slot_py": None, "target": None, "cond": None},
    0x39868: {"kind": "branch", "py": None, "slot_py": '', "target": 0x39872, "cond": 'notT'},
    0x3986c: {"kind": 'reg', "py": 'r[3] = 0xFFFFC572', "slot_py": None, "target": None, "cond": None},
    0x3986e: {"kind": 'reg', "py": 'r[1] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x39870: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC572, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x39872: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
