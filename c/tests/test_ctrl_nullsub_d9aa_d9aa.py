#!/usr/bin/env python3
"""Differential test for ctrl_nullsub_d9aa (0xD9AA) — v3 lift (branches + delay slots), 12 bytes.
...
Run from repo root: python3 c/tests/test_ctrl_nullsub_d9aa_d9aa.py
"""
...
RAM_MAX = 0xFFFFA3FC
SPAN_END = 0xD9B6
SENT = 0xD9B6     # stop-sentinel, placed past the literal pool
...
CODE = {
    0xd9aa: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},
    0xd9ae: {"kind": 'reg', "py": 'r[1] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0xd9b0: {"kind": 'reg', "py": 'r[0] = 0xFFFFA3FC', "slot_py": None, "target": None, "cond": None},
    0xd9b2: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFA3FC, 1, r[1])', "target": None, "cond": None},}
