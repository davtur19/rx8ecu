#!/usr/bin/env python3
"""Differential test for FUN_0004c3e4 (0x4C3E4) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_FUN_0004c3e4_4c3e4.py
"""
...
ENTRY = 0x4C3E4
RAW = bytes.fromhex("E2 00 25 22 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    ...
    0x4c3e6: {"kind": 'mem', "py": '_wrw(ram, r[5], 4, r[2])', "slot_py": None, "target": None, "cond": None},
