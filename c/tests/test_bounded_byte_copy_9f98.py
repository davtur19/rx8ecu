#!/usr/bin/env python3
"""Differential test for bounded_byte_copy (0x9F98) — v3 lift (branches + delay slots), 42 bytes.
...
Run from repo root: python3 c/tests/test_bounded_byte_copy_9f98.py
"""
...
RAM_MAX = None
SPAN_END = 0x9FC2
SENT = 0x9FC2     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x9f98: {"kind": 'reg', "py": 'r[15] = (r[15] + s8(0xFC)) & 0xFFFFFFFF\nsp = (sp + s8(0xFC)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x9f9a: {"kind": 'reg', "py": 'r[4] = (r[4] + r[5]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x9f9c: {"kind": 'mem', "py": 'local[0x3FC] = r[4]\n_wrw(ram, STACK_BASE + 0x3FC, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x9f9e: {"kind": 'reg', "py": 'r[3] = r[5] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x9fa0: {"kind": 'reg', "py": 'r[7] = (r[7] + r[3]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x9fa2: {"kind": 'reg', "py": 'r[4] = r[5]', "slot_py": None, "target": None, "cond": None},
    0x9fa4: {"kind": 'mem', "py": 'r[5] = s8(_rdw(ram, STACK_BASE + 0x3FC, 1))', "slot_py": None, "target": None, "cond": None},
    0x9fa6: {"kind": 'reg', "py": 'r[3] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x9fa8: {"kind": 'reg', "py": 'r[5] = r[5] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x9faa: {"kind": 'reg', "py": 'T = 1 if s32(r[3]) >= s32(r[5]) else 0', "slot_py": None, "target": None, "cond": None},
    0x9fac: {"kind": "branch", "py": None, "slot_py": '', "target": 0x9fbe, "cond": 'T'},
    0x9fb0: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, r[7], 1))\nr[7] = (r[7] + 1) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x9fb2: {"kind": 'reg', "py": 'r[4] = (r[4] + s8(0x01)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x9fb4: {"kind": 'mem', "py": '_wrw(ram, r[6], 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x9fb6: {"kind": 'reg', "py": 'r[2] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x9fb8: {"kind": 'reg', "py": 'T = 1 if s32(r[2]) >= s32(r[5]) else 0', "slot_py": None, "target": None, "cond": None},
    0x9fba: {"kind": "branch", "py": None, "slot_py": 'r[6] = (r[6] + s8(0x01)) & 0xFFFFFFFF', "target": 0x9fb0, "cond": 'notT'},
    0x9fbe: {"kind": "ret", "py": None, "slot_py": 'r[15] = (r[15] + s8(0x04)) & 0xFFFFFFFF\nsp = (sp + s8(0x04)) & 0xFFFFFFFF', "target": None, "cond": None},}
