#!/usr/bin/env python3
"""Differential test for DSC_checkIfMode_x20_a (0x2C5B0) — v3 lift (branches + delay slots), 30 bytes.
...
Run from repo root: python3 c/tests/test_DSC_checkIfMode_x20_a_2c5b0.py
"""
...
CODE = {
    0x2c5b0: {"kind": 'reg', "py": 'r[4] = 0xFFFFBC35', "slot_py": None, "target": None, "cond": None},
    0x2c5b2: {"kind": 'reg', "py": 'r[3] = 0xFFFFBC5E', "slot_py": None, "target": None, "cond": None},
    0x2c5b4: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFBC5E, 1))', "slot_py": None, "target": None, "cond": None},
    0x2c5b6: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x2c5b8: {"kind": 'reg', "py": 'r[0] = (r[0] & 0x20) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x2c5ba: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x20) else 0', "slot_py": None, "target": None, "cond": None},
    0x2c5bc: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2c5c6, "cond": 'notT'},
    0x2c5c0: {"kind": 'reg', "py": 'r[1] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x2c5c2: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFBC35, 1, r[1])', "target": 0x2c5ca, "cond": 'always'},
    0x2c5c6: {"kind": 'reg', "py": 'r[0] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x2c5c8: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBC35, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x2c5ca: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
