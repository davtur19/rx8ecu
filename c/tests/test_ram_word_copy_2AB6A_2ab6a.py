#!/usr/bin/env python3
"""Differential test for ram_word_copy_2AB6A (0x2AB6A) — v3 lift (branches + delay slots), 10 bytes.
...
Run from repo root: python3 c/tests/test_ram_word_copy_2AB6A_2ab6a.py
"""
...
CODE = {
    0x2ab6a: {"kind": 'reg', "py": 'r[3] = 0xFFFFBBA8', "slot_py": None, "target": None, "cond": None},
    0x2ab6c: {"kind": 'reg', "py": 'r[2] = 0xFFFFBBC0', "slot_py": None, "target": None, "cond": None},
    0x2ab6e: {"kind": 'mem', "py": 'r[1] = s16(_rdw(ram, 0xFFFFBBA8, 2))', "slot_py": None, "target": None, "cond": None},
    0x2ab70: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBBC0, 2, r[1])', "target": None, "cond": None},}
