#!/usr/bin/env python3
"""Differential test for caller_41AA4 (entry 0x41AA4) — v8 ST caller (CFG), 30 bytes.
...
Run: python3 test_caller_41AA4.py
"""
...
CODE = {
    0x41aa4: {"kind": 'st', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x41aa6: {"kind": 'reg', "py": 'r[0] = 0x00041B70', "slot_py": None, "target": None, "cond": None},
    0x41aa8: {"kind": 'reg', "py": 'r[3] = 0x00079BD4', "slot_py": None, "target": None, "cond": None},
    0x41aaa: {"kind": 'fpu', "py": 'fr[7] = bits2f(_rdw(ram, 0x00041B70, 4))', "slot_py": None, "target": None, "cond": None},
    0x41aac: {"kind": 'fpu', "py": 'fr[6] = bits2f(_rdw(ram, 0x00079BD4, 4))', "slot_py": None, "target": None, "cond": None},
    0x41aae: {"kind": 'reg', "py": 'r[2] = 0xFFFFC840', "slot_py": None, "target": None, "cond": None},
    0x41ab0: {"kind": 'reg', "py": 'r[1] = 0xFFFFAA74', "slot_py": None, "target": None, "cond": None},
    0x41ab2: {"kind": 'fpu', "py": 'fr[5] = bits2f(_rdw(ram, 0xFFFFC840, 4))', "slot_py": None, "target": None, "cond": None},
    0x41ab4: {"kind": 'reg', "py": 'r[3] = 0x000023B0', "slot_py": None, "target": None, "cond": None},
    0x41ab6: {"kind": "call", "py": None, "slot_py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFAA74, 4))', "target": 0x23b0, "ret_pc": 0x41aba, "set_pr": True, "cond": None},
    0x41aba: {"kind": 'reg', "py": 'r[2] = 0xFFFFC840', "slot_py": None, "target": None, "cond": None},
    0x41abc: {"kind": 'st', "py": 'pr = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x41abe: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFC840, 4, f2bits(fr[0]))', "target": None, "cond": None},
