#!/usr/bin/env python3
"""Differential test for FUN_00059da0 (0x59DA0) — v3 lift (branches + delay slots), 36 bytes.
...
Run from repo root: python3 c/tests/test_FUN_00059da0_59da0.py
"""
...
ENTRY = 0x59DA0
RAW = bytes.fromhex("88 01 8D 06 00 09 92 24 60 20 60 0C 88 01 8F 07 00 09 E2 00 91 1F 93 1D 90 1E 23 50 21 20 20 50 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFD298
SPAN_END = 0x59DC4
SENT = 0x59DC4     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x59da0: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x59da2: {"kind": "branch", "py": None, "slot_py": '', "target": 0x59db2, "cond": 'T'},
    0x59da6: {"kind": 'reg', "py": 'r[2] = 0xFFFFD292', "slot_py": None, "target": None, "cond": None},
    0x59da8: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFD292, 1))', "slot_py": None, "target": None, "cond": None},
    0x59daa: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x59dac: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x59dae: {"kind": "branch", "py": None, "slot_py": '', "target": 0x59dc0, "cond": 'notT'},
    0x59db2: {"kind": 'reg', "py": 'r[2] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x59db4: {"kind": 'reg', "py": 'r[1] = 0xFFFFD297', "slot_py": None, "target": None, "cond": None},
    0x59db6: {"kind": 'reg', "py": 'r[3] = 0xFFFFD296', "slot_py": None, "target": None, "cond": None},
    0x59db8: {"kind": 'reg', "py": 'r[0] = 0xFFFFD298', "slot_py": None, "target": None, "cond": None},
    0x59dba: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD296, 1, r[5])', "slot_py": None, "target": None, "cond": None},
    0x59dbc: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD297, 1, r[2])', "slot_py": None, "target": None, "cond": None},
    0x59dbe: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD298, 1, r[5])', "slot_py": None, "target": None, "cond": None},
    0x59dc0: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
