#!/usr/bin/env python3
"""Differential test for coolantTempModelBooleans (0x3EABA) — v3 lift + v4 FPU, 66 bytes.
...
Run from repo root: python3 c/tests/test_coolantTempModelBooleans_3eaba.py
"""
...
ENTRY = 0x3EABA
RAW = bytes.fromhex("E5 01 D2 2C 93 3B 96 3F F4 38 F3 28 F3 45 8F 02 E4 00 A0 06 26 40 D1 28 F2 18 F4 25 8F 01 00 09 26 50 96 32 D3 26 F3 38 F3 45 8F 02 00 09 A0 06 26 40 D2 23 F2 28 F4 25 8F 01 00 09 26 50 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFC649
SPAN_END = 0x3EAFC
SENT = 0x3EAFC     # stop-sentinel, placed past the literal pool
...
CODE = {
    ...
    0x3eada: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC648, 1, r[5])', "slot_py": None, "target": None, "cond": None},
    ...
    0x3eae8: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFC649, 1, r[4])', "target": 0x3eaf8, "cond": 'always'},
    ...
    0x3eaf6: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC649, 1, r[5])', "slot_py": None, "target": None, "cond": None},
