#!/usr/bin/env python3
"""Differential test for ram_word_copy_2AB56 (0x2AB56) — v3 lift (branches + delay slots), 10 bytes.
...
Run from repo root: python3 c/tests/test_ram_word_copy_2AB56_2ab56.py
"""
...
CODE = {
    0x2ab56: {"kind": 'reg', "py": 'r[2] = 0xFFFFBBA4', "slot_py": None, "target": None, "cond": None},
    0x2ab58: {"kind": 'reg', "py": 'r[1] = 0xFFFFBBBC', "slot_py": None, "target": None, "cond": None},
    0x2ab5a: {"kind": 'mem', "py": 'r[3] = s16(_rdw(ram, 0xFFFFBBA4, 2))', "slot_py": None, "target": None, "cond": None},
    0x2ab5c: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBBBC, 2, r[3])', "target": None, "cond": None},}
