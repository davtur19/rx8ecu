#!/usr/bin/env python3
"""Differential test for caller_2DD88 (entry 0x2DD88) — v8 ST caller (CFG), 30 bytes.
...
Run: python3 test_caller_2DD88.py
"""
...
CODE = {
    0x2dd88: {"kind": 'st', "py": 'local[0x3FC] = pr\n_wrw(ram, STACK_BASE + 0x3FC, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x2dd8a: {"kind": 'reg', "py": 'r[0] = 0x0002DDB8', "slot_py": None, "target": None, "cond": None},
    0x2dd8c: {"kind": 'reg', "py": 'r[3] = 0x00076B30', "slot_py": None, "target": None, "cond": None},
    0x2dd8e: {"kind": 'fpu', "py": 'fr[7] = bits2f(_rdw(ram, 0x0002DDB8, 4))', "slot_py": None, "target": None, "cond": None},
    0x2dd90: {"kind": 'fpu', "py": 'fr[6] = bits2f(_rdw(ram, 0x00076B30, 4))', "slot_py": None, "target": None, "cond": None},
    0x2dd92: {"kind": 'reg', "py": 'r[2] = 0xFFFFBD38', "slot_py": None, "target": None, "cond": None},
    0x2dd94: {"kind": 'reg', "py": 'r[1] = 0xFFFFBD3C', "slot_py": None, "target": None, "cond": None},
    0x2dd96: {"kind": 'fpu', "py": 'fr[5] = bits2f(_rdw(ram, 0xFFFFBD38, 4))', "slot_py": None, "target": None, "cond": None},
    0x2dd98: {"kind": 'reg', "py": 'r[3] = 0x000023B0', "slot_py": None, "target": None, "cond": None},
    0x2dd9a: {"kind": "call", "py": None, "slot_py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFBD3C, 4))', "target": 0x23b0, "ret_pc": 0x2dd9e, "set_pr": True, "cond": None},
    0x2dd9e: {"kind": 'reg', "py": 'r[2] = 0xFFFFBD38', "slot_py": None, "target": None, "cond": None},
    0x2dda0: {"kind": 'st', "py": 'pr = _rdw(ram, STACK_BASE + 0x3FC, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x2dda2: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBD38, 4, f2bits(fr[0]))', "target": None, "cond": None},
