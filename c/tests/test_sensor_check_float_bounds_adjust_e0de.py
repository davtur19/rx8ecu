#!/usr/bin/env python3
"""Differential test for sensor_check_float_bounds_adjust (0xE0DE) — v3 lift + v4 FPU, 44 bytes.
...
Run from repo root: python3 c/tests/test_sensor_check_float_bounds_adjust_e0de.py
"""
...
RAM_MAX = 0xFFFFB600
SPAN_END = 0xE10A
SENT = 0xE10A     # stop-sentinel, placed past the literal pool
...
CODE = {
    0xe0de: {"kind": 'reg', "py": 'r[5] = 0xFFFFA400', "slot_py": None, "target": None, "cond": None},
    0xe0e0: {"kind": 'reg', "py": 'r[3] = 0x0006CF8C', "slot_py": None, "target": None, "cond": None},
    0xe0e2: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x0006CF8C, 4))', "slot_py": None, "target": None, "cond": None},
    0xe0e4: {"kind": 'reg', "py": 'r[2] = 0xFFFFB600', "slot_py": None, "target": None, "cond": None},
    0xe0e6: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0xFFFFB600, 4))', "slot_py": None, "target": None, "cond": None},
    0xe0e8: {"kind": 'fpu', "py": 'T = 1 if fr[3] > fr[2] else 0', "slot_py": None, "target": None, "cond": None},
    0xe0ea: {"kind": "branch", "py": None, "slot_py": '', "target": 0xe0f6, "cond": 'notT'},
    0xe0ee: {"kind": 'reg', "py": 'r[1] = 0x0006CF88', "slot_py": None, "target": None, "cond": None},
    0xe0f0: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0x0006CF88, 1))', "slot_py": None, "target": None, "cond": None},
    0xe0f2: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFA400, 1, r[0])', "target": 0xe106, "cond": 'always'},
    0xe0f6: {"kind": 'mem', "py": 'r[4] = s8(_rdw(ram, 0xFFFFA400, 1))', "slot_py": None, "target": None, "cond": None},
    0xe0f8: {"kind": 'reg', "py": 'r[1] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0xe0fa: {"kind": 'reg', "py": 'T = 1 if (r[1] & r[1]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0xe0fc: {"kind": "branch", "py": None, "slot_py": '', "target": 0xe106, "cond": 'T'},
    0xe100: {"kind": 'reg', "py": 'r[0] = 0x000000FF', "slot_py": None, "target": None, "cond": None},
    0xe102: {"kind": 'reg', "py": 'r[4] = (r[4] + r[0]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xe104: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA400, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0xe106: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
