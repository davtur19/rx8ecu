#!/usr/bin/env python3
"""Differential test for caller_66406 (entry 0x66406) — v8 ST caller (CFG), 18 bytes.
...
Run: python3 test_caller_66406.py
"""
...
CODE = {
    0x66406: {"kind": 'st', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x66408: {"kind": 'reg', "py": 'r[3] = 0xFFFF8FD8', "slot_py": None, "target": None, "cond": None},
    0x6640a: {"kind": 'reg', "py": 'r[2] = 0x00002430', "slot_py": None, "target": None, "cond": None},
    0x6640c: {"kind": "call", "py": None, "slot_py": 'r[4] = s16(_rdw(ram, 0xFFFF8FD8, 2))', "target": 0x2430, "ret_pc": 0x66410, "set_pr": True, "cond": None},
    0x66410: {"kind": 'reg', "py": 'r[1] = 0xFFFF8FD4', "slot_py": None, "target": None, "cond": None},
    0x66412: {"kind": 'st', "py": 'pr = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x66414: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFF8FD4, 4, r[0])', "target": None, "cond": None},
