#!/usr/bin/env python3
"""Differential test for caller_25EC4 (entry 0x25EC4) — v8 ST caller (CFG), 30 bytes.
...
Run: python3 test_caller_25EC4.py
"""
...
CODE = {
    0x25ec4: {"kind": 'st', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x25ec6: {"kind": 'reg', "py": 'r[0] = 0x00025EEC', "slot_py": None, "target": None, "cond": None},
    0x25ec8: {"kind": 'reg', "py": 'r[3] = 0x000749E8', "slot_py": None, "target": None, "cond": None},
    0x25eca: {"kind": 'fpu', "py": 'fr[7] = bits2f(_rdw(ram, 0x00025EEC, 4))', "slot_py": None, "target": None, "cond": None},
    0x25ecc: {"kind": 'fpu', "py": 'fr[6] = bits2f(_rdw(ram, 0x000749E8, 4))', "slot_py": None, "target": None, "cond": None},
    0x25ece: {"kind": 'reg', "py": 'r[2] = 0xFFFFB5E0', "slot_py": None, "target": None, "cond": None},
    0x25ed0: {"kind": 'reg', "py": 'r[1] = 0xFFFFB5DC', "slot_py": None, "target": None, "cond": None},
    0x25ed2: {"kind": 'fpu', "py": 'fr[5] = bits2f(_rdw(ram, 0xFFFFB5E0, 4))', "slot_py": None, "target": None, "cond": None},
    0x25ed4: {"kind": 'reg', "py": 'r[3] = 0x000023B0', "slot_py": None, "target": None, "cond": None},
    0x25ed6: {"kind": "call", "py": None, "slot_py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFB5DC, 4))', "target": 0x23b0, "ret_pc": 0x25eda, "set_pr": True, "cond": None},
    0x25eda: {"kind": 'reg', "py": 'r[2] = 0xFFFFB5E0', "slot_py": None, "target": None, "cond": None},
    0x25edc: {"kind": 'st', "py": 'pr = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x25ede: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFB5E0, 4, f2bits(fr[0]))', "target": None, "cond": None},
