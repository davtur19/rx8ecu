#!/usr/bin/env python3
"""Differential test for caller_44C6E (entry 0x44C6E) — v8 ST caller (CFG), 24 bytes.
...
Run: python3 test_caller_44C6E.py
"""
...
CODE = {
    0x44c6e: {"kind": 'fpu', "py": 'fr[5] = 0.0', "slot_py": None, "target": None, "cond": None},
    0x44c70: {"kind": 'reg', "py": 'r[0] = 0x00044CCC', "slot_py": None, "target": None, "cond": None},
    0x44c72: {"kind": 'st', "py": 'local[0x3FC] = pr\n_wrw(ram, STACK_BASE + 0x3FC, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x44c74: {"kind": 'reg', "py": 'r[4] = 0xFFFF9EF0', "slot_py": None, "target": None, "cond": None},
    0x44c76: {"kind": 'mem', "py": 'r[4] = s16(_rdw(ram, 0xFFFF9EF0, 2))', "slot_py": None, "target": None, "cond": None},
    0x44c78: {"kind": 'reg', "py": 'r[3] = 0x000024C0', "slot_py": None, "target": None, "cond": None},
    0x44c7a: {"kind": "call", "py": None, "slot_py": 'fr[4] = bits2f(_rdw(ram, 0x00044CCC, 4))', "target": 0x24c0, "ret_pc": 0x44c7e, "set_pr": True, "cond": None},
    0x44c7e: {"kind": 'reg', "py": 'r[2] = 0xFFFFCB20', "slot_py": None, "target": None, "cond": None},
    0x44c80: {"kind": 'st', "py": 'pr = _rdw(ram, STACK_BASE + 0x3FC, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x44c82: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFCB20, 4, f2bits(fr[0]))', "target": None, "cond": None},
