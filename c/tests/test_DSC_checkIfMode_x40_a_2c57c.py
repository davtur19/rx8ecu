#!/usr/bin/env python3
"""Differential test for DSC_checkIfMode_x40_a (0x2C57C) — v3 lift (branches + delay slots), 52 bytes.
...
Run from repo root: python3 c/tests/test_DSC_checkIfMode_x40_a_2c57c.py
"""
...
CODE = {
    0x2c57c: {"kind": 'reg', "py": 'r[4] = 0xFFFFBC34', "slot_py": None, "target": None, "cond": None},
    0x2c57e: {"kind": 'reg', "py": 'r[3] = 0xFFFFBC5E', "slot_py": None, "target": None, "cond": None},
    0x2c580: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFBC5E, 1))', "slot_py": None, "target": None, "cond": None},
    0x2c582: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x2c584: {"kind": 'reg', "py": 'r[0] = (r[0] & 0x40) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x2c586: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x40) else 0', "slot_py": None, "target": None, "cond": None},
    0x2c588: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2c596, "cond": 'T'},
    0x2c58c: {"kind": 'reg', "py": 'r[2] = 0x00078D5F', "slot_py": None, "target": None, "cond": None},
    0x2c58e: {"kind": 'mem', "py": 'r[1] = s8(_rdw(ram, 0x00078D5F, 1))', "slot_py": None, "target": None, "cond": None},
    0x2c590: {"kind": 'reg', "py": 'T = 1 if (r[1] & r[1]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x2c592: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2c5a8, "cond": 'T'},
    0x2c596: {"kind": 'reg', "py": 'r[3] = 0xFFFFA428', "slot_py": None, "target": None, "cond": None},
    0x2c598: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFA428, 1))', "slot_py": None, "target": None, "cond": None},
    0x2c59a: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x2c59c: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x2c59e: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2c5a8, "cond": 'notT'},
    0x2c5a2: {"kind": 'reg', "py": 'r[3] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x2c5a4: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFBC34, 1, r[3])', "target": 0x2c5ac, "cond": 'always'},
    0x2c5a8: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x2c5aa: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBC34, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x2c5ac: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
