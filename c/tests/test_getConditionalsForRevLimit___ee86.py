#!/usr/bin/env python3
"""Differential test for getConditionalsForRevLimit__ (0xEE86) — v3 lift + v4 FPU, 120 bytes.
...
Run from repo root: python3 c/tests/test_getConditionalsForRevLimit___ee86.py
"""
...
RAM_MAX = 0xFFFFBB24
SPAN_END = 0xEEFE
SENT = 0xEEFE     # stop-sentinel, placed past the literal pool
...
CODE = {
    0xee86: {"kind": 'reg', "py": 'r[7] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0xee88: {"kind": 'reg', "py": 'r[2] = 0xFFFFA9FC', "slot_py": None, "target": None, "cond": None},
    0xee8a: {"kind": 'fpu', "py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFA9FC, 4))', "slot_py": None, "target": None, "cond": None},
    0xee8c: {"kind": 'reg', "py": 'r[3] = 0xFFFFBB24', "slot_py": None, "target": None, "cond": None},
    0xee8e: {"kind": 'mem', "py": 'r[4] = s8(_rdw(ram, 0xFFFFBB24, 1))', "slot_py": None, "target": None, "cond": None},
    0xee90: {"kind": 'reg', "py": 'r[1] = 0x0006DA3C', "slot_py": None, "target": None, "cond": None},
    0xee92: {"kind": 'fpu', "py": 'fr[5] = bits2f(_rdw(ram, 0x0006DA3C, 4))', "slot_py": None, "target": None, "cond": None},
    0xee94: {"kind": 'reg', "py": 'r[2] = 0x0006DA40', "slot_py": None, "target": None, "cond": None},
    0xee96: {"kind": 'fpu', "py": 'fr[6] = fr[5]', "slot_py": None, "target": None, "cond": None},
    0xee98: {"kind": 'reg', "py": 'r[5] = 0xFFFFA4A6', "slot_py": None, "target": None, "cond": None},
    0xee9a: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x0006DA40, 4))', "slot_py": None, "target": None, "cond": None},
    0xee9c: {"kind": 'fpu', "py": 'fr[6] = ts(fr[6] - fr[3])', "slot_py": None, "target": None, "cond": None},
    0xee9e: {"kind": 'fpu', "py": 'T = 1 if fr[6] > fr[4] else 0', "slot_py": None, "target": None, "cond": None},
    0xeea0: {"kind": "branch", "py": None, "slot_py": 'r[6] = s8(0x00)', "target": 0xeea8, "cond": 'notT'},
    0xeea4: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFA4A6, 1, r[7])', "target": 0xeeb0, "cond": 'always'},
    0xeea8: {"kind": 'fpu', "py": 'T = 1 if fr[5] > fr[4] else 0', "slot_py": None, "target": None, "cond": None},
    0xeeaa: {"kind": "branch", "py": None, "slot_py": '', "target": 0xeeb0, "cond": 'T'},
    0xeeae: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA4A6, 1, r[6])', "slot_py": None, "target": None, "cond": None},
    0xeeb0: {"kind": 'reg', "py": 'r[5] = 0xFFFFA4AE', "slot_py": None, "target": None, "cond": None},
    0xeeb2: {"kind": 'reg', "py": 'r[3] = 0xFFFFB580', "slot_py": None, "target": None, "cond": None},
    0xeeb4: {"kind": 'mem', "py": 'r[2] = s8(_rdw(ram, 0xFFFFB580, 1))', "slot_py": None, "target": None, "cond": None},
    0xeeb6: {"kind": 'reg', "py": 'T = 1 if (r[2] & r[2]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0xeeb8: {"kind": "branch", "py": None, "slot_py": '', "target": 0xeedc, "cond": 'notT'},
    0xeebc: {"kind": 'reg', "py": 'r[0] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0xeebe: {"kind": 'reg', "py": 'T = 1 if (r[0] & r[0]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0xeec0: {"kind": "branch", "py": None, "slot_py": '', "target": 0xeedc, "cond": 'T'},
    0xeec4: {"kind": 'reg', "py": 'r[2] = 0xFFFFA4AD', "slot_py": None, "target": None, "cond": None},
    0xeec6: {"kind": 'mem', "py": 'r[1] = s8(_rdw(ram, 0xFFFFA4AD, 1))', "slot_py": None, "target": None, "cond": None},
    0xeec8: {"kind": 'reg', "py": 'T = 1 if (r[1] & r[1]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0xeeca: {"kind": "branch", "py": None, "slot_py": '', "target": 0xeedc, "cond": 'notT'},
    0xeece: {"kind": 'reg', "py": 'r[0] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0xeed0: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x07) else 0', "slot_py": None, "target": None, "cond": None},
    0xeed2: {"kind": "branch", "py": None, "slot_py": '', "target": 0xeedc, "cond": 'T'},
    0xeed6: {"kind": 'reg', "py": 'r[2] = 0x0006DA34', "slot_py": None, "target": None, "cond": None},
    0xeed8: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0x0006DA34, 1))', "slot_py": None, "target": None, "cond": None},
    0xeeda: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA4AE, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0xeedc: {"kind": 'mem', "py": 'r[1] = s8(_rdw(ram, r[5], 1))', "slot_py": None, "target": None, "cond": None},
    0xeede: {"kind": 'reg', "py": 'r[1] = r[1] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0xeee0: {"kind": 'reg', "py": 'T = 1 if s32(r[1]) > 0 else 0', "slot_py": None, "target": None, "cond": None},
    0xeee2: {"kind": "branch", "py": None, "slot_py": '', "target": 0xeef4, "cond": 'notT'},
    0xeee6: {"kind": 'reg', "py": 'r[2] = 0xFFFFA4AA', "slot_py": None, "target": None, "cond": None},
    0xeee8: {"kind": 'reg', "py": 'r[3] = 0x000000FF', "slot_py": None, "target": None, "cond": None},
    0xeeea: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA4AA, 1, r[7])', "slot_py": None, "target": None, "cond": None},
    0xeeec: {"kind": 'mem', "py": 'r[1] = s8(_rdw(ram, 0xFFFFA4AE, 1))', "slot_py": None, "target": None, "cond": None},
    0xeeee: {"kind": 'reg', "py": 'r[1] = (r[1] + r[3]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xeef0: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFA4AE, 1, r[1])', "target": 0xeef8, "cond": 'always'},
    0xeef4: {"kind": 'reg', "py": 'r[3] = 0xFFFFA4AA', "slot_py": None, "target": None, "cond": None},
    0xeef6: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA4AA, 1, r[6])', "slot_py": None, "target": None, "cond": None},
    0xeef8: {"kind": 'reg', "py": 'r[2] = 0xFFFFA4AD', "slot_py": None, "target": None, "cond": None},
    0xeefa: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFA4AD, 1, r[4])', "target": None, "cond": None},}
