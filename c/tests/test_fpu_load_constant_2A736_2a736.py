#!/usr/bin/env python3
"""Differential test for fpu_load_constant_2A736 (0x2A736) — v3 lift + v4 FPU, 10 bytes.
...
Run from repo root: python3 c/tests/test_fpu_load_constant_2A736_2a736.py
"""
...
ENTRY = 0x2A736
RAW = bytes.fromhex("D3 39 92 5B F3 38 00 0B F2 3A")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBB88
SPAN_END = 0x2A740
SENT = 0x2A740     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x2a736: {"kind": 'reg', "py": 'r[3] = 0x00078D88', "slot_py": None, "target": None, "cond": None},
    0x2a738: {"kind": 'reg', "py": 'r[2] = 0xFFFFBB88', "slot_py": None, "target": None, "cond": None},
    0x2a73a: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x00078D88, 4))', "slot_py": None, "target": None, "cond": None},
    0x2a73c: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBB88, 4, f2bits(fr[3]))', "target": None, "cond": None},}
