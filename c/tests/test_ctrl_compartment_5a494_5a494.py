#!/usr/bin/env python3
"""Differential test for ctrl_compartment_5a494 (0x5A494) — v3 lift (branches + delay slots), 56 bytes.
...
Run from repo root: python3 c/tests/test_ctrl_compartment_5a494_5a494.py
"""
...
ENTRY = 0x5A494
RAW = bytes.fromhex("95 1E 60 50 60 0C 88 30 8F 02 E4 01 92 19 22 40 97 18 60 50 60 0C 88 10 8F 02 E6 00 A0 01 27 40 27 60 97 10 60 50 60 0C 88 20 8F 02 00 09 A0 01 27 40 27 60 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    0x5a494: {"kind": 'reg', "py": 'r[5] = 0xFFFFD28D', "slot_py": None, "target": None, "cond": None},
    0x5a496: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFD28D, 1))', "slot_py": None, "target": None, "cond": None},
    0x5a498: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x5a49a: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x30) else 0', "slot_py": None, "target": None, "cond": None},
    0x5a49c: {"kind": "branch", "py": None, "slot_py": 'r[4] = s8(0x01)', "target": 0x5a4a4, "cond": 'notT'},
    0x5a4a0: {"kind": 'reg', "py": 'r[2] = 0xFFFFD29E', "slot_py": None, "target": None, "cond": None},
    0x5a4a2: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD29E, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x5a4a4: {"kind": 'reg', "py": 'r[7] = 0xFFFFD29F', "slot_py": None, "target": None, "cond": None},
    0x5a4a6: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFD28D, 1))', "slot_py": None, "target": None, "cond": None},
    0x5a4a8: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x5a4aa: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x10) else 0', "slot_py": None, "target": None, "cond": None},
    0x5a4ac: {"kind": "branch", "py": None, "slot_py": 'r[6] = s8(0x00)', "target": 0x5a4b4, "cond": 'notT'},
    0x5a4b0: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFD29F, 1, r[4])', "target": 0x5a4b6, "cond": 'always'},
    0x5a4b4: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD29F, 1, r[6])', "slot_py": None, "target": None, "cond": None},
    0x5a4b6: {"kind": 'reg', "py": 'r[7] = 0xFFFFD2A0', "slot_py": None, "target": None, "cond": None},
    0x5a4b8: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFD28D, 1))', "slot_py": None, "target": None, "cond": None},
    0x5a4ba: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x5a4bc: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x20) else 0', "slot_py": None, "target": None, "cond": None},
    0x5a4be: {"kind": "branch", "py": None, "slot_py": '', "target": 0x5a4c6, "cond": 'notT'},
    0x5a4c2: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFD2A0, 1, r[4])', "target": 0x5a4c8, "cond": 'always'},
    0x5a4c6: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD2A0, 1, r[6])', "slot_py": None, "target": None, "cond": None},
    0x5a4c8: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
