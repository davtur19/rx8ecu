#!/usr/bin/env python3
"""Differential test for hcan_mbox_word_byteswap_write (0xCEC8) — pure straight-line lift, 8 bytes.
...
Run from repo root: python3 c/tests/test_hcan_mbox_word_byteswap_write_cec8.py
"""
...
ENTRY = 0xCEC8
RAW = bytes.fromhex("63 E3 43 19 63 3C 32 3C")
SEED = 42
N = 2000
