#!/usr/bin/env python3
"""Differential test for fpu_control_reset (0xD9A2) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_fpu_control_reset_d9a2.py
"""
...
CODE = {
    0xd9a2: {"kind": 'reg', "py": 'r[3] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0xd9a4: {"kind": 'reg', "py": 'r[2] = 0xFFFFA3FC', "slot_py": None, "target": None, "cond": None},
    0xd9a6: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFA3FC, 1, r[3])', "target": None, "cond": None},}
