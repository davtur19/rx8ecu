#!/usr/bin/env python3
"""Differential test for uds_request_3ded4 (0x3DED4) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_uds_request_3ded4_3ded4.py
"""
...
ENTRY = 0x3DED4
RAW = bytes.fromhex("6C F6 6D F6 00 0B 6E F6")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = None
SPAN_END = 0x3DEDC
SENT = 0x3DEDC     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x3ded4: {"kind": 'mem', "py": 'r[12] = _rdw(ram, STACK_BASE + 0x400, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x3ded6: {"kind": 'mem', "py": 'r[13] = _rdw(ram, STACK_BASE + 0x404, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x3ded8: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, STACK_BASE + 0x408, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},}
