#!/usr/bin/env python3
"""Differential test for conditional_flag_copy_30F5A (0x30F5A) — v3 lift + v4 FPU, 24 bytes.
...
Run from repo root: python3 c/tests/test_conditional_flag_copy_30F5A_30f5a.py
"""
...
RAM_MAX = 0xFFFFBEE8
SPAN_END = 0x30F72
SENT = 0x30F72     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x30f5a: {"kind": 'reg', "py": 'r[3] = 0xFFFF9F8C', "slot_py": None, "target": None, "cond": None},
    0x30f5c: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFF9F8C, 1))', "slot_py": None, "target": None, "cond": None},
    0x30f5e: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x30f60: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x30f62: {"kind": "branch", "py": None, "slot_py": '', "target": 0x30f6e, "cond": 'notT'},
    0x30f66: {"kind": 'reg', "py": 'r[2] = 0x00078254', "slot_py": None, "target": None, "cond": None},
    0x30f68: {"kind": 'reg', "py": 'r[1] = 0xFFFFBEE8', "slot_py": None, "target": None, "cond": None},
    0x30f6a: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x00078254, 4))', "slot_py": None, "target": None, "cond": None},
    0x30f6c: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFBEE8, 4, f2bits(fr[3]))', "slot_py": None, "target": None, "cond": None},
    0x30f6e: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
