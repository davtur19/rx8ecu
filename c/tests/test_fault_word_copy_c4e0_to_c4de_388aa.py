#!/usr/bin/env python3
"""Differential test for fault_word_copy_c4e0_to_c4de (0x388AA) — v3 lift (branches + delay slots), 10 bytes.
...
Run from repo root: python3 c/tests/test_fault_word_copy_c4e0_to_c4de_388aa.py
"""
...
ENTRY = 0x388AA
RAW = bytes.fromhex("D1 19 92 24 63 11 00 0B 22 31")
SEED = 43
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFC4E0
SPAN_END = 0x388B4
SENT = 0x388B4     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x388aa: {"kind": 'reg', "py": 'r[1] = 0xFFFFC4E0', "slot_py": None, "target": None, "cond": None},
    0x388ac: {"kind": 'reg', "py": 'r[2] = 0xFFFFC4DE', "slot_py": None, "target": None, "cond": None},
    0x388ae: {"kind": 'mem', "py": 'r[3] = s16(_rdw(ram, 0xFFFFC4E0, 2))', "slot_py": None, "target": None, "cond": None},
    0x388b0: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFC4DE, 2, r[3])', "target": None, "cond": None},}
