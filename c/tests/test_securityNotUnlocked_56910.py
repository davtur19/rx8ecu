#!/usr/bin/env python3
"""Differential test for securityNotUnlocked (0x56910) — v3 lift (branches + delay slots), 24 bytes.
...
Run from repo root: python3 c/tests/test_securityNotUnlocked_56910.py
"""
...
CODE = {
    0x56910: {"kind": 'reg', "py": 'r[1] = 0xFFFFD20C', "slot_py": None, "target": None, "cond": None},
    0x56912: {"kind": 'reg', "py": 'r[4] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x56914: {"kind": 'mem', "py": 'r[2] = s8(_rdw(ram, 0xFFFFD20C, 1))', "slot_py": None, "target": None, "cond": None},
    0x56916: {"kind": 'reg', "py": 'r[2] = r[2] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x56918: {"kind": 'reg', "py": 'T = 1 if r[2] == r[4] else 0', "slot_py": None, "target": None, "cond": None},
    0x5691a: {"kind": "branch", "py": None, "slot_py": '', "target": 0x56922, "cond": 'notT'},
    0x5691e: {"kind": "branch", "py": None, "slot_py": 'r[4] = s8(0x00)', "target": 0x56924, "cond": 'always'},
    0x56922: {"kind": 'reg', "py": 'r[4] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x56924: {"kind": "ret", "py": None, "slot_py": 'r[0] = r[4]', "target": None, "cond": None},}
