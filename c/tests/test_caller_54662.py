#!/usr/bin/env python3
"""Differential test for caller_54662 (entry 0x54662) — v8 ST caller (CFG), 30 bytes.
...
Run: python3 test_caller_54662.py
"""
...
CODE = {
    0x54662: {"kind": 'mem', "py": 'local[0x3FC] = r[14]\n_wrw(ram, STACK_BASE + 0x3FC, 4, r[14])\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x54664: {"kind": 'st', "py": 'local[0x3F8] = pr\n_wrw(ram, STACK_BASE + 0x3F8, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x54666: {"kind": 'reg', "py": 'r[14] = 0x0003EE58', "slot_py": None, "target": None, "cond": None},
    0x54668: {"kind": 'reg', "py": 'r[4] = 0xFFFF8FFA', "slot_py": None, "target": None, "cond": None},
    0x5466a: {"kind": "call", "py": None, "slot_py": 'r[5] = s8(0x00)', "target": 0x3ee58, "ret_pc": 0x5466e, "set_pr": True, "cond": None},
    0x5466e: {"kind": 'reg', "py": 'r[4] = 0xFFFF8FFC', "slot_py": None, "target": None, "cond": None},
    0x54670: {"kind": "call", "py": None, "slot_py": 'r[5] = s8(0x00)', "target": 0x3ee58, "ret_pc": 0x54674, "set_pr": True, "cond": None},
    0x54674: {"kind": 'reg', "py": 'r[4] = 0xFFFF8FF8', "slot_py": None, "target": None, "cond": None},
    0x54676: {"kind": "call", "py": None, "slot_py": 'r[5] = s8(0x00)', "target": 0x3ee58, "ret_pc": 0x5467a, "set_pr": True, "cond": None},
    0x5467a: {"kind": 'st', "py": 'pr = _rdw(ram, STACK_BASE + 0x3F8, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x5467c: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, STACK_BASE + 0x3FC, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},
