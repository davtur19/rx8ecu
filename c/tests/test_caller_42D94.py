#!/usr/bin/env python3
"""Differential test for caller_42D94 (entry 0x42D94) — v8 ST caller (CFG), 58 bytes.
...
Run: python3 test_caller_42D94.py
"""
...
CODE = {
    0x42d94: {"kind": 'st', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x42d96: {"kind": 'reg', "py": 'r[3] = 0xFFFFC944', "slot_py": None, "target": None, "cond": None},
    0x42d98: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFC944, 1))', "slot_py": None, "target": None, "cond": None},
    0x42d9a: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x42d9c: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x42d9e: {"kind": "branch", "py": None, "slot_py": '', "target": 0x42dc8, "cond": 'notT'},
    0x42da2: {"kind": 'reg', "py": 'r[0] = 0x00042E58', "slot_py": None, "target": None, "cond": None},
    0x42da4: {"kind": 'reg', "py": 'r[2] = 0xFFFFBCC0', "slot_py": None, "target": None, "cond": None},
    0x42da6: {"kind": 'fpu', "py": 'fr[6] = bits2f(_rdw(ram, 0x00042E58, 4))', "slot_py": None, "target": None, "cond": None},
    0x42da8: {"kind": 'reg', "py": 'r[0] = 0x00042E5C', "slot_py": None, "target": None, "cond": None},
    0x42daa: {"kind": 'fpu', "py": 'fr[5] = bits2f(_rdw(ram, 0x00042E5C, 4))', "slot_py": None, "target": None, "cond": None},
    0x42dac: {"kind": 'reg', "py": 'r[1] = 0x00002404', "slot_py": None, "target": None, "cond": None},
    0x42dae: {"kind": "call", "py": None, "slot_py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFBCC0, 4))', "target": 0x2404, "ret_pc": 0x42db2, "set_pr": True, "cond": None},
    0x42db2: {"kind": 'reg', "py": 'r[3] = 0xFFFFC8B4', "slot_py": None, "target": None, "cond": None},
    0x42db4: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFC8B4, 4, f2bits(fr[0]))', "slot_py": None, "target": None, "cond": None},
    0x42db6: {"kind": 'reg', "py": 'r[2] = 0xFFFFBCC8', "slot_py": None, "target": None, "cond": None},
    0x42db8: {"kind": 'reg', "py": 'r[1] = 0xFFFFC8B8', "slot_py": None, "target": None, "cond": None},
    0x42dba: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFBCC8, 4))', "slot_py": None, "target": None, "cond": None},
    0x42dbc: {"kind": 'fpu', "py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFC8B8, 4))', "slot_py": None, "target": None, "cond": None},
    0x42dbe: {"kind": 'fpu', "py": 'fr[4] = ts(fr[4] * fr[3])', "slot_py": None, "target": None, "cond": None},
    0x42dc0: {"kind": 'fpu', "py": 'fr[4] = ts(fr[4] / fr[0])', "slot_py": None, "target": None, "cond": None},
    0x42dc2: {"kind": 'fpu', "py": 'fr[4] = fr[4]', "slot_py": None, "target": None, "cond": None},
    0x42dc4: {"kind": 'reg', "py": 'r[3] = 0xFFFFC8B0', "slot_py": None, "target": None, "cond": None},
    0x42dc6: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFC8B0, 4, f2bits(fr[4]))', "slot_py": None, "target": None, "cond": None},
    0x42dc8: {"kind": 'st', "py": 'pr = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x42dca: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},
