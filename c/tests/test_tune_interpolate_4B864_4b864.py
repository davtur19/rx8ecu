#!/usr/bin/env python3
"""Differential test for tune_interpolate_4B864 (0x4B864) — v3 lift (branches + delay slots), 64 bytes.
...
Run from repo root: python3 c/tests/test_tune_interpolate_4B864_4b864.py
"""
...
CODE = {
    0x4b864: {"kind": 'reg', "py": 'r[4] = 0xFFFFCE19', "slot_py": None, "target": None, "cond": None},
    0x4b866: {"kind": 'reg', "py": 'r[2] = 0xFFFFB5A4', "slot_py": None, "target": None, "cond": None},
    0x4b868: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFB5A4, 1))', "slot_py": None, "target": None, "cond": None},
    0x4b86a: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x4b86c: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4b89c, "cond": 'notT'},
    0x4b870: {"kind": 'reg', "py": 'r[1] = 0xFFFFCE1B', "slot_py": None, "target": None, "cond": None},
    0x4b872: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCE1B, 1))', "slot_py": None, "target": None, "cond": None},
    0x4b874: {"kind": 'reg', "py": 'T = 1 if (r[0] & r[0]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x4b876: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4b89c, "cond": 'notT'},
    0x4b87a: {"kind": 'reg', "py": 'r[0] = 0xFFFFB5AA', "slot_py": None, "target": None, "cond": None},
    0x4b87c: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFB5AA, 1))', "slot_py": None, "target": None, "cond": None},
    0x4b87e: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x4b880: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4b89c, "cond": 'notT'},
    0x4b884: {"kind": 'reg', "py": 'r[0] = 0xFFFFCE5C', "slot_py": None, "target": None, "cond": None},
    0x4b886: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCE5C, 1))', "slot_py": None, "target": None, "cond": None},
    0x4b888: {"kind": 'reg', "py": 'T = 1 if (r[0] & 0x80) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x4b88a: {"kind": 'reg', "py": 'r[3] = T;', "slot_py": None, "target": None, "cond": None},
    0x4b88c: {"kind": 'reg', "py": 'r[3] = (r[3] + s8(0xFF)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x4b88e: {"kind": 'reg', "py": 'r[3] = (-r[3]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x4b890: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x4b892: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4b89c, "cond": 'notT'},
    0x4b896: {"kind": 'reg', "py": 'r[1] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x4b898: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFCE19, 1, r[1])', "target": 0x4b8a0, "cond": 'always'},
    0x4b89c: {"kind": 'reg', "py": 'r[2] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x4b89e: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCE19, 1, r[2])', "slot_py": None, "target": None, "cond": None},
    0x4b8a0: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
