#!/usr/bin/env python3
"""Differential test for sensor_latch_ch0 (0x72B4) — mem lift (RAM-only, straight-line), 8 bytes.
...
Run from repo root: python3 c/tests/test_sensor_latch_ch0_72b4.py
"""
...
def spec_mirror(r4, r5, r6, r7, ram, stack_top):
    ...
    r[2] = s16(_rdw(ram, 0xFFFF9F1E, 2))
    # 0x0072B8: op 0xD11B
    r[1] = 0xFFFF9F66
    # 0x0072BA: mov.w r2,@r1
    _wrw(ram, 0xFFFF9F66, 2, r[2])
    r[15] = sp
