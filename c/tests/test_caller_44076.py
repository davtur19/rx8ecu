#!/usr/bin/env python3
"""Differential test for caller_44076 (entry 0x44076) — v8 ST caller (CFG), 40 bytes.
...
Run: python3 test_caller_44076.py
"""
...
CODE = {
    0x44076: {"kind": 'fpu', "py": 'fr[6] = 1.0', "slot_py": None, "target": None, "cond": None},
    0x44078: {"kind": 'reg', "py": 'r[0] = 0x00044144', "slot_py": None, "target": None, "cond": None},
    0x4407a: {"kind": 'fpu', "py": 'fr[6] = ts(fr[6] + fr[6])', "slot_py": None, "target": None, "cond": None},
    0x4407c: {"kind": 'reg', "py": 'r[3] = 0xFFFFC12C', "slot_py": None, "target": None, "cond": None},
    0x4407e: {"kind": 'st', "py": 'local[0x3FC] = pr\n_wrw(ram, STACK_BASE + 0x3FC, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x44080: {"kind": 'fpu', "py": 'fr[5] = bits2f(_rdw(ram, 0x00044144, 4))', "slot_py": None, "target": None, "cond": None},
    0x44082: {"kind": 'reg', "py": 'r[2] = 0x00002404', "slot_py": None, "target": None, "cond": None},
    0x44084: {"kind": "call", "py": None, "slot_py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFC12C, 4))', "target": 0x2404, "ret_pc": 0x44088, "set_pr": True, "cond": None},
    0x44088: {"kind": 'reg', "py": 'r[1] = 0xFFFFCA5C', "slot_py": None, "target": None, "cond": None},
    0x4408a: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFCA5C, 4, f2bits(fr[0]))', "slot_py": None, "target": None, "cond": None},
    0x4408c: {"kind": 'reg', "py": 'r[3] = 0x0007B400', "slot_py": None, "target": None, "cond": None},
    0x4408e: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x0007B400, 4))', "slot_py": None, "target": None, "cond": None},
    0x44090: {"kind": 'reg', "py": 'r[2] = 0xFFFFB5B8', "slot_py": None, "target": None, "cond": None},
    0x44092: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0xFFFFB5B8, 4))', "slot_py": None, "target": None, "cond": None},
    0x44094: {"kind": 'reg', "py": 'r[1] = 0xFFFFCA58', "slot_py": None, "target": None, "cond": None},
    0x44096: {"kind": 'fpu', "py": 'fr[2] = ts(fr[2] * fr[3])', "slot_py": None, "target": None, "cond": None},
    0x44098: {"kind": 'st', "py": 'pr = _rdw(ram, STACK_BASE + 0x3FC, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x4409a: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFCA58, 4, f2bits(fr[2]))', "target": None, "cond": None},
