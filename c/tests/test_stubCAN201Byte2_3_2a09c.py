#!/usr/bin/env python3
"""Differential test for stubCAN201Byte2_3 (0x2A09C) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_stubCAN201Byte2_3_2a09c.py
"""
...
ENTRY = 0x2A09C
RAW = bytes.fromhex("D3 12 D2 0C 00 0B 22 31")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBB66
SPAN_END = 0x2A0A4
SENT = 0x2A0A4     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x2a09c: {"kind": 'reg', "py": 'r[3] = 0x0000FFFF', "slot_py": None, "target": None, "cond": None},
    0x2a09e: {"kind": 'reg', "py": 'r[2] = 0xFFFFBB66', "slot_py": None, "target": None, "cond": None},
    0x2a0a0: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBB66, 2, r[3])', "target": None, "cond": None},}
