#!/usr/bin/env python3
"""Differential test for read_intake_pressure_target_const_12508 (0x12508) — v3 lift + v4 FPU, 18 bytes.
...
Run from repo root: python3 c/tests/test_read_intake_pressure_target_const_12508_12508.py
"""
...
RAM_MAX = 0xFFFFA65C
SPAN_END = 0x1251A
SENT = 0x1251A     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x12508: {"kind": 'reg', "py": 'r[3] = 0x0006E3D8', "slot_py": None, "target": None, "cond": None},
    0x1250a: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x0006E3D8, 4))', "slot_py": None, "target": None, "cond": None},
    0x1250c: {"kind": 'reg', "py": 'r[2] = 0xFFFFA64C', "slot_py": None, "target": None, "cond": None},
    0x1250e: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFA64C, 4, f2bits(fr[3]))', "slot_py": None, "target": None, "cond": None},
    0x12510: {"kind": 'reg', "py": 'r[1] = 0x0006E40C', "slot_py": None, "target": None, "cond": None},
    0x12512: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x0006E40C, 4))', "slot_py": None, "target": None, "cond": None},
    0x12514: {"kind": 'reg', "py": 'r[0] = 0xFFFFA65C', "slot_py": None, "target": None, "cond": None},
    0x12516: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFA65C, 4, f2bits(fr[3]))', "target": None, "cond": None},}
