#!/usr/bin/env python3
"""Differential test for float_array_fill_from_aa70_ac80 (0x1AC80) — v3 lift + v4 FPU, 32 bytes.
...
Run from repo root: python3 c/tests/test_float_array_fill_from_aa70_ac80_1ac80.py
"""
...
ENTRY = 0x1AC80
RAW = bytes.fromhex("93 67 E5 00 D1 36 E6 06 D7 34 E0 00 F4 38 75 01 F7 47 62 5C F1 47 32 63 8F F9 70 04 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFAA98
SPAN_END = 0x1ACA0
SENT = 0x1ACA0     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x1ac80: {"kind": 'reg', "py": 'r[3] = 0xFFFFAA70', "slot_py": None, "target": None, "cond": None},
    0x1ac82: {"kind": 'reg', "py": 'r[5] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x1ac84: {"kind": 'reg', "py": 'r[1] = 0xFFFFAA98', "slot_py": None, "target": None, "cond": None},
    0x1ac86: {"kind": 'reg', "py": 'r[6] = s8(0x06)', "slot_py": None, "target": None, "cond": None},
    0x1ac88: {"kind": 'reg', "py": 'r[7] = 0xFFFFAA80', "slot_py": None, "target": None, "cond": None},
    0x1ac8a: {"kind": 'reg', "py": 'r[0] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x1ac8c: {"kind": 'fpu', "py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFAA70, 4))', "slot_py": None, "target": None, "cond": None},
    0x1ac8e: {"kind": 'reg', "py": 'r[5] = (r[5] + s8(0x01)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x1ac90: {"kind": 'fpu', "py": '_wrw(ram, r[0] + r[7], 4, f2bits(fr[4]))', "slot_py": None, "target": None, "cond": None},
    0x1ac92: {"kind": 'reg', "py": 'r[2] = r[5] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x1ac94: {"kind": 'fpu', "py": '_wrw(ram, r[0] + r[1], 4, f2bits(fr[4]))', "slot_py": None, "target": None, "cond": None},
    0x1ac96: {"kind": 'reg', "py": 'T = 1 if s32(r[2]) >= s32(r[6]) else 0', "slot_py": None, "target": None, "cond": None},
    0x1ac98: {"kind": "branch", "py": None, "slot_py": 'r[0] = (r[0] + s8(0x04)) & 0xFFFFFFFF', "target": 0x1ac8e, "cond": 'notT'},
    0x1ac9c: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
