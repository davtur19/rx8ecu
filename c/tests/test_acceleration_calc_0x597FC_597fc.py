#!/usr/bin/env python3
"""Differential test for acceleration_calc_0x597FC (0x597FC) — v3 lift (branches + delay slots), 10 bytes.
...
Run from repo root: python3 c/tests/test_acceleration_calc_0x597FC_597fc.py
"""
...
ENTRY = 0x597FC
RAW = bytes.fromhex("7F 0C 4F 26 6D F6 00 0B 6E F6")
SEED = 42
N = 500
MAXSTEPS = 100000
STACK_BASE = 0xFFFFD000
STACK_TOP = STACK_BASE + 0x400
STACK_OFFS = (0x40C, 0x410, 0x414)
SEED_OFFS = (0x40C,)   # lds.l pr/macl/mach slots seeded with the return sentinel
RAM_MIN = None
RAM_MAX = None
SPAN_END = 0x59806
SENT = 0x59806     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x597fc: {"kind": 'reg', "py": 'r[15] = (r[15] + s8(0x0C)) & 0xFFFFFFFF\nsp = (sp + s8(0x0C)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x597fe: {"kind": 'mem', "py": 'pr = _rdw(ram, STACK_BASE + 0x40C, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x59800: {"kind": 'mem', "py": 'r[13] = _rdw(ram, STACK_BASE + 0x410, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x59802: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, STACK_BASE + 0x414, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},}
