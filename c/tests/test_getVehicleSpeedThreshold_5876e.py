#!/usr/bin/env python3
"""Differential test for getVehicleSpeedThreshold (0x5876E) — v3 lift + v4 FPU, 42 bytes.
...
Run from repo root: python3 c/tests/test_getVehicleSpeedThreshold_5876e.py
"""
...
ENTRY = 0x5876E
RAW = bytes.fromhex("94 28 93 28 F4 38 D2 15 F5 28 F5 45 8D 03 00 09 E0 01 A0 08 24 00 D1 12 F3 18 F5 31 F5 45 8F 02 00 09 E0 00 24 00 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFD085
SPAN_END = 0x58798
SENT = 0x58798     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x5876e: {"kind": 'reg', "py": 'r[4] = 0xFFFFD085', "slot_py": None, "target": None, "cond": None},
    0x58770: {"kind": 'reg', "py": 'r[3] = 0xFFFFBBE8', "slot_py": None, "target": None, "cond": None},
    0x58772: {"kind": 'fpu', "py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFBBE8, 4))', "slot_py": None, "target": None, "cond": None},
    0x58774: {"kind": 'reg', "py": 'r[2] = 0x0007C294', "slot_py": None, "target": None, "cond": None},
    0x58776: {"kind": 'fpu', "py": 'fr[5] = bits2f(_rdw(ram, 0x0007C294, 4))', "slot_py": None, "target": None, "cond": None},
    0x58778: {"kind": 'fpu', "py": 'T = 1 if fr[5] > fr[4] else 0', "slot_py": None, "target": None, "cond": None},
    0x5877a: {"kind": "branch", "py": None, "slot_py": '', "target": 0x58784, "cond": 'T'},
    0x5877e: {"kind": 'reg', "py": 'r[0] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x58780: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFD085, 1, r[0])', "target": 0x58794, "cond": 'always'},
    0x58784: {"kind": 'reg', "py": 'r[1] = 0x0007C298', "slot_py": None, "target": None, "cond": None},
    0x58786: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x0007C298, 4))', "slot_py": None, "target": None, "cond": None},
    0x58788: {"kind": 'fpu', "py": 'fr[5] = ts(fr[5] - fr[3])', "slot_py": None, "target": None, "cond": None},
    0x5878a: {"kind": 'fpu', "py": 'T = 1 if fr[5] > fr[4] else 0', "slot_py": None, "target": None, "cond": None},
    0x5878c: {"kind": "branch", "py": None, "slot_py": '', "target": 0x58794, "cond": 'notT'},
    0x58790: {"kind": 'reg', "py": 'r[0] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x58792: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD085, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x58794: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
