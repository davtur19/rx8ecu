#!/usr/bin/env python3
"""Differential test for caller_27200 (entry 0x27200) — v8 ST caller (CFG), 28 bytes.
...
Run: python3 test_caller_27200.py
"""
...
CODE = {
    0x27200: {"kind": 'st', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x27202: {"kind": 'fpu', "py": 'fr[5] = 0.0', "slot_py": None, "target": None, "cond": None},
    0x27204: {"kind": 'reg', "py": 'r[0] = 0x0002724C', "slot_py": None, "target": None, "cond": None},
    0x27206: {"kind": 'reg', "py": 'r[4] = 0xFFFF9EF4', "slot_py": None, "target": None, "cond": None},
    0x27208: {"kind": 'reg', "py": 'r[3] = 0x000024C0', "slot_py": None, "target": None, "cond": None},
    0x2720a: {"kind": 'mem', "py": 'r[4] = s16(_rdw(ram, 0xFFFF9EF4, 2))', "slot_py": None, "target": None, "cond": None},
    0x2720c: {"kind": "call", "py": None, "slot_py": 'fr[4] = bits2f(_rdw(ram, 0x0002724C, 4))', "target": 0x24c0, "ret_pc": 0x27210, "set_pr": True, "cond": None},
    0x27210: {"kind": 'reg', "py": 'r[2] = 0xFFFFB68C', "slot_py": None, "target": None, "cond": None},
    0x27212: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFB68C, 4, f2bits(fr[0]))', "slot_py": None, "target": None, "cond": None},
    0x27214: {"kind": 'reg', "py": 'r[3] = 0xFFFFB690', "slot_py": None, "target": None, "cond": None},
    0x27216: {"kind": 'st', "py": 'pr = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x27218: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFB690, 4, f2bits(fr[0]))', "target": None, "cond": None},
