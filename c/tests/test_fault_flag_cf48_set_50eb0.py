#!/usr/bin/env python3
"""Differential test for fault_flag_cf48_set (0x50EB0) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_fault_flag_cf48_set_50eb0.py
"""
...
ENTRY = 0x50EB0
RAW = bytes.fromhex("92 76 E3 01 00 0B 22 30")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCF48
SPAN_END = 0x50EB8
SENT = 0x50EB8     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x50eb0: {"kind": 'reg', "py": 'r[2] = 0xFFFFCF48', "slot_py": None, "target": None, "cond": None},
    0x50eb2: {"kind": 'reg', "py": 'r[3] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x50eb4: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFCF48, 1, r[3])', "target": None, "cond": None},}
