#!/usr/bin/env python3
"""Differential test for spi_set_clk_high_wait (0x9C0) — v3 lift (branches + delay slots), 30 bytes.
...
Run from repo root: python3 c/tests/test_spi_set_clk_high_wait_9c0.py
"""
...
ENTRY = 0x9C0
RAW = bytes.fromhex("60 40 E6 08 CB 01 24 00 94 90 63 50 63 3C 23 68 8B 03 74 FF E3 00 34 36 89 F7 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = None
SPAN_END = 0x9DE
SENT = 0x9DE     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x9c0: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, r[4], 1))', "slot_py": None, "target": None, "cond": None},
    0x9c2: {"kind": 'reg', "py": 'r[6] = s8(0x08)', "slot_py": None, "target": None, "cond": None},
    0x9c4: {"kind": 'reg', "py": 'r[0] = (r[0] | 0x01) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x9c6: {"kind": 'mem', "py": '_wrw(ram, r[4], 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x9c8: {"kind": 'reg', "py": 'r[4] = 0x00000FA0', "slot_py": None, "target": None, "cond": None},
    0x9ca: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, r[5], 1))', "slot_py": None, "target": None, "cond": None},
    0x9cc: {"kind": 'reg', "py": 'r[3] = r[3] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x9ce: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[6]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x9d0: {"kind": "branch", "py": None, "slot_py": None, "target": 0x9da, "cond": 'notT'},
    0x9d2: {"kind": 'reg', "py": 'r[4] = (r[4] + s8(0xFF)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x9d4: {"kind": 'reg', "py": 'r[3] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x9d6: {"kind": 'reg', "py": 'T = 1 if (r[4] & 0xFFFFFFFF) > (r[3] & 0xFFFFFFFF) else 0', "slot_py": None, "target": None, "cond": None},
    0x9d8: {"kind": "branch", "py": None, "slot_py": None, "target": 0x9ca, "cond": 'T'},
    0x9da: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
