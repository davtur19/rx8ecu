#!/usr/bin/env python3
"""Differential test for set_intake_target_flag_23FD0 (0x23FD0) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_set_intake_target_flag_23FD0_23fd0.py
"""
...
CODE = {
    0x23fd0: {"kind": 'reg', "py": 'r[2] = 0xFFFFB478', "slot_py": None, "target": None, "cond": None},
    0x23fd2: {"kind": 'reg', "py": 'r[3] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x23fd4: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFB478, 1, r[3])', "target": None, "cond": None},}
