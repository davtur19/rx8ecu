#!/usr/bin/env python3
"""Differential test for returnCoolantTempGreaterThan71 (0x5E5F0) — v3 lift (branches + delay slots), 38 bytes.
...
Run from repo root: python3 c/tests/test_returnCoolantTempGreaterThan71_5e5f0.py
"""
...
ENTRY = 0x5E5F0
RAW = bytes.fromhex("00 09 67 7C 27 78 8F 02 00 09 A0 03 66 D3 63 40 73 FF 24 30 68 F6 60 63 69 F6 6A F6 6B F6 6C F6 6D F6 00 0B 6E F6")
SEED = 42
N = 500
MAXSTEPS = 100000
STACK_BASE = 0xFFFFD000
STACK_TOP = STACK_BASE + 0x400
STACK_OFFS = (0x400, 0x404, 0x408, 0x40C, 0x410, 0x414, 0x418)
RAM_MIN = None
RAM_MAX = None
SPAN_END = 0x5E616
...
CODE = {
    0x5e5f0: {"kind": 'reg', "py": None, "slot_py": None, "target": None, "cond": None},
    ...
    0x5e602: {"kind": 'mem', "py": '_wrw(ram, r[4], 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x5e604: {"kind": 'mem', "py": 'r[8] = _rdw(ram, STACK_BASE + 0x400, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x5e606: {"kind": 'reg', "py": 'r[0] = r[6]', "slot_py": None, "target": None, "cond": None},
    0x5e608: {"kind": 'mem', "py": 'r[9] = _rdw(ram, STACK_BASE + 0x404, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x5e60a: {"kind": 'mem', "py": 'r[10] = _rdw(ram, STACK_BASE + 0x408, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x5e60c: {"kind": 'mem', "py": 'r[11] = _rdw(ram, STACK_BASE + 0x40C, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x5e60e: {"kind": 'mem', "py": 'r[12] = _rdw(ram, STACK_BASE + 0x410, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x5e610: {"kind": 'mem', "py": 'r[13] = _rdw(ram, STACK_BASE + 0x414, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x5e612: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, STACK_BASE + 0x418, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},}
