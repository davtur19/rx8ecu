#!/usr/bin/env python3
"""Differential test for get_fuel_cut_request_status (0x1019C) — v3 lift (branches + delay slots), 12 bytes.
...
Run from repo root: python3 c/tests/test_get_fuel_cut_request_status_1019c.py
"""
...
RAM_MAX = 0xFFFFA574
SPAN_END = 0x101A8
SENT = 0x101A8     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x1019c: {"kind": 'reg', "py": 'r[3] = 0xFFFFA430', "slot_py": None, "target": None, "cond": None},
    0x1019e: {"kind": "ret", "py": None, "slot_py": 'r[0] = s16(_rdw(ram, 0xFFFFA430, 2))', "target": None, "cond": None},
    0x101a2: {"kind": 'reg', "py": 'r[2] = 0xFFFFA574', "slot_py": None, "target": None, "cond": None},
    0x101a4: {"kind": "ret", "py": None, "slot_py": 'r[0] = s8(_rdw(ram, 0xFFFFA574, 1))', "target": None, "cond": None},}
