#!/usr/bin/env python3
"""Differential test for lookup_constant_value_1CDDE (0x1CDDE) — v3 lift + v4 FPU, 10 bytes.
...
Run from repo root: python3 c/tests/test_lookup_constant_value_1CDDE_1cdde.py
"""
...
RAM_MAX = 0xFFFFAE50
SPAN_END = 0x1CDE8
SENT = 0x1CDE8     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x1cdde: {"kind": 'reg', "py": 'r[3] = 0xFFFF9F60', "slot_py": None, "target": None, "cond": None},
    0x1cde0: {"kind": 'reg', "py": 'r[1] = 0xFFFFAE50', "slot_py": None, "target": None, "cond": None},
    0x1cde2: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFF9F60, 4))', "slot_py": None, "target": None, "cond": None},
    0x1cde4: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFAE50, 4, f2bits(fr[3]))', "target": None, "cond": None},}
