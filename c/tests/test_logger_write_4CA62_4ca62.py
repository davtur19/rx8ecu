#!/usr/bin/env python3
"""Differential test for logger_write_4CA62 (0x4CA62) — v3 lift + v4 FPU, 56 bytes.
...
Run from repo root: python3 c/tests/test_logger_write_4CA62_4ca62.py
"""
...
RAM_MAX = 0xFFFFD201
SPAN_END = 0x4CA9A
SENT = 0x4CA9A     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x4ca62: {"kind": 'reg', "py": 'r[0] = 0xFFFFBFEC', "slot_py": None, "target": None, "cond": None},
    0x4ca64: {"kind": 'reg', "py": 'r[4] = 0xFFFFCED4', "slot_py": None, "target": None, "cond": None},
    0x4ca66: {"kind": 'reg', "py": 'r[2] = 0xFFFFD1E9', "slot_py": None, "target": None, "cond": None},
    0x4ca68: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFD1E9, 1))', "slot_py": None, "target": None, "cond": None},
    0x4ca6a: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x4ca6c: {"kind": "branch", "py": None, "slot_py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFBFEC, 4))', "target": 0x4ca92, "cond": 'notT'},
    0x4ca70: {"kind": 'reg', "py": 'r[1] = 0xFFFFD201', "slot_py": None, "target": None, "cond": None},
    0x4ca72: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFD201, 1))', "slot_py": None, "target": None, "cond": None},
    0x4ca74: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x4ca76: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4ca92, "cond": 'notT'},
    0x4ca7a: {"kind": 'reg', "py": 'r[0] = 0x0004CB60', "slot_py": None, "target": None, "cond": None},
    0x4ca7c: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x0004CB60, 4))', "slot_py": None, "target": None, "cond": None},
    0x4ca7e: {"kind": 'fpu', "py": 'T = 1 if fr[4] == fr[3] else 0', "slot_py": None, "target": None, "cond": None},
    0x4ca80: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4ca92, "cond": 'T'},
    0x4ca84: {"kind": 'fpu', "py": 'fr[2] = 0.0', "slot_py": None, "target": None, "cond": None},
    0x4ca86: {"kind": 'fpu', "py": 'T = 1 if fr[4] == fr[2] else 0', "slot_py": None, "target": None, "cond": None},
    0x4ca88: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4ca92, "cond": 'T'},
    0x4ca8c: {"kind": 'reg', "py": 'r[2] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x4ca8e: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFCED4, 1, r[2])', "target": 0x4ca96, "cond": 'always'},
    0x4ca92: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x4ca94: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCED4, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x4ca96: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
