#!/usr/bin/env python3
"""Differential test for sensor_word_latch_d179 (0x5BD18) — v3 lift (branches + delay slots), 22 bytes.
...
Run from repo root: python3 c/tests/test_sensor_word_latch_d179_5bd18.py
"""
...
ENTRY = 0x5BD18
RAW = bytes.fromhex("00 09 7F 34 4F 26 68 F6 69 F6 6A F6 6B F6 6C F6 6D F6 00 0B 6E F6")
SEED = 0
N = 2000
MAXSTEPS = 100000
STACK_BASE = 0xFFFFD000
STACK_TOP = STACK_BASE + 0x400
STACK_OFFS = (0x434, 0x438, 0x43C, 0x440, 0x444, 0x448, 0x44C, 0x450)
SEED_OFFS = (0x434,)   # lds.l pr/macl/mach slots seeded with the return sentinel
RAM_MIN = None
RAM_MAX = None
SPAN_END = 0x5BD2E
SENT = 0x5BD2E     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x5bd18: {"kind": 'reg', "py": None, "slot_py": None, "target": None, "cond": None},
    0x5bd1a: {"kind": 'reg', "py": 'r[15] = (r[15] + s8(0x34)) & 0xFFFFFFFF\nsp = (sp + s8(0x34)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x5bd1c: {"kind": 'mem', "py": 'pr = _rdw(ram, STACK_BASE + 0x434, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x5bd1e: {"kind": 'mem', "py": 'r[8] = _rdw(ram, STACK_BASE + 0x438, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x5bd20: {"kind": 'mem', "py": 'r[9] = _rdw(ram, STACK_BASE + 0x43C, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x5bd22: {"kind": 'mem', "py": 'r[10] = _rdw(ram, STACK_BASE + 0x440, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x5bd24: {"kind": 'mem', "py": 'r[11] = _rdw(ram, STACK_BASE + 0x444, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x5bd26: {"kind": 'mem', "py": 'r[12] = _rdw(ram, STACK_BASE + 0x448, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x5bd28: {"kind": 'mem', "py": 'r[13] = _rdw(ram, STACK_BASE + 0x44C, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x5bd2a: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, STACK_BASE + 0x450, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},}
