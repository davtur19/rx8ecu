#!/usr/bin/env python3
"""Differential test for stubCAN201Byte2_3 (0x29C1C) — v3 lift (branches + delay slots), 38 bytes.
...
Run from repo root: python3 c/tests/test_stubCAN201Byte2_3_29c1c.py
"""
...
ENTRY = 0x29C1C
RAW = bytes.fromhex("D5 2C D2 24 63 21 63 3D 33 60 8D 03 00 09 E1 3E A0 07 25 11 64 51 61 4D 41 15 8F 02 00 09 34 6C 25 41 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBB3C
SPAN_END = 0x29C42
SENT = 0x29C42     # stop-sentinel, placed past the literal pool
