#!/usr/bin/env python3
"""Differential test for aux_ctrl_flags_write_a968_a976 (0x17D30) — v3 lift (branches + delay slots), 14 bytes.
...
Run from repo root: python3 c/tests/test_aux_ctrl_flags_write_a968_a976_17d30.py
"""
...
ENTRY = 0x17D30
RAW = bytes.fromhex("D2 2C E1 06 D0 2C E3 08 22 30 00 0B 20 10")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFA976
SPAN_END = 0x17D3E
SENT = 0x17D3E     # stop-sentinel, placed past the literal pool
