#!/usr/bin/env python3
"""Differential test for helper_utility_292FC (0x292FC) — v3 lift + v4 FPU, 22 bytes.
...
Run from repo root: python3 c/tests/test_helper_utility_292FC_292fc.py
"""
...
RAM_MAX = 0xFFFFBAE8
SPAN_END = 0x29312
SENT = 0x29312     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x292fc: {"kind": 'reg', "py": 'r[0] = 0x0002941C', "slot_py": None, "target": None, "cond": None},
    0x292fe: {"kind": 'fpu', "py": 'fr[4] = bits2f(_rdw(ram, 0x0002941C, 4))', "slot_py": None, "target": None, "cond": None},
    0x29300: {"kind": 'reg', "py": 'r[3] = 0xFFFFBADC', "slot_py": None, "target": None, "cond": None},
    0x29302: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFBADC, 4, f2bits(fr[4]))', "slot_py": None, "target": None, "cond": None},
    0x29304: {"kind": 'reg', "py": 'r[2] = 0xFFFFBAE0', "slot_py": None, "target": None, "cond": None},
    0x29306: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFBAE0, 4, f2bits(fr[4]))', "slot_py": None, "target": None, "cond": None},
    0x29308: {"kind": 'reg', "py": 'r[1] = 0xFFFFBAE4', "slot_py": None, "target": None, "cond": None},
    0x2930a: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFBAE4, 4, f2bits(fr[4]))', "slot_py": None, "target": None, "cond": None},
    0x2930c: {"kind": 'reg', "py": 'r[3] = 0xFFFFBAE8', "slot_py": None, "target": None, "cond": None},
    0x2930e: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBAE8, 4, f2bits(fr[4]))', "target": None, "cond": None},}
