#!/usr/bin/env python3
"""Differential test for FUN_0002a31c (0x2A31C) — v3 lift + v4 FPU, 86 bytes.
...
Run from repo root: python3 c/tests/test_FUN_0002a31c_2a31c.py
"""
...
ENTRY = 0x2A31C
RAW = bytes.fromhex("94 4B 93 4B 92 4B F3 38 F2 28 F2 35 8D 11 00 09 91 46 60 10 60 0C 88 01 8F 0B 00 09 92 41 60 20 60 0C 88 01 8F 05 00 09 93 3C 60 30 20 08 8D 0B 00 09 92 38 61 21 21 18 8F 09 00 09 93 34 60 31 60 0D 40 15 8F 03 00 09 E3 01 A0 02 24 30 E1 00 24 10 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBB5D
SPAN_END = 0x2A372
SENT = 0x2A372     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x2a31c: {"kind": 'reg', "py": 'r[4] = 0xFFFFBB5D', "slot_py": None, "target": None, "cond": None},
    0x2a31e: {"kind": 'reg', "py": 'r[3] = 0xFFFFA998', "slot_py": None, "target": None, "cond": None},
    0x2a320: {"kind": 'reg', "py": 'r[2] = 0xFFFFA62C', "slot_py": None, "target": None, "cond": None},
    0x2a322: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFA998, 4))', "slot_py": None, "target": None, "cond": None},
    0x2a324: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0xFFFFA62C, 4))', "slot_py": None, "target": None, "cond": None},
    0x2a326: {"kind": 'fpu', "py": 'T = 1 if fr[2] > fr[3] else 0', "slot_py": None, "target": None, "cond": None},
    0x2a328: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2a34e, "cond": 'T'},
    0x2a32c: {"kind": 'reg', "py": 'r[1] = 0xFFFFA9AC', "slot_py": None, "target": None, "cond": None},
    0x2a32e: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFA9AC, 1))', "slot_py": None, "target": None, "cond": None},
    0x2a330: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x2a332: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x2a334: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2a34e, "cond": 'notT'},
    0x2a338: {"kind": 'reg', "py": 'r[2] = 0xFFFFA428', "slot_py": None, "target": None, "cond": None},
    0x2a33a: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFA428, 1))', "slot_py": None, "target": None, "cond": None},
    0x2a33c: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x2a33e: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x2a340: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2a34e, "cond": 'notT'},
    0x2a344: {"kind": 'reg', "py": 'r[3] = 0xFFFFAAC6', "slot_py": None, "target": None, "cond": None},
    0x2a346: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFAAC6, 1))', "slot_py": None, "target": None, "cond": None},
    0x2a348: {"kind": 'reg', "py": 'T = 1 if (r[0] & r[0]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x2a34a: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2a364, "cond": 'T'},
    0x2a34e: {"kind": 'reg', "py": 'r[2] = 0xFFFFA9A8', "slot_py": None, "target": None, "cond": None},
    0x2a350: {"kind": 'mem', "py": 'r[1] = s16(_rdw(ram, 0xFFFFA9A8, 2))', "slot_py": None, "target": None, "cond": None},
    0x2a352: {"kind": 'reg', "py": 'T = 1 if (r[1] & r[1]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x2a354: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2a36a, "cond": 'notT'},
    0x2a358: {"kind": 'reg', "py": 'r[3] = 0xFFFFA9AA', "slot_py": None, "target": None, "cond": None},
    0x2a35a: {"kind": 'mem', "py": 'r[0] = s16(_rdw(ram, 0xFFFFA9AA, 2))', "slot_py": None, "target": None, "cond": None},
    0x2a35c: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x2a35e: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) > 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x2a360: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2a36a, "cond": 'notT'},
    0x2a364: {"kind": 'reg', "py": 'r[3] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x2a366: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFBB5D, 1, r[3])', "target": 0x2a36e, "cond": 'always'},
    0x2a36a: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x2a36c: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBB5D, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x2a36e: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
