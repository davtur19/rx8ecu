#!/usr/bin/env python3
"""Differential test for check_coolant_threshold_39846 (0x39846) — v3 lift (branches + delay slots), 24 bytes.
...
Run from repo root: python3 c/tests/test_check_coolant_threshold_39846_39846.py
"""
...
ENTRY = 0x39846
RAW = bytes.fromhex("92 47 D0 2B 63 21 61 01 33 16 8F 03 00 09 93 43 E1 01 23 10 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFC574
SPAN_END = 0x3985E
SENT = 0x3985E     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x39846: {"kind": 'reg', "py": 'r[2] = 0xFFFFC56A', "slot_py": None, "target": None, "cond": None},
    0x39848: {"kind": 'reg', "py": 'r[0] = 0x0007A5BE', "slot_py": None, "target": None, "cond": None},
    0x3984a: {"kind": 'mem', "py": 'r[3] = s16(_rdw(ram, 0xFFFFC56A, 2))', "slot_py": None, "target": None, "cond": None},
    0x3984c: {"kind": 'mem', "py": 'r[1] = s16(_rdw(ram, 0x0007A5BE, 2))', "slot_py": None, "target": None, "cond": None},
    0x3984e: {"kind": 'reg', "py": 'T = 1 if (r[3] & 0xFFFFFFFF) > (r[1] & 0xFFFFFFFF) else 0', "slot_py": None, "target": None, "cond": None},
    0x39850: {"kind": "branch", "py": None, "slot_py": '', "target": 0x3985a, "cond": 'notT'},
    0x39854: {"kind": 'reg', "py": 'r[3] = 0xFFFFC574', "slot_py": None, "target": None, "cond": None},
    0x39856: {"kind": 'reg', "py": 'r[1] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x39858: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC574, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x3985a: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
