#!/usr/bin/env python3
"""Differential test for caller_1B8F0 (entry 0x1B8F0) — v8 ST caller (CFG), 28 bytes.
...
Run: python3 test_caller_1B8F0.py
"""
...
CODE = {
    0x1b8f0: {"kind": 'st', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x1b8f2: {"kind": 'fpu', "py": 'fr[5] = 0.0', "slot_py": None, "target": None, "cond": None},
    0x1b8f4: {"kind": 'reg', "py": 'r[0] = 0x0001B9B4', "slot_py": None, "target": None, "cond": None},
    0x1b8f6: {"kind": 'fpu', "py": 'fr[4] = bits2f(_rdw(ram, 0x0001B9B4, 4))', "slot_py": None, "target": None, "cond": None},
    0x1b8f8: {"kind": 'reg', "py": 'r[3] = 0xFFFFAD80', "slot_py": None, "target": None, "cond": None},
    0x1b8fa: {"kind": 'reg', "py": 'r[2] = 0x000024C0', "slot_py": None, "target": None, "cond": None},
    0x1b8fc: {"kind": "call", "py": None, "slot_py": 'r[4] = s16(_rdw(ram, 0xFFFFAD80, 2))', "target": 0x24c0, "ret_pc": 0x1b900, "set_pr": True, "cond": None},
    0x1b900: {"kind": 'reg', "py": 'r[1] = 0xFFFFAD8C', "slot_py": None, "target": None, "cond": None},
    0x1b902: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFAD8C, 4, f2bits(fr[0]))', "slot_py": None, "target": None, "cond": None},
    0x1b904: {"kind": 'reg', "py": 'r[3] = 0xFFFFAD84', "slot_py": None, "target": None, "cond": None},
    0x1b906: {"kind": 'st', "py": 'pr = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x1b908: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFAD84, 4, f2bits(fr[0]))', "target": None, "cond": None},
