#!/usr/bin/env python3
"""Differential test for getOBDCANTXVars1 (0x4C8C2) — v3 lift (branches + delay slots), 14 bytes.
...
Run from repo root: python3 c/tests/test_getOBDCANTXVars1_4c8c2.py
"""
...
ENTRY = 0x4C8C2
RAW = bytes.fromhex("26 50 A0 01 24 70 24 50 7F 04 00 0B 6E F6")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
CODE = {
    0x4c8c2: {"kind": 'mem', "py": '_wrw(ram, r[6], 1, r[5])', "slot_py": None, "target": None, "cond": None},
