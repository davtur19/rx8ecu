#!/usr/bin/env python3
"""Differential test for fuel_calc_entry (0x9528) — mem lift (RAM-only, straight-line), 12 bytes.
...
Run from repo root: python3 c/tests/test_fuel_calc_entry_9528.py
"""
...
ENTRY = 0x9528
RAW = bytes.fromhex("D5 44 D4 45 85 54 24 01 85 55 81 41")
SEED = 42
N = 2000
...
def spec_mirror(r4, r5, r6, r7, ram, stack_top):
    ...
    r[0] = s16(_rdw(ram, 0xFFFF9EEC, 2))
    # 0x00952E: mov.w r0,@r4
    _wrw(ram, 0xFFFFA112, 2, r[0])
    # 0x009530: mov.w @(0xA,r5),r0
    r[0] = s16(_rdw(ram, 0xFFFF9EEE, 2))
    # 0x009532: mov.w r0,@(0x2,r4)
    _wrw(ram, 0xFFFFA114, 2, r[0])
    r[15] = sp
