#!/usr/bin/env python3
"""Differential test for uds_eeprom_read_64_len3 (0x59DFE) — v3 lift (branches + delay slots), 32 bytes.
...
Run from repo root: python3 c/tests/test_uds_eeprom_read_64_len3_59dfe.py
"""
...
ENTRY = 0x59DFE
RAW = bytes.fromhex("D2 AE 91 79 35 10 8F 03 00 09 92 76 A0 06 22 60 60 53 88 0F 8F 02 00 09 93 70 23 60 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFD295
SPAN_END = 0x59E1E
SENT = 0x59E1E     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x59dfe: {"kind": 'reg', "py": 'r[2] = 0x600C8801', "slot_py": None, "target": None, "cond": None},
    0x59e00: {"kind": 'reg', "py": 'r[1] = 0x00000082', "slot_py": None, "target": None, "cond": None},
    0x59e02: {"kind": 'reg', "py": 'T = 1 if r[5] == r[1] else 0', "slot_py": None, "target": None, "cond": None},
    0x59e04: {"kind": "branch", "py": None, "slot_py": '', "target": 0x59e0e, "cond": 'notT'},
    0x59e08: {"kind": 'reg', "py": 'r[2] = 0xFFFFD294', "slot_py": None, "target": None, "cond": None},
    0x59e0a: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFD294, 1, r[6])', "target": 0x59e1a, "cond": 'always'},
    0x59e0e: {"kind": 'reg', "py": 'r[0] = r[5]', "slot_py": None, "target": None, "cond": None},
    0x59e10: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x0F) else 0', "slot_py": None, "target": None, "cond": None},
    0x59e12: {"kind": "branch", "py": None, "slot_py": '', "target": 0x59e1a, "cond": 'notT'},
    0x59e16: {"kind": 'reg', "py": 'r[3] = 0xFFFFD295', "slot_py": None, "target": None, "cond": None},
    0x59e18: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD295, 1, r[6])', "slot_py": None, "target": None, "cond": None},
    0x59e1a: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
