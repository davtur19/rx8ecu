#!/usr/bin/env python3
"""Differential test for call-composition caller_551B4 (entry 0x551B4) — v7 ST caller + callee lib, flattened CODE with nested returns.
...
Run: python3 /home/davide/ailocal/rx8ecu/c/tests/test_caller_551B4.py
"""
...
CODE = {
    0x551b4: {"kind": 'reg', "py": 'r[4] = 0xFFFF900C', "slot_py": None, "target": None, "cond": None},
    0x551b6: {"kind": 'reg', "py": 'r[3] = 0x0003EE58', "slot_py": None, "target": None, "cond": None},
    0x551b8: {"kind": "call", "py": None, "slot_py": 'r[5] = s8(0x00)', "target": 0x3ee58, "ret_pc": 0x551bc, "set_pr": False, "cond": None},
