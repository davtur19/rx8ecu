#!/usr/bin/env python3
"""Differential test for cal_word_flag_init_afb8 (0x1AFB8) — v3 lift (branches + delay slots), 20 bytes.
...
Run from repo root: python3 c/tests/test_cal_word_flag_init_afb8_1afb8.py
"""
...
ENTRY = 0x1AFB8
RAW = bytes.fromhex("D2 2D E4 01 91 54 63 21 92 54 21 31 93 51 23 40 00 0B 22 40")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFAAC7
SPAN_END = 0x1AFCC
SENT = 0x1AFCC     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x1afb8: {"kind": 'reg', "py": 'r[2] = 0x0006F7E4', "slot_py": None, "target": None, "cond": None},
    0x1afba: {"kind": 'reg', "py": 'r[4] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x1afbc: {"kind": 'reg', "py": 'r[1] = 0xFFFFAAC4', "slot_py": None, "target": None, "cond": None},
    0x1afbe: {"kind": 'mem', "py": 'r[3] = s16(_rdw(ram, 0x0006F7E4, 2))', "slot_py": None, "target": None, "cond": None},
    0x1afc0: {"kind": 'reg', "py": 'r[2] = 0xFFFFAAC6', "slot_py": None, "target": None, "cond": None},
    0x1afc2: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFAAC4, 2, r[3])', "slot_py": None, "target": None, "cond": None},
    0x1afc4: {"kind": 'reg', "py": 'r[3] = 0xFFFFAAC7', "slot_py": None, "target": None, "cond": None},
    0x1afc6: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFAAC7, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x1afc8: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFAAC6, 1, r[4])', "target": None, "cond": None},}
