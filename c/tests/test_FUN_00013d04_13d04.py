#!/usr/bin/env python3
"""Differential test for FUN_00013d04 (0x13D04) — v3 lift + v4 FPU, 24 bytes.
...
Run from repo root: python3 c/tests/test_FUN_00013d04_13d04.py
"""
...
RAM_MAX = 0xFFFFA760
SPAN_END = 0x13D1C
SENT = 0x13D1C     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x13d04: {"kind": 'reg', "py": 'r[3] = 0xFFFFA750', "slot_py": None, "target": None, "cond": None},
    0x13d06: {"kind": 'fpu', "py": 'fr[3] = 0.0', "slot_py": None, "target": None, "cond": None},
    0x13d08: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0xFFFFA750, 4))', "slot_py": None, "target": None, "cond": None},
    0x13d0a: {"kind": 'fpu', "py": 'T = 1 if fr[2] > fr[3] else 0', "slot_py": None, "target": None, "cond": None},
    0x13d0c: {"kind": "branch", "py": None, "slot_py": '', "target": 0x13d18, "cond": 'notT'},
    0x13d10: {"kind": 'reg', "py": 'r[2] = 0x000727BC', "slot_py": None, "target": None, "cond": None},
    0x13d12: {"kind": 'mem', "py": 'r[1] = s16(_rdw(ram, 0x000727BC, 2))', "slot_py": None, "target": None, "cond": None},
    0x13d14: {"kind": 'reg', "py": 'r[0] = 0xFFFFA760', "slot_py": None, "target": None, "cond": None},
    0x13d16: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA760, 2, r[1])', "slot_py": None, "target": None, "cond": None},
    0x13d18: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
