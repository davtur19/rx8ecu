#!/usr/bin/env python3
"""Differential test for stubByte420TX (0x29A72) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_stubByte420TX_29a72.py
"""
...
ENTRY = 0x29A72
RAW = bytes.fromhex("E1 00 D3 16 00 0B 23 11")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBB16
SPAN_END = 0x29A7A
SENT = 0x29A7A     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x29a72: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x29a74: {"kind": 'reg', "py": 'r[3] = 0xFFFFBB16', "slot_py": None, "target": None, "cond": None},
    0x29a76: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBB16, 2, r[1])', "target": None, "cond": None},}
