#!/usr/bin/env python3
"""Differential test for engine_limit_check_0x4F18C (0x4F18C) — v3 lift (branches + delay slots), 40 bytes.
...
Run from repo root: python3 c/tests/test_engine_limit_check_0x4F18C_4f18c.py
"""
...
ENTRY = 0x4F18C
RAW = bytes.fromhex("94 12 92 12 63 20 23 38 8F 03 00 09 E0 00 A0 09 24 00 93 0B D2 06 61 31 60 21 31 02 8F 02 00 09 E0 01 24 00 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFD12E
SPAN_END = 0x4F1B4
SENT = 0x4F1C0     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x4f18c: {"kind": 'reg', "py": 'r[4] = 0xFFFFCFD8', "slot_py": None, "target": None, "cond": None},
    0x4f18e: {"kind": 'reg', "py": 'r[2] = 0xFFFFD12E', "slot_py": None, "target": None, "cond": None},
    0x4f190: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFD12E, 1))', "slot_py": None, "target": None, "cond": None},
    0x4f192: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x4f194: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4f19e, "cond": 'notT'},
    0x4f198: {"kind": 'reg', "py": 'r[0] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x4f19a: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFCFD8, 1, r[0])', "target": 0x4f1b0, "cond": 'always'},
    0x4f19e: {"kind": 'reg', "py": 'r[3] = 0xFFFFCFE6', "slot_py": None, "target": None, "cond": None},
    0x4f1a0: {"kind": 'reg', "py": 'r[2] = 0x0007D6CA', "slot_py": None, "target": None, "cond": None},
    0x4f1a2: {"kind": 'mem', "py": 'r[1] = s16(_rdw(ram, 0xFFFFCFE6, 2))', "slot_py": None, "target": None, "cond": None},
    0x4f1a4: {"kind": 'mem', "py": 'r[0] = s16(_rdw(ram, 0x0007D6CA, 2))', "slot_py": None, "target": None, "cond": None},
    0x4f1a6: {"kind": 'reg', "py": 'T = 1 if (r[1] & 0xFFFFFFFF) >= (r[0] & 0xFFFFFFFF) else 0', "slot_py": None, "target": None, "cond": None},
    0x4f1a8: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4f1b0, "cond": 'notT'},
    0x4f1ac: {"kind": 'reg', "py": 'r[0] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x4f1ae: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCFD8, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x4f1b0: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
