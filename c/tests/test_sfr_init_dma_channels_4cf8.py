#!/usr/bin/env python3
"""Differential test for sfr_init_dma_channels (0x4CF8) — v3 lift (branches + delay slots), 52 bytes.
...
Run from repo root: python3 c/tests/test_sfr_init_dma_channels_4cf8.py
"""
...
ENTRY = 0x4CF8
RAW = bytes.fromhex("93 1A E4 00 23 41 92 18 22 41 91 17 21 41 73 06 23 41 72 06 22 41 71 06 21 41 73 06 23 41 72 06 22 41 71 06 21 41 73 06 23 41 72 06 22 41 71 06 00 0B 21 41")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFED16
SPAN_END = 0x4D2C
SENT = 0x4D2C     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x4cf8: {"kind": 'reg', "py": 'r[3] = 0xFFFFED00', "slot_py": None, "target": None, "cond": None},
    0x4cfa: {"kind": 'reg', "py": 'r[4] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x4cfc: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFED00, 2, r[4])', "slot_py": None, "target": None, "cond": None},
    0x4cfe: {"kind": 'reg', "py": 'r[2] = 0xFFFFED02', "slot_py": None, "target": None, "cond": None},
    0x4d00: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFED02, 2, r[4])', "slot_py": None, "target": None, "cond": None},
    0x4d02: {"kind": 'reg', "py": 'r[1] = 0xFFFFED04', "slot_py": None, "target": None, "cond": None},
    0x4d04: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFED04, 2, r[4])', "slot_py": None, "target": None, "cond": None},
    0x4d06: {"kind": 'reg', "py": 'r[3] = (r[3] + s8(0x06)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x4d08: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFED06, 2, r[4])', "slot_py": None, "target": None, "cond": None},
    0x4d0a: {"kind": 'reg', "py": 'r[2] = (r[2] + s8(0x06)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x4d0c: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFED08, 2, r[4])', "slot_py": None, "target": None, "cond": None},
    0x4d0e: {"kind": 'reg', "py": 'r[1] = (r[1] + s8(0x06)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x4d10: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFED0A, 2, r[4])', "slot_py": None, "target": None, "cond": None},
    0x4d12: {"kind": 'reg', "py": 'r[3] = (r[3] + s8(0x06)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x4d14: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFED0C, 2, r[4])', "slot_py": None, "target": None, "cond": None},
    0x4d16: {"kind": 'reg', "py": 'r[2] = (r[2] + s8(0x06)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x4d18: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFED0E, 2, r[4])', "slot_py": None, "target": None, "cond": None},
    0x4d1a: {"kind": 'reg', "py": 'r[1] = (r[1] + s8(0x06)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x4d1c: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFED10, 2, r[4])', "slot_py": None, "target": None, "cond": None},
    0x4d1e: {"kind": 'reg', "py": 'r[3] = (r[3] + s8(0x06)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x4d20: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFED12, 2, r[4])', "slot_py": None, "target": None, "cond": None},
    0x4d22: {"kind": 'reg', "py": 'r[2] = (r[2] + s8(0x06)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x4d24: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFED14, 2, r[4])', "slot_py": None, "target": None, "cond": None},
    0x4d26: {"kind": 'reg', "py": 'r[1] = (r[1] + s8(0x06)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x4d28: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFED16, 2, r[4])', "target": None, "cond": None},}
