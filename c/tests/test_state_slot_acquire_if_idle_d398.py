#!/usr/bin/env python3
"""Differential test for state_slot_acquire_if_idle (0xD398) — v3 lift (branches + delay slots), 32 bytes.
...
Run from repo root: python3 c/tests/test_state_slot_acquire_if_idle_d398.py
"""
...
ENTRY = 0xD398
RAW = bytes.fromhex("D5 19 63 50 23 38 8F 08 E6 02 E2 01 D1 17 21 40 D3 10 23 60 25 20 A0 01 E4 00 64 63 00 0B 60 43")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFA3FA
SPAN_END = 0xD3B8
SENT = 0xD3B8     # stop-sentinel, placed past the literal pool
...
CODE = {
    0xd398: {"kind": 'reg', "py": 'r[5] = 0xFFFFA3F9', "slot_py": None, "target": None, "cond": None},
    0xd39a: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFA3F9, 1))', "slot_py": None, "target": None, "cond": None},
    0xd39c: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0xd39e: {"kind": "branch", "py": None, "slot_py": 'r[6] = s8(0x02)', "target": 0xd3b2, "cond": 'notT'},
    0xd3a2: {"kind": 'reg', "py": 'r[2] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0xd3a4: {"kind": 'reg', "py": 'r[1] = 0xFFFFA3F8', "slot_py": None, "target": None, "cond": None},
    0xd3a6: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA3F8, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0xd3a8: {"kind": 'reg', "py": 'r[3] = 0xFFFFA3FA', "slot_py": None, "target": None, "cond": None},
    0xd3aa: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA3FA, 1, r[6])', "slot_py": None, "target": None, "cond": None},
    0xd3ac: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA3F9, 1, r[2])', "slot_py": None, "target": None, "cond": None},
    0xd3ae: {"kind": "branch", "py": None, "slot_py": 'r[4] = s8(0x00)', "target": 0xd3b4, "cond": 'always'},
    0xd3b2: {"kind": 'reg', "py": 'r[4] = r[6]', "slot_py": None, "target": None, "cond": None},
    0xd3b4: {"kind": "ret", "py": None, "slot_py": 'r[0] = r[4]', "target": None, "cond": None},}
