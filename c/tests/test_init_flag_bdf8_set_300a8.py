#!/usr/bin/env python3
"""Differential test for init_flag_bdf8_set (0x300A8) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_init_flag_bdf8_set_300a8.py
"""
...
ENTRY = 0x300A8
RAW = bytes.fromhex("92 6D E3 01 00 0B 22 30")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBDF8
SPAN_END = 0x300B0
SENT = 0x300B0     # stop-sentinel, placed past the literal pool
