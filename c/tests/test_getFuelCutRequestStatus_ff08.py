#!/usr/bin/env python3
"""Differential test for getFuelCutRequestStatus (0xFF08) — v3 lift (branches + delay slots), 12 bytes.
...
Run from repo root: python3 c/tests/test_getFuelCutRequestStatus_ff08.py
"""
...
ENTRY = 0xFF08
RAW = bytes.fromhex("93 7C 00 0B 60 31 D2 41 00 0B 60 20")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFA574
SPAN_END = 0xFF14
SENT = 0xFF14     # stop-sentinel, placed past the literal pool
...
CODE = {
    0xff08: {"kind": 'reg', "py": 'r[3] = 0xFFFFA430', "slot_py": None, "target": None, "cond": None},
    0xff0a: {"kind": "ret", "py": None, "slot_py": 'r[0] = s16(_rdw(ram, 0xFFFFA430, 2))', "target": None, "cond": None},
    0xff0e: {"kind": 'reg', "py": 'r[2] = 0xFFFFA574', "slot_py": None, "target": None, "cond": None},
    0xff10: {"kind": "ret", "py": None, "slot_py": 'r[0] = s8(_rdw(ram, 0xFFFFA574, 1))', "target": None, "cond": None},}
