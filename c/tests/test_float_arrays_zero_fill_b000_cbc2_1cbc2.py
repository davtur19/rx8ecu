#!/usr/bin/env python3
"""Differential test for float_arrays_zero_fill_b000_cbc2 (0x1CBC2) — v3 lift + v4 FPU, 30 bytes.
...
Run from repo root: python3 c/tests/test_float_arrays_zero_fill_b000_cbc2_1cbc2.py
"""
...
ENTRY = 0x1CBC2
RAW = bytes.fromhex("E5 01 D1 26 E6 14 D7 26 F4 8D E0 04 75 01 F7 47 63 5C F1 47 33 67 8F F9 70 04 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFB000
SPAN_END = 0x1CBE0
SENT = 0x1CBE0     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x1cbc2: {"kind": 'reg', "py": 'r[5] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x1cbc4: {"kind": 'reg', "py": 'r[1] = 0xFFFFB000', "slot_py": None, "target": None, "cond": None},
    0x1cbc6: {"kind": 'reg', "py": 'r[6] = s8(0x14)', "slot_py": None, "target": None, "cond": None},
    0x1cbc8: {"kind": 'reg', "py": 'r[7] = 0xFFFFAFAC', "slot_py": None, "target": None, "cond": None},
    0x1cbca: {"kind": 'fpu', "py": 'fr[4] = 0.0', "slot_py": None, "target": None, "cond": None},
    0x1cbcc: {"kind": 'reg', "py": 'r[0] = s8(0x04)', "slot_py": None, "target": None, "cond": None},
    0x1cbce: {"kind": 'reg', "py": 'r[5] = (r[5] + s8(0x01)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x1cbd0: {"kind": 'fpu', "py": '_wrw(ram, r[0] + r[7], 4, f2bits(fr[4]))', "slot_py": None, "target": None, "cond": None},
    0x1cbd2: {"kind": 'reg', "py": 'r[3] = r[5] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x1cbd4: {"kind": 'fpu', "py": '_wrw(ram, r[0] + r[1], 4, f2bits(fr[4]))', "slot_py": None, "target": None, "cond": None},
    0x1cbd6: {"kind": 'reg', "py": 'T = 1 if s32(r[3]) > s32(r[6]) else 0', "slot_py": None, "target": None, "cond": None},
    0x1cbd8: {"kind": "branch", "py": None, "slot_py": 'r[0] = (r[0] + s8(0x04)) & 0xFFFFFFFF', "target": 0x1cbce, "cond": 'notT'},
    0x1cbdc: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
