#!/usr/bin/env python3
"""Differential test for data_register_tri_copy_33BF8 (0x33BF8) — v3 lift (branches + delay slots), 26 bytes.
...
Run from repo root: python3 c/tests/test_data_register_tri_copy_33BF8_33bf8.py
"""
...
CODE = {
    0x33bf8: {"kind": 'reg', "py": 'r[1] = 0xFFFFC06B', "slot_py": None, "target": None, "cond": None},
    0x33bfa: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFC06B, 1))', "slot_py": None, "target": None, "cond": None},
    0x33bfc: {"kind": 'reg', "py": 'r[2] = 0xFFFFC068', "slot_py": None, "target": None, "cond": None},
    0x33bfe: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC068, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x33c00: {"kind": 'reg', "py": 'r[3] = 0xFFFFC06C', "slot_py": None, "target": None, "cond": None},
    0x33c02: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFC06C, 1))', "slot_py": None, "target": None, "cond": None},
    0x33c04: {"kind": 'reg', "py": 'r[2] = 0xFFFFC069', "slot_py": None, "target": None, "cond": None},
    0x33c06: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC069, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x33c08: {"kind": 'reg', "py": 'r[0] = 0xFFFFC06D', "slot_py": None, "target": None, "cond": None},
    0x33c0a: {"kind": 'mem', "py": 'r[1] = s8(_rdw(ram, 0xFFFFC06D, 1))', "slot_py": None, "target": None, "cond": None},
    0x33c0c: {"kind": 'reg', "py": 'r[3] = 0xFFFFC06A', "slot_py": None, "target": None, "cond": None},
    0x33c0e: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFC06A, 1, r[1])', "target": None, "cond": None},}
