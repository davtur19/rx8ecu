#!/usr/bin/env python3
"""Differential test for port_byte_copy_simple_339F8 (0x339F8) — v3 lift (branches + delay slots), 10 bytes.
...
Run from repo root: python3 c/tests/test_port_byte_copy_simple_339F8_339f8.py
"""
...
CODE = {
    0x339f8: {"kind": 'reg', "py": 'r[2] = 0xFFFFD3BE', "slot_py": None, "target": None, "cond": None},
    0x339fa: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFD3BE, 1))', "slot_py": None, "target": None, "cond": None},
    0x339fc: {"kind": 'reg', "py": 'r[0] = 0xFFFFC04E', "slot_py": None, "target": None, "cond": None},
    0x339fe: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFC04E, 1, r[3])', "target": None, "cond": None},}
