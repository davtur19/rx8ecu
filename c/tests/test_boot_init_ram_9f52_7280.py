#!/usr/bin/env python3
"""Differential test for boot_init_ram_9f52 (0x7280) — v3 lift (branches + delay slots), 16 bytes.
...
Run from repo root: python3 c/tests/test_boot_init_ram_9f52_7280.py
"""
...
ENTRY = 0x7280
RAW = bytes.fromhex("D4 02 E3 00 24 31 E0 01 00 0B 80 4A FF FF 9F 52")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFF9F52
SPAN_END = 0x7290
SENT = 0x7290     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x7280: {"kind": 'reg', "py": 'r[4] = 0xFFFF9F52', "slot_py": None, "target": None, "cond": None},
    0x7282: {"kind": 'reg', "py": 'r[3] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x7284: {"kind": 'mem', "py": '_wrw(ram, 0xFFFF9F52, 2, r[3])', "slot_py": None, "target": None, "cond": None},
    0x7286: {"kind": 'reg', "py": 'r[0] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x7288: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFF9F5C, 1, r[0])', "target": None, "cond": None},}
