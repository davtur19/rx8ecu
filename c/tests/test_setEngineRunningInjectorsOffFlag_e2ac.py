#!/usr/bin/env python3
"""Differential test for setEngineRunningInjectorsOffFlag (0xE2AC) — v3 lift (branches + delay slots), 42 bytes.
...
Run from repo root: python3 c/tests/test_setEngineRunningInjectorsOffFlag_e2ac.py
"""
...
ENTRY = 0xE2AC
RAW = bytes.fromhex("94 10 92 10 63 20 23 38 8F 08 00 09 91 0C 60 10 20 08 8F 03 00 09 E2 01 A0 02 24 20 E1 00 24 10 00 0B 00 09 A4 2C A4 28 A4 1C")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFA42C
SPAN_END = 0xE2D6
SENT = 0xE2D6     # stop-sentinel, placed past the literal pool
...
CODE = {
    0xe2ac: {"kind": 'reg', "py": 'r[4] = 0xFFFFA42C', "slot_py": None, "target": None, "cond": None},
    0xe2ae: {"kind": 'reg', "py": 'r[2] = 0xFFFFA428', "slot_py": None, "target": None, "cond": None},
    0xe2b0: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFA428, 1))', "slot_py": None, "target": None, "cond": None},
    0xe2b2: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0xe2b4: {"kind": "branch", "py": None, "slot_py": '', "target": 0xe2c8, "cond": 'notT'},
    0xe2b8: {"kind": 'reg', "py": 'r[1] = 0xFFFFA41C', "slot_py": None, "target": None, "cond": None},
    0xe2ba: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFA41C, 1))', "slot_py": None, "target": None, "cond": None},
    0xe2bc: {"kind": 'reg', "py": 'T = 1 if (r[0] & r[0]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0xe2be: {"kind": "branch", "py": None, "slot_py": '', "target": 0xe2c8, "cond": 'notT'},
    0xe2c2: {"kind": 'reg', "py": 'r[2] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0xe2c4: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFA42C, 1, r[2])', "target": 0xe2cc, "cond": 'always'},
    0xe2c8: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0xe2ca: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA42C, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0xe2cc: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
