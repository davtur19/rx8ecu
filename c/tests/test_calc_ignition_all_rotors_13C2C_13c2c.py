#!/usr/bin/env python3
"""Differential test for calc_ignition_all_rotors_13C2C (0x13C2C) — v3 lift + v4 FPU, 24 bytes.
...
Run from repo root: python3 c/tests/test_calc_ignition_all_rotors_13C2C_13c2c.py
"""
...
ENTRY = 0x13C2C
RAW = bytes.fromhex("93 39 F2 38 F3 25 8D 03 00 09 E1 01 A0 02 25 10 E0 00 25 00 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    ...
    0x13c38: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, r[5], 1, r[1])', "target": 0x13c40, "cond": 'always'},
    0x13c3c: {"kind": 'reg', "py": 'r[0] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x13c3e: {"kind": 'mem', "py": '_wrw(ram, r[5], 1, r[0])', "slot_py": None, "target": None, "cond": None},
