#!/usr/bin/env python3
"""Differential test for updateDSCRelatedCANStuff__ (0x2AA02) — v3 lift (branches + delay slots), 24 bytes.
...
Run from repo root: python3 c/tests/test_updateDSCRelatedCANStuff___2aa02.py
"""
...
ENTRY = 0x2AA02
RAW = bytes.fromhex("60 0D 40 15 8F 03 00 09 E3 01 A0 02 26 30 E1 00 26 10 4F 26 00 0B 6E F6")
SEED = 0
N = 2000
MAXSTEPS = 100000
