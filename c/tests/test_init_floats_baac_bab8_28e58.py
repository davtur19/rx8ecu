#!/usr/bin/env python3
"""Differential test for init_floats_baac_bab8 (0x28E58) — v3 lift + v4 FPU, 22 bytes.
...
Run from repo root: python3 c/tests/test_init_floats_baac_bab8_28e58.py
"""
...
ENTRY = 0x28E58
RAW = bytes.fromhex("C7 47 F4 08 93 80 F3 4A 92 7F F2 4A 91 7E F1 4A 93 7D 00 0B F3 4A")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBAB8
SPAN_END = 0x28E6E
SENT = 0x28E6E     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x28e58: {"kind": 'reg', "py": 'r[0] = 0x00028F78', "slot_py": None, "target": None, "cond": None},
    0x28e5a: {"kind": 'fpu', "py": 'fr[4] = bits2f(_rdw(ram, 0x00028F78, 4))', "slot_py": None, "target": None, "cond": None},
    0x28e5c: {"kind": 'reg', "py": 'r[3] = 0xFFFFBAAC', "slot_py": None, "target": None, "cond": None},
    0x28e5e: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFBAAC, 4, f2bits(fr[4]))', "slot_py": None, "target": None, "cond": None},
    0x28e60: {"kind": 'reg', "py": 'r[2] = 0xFFFFBAB0', "slot_py": None, "target": None, "cond": None},
    0x28e62: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFBAB0, 4, f2bits(fr[4]))', "slot_py": None, "target": None, "cond": None},
    0x28e64: {"kind": 'reg', "py": 'r[1] = 0xFFFFBAB4', "slot_py": None, "target": None, "cond": None},
    0x28e66: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFBAB4, 4, f2bits(fr[4]))', "slot_py": None, "target": None, "cond": None},
    0x28e68: {"kind": 'reg', "py": 'r[3] = 0xFFFFBAB8', "slot_py": None, "target": None, "cond": None},
    0x28e6a: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBAB8, 4, f2bits(fr[4]))', "target": None, "cond": None},}
