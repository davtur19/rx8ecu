#!/usr/bin/env python3
"""Differential test for atu_clock_prescaler_select (0x5292) — v3 lift (branches + delay slots), 30 bytes.
...
Run from repo root: python3 c/tests/test_atu_clock_prescaler_select_5292.py
"""
...
ENTRY = 0x5292
RAW = bytes.fromhex("E1 01 90 4E 20 10 94 4D D2 2F 63 20 23 38 8F 03 00 09 93 48 A0 01 00 09 93 46 00 0B 24 31")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    0x5292: {"kind": 'reg', "py": 'r[1] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x5294: {"kind": 'reg', "py": 'r[0] = 0xFFFFF708', "slot_py": None, "target": None, "cond": None},
    0x5296: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFF708, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x5298: {"kind": 'reg', "py": 'r[4] = 0xFFFFF70A', "slot_py": None, "target": None, "cond": None},
    0x529a: {"kind": 'reg', "py": 'r[2] = 0x0006CF00', "slot_py": None, "target": None, "cond": None},
    0x529c: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0x0006CF00, 1))', "slot_py": None, "target": None, "cond": None},
