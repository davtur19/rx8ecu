#!/usr/bin/env python3
"""Differential test for dwell_time_calc_0x5071C (0x5071C) — v3 lift (branches + delay slots), 64 bytes.
...
Run from repo root: python3 c/tests/test_dwell_time_calc_0x5071C_5071c.py
"""
...
ENTRY = 0x5071C
RAW = bytes.fromhex("93 47 95 4A 92 3B 60 20 60 0C 88 01 8F 13 64 30 91 3E 60 11 D2 25 63 21 30 36 8F 0C 00 09 D3 24 60 30 20 08 8D 07 00 09 62 4C 22 28 8F 03 00 09 E3 01 A0 02 25 30 E1 00 25 10 D3 1D 00 0B 23 40")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    0x5071c: {"kind": 'reg', "py": 'r[3] = 0xFFFFD034', "slot_py": None, "target": None, "cond": None},
    0x5071e: {"kind": 'reg', "py": 'r[5] = 0xFFFFD083', "slot_py": None, "target": None, "cond": None},
    0x50720: {"kind": 'reg', "py": 'r[2] = 0xFFFFD07C', "slot_py": None, "target": None, "cond": None},
    0x50722: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFD07C, 1))', "slot_py": None, "target": None, "cond": None},
    0x50724: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x50726: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x50728: {"kind": "branch", "py": None, "slot_py": 'r[4] = s8(_rdw(ram, 0xFFFFD034, 1))', "target": 0x50752, "cond": 'notT'},
    0x5072c: {"kind": 'reg', "py": 'r[1] = 0xFFFFCFE6', "slot_py": None, "target": None, "cond": None},
    0x5072e: {"kind": 'mem', "py": 'r[0] = s16(_rdw(ram, 0xFFFFCFE6, 2))', "slot_py": None, "target": None, "cond": None},
    0x50730: {"kind": 'reg', "py": 'r[2] = 0x0007D23E', "slot_py": None, "target": None, "cond": None},
    0x50732: {"kind": 'mem', "py": 'r[3] = s16(_rdw(ram, 0x0007D23E, 2))', "slot_py": None, "target": None, "cond": None},
    0x50734: {"kind": 'reg', "py": 'T = 1 if r[0] > r[3] else 0', "slot_py": None, "target": None, "cond": None},
    0x50736: {"kind": "branch", "py": None, "slot_py": '', "target": 0x50752, "cond": 'notT'},
    0x5073a: {"kind": 'reg', "py": 'r[3] = 0xFFFFD0BB', "slot_py": None, "target": None, "cond": None},
    0x5073c: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFD0BB, 1))', "slot_py": None, "target": None, "cond": None},
    0x5073e: {"kind": 'reg', "py": 'T = 1 if (r[0] & r[0]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x50740: {"kind": "branch", "py": None, "slot_py": '', "target": 0x50752, "cond": 'T'},
    0x50744: {"kind": 'reg', "py": 'r[2] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x50746: {"kind": 'reg', "py": 'T = 1 if (r[2] & r[2]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x50748: {"kind": "branch", "py": None, "slot_py": '', "target": 0x50752, "cond": 'notT'},
    0x5074c: {"kind": 'reg', "py": 'r[3] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x5074e: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFD083, 1, r[3])', "target": 0x50756, "cond": 'always'},
    0x50752: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x50754: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD083, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x50756: {"kind": 'reg', "py": 'r[3] = 0xFFFFD0BB', "slot_py": None, "target": None, "cond": None},
    0x50758: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFD0BB, 1, r[4])', "target": None, "cond": None},}
