#!/usr/bin/env python3
"""Differential test for caller_19BC6 (entry 0x19BC6) — v8 ST caller (CFG), 30 bytes.
...
Run: python3 test_caller_19BC6.py
"""
...
CODE = {
    0x19bc6: {"kind": 'st', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x19bc8: {"kind": 'reg', "py": 'r[0] = 0x00019C6C', "slot_py": None, "target": None, "cond": None},
    0x19bca: {"kind": 'fpu', "py": 'fr[7] = bits2f(_rdw(ram, 0x00019C6C, 4))', "slot_py": None, "target": None, "cond": None},
    0x19bcc: {"kind": 'reg', "py": 'r[3] = 0x0006F570', "slot_py": None, "target": None, "cond": None},
    0x19bce: {"kind": 'fpu', "py": 'fr[6] = bits2f(_rdw(ram, 0x0006F570, 4))', "slot_py": None, "target": None, "cond": None},
    0x19bd0: {"kind": 'reg', "py": 'r[2] = 0xFFFFAA18', "slot_py": None, "target": None, "cond": None},
    0x19bd2: {"kind": 'fpu', "py": 'fr[5] = bits2f(_rdw(ram, 0xFFFFAA18, 4))', "slot_py": None, "target": None, "cond": None},
    0x19bd4: {"kind": 'reg', "py": 'r[1] = 0xFFFFAA14', "slot_py": None, "target": None, "cond": None},
    0x19bd6: {"kind": 'reg', "py": 'r[3] = 0x000023B0', "slot_py": None, "target": None, "cond": None},
    0x19bd8: {"kind": "call", "py": None, "slot_py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFAA14, 4))', "target": 0x23b0, "ret_pc": 0x19bdc, "set_pr": True, "cond": None},
    0x19bdc: {"kind": 'reg', "py": 'r[2] = 0xFFFFAA18', "slot_py": None, "target": None, "cond": None},
    0x19bde: {"kind": 'st', "py": 'pr = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x19be0: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFAA18, 4, f2bits(fr[0]))', "target": None, "cond": None},
