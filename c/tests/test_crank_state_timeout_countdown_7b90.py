#!/usr/bin/env python3
"""Differential test for crank_state_timeout_countdown (0x7B90) — v3 lift (branches + delay slots), 46 bytes.
...
Run from repo root: python3 c/tests/test_crank_state_timeout_countdown_7b90.py
"""
...
ENTRY = 0x7B90
RAW = bytes.fromhex("D4 2E 63 40 63 3C 43 15 8F 0F 00 09 63 40 73 FF 24 30 62 40 22 28 8F 08 00 09 D3 29 61 30 21 18 8F 03 00 09 D2 24 E0 00 22 00 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFF9FC8
SPAN_END = 0x7BBE
SENT = 0x7BBE     # stop-sentinel, placed past the literal pool
