#!/usr/bin/env python3
"""Differential test for getThrottleLessThanLookupTimer (0x42F2C) — mem lift (RAM-only, straight-line), 20 bytes.
...
Run from repo root: python3 c/tests/test_getThrottleLessThanLookupTimer_42f2c.py
"""
...
ENTRY = 0x42F2C
RAW = bytes.fromhex("93 1E 60 30 D8 1E 80 F4 D0 1C 62 00 DA 1D 2F 20 92 17 60 20")
SEED = 42
N = 2000
...
def spec_mirror(r4, r5, r6, r7, ram, stack_top):
    ...
    r[0] = s8(_rdw(ram, 0xFFFFC99C, 1))
    # 0x042F30: op 0xD81E
    r[8] = 0xFFFFC9C8
    # 0x042F32: mov.b r0,@(0x4,r15)
    local[0x404] = r[0]
    _wrw(ram, STACK_BASE + 0x404, 1, r[0])
    # 0x042F34: op 0xD01C
    r[0] = 0xFFFFC9BD
    # 0x042F36: mov.b @r0,r2
    r[2] = s8(_rdw(ram, 0xFFFFC9BD, 1))
    # 0x042F38: op 0xDA1D
    r[10] = 0xFFFFC9CE
    # 0x042F3A: mov.b r2,@r15
    local[0x400] = r[2]
    _wrw(ram, STACK_BASE + 0x400, 1, r[2])
    # 0x042F3C: op 0x9217
    r[2] = 0xFFFFD201
    # 0x042F3E: mov.b @r2,r0
    r[0] = s8(_rdw(ram, 0xFFFFD201, 1))
    r[15] = sp
