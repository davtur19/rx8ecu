#!/usr/bin/env python3
"""Differential test for math_conditional_2ef42 (0x2EF42) — v3 lift (branches + delay slots), 34 bytes.
...
Run from repo root: python3 c/tests/test_math_conditional_2ef42_2ef42.py
"""
...
ENTRY = 0x2EF42
RAW = bytes.fromhex("94 12 90 12 60 00 C8 80 00 29 70 FF 60 0B 88 01 8F 03 00 09 E2 01 A0 02 24 20 E1 00 24 10 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
