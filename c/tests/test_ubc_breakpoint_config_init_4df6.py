#!/usr/bin/env python3
"""Differential test for ubc_breakpoint_config_init (0x4DF6) — v3 lift (branches + delay slots), 24 bytes.
...
Run from repo root: python3 c/tests/test_ubc_breakpoint_config_init_4df6.py
"""
...
CODE = {
    0x4df6: {"kind": 'reg', "py": 'r[4] = 0x7FFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x4df8: {"kind": 'reg', "py": 'r[3] = 0xFFFFEC00', "slot_py": None, "target": None, "cond": None},
    0x4dfa: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFEC00, 4, r[4])', "slot_py": None, "target": None, "cond": None},
    0x4dfc: {"kind": 'reg', "py": 'r[2] = 0xFFFFEC04', "slot_py": None, "target": None, "cond": None},
    0x4dfe: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFEC04, 4, r[4])', "slot_py": None, "target": None, "cond": None},
    0x4e00: {"kind": 'reg', "py": 'r[1] = 0x000000E8', "slot_py": None, "target": None, "cond": None},
    0x4e02: {"kind": 'reg', "py": 'r[0] = 0xFFFFEC08', "slot_py": None, "target": None, "cond": None},
    0x4e04: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFEC08, 2, r[1])', "slot_py": None, "target": None, "cond": None},
    0x4e06: {"kind": 'reg', "py": 'r[3] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x4e08: {"kind": 'reg', "py": 'r[1] = 0xFFFFEC0A', "slot_py": None, "target": None, "cond": None},
    0x4e0a: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFEC0A, 2, r[3])', "target": None, "cond": None},}
