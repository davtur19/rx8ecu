#!/usr/bin/env python3
"""Differential test for fuel_table_lookup_compare_3DB82 (0x3DB82) — v3 lift + v4 FPU, 42 bytes.
...
Run from repo root: python3 c/tests/test_fuel_table_lookup_compare_3DB82_3db82.py
"""
...
ENTRY = 0x3DB82
RAW = bytes.fromhex("E5 01 D3 0F 96 18 F3 38 F3 45 8F 02 E4 00 A0 01 26 50 26 40 96 11 D3 0B F3 38 F4 35 8F 02 00 09 A0 01 26 50 26 40 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFC64D
SPAN_END = 0x3DBAC
SENT = 0x3DBAC     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x3db82: {"kind": 'reg', "py": 'r[5] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x3db84: {"kind": 'reg', "py": 'r[3] = 0x0007A91C', "slot_py": None, "target": None, "cond": None},
    0x3db86: {"kind": 'reg', "py": 'r[6] = 0xFFFFC64C', "slot_py": None, "target": None, "cond": None},
    0x3db88: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x0007A91C, 4))', "slot_py": None, "target": None, "cond": None},
    0x3db8a: {"kind": 'fpu', "py": 'T = 1 if fr[3] > fr[4] else 0', "slot_py": None, "target": None, "cond": None},
    0x3db8c: {"kind": "branch", "py": None, "slot_py": 'r[4] = s8(0x00)', "target": 0x3db94, "cond": 'notT'},
    0x3db90: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFC64C, 1, r[5])', "target": 0x3db96, "cond": 'always'},
    0x3db94: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC64C, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x3db96: {"kind": 'reg', "py": 'r[6] = 0xFFFFC64D', "slot_py": None, "target": None, "cond": None},
    0x3db98: {"kind": 'reg', "py": 'r[3] = 0x0007A920', "slot_py": None, "target": None, "cond": None},
    0x3db9a: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x0007A920, 4))', "slot_py": None, "target": None, "cond": None},
    0x3db9c: {"kind": 'fpu', "py": 'T = 1 if fr[4] > fr[3] else 0', "slot_py": None, "target": None, "cond": None},
    0x3db9e: {"kind": "branch", "py": None, "slot_py": '', "target": 0x3dba6, "cond": 'notT'},
    0x3dba2: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFC64D, 1, r[5])', "target": 0x3dba8, "cond": 'always'},
    0x3dba6: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC64D, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x3dba8: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
