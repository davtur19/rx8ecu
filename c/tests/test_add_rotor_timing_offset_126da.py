#!/usr/bin/env python3
"""Differential test for add_rotor_timing_offset (0x126DA) — v3 lift + v4 FPU, 16 bytes.
...
Run from repo root: python3 c/tests/test_add_rotor_timing_offset_126da.py
"""
...
RAM_MAX = 0xFFFFA664
SPAN_END = 0x126EA
SENT = 0x126EA     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x126da: {"kind": 'reg', "py": 'r[2] = 0xFFFFA664', "slot_py": None, "target": None, "cond": None},
    0x126dc: {"kind": 'reg', "py": 'r[1] = 0xFFFFA65C', "slot_py": None, "target": None, "cond": None},
    0x126de: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFA664, 4))', "slot_py": None, "target": None, "cond": None},
    0x126e0: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0xFFFFA65C, 4))', "slot_py": None, "target": None, "cond": None},
    0x126e2: {"kind": 'fpu', "py": 'fr[2] = ts(fr[2] + fr[3])', "slot_py": None, "target": None, "cond": None},
    0x126e4: {"kind": 'reg', "py": 'r[3] = 0xFFFFA648', "slot_py": None, "target": None, "cond": None},
    0x126e6: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFA648, 4, f2bits(fr[2]))', "target": None, "cond": None},}
