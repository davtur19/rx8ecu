#!/usr/bin/env python3
"""Differential test for caller_B460 (entry 0xB460) — v8 ST caller (CFG), 48 bytes.
...
Run: python3 test_caller_B460.py
"""
...
CODE = {
    0xb460: {"kind": 'st', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xb462: {"kind": 'reg', "py": 'r[15] = (r[15] + s8(0xFC)) & 0xFFFFFFFF\nsp = (sp + s8(0xFC)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xb464: {"kind": 'reg', "py": 'r[5] = 0x000000E0', "slot_py": None, "target": None, "cond": None},
    0xb466: {"kind": 'reg', "py": 'r[3] = 0x00002054', "slot_py": None, "target": None, "cond": None},
    0xb468: {"kind": "call", "py": None, "slot_py": 'r[4] = r[15]', "target": 0x2054, "ret_pc": 0xb46c, "set_pr": True, "cond": None},
    0xb46c: {"kind": 'reg', "py": 'r[0] = 0xFFFFA214', "slot_py": None, "target": None, "cond": None},
    0xb46e: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFA214, 1))', "slot_py": None, "target": None, "cond": None},
    0xb470: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0xb472: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0xb474: {"kind": "branch", "py": None, "slot_py": '', "target": 0xb482, "cond": 'notT'},
    0xb478: {"kind": 'reg', "py": 'r[4] = 0x00007D00', "slot_py": None, "target": None, "cond": None},
    0xb47a: {"kind": 'reg', "py": 'r[2] = 0xFFFFF58E', "slot_py": None, "target": None, "cond": None},
    0xb47c: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFF58E, 2, r[4])', "slot_py": None, "target": None, "cond": None},
    0xb47e: {"kind": 'reg', "py": 'r[3] = 0xFFFF9F50', "slot_py": None, "target": None, "cond": None},
    0xb480: {"kind": 'mem', "py": '_wrw(ram, r[3], 2, r[4])', "slot_py": None, "target": None, "cond": None},
    0xb482: {"kind": 'reg', "py": 'r[3] = 0x00002064', "slot_py": None, "target": None, "cond": None},
    0xb484: {"kind": "call", "py": None, "slot_py": 'r[4] = _rdw(ram, sp, 4)', "target": 0x2064, "ret_pc": 0xb488, "set_pr": True, "cond": None},
    0xb488: {"kind": 'reg', "py": 'r[15] = (r[15] + s8(0x04)) & 0xFFFFFFFF\nsp = (sp + s8(0x04)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xb48a: {"kind": 'st', "py": 'pr = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xb48c: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},
