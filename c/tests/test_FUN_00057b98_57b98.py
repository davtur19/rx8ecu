#!/usr/bin/env python3
"""Differential test for FUN_00057b98 (0x57B98) — v3 lift (branches + delay slots), 32 bytes.
...
Run from repo root: python3 c/tests/test_FUN_00057b98_57b98.py
"""
...
ENTRY = 0x57B98
RAW = bytes.fromhex("D3 39 E4 00 D2 39 23 40 22 41 D1 39 D3 39 21 40 23 40 D2 39 D1 39 22 40 21 41 D3 39 00 0B 23 40")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFD090
SPAN_END = 0x57BB8
SENT = 0x57BB8     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x57b98: {"kind": 'reg', "py": 'r[3] = 0xFFFFD087', "slot_py": None, "target": None, "cond": None},
    0x57b9a: {"kind": 'reg', "py": 'r[4] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x57b9c: {"kind": 'reg', "py": 'r[2] = 0xFFFFD088', "slot_py": None, "target": None, "cond": None},
    0x57b9e: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD087, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x57ba0: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD088, 2, r[4])', "slot_py": None, "target": None, "cond": None},
    0x57ba2: {"kind": 'reg', "py": 'r[1] = 0xFFFFD08A', "slot_py": None, "target": None, "cond": None},
    0x57ba4: {"kind": 'reg', "py": 'r[3] = 0xFFFFD08B', "slot_py": None, "target": None, "cond": None},
    0x57ba6: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD08A, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x57ba8: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD08B, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x57baa: {"kind": 'reg', "py": 'r[2] = 0xFFFFD08C', "slot_py": None, "target": None, "cond": None},
    0x57bac: {"kind": 'reg', "py": 'r[1] = 0xFFFFD08E', "slot_py": None, "target": None, "cond": None},
    0x57bae: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD08C, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x57bb0: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD08E, 2, r[4])', "slot_py": None, "target": None, "cond": None},
    0x57bb2: {"kind": 'reg', "py": 'r[3] = 0xFFFFD090', "slot_py": None, "target": None, "cond": None},
    0x57bb4: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFD090, 1, r[4])', "target": None, "cond": None},}
