#!/usr/bin/env python3
"""Differential test for DSC_checkIfMode_x40 (0x2BEA8) — v3 lift (branches + delay slots), 52 bytes.
...
Run from repo root: python3 c/tests/test_DSC_checkIfMode_x40_2bea8.py
"""
...
ENTRY = 0x2BEA8
RAW = bytes.fromhex("94 6E D3 3B 60 30 60 0C C9 40 88 40 8D 05 00 09 D2 38 61 20 21 18 8D 09 00 09 93 62 60 30 60 0C 88 01 8F 03 00 09 E3 01 A0 02 24 30 E1 00 24 10 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBC2A
SPAN_END = 0x2BEDC
SENT = 0x2BEDC     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x2bea8: {"kind": 'reg', "py": 'r[4] = 0xFFFFBC00', "slot_py": None, "target": None, "cond": None},
    0x2beaa: {"kind": 'reg', "py": 'r[3] = 0xFFFFBC2A', "slot_py": None, "target": None, "cond": None},
    0x2beac: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFBC2A, 1))', "slot_py": None, "target": None, "cond": None},
    0x2beae: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x2beb0: {"kind": 'reg', "py": 'r[0] = (r[0] & 0x40) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x2beb2: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x40) else 0', "slot_py": None, "target": None, "cond": None},
    0x2beb4: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2bec2, "cond": 'T'},
    0x2beb8: {"kind": 'reg', "py": 'r[2] = 0x00077A6B', "slot_py": None, "target": None, "cond": None},
    0x2beba: {"kind": 'mem', "py": 'r[1] = s8(_rdw(ram, 0x00077A6B, 1))', "slot_py": None, "target": None, "cond": None},
    0x2bebc: {"kind": 'reg', "py": 'T = 1 if (r[1] & r[1]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x2bebe: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2bed4, "cond": 'T'},
    0x2bec2: {"kind": 'reg', "py": 'r[3] = 0xFFFFA428', "slot_py": None, "target": None, "cond": None},
    0x2bec4: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFA428, 1))', "slot_py": None, "target": None, "cond": None},
    0x2bec6: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x2bec8: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x2beca: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2bed4, "cond": 'notT'},
    0x2bece: {"kind": 'reg', "py": 'r[3] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x2bed0: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFBC00, 1, r[3])', "target": 0x2bed8, "cond": 'always'},
    0x2bed4: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x2bed6: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBC00, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x2bed8: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
