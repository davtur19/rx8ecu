#!/usr/bin/env python3
"""Differential test for hysteresis_flag_ba98 (0x28A06) — v3 lift + v4 FPU, 90 bytes.
...
Run from repo root: python3 c/tests/test_hysteresis_flag_ba98_28a06.py
"""
...
ENTRY = 0x28A06
RAW = bytes.fromhex("E6 01 D4 2F 93 4E D2 2C F4 38 F5 28 D1 2C F3 18 F6 5C F6 30 F5 45 8F 02 E5 00 A0 04 24 50 F6 45 8D 01 00 09 24 60 97 39 62 40 22 28 8F 0A 00 09 27 50 D3 1E 62 30 91 32 21 20 D2 1D 60 20 93 2F A0 09 23 00 27 60 D2 1F 63 20 91 28 21 30 D3 1E 60 30 92 25 22 00 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBAA8
SPAN_END = 0x28A60
SENT = 0x28A60     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x28a06: {"kind": 'reg', "py": 'r[6] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x28a08: {"kind": 'reg', "py": 'r[4] = 0xFFFFBAA8', "slot_py": None, "target": None, "cond": None},
    0x28a0a: {"kind": 'reg', "py": 'r[3] = 0xFFFFB594', "slot_py": None, "target": None, "cond": None},
    0x28a0c: {"kind": 'reg', "py": 'r[2] = 0x00075384', "slot_py": None, "target": None, "cond": None},
    0x28a0e: {"kind": 'fpu', "py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFB594, 4))', "slot_py": None, "target": None, "cond": None},
    0x28a10: {"kind": 'fpu', "py": 'fr[5] = bits2f(_rdw(ram, 0x00075384, 4))', "slot_py": None, "target": None, "cond": None},
    0x28a12: {"kind": 'reg', "py": 'r[1] = 0x0007538C', "slot_py": None, "target": None, "cond": None},
    0x28a14: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x0007538C, 4))', "slot_py": None, "target": None, "cond": None},
    0x28a16: {"kind": 'fpu', "py": 'fr[6] = fr[5]', "slot_py": None, "target": None, "cond": None},
    0x28a18: {"kind": 'fpu', "py": 'fr[6] = ts(fr[6] + fr[3])', "slot_py": None, "target": None, "cond": None},
    0x28a1a: {"kind": 'fpu', "py": 'T = 1 if fr[5] > fr[4] else 0', "slot_py": None, "target": None, "cond": None},
    0x28a1c: {"kind": "branch", "py": None, "slot_py": 'r[5] = s8(0x00)', "target": 0x28a24, "cond": 'notT'},
    0x28a20: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFBAA8, 1, r[5])', "target": 0x28a2c, "cond": 'always'},
    0x28a24: {"kind": 'fpu', "py": 'T = 1 if fr[6] > fr[4] else 0', "slot_py": None, "target": None, "cond": None},
    0x28a26: {"kind": "branch", "py": None, "slot_py": '', "target": 0x28a2c, "cond": 'T'},
    0x28a2a: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBAA8, 1, r[6])', "slot_py": None, "target": None, "cond": None},
    0x28a2c: {"kind": 'reg', "py": 'r[7] = 0xFFFFBA98', "slot_py": None, "target": None, "cond": None},
    0x28a2e: {"kind": 'mem', "py": 'r[2] = s8(_rdw(ram, 0xFFFFBAA8, 1))', "slot_py": None, "target": None, "cond": None},
    0x28a30: {"kind": 'reg', "py": 'T = 1 if (r[2] & r[2]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x28a32: {"kind": "branch", "py": None, "slot_py": '', "target": 0x28a4a, "cond": 'notT'},
    0x28a36: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBA98, 1, r[5])', "slot_py": None, "target": None, "cond": None},
    0x28a38: {"kind": 'reg', "py": 'r[3] = 0x0007537C', "slot_py": None, "target": None, "cond": None},
    0x28a3a: {"kind": 'mem', "py": 'r[2] = s8(_rdw(ram, 0x0007537C, 1))', "slot_py": None, "target": None, "cond": None},
    0x28a3c: {"kind": 'reg', "py": 'r[1] = 0xFFFFBA96', "slot_py": None, "target": None, "cond": None},
    0x28a3e: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBA96, 1, r[2])', "slot_py": None, "target": None, "cond": None},
    0x28a40: {"kind": 'reg', "py": 'r[2] = 0x0007537E', "slot_py": None, "target": None, "cond": None},
    0x28a42: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0x0007537E, 1))', "slot_py": None, "target": None, "cond": None},
    0x28a44: {"kind": 'reg', "py": 'r[3] = 0xFFFFBA97', "slot_py": None, "target": None, "cond": None},
    0x28a46: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFBA97, 1, r[0])', "target": 0x28a5c, "cond": 'always'},
    0x28a4a: {"kind": 'mem', "py": '_wrw(ram, r[7], 1, r[6])', "slot_py": None, "target": None, "cond": None},
    0x28a4c: {"kind": 'reg', "py": 'r[2] = 0x0007537D', "slot_py": None, "target": None, "cond": None},
    0x28a4e: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0x0007537D, 1))', "slot_py": None, "target": None, "cond": None},
    0x28a50: {"kind": 'reg', "py": 'r[1] = 0xFFFFBA96', "slot_py": None, "target": None, "cond": None},
    0x28a52: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBA96, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x28a54: {"kind": 'reg', "py": 'r[3] = 0x0007537F', "slot_py": None, "target": None, "cond": None},
    0x28a56: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0x0007537F, 1))', "slot_py": None, "target": None, "cond": None},
    0x28a58: {"kind": 'reg', "py": 'r[2] = 0xFFFFBA97', "slot_py": None, "target": None, "cond": None},
    0x28a5a: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBA97, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x28a5c: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
