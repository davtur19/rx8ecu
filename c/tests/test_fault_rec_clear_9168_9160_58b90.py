#!/usr/bin/env python3
"""Differential test for fault_rec_clear_9168_9160 (0x58B90) — v3 lift (branches + delay slots), 20 bytes.
...
Run from repo root: python3 c/tests/test_fault_rec_clear_9168_9160_58b90.py
"""
...
RAM_MAX = None
SPAN_END = 0x58BA4
SENT = 0x58BA4     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x58b90: {"kind": 'reg', "py": 'r[15] = (r[15] + s8(0x18)) & 0xFFFFFFFF\nsp = (sp + s8(0x18)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x58b92: {"kind": 'mem', "py": 'pr = _rdw(ram, STACK_BASE + 0x418, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x58b94: {"kind": 'mem', "py": 'r[8] = _rdw(ram, STACK_BASE + 0x41C, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x58b96: {"kind": 'mem', "py": 'r[9] = _rdw(ram, STACK_BASE + 0x420, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x58b98: {"kind": 'mem', "py": 'r[10] = _rdw(ram, STACK_BASE + 0x424, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x58b9a: {"kind": 'mem', "py": 'r[11] = _rdw(ram, STACK_BASE + 0x428, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x58b9c: {"kind": 'mem', "py": 'r[12] = _rdw(ram, STACK_BASE + 0x42C, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x58b9e: {"kind": 'mem', "py": 'r[13] = _rdw(ram, STACK_BASE + 0x430, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x58ba0: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, STACK_BASE + 0x434, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},}
