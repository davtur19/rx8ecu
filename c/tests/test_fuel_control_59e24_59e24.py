#!/usr/bin/env python3
"""Differential test for fuel_control_59e24 (0x59E24) — v3 lift (branches + delay slots), 32 bytes.
...
Run from repo root: python3 c/tests/test_fuel_control_59e24_59e24.py
"""
...
ENTRY = 0x59E24
RAW = bytes.fromhex("D3 37 E4 00 D2 37 23 40 22 41 D1 37 D3 37 21 40 23 40 D2 37 D1 37 22 40 21 41 D3 37 00 0B 23 40")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    0x59e24: {"kind": 'reg', "py": 'r[3] = 0xFFFFD2AF', "slot_py": None, "target": None, "cond": None},
    0x59e26: {"kind": 'reg', "py": 'r[4] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x59e28: {"kind": 'reg', "py": 'r[2] = 0xFFFFD2B0', "slot_py": None, "target": None, "cond": None},
    0x59e2a: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD2AF, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x59e2c: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD2B0, 2, r[4])', "slot_py": None, "target": None, "cond": None},
    0x59e2e: {"kind": 'reg', "py": 'r[1] = 0xFFFFD2B2', "slot_py": None, "target": None, "cond": None},
    0x59e30: {"kind": 'reg', "py": 'r[3] = 0xFFFFD2B3', "slot_py": None, "target": None, "cond": None},
    0x59e32: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD2B2, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x59e34: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD2B3, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x59e36: {"kind": 'reg', "py": 'r[2] = 0xFFFFD2B4', "slot_py": None, "target": None, "cond": None},
    0x59e38: {"kind": 'reg', "py": 'r[1] = 0xFFFFD2B6', "slot_py": None, "target": None, "cond": None},
    0x59e3a: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD2B4, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x59e3c: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD2B6, 2, r[4])', "slot_py": None, "target": None, "cond": None},
    0x59e3e: {"kind": 'reg', "py": 'r[3] = 0xFFFFD2B8', "slot_py": None, "target": None, "cond": None},
    0x59e40: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFD2B8, 1, r[4])', "target": None, "cond": None},}
