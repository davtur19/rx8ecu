#!/usr/bin/env python3
"""Differential test for stubCAN203TX_byte6 (0x29F36) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_stubCAN203TX_byte6_29f36.py
"""
...
ENTRY = 0x29F36
RAW = bytes.fromhex("92 54 D1 2D 00 0B 21 20")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBB64
SPAN_END = 0x29F3E
SENT = 0x29F3E     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x29f36: {"kind": 'reg', "py": 'r[2] = 0x000000FF', "slot_py": None, "target": None, "cond": None},
    0x29f38: {"kind": 'reg', "py": 'r[1] = 0xFFFFBB64', "slot_py": None, "target": None, "cond": None},
    0x29f3a: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBB64, 1, r[2])', "target": None, "cond": None},}
