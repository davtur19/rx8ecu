#!/usr/bin/env python3
"""Differential test for load_float_constant_0x4EF98 (0x4EF98) — v3 lift + v4 FPU, 10 bytes.
...
Run from repo root: python3 c/tests/test_load_float_constant_0x4EF98_4ef98.py
"""
...
RAM_MAX = 0xFFFFCFBC
SPAN_END = 0x4EFA2
SENT = 0x4EFA2     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x4ef98: {"kind": 'reg', "py": 'r[3] = 0x0007D95C', "slot_py": None, "target": None, "cond": None},
    0x4ef9a: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x0007D95C, 4))', "slot_py": None, "target": None, "cond": None},
    0x4ef9c: {"kind": 'reg', "py": 'r[1] = 0xFFFFCFBC', "slot_py": None, "target": None, "cond": None},
    0x4ef9e: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFCFBC, 4, f2bits(fr[3]))', "target": None, "cond": None},}
