#!/usr/bin/env python3
"""Differential test for sensor_value_scale (0x8F1E) — v3 lift (branches + delay slots), 12 bytes.
...
Run from repo root: python3 c/tests/test_sensor_value_scale_8f1e.py
"""
...
ENTRY = 0x8F1E
RAW = bytes.fromhex("00 09 60 E3 7F 04 4F 26 00 0B 6E F6")
SEED = 0
N = 2000
MAXSTEPS = 100000
STACK_BASE = 0xFFFFD000
STACK_TOP = STACK_BASE + 0x400
STACK_OFFS = (0x404, 0x408)
SEED_OFFS = (0x404,)   # lds.l pr/macl/mach slots seeded with the return sentinel
RAM_MIN = None
RAM_MAX = None
SPAN_END = 0x8F2A
SENT = 0x8F2A     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x8f1e: {"kind": 'reg', "py": None, "slot_py": None, "target": None, "cond": None},
    0x8f20: {"kind": 'reg', "py": 'r[0] = r[14]', "slot_py": None, "target": None, "cond": None},
    0x8f22: {"kind": 'reg', "py": 'r[15] = (r[15] + s8(0x04)) & 0xFFFFFFFF\nsp = (sp + s8(0x04)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x8f24: {"kind": 'mem', "py": 'pr = _rdw(ram, STACK_BASE + 0x404, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x8f26: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, STACK_BASE + 0x408, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},}
