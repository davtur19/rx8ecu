#!/usr/bin/env python3
"""Differential test for canMessageSetup (0x2AC4C) — v3 lift (branches + delay slots), 40 bytes.
...
Run from repo root: python3 c/tests/test_canMessageSetup_2ac4c.py
"""
...
ENTRY = 0x2AC4C
RAW = bytes.fromhex("2F E6 63 4C 2F D6 23 38 2F C6 2F B6 2F A6 EA 00 2F 96 2F 86 7F F0 8F 03 67 A3 93 65 A0 02 6E A3 93 63 6E A3 6D 30 6D DC")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFE600
SPAN_END = 0x2AC74
SENT = 0x2AC74     # stop-sentinel, placed past the literal pool
