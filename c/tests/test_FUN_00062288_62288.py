#!/usr/bin/env python3
"""Differential test for FUN_00062288 (0x62288) — pure straight-line lift, 12 bytes.
...
Run from repo root: python3 c/tests/test_FUN_00062288_62288.py
"""
...
ENTRY = 0x62288
RAW = bytes.fromhex("00 09 66 53 46 08 46 08 36 1C 62 4D")
SEED = 42
N = 2000
...
def spec_mirror(r4, r5, r6, r7):
    ...
    r[6] = r[5]
    # 0x06228C: op 0x4608
    r[6] = (r[6] << 2) & 0xFFFFFFFF
    # 0x06228E: op 0x4608
    r[6] = (r[6] << 2) & 0xFFFFFFFF
    # 0x062290: op 0x361C
    r[6] = (r[6] + r[1]) & 0xFFFFFFFF
    # 0x062292: op 0x624D
    r[2] = r[4] & 0xFFFF
