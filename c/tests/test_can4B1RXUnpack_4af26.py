#!/usr/bin/env python3
"""Differential test for can4B1RXUnpack (0x4AF26) — v3 lift (branches + delay slots), 52 bytes.
...
Run from repo root: python3 c/tests/test_can4B1RXUnpack_4af26.py
"""
...
ENTRY = 0x4AF26
RAW = bytes.fromhex("D4 1E D2 1E 63 40 D1 1E 22 30 84 41 21 00 84 42 D3 1D D2 1D 23 00 84 43 22 00 84 44 D1 1C D3 1C 21 00 84 45 23 00 84 46 D2 1B D1 1B 22 00 84 47 00 0B 21 00")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCD2C
SPAN_END = 0x4AF5A
SENT = 0x4AF5A     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x4af26: {"kind": 'reg', "py": 'r[4] = 0xFFFFCD1C', "slot_py": None, "target": None, "cond": None},
    0x4af28: {"kind": 'reg', "py": 'r[2] = 0xFFFFCD25', "slot_py": None, "target": None, "cond": None},
    0x4af2a: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFCD1C, 1))', "slot_py": None, "target": None, "cond": None},
    0x4af2c: {"kind": 'reg', "py": 'r[1] = 0xFFFFCD26', "slot_py": None, "target": None, "cond": None},
    0x4af2e: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCD25, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x4af30: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCD1D, 1))', "slot_py": None, "target": None, "cond": None},
    0x4af32: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCD26, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x4af34: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCD1E, 1))', "slot_py": None, "target": None, "cond": None},
    0x4af36: {"kind": 'reg', "py": 'r[3] = 0xFFFFCD27', "slot_py": None, "target": None, "cond": None},
    0x4af38: {"kind": 'reg', "py": 'r[2] = 0xFFFFCD28', "slot_py": None, "target": None, "cond": None},
    0x4af3a: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCD27, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x4af3c: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCD1F, 1))', "slot_py": None, "target": None, "cond": None},
    0x4af3e: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCD28, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x4af40: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCD20, 1))', "slot_py": None, "target": None, "cond": None},
    0x4af42: {"kind": 'reg', "py": 'r[1] = 0xFFFFCD29', "slot_py": None, "target": None, "cond": None},
    0x4af44: {"kind": 'reg', "py": 'r[3] = 0xFFFFCD2A', "slot_py": None, "target": None, "cond": None},
    0x4af46: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCD29, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x4af48: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCD21, 1))', "slot_py": None, "target": None, "cond": None},
    0x4af4a: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCD2A, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x4af4c: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCD22, 1))', "slot_py": None, "target": None, "cond": None},
    0x4af4e: {"kind": 'reg', "py": 'r[2] = 0xFFFFCD2B', "slot_py": None, "target": None, "cond": None},
    0x4af50: {"kind": 'reg', "py": 'r[1] = 0xFFFFCD2C', "slot_py": None, "target": None, "cond": None},
    0x4af52: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCD2B, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x4af54: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCD23, 1))', "slot_py": None, "target": None, "cond": None},
    0x4af56: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFCD2C, 1, r[0])', "target": None, "cond": None},}
