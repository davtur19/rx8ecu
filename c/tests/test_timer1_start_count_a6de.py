#!/usr/bin/env python3
"""Differential test for timer1_start_count (0xA6DE) — v3 lift (branches + delay slots), 20 bytes.
...
Run from repo root: python3 c/tests/test_timer1_start_count_a6de.py
"""
...
CODE = {
    0xa6de: {"kind": 'reg', "py": 'r[2] = s8(0x02)', "slot_py": None, "target": None, "cond": None},
    0xa6e0: {"kind": 'reg', "py": 'r[1] = 0xFFFFF710', "slot_py": None, "target": None, "cond": None},
    0xa6e2: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFF710, 2, r[2])', "slot_py": None, "target": None, "cond": None},
    0xa6e4: {"kind": 'reg', "py": 'r[3] = 0x000000C0', "slot_py": None, "target": None, "cond": None},
    0xa6e6: {"kind": 'reg', "py": 'r[0] = 0xFFFFF718', "slot_py": None, "target": None, "cond": None},
    0xa6e8: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFF718, 2, r[3])', "slot_py": None, "target": None, "cond": None},
    0xa6ea: {"kind": 'reg', "py": 'r[2] = 0x000009C3', "slot_py": None, "target": None, "cond": None},
    0xa6ec: {"kind": 'reg', "py": 'r[3] = 0xFFFFF71C', "slot_py": None, "target": None, "cond": None},
    0xa6ee: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFF71C, 2, r[2])', "target": None, "cond": None},}
