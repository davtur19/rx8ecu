#!/usr/bin/env python3
"""Differential test for caller_3544E (entry 0x3544E) — v8 ST caller (CFG), 38 bytes.
...
Run: python3 test_caller_3544E.py
"""
...
CODE = {
    0x3544e: {"kind": 'st', "py": 'local[0x3FC] = pr\n_wrw(ram, STACK_BASE + 0x3FC, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x35450: {"kind": 'reg', "py": 'r[1] = 0xFFFFA42C', "slot_py": None, "target": None, "cond": None},
    0x35452: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFA42C, 1))', "slot_py": None, "target": None, "cond": None},
    0x35454: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x35456: {"kind": "branch", "py": None, "slot_py": '', "target": 0x3546e, "cond": 'notT'},
    0x3545a: {"kind": 'reg', "py": 'r[2] = 0x00079BE4', "slot_py": None, "target": None, "cond": None},
    0x3545c: {"kind": 'reg', "py": 'r[0] = 0xFFFFC180', "slot_py": None, "target": None, "cond": None},
    0x3545e: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x00079BE4, 4))', "slot_py": None, "target": None, "cond": None},
    0x35460: {"kind": 'fpu', "py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFC180, 4))', "slot_py": None, "target": None, "cond": None},
    0x35462: {"kind": 'fpu', "py": 'fr[4] = ts(fr[4] - fr[3])', "slot_py": None, "target": None, "cond": None},
    0x35464: {"kind": 'reg', "py": 'r[3] = 0x000023E4', "slot_py": None, "target": None, "cond": None},
    0x35466: {"kind": "call", "py": None, "slot_py": 'fr[5] = 1.0', "target": 0x23e4, "ret_pc": 0x3546a, "set_pr": True, "cond": None},
    0x3546a: {"kind": 'reg', "py": 'r[2] = 0xFFFFC180', "slot_py": None, "target": None, "cond": None},
    0x3546c: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFC180, 4, f2bits(fr[0]))', "slot_py": None, "target": None, "cond": None},
    0x3546e: {"kind": 'st', "py": 'pr = _rdw(ram, STACK_BASE + 0x3FC, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x35470: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},
