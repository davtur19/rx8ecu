#!/usr/bin/env python3
"""Differential test for FUN_00052c84 (0x52C84) — v3 lift (branches + delay slots), 14 bytes.
...
Run from repo root: python3 c/tests/test_FUN_00052c84_52c84.py
"""
...
RAM_MAX = None
SPAN_END = 0x52C92
SENT = 0x52C92     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x52c84: {"kind": 'mem', "py": 'r[9] = _rdw(ram, STACK_BASE + 0x400, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x52c86: {"kind": 'mem', "py": 'r[10] = _rdw(ram, STACK_BASE + 0x404, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x52c88: {"kind": 'mem', "py": 'r[11] = _rdw(ram, STACK_BASE + 0x408, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x52c8a: {"kind": 'mem', "py": 'r[12] = _rdw(ram, STACK_BASE + 0x40C, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x52c8c: {"kind": 'mem', "py": 'r[13] = _rdw(ram, STACK_BASE + 0x410, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x52c8e: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, STACK_BASE + 0x414, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},}
