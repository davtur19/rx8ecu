#!/usr/bin/env python3
"""Differential test for caller_4F23E (entry 0x4F23E) — v8 ST caller (CFG), 38 bytes.
...
Run: python3 test_caller_4F23E.py
"""
...
CODE = {
    0x4f23e: {"kind": 'fpu', "py": 'fr[5] = 0.0', "slot_py": None, "target": None, "cond": None},
    0x4f240: {"kind": 'st', "py": 'local[0x3FC] = pr\n_wrw(ram, STACK_BASE + 0x3FC, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x4f242: {"kind": 'reg', "py": 'r[3] = 0xFFFF9EF6', "slot_py": None, "target": None, "cond": None},
    0x4f244: {"kind": 'reg', "py": 'r[0] = 0xFFFFCFE0', "slot_py": None, "target": None, "cond": None},
    0x4f246: {"kind": 'mem', "py": 'r[2] = s16(_rdw(ram, 0xFFFF9EF6, 2))', "slot_py": None, "target": None, "cond": None},
    0x4f248: {"kind": 'reg', "py": 'r[3] = 0x000024C0', "slot_py": None, "target": None, "cond": None},
    0x4f24a: {"kind": 'reg', "py": 'r[2] = r[2] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x4f24c: {"kind": 'reg', "py": 'r[2] = (r[2] >> 2) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x4f24e: {"kind": 'reg', "py": 'r[2] = (r[2] >> 2) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x4f250: {"kind": 'reg', "py": 'r[2] = (r[2] >> 2) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x4f252: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCFE0, 2, r[2])', "slot_py": None, "target": None, "cond": None},
    0x4f254: {"kind": 'reg', "py": 'r[0] = 0x0004F2D0', "slot_py": None, "target": None, "cond": None},
    0x4f256: {"kind": 'fpu', "py": 'fr[4] = bits2f(_rdw(ram, 0x0004F2D0, 4))', "slot_py": None, "target": None, "cond": None},
    0x4f258: {"kind": "call", "py": None, "slot_py": 'r[4] = r[2]', "target": 0x24c0, "ret_pc": 0x4f25c, "set_pr": True, "cond": None},
    0x4f25c: {"kind": 'reg', "py": 'r[1] = 0xFFFFCFDC', "slot_py": None, "target": None, "cond": None},
    0x4f25e: {"kind": 'st', "py": 'pr = _rdw(ram, STACK_BASE + 0x3FC, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x4f260: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFCFDC, 4, f2bits(fr[0]))', "target": None, "cond": None},
