#!/usr/bin/env python3
"""Differential test for uds_fault_compare_d084_d085 (0x58758) — v3 lift (branches + delay slots), 22 bytes.
...
Run from repo root: python3 c/tests/test_uds_fault_compare_d084_d085_58758.py
"""
...
ENTRY = 0x58758
RAW = bytes.fromhex("93 31 60 30 60 0C 88 20 8F 03 00 09 92 2C E1 01 22 10 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFD084
SPAN_END = 0x5876E
SENT = 0x5876E     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x58758: {"kind": 'reg', "py": 'r[3] = 0xFFFFD067', "slot_py": None, "target": None, "cond": None},
    0x5875a: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFD067, 1))', "slot_py": None, "target": None, "cond": None},
    0x5875c: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x5875e: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x20) else 0', "slot_py": None, "target": None, "cond": None},
    0x58760: {"kind": "branch", "py": None, "slot_py": '', "target": 0x5876a, "cond": 'notT'},
    0x58764: {"kind": 'reg', "py": 'r[2] = 0xFFFFD084', "slot_py": None, "target": None, "cond": None},
    0x58766: {"kind": 'reg', "py": 'r[1] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x58768: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD084, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x5876a: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
