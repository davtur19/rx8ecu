#!/usr/bin/env python3
"""Differential test for FUN_0003b998 (0x3B998) — v3 lift (branches + delay slots), 22 bytes.
...
Run from repo root: python3 c/tests/test_FUN_0003b998_3b998.py
"""
...
ENTRY = 0x3B998
RAW = bytes.fromhex("95 4D 64 50 63 4C 43 15 8F 03 00 09 93 48 34 3C 25 40 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFC58F
SPAN_END = 0x3B9AE
SENT = 0x3B9AE     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x3b998: {"kind": 'reg', "py": 'r[5] = 0xFFFFC58F', "slot_py": None, "target": None, "cond": None},
    0x3b99a: {"kind": 'mem', "py": 'r[4] = s8(_rdw(ram, 0xFFFFC58F, 1))', "slot_py": None, "target": None, "cond": None},
    0x3b99c: {"kind": 'reg', "py": 'r[3] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x3b99e: {"kind": 'reg', "py": 'T = 1 if s32(r[3]) > 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x3b9a0: {"kind": "branch", "py": None, "slot_py": '', "target": 0x3b9aa, "cond": 'notT'},
    0x3b9a4: {"kind": 'reg', "py": 'r[3] = 0x000000FF', "slot_py": None, "target": None, "cond": None},
    0x3b9a6: {"kind": 'reg', "py": 'r[4] = (r[4] + r[3]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x3b9a8: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC58F, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x3b9aa: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
