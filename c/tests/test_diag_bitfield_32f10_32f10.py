#!/usr/bin/env python3
"""Differential test for diag_bitfield_32f10 (0x32F10) — v3 lift (branches + delay slots), 32 bytes.
...
Run from repo root: python3 c/tests/test_diag_bitfield_32f10_32f10.py
"""
...
ENTRY = 0x32F10
RAW = bytes.fromhex("94 0E D3 08 60 30 60 0C C8 40 00 29 88 01 8F 03 00 09 E3 01 A0 02 24 30 E1 00 24 10 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFC004
SPAN_END = 0x32F30
SENT = 0x32F38     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x32f10: {"kind": 'reg', "py": 'r[4] = 0xFFFFC004', "slot_py": None, "target": None, "cond": None},
    0x32f12: {"kind": 'reg', "py": 'r[3] = 0xFFFF9ECD', "slot_py": None, "target": None, "cond": None},
    0x32f14: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFF9ECD, 1))', "slot_py": None, "target": None, "cond": None},
    0x32f16: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x32f18: {"kind": 'reg', "py": 'T = 1 if (r[0] & 0x40) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x32f1a: {"kind": 'reg', "py": 'r[0] = T;', "slot_py": None, "target": None, "cond": None},
    0x32f1c: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x32f1e: {"kind": "branch", "py": None, "slot_py": '', "target": 0x32f28, "cond": 'notT'},
    0x32f22: {"kind": 'reg', "py": 'r[3] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x32f24: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFC004, 1, r[3])', "target": 0x32f2c, "cond": 'always'},
    0x32f28: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x32f2a: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC004, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x32f2c: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
