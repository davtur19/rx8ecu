#!/usr/bin/env python3
"""Differential test for acceleration_enrich_0x591BA (0x591BA) — v3 lift (branches + delay slots), 18 bytes.
...
Run from repo root: python3 c/tests/test_acceleration_enrich_0x591BA_591ba.py
"""
...
CODE = {
    0x591ba: {"kind": 'reg', "py": 'r[2] = 0xFFFFD07E', "slot_py": None, "target": None, "cond": None},
    0x591bc: {"kind": 'reg', "py": 'r[1] = 0xFFFFD26F', "slot_py": None, "target": None, "cond": None},
    0x591be: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFD07E, 1))', "slot_py": None, "target": None, "cond": None},
    0x591c0: {"kind": 'reg', "py": 'r[2] = 0xFFFFD270', "slot_py": None, "target": None, "cond": None},
    0x591c2: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD26F, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x591c4: {"kind": 'reg', "py": 'r[3] = 0xFFFFD07F', "slot_py": None, "target": None, "cond": None},
    0x591c6: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFD07F, 1))', "slot_py": None, "target": None, "cond": None},
    0x591c8: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFD270, 1, r[0])', "target": None, "cond": None},}
