#!/usr/bin/env python3
"""Differential test for air_bypass_control_43E4A (0x43E00) — v3 lift + v4 FPU, 96 bytes.
...
Run from repo root: python3 c/tests/test_air_bypass_control_43E4A_43e00.py
"""
...
RAM_MAX = 0xFFFFCAB6
SPAN_END = 0x43E60
SENT = 0x43E60     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x43e00: {"kind": 'reg', "py": 'r[1] = 0xFFFFB5B8', "slot_py": None, "target": None, "cond": None},
    0x43e02: {"kind": 'fpu', "py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFB5B8, 4))', "slot_py": None, "target": None, "cond": None},
    0x43e04: {"kind": 'reg', "py": 'r[6] = 0xFFFFCAAF', "slot_py": None, "target": None, "cond": None},
    0x43e06: {"kind": 'reg', "py": 'r[5] = 0xFFFFCAB4', "slot_py": None, "target": None, "cond": None},
    0x43e08: {"kind": 'reg', "py": 'r[2] = 0xFFFFCAB6', "slot_py": None, "target": None, "cond": None},
    0x43e0a: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFCAB6, 1))', "slot_py": None, "target": None, "cond": None},
    0x43e0c: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x43e0e: {"kind": "branch", "py": None, "slot_py": 'r[4] = s8(0x00)', "target": 0x43e18, "cond": 'notT'},
    0x43e12: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCAAF, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x43e14: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFCAB4, 1, r[4])', "target": 0x43e5c, "cond": 'always'},
    0x43e18: {"kind": 'mem', "py": 'r[7] = s8(_rdw(ram, 0xFFFFCAAF, 1))', "slot_py": None, "target": None, "cond": None},
    0x43e1a: {"kind": 'reg', "py": 'r[0] = 0x0007B3D9', "slot_py": None, "target": None, "cond": None},
    0x43e1c: {"kind": 'mem', "py": 'r[2] = s8(_rdw(ram, 0x0007B3D9, 1))', "slot_py": None, "target": None, "cond": None},
    0x43e1e: {"kind": 'reg', "py": 'r[3] = r[7] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x43e20: {"kind": 'reg', "py": 'r[1] = r[2] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x43e22: {"kind": 'reg', "py": 'T = 1 if s32(r[3]) >= s32(r[1]) else 0', "slot_py": None, "target": None, "cond": None},
    0x43e24: {"kind": "branch", "py": None, "slot_py": '', "target": 0x43e58, "cond": 'T'},
    0x43e28: {"kind": 'reg', "py": 'r[3] = 0x0007B3F0', "slot_py": None, "target": None, "cond": None},
    0x43e2a: {"kind": 'reg', "py": 'r[7] = (r[7] + s8(0x01)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x43e2c: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCAAF, 1, r[7])', "slot_py": None, "target": None, "cond": None},
    0x43e2e: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x0007B3F0, 4))', "slot_py": None, "target": None, "cond": None},
    0x43e30: {"kind": 'fpu', "py": 'T = 1 if fr[4] > fr[3] else 0', "slot_py": None, "target": None, "cond": None},
    0x43e32: {"kind": "branch", "py": None, "slot_py": '', "target": 0x43e54, "cond": 'notT'},
    0x43e36: {"kind": 'reg', "py": 'r[2] = 0x0007B3F4', "slot_py": None, "target": None, "cond": None},
    0x43e38: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0x0007B3F4, 4))', "slot_py": None, "target": None, "cond": None},
    0x43e3a: {"kind": 'fpu', "py": 'T = 1 if fr[2] > fr[4] else 0', "slot_py": None, "target": None, "cond": None},
    0x43e3c: {"kind": "branch", "py": None, "slot_py": '', "target": 0x43e54, "cond": 'notT'},
    0x43e40: {"kind": 'reg', "py": 'r[1] = 0x0007B3F8', "slot_py": None, "target": None, "cond": None},
    0x43e42: {"kind": 'fpu', "py": 'fr[1] = bits2f(_rdw(ram, 0x0007B3F8, 4))', "slot_py": None, "target": None, "cond": None},
    0x43e44: {"kind": 'reg', "py": 'r[3] = 0xFFFFAA10', "slot_py": None, "target": None, "cond": None},
    0x43e46: {"kind": 'fpu', "py": 'fr[0] = bits2f(_rdw(ram, 0xFFFFAA10, 4))', "slot_py": None, "target": None, "cond": None},
    0x43e48: {"kind": 'fpu', "py": 'T = 1 if fr[0] > fr[1] else 0', "slot_py": None, "target": None, "cond": None},
    0x43e4a: {"kind": "branch", "py": None, "slot_py": '', "target": 0x43e54, "cond": 'notT'},
    0x43e4e: {"kind": 'reg', "py": 'r[0] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x43e50: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFCAB4, 1, r[0])', "target": 0x43e5c, "cond": 'always'},
    0x43e54: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFCAB4, 1, r[4])', "target": 0x43e5c, "cond": 'always'},
    0x43e58: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCAAF, 1, r[2])', "slot_py": None, "target": None, "cond": None},
    0x43e5a: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCAB4, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x43e5c: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
