#!/usr/bin/env python3
"""Differential test for caller_F5B4 (entry 0xF5B4) — v8 ST caller (CFG), 40 bytes.
...
Run: python3 test_caller_F5B4.py
"""
...
CODE = {
    0xf5b4: {"kind": 'reg', "py": 'r[4] = 0xFFFFA4B2', "slot_py": None, "target": None, "cond": None},
    0xf5b6: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFA4B2, 1))', "slot_py": None, "target": None, "cond": None},
    0xf5b8: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0xf5ba: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0xf5bc: {"kind": "branch", "py": None, "slot_py": '', "target": 0xf5d4, "cond": 'notT'},
    0xf5c0: {"kind": 'reg', "py": 'r[4] = 0xFFFFA4B0', "slot_py": None, "target": None, "cond": None},
    0xf5c2: {"kind": 'mem', "py": 'r[2] = s8(_rdw(ram, r[4], 1))', "slot_py": None, "target": None, "cond": None},
    0xf5c4: {"kind": 'reg', "py": 'r[2] = r[2] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0xf5c6: {"kind": 'reg', "py": 'T = 1 if s32(r[2]) > 0 else 0', "slot_py": None, "target": None, "cond": None},
    0xf5c8: {"kind": "branch", "py": None, "slot_py": '', "target": 0xf5d8, "cond": 'notT'},
    0xf5cc: {"kind": 'mem', "py": 'r[2] = s8(_rdw(ram, r[4], 1))', "slot_py": None, "target": None, "cond": None},
    0xf5ce: {"kind": 'reg', "py": 'r[2] = (r[2] + s8(0xFF)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xf5d0: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, r[4], 1, r[2])', "target": 0xf5d8, "cond": 'always'},
    0xf5d4: {"kind": 'reg', "py": 'r[1] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0xf5d6: {"kind": 'mem', "py": '_wrw(ram, r[4], 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0xf5d8: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},
}
