#!/usr/bin/env python3
"""Differential test for crank_output_update (0x808E) — v3 lift + v4 FPU, 30 bytes.
...
Run from repo root: python3 c/tests/test_crank_output_update_808e.py
"""
...
ENTRY = 0x808E
RAW = bytes.fromhex("F3 9D C7 1A F4 08 D3 1A F3 4A D2 1A F2 4A D1 1A F4 8D D3 1A F1 4A F3 4A D2 1A 00 0B F2 3A")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFF9FFC
SPAN_END = 0x80AC
SENT = 0x80AC     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x808e: {"kind": 'fpu', "py": 'fr[3] = 1.0', "slot_py": None, "target": None, "cond": None},
    0x8090: {"kind": 'reg', "py": 'r[0] = 0x000080FC', "slot_py": None, "target": None, "cond": None},
    0x8092: {"kind": 'fpu', "py": 'fr[4] = bits2f(_rdw(ram, 0x000080FC, 4))', "slot_py": None, "target": None, "cond": None},
    0x8094: {"kind": 'reg', "py": 'r[3] = 0xFFFF9FF0', "slot_py": None, "target": None, "cond": None},
    0x8096: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFF9FF0, 4, f2bits(fr[4]))', "slot_py": None, "target": None, "cond": None},
    0x8098: {"kind": 'reg', "py": 'r[2] = 0xFFFF9FF4', "slot_py": None, "target": None, "cond": None},
    0x809a: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFF9FF4, 4, f2bits(fr[4]))', "slot_py": None, "target": None, "cond": None},
    0x809c: {"kind": 'reg', "py": 'r[1] = 0xFFFF9FF8', "slot_py": None, "target": None, "cond": None},
    0x809e: {"kind": 'fpu', "py": 'fr[4] = 0.0', "slot_py": None, "target": None, "cond": None},
    0x80a0: {"kind": 'reg', "py": 'r[3] = 0xFFFF9FFC', "slot_py": None, "target": None, "cond": None},
    0x80a2: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFF9FF8, 4, f2bits(fr[4]))', "slot_py": None, "target": None, "cond": None},
    0x80a4: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFF9FFC, 4, f2bits(fr[4]))', "slot_py": None, "target": None, "cond": None},
    0x80a6: {"kind": 'reg', "py": 'r[2] = 0xFFFF9FEC', "slot_py": None, "target": None, "cond": None},
    0x80a8: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFF9FEC, 4, f2bits(fr[3]))', "target": None, "cond": None},}
