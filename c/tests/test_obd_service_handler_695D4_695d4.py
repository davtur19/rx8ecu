#!/usr/bin/env python3
"""Differential test for obd_service_handler_695D4 (0x695D4) — pure straight-line lift, 8 bytes.
...
Run from repo root: python3 c/tests/test_obd_service_handler_695D4_695d4.py
"""
...
ENTRY = 0x695D4
RAW = bytes.fromhex("D0 02 64 4C 44 00 E3 00")
SEED = 42
N = 2000
