#!/usr/bin/env python3
"""Differential test for init_rotor_status_flags (0x1117A) — pure straight-line lift, 10 bytes.
...
Run from repo root: python3 c/tests/test_init_rotor_status_flags_1117a.py
"""
...
ENTRY = 0x1117A
RAW = bytes.fromhex("D5 33 64 53 66 53 76 58 34 62")
SEED = 42
N = 2000
...
def spec_mirror(r4, r5, r6, r7):
    ...
    r[6] = r[5]
    # 0x011180: op 0x7658
    r[6] = (r[6] + s8(0x58)) & 0xFFFFFFFF
    # 0x011182: op 0x3462
    T = 1 if r[4] >= r[6] else 0
