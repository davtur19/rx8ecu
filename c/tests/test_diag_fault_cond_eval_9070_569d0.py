#!/usr/bin/env python3
"""Differential test for diag_fault_cond_eval_9070 (0x569D0) — mem lift (RAM-only, straight-line), 8 bytes.
...
Run from repo root: python3 c/tests/test_diag_fault_cond_eval_9070_569d0.py
"""
...
ENTRY = 0x569D0
RAW = bytes.fromhex("73 02 62 93 1F 33 EB 10")
SEED = 42
N = 2000
...
def spec_mirror(r4, r5, r6, r7, ram, stack_top):
    ...
    # 0x0569D0: op 0x7302
    r[3] = (r[3] + s8(0x02)) & 0xFFFFFFFF
    # 0x0569D2: op 0x6293
    r[2] = r[9]
    # 0x0569D4: mov.l r3,@(0xC,r15)
    local[0x40C] = r[3]
    _wrw(ram, STACK_BASE + 0x40C, 4, r[3])
    # 0x0569D6: op 0xEB10
    r[11] = s8(0x10)
    r[15] = sp
