#!/usr/bin/env python3
"""Differential test for setOilPressureGaugeStatus (0x295FA) — v3 lift (branches + delay slots), 38 bytes.
...
Run from repo root: python3 c/tests/test_setOilPressureGaugeStatus_295fa.py
"""
...
ENTRY = 0x295FA
RAW = bytes.fromhex("D4 16 92 1B 63 20 23 38 8D 06 00 09 91 17 60 10 60 0C 88 01 8F 03 00 09 E2 01 A0 02 24 20 E1 00 24 10 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBC48
SPAN_END = 0x29620
SENT = 0x29620     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x295fa: {"kind": 'reg', "py": 'r[4] = 0xFFFFBAE8', "slot_py": None, "target": None, "cond": None},
    0x295fc: {"kind": 'reg', "py": 'r[2] = 0xFFFFBC48', "slot_py": None, "target": None, "cond": None},
    0x295fe: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFBC48, 1))', "slot_py": None, "target": None, "cond": None},
    0x29600: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x29602: {"kind": "branch", "py": None, "slot_py": '', "target": 0x29612, "cond": 'T'},
    0x29606: {"kind": 'reg', "py": 'r[1] = 0xFFFFB708', "slot_py": None, "target": None, "cond": None},
    0x29608: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFB708, 1))', "slot_py": None, "target": None, "cond": None},
    0x2960a: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x2960c: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x2960e: {"kind": "branch", "py": None, "slot_py": '', "target": 0x29618, "cond": 'notT'},
    0x29612: {"kind": 'reg', "py": 'r[2] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x29614: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFBAE8, 1, r[2])', "target": 0x2961c, "cond": 'always'},
    0x29618: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x2961a: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBAE8, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x2961c: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
