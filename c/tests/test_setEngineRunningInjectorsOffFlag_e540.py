#!/usr/bin/env python3
"""Differential test for setEngineRunningInjectorsOffFlag (0xE540) — v3 lift (branches + delay slots), 36 bytes.
...
Run from repo root: python3 c/tests/test_setEngineRunningInjectorsOffFlag_e540.py
"""
...
ENTRY = 0xE540
RAW = bytes.fromhex("94 10 92 10 63 20 23 38 8F 08 00 09 91 0C 60 10 20 08 8F 03 00 09 E2 01 A0 02 24 20 E1 00 24 10 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFA42C
SPAN_END = 0xE564
SENT = 0xE56A     # stop-sentinel, placed past the literal pool
...
CODE = {
    0xe540: {"kind": 'reg', "py": 'r[4] = 0xFFFFA42C', "slot_py": None, "target": None, "cond": None},
    0xe542: {"kind": 'reg', "py": 'r[2] = 0xFFFFA428', "slot_py": None, "target": None, "cond": None},
    0xe544: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFA428, 1))', "slot_py": None, "target": None, "cond": None},
    0xe546: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0xe548: {"kind": "branch", "py": None, "slot_py": '', "target": 0xe55c, "cond": 'notT'},
    0xe54c: {"kind": 'reg', "py": 'r[1] = 0xFFFFA41C', "slot_py": None, "target": None, "cond": None},
    0xe54e: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFA41C, 1))', "slot_py": None, "target": None, "cond": None},
    0xe550: {"kind": 'reg', "py": 'T = 1 if (r[0] & r[0]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0xe552: {"kind": "branch", "py": None, "slot_py": '', "target": 0xe55c, "cond": 'notT'},
    0xe556: {"kind": 'reg', "py": 'r[2] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0xe558: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFA42C, 1, r[2])', "target": 0xe560, "cond": 'always'},
    0xe55c: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0xe55e: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA42C, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0xe560: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
