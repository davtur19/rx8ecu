#!/usr/bin/env python3
"""Differential test for math_trochoid_58ba4 (0x58BA4) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_math_trochoid_58ba4_58ba4.py
"""
...
ENTRY = 0x58BA4
RAW = bytes.fromhex("D2 2B 4F 26 00 0B 22 30")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFD0EF
SPAN_END = 0x58BAC
SENT = 0x58BAC     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x58ba4: {"kind": 'reg', "py": 'r[2] = 0xFFFFD0EF', "slot_py": None, "target": None, "cond": None},
    0x58ba6: {"kind": 'mem', "py": 'pr = _rdw(ram, STACK_BASE + 0x400, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x58ba8: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFD0EF, 1, r[3])', "target": None, "cond": None},}
