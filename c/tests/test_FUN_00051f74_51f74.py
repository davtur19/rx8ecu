#!/usr/bin/env python3
"""Differential test for FUN_00051f74 (0x51F74) — pure straight-line lift, 8 bytes.
...
Run from repo root: python3 c/tests/test_FUN_00051f74_51f74.py
"""
...
ENTRY = 0x51F74
RAW = bytes.fromhex("00 07 D6 EC 00 07 D6 C4")
SEED = 42
N = 2000
