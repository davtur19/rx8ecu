#!/usr/bin/env python3
"""Differential test for data_copy_init_28E6C (0x28E6C) — v3 lift (branches + delay slots), 24 bytes.
...
Run from repo root: python3 c/tests/test_data_copy_init_28E6C_28e6c.py
"""
...
CODE = {
    0x28e6c: {"kind": 'reg', "py": 'r[2] = 0xFFFFBAC8', "slot_py": None, "target": None, "cond": None},
    0x28e6e: {"kind": 'reg', "py": 'r[3] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x28e70: {"kind": 'reg', "py": 'r[0] = 0x00075B28', "slot_py": None, "target": None, "cond": None},
    0x28e72: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBAC8, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x28e74: {"kind": 'mem', "py": 'r[1] = s8(_rdw(ram, 0x00075B28, 1))', "slot_py": None, "target": None, "cond": None},
    0x28e76: {"kind": 'reg', "py": 'r[3] = 0xFFFFBAC6', "slot_py": None, "target": None, "cond": None},
    0x28e78: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBAC6, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x28e7a: {"kind": 'reg', "py": 'r[1] = 0x00075B2A', "slot_py": None, "target": None, "cond": None},
    0x28e7c: {"kind": 'reg', "py": 'r[3] = 0xFFFFBAC7', "slot_py": None, "target": None, "cond": None},
    0x28e7e: {"kind": 'mem', "py": 'r[2] = s8(_rdw(ram, 0x00075B2A, 1))', "slot_py": None, "target": None, "cond": None},
    0x28e80: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBAC7, 1, r[2])', "target": None, "cond": None},}
