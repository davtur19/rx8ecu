#!/usr/bin/env python3
"""Differential test for rotor_fuel_calc_dispatcher (0xB57A) — v3 lift (branches + delay slots), 38 bytes.
...
Run from repo root: python3 c/tests/test_rotor_fuel_calc_dispatcher_b57a.py
"""
...
ENTRY = 0xB57A
RAW = bytes.fromhex("20 19 CB 10 24 01 D3 34 23 D0 D2 34 22 D0 D1 34 21 D0 7F 0C 4F 26 68 F6 69 F6 6A F6 6B F6 6C F6 6D F6 00 0B 6E F6")
SEED = 0
N = 2000
MAXSTEPS = 100000
STACK_BASE = 0xFFFFD000
STACK_TOP = STACK_BASE + 0x400
STACK_OFFS = (0x40C, 0x410, 0x414, 0x418, 0x41C, 0x420, 0x424, 0x428)
SEED_OFFS = (0x40C,)   # lds.l pr/macl/mach slots seeded with the return sentinel
RAM_MIN = 0xFFFFA228
RAM_MAX = 0xFFFFA322
SPAN_END = 0xB5A0
SENT = 0xB5A0     # stop-sentinel, placed past the literal pool
...
CODE = {
    0xb57a: {"kind": 'reg', "py": 'r[0] = (r[0] & r[1]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xb57c: {"kind": 'reg', "py": 'r[0] = (r[0] | 0x10) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xb57e: {"kind": 'mem', "py": '_wrw(ram, r[4], 2, r[0])', "slot_py": None, "target": None, "cond": None},
    0xb580: {"kind": 'reg', "py": 'r[3] = 0xFFFFA322', "slot_py": None, "target": None, "cond": None},
    0xb582: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA322, 1, r[13])', "slot_py": None, "target": None, "cond": None},
    0xb584: {"kind": 'reg', "py": 'r[2] = 0xFFFFA320', "slot_py": None, "target": None, "cond": None},
    0xb586: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA320, 1, r[13])', "slot_py": None, "target": None, "cond": None},
    0xb588: {"kind": 'reg', "py": 'r[1] = 0xFFFFA228', "slot_py": None, "target": None, "cond": None},
    0xb58a: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA228, 1, r[13])', "slot_py": None, "target": None, "cond": None},
    0xb58c: {"kind": 'reg', "py": 'r[15] = (r[15] + s8(0x0C)) & 0xFFFFFFFF\nsp = (sp + s8(0x0C)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xb58e: {"kind": 'mem', "py": 'pr = _rdw(ram, STACK_BASE + 0x40C, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xb590: {"kind": 'mem', "py": 'r[8] = _rdw(ram, STACK_BASE + 0x410, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xb592: {"kind": 'mem', "py": 'r[9] = _rdw(ram, STACK_BASE + 0x414, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xb594: {"kind": 'mem', "py": 'r[10] = _rdw(ram, STACK_BASE + 0x418, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xb596: {"kind": 'mem', "py": 'r[11] = _rdw(ram, STACK_BASE + 0x41C, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xb598: {"kind": 'mem', "py": 'r[12] = _rdw(ram, STACK_BASE + 0x420, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xb59a: {"kind": 'mem', "py": 'r[13] = _rdw(ram, STACK_BASE + 0x424, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xb59c: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, STACK_BASE + 0x428, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},}
