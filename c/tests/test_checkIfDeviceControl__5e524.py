#!/usr/bin/env python3
"""Differential test for checkIfDeviceControl_ (0x5E524) — v3 lift (branches + delay slots), 36 bytes.
...
Run from repo root: python3 c/tests/test_checkIfDeviceControl__5e524.py
"""
...
ENTRY = 0x5E524
RAW = bytes.fromhex("D2 07 E4 00 91 0A 63 21 60 10 24 3B 60 0C 88 01 8F 01 00 09 D4 03 92 02 00 0B 22 41 CF E2 D1 C8 00 07 C2 C8")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFD1C8
SPAN_END = 0x5E548
SENT = 0x5E54C     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x5e524: {"kind": 'reg', "py": 'r[2] = 0x0007C2C8', "slot_py": None, "target": None, "cond": None},
    0x5e526: {"kind": 'reg', "py": 'r[4] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x5e528: {"kind": 'reg', "py": 'r[1] = 0xFFFFCFE2', "slot_py": None, "target": None, "cond": None},
    0x5e52a: {"kind": 'mem', "py": 'r[3] = s16(_rdw(ram, 0x0007C2C8, 2))', "slot_py": None, "target": None, "cond": None},
    0x5e52c: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCFE2, 1))', "slot_py": None, "target": None, "cond": None},
    0x5e52e: {"kind": 'reg', "py": 'r[4] = (r[4] | r[3]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x5e530: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x5e532: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x5e534: {"kind": "branch", "py": None, "slot_py": '', "target": 0x5e53a, "cond": 'notT'},
    0x5e538: {"kind": 'reg', "py": 'r[4] = 0x0000FFFF', "slot_py": None, "target": None, "cond": None},
    0x5e53a: {"kind": 'reg', "py": 'r[2] = 0xFFFFD1C8', "slot_py": None, "target": None, "cond": None},
    0x5e53c: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFD1C8, 2, r[4])', "target": None, "cond": None},}
