#!/usr/bin/env python3
"""Differential test for fault_d054_counter_load (0x578C6) — v3 lift (branches + delay slots), 56 bytes.
...
Run from repo root: python3 c/tests/test_fault_d054_counter_load_578c6.py
"""
...
ENTRY = 0x578C6
RAW = bytes.fromhex("97 26 95 26 92 23 63 20 23 38 8F 02 E4 00 A0 0C 25 41 D6 10 60 60 60 0C 88 01 8F 06 00 09 26 40 E1 01 D0 0E 27 10 63 01 25 31 62 51 22 28 8F 01 00 09 27 40 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFD057
SPAN_END = 0x578FE
SENT = 0x578FE     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x578c6: {"kind": 'reg', "py": 'r[7] = 0xFFFFD056', "slot_py": None, "target": None, "cond": None},
    0x578c8: {"kind": 'reg', "py": 'r[5] = 0xFFFFD054', "slot_py": None, "target": None, "cond": None},
    0x578ca: {"kind": 'reg', "py": 'r[2] = 0xFFFFA41C', "slot_py": None, "target": None, "cond": None},
    0x578cc: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFA41C, 1))', "slot_py": None, "target": None, "cond": None},
    0x578ce: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x578d0: {"kind": "branch", "py": None, "slot_py": 'r[4] = s8(0x00)', "target": 0x578d8, "cond": 'notT'},
    0x578d4: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFD054, 2, r[4])', "target": 0x578f0, "cond": 'always'},
    0x578d8: {"kind": 'reg', "py": 'r[6] = 0xFFFFD057', "slot_py": None, "target": None, "cond": None},
    0x578da: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFD057, 1))', "slot_py": None, "target": None, "cond": None},
    0x578dc: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x578de: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x578e0: {"kind": "branch", "py": None, "slot_py": '', "target": 0x578f0, "cond": 'notT'},
    0x578e4: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD057, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x578e6: {"kind": 'reg', "py": 'r[1] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x578e8: {"kind": 'reg', "py": 'r[0] = 0x0007C2C0', "slot_py": None, "target": None, "cond": None},
    0x578ea: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD056, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x578ec: {"kind": 'mem', "py": 'r[3] = s16(_rdw(ram, 0x0007C2C0, 2))', "slot_py": None, "target": None, "cond": None},
    0x578ee: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD054, 2, r[3])', "slot_py": None, "target": None, "cond": None},
    0x578f0: {"kind": 'mem', "py": 'r[2] = s16(_rdw(ram, r[5], 2))', "slot_py": None, "target": None, "cond": None},
    0x578f2: {"kind": 'reg', "py": 'T = 1 if (r[2] & r[2]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x578f4: {"kind": "branch", "py": None, "slot_py": '', "target": 0x578fa, "cond": 'notT'},
    0x578f8: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD056, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x578fa: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
