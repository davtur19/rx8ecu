#!/usr/bin/env python3
"""Differential test for conditional_flag_set_sensor_state_2EF0C (0x2EF0C) — v3 lift (branches + delay slots), 54 bytes.
...
Run from repo root: python3 c/tests/test_conditional_flag_set_sensor_state_2EF0C_2ef0c.py
"""
