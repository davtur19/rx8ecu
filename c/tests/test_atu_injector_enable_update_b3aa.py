#!/usr/bin/env python3
"""Differential test for atu_injector_enable_update (0xB3AA) — v3 lift (branches + delay slots), 40 bytes.
...
Run from repo root: python3 c/tests/test_atu_injector_enable_update_b3aa.py
"""
...
ENTRY = 0xB3AA
RAW = bytes.fromhex("D2 13 63 20 23 38 8F 0B 00 09 D0 11 91 14 63 11 20 31 D2 10 71 E0 63 11 22 31 D0 0F E3 01 20 30 E2 00 D1 0E 00 0B 21 20")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFF836
SPAN_END = 0xB3D2
SENT = 0xB3D2     # stop-sentinel, placed past the literal pool
...
CODE = {
    0xb3aa: {"kind": 'reg', "py": 'r[2] = 0xFFFFA205', "slot_py": None, "target": None, "cond": None},
    0xb3ac: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFA205, 1))', "slot_py": None, "target": None, "cond": None},
    0xb3ae: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0xb3b0: {"kind": "branch", "py": None, "slot_py": '', "target": 0xb3ca, "cond": 'notT'},
    0xb3b4: {"kind": 'reg', "py": 'r[0] = 0xFFFFA1FC', "slot_py": None, "target": None, "cond": None},
    0xb3b6: {"kind": 'reg', "py": 'r[1] = 0xFFFFF836', "slot_py": None, "target": None, "cond": None},
    0xb3b8: {"kind": 'mem', "py": 'r[3] = s16(_rdw(ram, 0xFFFFF836, 2))', "slot_py": None, "target": None, "cond": None},
    0xb3ba: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA1FC, 2, r[3])', "slot_py": None, "target": None, "cond": None},
    0xb3bc: {"kind": 'reg', "py": 'r[2] = 0xFFFFA200', "slot_py": None, "target": None, "cond": None},
    0xb3be: {"kind": 'reg', "py": 'r[1] = (r[1] + s8(0xE0)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xb3c0: {"kind": 'mem', "py": 'r[3] = s16(_rdw(ram, 0xFFFFF816, 2))', "slot_py": None, "target": None, "cond": None},
    0xb3c2: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA200, 2, r[3])', "slot_py": None, "target": None, "cond": None},
    0xb3c4: {"kind": 'reg', "py": 'r[0] = 0xFFFFA202', "slot_py": None, "target": None, "cond": None},
    0xb3c6: {"kind": 'reg', "py": 'r[3] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0xb3c8: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA202, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0xb3ca: {"kind": 'reg', "py": 'r[2] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0xb3cc: {"kind": 'reg', "py": 'r[1] = 0xFFFFA207', "slot_py": None, "target": None, "cond": None},
    0xb3ce: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFA207, 1, r[2])', "target": None, "cond": None},}
