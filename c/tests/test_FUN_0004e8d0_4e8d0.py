#!/usr/bin/env python3
"""Differential test for FUN_0004e8d0 (0x4E8D0) — v3 lift (branches + delay slots), 64 bytes.
...
Run from repo root: python3 c/tests/test_FUN_0004e8d0_4e8d0.py
"""
...
ENTRY = 0x4E8D0
RAW = bytes.fromhex("94 4E 92 4E 90 4E 63 21 61 01 33 16 8F 14 00 09 93 49 61 30 21 18 8F 0F 00 09 92 45 60 20 60 0C 88 01 8D 06 00 09 91 40 60 10 60 0C 88 01 8F 03 00 09 E2 01 A0 02 24 20 E1 00 24 10 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCEBF
SPAN_END = 0x4E910
SENT = 0x4E910     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x4e8d0: {"kind": 'reg', "py": 'r[4] = 0xFFFFCEBF', "slot_py": None, "target": None, "cond": None},
    0x4e8d2: {"kind": 'reg', "py": 'r[2] = 0xFFFFCDA6', "slot_py": None, "target": None, "cond": None},
    0x4e8d4: {"kind": 'reg', "py": 'r[0] = 0xFFFFCDA4', "slot_py": None, "target": None, "cond": None},
    0x4e8d6: {"kind": 'mem', "py": 'r[3] = s16(_rdw(ram, 0xFFFFCDA6, 2))', "slot_py": None, "target": None, "cond": None},
    0x4e8d8: {"kind": 'mem', "py": 'r[1] = s16(_rdw(ram, 0xFFFFCDA4, 2))', "slot_py": None, "target": None, "cond": None},
    0x4e8da: {"kind": 'reg', "py": 'T = 1 if (r[3] & 0xFFFFFFFF) > (r[1] & 0xFFFFFFFF) else 0', "slot_py": None, "target": None, "cond": None},
    0x4e8dc: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4e908, "cond": 'notT'},
    0x4e8e0: {"kind": 'reg', "py": 'r[3] = 0xFFFFCE00', "slot_py": None, "target": None, "cond": None},
    0x4e8e2: {"kind": 'mem', "py": 'r[1] = s8(_rdw(ram, 0xFFFFCE00, 1))', "slot_py": None, "target": None, "cond": None},
    0x4e8e4: {"kind": 'reg', "py": 'T = 1 if (r[1] & r[1]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x4e8e6: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4e908, "cond": 'notT'},
    0x4e8ea: {"kind": 'reg', "py": 'r[2] = 0xFFFFCEBC', "slot_py": None, "target": None, "cond": None},
    0x4e8ec: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCEBC, 1))', "slot_py": None, "target": None, "cond": None},
    0x4e8ee: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x4e8f0: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x4e8f2: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4e902, "cond": 'T'},
    0x4e8f6: {"kind": 'reg', "py": 'r[1] = 0xFFFFCD7C', "slot_py": None, "target": None, "cond": None},
    0x4e8f8: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCD7C, 1))', "slot_py": None, "target": None, "cond": None},
    0x4e8fa: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x4e8fc: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x4e8fe: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4e908, "cond": 'notT'},
    0x4e902: {"kind": 'reg', "py": 'r[2] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x4e904: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFCEBF, 1, r[2])', "target": 0x4e90c, "cond": 'always'},
    0x4e908: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x4e90a: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCEBF, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x4e90c: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
