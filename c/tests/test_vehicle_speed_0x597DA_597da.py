#!/usr/bin/env python3
"""Differential test for vehicle_speed_0x597DA (0x597DA) — v3 lift (branches + delay slots), 34 bytes.
...
Run from repo root: python3 c/tests/test_vehicle_speed_0x597DA_597da.py
"""
...
ENTRY = 0x597DA
RAW = bytes.fromhex("92 2A D1 20 63 20 D2 20 21 30 93 26 60 30 D3 1F 22 00 90 23 61 00 23 10 91 21 D3 1D 62 10 00 0B 23 20")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    0x597da: {"kind": 'reg', "py": 'r[2] = 0xFFFFC570', "slot_py": None, "target": None, "cond": None},
    0x597dc: {"kind": 'reg', "py": 'r[1] = 0xFFFFD278', "slot_py": None, "target": None, "cond": None},
    0x597de: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFC570, 1))', "slot_py": None, "target": None, "cond": None},
    0x597e0: {"kind": 'reg', "py": 'r[2] = 0xFFFFD279', "slot_py": None, "target": None, "cond": None},
    0x597e2: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD278, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x597e4: {"kind": 'reg', "py": 'r[3] = 0xFFFFC571', "slot_py": None, "target": None, "cond": None},
    0x597e6: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFC571, 1))', "slot_py": None, "target": None, "cond": None},
    0x597e8: {"kind": 'reg', "py": 'r[3] = 0xFFFFD27A', "slot_py": None, "target": None, "cond": None},
    0x597ea: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD279, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x597ec: {"kind": 'reg', "py": 'r[0] = 0xFFFFC575', "slot_py": None, "target": None, "cond": None},
    0x597ee: {"kind": 'mem', "py": 'r[1] = s8(_rdw(ram, 0xFFFFC575, 1))', "slot_py": None, "target": None, "cond": None},
    0x597f0: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD27A, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x597f2: {"kind": 'reg', "py": 'r[1] = 0xFFFFC576', "slot_py": None, "target": None, "cond": None},
    0x597f4: {"kind": 'reg', "py": 'r[3] = 0xFFFFD27B', "slot_py": None, "target": None, "cond": None},
    0x597f6: {"kind": 'mem', "py": 'r[2] = s8(_rdw(ram, 0xFFFFC576, 1))', "slot_py": None, "target": None, "cond": None},
    0x597f8: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFD27B, 1, r[2])', "target": None, "cond": None},}
