#!/usr/bin/env python3
"""Differential test for rtos_dispatch_297a6 (0x297A6) — v3 lift (branches + delay slots), 28 bytes.
...
Run from repo root: python3 c/tests/test_rtos_dispatch_297a6_297a6.py
"""
...
ENTRY = 0x297A6
RAW = bytes.fromhex("8D 03 00 09 E1 3E A0 07 25 11 64 51 61 4D 41 15 8F 02 00 09 34 6C 25 41 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    ...
    0x297ac: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, r[5], 2, r[1])', "target": 0x297be, "cond": 'always'},
    ...
    0x297bc: {"kind": 'mem', "py": '_wrw(ram, r[5], 2, r[4])', "slot_py": None, "target": None, "cond": None},
