#!/usr/bin/env python3
"""Differential test for spi_set_clk_low_wait (0x9DE) — v3 lift (branches + delay slots), 30 bytes.
...
Run from repo root: python3 c/tests/test_spi_set_clk_low_wait_9de.py
"""
...
CODE = {
    0x9de: {"kind": 'reg', "py": 'r[6] = s8(0x08)', "slot_py": None, "target": None, "cond": None},
    0x9e0: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, r[4], 1))', "slot_py": None, "target": None, "cond": None},
    0x9e2: {"kind": 'reg', "py": 'r[0] = (r[0] & 0xFE) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x9e4: {"kind": 'mem', "py": '_wrw(ram, r[4], 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x9e6: {"kind": 'reg', "py": 'r[4] = 0x00000FA0', "slot_py": None, "target": None, "cond": None},
    0x9e8: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, r[5], 1))', "slot_py": None, "target": None, "cond": None},
    0x9ea: {"kind": 'reg', "py": 'r[3] = r[3] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x9ec: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[6]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x9ee: {"kind": "branch", "py": None, "slot_py": None, "target": 0x9f8, "cond": 'T'},
    0x9f0: {"kind": 'reg', "py": 'r[4] = (r[4] + s8(0xFF)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x9f2: {"kind": 'reg', "py": 'r[3] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x9f4: {"kind": 'reg', "py": 'T = 1 if r[4] > r[3] else 0', "slot_py": None, "target": None, "cond": None},
    0x9f6: {"kind": "branch", "py": None, "slot_py": None, "target": 0x9e8, "cond": 'T'},
    0x9f8: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
