#!/usr/bin/env python3
"""Differential test for isr_state_2b88a (0x2B88A) — v3 lift (branches + delay slots), 38 bytes.
...
Run from repo root: python3 c/tests/test_isr_state_2b88a_2b88a.py
"""
...
CODE = {
    0x2b88a: {"kind": 'reg', "py": 'r[4] = 0xFFFFBBCD', "slot_py": None, "target": None, "cond": None},
    0x2b88c: {"kind": 'reg', "py": 'r[3] = 0xFFFFA4A6', "slot_py": None, "target": None, "cond": None},
    0x2b88e: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFA4A6, 1))', "slot_py": None, "target": None, "cond": None},
    0x2b890: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x2b892: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x2b894: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2b8a8, "cond": 'notT'},
    0x2b898: {"kind": 'reg', "py": 'r[2] = 0x00075B42', "slot_py": None, "target": None, "cond": None},
    0x2b89a: {"kind": 'mem', "py": 'r[1] = s8(_rdw(ram, 0x00075B42, 1))', "slot_py": None, "target": None, "cond": None},
    0x2b89c: {"kind": 'reg', "py": 'T = 1 if (r[1] & r[1]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x2b89e: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2b8a8, "cond": 'T'},
    0x2b8a2: {"kind": 'reg', "py": 'r[3] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x2b8a4: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFBBCD, 1, r[3])', "target": 0x2b8ac, "cond": 'always'},
    0x2b8a8: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x2b8aa: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBBCD, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x2b8ac: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
