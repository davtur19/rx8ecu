#!/usr/bin/env python3
"""Differential test for can_message_setup_dispatcher_33974 (0x33974) — v3 lift (branches + delay slots), 14 bytes.
...
Run from repo root: python3 c/tests/test_can_message_setup_dispatcher_33974_33974.py
"""
...
ENTRY = 0x33974
RAW = bytes.fromhex("90 2C 00 0B 20 20 E3 00 91 29 00 0B 21 30")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFC071
SPAN_END = 0x33982
SENT = 0x33982     # stop-sentinel, placed past the literal pool
...
CODE = {
    ...
    0x3397a: {"kind": 'reg', "py": 'r[3] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x3397c: {"kind": 'reg', "py": 'r[1] = 0xFFFFC070', "slot_py": None, "target": None, "cond": None},
    0x3397e: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFC070, 1, r[3])', "target": None, "cond": None},}
