#!/usr/bin/env python3
"""Differential test for caller_32D86 (entry 0x32D86) — v8 ST caller (CFG), 40 bytes.
...
Run: python3 test_caller_32D86.py
"""
...
CODE = {
    0x32d86: {"kind": 'mem', "py": 'local[0x3FC] = r[14]\n_wrw(ram, STACK_BASE + 0x3FC, 4, r[14])\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x32d88: {"kind": 'st', "py": 'local[0x3F8] = pr\n_wrw(ram, STACK_BASE + 0x3F8, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x32d8a: {"kind": 'reg', "py": 'r[14] = 0xFFFFBFF2', "slot_py": None, "target": None, "cond": None},
    0x32d8c: {"kind": 'reg', "py": 'r[3] = 0xFFFFBFF3', "slot_py": None, "target": None, "cond": None},
    0x32d8e: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFBFF3, 1))', "slot_py": None, "target": None, "cond": None},
    0x32d90: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x32d92: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x32d94: {"kind": "branch", "py": None, "slot_py": '', "target": 0x32d9e, "cond": 'notT'},
    0x32d98: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x32d9a: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFBFF2, 1, r[1])', "target": 0x32da8, "cond": 'always'},
    0x32d9e: {"kind": 'reg', "py": 'r[5] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x32da0: {"kind": 'reg', "py": 'r[1] = 0x00002478', "slot_py": None, "target": None, "cond": None},
    0x32da2: {"kind": "call", "py": None, "slot_py": 'r[4] = s8(_rdw(ram, 0xFFFFBFF2, 1))', "target": 0x2478, "ret_pc": 0x32da6, "set_pr": True, "cond": None},
    0x32da6: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBFF2, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x32da8: {"kind": 'st', "py": 'pr = _rdw(ram, STACK_BASE + 0x3F8, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x32daa: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, STACK_BASE + 0x3FC, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},
