#!/usr/bin/env python3
"""Differential test for FUN_0004f764 (0x4F764) — v3 lift (branches + delay slots), 20 bytes.
...
Run from repo root: python3 c/tests/test_FUN_0004f764_4f764.py
"""
...
RAM_MAX = None
SPAN_END = 0x4F778
SENT = 0x4F778     # stop-sentinel, placed past the literal pool
...
CODE = {
    ...
    0x4f76c: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, r[4], 1, r[3])', "target": 0x4f774, "cond": 'always'},
    0x4f770: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x4f772: {"kind": 'mem', "py": '_wrw(ram, r[4], 1, r[1])', "slot_py": None, "target": None, "cond": None},
