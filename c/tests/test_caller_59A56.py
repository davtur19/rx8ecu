#!/usr/bin/env python3
"""Differential test for caller_59A56 (entry 0x59A56) — v8 ST caller (CFG), 48 bytes.
...
Run: python3 test_caller_59A56.py
"""
...
STACK_OFFS = (0x3F0, 0x3F4, 0x3F8, 0x3FC, 0x400)
RAM_MIN = None
RAM_MAX = None
PRET = 0xEEEE0000
JTABLES = []
...
CODE = {
    0x59a56: {"kind": 'reg', "py": 'r[14] = r[4]', "slot_py": None, "target": None, "cond": None},
    0x59a58: {"kind": 'mem', "py": 'local[0x3FC] = r[13]\n_wrw(ram, STACK_BASE + 0x3FC, 4, r[13])\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x59a5a: {"kind": 'mem', "py": 'local[0x3F8] = r[12]\n_wrw(ram, STACK_BASE + 0x3F8, 4, r[12])\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x59a5c: {"kind": 'mem', "py": 'local[0x3F4] = r[11]\n_wrw(ram, STACK_BASE + 0x3F4, 4, r[11])\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x59a5e: {"kind": 'st', "py": 'local[0x3F0] = pr\n_wrw(ram, STACK_BASE + 0x3F0, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x59a60: {"kind": 'reg', "py": 'r[12] = 0x0003EE68', "slot_py": None, "target": None, "cond": None},
    0x59a62: {"kind": "call", "py": None, "slot_py": 'r[4] = (r[4] + s8(0x0C)) & 0xFFFFFFFF', "target": 0x3ee68, "ret_pc": 0x59a66, "set_pr": True, "cond": None},
    0x59a66: {"kind": 'reg', "py": 'r[11] = s8(0x03)', "slot_py": None, "target": None, "cond": None},
    0x59a68: {"kind": 'reg', "py": 'r[13] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x59a6a: {"kind": 'reg', "py": 'r[5] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x59a6c: {"kind": "call", "py": None, "slot_py": 'r[4] = r[14]', "target": 0x3ee68, "ret_pc": 0x59a70, "set_pr": True, "cond": None},
    0x59a70: {"kind": 'reg', "py": 'r[13] = (r[13] + s8(0x01)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x59a72: {"kind": 'reg', "py": 'r[3] = r[13] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x59a74: {"kind": 'reg', "py": 'T = 1 if s32(r[3]) >= s32(r[11]) else 0', "slot_py": None, "target": None, "cond": None},
    0x59a76: {"kind": "branch", "py": None, "slot_py": 'r[14] = (r[14] + s8(0x04)) & 0xFFFFFFFF', "target": 0x59a6a, "cond": 'notT'},
    0x59a7a: {"kind": 'st', "py": 'pr = _rdw(ram, STACK_BASE + 0x3F0, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x59a7c: {"kind": 'mem', "py": 'r[11] = _rdw(ram, STACK_BASE + 0x3F4, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x59a7e: {"kind": 'mem', "py": 'r[12] = _rdw(ram, STACK_BASE + 0x3F8, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x59a80: {"kind": 'mem', "py": 'r[13] = _rdw(ram, STACK_BASE + 0x3FC, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x59a82: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, STACK_BASE + 0x400, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},
