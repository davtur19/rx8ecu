#!/usr/bin/env python3
"""Differential test for utility_bitfield_check_2C7A6 (0x2C7A6) — v3 lift (branches + delay slots), 10 bytes.
...
Run from repo root: python3 c/tests/test_utility_bitfield_check_2C7A6_2c7a6.py
"""
...
CODE = {
    0x2c7a6: {"kind": 'reg', "py": 'r[3] = 0xFFFFBC64', "slot_py": None, "target": None, "cond": None},
    0x2c7a8: {"kind": 'reg', "py": 'r[1] = 0xFFFFBC65', "slot_py": None, "target": None, "cond": None},
    0x2c7aa: {"kind": 'mem', "py": 'r[2] = s8(_rdw(ram, 0xFFFFBC64, 1))', "slot_py": None, "target": None, "cond": None},
    0x2c7ac: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBC65, 1, r[2])', "target": None, "cond": None},}
