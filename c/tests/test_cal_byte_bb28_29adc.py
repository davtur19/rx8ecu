#!/usr/bin/env python3
"""Differential test for cal_byte_bb28 (0x29ADC) — v3 lift (branches + delay slots), 10 bytes.
...
Run from repo root: python3 c/tests/test_cal_byte_bb28_29adc.py
"""
...
ENTRY = 0x29ADC
RAW = bytes.fromhex("D2 1A 63 20 91 1D 00 0B 21 30")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBB28
SPAN_END = 0x29AE6
SENT = 0x29AE6     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x29adc: {"kind": 'reg', "py": 'r[2] = 0x0006D486', "slot_py": None, "target": None, "cond": None},
    0x29ade: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0x0006D486, 1))', "slot_py": None, "target": None, "cond": None},
    0x29ae0: {"kind": 'reg', "py": 'r[1] = 0xFFFFBB28', "slot_py": None, "target": None, "cond": None},
    0x29ae2: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBB28, 1, r[3])', "target": None, "cond": None},}
