#!/usr/bin/env python3
"""Differential test for byte_a3b0_to_b69c (0x272A6) — v3 lift (branches + delay slots), 12 bytes.
...
Run from repo root: python3 c/tests/test_byte_a3b0_to_b69c_272a6.py
"""
...
ENTRY = 0x272A6
RAW = bytes.fromhex("D1 20 92 38 63 10 63 3C 00 0B 22 31")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFB69C
SPAN_END = 0x272B2
SENT = 0x272B2     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x272a6: {"kind": 'reg', "py": 'r[1] = 0xFFFFA3B0', "slot_py": None, "target": None, "cond": None},
    0x272a8: {"kind": 'reg', "py": 'r[2] = 0xFFFFB69C', "slot_py": None, "target": None, "cond": None},
    0x272aa: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFA3B0, 1))', "slot_py": None, "target": None, "cond": None},
    0x272ac: {"kind": 'reg', "py": 'r[3] = r[3] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x272ae: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFB69C, 2, r[3])', "target": None, "cond": None},}
