#!/usr/bin/env python3
"""Differential test for caller_45DF0 (entry 0x45DF0) — v8 ST caller (CFG), 28 bytes.
...
Run: python3 test_caller_45DF0.py
"""
...
CODE = {
    0x45df0: {"kind": 'st', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x45df2: {"kind": 'reg', "py": 'r[4] = 0xFFFF876C', "slot_py": None, "target": None, "cond": None},
    0x45df4: {"kind": 'reg', "py": 'r[3] = 0x0003E208', "slot_py": None, "target": None, "cond": None},
    0x45df6: {"kind": "call", "py": None, "slot_py": 'r[5] = s8(0x00)', "target": 0x3e208, "ret_pc": 0x45dfa, "set_pr": True, "cond": None},
    0x45dfa: {"kind": 'reg', "py": 'r[4] = 0xFFFF8768', "slot_py": None, "target": None, "cond": None},
    0x45dfc: {"kind": 'reg', "py": 'r[2] = 0x0003E1F8', "slot_py": None, "target": None, "cond": None},
    0x45dfe: {"kind": "call", "py": None, "slot_py": 'r[5] = s8(0x00)', "target": 0x3e1f8, "ret_pc": 0x45e02, "set_pr": True, "cond": None},
    0x45e02: {"kind": 'reg', "py": 'r[5] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x45e04: {"kind": 'reg', "py": 'r[4] = 0xFFFF876A', "slot_py": None, "target": None, "cond": None},
    0x45e06: {"kind": 'reg', "py": 'r[3] = 0x0003E1F8', "slot_py": None, "target": None, "cond": None},
    0x45e08: {"kind": "call", "py": None, "slot_py": 'pr = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": 0x3e1f8, "ret_pc": 0x45e0c, "set_pr": False, "cond": None},
