#!/usr/bin/env python3
"""Differential test for call-composition caller_490F8 (entry 0x490F8) — v7 ST caller + callee lib, flattened CODE with nested returns.
...
Run: python3 /home/davide/ailocal/rx8ecu/c/tests/test_caller_490F8.py
"""
...
CODE = {
    0x490f8: {"kind": 'reg', "py": 'r[4] = 0xFFFF878A', "slot_py": None, "target": None, "cond": None},
    0x490fa: {"kind": 'reg', "py": 'r[3] = 0x0003EE58', "slot_py": None, "target": None, "cond": None},
    0x490fc: {"kind": "call", "py": None, "slot_py": 'r[5] = s8(0x00)', "target": 0x3ee58, "ret_pc": 0x49100, "set_pr": False, "cond": None},
