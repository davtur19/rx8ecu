#!/usr/bin/env python3
"""Differential test for FUN_0005a3de (0x5A3DE) — pure straight-line lift, 12 bytes.
...
Run from repo root: python3 c/tests/test_FUN_0005a3de_5a3de.py
"""
...
ENTRY = 0x5A3DE
RAW = bytes.fromhex("D2 9B D2 9C D2 8D D2 98 D2 93 D2 90")
SEED = 42
N = 2000
