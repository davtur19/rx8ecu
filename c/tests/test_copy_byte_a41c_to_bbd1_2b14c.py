#!/usr/bin/env python3
"""Differential test for copy_byte_a41c_to_bbd1 (0x2B14C) — v3 lift (branches + delay slots), 10 bytes.
...
Run from repo root: python3 c/tests/test_copy_byte_a41c_to_bbd1_2b14c.py
"""
...
ENTRY = 0x2B14C
RAW = bytes.fromhex("92 71 63 20 D1 3E 00 0B 21 30")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBBD1
SPAN_END = 0x2B156
SENT = 0x2B156     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x2b14c: {"kind": 'reg', "py": 'r[2] = 0xFFFFA41C', "slot_py": None, "target": None, "cond": None},
    0x2b14e: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFA41C, 1))', "slot_py": None, "target": None, "cond": None},
    0x2b150: {"kind": 'reg', "py": 'r[1] = 0xFFFFBBD1', "slot_py": None, "target": None, "cond": None},
    0x2b152: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBBD1, 1, r[3])', "target": None, "cond": None},}
