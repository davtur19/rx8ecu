#!/usr/bin/env python3
"""Differential test for throttleLiftInitStuff (0x4315C) — v3 lift + v4 FPU, 12 bytes.
...
Run from repo root: python3 c/tests/test_throttleLiftInitStuff_4315c.py
"""
...
RAM_MAX = 0xFFFFC9A8
SPAN_END = 0x43168
SENT = 0x43168     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x4315c: {"kind": 'reg', "py": 'r[3] = 0xFFFFC9A8', "slot_py": None, "target": None, "cond": None},
    0x4315e: {"kind": 'fpu', "py": 'fr[4] = 0.0', "slot_py": None, "target": None, "cond": None},
    0x43160: {"kind": 'reg', "py": 'r[2] = 0xFFFFC9A0', "slot_py": None, "target": None, "cond": None},
    0x43162: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFC9A8, 4, f2bits(fr[4]))', "slot_py": None, "target": None, "cond": None},
    0x43164: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFC9A0, 4, f2bits(fr[4]))', "target": None, "cond": None},}
