#!/usr/bin/env python3
"""Differential test for caller_61AAA (entry 0x61AAA) — v8 ST caller (CFG), 36 bytes.
...
Run: python3 test_caller_61AAA.py
"""
...
CODE = {
    0x61aaa: {"kind": 'st', "py": 'local[0x3FC] = pr\n_wrw(ram, STACK_BASE + 0x3FC, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x61aac: {"kind": 'reg', "py": 'r[3] = 0x00002420', "slot_py": None, "target": None, "cond": None},
    0x61aae: {"kind": "call", "py": None, "slot_py": 'r[4] = s8(0x00)', "target": 0x2420, "ret_pc": 0x61ab2, "set_pr": True, "cond": None},
    0x61ab2: {"kind": 'reg', "py": 'r[2] = 0xFFFF87B4', "slot_py": None, "target": None, "cond": None},
    0x61ab4: {"kind": 'reg', "py": 'r[3] = 0x00002430', "slot_py": None, "target": None, "cond": None},
    0x61ab6: {"kind": 'mem', "py": '_wrw(ram, 0xFFFF87B4, 2, r[0])', "slot_py": None, "target": None, "cond": None},
    0x61ab8: {"kind": "call", "py": None, "slot_py": 'r[4] = s8(0x00)', "target": 0x2430, "ret_pc": 0x61abc, "set_pr": True, "cond": None},
    0x61abc: {"kind": 'reg', "py": 'r[2] = 0xFFFF87AC', "slot_py": None, "target": None, "cond": None},
    0x61abe: {"kind": 'mem', "py": '_wrw(ram, 0xFFFF87AC, 4, r[0])', "slot_py": None, "target": None, "cond": None},
    0x61ac0: {"kind": 'reg', "py": 'r[3] = 0x00002430', "slot_py": None, "target": None, "cond": None},
    0x61ac2: {"kind": "call", "py": None, "slot_py": 'r[4] = s8(0x00)', "target": 0x2430, "ret_pc": 0x61ac6, "set_pr": True, "cond": None},
    0x61ac6: {"kind": 'reg', "py": 'r[2] = 0xFFFF87B0', "slot_py": None, "target": None, "cond": None},
    0x61ac8: {"kind": 'st', "py": 'pr = _rdw(ram, STACK_BASE + 0x3FC, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x61aca: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFF87B0, 4, r[0])', "target": None, "cond": None},
