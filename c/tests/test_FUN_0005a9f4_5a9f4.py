#!/usr/bin/env python3
"""Differential test for FUN_0005a9f4 (0x5A9F4) — v3 lift + v4 FPU, 40 bytes.
...
Run from repo root: python3 c/tests/test_FUN_0005a9f4_5a9f4.py
"""
...
ENTRY = 0x5A9F4
RAW = bytes.fromhex("93 28 F4 38 D2 15 F5 28 F5 45 8D 03 00 09 E0 01 A0 08 24 00 D1 12 F3 18 F5 31 F5 45 8F 02 00 09 E0 00 24 00 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    ...
    0x5aa04: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, r[4], 1, r[0])', "target": 0x5aa18, "cond": 'always'},
    ...
    0x5aa16: {"kind": 'mem', "py": '_wrw(ram, r[4], 1, r[0])', "slot_py": None, "target": None, "cond": None},
