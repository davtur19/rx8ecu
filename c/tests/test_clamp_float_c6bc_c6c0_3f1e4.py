#!/usr/bin/env python3
"""Differential test for clamp_float_c6bc_c6c0 (0x3F1E4) — v3 lift + v4 FPU, 64 bytes.
...
Run from repo root: python3 c/tests/test_clamp_float_c6bc_c6c0_3f1e4.py
"""
...
ENTRY = 0x3F1E4
RAW = bytes.fromhex("93 65 F4 38 D5 35 D4 36 D2 36 F3 28 91 60 F2 18 F3 25 8D 06 00 09 93 5C 60 30 60 0C 88 01 8F 03 00 09 F4 4A A0 0A F5 4A F3 48 F4 35 8F 01 00 09 F4 4A F3 58 F4 35 8D 01 00 09 F5 4A 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCFD9
SPAN_END = 0x3F224
SENT = 0x3F224     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x3f1e4: {"kind": 'reg', "py": 'r[3] = 0xFFFFAD84', "slot_py": None, "target": None, "cond": None},
    0x3f1e6: {"kind": 'fpu', "py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFAD84, 4))', "slot_py": None, "target": None, "cond": None},
    0x3f1e8: {"kind": 'reg', "py": 'r[5] = 0xFFFFC6BC', "slot_py": None, "target": None, "cond": None},
    0x3f1ea: {"kind": 'reg', "py": 'r[4] = 0xFFFFC6C0', "slot_py": None, "target": None, "cond": None},
    0x3f1ec: {"kind": 'reg', "py": 'r[2] = 0x0007C1F0', "slot_py": None, "target": None, "cond": None},
    0x3f1ee: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x0007C1F0, 4))', "slot_py": None, "target": None, "cond": None},
    0x3f1f0: {"kind": 'reg', "py": 'r[1] = 0xFFFFB390', "slot_py": None, "target": None, "cond": None},
    0x3f1f2: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0xFFFFB390, 4))', "slot_py": None, "target": None, "cond": None},
    0x3f1f4: {"kind": 'fpu', "py": 'T = 1 if fr[3] > fr[2] else 0', "slot_py": None, "target": None, "cond": None},
    0x3f1f6: {"kind": "branch", "py": None, "slot_py": '', "target": 0x3f206, "cond": 'T'},
    0x3f1fa: {"kind": 'reg', "py": 'r[3] = 0xFFFFCFD9', "slot_py": None, "target": None, "cond": None},
    0x3f1fc: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCFD9, 1))', "slot_py": None, "target": None, "cond": None},
    0x3f1fe: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x3f200: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x3f202: {"kind": "branch", "py": None, "slot_py": '', "target": 0x3f20c, "cond": 'notT'},
    0x3f206: {"kind": 'fpu', "py": '_wrw(ram, r[4], 4, f2bits(fr[4]))', "slot_py": None, "target": None, "cond": None},
    0x3f208: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, r[5], 4, f2bits(fr[4]))', "target": 0x3f220, "cond": 'always'},
    0x3f20c: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, r[4], 4))', "slot_py": None, "target": None, "cond": None},
    0x3f20e: {"kind": 'fpu', "py": 'T = 1 if fr[4] > fr[3] else 0', "slot_py": None, "target": None, "cond": None},
    0x3f210: {"kind": "branch", "py": None, "slot_py": '', "target": 0x3f216, "cond": 'notT'},
    0x3f214: {"kind": 'fpu', "py": '_wrw(ram, r[4], 4, f2bits(fr[4]))', "slot_py": None, "target": None, "cond": None},
    0x3f216: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, r[5], 4))', "slot_py": None, "target": None, "cond": None},
    0x3f218: {"kind": 'fpu', "py": 'T = 1 if fr[4] > fr[3] else 0', "slot_py": None, "target": None, "cond": None},
    0x3f21a: {"kind": "branch", "py": None, "slot_py": '', "target": 0x3f220, "cond": 'T'},
    0x3f21e: {"kind": 'fpu', "py": '_wrw(ram, r[5], 4, f2bits(fr[4]))', "slot_py": None, "target": None, "cond": None},
    0x3f220: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
