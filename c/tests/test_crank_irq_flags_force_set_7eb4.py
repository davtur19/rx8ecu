#!/usr/bin/env python3
"""Differential test for crank_irq_flags_force_set (0x7EB4) — v3 lift (branches + delay slots), 22 bytes.
...
Run from repo root: python3 c/tests/test_crank_irq_flags_force_set_7eb4.py
"""
...
ENTRY = 0x7EB4
RAW = bytes.fromhex("D3 2F E4 01 D2 2F 23 40 22 40 D1 2F D3 2F 21 40 D0 2F 00 0B 20 31")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFF9FCE
SPAN_END = 0x7ECA
SENT = 0x7ECA     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x7eb4: {"kind": 'reg', "py": 'r[3] = 0xFFFF9FCE', "slot_py": None, "target": None, "cond": None},
    0x7eb6: {"kind": 'reg', "py": 'r[4] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x7eb8: {"kind": 'reg', "py": 'r[2] = 0xFFFF9FA0', "slot_py": None, "target": None, "cond": None},
    0x7eba: {"kind": 'mem', "py": '_wrw(ram, 0xFFFF9FCE, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x7ebc: {"kind": 'mem', "py": '_wrw(ram, 0xFFFF9FA0, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x7ebe: {"kind": 'reg', "py": 'r[1] = 0xFFFF9F8C', "slot_py": None, "target": None, "cond": None},
    0x7ec0: {"kind": 'reg', "py": 'r[3] = 0x0000FFFF', "slot_py": None, "target": None, "cond": None},
    0x7ec2: {"kind": 'mem', "py": '_wrw(ram, 0xFFFF9F8C, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x7ec4: {"kind": 'reg', "py": 'r[0] = 0xFFFF9FCC', "slot_py": None, "target": None, "cond": None},
    0x7ec6: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFF9FCC, 2, r[3])', "target": None, "cond": None},}
