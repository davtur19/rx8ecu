#!/usr/bin/env python3
"""Differential test for caller_56128 (entry 0x56128) — v8 ST caller (CFG), 22 bytes.
...
Run: python3 test_caller_56128.py
"""
...
CODE = {
    0x56128: {"kind": 'st', "py": 'local[0x3FC] = pr\n_wrw(ram, STACK_BASE + 0x3FC, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x5612a: {"kind": 'fpu', "py": 'fr[6] = 0.0', "slot_py": None, "target": None, "cond": None},
    0x5612c: {"kind": 'reg', "py": 'r[0] = 0x00056248', "slot_py": None, "target": None, "cond": None},
    0x5612e: {"kind": 'reg', "py": 'r[3] = 0xFFFFAAE4', "slot_py": None, "target": None, "cond": None},
    0x56130: {"kind": 'reg', "py": 'r[2] = 0x00002490', "slot_py": None, "target": None, "cond": None},
    0x56132: {"kind": 'fpu', "py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFAAE4, 4))', "slot_py": None, "target": None, "cond": None},
    0x56134: {"kind": "call", "py": None, "slot_py": 'fr[5] = bits2f(_rdw(ram, 0x00056248, 4))', "target": 0x2490, "ret_pc": 0x56138, "set_pr": True, "cond": None},
    0x56138: {"kind": 'st', "py": 'pr = _rdw(ram, STACK_BASE + 0x3FC, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x5613a: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},
