#!/usr/bin/env python3
"""Differential test for getIgnitionTimingInit (0x12180) — v3 lift + v4 FPU, 18 bytes.
...
Run from repo root: python3 c/tests/test_getIgnitionTimingInit_12180.py
"""
...
ENTRY = 0x12180
RAW = bytes.fromhex("D3 39 F3 38 D2 39 F2 3A D1 39 F3 18 D0 39 00 0B F0 3A")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFA64C
SPAN_END = 0x12192
SENT = 0x12192     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x12180: {"kind": 'reg', "py": 'r[3] = 0x0006E098', "slot_py": None, "target": None, "cond": None},
    0x12182: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x0006E098, 4))', "slot_py": None, "target": None, "cond": None},
    0x12184: {"kind": 'reg', "py": 'r[2] = 0xFFFFA63C', "slot_py": None, "target": None, "cond": None},
    0x12186: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFA63C, 4, f2bits(fr[3]))', "slot_py": None, "target": None, "cond": None},
    0x12188: {"kind": 'reg', "py": 'r[1] = 0x0006E0CC', "slot_py": None, "target": None, "cond": None},
    0x1218a: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x0006E0CC, 4))', "slot_py": None, "target": None, "cond": None},
    0x1218c: {"kind": 'reg', "py": 'r[0] = 0xFFFFA64C', "slot_py": None, "target": None, "cond": None},
    0x1218e: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFA64C, 4, f2bits(fr[3]))', "target": None, "cond": None},}
