#!/usr/bin/env python3
"""Differential test for timer_sfr_ec00_init_max (0x4DEE) — v3 lift (branches + delay slots), 24 bytes.
...
Run from repo root: python3 c/tests/test_timer_sfr_ec00_init_max_4dee.py
"""
...
ENTRY = 0x4DEE
RAW = bytes.fromhex("D4 1E 93 29 23 42 92 28 22 42 91 27 90 27 20 11 E3 00 91 25 00 0B 21 31")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFEC0A
SPAN_END = 0x4E06
SENT = 0x4E06     # stop-sentinel, placed past the literal pool
...
CODE = {
    ...
    0x4e02: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFEC0A, 2, r[3])', "target": None, "cond": None},}
