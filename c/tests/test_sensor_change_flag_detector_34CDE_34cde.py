#!/usr/bin/env python3
"""Differential test for sensor_change_flag_detector_34CDE (0x34CDE) — v3 lift (branches + delay slots), 28 bytes.
...
Run from repo root: python3 c/tests/test_sensor_change_flag_detector_34CDE_34cde.py
"""
...
ENTRY = 0x34CDE
RAW = bytes.fromhex("93 0F D5 12 64 30 61 50 62 4C 61 1C 32 10 8D 03 00 09 D2 0A E1 01 22 10 00 0B 25 40")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    0x34cde: {"kind": 'reg', "py": 'r[3] = 0xFFFFBB54', "slot_py": None, "target": None, "cond": None},
    0x34ce0: {"kind": 'reg', "py": 'r[5] = 0xFFFFC124', "slot_py": None, "target": None, "cond": None},
    0x34ce2: {"kind": 'mem', "py": 'r[4] = s8(_rdw(ram, 0xFFFFBB54, 1))', "slot_py": None, "target": None, "cond": None},
    0x34ce4: {"kind": 'mem', "py": 'r[1] = s8(_rdw(ram, 0xFFFFC124, 1))', "slot_py": None, "target": None, "cond": None},
    0x34ce6: {"kind": 'reg', "py": 'r[2] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x34ce8: {"kind": 'reg', "py": 'r[1] = r[1] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x34cea: {"kind": 'reg', "py": 'T = 1 if r[2] == r[1] else 0', "slot_py": None, "target": None, "cond": None},
    0x34cec: {"kind": "branch", "py": None, "slot_py": '', "target": 0x34cf6, "cond": 'T'},
    0x34cf0: {"kind": 'reg', "py": 'r[2] = 0xFFFFC127', "slot_py": None, "target": None, "cond": None},
    0x34cf2: {"kind": 'reg', "py": 'r[1] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x34cf4: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC127, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x34cf6: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFC124, 1, r[4])', "target": None, "cond": None},}
