#!/usr/bin/env python3
"""Differential test for calc_manifold_pressure_error_diff_10A88 (0x10A88) — pure straight-line lift, 10 bytes.
...
Run from repo root: python3 c/tests/test_calc_manifold_pressure_error_diff_10A88_10a88.py
"""
...
ENTRY = 0x10A88
RAW = bytes.fromhex("D2 68 63 53 33 48 64 33 34 27")
SEED = 42
N = 2000
