#!/usr/bin/env python3
"""Differential test for diag_octane_5035c (0x5035C) — v3 lift + v4 FPU, 32 bytes.
...
Run from repo root: python3 c/tests/test_diag_octane_5035c_5035c.py
"""
...
ENTRY = 0x5035C
RAW = bytes.fromhex("91 1B 62 11 D3 17 62 2D 32 30 8F 07 00 09 C7 16 92 14 F3 08 F2 28 F2 32 93 09 F3 2A 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFD044
SPAN_END = 0x5037C
SENT = 0x5037C     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x5035c: {"kind": 'reg', "py": 'r[1] = 0xFFFFB148', "slot_py": None, "target": None, "cond": None},
    0x5035e: {"kind": 'mem', "py": 'r[2] = s16(_rdw(ram, 0xFFFFB148, 2))', "slot_py": None, "target": None, "cond": None},
    0x50360: {"kind": 'reg', "py": 'r[3] = 0x00008000', "slot_py": None, "target": None, "cond": None},
    0x50362: {"kind": 'reg', "py": 'r[2] = r[2] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x50364: {"kind": 'reg', "py": 'T = 1 if r[2] == r[3] else 0', "slot_py": None, "target": None, "cond": None},
    0x50366: {"kind": "branch", "py": None, "slot_py": '', "target": 0x50378, "cond": 'notT'},
    0x5036a: {"kind": 'reg', "py": 'r[0] = 0x000503C4', "slot_py": None, "target": None, "cond": None},
    0x5036c: {"kind": 'reg', "py": 'r[2] = 0xFFFFB290', "slot_py": None, "target": None, "cond": None},
    0x5036e: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x000503C4, 4))', "slot_py": None, "target": None, "cond": None},
    0x50370: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0xFFFFB290, 4))', "slot_py": None, "target": None, "cond": None},
    0x50372: {"kind": 'fpu', "py": 'fr[2] = ts(fr[2] * fr[3])', "slot_py": None, "target": None, "cond": None},
    0x50374: {"kind": 'reg', "py": 'r[3] = 0xFFFFD044', "slot_py": None, "target": None, "cond": None},
    0x50376: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFD044, 4, f2bits(fr[2]))', "slot_py": None, "target": None, "cond": None},
    0x50378: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
