#!/usr/bin/env python3
"""Differential test for FUN_0005c740 (0x5C740) — pure straight-line lift, 10 bytes.
...
Run from repo root: python3 c/tests/test_FUN_0005c740_5c740.py
"""
...
ENTRY = 0x5C740
RAW = bytes.fromhex("00 09 60 EC D1 24 40 08 40 08")
SEED = 42
N = 2000
