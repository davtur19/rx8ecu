#!/usr/bin/env python3
"""Differential test for check_multi_threshold_limiter_2B8B0 (0x2B8B0) — v3 lift + v4 FPU, 34 bytes.
...
Run from repo root: python3 c/tests/test_check_multi_threshold_limiter_2B8B0_2b8b0.py
"""
...
ENTRY = 0x2B8B0
RAW = bytes.fromhex("D2 3A F3 28 F4 35 8D 03 00 09 E0 01 A0 07 24 00 D1 37 F2 18 F2 45 8D 02 00 09 E0 00 24 00 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    ...
    0x2b8bc: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, r[4], 1, r[0])', "target": 0x2b8ce, "cond": 'always'},
    ...
    0x2b8cc: {"kind": 'mem', "py": '_wrw(ram, r[4], 1, r[0])', "slot_py": None, "target": None, "cond": None},
