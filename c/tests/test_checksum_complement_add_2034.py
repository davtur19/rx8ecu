#!/usr/bin/env python3
"""Differential test for checksum_complement_add (0x2034) — v3 lift (branches + delay slots), 14 bytes.
...
Run from repo root: python3 c/tests/test_checksum_complement_add_2034.py
"""
...
ENTRY = 0x2034
RAW = bytes.fromhex("63 42 60 33 43 29 60 07 30 38 00 0B 60 0D")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = None
SPAN_END = 0x2042
SENT = 0x2042     # stop-sentinel, placed past the literal pool
