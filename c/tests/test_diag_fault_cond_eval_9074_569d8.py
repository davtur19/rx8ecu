#!/usr/bin/env python3
"""Differential test for diag_fault_cond_eval_9074 (0x569D8) — mem lift (RAM-only, straight-line), 8 bytes.
...
Run from repo root: python3 c/tests/test_diag_fault_cond_eval_9074_569d8.py
"""
...
ENTRY = 0x569D8
RAW = bytes.fromhex("1F 25 61 23 71 01 63 23")
SEED = 42
N = 2000
...
def spec_mirror(r4, r5, r6, r7, ram, stack_top):
    ...
    local[0x414] = r[2]
    _wrw(ram, STACK_BASE + 0x414, 4, r[2])
    # 0x0569DA: op 0x6123
    r[1] = r[2]
    # 0x0569DC: op 0x7101
    r[1] = (r[1] + s8(0x01)) & 0xFFFFFFFF
    # 0x0569DE: op 0x6323
    r[3] = r[2]
    r[15] = sp
