#!/usr/bin/env python3
"""Differential test for timer_manager_0x5226A (0x5226A) — v3 lift + v4 FPU, 78 bytes.
...
Run from repo root: python3 c/tests/test_timer_manager_0x5226A_5226a.py
"""
...
ENTRY = 0x5226A
RAW = bytes.fromhex("93 37 95 38 92 34 60 20 60 0C 88 01 8F 03 64 30 F3 8D A0 19 F5 3A 91 26 60 10 60 0C 88 01 8F 07 00 09 93 21 60 31 D1 19 62 11 30 20 8D 09 00 09 D2 18 63 20 23 38 8F 07 00 09 60 4C 88 01 8F 03 00 09 93 13 F3 38 F5 3A D2 12 00 0B 22 40")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFD201
SPAN_END = 0x522B8
SENT = 0x522B8     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x5226a: {"kind": 'reg', "py": 'r[3] = 0xFFFFD131', "slot_py": None, "target": None, "cond": None},
    0x5226c: {"kind": 'reg', "py": 'r[5] = 0xFFFFD11C', "slot_py": None, "target": None, "cond": None},
    0x5226e: {"kind": 'reg', "py": 'r[2] = 0xFFFFD201', "slot_py": None, "target": None, "cond": None},
    0x52270: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFD201, 1))', "slot_py": None, "target": None, "cond": None},
    ...
    0x52276: {"kind": "branch", "py": None, "slot_py": 'r[4] = s8(_rdw(ram, 0xFFFFD131, 1))', "target": 0x52280, "cond": 'notT'},
    0x5227a: {"kind": 'fpu', "py": 'fr[3] = 0.0', "slot_py": None, "target": None, "cond": None},
    0x5227c: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, r[5], 4, f2bits(fr[3]))', "target": 0x522b2, "cond": 'always'},
    0x52280: {"kind": 'reg', "py": 'r[1] = 0xFFFFD12E', "slot_py": None, "target": None, "cond": None},
    0x52282: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFD12E, 1))', "slot_py": None, "target": None, "cond": None},
    0x52284: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x52286: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x52288: {"kind": "branch", "py": None, "slot_py": '', "target": 0x5229a, "cond": 'notT'},
    0x5228c: {"kind": 'reg', "py": 'r[3] = 0xFFFFCFE6', "slot_py": None, "target": None, "cond": None},
    0x5228e: {"kind": 'mem', "py": 'r[0] = s16(_rdw(ram, 0xFFFFCFE6, 2))', "slot_py": None, "target": None, "cond": None},
    0x52290: {"kind": 'reg', "py": 'r[1] = 0x0007D6CC', "slot_py": None, "target": None, "cond": None},
    0x52292: {"kind": 'mem', "py": 'r[2] = s16(_rdw(ram, 0x0007D6CC, 2))', "slot_py": None, "target": None, "cond": None},
    0x52294: {"kind": 'reg', "py": 'T = 1 if r[0] == r[2] else 0', "slot_py": None, "target": None, "cond": None},
    0x52296: {"kind": "branch", "py": None, "slot_py": '', "target": 0x522ac, "cond": 'T'},
    0x5229a: {"kind": 'reg', "py": 'r[2] = 0xFFFFD142', "slot_py": None, "target": None, "cond": None},
    0x5229c: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFD142, 1))', "slot_py": None, "target": None, "cond": None},
    0x5229e: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x522a0: {"kind": "branch", "py": None, "slot_py": '', "target": 0x522b2, "cond": 'notT'},
    0x522a4: {"kind": 'reg', "py": 'r[0] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x522a6: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x522a8: {"kind": "branch", "py": None, "slot_py": '', "target": 0x522b2, "cond": 'notT'},
    0x522ac: {"kind": 'reg', "py": 'r[3] = 0xFFFFD01C', "slot_py": None, "target": None, "cond": None},
    0x522ae: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFD01C, 4))', "slot_py": None, "target": None, "cond": None},
    0x522b0: {"kind": 'fpu', "py": '_wrw(ram, r[5], 4, f2bits(fr[3]))', "slot_py": None, "target": None, "cond": None},
    0x522b2: {"kind": 'reg', "py": 'r[2] = 0xFFFFD142', "slot_py": None, "target": None, "cond": None},
    0x522b4: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFD142, 1, r[4])', "target": None, "cond": None},}
