#!/usr/bin/env python3
"""Differential test for wdt_disable_and_set_timer (0x502C) — v3 lift (branches + delay slots), 14 bytes.
...
Run from repo root: python3 c/tests/test_wdt_disable_and_set_timer_502c.py
"""
