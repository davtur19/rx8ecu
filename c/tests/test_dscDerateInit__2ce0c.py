#!/usr/bin/env python3
"""Differential test for dscDerateInit_ (0x2CE0C) — v3 lift (branches + delay slots), 24 bytes.
...
Run from repo root: python3 c/tests/test_dscDerateInit__2ce0c.py
"""
...
ENTRY = 0x2CE0C
RAW = bytes.fromhex("93 78 E4 00 92 77 23 40 22 40 91 75 93 75 21 40 23 40 92 73 00 0B 22 40")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBCB7
SPAN_END = 0x2CE24
SENT = 0x2CE24     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x2ce0c: {"kind": 'reg', "py": 'r[3] = 0xFFFFBCB4', "slot_py": None, "target": None, "cond": None},
    0x2ce0e: {"kind": 'reg', "py": 'r[4] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x2ce10: {"kind": 'reg', "py": 'r[2] = 0xFFFFBCB5', "slot_py": None, "target": None, "cond": None},
    0x2ce12: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBCB4, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x2ce14: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBCB5, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x2ce16: {"kind": 'reg', "py": 'r[1] = 0xFFFFBCB3', "slot_py": None, "target": None, "cond": None},
    0x2ce18: {"kind": 'reg', "py": 'r[3] = 0xFFFFBCB6', "slot_py": None, "target": None, "cond": None},
    0x2ce1a: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBCB3, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x2ce1c: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBCB6, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x2ce1e: {"kind": 'reg', "py": 'r[2] = 0xFFFFBCB7', "slot_py": None, "target": None, "cond": None},
    0x2ce20: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBCB7, 1, r[4])', "target": None, "cond": None},}
