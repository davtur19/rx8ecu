#!/usr/bin/env python3
"""Differential test for getKnockControlActive (0x13A86) — v3 lift (branches + delay slots), 40 bytes.
...
Run from repo root: python3 c/tests/test_getKnockControlActive_13a86.py
"""
...
ENTRY = 0x13A86
RAW = bytes.fromhex("94 19 D3 10 60 30 60 0C 88 01 8F 09 00 09 D2 13 60 20 60 0C 88 01 8F 03 00 09 E3 01 A0 02 24 30 E1 00 24 10 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    0x13a86: {"kind": 'reg', "py": 'r[4] = 0xFFFFA740', "slot_py": None, "target": None, "cond": None},
    0x13a88: {"kind": 'reg', "py": 'r[3] = 0xFFFFA748', "slot_py": None, "target": None, "cond": None},
    0x13a8a: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFA748, 1))', "slot_py": None, "target": None, "cond": None},
    0x13a8c: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x13a8e: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x13a90: {"kind": "branch", "py": None, "slot_py": '', "target": 0x13aa6, "cond": 'notT'},
    0x13a94: {"kind": 'reg', "py": 'r[2] = 0xFFFFA749', "slot_py": None, "target": None, "cond": None},
    0x13a96: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFA749, 1))', "slot_py": None, "target": None, "cond": None},
    0x13a98: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x13a9a: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x13a9c: {"kind": "branch", "py": None, "slot_py": '', "target": 0x13aa6, "cond": 'notT'},
    0x13aa0: {"kind": 'reg', "py": 'r[3] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x13aa2: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFA740, 1, r[3])', "target": 0x13aaa, "cond": 'always'},
    0x13aa6: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x13aa8: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA740, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x13aaa: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
