#!/usr/bin/env python3
"""Differential test for FUN_00013be0 (0x13BE0) — v3 lift + v4 FPU, 100 bytes.
...
Run from repo root: python3 c/tests/test_FUN_00013be0_13be0.py
"""
...
RAM_MAX = 0xFFFFBD88
SPAN_END = 0x13C44
SENT = 0x13C44     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x13be0: {"kind": 'reg', "py": 'r[4] = 0xFFFFA75C', "slot_py": None, "target": None, "cond": None},
    0x13be2: {"kind": 'reg', "py": 'r[3] = 0xFFFFB586', "slot_py": None, "target": None, "cond": None},
    0x13be4: {"kind": 'reg', "py": 'r[2] = 0xFFFFBD88', "slot_py": None, "target": None, "cond": None},
    0x13be6: {"kind": 'mem', "py": 'r[5] = s8(_rdw(ram, 0xFFFFB586, 1))', "slot_py": None, "target": None, "cond": None},
    0x13be8: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFBD88, 1))', "slot_py": None, "target": None, "cond": None},
    0x13bea: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x13bec: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x13bee: {"kind": "branch", "py": None, "slot_py": 'r[5] = r[5] & 0xFF', "target": 0x13bfe, "cond": 'T'},
    0x13bf2: {"kind": 'reg', "py": 'r[1] = 0xFFFFB5FF', "slot_py": None, "target": None, "cond": None},
    0x13bf4: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFB5FF, 1))', "slot_py": None, "target": None, "cond": None},
    0x13bf6: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x13bf8: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x13bfa: {"kind": "branch", "py": None, "slot_py": '', "target": 0x13c14, "cond": 'notT'},
    0x13bfe: {"kind": 'reg', "py": 'r[0] = r[5]', "slot_py": None, "target": None, "cond": None},
    0x13c00: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x13c02: {"kind": "branch", "py": None, "slot_py": '', "target": 0x13c0c, "cond": 'notT'},
    0x13c06: {"kind": 'reg', "py": 'r[3] = 0x000727C0', "slot_py": None, "target": None, "cond": None},
    0x13c08: {"kind": "branch", "py": None, "slot_py": 'fr[3] = bits2f(_rdw(ram, 0x000727C0, 4))', "target": 0x13c10, "cond": 'always'},
    0x13c0c: {"kind": 'reg', "py": 'r[2] = 0x000727C4', "slot_py": None, "target": None, "cond": None},
    0x13c0e: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x000727C4, 4))', "slot_py": None, "target": None, "cond": None},
    0x13c10: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, r[4], 4, f2bits(fr[3]))', "target": 0x13c28, "cond": 'always'},
    0x13c14: {"kind": 'reg', "py": 'r[0] = r[5]', "slot_py": None, "target": None, "cond": None},
    0x13c16: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x13c18: {"kind": "branch", "py": None, "slot_py": '', "target": 0x13c22, "cond": 'notT'},
    0x13c1c: {"kind": 'reg', "py": 'r[3] = 0x000727C8', "slot_py": None, "target": None, "cond": None},
    0x13c1e: {"kind": "branch", "py": None, "slot_py": 'fr[3] = bits2f(_rdw(ram, 0x000727C8, 4))', "target": 0x13c26, "cond": 'always'},
    0x13c22: {"kind": 'reg', "py": 'r[2] = 0x000727CC', "slot_py": None, "target": None, "cond": None},
    0x13c24: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x000727CC, 4))', "slot_py": None, "target": None, "cond": None},
    0x13c26: {"kind": 'fpu', "py": '_wrw(ram, r[4], 4, f2bits(fr[3]))', "slot_py": None, "target": None, "cond": None},
    0x13c28: {"kind": 'reg', "py": 'r[5] = 0xFFFFA764', "slot_py": None, "target": None, "cond": None},
    0x13c2a: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, r[4], 4))', "slot_py": None, "target": None, "cond": None},
    0x13c2c: {"kind": 'reg', "py": 'r[3] = 0xFFFFA668', "slot_py": None, "target": None, "cond": None},
    0x13c2e: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0xFFFFA668, 4))', "slot_py": None, "target": None, "cond": None},
    0x13c30: {"kind": 'fpu', "py": 'T = 1 if fr[3] > fr[2] else 0', "slot_py": None, "target": None, "cond": None},
    0x13c32: {"kind": "branch", "py": None, "slot_py": '', "target": 0x13c3c, "cond": 'T'},
    0x13c36: {"kind": 'reg', "py": 'r[1] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x13c38: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFA764, 1, r[1])', "target": 0x13c40, "cond": 'always'},
    0x13c3c: {"kind": 'reg', "py": 'r[0] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x13c3e: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA764, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x13c40: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
