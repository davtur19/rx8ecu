#!/usr/bin/env python3
"""Differential test for task_wait_4C4F8 (0x4C4F8) — v3 lift (branches + delay slots), 38 bytes.
...
Run from repo root: python3 c/tests/test_task_wait_4C4F8_4c4f8.py
"""
...
ENTRY = 0x4C4F8
RAW = bytes.fromhex("8F 06 00 09 E0 00 26 01 D0 19 63 01 A0 09 24 31 45 15 8F 06 00 09 D3 17 60 31 26 01 D0 16 62 01 24 21 94 1B 93 1B")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
CODE = {
    ...
    0x4c4fe: {"kind": 'mem', "py": '_wrw(ram, r[6], 2, r[0])', "slot_py": None, "target": None, "cond": None},
    0x4c500: {"kind": 'reg', "py": 'r[0] = 0x0007B98C', "slot_py": None, "target": None, "cond": None},
    0x4c502: {"kind": 'mem', "py": 'r[3] = s16(_rdw(ram, 0x0007B98C, 2))', "slot_py": None, "target": None, "cond": None},
    0x4c504: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, r[4], 2, r[3])', "target": 0x4c51a, "cond": 'always'},
    ...
    0x4c512: {"kind": 'mem', "py": '_wrw(ram, r[6], 2, r[0])', "slot_py": None, "target": None, "cond": None},
    ...
    0x4c518: {"kind": 'mem', "py": '_wrw(ram, r[4], 2, r[2])', "slot_py": None, "target": None, "cond": None},
