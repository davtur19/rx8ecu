#!/usr/bin/env python3
"""Differential test for float_cell_dual_zero_c9a4_c99c (0x43150) — v3 lift + v4 FPU, 12 bytes.
...
Run from repo root: python3 c/tests/test_float_cell_dual_zero_c9a4_c99c_43150.py
"""
...
ENTRY = 0x43150
RAW = bytes.fromhex("D3 42 F4 8D 92 7C F3 4A 00 0B F2 4A")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFC9A4
SPAN_END = 0x4315C
SENT = 0x4315C     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x43150: {"kind": 'reg', "py": 'r[3] = 0xFFFFC9A4', "slot_py": None, "target": None, "cond": None},
    0x43152: {"kind": 'fpu', "py": 'fr[4] = 0.0', "slot_py": None, "target": None, "cond": None},
    0x43154: {"kind": 'reg', "py": 'r[2] = 0xFFFFC99C', "slot_py": None, "target": None, "cond": None},
    0x43156: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFC9A4, 4, f2bits(fr[4]))', "slot_py": None, "target": None, "cond": None},
    0x43158: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFC99C, 4, f2bits(fr[4]))', "target": None, "cond": None},}
