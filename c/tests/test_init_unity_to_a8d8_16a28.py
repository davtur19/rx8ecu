#!/usr/bin/env python3
"""Differential test for init_unity_to_a8d8 (0x16A28) — v3 lift + v4 FPU, 8 bytes.
...
Run from repo root: python3 c/tests/test_init_unity_to_a8d8_16a28.py
"""
...
ENTRY = 0x16A28
RAW = bytes.fromhex("D3 14 F3 9D 00 0B F3 3A")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFA8D8
SPAN_END = 0x16A30
SENT = 0x16A30     # stop-sentinel, placed past the literal pool
