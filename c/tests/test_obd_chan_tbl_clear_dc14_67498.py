#!/usr/bin/env python3
"""Differential test for obd_chan_tbl_clear_dc14 (0x67498) — v3 lift (branches + delay slots), 30 bytes.
...
Run from repo root: python3 c/tests/test_obd_chan_tbl_clear_dc14_67498.py
"""
...
ENTRY = 0x67498
RAW = bytes.fromhex("D6 35 E5 00 D4 35 7F FC 2F 42 67 43 77 1C 24 52 26 50 74 04 34 72 8F FA 76 01 00 0B 7F 04")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFDC14
SPAN_END = 0x674B6
SENT = 0x674B6     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x67498: {"kind": 'reg', "py": 'r[6] = 0xFFFFDC0C', "slot_py": None, "target": None, "cond": None},
    0x6749a: {"kind": 'reg', "py": 'r[5] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x6749c: {"kind": 'reg', "py": 'r[4] = 0xFFFFDC14', "slot_py": None, "target": None, "cond": None},
    0x6749e: {"kind": 'reg', "py": 'r[15] = (r[15] + s8(0xFC)) & 0xFFFFFFFF\nsp = (sp + s8(0xFC)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x674a0: {"kind": 'mem', "py": 'local[0x3FC] = r[4]\n_wrw(ram, STACK_BASE + 0x3FC, 4, r[4])', "slot_py": None, "target": None, "cond": None},
    0x674a2: {"kind": 'reg', "py": 'r[7] = r[4]', "slot_py": None, "target": None, "cond": None},
    0x674a4: {"kind": 'reg', "py": 'r[7] = (r[7] + s8(0x1C)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x674a6: {"kind": 'mem', "py": '_wrw(ram, r[4], 4, r[5])', "slot_py": None, "target": None, "cond": None},
    0x674a8: {"kind": 'mem', "py": '_wrw(ram, r[6], 1, r[5])', "slot_py": None, "target": None, "cond": None},
    0x674aa: {"kind": 'reg', "py": 'r[4] = (r[4] + s8(0x04)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x674ac: {"kind": 'reg', "py": 'T = 1 if (r[4] & 0xFFFFFFFF) >= (r[7] & 0xFFFFFFFF) else 0', "slot_py": None, "target": None, "cond": None},
    0x674ae: {"kind": "branch", "py": None, "slot_py": 'r[6] = (r[6] + s8(0x01)) & 0xFFFFFFFF', "target": 0x674a6, "cond": 'notT'},
    0x674b2: {"kind": "ret", "py": None, "slot_py": 'r[15] = (r[15] + s8(0x04)) & 0xFFFFFFFF\nsp = (sp + s8(0x04)) & 0xFFFFFFFF', "target": None, "cond": None},}
