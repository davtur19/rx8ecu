#!/usr/bin/env python3
"""Differential test for dtc_report_b5fc_b5fd_7e_7c (0x52682) — v3 lift (branches + delay slots), 56 bytes.
...
Run from repo root: python3 c/tests/test_dtc_report_b5fc_b5fd_7e_7c_52682.py
"""
...
ENTRY = 0x52682
RAW = bytes.fromhex("00 09 92 2F 61 21 D3 1C 60 31 31 00 8F 0E 00 09 91 29 60 10 20 08 8F 09 00 09 90 25 63 00 23 38 8F 04 00 09 E1 01 92 20 A0 03 22 10 E0 00 93 1C 23 00 4F 26 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFD131
SPAN_END = 0x526BA
SENT = 0x526BA     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x52682: {"kind": 'reg', "py": None, "slot_py": None, "target": None, "cond": None},
    0x52684: {"kind": 'reg', "py": 'r[2] = 0xFFFFCFE6', "slot_py": None, "target": None, "cond": None},
    0x52686: {"kind": 'mem', "py": 'r[1] = s16(_rdw(ram, 0xFFFFCFE6, 2))', "slot_py": None, "target": None, "cond": None},
    0x52688: {"kind": 'reg', "py": 'r[3] = 0x0007D6CC', "slot_py": None, "target": None, "cond": None},
    0x5268a: {"kind": 'mem', "py": 'r[0] = s16(_rdw(ram, 0x0007D6CC, 2))', "slot_py": None, "target": None, "cond": None},
    0x5268c: {"kind": 'reg', "py": 'T = 1 if r[1] == r[0] else 0', "slot_py": None, "target": None, "cond": None},
    0x5268e: {"kind": "branch", "py": None, "slot_py": '', "target": 0x526ae, "cond": 'notT'},
    0x52692: {"kind": 'reg', "py": 'r[1] = 0xFFFFD130', "slot_py": None, "target": None, "cond": None},
    0x52694: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFD130, 1))', "slot_py": None, "target": None, "cond": None},
    0x52696: {"kind": 'reg', "py": 'T = 1 if (r[0] & r[0]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x52698: {"kind": "branch", "py": None, "slot_py": '', "target": 0x526ae, "cond": 'notT'},
    0x5269c: {"kind": 'reg', "py": 'r[0] = 0xFFFFD131', "slot_py": None, "target": None, "cond": None},
    0x5269e: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFD131, 1))', "slot_py": None, "target": None, "cond": None},
    0x526a0: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x526a2: {"kind": "branch", "py": None, "slot_py": '', "target": 0x526ae, "cond": 'notT'},
    0x526a6: {"kind": 'reg', "py": 'r[1] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x526a8: {"kind": 'reg', "py": 'r[2] = 0xFFFFD12F', "slot_py": None, "target": None, "cond": None},
    0x526aa: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFD12F, 1, r[1])', "target": 0x526b4, "cond": 'always'},
    0x526ae: {"kind": 'reg', "py": 'r[0] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x526b0: {"kind": 'reg', "py": 'r[3] = 0xFFFFD12F', "slot_py": None, "target": None, "cond": None},
    0x526b2: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD12F, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x526b4: {"kind": 'mem', "py": 'pr = _rdw(ram, STACK_BASE + 0x400, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x526b6: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
