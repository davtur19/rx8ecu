#!/usr/bin/env python3
"""Differential test for can_clear_txcr_and_init_mailbox (0xD204) — v3 lift (branches + delay slots), 34 bytes.
...
Run from repo root: python3 c/tests/test_can_clear_txcr_and_init_mailbox_d204.py
"""
...
ENTRY = 0xD204
RAW = bytes.fromhex("24 48 8F 0C 00 09 E5 00 D7 29 64 73 66 73 76 06 24 50 74 01 34 62 8F FB 00 09 D3 26 23 50 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFA3D8
SPAN_END = 0xD226
SENT = 0xD226     # stop-sentinel, placed past the literal pool
...
CODE = {
    0xd204: {"kind": 'reg', "py": 'T = 1 if (r[4] & r[4]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0xd206: {"kind": "branch", "py": None, "slot_py": '', "target": 0xd222, "cond": 'notT'},
    0xd20a: {"kind": 'reg', "py": 'r[5] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0xd20c: {"kind": 'reg', "py": 'r[7] = 0xFFFFA3D0', "slot_py": None, "target": None, "cond": None},
    0xd20e: {"kind": 'reg', "py": 'r[4] = r[7]', "slot_py": None, "target": None, "cond": None},
    0xd210: {"kind": 'reg', "py": 'r[6] = r[7]', "slot_py": None, "target": None, "cond": None},
    0xd212: {"kind": 'reg', "py": 'r[6] = (r[6] + s8(0x06)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xd214: {"kind": 'mem', "py": '_wrw(ram, r[4], 1, r[5])', "slot_py": None, "target": None, "cond": None},
    0xd216: {"kind": 'reg', "py": 'r[4] = (r[4] + s8(0x01)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xd218: {"kind": 'reg', "py": 'T = 1 if (r[4] & 0xFFFFFFFF) >= (r[6] & 0xFFFFFFFF) else 0', "slot_py": None, "target": None, "cond": None},
    0xd21a: {"kind": "branch", "py": None, "slot_py": '', "target": 0xd214, "cond": 'notT'},
    0xd21e: {"kind": 'reg', "py": 'r[3] = 0xFFFFA3D8', "slot_py": None, "target": None, "cond": None},
    0xd220: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA3D8, 1, r[5])', "slot_py": None, "target": None, "cond": None},
    0xd222: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
