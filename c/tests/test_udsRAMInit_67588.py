#!/usr/bin/env python3
"""Differential test for udsRAMInit (0x67588) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_udsRAMInit_67588.py
"""
...
ENTRY = 0x67588
RAW = bytes.fromhex("D2 3B E3 00 00 0B 22 30")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFDC30
SPAN_END = 0x67590
SENT = 0x67590     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x67588: {"kind": 'reg', "py": 'r[2] = 0xFFFFDC30', "slot_py": None, "target": None, "cond": None},
    0x6758a: {"kind": 'reg', "py": 'r[3] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x6758c: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFDC30, 1, r[3])', "target": None, "cond": None},}
