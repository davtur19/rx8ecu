#!/usr/bin/env python3
"""Differential test for diag_fault_0x65_cond_eval (0x45B56) — v3 lift (branches + delay slots), 22 bytes.
...
Run from repo root: python3 c/tests/test_diag_fault_0x65_cond_eval_45b56.py
"""
...
ENTRY = 0x45B56
RAW = bytes.fromhex("88 01 8F 06 00 09 93 5C E1 00 90 5E 92 5A 22 31 20 10 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCBF3
SPAN_END = 0x45B6C
SENT = 0x45B6C     # stop-sentinel, placed past the literal pool
