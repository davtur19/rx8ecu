#!/usr/bin/env python3
"""Differential test for FUN_0005025e (0x5025E) — v3 lift (branches + delay slots), 46 bytes.
...
Run from repo root: python3 c/tests/test_FUN_0005025e_5025e.py
"""
...
ENTRY = 0x5025E
RAW = bytes.fromhex("93 36 60 30 60 0C 88 01 8F 0F 00 09 92 31 93 31 61 21 60 31 31 06 8F 08 00 09 91 2C 60 10 20 08 8F 03 00 09 E2 01 93 27 23 20 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCF19
SPAN_END = 0x5028C
SENT = 0x5028C     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x5025e: {"kind": 'reg', "py": 'r[3] = 0xFFFFCDBD', "slot_py": None, "target": None, "cond": None},
    0x50260: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCDBD, 1))', "slot_py": None, "target": None, "cond": None},
    0x50262: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x50264: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x50266: {"kind": "branch", "py": None, "slot_py": '', "target": 0x50288, "cond": 'notT'},
    0x5026a: {"kind": 'reg', "py": 'r[2] = 0xFFFFCDA6', "slot_py": None, "target": None, "cond": None},
    0x5026c: {"kind": 'reg', "py": 'r[3] = 0xFFFFCDA4', "slot_py": None, "target": None, "cond": None},
    0x5026e: {"kind": 'mem', "py": 'r[1] = s16(_rdw(ram, 0xFFFFCDA6, 2))', "slot_py": None, "target": None, "cond": None},
    0x50270: {"kind": 'mem', "py": 'r[0] = s16(_rdw(ram, 0xFFFFCDA4, 2))', "slot_py": None, "target": None, "cond": None},
    0x50272: {"kind": 'reg', "py": 'T = 1 if (r[1] & 0xFFFFFFFF) > (r[0] & 0xFFFFFFFF) else 0', "slot_py": None, "target": None, "cond": None},
    0x50274: {"kind": "branch", "py": None, "slot_py": '', "target": 0x50288, "cond": 'notT'},
    0x50278: {"kind": 'reg', "py": 'r[1] = 0xFFFFCE00', "slot_py": None, "target": None, "cond": None},
    0x5027a: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCE00, 1))', "slot_py": None, "target": None, "cond": None},
    0x5027c: {"kind": 'reg', "py": 'T = 1 if (r[0] & r[0]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x5027e: {"kind": "branch", "py": None, "slot_py": '', "target": 0x50288, "cond": 'notT'},
    0x50282: {"kind": 'reg', "py": 'r[2] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x50284: {"kind": 'reg', "py": 'r[3] = 0xFFFFCF19', "slot_py": None, "target": None, "cond": None},
    0x50286: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCF19, 1, r[2])', "slot_py": None, "target": None, "cond": None},
    0x50288: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
