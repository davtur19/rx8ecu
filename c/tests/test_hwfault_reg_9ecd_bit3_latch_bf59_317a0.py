#!/usr/bin/env python3
"""Differential test for hwfault_reg_9ecd_bit3_latch_bf59 (0x317A0) — v3 lift (branches + delay slots), 32 bytes.
...
Run from repo root: python3 c/tests/test_hwfault_reg_9ecd_bit3_latch_bf59_317a0.py
"""
...
ENTRY = 0x317A0
RAW = bytes.fromhex("D4 0E D3 0F 60 30 60 0C C8 08 00 29 88 01 8F 03 00 09 E3 01 A0 02 24 30 E1 00 24 10 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBF59
SPAN_END = 0x317C0
SENT = 0x317C0     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x317a0: {"kind": 'reg', "py": 'r[4] = 0xFFFFBF59', "slot_py": None, "target": None, "cond": None},
    0x317a2: {"kind": 'reg', "py": 'r[3] = 0xFFFF9ECD', "slot_py": None, "target": None, "cond": None},
    0x317a4: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFF9ECD, 1))', "slot_py": None, "target": None, "cond": None},
    0x317a6: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x317a8: {"kind": 'reg', "py": 'T = 1 if (r[0] & 0x08) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x317aa: {"kind": 'reg', "py": 'r[0] = T;', "slot_py": None, "target": None, "cond": None},
    0x317ac: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x317ae: {"kind": "branch", "py": None, "slot_py": '', "target": 0x317b8, "cond": 'notT'},
    0x317b2: {"kind": 'reg', "py": 'r[3] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x317b4: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFBF59, 1, r[3])', "target": 0x317bc, "cond": 'always'},
    0x317b8: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x317ba: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBF59, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x317bc: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
