#!/usr/bin/env python3
"""Differential test for evaluateFuelCutCondtionUnknown (0x198FA) — v3 lift + v4 FPU, 52 bytes.
...
Run from repo root: python3 c/tests/test_evaluateFuelCutCondtionUnknown_198fa.py
"""
...
ENTRY = 0x198FA
RAW = bytes.fromhex("E5 01 93 3F F4 38 D2 25 F5 28 D1 25 F7 5C D6 25 F3 18 D3 25 F7 31 F6 68 F2 38 D7 24 F6 21 F5 45 8D 02 E4 00 A0 04 27 50 F7 45 8F 01 00 09 27 40 D7 20 F3 68")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFB594
SPAN_END = 0x1992E
SENT = 0x1992E     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x198fa: {"kind": 'reg', "py": 'r[5] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x198fc: {"kind": 'reg', "py": 'r[3] = 0xFFFFB594', "slot_py": None, "target": None, "cond": None},
    0x198fe: {"kind": 'fpu', "py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFB594, 4))', "slot_py": None, "target": None, "cond": None},
    0x19900: {"kind": 'reg', "py": 'r[2] = 0x0006F3F4', "slot_py": None, "target": None, "cond": None},
    0x19902: {"kind": 'fpu', "py": 'fr[5] = bits2f(_rdw(ram, 0x0006F3F4, 4))', "slot_py": None, "target": None, "cond": None},
    0x19904: {"kind": 'reg', "py": 'r[1] = 0x0006F3F8', "slot_py": None, "target": None, "cond": None},
    0x19906: {"kind": 'fpu', "py": 'fr[7] = fr[5]', "slot_py": None, "target": None, "cond": None},
    0x19908: {"kind": 'reg', "py": 'r[6] = 0x0006F428', "slot_py": None, "target": None, "cond": None},
    0x1990a: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x0006F3F8, 4))', "slot_py": None, "target": None, "cond": None},
    0x1990c: {"kind": 'reg', "py": 'r[3] = 0x0006F42C', "slot_py": None, "target": None, "cond": None},
    0x1990e: {"kind": 'fpu', "py": 'fr[7] = ts(fr[7] - fr[3])', "slot_py": None, "target": None, "cond": None},
    0x19910: {"kind": 'fpu', "py": 'fr[6] = bits2f(_rdw(ram, r[6], 4))', "slot_py": None, "target": None, "cond": None},
    0x19912: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0x0006F42C, 4))', "slot_py": None, "target": None, "cond": None},
    0x19914: {"kind": 'reg', "py": 'r[7] = 0xFFFFA9EC', "slot_py": None, "target": None, "cond": None},
    0x19916: {"kind": 'fpu', "py": 'fr[6] = ts(fr[6] - fr[2])', "slot_py": None, "target": None, "cond": None},
    0x19918: {"kind": 'fpu', "py": 'T = 1 if fr[5] > fr[4] else 0', "slot_py": None, "target": None, "cond": None},
    0x1991a: {"kind": "branch", "py": None, "slot_py": 'r[4] = s8(0x00)', "target": 0x19922, "cond": 'T'},
    0x1991e: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFA9EC, 1, r[5])', "target": 0x1992a, "cond": 'always'},
    0x19922: {"kind": 'fpu', "py": 'T = 1 if fr[7] > fr[4] else 0', "slot_py": None, "target": None, "cond": None},
    0x19924: {"kind": "branch", "py": None, "slot_py": '', "target": 0x1992a, "cond": 'notT'},
    0x19928: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA9EC, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x1992a: {"kind": 'reg', "py": 'r[7] = 0xFFFFA9ED', "slot_py": None, "target": None, "cond": None},
    0x1992c: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, r[6], 4))', "slot_py": None, "target": None, "cond": None},}
