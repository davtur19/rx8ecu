#!/usr/bin/env python3
"""Differential test for atu_set_channel_mode (0x1E1C) — v3 lift (branches + delay slots), 30 bytes.
...
Run from repo root: python3 c/tests/test_atu_set_channel_mode_1e1c.py
"""
...
ENTRY = 0x1E1C
RAW = bytes.fromhex("60 40 E6 08 CB 01 24 00 94 9B 63 50 63 3C 23 68 8B 03 74 FF E3 00 34 36 89 F7 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = None
SPAN_END = 0x1E3A
SENT = 0x1E3A     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x1e1c: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, r[4], 1))', "slot_py": None, "target": None, "cond": None},
    0x1e1e: {"kind": 'reg', "py": 'r[6] = s8(0x08)', "slot_py": None, "target": None, "cond": None},
    0x1e20: {"kind": 'reg', "py": 'r[0] = (r[0] | 0x01) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x1e22: {"kind": 'mem', "py": '_wrw(ram, r[4], 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x1e24: {"kind": 'reg', "py": 'r[4] = 0x00000FA0', "slot_py": None, "target": None, "cond": None},
    0x1e26: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, r[5], 1))', "slot_py": None, "target": None, "cond": None},
    0x1e28: {"kind": 'reg', "py": 'r[3] = r[3] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x1e2a: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[6]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x1e2c: {"kind": "branch", "py": None, "slot_py": None, "target": 0x1e36, "cond": 'notT'},
    0x1e2e: {"kind": 'reg', "py": 'r[4] = (r[4] + s8(0xFF)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x1e30: {"kind": 'reg', "py": 'r[3] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x1e32: {"kind": 'reg', "py": 'T = 1 if (r[4] & 0xFFFFFFFF) > (r[3] & 0xFFFFFFFF) else 0', "slot_py": None, "target": None, "cond": None},
    0x1e34: {"kind": "branch", "py": None, "slot_py": None, "target": 0x1e26, "cond": 'T'},
    0x1e36: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
