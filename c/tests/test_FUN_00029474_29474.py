#!/usr/bin/env python3
"""Differential test for FUN_00029474 (0x29474) — v3 lift (branches + delay slots), 44 bytes.
...
Run from repo root: python3 c/tests/test_FUN_00029474_29474.py
"""
...
ENTRY = 0x29474
RAW = bytes.fromhex("91 62 60 10 60 0C 88 01 8F 0E 00 09 93 5D 60 30 60 0C 88 01 8F 08 00 09 93 54 E1 01 90 51 E4 00 92 51 23 41 22 41 20 10 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCFD9
SPAN_END = 0x294A0
SENT = 0x294A0     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x29474: {"kind": 'reg', "py": 'r[1] = 0xFFFFCFD9', "slot_py": None, "target": None, "cond": None},
    0x29476: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCFD9, 1))', "slot_py": None, "target": None, "cond": None},
    0x29478: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x2947a: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x2947c: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2949c, "cond": 'notT'},
    0x29480: {"kind": 'reg', "py": 'r[3] = 0xFFFFA41C', "slot_py": None, "target": None, "cond": None},
    0x29482: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFA41C, 1))', "slot_py": None, "target": None, "cond": None},
    0x29484: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x29486: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x29488: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2949c, "cond": 'notT'},
    0x2948c: {"kind": 'reg', "py": 'r[3] = 0xFFFFBAD4', "slot_py": None, "target": None, "cond": None},
    0x2948e: {"kind": 'reg', "py": 'r[1] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x29490: {"kind": 'reg', "py": 'r[0] = 0xFFFFBAD8', "slot_py": None, "target": None, "cond": None},
    0x29492: {"kind": 'reg', "py": 'r[4] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x29494: {"kind": 'reg', "py": 'r[2] = 0xFFFFBAD6', "slot_py": None, "target": None, "cond": None},
    0x29496: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBAD4, 2, r[4])', "slot_py": None, "target": None, "cond": None},
    0x29498: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBAD6, 2, r[4])', "slot_py": None, "target": None, "cond": None},
    0x2949a: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBAD8, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x2949c: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
