#!/usr/bin/env python3
"""Differential test for ram_mirror_value_copies (0x1C0E0) — v3 lift + v4 FPU, 26 bytes.
...
Run from repo root: python3 c/tests/test_ram_mirror_value_copies_1c0e0.py
"""
...
RAM_MAX = 0xFFFFADFE
SPAN_END = 0x1C0FA
SENT = 0x1C0FA     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x1c0e0: {"kind": 'reg', "py": 'r[3] = 0xFFFF9F0A', "slot_py": None, "target": None, "cond": None},
    0x1c0e2: {"kind": 'mem', "py": 'r[2] = s16(_rdw(ram, 0xFFFF9F0A, 2))', "slot_py": None, "target": None, "cond": None},
    0x1c0e4: {"kind": 'reg', "py": 'r[1] = 0xFFFFADD6', "slot_py": None, "target": None, "cond": None},
    0x1c0e6: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFADD6, 2, r[2])', "slot_py": None, "target": None, "cond": None},
    0x1c0e8: {"kind": 'reg', "py": 'r[0] = 0xFFFFA224', "slot_py": None, "target": None, "cond": None},
    0x1c0ea: {"kind": 'mem', "py": 'r[3] = s16(_rdw(ram, 0xFFFFA224, 2))', "slot_py": None, "target": None, "cond": None},
    0x1c0ec: {"kind": 'reg', "py": 'r[2] = 0xFFFFADFE', "slot_py": None, "target": None, "cond": None},
    0x1c0ee: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFADFE, 2, r[3])', "slot_py": None, "target": None, "cond": None},
    0x1c0f0: {"kind": 'reg', "py": 'r[1] = 0xFFFFA21C', "slot_py": None, "target": None, "cond": None},
    0x1c0f2: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFA21C, 4))', "slot_py": None, "target": None, "cond": None},
    0x1c0f4: {"kind": 'reg', "py": 'r[3] = 0xFFFFADAC', "slot_py": None, "target": None, "cond": None},
    0x1c0f6: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFADAC, 4, f2bits(fr[3]))', "target": None, "cond": None},}
