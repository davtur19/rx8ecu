#!/usr/bin/env python3
"""Differential test for crank_event_timeout_check (0x7C08) — v3 lift (branches + delay slots), 40 bytes.
...
Run from repo root: python3 c/tests/test_crank_event_timeout_check_7c08.py
"""
...
ENTRY = 0x7C08
RAW = bytes.fromhex("D2 1A 60 20 60 0C 88 01 8F 0A 00 09 D1 12 E2 0C D0 19 63 00 63 3C 33 23 8F 03 64 10 A0 01 74 24 94 16 D3 14 00 0B 23 40")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    ...
    0x7c0c: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x7c0e: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x7c10: {"kind": "branch", "py": None, "slot_py": '', "target": 0x7c28, "cond": 'notT'},
    0x7c14: {"kind": 'reg', "py": 'r[1] = 0xFFFF9F95', "slot_py": None, "target": None, "cond": None},
    0x7c16: {"kind": 'reg', "py": 'r[2] = s8(0x0C)', "slot_py": None, "target": None, "cond": None},
    0x7c18: {"kind": 'reg', "py": 'r[0] = 0xFFFF9F97', "slot_py": None, "target": None, "cond": None},
    0x7c1a: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFF9F97, 1))', "slot_py": None, "target": None, "cond": None},
    0x7c1c: {"kind": 'reg', "py": 'r[3] = r[3] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x7c1e: {"kind": 'reg', "py": 'T = 1 if s32(r[3]) >= s32(r[2]) else 0', "slot_py": None, "target": None, "cond": None},
    0x7c20: {"kind": "branch", "py": None, "slot_py": 'r[4] = s8(_rdw(ram, 0xFFFF9F95, 1))', "target": 0x7c2a, "cond": 'notT'},
    0x7c24: {"kind": "branch", "py": None, "slot_py": 'r[4] = (r[4] + s8(0x24)) & 0xFFFFFFFF', "target": 0x7c2a, "cond": 'always'},
    0x7c28: {"kind": 'reg', "py": 'r[4] = 0x000000FF', "slot_py": None, "target": None, "cond": None},
    0x7c2a: {"kind": 'reg', "py": 'r[3] = 0xFFFF9FC6', "slot_py": None, "target": None, "cond": None},
    0x7c2c: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFF9FC6, 1, r[4])', "target": None, "cond": None},}
