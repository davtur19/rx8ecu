#!/usr/bin/env python3
"""Differential test for caller_23D58 (entry 0x23D58) — v8 ST caller (CFG), 42 bytes.
...
Run: python3 test_caller_23D58.py
"""
...
CODE = {
    0x23d58: {"kind": 'st', "py": 'local[0x3FC] = pr\n_wrw(ram, STACK_BASE + 0x3FC, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x23d5a: {"kind": 'reg', "py": 'r[3] = 0xFFFFCCFB', "slot_py": None, "target": None, "cond": None},
    0x23d5c: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCCFB, 1))', "slot_py": None, "target": None, "cond": None},
    0x23d5e: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x23d60: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x23d62: {"kind": "branch", "py": None, "slot_py": '', "target": 0x23d76, "cond": 'notT'},
    0x23d66: {"kind": 'reg', "py": 'r[1] = 0x00075010', "slot_py": None, "target": None, "cond": None},
    0x23d68: {"kind": 'reg', "py": 'r[2] = 0x000023E4', "slot_py": None, "target": None, "cond": None},
    0x23d6a: {"kind": 'fpu', "py": 'fr[5] = bits2f(_rdw(ram, 0x00075010, 4))', "slot_py": None, "target": None, "cond": None},
    0x23d6c: {"kind": "call", "py": None, "slot_py": 'fr[4] = 1.0', "target": 0x23e4, "ret_pc": 0x23d70, "set_pr": True, "cond": None},
    0x23d70: {"kind": 'reg', "py": 'r[3] = 0xFFFFB474', "slot_py": None, "target": None, "cond": None},
    0x23d72: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFB474, 4, f2bits(fr[0]))', "target": 0x23d7c, "cond": 'always'},
    0x23d76: {"kind": 'fpu', "py": 'fr[3] = 0.0', "slot_py": None, "target": None, "cond": None},
    0x23d78: {"kind": 'reg', "py": 'r[2] = 0xFFFFB474', "slot_py": None, "target": None, "cond": None},
    0x23d7a: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFB474, 4, f2bits(fr[3]))', "slot_py": None, "target": None, "cond": None},
    0x23d7c: {"kind": 'st', "py": 'pr = _rdw(ram, STACK_BASE + 0x3FC, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x23d7e: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},
