#!/usr/bin/env python3
"""Differential test for FUN_00057f90 (0x57F90) — v3 lift (branches + delay slots), 52 bytes.
...
Run from repo root: python3 c/tests/test_FUN_00057f90_57f90.py
"""
...
ENTRY = 0x57F90
RAW = bytes.fromhex("94 50 93 50 60 30 60 0C 88 01 8D 0C 00 09 92 4B 60 20 60 0C 88 01 8D 06 00 09 91 46 60 10 60 0C 88 01 8F 03 00 09 E2 01 A0 02 24 20 E1 00 24 10 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFD083
SPAN_END = 0x57FC4
SENT = 0x57FC4     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x57f90: {"kind": 'reg', "py": 'r[4] = 0xFFFFD071', "slot_py": None, "target": None, "cond": None},
    0x57f92: {"kind": 'reg', "py": 'r[3] = 0xFFFFD075', "slot_py": None, "target": None, "cond": None},
    0x57f94: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFD075, 1))', "slot_py": None, "target": None, "cond": None},
    0x57f96: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x57f98: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x57f9a: {"kind": "branch", "py": None, "slot_py": '', "target": 0x57fb6, "cond": 'T'},
    0x57f9e: {"kind": 'reg', "py": 'r[2] = 0xFFFFD07A', "slot_py": None, "target": None, "cond": None},
    0x57fa0: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFD07A, 1))', "slot_py": None, "target": None, "cond": None},
    0x57fa2: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x57fa4: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x57fa6: {"kind": "branch", "py": None, "slot_py": '', "target": 0x57fb6, "cond": 'T'},
    0x57faa: {"kind": 'reg', "py": 'r[1] = 0xFFFFD083', "slot_py": None, "target": None, "cond": None},
    0x57fac: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFD083, 1))', "slot_py": None, "target": None, "cond": None},
    0x57fae: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x57fb0: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x57fb2: {"kind": "branch", "py": None, "slot_py": '', "target": 0x57fbc, "cond": 'notT'},
    0x57fb6: {"kind": 'reg', "py": 'r[2] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x57fb8: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFD071, 1, r[2])', "target": 0x57fc0, "cond": 'always'},
    0x57fbc: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x57fbe: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD071, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x57fc0: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
