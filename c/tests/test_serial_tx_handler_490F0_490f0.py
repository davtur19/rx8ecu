#!/usr/bin/env python3
"""Differential test for serial_tx_handler_490F0 (0x490F0) — v3 lift (branches + delay slots), 78 bytes.
...
Run from repo root: python3 c/tests/test_serial_tx_handler_490F0_490f0.py
"""
...
ENTRY = 0x490F0
RAW = bytes.fromhex("00 09 91 20 60 10 60 0C 88 01 8D 12 00 09 93 1B 60 30 60 0C 88 01 8D 0C 00 09 92 16 60 20 60 0C 88 01 8D 06 00 09 93 11 60 30 60 0C 88 01 8F 03 00 09 E3 01 A0 02 24 30 E1 00 24 10 00 0B 00 09 CC 3C C8 1D C8 12 C8 14 C8 6D C8 6F C8 71")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
CODE = {
    0x490f0: {"kind": 'reg', "py": None, "slot_py": None, "target": None, "cond": None},
    ...
    0x49124: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, r[4], 1, r[3])', "target": 0x4912c, "cond": 'always'},
    0x49128: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x4912a: {"kind": 'mem', "py": '_wrw(ram, r[4], 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x4912c: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},
    0x49130: {"kind": 'mem', "py": 'T = 1 if (_rdw(ram, (gbr + r[0]), 1) & 0x3C) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x49132: {"kind": 'reg', "py": 'T = 1 if (r[0] & 0x1D) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x49134: {"kind": 'reg', "py": 'T = 1 if (r[0] & 0x12) == 0 else 0', "slot_py": None, "target": None, "cond": None},}
