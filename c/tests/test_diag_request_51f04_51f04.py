#!/usr/bin/env python3
"""Differential test for diag_request_51f04 (0x51F04) — v3 lift (branches + delay slots), 46 bytes.
...
Run from repo root: python3 c/tests/test_diag_request_51f04_51f04.py
"""
...
ENTRY = 0x51F04
RAW = bytes.fromhex("95 2E 93 2A 62 30 22 28 8F 0C 64 03 60 4C 88 01 8D 05 00 09 92 1F 61 20 21 18 8F 03 00 09 E3 01 A0 02 25 30 E1 00 25 10 4F 26 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCFAA
SPAN_END = 0x51F32
SENT = 0x51F32     # stop-sentinel, placed past the literal pool
...
CODE = {
    ...
    0x51f08: {"kind": 'mem', "py": 'r[2] = s8(_rdw(ram, 0xFFFFCFA9, 1))', "slot_py": None, "target": None, "cond": None},
    ...
    0x51f24: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFCFAA, 1, r[3])', "target": 0x51f2c, "cond": 'always'},
    0x51f28: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x51f2a: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCFAA, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x51f2c: {"kind": 'mem', "py": 'pr = _rdw(ram, STACK_BASE + 0x400, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
