#!/usr/bin/env python3
"""Differential test for control_struct_init_zero_5C98C (0x5C98C) — pure straight-line lift, 8 bytes.
...
Run from repo root: python3 c/tests/test_control_struct_init_zero_5C98C_5c98c.py
"""
...
ENTRY = 0x5C98C
RAW = bytes.fromhex("D4 11 E6 00 65 63 E7 1A")
SEED = 42
N = 2000
