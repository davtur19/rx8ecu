#!/usr/bin/env python3
"""Differential test for setRegisters (0x4D2E) — pure straight-line lift, 8 bytes.
...
Run from repo root: python3 c/tests/test_setRegisters_4d2e.py
"""
...
ENTRY = 0x4D2E
RAW = bytes.fromhex("ED 18 ED 00 ED 02 ED 04")
SEED = 42
N = 2000
