#!/usr/bin/env python3
"""Differential test for math_conditional_2dcf0 (0x2DCF0) — v3 lift + v4 FPU, 32 bytes.
...
Run from repo root: python3 c/tests/test_math_conditional_2dcf0_2dcf0.py
"""
...
ENTRY = 0x2DCF0
RAW = bytes.fromhex("D4 0E D3 1A 92 17 60 20 60 0C 88 01 8F 05 F4 38 D1 17 F3 18 F3 40 A0 01 F4 3A F4 4A 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBDD4
SPAN_END = 0x2DD10
SENT = 0x2DD10     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x2dcf0: {"kind": 'reg', "py": 'r[4] = 0xFFFFBD34', "slot_py": None, "target": None, "cond": None},
    0x2dcf2: {"kind": 'reg', "py": 'r[3] = 0xFFFFBD30', "slot_py": None, "target": None, "cond": None},
    0x2dcf4: {"kind": 'reg', "py": 'r[2] = 0xFFFFBDD4', "slot_py": None, "target": None, "cond": None},
    0x2dcf6: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFBDD4, 1))', "slot_py": None, "target": None, "cond": None},
    0x2dcf8: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x2dcfa: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x2dcfc: {"kind": "branch", "py": None, "slot_py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFBD30, 4))', "target": 0x2dd0a, "cond": 'notT'},
    0x2dd00: {"kind": 'reg', "py": 'r[1] = 0x00075FE8', "slot_py": None, "target": None, "cond": None},
    0x2dd02: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x00075FE8, 4))', "slot_py": None, "target": None, "cond": None},
    0x2dd04: {"kind": 'fpu', "py": 'fr[3] = ts(fr[3] + fr[4])', "slot_py": None, "target": None, "cond": None},
    0x2dd06: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, r[4], 4, f2bits(fr[3]))', "target": 0x2dd0c, "cond": 'always'},
    0x2dd0a: {"kind": 'fpu', "py": '_wrw(ram, r[4], 4, f2bits(fr[4]))', "slot_py": None, "target": None, "cond": None},
    0x2dd0c: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
