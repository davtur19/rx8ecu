#!/usr/bin/env python3
"""Differential test for filter_counter_init_c750 (0x3FE08) — v3 lift + v4 FPU, 60 bytes.
...
Run from repo root: python3 c/tests/test_filter_counter_init_c750_3fe08.py
"""
...
ENTRY = 0x3FE08
RAW = bytes.fromhex("D4 34 F4 9D D5 34 F4 4A F5 4A F3 48 D3 33 F3 3A F3 58 D2 33 F2 3A D7 33 D4 33 A0 04 E6 00 76 01 F3 58 F4 3A 74 04 63 6D 62 71 62 2D 33 27 8F F6 00 09 D3 2E D1 2E 62 31 00 0B 21 21")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFC7F8
SPAN_END = 0x3FE44
SENT = 0x3FE44     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x3fe08: {"kind": 'reg', "py": 'r[4] = 0xFFFFC704', "slot_py": None, "target": None, "cond": None},
    0x3fe0a: {"kind": 'fpu', "py": 'fr[4] = 1.0', "slot_py": None, "target": None, "cond": None},
    0x3fe0c: {"kind": 'reg', "py": 'r[5] = 0xFFFFC708', "slot_py": None, "target": None, "cond": None},
    0x3fe0e: {"kind": 'fpu', "py": '_wrw(ram, r[4], 4, f2bits(fr[4]))', "slot_py": None, "target": None, "cond": None},
    0x3fe10: {"kind": 'fpu', "py": '_wrw(ram, r[5], 4, f2bits(fr[4]))', "slot_py": None, "target": None, "cond": None},
    0x3fe12: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, r[4], 4))', "slot_py": None, "target": None, "cond": None},
    0x3fe14: {"kind": 'reg', "py": 'r[3] = 0xFFFFC7F4', "slot_py": None, "target": None, "cond": None},
    0x3fe16: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFC7F4, 4, f2bits(fr[3]))', "slot_py": None, "target": None, "cond": None},
    0x3fe18: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, r[5], 4))', "slot_py": None, "target": None, "cond": None},
    0x3fe1a: {"kind": 'reg', "py": 'r[2] = 0xFFFFC7F8', "slot_py": None, "target": None, "cond": None},
    0x3fe1c: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFC7F8, 4, f2bits(fr[3]))', "slot_py": None, "target": None, "cond": None},
    0x3fe1e: {"kind": 'reg', "py": 'r[7] = 0x0007980E', "slot_py": None, "target": None, "cond": None},
    0x3fe20: {"kind": 'reg', "py": 'r[4] = 0xFFFFC778', "slot_py": None, "target": None, "cond": None},
    0x3fe22: {"kind": "branch", "py": None, "slot_py": 'r[6] = s8(0x00)', "target": 0x3fe2e, "cond": 'always'},
    0x3fe26: {"kind": 'reg', "py": 'r[6] = (r[6] + s8(0x01)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x3fe28: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, r[5], 4))', "slot_py": None, "target": None, "cond": None},
    0x3fe2a: {"kind": 'fpu', "py": '_wrw(ram, r[4], 4, f2bits(fr[3]))', "slot_py": None, "target": None, "cond": None},
    0x3fe2c: {"kind": 'reg', "py": 'r[4] = (r[4] + s8(0x04)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x3fe2e: {"kind": 'reg', "py": 'r[3] = r[6] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x3fe30: {"kind": 'mem', "py": 'r[2] = s16(_rdw(ram, 0x0007980E, 2))', "slot_py": None, "target": None, "cond": None},
    0x3fe32: {"kind": 'reg', "py": 'r[2] = r[2] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x3fe34: {"kind": 'reg', "py": 'T = 1 if s32(r[3]) > s32(r[2]) else 0', "slot_py": None, "target": None, "cond": None},
    0x3fe36: {"kind": "branch", "py": None, "slot_py": '', "target": 0x3fe26, "cond": 'notT'},
    0x3fe3a: {"kind": 'reg', "py": 'r[3] = 0x00079808', "slot_py": None, "target": None, "cond": None},
    0x3fe3c: {"kind": 'reg', "py": 'r[1] = 0xFFFFC750', "slot_py": None, "target": None, "cond": None},
    0x3fe3e: {"kind": 'mem', "py": 'r[2] = s16(_rdw(ram, 0x00079808, 2))', "slot_py": None, "target": None, "cond": None},
    0x3fe40: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFC750, 2, r[2])', "target": None, "cond": None},}
