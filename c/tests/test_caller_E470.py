#!/usr/bin/env python3
"""Differential test for caller_E470 (entry 0xE470) — v8 ST caller (CFG), 34 bytes.
...
Run: python3 test_caller_E470.py
"""
...
CODE = {
    0xe470: {"kind": 'st', "py": 'local[0x3FC] = pr\n_wrw(ram, STACK_BASE + 0x3FC, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xe472: {"kind": 'reg', "py": 'r[3] = 0xFFFFA428', "slot_py": None, "target": None, "cond": None},
    0xe474: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFA428, 1))', "slot_py": None, "target": None, "cond": None},
    0xe476: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0xe478: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0xe47a: {"kind": "branch", "py": None, "slot_py": '', "target": 0xe48c, "cond": 'notT'},
    0xe47e: {"kind": 'reg', "py": 'r[5] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0xe480: {"kind": 'reg', "py": 'r[1] = 0xFFFFA420', "slot_py": None, "target": None, "cond": None},
    0xe482: {"kind": 'reg', "py": 'r[2] = 0x00002460', "slot_py": None, "target": None, "cond": None},
    0xe484: {"kind": "call", "py": None, "slot_py": 'r[4] = s16(_rdw(ram, 0xFFFFA420, 2))', "target": 0x2460, "ret_pc": 0xe488, "set_pr": True, "cond": None},
    0xe488: {"kind": 'reg', "py": 'r[3] = 0xFFFFA420', "slot_py": None, "target": None, "cond": None},
    0xe48a: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA420, 2, r[0])', "slot_py": None, "target": None, "cond": None},
    0xe48c: {"kind": 'st', "py": 'pr = _rdw(ram, STACK_BASE + 0x3FC, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
