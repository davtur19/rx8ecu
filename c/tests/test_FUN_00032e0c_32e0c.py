#!/usr/bin/env python3
"""Differential test for FUN_00032e0c (0x32E0C) — mem lift (RAM-only, straight-line), 8 bytes.
...
Run from repo root: python3 c/tests/test_FUN_00032e0c_32e0c.py
"""
...
ENTRY = 0x32E0C
RAW = bytes.fromhex("25 30 94 5E 62 50 22 28")
SEED = 42
N = 2000
...
def spec_mirror(r4, r5, r6, r7, ram, stack_top):
    ...
    r[2] = s8(_rdw(ram, r[5], 1))
    # 0x032E12: op 0x2228
    T = 1 if (r[2] & r[2]) == 0 else 0
    r[15] = sp
