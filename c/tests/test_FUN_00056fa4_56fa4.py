#!/usr/bin/env python3
"""Differential test for FUN_00056fa4 (0x56FA4) — v3 lift (branches + delay slots), 18 bytes.
...
Run from repo root: python3 c/tests/test_FUN_00056fa4_56fa4.py
"""
...
ENTRY = 0x56FA4
RAW = bytes.fromhex("92 3D 63 20 D1 28 21 30 93 3A 60 30 D2 27 00 0B 22 00")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFD04E
SPAN_END = 0x56FB6
SENT = 0x56FB6     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x56fa4: {"kind": 'reg', "py": 'r[2] = 0xFFFFCEF5', "slot_py": None, "target": None, "cond": None},
    0x56fa6: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFCEF5, 1))', "slot_py": None, "target": None, "cond": None},
    0x56fa8: {"kind": 'reg', "py": 'r[1] = 0xFFFFD04D', "slot_py": None, "target": None, "cond": None},
    0x56faa: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD04D, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x56fac: {"kind": 'reg', "py": 'r[3] = 0xFFFFCEF6', "slot_py": None, "target": None, "cond": None},
    0x56fae: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCEF6, 1))', "slot_py": None, "target": None, "cond": None},
    0x56fb0: {"kind": 'reg', "py": 'r[2] = 0xFFFFD04E', "slot_py": None, "target": None, "cond": None},
    0x56fb2: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFD04E, 1, r[0])', "target": None, "cond": None},}
