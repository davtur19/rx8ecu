#!/usr/bin/env python3
"""Differential test for obd_session_flag_cfe3_cmp (0x5415A) — v3 lift (branches + delay slots), 24 bytes.
...
Run from repo root: python3 c/tests/test_obd_session_flag_cfe3_cmp_5415a.py
"""
...
ENTRY = 0x5415A
RAW = bytes.fromhex("64 4C D2 20 63 20 63 3C 33 40 8F 02 00 09 A0 01 E4 00 E4 01 00 0B 60 43")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCFE3
SPAN_END = 0x54172
SENT = 0x54172     # stop-sentinel, placed past the literal pool
