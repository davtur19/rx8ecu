#!/usr/bin/env python3
"""Differential test for sample_store_prev_float_bfbc (0x2D57C) — v3 lift + v4 FPU, 10 bytes.
...
Run from repo root: python3 c/tests/test_sample_store_prev_float_bfbc_2d57c.py
"""
...
ENTRY = 0x2D57C
RAW = bytes.fromhex("93 1F F3 38 D2 10 00 0B F2 3A")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBFBC
SPAN_END = 0x2D586
SENT = 0x2D586     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x2d57c: {"kind": 'reg', "py": 'r[3] = 0xFFFFBFBC', "slot_py": None, "target": None, "cond": None},
    0x2d57e: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFBFBC, 4))', "slot_py": None, "target": None, "cond": None},
    0x2d580: {"kind": 'reg', "py": 'r[2] = 0xFFFFBD04', "slot_py": None, "target": None, "cond": None},
    0x2d582: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBD04, 4, f2bits(fr[3]))', "target": None, "cond": None},}
