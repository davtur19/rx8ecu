#!/usr/bin/env python3
"""Differential test for copy_byte_from_rom_39414 (0x39414) — v3 lift (branches + delay slots), 10 bytes.
...
Run from repo root: python3 c/tests/test_copy_byte_from_rom_39414_39414.py
"""
...
CODE = {
    0x39414: {"kind": 'reg', "py": 'r[3] = 0x0006CF87', "slot_py": None, "target": None, "cond": None},
    0x39416: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0x0006CF87, 1))', "slot_py": None, "target": None, "cond": None},
    0x39418: {"kind": 'reg', "py": 'r[2] = 0xFFFFC528', "slot_py": None, "target": None, "cond": None},
    0x3941a: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFC528, 1, r[0])', "target": None, "cond": None},}
