#!/usr/bin/env python3
"""Differential test for flag_copy_io_register_30F44 (0x30F44) — v3 lift + v4 FPU, 22 bytes.
...
Run from repo root: python3 c/tests/test_flag_copy_io_register_30F44_30f44.py
"""
...
RAM_MAX = 0xFFFFBF15
SPAN_END = 0x30F5A
SENT = 0x30F5A     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x30f44: {"kind": 'reg', "py": 'r[3] = 0x00078254', "slot_py": None, "target": None, "cond": None},
    0x30f46: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x00078254, 4))', "slot_py": None, "target": None, "cond": None},
    0x30f48: {"kind": 'reg', "py": 'r[2] = 0xFFFFBEE8', "slot_py": None, "target": None, "cond": None},
    0x30f4a: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFBEE8, 4, f2bits(fr[3]))', "slot_py": None, "target": None, "cond": None},
    0x30f4c: {"kind": 'reg', "py": 'r[1] = 0xFFFFA42C', "slot_py": None, "target": None, "cond": None},
    0x30f4e: {"kind": 'mem', "py": 'r[4] = s8(_rdw(ram, 0xFFFFA42C, 1))', "slot_py": None, "target": None, "cond": None},
    0x30f50: {"kind": 'reg', "py": 'r[3] = 0xFFFFBF13', "slot_py": None, "target": None, "cond": None},
    0x30f52: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBF13, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x30f54: {"kind": 'reg', "py": 'r[2] = 0xFFFFBF15', "slot_py": None, "target": None, "cond": None},
    0x30f56: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBF15, 1, r[4])', "target": None, "cond": None},}
