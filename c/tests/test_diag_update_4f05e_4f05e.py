#!/usr/bin/env python3
"""Differential test for diag_update_4f05e (0x4F05E) — v3 lift + v4 FPU, 38 bytes.
...
Run from repo root: python3 c/tests/test_diag_update_4f05e_4f05e.py
"""
...
ENTRY = 0x4F05E
RAW = bytes.fromhex("00 09 26 40 96 24 D2 21 F5 28 F5 45 8D 02 00 09 A0 07 26 50 D3 1F F3 38 F5 31 F5 45 8F 01 00 09 26 40 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
CODE = {
    0x4f05e: {"kind": 'reg', "py": None, "slot_py": None, "target": None, "cond": None},
    0x4f060: {"kind": 'mem', "py": '_wrw(ram, r[6], 1, r[4])', "slot_py": None, "target": None, "cond": None},
