#!/usr/bin/env python3
"""Differential test for obd_service_handler_691A0 (0x691A0) — v3 lift (branches + delay slots), 18 bytes.
...
Run from repo root: python3 c/tests/test_obd_service_handler_691A0_691a0.py
"""
...
CODE = {
    0x691a0: {"kind": 'reg', "py": 'r[3] = 0xFFFFDE1D', "slot_py": None, "target": None, "cond": None},
    0x691a2: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFDE1D, 1))', "slot_py": None, "target": None, "cond": None},
    0x691a4: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x691a6: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x07) else 0', "slot_py": None, "target": None, "cond": None},
    0x691a8: {"kind": "branch", "py": None, "slot_py": 'r[4] = s8(0x01)', "target": 0x691ae, "cond": 'notT'},
    0x691ac: {"kind": 'reg', "py": 'r[4] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x691ae: {"kind": "ret", "py": None, "slot_py": 'r[0] = r[4]', "target": None, "cond": None},}
