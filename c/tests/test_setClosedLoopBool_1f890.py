#!/usr/bin/env python3
"""Differential test for setClosedLoopBool (0x1F890) — v3 lift (branches + delay slots), 26 bytes.
...
Run from repo root: python3 c/tests/test_setClosedLoopBool_1f890.py
"""
...
ENTRY = 0x1F890
RAW = bytes.fromhex("94 7D 92 7D 63 20 23 38 8F 03 00 09 E0 00 A0 02 24 00 E1 01 24 10 00 0B 00 09")
SEED = 43
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFB188
SPAN_END = 0x1F8AA
SENT = 0x1F8AA     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x1f890: {"kind": 'reg', "py": 'r[4] = 0xFFFFB188', "slot_py": None, "target": None, "cond": None},
    0x1f892: {"kind": 'reg', "py": 'r[2] = 0xFFFFB186', "slot_py": None, "target": None, "cond": None},
    0x1f894: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFB186, 1))', "slot_py": None, "target": None, "cond": None},
    0x1f896: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x1f898: {"kind": "branch", "py": None, "slot_py": '', "target": 0x1f8a2, "cond": 'notT'},
    0x1f89c: {"kind": 'reg', "py": 'r[0] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x1f89e: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFB188, 1, r[0])', "target": 0x1f8a6, "cond": 'always'},
    0x1f8a2: {"kind": 'reg', "py": 'r[1] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x1f8a4: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFB188, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x1f8a6: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
