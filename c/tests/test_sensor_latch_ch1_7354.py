#!/usr/bin/env python3
"""Differential test for sensor_latch_ch1 (0x7354) — mem lift (RAM-only, straight-line), 8 bytes.
...
Run from repo root: python3 c/tests/test_sensor_latch_ch1_7354.py
"""
...
ENTRY = 0x7354
RAW = bytes.fromhex("D3 12 62 31 D1 12 21 21")
SEED = 42
N = 2000
...
def spec_mirror(r4, r5, r6, r7, ram, stack_top):
    ...
    r[2] = s16(_rdw(ram, 0xFFFF9F00, 2))
    # 0x007358: op 0xD112
    r[1] = 0xFFFF9F6C
    # 0x00735A: mov.w r2,@r1
    _wrw(ram, 0xFFFF9F6C, 2, r[2])
    r[15] = sp
