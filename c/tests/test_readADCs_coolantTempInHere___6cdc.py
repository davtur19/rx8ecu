#!/usr/bin/env python3
"""Differential test for readADCs_coolantTempInHere__ (0x6CDC) — v3 lift (branches + delay slots), 36 bytes.
...
Run from repo root: python3 c/tests/test_readADCs_coolantTempInHere___6cdc.py
"""
...
ENTRY = 0x6CDC
RAW = bytes.fromhex("91 4E E0 20 63 11 04 35 92 4B 60 21 81 4F 93 49 60 31 81 4E 91 47 60 11 81 4D 93 45 60 31 81 4C 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    ...
    0x6ce2: {"kind": 'mem', "py": '_wrw(ram, (r[4] + r[0]), 2, r[3])', "slot_py": None, "target": None, "cond": None},
    ...
    0x6ce8: {"kind": 'mem', "py": '_wrw(ram, (r[4] + 30), 2, r[0])', "slot_py": None, "target": None, "cond": None},
    ...
    0x6cee: {"kind": 'mem', "py": '_wrw(ram, (r[4] + 28), 2, r[0])', "slot_py": None, "target": None, "cond": None},
    ...
    0x6cf4: {"kind": 'mem', "py": '_wrw(ram, (r[4] + 26), 2, r[0])', "slot_py": None, "target": None, "cond": None},
    ...
    0x6cfa: {"kind": 'mem', "py": '_wrw(ram, (r[4] + 24), 2, r[0])', "slot_py": None, "target": None, "cond": None},
