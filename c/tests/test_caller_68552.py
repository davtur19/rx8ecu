#!/usr/bin/env python3
"""Differential test for caller_68552 (entry 0x68552) — v8 ST caller (CFG), 18 bytes.
...
Run: python3 test_caller_68552.py
"""
...
CODE = {
    0x68552: {"kind": 'st', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x68554: {"kind": 'reg', "py": 'r[3] = 0xFFFF8FE0', "slot_py": None, "target": None, "cond": None},
    0x68556: {"kind": 'reg', "py": 'r[2] = 0x00002430', "slot_py": None, "target": None, "cond": None},
    0x68558: {"kind": "call", "py": None, "slot_py": 'r[4] = s16(_rdw(ram, 0xFFFF8FE0, 2))', "target": 0x2430, "ret_pc": 0x6855c, "set_pr": True, "cond": None},
    0x6855c: {"kind": 'reg', "py": 'r[1] = 0xFFFF8FDC', "slot_py": None, "target": None, "cond": None},
    0x6855e: {"kind": 'st', "py": 'pr = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x68560: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFF8FDC, 4, r[0])', "target": None, "cond": None},
