#!/usr/bin/env python3
"""Differential test for FUN_0004cecc (0x4CECC) — pure straight-line lift, 8 bytes.
...
Run from repo root: python3 c/tests/test_FUN_0004cecc_4cecc.py
"""
...
ENTRY = 0x4CECC
RAW = bytes.fromhex("DA 3A DB 3B DC 3B 93 69")
SEED = 42
N = 2000
