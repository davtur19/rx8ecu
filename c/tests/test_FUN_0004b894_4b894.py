#!/usr/bin/env python3
"""Differential test for FUN_0004b894 (0x4B894) — v3 lift (branches + delay slots), 16 bytes.
...
Run from repo root: python3 c/tests/test_FUN_0004b894_4b894.py
"""
...
RAM_MAX = None
SPAN_END = 0x4B8A4
SENT = 0x4B8A4     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x4b894: {"kind": 'reg', "py": None, "slot_py": None, "target": None, "cond": None},
    0x4b896: {"kind": 'reg', "py": 'r[1] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x4b898: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, r[4], 1, r[1])', "target": 0x4b8a0, "cond": 'always'},
    0x4b89c: {"kind": 'reg', "py": 'r[2] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x4b89e: {"kind": 'mem', "py": '_wrw(ram, r[4], 1, r[2])', "slot_py": None, "target": None, "cond": None},
