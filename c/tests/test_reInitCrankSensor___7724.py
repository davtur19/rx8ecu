#!/usr/bin/env python3
"""Differential test for reInitCrankSensor__ (0x7724) — v3 lift (branches + delay slots), 36 bytes.
...
Run from repo root: python3 c/tests/test_reInitCrankSensor___7724.py
"""
...
ENTRY = 0x7724
RAW = bytes.fromhex("24 00 60 40 C9 EF 24 00 60 40 C9 BF 24 00 60 40 C9 DF 24 00 60 40 C9 7F 24 00 D0 29 92 48 63 02 00 0B 22 32")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    0x7724: {"kind": 'mem', "py": '_wrw(ram, r[4], 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x7726: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, r[4], 1))', "slot_py": None, "target": None, "cond": None},
    0x7728: {"kind": 'reg', "py": 'r[0] = (r[0] & 0xEF) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x772a: {"kind": 'mem', "py": '_wrw(ram, r[4], 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x772c: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, r[4], 1))', "slot_py": None, "target": None, "cond": None},
    0x772e: {"kind": 'reg', "py": 'r[0] = (r[0] & 0xBF) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x7730: {"kind": 'mem', "py": '_wrw(ram, r[4], 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x7732: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, r[4], 1))', "slot_py": None, "target": None, "cond": None},
    0x7734: {"kind": 'reg', "py": 'r[0] = (r[0] & 0xDF) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x7736: {"kind": 'mem', "py": '_wrw(ram, r[4], 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x7738: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, r[4], 1))', "slot_py": None, "target": None, "cond": None},
    0x773a: {"kind": 'reg', "py": 'r[0] = (r[0] & 0x7F) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x773c: {"kind": 'mem', "py": '_wrw(ram, r[4], 1, r[0])', "slot_py": None, "target": None, "cond": None},
