#!/usr/bin/env python3
"""Differential test for crank_flag_propagator (0x1B594) — v3 lift (branches + delay slots), 10 bytes.
...
Run from repo root: python3 c/tests/test_crank_flag_propagator_1b594.py
"""
...
ENTRY = 0x1B594
RAW = bytes.fromhex("D1 02 63 10 90 01 00 0B 20 30")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFAAE1
SPAN_END = 0x1B59E
SENT = 0x1B5A4     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x1b594: {"kind": 'reg', "py": 'r[1] = 0xFFFFAAE1', "slot_py": None, "target": None, "cond": None},
    0x1b596: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFAAE1, 1))', "slot_py": None, "target": None, "cond": None},
    0x1b598: {"kind": 'reg', "py": 'r[0] = 0xFFFFAAE0', "slot_py": None, "target": None, "cond": None},
    0x1b59a: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFAAE0, 1, r[3])', "target": None, "cond": None},}
