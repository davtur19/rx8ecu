#!/usr/bin/env python3
"""Differential test for ign_retard_flag_c8bc (0x42CE0) — v3 lift + v4 FPU, 40 bytes.
...
Run from repo root: python3 c/tests/test_ign_retard_flag_c8bc_42ce0.py
"""
...
ENTRY = 0x42CE0
RAW = bytes.fromhex("93 24 60 30 60 0C 88 01 8F 0C 00 09 94 24 92 24 60 20 60 0C 88 01 8F 03 00 09 F3 9D A0 01 F3 30 F3 8D F4 3A 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFC945
SPAN_END = 0x42D08
SENT = 0x42D08     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x42ce0: {"kind": 'reg', "py": 'r[3] = 0xFFFFC944', "slot_py": None, "target": None, "cond": None},
    0x42ce2: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFC944, 1))', "slot_py": None, "target": None, "cond": None},
    0x42ce4: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x42ce6: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x42ce8: {"kind": "branch", "py": None, "slot_py": '', "target": 0x42d04, "cond": 'notT'},
    0x42cec: {"kind": 'reg', "py": 'r[4] = 0xFFFFC8BC', "slot_py": None, "target": None, "cond": None},
    0x42cee: {"kind": 'reg', "py": 'r[2] = 0xFFFFC945', "slot_py": None, "target": None, "cond": None},
    0x42cf0: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFC945, 1))', "slot_py": None, "target": None, "cond": None},
    0x42cf2: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x42cf4: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x42cf6: {"kind": "branch", "py": None, "slot_py": '', "target": 0x42d00, "cond": 'notT'},
    0x42cfa: {"kind": 'fpu', "py": 'fr[3] = 1.0', "slot_py": None, "target": None, "cond": None},
    0x42cfc: {"kind": "branch", "py": None, "slot_py": 'fr[3] = ts(fr[3] + fr[3])', "target": 0x42d02, "cond": 'always'},
    0x42d00: {"kind": 'fpu', "py": 'fr[3] = 0.0', "slot_py": None, "target": None, "cond": None},
    0x42d02: {"kind": 'fpu', "py": '_wrw(ram, r[4], 4, f2bits(fr[3]))', "slot_py": None, "target": None, "cond": None},
    0x42d04: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
