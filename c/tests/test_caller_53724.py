#!/usr/bin/env python3
"""Differential test for caller_53724 (entry 0x53724) — v8 ST caller (CFG), 30 bytes.
...
Run: python3 test_caller_53724.py
"""
...
CODE = {
    0x53724: {"kind": 'st', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x53726: {"kind": 'reg', "py": 'r[0] = 0x000537CC', "slot_py": None, "target": None, "cond": None},
    0x53728: {"kind": 'reg', "py": 'r[3] = 0xFFFFB0D0', "slot_py": None, "target": None, "cond": None},
    0x5372a: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x000537CC, 4))', "slot_py": None, "target": None, "cond": None},
    0x5372c: {"kind": 'fpu', "py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFB0D0, 4))', "slot_py": None, "target": None, "cond": None},
    0x5372e: {"kind": 'fpu', "py": 'fr[4] = ts(fr[4] * fr[3])', "slot_py": None, "target": None, "cond": None},
    0x53730: {"kind": 'reg', "py": 'r[0] = 0x000537D0', "slot_py": None, "target": None, "cond": None},
    0x53732: {"kind": 'fpu', "py": 'fr[6] = bits2f(_rdw(ram, 0x000537D0, 4))', "slot_py": None, "target": None, "cond": None},
    0x53734: {"kind": 'reg', "py": 'r[0] = 0x000537D4', "slot_py": None, "target": None, "cond": None},
    0x53736: {"kind": 'reg', "py": 'r[3] = 0x000024D0', "slot_py": None, "target": None, "cond": None},
    0x53738: {"kind": "call", "py": None, "slot_py": 'fr[5] = bits2f(_rdw(ram, 0x000537D4, 4))', "target": 0x24d0, "ret_pc": 0x5373c, "set_pr": True, "cond": None},
    0x5373c: {"kind": 'st', "py": 'pr = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x5373e: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},
