#!/usr/bin/env python3
"""Differential test for fuel_secondary_2aa4e (0x2AA4E) — v3 lift + v4 FPU, 52 bytes.
...
Run from repo root: python3 c/tests/test_fuel_secondary_2aa4e_2aa4e.py
"""
...
ENTRY = 0x2AA4E
RAW = bytes.fromhex("94 21 D3 16 F3 38 92 1F F2 28 F2 35 8D 0E 00 09 91 12 60 10 60 0C 88 01 8F 08 00 09 92 0D 60 20 20 08 8F 03 00 09 E1 01 A0 02 24 10 E2 00 24 20 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBB90
SPAN_END = 0x2AA82
SENT = 0x2AA82     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x2aa4e: {"kind": 'reg', "py": 'r[4] = 0xFFFFBB90', "slot_py": None, "target": None, "cond": None},
    0x2aa50: {"kind": 'reg', "py": 'r[3] = 0x00078D8C', "slot_py": None, "target": None, "cond": None},
    0x2aa52: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x00078D8C, 4))', "slot_py": None, "target": None, "cond": None},
    0x2aa54: {"kind": 'reg', "py": 'r[2] = 0xFFFFAA10', "slot_py": None, "target": None, "cond": None},
    0x2aa56: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0xFFFFAA10, 4))', "slot_py": None, "target": None, "cond": None},
    0x2aa58: {"kind": 'fpu', "py": 'T = 1 if fr[2] > fr[3] else 0', "slot_py": None, "target": None, "cond": None},
    0x2aa5a: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2aa7a, "cond": 'T'},
    0x2aa5e: {"kind": 'reg', "py": 'r[1] = 0xFFFFA428', "slot_py": None, "target": None, "cond": None},
    0x2aa60: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFA428, 1))', "slot_py": None, "target": None, "cond": None},
    0x2aa62: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x2aa64: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x2aa66: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2aa7a, "cond": 'notT'},
    0x2aa6a: {"kind": 'reg', "py": 'r[2] = 0xFFFFAADA', "slot_py": None, "target": None, "cond": None},
    0x2aa6c: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFAADA, 1))', "slot_py": None, "target": None, "cond": None},
    0x2aa6e: {"kind": 'reg', "py": 'T = 1 if (r[0] & r[0]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x2aa70: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2aa7a, "cond": 'notT'},
    0x2aa74: {"kind": 'reg', "py": 'r[1] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x2aa76: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFBB90, 1, r[1])', "target": 0x2aa7e, "cond": 'always'},
    0x2aa7a: {"kind": 'reg', "py": 'r[2] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x2aa7c: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBB90, 1, r[2])', "slot_py": None, "target": None, "cond": None},
    0x2aa7e: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
