#!/usr/bin/env python3
"""Differential test for FUN_0003c154 (0x3C154) — v3 lift (branches + delay slots), 64 bytes.
...
Run from repo root: python3 c/tests/test_FUN_0003c154_3c154.py
"""
...
ENTRY = 0x3C154
RAW = bytes.fromhex("96 65 95 65 93 65 60 30 60 0C 88 01 8F 03 E4 00 26 40 A0 13 25 40 91 5D 62 10 22 28 8F 01 E7 01 25 70 60 50 60 0C 88 01 8F 02 00 09 A0 06 26 40 92 51 63 20 23 38 8F 01 00 09 26 70 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCFD9
SPAN_END = 0x3C194
SENT = 0x3C194     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x3c154: {"kind": 'reg', "py": 'r[6] = 0xFFFFC5B7', "slot_py": None, "target": None, "cond": None},
    0x3c156: {"kind": 'reg', "py": 'r[5] = 0xFFFFC5B8', "slot_py": None, "target": None, "cond": None},
    0x3c158: {"kind": 'reg', "py": 'r[3] = 0xFFFFCFD9', "slot_py": None, "target": None, "cond": None},
    0x3c15a: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCFD9, 1))', "slot_py": None, "target": None, "cond": None},
    0x3c15c: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x3c15e: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x3c160: {"kind": "branch", "py": None, "slot_py": 'r[4] = s8(0x00)', "target": 0x3c16a, "cond": 'notT'},
    0x3c164: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC5B7, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x3c166: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFC5B8, 1, r[4])', "target": 0x3c190, "cond": 'always'},
    0x3c16a: {"kind": 'reg', "py": 'r[1] = 0xFFFFC5A5', "slot_py": None, "target": None, "cond": None},
    0x3c16c: {"kind": 'mem', "py": 'r[2] = s8(_rdw(ram, 0xFFFFC5A5, 1))', "slot_py": None, "target": None, "cond": None},
    0x3c16e: {"kind": 'reg', "py": 'T = 1 if (r[2] & r[2]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x3c170: {"kind": "branch", "py": None, "slot_py": 'r[7] = s8(0x01)', "target": 0x3c176, "cond": 'notT'},
    0x3c174: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC5B8, 1, r[7])', "slot_py": None, "target": None, "cond": None},
    0x3c176: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, r[5], 1))', "slot_py": None, "target": None, "cond": None},
    0x3c178: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x3c17a: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x3c17c: {"kind": "branch", "py": None, "slot_py": '', "target": 0x3c184, "cond": 'notT'},
    0x3c180: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFC5B7, 1, r[4])', "target": 0x3c190, "cond": 'always'},
    0x3c184: {"kind": 'reg', "py": 'r[2] = 0xFFFFC5A4', "slot_py": None, "target": None, "cond": None},
    0x3c186: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFC5A4, 1))', "slot_py": None, "target": None, "cond": None},
    0x3c188: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x3c18a: {"kind": "branch", "py": None, "slot_py": '', "target": 0x3c190, "cond": 'notT'},
    0x3c18e: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC5B7, 1, r[7])', "slot_py": None, "target": None, "cond": None},
    0x3c190: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
