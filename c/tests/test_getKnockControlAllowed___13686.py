#!/usr/bin/env python3
"""Differential test for getKnockControlAllowed__ (0x13686) — v3 lift + v4 FPU, 80 bytes.
...
Run from repo root: python3 c/tests/test_getKnockControlAllowed___13686.py
"""
...
ENTRY = 0x13686
RAW = bytes.fromhex("93 4F D4 2E D1 2F 62 10 22 28 8F 1D F4 38 90 49 62 01 D1 2C 63 11 32 32 8F 16 00 09 D3 2B 92 42 F3 38 F2 28 F3 25 8D 0F 00 09 D1 28 F1 18 93 3B F0 38 F1 05 8D 08 00 09 D2 26 F3 28 F3 45 8F 03 00 09 E1 01 A0 02 24 10 E2 00 24 20 00 0B 00 09")
SEED = 43
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFC0D8
SPAN_END = 0x136D6
SENT = 0x136D6     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x13686: {"kind": 'reg', "py": 'r[3] = 0xFFFFB594', "slot_py": None, "target": None, "cond": None},
    0x13688: {"kind": 'reg', "py": 'r[4] = 0xFFFFA738', "slot_py": None, "target": None, "cond": None},
    0x1368a: {"kind": 'reg', "py": 'r[1] = 0x00078E7E', "slot_py": None, "target": None, "cond": None},
    0x1368c: {"kind": 'mem', "py": 'r[2] = s8(_rdw(ram, 0x00078E7E, 1))', "slot_py": None, "target": None, "cond": None},
    0x1368e: {"kind": 'reg', "py": 'T = 1 if (r[2] & r[2]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x13690: {"kind": "branch", "py": None, "slot_py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFB594, 4))', "target": 0x136ce, "cond": 'notT'},
    0x13694: {"kind": 'reg', "py": 'r[0] = 0xFFFFA424', "slot_py": None, "target": None, "cond": None},
    0x13696: {"kind": 'mem', "py": 'r[2] = s16(_rdw(ram, 0xFFFFA424, 2))', "slot_py": None, "target": None, "cond": None},
    0x13698: {"kind": 'reg', "py": 'r[1] = 0x00078548', "slot_py": None, "target": None, "cond": None},
    0x1369a: {"kind": 'mem', "py": 'r[3] = s16(_rdw(ram, 0x00078548, 2))', "slot_py": None, "target": None, "cond": None},
    0x1369c: {"kind": 'reg', "py": 'T = 1 if (r[2] & 0xFFFFFFFF) >= (r[3] & 0xFFFFFFFF) else 0', "slot_py": None, "target": None, "cond": None},
    0x1369e: {"kind": "branch", "py": None, "slot_py": '', "target": 0x136ce, "cond": 'notT'},
    0x136a2: {"kind": 'reg', "py": 'r[3] = 0x0007854C', "slot_py": None, "target": None, "cond": None},
    0x136a4: {"kind": 'reg', "py": 'r[2] = 0xFFFFA9FC', "slot_py": None, "target": None, "cond": None},
    0x136a6: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x0007854C, 4))', "slot_py": None, "target": None, "cond": None},
    0x136a8: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0xFFFFA9FC, 4))', "slot_py": None, "target": None, "cond": None},
    0x136aa: {"kind": 'fpu', "py": 'T = 1 if fr[3] > fr[2] else 0', "slot_py": None, "target": None, "cond": None},
    0x136ac: {"kind": "branch", "py": None, "slot_py": '', "target": 0x136ce, "cond": 'T'},
    0x136b0: {"kind": 'reg', "py": 'r[1] = 0x00078550', "slot_py": None, "target": None, "cond": None},
    0x136b2: {"kind": 'fpu', "py": 'fr[1] = bits2f(_rdw(ram, 0x00078550, 4))', "slot_py": None, "target": None, "cond": None},
    0x136b4: {"kind": 'reg', "py": 'r[3] = 0xFFFFC0D8', "slot_py": None, "target": None, "cond": None},
    0x136b6: {"kind": 'fpu', "py": 'fr[0] = bits2f(_rdw(ram, 0xFFFFC0D8, 4))', "slot_py": None, "target": None, "cond": None},
    0x136b8: {"kind": 'fpu', "py": 'T = 1 if fr[1] > fr[0] else 0', "slot_py": None, "target": None, "cond": None},
    0x136ba: {"kind": "branch", "py": None, "slot_py": '', "target": 0x136ce, "cond": 'T'},
    0x136be: {"kind": 'reg', "py": 'r[2] = 0x00078554', "slot_py": None, "target": None, "cond": None},
    0x136c0: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x00078554, 4))', "slot_py": None, "target": None, "cond": None},
    0x136c2: {"kind": 'fpu', "py": 'T = 1 if fr[3] > fr[4] else 0', "slot_py": None, "target": None, "cond": None},
    0x136c4: {"kind": "branch", "py": None, "slot_py": '', "target": 0x136ce, "cond": 'notT'},
    0x136c8: {"kind": 'reg', "py": 'r[1] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x136ca: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFA738, 1, r[1])', "target": 0x136d2, "cond": 'always'},
    0x136ce: {"kind": 'reg', "py": 'r[2] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x136d0: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA738, 1, r[2])', "slot_py": None, "target": None, "cond": None},
    0x136d2: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
