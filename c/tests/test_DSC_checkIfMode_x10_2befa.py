#!/usr/bin/env python3
"""Differential test for DSC_checkIfMode_x10 (0x2BEFA) — v3 lift (branches + delay slots), 30 bytes.
...
Run from repo root: python3 c/tests/test_DSC_checkIfMode_x10_2befa.py
"""
...
ENTRY = 0x2BEFA
RAW = bytes.fromhex("94 48 D3 26 60 30 60 0C C9 10 88 10 8F 03 00 09 E1 01 A0 02 24 10 E0 00 24 00 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBC2A
SPAN_END = 0x2BF18
SENT = 0x2BF18     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x2befa: {"kind": 'reg', "py": 'r[4] = 0xFFFFBC02', "slot_py": None, "target": None, "cond": None},
    0x2befc: {"kind": 'reg', "py": 'r[3] = 0xFFFFBC2A', "slot_py": None, "target": None, "cond": None},
    0x2befe: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFBC2A, 1))', "slot_py": None, "target": None, "cond": None},
    0x2bf00: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x2bf02: {"kind": 'reg', "py": 'r[0] = (r[0] & 0x10) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x2bf04: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x10) else 0', "slot_py": None, "target": None, "cond": None},
    0x2bf06: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2bf10, "cond": 'notT'},
    0x2bf0a: {"kind": 'reg', "py": 'r[1] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x2bf0c: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFBC02, 1, r[1])', "target": 0x2bf14, "cond": 'always'},
    0x2bf10: {"kind": 'reg', "py": 'r[0] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x2bf12: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBC02, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x2bf14: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
