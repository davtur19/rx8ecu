#!/usr/bin/env python3
"""Differential test for housing_temp_0x58904 (0x58904) — v3 lift (branches + delay slots), 22 bytes.
...
Run from repo root: python3 c/tests/test_housing_temp_0x58904_58904.py
"""
...
ENTRY = 0x58904
RAW = bytes.fromhex("88 01 8F 03 00 09 E2 00 A0 02 26 20 E1 01 26 10 4F 26 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = None
SPAN_END = 0x5891A
SENT = 0x5891A     # stop-sentinel, placed past the literal pool
...
CODE = {
    ...
    0x5890c: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, r[6], 1, r[2])', "target": 0x58914, "cond": 'always'},
    0x58910: {"kind": 'reg', "py": 'r[1] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x58912: {"kind": 'mem', "py": '_wrw(ram, r[6], 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x58914: {"kind": 'mem', "py": 'pr = _rdw(ram, STACK_BASE + 0x400, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
