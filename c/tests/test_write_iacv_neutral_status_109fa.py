#!/usr/bin/env python3
"""Differential test for write_iacv_neutral_status (0x109FA) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_write_iacv_neutral_status_109fa.py
"""
...
CODE = {
    0x109fa: {"kind": 'reg', "py": 'r[2] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x109fc: {"kind": 'reg', "py": 'r[1] = 0xFFFFA5D5', "slot_py": None, "target": None, "cond": None},
    0x109fe: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFA5D5, 1, r[2])', "target": None, "cond": None},}
