#!/usr/bin/env python3
"""Differential test for FUN_0003ba48 (0x3BA48) — v3 lift + v4 FPU, 72 bytes.
...
Run from repo root: python3 c/tests/test_FUN_0003ba48_3ba48.py
"""
...
ENTRY = 0x3BA48
RAW = bytes.fromhex("D2 3F 63 20 91 6C 21 30 D3 3E 60 30 92 69 22 00 91 68 F4 18 93 67 F3 4A 92 66 F2 4A D4 3A 61 40 90 63 20 10 63 40 91 61 D4 38 21 30 63 40 92 5E 22 30 60 40 93 5C 23 00 D4 35 61 40 90 59 20 10 62 40 91 57 00 0B 21 20")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCD8C
SPAN_END = 0x3BA90
SENT = 0x3BA90     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x3ba48: {"kind": 'reg', "py": 'r[2] = 0x00079714', "slot_py": None, "target": None, "cond": None},
    0x3ba4a: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0x00079714, 1))', "slot_py": None, "target": None, "cond": None},
    0x3ba4c: {"kind": 'reg', "py": 'r[1] = 0xFFFFC5A4', "slot_py": None, "target": None, "cond": None},
    0x3ba4e: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC5A4, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x3ba50: {"kind": 'reg', "py": 'r[3] = 0x00079713', "slot_py": None, "target": None, "cond": None},
    0x3ba52: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0x00079713, 1))', "slot_py": None, "target": None, "cond": None},
    0x3ba54: {"kind": 'reg', "py": 'r[2] = 0xFFFFC5A5', "slot_py": None, "target": None, "cond": None},
    0x3ba56: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC5A5, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x3ba58: {"kind": 'reg', "py": 'r[1] = 0xFFFFCD8C', "slot_py": None, "target": None, "cond": None},
    0x3ba5a: {"kind": 'fpu', "py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFCD8C, 4))', "slot_py": None, "target": None, "cond": None},
    0x3ba5c: {"kind": 'reg', "py": 'r[3] = 0xFFFFC59C', "slot_py": None, "target": None, "cond": None},
    0x3ba5e: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFC59C, 4, f2bits(fr[4]))', "slot_py": None, "target": None, "cond": None},
    0x3ba60: {"kind": 'reg', "py": 'r[2] = 0xFFFFC5A0', "slot_py": None, "target": None, "cond": None},
    0x3ba62: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFC5A0, 4, f2bits(fr[4]))', "slot_py": None, "target": None, "cond": None},
    0x3ba64: {"kind": 'reg', "py": 'r[4] = 0x00079715', "slot_py": None, "target": None, "cond": None},
    0x3ba66: {"kind": 'mem', "py": 'r[1] = s8(_rdw(ram, 0x00079715, 1))', "slot_py": None, "target": None, "cond": None},
    0x3ba68: {"kind": 'reg', "py": 'r[0] = 0xFFFFC5A6', "slot_py": None, "target": None, "cond": None},
    0x3ba6a: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC5A6, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x3ba6c: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0x00079715, 1))', "slot_py": None, "target": None, "cond": None},
    0x3ba6e: {"kind": 'reg', "py": 'r[1] = 0xFFFFC5A7', "slot_py": None, "target": None, "cond": None},
    0x3ba70: {"kind": 'reg', "py": 'r[4] = 0x00079712', "slot_py": None, "target": None, "cond": None},
    0x3ba72: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC5A7, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x3ba74: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0x00079712, 1))', "slot_py": None, "target": None, "cond": None},
    0x3ba76: {"kind": 'reg', "py": 'r[2] = 0xFFFFC5A8', "slot_py": None, "target": None, "cond": None},
    0x3ba78: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC5A8, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x3ba7a: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0x00079712, 1))', "slot_py": None, "target": None, "cond": None},
    0x3ba7c: {"kind": 'reg', "py": 'r[3] = 0xFFFFC5A9', "slot_py": None, "target": None, "cond": None},
    0x3ba7e: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC5A9, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x3ba80: {"kind": 'reg', "py": 'r[4] = 0x00079718', "slot_py": None, "target": None, "cond": None},
    0x3ba82: {"kind": 'mem', "py": 'r[1] = s8(_rdw(ram, 0x00079718, 1))', "slot_py": None, "target": None, "cond": None},
    0x3ba84: {"kind": 'reg', "py": 'r[0] = 0xFFFFC5AA', "slot_py": None, "target": None, "cond": None},
    0x3ba86: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC5AA, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x3ba88: {"kind": 'mem', "py": 'r[2] = s8(_rdw(ram, 0x00079718, 1))', "slot_py": None, "target": None, "cond": None},
    0x3ba8a: {"kind": 'reg', "py": 'r[1] = 0xFFFFC5AB', "slot_py": None, "target": None, "cond": None},
    0x3ba8c: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFC5AB, 1, r[2])', "target": None, "cond": None},}
