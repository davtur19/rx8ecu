#!/usr/bin/env python3
"""Differential test for writeWatchdog_disable_ (0x5024) — v3 lift (branches + delay slots), 14 bytes.
...
Run from repo root: python3 c/tests/test_writeWatchdog_disable__5024.py
"""
...
ENTRY = 0x5024
RAW = bytes.fromhex("91 93 90 93 20 11 D3 60 92 91 00 0B 22 31")
SEED = 0
N = 2000
MAXSTEPS = 100000
