#!/usr/bin/env python3
"""Differential test for watchdogTimerRead (0x31C) — v3 lift (branches + delay slots), 28 bytes.
...
Run from repo root: python3 c/tests/test_watchdogTimerRead_31c.py
"""
...
ENTRY = 0x31C
RAW = bytes.fromhex("94 6C 60 40 60 0C C8 80 89 06 D2 38 24 21 93 66 D2 37 61 31 21 2A 23 11 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    0x31c: {"kind": 'reg', "py": 'r[4] = 0xFFFFEC10', "slot_py": None, "target": None, "cond": None},
    0x31e: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFEC10, 1))', "slot_py": None, "target": None, "cond": None},
    0x320: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x322: {"kind": 'reg', "py": 'T = 1 if (r[0] & 0x80) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x324: {"kind": "branch", "py": None, "slot_py": None, "target": 0x334, "cond": 'T'},
    0x326: {"kind": 'reg', "py": 'r[2] = 0x0000A53C', "slot_py": None, "target": None, "cond": None},
    0x328: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFEC10, 2, r[2])', "slot_py": None, "target": None, "cond": None},
    0x32a: {"kind": 'reg', "py": 'r[3] = 0xFFFFF738', "slot_py": None, "target": None, "cond": None},
    0x32c: {"kind": 'reg', "py": 'r[2] = 0x00008000', "slot_py": None, "target": None, "cond": None},
    0x32e: {"kind": 'mem', "py": 'r[1] = s16(_rdw(ram, 0xFFFFF738, 2))', "slot_py": None, "target": None, "cond": None},
    0x330: {"kind": 'reg', "py": 'r[1] = (r[1] ^ r[2]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x332: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFF738, 2, r[1])', "slot_py": None, "target": None, "cond": None},
    0x334: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
