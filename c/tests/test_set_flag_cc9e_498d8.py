#!/usr/bin/env python3
"""Differential test for set_flag_cc9e (0x498D8) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_set_flag_cc9e_498d8.py
"""
...
ENTRY = 0x498D8
RAW = bytes.fromhex("D2 40 E3 01 00 0B 22 30")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCC9E
SPAN_END = 0x498E0
SENT = 0x498E0     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x498d8: {"kind": 'reg', "py": 'r[2] = 0xFFFFCC9E', "slot_py": None, "target": None, "cond": None},
    0x498da: {"kind": 'reg', "py": 'r[3] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x498dc: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFCC9E, 1, r[3])', "target": None, "cond": None},}
