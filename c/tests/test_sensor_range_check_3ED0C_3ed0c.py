#!/usr/bin/env python3
"""Differential test for sensor_range_check_3ED0C (0x3ED0C) — v3 lift + v4 FPU, 48 bytes.
...
Run from repo root: python3 c/tests/test_sensor_range_check_3ED0C_3ed0c.py
"""
...
RAM_MAX = None
SPAN_END = 0x3ED3C
SENT = 0x3ED3C     # stop-sentinel, placed past the literal pool
