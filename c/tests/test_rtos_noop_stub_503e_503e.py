#!/usr/bin/env python3
"""Differential test for rtos_noop_stub_503e (0x503E) — v3 lift (branches + delay slots), 24 bytes.
...
Run from repo root: python3 c/tests/test_rtos_noop_stub_503e_503e.py
"""
...
ENTRY = 0x503E
RAW = bytes.fromhex("94 89 93 89 23 40 92 88 22 40 91 87 21 40 73 18 23 40 72 18 00 0B 22 40")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFF020
SPAN_END = 0x5056
SENT = 0x5056     # stop-sentinel, placed past the literal pool
...
CODE = {
    ...
    0x504e: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFF018, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x5050: {"kind": 'reg', "py": 'r[2] = (r[2] + s8(0x18)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x5052: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFF020, 1, r[4])', "target": None, "cond": None},}
