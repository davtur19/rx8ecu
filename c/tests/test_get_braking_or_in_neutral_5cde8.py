#!/usr/bin/env python3
"""Differential test for get_braking_or_in_neutral (0x5CDE8) — v3 lift (branches + delay slots), 24 bytes.
...
Run from repo root: python3 c/tests/test_get_braking_or_in_neutral_5cde8.py
"""
...
ENTRY = 0x5CDE8
RAW = bytes.fromhex("91 30 62 10 D0 1A 20 20 92 2D E0 10 D1 19 63 20 21 30 D3 19 00 0B 23 00")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFD1A6
SPAN_END = 0x5CE00
SENT = 0x5CE00     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x5cde8: {"kind": 'reg', "py": 'r[1] = 0xFFFFD19C', "slot_py": None, "target": None, "cond": None},
    0x5cdea: {"kind": 'mem', "py": 'r[2] = s8(_rdw(ram, 0xFFFFD19C, 1))', "slot_py": None, "target": None, "cond": None},
    0x5cdec: {"kind": 'reg', "py": 'r[0] = 0xFFFFD1A4', "slot_py": None, "target": None, "cond": None},
    0x5cdee: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD1A4, 1, r[2])', "slot_py": None, "target": None, "cond": None},
    0x5cdf0: {"kind": 'reg', "py": 'r[2] = 0xFFFFD19D', "slot_py": None, "target": None, "cond": None},
    0x5cdf2: {"kind": 'reg', "py": 'r[0] = s8(0x10)', "slot_py": None, "target": None, "cond": None},
    0x5cdf4: {"kind": 'reg', "py": 'r[1] = 0xFFFFD1A5', "slot_py": None, "target": None, "cond": None},
    0x5cdf6: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFD19D, 1))', "slot_py": None, "target": None, "cond": None},
    0x5cdf8: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD1A5, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x5cdfa: {"kind": 'reg', "py": 'r[3] = 0xFFFFD1A6', "slot_py": None, "target": None, "cond": None},
    0x5cdfc: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFD1A6, 1, r[0])', "target": None, "cond": None},}
