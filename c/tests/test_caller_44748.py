#!/usr/bin/env python3
"""Differential test for caller_44748 (entry 0x44748) — v8 ST caller (CFG), 58 bytes.
...
Run: python3 test_caller_44748.py
"""
...
CODE = {
    0x44748: {"kind": 'st', "py": 'local[0x3FC] = pr\n_wrw(ram, STACK_BASE + 0x3FC, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x4474a: {"kind": 'reg', "py": 'r[3] = 0xFFFFCAB4', "slot_py": None, "target": None, "cond": None},
    0x4474c: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCAB4, 1))', "slot_py": None, "target": None, "cond": None},
    0x4474e: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x44750: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x44752: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4477c, "cond": 'notT'},
    0x44756: {"kind": 'reg', "py": 'r[0] = 0x0004480C', "slot_py": None, "target": None, "cond": None},
    0x44758: {"kind": 'reg', "py": 'r[2] = 0xFFFFBCFC', "slot_py": None, "target": None, "cond": None},
    0x4475a: {"kind": 'fpu', "py": 'fr[6] = bits2f(_rdw(ram, 0x0004480C, 4))', "slot_py": None, "target": None, "cond": None},
    0x4475c: {"kind": 'reg', "py": 'r[0] = 0x00044810', "slot_py": None, "target": None, "cond": None},
    0x4475e: {"kind": 'fpu', "py": 'fr[5] = bits2f(_rdw(ram, 0x00044810, 4))', "slot_py": None, "target": None, "cond": None},
    0x44760: {"kind": 'reg', "py": 'r[1] = 0x00002404', "slot_py": None, "target": None, "cond": None},
    0x44762: {"kind": "call", "py": None, "slot_py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFBCFC, 4))', "target": 0x2404, "ret_pc": 0x44766, "set_pr": True, "cond": None},
    0x44766: {"kind": 'reg', "py": 'r[3] = 0xFFFFCA24', "slot_py": None, "target": None, "cond": None},
    0x44768: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFCA24, 4, f2bits(fr[0]))', "slot_py": None, "target": None, "cond": None},
    0x4476a: {"kind": 'reg', "py": 'r[2] = 0xFFFFBD04', "slot_py": None, "target": None, "cond": None},
    0x4476c: {"kind": 'reg', "py": 'r[1] = 0xFFFFCA28', "slot_py": None, "target": None, "cond": None},
    0x4476e: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFBD04, 4))', "slot_py": None, "target": None, "cond": None},
    0x44770: {"kind": 'fpu', "py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFCA28, 4))', "slot_py": None, "target": None, "cond": None},
    0x44772: {"kind": 'fpu', "py": 'fr[4] = ts(fr[4] * fr[3])', "slot_py": None, "target": None, "cond": None},
    0x44774: {"kind": 'fpu', "py": 'fr[4] = ts(fr[4] / fr[0])', "slot_py": None, "target": None, "cond": None},
    0x44776: {"kind": 'fpu', "py": 'fr[4] = fr[4]', "slot_py": None, "target": None, "cond": None},
    0x44778: {"kind": 'reg', "py": 'r[3] = 0xFFFFCA20', "slot_py": None, "target": None, "cond": None},
    0x4477a: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFCA20, 4, f2bits(fr[4]))', "slot_py": None, "target": None, "cond": None},
    0x4477c: {"kind": 'st', "py": 'pr = _rdw(ram, STACK_BASE + 0x3FC, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x4477e: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},
