#!/usr/bin/env python3
"""Differential test for FUN_00029e74 (0x29E74) — v3 lift (branches + delay slots), 16 bytes.
...
Run from repo root: python3 c/tests/test_FUN_00029e74_29e74.py
"""
...
ENTRY = 0x29E74
RAW = bytes.fromhex("23 38 8D 03 00 09 90 07 34 0C 25 40 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = None
SPAN_END = 0x29E84
SENT = 0x29E84     # stop-sentinel, placed past the literal pool
...
CODE = {
    ...
    0x29e7e: {"kind": 'mem', "py": '_wrw(ram, r[5], 1, r[4])', "slot_py": None, "target": None, "cond": None},
