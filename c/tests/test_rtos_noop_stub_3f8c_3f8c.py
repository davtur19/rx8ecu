#!/usr/bin/env python3
"""Differential test for rtos_noop_stub_3f8c (0x3F8C) — v3 lift (branches + delay slots), 12 bytes.
...
Run from repo root: python3 c/tests/test_rtos_noop_stub_3f8c_3f8c.py
"""
...
ENTRY = 0x3F8C
RAW = bytes.fromhex("00 0B 00 09 D2 01 E3 00 00 0B 22 30")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFF72DC
SPAN_END = 0x3F98
SENT = 0x3F9C     # stop-sentinel, placed past the literal pool
...
CODE = {
    ...
    0x3f90: {"kind": 'reg', "py": 'r[2] = 0xFFFF72DC', "slot_py": None, "target": None, "cond": None},
    0x3f92: {"kind": 'reg', "py": 'r[3] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x3f94: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFF72DC, 1, r[3])', "target": None, "cond": None},}
