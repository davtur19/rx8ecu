#!/usr/bin/env python3
"""Differential test for caller_4C0DE (entry 0x4C0DE) — v8 ST caller (CFG), 24 bytes.
...
Run: python3 test_caller_4C0DE.py
"""
...
CODE = {
    0x4c0de: {"kind": 'fpu', "py": 'fr[5] = 0.0', "slot_py": None, "target": None, "cond": None},
    0x4c0e0: {"kind": 'reg', "py": 'r[0] = 0x0004C1D0', "slot_py": None, "target": None, "cond": None},
    0x4c0e2: {"kind": 'st', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x4c0e4: {"kind": 'fpu', "py": 'fr[4] = bits2f(_rdw(ram, 0x0004C1D0, 4))', "slot_py": None, "target": None, "cond": None},
    0x4c0e6: {"kind": 'reg', "py": 'r[3] = 0xFFFFC014', "slot_py": None, "target": None, "cond": None},
    0x4c0e8: {"kind": 'reg', "py": 'r[2] = 0x00002500', "slot_py": None, "target": None, "cond": None},
    0x4c0ea: {"kind": "call", "py": None, "slot_py": 'r[4] = s8(_rdw(ram, 0xFFFFC014, 1))', "target": 0x2500, "ret_pc": 0x4c0ee, "set_pr": True, "cond": None},
    0x4c0ee: {"kind": 'reg', "py": 'r[1] = 0xFFFFCD8C', "slot_py": None, "target": None, "cond": None},
    0x4c0f0: {"kind": 'st', "py": 'pr = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x4c0f2: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFCD8C, 4, f2bits(fr[0]))', "target": None, "cond": None},
