#!/usr/bin/env python3
"""Differential test for check_status_bit_c633 (0x3DD46) — v3 lift (branches + delay slots), 32 bytes.
...
Run from repo root: python3 c/tests/test_check_status_bit_c633_3dd46.py
"""
...
ENTRY = 0x3DD46
RAW = bytes.fromhex("94 7B D3 46 60 30 60 0C C8 04 00 29 88 01 8F 03 00 09 E3 00 A0 02 24 30 E1 01 24 10 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFC633
SPAN_END = 0x3DD66
SENT = 0x3DD66     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x3dd46: {"kind": 'reg', "py": 'r[4] = 0xFFFFC633', "slot_py": None, "target": None, "cond": None},
    0x3dd48: {"kind": 'reg', "py": 'r[3] = 0xFFFF9ECE', "slot_py": None, "target": None, "cond": None},
    0x3dd4a: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFF9ECE, 1))', "slot_py": None, "target": None, "cond": None},
    0x3dd4c: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x3dd4e: {"kind": 'reg', "py": 'T = 1 if (r[0] & 0x04) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x3dd50: {"kind": 'reg', "py": 'r[0] = T;', "slot_py": None, "target": None, "cond": None},
    0x3dd52: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x3dd54: {"kind": "branch", "py": None, "slot_py": '', "target": 0x3dd5e, "cond": 'notT'},
    0x3dd58: {"kind": 'reg', "py": 'r[3] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x3dd5a: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFC633, 1, r[3])', "target": 0x3dd62, "cond": 'always'},
    0x3dd5e: {"kind": 'reg', "py": 'r[1] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x3dd60: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC633, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x3dd62: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
