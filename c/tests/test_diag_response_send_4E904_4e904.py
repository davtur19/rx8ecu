#!/usr/bin/env python3
"""Differential test for diag_response_send_4E904 (0x4E904) — pure straight-line lift, 8 bytes.
...
Run from repo root: python3 c/tests/test_diag_response_send_4E904_4e904.py
"""
...
ENTRY = 0x4E904
RAW = bytes.fromhex("92 14 E1 01 90 13 E3 00")
SEED = 42
N = 2000
