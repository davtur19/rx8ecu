#!/usr/bin/env python3
"""Differential test for fuel_state_mode_a574_update (0xFF14) — v3 lift (branches + delay slots), 34 bytes.
...
Run from repo root: python3 c/tests/test_fuel_state_mode_a574_update_ff14.py
"""
...
ENTRY = 0xFF14
RAW = bytes.fromhex("93 77 64 30 64 4C 24 48 8D 07 00 09 92 72 61 20 21 18 8F 02 00 09 A0 01 E4 02 E4 00 D2 38 00 0B 22 40")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBE5C
SPAN_END = 0xFF36
SENT = 0xFF36     # stop-sentinel, placed past the literal pool
...
CODE = {
    ...
    0xff32: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFA574, 1, r[4])', "target": None, "cond": None},}
