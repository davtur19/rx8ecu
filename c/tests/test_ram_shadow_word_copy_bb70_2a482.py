#!/usr/bin/env python3
"""Differential test for ram_shadow_word_copy_bb70 (0x2A482) — v3 lift (branches + delay slots), 10 bytes.
...
Run from repo root: python3 c/tests/test_ram_shadow_word_copy_bb70_2a482.py
"""
...
ENTRY = 0x2A482
RAW = bytes.fromhex("92 26 D1 18 63 21 00 0B 21 31")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBB88
SPAN_END = 0x2A48C
SENT = 0x2A48C     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x2a482: {"kind": 'reg', "py": 'r[2] = 0xFFFFBB70', "slot_py": None, "target": None, "cond": None},
    0x2a484: {"kind": 'reg', "py": 'r[1] = 0xFFFFBB88', "slot_py": None, "target": None, "cond": None},
    0x2a486: {"kind": 'mem', "py": 'r[3] = s16(_rdw(ram, 0xFFFFBB70, 2))', "slot_py": None, "target": None, "cond": None},
    0x2a488: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBB88, 2, r[3])', "target": None, "cond": None},}
