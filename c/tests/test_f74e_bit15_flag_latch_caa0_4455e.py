#!/usr/bin/env python3
"""Differential test for f74e_bit15_flag_latch_caa0 (0x4455E) — v3 lift (branches + delay slots), 66 bytes.
...
Run from repo root: python3 c/tests/test_f74e_bit15_flag_latch_caa0_4455e.py
"""
...
ENTRY = 0x4455E
RAW = bytes.fromhex("92 19 64 21 64 4D D3 0C 24 38 97 15 04 29 D6 0B 60 4C 65 60 88 01 8F 07 65 5C 60 53 88 01 8F 08 00 09 E3 01 A0 05 27 30 25 58 8F 02 00 09 E2 00 27 20 00 0B 26 40 F7 4E CA A0 00 00 80 00 FF FF CA A1")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFF74E
SPAN_END = 0x445A0
SENT = 0x445A0     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x4455e: {"kind": 'reg', "py": 'r[2] = 0xFFFFF74E', "slot_py": None, "target": None, "cond": None},
    0x44560: {"kind": 'mem', "py": 'r[4] = s16(_rdw(ram, 0xFFFFF74E, 2))', "slot_py": None, "target": None, "cond": None},
    0x44562: {"kind": 'reg', "py": 'r[4] = r[4] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x44564: {"kind": 'reg', "py": 'r[3] = 0x00008000', "slot_py": None, "target": None, "cond": None},
    0x44566: {"kind": 'reg', "py": 'T = 1 if (r[4] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x44568: {"kind": 'reg', "py": 'r[7] = 0xFFFFCAA0', "slot_py": None, "target": None, "cond": None},
    0x4456a: {"kind": 'reg', "py": 'r[4] = T;', "slot_py": None, "target": None, "cond": None},
    0x4456c: {"kind": 'reg', "py": 'r[6] = 0xFFFFCAA1', "slot_py": None, "target": None, "cond": None},
    0x4456e: {"kind": 'reg', "py": 'r[0] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x44570: {"kind": 'mem', "py": 'r[5] = s8(_rdw(ram, 0xFFFFCAA1, 1))', "slot_py": None, "target": None, "cond": None},
    0x44572: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x44574: {"kind": "branch", "py": None, "slot_py": 'r[5] = r[5] & 0xFF', "target": 0x44586, "cond": 'notT'},
    0x44578: {"kind": 'reg', "py": 'r[0] = r[5]', "slot_py": None, "target": None, "cond": None},
    0x4457a: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x4457c: {"kind": "branch", "py": None, "slot_py": '', "target": 0x44590, "cond": 'notT'},
    0x44580: {"kind": 'reg', "py": 'r[3] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x44582: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFCAA0, 1, r[3])', "target": 0x44590, "cond": 'always'},
    0x44586: {"kind": 'reg', "py": 'T = 1 if (r[5] & r[5]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x44588: {"kind": "branch", "py": None, "slot_py": '', "target": 0x44590, "cond": 'notT'},
    0x4458c: {"kind": 'reg', "py": 'r[2] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x4458e: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCAA0, 1, r[2])', "slot_py": None, "target": None, "cond": None},
    0x44590: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFCAA1, 1, r[4])', "target": None, "cond": None},}
