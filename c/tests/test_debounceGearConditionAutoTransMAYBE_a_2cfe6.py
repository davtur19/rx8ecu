#!/usr/bin/env python3
"""Differential test for debounceGearConditionAutoTransMAYBE_a (0x2CFE6) — v3 lift (branches + delay slots), 20 bytes.
...
Run from repo root: python3 c/tests/test_debounceGearConditionAutoTransMAYBE_a_2cfe6.py
"""
...
ENTRY = 0x2CFE6
RAW = bytes.fromhex("8F 02 00 09 A0 01 74 01 74 02 93 2A 23 40 6D F6 00 0B 6E F6")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBCB2
SPAN_END = 0x2CFFA
SENT = 0x2CFFA     # stop-sentinel, placed past the literal pool
...
CODE = {
    ...
    0x2cff2: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBCB2, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x2cff4: {"kind": 'mem', "py": 'r[13] = _rdw(ram, STACK_BASE + 0x400, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x2cff6: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, STACK_BASE + 0x404, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},}
