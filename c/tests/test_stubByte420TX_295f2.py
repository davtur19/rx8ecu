#!/usr/bin/env python3
"""Differential test for stubByte420TX (0x295F2) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_stubByte420TX_295f2.py
"""
...
RAM_MAX = 0xFFFFBAE6
SPAN_END = 0x295FA
SENT = 0x295FA     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x295f2: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x295f4: {"kind": 'reg', "py": 'r[3] = 0xFFFFBAE6', "slot_py": None, "target": None, "cond": None},
    0x295f6: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBAE6, 2, r[1])', "target": None, "cond": None},}
