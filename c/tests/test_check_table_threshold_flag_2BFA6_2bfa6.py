#!/usr/bin/env python3
"""Differential test for check_table_threshold_flag_2BFA6 (0x2BFA6) — v3 lift (branches + delay slots), 44 bytes.
...
Run from repo root: python3 c/tests/test_check_table_threshold_flag_2BFA6_2bfa6.py
"""
...
RAM_MAX = 0xFFFFBC26
SPAN_END = 0x2BFD2
SENT = 0x2BFD2     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x2bfa6: {"kind": 'reg', "py": 'r[4] = 0xFFFFBC21', "slot_py": None, "target": None, "cond": None},
    0x2bfa8: {"kind": 'reg', "py": 'r[2] = 0xFFFFBC14', "slot_py": None, "target": None, "cond": None},
    0x2bfaa: {"kind": 'mem', "py": 'r[3] = s16(_rdw(ram, 0xFFFFBC14, 2))', "slot_py": None, "target": None, "cond": None},
    0x2bfac: {"kind": 'reg', "py": 'r[1] = 0x0000FFFF', "slot_py": None, "target": None, "cond": None},
    0x2bfae: {"kind": 'reg', "py": 'r[3] = r[3] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x2bfb0: {"kind": 'reg', "py": 'T = 1 if r[3] == r[1] else 0', "slot_py": None, "target": None, "cond": None},
    0x2bfb2: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2bfc4, "cond": 'T'},
    0x2bfb6: {"kind": 'reg', "py": 'r[3] = 0xFFFFBC26', "slot_py": None, "target": None, "cond": None},
    0x2bfb8: {"kind": 'reg', "py": 'r[1] = 0x0007BA1C', "slot_py": None, "target": None, "cond": None},
    0x2bfba: {"kind": 'mem', "py": 'r[0] = s16(_rdw(ram, 0xFFFFBC26, 2))', "slot_py": None, "target": None, "cond": None},
    0x2bfbc: {"kind": 'mem', "py": 'r[2] = s16(_rdw(ram, 0x0007BA1C, 2))', "slot_py": None, "target": None, "cond": None},
    0x2bfbe: {"kind": 'reg', "py": 'T = 1 if (r[0] & 0xFFFFFFFF) >= (r[2] & 0xFFFFFFFF) else 0', "slot_py": None, "target": None, "cond": None},
    0x2bfc0: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2bfca, "cond": 'notT'},
    0x2bfc4: {"kind": 'reg', "py": 'r[3] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x2bfc6: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFBC21, 1, r[3])', "target": 0x2bfce, "cond": 'always'},
    0x2bfca: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x2bfcc: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBC21, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x2bfce: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
