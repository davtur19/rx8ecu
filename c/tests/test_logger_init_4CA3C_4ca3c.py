#!/usr/bin/env python3
"""Differential test for logger_init_4CA3C (0x4CA3C) — v3 lift (branches + delay slots), 38 bytes.
...
Run from repo root: python3 c/tests/test_logger_init_4CA3C_4ca3c.py
"""
...
CODE = {
    0x4ca3c: {"kind": 'reg', "py": 'r[2] = 0xFFFFCEE8', "slot_py": None, "target": None, "cond": None},
    0x4ca3e: {"kind": 'reg', "py": 'r[3] = s8(0x03)', "slot_py": None, "target": None, "cond": None},
    0x4ca40: {"kind": 'reg', "py": 'r[4] = 0x0007C880', "slot_py": None, "target": None, "cond": None},
    0x4ca42: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCEE8, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x4ca44: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0x0007C880, 1))', "slot_py": None, "target": None, "cond": None},
    0x4ca46: {"kind": 'reg', "py": 'r[1] = 0xFFFFCEDC', "slot_py": None, "target": None, "cond": None},
    0x4ca48: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCEDC, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x4ca4a: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0x0007C880, 1))', "slot_py": None, "target": None, "cond": None},
    0x4ca4c: {"kind": 'reg', "py": 'r[3] = 0xFFFFCEDD', "slot_py": None, "target": None, "cond": None},
    0x4ca4e: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCEDD, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x4ca50: {"kind": 'reg', "py": 'r[0] = 0x0007C881', "slot_py": None, "target": None, "cond": None},
    0x4ca52: {"kind": 'mem', "py": 'r[2] = s8(_rdw(ram, 0x0007C881, 1))', "slot_py": None, "target": None, "cond": None},
    0x4ca54: {"kind": 'reg', "py": 'r[1] = 0xFFFFCEDE', "slot_py": None, "target": None, "cond": None},
    0x4ca56: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCEDE, 1, r[2])', "slot_py": None, "target": None, "cond": None},
    0x4ca58: {"kind": 'reg', "py": 'r[2] = 0x0007C882', "slot_py": None, "target": None, "cond": None},
    0x4ca5a: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0x0007C882, 1))', "slot_py": None, "target": None, "cond": None},
    0x4ca5c: {"kind": 'reg', "py": 'r[1] = 0xFFFFCEDF', "slot_py": None, "target": None, "cond": None},
    0x4ca5e: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFCEDF, 1, r[3])', "target": None, "cond": None},}
