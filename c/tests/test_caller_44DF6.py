#!/usr/bin/env python3
"""Differential test for caller_44DF6 (entry 0x44DF6) — v8 ST caller (CFG), 20 bytes.
...
Run: python3 test_caller_44DF6.py
"""
...
CODE = {
    0x44df6: {"kind": 'st', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x44df8: {"kind": 'reg', "py": 'r[4] = 0xFFFF8754', "slot_py": None, "target": None, "cond": None},
    0x44dfa: {"kind": 'reg', "py": 'r[3] = 0x0003E1F8', "slot_py": None, "target": None, "cond": None},
    0x44dfc: {"kind": "call", "py": None, "slot_py": 'r[5] = s8(0x00)', "target": 0x3e1f8, "ret_pc": 0x44e00, "set_pr": True, "cond": None},
    0x44e00: {"kind": 'reg', "py": 'r[4] = 0xFFFF8756', "slot_py": None, "target": None, "cond": None},
    0x44e02: {"kind": 'reg', "py": 'r[5] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x44e04: {"kind": 'reg', "py": 'r[2] = 0x0003E1F8', "slot_py": None, "target": None, "cond": None},
    0x44e06: {"kind": "call", "py": None, "slot_py": 'pr = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": 0x3e1f8, "ret_pc": 0x44e0a, "set_pr": False, "cond": None},
