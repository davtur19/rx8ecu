#!/usr/bin/env python3
"""Differential test for caller_27738 (entry 0x27738) — v8 ST caller (CFG), 28 bytes.
...
Run: python3 test_caller_27738.py
"""
...
CODE = {
    0x27738: {"kind": 'st', "py": 'local[0x3FC] = pr\n_wrw(ram, STACK_BASE + 0x3FC, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x2773a: {"kind": 'fpu', "py": 'fr[5] = 0.0', "slot_py": None, "target": None, "cond": None},
    0x2773c: {"kind": 'reg', "py": 'r[0] = 0x00027784', "slot_py": None, "target": None, "cond": None},
    0x2773e: {"kind": 'reg', "py": 'r[4] = 0xFFFF9EF4', "slot_py": None, "target": None, "cond": None},
    0x27740: {"kind": 'reg', "py": 'r[3] = 0x000024C0', "slot_py": None, "target": None, "cond": None},
    0x27742: {"kind": 'mem', "py": 'r[4] = s16(_rdw(ram, 0xFFFF9EF4, 2))', "slot_py": None, "target": None, "cond": None},
    0x27744: {"kind": "call", "py": None, "slot_py": 'fr[4] = bits2f(_rdw(ram, 0x00027784, 4))', "target": 0x24c0, "ret_pc": 0x27748, "set_pr": True, "cond": None},
    0x27748: {"kind": 'reg', "py": 'r[2] = 0xFFFFB6C0', "slot_py": None, "target": None, "cond": None},
    0x2774a: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFB6C0, 4, f2bits(fr[0]))', "slot_py": None, "target": None, "cond": None},
    0x2774c: {"kind": 'reg', "py": 'r[3] = 0xFFFFB6C4', "slot_py": None, "target": None, "cond": None},
    0x2774e: {"kind": 'st', "py": 'pr = _rdw(ram, STACK_BASE + 0x3FC, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x27750: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFB6C4, 4, f2bits(fr[0]))', "target": None, "cond": None},
