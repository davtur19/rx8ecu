#!/usr/bin/env python3
"""Differential test for caller_D164 (entry 0xD164) — v8 ST caller (CFG), 22 bytes.
...
Run: python3 test_caller_D164.py
"""
...
CODE = {
    0xd164: {"kind": 'reg', "py": 'r[4] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0xd166: {"kind": 'reg', "py": 'r[3] = s8(0x20)', "slot_py": None, "target": None, "cond": None},
    0xd168: {"kind": 'reg', "py": 'T = 1 if s32(r[4]) >= s32(r[3]) else 0', "slot_py": None, "target": None, "cond": None},
    0xd16a: {"kind": "branch", "py": None, "slot_py": '', "target": 0xd172, "cond": 'T'},
    0xd16e: {"kind": "branch", "py": None, "slot_py": 'r[4] = r[5]', "target": 0xd176, "cond": 'always'},
    0xd172: {"kind": 'reg', "py": 'r[4] = 0x00000200', "slot_py": None, "target": None, "cond": None},
    0xd174: {"kind": 'reg', "py": 'r[4] = (r[4] + r[5]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xd176: {"kind": "ret", "py": None, "slot_py": 'r[0] = r[4]', "target": None, "cond": None},
}
