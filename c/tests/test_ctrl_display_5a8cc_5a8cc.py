#!/usr/bin/env python3
"""Differential test for ctrl_display_5a8cc (0x5A8CC) — v3 lift + v4 FPU, 30 bytes.
...
Run from repo root: python3 c/tests/test_ctrl_display_5a8cc_5a8cc.py
"""
...
RAM_MAX = 0xFFFFD28E
SPAN_END = 0x5A8EA
SENT = 0x5A8EA     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x5a8cc: {"kind": 'reg', "py": 'r[4] = 0xFFFFD280', "slot_py": None, "target": None, "cond": None},
    0x5a8ce: {"kind": 'reg', "py": 'r[1] = s8(0x30)', "slot_py": None, "target": None, "cond": None},
    0x5a8d0: {"kind": 'reg', "py": 'r[2] = 0xFFFFD28E', "slot_py": None, "target": None, "cond": None},
    0x5a8d2: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFD28E, 1))', "slot_py": None, "target": None, "cond": None},
    0x5a8d4: {"kind": 'reg', "py": 'r[3] = r[3] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x5a8d6: {"kind": 'reg', "py": 'T = 1 if s32(r[3]) >= s32(r[1]) else 0', "slot_py": None, "target": None, "cond": None},
    0x5a8d8: {"kind": "branch", "py": None, "slot_py": '', "target": 0x5a8e2, "cond": 'notT'},
    0x5a8dc: {"kind": 'reg', "py": 'r[3] = 0xFFFFA7C0', "slot_py": None, "target": None, "cond": None},
    0x5a8de: {"kind": "branch", "py": None, "slot_py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFA7C0, 4))', "target": 0x5a8e6, "cond": 'always'},
    0x5a8e2: {"kind": 'reg', "py": 'r[0] = 0x0007DAB0', "slot_py": None, "target": None, "cond": None},
    0x5a8e4: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x0007DAB0, 4))', "slot_py": None, "target": None, "cond": None},
    0x5a8e6: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, r[4], 4, f2bits(fr[3]))', "target": None, "cond": None},}
