#!/usr/bin/env python3
"""Differential test for caller_1CDC6 (entry 0x1CDC6) — v8 ST caller (CFG), 24 bytes.
...
Run: python3 test_caller_1CDC6.py
"""
...
CODE = {
    0x1cdc6: {"kind": 'fpu', "py": 'fr[5] = 0.0', "slot_py": None, "target": None, "cond": None},
    0x1cdc8: {"kind": 'reg', "py": 'r[0] = 0x0001CE98', "slot_py": None, "target": None, "cond": None},
    0x1cdca: {"kind": 'st', "py": 'local[0x3FC] = pr\n_wrw(ram, STACK_BASE + 0x3FC, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x1cdcc: {"kind": 'reg', "py": 'r[4] = 0xFFFF9F1E', "slot_py": None, "target": None, "cond": None},
    0x1cdce: {"kind": 'mem', "py": 'r[4] = s16(_rdw(ram, 0xFFFF9F1E, 2))', "slot_py": None, "target": None, "cond": None},
    0x1cdd0: {"kind": 'reg', "py": 'r[3] = 0x000024C0', "slot_py": None, "target": None, "cond": None},
    0x1cdd2: {"kind": "call", "py": None, "slot_py": 'fr[4] = bits2f(_rdw(ram, 0x0001CE98, 4))', "target": 0x24c0, "ret_pc": 0x1cdd6, "set_pr": True, "cond": None},
    0x1cdd6: {"kind": 'reg', "py": 'r[2] = 0xFFFFAE4C', "slot_py": None, "target": None, "cond": None},
    0x1cdd8: {"kind": 'st', "py": 'pr = _rdw(ram, STACK_BASE + 0x3FC, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x1cdda: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFAE4C, 4, f2bits(fr[0]))', "target": None, "cond": None},
