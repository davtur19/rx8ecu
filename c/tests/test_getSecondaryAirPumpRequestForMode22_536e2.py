#!/usr/bin/env python3
"""Differential test for getSecondaryAirPumpRequestForMode22 (0x536E2) — v3 lift (branches + delay slots), 22 bytes.
...
Run from repo root: python3 c/tests/test_getSecondaryAirPumpRequestForMode22_536e2.py
"""
...
ENTRY = 0x536E2
RAW = bytes.fromhex("93 57 60 30 60 0C 88 01 8F 02 00 09 A0 01 E4 01 E4 04 00 0B 60 43")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFA9D0
SPAN_END = 0x536F8
SENT = 0x536F8     # stop-sentinel, placed past the literal pool
