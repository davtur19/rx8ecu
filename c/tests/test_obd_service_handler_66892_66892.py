#!/usr/bin/env python3
"""Differential test for obd_service_handler_66892 (0x66892) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_obd_service_handler_66892_66892.py
"""
...
ENTRY = 0x66892
RAW = bytes.fromhex("7F 10 4F 26 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
STACK_OFFS = (0x410,)
SEED_OFFS = (0x410,)   # lds.l pr/macl/mach slots seeded with the return sentinel
RAM_MIN = None
RAM_MAX = None
SPAN_END = 0x6689A
SENT = 0x6689A     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x66892: {"kind": 'reg', "py": 'r[15] = (r[15] + s8(0x10)) & 0xFFFFFFFF\nsp = (sp + s8(0x10)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x66894: {"kind": 'mem', "py": 'pr = _rdw(ram, STACK_BASE + 0x410, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x66896: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
