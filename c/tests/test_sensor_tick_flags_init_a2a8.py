#!/usr/bin/env python3
"""Differential test for sensor_tick_flags_init (0xA2A8) — v3 lift (branches + delay slots), 14 bytes.
...
Run from repo root: python3 c/tests/test_sensor_tick_flags_init_a2a8.py
"""
...
ENTRY = 0xA2A8
RAW = bytes.fromhex("D2 3B E1 01 D0 3B E3 00 22 31 00 0B 20 10")
SEED = 43
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFA18A
SPAN_END = 0xA2B6
SENT = 0xA2B6     # stop-sentinel, placed past the literal pool
...
CODE = {
    0xa2a8: {"kind": 'reg', "py": 'r[2] = 0xFFFFA188', "slot_py": None, "target": None, "cond": None},
    0xa2aa: {"kind": 'reg', "py": 'r[1] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0xa2ac: {"kind": 'reg', "py": 'r[0] = 0xFFFFA18A', "slot_py": None, "target": None, "cond": None},
    0xa2ae: {"kind": 'reg', "py": 'r[3] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0xa2b0: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA188, 2, r[3])', "slot_py": None, "target": None, "cond": None},
    0xa2b2: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFA18A, 1, r[1])', "target": None, "cond": None},}
