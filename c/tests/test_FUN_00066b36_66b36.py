#!/usr/bin/env python3
"""Differential test for FUN_00066b36 (0x66B36) — pure straight-line lift, 10 bytes.
...
Run from repo root: python3 c/tests/test_FUN_00066b36_66b36.py
"""
...
ENTRY = 0x66B36
RAW = bytes.fromhex("00 09 D2 33 64 F3 D1 33 E5 03")
SEED = 42
N = 2000
