#!/usr/bin/env python3
"""Differential test for caller_51DDE (entry 0x51DDE) — v8 ST caller (CFG), 40 bytes.
...
Run: python3 test_caller_51DDE.py
"""
...
CODE = {
    0x51dde: {"kind": 'mem', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, r[14])\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x51de0: {"kind": 'st', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x51de2: {"kind": 'reg', "py": 'r[14] = 0xFFFFCFA8', "slot_py": None, "target": None, "cond": None},
    0x51de4: {"kind": 'reg', "py": 'r[3] = 0xFFFFA428', "slot_py": None, "target": None, "cond": None},
    0x51de6: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFA428, 1))', "slot_py": None, "target": None, "cond": None},
    0x51de8: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x51dea: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x51dec: {"kind": "branch", "py": None, "slot_py": '', "target": 0x51df6, "cond": 'notT'},
    0x51df0: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x51df2: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFCFA8, 1, r[1])', "target": 0x51e00, "cond": 'always'},
    0x51df6: {"kind": 'reg', "py": 'r[5] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x51df8: {"kind": 'reg', "py": 'r[1] = 0x00002478', "slot_py": None, "target": None, "cond": None},
    0x51dfa: {"kind": "call", "py": None, "slot_py": 'r[4] = s8(_rdw(ram, 0xFFFFCFA8, 1))', "target": 0x2478, "ret_pc": 0x51dfe, "set_pr": True, "cond": None},
    0x51dfe: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCFA8, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x51e00: {"kind": 'st', "py": 'pr = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x51e02: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},
