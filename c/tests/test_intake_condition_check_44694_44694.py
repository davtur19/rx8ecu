#!/usr/bin/env python3
"""Differential test for intake_condition_check_44694 (0x44694) — v3 lift + v4 FPU, 40 bytes.
...
Run from repo root: python3 c/tests/test_intake_condition_check_44694_44694.py
"""
...
RAM_MAX = 0xFFFFCAB5
SPAN_END = 0x446BC
SENT = 0x446BC     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x44694: {"kind": 'reg', "py": 'r[3] = 0xFFFFCAB4', "slot_py": None, "target": None, "cond": None},
    0x44696: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCAB4, 1))', "slot_py": None, "target": None, "cond": None},
    0x44698: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x4469a: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x4469c: {"kind": "branch", "py": None, "slot_py": '', "target": 0x446b8, "cond": 'notT'},
    0x446a0: {"kind": 'reg', "py": 'r[4] = 0xFFFFCA2C', "slot_py": None, "target": None, "cond": None},
    0x446a2: {"kind": 'reg', "py": 'r[2] = 0xFFFFCAB5', "slot_py": None, "target": None, "cond": None},
    0x446a4: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCAB5, 1))', "slot_py": None, "target": None, "cond": None},
    0x446a6: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x446a8: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x446aa: {"kind": "branch", "py": None, "slot_py": '', "target": 0x446b4, "cond": 'notT'},
    0x446ae: {"kind": 'fpu', "py": 'fr[3] = 1.0', "slot_py": None, "target": None, "cond": None},
    0x446b0: {"kind": "branch", "py": None, "slot_py": 'fr[3] = ts(fr[3] + fr[3])', "target": 0x446b6, "cond": 'always'},
    0x446b4: {"kind": 'fpu', "py": 'fr[3] = 0.0', "slot_py": None, "target": None, "cond": None},
    0x446b6: {"kind": 'fpu', "py": '_wrw(ram, r[4], 4, f2bits(fr[3]))', "slot_py": None, "target": None, "cond": None},
    0x446b8: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
