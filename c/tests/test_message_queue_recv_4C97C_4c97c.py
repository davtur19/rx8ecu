#!/usr/bin/env python3
"""Differential test for message_queue_recv_4C97C (0x4C97C) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_message_queue_recv_4C97C_4c97c.py
"""
...
CODE = {
    0x4c97c: {"kind": 'reg', "py": 'r[1] = 0xFFFFCEC8', "slot_py": None, "target": None, "cond": None},
    0x4c97e: {"kind": 'reg', "py": 'r[3] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x4c980: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFCEC8, 2, r[3])', "target": None, "cond": None},}
