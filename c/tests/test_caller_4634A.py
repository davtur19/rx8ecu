#!/usr/bin/env python3
"""Differential test for call-composition caller_4634A (entry 0x4634A) — v7 ST caller + callee lib, flattened CODE with nested returns.
...
Run: python3 /home/davide/ailocal/rx8ecu/c/tests/test_caller_4634A.py
"""
...
CODE = {
    0x4634a: {"kind": 'reg', "py": 'r[4] = 0xFFFF8754', "slot_py": None, "target": None, "cond": None},
    0x4634c: {"kind": 'reg', "py": 'r[3] = 0x0003EE58', "slot_py": None, "target": None, "cond": None},
    0x4634e: {"kind": "call", "py": None, "slot_py": 'r[5] = s8(0x00)', "target": 0x3ee58, "ret_pc": 0x46352, "set_pr": False, "cond": None},
