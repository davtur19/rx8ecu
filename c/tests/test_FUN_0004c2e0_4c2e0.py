#!/usr/bin/env python3
"""Differential test for FUN_0004c2e0 (0x4C2E0) — v3 lift (branches + delay slots), 42 bytes.
...
Run from repo root: python3 c/tests/test_FUN_0004c2e0_4c2e0.py
"""
...
ENTRY = 0x4C2E0
RAW = bytes.fromhex("95 22 93 23 60 30 60 0C 88 01 8F 04 00 09 D2 14 61 20 A0 08 25 10 64 50 62 4C 42 15 8F 03 00 09 92 19 34 2C 25 40 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCDB5
SPAN_END = 0x4C30A
SENT = 0x4C30A     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x4c2e0: {"kind": 'reg', "py": 'r[5] = 0xFFFFCDB0', "slot_py": None, "target": None, "cond": None},
    0x4c2e2: {"kind": 'reg', "py": 'r[3] = 0xFFFFCDB5', "slot_py": None, "target": None, "cond": None},
    0x4c2e4: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCDB5, 1))', "slot_py": None, "target": None, "cond": None},
    0x4c2e6: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x4c2e8: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x4c2ea: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4c2f6, "cond": 'notT'},
    0x4c2ee: {"kind": 'reg', "py": 'r[2] = 0x0007B816', "slot_py": None, "target": None, "cond": None},
    0x4c2f0: {"kind": 'mem', "py": 'r[1] = s8(_rdw(ram, 0x0007B816, 1))', "slot_py": None, "target": None, "cond": None},
    0x4c2f2: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFCDB0, 1, r[1])', "target": 0x4c306, "cond": 'always'},
    0x4c2f6: {"kind": 'mem', "py": 'r[4] = s8(_rdw(ram, 0xFFFFCDB0, 1))', "slot_py": None, "target": None, "cond": None},
    0x4c2f8: {"kind": 'reg', "py": 'r[2] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x4c2fa: {"kind": 'reg', "py": 'T = 1 if s32(r[2]) > 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x4c2fc: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4c306, "cond": 'notT'},
    0x4c300: {"kind": 'reg', "py": 'r[2] = 0x000000FF', "slot_py": None, "target": None, "cond": None},
    0x4c302: {"kind": 'reg', "py": 'r[4] = (r[4] + r[2]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x4c304: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCDB0, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x4c306: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
