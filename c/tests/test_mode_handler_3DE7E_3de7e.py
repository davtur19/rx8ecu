#!/usr/bin/env python3
"""Differential test for mode_handler_3DE7E (0x3DE7E) — v3 lift + v4 FPU, 56 bytes.
...
Run from repo root: python3 c/tests/test_mode_handler_3DE7E_3de7e.py
"""
...
ENTRY = 0x3DE7E
RAW = bytes.fromhex("E5 01 D3 11 96 1C F3 38 F3 45 8F 02 E4 00 A0 01 26 50 26 40 96 15 D3 0D F3 38 F4 35 8F 09 00 09 D2 0C 91 0F F2 28 F1 18 F1 25 8F 02 00 09 A0 01 26 50 26 40 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFC658
SPAN_END = 0x3DEB6
SENT = 0x3DEB6     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x3de7e: {"kind": 'reg', "py": 'r[5] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x3de80: {"kind": 'reg', "py": 'r[3] = 0x0007A90C', "slot_py": None, "target": None, "cond": None},
    0x3de82: {"kind": 'reg', "py": 'r[6] = 0xFFFFC657', "slot_py": None, "target": None, "cond": None},
    0x3de84: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x0007A90C, 4))', "slot_py": None, "target": None, "cond": None},
    0x3de86: {"kind": 'fpu', "py": 'T = 1 if fr[3] > fr[4] else 0', "slot_py": None, "target": None, "cond": None},
    0x3de88: {"kind": "branch", "py": None, "slot_py": 'r[4] = s8(0x00)', "target": 0x3de90, "cond": 'notT'},
    0x3de8c: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFC657, 1, r[5])', "target": 0x3de92, "cond": 'always'},
    0x3de90: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC657, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x3de92: {"kind": 'reg', "py": 'r[6] = 0xFFFFC658', "slot_py": None, "target": None, "cond": None},
    0x3de94: {"kind": 'reg', "py": 'r[3] = 0x0007A910', "slot_py": None, "target": None, "cond": None},
    0x3de96: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x0007A910, 4))', "slot_py": None, "target": None, "cond": None},
    0x3de98: {"kind": 'fpu', "py": 'T = 1 if fr[4] > fr[3] else 0', "slot_py": None, "target": None, "cond": None},
    0x3de9a: {"kind": "branch", "py": None, "slot_py": '', "target": 0x3deb0, "cond": 'notT'},
    0x3de9e: {"kind": 'reg', "py": 'r[2] = 0x0007A914', "slot_py": None, "target": None, "cond": None},
    0x3dea0: {"kind": 'reg', "py": 'r[1] = 0xFFFFAE58', "slot_py": None, "target": None, "cond": None},
    0x3dea2: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0x0007A914, 4))', "slot_py": None, "target": None, "cond": None},
    0x3dea4: {"kind": 'fpu', "py": 'fr[1] = bits2f(_rdw(ram, 0xFFFFAE58, 4))', "slot_py": None, "target": None, "cond": None},
    0x3dea6: {"kind": 'fpu', "py": 'T = 1 if fr[1] > fr[2] else 0', "slot_py": None, "target": None, "cond": None},
    0x3dea8: {"kind": "branch", "py": None, "slot_py": '', "target": 0x3deb0, "cond": 'notT'},
    0x3deac: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFC658, 1, r[5])', "target": 0x3deb2, "cond": 'always'},
    0x3deb0: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC658, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x3deb2: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
