#!/usr/bin/env python3
"""Differential test for fault_flag_or_eval_cfab_cfac_to_cfa9 (0x51ED2) — v3 lift (branches + delay slots), 40 bytes.
...
Run from repo root: python3 c/tests/test_fault_flag_or_eval_cfab_cfac_to_cfa9_51ed2.py
"""
...
ENTRY = 0x51ED2
RAW = bytes.fromhex("94 44 93 42 60 30 60 0C 88 01 8D 06 00 09 92 3E 60 20 60 0C 88 01 8F 03 00 09 E3 01 A0 02 24 30 E1 00 24 10 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCFAC
SPAN_END = 0x51EFA
SENT = 0x51EFA     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x51ed2: {"kind": 'reg', "py": 'r[4] = 0xFFFFCFA9', "slot_py": None, "target": None, "cond": None},
    0x51ed4: {"kind": 'reg', "py": 'r[3] = 0xFFFFCFAB', "slot_py": None, "target": None, "cond": None},
    0x51ed6: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCFAB, 1))', "slot_py": None, "target": None, "cond": None},
    0x51ed8: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x51eda: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x51edc: {"kind": "branch", "py": None, "slot_py": '', "target": 0x51eec, "cond": 'T'},
    0x51ee0: {"kind": 'reg', "py": 'r[2] = 0xFFFFCFAC', "slot_py": None, "target": None, "cond": None},
    0x51ee2: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCFAC, 1))', "slot_py": None, "target": None, "cond": None},
    0x51ee4: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x51ee6: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x51ee8: {"kind": "branch", "py": None, "slot_py": '', "target": 0x51ef2, "cond": 'notT'},
    0x51eec: {"kind": 'reg', "py": 'r[3] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x51eee: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFCFA9, 1, r[3])', "target": 0x51ef6, "cond": 'always'},
    0x51ef2: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x51ef4: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCFA9, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x51ef6: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
