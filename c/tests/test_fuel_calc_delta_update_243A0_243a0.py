#!/usr/bin/env python3
"""Differential test for fuel_calc_delta_update_243A0 (0x243A0) — v3 lift + v4 FPU, 38 bytes.
...
Run from repo root: python3 c/tests/test_fuel_calc_delta_update_243A0_243a0.py
"""
...
ENTRY = 0x243A0
RAW = bytes.fromhex("D6 1A 95 17 94 18 93 18 60 30 60 0C 88 01 8F 03 00 09 F3 8D A0 04 F4 3A F3 68 F2 58 F2 31 F4 2A F3 58 00 0B F6 3A")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCD09
SPAN_END = 0x243C6
SENT = 0x243C6     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x243a0: {"kind": 'reg', "py": 'r[6] = 0xFFFFB498', "slot_py": None, "target": None, "cond": None},
    0x243a2: {"kind": 'reg', "py": 'r[5] = 0xFFFFB480', "slot_py": None, "target": None, "cond": None},
    0x243a4: {"kind": 'reg', "py": 'r[4] = 0xFFFFB484', "slot_py": None, "target": None, "cond": None},
    0x243a6: {"kind": 'reg', "py": 'r[3] = 0xFFFFCD09', "slot_py": None, "target": None, "cond": None},
    0x243a8: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCD09, 1))', "slot_py": None, "target": None, "cond": None},
    0x243aa: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x243ac: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x243ae: {"kind": "branch", "py": None, "slot_py": '', "target": 0x243b8, "cond": 'notT'},
    0x243b2: {"kind": 'fpu', "py": 'fr[3] = 0.0', "slot_py": None, "target": None, "cond": None},
    0x243b4: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, r[4], 4, f2bits(fr[3]))', "target": 0x243c0, "cond": 'always'},
    0x243b8: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, r[6], 4))', "slot_py": None, "target": None, "cond": None},
    0x243ba: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, r[5], 4))', "slot_py": None, "target": None, "cond": None},
    0x243bc: {"kind": 'fpu', "py": 'fr[2] = ts(fr[2] - fr[3])', "slot_py": None, "target": None, "cond": None},
    0x243be: {"kind": 'fpu', "py": '_wrw(ram, r[4], 4, f2bits(fr[2]))', "slot_py": None, "target": None, "cond": None},
    0x243c0: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, r[5], 4))', "slot_py": None, "target": None, "cond": None},
    0x243c2: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, r[6], 4, f2bits(fr[3]))', "target": None, "cond": None},}
