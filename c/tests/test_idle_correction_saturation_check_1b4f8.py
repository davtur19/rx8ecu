#!/usr/bin/env python3
"""Differential test for idle_correction_saturation_check (0x1B4F8) — v3 lift + v4 FPU, 84 bytes.
...
Run from repo root: python3 c/tests/test_idle_correction_saturation_check_1b4f8.py
"""
...
ENTRY = 0x1B4F8
RAW = bytes.fromhex("93 2B E5 01 D2 16 F4 38 F6 28 D1 16 F3 18 F5 6C D1 17 F5 31 F6 45 8D 02 E4 00 A0 04 21 50 F5 45 8F 01 00 09 21 40 97 17 96 15 62 10 22 28 8F 0D 00 09 93 0F D0 09 61 31 62 01 31 22 8F 03 00 09 26 50 A0 05 27 50 26 50 A0 02 27 40 26 40 27 40 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFAADD
SPAN_END = 0x1B54C
SENT = 0x1B56C     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x1b4f8: {"kind": 'reg', "py": 'r[3] = 0xFFFFAA40', "slot_py": None, "target": None, "cond": None},
    0x1b4fa: {"kind": 'reg', "py": 'r[5] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x1b4fc: {"kind": 'reg', "py": 'r[2] = 0x0006FCA4', "slot_py": None, "target": None, "cond": None},
    0x1b4fe: {"kind": 'fpu', "py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFAA40, 4))', "slot_py": None, "target": None, "cond": None},
    0x1b500: {"kind": 'fpu', "py": 'fr[6] = bits2f(_rdw(ram, 0x0006FCA4, 4))', "slot_py": None, "target": None, "cond": None},
    0x1b502: {"kind": 'reg', "py": 'r[1] = 0x0006FCA8', "slot_py": None, "target": None, "cond": None},
    0x1b504: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x0006FCA8, 4))', "slot_py": None, "target": None, "cond": None},
    0x1b506: {"kind": 'fpu', "py": 'fr[5] = fr[6]', "slot_py": None, "target": None, "cond": None},
    0x1b508: {"kind": 'reg', "py": 'r[1] = 0xFFFFAADD', "slot_py": None, "target": None, "cond": None},
    0x1b50a: {"kind": 'fpu', "py": 'fr[5] = ts(fr[5] - fr[3])', "slot_py": None, "target": None, "cond": None},
    0x1b50c: {"kind": 'fpu', "py": 'T = 1 if fr[6] > fr[4] else 0', "slot_py": None, "target": None, "cond": None},
    0x1b50e: {"kind": "branch", "py": None, "slot_py": 'r[4] = s8(0x00)', "target": 0x1b516, "cond": 'T'},
    0x1b512: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFAADD, 1, r[5])', "target": 0x1b51e, "cond": 'always'},
    0x1b516: {"kind": 'fpu', "py": 'T = 1 if fr[5] > fr[4] else 0', "slot_py": None, "target": None, "cond": None},
    0x1b518: {"kind": "branch", "py": None, "slot_py": '', "target": 0x1b51e, "cond": 'notT'},
    0x1b51c: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFAADD, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x1b51e: {"kind": 'reg', "py": 'r[7] = 0xFFFFAADA', "slot_py": None, "target": None, "cond": None},
    0x1b520: {"kind": 'reg', "py": 'r[6] = 0xFFFFAADB', "slot_py": None, "target": None, "cond": None},
    0x1b522: {"kind": 'mem', "py": 'r[2] = s8(_rdw(ram, 0xFFFFAADD, 1))', "slot_py": None, "target": None, "cond": None},
    0x1b524: {"kind": 'reg', "py": 'T = 1 if (r[2] & r[2]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x1b526: {"kind": "branch", "py": None, "slot_py": '', "target": 0x1b544, "cond": 'notT'},
    0x1b52a: {"kind": 'reg', "py": 'r[3] = 0xFFFFAAD8', "slot_py": None, "target": None, "cond": None},
    0x1b52c: {"kind": 'reg', "py": 'r[0] = 0x0006FCA0', "slot_py": None, "target": None, "cond": None},
    0x1b52e: {"kind": 'mem', "py": 'r[1] = s16(_rdw(ram, 0xFFFFAAD8, 2))', "slot_py": None, "target": None, "cond": None},
    0x1b530: {"kind": 'mem', "py": 'r[2] = s16(_rdw(ram, 0x0006FCA0, 2))', "slot_py": None, "target": None, "cond": None},
    0x1b532: {"kind": 'reg', "py": 'T = 1 if (r[1] & 0xFFFFFFFF) >= (r[2] & 0xFFFFFFFF) else 0', "slot_py": None, "target": None, "cond": None},
    0x1b534: {"kind": "branch", "py": None, "slot_py": '', "target": 0x1b53e, "cond": 'notT'},
    0x1b538: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFAADB, 1, r[5])', "slot_py": None, "target": None, "cond": None},
    0x1b53a: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFAADA, 1, r[5])', "target": 0x1b548, "cond": 'always'},
    0x1b53e: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFAADB, 1, r[5])', "slot_py": None, "target": None, "cond": None},
    0x1b540: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFAADA, 1, r[4])', "target": 0x1b548, "cond": 'always'},
    0x1b544: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFAADB, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x1b546: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFAADA, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x1b548: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
