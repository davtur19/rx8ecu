#!/usr/bin/env python3
"""Differential test for init_sequence_547fa (0x547FA) — v3 lift (branches + delay slots), 40 bytes.
...
Run from repo root: python3 c/tests/test_init_sequence_547fa_547fa.py
"""
...
CODE = {
    0x547fa: {"kind": 'reg', "py": 'r[4] = 0xFFFFD1DD', "slot_py": None, "target": None, "cond": None},
    0x547fc: {"kind": 'reg', "py": 'r[3] = 0xFFFFD1DF', "slot_py": None, "target": None, "cond": None},
    0x547fe: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFD1DF, 1))', "slot_py": None, "target": None, "cond": None},
    0x54800: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x54802: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x54804: {"kind": "branch", "py": None, "slot_py": '', "target": 0x54814, "cond": 'T'},
    0x54808: {"kind": 'reg', "py": 'r[2] = 0xFFFFD1E0', "slot_py": None, "target": None, "cond": None},
    0x5480a: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFD1E0, 1))', "slot_py": None, "target": None, "cond": None},
    0x5480c: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x5480e: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x54810: {"kind": "branch", "py": None, "slot_py": '', "target": 0x5481a, "cond": 'notT'},
    0x54814: {"kind": 'reg', "py": 'r[3] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x54816: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFD1DD, 1, r[3])', "target": 0x5481e, "cond": 'always'},
    0x5481a: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x5481c: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD1DD, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x5481e: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
