#!/usr/bin/env python3
"""Differential test for dtc_data_read_60CC8 (0x60CC8) — pure straight-line lift, 8 bytes.
...
Run from repo root: python3 c/tests/test_dtc_data_read_60CC8_60cc8.py
"""
...
ENTRY = 0x60CC8
RAW = bytes.fromhex("97 20 E6 00 D4 10 65 63")
SEED = 42
N = 2000
