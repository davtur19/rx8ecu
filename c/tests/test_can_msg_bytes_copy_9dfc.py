#!/usr/bin/env python3
"""Differential test for can_msg_bytes_copy (0x9DFC) — v3 lift (branches + delay slots), 42 bytes.
...
Run from repo root: python3 c/tests/test_can_msg_bytes_copy_9dfc.py
"""
...
ENTRY = 0x9DFC
RAW = bytes.fromhex("7F FC 34 5C 2F 40 63 5C 37 3C 64 53 65 F0 63 4C 65 5C 33 53 8D 07 00 09 63 74 74 01 26 30 62 4C 32 53 8F F9 76 01 00 0B 7F 04")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = None
SPAN_END = 0x9E26
SENT = 0x9E26     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x9dfc: {"kind": 'reg', "py": 'r[15] = (r[15] + s8(0xFC)) & 0xFFFFFFFF\nsp = (sp + s8(0xFC)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x9dfe: {"kind": 'reg', "py": 'r[4] = (r[4] + r[5]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x9e00: {"kind": 'mem', "py": 'local[0x3FC] = r[4]\n_wrw(ram, STACK_BASE + 0x3FC, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x9e02: {"kind": 'reg', "py": 'r[3] = r[5] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x9e04: {"kind": 'reg', "py": 'r[7] = (r[7] + r[3]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x9e06: {"kind": 'reg', "py": 'r[4] = r[5]', "slot_py": None, "target": None, "cond": None},
    0x9e08: {"kind": 'mem', "py": 'r[5] = s8(_rdw(ram, STACK_BASE + 0x3FC, 1))', "slot_py": None, "target": None, "cond": None},
    0x9e0a: {"kind": 'reg', "py": 'r[3] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x9e0c: {"kind": 'reg', "py": 'r[5] = r[5] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x9e0e: {"kind": 'reg', "py": 'T = 1 if s32(r[3]) >= s32(r[5]) else 0', "slot_py": None, "target": None, "cond": None},
    0x9e10: {"kind": "branch", "py": None, "slot_py": '', "target": 0x9e22, "cond": 'T'},
    0x9e14: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, r[7], 1))\nr[7] = (r[7] + 1) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x9e16: {"kind": 'reg', "py": 'r[4] = (r[4] + s8(0x01)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x9e18: {"kind": 'mem', "py": '_wrw(ram, r[6], 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x9e1a: {"kind": 'reg', "py": 'r[2] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x9e1c: {"kind": 'reg', "py": 'T = 1 if s32(r[2]) >= s32(r[5]) else 0', "slot_py": None, "target": None, "cond": None},
    0x9e1e: {"kind": "branch", "py": None, "slot_py": 'r[6] = (r[6] + s8(0x01)) & 0xFFFFFFFF', "target": 0x9e14, "cond": 'notT'},
    0x9e22: {"kind": "ret", "py": None, "slot_py": 'r[15] = (r[15] + s8(0x04)) & 0xFFFFFFFF\nsp = (sp + s8(0x04)) & 0xFFFFFFFF', "target": None, "cond": None},}
