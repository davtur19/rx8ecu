#!/usr/bin/env python3
"""Differential test for duty_cycle_control_0x4F264 (0x4F264) — v3 lift (branches + delay slots), 42 bytes.
...
Run from repo root: python3 c/tests/test_duty_cycle_control_0x4F264_4f264.py
"""
...
ENTRY = 0x4F264
RAW = bytes.fromhex("95 22 93 22 60 30 60 0C 88 01 8F 04 00 09 D2 14 61 20 A0 08 25 10 64 50 62 4C 42 15 8F 03 00 09 92 18 34 2C 25 40 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    0x4f264: {"kind": 'reg', "py": 'r[5] = 0xFFFFCFF0', "slot_py": None, "target": None, "cond": None},
    0x4f266: {"kind": 'reg', "py": 'r[3] = 0xFFFFCFF4', "slot_py": None, "target": None, "cond": None},
    0x4f268: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCFF4, 1))', "slot_py": None, "target": None, "cond": None},
    0x4f26a: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x4f26c: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x4f26e: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4f27a, "cond": 'notT'},
    0x4f272: {"kind": 'reg', "py": 'r[2] = 0x0007D0CE', "slot_py": None, "target": None, "cond": None},
    0x4f274: {"kind": 'mem', "py": 'r[1] = s8(_rdw(ram, 0x0007D0CE, 1))', "slot_py": None, "target": None, "cond": None},
    0x4f276: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFCFF0, 1, r[1])', "target": 0x4f28a, "cond": 'always'},
    0x4f27a: {"kind": 'mem', "py": 'r[4] = s8(_rdw(ram, 0xFFFFCFF0, 1))', "slot_py": None, "target": None, "cond": None},
    0x4f27c: {"kind": 'reg', "py": 'r[2] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x4f27e: {"kind": 'reg', "py": 'T = 1 if s32(r[2]) > 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x4f280: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4f28a, "cond": 'notT'},
    0x4f284: {"kind": 'reg', "py": 'r[2] = 0x000000FF', "slot_py": None, "target": None, "cond": None},
    0x4f286: {"kind": 'reg', "py": 'r[4] = (r[4] + r[2]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x4f288: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCFF0, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x4f28a: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
