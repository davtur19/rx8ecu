#!/usr/bin/env python3
"""Differential test for fuel_emission_4f70c (0x4F70C) — v3 lift (branches + delay slots), 40 bytes.
...
Run from repo root: python3 c/tests/test_fuel_emission_4f70c_4f70c.py
"""
...
ENTRY = 0x4F70C
RAW = bytes.fromhex("94 78 93 78 60 30 60 0C 88 01 8D 06 00 09 92 73 60 20 60 0C 88 01 8F 03 00 09 E3 01 A0 02 24 30 E1 00 24 10 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    0x4f70c: {"kind": 'reg', "py": 'r[4] = 0xFFFFCFFB', "slot_py": None, "target": None, "cond": None},
    0x4f70e: {"kind": 'reg', "py": 'r[3] = 0xFFFFD002', "slot_py": None, "target": None, "cond": None},
    0x4f710: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFD002, 1))', "slot_py": None, "target": None, "cond": None},
    0x4f712: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x4f714: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x4f716: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4f726, "cond": 'T'},
    0x4f71a: {"kind": 'reg', "py": 'r[2] = 0xFFFFD12E', "slot_py": None, "target": None, "cond": None},
    0x4f71c: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFD12E, 1))', "slot_py": None, "target": None, "cond": None},
    0x4f71e: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x4f720: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x4f722: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4f72c, "cond": 'notT'},
    0x4f726: {"kind": 'reg', "py": 'r[3] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x4f728: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFCFFB, 1, r[3])', "target": 0x4f730, "cond": 'always'},
    0x4f72c: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x4f72e: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCFFB, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x4f730: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
