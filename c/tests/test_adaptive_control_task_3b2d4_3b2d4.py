#!/usr/bin/env python3
"""Differential test for adaptive_control_task_3b2d4 (0x3B2D4) — v3 lift (branches + delay slots), 14 bytes.
...
Run from repo root: python3 c/tests/test_adaptive_control_task_3b2d4_3b2d4.py
"""
...
ENTRY = 0x3B2D4
RAW = bytes.fromhex("A0 02 26 20 E1 00 26 10 63 40 00 0B 25 30")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
CODE = {
    0x3b2d4: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, r[6], 1, r[2])', "target": 0x3b2dc, "cond": 'always'},
    0x3b2d8: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x3b2da: {"kind": 'mem', "py": '_wrw(ram, r[6], 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x3b2dc: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, r[4], 1))', "slot_py": None, "target": None, "cond": None},
    0x3b2de: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, r[5], 1, r[3])', "target": None, "cond": None},}
