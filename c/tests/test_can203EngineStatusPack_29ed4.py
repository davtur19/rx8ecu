#!/usr/bin/env python3
"""Differential test for can203EngineStatusPack (0x29ED4) — v3 lift (branches + delay slots), 26 bytes.
...
Run from repo root: python3 c/tests/test_can203EngineStatusPack_29ed4.py
"""
...
ENTRY = 0x29ED4
RAW = bytes.fromhex("84 42 60 0C 92 5B 40 18 63 03 84 43 60 0C 33 0C D0 34 20 31 84 44 00 0B 22 00")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBB5A
SPAN_END = 0x29EEE
SENT = 0x29EEE     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x29ed4: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, (r[4] + 2), 1))', "slot_py": None, "target": None, "cond": None},
    ...
    0x29ede: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, (r[4] + 3), 1))', "slot_py": None, "target": None, "cond": None},
    ...
    0x29ee8: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, (r[4] + 4), 1))', "slot_py": None, "target": None, "cond": None},
