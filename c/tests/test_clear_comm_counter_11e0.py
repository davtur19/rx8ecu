#!/usr/bin/env python3
"""Differential test for clear_comm_counter (0x11E0) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_clear_comm_counter_11e0.py
"""
...
CODE = {
    0x11e0: {"kind": 'reg', "py": 'r[2] = 0xFFFFDFA0', "slot_py": None, "target": None, "cond": None},
    0x11e2: {"kind": 'reg', "py": 'r[3] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x11e4: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFDFA0, 2, r[3])', "target": None, "cond": None},}
