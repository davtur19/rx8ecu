#!/usr/bin/env python3
"""Differential test for diag_vehicle_info_4E2BE (0x4E2BE) — mem lift (RAM-only, straight-line), 8 bytes.
...
Run from repo root: python3 c/tests/test_diag_vehicle_info_4E2BE_4e2be.py
"""
...
ENTRY = 0x4E2BE
RAW = bytes.fromhex("00 09 91 6A 37 5C 21 70")
SEED = 42
N = 2000
...
def spec_mirror(r4, r5, r6, r7, ram, stack_top):
    ...
    r[1] = 0xFFFFCF8D
    # 0x04E2C2: op 0x375C
    r[7] = (r[7] + r[5]) & 0xFFFFFFFF
    # 0x04E2C4: mov.b r7,@r1
    _wrw(ram, 0xFFFFCF8D, 1, r[7])
    r[15] = sp
