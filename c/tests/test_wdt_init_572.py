#!/usr/bin/env python3
"""Differential test for wdt_init (0x572) — v3 lift (branches + delay slots), 20 bytes.
...
Run from repo root: python3 c/tests/test_wdt_init_572.py
"""
...
ENTRY = 0x572
RAW = bytes.fromhex("93 10 92 10 22 31 94 0F 73 E1 24 31 61 40 D0 0A 00 0B 24 01")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFEC12
SPAN_END = 0x586
SENT = 0x586     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x572: {"kind": 'reg', "py": 'r[3] = 0x00005A1F', "slot_py": None, "target": None, "cond": None},
    0x574: {"kind": 'reg', "py": 'r[2] = 0xFFFFEC12', "slot_py": None, "target": None, "cond": None},
    0x576: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFEC12, 2, r[3])', "slot_py": None, "target": None, "cond": None},
    0x578: {"kind": 'reg', "py": 'r[4] = 0xFFFFEC10', "slot_py": None, "target": None, "cond": None},
    0x57a: {"kind": 'reg', "py": 'r[3] = (r[3] + s8(0xE1)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x57c: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFEC10, 2, r[3])', "slot_py": None, "target": None, "cond": None},
    0x57e: {"kind": 'mem', "py": 'r[1] = s8(_rdw(ram, 0xFFFFEC10, 1))', "slot_py": None, "target": None, "cond": None},
    0x580: {"kind": 'reg', "py": 'r[0] = 0x0000A53C', "slot_py": None, "target": None, "cond": None},
    0x582: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFEC10, 2, r[0])', "target": None, "cond": None},}
