#!/usr/bin/env python3
"""Differential test for getEngineTorqueMaxCal (0x2A264) — v3 lift + v4 FPU, 10 bytes.
...
Run from repo root: python3 c/tests/test_getEngineTorqueMaxCal_2a264.py
"""
...
ENTRY = 0x2A264
RAW = bytes.fromhex("D3 0E F3 38 92 08 00 0B F2 3A")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBB58
SPAN_END = 0x2A26E
SENT = 0x2A26E     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x2a264: {"kind": 'reg', "py": 'r[3] = 0x00077A94', "slot_py": None, "target": None, "cond": None},
    0x2a266: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x00077A94, 4))', "slot_py": None, "target": None, "cond": None},
    0x2a268: {"kind": 'reg', "py": 'r[2] = 0xFFFFBB58', "slot_py": None, "target": None, "cond": None},
    0x2a26a: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBB58, 4, f2bits(fr[3]))', "target": None, "cond": None},}
