#!/usr/bin/env python3
"""Differential test for getCatTempConditional2 (0x3ED2A) — v3 lift + v4 FPU, 40 bytes.
...
Run from repo root: python3 c/tests/test_getCatTempConditional2_3ed2a.py
"""
...
ENTRY = 0x3ED2A
RAW = bytes.fromhex("93 25 94 28 F4 38 D2 1F F3 28 F3 45 8F 03 00 09 E0 00 A0 07 24 00 D1 1C F2 18 F4 25 8F 02 00 09 E0 01 24 00 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFC64C
SPAN_END = 0x3ED52
SENT = 0x3ED52     # stop-sentinel, placed past the literal pool
