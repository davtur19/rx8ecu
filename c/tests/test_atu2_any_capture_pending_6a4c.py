#!/usr/bin/env python3
"""Differential test for atu2_any_capture_pending (0x6A4C) — v3 lift (branches + delay slots), 36 bytes.
...
Run from repo root: python3 c/tests/test_atu2_any_capture_pending_6a4c.py
"""
...
CODE = {
    0x6a4c: {"kind": 'reg', "py": 'r[4] = 0xFFFF9F29', "slot_py": None, "target": None, "cond": None},
    0x6a4e: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFF9F2A, 1))', "slot_py": None, "target": None, "cond": None},
    0x6a50: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x6a52: {"kind": "branch", "py": None, "slot_py": '', "target": 0x6a66, "cond": 'T'},
    0x6a56: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFF9F2D, 1))', "slot_py": None, "target": None, "cond": None},
    0x6a58: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x6a5a: {"kind": "branch", "py": None, "slot_py": '', "target": 0x6a66, "cond": 'T'},
    0x6a5e: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFF9F30, 1))', "slot_py": None, "target": None, "cond": None},
    0x6a60: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x6a62: {"kind": "branch", "py": None, "slot_py": '', "target": 0x6a6a, "cond": 'notT'},
    0x6a66: {"kind": "ret", "py": None, "slot_py": 'r[0] = s8(0x01)', "target": None, "cond": None},
    0x6a6a: {"kind": 'reg', "py": 'r[0] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x6a6c: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
