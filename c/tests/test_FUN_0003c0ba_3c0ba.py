#!/usr/bin/env python3
"""Differential test for FUN_0003c0ba (0x3C0BA) — v3 lift + v4 FPU, 62 bytes.
...
Run from repo root: python3 c/tests/test_FUN_0003c0ba_3c0ba.py
"""
...
ENTRY = 0x3C0BA
RAW = bytes.fromhex("C7 2C F3 08 F3 45 8D 03 00 09 F4 55 8F 02 00 09 A0 08 26 40 93 3C 60 30 60 0C 88 01 8F 04 00 09 E1 01 26 10 A0 09 25 40 26 40 64 50 61 4C 92 35 31 23 8D 02 00 09 74 01 25 40 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    ...
    0x3c0ca: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, r[6], 1, r[4])', "target": 0x3c0de, "cond": 'always'},
    ...
    0x3c0dc: {"kind": 'mem', "py": '_wrw(ram, r[6], 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x3c0de: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, r[5], 1, r[4])', "target": 0x3c0f4, "cond": 'always'},
    0x3c0e2: {"kind": 'mem', "py": '_wrw(ram, r[6], 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x3c0e4: {"kind": 'mem', "py": 'r[4] = s8(_rdw(ram, r[5], 1))', "slot_py": None, "target": None, "cond": None},
    ...
    0x3c0f2: {"kind": 'mem', "py": '_wrw(ram, r[5], 1, r[4])', "slot_py": None, "target": None, "cond": None},
