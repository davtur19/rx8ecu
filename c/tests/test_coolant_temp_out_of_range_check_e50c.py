#!/usr/bin/env python3
"""Differential test for coolant_temp_out_of_range_check (0xE50C) — v3 lift + v4 FPU, 40 bytes.
...
Run from repo root: python3 c/tests/test_coolant_temp_out_of_range_check_e50c.py
"""
...
ENTRY = 0xE50C
RAW = bytes.fromhex("93 12 F4 38 94 11 D2 09 F3 28 F3 45 8F 03 00 09 E0 00 A0 07 24 00 D1 06 F2 18 F2 45 8D 02 00 09 E0 01 24 00 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFB5B8
SPAN_END = 0xE534
SENT = 0xE540     # stop-sentinel, placed past the literal pool
...
CODE = {
    0xe50c: {"kind": 'reg', "py": 'r[3] = 0xFFFFB5B8', "slot_py": None, "target": None, "cond": None},
    0xe50e: {"kind": 'fpu', "py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFB5B8, 4))', "slot_py": None, "target": None, "cond": None},
    0xe510: {"kind": 'reg', "py": 'r[4] = 0xFFFFA428', "slot_py": None, "target": None, "cond": None},
    0xe512: {"kind": 'reg', "py": 'r[2] = 0x0006CF90', "slot_py": None, "target": None, "cond": None},
    0xe514: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x0006CF90, 4))', "slot_py": None, "target": None, "cond": None},
    0xe516: {"kind": 'fpu', "py": 'T = 1 if fr[3] > fr[4] else 0', "slot_py": None, "target": None, "cond": None},
    0xe518: {"kind": "branch", "py": None, "slot_py": '', "target": 0xe522, "cond": 'notT'},
    0xe51c: {"kind": 'reg', "py": 'r[0] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0xe51e: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFA428, 1, r[0])', "target": 0xe530, "cond": 'always'},
    0xe522: {"kind": 'reg', "py": 'r[1] = 0x0006CF94', "slot_py": None, "target": None, "cond": None},
    0xe524: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0x0006CF94, 4))', "slot_py": None, "target": None, "cond": None},
    0xe526: {"kind": 'fpu', "py": 'T = 1 if fr[2] > fr[4] else 0', "slot_py": None, "target": None, "cond": None},
    0xe528: {"kind": "branch", "py": None, "slot_py": '', "target": 0xe530, "cond": 'T'},
    0xe52c: {"kind": 'reg', "py": 'r[0] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0xe52e: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA428, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0xe530: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
