#!/usr/bin/env python3
"""Differential test for atu_write_compare_value (0x1DD4) — v3 lift (branches + delay slots), 38 bytes.
...
Run from repo root: python3 c/tests/test_atu_write_compare_value_1dd4.py
"""
...
CODE = {
    0x1dd4: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, (r[4] + 1), 1))', "slot_py": None, "target": None, "cond": None},
    0x1dd6: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x1dd8: {"kind": 'mem', "py": 'r[2] = s8(_rdw(ram, r[4], 1))', "slot_py": None, "target": None, "cond": None},
    0x1dda: {"kind": 'reg', "py": 'r[0] = (r[0] << 16) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x1ddc: {"kind": 'reg', "py": 'r[3] = r[0]', "slot_py": None, "target": None, "cond": None},
    0x1dde: {"kind": 'reg', "py": 'r[2] = r[2] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x1de0: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, (r[4] + 2), 1))', "slot_py": None, "target": None, "cond": None},
    0x1de2: {"kind": 'reg', "py": 'r[2] = (r[2] << 16) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x1de4: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x1de6: {"kind": 'reg', "py": 'r[0] = (r[0] << 8) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x1de8: {"kind": 'reg', "py": 'r[3] = (r[3] + r[0]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x1dea: {"kind": 'reg', "py": 'r[2] = (r[2] << 8) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x1dec: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, (r[4] + 3), 1))', "slot_py": None, "target": None, "cond": None},
    0x1dee: {"kind": 'reg', "py": 'r[3] = (r[3] + r[2]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x1df0: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x1df2: {"kind": 'reg', "py": 'r[4] = r[3]', "slot_py": None, "target": None, "cond": None},
    0x1df4: {"kind": 'reg', "py": 'r[4] = (r[4] + r[0]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x1df6: {"kind": "ret", "py": None, "slot_py": 'r[0] = r[4]', "target": None, "cond": None},}
