#!/usr/bin/env python3
"""Differential test for caller_64F6C (entry 0x64F6C) — v8 ST caller (CFG), 44 bytes.
...
Run: python3 test_caller_64F6C.py
"""
...
CODE = {
    0x64f6c: {"kind": 'st', "py": 'local[0x3FC] = pr\n_wrw(ram, STACK_BASE + 0x3FC, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x64f6e: {"kind": 'reg', "py": 'r[3] = 0xFFFF8EA4', "slot_py": None, "target": None, "cond": None},
    0x64f70: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFF8EA4, 1))', "slot_py": None, "target": None, "cond": None},
    0x64f72: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x64f74: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x64f76: {"kind": "branch", "py": None, "slot_py": '', "target": 0x64f92, "cond": 'notT'},
    0x64f7a: {"kind": 'reg', "py": 'r[4] = 0xFFFF8D7C', "slot_py": None, "target": None, "cond": None},
    0x64f7c: {"kind": 'reg', "py": 'r[2] = 0x00002420', "slot_py": None, "target": None, "cond": None},
    0x64f7e: {"kind": "call", "py": None, "slot_py": 'r[4] = s8(_rdw(ram, 0xFFFF8D7C, 1))', "target": 0x2420, "ret_pc": 0x64f82, "set_pr": True, "cond": None},
    0x64f82: {"kind": 'reg', "py": 'r[3] = 0xFFFF8EA0', "slot_py": None, "target": None, "cond": None},
    0x64f84: {"kind": 'reg', "py": 'r[4] = 0xFFFF8D7E', "slot_py": None, "target": None, "cond": None},
    0x64f86: {"kind": 'mem', "py": '_wrw(ram, 0xFFFF8EA0, 2, r[0])', "slot_py": None, "target": None, "cond": None},
    0x64f88: {"kind": 'reg', "py": 'r[2] = 0x00002420', "slot_py": None, "target": None, "cond": None},
    0x64f8a: {"kind": "call", "py": None, "slot_py": 'r[4] = s8(_rdw(ram, 0xFFFF8D7E, 1))', "target": 0x2420, "ret_pc": 0x64f8e, "set_pr": True, "cond": None},
    0x64f8e: {"kind": 'reg', "py": 'r[3] = 0xFFFF8EA2', "slot_py": None, "target": None, "cond": None},
    0x64f90: {"kind": 'mem', "py": '_wrw(ram, 0xFFFF8EA2, 2, r[0])', "slot_py": None, "target": None, "cond": None},
    0x64f92: {"kind": 'st', "py": 'pr = _rdw(ram, STACK_BASE + 0x3FC, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x64f94: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},
