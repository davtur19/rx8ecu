#!/usr/bin/env python3
"""Differential test for caller_4C2BA (entry 0x4C2BA) — v8 ST caller (CFG), 38 bytes.
...
Run: python3 test_caller_4C2BA.py
"""
...
CODE = {
    0x4c2ba: {"kind": 'fpu', "py": 'fr[5] = 0.0', "slot_py": None, "target": None, "cond": None},
    0x4c2bc: {"kind": 'st', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x4c2be: {"kind": 'reg', "py": 'r[3] = 0xFFFF9EF6', "slot_py": None, "target": None, "cond": None},
    0x4c2c0: {"kind": 'reg', "py": 'r[0] = 0xFFFFCDA0', "slot_py": None, "target": None, "cond": None},
    0x4c2c2: {"kind": 'mem', "py": 'r[2] = s16(_rdw(ram, 0xFFFF9EF6, 2))', "slot_py": None, "target": None, "cond": None},
    0x4c2c4: {"kind": 'reg', "py": 'r[3] = 0x000024C0', "slot_py": None, "target": None, "cond": None},
    0x4c2c6: {"kind": 'reg', "py": 'r[2] = r[2] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x4c2c8: {"kind": 'reg', "py": 'r[2] = (r[2] >> 2) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x4c2ca: {"kind": 'reg', "py": 'r[2] = (r[2] >> 2) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x4c2cc: {"kind": 'reg', "py": 'r[2] = (r[2] >> 2) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x4c2ce: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCDA0, 2, r[2])', "slot_py": None, "target": None, "cond": None},
    0x4c2d0: {"kind": 'reg', "py": 'r[0] = 0x0004C350', "slot_py": None, "target": None, "cond": None},
    0x4c2d2: {"kind": 'fpu', "py": 'fr[4] = bits2f(_rdw(ram, 0x0004C350, 4))', "slot_py": None, "target": None, "cond": None},
    0x4c2d4: {"kind": "call", "py": None, "slot_py": 'r[4] = r[2]', "target": 0x24c0, "ret_pc": 0x4c2d8, "set_pr": True, "cond": None},
    0x4c2d8: {"kind": 'reg', "py": 'r[1] = 0xFFFFCD9C', "slot_py": None, "target": None, "cond": None},
    0x4c2da: {"kind": 'st', "py": 'pr = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x4c2dc: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFCD9C, 4, f2bits(fr[0]))', "target": None, "cond": None, },
