#!/usr/bin/env python3
"""Differential test for caller_66F00 (entry 0x66F00) — v8 ST caller (CFG), 22 bytes.
...
Run: python3 test_caller_66F00.py
"""
...
CODE = {
    0x66f00: {"kind": 'reg', "py": 'r[6] = r[4] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x66f02: {"kind": 'reg', "py": 'T = 1 if (r[6] & r[6]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x66f04: {"kind": "branch", "py": None, "slot_py": 'r[5] = s8(0x00)', "target": 0x66f10, "cond": 'T'},
    0x66f08: {"kind": 'reg', "py": 'r[2] = s8(0x06)', "slot_py": None, "target": None, "cond": None},
    0x66f0a: {"kind": 'reg', "py": 'T = 1 if s32(r[6]) > s32(r[2]) else 0', "slot_py": None, "target": None, "cond": None},
    0x66f0c: {"kind": "branch", "py": None, "slot_py": '', "target": 0x66f12, "cond": 'notT'},
    0x66f10: {"kind": 'reg', "py": 'r[5] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x66f12: {"kind": "ret", "py": None, "slot_py": 'r[0] = r[5]', "target": None, "cond": None},
}
