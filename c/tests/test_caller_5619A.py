#!/usr/bin/env python3
"""Differential test for caller_5619A (entry 0x5619A) — v8 ST caller (CFG), 22 bytes.
...
Run: python3 test_caller_5619A.py
"""
...
CODE = {
    0x5619a: {"kind": 'fpu', "py": 'fr[6] = 0.0', "slot_py": None, "target": None, "cond": None},
    0x5619c: {"kind": 'reg', "py": 'r[0] = 0x00056248', "slot_py": None, "target": None, "cond": None},
    0x5619e: {"kind": 'st', "py": 'local[0x3FC] = pr\n_wrw(ram, STACK_BASE + 0x3FC, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x561a0: {"kind": 'reg', "py": 'r[3] = 0xFFFFAE74', "slot_py": None, "target": None, "cond": None},
    0x561a2: {"kind": 'fpu', "py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFAE74, 4))', "slot_py": None, "target": None, "cond": None},
    0x561a4: {"kind": 'reg', "py": 'r[2] = 0x00002490', "slot_py": None, "target": None, "cond": None},
    0x561a6: {"kind": "call", "py": None, "slot_py": 'fr[5] = bits2f(_rdw(ram, 0x00056248, 4))', "target": 0x2490, "ret_pc": 0x561aa, "set_pr": True, "cond": None},
    0x561aa: {"kind": 'st', "py": 'pr = _rdw(ram, STACK_BASE + 0x3FC, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x561ac: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},
