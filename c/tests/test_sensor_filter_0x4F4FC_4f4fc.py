#!/usr/bin/env python3
"""Differential test for sensor_filter_0x4F4FC (0x4F4FC) — v3 lift + v4 FPU, 80 bytes.
...
Run from repo root: python3 c/tests/test_sensor_filter_0x4F4FC_4f4fc.py
"""
...
ENTRY = 0x4F4FC
RAW = bytes.fromhex("93 5A 60 30 60 0C 88 01 8F 20 00 09 92 55 61 21 93 54 60 31 31 06 8F 19 00 09 95 50 93 50 F3 38 92 4F F2 28 F2 35 8D 04 00 09 D1 2A 60 10 A0 0D 25 00 91 47 62 10 22 28 8F 08 00 09 64 50 62 4C 42 15 8F 03 00 09 92 3E 34 2C 25 40 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFD034
SPAN_END = 0x4F54C
SENT = 0x4F54C     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x4f4fc: {"kind": 'reg', "py": 'r[3] = 0xFFFFD002', "slot_py": None, "target": None, "cond": None},
    0x4f4fe: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFD002, 1))', "slot_py": None, "target": None, "cond": None},
    0x4f500: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x4f502: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x4f504: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4f548, "cond": 'notT'},
    0x4f508: {"kind": 'reg', "py": 'r[2] = 0xFFFFCFE6', "slot_py": None, "target": None, "cond": None},
    0x4f50a: {"kind": 'mem', "py": 'r[1] = s16(_rdw(ram, 0xFFFFCFE6, 2))', "slot_py": None, "target": None, "cond": None},
    0x4f50c: {"kind": 'reg', "py": 'r[3] = 0xFFFFCFE4', "slot_py": None, "target": None, "cond": None},
    0x4f50e: {"kind": 'mem', "py": 'r[0] = s16(_rdw(ram, 0xFFFFCFE4, 2))', "slot_py": None, "target": None, "cond": None},
    0x4f510: {"kind": 'reg', "py": 'T = 1 if (r[1] & 0xFFFFFFFF) > (r[0] & 0xFFFFFFFF) else 0', "slot_py": None, "target": None, "cond": None},
    0x4f512: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4f548, "cond": 'notT'},
    0x4f516: {"kind": 'reg', "py": 'r[5] = 0xFFFFCFED', "slot_py": None, "target": None, "cond": None},
    0x4f518: {"kind": 'reg', "py": 'r[3] = 0xFFFFD020', "slot_py": None, "target": None, "cond": None},
    0x4f51a: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFD020, 4))', "slot_py": None, "target": None, "cond": None},
    0x4f51c: {"kind": 'reg', "py": 'r[2] = 0xFFFFD01C', "slot_py": None, "target": None, "cond": None},
    0x4f51e: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0xFFFFD01C, 4))', "slot_py": None, "target": None, "cond": None},
    0x4f520: {"kind": 'fpu', "py": 'T = 1 if fr[2] > fr[3] else 0', "slot_py": None, "target": None, "cond": None},
    0x4f522: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4f52e, "cond": 'T'},
    0x4f526: {"kind": 'reg', "py": 'r[1] = 0x0007D0CB', "slot_py": None, "target": None, "cond": None},
    0x4f528: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0x0007D0CB, 1))', "slot_py": None, "target": None, "cond": None},
    0x4f52a: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFCFED, 1, r[0])', "target": 0x4f548, "cond": 'always'},
    0x4f52e: {"kind": 'reg', "py": 'r[1] = 0xFFFFD034', "slot_py": None, "target": None, "cond": None},
    0x4f530: {"kind": 'mem', "py": 'r[2] = s8(_rdw(ram, 0xFFFFD034, 1))', "slot_py": None, "target": None, "cond": None},
    0x4f532: {"kind": 'reg', "py": 'T = 1 if (r[2] & r[2]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x4f534: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4f548, "cond": 'notT'},
    0x4f538: {"kind": 'mem', "py": 'r[4] = s8(_rdw(ram, 0xFFFFCFED, 1))', "slot_py": None, "target": None, "cond": None},
    0x4f53a: {"kind": 'reg', "py": 'r[2] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x4f53c: {"kind": 'reg', "py": 'T = 1 if s32(r[2]) > 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x4f53e: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4f548, "cond": 'notT'},
    0x4f542: {"kind": 'reg', "py": 'r[2] = 0x000000FF', "slot_py": None, "target": None, "cond": None},
    0x4f544: {"kind": 'reg', "py": 'r[4] = (r[4] + r[2]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x4f546: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCFED, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x4f548: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
