#!/usr/bin/env python3
"""Differential test for FUN_00010a8c (0x10A8C) — v3 lift (branches + delay slots), 22 bytes.
...
Run from repo root: python3 c/tests/test_FUN_00010a8c_10a8c.py
"""
...
ENTRY = 0x10A8C
RAW = bytes.fromhex("33 48 64 33 34 27 8D 02 00 09 D1 66 34 1C 00 0B 60 43 2F E6 2F D6")
SEED = 42
N = 2000
MAXSTEPS = 100000
...
CODE = {
    0x10a8c: {"kind": 'reg', "py": 'r[3] = (r[3] - r[4]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x10a8e: {"kind": 'reg', "py": 'r[4] = r[3]', "slot_py": None, "target": None, "cond": None},
    0x10a90: {"kind": 'reg', "py": 'T = 1 if s32(r[4]) > s32(r[2]) else 0', "slot_py": None, "target": None, "cond": None},
    0x10a92: {"kind": "branch", "py": None, "slot_py": '', "target": 0x10a9a, "cond": 'T'},
    0x10a96: {"kind": 'reg', "py": 'r[1] = 0x01680000', "slot_py": None, "target": None, "cond": None},
    0x10a98: {"kind": 'reg', "py": 'r[4] = (r[4] + r[1]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x10a9a: {"kind": "ret", "py": None, "slot_py": 'r[0] = r[4]', "target": None, "cond": None},
    0x10a9e: {"kind": 'mem', "py": 'local[0x3FC] = r[14]\n_wrw(ram, STACK_BASE + 0x3FC, 4, r[14])\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x10aa0: {"kind": 'mem', "py": 'local[0x3F8] = r[13]\n_wrw(ram, STACK_BASE + 0x3F8, 4, r[13])\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},}
