#!/usr/bin/env python3
"""Differential test for calc_fuel_cut_flags_merged (0x11140) — v3 lift (branches + delay slots), 38 bytes.
...
Run from repo root: python3 c/tests/test_calc_fuel_cut_flags_merged_11140.py
"""
...
RAM_MAX = 0xFFFFA5DC
SPAN_END = 0x11166
SENT = 0x11166     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x11140: {"kind": 'reg', "py": 'r[3] = 0xFFFFA5D8', "slot_py": None, "target": None, "cond": None},
    0x11142: {"kind": 'reg', "py": 'r[5] = 0xFFFFA578', "slot_py": None, "target": None, "cond": None},
    0x11144: {"kind": 'mem', "py": 'r[2] = s8(_rdw(ram, 0xFFFFA578, 1))', "slot_py": None, "target": None, "cond": None},
    0x11146: {"kind": 'reg', "py": 'T = 1 if (r[2] & r[2]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x11148: {"kind": "branch", "py": None, "slot_py": 'r[4] = s16(_rdw(ram, 0xFFFFA5D8, 2))', "target": 0x11152, "cond": 'notT'},
    0x1114c: {"kind": 'reg', "py": 'r[1] = 0xFFFFA5DA', "slot_py": None, "target": None, "cond": None},
    0x1114e: {"kind": 'mem', "py": 'r[0] = s16(_rdw(ram, 0xFFFFA5DA, 2))', "slot_py": None, "target": None, "cond": None},
    0x11150: {"kind": 'reg', "py": 'r[4] = (r[4] | r[0]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x11152: {"kind": 'reg', "py": 'r[0] = s8(0x2C)', "slot_py": None, "target": None, "cond": None},
    0x11154: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, (0xFFFFA578 + r[0]), 1))', "slot_py": None, "target": None, "cond": None},
    0x11156: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x11158: {"kind": "branch", "py": None, "slot_py": '', "target": 0x11162, "cond": 'notT'},
    0x1115c: {"kind": 'reg', "py": 'r[2] = 0xFFFFA5DC', "slot_py": None, "target": None, "cond": None},
    0x1115e: {"kind": 'mem', "py": 'r[1] = s16(_rdw(ram, 0xFFFFA5DC, 2))', "slot_py": None, "target": None, "cond": None},
    0x11160: {"kind": 'reg', "py": 'r[4] = (r[4] | r[1]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x11162: {"kind": "ret", "py": None, "slot_py": 'r[0] = r[4]', "target": None, "cond": None},}
