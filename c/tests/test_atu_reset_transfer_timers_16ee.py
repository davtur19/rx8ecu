#!/usr/bin/env python3
"""Differential test for atu_reset_transfer_timers (0x16EE) — v3 lift (branches + delay slots), 22 bytes.
...
Run from repo root: python3 c/tests/test_atu_reset_transfer_timers_16ee.py
"""
...
ENTRY = 0x16EE
RAW = bytes.fromhex("E3 0D 92 0A 22 31 93 09 E4 00 23 41 91 07 21 41 72 30 00 0B 22 41")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFF770
SPAN_END = 0x1704
SENT = 0x1704     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x16ee: {"kind": 'reg', "py": 'r[3] = s8(0x0D)', "slot_py": None, "target": None, "cond": None},
    0x16f0: {"kind": 'reg', "py": 'r[2] = 0xFFFFF740', "slot_py": None, "target": None, "cond": None},
    0x16f2: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFF740, 2, r[3])', "slot_py": None, "target": None, "cond": None},
    0x16f4: {"kind": 'reg', "py": 'r[3] = 0xFFFFF750', "slot_py": None, "target": None, "cond": None},
    0x16f6: {"kind": 'reg', "py": 'r[4] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x16f8: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFF750, 2, r[4])', "slot_py": None, "target": None, "cond": None},
    0x16fa: {"kind": 'reg', "py": 'r[1] = 0xFFFFF748', "slot_py": None, "target": None, "cond": None},
    0x16fc: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFF748, 2, r[4])', "slot_py": None, "target": None, "cond": None},
    0x16fe: {"kind": 'reg', "py": 'r[2] = (r[2] + s8(0x30)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x1700: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFF770, 2, r[4])', "target": None, "cond": None},}
