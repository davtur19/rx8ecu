#!/usr/bin/env python3
"""Differential test for sample_copy_float_bbe8_to_bfbc (0x32564) — v3 lift + v4 FPU, 10 bytes.
...
Run from repo root: python3 c/tests/test_sample_copy_float_bbe8_to_bfbc_32564.py
"""
...
ENTRY = 0x32564
RAW = bytes.fromhex("93 12 F3 38 92 11 00 0B F2 3A")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBFBC
SPAN_END = 0x3256E
SENT = 0x3256E     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x32564: {"kind": 'reg', "py": 'r[3] = 0xFFFFBBE8', "slot_py": None, "target": None, "cond": None},
    0x32566: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFBBE8, 4))', "slot_py": None, "target": None, "cond": None},
    0x32568: {"kind": 'reg', "py": 'r[2] = 0xFFFFBFBC', "slot_py": None, "target": None, "cond": None},
    0x3256a: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBFBC, 4, f2bits(fr[3]))', "target": None, "cond": None},}
