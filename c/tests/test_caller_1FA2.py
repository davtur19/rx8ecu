#!/usr/bin/env python3
"""Differential test for caller_1FA2 (entry 0x1FA2) — v8 ST caller (CFG), 20 bytes.
...
Run: python3 test_caller_1FA2.py
"""
...
CODE = {
    0x1fa2: {"kind": 'reg', "py": 'r[4] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x1fa4: {"kind": 'reg', "py": 'r[3] = s8(0x20)', "slot_py": None, "target": None, "cond": None},
    0x1fa6: {"kind": 'reg', "py": 'T = 1 if s32(r[4]) >= s32(r[3]) else 0', "slot_py": None, "target": None, "cond": None},
    0x1fa8: {"kind": "branch", "py": None, "slot_py": None, "target": 0x1fae, "cond": 'T'},
    0x1faa: {"kind": "branch", "py": None, "slot_py": 'r[4] = r[5]', "target": 0x1fb2, "cond": 'always'},
    0x1fae: {"kind": 'reg', "py": 'r[4] = 0x00000200', "slot_py": None, "target": None, "cond": None},
    0x1fb0: {"kind": 'reg', "py": 'r[4] = (r[4] + r[5]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x1fb2: {"kind": "ret", "py": None, "slot_py": 'r[0] = r[4]', "target": None, "cond": None},
}
