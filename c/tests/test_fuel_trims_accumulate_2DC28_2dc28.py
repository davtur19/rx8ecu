#!/usr/bin/env python3
"""Differential test for fuel_trims_accumulate_2DC28 (0x2DC28) — v3 lift + v4 FPU, 22 bytes.
...
Run from repo root: python3 c/tests/test_fuel_trims_accumulate_2DC28_2dc28.py
"""
...
RAM_MAX = 0xFFFFBD34
SPAN_END = 0x2DC3E
SENT = 0x2DC3E     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x2dc28: {"kind": 'reg', "py": 'r[3] = 0xFFFFBD2C', "slot_py": None, "target": None, "cond": None},
    0x2dc2a: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFBD2C, 4))', "slot_py": None, "target": None, "cond": None},
    0x2dc2c: {"kind": 'reg', "py": 'r[1] = 0xFFFFBD28', "slot_py": None, "target": None, "cond": None},
    0x2dc2e: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0xFFFFBD28, 4))', "slot_py": None, "target": None, "cond": None},
    0x2dc30: {"kind": 'reg', "py": 'r[2] = 0xFFFFBD34', "slot_py": None, "target": None, "cond": None},
    0x2dc32: {"kind": 'fpu', "py": 'fr[2] = ts(fr[2] + fr[3])', "slot_py": None, "target": None, "cond": None},
    0x2dc34: {"kind": 'reg', "py": 'r[1] = 0xFFFFBD20', "slot_py": None, "target": None, "cond": None},
    0x2dc36: {"kind": 'fpu', "py": 'fr[1] = bits2f(_rdw(ram, 0xFFFFBD34, 4))', "slot_py": None, "target": None, "cond": None},
    0x2dc38: {"kind": 'fpu', "py": 'fr[2] = ts(fr[2] + fr[1])', "slot_py": None, "target": None, "cond": None},
    0x2dc3a: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBD20, 4, f2bits(fr[2]))', "target": None, "cond": None},}
