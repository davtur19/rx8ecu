#!/usr/bin/env python3
"""Differential test for thresh_flag_ba49_word_arr (0x27D38) — v3 lift + v4 FPU, 112 bytes.
...
Run from repo root: python3 c/tests/test_thresh_flag_ba49_word_arr_27d38.py
"""
...
ENTRY = 0x27D38
RAW = bytes.fromhex("93 72 F4 38 92 71 F3 28 91 70 F2 18 F3 25 8F 24 00 09 D3 3A 60 30 60 0C 88 01 8D 1E 00 09 91 66 D2 37 60 11 63 21 30 32 8D 17 00 09 93 60 60 31 D1 33 62 11 30 22 8D 10 00 09 92 5A 63 11 60 21 30 32 8D 0A 00 09 D3 2F F1 38 F1 45 8D 05 00 09 D0 2D F1 08 F4 15 8F 09 00 09 D3 2C 62 31 62 2D 42 15 8F 03 00 09 E3 01 D2 29 22 30 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCA60
SPAN_END = 0x27DA8
SENT = 0x27DA8     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x27d38: {"kind": 'reg', "py": 'r[3] = 0xFFFFC828', "slot_py": None, "target": None, "cond": None},
    0x27d3a: {"kind": 'fpu', "py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFC828, 4))', "slot_py": None, "target": None, "cond": None},
    0x27d3c: {"kind": 'reg', "py": 'r[2] = 0xFFFFBAB8', "slot_py": None, "target": None, "cond": None},
    0x27d3e: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFBAB8, 4))', "slot_py": None, "target": None, "cond": None},
    0x27d40: {"kind": 'reg', "py": 'r[1] = 0xFFFFBA88', "slot_py": None, "target": None, "cond": None},
    0x27d42: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0xFFFFBA88, 4))', "slot_py": None, "target": None, "cond": None},
    0x27d44: {"kind": 'fpu', "py": 'T = 1 if fr[3] > fr[2] else 0', "slot_py": None, "target": None, "cond": None},
    0x27d46: {"kind": "branch", "py": None, "slot_py": '', "target": 0x27d92, "cond": 'notT'},
    0x27d4a: {"kind": 'reg', "py": 'r[3] = 0xFFFFBA48', "slot_py": None, "target": None, "cond": None},
    0x27d4c: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFBA48, 1))', "slot_py": None, "target": None, "cond": None},
    0x27d4e: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x27d50: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x27d52: {"kind": "branch", "py": None, "slot_py": '', "target": 0x27d92, "cond": 'T'},
    0x27d56: {"kind": 'reg', "py": 'r[1] = 0xFFFFCA60', "slot_py": None, "target": None, "cond": None},
    0x27d58: {"kind": 'reg', "py": 'r[2] = 0x0007523C', "slot_py": None, "target": None, "cond": None},
    0x27d5a: {"kind": 'mem', "py": 'r[0] = s16(_rdw(ram, 0xFFFFCA60, 2))', "slot_py": None, "target": None, "cond": None},
    0x27d5c: {"kind": 'mem', "py": 'r[3] = s16(_rdw(ram, 0x0007523C, 2))', "slot_py": None, "target": None, "cond": None},
    0x27d5e: {"kind": 'reg', "py": 'T = 1 if (r[0] & 0xFFFFFFFF) >= (r[3] & 0xFFFFFFFF) else 0', "slot_py": None, "target": None, "cond": None},
    0x27d60: {"kind": "branch", "py": None, "slot_py": '', "target": 0x27d92, "cond": 'T'},
    0x27d64: {"kind": 'reg', "py": 'r[3] = 0xFFFFB6C4', "slot_py": None, "target": None, "cond": None},
    0x27d66: {"kind": 'mem', "py": 'r[0] = s16(_rdw(ram, 0xFFFFB6C4, 2))', "slot_py": None, "target": None, "cond": None},
    0x27d68: {"kind": 'reg', "py": 'r[1] = 0x0007523C', "slot_py": None, "target": None, "cond": None},
    0x27d6a: {"kind": 'mem', "py": 'r[2] = s16(_rdw(ram, 0x0007523C, 2))', "slot_py": None, "target": None, "cond": None},
    0x27d6c: {"kind": 'reg', "py": 'T = 1 if (r[0] & 0xFFFFFFFF) >= (r[2] & 0xFFFFFFFF) else 0', "slot_py": None, "target": None, "cond": None},
    0x27d6e: {"kind": "branch", "py": None, "slot_py": '', "target": 0x27d92, "cond": 'T'},
    0x27d72: {"kind": 'reg', "py": 'r[2] = 0xFFFFB6C6', "slot_py": None, "target": None, "cond": None},
    0x27d74: {"kind": 'mem', "py": 'r[3] = s16(_rdw(ram, 0x0007523C, 2))', "slot_py": None, "target": None, "cond": None},
    0x27d76: {"kind": 'mem', "py": 'r[0] = s16(_rdw(ram, 0xFFFFB6C6, 2))', "slot_py": None, "target": None, "cond": None},
    0x27d78: {"kind": 'reg', "py": 'T = 1 if (r[0] & 0xFFFFFFFF) >= (r[3] & 0xFFFFFFFF) else 0', "slot_py": None, "target": None, "cond": None},
    0x27d7a: {"kind": "branch", "py": None, "slot_py": '', "target": 0x27d92, "cond": 'T'},
    0x27d7e: {"kind": 'reg', "py": 'r[3] = 0x0007525C', "slot_py": None, "target": None, "cond": None},
    0x27d80: {"kind": 'fpu', "py": 'fr[1] = bits2f(_rdw(ram, 0x0007525C, 4))', "slot_py": None, "target": None, "cond": None},
    0x27d82: {"kind": 'fpu', "py": 'T = 1 if fr[1] > fr[4] else 0', "slot_py": None, "target": None, "cond": None},
    0x27d84: {"kind": "branch", "py": None, "slot_py": '', "target": 0x27d92, "cond": 'T'},
    0x27d88: {"kind": 'reg', "py": 'r[0] = 0x00075260', "slot_py": None, "target": None, "cond": None},
    0x27d8a: {"kind": 'fpu', "py": 'fr[1] = bits2f(_rdw(ram, 0x00075260, 4))', "slot_py": None, "target": None, "cond": None},
    0x27d8c: {"kind": 'fpu', "py": 'T = 1 if fr[4] > fr[1] else 0', "slot_py": None, "target": None, "cond": None},
    0x27d8e: {"kind": "branch", "py": None, "slot_py": '', "target": 0x27da4, "cond": 'notT'},
    0x27d92: {"kind": 'reg', "py": 'r[3] = 0xFFFFBA44', "slot_py": None, "target": None, "cond": None},
    0x27d94: {"kind": 'mem', "py": 'r[2] = s16(_rdw(ram, 0xFFFFBA44, 2))', "slot_py": None, "target": None, "cond": None},
    0x27d96: {"kind": 'reg', "py": 'r[2] = r[2] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x27d98: {"kind": 'reg', "py": 'T = 1 if s32(r[2]) > 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x27d9a: {"kind": "branch", "py": None, "slot_py": '', "target": 0x27da4, "cond": 'notT'},
    0x27d9e: {"kind": 'reg', "py": 'r[3] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x27da0: {"kind": 'reg', "py": 'r[2] = 0xFFFFBA49', "slot_py": None, "target": None, "cond": None},
    0x27da2: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBA49, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x27da4: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
