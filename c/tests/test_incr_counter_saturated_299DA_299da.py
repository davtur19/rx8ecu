#!/usr/bin/env python3
"""Differential test for incr_counter_saturated_299DA (0x299DA) — v3 lift (branches + delay slots), 42 bytes.
...
Run from repo root: python3 c/tests/test_incr_counter_saturated_299DA_299da.py
"""
...
ENTRY = 0x299DA
RAW = bytes.fromhex("95 15 92 15 63 20 63 3C 43 15 8F 04 00 09 D3 0A 61 30 A0 08 25 10 64 50 63 4C 23 38 8D 03 00 09 90 07 34 0C 25 40 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBAF8
SPAN_END = 0x29A04
SENT = 0x29A04     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x299da: {"kind": 'reg', "py": 'r[5] = 0xFFFFBAF8', "slot_py": None, "target": None, "cond": None},
    0x299dc: {"kind": 'reg', "py": 'r[2] = 0xFFFFA400', "slot_py": None, "target": None, "cond": None},
    0x299de: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFA400, 1))', "slot_py": None, "target": None, "cond": None},
    0x299e0: {"kind": 'reg', "py": 'r[3] = r[3] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x299e2: {"kind": 'reg', "py": 'T = 1 if s32(r[3]) > 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x299e4: {"kind": "branch", "py": None, "slot_py": '', "target": 0x299f0, "cond": 'notT'},
    0x299e8: {"kind": 'reg', "py": 'r[3] = 0x0006D485', "slot_py": None, "target": None, "cond": None},
    0x299ea: {"kind": 'mem', "py": 'r[1] = s8(_rdw(ram, 0x0006D485, 1))', "slot_py": None, "target": None, "cond": None},
    0x299ec: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFBAF8, 1, r[1])', "target": 0x29a00, "cond": 'always'},
    0x299f0: {"kind": 'mem', "py": 'r[4] = s8(_rdw(ram, r[5], 1))', "slot_py": None, "target": None, "cond": None},
    0x299f2: {"kind": 'reg', "py": 'r[3] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x299f4: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x299f6: {"kind": "branch", "py": None, "slot_py": '', "target": 0x29a00, "cond": 'T'},
    0x299fa: {"kind": 'reg', "py": 'r[0] = 0x000000FF', "slot_py": None, "target": None, "cond": None},
    0x299fc: {"kind": 'reg', "py": 'r[4] = (r[4] + r[0]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x299fe: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBAF8, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x29a00: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
