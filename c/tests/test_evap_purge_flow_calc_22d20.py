#!/usr/bin/env python3
"""Differential test for evap_purge_flow_calc (0x22D20) — pure straight-line lift, 10 bytes.
...
Run from repo root: python3 c/tests/test_evap_purge_flow_calc_22d20.py
"""
...
ENTRY = 0x22D20
RAW = bytes.fromhex("00 07 37 24 00 07 37 25 00 07")
SEED = 42
N = 2000
