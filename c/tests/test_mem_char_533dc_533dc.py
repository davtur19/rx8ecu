#!/usr/bin/env python3
"""Differential test for mem_char_533dc (0x533DC) — v3 lift (branches + delay slots), 20 bytes.
...
Run from repo root: python3 c/tests/test_mem_char_533dc_533dc.py
"""
...
ENTRY = 0x533DC
RAW = bytes.fromhex("92 12 63 20 23 38 8F 03 00 09 E0 00 91 0D 21 00 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    0x533dc: {"kind": 'reg', "py": 'r[2] = 0xFFFFCFFB', "slot_py": None, "target": None, "cond": None},
    0x533de: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFCFFB, 1))', "slot_py": None, "target": None, "cond": None},
    0x533e0: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x533e2: {"kind": "branch", "py": None, "slot_py": '', "target": 0x533ec, "cond": 'notT'},
    0x533e6: {"kind": 'reg', "py": 'r[0] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x533e8: {"kind": 'reg', "py": 'r[1] = 0xFFFFD16C', "slot_py": None, "target": None, "cond": None},
    0x533ea: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD16C, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x533ec: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
