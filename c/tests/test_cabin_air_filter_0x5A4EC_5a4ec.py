#!/usr/bin/env python3
"""Differential test for cabin_air_filter_0x5A4EC (0x5A4EC) — v3 lift (branches + delay slots), 68 bytes.
...
Run from repo root: python3 c/tests/test_cabin_air_filter_0x5A4EC_5a4ec.py
"""
...
CODE = {
    0x5a4ec: {"kind": 'reg', "py": 'r[3] = 0xFFFFD3D4', "slot_py": None, "target": None, "cond": None},
    0x5a4ee: {"kind": 'mem', "py": 'r[5] = s16(_rdw(ram, 0xFFFFD3D4, 2))', "slot_py": None, "target": None, "cond": None},
    0x5a4f0: {"kind": 'reg', "py": 'r[6] = 0xFFFFD2A1', "slot_py": None, "target": None, "cond": None},
    0x5a4f2: {"kind": 'reg', "py": 'r[2] = 0x0007C598', "slot_py": None, "target": None, "cond": None},
    0x5a4f4: {"kind": 'mem', "py": 'r[4] = s8(_rdw(ram, 0x0007C598, 1))', "slot_py": None, "target": None, "cond": None},
    0x5a4f6: {"kind": 'reg', "py": 'r[0] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x5a4f8: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x5a4fa: {"kind": "branch", "py": None, "slot_py": 'r[4] = r[0]', "target": 0x5a522, "cond": 'T'},
    0x5a4fe: {"kind": 'reg', "py": 'r[0] = r[4]', "slot_py": None, "target": None, "cond": None},
    0x5a500: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x02) else 0', "slot_py": None, "target": None, "cond": None},
    0x5a502: {"kind": "branch", "py": None, "slot_py": '', "target": 0x5a522, "cond": 'T'},
    0x5a506: {"kind": 'reg', "py": 'r[1] = 0x000000FF', "slot_py": None, "target": None, "cond": None},
    0x5a508: {"kind": 'reg', "py": 'T = 1 if r[4] == r[1] else 0', "slot_py": None, "target": None, "cond": None},
    0x5a50a: {"kind": "branch", "py": None, "slot_py": '', "target": 0x5a528, "cond": 'notT'},
    0x5a50e: {"kind": 'reg', "py": 'r[0] = r[5] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x5a510: {"kind": 'reg', "py": 'r[3] = 0x00003031', "slot_py": None, "target": None, "cond": None},
    0x5a512: {"kind": 'reg', "py": 'T = 1 if r[0] == r[3] else 0', "slot_py": None, "target": None, "cond": None},
    0x5a514: {"kind": "branch", "py": None, "slot_py": '', "target": 0x5a522, "cond": 'T'},
    0x5a518: {"kind": 'reg', "py": 'r[2] = 0x00003032', "slot_py": None, "target": None, "cond": None},
    0x5a51a: {"kind": 'reg', "py": 'r[0] = r[5] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x5a51c: {"kind": 'reg', "py": 'T = 1 if r[0] == r[2] else 0', "slot_py": None, "target": None, "cond": None},
    0x5a51e: {"kind": "branch", "py": None, "slot_py": '', "target": 0x5a528, "cond": 'notT'},
    0x5a522: {"kind": 'reg', "py": 'r[1] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x5a524: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFD2A1, 1, r[1])', "target": 0x5a52c, "cond": 'always'},
    0x5a528: {"kind": 'reg', "py": 'r[2] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x5a52a: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD2A1, 1, r[2])', "slot_py": None, "target": None, "cond": None},
    0x5a52c: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
