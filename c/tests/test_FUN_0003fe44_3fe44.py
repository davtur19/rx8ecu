#!/usr/bin/env python3
"""Differential test for FUN_0003fe44 (0x3FE44) — v3 lift + v4 FPU, 12 bytes.
...
Run from repo root: python3 c/tests/test_FUN_0003fe44_3fe44.py
"""
...
ENTRY = 0x3FE44
RAW = bytes.fromhex("D3 25 F4 9D D2 25 F3 4A 00 0B F2 4A")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFC708
SPAN_END = 0x3FE50
SENT = 0x3FE50     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x3fe44: {"kind": 'reg', "py": 'r[3] = 0xFFFFC704', "slot_py": None, "target": None, "cond": None},
    0x3fe46: {"kind": 'fpu', "py": 'fr[4] = 1.0', "slot_py": None, "target": None, "cond": None},
    0x3fe48: {"kind": 'reg', "py": 'r[2] = 0xFFFFC708', "slot_py": None, "target": None, "cond": None},
    0x3fe4a: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFC704, 4, f2bits(fr[4]))', "slot_py": None, "target": None, "cond": None},
    0x3fe4c: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFC708, 4, f2bits(fr[4]))', "target": None, "cond": None},}
