#!/usr/bin/env python3
"""Differential test for caller_4F028 (entry 0x4F028) — v8 ST caller (CFG), 22 bytes.
...
Run: python3 test_caller_4F028.py
"""
...
CODE = {
    0x4f028: {"kind": 'st', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x4f02a: {"kind": 'reg', "py": 'r[3] = 0x0007BE94', "slot_py": None, "target": None, "cond": None},
    0x4f02c: {"kind": 'reg', "py": 'r[4] = 0xFFFF86E4', "slot_py": None, "target": None, "cond": None},
    0x4f02e: {"kind": 'reg', "py": 'r[2] = 0x0003E1F8', "slot_py": None, "target": None, "cond": None},
    0x4f030: {"kind": "call", "py": None, "slot_py": 'r[5] = s8(_rdw(ram, 0x0007BE94, 1))', "target": 0x3e1f8, "ret_pc": 0x4f034, "set_pr": True, "cond": None},
    0x4f034: {"kind": 'reg', "py": 'r[4] = 0xFFFF86E6', "slot_py": None, "target": None, "cond": None},
    0x4f036: {"kind": 'reg', "py": 'r[5] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x4f038: {"kind": 'reg', "py": 'r[3] = 0x0003E1F8', "slot_py": None, "target": None, "cond": None},
    0x4f03a: {"kind": "call", "py": None, "slot_py": 'pr = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": 0x3e1f8, "ret_pc": 0x4f03e, "set_pr": False, "cond": None},
