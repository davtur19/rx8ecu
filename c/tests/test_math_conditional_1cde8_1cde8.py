#!/usr/bin/env python3
"""Differential test for math_conditional_1cde8 (0x1CDE8) — v3 lift + v4 FPU, 26 bytes.
...
Run from repo root: python3 c/tests/test_math_conditional_1cde8_1cde8.py
"""
...
RAM_MAX = 0xFFFFC64B
SPAN_END = 0x1CE02
SENT = 0x1CE02     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x1cde8: {"kind": 'reg', "py": 'r[4] = 0xFFFFAE54', "slot_py": None, "target": None, "cond": None},
    0x1cdea: {"kind": 'reg', "py": 'r[2] = 0xFFFFC64B', "slot_py": None, "target": None, "cond": None},
    0x1cdec: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFC64B, 1))', "slot_py": None, "target": None, "cond": None},
    0x1cdee: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x1cdf0: {"kind": "branch", "py": None, "slot_py": '', "target": 0x1cdfa, "cond": 'notT'},
    0x1cdf4: {"kind": 'reg', "py": 'r[1] = 0xFFFFAE50', "slot_py": None, "target": None, "cond": None},
    0x1cdf6: {"kind": "branch", "py": None, "slot_py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFAE50, 4))', "target": 0x1cdfe, "cond": 'always'},
    0x1cdfa: {"kind": 'reg', "py": 'r[3] = 0x0007002C', "slot_py": None, "target": None, "cond": None},
    0x1cdfc: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x0007002C, 4))', "slot_py": None, "target": None, "cond": None},
    0x1cdfe: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, r[4], 4, f2bits(fr[3]))', "target": None, "cond": None},}
