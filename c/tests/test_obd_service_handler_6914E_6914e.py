#!/usr/bin/env python3
"""Differential test for obd_service_handler_6914E (0x6914E) — v3 lift (branches + delay slots), 26 bytes.
...
Run from repo root: python3 c/tests/test_obd_service_handler_6914E_6914e.py
"""
...
CODE = {
    0x6914e: {"kind": 'reg', "py": 'r[3] = 0xFFFFDE31', "slot_py": None, "target": None, "cond": None},
    0x69150: {"kind": 'mem', "py": 'r[5] = s8(_rdw(ram, 0xFFFFDE31, 1))', "slot_py": None, "target": None, "cond": None},
    0x69152: {"kind": 'reg', "py": 'r[6] = r[5] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x69154: {"kind": 'reg', "py": 'T = 1 if (r[6] & r[6]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x69156: {"kind": "branch", "py": None, "slot_py": 'r[4] = s8(0x01)', "target": 0x69162, "cond": 'T'},
    0x6915a: {"kind": 'reg', "py": 'r[1] = s8(0x04)', "slot_py": None, "target": None, "cond": None},
    0x6915c: {"kind": 'reg', "py": 'T = 1 if (r[1] & r[6]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x6915e: {"kind": "branch", "py": None, "slot_py": '', "target": 0x69164, "cond": 'T'},
    0x69162: {"kind": 'reg', "py": 'r[4] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x69164: {"kind": "ret", "py": None, "slot_py": 'r[0] = r[4]', "target": None, "cond": None},}
