#!/usr/bin/env python3
"""Differential test for mutex_lock_0x52ACC (0x52ACC) — v3 lift (branches + delay slots), 30 bytes.
...
Run from repo root: python3 c/tests/test_mutex_lock_0x52ACC_52acc.py
"""
...
ENTRY = 0x52ACC
RAW = bytes.fromhex("63 44 75 01 26 30 76 01 84 71 62 5C 60 0C 32 03 8F F6 00 09 A0 01 00 09 E5 00 00 0B 60 53")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = None
SPAN_END = 0x52AEA
SENT = 0x52AEA     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x52acc: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, r[4], 1))\nr[4] = (r[4] + 1) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x52ace: {"kind": 'reg', "py": 'r[5] = (r[5] + s8(0x01)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x52ad0: {"kind": 'mem', "py": '_wrw(ram, r[6], 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x52ad2: {"kind": 'reg', "py": 'r[6] = (r[6] + s8(0x01)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x52ad4: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, (r[7] + 1), 1))', "slot_py": None, "target": None, "cond": None},
    0x52ad6: {"kind": 'reg', "py": 'r[2] = r[5] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x52ad8: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x52ada: {"kind": 'reg', "py": 'T = 1 if s32(r[2]) >= s32(r[0]) else 0', "slot_py": None, "target": None, "cond": None},
    0x52adc: {"kind": "branch", "py": None, "slot_py": '', "target": 0x52acc, "cond": 'notT'},
    0x52ae0: {"kind": "branch", "py": None, "slot_py": '', "target": 0x52ae6, "cond": 'always'},
    0x52ae4: {"kind": 'reg', "py": 'r[5] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x52ae6: {"kind": "ret", "py": None, "slot_py": 'r[0] = r[5]', "target": None, "cond": None},}
