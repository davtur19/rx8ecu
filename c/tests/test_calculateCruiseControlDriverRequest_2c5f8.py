#!/usr/bin/env python3
"""Differential test for calculateCruiseControlDriverRequest (0x2C5F8) — v3 lift (branches + delay slots), 18 bytes.
...
Run from repo root: python3 c/tests/test_calculateCruiseControlDriverRequest_2c5f8.py
"""
...
ENTRY = 0x2C5F8
RAW = bytes.fromhex("8F 03 00 09 E1 01 A0 02 24 10 E3 00 24 30 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    ...
    0x2c5fe: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, r[4], 1, r[1])', "target": 0x2c606, "cond": 'always'},
    0x2c602: {"kind": 'reg', "py": 'r[3] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x2c604: {"kind": 'mem', "py": '_wrw(ram, r[4], 1, r[3])', "slot_py": None, "target": None, "cond": None},
