#!/usr/bin/env python3
"""Differential test for caller_614C2 (entry 0x614C2) — v8 ST caller (CFG), 16 bytes.
...
Run: python3 test_caller_614C2.py
"""
...
CODE = {
    0x614c2: {"kind": 'st', "py": 'local[0x3FC] = pr\n_wrw(ram, STACK_BASE + 0x3FC, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x614c4: {"kind": 'reg', "py": 'r[3] = 0x00002420', "slot_py": None, "target": None, "cond": None},
    0x614c6: {"kind": "call", "py": None, "slot_py": 'r[4] = s8(0x00)', "target": 0x2420, "ret_pc": 0x614ca, "set_pr": True, "cond": None},
    0x614ca: {"kind": 'reg', "py": 'r[2] = 0xFFFF87A8', "slot_py": None, "target": None, "cond": None},
    0x614cc: {"kind": 'st', "py": 'pr = _rdw(ram, STACK_BASE + 0x3FC, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x614ce: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFF87A8, 2, r[0])', "target": None, "cond": None},
