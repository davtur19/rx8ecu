#!/usr/bin/env python3
"""Differential test for getAlternatorFaultStatus (0x2687E) — v3 lift (branches + delay slots), 26 bytes.
...
Run from repo root: python3 c/tests/test_getAlternatorFaultStatus_2687e.py
"""
...
ENTRY = 0x2687E
RAW = bytes.fromhex("94 4D 92 4D 63 21 23 38 8F 03 00 09 E0 01 A0 02 24 00 E1 00 24 10 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    0x2687e: {"kind": 'reg', "py": 'r[4] = 0xFFFFB621', "slot_py": None, "target": None, "cond": None},
    0x26880: {"kind": 'reg', "py": 'r[2] = 0xFFFFB67A', "slot_py": None, "target": None, "cond": None},
    0x26882: {"kind": 'mem', "py": 'r[3] = s16(_rdw(ram, 0xFFFFB67A, 2))', "slot_py": None, "target": None, "cond": None},
    0x26884: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x26886: {"kind": "branch", "py": None, "slot_py": '', "target": 0x26890, "cond": 'notT'},
    0x2688a: {"kind": 'reg', "py": 'r[0] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x2688c: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFB621, 1, r[0])', "target": 0x26894, "cond": 'always'},
    0x26890: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x26892: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFB621, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x26894: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
