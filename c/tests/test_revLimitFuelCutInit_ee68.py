#!/usr/bin/env python3
"""Differential test for revLimitFuelCutInit (0xEE68) — v3 lift (branches + delay slots), 30 bytes.
...
Run from repo root: python3 c/tests/test_revLimitFuelCutInit_ee68.py
"""
...
ENTRY = 0xEE68
RAW = bytes.fromhex("D3 3D 60 30 60 0C 88 01 8F 07 00 09 91 68 E4 00 92 67 21 40 22 40 D3 39 23 41 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFA4A8
SPAN_END = 0xEE86
SENT = 0xEE86     # stop-sentinel, placed past the literal pool
...
CODE = {
    0xee68: {"kind": 'reg', "py": 'r[3] = 0xFFFF9F8C', "slot_py": None, "target": None, "cond": None},
    0xee6a: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFF9F8C, 1))', "slot_py": None, "target": None, "cond": None},
    0xee6c: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0xee6e: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0xee70: {"kind": "branch", "py": None, "slot_py": '', "target": 0xee82, "cond": 'notT'},
    0xee74: {"kind": 'reg', "py": 'r[1] = 0xFFFFA4A4', "slot_py": None, "target": None, "cond": None},
    0xee76: {"kind": 'reg', "py": 'r[4] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0xee78: {"kind": 'reg', "py": 'r[2] = 0xFFFFA4A5', "slot_py": None, "target": None, "cond": None},
    0xee7a: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA4A4, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0xee7c: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA4A5, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0xee7e: {"kind": 'reg', "py": 'r[3] = 0xFFFFA4A8', "slot_py": None, "target": None, "cond": None},
    0xee80: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA4A8, 2, r[4])', "slot_py": None, "target": None, "cond": None},
    0xee82: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
