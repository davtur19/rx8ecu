#!/usr/bin/env python3
"""Differential test for diag_flags_pack_to_bb8f (0x2A5CA) — v3 lift (branches + delay slots), 52 bytes.
...
Run from repo root: python3 c/tests/test_diag_flags_pack_to_bb8f_2a5ca.py
"""
...
ENTRY = 0x2A5CA
RAW = bytes.fromhex("93 2C 60 30 60 0C 88 01 8F 01 E4 00 94 27 93 27 60 30 60 0C 88 01 8F 02 00 09 E1 04 24 1B 93 20 60 30 60 0C 88 01 8F 02 00 09 E1 01 24 1B D3 1A 00 0B 23 40")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBB8F
SPAN_END = 0x2A5FE
SENT = 0x2A5FE     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x2a5ca: {"kind": 'reg', "py": 'r[3] = 0xFFFFBB7C', "slot_py": None, "target": None, "cond": None},
    0x2a5cc: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFBB7C, 1))', "slot_py": None, "target": None, "cond": None},
    0x2a5ce: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x2a5d0: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x2a5d2: {"kind": "branch", "py": None, "slot_py": 'r[4] = s8(0x00)', "target": 0x2a5d8, "cond": 'notT'},
    0x2a5d6: {"kind": 'reg', "py": 'r[4] = 0x00000080', "slot_py": None, "target": None, "cond": None},
    0x2a5d8: {"kind": 'reg', "py": 'r[3] = 0xFFFFBB7D', "slot_py": None, "target": None, "cond": None},
    0x2a5da: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFBB7D, 1))', "slot_py": None, "target": None, "cond": None},
    0x2a5dc: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x2a5de: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x2a5e0: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2a5e8, "cond": 'notT'},
    0x2a5e4: {"kind": 'reg', "py": 'r[1] = s8(0x04)', "slot_py": None, "target": None, "cond": None},
    0x2a5e6: {"kind": 'reg', "py": 'r[4] = (r[4] | r[1]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x2a5e8: {"kind": 'reg', "py": 'r[3] = 0xFFFFBB7E', "slot_py": None, "target": None, "cond": None},
    0x2a5ea: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFBB7E, 1))', "slot_py": None, "target": None, "cond": None},
    0x2a5ec: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x2a5ee: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x2a5f0: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2a5f8, "cond": 'notT'},
    0x2a5f4: {"kind": 'reg', "py": 'r[1] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x2a5f6: {"kind": 'reg', "py": 'r[4] = (r[4] | r[1]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x2a5f8: {"kind": 'reg', "py": 'r[3] = 0xFFFFBB8F', "slot_py": None, "target": None, "cond": None},
    0x2a5fa: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBB8F, 1, r[4])', "target": None, "cond": None},}
