#!/usr/bin/env python3
"""Differential test for base_timing_lookup_0x50352 (0x50352) — v3 lift + v4 FPU, 10 bytes.
...
Run from repo root: python3 c/tests/test_base_timing_lookup_0x50352_50352.py
"""
...
RAM_MAX = 0xFFFFD044
SPAN_END = 0x5035C
SENT = 0x5035C     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x50352: {"kind": 'reg', "py": 'r[0] = 0x000503BC', "slot_py": None, "target": None, "cond": None},
    0x50354: {"kind": 'reg', "py": 'r[3] = 0xFFFFD044', "slot_py": None, "target": None, "cond": None},
    0x50356: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x000503BC, 4))', "slot_py": None, "target": None, "cond": None},
    0x50358: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFD044, 4, f2bits(fr[3]))', "target": None, "cond": None},}
