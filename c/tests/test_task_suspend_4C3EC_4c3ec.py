#!/usr/bin/env python3
"""Differential test for task_suspend_4C3EC (0x4C3EC) — v3 lift (branches + delay slots), 32 bytes.
...
Run from repo root: python3 c/tests/test_task_suspend_4C3EC_4c3ec.py
"""
...
ENTRY = 0x4C3EC
RAW = bytes.fromhex("88 01 8D 06 00 09 92 2A 60 20 60 0C 88 01 8F 03 00 09 E3 01 A0 02 24 30 E1 00 24 10 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCEBC
SPAN_END = 0x4C40C
SENT = 0x4C40C     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x4c3ec: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x4c3ee: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4c3fe, "cond": 'T'},
    0x4c3f2: {"kind": 'reg', "py": 'r[2] = 0xFFFFCEBC', "slot_py": None, "target": None, "cond": None},
    0x4c3f4: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCEBC, 1))', "slot_py": None, "target": None, "cond": None},
    0x4c3f6: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x4c3f8: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x4c3fa: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4c404, "cond": 'notT'},
    0x4c3fe: {"kind": 'reg', "py": 'r[3] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x4c400: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, r[4], 1, r[3])', "target": 0x4c408, "cond": 'always'},
    0x4c404: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x4c406: {"kind": 'mem', "py": '_wrw(ram, r[4], 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x4c408: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
