#!/usr/bin/env python3
"""Differential test for fuel_pressure_monitor_reset_45984 (0x45984) — v3 lift (branches + delay slots), 46 bytes.
...
Run from repo root: python3 c/tests/test_fuel_pressure_monitor_reset_45984_45984.py
"""
...
CODE = {
    0x45984: {"kind": 'reg', "py": 'r[3] = 0xFFFFD201', "slot_py": None, "target": None, "cond": None},
    0x45986: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFD201, 1))', "slot_py": None, "target": None, "cond": None},
    0x45988: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x4598a: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x4598c: {"kind": "branch", "py": None, "slot_py": '', "target": 0x459ae, "cond": 'notT'},
    0x45990: {"kind": 'reg', "py": 'r[2] = 0xFFFFA41C', "slot_py": None, "target": None, "cond": None},
    0x45992: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFA41C, 1))', "slot_py": None, "target": None, "cond": None},
    0x45994: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x45996: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x45998: {"kind": "branch", "py": None, "slot_py": '', "target": 0x459ae, "cond": 'notT'},
    0x4599c: {"kind": 'reg', "py": 'r[3] = 0xFFFFCBE4', "slot_py": None, "target": None, "cond": None},
    0x4599e: {"kind": 'reg', "py": 'r[4] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x459a0: {"kind": 'reg', "py": 'r[2] = 0xFFFFCBE6', "slot_py": None, "target": None, "cond": None},
    0x459a2: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCBE4, 2, r[4])', "slot_py": None, "target": None, "cond": None},
    0x459a4: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCBE6, 2, r[4])', "slot_py": None, "target": None, "cond": None},
    0x459a6: {"kind": 'reg', "py": 'r[1] = 0xFFFFCBE8', "slot_py": None, "target": None, "cond": None},
    0x459a8: {"kind": 'reg', "py": 'r[3] = 0xFFFFCBEA', "slot_py": None, "target": None, "cond": None},
    0x459aa: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCBE8, 2, r[4])', "slot_py": None, "target": None, "cond": None},
    0x459ac: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCBEA, 2, r[4])', "slot_py": None, "target": None, "cond": None},
    0x459ae: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
