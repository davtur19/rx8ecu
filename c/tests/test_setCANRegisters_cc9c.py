#!/usr/bin/env python3
"""Differential test for setCANRegisters (0xCC9C) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_setCANRegisters_cc9c.py
"""
...
ENTRY = 0xCC9C
RAW = bytes.fromhex("4F 26 68 F6 00 0B 6E F6")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = None
SPAN_END = 0xCCA4
SENT = 0xCCA4     # stop-sentinel, placed past the literal pool
...
CODE = {
    0xcc9c: {"kind": 'mem', "py": 'pr = _rdw(ram, STACK_BASE + 0x400, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xcc9e: {"kind": 'mem', "py": 'r[8] = _rdw(ram, STACK_BASE + 0x404, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xcca0: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, STACK_BASE + 0x408, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},}
