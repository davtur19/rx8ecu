#!/usr/bin/env python3
"""Differential test for revLimitFuelCutInit (0xF0FC) — v3 lift (branches + delay slots), 30 bytes.
...
Run from repo root: python3 c/tests/test_revLimitFuelCutInit_f0fc.py
"""
...
CODE = {
    0xf0fc: {"kind": 'reg', "py": 'r[3] = 0xFFFF9F8C', "slot_py": None, "target": None, "cond": None},
    0xf0fe: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFF9F8C, 1))', "slot_py": None, "target": None, "cond": None},
    0xf100: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0xf102: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0xf104: {"kind": "branch", "py": None, "slot_py": '', "target": 0xf116, "cond": 'notT'},
    0xf108: {"kind": 'reg', "py": 'r[1] = 0xFFFFA4A4', "slot_py": None, "target": None, "cond": None},
    0xf10a: {"kind": 'reg', "py": 'r[4] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0xf10c: {"kind": 'reg', "py": 'r[2] = 0xFFFFA4A5', "slot_py": None, "target": None, "cond": None},
    0xf10e: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA4A4, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0xf110: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA4A5, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0xf112: {"kind": 'reg', "py": 'r[3] = 0xFFFFA4A8', "slot_py": None, "target": None, "cond": None},
    0xf114: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA4A8, 2, r[4])', "slot_py": None, "target": None, "cond": None},
    0xf116: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
