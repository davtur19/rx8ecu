#!/usr/bin/env python3
"""Differential test for parseSubFunction (0x5878C) — v3 lift (branches + delay slots), 58 bytes.
...
Run from repo root: python3 c/tests/test_parseSubFunction_5878c.py
"""
...
RAM_MAX = 0xFFFFD209
SPAN_END = 0x587C6
SENT = 0x587CA     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x5878c: {"kind": 'reg', "py": 'r[5] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x5878e: {"kind": 'reg', "py": 'r[0] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x58790: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x58792: {"kind": "branch", "py": None, "slot_py": 'r[6] = s8(0x00)', "target": 0x587a0, "cond": 'T'},
    0x58796: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x04) else 0', "slot_py": None, "target": None, "cond": None},
    0x58798: {"kind": "branch", "py": None, "slot_py": '', "target": 0x587b0, "cond": 'T'},
    0x5879c: {"kind": "branch", "py": None, "slot_py": '', "target": 0x587c0, "cond": 'always'},
    0x587a0: {"kind": 'reg', "py": 'r[3] = 0xFFFFD208', "slot_py": None, "target": None, "cond": None},
    0x587a2: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFD208, 1))', "slot_py": None, "target": None, "cond": None},
    0x587a4: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x587a6: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x587a8: {"kind": "branch", "py": None, "slot_py": '', "target": 0x587c2, "cond": 'notT'},
    0x587ac: {"kind": "branch", "py": None, "slot_py": 'r[5] = r[6]', "target": 0x587c2, "cond": 'always'},
    0x587b0: {"kind": 'reg', "py": 'r[3] = 0xFFFFD209', "slot_py": None, "target": None, "cond": None},
    0x587b2: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFD209, 1))', "slot_py": None, "target": None, "cond": None},
    0x587b4: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x587b6: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x587b8: {"kind": "branch", "py": None, "slot_py": '', "target": 0x587c2, "cond": 'notT'},
    0x587bc: {"kind": "branch", "py": None, "slot_py": 'r[5] = r[6]', "target": 0x587c2, "cond": 'always'},
    0x587c0: {"kind": 'reg', "py": 'r[5] = r[6]', "slot_py": None, "target": None, "cond": None},
    0x587c2: {"kind": "ret", "py": None, "slot_py": 'r[0] = r[5]', "target": None, "cond": None},}
