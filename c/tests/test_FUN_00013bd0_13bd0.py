#!/usr/bin/env python3
"""Differential test for FUN_00013bd0 (0x13BD0) — v3 lift + v4 FPU, 16 bytes.
...
Run from repo root: python3 c/tests/test_FUN_00013bd0_13bd0.py
"""
...
ENTRY = 0x13BD0
RAW = bytes.fromhex("92 62 E3 15 91 61 22 30 F3 18 D0 33 00 0B F0 3A")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFC0D8
SPAN_END = 0x13BE0
SENT = 0x13BE0     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x13bd0: {"kind": 'reg', "py": 'r[2] = 0xFFFFA758', "slot_py": None, "target": None, "cond": None},
    0x13bd2: {"kind": 'reg', "py": 'r[3] = s8(0x15)', "slot_py": None, "target": None, "cond": None},
    0x13bd4: {"kind": 'reg', "py": 'r[1] = 0xFFFFC0D8', "slot_py": None, "target": None, "cond": None},
    0x13bd6: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA758, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x13bd8: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFC0D8, 4))', "slot_py": None, "target": None, "cond": None},
    0x13bda: {"kind": 'reg', "py": 'r[0] = 0xFFFFA768', "slot_py": None, "target": None, "cond": None},
    0x13bdc: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFA768, 4, f2bits(fr[3]))', "target": None, "cond": None},}
