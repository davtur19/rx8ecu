#!/usr/bin/env python3
"""Differential test for load_float_from_mem_0x4F168 (0x4F168) — v3 lift + v4 FPU, 10 bytes.
...
Run from repo root: python3 c/tests/test_load_float_from_mem_0x4F168_4f168.py
"""
...
ENTRY = 0x4F168
RAW = bytes.fromhex("93 0D F3 38 92 0C 00 0B F2 3A")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCFD4
SPAN_END = 0x4F172
SENT = 0x4F172     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x4f168: {"kind": 'reg', "py": 'r[3] = 0xFFFFAE54', "slot_py": None, "target": None, "cond": None},
    0x4f16a: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFAE54, 4))', "slot_py": None, "target": None, "cond": None},
    0x4f16c: {"kind": 'reg', "py": 'r[2] = 0xFFFFCFD4', "slot_py": None, "target": None, "cond": None},
    0x4f16e: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFCFD4, 4, f2bits(fr[3]))', "target": None, "cond": None},}
