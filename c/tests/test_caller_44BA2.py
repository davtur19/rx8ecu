#!/usr/bin/env python3
"""Differential test for caller_44BA2 (entry 0x44BA2) — v8 ST caller (CFG), 20 bytes.
...
Run: python3 test_caller_44BA2.py
"""
...
CODE = {
    0x44ba2: {"kind": 'st', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x44ba4: {"kind": 'reg', "py": 'r[4] = 0xFFFF8750', "slot_py": None, "target": None, "cond": None},
    0x44ba6: {"kind": 'reg', "py": 'r[3] = 0x0003E1F8', "slot_py": None, "target": None, "cond": None},
    0x44ba8: {"kind": "call", "py": None, "slot_py": 'r[5] = s8(0x00)', "target": 0x3e1f8, "ret_pc": 0x44bac, "set_pr": True, "cond": None},
    0x44bac: {"kind": 'reg', "py": 'r[4] = 0xFFFF8752', "slot_py": None, "target": None, "cond": None},
    0x44bae: {"kind": 'reg', "py": 'r[5] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x44bb0: {"kind": 'reg', "py": 'r[2] = 0x0003E1F8', "slot_py": None, "target": None, "cond": None},
    0x44bb2: {"kind": "call", "py": None, "slot_py": 'pr = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": 0x3e1f8, "ret_pc": 0x44bb6, "set_pr": False, "cond": None},
