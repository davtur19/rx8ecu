#!/usr/bin/env python3
"""Differential test for filter_signal_adaptive_2CBBA (0x2CBBA) — v3 lift + v4 FPU, 98 bytes.
...
Run from repo root: python3 c/tests/test_filter_signal_adaptive_2CBBA_2cbba.py
"""
...
RAM_MAX = 0xFFFFCE6E
SPAN_END = 0x2CC1C
SENT = 0x2CC1C     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x2cbba: {"kind": 'reg', "py": 'r[3] = 0xFFFFAA10', "slot_py": None, "target": None, "cond": None},
    0x2cbbc: {"kind": 'reg', "py": 'r[4] = 0xFFFFBC94', "slot_py": None, "target": None, "cond": None},
    0x2cbbe: {"kind": 'reg', "py": 'r[2] = 0xFFFFCE6E', "slot_py": None, "target": None, "cond": None},
    0x2cbc0: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCE6E, 1))', "slot_py": None, "target": None, "cond": None},
    0x2cbc2: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x2cbc4: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x2cbc6: {"kind": "branch", "py": None, "slot_py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFAA10, 4))', "target": 0x2cc14, "cond": 'notT'},
    0x2cbca: {"kind": 'reg', "py": 'r[1] = 0x00075B98', "slot_py": None, "target": None, "cond": None},
    0x2cbcc: {"kind": 'reg', "py": 'r[3] = 0xFFFFADBC', "slot_py": None, "target": None, "cond": None},
    0x2cbce: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x00075B98, 4))', "slot_py": None, "target": None, "cond": None},
    0x2cbd0: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0xFFFFADBC, 4))', "slot_py": None, "target": None, "cond": None},
    0x2cbd2: {"kind": 'fpu', "py": 'T = 1 if fr[3] > fr[2] else 0', "slot_py": None, "target": None, "cond": None},
    0x2cbd4: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2cc14, "cond": 'T'},
    0x2cbd8: {"kind": 'reg', "py": 'r[2] = 0x00075B9C', "slot_py": None, "target": None, "cond": None},
    0x2cbda: {"kind": 'fpu', "py": 'fr[1] = bits2f(_rdw(ram, 0x00075B9C, 4))', "slot_py": None, "target": None, "cond": None},
    0x2cbdc: {"kind": 'fpu', "py": 'T = 1 if fr[1] > fr[4] else 0', "slot_py": None, "target": None, "cond": None},
    0x2cbde: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2cc14, "cond": 'T'},
    0x2cbe2: {"kind": 'reg', "py": 'r[3] = 0x00075BA0', "slot_py": None, "target": None, "cond": None},
    0x2cbe4: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x00075BA0, 4))', "slot_py": None, "target": None, "cond": None},
    0x2cbe6: {"kind": 'fpu', "py": 'T = 1 if fr[3] > fr[4] else 0', "slot_py": None, "target": None, "cond": None},
    0x2cbe8: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2cc14, "cond": 'notT'},
    0x2cbec: {"kind": 'reg', "py": 'r[2] = 0xFFFFA428', "slot_py": None, "target": None, "cond": None},
    0x2cbee: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFA428, 1))', "slot_py": None, "target": None, "cond": None},
    0x2cbf0: {"kind": 'reg', "py": 'T = 1 if (r[0] & r[0]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x2cbf2: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2cc14, "cond": 'notT'},
    0x2cbf6: {"kind": 'reg', "py": 'r[3] = 0xFFFFA42C', "slot_py": None, "target": None, "cond": None},
    0x2cbf8: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFA42C, 1))', "slot_py": None, "target": None, "cond": None},
    0x2cbfa: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x2cbfc: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x2cbfe: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2cc14, "cond": 'notT'},
    0x2cc02: {"kind": 'reg', "py": 'r[2] = 0xFFFFB490', "slot_py": None, "target": None, "cond": None},
    0x2cc04: {"kind": 'mem', "py": 'r[0] = s16(_rdw(ram, 0xFFFFB490, 2))', "slot_py": None, "target": None, "cond": None},
    0x2cc06: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x2cc08: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) > 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x2cc0a: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2cc14, "cond": 'notT'},
    0x2cc0e: {"kind": 'reg', "py": 'r[2] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x2cc10: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFBC94, 1, r[2])', "target": 0x2cc18, "cond": 'always'},
    0x2cc14: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x2cc16: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBC94, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x2cc18: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
