#!/usr/bin/env python3
"""Differential test for clear_fault_flags_ca6c (0x43D8C) — v3 lift (branches + delay slots), 50 bytes.
...
Run from repo root: python3 c/tests/test_clear_fault_flags_ca6c_43d8c.py
"""
...
ENTRY = 0x43D8C
RAW = bytes.fromhex("93 7D 60 30 60 0C 88 01 8F 11 00 09 92 78 60 20 60 0C 88 01 8F 0B 00 09 93 73 E4 00 92 72 23 40 22 40 91 70 93 70 21 40 23 40 92 6E 22 40 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCFD9
SPAN_END = 0x43DBE
SENT = 0x43DBE     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x43d8c: {"kind": 'reg', "py": 'r[3] = 0xFFFFCFD9', "slot_py": None, "target": None, "cond": None},
    0x43d8e: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCFD9, 1))', "slot_py": None, "target": None, "cond": None},
    0x43d90: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x43d92: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x43d94: {"kind": "branch", "py": None, "slot_py": '', "target": 0x43dba, "cond": 'notT'},
    0x43d98: {"kind": 'reg', "py": 'r[2] = 0xFFFFA41C', "slot_py": None, "target": None, "cond": None},
    0x43d9a: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFA41C, 1))', "slot_py": None, "target": None, "cond": None},
    0x43d9c: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x43d9e: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x43da0: {"kind": "branch", "py": None, "slot_py": '', "target": 0x43dba, "cond": 'notT'},
    0x43da4: {"kind": 'reg', "py": 'r[3] = 0xFFFFCA6D', "slot_py": None, "target": None, "cond": None},
    0x43da6: {"kind": 'reg', "py": 'r[4] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x43da8: {"kind": 'reg', "py": 'r[2] = 0xFFFFCA6E', "slot_py": None, "target": None, "cond": None},
    0x43daa: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCA6D, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x43dac: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCA6E, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x43dae: {"kind": 'reg', "py": 'r[1] = 0xFFFFCA6C', "slot_py": None, "target": None, "cond": None},
    0x43db0: {"kind": 'reg', "py": 'r[3] = 0xFFFFCA6F', "slot_py": None, "target": None, "cond": None},
    0x43db2: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCA6C, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x43db4: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCA6F, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x43db6: {"kind": 'reg', "py": 'r[2] = 0xFFFFCA70', "slot_py": None, "target": None, "cond": None},
    0x43db8: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCA70, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x43dba: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
