#!/usr/bin/env python3
"""Differential test for load_adc_thermistor_value (0x19F5A) — v3 lift + v4 FPU, 10 bytes.
...
Run from repo root: python3 c/tests/test_load_adc_thermistor_value_19f5a.py
"""
...
ENTRY = 0x19F5A
RAW = bytes.fromhex("D3 25 91 3F F3 38 00 0B F1 3A")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFAA0C
SPAN_END = 0x19F64
SENT = 0x19F64     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x19f5a: {"kind": 'reg', "py": 'r[3] = 0xFFFF9F70', "slot_py": None, "target": None, "cond": None},
    0x19f5c: {"kind": 'reg', "py": 'r[1] = 0xFFFFAA0C', "slot_py": None, "target": None, "cond": None},
    0x19f5e: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFF9F70, 4))', "slot_py": None, "target": None, "cond": None},
    0x19f60: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFAA0C, 4, f2bits(fr[3]))', "target": None, "cond": None},}
