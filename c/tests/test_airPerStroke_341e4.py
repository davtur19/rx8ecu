#!/usr/bin/env python3
"""Differential test for airPerStroke (0x341E4) — pure straight-line lift, 8 bytes.
...
Run from repo root: python3 c/tests/test_airPerStroke_341e4.py
"""
...
ENTRY = 0x341E4
RAW = bytes.fromhex("00 07 96 B8 00 07 96 7A")
SEED = 42
N = 2000
