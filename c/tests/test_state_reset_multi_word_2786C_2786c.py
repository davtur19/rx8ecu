#!/usr/bin/env python3
"""Differential test for state_reset_multi_word_2786C (0x2786C) — v3 lift (branches + delay slots), 50 bytes.
...
Run from repo root: python3 c/tests/test_state_reset_multi_word_2786C_2786c.py
"""
...
ENTRY = 0x2786C
RAW = bytes.fromhex("93 78 60 30 60 0C 88 01 8F 11 00 09 92 73 60 20 60 0C 88 01 8F 0B 00 09 93 6E E4 00 92 6D 23 41 22 41 91 6B 93 6B 21 41 23 41 92 69 22 40 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    0x2786c: {"kind": 'reg', "py": 'r[3] = 0xFFFFD201', "slot_py": None, "target": None, "cond": None},
    0x2786e: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFD201, 1))', "slot_py": None, "target": None, "cond": None},
    0x27870: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x27872: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x27874: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2789a, "cond": 'notT'},
    0x27878: {"kind": 'reg', "py": 'r[2] = 0xFFFFA41C', "slot_py": None, "target": None, "cond": None},
    0x2787a: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFA41C, 1))', "slot_py": None, "target": None, "cond": None},
    0x2787c: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x2787e: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x27880: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2789a, "cond": 'notT'},
    0x27884: {"kind": 'reg', "py": 'r[3] = 0xFFFFB6F8', "slot_py": None, "target": None, "cond": None},
    0x27886: {"kind": 'reg', "py": 'r[4] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x27888: {"kind": 'reg', "py": 'r[2] = 0xFFFFB6FA', "slot_py": None, "target": None, "cond": None},
    0x2788a: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFB6F8, 2, r[4])', "slot_py": None, "target": None, "cond": None},
    0x2788c: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFB6FA, 2, r[4])', "slot_py": None, "target": None, "cond": None},
    0x2788e: {"kind": 'reg', "py": 'r[1] = 0xFFFFB6FC', "slot_py": None, "target": None, "cond": None},
    0x27890: {"kind": 'reg', "py": 'r[3] = 0xFFFFB6FE', "slot_py": None, "target": None, "cond": None},
    0x27892: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFB6FC, 2, r[4])', "slot_py": None, "target": None, "cond": None},
    0x27894: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFB6FE, 2, r[4])', "slot_py": None, "target": None, "cond": None},
    0x27896: {"kind": 'reg', "py": 'r[2] = 0xFFFFB704', "slot_py": None, "target": None, "cond": None},
    0x27898: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFB704, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x2789a: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
