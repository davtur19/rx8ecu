#!/usr/bin/env python3
"""Differential test for can_tx_byte_set_zero_2D49C (0x2D49C) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_can_tx_byte_set_zero_2D49C_2d49c.py
"""
...
CODE = {
    0x2d49c: {"kind": 'reg', "py": 'r[1] = 0xFFFFBCCA', "slot_py": None, "target": None, "cond": None},
    0x2d49e: {"kind": 'reg', "py": 'r[3] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x2d4a0: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBCCA, 1, r[3])', "target": None, "cond": None},}
