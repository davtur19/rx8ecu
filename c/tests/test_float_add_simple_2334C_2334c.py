#!/usr/bin/env python3
"""Differential test for float_add_simple_2334C (0x2334C) — v3 lift + v4 FPU, 14 bytes.
...
Run from repo root: python3 c/tests/test_float_add_simple_2334C_2334c.py
"""
...
ENTRY = 0x2334C
RAW = bytes.fromhex("94 07 F3 48 93 04 F2 38 F2 30 00 0B F4 2A")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFB3A0
SPAN_END = 0x2335A
SENT = 0x23360     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x2334c: {"kind": 'reg', "py": 'r[4] = 0xFFFFB3A4', "slot_py": None, "target": None, "cond": None},
    0x2334e: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, r[4], 4))', "slot_py": None, "target": None, "cond": None},
    0x23350: {"kind": 'reg', "py": 'r[3] = 0xFFFFB3A0', "slot_py": None, "target": None, "cond": None},
    0x23352: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0xFFFFB3A0, 4))', "slot_py": None, "target": None, "cond": None},
    0x23354: {"kind": 'fpu', "py": 'fr[2] = ts(fr[2] + fr[3])', "slot_py": None, "target": None, "cond": None},
    0x23356: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, r[4], 4, f2bits(fr[2]))', "target": None, "cond": None},}
