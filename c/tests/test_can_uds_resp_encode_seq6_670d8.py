#!/usr/bin/env python3
"""Differential test for can_uds_resp_encode_seq6 (0x670D8) — pure straight-line lift, 8 bytes.
...
Run from repo root: python3 c/tests/test_can_uds_resp_encode_seq6_670d8.py
"""
...
ENTRY = 0x670D8
RAW = bytes.fromhex("64 E3 64 03 60 43 7F 04")
SEED = 42
N = 2000
