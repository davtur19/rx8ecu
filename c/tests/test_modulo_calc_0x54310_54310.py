#!/usr/bin/env python3
"""Differential test for modulo_calc_0x54310 (0x54310) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_modulo_calc_0x54310_54310.py
"""
...
ENTRY = 0x54310
RAW = bytes.fromhex("92 02 E3 00 00 0B 22 30")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFD1D4
SPAN_END = 0x54318
SENT = 0x5431A     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x54310: {"kind": 'reg', "py": 'r[2] = 0xFFFFD1D4', "slot_py": None, "target": None, "cond": None},
    0x54312: {"kind": 'reg', "py": 'r[3] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x54314: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFD1D4, 1, r[3])', "target": None, "cond": None},}
