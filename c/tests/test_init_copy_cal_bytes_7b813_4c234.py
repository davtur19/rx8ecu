#!/usr/bin/env python3
"""Differential test for init_copy_cal_bytes_7b813 (0x4C234) — v3 lift (branches + delay slots), 46 bytes.
...
Run from repo root: python3 c/tests/test_init_copy_cal_bytes_7b813_4c234.py
"""
...
ENTRY = 0x4C234
RAW = bytes.fromhex("D2 40 E0 40 91 72 63 20 21 30 E2 01 93 6F 23 00 90 6E 20 20 D2 3C 61 20 93 6B 23 10 D1 3B 60 10 93 68 23 00 D0 3A 62 00 93 65 00 0B 23 20")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCDC7
SPAN_END = 0x4C262
SENT = 0x4C262     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x4c234: {"kind": 'reg', "py": 'r[2] = 0x0007B813', "slot_py": None, "target": None, "cond": None},
    0x4c236: {"kind": 'reg', "py": 'r[0] = s8(0x40)', "slot_py": None, "target": None, "cond": None},
    0x4c238: {"kind": 'reg', "py": 'r[1] = 0xFFFFCDAD', "slot_py": None, "target": None, "cond": None},
    0x4c23a: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0x0007B813, 1))', "slot_py": None, "target": None, "cond": None},
    0x4c23c: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCDAD, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x4c23e: {"kind": 'reg', "py": 'r[2] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x4c240: {"kind": 'reg', "py": 'r[3] = 0xFFFFCDB2', "slot_py": None, "target": None, "cond": None},
    0x4c242: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCDB2, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x4c244: {"kind": 'reg', "py": 'r[0] = 0xFFFFCDC7', "slot_py": None, "target": None, "cond": None},
    0x4c246: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCDC7, 1, r[2])', "slot_py": None, "target": None, "cond": None},
    0x4c248: {"kind": 'reg', "py": 'r[2] = 0x0007B815', "slot_py": None, "target": None, "cond": None},
    0x4c24a: {"kind": 'mem', "py": 'r[1] = s8(_rdw(ram, 0x0007B815, 1))', "slot_py": None, "target": None, "cond": None},
    0x4c24c: {"kind": 'reg', "py": 'r[3] = 0xFFFFCDAF', "slot_py": None, "target": None, "cond": None},
    0x4c24e: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCDAF, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x4c250: {"kind": 'reg', "py": 'r[1] = 0x0007B816', "slot_py": None, "target": None, "cond": None},
    0x4c252: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0x0007B816, 1))', "slot_py": None, "target": None, "cond": None},
    0x4c254: {"kind": 'reg', "py": 'r[3] = 0xFFFFCDB0', "slot_py": None, "target": None, "cond": None},
    0x4c256: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCDB0, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x4c258: {"kind": 'reg', "py": 'r[0] = 0x0007B817', "slot_py": None, "target": None, "cond": None},
    0x4c25a: {"kind": 'mem', "py": 'r[2] = s8(_rdw(ram, 0x0007B817, 1))', "slot_py": None, "target": None, "cond": None},
    0x4c25c: {"kind": 'reg', "py": 'r[3] = 0xFFFFCDB1', "slot_py": None, "target": None, "cond": None},
    0x4c25e: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFCDB1, 1, r[2])', "target": None, "cond": None},}
