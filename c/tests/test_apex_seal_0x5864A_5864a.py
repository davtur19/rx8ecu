#!/usr/bin/env python3
"""Differential test for apex_seal_0x5864A (0x5864A) — v3 lift + v4 FPU, 28 bytes.
...
Run from repo root: python3 c/tests/test_apex_seal_0x5864A_5864a.py
"""
...
ENTRY = 0x5864A
RAW = bytes.fromhex("E1 30 92 70 63 20 63 3C 33 13 8F 03 00 09 93 6B A0 02 F3 38 D0 39 F3 08 00 0B F4 3A")
SEED = 0
N = 2000
MAXSTEPS = 100000
