#!/usr/bin/env python3
"""Differential test for sensor_port_init_f020_f026 (0xBDA0) — v3 lift (branches + delay slots), 28 bytes.
...
Run from repo root: python3 c/tests/test_sensor_port_init_f020_f026_bda0.py
"""
...
ENTRY = 0xBDA0
RAW = bytes.fromhex("93 8B 92 8B 22 30 94 8A 60 40 C9 FC 24 00 73 78 91 86 21 30 93 85 E0 06 00 0B 23 00")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFF026
SPAN_END = 0xBDBC
SENT = 0xBDBC     # stop-sentinel, placed past the literal pool
...
CODE = {
    0xbda0: {"kind": 'reg', "py": 'r[3] = 0x00000080', "slot_py": None, "target": None, "cond": None},
    0xbda2: {"kind": 'reg', "py": 'r[2] = 0xFFFFF020', "slot_py": None, "target": None, "cond": None},
    0xbda4: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFF020, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0xbda6: {"kind": 'reg', "py": 'r[4] = 0xFFFFF022', "slot_py": None, "target": None, "cond": None},
    0xbda8: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFF022, 1))', "slot_py": None, "target": None, "cond": None},
    0xbdaa: {"kind": 'reg', "py": 'r[0] = (r[0] & 0xFC) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xbdac: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFF022, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0xbdae: {"kind": 'reg', "py": 'r[3] = (r[3] + s8(0x78)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0xbdb0: {"kind": 'reg', "py": 'r[1] = 0xFFFFF026', "slot_py": None, "target": None, "cond": None},
    0xbdb2: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFF026, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0xbdb4: {"kind": 'reg', "py": 'r[3] = 0xFFFFF021', "slot_py": None, "target": None, "cond": None},
    0xbdb6: {"kind": 'reg', "py": 'r[0] = s8(0x06)', "slot_py": None, "target": None, "cond": None},
    0xbdb8: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFF021, 1, r[0])', "target": None, "cond": None},}
