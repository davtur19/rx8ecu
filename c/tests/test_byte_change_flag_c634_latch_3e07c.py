#!/usr/bin/env python3
"""Differential test for byte_change_flag_c634_latch (0x3E07C) — v3 lift (branches + delay slots), 48 bytes.
...
Run from repo root: python3 c/tests/test_byte_change_flag_c634_latch_3e07c.py
"""
...
ENTRY = 0x3E07C
RAW = bytes.fromhex("93 12 64 30 D6 09 65 4C 62 60 62 2C 32 50 8F 09 00 09 25 58 97 09 8F 03 00 09 E1 01 A0 02 27 10 E0 00 27 00 00 0B 26 40 C6 33 C6 34 FF FF C6 35")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFC635
SPAN_END = 0x3E0AC
SENT = 0x3E0AC     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x3e07c: {"kind": 'reg', "py": 'r[3] = 0xFFFFC633', "slot_py": None, "target": None, "cond": None},
    0x3e07e: {"kind": 'mem', "py": 'r[4] = s8(_rdw(ram, 0xFFFFC633, 1))', "slot_py": None, "target": None, "cond": None},
    0x3e080: {"kind": 'reg', "py": 'r[6] = 0xFFFFC635', "slot_py": None, "target": None, "cond": None},
    0x3e082: {"kind": 'reg', "py": 'r[5] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x3e084: {"kind": 'mem', "py": 'r[2] = s8(_rdw(ram, 0xFFFFC635, 1))', "slot_py": None, "target": None, "cond": None},
    0x3e086: {"kind": 'reg', "py": 'r[2] = r[2] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x3e088: {"kind": 'reg', "py": 'T = 1 if r[2] == r[5] else 0', "slot_py": None, "target": None, "cond": None},
    0x3e08a: {"kind": "branch", "py": None, "slot_py": '', "target": 0x3e0a0, "cond": 'notT'},
    0x3e08e: {"kind": 'reg', "py": 'T = 1 if (r[5] & r[5]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x3e090: {"kind": 'reg', "py": 'r[7] = 0xFFFFC634', "slot_py": None, "target": None, "cond": None},
    0x3e092: {"kind": "branch", "py": None, "slot_py": '', "target": 0x3e09c, "cond": 'notT'},
    0x3e096: {"kind": 'reg', "py": 'r[1] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x3e098: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFC634, 1, r[1])', "target": 0x3e0a0, "cond": 'always'},
    0x3e09c: {"kind": 'reg', "py": 'r[0] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x3e09e: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC634, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x3e0a0: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFC635, 1, r[4])', "target": None, "cond": None},}
