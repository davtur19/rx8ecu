#!/usr/bin/env python3
"""Differential test for rev_converter_552fe (0x552FE) — v3 lift (branches + delay slots), 14 bytes.
...
Run from repo root: python3 c/tests/test_rev_converter_552fe_552fe.py
"""
...
CODE = {
    0x552fe: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, r[5], 1))', "slot_py": None, "target": None, "cond": None},
    0x55300: {"kind": 'reg', "py": 'r[3] = (r[3] + s8(0x01)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x55302: {"kind": 'mem', "py": '_wrw(ram, r[5], 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x55304: {"kind": 'mem', "py": '_wrw(ram, r[4], 1, r[6])', "slot_py": None, "target": None, "cond": None},
    0x55306: {"kind": 'reg', "py": 'r[4] = (r[4] + s8(0x01)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x55308: {"kind": "ret", "py": None, "slot_py": 'r[0] = r[4]', "target": None, "cond": None},}
