#!/usr/bin/env python3
"""Differential test for calculateTrailingTimingDerateCompensated (0x12352) — v3 lift + v4 FPU, 16 bytes.
...
Run from repo root: python3 c/tests/test_calculateTrailingTimingDerateCompensated_12352.py
"""
...
ENTRY = 0x12352
RAW = bytes.fromhex("D2 1C D1 1C F3 28 F2 18 F2 30 93 1A 00 0B F3 2A")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFA654
SPAN_END = 0x12362
SENT = 0x12362     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x12352: {"kind": 'reg', "py": 'r[2] = 0xFFFFA654', "slot_py": None, "target": None, "cond": None},
    0x12354: {"kind": 'reg', "py": 'r[1] = 0xFFFFA64C', "slot_py": None, "target": None, "cond": None},
    0x12356: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFA654, 4))', "slot_py": None, "target": None, "cond": None},
    0x12358: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0xFFFFA64C, 4))', "slot_py": None, "target": None, "cond": None},
    0x1235a: {"kind": 'fpu', "py": 'fr[2] = ts(fr[2] + fr[3])', "slot_py": None, "target": None, "cond": None},
    0x1235c: {"kind": 'reg', "py": 'r[3] = 0xFFFFA638', "slot_py": None, "target": None, "cond": None},
    0x1235e: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFA638, 4, f2bits(fr[2]))', "target": None, "cond": None},}
