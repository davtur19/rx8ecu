#!/usr/bin/env python3
"""Differential test for calculateIfVehicleMoving (0x2B8AA) — v3 lift + v4 FPU, 40 bytes.
...
Run from repo root: python3 c/tests/test_calculateIfVehicleMoving_2b8aa.py
"""
...
RAM_MAX = 0xFFFFBBEC
SPAN_END = 0x2B8D2
SENT = 0x2B8D2     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x2b8aa: {"kind": 'reg', "py": 'r[4] = 0xFFFFBBEC', "slot_py": None, "target": None, "cond": None},
    0x2b8ac: {"kind": 'reg', "py": 'r[3] = 0xFFFFBBE8', "slot_py": None, "target": None, "cond": None},
    0x2b8ae: {"kind": 'fpu', "py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFBBE8, 4))', "slot_py": None, "target": None, "cond": None},
    0x2b8b0: {"kind": 'reg', "py": 'r[2] = 0x00077A84', "slot_py": None, "target": None, "cond": None},
    0x2b8b2: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x00077A84, 4))', "slot_py": None, "target": None, "cond": None},
    0x2b8b4: {"kind": 'fpu', "py": 'T = 1 if fr[4] > fr[3] else 0', "slot_py": None, "target": None, "cond": None},
    0x2b8b6: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2b8c0, "cond": 'T'},
    0x2b8ba: {"kind": 'reg', "py": 'r[0] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x2b8bc: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFBBEC, 1, r[0])', "target": 0x2b8ce, "cond": 'always'},
    0x2b8c0: {"kind": 'reg', "py": 'r[1] = 0x00077A88', "slot_py": None, "target": None, "cond": None},
    0x2b8c2: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0x00077A88, 4))', "slot_py": None, "target": None, "cond": None},
    0x2b8c4: {"kind": 'fpu', "py": 'T = 1 if fr[2] > fr[4] else 0', "slot_py": None, "target": None, "cond": None},
    0x2b8c6: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2b8ce, "cond": 'T'},
    0x2b8ca: {"kind": 'reg', "py": 'r[0] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x2b8cc: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBBEC, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x2b8ce: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
