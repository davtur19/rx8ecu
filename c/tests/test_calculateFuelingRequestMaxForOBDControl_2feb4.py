#!/usr/bin/env python3
"""Differential test for calculateFuelingRequestMaxForOBDControl (0x2FEB4) — pure straight-line lift, 8 bytes.
...
Run from repo root: python3 c/tests/test_calculateFuelingRequestMaxForOBDControl_2feb4.py
"""
...
ENTRY = 0x2FEB4
RAW = bytes.fromhex("00 07 78 94 00 07 78 82")
SEED = 42
N = 2000
...
def spec_mirror(r4, r5, r6, r7):
    ...
    # 0x02FEB6: op 0x7894
    r[8] = (r[8] + s8(0x94)) & 0xFFFFFFFF
    # 0x02FEB8: op 0x0007
    macl = (s32(r[0]) * s32(r[0])) & 0xFFFFFFFF
    # 0x02FEBA: op 0x7882
    r[8] = (r[8] + s8(0x82)) & 0xFFFFFFFF
