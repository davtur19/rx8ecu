#!/usr/bin/env python3
"""Differential test for returnEngineSpeed (0x5E604) — v3 lift (branches + delay slots), 18 bytes.
...
Run from repo root: python3 c/tests/test_returnEngineSpeed_5e604.py
"""
...
ENTRY = 0x5E604
RAW = bytes.fromhex("68 F6 60 63 69 F6 6A F6 6B F6 6C F6 6D F6 00 0B 6E F6")
SEED = 42
N = 500
MAXSTEPS = 100000
