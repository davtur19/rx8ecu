#!/usr/bin/env python3
"""Differential test for caller_13B4A (entry 0x13B4A) — v8 ST caller (CFG), 20 bytes.
...
Run: python3 test_caller_13B4A.py
"""
...
CODE = {
    0x13b4a: {"kind": 'st', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x13b4c: {"kind": 'reg', "py": 'r[3] = 0x000785AC', "slot_py": None, "target": None, "cond": None},
    0x13b4e: {"kind": 'fpu', "py": 'fr[6] = bits2f(_rdw(ram, 0x000785AC, 4))', "slot_py": None, "target": None, "cond": None},
    0x13b50: {"kind": 'reg', "py": 'r[2] = 0x000785A8', "slot_py": None, "target": None, "cond": None},
    0x13b52: {"kind": 'reg', "py": 'r[1] = 0x00002404', "slot_py": None, "target": None, "cond": None},
    0x13b54: {"kind": "call", "py": None, "slot_py": 'fr[5] = bits2f(_rdw(ram, 0x000785A8, 4))', "target": 0x2404, "ret_pc": 0x13b58, "set_pr": True, "cond": None},
    0x13b58: {"kind": 'st', "py": 'pr = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x13b5a: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},
