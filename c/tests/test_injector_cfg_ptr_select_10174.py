#!/usr/bin/env python3
"""Differential test for injector_cfg_ptr_select (0x10174) — v3 lift (branches + delay slots), 60 bytes.
...
Run from repo root: python3 c/tests/test_injector_cfg_ptr_select_10174.py
"""
...
ENTRY = 0x10174
RAW = bytes.fromhex("60 4C 88 00 8D 11 00 09 88 03 8D 0E 00 09 88 01 8D 0E 00 09 88 02 8D 0B 00 09 88 04 8D 08 00 09 88 05 8D 05 00 09 A0 06 00 09 D3 18 A0 04 64 32 D1 17 A0 01 64 12 E4 00 00 0B 60 43")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = None
SPAN_END = 0x101B0
SENT = 0x101B0     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x10174: {"kind": 'reg', "py": 'r[0] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x10176: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x00) else 0', "slot_py": None, "target": None, "cond": None},
    0x10178: {"kind": "branch", "py": None, "slot_py": '', "target": 0x1019e, "cond": 'T'},
    0x1017c: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x03) else 0', "slot_py": None, "target": None, "cond": None},
    0x1017e: {"kind": "branch", "py": None, "slot_py": '', "target": 0x1019e, "cond": 'T'},
    0x10182: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x10184: {"kind": "branch", "py": None, "slot_py": '', "target": 0x101a4, "cond": 'T'},
    0x10188: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x02) else 0', "slot_py": None, "target": None, "cond": None},
    0x1018a: {"kind": "branch", "py": None, "slot_py": '', "target": 0x101a4, "cond": 'T'},
    0x1018e: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x04) else 0', "slot_py": None, "target": None, "cond": None},
    0x10190: {"kind": "branch", "py": None, "slot_py": '', "target": 0x101a4, "cond": 'T'},
    0x10194: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x05) else 0', "slot_py": None, "target": None, "cond": None},
    0x10196: {"kind": "branch", "py": None, "slot_py": '', "target": 0x101a4, "cond": 'T'},
    0x1019a: {"kind": "branch", "py": None, "slot_py": '', "target": 0x101aa, "cond": 'always'},
    0x1019e: {"kind": 'reg', "py": 'r[3] = 0x0006D498', "slot_py": None, "target": None, "cond": None},
    0x101a0: {"kind": "branch", "py": None, "slot_py": 'r[4] = _rdw(ram, 0x0006D498, 4)', "target": 0x101ac, "cond": 'always'},
    0x101a4: {"kind": 'reg', "py": 'r[1] = 0x0006D49C', "slot_py": None, "target": None, "cond": None},
    0x101a6: {"kind": "branch", "py": None, "slot_py": 'r[4] = _rdw(ram, 0x0006D49C, 4)', "target": 0x101ac, "cond": 'always'},
    0x101aa: {"kind": 'reg', "py": 'r[4] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x101ac: {"kind": "ret", "py": None, "slot_py": 'r[0] = r[4]', "target": None, "cond": None},}
