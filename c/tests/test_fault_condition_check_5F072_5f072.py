#!/usr/bin/env python3
"""Differential test for fault_condition_check_5F072 (0x5F072) — v3 lift + v4 FPU, 10 bytes.
...
Run from repo root: python3 c/tests/test_fault_condition_check_5F072_5f072.py
"""
...
ENTRY = 0x5F072
RAW = bytes.fromhex("92 07 D1 09 F3 28 00 0B F1 3A")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFD3C8
SPAN_END = 0x5F07C
SENT = 0x5F07C     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x5f072: {"kind": 'reg', "py": 'r[2] = 0xFFFFAD98', "slot_py": None, "target": None, "cond": None},
    0x5f074: {"kind": 'reg', "py": 'r[1] = 0xFFFFD3C8', "slot_py": None, "target": None, "cond": None},
    0x5f076: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFAD98, 4))', "slot_py": None, "target": None, "cond": None},
    0x5f078: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFD3C8, 4, f2bits(fr[3]))', "target": None, "cond": None},}
