#!/usr/bin/env python3
"""Differential test for FUN_000568dc (0x568DC) — v3 lift (branches + delay slots), 16 bytes.
...
Run from repo root: python3 c/tests/test_FUN_000568dc_568dc.py
"""
...
ENTRY = 0x568DC
RAW = bytes.fromhex("8F 01 00 09 65 43 00 0B 60 53 D3 09 00 0B 60 30")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFD20C
SPAN_END = 0x568EC
SENT = 0x568EC     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x568dc: {"kind": "branch", "py": None, "slot_py": '', "target": 0x568e2, "cond": 'notT'},
    0x568e0: {"kind": 'reg', "py": 'r[5] = r[4]', "slot_py": None, "target": None, "cond": None},
    0x568e2: {"kind": "ret", "py": None, "slot_py": 'r[0] = r[5]', "target": None, "cond": None},
    0x568e6: {"kind": 'reg', "py": 'r[3] = 0xFFFFD20C', "slot_py": None, "target": None, "cond": None},
    0x568e8: {"kind": "ret", "py": None, "slot_py": 'r[0] = s8(_rdw(ram, 0xFFFFD20C, 1))', "target": None, "cond": None},}
