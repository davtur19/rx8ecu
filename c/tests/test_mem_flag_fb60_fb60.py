#!/usr/bin/env python3
"""Differential test for mem_flag_fb60 (0xFB60) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_mem_flag_fb60_fb60.py
"""
...
CODE = {
    0xfb60: {"kind": 'reg', "py": 'r[1] = 0xFFFFA571', "slot_py": None, "target": None, "cond": None},
    0xfb62: {"kind": 'reg', "py": 'r[2] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0xfb64: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFA571, 1, r[2])', "target": None, "cond": None},}
