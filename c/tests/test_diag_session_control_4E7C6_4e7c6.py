#!/usr/bin/env python3
"""Differential test for diag_session_control_4E7C6 (0x4E7C6) — v3 lift + v4 FPU, 96 bytes.
...
Run from repo root: python3 c/tests/test_diag_session_control_4E7C6_4e7c6.py
"""
...
ENTRY = 0x4E7C6
RAW = bytes.fromhex("92 35 93 35 F4 28 F5 38 91 33 D6 1E 95 32 D2 1E F3 28 F3 45 8F 03 F6 18 F6 55 8D 04 00 09 D2 1B 63 21 A0 07 25 31 64 51 63 4D 43 15 8F 02 00 09 34 6C 25 41 95 1F D3 16 F3 38 F3 45 8F 03 00 09 F6 55 8D 04 00 09 D2 13 63 21 A0 07 25 31 64 51 63 4D 43 15 8F 02 00 09 34 6C 25 41 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCF6E
SPAN_END = 0x4E826
SENT = 0x4E826     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x4e7c6: {"kind": 'reg', "py": 'r[2] = 0xFFFFBD38', "slot_py": None, "target": None, "cond": None},
    0x4e7c8: {"kind": 'reg', "py": 'r[3] = 0xFFFFC008', "slot_py": None, "target": None, "cond": None},
    0x4e7ca: {"kind": 'fpu', "py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFBD38, 4))', "slot_py": None, "target": None, "cond": None},
    0x4e7cc: {"kind": 'fpu', "py": 'fr[5] = bits2f(_rdw(ram, 0xFFFFC008, 4))', "slot_py": None, "target": None, "cond": None},
    0x4e7ce: {"kind": 'reg', "py": 'r[1] = 0xFFFFC00C', "slot_py": None, "target": None, "cond": None},
    0x4e7d0: {"kind": 'reg', "py": 'r[6] = 0x0000FFFF', "slot_py": None, "target": None, "cond": None},
    0x4e7d2: {"kind": 'reg', "py": 'r[5] = 0xFFFFCF6C', "slot_py": None, "target": None, "cond": None},
    0x4e7d4: {"kind": 'reg', "py": 'r[2] = 0x00076B34', "slot_py": None, "target": None, "cond": None},
    0x4e7d6: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x00076B34, 4))', "slot_py": None, "target": None, "cond": None},
    0x4e7d8: {"kind": 'fpu', "py": 'T = 1 if fr[3] > fr[4] else 0', "slot_py": None, "target": None, "cond": None},
    0x4e7da: {"kind": "branch", "py": None, "slot_py": 'fr[6] = bits2f(_rdw(ram, 0xFFFFC00C, 4))', "target": 0x4e7e4, "cond": 'notT'},
    0x4e7de: {"kind": 'fpu', "py": 'T = 1 if fr[6] > fr[5] else 0', "slot_py": None, "target": None, "cond": None},
    0x4e7e0: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4e7ec, "cond": 'T'},
    0x4e7e4: {"kind": 'reg', "py": 'r[2] = 0x00076B3A', "slot_py": None, "target": None, "cond": None},
    0x4e7e6: {"kind": 'mem', "py": 'r[3] = s16(_rdw(ram, 0x00076B3A, 2))', "slot_py": None, "target": None, "cond": None},
    0x4e7e8: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFCF6C, 2, r[3])', "target": 0x4e7fa, "cond": 'always'},
    0x4e7ec: {"kind": 'mem', "py": 'r[4] = s16(_rdw(ram, 0xFFFFCF6C, 2))', "slot_py": None, "target": None, "cond": None},
    0x4e7ee: {"kind": 'reg', "py": 'r[3] = r[4] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x4e7f0: {"kind": 'reg', "py": 'T = 1 if s32(r[3]) > 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x4e7f2: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4e7fa, "cond": 'notT'},
    0x4e7f6: {"kind": 'reg', "py": 'r[4] = (r[4] + r[6]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x4e7f8: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCF6C, 2, r[4])', "slot_py": None, "target": None, "cond": None},
    0x4e7fa: {"kind": 'reg', "py": 'r[5] = 0xFFFFCF6E', "slot_py": None, "target": None, "cond": None},
    0x4e7fc: {"kind": 'reg', "py": 'r[3] = 0x0007CCB0', "slot_py": None, "target": None, "cond": None},
    0x4e7fe: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x0007CCB0, 4))', "slot_py": None, "target": None, "cond": None},
    0x4e800: {"kind": 'fpu', "py": 'T = 1 if fr[3] > fr[4] else 0', "slot_py": None, "target": None, "cond": None},
    0x4e802: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4e80c, "cond": 'notT'},
    0x4e806: {"kind": 'fpu', "py": 'T = 1 if fr[6] > fr[5] else 0', "slot_py": None, "target": None, "cond": None},
    0x4e808: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4e814, "cond": 'T'},
    0x4e80c: {"kind": 'reg', "py": 'r[2] = 0x0007CC4C', "slot_py": None, "target": None, "cond": None},
    0x4e80e: {"kind": 'mem', "py": 'r[3] = s16(_rdw(ram, 0x0007CC4C, 2))', "slot_py": None, "target": None, "cond": None},
    0x4e810: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFCF6E, 2, r[3])', "target": 0x4e822, "cond": 'always'},
    0x4e814: {"kind": 'mem', "py": 'r[4] = s16(_rdw(ram, 0xFFFFCF6E, 2))', "slot_py": None, "target": None, "cond": None},
    0x4e816: {"kind": 'reg', "py": 'r[3] = r[4] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x4e818: {"kind": 'reg', "py": 'T = 1 if s32(r[3]) > 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x4e81a: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4e822, "cond": 'notT'},
    0x4e81e: {"kind": 'reg', "py": 'r[4] = (r[4] + r[6]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x4e820: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCF6E, 2, r[4])', "slot_py": None, "target": None, "cond": None},
    0x4e822: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
