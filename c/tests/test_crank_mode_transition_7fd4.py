#!/usr/bin/env python3
"""Differential test for crank_mode_transition (0x7FD4) — v3 lift + v4 FPU, 28 bytes.
...
Run from repo root: python3 c/tests/test_crank_mode_transition_7fd4.py
"""
...
RAM_MAX = 0xFFFF9FE8
SPAN_END = 0x7FF0
SENT = 0x7FF0     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x7fd4: {"kind": 'reg', "py": 'r[2] = 0xFFFF9FE8', "slot_py": None, "target": None, "cond": None},
    0x7fd6: {"kind": 'reg', "py": 'r[3] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x7fd8: {"kind": 'reg', "py": 'r[1] = 0xFFFF9FBC', "slot_py": None, "target": None, "cond": None},
    0x7fda: {"kind": 'mem', "py": '_wrw(ram, 0xFFFF9FE8, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x7fdc: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFF9FBC, 4))', "slot_py": None, "target": None, "cond": None},
    0x7fde: {"kind": 'reg', "py": 'r[0] = 0xFFFF9F90', "slot_py": None, "target": None, "cond": None},
    0x7fe0: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFF9F90, 4, f2bits(fr[3]))', "slot_py": None, "target": None, "cond": None},
    0x7fe2: {"kind": 'reg', "py": 'r[3] = 0x000000FF', "slot_py": None, "target": None, "cond": None},
    0x7fe4: {"kind": 'reg', "py": 'r[1] = 0xFFFF9FC5', "slot_py": None, "target": None, "cond": None},
    0x7fe6: {"kind": 'mem', "py": 'r[2] = s8(_rdw(ram, 0xFFFF9FC5, 1))', "slot_py": None, "target": None, "cond": None},
    0x7fe8: {"kind": 'reg', "py": 'r[0] = 0xFFFF9F94', "slot_py": None, "target": None, "cond": None},
    0x7fea: {"kind": 'reg', "py": 'r[2] = (r[2] + r[3]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x7fec: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFF9F94, 1, r[2])', "target": None, "cond": None},}
