#!/usr/bin/env python3
"""Differential test for engineSpeedInit (0x7F90) — v3 lift + v4 FPU, 32 bytes.
...
Run from repo root: python3 c/tests/test_engineSpeedInit_7f90.py
"""
...
ENTRY = 0x7F90
RAW = bytes.fromhex("D4 3E F4 8D D1 40 D3 3E D2 3E 23 42 22 42 E4 00 D3 3E F1 4A 23 40 D2 3E F2 4A D1 3E 00 0B 21 40")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFF9FE8
SPAN_END = 0x7FB0
SENT = 0x7FB0     # stop-sentinel, placed past the literal pool
...
CODE = {
    ...
    0x7fa4: {"kind": 'mem', "py": '_wrw(ram, 0xFFFF9FE8, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    ...
    0x7fac: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFF9F94, 1, r[4])', "target": None, "cond": None},}
