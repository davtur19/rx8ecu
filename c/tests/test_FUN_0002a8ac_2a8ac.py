#!/usr/bin/env python3
"""Differential test for FUN_0002a8ac (0x2A8AC) — v3 lift (branches + delay slots), 56 bytes.
...
Run from repo root: python3 c/tests/test_FUN_0002a8ac_2a8ac.py
"""
...
ENTRY = 0x2A8AC
RAW = bytes.fromhex("8D 13 00 09 91 4B 60 10 60 0C 88 01 8D 0D 00 09 93 46 60 30 60 0C 88 01 8D 07 00 09 92 41 E3 03 60 20 60 0C 30 33 8F 03 00 09 E1 01 A0 02 24 10 E2 00 24 20 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCCD1
SPAN_END = 0x2A8E4
SENT = 0x2A8E4     # stop-sentinel, placed past the literal pool
...
CODE = {
    ...
    0x2a8d8: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, r[4], 1, r[1])', "target": 0x2a8e0, "cond": 'always'},
    0x2a8dc: {"kind": 'reg', "py": 'r[2] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x2a8de: {"kind": 'mem', "py": '_wrw(ram, r[4], 1, r[2])', "slot_py": None, "target": None, "cond": None},
