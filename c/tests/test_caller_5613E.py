#!/usr/bin/env python3
"""Differential test for caller_5613E (entry 0x5613E) — v8 ST caller (CFG), 24 bytes.
...
Run: python3 test_caller_5613E.py
"""
...
CODE = {
    0x5613e: {"kind": 'st', "py": 'local[0x3FC] = pr\n_wrw(ram, STACK_BASE + 0x3FC, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x56140: {"kind": 'reg', "py": 'r[3] = 0xFFFFAAF4', "slot_py": None, "target": None, "cond": None},
    0x56142: {"kind": 'fpu', "py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFAAF4, 4))', "slot_py": None, "target": None, "cond": None},
    0x56144: {"kind": 'reg', "py": 'r[0] = 0x0005624C', "slot_py": None, "target": None, "cond": None},
    0x56146: {"kind": 'fpu', "py": 'fr[6] = bits2f(_rdw(ram, 0x0005624C, 4))', "slot_py": None, "target": None, "cond": None},
    0x56148: {"kind": 'reg', "py": 'r[0] = 0x00056250', "slot_py": None, "target": None, "cond": None},
    0x5614a: {"kind": 'reg', "py": 'r[2] = 0x00002490', "slot_py": None, "target": None, "cond": None},
    0x5614c: {"kind": "call", "py": None, "slot_py": 'fr[5] = bits2f(_rdw(ram, 0x00056250, 4))', "target": 0x2490, "ret_pc": 0x56150, "set_pr": True, "cond": None},
    0x56150: {"kind": 'st', "py": 'pr = _rdw(ram, STACK_BASE + 0x3FC, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x56152: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},
