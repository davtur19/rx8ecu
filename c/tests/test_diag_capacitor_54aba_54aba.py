#!/usr/bin/env python3
"""Differential test for diag_capacitor_54aba (0x54ABA) — v3 lift + v4 FPU, 42 bytes.
...
Run from repo root: python3 c/tests/test_diag_capacitor_54aba_54aba.py
"""
...
ENTRY = 0x54ABA
RAW = bytes.fromhex("94 15 93 17 F4 38 D2 0C F5 28 F5 45 8D 03 00 09 E0 01 A0 08 24 00 D1 09 F3 18 F5 31 F5 45 8F 02 00 09 E0 00 24 00 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFD1EA
SPAN_END = 0x54AE4
SENT = 0x54AE4     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x54aba: {"kind": 'reg', "py": 'r[4] = 0xFFFFD1EA', "slot_py": None, "target": None, "cond": None},
    0x54abc: {"kind": 'reg', "py": 'r[3] = 0xFFFFB600', "slot_py": None, "target": None, "cond": None},
    0x54abe: {"kind": 'fpu', "py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFB600, 4))', "slot_py": None, "target": None, "cond": None},
    0x54ac0: {"kind": 'reg', "py": 'r[2] = 0x0007DA54', "slot_py": None, "target": None, "cond": None},
    0x54ac2: {"kind": 'fpu', "py": 'fr[5] = bits2f(_rdw(ram, 0x0007DA54, 4))', "slot_py": None, "target": None, "cond": None},
    0x54ac4: {"kind": 'fpu', "py": 'T = 1 if fr[5] > fr[4] else 0', "slot_py": None, "target": None, "cond": None},
    0x54ac6: {"kind": "branch", "py": None, "slot_py": '', "target": 0x54ad0, "cond": 'T'},
    0x54aca: {"kind": 'reg', "py": 'r[0] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x54acc: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFD1EA, 1, r[0])', "target": 0x54ae0, "cond": 'always'},
    0x54ad0: {"kind": 'reg', "py": 'r[1] = 0x0007DA58', "slot_py": None, "target": None, "cond": None},
    0x54ad2: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x0007DA58, 4))', "slot_py": None, "target": None, "cond": None},
    0x54ad4: {"kind": 'fpu', "py": 'fr[5] = ts(fr[5] - fr[3])', "slot_py": None, "target": None, "cond": None},
    0x54ad6: {"kind": 'fpu', "py": 'T = 1 if fr[5] > fr[4] else 0', "slot_py": None, "target": None, "cond": None},
    0x54ad8: {"kind": "branch", "py": None, "slot_py": '', "target": 0x54ae0, "cond": 'notT'},
    0x54adc: {"kind": 'reg', "py": 'r[0] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x54ade: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD1EA, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x54ae0: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
