#!/usr/bin/env python3
"""Differential test for vehicleSpeedRelatedSOmething (0x424AC) — v3 lift + v4 FPU, 48 bytes.
...
Run from repo root: python3 c/tests/test_vehicleSpeedRelatedSOmething_424ac.py
"""
...
ENTRY = 0x424AC
RAW = bytes.fromhex("93 2F F4 38 94 2E C7 1C F3 08 F3 45 8D 04 00 09 C7 1A F2 08 A0 0A F4 2A F2 8D F4 25 8F 04 00 09 D2 17 F1 28 A0 01 F1 42 F1 9D F4 1A 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBFBC
SPAN_END = 0x424DC
SENT = 0x424DC     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x424ac: {"kind": 'reg', "py": 'r[3] = 0xFFFFBFBC', "slot_py": None, "target": None, "cond": None},
    0x424ae: {"kind": 'fpu', "py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFBFBC, 4))', "slot_py": None, "target": None, "cond": None},
    0x424b0: {"kind": 'reg', "py": 'r[4] = 0xFFFFC930', "slot_py": None, "target": None, "cond": None},
    0x424b2: {"kind": 'reg', "py": 'r[0] = 0x00042524', "slot_py": None, "target": None, "cond": None},
    0x424b4: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x00042524, 4))', "slot_py": None, "target": None, "cond": None},
    0x424b6: {"kind": 'fpu', "py": 'T = 1 if fr[3] > fr[4] else 0', "slot_py": None, "target": None, "cond": None},
    0x424b8: {"kind": "branch", "py": None, "slot_py": '', "target": 0x424c4, "cond": 'T'},
    0x424bc: {"kind": 'reg', "py": 'r[0] = 0x00042528', "slot_py": None, "target": None, "cond": None},
    0x424be: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0x00042528, 4))', "slot_py": None, "target": None, "cond": None},
    0x424c0: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, r[4], 4, f2bits(fr[2]))', "target": 0x424d8, "cond": 'always'},
    0x424c4: {"kind": 'fpu', "py": 'fr[2] = 0.0', "slot_py": None, "target": None, "cond": None},
    0x424c6: {"kind": 'fpu', "py": 'T = 1 if fr[4] > fr[2] else 0', "slot_py": None, "target": None, "cond": None},
    0x424c8: {"kind": "branch", "py": None, "slot_py": '', "target": 0x424d4, "cond": 'notT'},
    0x424cc: {"kind": 'reg', "py": 'r[2] = 0x0007A1A0', "slot_py": None, "target": None, "cond": None},
    0x424ce: {"kind": 'fpu', "py": 'fr[1] = bits2f(_rdw(ram, 0x0007A1A0, 4))', "slot_py": None, "target": None, "cond": None},
    0x424d0: {"kind": "branch", "py": None, "slot_py": 'fr[1] = ts(fr[1] * fr[4])', "target": 0x424d6, "cond": 'always'},
    0x424d4: {"kind": 'fpu', "py": 'fr[1] = 1.0', "slot_py": None, "target": None, "cond": None},
    0x424d6: {"kind": 'fpu', "py": '_wrw(ram, r[4], 4, f2bits(fr[1]))', "slot_py": None, "target": None, "cond": None},
    0x424d8: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
