#!/usr/bin/env python3
"""Differential test for noOpFunc7 (0x50A6) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_noOpFunc7_50a6.py
"""
...
ENTRY = 0x50A6
RAW = bytes.fromhex("93 6A 92 6A 00 0B 22 31")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFF75E
SPAN_END = 0x50AE
SENT = 0x50AE     # stop-sentinel, placed past the literal pool
