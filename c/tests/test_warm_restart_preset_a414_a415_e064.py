#!/usr/bin/env python3
"""Differential test for warm_restart_preset_a414_a415 (0xE064) — v3 lift (branches + delay slots), 26 bytes.
...
Run from repo root: python3 c/tests/test_warm_restart_preset_a414_a415_e064.py
"""
...
ENTRY = 0xE064
RAW = bytes.fromhex("D3 3E 60 30 60 0C 88 01 8F 05 00 09 94 6B 91 6B 92 6B 21 40 22 40 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFA415
SPAN_END = 0xE07E
SENT = 0xE07E     # stop-sentinel, placed past the literal pool
...
CODE = {
    0xe064: {"kind": 'reg', "py": 'r[3] = 0xFFFF9F8C', "slot_py": None, "target": None, "cond": None},
    0xe066: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFF9F8C, 1))', "slot_py": None, "target": None, "cond": None},
    0xe068: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0xe06a: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0xe06c: {"kind": "branch", "py": None, "slot_py": '', "target": 0xe07a, "cond": 'notT'},
    0xe070: {"kind": 'reg', "py": 'r[4] = 0x000000FF', "slot_py": None, "target": None, "cond": None},
    0xe072: {"kind": 'reg', "py": 'r[1] = 0xFFFFA414', "slot_py": None, "target": None, "cond": None},
    0xe074: {"kind": 'reg', "py": 'r[2] = 0xFFFFA415', "slot_py": None, "target": None, "cond": None},
    0xe076: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA414, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0xe078: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA415, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0xe07a: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
