#!/usr/bin/env python3
"""Differential test for fault_flag_invert_store_cf9c_to_cce0 (0x4A5A4) — v3 lift (branches + delay slots), 28 bytes.
...
Run from repo root: python3 c/tests/test_fault_flag_invert_store_cf9c_to_cce0_4a5a4.py
"""
...
ENTRY = 0x4A5A4
RAW = bytes.fromhex("94 5B 93 5B 60 30 60 0C 88 01 8F 03 00 09 E1 00 A0 02 24 10 E0 01 24 00 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCF9C
SPAN_END = 0x4A5C0
SENT = 0x4A5C0     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x4a5a4: {"kind": 'reg', "py": 'r[4] = 0xFFFFCCE0', "slot_py": None, "target": None, "cond": None},
    0x4a5a6: {"kind": 'reg', "py": 'r[3] = 0xFFFFCF9C', "slot_py": None, "target": None, "cond": None},
    0x4a5a8: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCF9C, 1))', "slot_py": None, "target": None, "cond": None},
    0x4a5aa: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x4a5ac: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x4a5ae: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4a5b8, "cond": 'notT'},
    0x4a5b2: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x4a5b4: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFCCE0, 1, r[1])', "target": 0x4a5bc, "cond": 'always'},
    0x4a5b8: {"kind": 'reg', "py": 'r[0] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x4a5ba: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCCE0, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x4a5bc: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
