#!/usr/bin/env python3
"""Differential test for setMemInsideFUNCto1 (0x3E3F0) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_setMemInsideFUNCto1_3e3f0.py
"""
...
ENTRY = 0x3E3F0
RAW = bytes.fromhex("92 8B E3 01 00 0B 22 30")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFC638
SPAN_END = 0x3E3F8
SENT = 0x3E3F8     # stop-sentinel, placed past the literal pool
