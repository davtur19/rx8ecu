#!/usr/bin/env python3
"""Differential test for kwp_session_frame_init (0x15A6) — pure straight-line lift, 10 bytes.
...
Run from repo root: python3 c/tests/test_kwp_session_frame_init_15a6.py
"""
...
ENTRY = 0x15A6
RAW = bytes.fromhex("63 63 62 2D 73 04 32 3C 77 01")
SEED = 42
N = 2000
...
def spec_mirror(r4, r5, r6, r7):
    ...
    r[2] = r[2] & 0xFFFF
    # 0x0015AA: op 0x7304
    r[3] = (r[3] + s8(0x04)) & 0xFFFFFFFF
    # 0x0015AC: op 0x323C
    r[2] = (r[2] + r[3]) & 0xFFFFFFFF
    # 0x0015AE: op 0x7701
    r[7] = (r[7] + s8(0x01)) & 0xFFFFFFFF
