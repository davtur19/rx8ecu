#!/usr/bin/env python3
"""Differential test for CANSetupSomethingDifferentBasedOnBit (0xE074) — mem lift (RAM-only, straight-line), 12 bytes.
...
Run from repo root: python3 c/tests/test_CANSetupSomethingDifferentBasedOnBit_e074.py
"""
...
ENTRY = 0xE074
RAW = bytes.fromhex("2F E6 2F D6 2F C6 2F B6 2F A6 EB 00")
SEED = 42
N = 2000
