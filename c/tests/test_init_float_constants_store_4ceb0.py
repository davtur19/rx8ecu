#!/usr/bin/env python3
"""Differential test for init_float_constants_store (0x4CEB0) — v3 lift + v4 FPU, 28 bytes.
...
Run from repo root: python3 c/tests/test_init_float_constants_store_4ceb0.py
"""
...
ENTRY = 0x4CEB0
RAW = bytes.fromhex("93 8A E1 01 C7 4B F4 38 F3 08 92 86 F2 3A 90 85 93 85 20 10 F3 4A 92 83 00 0B F2 4A")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCE01
SPAN_END = 0x4CECC
SENT = 0x4CECC     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x4ceb0: {"kind": 'reg', "py": 'r[3] = 0xFFFFB5D8', "slot_py": None, "target": None, "cond": None},
    0x4ceb2: {"kind": 'reg', "py": 'r[1] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x4ceb4: {"kind": 'reg', "py": 'r[0] = 0x0004CFE4', "slot_py": None, "target": None, "cond": None},
    0x4ceb6: {"kind": 'fpu', "py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFB5D8, 4))', "slot_py": None, "target": None, "cond": None},
    0x4ceb8: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x0004CFE4, 4))', "slot_py": None, "target": None, "cond": None},
    0x4ceba: {"kind": 'reg', "py": 'r[2] = 0xFFFFCDE8', "slot_py": None, "target": None, "cond": None},
    0x4cebc: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFCDE8, 4, f2bits(fr[3]))', "slot_py": None, "target": None, "cond": None},
    0x4cebe: {"kind": 'reg', "py": 'r[0] = 0xFFFFCE01', "slot_py": None, "target": None, "cond": None},
    0x4cec0: {"kind": 'reg', "py": 'r[3] = 0xFFFFCDF8', "slot_py": None, "target": None, "cond": None},
    0x4cec2: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCE01, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x4cec4: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFCDF8, 4, f2bits(fr[4]))', "slot_py": None, "target": None, "cond": None},
    0x4cec6: {"kind": 'reg', "py": 'r[2] = 0xFFFFCDFC', "slot_py": None, "target": None, "cond": None},
    0x4cec8: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFCDFC, 4, f2bits(fr[4]))', "target": None, "cond": None},}
