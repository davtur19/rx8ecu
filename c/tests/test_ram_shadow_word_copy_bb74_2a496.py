#!/usr/bin/env python3
"""Differential test for ram_shadow_word_copy_bb74 (0x2A496) — v3 lift (branches + delay slots), 10 bytes.
...
Run from repo root: python3 c/tests/test_ram_shadow_word_copy_bb74_2a496.py
"""
...
ENTRY = 0x2A496
RAW = bytes.fromhex("93 1E D2 16 61 31 00 0B 22 11")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBB8C
SPAN_END = 0x2A4A0
SENT = 0x2A4A0     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x2a496: {"kind": 'reg', "py": 'r[3] = 0xFFFFBB74', "slot_py": None, "target": None, "cond": None},
    0x2a498: {"kind": 'reg', "py": 'r[2] = 0xFFFFBB8C', "slot_py": None, "target": None, "cond": None},
    0x2a49a: {"kind": 'mem', "py": 'r[1] = s16(_rdw(ram, 0xFFFFBB74, 2))', "slot_py": None, "target": None, "cond": None},
    0x2a49c: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBB8C, 2, r[1])', "target": None, "cond": None},}
