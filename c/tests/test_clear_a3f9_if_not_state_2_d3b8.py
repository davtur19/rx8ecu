#!/usr/bin/env python3
"""Differential test for clear_a3f9_if_not_state_2 (0xD3B8) — v3 lift (branches + delay slots), 22 bytes.
...
Run from repo root: python3 c/tests/test_clear_a3f9_if_not_state_2_d3b8.py
"""
...
ENTRY = 0xD3B8
RAW = bytes.fromhex("D4 0C 60 40 60 0C 88 02 8D 03 00 09 D3 0E E2 00 23 20 00 0B 60 40")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFA3FA
SPAN_END = 0xD3CE
SENT = 0xD3CE     # stop-sentinel, placed past the literal pool
...
CODE = {
    0xd3b8: {"kind": 'reg', "py": 'r[4] = 0xFFFFA3FA', "slot_py": None, "target": None, "cond": None},
    0xd3ba: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFA3FA, 1))', "slot_py": None, "target": None, "cond": None},
    0xd3bc: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0xd3be: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x02) else 0', "slot_py": None, "target": None, "cond": None},
    0xd3c0: {"kind": "branch", "py": None, "slot_py": '', "target": 0xd3ca, "cond": 'T'},
    0xd3c4: {"kind": 'reg', "py": 'r[3] = 0xFFFFA3F9', "slot_py": None, "target": None, "cond": None},
    0xd3c6: {"kind": 'reg', "py": 'r[2] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0xd3c8: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA3F9, 1, r[2])', "slot_py": None, "target": None, "cond": None},
    0xd3ca: {"kind": "ret", "py": None, "slot_py": 'r[0] = s8(_rdw(ram, 0xFFFFA3FA, 1))', "target": None, "cond": None},}
