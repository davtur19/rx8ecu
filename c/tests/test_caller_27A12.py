#!/usr/bin/env python3
"""Differential test for caller_27A12 (entry 0x27A12) — v8 ST caller (CFG), 20 bytes.
...
Run: python3 test_caller_27A12.py
"""
...
CODE = {
    0x27a12: {"kind": 'st', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x27a14: {"kind": 'reg', "py": 'r[4] = 0xFFFF8682', "slot_py": None, "target": None, "cond": None},
    0x27a16: {"kind": 'reg', "py": 'r[3] = 0x0003E1F8', "slot_py": None, "target": None, "cond": None},
    0x27a18: {"kind": "call", "py": None, "slot_py": 'r[5] = s8(0x00)', "target": 0x3e1f8, "ret_pc": 0x27a1c, "set_pr": True, "cond": None},
    0x27a1c: {"kind": 'reg', "py": 'r[4] = 0xFFFF8684', "slot_py": None, "target": None, "cond": None},
    0x27a1e: {"kind": 'reg', "py": 'r[5] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x27a20: {"kind": 'reg', "py": 'r[2] = 0x0003E1F8', "slot_py": None, "target": None, "cond": None},
    0x27a22: {"kind": "call", "py": None, "slot_py": 'pr = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": 0x3e1f8, "ret_pc": 0x27a26, "set_pr": False, "cond": None},
