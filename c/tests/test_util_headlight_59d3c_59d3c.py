#!/usr/bin/env python3
"""Differential test for util_headlight_59d3c (0x59D3C) — v3 lift (branches + delay slots), 26 bytes.
...
Run from repo root: python3 c/tests/test_util_headlight_59d3c_59d3c.py
"""
...
ENTRY = 0x59D3C
RAW = bytes.fromhex("93 52 64 4C 66 30 66 6C 34 60 8F 03 E5 00 26 68 8F 01 00 09 E5 01 00 0B 60 53")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    0x59d3c: {"kind": 'reg', "py": 'r[3] = 0xFFFFD28C', "slot_py": None, "target": None, "cond": None},
    0x59d3e: {"kind": 'reg', "py": 'r[4] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x59d40: {"kind": 'mem', "py": 'r[6] = s8(_rdw(ram, 0xFFFFD28C, 1))', "slot_py": None, "target": None, "cond": None},
    0x59d42: {"kind": 'reg', "py": 'r[6] = r[6] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x59d44: {"kind": 'reg', "py": 'T = 1 if r[4] == r[6] else 0', "slot_py": None, "target": None, "cond": None},
    0x59d46: {"kind": "branch", "py": None, "slot_py": 'r[5] = s8(0x00)', "target": 0x59d50, "cond": 'notT'},
    0x59d4a: {"kind": 'reg', "py": 'T = 1 if (r[6] & r[6]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x59d4c: {"kind": "branch", "py": None, "slot_py": '', "target": 0x59d52, "cond": 'notT'},
    0x59d50: {"kind": 'reg', "py": 'r[5] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x59d52: {"kind": "ret", "py": None, "slot_py": 'r[0] = r[5]', "target": None, "cond": None},}
