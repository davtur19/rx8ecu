#!/usr/bin/env python3
"""Differential test for math_divRoundClampInt16 (0x52970) — v3 lift + v4 FPU, 62 bytes.
...
Run from repo root: python3 c/tests/test_math_divRoundClampInt16_52970.py
"""
...
ENTRY = 0x52970
RAW = bytes.fromhex("F3 6C F6 4C F6 31 F2 8D F2 65 8F 03 00 09 C7 4E A0 02 F4 08 C7 4D F4 08 F6 53 F6 6C F3 6C F3 40 95 8F F3 3D 04 5A 34 57 8F 02 00 09 A0 05 64 53 95 88 34 53 8D 01 00 09 64 53 00 0B 60 43")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = None
SPAN_END = 0x529AE
SENT = 0x529AE     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x52970: {"kind": 'fpu', "py": 'fr[3] = fr[6]', "slot_py": None, "target": None, "cond": None},
    0x52972: {"kind": 'fpu', "py": 'fr[6] = fr[4]', "slot_py": None, "target": None, "cond": None},
    0x52974: {"kind": 'fpu', "py": 'fr[6] = ts(fr[6] - fr[3])', "slot_py": None, "target": None, "cond": None},
    0x52976: {"kind": 'fpu', "py": 'fr[2] = 0.0', "slot_py": None, "target": None, "cond": None},
    0x52978: {"kind": 'fpu', "py": 'T = 1 if fr[2] > fr[6] else 0', "slot_py": None, "target": None, "cond": None},
    0x5297a: {"kind": "branch", "py": None, "slot_py": '', "target": 0x52984, "cond": 'notT'},
    0x5297e: {"kind": 'reg', "py": 'r[0] = 0x00052AB8', "slot_py": None, "target": None, "cond": None},
    0x52980: {"kind": "branch", "py": None, "slot_py": 'fr[4] = bits2f(_rdw(ram, 0x00052AB8, 4))', "target": 0x52988, "cond": 'always'},
    0x52984: {"kind": 'reg', "py": 'r[0] = 0x00052ABC', "slot_py": None, "target": None, "cond": None},
    0x52986: {"kind": 'fpu', "py": 'fr[4] = bits2f(_rdw(ram, 0x00052ABC, 4))', "slot_py": None, "target": None, "cond": None},
    0x52988: {"kind": 'fpu', "py": 'fr[6] = ts(fr[6] / fr[5])', "slot_py": None, "target": None, "cond": None},
    0x5298a: {"kind": 'fpu', "py": 'fr[6] = fr[6]', "slot_py": None, "target": None, "cond": None},
    0x5298c: {"kind": 'fpu', "py": 'fr[3] = fr[6]', "slot_py": None, "target": None, "cond": None},
    0x5298e: {"kind": 'fpu', "py": 'fr[3] = ts(fr[3] + fr[4])', "slot_py": None, "target": None, "cond": None},
    0x52990: {"kind": 'reg', "py": 'r[5] = 0x00007FFF', "slot_py": None, "target": None, "cond": None},
    0x52992: {"kind": 'fpu', "py": 'fpul = (0x80000000 if fr[3] != fr[3] else (0x7FFFFFFF if fr[3] >= 2147483648.0 else (0x80000000 if fr[3] < -2147483648.0 else int(fr[3])))) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x52994: {"kind": 'fpu', "py": 'r[4] = fpul', "slot_py": None, "target": None, "cond": None},
    0x52996: {"kind": 'reg', "py": 'T = 1 if s32(r[4]) > s32(r[5]) else 0', "slot_py": None, "target": None, "cond": None},
    0x52998: {"kind": "branch", "py": None, "slot_py": '', "target": 0x529a0, "cond": 'notT'},
    0x5299c: {"kind": "branch", "py": None, "slot_py": 'r[4] = r[5]', "target": 0x529aa, "cond": 'always'},
    0x529a0: {"kind": 'reg', "py": 'r[5] = 0xFFFF8000', "slot_py": None, "target": None, "cond": None},
    0x529a2: {"kind": 'reg', "py": 'T = 1 if s32(r[4]) >= s32(r[5]) else 0', "slot_py": None, "target": None, "cond": None},
    0x529a4: {"kind": "branch", "py": None, "slot_py": '', "target": 0x529aa, "cond": 'T'},
    0x529a8: {"kind": 'reg', "py": 'r[4] = r[5]', "slot_py": None, "target": None, "cond": None},
    0x529aa: {"kind": "ret", "py": None, "slot_py": 'r[0] = r[4]', "target": None, "cond": None},}
