#!/usr/bin/env python3
"""Differential test for egr_control_3F208 (0x3F208) — v3 lift + v4 FPU, 28 bytes.
...
Run from repo root: python3 c/tests/test_egr_control_3F208_3f208.py
"""
...
ENTRY = 0x3F208
RAW = bytes.fromhex("A0 0A F5 4A F3 48 F4 35 8F 01 00 09 F4 4A F3 58 F4 35 8D 01 00 09 F5 4A 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
