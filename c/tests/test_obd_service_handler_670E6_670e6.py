#!/usr/bin/env python3
"""Differential test for obd_service_handler_670E6 (0x670E6) — pure straight-line lift, 26 bytes.
...
Run from repo root: python3 c/tests/test_obd_service_handler_670E6_670e6.py
"""
...
ENTRY = 0x670E6
RAW = bytes.fromhex("65 5C D3 42 60 4C 45 09 45 09 45 01 70 FF 40 08 40 08 40 00 65 5C 45 08 30 3C")
SEED = 42
N = 2000
...
def spec_mirror(r4, r5, r6, r7):
    ...
    r[0] = r[4] & 0xFF
    # 0x0670EC: op 0x4509
    r[5] = (r[5] >> 2) & 0xFFFFFFFF
    # 0x0670EE: op 0x4509
    r[5] = (r[5] >> 2) & 0xFFFFFFFF
    # 0x0670F0: op 0x4501
    r[5] = (r[5] >> 1) & 0xFFFFFFFF
    # 0x0670F2: op 0x70FF
    r[0] = (r[0] + s8(0xFF)) & 0xFFFFFFFF
    # 0x0670F4: op 0x4008
    r[0] = (r[0] << 2) & 0xFFFFFFFF
    # 0x0670F6: op 0x4008
    r[0] = (r[0] << 2) & 0xFFFFFFFF
    # 0x0670F8: op 0x4000
