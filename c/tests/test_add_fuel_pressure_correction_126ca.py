#!/usr/bin/env python3
"""Differential test for add_fuel_pressure_correction (0x126CA) — v3 lift + v4 FPU, 16 bytes.
...
Run from repo root: python3 c/tests/test_add_fuel_pressure_correction_126ca.py
"""
...
RAM_MAX = 0xFFFFA654
SPAN_END = 0x126DA
SENT = 0x126DA     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x126ca: {"kind": 'reg', "py": 'r[2] = 0xFFFFA654', "slot_py": None, "target": None, "cond": None},
    0x126cc: {"kind": 'reg', "py": 'r[1] = 0xFFFFA64C', "slot_py": None, "target": None, "cond": None},
    0x126ce: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFA654, 4))', "slot_py": None, "target": None, "cond": None},
    0x126d0: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0xFFFFA64C, 4))', "slot_py": None, "target": None, "cond": None},
    0x126d2: {"kind": 'fpu', "py": 'fr[2] = ts(fr[2] + fr[3])', "slot_py": None, "target": None, "cond": None},
    0x126d4: {"kind": 'reg', "py": 'r[3] = 0xFFFFA640', "slot_py": None, "target": None, "cond": None},
    0x126d6: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFA640, 4, f2bits(fr[2]))', "target": None, "cond": None},}
