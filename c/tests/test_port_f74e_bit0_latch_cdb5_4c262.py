#!/usr/bin/env python3
"""Differential test for port_f74e_bit0_latch_cdb5 (0x4C262) — v3 lift (branches + delay slots), 48 bytes.
...
Run from repo root: python3 c/tests/test_port_f74e_bit0_latch_cdb5_4c262.py
"""
...
ENTRY = 0x4C262
RAW = bytes.fromhex("E4 01 93 63 95 61 60 31 60 0D 20 49 20 08 00 29 CA 01 88 01 8F 02 00 09 A0 01 60 43 E0 00 88 01 8F 02 00 09 A0 02 25 40 E2 00 25 20 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFF74E
SPAN_END = 0x4C292
SENT = 0x4C292     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x4c262: {"kind": 'reg', "py": 'r[4] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x4c264: {"kind": 'reg', "py": 'r[3] = 0xFFFFF74E', "slot_py": None, "target": None, "cond": None},
    0x4c266: {"kind": 'reg', "py": 'r[5] = 0xFFFFCDB5', "slot_py": None, "target": None, "cond": None},
    0x4c268: {"kind": 'mem', "py": 'r[0] = s16(_rdw(ram, 0xFFFFF74E, 2))', "slot_py": None, "target": None, "cond": None},
    0x4c26a: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x4c26c: {"kind": 'reg', "py": 'r[0] = (r[0] & r[4]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x4c26e: {"kind": 'reg', "py": 'T = 1 if (r[0] & r[0]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x4c270: {"kind": 'reg', "py": 'r[0] = T;', "slot_py": None, "target": None, "cond": None},
    0x4c272: {"kind": 'reg', "py": 'r[0] = (r[0] ^ 0x01) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x4c274: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x4c276: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4c27e, "cond": 'notT'},
    0x4c27a: {"kind": "branch", "py": None, "slot_py": 'r[0] = r[4]', "target": 0x4c280, "cond": 'always'},
    0x4c27e: {"kind": 'reg', "py": 'r[0] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x4c280: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x4c282: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4c28a, "cond": 'notT'},
    0x4c286: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFCDB5, 1, r[4])', "target": 0x4c28e, "cond": 'always'},
    0x4c28a: {"kind": 'reg', "py": 'r[2] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x4c28c: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCDB5, 1, r[2])', "slot_py": None, "target": None, "cond": None},
    0x4c28e: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
