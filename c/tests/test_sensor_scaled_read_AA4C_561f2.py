#!/usr/bin/env python3
"""Differential test for sensor_scaled_read_AA4C (0x561F2) — v3 lift (branches + delay slots), 10 bytes.
...
Run from repo root: python3 c/tests/test_sensor_scaled_read_AA4C_561f2.py
"""
...
ENTRY = 0x561F2
RAW = bytes.fromhex("4F 26 6C F6 6D F6 00 0B 6E F6")
SEED = 43
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = None
SPAN_END = 0x561FC
SENT = 0x561FC     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x561f2: {"kind": 'mem', "py": 'pr = _rdw(ram, STACK_BASE + 0x400, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x561f4: {"kind": 'mem', "py": 'r[12] = _rdw(ram, STACK_BASE + 0x404, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x561f6: {"kind": 'mem', "py": 'r[13] = _rdw(ram, STACK_BASE + 0x408, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x561f8: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, STACK_BASE + 0x40C, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},}
