#!/usr/bin/env python3
"""Differential test for calculateTotalRequestedTrqPcnt (0x2D3A2) — v3 lift + v4 FPU, 22 bytes.
...
Run from repo root: python3 c/tests/test_calculateTotalRequestedTrqPcnt_2d3a2.py
"""
...
ENTRY = 0x2D3A2
RAW = bytes.fromhex("93 2A 91 25 F3 38 F2 18 F2 30 92 26 F1 28 91 26 F2 10 00 0B F1 2A")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBCEC
SPAN_END = 0x2D3B8
SENT = 0x2D3B8     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x2d3a2: {"kind": 'reg', "py": 'r[3] = 0xFFFFBCE8', "slot_py": None, "target": None, "cond": None},
    0x2d3a4: {"kind": 'reg', "py": 'r[1] = 0xFFFFBCD0', "slot_py": None, "target": None, "cond": None},
    0x2d3a6: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFBCE8, 4))', "slot_py": None, "target": None, "cond": None},
    0x2d3a8: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0xFFFFBCD0, 4))', "slot_py": None, "target": None, "cond": None},
    0x2d3aa: {"kind": 'fpu', "py": 'fr[2] = ts(fr[2] + fr[3])', "slot_py": None, "target": None, "cond": None},
    0x2d3ac: {"kind": 'reg', "py": 'r[2] = 0xFFFFBCEC', "slot_py": None, "target": None, "cond": None},
    0x2d3ae: {"kind": 'fpu', "py": 'fr[1] = bits2f(_rdw(ram, 0xFFFFBCEC, 4))', "slot_py": None, "target": None, "cond": None},
    0x2d3b0: {"kind": 'reg', "py": 'r[1] = 0xFFFFBCD8', "slot_py": None, "target": None, "cond": None},
    0x2d3b2: {"kind": 'fpu', "py": 'fr[2] = ts(fr[2] + fr[1])', "slot_py": None, "target": None, "cond": None},
    0x2d3b4: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBCD8, 4, f2bits(fr[2]))', "target": None, "cond": None},}
