#!/usr/bin/env python3
"""Differential test for set_ram_flag_298F4 (0x298F4) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_set_ram_flag_298F4_298f4.py
"""
...
ENTRY = 0x298F4
RAW = bytes.fromhex("92 63 E3 01 00 0B 22 30")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    0x298f4: {"kind": 'reg', "py": 'r[2] = 0xFFFFBB08', "slot_py": None, "target": None, "cond": None},
    0x298f6: {"kind": 'reg', "py": 'r[3] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x298f8: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBB08, 1, r[3])', "target": None, "cond": None},}
