#!/usr/bin/env python3
"""Differential test for copy_float_c9d0 (0x433DA) — v3 lift + v4 FPU, 10 bytes.
...
Run from repo root: python3 c/tests/test_copy_float_c9d0_433da.py
"""
...
ENTRY = 0x433DA
RAW = bytes.fromhex("93 1C D1 16 F3 38 00 0B F1 3A")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFC9D0
SPAN_END = 0x433E4
SENT = 0x433E4     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x433da: {"kind": 'reg', "py": 'r[3] = 0xFFFFC644', "slot_py": None, "target": None, "cond": None},
    0x433dc: {"kind": 'reg', "py": 'r[1] = 0xFFFFC9D0', "slot_py": None, "target": None, "cond": None},
    0x433de: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFC644, 4))', "slot_py": None, "target": None, "cond": None},
    0x433e0: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFC9D0, 4, f2bits(fr[3]))', "target": None, "cond": None},}
