#!/usr/bin/env python3
"""Differential test for port_bitfield_check_sensor_flag_32174 (0x32174) — v3 lift (branches + delay slots), 32 bytes.
...
Run from repo root: python3 c/tests/test_port_bitfield_check_sensor_flag_32174_32174.py
"""
...
CODE = {
    0x32174: {"kind": 'reg', "py": 'r[4] = 0xFFFFBFA5', "slot_py": None, "target": None, "cond": None},
    0x32176: {"kind": 'reg', "py": 'r[3] = 0xFFFF9ECD', "slot_py": None, "target": None, "cond": None},
    0x32178: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFF9ECD, 1))', "slot_py": None, "target": None, "cond": None},
    0x3217a: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x3217c: {"kind": 'reg', "py": 'T = 1 if (r[0] & 0x08) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x3217e: {"kind": 'reg', "py": 'r[0] = T;', "slot_py": None, "target": None, "cond": None},
    0x32180: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x32182: {"kind": "branch", "py": None, "slot_py": '', "target": 0x3218c, "cond": 'notT'},
    0x32186: {"kind": 'reg', "py": 'r[3] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x32188: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFBFA5, 1, r[3])', "target": 0x32190, "cond": 'always'},
    0x3218c: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x3218e: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBFA5, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x32190: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
