#!/usr/bin/env python3
"""Differential test for FUN_00051314 (0x51314) — mem lift (RAM-only, straight-line), 16 bytes.
...
Run from repo root: python3 c/tests/test_FUN_00051314_51314.py
"""
...
ENTRY = 0x51314
RAW = bytes.fromhex("00 09 90 25 60 00 C8 20 00 29 70 FF 60 0B 88 01")
SEED = 42
N = 2000
...
def spec_mirror(r4, r5, r6, r7, ram, stack_top):
    ...
    r[0] = s8(_rdw(ram, 0xFFFFCFF1, 1))
    # 0x05131A: op 0xC820
    T = 1 if (r[0] & 0x20) == 0 else 0
    # 0x05131C: op 0x0029
    r[0] = T
    # 0x05131E: op 0x70FF
