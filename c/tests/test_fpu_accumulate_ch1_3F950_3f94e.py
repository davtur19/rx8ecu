#!/usr/bin/env python3
"""Differential test for fpu_accumulate_ch1_3F950 (0x3F94E) — v3 lift + v4 FPU, 40 bytes.
...
Run from repo root: python3 c/tests/test_fpu_accumulate_ch1_3F950_3f94e.py
"""
...
RAM_MAX = 0xFFFFC6BF
SPAN_END = 0x3F976
SENT = 0x3F976     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x3f94e: {"kind": 'reg', "py": 'r[3] = 0xFFFFC6B4', "slot_py": None, "target": None, "cond": None},
    0x3f950: {"kind": 'reg', "py": 'r[4] = 0xFFFFC6BF', "slot_py": None, "target": None, "cond": None},
    0x3f952: {"kind": 'fpu', "py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFC6B4, 4))', "slot_py": None, "target": None, "cond": None},
    0x3f954: {"kind": 'reg', "py": 'r[2] = 0x0007AF08', "slot_py": None, "target": None, "cond": None},
    0x3f956: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x0007AF08, 4))', "slot_py": None, "target": None, "cond": None},
    0x3f958: {"kind": 'fpu', "py": 'T = 1 if fr[3] > fr[4] else 0', "slot_py": None, "target": None, "cond": None},
    0x3f95a: {"kind": "branch", "py": None, "slot_py": '', "target": 0x3f964, "cond": 'notT'},
    0x3f95e: {"kind": 'reg', "py": 'r[0] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x3f960: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFC6BF, 1, r[0])', "target": 0x3f972, "cond": 'always'},
    0x3f964: {"kind": 'reg', "py": 'r[1] = 0x0007AF04', "slot_py": None, "target": None, "cond": None},
    0x3f966: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0x0007AF04, 4))', "slot_py": None, "target": None, "cond": None},
    0x3f968: {"kind": 'fpu', "py": 'T = 1 if fr[4] > fr[2] else 0', "slot_py": None, "target": None, "cond": None},
    0x3f96a: {"kind": "branch", "py": None, "slot_py": '', "target": 0x3f972, "cond": 'notT'},
    0x3f96e: {"kind": 'reg', "py": 'r[0] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x3f970: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC6BF, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x3f972: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
