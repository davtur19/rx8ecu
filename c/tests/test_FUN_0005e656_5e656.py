#!/usr/bin/env python3
"""Differential test for FUN_0005e656 (0x5E656) — v3 lift (branches + delay slots), 34 bytes.
...
Run from repo root: python3 c/tests/test_FUN_0005e656_5e656.py
"""
...
ENTRY = 0x5E656
RAW = bytes.fromhex("60 4C D5 30 88 01 8D 05 00 09 88 00 8D 05 00 09 A0 05 00 09 E3 01 A0 02 25 30 E1 00 25 10 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFD49A
SPAN_END = 0x5E678
SENT = 0x5E678     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x5e656: {"kind": 'reg', "py": 'r[0] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x5e658: {"kind": 'reg', "py": 'r[5] = 0xFFFFD49A', "slot_py": None, "target": None, "cond": None},
    0x5e65a: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x5e65c: {"kind": "branch", "py": None, "slot_py": '', "target": 0x5e66a, "cond": 'T'},
    0x5e660: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x00) else 0', "slot_py": None, "target": None, "cond": None},
    0x5e662: {"kind": "branch", "py": None, "slot_py": '', "target": 0x5e670, "cond": 'T'},
    0x5e666: {"kind": "branch", "py": None, "slot_py": '', "target": 0x5e674, "cond": 'always'},
    0x5e66a: {"kind": 'reg', "py": 'r[3] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x5e66c: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFD49A, 1, r[3])', "target": 0x5e674, "cond": 'always'},
    0x5e670: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x5e672: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD49A, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x5e674: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
