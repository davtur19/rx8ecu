#!/usr/bin/env python3
"""Differential test for FUN_00067054 (0x67054) — v3 lift (branches + delay slots), 18 bytes.
...
Run from repo root: python3 c/tests/test_FUN_00067054_67054.py
"""
...
ENTRY = 0x67054
RAW = bytes.fromhex("D3 5F 60 30 60 0C 88 07 8F 01 E4 01 E4 00 00 0B 60 43")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFDBF1
SPAN_END = 0x67066
SENT = 0x67066     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x67054: {"kind": 'reg', "py": 'r[3] = 0xFFFFDBF1', "slot_py": None, "target": None, "cond": None},
    0x67056: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFDBF1, 1))', "slot_py": None, "target": None, "cond": None},
    0x67058: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x6705a: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x07) else 0', "slot_py": None, "target": None, "cond": None},
    0x6705c: {"kind": "branch", "py": None, "slot_py": 'r[4] = s8(0x01)', "target": 0x67062, "cond": 'notT'},
    0x67060: {"kind": 'reg', "py": 'r[4] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x67062: {"kind": "ret", "py": None, "slot_py": 'r[0] = r[4]', "target": None, "cond": None},}
