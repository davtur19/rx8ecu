#!/usr/bin/env python3
"""Differential test for fuel_pump_rpm_scale_262FA (0x262FA) — v3 lift (branches + delay slots), 14 bytes.
...
Run from repo root: python3 c/tests/test_fuel_pump_rpm_scale_262FA_262fa.py
"""
...
ENTRY = 0x262FA
RAW = bytes.fromhex("E2 01 A0 02 24 20 E1 00 24 10 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    ...
    0x262fc: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, r[4], 1, r[2])', "target": 0x26304, "cond": 'always'},
    0x26300: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x26302: {"kind": 'mem', "py": '_wrw(ram, r[4], 1, r[1])', "slot_py": None, "target": None, "cond": None},
