#!/usr/bin/env python3
"""Differential test for init_d49c_ffff_region (0x5EE0C) — v3 lift (branches + delay slots), 24 bytes.
...
Run from repo root: python3 c/tests/test_init_d49c_ffff_region_5ee0c.py
"""
...
ENTRY = 0x5EE0C
RAW = bytes.fromhex("D7 0E 64 73 D5 0E 66 73 76 08 24 51 74 04 34 62 8F FB 00 09 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFD49C
SPAN_END = 0x5EE24
SENT = 0x5EE24     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x5ee0c: {"kind": 'reg', "py": 'r[7] = 0xFFFFD49C', "slot_py": None, "target": None, "cond": None},
    0x5ee0e: {"kind": 'reg', "py": 'r[4] = r[7]', "slot_py": None, "target": None, "cond": None},
    0x5ee10: {"kind": 'reg', "py": 'r[5] = 0x0000FFFF', "slot_py": None, "target": None, "cond": None},
    0x5ee12: {"kind": 'reg', "py": 'r[6] = r[7]', "slot_py": None, "target": None, "cond": None},
    0x5ee14: {"kind": 'reg', "py": 'r[6] = (r[6] + s8(0x08)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x5ee16: {"kind": 'mem', "py": '_wrw(ram, r[4], 2, r[5])', "slot_py": None, "target": None, "cond": None},
    0x5ee18: {"kind": 'reg', "py": 'r[4] = (r[4] + s8(0x04)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x5ee1a: {"kind": 'reg', "py": 'T = 1 if (r[4] & 0xFFFFFFFF) >= (r[6] & 0xFFFFFFFF) else 0', "slot_py": None, "target": None, "cond": None},
    0x5ee1c: {"kind": "branch", "py": None, "slot_py": '', "target": 0x5ee16, "cond": 'notT'},
    0x5ee20: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
