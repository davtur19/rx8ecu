#!/usr/bin/env python3
"""Differential test for message_parser_3E36C (0x3E36C) — v3 lift + v4 FPU, 26 bytes.
...
Run from repo root: python3 c/tests/test_message_parser_3E36C_3e36c.py
"""
...
RAM_MAX = 0xFFFFC688
SPAN_END = 0x3E386
SENT = 0x3E386     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x3e36c: {"kind": 'reg', "py": 'r[3] = 0xFFFFBC1C', "slot_py": None, "target": None, "cond": None},
    0x3e36e: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFBC1C, 4))', "slot_py": None, "target": None, "cond": None},
    0x3e370: {"kind": 'reg', "py": 'r[2] = 0xFFFFC688', "slot_py": None, "target": None, "cond": None},
    0x3e372: {"kind": 'fpu', "py": '_wrw(ram, 0xFFFFC688, 4, f2bits(fr[3]))', "slot_py": None, "target": None, "cond": None},
    0x3e374: {"kind": 'reg', "py": 'r[0] = 0xFFFFAD90', "slot_py": None, "target": None, "cond": None},
    0x3e376: {"kind": 'mem', "py": 'r[1] = s8(_rdw(ram, 0xFFFFAD90, 1))', "slot_py": None, "target": None, "cond": None},
    0x3e378: {"kind": 'reg', "py": 'r[3] = 0xFFFFC683', "slot_py": None, "target": None, "cond": None},
    0x3e37a: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC683, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x3e37c: {"kind": 'reg', "py": 'r[1] = 0x0007A881', "slot_py": None, "target": None, "cond": None},
    0x3e37e: {"kind": 'mem', "py": 'r[2] = s8(_rdw(ram, 0x0007A881, 1))', "slot_py": None, "target": None, "cond": None},
    0x3e380: {"kind": 'reg', "py": 'r[3] = 0xFFFFC681', "slot_py": None, "target": None, "cond": None},
    0x3e382: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFC681, 1, r[2])', "target": None, "cond": None},}
