#!/usr/bin/env python3
"""Differential test for sensor_extract_606ba (0x606BA) — v3 lift + v4 FPU, 26 bytes.
...
Run from repo root: python3 c/tests/test_sensor_extract_606ba_606ba.py
"""
...
RAM_MAX = 0xFFFFAA1C
SPAN_END = 0x606D4
SENT = 0x606D4     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x606ba: {"kind": 'reg', "py": 'r[3] = 0xFFFFAA1C', "slot_py": None, "target": None, "cond": None},
    0x606bc: {"kind": "ret", "py": None, "slot_py": 'fr[0] = bits2f(_rdw(ram, 0xFFFFAA1C, 4))', "target": None, "cond": None},
    0x606c0: {"kind": 'reg', "py": 'r[1] = 0xFFFFA41C', "slot_py": None, "target": None, "cond": None},
    0x606c2: {"kind": 'mem', "py": 'r[2] = s8(_rdw(ram, 0xFFFFA41C, 1))', "slot_py": None, "target": None, "cond": None},
    0x606c4: {"kind": 'reg', "py": 'T = 1 if (r[2] & r[2]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x606c6: {"kind": "branch", "py": None, "slot_py": '', "target": 0x606ce, "cond": 'notT'},
    0x606ca: {"kind": "branch", "py": None, "slot_py": 'r[4] = s8(0x00)', "target": 0x606d0, "cond": 'always'},
    0x606ce: {"kind": 'reg', "py": 'r[4] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x606d0: {"kind": "ret", "py": None, "slot_py": 'r[0] = r[4]', "target": None, "cond": None},}
