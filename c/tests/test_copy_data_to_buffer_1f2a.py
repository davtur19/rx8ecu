#!/usr/bin/env python3
"""Differential test for copy_data_to_buffer (0x1F2A) — v3 lift (branches + delay slots), 40 bytes.
...
Run from repo root: python3 c/tests/test_copy_data_to_buffer_1f2a.py
"""
...
ENTRY = 0x1F2A
RAW = bytes.fromhex("7F FC 34 5C 63 5C 2F 40 37 3C 64 53 63 4C 65 F0 65 5C 33 53 89 06 63 74 74 01 26 30 62 4C 32 53 8F F9 76 01 00 0B 7F 04")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = None
SPAN_END = 0x1F52
SENT = 0x1F52     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x1f2a: {"kind": 'reg', "py": 'r[15] = (r[15] + s8(0xFC)) & 0xFFFFFFFF\nsp = (sp + s8(0xFC)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x1f2c: {"kind": 'reg', "py": 'r[4] = (r[4] + r[5]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x1f2e: {"kind": 'reg', "py": 'r[3] = r[5] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x1f30: {"kind": 'mem', "py": 'local[0x3FC] = r[4]\n_wrw(ram, STACK_BASE + 0x3FC, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x1f32: {"kind": 'reg', "py": 'r[7] = (r[7] + r[3]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x1f34: {"kind": 'reg', "py": 'r[4] = r[5]', "slot_py": None, "target": None, "cond": None},
    0x1f36: {"kind": 'reg', "py": 'r[3] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x1f38: {"kind": 'mem', "py": 'r[5] = s8(_rdw(ram, STACK_BASE + 0x3FC, 1))', "slot_py": None, "target": None, "cond": None},
    0x1f3a: {"kind": 'reg', "py": 'r[5] = r[5] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x1f3c: {"kind": 'reg', "py": 'T = 1 if s32(r[3]) >= s32(r[5]) else 0', "slot_py": None, "target": None, "cond": None},
    0x1f3e: {"kind": "branch", "py": None, "slot_py": None, "target": 0x1f4e, "cond": 'T'},
    0x1f40: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, r[7], 1))\nr[7] = (r[7] + 1) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x1f42: {"kind": 'reg', "py": 'r[4] = (r[4] + s8(0x01)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x1f44: {"kind": 'mem', "py": '_wrw(ram, r[6], 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x1f46: {"kind": 'reg', "py": 'r[2] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x1f48: {"kind": 'reg', "py": 'T = 1 if s32(r[2]) >= s32(r[5]) else 0', "slot_py": None, "target": None, "cond": None},
    0x1f4a: {"kind": "branch", "py": None, "slot_py": 'r[6] = (r[6] + s8(0x01)) & 0xFFFFFFFF', "target": 0x1f40, "cond": 'notT'},
    0x1f4e: {"kind": "ret", "py": None, "slot_py": 'r[15] = (r[15] + s8(0x04)) & 0xFFFFFFFF\nsp = (sp + s8(0x04)) & 0xFFFFFFFF', "target": None, "cond": None},}
