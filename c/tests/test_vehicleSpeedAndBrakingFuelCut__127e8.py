#!/usr/bin/env python3
"""Differential test for vehicleSpeedAndBrakingFuelCut_ (0x127E8) — v3 lift + v4 FPU, 88 bytes.
...
Run from repo root: python3 c/tests/test_vehicleSpeedAndBrakingFuelCut__127e8.py
"""
...
ENTRY = 0x127E8
RAW = bytes.fromhex("D4 3C F3 8D 93 65 F2 38 F2 35 8F 04 00 09 D2 3A 61 21 A0 09 24 11 60 41 60 0D 40 15 8F 04 00 09 D3 36 62 41 32 3C 24 21 94 54 92 54 63 20 23 38 8D 05 00 09 D1 2F 60 11 20 08 8F 03 00 09 E2 00 A0 08 24 20 D3 2E 60 30 60 0C 88 01 8F 02 00 09 E1 01 24 10 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBBE8
SPAN_END = 0x12840
SENT = 0x12840     # stop-sentinel, placed past the literal pool
...
CODE = {
    ...
    0x1280a: {"kind": 'mem', "py": 'r[2] = s16(_rdw(ram, 0xFFFFA67C, 2))', "slot_py": None, "target": None, "cond": None},
    0x1280c: {"kind": 'reg', "py": 'r[2] = (r[2] + r[3]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x1280e: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA67C, 2, r[2])', "slot_py": None, "target": None, "cond": None},
    ...
    0x12814: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFAD7C, 1))', "slot_py": None, "target": None, "cond": None},
    ...
    0x12828: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFA66C, 1, r[2])', "target": 0x1283c, "cond": 'always'},
    0x1282c: {"kind": 'reg', "py": 'r[3] = 0xFFFFA680', "slot_py": None, "target": None, "cond": None},
    0x1282e: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFA680, 1))', "slot_py": None, "target": None, "cond": None},
    ...
    0x1283a: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA66C, 1, r[1])', "slot_py": None, "target": None, "cond": None},
