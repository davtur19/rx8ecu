#!/usr/bin/env python3
"""Differential test for FUN_0006060a (0x6060A) — v3 lift (branches + delay slots), 14 bytes.
...
Run from repo root: python3 c/tests/test_FUN_0006060a_6060a.py
"""
...
ENTRY = 0x6060A
RAW = bytes.fromhex("00 0B 6E F6 00 0B E0 01 93 18 64 30 64 4C")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    0x6060a: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, STACK_BASE + 0x400, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},
    0x6060e: {"kind": "ret", "py": None, "slot_py": 'r[0] = s8(0x01)', "target": None, "cond": None},
    0x60612: {"kind": 'reg', "py": 'r[3] = 0xFFFFD1E9', "slot_py": None, "target": None, "cond": None},
    0x60614: {"kind": 'mem', "py": 'r[4] = s8(_rdw(ram, 0xFFFFD1E9, 1))', "slot_py": None, "target": None, "cond": None},
    0x60616: {"kind": 'reg', "py": 'r[4] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},}
