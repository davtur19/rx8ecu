#!/usr/bin/env python3
"""Differential test for air_fuel_ratio_feedback_calc (0x1913C) — v3 lift + v4 FPU, 84 bytes.
...
Run from repo root: python3 c/tests/test_air_fuel_ratio_feedback_calc_1913c.py
"""
...
RAM_MAX = 0xFFFFA9D0
SPAN_END = 0x19190
SENT = 0x19190     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x1913c: {"kind": 'reg', "py": 'r[3] = 0xFFFFA9B8', "slot_py": None, "target": None, "cond": None},
    0x1913e: {"kind": 'reg', "py": 'r[6] = 0xFFFFA9CC', "slot_py": None, "target": None, "cond": None},
    0x19140: {"kind": 'reg', "py": 'r[0] = 0x000191F8', "slot_py": None, "target": None, "cond": None},
    0x19142: {"kind": 'fpu', "py": 'fr[5] = bits2f(_rdw(ram, 0x000191F8, 4))', "slot_py": None, "target": None, "cond": None},
    0x19144: {"kind": 'reg', "py": 'r[5] = 0xFFFFA9BE', "slot_py": None, "target": None, "cond": None},
    0x19146: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, r[6], 4))', "slot_py": None, "target": None, "cond": None},
    0x19148: {"kind": 'fpu', "py": 'T = 1 if fr[5] > fr[3] else 0', "slot_py": None, "target": None, "cond": None},
    0x1914a: {"kind": "branch", "py": None, "slot_py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFA9B8, 4))', "target": 0x19154, "cond": 'T'},
    0x1914e: {"kind": 'fpu', "py": 'T = 1 if fr[5] > fr[4] else 0', "slot_py": None, "target": None, "cond": None},
    0x19150: {"kind": "branch", "py": None, "slot_py": '', "target": 0x19174, "cond": 'T'},
    0x19154: {"kind": 'reg', "py": 'r[2] = 0xFFFFA9BC', "slot_py": None, "target": None, "cond": None},
    0x19156: {"kind": 'mem', "py": 'r[3] = s16(_rdw(ram, 0xFFFFA9BC, 2))', "slot_py": None, "target": None, "cond": None},
    0x19158: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x1915a: {"kind": "branch", "py": None, "slot_py": '', "target": 0x1917c, "cond": 'notT'},
    0x1915e: {"kind": 'reg', "py": 'r[1] = 0xFFFFA9D0', "slot_py": None, "target": None, "cond": None},
    0x19160: {"kind": 'mem', "py": 'r[0] = s16(_rdw(ram, 0xFFFFA9D0, 2))', "slot_py": None, "target": None, "cond": None},
    0x19162: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x19164: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) > 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x19166: {"kind": "branch", "py": None, "slot_py": '', "target": 0x1917c, "cond": 'notT'},
    0x1916a: {"kind": 'reg', "py": 'r[3] = 0xFFFFA9BE', "slot_py": None, "target": None, "cond": None},
    0x1916c: {"kind": 'mem', "py": 'r[0] = s16(_rdw(ram, 0xFFFFA9BE, 2))', "slot_py": None, "target": None, "cond": None},
    0x1916e: {"kind": 'reg', "py": 'T = 1 if (r[0] & r[0]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x19170: {"kind": "branch", "py": None, "slot_py": '', "target": 0x1917c, "cond": 'notT'},
    0x19174: {"kind": 'reg', "py": 'r[2] = 0x0006ED9A', "slot_py": None, "target": None, "cond": None},
    0x19176: {"kind": 'mem', "py": 'r[1] = s16(_rdw(ram, 0x0006ED9A, 2))', "slot_py": None, "target": None, "cond": None},
    0x19178: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFA9BE, 2, r[1])', "target": 0x1918c, "cond": 'always'},
    0x1917c: {"kind": 'mem', "py": 'r[4] = s16(_rdw(ram, r[5], 2))', "slot_py": None, "target": None, "cond": None},
    0x1917e: {"kind": 'reg', "py": 'r[2] = r[4] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x19180: {"kind": 'reg', "py": 'T = 1 if s32(r[2]) > 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x19182: {"kind": "branch", "py": None, "slot_py": '', "target": 0x1918c, "cond": 'notT'},
    0x19186: {"kind": 'reg', "py": 'r[2] = 0x0000FFFF', "slot_py": None, "target": None, "cond": None},
    0x19188: {"kind": 'reg', "py": 'r[4] = (r[4] + r[2]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x1918a: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA9BE, 2, r[4])', "slot_py": None, "target": None, "cond": None},
    0x1918c: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, r[6], 4, f2bits(fr[4]))', "target": None, "cond": None},}
