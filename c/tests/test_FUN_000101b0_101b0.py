#!/usr/bin/env python3
"""Differential test for FUN_000101b0 (0x101B0) — v3 lift (branches + delay slots), 26 bytes.
...
Run from repo root: python3 c/tests/test_FUN_000101b0_101b0.py
"""
...
ENTRY = 0x101B0
RAW = bytes.fromhex("8D 07 00 09 92 72 61 20 21 18 8F 02 00 09 A0 01 E4 02 E4 00 D2 38 00 0B 22 40")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBEA8
SPAN_END = 0x101CA
SENT = 0x101CA     # stop-sentinel, placed past the literal pool
