#!/usr/bin/env python3
"""Differential test for caller_45242 (entry 0x45242) — v8 ST caller (CFG), 20 bytes.
...
Run: python3 test_caller_45242.py
"""
...
CODE = {
    0x45242: {"kind": 'st', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x45244: {"kind": 'reg', "py": 'r[4] = 0xFFFF875C', "slot_py": None, "target": None, "cond": None},
    0x45246: {"kind": 'reg', "py": 'r[3] = 0x0003E1F8', "slot_py": None, "target": None, "cond": None},
    0x45248: {"kind": "call", "py": None, "slot_py": 'r[5] = s8(0x00)', "target": 0x3e1f8, "ret_pc": 0x4524c, "set_pr": True, "cond": None},
    0x4524c: {"kind": 'reg', "py": 'r[4] = 0xFFFF875E', "slot_py": None, "target": None, "cond": None},
    0x4524e: {"kind": 'reg', "py": 'r[5] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x45250: {"kind": 'reg', "py": 'r[2] = 0x0003E1F8', "slot_py": None, "target": None, "cond": None},
    0x45252: {"kind": "call", "py": None, "slot_py": 'pr = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": 0x3e1f8, "ret_pc": 0x45256, "set_pr": False, "cond": None},
