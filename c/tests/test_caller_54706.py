#!/usr/bin/env python3
"""Differential test for caller_54706 (entry 0x54706) — v8 ST caller (CFG), 40 bytes.
...
Run: python3 test_caller_54706.py
"""
...
CODE = {
    0x54706: {"kind": 'mem', "py": 'local[0x3FC] = r[14]\n_wrw(ram, STACK_BASE + 0x3FC, 4, r[14])\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x54708: {"kind": 'st', "py": 'local[0x3F8] = pr\n_wrw(ram, STACK_BASE + 0x3F8, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x5470a: {"kind": 'reg', "py": 'r[14] = 0xFFFFD1DC', "slot_py": None, "target": None, "cond": None},
    0x5470c: {"kind": 'reg', "py": 'r[3] = 0xFFFFA428', "slot_py": None, "target": None, "cond": None},
    0x5470e: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFA428, 1))', "slot_py": None, "target": None, "cond": None},
    0x54710: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x54712: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x54714: {"kind": "branch", "py": None, "slot_py": '', "target": 0x5471e, "cond": 'notT'},
    0x54718: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x5471a: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFD1DC, 1, r[1])', "target": 0x54728, "cond": 'always'},
    0x5471e: {"kind": 'reg', "py": 'r[5] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x54720: {"kind": 'reg', "py": 'r[1] = 0x00002478', "slot_py": None, "target": None, "cond": None},
    0x54722: {"kind": "call", "py": None, "slot_py": 'r[4] = s8(_rdw(ram, 0xFFFFD1DC, 1))', "target": 0x2478, "ret_pc": 0x54726, "set_pr": True, "cond": None},
    0x54726: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD1DC, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x54728: {"kind": 'st', "py": 'pr = _rdw(ram, STACK_BASE + 0x3F8, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x5472a: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, STACK_BASE + 0x3FC, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},
