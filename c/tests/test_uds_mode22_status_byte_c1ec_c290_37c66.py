#!/usr/bin/env python3
"""Differential test for uds_mode22_status_byte_c1ec_c290 (0x37C66) — v3 lift (branches + delay slots), 34 bytes.
...
Run from repo root: python3 c/tests/test_uds_mode22_status_byte_c1ec_c290_37c66.py
"""
...
ENTRY = 0x37C66
RAW = bytes.fromhex("93 23 60 30 60 0C 88 01 8F 01 E4 00 E4 40 D3 17 60 30 60 0C 88 01 8F 02 00 09 E1 04 24 1B 00 0B 60 43")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFC290
SPAN_END = 0x37C88
SENT = 0x37C88     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x37c66: {"kind": 'reg', "py": 'r[3] = 0xFFFFC1EC', "slot_py": None, "target": None, "cond": None},
    0x37c68: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFC1EC, 1))', "slot_py": None, "target": None, "cond": None},
    0x37c6a: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x37c6c: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x37c6e: {"kind": "branch", "py": None, "slot_py": 'r[4] = s8(0x00)', "target": 0x37c74, "cond": 'notT'},
    0x37c72: {"kind": 'reg', "py": 'r[4] = s8(0x40)', "slot_py": None, "target": None, "cond": None},
    0x37c74: {"kind": 'reg', "py": 'r[3] = 0xFFFFC290', "slot_py": None, "target": None, "cond": None},
    0x37c76: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFC290, 1))', "slot_py": None, "target": None, "cond": None},
    0x37c78: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x37c7a: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x37c7c: {"kind": "branch", "py": None, "slot_py": '', "target": 0x37c84, "cond": 'notT'},
    0x37c80: {"kind": 'reg', "py": 'r[1] = s8(0x04)', "slot_py": None, "target": None, "cond": None},
    0x37c82: {"kind": 'reg', "py": 'r[4] = (r[4] | r[1]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x37c84: {"kind": "ret", "py": None, "slot_py": 'r[0] = r[4]', "target": None, "cond": None},}
