#!/usr/bin/env python3
"""Differential test for can251TX_getAndPack (0x2A3E2) — v3 lift (branches + delay slots), 10 bytes.
...
Run from repo root: python3 c/tests/test_can251TX_getAndPack_2a3e2.py
"""
...
ENTRY = 0x2A3E2
RAW = bytes.fromhex("91 32 D0 1C 62 10 00 0B 20 20")
SEED = 42
N = 500
MAXSTEPS = 100000
