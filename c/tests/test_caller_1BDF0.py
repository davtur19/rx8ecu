#!/usr/bin/env python3
"""Differential test for caller_1BDF0 (entry 0x1BDF0) — v8 ST caller (CFG), 24 bytes.
...
Run: python3 test_caller_1BDF0.py
"""
...
CODE = {
    0x1bdf0: {"kind": 'st', "py": 'local[0x3FC] = pr\n_wrw(ram, STACK_BASE + 0x3FC, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x1bdf2: {"kind": 'fpu', "py": 'fr[6] = 0.0', "slot_py": None, "target": None, "cond": None},
    0x1bdf4: {"kind": 'reg', "py": 'r[0] = 0x0001BE98', "slot_py": None, "target": None, "cond": None},
    0x1bdf6: {"kind": 'reg', "py": 'r[2] = 0xFFFFA3E4', "slot_py": None, "target": None, "cond": None},
    0x1bdf8: {"kind": 'reg', "py": 'r[3] = 0x00002490', "slot_py": None, "target": None, "cond": None},
    0x1bdfa: {"kind": 'fpu', "py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFA3E4, 4))', "slot_py": None, "target": None, "cond": None},
    0x1bdfc: {"kind": "call", "py": None, "slot_py": 'fr[5] = bits2f(_rdw(ram, 0x0001BE98, 4))', "target": 0x2490, "ret_pc": 0x1be00, "set_pr": True, "cond": None},
    0x1be00: {"kind": 'reg', "py": 'r[2] = 0xFFFFAD94', "slot_py": None, "target": None, "cond": None},
    0x1be02: {"kind": 'st', "py": 'pr = _rdw(ram, STACK_BASE + 0x3FC, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x1be04: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFAD94, 2, r[0])', "target": None, "cond": None},
