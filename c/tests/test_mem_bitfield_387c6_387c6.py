#!/usr/bin/env python3
"""Differential test for mem_bitfield_387c6 (0x387C6) — v3 lift (branches + delay slots), 34 bytes.
...
Run from repo root: python3 c/tests/test_mem_bitfield_387c6_387c6.py
"""
...
CODE = {
    0x387c6: {"kind": 'reg', "py": 'r[3] = 0xFFFFC240', "slot_py": None, "target": None, "cond": None},
    0x387c8: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFC240, 1))', "slot_py": None, "target": None, "cond": None},
    0x387ca: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x387cc: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x387ce: {"kind": "branch", "py": None, "slot_py": 'r[4] = s8(0x00)', "target": 0x387d4, "cond": 'notT'},
    0x387d2: {"kind": 'reg', "py": 'r[4] = s8(0x40)', "slot_py": None, "target": None, "cond": None},
    0x387d4: {"kind": 'reg', "py": 'r[3] = 0xFFFFC2E4', "slot_py": None, "target": None, "cond": None},
    0x387d6: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFC2E4, 1))', "slot_py": None, "target": None, "cond": None},
    0x387d8: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x387da: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x387dc: {"kind": "branch", "py": None, "slot_py": '', "target": 0x387e4, "cond": 'notT'},
    0x387e0: {"kind": 'reg', "py": 'r[1] = s8(0x04)', "slot_py": None, "target": None, "cond": None},
    0x387e2: {"kind": 'reg', "py": 'r[4] = (r[4] | r[1]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x387e4: {"kind": "ret", "py": None, "slot_py": 'r[0] = r[4]', "target": None, "cond": None},}
