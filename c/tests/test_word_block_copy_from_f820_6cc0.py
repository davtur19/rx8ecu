#!/usr/bin/env python3
"""Differential test for word_block_copy_from_f820 (0x6CC0) — v3 lift (branches + delay slots), 28 bytes.
...
Run from repo root: python3 c/tests/test_word_block_copy_from_f820_6cc0.py
"""
...
ENTRY = 0x6CC0
RAW = bytes.fromhex("92 4B 60 21 81 4F 93 49 60 31 81 4E 91 47 60 11 81 4D 93 45 60 31 81 4C 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFF826
SPAN_END = 0x6CDC
SENT = 0x6CDC     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x6cc0: {"kind": 'reg', "py": 'r[2] = 0xFFFFF826', "slot_py": None, "target": None, "cond": None},
    0x6cc2: {"kind": 'mem', "py": 'r[0] = s16(_rdw(ram, 0xFFFFF826, 2))', "slot_py": None, "target": None, "cond": None},
    0x6cc4: {"kind": 'mem', "py": '_wrw(ram, (r[4] + 30), 2, r[0])', "slot_py": None, "target": None, "cond": None},
    0x6cc6: {"kind": 'reg', "py": 'r[3] = 0xFFFFF824', "slot_py": None, "target": None, "cond": None},
    0x6cc8: {"kind": 'mem', "py": 'r[0] = s16(_rdw(ram, 0xFFFFF824, 2))', "slot_py": None, "target": None, "cond": None},
    0x6cca: {"kind": 'mem', "py": '_wrw(ram, (r[4] + 28), 2, r[0])', "slot_py": None, "target": None, "cond": None},
    0x6ccc: {"kind": 'reg', "py": 'r[1] = 0xFFFFF822', "slot_py": None, "target": None, "cond": None},
    0x6cce: {"kind": 'mem', "py": 'r[0] = s16(_rdw(ram, 0xFFFFF822, 2))', "slot_py": None, "target": None, "cond": None},
    0x6cd0: {"kind": 'mem', "py": '_wrw(ram, (r[4] + 26), 2, r[0])', "slot_py": None, "target": None, "cond": None},
    0x6cd2: {"kind": 'reg', "py": 'r[3] = 0xFFFFF820', "slot_py": None, "target": None, "cond": None},
    0x6cd4: {"kind": 'mem', "py": 'r[0] = s16(_rdw(ram, 0xFFFFF820, 2))', "slot_py": None, "target": None, "cond": None},
    0x6cd6: {"kind": 'mem', "py": '_wrw(ram, (r[4] + 24), 2, r[0])', "slot_py": None, "target": None, "cond": None},
    0x6cd8: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
