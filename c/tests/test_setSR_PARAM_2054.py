#!/usr/bin/env python3
"""Differential test for setSR_PARAM (0x2054) — v3 lift (branches + delay slots), 16 bytes.
...
Run from repo root: python3 c/tests/test_setSR_PARAM_2054.py
"""
...
ENTRY = 0x2054
RAW = bytes.fromhex("00 02 C9 F0 35 02 8D 01 24 02 65 03 00 0B 45 0E")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = None
SPAN_END = 0x2064
SENT = 0x2064     # stop-sentinel, placed past the literal pool
