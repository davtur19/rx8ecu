#!/usr/bin/env python3
"""Differential test for interrupt_state_clear (0xB7CA) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_interrupt_state_clear_b7ca.py
"""
...
ENTRY = 0xB7CA
RAW = bytes.fromhex("E3 00 D2 18 00 0B 22 30")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFA323
SPAN_END = 0xB7D2
SENT = 0xB7D2     # stop-sentinel, placed past the literal pool
...
CODE = {
    0xb7ca: {"kind": 'reg', "py": 'r[3] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0xb7cc: {"kind": 'reg', "py": 'r[2] = 0xFFFFA323', "slot_py": None, "target": None, "cond": None},
    0xb7ce: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFA323, 1, r[3])', "target": None, "cond": None},}
