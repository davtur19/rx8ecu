#!/usr/bin/env python3
"""Differential test for ram_copy_byte_29A5E (0x29A5E) — v3 lift (branches + delay slots), 10 bytes.
...
Run from repo root: python3 c/tests/test_ram_copy_byte_29A5E_29a5e.py
"""
...
CODE = {
    0x29a5e: {"kind": 'reg', "py": 'r[2] = 0xFFFFBB13', "slot_py": None, "target": None, "cond": None},
    0x29a60: {"kind": 'reg', "py": 'r[1] = 0xFFFFBB14', "slot_py": None, "target": None, "cond": None},
    0x29a62: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFBB13, 1))', "slot_py": None, "target": None, "cond": None},
    0x29a64: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBB14, 1, r[3])', "target": None, "cond": None},}
