#!/usr/bin/env python3
"""Differential test for timer_xor_shift_operation_37328 (0x37328) — v3 lift (branches + delay slots), 32 bytes.
...
Run from repo root: python3 c/tests/test_timer_xor_shift_operation_37328_37328.py
"""
...
ENTRY = 0x37328
RAW = bytes.fromhex("93 88 64 32 D5 44 61 43 62 52 60 43 22 4A 41 29 25 22 40 28 D5 41 31 0C 62 52 22 1A 00 0B 25 22")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    0x37328: {"kind": 'reg', "py": 'r[3] = 0xFFFFF430', "slot_py": None, "target": None, "cond": None},
    0x3732a: {"kind": 'mem', "py": 'r[4] = _rdw(ram, 0xFFFFF430, 4)', "slot_py": None, "target": None, "cond": None},
    0x3732c: {"kind": 'reg', "py": 'r[5] = 0xFFFFC2DC', "slot_py": None, "target": None, "cond": None},
    0x3732e: {"kind": 'reg', "py": 'r[1] = r[4]', "slot_py": None, "target": None, "cond": None},
    0x37330: {"kind": 'mem', "py": 'r[2] = _rdw(ram, 0xFFFFC2DC, 4)', "slot_py": None, "target": None, "cond": None},
    0x37332: {"kind": 'reg', "py": 'r[0] = r[4]', "slot_py": None, "target": None, "cond": None},
    0x37334: {"kind": 'reg', "py": 'r[2] = (r[2] ^ r[4]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x37336: {"kind": 'reg', "py": 'r[1] = (r[1] >> 16) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x37338: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC2DC, 4, r[2])', "slot_py": None, "target": None, "cond": None},
    0x3733a: {"kind": 'reg', "py": 'r[0] = (r[0] << 16) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x3733c: {"kind": 'reg', "py": 'r[5] = 0xFFFFC2E0', "slot_py": None, "target": None, "cond": None},
    0x3733e: {"kind": 'reg', "py": 'r[1] = (r[1] + r[0]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x37340: {"kind": 'mem', "py": 'r[2] = _rdw(ram, 0xFFFFC2E0, 4)', "slot_py": None, "target": None, "cond": None},
    0x37342: {"kind": 'reg', "py": 'r[2] = (r[2] ^ r[1]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x37344: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFC2E0, 4, r[2])', "target": None, "cond": None},}
