#!/usr/bin/env python3
"""Differential test for setEngineLoadsPrevLoop (0x34A30) — v3 lift + v4 FPU, 26 bytes.
...
Run from repo root: python3 c/tests/test_setEngineLoadsPrevLoop_34a30.py
"""
...
ENTRY = 0x34A30
RAW = bytes.fromhex("93 79 F5 38 92 78 F4 28 D1 3F F1 4A D3 3F F3 4A D2 3F F2 5A D1 3F 00 0B F1 5A")
SEED = 43
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFC1A8
SPAN_END = 0x34A4A
SENT = 0x34A4A     # stop-sentinel, placed past the literal pool
