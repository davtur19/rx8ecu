#!/usr/bin/env python3
"""Differential test for caller_69E2 (entry 0x69E2) — v8 ST caller (CFG), 70 bytes.
...
Run: python3 test_caller_69E2.py
"""
...
CODE = {
    0x69e2: {"kind": 'st', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x69e4: {"kind": 'reg', "py": 'r[5] = 0x000000E0', "slot_py": None, "target": None, "cond": None},
    0x69e6: {"kind": 'reg', "py": 'r[15] = (r[15] + s8(0xFC)) & 0xFFFFFFFF\nsp = (sp + s8(0xFC)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x69e8: {"kind": 'reg', "py": 'r[3] = 0x00002054', "slot_py": None, "target": None, "cond": None},
    0x69ea: {"kind": "call", "py": None, "slot_py": 'r[4] = sp', "target": 0x2054, "ret_pc": 0x69ee, "set_pr": True, "cond": None},
    0x69ee: {"kind": 'reg', "py": 'r[3] = 0x00002064', "slot_py": None, "target": None, "cond": None},
    0x69f0: {"kind": "call", "py": None, "slot_py": 'r[4] = _rdw(ram, sp, 4)', "target": 0x2064, "ret_pc": 0x69f4, "set_pr": True, "cond": None},
    0x69f4: {"kind": 'reg', "py": 'r[15] = (r[15] + s8(0x04)) & 0xFFFFFFFF\nsp = (sp + s8(0x04)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x69f6: {"kind": 'st', "py": 'pr = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x69f8: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None, },
    0x69fc: {"kind": 'fpu', "py": 'fr[8] = bits2f(_rdw(ram, r[1], 4))\nr[1] = (r[1] + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x69fe: {"kind": 'fpu', "py": 'fr[8] = bits2f(_rdw(ram, r[1], 4))', "slot_py": None, "target": None, "cond": None},
    0x6a00: {"kind": 'fpu', "py": 'fr[8] = bits2f(_rdw(ram, 0x00002064, 4))', "slot_py": None, "target": None, "cond": None},
    0x6a02: {"kind": 'fpu', "py": 'fr[8] = bits2f(_rdw(ram, r[5], 4))', "slot_py": None, "target": None, "cond": None},
    0x6a08: {"kind": 'fpu', "py": 'fr[8] = ts(fr[8] + fr[0])', "slot_py": None, "target": None, "cond": None},
    0x6a0a: {"kind": 'fpu', "py": 'fr[8] = ts(fr[8] * fr[0])', "slot_py": None, "target": None, "cond": None},
    0x6a0c: {"kind": 'fpu', "py": 'T = 1 if fr[8] == fr[0] else 0', "slot_py": None, "target": None, "cond": None},
    0x6a12: {"kind": 'reg', "py": 'sp = 0x00006040', "slot_py": None, "target": None, "cond": None},
    0x6a16: {"kind": 'reg', "py": 'sp = 0xFFFF8D08', "slot_py": None, "target": None, "cond": None},
    0x6a1a: {"kind": 'reg', "py": 'sp = 0xFFFF8D08', "slot_py": None, "target": None, "cond": None},
    0x6a1e: {"kind": 'reg', "py": 'r[14] = 0xFFFF8146', "slot_py": None, "target": None, "cond": None},
