#!/usr/bin/env python3
"""Differential test for fault_flag_byte_copy_cca5_cca9 (0x49DAC) — v3 lift (branches + delay slots), 10 bytes.
...
Run from repo root: python3 c/tests/test_fault_flag_byte_copy_cca5_cca9_49dac.py
"""
...
ENTRY = 0x49DAC
RAW = bytes.fromhex("92 79 63 20 D1 41 00 0B 21 30")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCCA9
SPAN_END = 0x49DB6
SENT = 0x49DB6     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x49dac: {"kind": 'reg', "py": 'r[2] = 0xFFFFCCA5', "slot_py": None, "target": None, "cond": None},
    0x49dae: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFCCA5, 1))', "slot_py": None, "target": None, "cond": None},
    0x49db0: {"kind": 'reg', "py": 'r[1] = 0xFFFFCCA9', "slot_py": None, "target": None, "cond": None},
    0x49db2: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFCCA9, 1, r[3])', "target": None, "cond": None},}
