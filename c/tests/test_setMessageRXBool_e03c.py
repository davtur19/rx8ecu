#!/usr/bin/env python3
"""Differential test for setMessageRXBool (0xE03C) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_setMessageRXBool_e03c.py
"""
...
ENTRY = 0xE03C
RAW = bytes.fromhex("91 0E E2 01 00 0B 21 20")
SEED = 0
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFA405
SPAN_END = 0xE044
SENT = 0xE044     # stop-sentinel, placed past the literal pool
...
CODE = {
    0xe03c: {"kind": 'reg', "py": 'r[1] = 0xFFFFA405', "slot_py": None, "target": None, "cond": None},
    0xe03e: {"kind": 'reg', "py": 'r[2] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0xe040: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFA405, 1, r[2])', "target": None, "cond": None},}
