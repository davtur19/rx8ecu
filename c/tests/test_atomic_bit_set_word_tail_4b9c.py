#!/usr/bin/env python3
"""Differential test for atomic_bit_set_word_tail (0x4B9C) — v3 lift (branches + delay slots), 28 bytes.
...
Run from repo root: python3 c/tests/test_atomic_bit_set_word_tail_4b9c.py
"""
...
ENTRY = 0x4B9C
RAW = bytes.fromhex("23 5B 24 31 00 0B 42 0E 63 40 66 6D 26 68 8B 03 65 57 23 59 00 0B 24 30 23 5B 24 30")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = None
SPAN_END = 0x4BB8
SENT = 0x4BB8     # stop-sentinel, placed past the literal pool
