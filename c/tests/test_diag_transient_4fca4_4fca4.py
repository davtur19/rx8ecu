#!/usr/bin/env python3
"""Differential test for diag_transient_4fca4 (0x4FCA4) — v3 lift (branches + delay slots), 34 bytes.
...
Run from repo root: python3 c/tests/test_diag_transient_4fca4_4fca4.py
"""
...
ENTRY = 0x4FCA4
RAW = bytes.fromhex("91 23 64 10 60 4C 88 01 8F 08 00 09 D3 18 62 30 22 28 8F 03 00 09 E1 00 90 13 20 11 D3 14 00 0B 23 40")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    0x4fca4: {"kind": 'reg', "py": 'r[1] = 0xFFFFCFFA', "slot_py": None, "target": None, "cond": None},
    0x4fca6: {"kind": 'mem', "py": 'r[4] = s8(_rdw(ram, 0xFFFFCFFA, 1))', "slot_py": None, "target": None, "cond": None},
    0x4fca8: {"kind": 'reg', "py": 'r[0] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x4fcaa: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x4fcac: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4fcc0, "cond": 'notT'},
    0x4fcb0: {"kind": 'reg', "py": 'r[3] = 0xFFFFD013', "slot_py": None, "target": None, "cond": None},
    0x4fcb2: {"kind": 'mem', "py": 'r[2] = s8(_rdw(ram, 0xFFFFD013, 1))', "slot_py": None, "target": None, "cond": None},
    0x4fcb4: {"kind": 'reg', "py": 'T = 1 if (r[2] & r[2]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x4fcb6: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4fcc0, "cond": 'notT'},
    0x4fcba: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x4fcbc: {"kind": 'reg', "py": 'r[0] = 0xFFFFCFE6', "slot_py": None, "target": None, "cond": None},
    0x4fcbe: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCFE6, 2, r[1])', "slot_py": None, "target": None, "cond": None},
    0x4fcc0: {"kind": 'reg', "py": 'r[3] = 0xFFFFD013', "slot_py": None, "target": None, "cond": None},
    0x4fcc2: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFD013, 1, r[4])', "target": None, "cond": None},}
