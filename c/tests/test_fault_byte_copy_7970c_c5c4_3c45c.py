#!/usr/bin/env python3
"""Differential test for fault_byte_copy_7970c_c5c4 (0x3C45C) — v3 lift (branches + delay slots), 10 bytes.
...
Run from repo root: python3 c/tests/test_fault_byte_copy_7970c_c5c4_3c45c.py
"""
...
ENTRY = 0x3C45C
RAW = bytes.fromhex("D2 2F 63 20 91 55 00 0B 21 30")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFC5C4
SPAN_END = 0x3C466
SENT = 0x3C466     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x3c45c: {"kind": 'reg', "py": 'r[2] = 0x0007970C', "slot_py": None, "target": None, "cond": None},
    0x3c45e: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0x0007970C, 1))', "slot_py": None, "target": None, "cond": None},
    0x3c460: {"kind": 'reg', "py": 'r[1] = 0xFFFFC5C4', "slot_py": None, "target": None, "cond": None},
    0x3c462: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFC5C4, 1, r[3])', "target": None, "cond": None},}
