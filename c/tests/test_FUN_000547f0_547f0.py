#!/usr/bin/env python3
"""Differential test for FUN_000547f0 (0x547F0) — v3 lift (branches + delay slots), 10 bytes.
...
Run from repo root: python3 c/tests/test_FUN_000547f0_547f0.py
"""
...
ENTRY = 0x547F0
RAW = bytes.fromhex("00 09 92 47 22 70 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    0x547f0: {"kind": 'reg', "py": None, "slot_py": None, "target": None, "cond": None},
