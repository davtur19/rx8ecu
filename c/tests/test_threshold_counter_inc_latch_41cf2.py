#!/usr/bin/env python3
"""Differential test for threshold_counter_inc_latch (0x41CF2) — pure straight-line lift, 8 bytes.
...
Run from repo root: python3 c/tests/test_threshold_counter_inc_latch_41cf2.py
"""
...
ENTRY = 0x41CF2
RAW = bytes.fromhex("00 09 D2 19 E3 00 D0 17")
SEED = 42
N = 2000
