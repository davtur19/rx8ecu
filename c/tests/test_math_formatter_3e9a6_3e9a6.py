#!/usr/bin/env python3
"""Differential test for math_formatter_3e9a6 (0x3E9A6) — v3 lift (branches + delay slots), 32 bytes.
...
Run from repo root: python3 c/tests/test_math_formatter_3e9a6_3e9a6.py
"""
...
CODE = {
    0x3e9a6: {"kind": 'reg', "py": 'r[4] = 0xFFFFC6A7', "slot_py": None, "target": None, "cond": None},
    0x3e9a8: {"kind": 'reg', "py": 'r[3] = 0xFFFF9ECE', "slot_py": None, "target": None, "cond": None},
    0x3e9aa: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFF9ECE, 1))', "slot_py": None, "target": None, "cond": None},
    0x3e9ac: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x3e9ae: {"kind": 'reg', "py": 'T = 1 if (r[0] & 0x04) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x3e9b0: {"kind": 'reg', "py": 'r[0] = T;', "slot_py": None, "target": None, "cond": None},
    0x3e9b2: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x3e9b4: {"kind": "branch", "py": None, "slot_py": '', "target": 0x3e9be, "cond": 'notT'},
    0x3e9b8: {"kind": 'reg', "py": 'r[3] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x3e9ba: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFC6A7, 1, r[3])', "target": 0x3e9c2, "cond": 'always'},
    0x3e9be: {"kind": 'reg', "py": 'r[1] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x3e9c0: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC6A7, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x3e9c2: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
