#!/usr/bin/env python3
"""Differential test for monitor_state_word_copy (0x4D506) — v3 lift (branches + delay slots), 44 bytes.
...
Run from repo root: python3 c/tests/test_monitor_state_word_copy_4d506.py
"""
...
ENTRY = 0x4D506
RAW = bytes.fromhex("90 33 60 00 C8 80 04 29 74 FF 64 4B 60 4C 88 01 8F 09 00 09 D3 1F 62 30 22 28 8F 04 00 09 91 25 60 11 93 24 23 01 D2 1A 00 0B 22 40")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCE19
SPAN_END = 0x4D532
SENT = 0x4D532     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x4d506: {"kind": 'reg', "py": 'r[0] = 0xFFFFCDB2', "slot_py": None, "target": None, "cond": None},
    0x4d508: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCDB2, 1))', "slot_py": None, "target": None, "cond": None},
    0x4d50a: {"kind": 'reg', "py": 'T = 1 if (r[0] & 0x80) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x4d50c: {"kind": 'reg', "py": 'r[4] = T;', "slot_py": None, "target": None, "cond": None},
    0x4d50e: {"kind": 'reg', "py": 'r[4] = (r[4] + s8(0xFF)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x4d510: {"kind": 'reg', "py": 'r[4] = (-r[4]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x4d512: {"kind": 'reg', "py": 'r[0] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x4d514: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x4d516: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4d52c, "cond": 'notT'},
    0x4d51a: {"kind": 'reg', "py": 'r[3] = 0xFFFFCE19', "slot_py": None, "target": None, "cond": None},
    0x4d51c: {"kind": 'mem', "py": 'r[2] = s8(_rdw(ram, 0xFFFFCE19, 1))', "slot_py": None, "target": None, "cond": None},
    0x4d51e: {"kind": 'reg', "py": 'T = 1 if (r[2] & r[2]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x4d520: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4d52c, "cond": 'notT'},
    0x4d524: {"kind": 'reg', "py": 'r[1] = 0xFFFFA426', "slot_py": None, "target": None, "cond": None},
    0x4d526: {"kind": 'mem', "py": 'r[0] = s16(_rdw(ram, 0xFFFFA426, 2))', "slot_py": None, "target": None, "cond": None},
    0x4d528: {"kind": 'reg', "py": 'r[3] = 0xFFFFCE14', "slot_py": None, "target": None, "cond": None},
    0x4d52a: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCE14, 2, r[0])', "slot_py": None, "target": None, "cond": None},
    0x4d52c: {"kind": 'reg', "py": 'r[2] = 0xFFFFCE19', "slot_py": None, "target": None, "cond": None},
    0x4d52e: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFCE19, 1, r[4])', "target": None, "cond": None},}
