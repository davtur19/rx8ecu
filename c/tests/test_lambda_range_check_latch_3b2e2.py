#!/usr/bin/env python3
"""Differential test for lambda_range_check_latch (0x3B2E2) — v3 lift + v4 FPU, 98 bytes.
...
Run from repo root: python3 c/tests/test_lambda_range_check_latch_3b2e2.py
"""
...
RAM_MAX = 0xFFFFCFD9
SPAN_END = 0x3B344
SENT = 0x3B344     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x3b2e2: {"kind": 'reg', "py": 'r[2] = 0xFFFFB34C', "slot_py": None, "target": None, "cond": None},
    0x3b2e4: {"kind": 'reg', "py": 'r[0] = 0x0003B3B4', "slot_py": None, "target": None, "cond": None},
    0x3b2e6: {"kind": 'fpu', "py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFB34C, 4))', "slot_py": None, "target": None, "cond": None},
    0x3b2e8: {"kind": 'fpu', "py": 'fr[5] = bits2f(_rdw(ram, 0x0003B3B4, 4))', "slot_py": None, "target": None, "cond": None},
    0x3b2ea: {"kind": 'reg', "py": 'r[6] = 0xFFFFC587', "slot_py": None, "target": None, "cond": None},
    0x3b2ec: {"kind": 'reg', "py": 'r[5] = 0xFFFFC57C', "slot_py": None, "target": None, "cond": None},
    0x3b2ee: {"kind": 'reg', "py": 'r[3] = 0xFFFFCFD9', "slot_py": None, "target": None, "cond": None},
    0x3b2f0: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCFD9, 1))', "slot_py": None, "target": None, "cond": None},
    0x3b2f2: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x3b2f4: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x3b2f6: {"kind": "branch", "py": None, "slot_py": 'r[4] = s8(0x00)', "target": 0x3b316, "cond": 'T'},
    0x3b2fa: {"kind": 'reg', "py": 'r[1] = 0xFFFFCFB9', "slot_py": None, "target": None, "cond": None},
    0x3b2fc: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCFB9, 1))', "slot_py": None, "target": None, "cond": None},
    0x3b2fe: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x3b300: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x3b302: {"kind": "branch", "py": None, "slot_py": '', "target": 0x3b316, "cond": 'T'},
    0x3b306: {"kind": 'reg', "py": 'r[0] = 0x0003B3B8', "slot_py": None, "target": None, "cond": None},
    0x3b308: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x0003B3B8, 4))', "slot_py": None, "target": None, "cond": None},
    0x3b30a: {"kind": 'fpu', "py": 'T = 1 if fr[3] > fr[4] else 0', "slot_py": None, "target": None, "cond": None},
    0x3b30c: {"kind": "branch", "py": None, "slot_py": '', "target": 0x3b316, "cond": 'T'},
    0x3b310: {"kind": 'fpu', "py": 'T = 1 if fr[4] > fr[5] else 0', "slot_py": None, "target": None, "cond": None},
    0x3b312: {"kind": "branch", "py": None, "slot_py": '', "target": 0x3b31a, "cond": 'notT'},
    0x3b316: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFC587, 1, r[4])', "target": 0x3b32a, "cond": 'always'},
    0x3b31a: {"kind": 'reg', "py": 'r[3] = 0xFFFFC583', "slot_py": None, "target": None, "cond": None},
    0x3b31c: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFC583, 1))', "slot_py": None, "target": None, "cond": None},
    0x3b31e: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x3b320: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x3b322: {"kind": "branch", "py": None, "slot_py": '', "target": 0x3b32e, "cond": 'notT'},
    0x3b326: {"kind": 'reg', "py": 'r[1] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x3b328: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC587, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x3b32a: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFC57C, 1, r[4])', "target": 0x3b340, "cond": 'always'},
    0x3b32e: {"kind": 'mem', "py": '_wrw(ram, r[6], 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x3b330: {"kind": 'mem', "py": 'r[4] = s8(_rdw(ram, 0xFFFFC57C, 1))', "slot_py": None, "target": None, "cond": None},
    0x3b332: {"kind": 'reg', "py": 'r[1] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x3b334: {"kind": 'reg', "py": 'r[2] = 0x000000FF', "slot_py": None, "target": None, "cond": None},
    0x3b336: {"kind": 'reg', "py": 'T = 1 if s32(r[1]) >= s32(r[2]) else 0', "slot_py": None, "target": None, "cond": None},
    0x3b338: {"kind": "branch", "py": None, "slot_py": '', "target": 0x3b340, "cond": 'T'},
    0x3b33c: {"kind": 'reg', "py": 'r[4] = (r[4] + s8(0x01)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x3b33e: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC57C, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x3b340: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
