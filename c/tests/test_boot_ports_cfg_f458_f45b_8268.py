#!/usr/bin/env python3
"""Differential test for boot_ports_cfg_f458_f45b (0x8268) — v3 lift (branches + delay slots), 36 bytes.
...
Run from repo root: python3 c/tests/test_boot_ports_cfg_f458_f45b_8268.py
"""
...
ENTRY = 0x8268
RAW = bytes.fromhex("24 01 72 F2 60 41 20 29 24 01 71 E4 60 41 20 19 24 01 4F 26 68 F6 69 F6 6A F6 6B F6 6C F6 6D F6 00 0B 6E F6")
SEED = 0
N = 2000
MAXSTEPS = 100000
STACK_BASE = 0xFFFFD000
STACK_TOP = STACK_BASE + 0x400
STACK_OFFS = (0x400, 0x404, 0x408, 0x40C, 0x410, 0x414, 0x418, 0x41C)
SEED_OFFS = (0x400,)   # lds.l pr/macl/mach slots seeded with the return sentinel
RAM_MIN = None
RAM_MAX = None
SPAN_END = 0x828C
SENT = 0x828C     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x8268: {"kind": 'mem', "py": '_wrw(ram, r[4], 2, r[0])', "slot_py": None, "target": None, "cond": None},
    0x826a: {"kind": 'reg', "py": 'r[2] = (r[2] + s8(0xF2)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x826c: {"kind": 'mem', "py": 'r[0] = s16(_rdw(ram, r[4], 2))', "slot_py": None, "target": None, "cond": None},
    0x826e: {"kind": 'reg', "py": 'r[0] = (r[0] & r[2]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x8270: {"kind": 'mem', "py": '_wrw(ram, r[4], 2, r[0])', "slot_py": None, "target": None, "cond": None},
    0x8272: {"kind": 'reg', "py": 'r[1] = (r[1] + s8(0xE4)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x8274: {"kind": 'mem', "py": 'r[0] = s16(_rdw(ram, r[4], 2))', "slot_py": None, "target": None, "cond": None},
    0x8276: {"kind": 'reg', "py": 'r[0] = (r[0] & r[1]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x8278: {"kind": 'mem', "py": '_wrw(ram, r[4], 2, r[0])', "slot_py": None, "target": None, "cond": None},
    0x827a: {"kind": 'mem', "py": 'pr = _rdw(ram, STACK_BASE + 0x400, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x827c: {"kind": 'mem', "py": 'r[8] = _rdw(ram, STACK_BASE + 0x404, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x827e: {"kind": 'mem', "py": 'r[9] = _rdw(ram, STACK_BASE + 0x408, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x8280: {"kind": 'mem', "py": 'r[10] = _rdw(ram, STACK_BASE + 0x40C, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x8282: {"kind": 'mem', "py": 'r[11] = _rdw(ram, STACK_BASE + 0x410, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x8284: {"kind": 'mem', "py": 'r[12] = _rdw(ram, STACK_BASE + 0x414, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x8286: {"kind": 'mem', "py": 'r[13] = _rdw(ram, STACK_BASE + 0x418, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x8288: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, STACK_BASE + 0x41C, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},}
