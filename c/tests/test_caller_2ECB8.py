#!/usr/bin/env python3
"""Differential test for caller_2ECB8 (entry 0x2ECB8) — v8 ST caller (CFG), 64 bytes.
...
Run: python3 test_caller_2ECB8.py
"""
...
CODE = {
    0x2ecb8: {"kind": 'st', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x2ecba: {"kind": 'reg', "py": 'r[15] = (r[15] + s8(0xFC)) & 0xFFFFFFFF\nsp = (sp + s8(0xFC)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x2ecbc: {"kind": 'reg', "py": 'r[5] = 0x000000E0', "slot_py": None, "target": None, "cond": None},
    0x2ecbe: {"kind": 'reg', "py": 'r[3] = 0x00002054', "slot_py": None, "target": None, "cond": None},
    0x2ecc0: {"kind": "call", "py": None, "slot_py": 'r[4] = r[15]', "target": 0x2054, "ret_pc": 0x2ecc4, "set_pr": True, "cond": None},
    0x2ecc4: {"kind": 'reg', "py": 'r[3] = 0xFFFFBD88', "slot_py": None, "target": None, "cond": None},
    0x2ecc6: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, r[3], 1))', "slot_py": None, "target": None, "cond": None},
    0x2ecc8: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x2ecca: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x2eccc: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2ece0, "cond": 'notT'},
    0x2ecd0: {"kind": 'reg', "py": 'r[4] = 0xFFFFF76C', "slot_py": None, "target": None, "cond": None},
    0x2ecd2: {"kind": 'reg', "py": 'r[6] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x2ecd4: {"kind": 'reg', "py": 'r[1] = 0x00004BBC', "slot_py": None, "target": None, "cond": None},
    0x2ecd6: {"kind": 'reg', "py": 'r[5] = r[6]', "slot_py": None, "target": None, "cond": None},
    0x2ecd8: {"kind": "call", "py": None, "slot_py": 'r[5] = (r[5] + s8(0x7F)) & 0xFFFFFFFF', "target": 0x4bbc, "ret_pc": 0x2ecdc, "set_pr": True, "cond": None},
    0x2ecdc: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2ecea, "cond": 'always'},
    0x2ece0: {"kind": 'reg', "py": 'r[5] = 0x00000080', "slot_py": None, "target": None, "cond": None},
    0x2ece2: {"kind": 'reg', "py": 'r[4] = 0xFFFFF76C', "slot_py": None, "target": None, "cond": None},
    0x2ece4: {"kind": 'reg', "py": 'r[2] = 0x00004BBC', "slot_py": None, "target": None, "cond": None},
    0x2ece6: {"kind": "call", "py": None, "slot_py": 'r[6] = s8(0x00)', "target": 0x4bbc, "ret_pc": 0x2ecea, "set_pr": True, "cond": None},
    0x2ecea: {"kind": 'reg', "py": 'r[3] = 0x00002064', "slot_py": None, "target": None, "cond": None},
    0x2ecec: {"kind": "call", "py": None, "slot_py": 'r[4] = _rdw(ram, sp, 4)', "target": 0x2064, "ret_pc": 0x2ecf0, "set_pr": True, "cond": None},
    0x2ecf0: {"kind": 'reg', "py": 'r[15] = (r[15] + s8(0x04)) & 0xFFFFFFFF\nsp = (sp + s8(0x04)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x2ecf2: {"kind": 'st', "py": 'pr = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x2ecf4: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},
