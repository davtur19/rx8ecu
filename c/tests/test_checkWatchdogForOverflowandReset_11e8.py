#!/usr/bin/env python3
"""Differential test for checkWatchdogForOverflowandReset (0x11E8) — v3 lift (branches + delay slots), 46 bytes.
...
Run from repo root: python3 c/tests/test_checkWatchdogForOverflowandReset_11e8.py
"""
...
CODE = {
    0x11e8: {"kind": 'reg', "py": 'r[5] = 0xFFFFEC10', "slot_py": None, "target": None, "cond": None},
    0x11ea: {"kind": 'reg', "py": 'r[4] = 0xFFFFDFA0', "slot_py": None, "target": None, "cond": None},
    0x11ec: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFEC10, 1))', "slot_py": None, "target": None, "cond": None},
    0x11ee: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x11f0: {"kind": 'reg', "py": 'T = 1 if (r[0] & 0x80) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x11f2: {"kind": "branch", "py": None, "slot_py": None, "target": 0x1212, "cond": 'T'},
    0x11f4: {"kind": 'reg', "py": 'r[2] = 0x0000A53C', "slot_py": None, "target": None, "cond": None},
    0x11f6: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFEC10, 2, r[2])', "slot_py": None, "target": None, "cond": None},
    0x11f8: {"kind": 'reg', "py": 'r[3] = 0xFFFFF738', "slot_py": None, "target": None, "cond": None},
    0x11fa: {"kind": 'reg', "py": 'r[2] = 0x00008000', "slot_py": None, "target": None, "cond": None},
    0x11fc: {"kind": 'mem', "py": 'r[1] = s16(_rdw(ram, 0xFFFFF738, 2))', "slot_py": None, "target": None, "cond": None},
    0x11fe: {"kind": 'reg', "py": 'r[1] = (r[1] ^ r[2]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x1200: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFF738, 2, r[1])', "slot_py": None, "target": None, "cond": None},
    0x1202: {"kind": 'mem', "py": 'r[3] = s16(_rdw(ram, 0xFFFFDFA0, 2))', "slot_py": None, "target": None, "cond": None},
    0x1204: {"kind": 'reg', "py": 'r[1] = 0x0000FFFF', "slot_py": None, "target": None, "cond": None},
    0x1206: {"kind": 'reg', "py": 'r[3] = r[3] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x1208: {"kind": 'reg', "py": 'T = 1 if s32(r[3]) >= s32(r[1]) else 0', "slot_py": None, "target": None, "cond": None},
    0x120a: {"kind": "branch", "py": None, "slot_py": None, "target": 0x1212, "cond": 'T'},
    0x120c: {"kind": 'mem', "py": 'r[0] = s16(_rdw(ram, 0xFFFFDFA0, 2))', "slot_py": None, "target": None, "cond": None},
    0x120e: {"kind": 'reg', "py": 'r[0] = (r[0] + s8(0x01)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x1210: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFDFA0, 2, r[0])', "slot_py": None, "target": None, "cond": None},
    0x1212: {"kind": "ret", "py": None, "slot_py": 'r[0] = s16(_rdw(ram, 0xFFFFDFA0, 2))', "target": None, "cond": None},}
