#!/usr/bin/env python3
"""Differential test for alternatorStuff (0x26044) — v3 lift + v4 FPU, 92 bytes.
...
Run from repo root: python3 c/tests/test_alternatorStuff_26044.py
"""
...
ENTRY = 0x26044
RAW = bytes.fromhex("2F E6 2F D6 2F C6 2F B6 2F A6 EA 01 2F 96 4F 22 91 52 F4 18 93 51 64 30 D2 2E F6 28 D1 2E F5 6C 99 4C F3 18 F5 31 F6 45 8D 02 EE 00 A0 04 29 A0 F5 45 8F 01 00 09 29 E0 D3 28 F3 38 92 3F F2 28 F2 35 8D 09 00 09 D1 26 90 3A F1 18 F0 08 F0 15 8D 02 00 09 A0 01 65 A3 65 E3 6C 5C")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFB694
SPAN_END = 0x260A0
SENT = 0x260A0     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x26044: {"kind": 'mem', "py": 'local[0x3FC] = r[14]\n_wrw(ram, STACK_BASE + 0x3FC, 4, r[14])\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x26046: {"kind": 'mem', "py": 'local[0x3F8] = r[13]\n_wrw(ram, STACK_BASE + 0x3F8, 4, r[13])\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x26048: {"kind": 'mem', "py": 'local[0x3F4] = r[12]\n_wrw(ram, STACK_BASE + 0x3F4, 4, r[12])\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x2604a: {"kind": 'mem', "py": 'local[0x3F0] = r[11]\n_wrw(ram, STACK_BASE + 0x3F0, 4, r[11])\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x2604c: {"kind": 'mem', "py": 'local[0x3EC] = r[10]\n_wrw(ram, STACK_BASE + 0x3EC, 4, r[10])\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x2604e: {"kind": 'reg', "py": 'r[10] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x26050: {"kind": 'mem', "py": 'local[0x3E8] = r[9]\n_wrw(ram, STACK_BASE + 0x3E8, 4, r[9])\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x26052: {"kind": 'mem', "py": 'local[0x3E4] = pr\n_wrw(ram, STACK_BASE + 0x3E4, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x26054: {"kind": 'reg', "py": 'r[1] = 0xFFFFB5DC', "slot_py": None, "target": None, "cond": None},
    0x26056: {"kind": 'fpu', "py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFB5DC, 4))', "slot_py": None, "target": None, "cond": None},
    0x26058: {"kind": 'reg', "py": 'r[3] = 0xFFFFA428', "slot_py": None, "target": None, "cond": None},
    0x2605a: {"kind": 'mem', "py": 'r[4] = s8(_rdw(ram, 0xFFFFA428, 1))', "slot_py": None, "target": None, "cond": None},
    0x2605c: {"kind": 'reg', "py": 'r[2] = 0x000749FC', "slot_py": None, "target": None, "cond": None},
    0x2605e: {"kind": 'fpu', "py": 'fr[6] = bits2f(_rdw(ram, 0x000749FC, 4))', "slot_py": None, "target": None, "cond": None},
    0x26060: {"kind": 'reg', "py": 'r[1] = 0x00074A00', "slot_py": None, "target": None, "cond": None},
    0x26062: {"kind": 'fpu', "py": 'fr[5] = fr[6]', "slot_py": None, "target": None, "cond": None},
    0x26064: {"kind": 'reg', "py": 'r[9] = 0xFFFFB681', "slot_py": None, "target": None, "cond": None},
    0x26066: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x00074A00, 4))', "slot_py": None, "target": None, "cond": None},
    0x26068: {"kind": 'fpu', "py": 'fr[5] = ts(fr[5] - fr[3])', "slot_py": None, "target": None, "cond": None},
    0x2606a: {"kind": 'fpu', "py": 'T = 1 if fr[6] > fr[4] else 0', "slot_py": None, "target": None, "cond": None},
    0x2606c: {"kind": "branch", "py": None, "slot_py": 'r[14] = s8(0x00)', "target": 0x26074, "cond": 'T'},
    0x26070: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFB681, 1, r[10])', "target": 0x2607c, "cond": 'always'},
    0x26074: {"kind": 'fpu', "py": 'T = 1 if fr[5] > fr[4] else 0', "slot_py": None, "target": None, "cond": None},
    0x26076: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2607c, "cond": 'notT'},
    0x2607a: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFB681, 1, r[14])', "slot_py": None, "target": None, "cond": None},
    0x2607c: {"kind": 'reg', "py": 'r[3] = 0x00074A04', "slot_py": None, "target": None, "cond": None},
    0x2607e: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x00074A04, 4))', "slot_py": None, "target": None, "cond": None},
    0x26080: {"kind": 'reg', "py": 'r[2] = 0xFFFFB690', "slot_py": None, "target": None, "cond": None},
    0x26082: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0xFFFFB690, 4))', "slot_py": None, "target": None, "cond": None},
    0x26084: {"kind": 'fpu', "py": 'T = 1 if fr[2] > fr[3] else 0', "slot_py": None, "target": None, "cond": None},
    0x26086: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2609c, "cond": 'T'},
    0x2608a: {"kind": 'reg', "py": 'r[1] = 0x00074A08', "slot_py": None, "target": None, "cond": None},
    0x2608c: {"kind": 'reg', "py": 'r[0] = 0xFFFFB694', "slot_py": None, "target": None, "cond": None},
    0x2608e: {"kind": 'fpu', "py": 'fr[1] = bits2f(_rdw(ram, 0x00074A08, 4))', "slot_py": None, "target": None, "cond": None},
    0x26090: {"kind": 'fpu', "py": 'fr[0] = bits2f(_rdw(ram, 0xFFFFB694, 4))', "slot_py": None, "target": None, "cond": None},
    0x26092: {"kind": 'fpu', "py": 'T = 1 if fr[0] > fr[1] else 0', "slot_py": None, "target": None, "cond": None},
    0x26094: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2609c, "cond": 'T'},
    0x26098: {"kind": "branch", "py": None, "slot_py": 'r[5] = r[10]', "target": 0x2609e, "cond": 'always'},
    0x2609c: {"kind": 'reg', "py": 'r[5] = r[14]', "slot_py": None, "target": None, "cond": None},
    0x2609e: {"kind": 'reg', "py": 'r[12] = r[5] & 0xFF', "slot_py": None, "target": None, "cond": None},}
