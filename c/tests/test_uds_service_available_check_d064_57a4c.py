#!/usr/bin/env python3
"""Differential test for uds_service_available_check_d064 (0x57A4C) — v3 lift (branches + delay slots), 80 bytes.
...
Run from repo root: python3 c/tests/test_uds_service_available_check_d064_57a4c.py
"""
...
ENTRY = 0x57A4C
RAW = bytes.fromhex("93 7B 65 4C 67 30 67 7C 35 70 8F 1E E6 00 27 78 8D 1B 00 09 60 53 88 02 8F 05 00 09 92 6E 61 20 21 18 8D 12 00 09 93 6A 35 30 8F 05 00 09 92 67 61 20 21 18 8D 09 00 09 60 53 88 0F 8F 06 00 09 93 5F 62 30 22 28 8F 01 00 09 E6 01 00 0B 60 63")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFD083
SPAN_END = 0x57A9C
SENT = 0x57A9C     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x57a4c: {"kind": 'reg', "py": 'r[3] = 0xFFFFD064', "slot_py": None, "target": None, "cond": None},
    0x57a4e: {"kind": 'reg', "py": 'r[5] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x57a50: {"kind": 'mem', "py": 'r[7] = s8(_rdw(ram, 0xFFFFD064, 1))', "slot_py": None, "target": None, "cond": None},
    0x57a52: {"kind": 'reg', "py": 'r[7] = r[7] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x57a54: {"kind": 'reg', "py": 'T = 1 if r[5] == r[7] else 0', "slot_py": None, "target": None, "cond": None},
    0x57a56: {"kind": "branch", "py": None, "slot_py": 'r[6] = s8(0x00)', "target": 0x57a96, "cond": 'notT'},
    0x57a5a: {"kind": 'reg', "py": 'T = 1 if (r[7] & r[7]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x57a5c: {"kind": "branch", "py": None, "slot_py": '', "target": 0x57a96, "cond": 'T'},
    0x57a60: {"kind": 'reg', "py": 'r[0] = r[5]', "slot_py": None, "target": None, "cond": None},
    0x57a62: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x02) else 0', "slot_py": None, "target": None, "cond": None},
    0x57a64: {"kind": "branch", "py": None, "slot_py": '', "target": 0x57a72, "cond": 'notT'},
    0x57a68: {"kind": 'reg', "py": 'r[2] = 0xFFFFD075', "slot_py": None, "target": None, "cond": None},
    0x57a6a: {"kind": 'mem', "py": 'r[1] = s8(_rdw(ram, 0xFFFFD075, 1))', "slot_py": None, "target": None, "cond": None},
    0x57a6c: {"kind": 'reg', "py": 'T = 1 if (r[1] & r[1]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x57a6e: {"kind": "branch", "py": None, "slot_py": '', "target": 0x57a96, "cond": 'T'},
    0x57a72: {"kind": 'reg', "py": 'r[3] = 0x00000082', "slot_py": None, "target": None, "cond": None},
    0x57a74: {"kind": 'reg', "py": 'T = 1 if r[5] == r[3] else 0', "slot_py": None, "target": None, "cond": None},
    0x57a76: {"kind": "branch", "py": None, "slot_py": '', "target": 0x57a84, "cond": 'notT'},
    0x57a7a: {"kind": 'reg', "py": 'r[2] = 0xFFFFD07A', "slot_py": None, "target": None, "cond": None},
    0x57a7c: {"kind": 'mem', "py": 'r[1] = s8(_rdw(ram, 0xFFFFD07A, 1))', "slot_py": None, "target": None, "cond": None},
    0x57a7e: {"kind": 'reg', "py": 'T = 1 if (r[1] & r[1]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x57a80: {"kind": "branch", "py": None, "slot_py": '', "target": 0x57a96, "cond": 'T'},
    0x57a84: {"kind": 'reg', "py": 'r[0] = r[5]', "slot_py": None, "target": None, "cond": None},
    0x57a86: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x0F) else 0', "slot_py": None, "target": None, "cond": None},
    0x57a88: {"kind": "branch", "py": None, "slot_py": '', "target": 0x57a98, "cond": 'notT'},
    0x57a8c: {"kind": 'reg', "py": 'r[3] = 0xFFFFD083', "slot_py": None, "target": None, "cond": None},
    0x57a8e: {"kind": 'mem', "py": 'r[2] = s8(_rdw(ram, 0xFFFFD083, 1))', "slot_py": None, "target": None, "cond": None},
    0x57a90: {"kind": 'reg', "py": 'T = 1 if (r[2] & r[2]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x57a92: {"kind": "branch", "py": None, "slot_py": '', "target": 0x57a98, "cond": 'notT'},
    0x57a96: {"kind": 'reg', "py": 'r[6] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x57a98: {"kind": "ret", "py": None, "slot_py": 'r[0] = r[6]', "target": None, "cond": None},}
