#!/usr/bin/env python3
"""Differential test for ctrl_copy_rom_flag_to_ram_2C048 (0x2C048) — v3 lift (branches + delay slots), 10 bytes.
...
Run from repo root: python3 c/tests/test_ctrl_copy_rom_flag_to_ram_2C048_2c048.py
"""
...
ENTRY = 0x2C048
RAW = bytes.fromhex("D2 0F 63 20 91 0A 00 0B 21 30")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    0x2c048: {"kind": 'reg', "py": 'r[2] = 0x0006CF80', "slot_py": None, "target": None, "cond": None},
    0x2c04a: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0x0006CF80, 1))', "slot_py": None, "target": None, "cond": None},
    0x2c04c: {"kind": 'reg', "py": 'r[1] = 0xFFFFBC18', "slot_py": None, "target": None, "cond": None},
    0x2c04e: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBC18, 1, r[3])', "target": None, "cond": None},}
