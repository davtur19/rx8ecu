#!/usr/bin/env python3
"""Differential test for caller_4B5A8 (entry 0x4B5A8) — v8 ST caller (CFG), 54 bytes.
...
Run: python3 test_caller_4B5A8.py
"""
...
CODE = {
    0x4b5a8: {"kind": 'mem', "py": 'local[0x3FC] = r[14]\n_wrw(ram, STACK_BASE + 0x3FC, 4, r[14])\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x4b5aa: {"kind": 'st', "py": 'local[0x3F8] = pr\n_wrw(ram, STACK_BASE + 0x3F8, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x4b5ac: {"kind": 'reg', "py": 'r[14] = 0xFFFFCE02', "slot_py": None, "target": None, "cond": None},
    0x4b5ae: {"kind": 'mem', "py": 'r[4] = s16(_rdw(ram, 0xFFFFCE02, 2))', "slot_py": None, "target": None, "cond": None},
    0x4b5b0: {"kind": 'reg', "py": 'r[1] = 0x0007DADE', "slot_py": None, "target": None, "cond": None},
    0x4b5b2: {"kind": 'reg', "py": 'r[3] = r[4] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x4b5b4: {"kind": 'mem', "py": 'r[2] = s16(_rdw(ram, 0x0007DADE, 2))', "slot_py": None, "target": None, "cond": None},
    0x4b5b6: {"kind": 'reg', "py": 'r[2] = r[2] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x4b5b8: {"kind": 'reg', "py": 'T = 1 if r[3] == r[2] else 0', "slot_py": None, "target": None, "cond": None},
    0x4b5ba: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4b5ca, "cond": 'T'},
    0x4b5be: {"kind": 'reg', "py": 'r[3] = 0xFFFFD201', "slot_py": None, "target": None, "cond": None},
    0x4b5c0: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFD201, 1))', "slot_py": None, "target": None, "cond": None},
    0x4b5c2: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x4b5c4: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x4b5c6: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4b5d0, "cond": 'notT'},
    0x4b5ca: {"kind": 'reg', "py": 'r[3] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x4b5cc: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFCE02, 2, r[3])', "target": 0x4b5d8, "cond": 'always'},
    0x4b5d0: {"kind": 'reg', "py": 'r[3] = 0x00002460', "slot_py": None, "target": None, "cond": None},
    0x4b5d2: {"kind": "call", "py": None, "slot_py": 'r[5] = s8(0x01)', "target": 0x2460, "ret_pc": 0x4b5d6, "set_pr": True, "cond": None},
    0x4b5d6: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCE02, 2, r[0])', "slot_py": None, "target": None, "cond": None},
    0x4b5d8: {"kind": 'st', "py": 'pr = _rdw(ram, STACK_BASE + 0x3F8, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x4b5da: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, STACK_BASE + 0x3FC, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},
