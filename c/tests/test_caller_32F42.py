#!/usr/bin/env python3
"""Differential test for caller_32F42 (entry 0x32F42) — v8 ST caller (CFG), 30 bytes.
...
Run: python3 test_caller_32F42.py
"""
...
CODE = {
    0x32f42: {"kind": 'st', "py": 'local[0x3FC] = pr\n_wrw(ram, STACK_BASE + 0x3FC, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x32f44: {"kind": 'reg', "py": 'r[0] = 0x00032F64', "slot_py": None, "target": None, "cond": None},
    0x32f46: {"kind": 'fpu', "py": 'fr[7] = bits2f(_rdw(ram, 0x00032F64, 4))', "slot_py": None, "target": None, "cond": None},
    0x32f48: {"kind": 'reg', "py": 'r[3] = 0x00078CFC', "slot_py": None, "target": None, "cond": None},
    0x32f4a: {"kind": 'fpu', "py": 'fr[6] = bits2f(_rdw(ram, 0x00078CFC, 4))', "slot_py": None, "target": None, "cond": None},
    0x32f4c: {"kind": 'reg', "py": 'r[2] = 0xFFFFBC1C', "slot_py": None, "target": None, "cond": None},
    0x32f4e: {"kind": 'fpu', "py": 'fr[5] = bits2f(_rdw(ram, 0xFFFFBC1C, 4))', "slot_py": None, "target": None, "cond": None},
    0x32f50: {"kind": 'reg', "py": 'r[1] = 0xFFFFC008', "slot_py": None, "target": None, "cond": None},
    0x32f52: {"kind": 'reg', "py": 'r[3] = 0x000023B0', "slot_py": None, "target": None, "cond": None},
    0x32f54: {"kind": "call", "py": None, "slot_py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFC008, 4))', "target": 0x23b0, "ret_pc": 0x32f58, "set_pr": True, "cond": None},
    0x32f58: {"kind": 'reg', "py": 'r[2] = 0xFFFFC008', "slot_py": None, "target": None, "cond": None},
    0x32f5a: {"kind": 'st', "py": 'pr = _rdw(ram, STACK_BASE + 0x3FC, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x32f5c: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFC008, 4, f2bits(fr[0]))', "target": None, "cond": None},
