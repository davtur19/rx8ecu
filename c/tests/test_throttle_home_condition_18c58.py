#!/usr/bin/env python3
"""Differential test for throttle_home_condition (0x18C58) — v3 lift + v4 FPU, 84 bytes.
...
Run from repo root: python3 c/tests/test_throttle_home_condition_18c58.py
"""
...
ENTRY = 0x18C58
RAW = bytes.fromhex("93 51 D6 2D C7 2D F5 08 95 4E F3 68 F5 35 8D 03 F4 38 F5 45 8D 10 00 09 92 47 63 21 23 38 8F 0F 00 09 D1 27 60 11 60 0D 40 15 8F 09 00 09 93 3B 60 31 20 08 8F 04 00 09 D2 22 61 21 A0 08 25 11 64 51 62 4D 42 15 8F 03 00 09 D2 1F 34 2C 25 41 00 0B F6 4A")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFA9BC
SPAN_END = 0x18CAC
SENT = 0x18CAC     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x18c58: {"kind": 'reg', "py": 'r[3] = 0xFFFFA9A4', "slot_py": None, "target": None, "cond": None},
    0x18c5a: {"kind": 'reg', "py": 'r[6] = 0xFFFFA9B8', "slot_py": None, "target": None, "cond": None},
    0x18c5c: {"kind": 'reg', "py": 'r[0] = 0x00018D14', "slot_py": None, "target": None, "cond": None},
    0x18c5e: {"kind": 'fpu', "py": 'fr[5] = bits2f(_rdw(ram, 0x00018D14, 4))', "slot_py": None, "target": None, "cond": None},
    0x18c60: {"kind": 'reg', "py": 'r[5] = 0xFFFFA9AA', "slot_py": None, "target": None, "cond": None},
    0x18c62: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, r[6], 4))', "slot_py": None, "target": None, "cond": None},
    0x18c64: {"kind": 'fpu', "py": 'T = 1 if fr[5] > fr[3] else 0', "slot_py": None, "target": None, "cond": None},
    0x18c66: {"kind": "branch", "py": None, "slot_py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFA9A4, 4))', "target": 0x18c70, "cond": 'T'},
    0x18c6a: {"kind": 'fpu', "py": 'T = 1 if fr[5] > fr[4] else 0', "slot_py": None, "target": None, "cond": None},
    0x18c6c: {"kind": "branch", "py": None, "slot_py": '', "target": 0x18c90, "cond": 'T'},
    0x18c70: {"kind": 'reg', "py": 'r[2] = 0xFFFFA9A8', "slot_py": None, "target": None, "cond": None},
    0x18c72: {"kind": 'mem', "py": 'r[3] = s16(_rdw(ram, 0xFFFFA9A8, 2))', "slot_py": None, "target": None, "cond": None},
    0x18c74: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x18c76: {"kind": "branch", "py": None, "slot_py": '', "target": 0x18c98, "cond": 'notT'},
    0x18c7a: {"kind": 'reg', "py": 'r[1] = 0xFFFFA9BC', "slot_py": None, "target": None, "cond": None},
    0x18c7c: {"kind": 'mem', "py": 'r[0] = s16(_rdw(ram, 0xFFFFA9BC, 2))', "slot_py": None, "target": None, "cond": None},
    0x18c7e: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x18c80: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) > 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x18c82: {"kind": "branch", "py": None, "slot_py": '', "target": 0x18c98, "cond": 'notT'},
    0x18c86: {"kind": 'reg', "py": 'r[3] = 0xFFFFA9AA', "slot_py": None, "target": None, "cond": None},
    0x18c88: {"kind": 'mem', "py": 'r[0] = s16(_rdw(ram, 0xFFFFA9AA, 2))', "slot_py": None, "target": None, "cond": None},
    0x18c8a: {"kind": 'reg', "py": 'T = 1 if (r[0] & r[0]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x18c8c: {"kind": "branch", "py": None, "slot_py": '', "target": 0x18c98, "cond": 'notT'},
    0x18c90: {"kind": 'reg', "py": 'r[2] = 0x0006E8DE', "slot_py": None, "target": None, "cond": None},
    0x18c92: {"kind": 'mem', "py": 'r[1] = s16(_rdw(ram, 0x0006E8DE, 2))', "slot_py": None, "target": None, "cond": None},
    0x18c94: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFA9AA, 2, r[1])', "target": 0x18ca8, "cond": 'always'},
    0x18c98: {"kind": 'mem', "py": 'r[4] = s16(_rdw(ram, r[5], 2))', "slot_py": None, "target": None, "cond": None},
    0x18c9a: {"kind": 'reg', "py": 'r[2] = r[4] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x18c9c: {"kind": 'reg', "py": 'T = 1 if s32(r[2]) > 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x18c9e: {"kind": "branch", "py": None, "slot_py": '', "target": 0x18ca8, "cond": 'notT'},
    0x18ca2: {"kind": 'reg', "py": 'r[2] = 0x0000FFFF', "slot_py": None, "target": None, "cond": None},
    0x18ca4: {"kind": 'reg', "py": 'r[4] = (r[4] + r[2]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x18ca6: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA9AA, 2, r[4])', "slot_py": None, "target": None, "cond": None},
    0x18ca8: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, r[6], 4, f2bits(fr[4]))', "target": None, "cond": None},}
