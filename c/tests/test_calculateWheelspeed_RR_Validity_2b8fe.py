#!/usr/bin/env python3
"""Differential test for calculateWheelspeed_RR_Validity (0x2B8FE) — v3 lift (branches + delay slots), 44 bytes.
...
Run from repo root: python3 c/tests/test_calculateWheelspeed_RR_Validity_2b8fe.py
"""
...
ENTRY = 0x2B8FE
RAW = bytes.fromhex("94 43 92 43 63 21 D1 27 63 3D 33 10 8D 07 00 09 D3 26 D1 26 60 31 62 11 30 22 8F 03 00 09 E3 01 A0 02 24 30 E1 00 24 10 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBBF2
SPAN_END = 0x2B92A
SENT = 0x2B92A     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x2b8fe: {"kind": 'reg', "py": 'r[4] = 0xFFFFBBEE', "slot_py": None, "target": None, "cond": None},
    0x2b900: {"kind": 'reg', "py": 'r[2] = 0xFFFFBBE2', "slot_py": None, "target": None, "cond": None},
    0x2b902: {"kind": 'mem', "py": 'r[3] = s16(_rdw(ram, 0xFFFFBBE2, 2))', "slot_py": None, "target": None, "cond": None},
    0x2b904: {"kind": 'reg', "py": 'r[1] = 0x0000FFFF', "slot_py": None, "target": None, "cond": None},
    0x2b906: {"kind": 'reg', "py": 'r[3] = r[3] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x2b908: {"kind": 'reg', "py": 'T = 1 if r[3] == r[1] else 0', "slot_py": None, "target": None, "cond": None},
    0x2b90a: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2b91c, "cond": 'T'},
    0x2b90e: {"kind": 'reg', "py": 'r[3] = 0xFFFFBBF2', "slot_py": None, "target": None, "cond": None},
    0x2b910: {"kind": 'reg', "py": 'r[1] = 0x0007A7C0', "slot_py": None, "target": None, "cond": None},
    0x2b912: {"kind": 'mem', "py": 'r[0] = s16(_rdw(ram, 0xFFFFBBF2, 2))', "slot_py": None, "target": None, "cond": None},
    0x2b914: {"kind": 'mem', "py": 'r[2] = s16(_rdw(ram, 0x0007A7C0, 2))', "slot_py": None, "target": None, "cond": None},
    0x2b916: {"kind": 'reg', "py": 'T = 1 if (r[0] & 0xFFFFFFFF) >= (r[2] & 0xFFFFFFFF) else 0', "slot_py": None, "target": None, "cond": None},
    0x2b918: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2b922, "cond": 'notT'},
    0x2b91c: {"kind": 'reg', "py": 'r[3] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x2b91e: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFBBEE, 1, r[3])', "target": 0x2b926, "cond": 'always'},
    0x2b922: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x2b924: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBBEE, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x2b926: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
