#!/usr/bin/env python3
"""Differential test for uds_sid_switch_d122_d124 (0x5A2F0) — v3 lift + v4 FPU, 132 bytes.
...
Run from repo root: python3 c/tests/test_uds_sid_switch_d122_d124_5a2f0.py
"""
...
ENTRY = 0x5A2F0
RAW = bytes.fromhex("2F 20 92 70 64 F0 66 20 64 4C 60 43 88 01 8F 0C E5 01 60 6C 20 08 8F 08 00 09 90 65 63 00 23 38 8F 03 00 09 92 61 A0 02 22 50 91 5E 21 70 24 48 8F 12 00 09 66 6C 26 68 8F 0E 00 09 92 54 63 20 23 38 8F 09 00 09 91 51 60 10 60 0C 88 01 8F 03 00 09 92 4C A0 02 22 50 91 49 21 70 96 48 60 43 88 01 8F 0C 00 09 D3 25 F3 38 F4 35 8F 07 00 09 D2 23 F2 28 F2 45 8F 02 00 09 A0 01 26 50 26 70 00 0B 7F 04")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFD2AD
SPAN_END = 0x5A374
SENT = 0x5A374     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x5a2f0: {"kind": 'mem', "py": 'local[0x400] = r[2]\n_wrw(ram, STACK_BASE + 0x400, 1, r[2])', "slot_py": None, "target": None, "cond": None},
    0x5a2f2: {"kind": 'reg', "py": 'r[2] = 0xFFFFCE18', "slot_py": None, "target": None, "cond": None},
    0x5a2f4: {"kind": 'mem', "py": 'r[4] = s8(_rdw(ram, STACK_BASE + 0x400, 1))', "slot_py": None, "target": None, "cond": None},
    0x5a2f6: {"kind": 'mem', "py": 'r[6] = s8(_rdw(ram, 0xFFFFCE18, 1))', "slot_py": None, "target": None, "cond": None},
    0x5a2f8: {"kind": 'reg', "py": 'r[4] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x5a2fa: {"kind": 'reg', "py": 'r[0] = r[4]', "slot_py": None, "target": None, "cond": None},
    0x5a2fc: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x5a2fe: {"kind": "branch", "py": None, "slot_py": 'r[5] = s8(0x01)', "target": 0x5a31a, "cond": 'notT'},
    0x5a302: {"kind": 'reg', "py": 'r[0] = r[6] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x5a304: {"kind": 'reg', "py": 'T = 1 if (r[0] & r[0]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x5a306: {"kind": "branch", "py": None, "slot_py": '', "target": 0x5a31a, "cond": 'notT'},
    0x5a30a: {"kind": 'reg', "py": 'r[0] = 0xFFFFD2AD', "slot_py": None, "target": None, "cond": None},
    0x5a30c: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFD2AD, 1))', "slot_py": None, "target": None, "cond": None},
    0x5a30e: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x5a310: {"kind": "branch", "py": None, "slot_py": '', "target": 0x5a31a, "cond": 'notT'},
    0x5a314: {"kind": 'reg', "py": 'r[2] = 0xFFFFD29A', "slot_py": None, "target": None, "cond": None},
    0x5a316: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFD29A, 1, r[5])', "target": 0x5a31e, "cond": 'always'},
    0x5a31a: {"kind": 'reg', "py": 'r[1] = 0xFFFFD29A', "slot_py": None, "target": None, "cond": None},
    0x5a31c: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD29A, 1, r[7])', "slot_py": None, "target": None, "cond": None},
    0x5a31e: {"kind": 'reg', "py": 'T = 1 if (r[4] & r[4]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x5a320: {"kind": "branch", "py": None, "slot_py": '', "target": 0x5a348, "cond": 'notT'},
    0x5a324: {"kind": 'reg', "py": 'r[6] = r[6] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x5a326: {"kind": 'reg', "py": 'T = 1 if (r[6] & r[6]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x5a328: {"kind": "branch", "py": None, "slot_py": '', "target": 0x5a348, "cond": 'notT'},
    0x5a32c: {"kind": 'reg', "py": 'r[2] = 0xFFFFD2AD', "slot_py": None, "target": None, "cond": None},
    0x5a32e: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFD2AD, 1))', "slot_py": None, "target": None, "cond": None},
    0x5a330: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x5a332: {"kind": "branch", "py": None, "slot_py": '', "target": 0x5a348, "cond": 'notT'},
    0x5a336: {"kind": 'reg', "py": 'r[1] = 0xFFFFAADA', "slot_py": None, "target": None, "cond": None},
    0x5a338: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFAADA, 1))', "slot_py": None, "target": None, "cond": None},
    0x5a33a: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x5a33c: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x5a33e: {"kind": "branch", "py": None, "slot_py": '', "target": 0x5a348, "cond": 'notT'},
    0x5a342: {"kind": 'reg', "py": 'r[2] = 0xFFFFD29B', "slot_py": None, "target": None, "cond": None},
    0x5a344: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFD29B, 1, r[5])', "target": 0x5a34c, "cond": 'always'},
    0x5a348: {"kind": 'reg', "py": 'r[1] = 0xFFFFD29B', "slot_py": None, "target": None, "cond": None},
    0x5a34a: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD29B, 1, r[7])', "slot_py": None, "target": None, "cond": None},
    0x5a34c: {"kind": 'reg', "py": 'r[6] = 0xFFFFD29C', "slot_py": None, "target": None, "cond": None},
    0x5a34e: {"kind": 'reg', "py": 'r[0] = r[4]', "slot_py": None, "target": None, "cond": None},
    0x5a350: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x5a352: {"kind": "branch", "py": None, "slot_py": '', "target": 0x5a36e, "cond": 'notT'},
    0x5a356: {"kind": 'reg', "py": 'r[3] = 0x0007D2A0', "slot_py": None, "target": None, "cond": None},
    0x5a358: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x0007D2A0, 4))', "slot_py": None, "target": None, "cond": None},
    0x5a35a: {"kind": 'fpu', "py": 'T = 1 if fr[4] > fr[3] else 0', "slot_py": None, "target": None, "cond": None},
    0x5a35c: {"kind": "branch", "py": None, "slot_py": '', "target": 0x5a36e, "cond": 'notT'},
    0x5a360: {"kind": 'reg', "py": 'r[2] = 0x0007D2A4', "slot_py": None, "target": None, "cond": None},
    0x5a362: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0x0007D2A4, 4))', "slot_py": None, "target": None, "cond": None},
    0x5a364: {"kind": 'fpu', "py": 'T = 1 if fr[2] > fr[4] else 0', "slot_py": None, "target": None, "cond": None},
    0x5a366: {"kind": "branch", "py": None, "slot_py": '', "target": 0x5a36e, "cond": 'notT'},
    0x5a36a: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFD29C, 1, r[5])', "target": 0x5a370, "cond": 'always'},
    0x5a36e: {"kind": 'mem', "py": '_wrw(ram, r[6], 1, r[7])', "slot_py": None, "target": None, "cond": None},
    0x5a370: {"kind": "ret", "py": None, "slot_py": 'r[15] = (r[15] + s8(0x04)) & 0xFFFFFFFF\nsp = (sp + s8(0x04)) & 0xFFFFFFFF', "target": None, "cond": None},}
