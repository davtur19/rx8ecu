#!/usr/bin/env python3
"""Differential test for sensor_circuit_549c8 (0x549C8) — v3 lift (branches + delay slots), 64 bytes.
...
Run from repo root: python3 c/tests/test_sensor_circuit_549c8_549c8.py
"""
...
ENTRY = 0x549C8
RAW = bytes.fromhex("94 3F 93 3F 60 30 60 0C 88 01 8D 12 00 09 92 3A 60 20 60 0C 88 01 8D 0C 00 09 91 35 60 10 60 0C 88 01 8D 06 00 09 93 30 60 30 60 0C 88 01 8F 03 00 09 E3 01 A0 02 24 30 E1 00 24 10 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    0x549c8: {"kind": 'reg', "py": 'r[4] = 0xFFFFD1E6', "slot_py": None, "target": None, "cond": None},
    0x549ca: {"kind": 'reg', "py": 'r[3] = 0xFFFFC982', "slot_py": None, "target": None, "cond": None},
    0x549cc: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFC982, 1))', "slot_py": None, "target": None, "cond": None},
    0x549ce: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x549d0: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x549d2: {"kind": "branch", "py": None, "slot_py": '', "target": 0x549fa, "cond": 'T'},
    0x549d6: {"kind": 'reg', "py": 'r[2] = 0xFFFFC984', "slot_py": None, "target": None, "cond": None},
    0x549d8: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFC984, 1))', "slot_py": None, "target": None, "cond": None},
    0x549da: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x549dc: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x549de: {"kind": "branch", "py": None, "slot_py": '', "target": 0x549fa, "cond": 'T'},
    0x549e2: {"kind": 'reg', "py": 'r[1] = 0xFFFFCA05', "slot_py": None, "target": None, "cond": None},
    0x549e4: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCA05, 1))', "slot_py": None, "target": None, "cond": None},
    0x549e6: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x549e8: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x549ea: {"kind": "branch", "py": None, "slot_py": '', "target": 0x549fa, "cond": 'T'},
    0x549ee: {"kind": 'reg', "py": 'r[3] = 0xFFFFCA07', "slot_py": None, "target": None, "cond": None},
    0x549f0: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCA07, 1))', "slot_py": None, "target": None, "cond": None},
    0x549f2: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x549f4: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x549f6: {"kind": "branch", "py": None, "slot_py": '', "target": 0x54a00, "cond": 'notT'},
    0x549fa: {"kind": 'reg', "py": 'r[3] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x549fc: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFD1E6, 1, r[3])', "target": 0x54a04, "cond": 'always'},
    0x54a00: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x54a02: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD1E6, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x54a04: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
