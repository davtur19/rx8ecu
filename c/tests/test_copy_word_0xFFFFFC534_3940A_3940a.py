#!/usr/bin/env python3
"""Differential test for copy_word_0xFFFFFC534_3940A (0x3940A) — v3 lift (branches + delay slots), 10 bytes.
...
Run from repo root: python3 c/tests/test_copy_word_0xFFFFFC534_3940A_3940a.py
"""
...
CODE = {
    0x3940a: {"kind": 'reg', "py": 'r[1] = 0xFFFFC534', "slot_py": None, "target": None, "cond": None},
    0x3940c: {"kind": 'reg', "py": 'r[2] = 0xFFFFC532', "slot_py": None, "target": None, "cond": None},
    0x3940e: {"kind": 'mem', "py": 'r[3] = s16(_rdw(ram, 0xFFFFC534, 2))', "slot_py": None, "target": None, "cond": None},
    0x39410: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFC532, 2, r[3])', "target": None, "cond": None},}
