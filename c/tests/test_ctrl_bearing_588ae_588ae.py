#!/usr/bin/env python3
"""Differential test for ctrl_bearing_588ae (0x588AE) — v3 lift (branches + delay slots), 32 bytes.
...
Run from repo root: python3 c/tests/test_ctrl_bearing_588ae_588ae.py
"""
...
ENTRY = 0x588AE
RAW = bytes.fromhex("E4 00 D3 0D 23 40 D2 0D 22 40 D1 0D 21 41 D3 0D 23 41 D2 0D 22 41 D1 0D 21 41 D3 0D 00 0B 23 41")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    0x588ae: {"kind": 'reg', "py": 'r[4] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x588b0: {"kind": 'reg', "py": 'r[3] = 0xFFFFD264', "slot_py": None, "target": None, "cond": None},
    0x588b2: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD264, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x588b4: {"kind": 'reg', "py": 'r[2] = 0xFFFFD265', "slot_py": None, "target": None, "cond": None},
    0x588b6: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD265, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x588b8: {"kind": 'reg', "py": 'r[1] = 0xFFFFD266', "slot_py": None, "target": None, "cond": None},
    0x588ba: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD266, 2, r[4])', "slot_py": None, "target": None, "cond": None},
    0x588bc: {"kind": 'reg', "py": 'r[3] = 0xFFFFD268', "slot_py": None, "target": None, "cond": None},
    0x588be: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD268, 2, r[4])', "slot_py": None, "target": None, "cond": None},
    0x588c0: {"kind": 'reg', "py": 'r[2] = 0xFFFFD26A', "slot_py": None, "target": None, "cond": None},
    0x588c2: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD26A, 2, r[4])', "slot_py": None, "target": None, "cond": None},
    0x588c4: {"kind": 'reg', "py": 'r[1] = 0xFFFFD260', "slot_py": None, "target": None, "cond": None},
    0x588c6: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFD260, 2, r[4])', "slot_py": None, "target": None, "cond": None},
    0x588c8: {"kind": 'reg', "py": 'r[3] = 0xFFFFD262', "slot_py": None, "target": None, "cond": None},
    0x588ca: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFD262, 2, r[4])', "target": None, "cond": None},}
