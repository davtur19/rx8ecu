#!/usr/bin/env python3
"""Differential test for dtc_data_read_60FBA (0x60FBA) — v3 lift (branches + delay slots), 10 bytes.
...
Run from repo root: python3 c/tests/test_dtc_data_read_60FBA_60fba.py
"""
...
ENTRY = 0x60FBA
RAW = bytes.fromhex("60 D3 6C F6 6D F6 00 0B 6E F6")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = None
SPAN_END = 0x60FC4
SENT = 0x60FC4     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x60fba: {"kind": 'reg', "py": 'r[0] = r[13]', "slot_py": None, "target": None, "cond": None},
    0x60fbc: {"kind": 'mem', "py": 'r[12] = _rdw(ram, STACK_BASE + 0x400, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x60fbe: {"kind": 'mem', "py": 'r[13] = _rdw(ram, STACK_BASE + 0x404, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x60fc0: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, STACK_BASE + 0x408, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},}
