#!/usr/bin/env python3
"""Differential test for irq_atomic_xor_word (0x4BE4) — v3 lift (branches + delay slots), 46 bytes.
...
Run from repo root: python3 c/tests/test_irq_atomic_xor_word_4be4.py
"""
...
ENTRY = 0x4BE4
RAW = bytes.fromhex("93 06 02 02 43 0E 63 41 23 5A 24 31 00 0B 42 0E 00 E0 E6 F7 E3 3C 46 18 64 4C 43 18 76 0A 24 3B 26 41 00 09 00 09 00 09 00 09 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFF70A
SPAN_END = 0x4C12
SENT = 0x4C12     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x4be4: {"kind": 'reg', "py": 'r[3] = 0x000000E0', "slot_py": None, "target": None, "cond": None},
    0x4be6: {"kind": 'reg', "py": 'r[2] = sr', "slot_py": None, "target": None, "cond": None},
    0x4be8: {"kind": 'reg', "py": 'sr = r[3]', "slot_py": None, "target": None, "cond": None},
    0x4bea: {"kind": 'mem', "py": 'r[3] = s16(_rdw(ram, r[4], 2))', "slot_py": None, "target": None, "cond": None},
    0x4bec: {"kind": 'reg', "py": 'r[3] = (r[3] ^ r[5]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x4bee: {"kind": 'mem', "py": '_wrw(ram, r[4], 2, r[3])', "slot_py": None, "target": None, "cond": None},
    0x4bf0: {"kind": "ret", "py": None, "slot_py": 'sr = r[2]', "target": None, "cond": None},
    0x4bf6: {"kind": 'reg', "py": 'r[6] = s8(0xF7)', "slot_py": None, "target": None, "cond": None},
    0x4bf8: {"kind": 'reg', "py": 'r[3] = s8(0x3C)', "slot_py": None, "target": None, "cond": None},
    0x4bfa: {"kind": 'reg', "py": 'r[6] = (r[6] << 8) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x4bfc: {"kind": 'reg', "py": 'r[4] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x4bfe: {"kind": 'reg', "py": 'r[3] = (r[3] << 8) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x4c00: {"kind": 'reg', "py": 'r[6] = (r[6] + s8(0x0A)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x4c02: {"kind": 'reg', "py": 'r[4] = (r[4] | r[3]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x4c04: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFF70A, 2, r[4])', "slot_py": None, "target": None, "cond": None},
    0x4c06: {"kind": 'reg', "py": None, "slot_py": None, "target": None, "cond": None},
    0x4c08: {"kind": 'reg', "py": None, "slot_py": None, "target": None, "cond": None},
    0x4c0a: {"kind": 'reg', "py": None, "slot_py": None, "target": None, "cond": None},
    0x4c0c: {"kind": 'reg', "py": None, "slot_py": None, "target": None, "cond": None},
    0x4c0e: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
