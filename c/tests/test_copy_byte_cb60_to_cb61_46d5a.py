#!/usr/bin/env python3
"""Differential test for copy_byte_cb60_to_cb61 (0x46D5A) — v3 lift (branches + delay slots), 10 bytes.
...
Run from repo root: python3 c/tests/test_copy_byte_cb60_to_cb61_46d5a.py
"""
...
ENTRY = 0x46D5A
RAW = bytes.fromhex("91 1B 90 1B 62 10 00 0B 20 20")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCB61
SPAN_END = 0x46D64
SENT = 0x46D64     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x46d5a: {"kind": 'reg', "py": 'r[1] = 0xFFFFCB60', "slot_py": None, "target": None, "cond": None},
    0x46d5c: {"kind": 'reg', "py": 'r[0] = 0xFFFFCB61', "slot_py": None, "target": None, "cond": None},
    0x46d5e: {"kind": 'mem', "py": 'r[2] = s8(_rdw(ram, 0xFFFFCB60, 1))', "slot_py": None, "target": None, "cond": None},
    0x46d60: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFCB61, 1, r[2])', "target": None, "cond": None},}
