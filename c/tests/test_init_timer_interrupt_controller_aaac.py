#!/usr/bin/env python3
"""Differential test for init_timer_interrupt_controller (0xAAAC) — v3 lift + v4 FPU, 24 bytes.
...
Run from repo root: python3 c/tests/test_init_timer_interrupt_controller_aaac.py
"""
...
ENTRY = 0xAAAC
RAW = bytes.fromhex("25 41 F4 4D F4 3D 01 5A A0 04 26 11 F4 3D 00 5A 25 01 26 41 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    0xaaac: {"kind": 'mem', "py": '_wrw(ram, r[5], 2, r[4])', "slot_py": None, "target": None, "cond": None},
    ...
    0xaab4: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, r[6], 2, r[1])', "target": 0xaac0, "cond": 'always'},
    ...
    0xaabc: {"kind": 'mem', "py": '_wrw(ram, r[5], 2, r[0])', "slot_py": None, "target": None, "cond": None},
    0xaabe: {"kind": 'mem', "py": '_wrw(ram, r[6], 2, r[4])', "slot_py": None, "target": None, "cond": None},
