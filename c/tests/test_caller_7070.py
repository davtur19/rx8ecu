#!/usr/bin/env python3
"""Differential test for caller_7070 (entry 0x7070) — v8 ST caller (CFG), 24 bytes.
...
Run: python3 test_caller_7070.py
"""
...
CODE = {
    0x7070: {"kind": 'st', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x7072: {"kind": 'reg', "py": 'r[6] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x7074: {"kind": 'reg', "py": 'r[4] = 0xFFFFF764', "slot_py": None, "target": None, "cond": None},
    0x7076: {"kind": 'reg', "py": 'r[3] = 0x00004BBC', "slot_py": None, "target": None, "cond": None},
    0x7078: {"kind": "call", "py": None, "slot_py": 'r[5] = r[6]', "target": 0x4bbc, "ret_pc": 0x707c, "set_pr": True, "cond": None},
    0x707c: {"kind": 'reg', "py": 'r[5] = 0x00000100', "slot_py": None, "target": None, "cond": None},
    0x707e: {"kind": 'reg', "py": 'r[6] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x7080: {"kind": 'reg', "py": 'r[4] = 0xFFFFF74E', "slot_py": None, "target": None, "cond": None},
    0x7082: {"kind": 'reg', "py": 'r[2] = 0x00004BBC', "slot_py": None, "target": None, "cond": None},
    0x7084: {"kind": "call", "py": None, "slot_py": 'pr = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": 0x4bbc, "ret_pc": 0x7088, "set_pr": False, "cond": None},
