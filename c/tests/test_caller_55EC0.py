#!/usr/bin/env python3
"""Differential test for caller_55EC0 (entry 0x55EC0) — v8 ST caller (CFG), 22 bytes.
...
Run: python3 test_caller_55EC0.py
"""
...
CODE = {
    0x55ec0: {"kind": 'st', "py": 'local[0x3FC] = pr\n_wrw(ram, STACK_BASE + 0x3FC, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x55ec2: {"kind": 'fpu', "py": 'fr[6] = 0.0', "slot_py": None, "target": None, "cond": None},
    0x55ec4: {"kind": 'reg', "py": 'r[0] = 0x00055F50', "slot_py": None, "target": None, "cond": None},
    0x55ec6: {"kind": 'reg', "py": 'r[3] = 0xFFFFB5B8', "slot_py": None, "target": None, "cond": None},
    0x55ec8: {"kind": 'reg', "py": 'r[2] = 0x00002490', "slot_py": None, "target": None, "cond": None},
    0x55eca: {"kind": 'fpu', "py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFB5B8, 4))', "slot_py": None, "target": None, "cond": None},
    0x55ecc: {"kind": "call", "py": None, "slot_py": 'fr[5] = bits2f(_rdw(ram, 0x00055F50, 4))', "target": 0x2490, "ret_pc": 0x55ed0, "set_pr": True, "cond": None},
    0x55ed0: {"kind": 'st', "py": 'pr = _rdw(ram, STACK_BASE + 0x3FC, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x55ed2: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},
