#!/usr/bin/env python3
"""Differential test for mem_checker_3e580 (0x3E580) — v3 lift (branches + delay slots), 10 bytes.
...
Run from repo root: python3 c/tests/test_mem_checker_3e580_3e580.py
"""
...
CODE = {
    0x3e580: {"kind": 'reg', "py": 'r[2] = 0x0007A870', "slot_py": None, "target": None, "cond": None},
    0x3e582: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0x0007A870, 1))', "slot_py": None, "target": None, "cond": None},
    0x3e584: {"kind": 'reg', "py": 'r[1] = 0xFFFFC68C', "slot_py": None, "target": None, "cond": None},
    0x3e586: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFC68C, 1, r[3])', "target": None, "cond": None},}
