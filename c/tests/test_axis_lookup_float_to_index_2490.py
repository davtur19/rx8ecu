#!/usr/bin/env python3
"""Differential test for axis_lookup_float_to_index (0x2490) — v3 lift + v4 FPU, 42 bytes.
...
Run from repo root: python3 c/tests/test_axis_lookup_float_to_index_2490.py
"""
...
ENTRY = 0x2490
RAW = bytes.fromhex("C7 09 F4 61 D5 09 F4 53 F3 08 F2 4C F2 30 F2 3D 04 5A 34 57 8F 02 00 09 A0 04 64 53 44 11 8D 01 00 09 E4 00 00 0B 60 43 3F 00")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = None
SPAN_END = 0x24BA
SENT = 0x24C0     # stop-sentinel, placed past the literal pool
