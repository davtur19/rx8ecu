#!/usr/bin/env python3
"""Differential test for FUN_0004c030 (0x4C030) — v3 lift + v4 FPU, 10 bytes.
...
Run from repo root: python3 c/tests/test_FUN_0004c030_4c030.py
"""
...
ENTRY = 0x4C030
RAW = bytes.fromhex("D3 22 F3 38 91 33 00 0B F1 3A")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCD80
SPAN_END = 0x4C03A
SENT = 0x4C03A     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x4c030: {"kind": 'reg', "py": 'r[3] = 0x0007C13C', "slot_py": None, "target": None, "cond": None},
    0x4c032: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x0007C13C, 4))', "slot_py": None, "target": None, "cond": None},
    0x4c034: {"kind": 'reg', "py": 'r[1] = 0xFFFFCD80', "slot_py": None, "target": None, "cond": None},
    0x4c036: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFCD80, 4, f2bits(fr[3]))', "target": None, "cond": None},}
