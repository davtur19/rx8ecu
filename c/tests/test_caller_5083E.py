#!/usr/bin/env python3
"""Differential test for caller_5083E (entry 0x5083E) — v8 ST caller (CFG), 38 bytes.
...
Run: python3 test_caller_5083E.py
"""
...
CODE = {
    0x5083e: {"kind": 'mem', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, r[14])\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x50840: {"kind": 'st', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x50842: {"kind": 'reg', "py": 'r[14] = 0x0003E1F8', "slot_py": None, "target": None, "cond": None},
    0x50844: {"kind": 'reg', "py": 'r[4] = 0xFFFF86FE', "slot_py": None, "target": None, "cond": None},
    0x50846: {"kind": "call", "py": None, "slot_py": 'r[5] = s8(0x00)', "target": 0x3e1f8, "ret_pc": 0x5084a, "set_pr": True, "cond": None},
    0x5084a: {"kind": 'reg', "py": 'r[4] = 0xFFFF8700', "slot_py": None, "target": None, "cond": None},
    0x5084c: {"kind": "call", "py": None, "slot_py": 'r[5] = s8(0x00)', "target": 0x3e1f8, "ret_pc": 0x50850, "set_pr": True, "cond": None},
    0x50850: {"kind": 'reg', "py": 'r[4] = 0xFFFF8702', "slot_py": None, "target": None, "cond": None},
    0x50852: {"kind": "call", "py": None, "slot_py": 'r[5] = s8(0x00)', "target": 0x3e1f8, "ret_pc": 0x50856, "set_pr": True, "cond": None},
    0x50856: {"kind": 'reg', "py": 'r[3] = 0x0007BFBE', "slot_py": None, "target": None, "cond": None},
    0x50858: {"kind": 'reg', "py": 'r[4] = 0xFFFF86FC', "slot_py": None, "target": None, "cond": None},
    0x5085a: {"kind": "call", "py": None, "slot_py": 'r[5] = s8(_rdw(ram, 0x0007BFBE, 1))', "target": 0x3e1f8, "ret_pc": 0x5085e, "set_pr": True, "cond": None},
    0x5085e: {"kind": 'st', "py": 'pr = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x50860: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},
