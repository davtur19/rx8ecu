#!/usr/bin/env python3
"""Differential test for FUN_0001b088 (0x1B088) — v3 lift (branches + delay slots), 40 bytes.
...
Run from repo root: python3 c/tests/test_FUN_0001b088_1b088.py
"""
...
ENTRY = 0x1B088
RAW = bytes.fromhex("D5 0C E4 01 D3 0C 60 31 60 0D 20 48 8D 02 00 09 A0 01 60 43 E0 00 88 01 8F 02 00 09 A0 02 25 40 E2 00 25 20 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFAACD
SPAN_END = 0x1B0B0
SENT = 0x1B0B0     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x1b088: {"kind": 'reg', "py": 'r[5] = 0xFFFFAACD', "slot_py": None, "target": None, "cond": None},
    0x1b08a: {"kind": 'reg', "py": 'r[4] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x1b08c: {"kind": 'reg', "py": 'r[3] = 0xFFFF9EC8', "slot_py": None, "target": None, "cond": None},
    0x1b08e: {"kind": 'mem', "py": 'r[0] = s16(_rdw(ram, 0xFFFF9EC8, 2))', "slot_py": None, "target": None, "cond": None},
    0x1b090: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFFFF', "slot_py": None, "target": None, "cond": None},
    0x1b092: {"kind": 'reg', "py": 'T = 1 if (r[0] & r[4]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x1b094: {"kind": "branch", "py": None, "slot_py": '', "target": 0x1b09c, "cond": 'T'},
    0x1b098: {"kind": "branch", "py": None, "slot_py": 'r[0] = r[4]', "target": 0x1b09e, "cond": 'always'},
    0x1b09c: {"kind": 'reg', "py": 'r[0] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x1b09e: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x1b0a0: {"kind": "branch", "py": None, "slot_py": '', "target": 0x1b0a8, "cond": 'notT'},
    0x1b0a4: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFAACD, 1, r[4])', "target": 0x1b0ac, "cond": 'always'},
    0x1b0a8: {"kind": 'reg', "py": 'r[2] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x1b0aa: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFAACD, 1, r[2])', "slot_py": None, "target": None, "cond": None},
    0x1b0ac: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
