#!/usr/bin/env python3
"""Differential test for getVehicleSpeedForOBD__ (0x53600) — v3 lift (branches + delay slots), 20 bytes.
...
Run from repo root: python3 c/tests/test_getVehicleSpeedForOBD___53600.py
"""
...
ENTRY = 0x53600
RAW = bytes.fromhex("68 F6 69 F6 6A F6 6B F6 6C F6 6D F6 00 0B 6E F6 94 19 93 19")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    0x53600: {"kind": 'mem', "py": 'r[8] = _rdw(ram, STACK_BASE + 0x400, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x53602: {"kind": 'mem', "py": 'r[9] = _rdw(ram, STACK_BASE + 0x404, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x53604: {"kind": 'mem', "py": 'r[10] = _rdw(ram, STACK_BASE + 0x408, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x53606: {"kind": 'mem', "py": 'r[11] = _rdw(ram, STACK_BASE + 0x40C, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x53608: {"kind": 'mem', "py": 'r[12] = _rdw(ram, STACK_BASE + 0x410, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x5360a: {"kind": 'mem', "py": 'r[13] = _rdw(ram, STACK_BASE + 0x414, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x5360c: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, STACK_BASE + 0x418, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},
