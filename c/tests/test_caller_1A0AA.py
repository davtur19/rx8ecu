#!/usr/bin/env python3
"""Differential test for caller_1A0AA (entry 0x1A0AA) — v8 ST caller (CFG), 30 bytes.
...
Run: python3 test_caller_1A0AA.py
"""
...
CODE = {
    0x1a0aa: {"kind": 'st', "py": 'local[0x3FC] = pr\n_wrw(ram, STACK_BASE + 0x3FC, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x1a0ac: {"kind": 'reg', "py": 'r[0] = 0x0001A150', "slot_py": None, "target": None, "cond": None},
    0x1a0ae: {"kind": 'fpu', "py": 'fr[7] = bits2f(_rdw(ram, 0x0001A150, 4))', "slot_py": None, "target": None, "cond": None},
    0x1a0b0: {"kind": 'reg', "py": 'r[3] = 0x0006FA2C', "slot_py": None, "target": None, "cond": None},
    0x1a0b2: {"kind": 'fpu', "py": 'fr[6] = bits2f(_rdw(ram, 0x0006FA2C, 4))', "slot_py": None, "target": None, "cond": None},
    0x1a0b4: {"kind": 'reg', "py": 'r[2] = 0xFFFFAA2C', "slot_py": None, "target": None, "cond": None},
    0x1a0b6: {"kind": 'fpu', "py": 'fr[5] = bits2f(_rdw(ram, 0xFFFFAA2C, 4))', "slot_py": None, "target": None, "cond": None},
    0x1a0b8: {"kind": 'reg', "py": 'r[1] = 0xFFFFAA28', "slot_py": None, "target": None, "cond": None},
    0x1a0ba: {"kind": 'reg', "py": 'r[3] = 0x000023B0', "slot_py": None, "target": None, "cond": None},
    0x1a0bc: {"kind": "call", "py": None, "slot_py": 'fr[4] = bits2f(_rdw(ram, 0xFFFFAA28, 4))', "target": 0x23b0, "ret_pc": 0x1a0c0, "set_pr": True, "cond": None},
    0x1a0c0: {"kind": 'reg', "py": 'r[2] = 0xFFFFAA2C', "slot_py": None, "target": None, "cond": None},
    0x1a0c2: {"kind": 'st', "py": 'pr = _rdw(ram, STACK_BASE + 0x3FC, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x1a0c4: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFAA2C, 4, f2bits(fr[0]))', "target": None, "cond": None},
