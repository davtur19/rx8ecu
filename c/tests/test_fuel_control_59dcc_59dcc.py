#!/usr/bin/env python3
"""Differential test for fuel_control_59dcc (0x59DCC) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_fuel_control_59dcc_59dcc.py
"""
...
ENTRY = 0x59DCC
RAW = bytes.fromhex("D0 0B E1 01 00 0B 20 10")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    0x59dcc: {"kind": 'reg', "py": 'r[0] = 0xFFFFD2AE', "slot_py": None, "target": None, "cond": None},
    0x59dce: {"kind": 'reg', "py": 'r[1] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x59dd0: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFD2AE, 1, r[1])', "target": None, "cond": None},}
