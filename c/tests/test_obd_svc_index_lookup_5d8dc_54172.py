#!/usr/bin/env python3
"""Differential test for obd_svc_index_lookup_5d8dc (0x54172) — v3 lift (branches + delay slots), 10 bytes.
...
Run from repo root: python3 c/tests/test_obd_svc_index_lookup_5d8dc_54172.py
"""
...
ENTRY = 0x54172
RAW = bytes.fromhex("D2 0C 22 E0 4F 26 00 0B 6E F6")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFD1CD
SPAN_END = 0x5417C
SENT = 0x5417C     # stop-sentinel, placed past the literal pool
...
CODE = {
    ...
    0x54176: {"kind": 'mem', "py": 'pr = _rdw(ram, STACK_BASE + 0x400, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x54178: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, STACK_BASE + 0x404, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},}
