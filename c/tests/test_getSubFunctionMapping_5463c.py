#!/usr/bin/env python3
"""Differential test for getSubFunctionMapping (0x5463C) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_getSubFunctionMapping_5463c.py
"""
...
RAM_MAX = None
SPAN_END = 0x54644
SENT = 0x54644     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x5463c: {"kind": 'mem', "py": 'pr = _rdw(ram, STACK_BASE + 0x400, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x5463e: {"kind": 'mem', "py": 'r[13] = _rdw(ram, STACK_BASE + 0x404, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x54640: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, STACK_BASE + 0x408, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},}
