#!/usr/bin/env python3
"""Differential test for fault_cca7_cond_counter (0x49DB6) — v3 lift (branches + delay slots), 42 bytes.
...
Run from repo root: python3 c/tests/test_fault_cca7_cond_counter_49db6.py
"""
...
ENTRY = 0x49DB6
RAW = bytes.fromhex("95 75 93 75 60 30 60 0C 88 01 8F 04 00 09 D2 3D 61 20 A0 08 25 10 64 50 62 4C 42 15 8F 03 00 09 92 67 34 2C 25 40 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCCA7
SPAN_END = 0x49DE0
SENT = 0x49DE0     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x49db6: {"kind": 'reg', "py": 'r[5] = 0xFFFFCCA7', "slot_py": None, "target": None, "cond": None},
    0x49db8: {"kind": 'reg', "py": 'r[3] = 0xFFFFA42C', "slot_py": None, "target": None, "cond": None},
    0x49dba: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFA42C, 1))', "slot_py": None, "target": None, "cond": None},
    0x49dbc: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x49dbe: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x49dc0: {"kind": "branch", "py": None, "slot_py": '', "target": 0x49dcc, "cond": 'notT'},
    0x49dc4: {"kind": 'reg', "py": 'r[2] = 0x0007B234', "slot_py": None, "target": None, "cond": None},
    0x49dc6: {"kind": 'mem', "py": 'r[1] = s8(_rdw(ram, 0x0007B234, 1))', "slot_py": None, "target": None, "cond": None},
    0x49dc8: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFCCA7, 1, r[1])', "target": 0x49ddc, "cond": 'always'},
    0x49dcc: {"kind": 'mem', "py": 'r[4] = s8(_rdw(ram, r[5], 1))', "slot_py": None, "target": None, "cond": None},
    0x49dce: {"kind": 'reg', "py": 'r[2] = r[4] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x49dd0: {"kind": 'reg', "py": 'T = 1 if s32(r[2]) > 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x49dd2: {"kind": "branch", "py": None, "slot_py": '', "target": 0x49ddc, "cond": 'notT'},
    0x49dd6: {"kind": 'reg', "py": 'r[2] = 0x000000FF', "slot_py": None, "target": None, "cond": None},
    0x49dd8: {"kind": 'reg', "py": 'r[4] = (r[4] + r[2]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x49dda: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCCA7, 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x49ddc: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
