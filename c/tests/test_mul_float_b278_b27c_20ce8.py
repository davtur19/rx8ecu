#!/usr/bin/env python3
"""Differential test for mul_float_b278_b27c (0x20CE8) — v3 lift + v4 FPU, 16 bytes.
...
Run from repo root: python3 c/tests/test_mul_float_b278_b27c_20ce8.py
"""
...
ENTRY = 0x20CE8
RAW = bytes.fromhex("D3 17 F3 38 92 24 F2 28 91 23 F2 32 00 0B F1 2A")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFB288
SPAN_END = 0x20CF8
SENT = 0x20CF8     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x20ce8: {"kind": 'reg', "py": 'r[3] = 0xFFFFB288', "slot_py": None, "target": None, "cond": None},
    0x20cea: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFB288, 4))', "slot_py": None, "target": None, "cond": None},
    0x20cec: {"kind": 'reg', "py": 'r[2] = 0xFFFFB27C', "slot_py": None, "target": None, "cond": None},
    0x20cee: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0xFFFFB27C, 4))', "slot_py": None, "target": None, "cond": None},
    0x20cf0: {"kind": 'reg', "py": 'r[1] = 0xFFFFB278', "slot_py": None, "target": None, "cond": None},
    0x20cf2: {"kind": 'fpu', "py": 'fr[2] = ts(fr[2] * fr[3])', "slot_py": None, "target": None, "cond": None},
    0x20cf4: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFB278, 4, f2bits(fr[2]))', "target": None, "cond": None},}
