#!/usr/bin/env python3
"""Differential test for nullsub_0xd712 (0xD712) — v3 lift (branches + delay slots), 12 bytes.
...
Run from repo root: python3 c/tests/test_nullsub_0xd712_d712.py
"""
...
ENTRY = 0xD712
RAW = bytes.fromhex("00 0B 00 09 E1 01 D0 02 00 0B 20 10")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFA3FC
SPAN_END = 0xD71E
SENT = 0xD71E     # stop-sentinel, placed past the literal pool
...
CODE = {
    0xd712: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},
