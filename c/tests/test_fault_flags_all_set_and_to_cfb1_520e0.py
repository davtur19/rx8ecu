#!/usr/bin/env python3
"""Differential test for fault_flags_all_set_and_to_cfb1 (0x520E0) — v3 lift + v4 FPU, 22 bytes.
...
Run from repo root: python3 c/tests/test_fault_flags_all_set_and_to_cfb1_520e0.py
"""
...
ENTRY = 0x520E0
RAW = bytes.fromhex("93 5D F3 4D C7 32 F2 38 F1 08 F2 30 93 58 F2 12 F3 2A 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
