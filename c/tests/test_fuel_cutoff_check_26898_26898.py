#!/usr/bin/env python3
"""Differential test for fuel_cutoff_check_26898 (0x26898) — v3 lift + v4 FPU, 44 bytes.
...
Run from repo root: python3 c/tests/test_fuel_cutoff_check_26898_26898.py
"""
...
ENTRY = 0x26898
RAW = bytes.fromhex("94 42 D3 27 92 41 F3 38 F2 28 F3 25 8F 07 00 09 D1 24 F1 18 90 3A F0 08 F1 05 8D 03 00 09 E2 01 A0 02 24 20 E1 00 24 10 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFB6C8
SPAN_END = 0x268C4
SENT = 0x268C4     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x26898: {"kind": 'reg', "py": 'r[4] = 0xFFFFB682', "slot_py": None, "target": None, "cond": None},
    0x2689a: {"kind": 'reg', "py": 'r[3] = 0x000751C8', "slot_py": None, "target": None, "cond": None},
    0x2689c: {"kind": 'reg', "py": 'r[2] = 0xFFFFB6C4', "slot_py": None, "target": None, "cond": None},
    0x2689e: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x000751C8, 4))', "slot_py": None, "target": None, "cond": None},
    0x268a0: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, 0xFFFFB6C4, 4))', "slot_py": None, "target": None, "cond": None},
    0x268a2: {"kind": 'fpu', "py": 'T = 1 if fr[3] > fr[2] else 0', "slot_py": None, "target": None, "cond": None},
    0x268a4: {"kind": "branch", "py": None, "slot_py": '', "target": 0x268b6, "cond": 'notT'},
    0x268a8: {"kind": 'reg', "py": 'r[1] = 0x000751CC', "slot_py": None, "target": None, "cond": None},
    0x268aa: {"kind": 'fpu', "py": 'fr[1] = bits2f(_rdw(ram, 0x000751CC, 4))', "slot_py": None, "target": None, "cond": None},
    0x268ac: {"kind": 'reg', "py": 'r[0] = 0xFFFFB6C8', "slot_py": None, "target": None, "cond": None},
    0x268ae: {"kind": 'fpu', "py": 'fr[0] = bits2f(_rdw(ram, 0xFFFFB6C8, 4))', "slot_py": None, "target": None, "cond": None},
    0x268b0: {"kind": 'fpu', "py": 'T = 1 if fr[1] > fr[0] else 0', "slot_py": None, "target": None, "cond": None},
    0x268b2: {"kind": "branch", "py": None, "slot_py": '', "target": 0x268bc, "cond": 'T'},
    0x268b6: {"kind": 'reg', "py": 'r[2] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x268b8: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFB682, 1, r[2])', "target": 0x268c0, "cond": 'always'},
    0x268bc: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x268be: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFB682, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x268c0: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
