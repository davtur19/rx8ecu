#!/usr/bin/env python3
"""Differential test for copy_ram_bytes_c62a_c62b (0x3DD34) — v3 lift (branches + delay slots), 18 bytes.
...
Run from repo root: python3 c/tests/test_copy_ram_bytes_c62a_c62b_3dd34.py
"""
...
ENTRY = 0x3DD34
RAW = bytes.fromhex("D2 49 63 20 91 80 21 30 D3 48 60 30 92 7D 00 0B 22 00")
SEED = 43
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFC62B
SPAN_END = 0x3DD46
SENT = 0x3DD46     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x3dd34: {"kind": 'reg', "py": 'r[2] = 0x00079781', "slot_py": None, "target": None, "cond": None},
    0x3dd36: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0x00079781, 1))', "slot_py": None, "target": None, "cond": None},
    0x3dd38: {"kind": 'reg', "py": 'r[1] = 0xFFFFC62A', "slot_py": None, "target": None, "cond": None},
    0x3dd3a: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFC62A, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x3dd3c: {"kind": 'reg', "py": 'r[3] = 0x00079782', "slot_py": None, "target": None, "cond": None},
    0x3dd3e: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0x00079782, 1))', "slot_py": None, "target": None, "cond": None},
    0x3dd40: {"kind": 'reg', "py": 'r[2] = 0xFFFFC62B', "slot_py": None, "target": None, "cond": None},
    0x3dd42: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFC62B, 1, r[0])', "target": None, "cond": None},}
