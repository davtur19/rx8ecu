#!/usr/bin/env python3
"""Differential test for uds_mode22_did_4a_getter (0x55034) — mem lift (RAM-only, straight-line), 10 bytes.
...
Run from repo root: python3 c/tests/test_uds_mode22_did_4a_getter_55034.py
"""
...
ENTRY = 0x55034
RAW = bytes.fromhex("00 09 91 6A 60 10 60 0C 88 01")
SEED = 42
N = 2000
