#!/usr/bin/env python3
"""Differential test for crank_angle_set_ff (0x7BDC) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_crank_angle_set_ff_7bdc.py
"""
...
ENTRY = 0x7BDC
RAW = bytes.fromhex("91 2A D3 1E 00 0B 23 10")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFF9FC6
SPAN_END = 0x7BE4
SENT = 0x7BE4     # stop-sentinel, placed past the literal pool
