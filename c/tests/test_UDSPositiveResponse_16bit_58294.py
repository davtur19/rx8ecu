#!/usr/bin/env python3
"""Differential test for UDSPositiveResponse_16bit (0x58294) — v3 lift (branches + delay slots), 24 bytes.
...
Run from repo root: python3 c/tests/test_UDSPositiveResponse_16bit_58294.py
"""
...
ENTRY = 0x58294
RAW = bytes.fromhex("92 57 60 5D 30 20 8F 03 00 09 E1 01 A0 02 26 10 E2 00 26 20 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
CODE = {
    ...
    0x582a0: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, r[6], 1, r[1])', "target": 0x582a8, "cond": 'always'},
    0x582a4: {"kind": 'reg', "py": 'r[2] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x582a6: {"kind": 'mem', "py": '_wrw(ram, r[6], 1, r[2])', "slot_py": None, "target": None, "cond": None},
