#!/usr/bin/env python3
"""Differential test for driverOffThrottleSetPrevLoop (0x210A4) — v3 lift (branches + delay slots), 18 bytes.
...
Run from repo root: python3 c/tests/test_driverOffThrottleSetPrevLoop_210a4.py
"""
...
ENTRY = 0x210A4
RAW = bytes.fromhex("92 76 63 20 D1 3F 21 30 93 73 60 30 D2 3E 00 0B 22 00")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFB2C2
SPAN_END = 0x210B6
SENT = 0x210B6     # stop-sentinel, placed past the literal pool
...
CODE = {
    ...
    0x210b2: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFB2C2, 1, r[0])', "target": None, "cond": None},}
