#!/usr/bin/env python3
"""Differential test for read_flag_ca82 (0x5E5BA) — v3 lift (branches + delay slots), 14 bytes.
...
Run from repo root: python3 c/tests/test_read_flag_ca82_5e5ba.py
"""
...
ENTRY = 0x5E5BA
RAW = bytes.fromhex("93 2F 60 30 60 0C 88 01 04 29 00 0B 60 43")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCA82
SPAN_END = 0x5E5C8
SENT = 0x5E5C8     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x5e5ba: {"kind": 'reg', "py": 'r[3] = 0xFFFFCA82', "slot_py": None, "target": None, "cond": None},
    0x5e5bc: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCA82, 1))', "slot_py": None, "target": None, "cond": None},
    0x5e5be: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x5e5c0: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x5e5c2: {"kind": 'reg', "py": 'r[4] = T;', "slot_py": None, "target": None, "cond": None},
    0x5e5c4: {"kind": "ret", "py": None, "slot_py": 'r[0] = r[4]', "target": None, "cond": None},}
