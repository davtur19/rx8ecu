#!/usr/bin/env python3
"""Differential test for obd_service_handler_638A6 (0x638A6) — pure straight-line lift, 18 bytes.
...
Run from repo root: python3 c/tests/test_obd_service_handler_638A6_638a6.py
"""
...
ENTRY = 0x638A6
RAW = bytes.fromhex("E5 00 D0 55 E1 15 D6 55 67 53 63 53 43 08 43 08 33 6C")
SEED = 42
N = 2000
