#!/usr/bin/env python3
"""Differential test for FUN_000239fc (0x239FC) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_FUN_000239fc_239fc.py
"""
...
ENTRY = 0x239FC
RAW = bytes.fromhex("92 29 E3 01 00 0B 22 30")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFB454
SPAN_END = 0x23A04
SENT = 0x23A04     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x239fc: {"kind": 'reg', "py": 'r[2] = 0xFFFFB454', "slot_py": None, "target": None, "cond": None},
    0x239fe: {"kind": 'reg', "py": 'r[3] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x23a00: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFB454, 1, r[3])', "target": None, "cond": None},}
