#!/usr/bin/env python3
"""Differential test for dtc_region_checksum_validate_8fc0 (0x66280) — pure straight-line lift, 10 bytes.
...
Run from repo root: python3 c/tests/test_dtc_region_checksum_validate_8fc0_66280.py
"""
...
ENTRY = 0x66280
RAW = bytes.fromhex("00 09 6D 93 D8 64 62 DC 22 28")
SEED = 42
N = 2000
