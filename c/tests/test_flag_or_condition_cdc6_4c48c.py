#!/usr/bin/env python3
"""Differential test for flag_or_condition_cdc6 (0x4C48C) — v3 lift (branches + delay slots), 68 bytes.
...
Run from repo root: python3 c/tests/test_flag_or_condition_cdc6_4c48c.py
"""
...
ENTRY = 0x4C48C
RAW = bytes.fromhex("94 59 93 59 60 30 60 0C 88 01 8D 06 00 09 92 54 60 20 60 0C 88 01 8F 11 00 09 D2 2D 63 20 23 38 8F 09 00 09 91 4A 60 10 20 08 8F 07 00 09 63 20 23 38 8F 03 00 09 E2 01 A0 02 24 20 E1 00 24 10 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCF4B
SPAN_END = 0x4C4D0
SENT = 0x4C4D0     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x4c48c: {"kind": 'reg', "py": 'r[4] = 0xFFFFCDC6', "slot_py": None, "target": None, "cond": None},
    0x4c48e: {"kind": 'reg', "py": 'r[3] = 0xFFFFCF4B', "slot_py": None, "target": None, "cond": None},
    0x4c490: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCF4B, 1))', "slot_py": None, "target": None, "cond": None},
    0x4c492: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x4c494: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x4c496: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4c4a6, "cond": 'T'},
    0x4c49a: {"kind": 'reg', "py": 'r[2] = 0xFFFFCF0D', "slot_py": None, "target": None, "cond": None},
    0x4c49c: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCF0D, 1))', "slot_py": None, "target": None, "cond": None},
    0x4c49e: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x4c4a0: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x4c4a2: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4c4c8, "cond": 'notT'},
    0x4c4a6: {"kind": 'reg', "py": 'r[2] = 0x0007B818', "slot_py": None, "target": None, "cond": None},
    0x4c4a8: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0x0007B818, 1))', "slot_py": None, "target": None, "cond": None},
    0x4c4aa: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x4c4ac: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4c4c2, "cond": 'notT'},
    0x4c4b0: {"kind": 'reg', "py": 'r[1] = 0xFFFFCDAE', "slot_py": None, "target": None, "cond": None},
    0x4c4b2: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFCDAE, 1))', "slot_py": None, "target": None, "cond": None},
    0x4c4b4: {"kind": 'reg', "py": 'T = 1 if (r[0] & r[0]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x4c4b6: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4c4c8, "cond": 'notT'},
    0x4c4ba: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0x0007B818, 1))', "slot_py": None, "target": None, "cond": None},
    0x4c4bc: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x4c4be: {"kind": "branch", "py": None, "slot_py": '', "target": 0x4c4c8, "cond": 'notT'},
    0x4c4c2: {"kind": 'reg', "py": 'r[2] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x4c4c4: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFCDC6, 1, r[2])', "target": 0x4c4cc, "cond": 'always'},
    0x4c4c8: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x4c4ca: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCDC6, 1, r[1])', "slot_py": None, "target": None, "cond": None},
    0x4c4cc: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
