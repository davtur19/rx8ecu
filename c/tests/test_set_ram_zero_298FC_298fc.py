#!/usr/bin/env python3
"""Differential test for set_ram_zero_298FC (0x298FC) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_set_ram_zero_298FC_298fc.py
"""
...
ENTRY = 0x298FC
RAW = bytes.fromhex("90 60 E1 00 00 0B 20 11")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    0x298fc: {"kind": 'reg', "py": 'r[0] = 0xFFFFBB04', "slot_py": None, "target": None, "cond": None},
    0x298fe: {"kind": 'reg', "py": 'r[1] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x29900: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBB04, 2, r[1])', "target": None, "cond": None},}
