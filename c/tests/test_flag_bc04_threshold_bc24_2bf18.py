#!/usr/bin/env python3
"""Differential test for flag_bc04_threshold_bc24 (0x2BF18) — v3 lift (branches + delay slots), 30 bytes.
...
Run from repo root: python3 c/tests/test_flag_bc04_threshold_bc24_2bf18.py
"""
...
ENTRY = 0x2BF18
RAW = bytes.fromhex("94 3A D2 21 D0 21 63 21 61 01 33 12 8F 03 00 09 E1 01 A0 02 24 10 E3 00 24 30 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFBC24
SPAN_END = 0x2BF36
SENT = 0x2BF36     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x2bf18: {"kind": 'reg', "py": 'r[4] = 0xFFFFBC04', "slot_py": None, "target": None, "cond": None},
    0x2bf1a: {"kind": 'reg', "py": 'r[2] = 0xFFFFBC24', "slot_py": None, "target": None, "cond": None},
    0x2bf1c: {"kind": 'reg', "py": 'r[0] = 0x0007A7C2', "slot_py": None, "target": None, "cond": None},
    0x2bf1e: {"kind": 'mem', "py": 'r[3] = s16(_rdw(ram, 0xFFFFBC24, 2))', "slot_py": None, "target": None, "cond": None},
    0x2bf20: {"kind": 'mem', "py": 'r[1] = s16(_rdw(ram, 0x0007A7C2, 2))', "slot_py": None, "target": None, "cond": None},
    0x2bf22: {"kind": 'reg', "py": 'T = 1 if (r[3] & 0xFFFFFFFF) >= (r[1] & 0xFFFFFFFF) else 0', "slot_py": None, "target": None, "cond": None},
    0x2bf24: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2bf2e, "cond": 'notT'},
    0x2bf28: {"kind": 'reg', "py": 'r[1] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x2bf2a: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFBC04, 1, r[1])', "target": 0x2bf32, "cond": 'always'},
    0x2bf2e: {"kind": 'reg', "py": 'r[3] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x2bf30: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFBC04, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x2bf32: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
