#!/usr/bin/env python3
"""Differential test for fault_counter_pos_latch_cfb8_to_cfb9 (0x5217A) — v3 lift (branches + delay slots), 28 bytes.
...
Run from repo root: python3 c/tests/test_fault_counter_pos_latch_cfb8_to_cfb9_5217a.py
"""
...
ENTRY = 0x5217A
RAW = bytes.fromhex("94 25 92 20 63 20 63 3C 43 15 8F 03 00 09 E1 01 A0 02 24 10 E0 00 24 00 00 0B 00 09")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFCFB9
SPAN_END = 0x52196
SENT = 0x52196     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x5217a: {"kind": 'reg', "py": 'r[4] = 0xFFFFCFB9', "slot_py": None, "target": None, "cond": None},
    0x5217c: {"kind": 'reg', "py": 'r[2] = 0xFFFFCFB8', "slot_py": None, "target": None, "cond": None},
    0x5217e: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFCFB8, 1))', "slot_py": None, "target": None, "cond": None},
    0x52180: {"kind": 'reg', "py": 'r[3] = r[3] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x52182: {"kind": 'reg', "py": 'T = 1 if s32(r[3]) > 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x52184: {"kind": "branch", "py": None, "slot_py": '', "target": 0x5218e, "cond": 'notT'},
    0x52188: {"kind": 'reg', "py": 'r[1] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x5218a: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFCFB9, 1, r[1])', "target": 0x52192, "cond": 'always'},
    0x5218e: {"kind": 'reg', "py": 'r[0] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x52190: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFCFB9, 1, r[0])', "slot_py": None, "target": None, "cond": None},
    0x52192: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
