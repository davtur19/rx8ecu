#!/usr/bin/env python3
"""Differential test for fpu_conditional_accumulate_pair_ch0 (0x14A5C) — v3 lift + v4 FPU, 54 bytes.
...
Run from repo root: python3 c/tests/test_fpu_conditional_accumulate_pair_ch0_14a5c.py
"""
...
ENTRY = 0x14A5C
RAW = bytes.fromhex("96 34 94 34 D2 1E 63 20 23 38 8F 0C 00 09 95 2F D3 1C F3 38 F2 58 F2 30 F4 2A D1 1B F2 58 F3 18 F2 30 A0 06 F6 2A 93 24 91 24 F3 38 F4 3A F3 18 F6 3A 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFA6E8
SPAN_END = 0x14A92
SENT = 0x14A92     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x14a5c: {"kind": 'reg', "py": 'r[6] = 0xFFFFA7A0', "slot_py": None, "target": None, "cond": None},
    0x14a5e: {"kind": 'reg', "py": 'r[4] = 0xFFFFA79C', "slot_py": None, "target": None, "cond": None},
    0x14a60: {"kind": 'reg', "py": 'r[2] = 0x0006E430', "slot_py": None, "target": None, "cond": None},
    0x14a62: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0x0006E430, 1))', "slot_py": None, "target": None, "cond": None},
    0x14a64: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x14a66: {"kind": "branch", "py": None, "slot_py": '', "target": 0x14a82, "cond": 'notT'},
    0x14a6a: {"kind": 'reg', "py": 'r[5] = 0xFFFFA63C', "slot_py": None, "target": None, "cond": None},
    0x14a6c: {"kind": 'reg', "py": 'r[3] = 0x00075B88', "slot_py": None, "target": None, "cond": None},
    0x14a6e: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x00075B88, 4))', "slot_py": None, "target": None, "cond": None},
    0x14a70: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, r[5], 4))', "slot_py": None, "target": None, "cond": None},
    0x14a72: {"kind": 'fpu', "py": 'fr[2] = ts(fr[2] + fr[3])', "slot_py": None, "target": None, "cond": None},
    0x14a74: {"kind": 'fpu', "py": '_wrw(ram, r[4], 4, f2bits(fr[2]))', "slot_py": None, "target": None, "cond": None},
    0x14a76: {"kind": 'reg', "py": 'r[1] = 0x00075B8C', "slot_py": None, "target": None, "cond": None},
    0x14a78: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, r[5], 4))', "slot_py": None, "target": None, "cond": None},
    0x14a7a: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x00075B8C, 4))', "slot_py": None, "target": None, "cond": None},
    0x14a7c: {"kind": 'fpu', "py": 'fr[2] = ts(fr[2] + fr[3])', "slot_py": None, "target": None, "cond": None},
    0x14a7e: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, r[6], 4, f2bits(fr[2]))', "target": 0x14a8e, "cond": 'always'},
    0x14a82: {"kind": 'reg', "py": 'r[3] = 0xFFFFA6E4', "slot_py": None, "target": None, "cond": None},
    0x14a84: {"kind": 'reg', "py": 'r[1] = 0xFFFFA6E8', "slot_py": None, "target": None, "cond": None},
    0x14a86: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFA6E4, 4))', "slot_py": None, "target": None, "cond": None},
    0x14a88: {"kind": 'fpu', "py": '_wrw(ram, r[4], 4, f2bits(fr[3]))', "slot_py": None, "target": None, "cond": None},
    0x14a8a: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0xFFFFA6E8, 4))', "slot_py": None, "target": None, "cond": None},
    0x14a8c: {"kind": 'fpu', "py": '_wrw(ram, r[6], 4, f2bits(fr[3]))', "slot_py": None, "target": None, "cond": None},
    0x14a8e: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
