#!/usr/bin/env python3
"""Differential test for set_ram_zero_29A04 (0x29A04) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_set_ram_zero_29A04_29a04.py
"""
...
CODE = {
    0x29a04: {"kind": 'reg', "py": 'r[2] = 0xFFFFBB1C', "slot_py": None, "target": None, "cond": None},
    0x29a06: {"kind": 'reg', "py": 'r[3] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x29a08: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFBB1C, 2, r[3])', "target": None, "cond": None},}
