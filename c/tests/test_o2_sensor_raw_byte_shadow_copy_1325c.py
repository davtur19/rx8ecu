#!/usr/bin/env python3
"""Differential test for o2_sensor_raw_byte_shadow_copy (0x1325C) — v3 lift (branches + delay slots), 18 bytes.
...
Run from repo root: python3 c/tests/test_o2_sensor_raw_byte_shadow_copy_1325c.py
"""
...
ENTRY = 0x1325C
RAW = bytes.fromhex("92 63 63 20 D1 39 21 30 93 60 60 30 D2 38 00 0B 22 00")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFA707
SPAN_END = 0x1326E
SENT = 0x1326E     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x1325c: {"kind": 'reg', "py": 'r[2] = 0xFFFFA415', "slot_py": None, "target": None, "cond": None},
    0x1325e: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFA415, 1))', "slot_py": None, "target": None, "cond": None},
    0x13260: {"kind": 'reg', "py": 'r[1] = 0xFFFFA706', "slot_py": None, "target": None, "cond": None},
    0x13262: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFA706, 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x13264: {"kind": 'reg', "py": 'r[3] = 0xFFFFA414', "slot_py": None, "target": None, "cond": None},
    0x13266: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFFA414, 1))', "slot_py": None, "target": None, "cond": None},
    0x13268: {"kind": 'reg', "py": 'r[2] = 0xFFFFA707', "slot_py": None, "target": None, "cond": None},
    0x1326a: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFA707, 1, r[0])', "target": None, "cond": None},}
