#!/usr/bin/env python3
"""Differential test for caller_7088 (entry 0x7088) — v8 ST caller (CFG), 36 bytes.
...
Run: python3 test_caller_7088.py
"""
...
CODE = {
    0x7088: {"kind": 'st', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x708a: {"kind": 'reg', "py": 'r[15] = (r[15] + s8(0xFC)) & 0xFFFFFFFF\nsp = (sp + s8(0xFC)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x708c: {"kind": 'reg', "py": 'r[5] = 0x000000E0', "slot_py": None, "target": None, "cond": None},
    0x708e: {"kind": 'reg', "py": 'r[3] = 0x00002054', "slot_py": None, "target": None, "cond": None},
    0x7090: {"kind": "call", "py": None, "slot_py": 'r[4] = r[15]', "target": 0x2054, "ret_pc": 0x7094, "set_pr": True, "cond": None},
    0x7094: {"kind": 'reg', "py": 'r[5] = 0x00000100', "slot_py": None, "target": None, "cond": None},
    0x7096: {"kind": 'reg', "py": 'r[4] = 0xFFFFF74E', "slot_py": None, "target": None, "cond": None},
    0x7098: {"kind": 'reg', "py": 'r[2] = 0x00004BBC', "slot_py": None, "target": None, "cond": None},
    0x709a: {"kind": "call", "py": None, "slot_py": 'r[6] = s8(0x01)', "target": 0x4bbc, "ret_pc": 0x709e, "set_pr": True, "cond": None},
    0x709e: {"kind": 'reg', "py": 'r[3] = 0x00002064', "slot_py": None, "target": None, "cond": None},
    0x70a0: {"kind": "call", "py": None, "slot_py": 'r[4] = _rdw(ram, sp, 4)', "target": 0x2064, "ret_pc": 0x70a4, "set_pr": True, "cond": None},
    0x70a4: {"kind": 'reg', "py": 'r[15] = (r[15] + s8(0x04)) & 0xFFFFFFFF\nsp = (sp + s8(0x04)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x70a6: {"kind": 'st', "py": 'pr = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x70a8: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},
