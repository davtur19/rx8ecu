#!/usr/bin/env python3
"""Differential test for hwfault_reg_9ecd_bit0_latch_b587 (0x253EC) — v3 lift (branches + delay slots), 40 bytes.
...
Run from repo root: python3 c/tests/test_hwfault_reg_9ecd_bit0_latch_b587_253ec.py
"""
...
ENTRY = 0x253EC
RAW = bytes.fromhex("95 71 E4 01 D3 3D 60 30 60 0C 20 48 8F 02 00 09 A0 01 60 43 E0 00 88 01 8F 02 00 09 A0 02 25 40 E2 00 25 20 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFFB587
SPAN_END = 0x25414
SENT = 0x25414     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x253ec: {"kind": 'reg', "py": 'r[5] = 0xFFFFB587', "slot_py": None, "target": None, "cond": None},
    0x253ee: {"kind": 'reg', "py": 'r[4] = s8(0x01)', "slot_py": None, "target": None, "cond": None},
    0x253f0: {"kind": 'reg', "py": 'r[3] = 0xFFFF9ECD', "slot_py": None, "target": None, "cond": None},
    0x253f2: {"kind": 'mem', "py": 'r[0] = s8(_rdw(ram, 0xFFFF9ECD, 1))', "slot_py": None, "target": None, "cond": None},
    0x253f4: {"kind": 'reg', "py": 'r[0] = r[0] & 0xFF', "slot_py": None, "target": None, "cond": None},
    0x253f6: {"kind": 'reg', "py": 'T = 1 if (r[0] & r[4]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x253f8: {"kind": "branch", "py": None, "slot_py": '', "target": 0x25400, "cond": 'notT'},
    0x253fc: {"kind": "branch", "py": None, "slot_py": 'r[0] = r[4]', "target": 0x25402, "cond": 'always'},
    0x25400: {"kind": 'reg', "py": 'r[0] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x25402: {"kind": 'reg', "py": 'T = 1 if s32(r[0]) == s8(0x01) else 0', "slot_py": None, "target": None, "cond": None},
    0x25404: {"kind": "branch", "py": None, "slot_py": '', "target": 0x2540c, "cond": 'notT'},
    0x25408: {"kind": "branch", "py": None, "slot_py": '_wrw(ram, 0xFFFFB587, 1, r[4])', "target": 0x25410, "cond": 'always'},
    0x2540c: {"kind": 'reg', "py": 'r[2] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x2540e: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFB587, 1, r[2])', "slot_py": None, "target": None, "cond": None},
    0x25410: {"kind": "ret", "py": None, "slot_py": '', "target": None, "cond": None},}
