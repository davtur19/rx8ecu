#!/usr/bin/env python3
"""Differential test for counter_inc_and_copy_9fc7 (0x7BBE) — v3 lift (branches + delay slots), 36 bytes.
...
Run from repo root: python3 c/tests/test_counter_inc_and_copy_9fc7_7bbe.py
"""
...
ENTRY = 0x7BBE
RAW = bytes.fromhex("00 09 63 40 73 FF 24 30 62 40 22 28 8F 08 00 09 D3 29 61 30 21 18 8F 03 00 09 D2 24 E0 00 22 00 00 0B 00 09")
SEED = 42
N = 500
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFF9FC7
SPAN_END = 0x7BE2
SENT = 0x7BE2     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x7bbe: {"kind": 'reg', "py": None, "slot_py": None, "target": None, "cond": None},
    0x7bc0: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, r[4], 1))', "slot_py": None, "target": None, "cond": None},
    0x7bc2: {"kind": 'reg', "py": 'r[3] = (r[3] + s8(0xFF)) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x7bc4: {"kind": 'mem', "py": '_wrw(ram, r[4], 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x7bc6: {"kind": 'mem', "py": 'r[2] = s8(_rdw(ram, r[4], 1))', "slot_py": None, "target": None, "cond": None},
