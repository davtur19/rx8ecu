#!/usr/bin/env python3
"""Differential test for fuel_control_59dc4 (0x59DC4) — v3 lift (branches + delay slots), 8 bytes.
...
Run from repo root: python3 c/tests/test_fuel_control_59dc4_59dc4.py
"""
...
ENTRY = 0x59DC4
RAW = bytes.fromhex("92 0E E3 00 00 0B 22 30")
SEED = 42
N = 500
MAXSTEPS = 100000
...
CODE = {
    0x59dc4: {"kind": 'reg', "py": 'r[2] = 0xFFFFD28C', "slot_py": None, "target": None, "cond": None},
    0x59dc6: {"kind": 'reg', "py": 'r[3] = s8(0x00)', "slot_py": None, "target": None, "cond": None},
    0x59dc8: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFD28C, 1, r[3])', "target": None, "cond": None},}
