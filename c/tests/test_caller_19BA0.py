#!/usr/bin/env python3
"""Differential test for caller_19BA0 (entry 0x19BA0) — v8 ST caller (CFG), 38 bytes.
...
Run: python3 test_caller_19BA0.py
"""
...
CODE = {
    0x19ba0: {"kind": 'st', "py": '_wrw(ram, (sp - 4) & 0xFFFFFFFF, 4, pr)\nsp = (sp - 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x19ba2: {"kind": 'reg', "py": 'r[3] = 0xFFFF9EEE', "slot_py": None, "target": None, "cond": None},
    0x19ba4: {"kind": 'reg', "py": 'r[1] = 0xFFFFAA3A', "slot_py": None, "target": None, "cond": None},
    0x19ba6: {"kind": 'mem', "py": 'r[2] = s16(_rdw(ram, 0xFFFF9EEE, 2))', "slot_py": None, "target": None, "cond": None},
    0x19ba8: {"kind": 'reg', "py": 'r[0] = 0xFFFFA114', "slot_py": None, "target": None, "cond": None},
    0x19baa: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFAA3A, 2, r[2])', "slot_py": None, "target": None, "cond": None},
    0x19bac: {"kind": 'mem', "py": 'r[3] = s16(_rdw(ram, 0xFFFFA114, 2))', "slot_py": None, "target": None, "cond": None},
    0x19bae: {"kind": 'reg', "py": 'r[2] = 0xFFFFAA46', "slot_py": None, "target": None, "cond": None},
    0x19bb0: {"kind": 'reg', "py": 'r[1] = 0xFFFFA10C', "slot_py": None, "target": None, "cond": None},
    0x19bb2: {"kind": 'mem', "py": '_wrw(ram, 0xFFFFAA46, 2, r[3])', "slot_py": None, "target": None, "cond": None},
    0x19bb4: {"kind": 'fpu', "py": 'fr[5] = bits2f(_rdw(ram, 0xFFFFA10C, 4))', "slot_py": None, "target": None, "cond": None},
    0x19bb6: {"kind": 'reg', "py": 'r[3] = 0x0006F56C', "slot_py": None, "target": None, "cond": None},
    0x19bb8: {"kind": 'reg', "py": 'r[2] = 0x000023F4', "slot_py": None, "target": None, "cond": None},
    0x19bba: {"kind": "call", "py": None, "slot_py": 'fr[4] = bits2f(_rdw(ram, 0x0006F56C, 4))', "target": 0x23f4, "ret_pc": 0x19bbe, "set_pr": True, "cond": None},
    0x19bbe: {"kind": 'reg', "py": 'r[1] = 0xFFFFAA14', "slot_py": None, "target": None, "cond": None},
    0x19bc0: {"kind": 'st', "py": 'pr = _rdw(ram, sp, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x19bc2: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, 0xFFFFAA14, 4, f2bits(fr[0]))', "target": None, "cond": None},
