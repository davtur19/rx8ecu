#!/usr/bin/env python3
"""Differential test for noop_stub_a (0x6842) — v3 lift (branches + delay slots), 36 bytes.
...
Run from repo root: python3 c/tests/test_noop_stub_a_6842.py
"""
...
ENTRY = 0x6842
RAW = bytes.fromhex("23 1B 26 30 25 40 D5 15 64 52 D6 15 63 43 62 62 61 43 23 4B 23 29 21 49 23 1B 26 32 25 42 4F 26 00 0B 6E F6")
SEED = 0
N = 2000
MAXSTEPS = 100000
...
RAM_MAX = 0xFFFF9ED4
SPAN_END = 0x6866
SENT = 0x6866     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x6842: {"kind": 'reg', "py": 'r[3] = (r[3] | r[1]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x6844: {"kind": 'mem', "py": '_wrw(ram, r[6], 1, r[3])', "slot_py": None, "target": None, "cond": None},
    0x6846: {"kind": 'mem', "py": '_wrw(ram, r[5], 1, r[4])', "slot_py": None, "target": None, "cond": None},
    0x6848: {"kind": 'reg', "py": 'r[5] = 0xFFFF9ED4', "slot_py": None, "target": None, "cond": None},
    0x684a: {"kind": 'mem', "py": 'r[4] = _rdw(ram, 0xFFFF9ED4, 4)', "slot_py": None, "target": None, "cond": None},
    0x684c: {"kind": 'reg', "py": 'r[6] = 0xFFFF9ED0', "slot_py": None, "target": None, "cond": None},
    0x684e: {"kind": 'reg', "py": 'r[3] = r[4]', "slot_py": None, "target": None, "cond": None},
    0x6850: {"kind": 'mem', "py": 'r[2] = _rdw(ram, 0xFFFF9ED0, 4)', "slot_py": None, "target": None, "cond": None},
    0x6852: {"kind": 'reg', "py": 'r[1] = r[4]', "slot_py": None, "target": None, "cond": None},
    0x6854: {"kind": 'reg', "py": 'r[3] = (r[3] | r[4]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x6856: {"kind": 'reg', "py": 'r[3] = (r[3] & r[2]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x6858: {"kind": 'reg', "py": 'r[1] = (r[1] & r[4]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x685a: {"kind": 'reg', "py": 'r[3] = (r[3] | r[1]) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x685c: {"kind": 'mem', "py": '_wrw(ram, 0xFFFF9ED0, 4, r[3])', "slot_py": None, "target": None, "cond": None},
    0x685e: {"kind": 'mem', "py": '_wrw(ram, 0xFFFF9ED4, 4, r[4])', "slot_py": None, "target": None, "cond": None},
    0x6860: {"kind": 'mem', "py": 'pr = _rdw(ram, STACK_BASE + 0x400, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "slot_py": None, "target": None, "cond": None},
    0x6862: {"kind": "ret", "py": None, "slot_py": 'r[14] = _rdw(ram, STACK_BASE + 0x404, 4)\nsp = (sp + 4) & 0xFFFFFFFF', "target": None, "cond": None},}
