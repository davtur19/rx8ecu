#!/usr/bin/env python3
"""Differential test for thermistor_conditional_load (0x19F64) — v3 lift + v4 FPU, 50 bytes.
...
Run from repo root: python3 c/tests/test_thermistor_conditional_load_19f64.py
"""
...
RAM_MAX = 0xFFFFC656
SPAN_END = 0x19F96
SENT = 0x19F96     # stop-sentinel, placed past the literal pool
...
CODE = {
    0x19f64: {"kind": 'reg', "py": 'r[7] = 0xFFFFAA18', "slot_py": None, "target": None, "cond": None},
    0x19f66: {"kind": 'reg', "py": 'r[6] = 0xFFFFAA14', "slot_py": None, "target": None, "cond": None},
    0x19f68: {"kind": 'reg', "py": 'r[5] = 0xFFFFAA10', "slot_py": None, "target": None, "cond": None},
    0x19f6a: {"kind": 'reg', "py": 'r[2] = 0xFFFFC656', "slot_py": None, "target": None, "cond": None},
    0x19f6c: {"kind": 'mem', "py": 'r[3] = s8(_rdw(ram, 0xFFFFC656, 1))', "slot_py": None, "target": None, "cond": None},
    0x19f6e: {"kind": 'reg', "py": 'T = 1 if (r[3] & r[3]) == 0 else 0', "slot_py": None, "target": None, "cond": None},
    0x19f70: {"kind": "branch", "py": None, "slot_py": '', "target": 0x19f82, "cond": 'notT'},
    0x19f74: {"kind": 'reg', "py": 'r[4] = 0xFFFFAA0C', "slot_py": None, "target": None, "cond": None},
    0x19f76: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, r[4], 4))', "slot_py": None, "target": None, "cond": None},
    0x19f78: {"kind": 'fpu', "py": '_wrw(ram, r[5], 4, f2bits(fr[3]))', "slot_py": None, "target": None, "cond": None},
    0x19f7a: {"kind": 'fpu', "py": 'fr[2] = bits2f(_rdw(ram, r[4], 4))', "slot_py": None, "target": None, "cond": None},
    0x19f7c: {"kind": 'fpu', "py": '_wrw(ram, r[6], 4, f2bits(fr[2]))', "slot_py": None, "target": None, "cond": None},
    0x19f7e: {"kind": "branch", "py": None, "slot_py": 'fr[3] = bits2f(_rdw(ram, r[4], 4))', "target": 0x19f92, "cond": 'always'},
    0x19f82: {"kind": 'reg', "py": 'r[3] = 0x0006F9F0', "slot_py": None, "target": None, "cond": None},
    0x19f84: {"kind": 'reg', "py": 'r[1] = 0x0006F9F4', "slot_py": None, "target": None, "cond": None},
    0x19f86: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x0006F9F0, 4))', "slot_py": None, "target": None, "cond": None},
    0x19f88: {"kind": 'fpu', "py": '_wrw(ram, r[5], 4, f2bits(fr[3]))', "slot_py": None, "target": None, "cond": None},
    0x19f8a: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x0006F9F4, 4))', "slot_py": None, "target": None, "cond": None},
    0x19f8c: {"kind": 'fpu', "py": '_wrw(ram, r[6], 4, f2bits(fr[3]))', "slot_py": None, "target": None, "cond": None},
    0x19f8e: {"kind": 'reg', "py": 'r[2] = 0x0006F9F8', "slot_py": None, "target": None, "cond": None},
    0x19f90: {"kind": 'fpu', "py": 'fr[3] = bits2f(_rdw(ram, 0x0006F9F8, 4))', "slot_py": None, "target": None, "cond": None},
    0x19f92: {"kind": "ret", "py": None, "slot_py": '_wrw(ram, r[7], 4, f2bits(fr[3]))', "target": None, "cond": None},}
