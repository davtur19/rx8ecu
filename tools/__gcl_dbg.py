    ...
    def _record_tbl_base(mr):
        ...
        if mr.get('idx') == 'r0' and mr['dir'] == 'load' and mr.get('dest') is not None:
            ...
            if _bl is not None:
                ...
                import sys as _s; print('TBLBASE_SET dest=r%d base=0x%08X ml_pc=0x%04X breg=%d r1lit=%s' % (mr['dest'], _bl, pc, mr['base_reg'], st['lits'].get('r1')), file=_s.stderr); tbl_base[mr['dest']] = _bl
        ...
        while pc + 1 < bound:
            ...
            if gcl.is_call_op(op):
                ...
                if rn in tbl_base:                     # JUMP TABLE
                    import sys as _s2; print('JTREAD pc=%06X rn=%d base=%s' % (pc, rn, tbl_base.get(rn)), file=_s2.stderr); base = tbl_base[rn]
